// TypeScript definitions for the C3 type Genai.Agent.Tool.Config

/**
 * Configuration for a {@link Genai.Agent.Tool}
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.Agent.Tool.Config
 */
...
declare namespace Genai.Agent.Tool {
  export class Config extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): Genai.Agent.Tool.Config;

    readonly configOverride?: string;
    withConfigOverride(configOverride: string | null): Genai.Agent.Tool.Config;

    readonly secretOverride?: string;
    withSecretOverride(secretOverride: string | null): Genai.Agent.Tool.Config;

    /**
     * Captures any issues that occurred while deserializing from filesystem
     */
    readonly issues?: Array_Type<string>;
    withIssues(issues: Array_Type<string> | Array<string> | null): Genai.Agent.Tool.Config;

    /**
     * Semantic name for the tool. Used for agent prompts.
     */
    readonly toolName: string;
    withToolName(toolName: string): Genai.Agent.Tool.Config;

    /**
     * Natural language description for the tool. Used for agent prompts.
     */
    readonly toolDescription: string;
    withToolDescription(toolDescription: string): Genai.Agent.Tool.Config;
    ...
    withFormattingMessage(formattingMessage: string | null): Genai.Agent.Tool.Config;

    /**
     * Array of {@link Genai.Agent.Tool.Example}s for this tool.
     */
    readonly examples?: Array_Type<Genai.Agent.Tool.Example>;
    withExamples(examples: Array_Type<Genai.Agent.Tool.Example> | Array<IGenai.Agent.Tool.Example> | null): Genai.Agent.Tool.Config;
    ...
    withUiOptions(uiOptions: IGenai.Agent.Tool.Config.UiOptions | null): Genai.Agent.Tool.Config;
    ...
    withOverrideRuntimeKwargs(overrideRuntimeKwargs: any | null): Genai.Agent.Tool.Config;
    ...
    withUseFewShotSpecGeneration(useFewShotSpecGeneration: boolean): Genai.Agent.Tool.Config;

    /**
     * Prompt used for getting a natural language answer to the question from structured data.
     */
    readonly textAnswerFromDataPrompt: string;
    withTextAnswerFromDataPrompt(textAnswerFromDataPrompt: string): Genai.Agent.Tool.Config;
    ...
    withDoNotGenerateAnswerFromLlm(doNotGenerateAnswerFromLlm: boolean): Genai.Agent.Tool.Config;
    ...
    withNumRowsForLlm(numRowsForLlm: number | null): Genai.Agent.Tool.Config;

    /**
     * Name of {@link Genai.UnstructuredQuery.Engine.ModelConfig} that should be used for getting a natural language answer from structured data.
     */
    readonly textAnswerFromDataModelConfigName?: string;
    withTextAnswerFromDataModelConfigName(textAnswerFromDataModelConfigName: string | null): Genai.Agent.Tool.Config;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.Agent.Tool.Config | null;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.Agent.Tool.Config | null;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.Agent.Tool.Config;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.Agent.Tool.Config;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.Agent.Tool.Config;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.Agent.Tool.Config;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.Agent.Tool.Config | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.Agent.Tool.Config | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.Agent.Tool.Config | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.Agent.Tool.Config | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.Agent.Tool.Config;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Agent.Tool.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Agent.Tool.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Agent.Tool.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Agent.Tool.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.Agent.Tool.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Agent.Tool.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Agent.Tool.Config;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.Agent.Tool.Config;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.Agent.Tool.Config;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.Agent.Tool.Config;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.Agent.Tool.Config;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.Agent.Tool.Config;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.Agent.Tool.Config;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.Agent.Tool.Config;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.Agent.Tool.Config;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.Agent.Tool.Config;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.Agent.Tool.Config;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.Agent.Tool.Config;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.Agent.Tool.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.Agent.Tool.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.Agent.Tool.Config;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.Agent.Tool.Config;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.Agent.Tool.Config;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.Agent.Tool.Config;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.Agent.Tool.Config;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.Agent.Tool.Config;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.Agent.Tool.Config;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.Agent.Tool.Config;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.Agent.Tool.Config;

    mergeJson(json: any): Genai.Agent.Tool.Config;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.Agent.Tool.Config;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.Agent.Tool.Config;
     ...
     */
    singletonArray(): Array_Type<Genai.Agent.Tool.Config>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.Agent.Tool.Config> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.Agent.Tool.Config> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.Agent.Tool.Config>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.Agent.Tool.Config> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.Agent.Tool.Config> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.Agent.Tool.Config> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.Agent.Tool.Config>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.Agent.Tool.Config>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.Agent.Tool.Config;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.Agent.Tool.Config;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.Agent.Tool.Config;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.Agent.Tool.Config;
     ...
     */
    static cachedEmptyInst(): Genai.Agent.Tool.Config;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.Agent.Tool.Config> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.Agent.Tool.Config;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.Agent.Tool.Config | null;
     ...
     */
    static allCached(): Stream<Genai.Agent.Tool.Config> | null;
     ...
     */
    static find(filter?: string): Stream<Genai.Agent.Tool.Config> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<Genai.Agent.Tool.Config> | null;

    /**
     * @return cached instance.
     */
    getCached(): Genai.Agent.Tool.Config | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string): Genai.Agent.Tool.Config | null;
     ...
     */
    static produce(key: string): Genai.Agent.Tool.Config | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, Genai.Agent.Tool.Config> | null;
     ...
     */
    getConfig(): Genai.Agent.Tool.Config;
     ...
     */
    getSecret(): Genai.Agent.Tool.Config;
     ...
     */
    withConfigKey(configKey: string): Genai.Agent.Tool.Config;

    /**
     * @return copy without config key.
     */
    withoutConfigKey(): Genai.Agent.Tool.Config;

    /**
     * @return return cached config instance for provided config key.
     */
    static forConfigKey(configKey: string): Genai.Agent.Tool.Config | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string>): Stream<Genai.Agent.Tool.Config> | null;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: Genai.Agent.Tool.Config, override?: string): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): Genai.Agent.Tool.Config | null;
     ...
     */
    static setRecursive(configJson: any, useSetConfigValues?: boolean, override?: string): Genai.Agent.Tool.Config;
