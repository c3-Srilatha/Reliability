// TypeScript definitions for the C3 type Genai.Query.Result.PassageFeedback

/**
 * Feedback given to the linked {@link Genai.Query.Result}
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.Query.Result.PassageFeedback
 */
declare namespace Genai.Query.Result {
  export interface IPassageFeedback {
     ...
     */
    additionalFeedback?: Array_Type<string> | Array<string>;

    /**
     * The step in the {@link Genai.Agent.DynamicTrajectory} that this feedback is associated with.
     */
    trajectoryStep?: IGenai.Agent.DynamicTrajectory.Step;
    ...
    /**
     * The {@link Genai.Query.ResultToPassageRelation} the feedback is for.
     * The user gives feedback on the presence of a passage/file in a
     * {@link Genai.Query.Result}.
     */
    passageRelation: IGenai.Query.ResultToPassageRelation;
  }
}
 ...
 * Feedback given to the linked {@link Genai.Query.Result}
 *
 * @remarks this represents a made instance of Genai.Query.Result.PassageFeedback
 */
declare namespace Genai.Query.Result {
  export class PassageFeedback extends Obj  {

    /**
     * Whether the {@link Genai.Query.Result} was helpful for the question asked.
     */
    readonly helpful: boolean;
    withHelpful(helpful: boolean): Genai.Query.Result.PassageFeedback;

    /**
     * The user's comment, if any, about the result.
     */
    readonly comment?: string;
    withComment(comment: string | null): Genai.Query.Result.PassageFeedback;

    /**
     * Additional feedback options selected.
     */
    readonly additionalFeedback?: Array_Type<string>;
    withAdditionalFeedback(additionalFeedback: Array_Type<string> | Array<string> | null): Genai.Query.Result.PassageFeedback;

    /**
     * The step in the {@link Genai.Agent.DynamicTrajectory} that this feedback is associated with.
     */
    readonly trajectoryStep?: Genai.Agent.DynamicTrajectory.Step;
    withTrajectoryStep(trajectoryStep: IGenai.Agent.DynamicTrajectory.Step | null): Genai.Query.Result.PassageFeedback;
     ...
     */
    readonly id: string;
    withId(id: string): Genai.Query.Result.PassageFeedback;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Genai.Query.Result.PassageFeedback;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): Genai.Query.Result.PassageFeedback;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Genai.Query.Result.PassageFeedback;
    ...
    withVersion(version: number | null): Genai.Query.Result.PassageFeedback;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Genai.Query.Result.PassageFeedback;
     ...
     * {@link Genai.Query.Result}.
     */
    readonly passageRelation: Genai.Query.ResultToPassageRelation;
    withPassageRelation(passageRelation: IGenai.Query.ResultToPassageRelation): Genai.Query.Result.PassageFeedback;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.Query.Result.PassageFeedback | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.Query.Result.PassageFeedback | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.Query.Result.PassageFeedback | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.Query.Result.PassageFeedback | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.Query.Result.PassageFeedback;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Query.Result.PassageFeedback;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Query.Result.PassageFeedback;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Query.Result.PassageFeedback>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Query.Result.PassageFeedback>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.Query.Result.PassageFeedback;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Query.Result.PassageFeedback;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Query.Result.PassageFeedback;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.Query.Result.PassageFeedback;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.Query.Result.PassageFeedback;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.Query.Result.PassageFeedback;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.Query.Result.PassageFeedback;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.Query.Result.PassageFeedback;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.Query.Result.PassageFeedback;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.Query.Result.PassageFeedback;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.Query.Result.PassageFeedback;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.Query.Result.PassageFeedback;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.Query.Result.PassageFeedback;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.Query.Result.PassageFeedback;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.Query.Result.PassageFeedback;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.Query.Result.PassageFeedback;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.Query.Result.PassageFeedback;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.Query.Result.PassageFeedback;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.Query.Result.PassageFeedback;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.Query.Result.PassageFeedback;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.Query.Result.PassageFeedback;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.Query.Result.PassageFeedback;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.Query.Result.PassageFeedback;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.Query.Result.PassageFeedback;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.Query.Result.PassageFeedback;

    mergeJson(json: any): Genai.Query.Result.PassageFeedback;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.Query.Result.PassageFeedback;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.Query.Result.PassageFeedback;
     ...
     */
    singletonArray(): Array_Type<Genai.Query.Result.PassageFeedback>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.Query.Result.PassageFeedback> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.Query.Result.PassageFeedback> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.Query.Result.PassageFeedback>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.Query.Result.PassageFeedback> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.Query.Result.PassageFeedback> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.Query.Result.PassageFeedback> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.Query.Result.PassageFeedback>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.Query.Result.PassageFeedback>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.Query.Result.PassageFeedback;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.Query.Result.PassageFeedback;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.Query.Result.PassageFeedback;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.Query.Result.PassageFeedback;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.Query.Result.PassageFeedback;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.Query.Result.PassageFeedback;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.Query.Result.PassageFeedback | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.Query.Result.PassageFeedback;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.Query.Result.PassageFeedback;
     ...
     */
    static cachedEmptyInst(): Genai.Query.Result.PassageFeedback;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.Query.Result.PassageFeedback> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.Query.Result.PassageFeedback;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Genai.Query.Result.PassageFeedback>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Genai.Query.Result.PassageFeedback>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Genai.Query.Result.PassageFeedback> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Genai.Query.Result.PassageFeedback>> | null;
     ...
     */
    get(include?: string): Genai.Query.Result.PassageFeedback | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Genai.Query.Result.PassageFeedback | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Genai.Query.Result.PassageFeedback;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Genai.Query.Result.PassageFeedback | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Genai.Query.Result.PassageFeedback;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.Query.Result.PassageFeedback | null;
     ...
     */
    create(spec?: UpsertSpec): Genai.Query.Result.PassageFeedback | null;
     ...
     */
    static createBatch(objs: Array_Type<Genai.Query.Result.PassageFeedback>, spec?: UpsertSpec): ObjList<Genai.Query.Result.PassageFeedback> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Genai.Query.Result.PassageFeedback>, spec?: CreateBatchObjStreamSpec): ObjList<Genai.Query.Result.PassageFeedback> | null;
     ...
     */
    update(srcObj?: Genai.Query.Result.PassageFeedback, spec?: UpsertSpec): Genai.Query.Result.PassageFeedback | null;
     ...
     */
    upsert(srcObj?: Genai.Query.Result.PassageFeedback, spec?: UpsertSpec): Genai.Query.Result.PassageFeedback | null;
     ...
     */
    merge(spec?: MergeSpec): Genai.Query.Result.PassageFeedback | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Genai.Query.Result.PassageFeedback | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Genai.Query.Result.PassageFeedback | null;
     ...
     */
    static updateBatch(objs: Array_Type<Genai.Query.Result.PassageFeedback>, srcObjs?: Array_Type<Genai.Query.Result.PassageFeedback>, spec?: UpsertSpec): ObjList<Genai.Query.Result.PassageFeedback> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Genai.Query.Result.PassageFeedback> | null>, spec?: UpsertSpec): ObjList<Genai.Query.Result.PassageFeedback> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Genai.Query.Result.PassageFeedback>, srcObjs?: Array_Type<Genai.Query.Result.PassageFeedback>, spec?: UpsertSpec): ObjList<Genai.Query.Result.PassageFeedback> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Genai.Query.Result.PassageFeedback> | null>, spec?: UpsertSpec): ObjList<Genai.Query.Result.PassageFeedback> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Genai.Query.Result.PassageFeedback>, spec?: TouchSpec): ObjList<Genai.Query.Result.PassageFeedback> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.Query.Result.PassageFeedback>, spec?: MergeSpec): ObjList<Genai.Query.Result.PassageFeedback> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.Query.Result.PassageFeedback>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.Query.Result.PassageFeedback> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Genai.Query.Result.PassageFeedback> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.Query.Result.PassageFeedback> | null;
     ...
     */
    static mergeAll(mergeObj: Genai.Query.Result.PassageFeedback, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Genai.Query.Result.PassageFeedback, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Genai.Query.Result.PassageFeedback>, spec?: UpsertSpec): ObjList<Genai.Query.Result.PassageFeedback> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Genai.Query.Result.PassageFeedback>, spec?: UpsertSpec): ObjList<Genai.Query.Result.PassageFeedback> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Genai.Query.Result.PassageFeedback | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Genai.Query.Result.PassageFeedback>): ObjList<Genai.Query.Result.PassageFeedback>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<Genai.Query.Result.PassageFeedback>): ObjList<Genai.Query.Result.PassageFeedback>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Genai.Query.Result.PassageFeedback>): ObjList<Genai.Query.Result.PassageFeedback>;
     ...
     */
    static afterCreate(objs: Array_Type<Genai.Query.Result.PassageFeedback>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Genai.Query.Result.PassageFeedback>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Genai.Query.Result.PassageFeedback>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Genai.Query.Result.PassageFeedback>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Genai.Query.Result.PassageFeedback>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.Query.Result.PassageFeedback | null;
     ...
     */
    withoutIdentity(): Genai.Query.Result.PassageFeedback | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Genai.Query.Result.PassageFeedback>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Genai.Query.Result.PassageFeedback, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Genai.Query.Result.PassageFeedback>, callback?: λFunction<Genai.Query.Result.PassageFeedback | null, Genai.Query.Result.PassageFeedback | null>): ObjList<Genai.Query.Result.PassageFeedback>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Genai.Query.Result.PassageFeedback>, callback?: λFunction<Genai.Query.Result.PassageFeedback | null, Genai.Query.Result.PassageFeedback | null>): Array_Type<ObjError> | null;
