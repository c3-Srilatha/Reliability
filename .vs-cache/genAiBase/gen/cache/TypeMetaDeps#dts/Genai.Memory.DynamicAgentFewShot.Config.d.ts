// TypeScript definitions for the C3 type Genai.Memory.DynamicAgentFewShot.Config

/**
 * The Config interface for {@link Genai.Memory.DynamicAgentFewShot}.
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.Memory.DynamicAgentFewShot.Config
 */
declare namespace Genai.Memory.DynamicAgentFewShot {
...
declare namespace Genai.Memory.DynamicAgentFewShot {
  export class Config extends Obj  {
    ...
    withConfigOverride(configOverride: string | null): Genai.Memory.DynamicAgentFewShot.Config;

    static readonly configOverride?: string;

    readonly secretOverride?: string;
    withSecretOverride(secretOverride: string | null): Genai.Memory.DynamicAgentFewShot.Config;
    ...
    withIssues(issues: Array_Type<string> | Array<string> | null): Genai.Memory.DynamicAgentFewShot.Config;
    ...
    withName(name: string): Genai.Memory.DynamicAgentFewShot.Config;
    ...
    withTypeIdent(typeIdent: string | null): Genai.Memory.DynamicAgentFewShot.Config;

    /**
     * Indicates explicit sub-type of entry.  Composed of the concatenation of the typeKey of the instance's type and all
     * of its base type's typeIdent
     */
    static readonly typeIdent?: string;

    /**
     * The Type of {@link Genai.Memory} that this config is for.
     */
    readonly memoryType?: Type<<Genai.Memory>>;
    withMemoryType(memoryType: IType<<Genai.Memory>> | null): Genai.Memory.DynamicAgentFewShot.Config;

    /**
     * The Type of {@link Genai.Memory} that this config is for.
     */
    static readonly memoryType?: Type<<Genai.Memory>>;

    /**
     * Spec of embedder to use for encoding memories.
     */
    readonly embedderSpec: Genai.Embedder.Spec;
    withEmbedderSpec(embedderSpec: IGenai.Embedder.Spec): Genai.Memory.DynamicAgentFewShot.Config;
     ...
     * {@link https://sbert.net/docs/package_reference/sentence_transformer/SentenceTransformer.html#sentence_transformers.SentenceTransformer.encode}
     */
    readonly memoryEncodeKwargs?: any;
    withMemoryEncodeKwargs(memoryEncodeKwargs: any | null): Genai.Memory.DynamicAgentFewShot.Config;
     ...
     * {@link https://sbert.net/docs/package_reference/sentence_transformer/SentenceTransformer.html#sentence_transformers.SentenceTransformer.encode}
     */
    static readonly memoryEncodeKwargs?: any;
     ...
     * {@link https://sbert.net/docs/package_reference/sentence_transformer/SentenceTransformer.html#sentence_transformers.SentenceTransformer.encode}
     */
    readonly queryEncodeKwargs?: any;
    withQueryEncodeKwargs(queryEncodeKwargs: any | null): Genai.Memory.DynamicAgentFewShot.Config;
     ...
     * {@link https://sbert.net/docs/package_reference/sentence_transformer/SentenceTransformer.html#sentence_transformers.SentenceTransformer.encode}
     */
    static readonly queryEncodeKwargs?: any;

    /**
     * Vector store to use for storing and retrieving memories.
     */
    readonly vectorStore?: GenaiCore.PgVector;
    withVectorStore(vectorStore: IGenaiCore.PgVector | null): Genai.Memory.DynamicAgentFewShot.Config;

    /**
     * Vector store to use for storing and retrieving memories.
     */
    static readonly vectorStore?: GenaiCore.PgVector;

    /**
     * @return the one and only instance to be used when member functions are called on this type.
     */
    static inst(): Genai.Memory.DynamicAgentFewShot.Config;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.Memory.DynamicAgentFewShot.Config | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.Memory.DynamicAgentFewShot.Config | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.Memory.DynamicAgentFewShot.Config | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.Memory.DynamicAgentFewShot.Config | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.Memory.DynamicAgentFewShot.Config;
     ...
     * This method is used during live metadata update
     */
    static replaceType(old: Type, new_: Type): Genai.Memory.DynamicAgentFewShot.Config;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Memory.DynamicAgentFewShot.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Memory.DynamicAgentFewShot.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Memory.DynamicAgentFewShot.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Memory.DynamicAgentFewShot.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Memory.DynamicAgentFewShot.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Memory.DynamicAgentFewShot.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Memory.DynamicAgentFewShot.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Memory.DynamicAgentFewShot.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.Memory.DynamicAgentFewShot.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.Memory.DynamicAgentFewShot.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Memory.DynamicAgentFewShot.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Memory.DynamicAgentFewShot.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Memory.DynamicAgentFewShot.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Memory.DynamicAgentFewShot.Config;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.Memory.DynamicAgentFewShot.Config;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    static validateObj(): Genai.Memory.DynamicAgentFewShot.Config;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.Memory.DynamicAgentFewShot.Config;
     ...
     * @see #defaultField
     */
    static withField(field: string, value: any, doNotConvert?: boolean): Genai.Memory.DynamicAgentFewShot.Config;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.Memory.DynamicAgentFewShot.Config;
     ...
     * @see #defaultField
     */
    static withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.Memory.DynamicAgentFewShot.Config;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.Memory.DynamicAgentFewShot.Config;
     ...
     * @return new Obj
     */
    static withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.Memory.DynamicAgentFewShot.Config;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.Memory.DynamicAgentFewShot.Config;
     ...
     * @return new Obj
     */
    static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.Memory.DynamicAgentFewShot.Config;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.Memory.DynamicAgentFewShot.Config;
     ...
     * @see #withoutField
     */
    static withoutFieldAtPath(path: string): Genai.Memory.DynamicAgentFewShot.Config;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.Memory.DynamicAgentFewShot.Config;
     ...
     * @see #removeField
     */
    static withoutField(field: string): Genai.Memory.DynamicAgentFewShot.Config;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.Memory.DynamicAgentFewShot.Config;
     ...
     * @see #removeField
     */
    static withoutField(field: FieldType): Genai.Memory.DynamicAgentFewShot.Config;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.Memory.DynamicAgentFewShot.Config;
     ...
     * @return new Obj with removed fields
     */
    static withoutFields(fields: Array_Type<string>): Genai.Memory.DynamicAgentFewShot.Config;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.Memory.DynamicAgentFewShot.Config;
     ...
     * @return new Obj with removed fields
     */
    static withoutFieldsByType(fields: Array_Type<FieldType>): Genai.Memory.DynamicAgentFewShot.Config;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.Memory.DynamicAgentFewShot.Config;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    static withoutSecretFields(): Genai.Memory.DynamicAgentFewShot.Config;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.Memory.DynamicAgentFewShot.Config;
     ...
     * @see FieldType#defaultValue
     */
    static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.Memory.DynamicAgentFewShot.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.Memory.DynamicAgentFewShot.Config;
     ...
     * @see #unsetField
     */
    static defaultField(field: string): Genai.Memory.DynamicAgentFewShot.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.Memory.DynamicAgentFewShot.Config;
     ...
     * @see #unsetField
     */
    static defaultField(field: FieldType): Genai.Memory.DynamicAgentFewShot.Config;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.Memory.DynamicAgentFewShot.Config;
     ...
     * @see #removeField
     */
    static unsetField(field: string): Genai.Memory.DynamicAgentFewShot.Config;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.Memory.DynamicAgentFewShot.Config;
     ...
     * @see #removeField
     */
    static unsetField(field: FieldType): Genai.Memory.DynamicAgentFewShot.Config;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.Memory.DynamicAgentFewShot.Config;
     ...
     * @see #unsetField
     */
    static removeField(field: string): Genai.Memory.DynamicAgentFewShot.Config;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.Memory.DynamicAgentFewShot.Config;
     ...
     * @see #unsetField
     */
    static removeField(field: FieldType): Genai.Memory.DynamicAgentFewShot.Config;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.Memory.DynamicAgentFewShot.Config;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.Memory.DynamicAgentFewShot.Config;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.Memory.DynamicAgentFewShot.Config;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj, otherFieldsFilter: Type): Genai.Memory.DynamicAgentFewShot.Config;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.Memory.DynamicAgentFewShot.Config;
     ...
     *        the same key or index.
     */
    static mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.Memory.DynamicAgentFewShot.Config;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.Memory.DynamicAgentFewShot.Config;
     ...
     * traverse child reference and collection fields.
     */
    static mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.Memory.DynamicAgentFewShot.Config;

    mergeJson(json: any): Genai.Memory.DynamicAgentFewShot.Config;

    static mergeJson(json: any): Genai.Memory.DynamicAgentFewShot.Config;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.Memory.DynamicAgentFewShot.Config;
     ...
     * @return Obj with child references merged
     */
    static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.Memory.DynamicAgentFewShot.Config;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.Memory.DynamicAgentFewShot.Config;
     ...
     * references with same name and collection elements at same index or key.
     */
    static sumObj(other: Obj, deep?: boolean): Genai.Memory.DynamicAgentFewShot.Config;
     ...
     */
    singletonArray(): Array_Type<Genai.Memory.DynamicAgentFewShot.Config>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonArray(): Array_Type<Genai.Memory.DynamicAgentFewShot.Config>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.Memory.DynamicAgentFewShot.Config> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.Memory.DynamicAgentFewShot.Config> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.Memory.DynamicAgentFewShot.Config>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonSet(): Set_Type<Genai.Memory.DynamicAgentFewShot.Config>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.Memory.DynamicAgentFewShot.Config> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.Memory.DynamicAgentFewShot.Config> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.Memory.DynamicAgentFewShot.Config> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.Memory.DynamicAgentFewShot.Config>;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    static toBuilder(): ObjBuilder<Genai.Memory.DynamicAgentFewShot.Config>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.Memory.DynamicAgentFewShot.Config>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.Memory.DynamicAgentFewShot.Config;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.Memory.DynamicAgentFewShot.Config;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.Memory.DynamicAgentFewShot.Config;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.Memory.DynamicAgentFewShot.Config;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.Memory.DynamicAgentFewShot.Config;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.Memory.DynamicAgentFewShot.Config;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.Memory.DynamicAgentFewShot.Config | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.Memory.DynamicAgentFewShot.Config;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.Memory.DynamicAgentFewShot.Config;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    static afterMake(): Genai.Memory.DynamicAgentFewShot.Config;
     ...
     */
    static cachedEmptyInst(): Genai.Memory.DynamicAgentFewShot.Config;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.Memory.DynamicAgentFewShot.Config> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.Memory.DynamicAgentFewShot.Config;
     ...
     */
    static allCached(): Stream<Genai.Memory.DynamicAgentFewShot.Config> | null;
     ...
     */
    static find(filter?: string): Stream<Genai.Memory.DynamicAgentFewShot.Config> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<Genai.Memory.DynamicAgentFewShot.Config> | null;

    /**
     * @return cached instance.
     */
    getCached(): Genai.Memory.DynamicAgentFewShot.Config | null;

    /**
     * @return cached instance.
     */
    static getCached(): Genai.Memory.DynamicAgentFewShot.Config | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string): Genai.Memory.DynamicAgentFewShot.Config | null;
     ...
     */
    static produce(key: string): Genai.Memory.DynamicAgentFewShot.Config | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, Genai.Memory.DynamicAgentFewShot.Config> | null;
     ...
     */
    getConfig(): Genai.Memory.DynamicAgentFewShot.Config;
     ...
     * Note that typical pattern is to use Configurable#config instead of this method.
     */
    static getConfig(): Genai.Memory.DynamicAgentFewShot.Config;
     ...
     */
    getSecret(): Genai.Memory.DynamicAgentFewShot.Config;
     ...
     * Note that typical pattern is to use Configurable#configWithSecrets instead of this method.
     */
    static getSecret(): Genai.Memory.DynamicAgentFewShot.Config;
     ...
     */
    withConfigKey(configKey: string): Genai.Memory.DynamicAgentFewShot.Config;
     ...
     *     config.configKey() => "folder1/abc"
     */
    static withConfigKey(configKey: string): Genai.Memory.DynamicAgentFewShot.Config;

    /**
     * @return copy without config key.
     */
    withoutConfigKey(): Genai.Memory.DynamicAgentFewShot.Config;

    /**
     * @return copy without config key.
     */
    static withoutConfigKey(): Genai.Memory.DynamicAgentFewShot.Config;

    /**
     * @return return cached config instance for provided config key.
     */
    static forConfigKey(configKey: string): Genai.Memory.DynamicAgentFewShot.Config | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string>): Stream<Genai.Memory.DynamicAgentFewShot.Config> | null;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: Genai.Memory.DynamicAgentFewShot.Config, override?: string): void;
     ...
     * @see setConfigValue
     */
    static setConfigValues(from: Genai.Memory.DynamicAgentFewShot.Config, override?: string): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): Genai.Memory.DynamicAgentFewShot.Config | null;
     ...
     */
    removeSecrets(): Genai.Memory.DynamicAgentFewShot.Config | null;

    /**
     * @return this config without any secret values.
     */
    static removeSecrets(): Genai.Memory.DynamicAgentFewShot.Config | null;

    /**
     * @return this config with only secret values.
     */
    removeNonSecrets(): Genai.Memory.DynamicAgentFewShot.Config | null;

    /**
     * @return this config with only secret values.
     */
    static removeNonSecrets(): Genai.Memory.DynamicAgentFewShot.Config | null;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    validate(): Genai.Memory.DynamicAgentFewShot.Config;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    static validate(): Genai.Memory.DynamicAgentFewShot.Config;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.Memory.DynamicAgentFewShot.Config | null;
     ...
     */
    static forName(name: string, failIfMissing?: boolean): Genai.Memory.DynamicAgentFewShot.Config | null;
     ...
     */
    embedder(): GenaiCore.Embedder;

    /**
     * Load the embedder intance from engine.
     */
    static embedder(): GenaiCore.Embedder;
     ...
     */
    addMemories(memories: Array_Type<any>): number | null;
     ...
     * uploaded memories count is returned.
     */
    static addMemories(memories: Array_Type<any>): number | null;

    /**
     * Retrieves memories similar to the query.
     */
    getMemories(query: string, similaritySearchSpec?: GenaiCore.SimilaritySearchSpec): Array_Type<GenaiCore.VectorStore.SimilaritySearchResult> | null;

    /**
     * Retrieves memories similar to the query.
     */
    static getMemories(query: string, similaritySearchSpec?: GenaiCore.SimilaritySearchSpec): Array_Type<GenaiCore.VectorStore.SimilaritySearchResult> | null;
     ...
     */
    zeroPadVectors(vectors: Array_Type<Array_Type<number>>): Array_Type<Array_Type<number>>;
     ...
     * The cosine similarity would not be affected by the padded zeros.
     */
    static zeroPadVectors(vectors: Array_Type<Array_Type<number>>): Array_Type<Array_Type<number>>;

    /**
     * Utility function to get the defined vector dimension of {@link Genai.Memory#embedding}.
     */
    expectedVectorDimension(): number | null;

    /**
     * Utility function to get the defined vector dimension of {@link Genai.Memory#embedding}.
     */
    static expectedVectorDimension(): number | null;

    /**
     * Formats the similarity search results to a string that can be ingested to the prompt.
     */
    static formatSearchResultsToString(searchResult?: Array_Type<GenaiCore.VectorStore.SimilaritySearchResult>): string | null;
  }
}
