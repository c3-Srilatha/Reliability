// TypeScript definitions for the C3 type Genai.StructuredData.DataModelGraph
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.StructuredData.DataModelGraph
 */
declare namespace Genai.StructuredData {
  export interface IDataModelGraph {
     ...
     */
    fieldsToIgnore?: Set_Type<string> | Array<string>;
     ...
     */
    includeCollectionFields?: boolean;
 ...
 */
declare namespace Genai.StructuredData {
  export class DataModelGraph extends Obj  {

    /**
     * The unique and required name of this instance.
     */
    readonly name: string;
    withName(name: string): Genai.StructuredData.DataModelGraph;
     ...
     */
    readonly id: string;
    withId(id: string): Genai.StructuredData.DataModelGraph;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Genai.StructuredData.DataModelGraph;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Genai.StructuredData.DataModelGraph;
    ...
    withVersion(version: number | null): Genai.StructuredData.DataModelGraph;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Genai.StructuredData.DataModelGraph;
    ...
    withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): Genai.StructuredData.DataModelGraph;
    ...
    withHidden(hidden: boolean): Genai.StructuredData.DataModelGraph;
    ...
    withUserOwned(userOwned: boolean): Genai.StructuredData.DataModelGraph;

    /**
     * Fields to ignore when constructing the graph.
     */
    readonly fieldsToIgnore?: Set_Type<string>;
    withFieldsToIgnore(fieldsToIgnore: Set_Type<string> | Array<string> | null): Genai.StructuredData.DataModelGraph;

    /**
     * The {@link File} storing the serialized `networkx.DiGraph` object.
     */
    readonly graphFile?: File;
    withGraphFile(graphFile: IFile | null): Genai.StructuredData.DataModelGraph;

    /**
     * The hash of the string written to #graphFile. Useful to track whether a cached version of the graph is stale.
     */
    readonly graphHash?: string;
    withGraphHash(graphHash: string | null): Genai.StructuredData.DataModelGraph;

    /**
     * Whether or not to include collection fields in the graph (default False).
     */
    readonly includeCollectionFields?: boolean;
    withIncludeCollectionFields(includeCollectionFields: boolean): Genai.StructuredData.DataModelGraph;
     ...
     *     Note that the cached values will not be updated. To do that, use #updateCachedValues.
     */
    readonly numExampleValues?: number;
    withNumExampleValues(numExampleValues: number | null): Genai.StructuredData.DataModelGraph;
     ...
     * ```
     */
    readonly whitelistedDataModel?: any;
    withWhitelistedDataModel(whitelistedDataModel: any | null): Genai.StructuredData.DataModelGraph;
     ...
     *               fields: {FIELD_NAME: NEW_DOCSTRING}}}
     */
    readonly overrideDocumentation?: any;
    withOverrideDocumentation(overrideDocumentation: any | null): Genai.StructuredData.DataModelGraph;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.StructuredData.DataModelGraph | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.StructuredData.DataModelGraph | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.StructuredData.DataModelGraph | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.StructuredData.DataModelGraph | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.StructuredData.DataModelGraph;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.StructuredData.DataModelGraph;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.StructuredData.DataModelGraph;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.StructuredData.DataModelGraph>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.StructuredData.DataModelGraph>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.StructuredData.DataModelGraph;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.StructuredData.DataModelGraph;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.StructuredData.DataModelGraph;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.StructuredData.DataModelGraph;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.StructuredData.DataModelGraph;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.StructuredData.DataModelGraph;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.StructuredData.DataModelGraph;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.StructuredData.DataModelGraph;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.StructuredData.DataModelGraph;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.StructuredData.DataModelGraph;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.StructuredData.DataModelGraph;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.StructuredData.DataModelGraph;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.StructuredData.DataModelGraph;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.StructuredData.DataModelGraph;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.StructuredData.DataModelGraph;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.StructuredData.DataModelGraph;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.StructuredData.DataModelGraph;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.StructuredData.DataModelGraph;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.StructuredData.DataModelGraph;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.StructuredData.DataModelGraph;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.StructuredData.DataModelGraph;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.StructuredData.DataModelGraph;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.StructuredData.DataModelGraph;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.StructuredData.DataModelGraph;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.StructuredData.DataModelGraph;

    mergeJson(json: any): Genai.StructuredData.DataModelGraph;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.StructuredData.DataModelGraph;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.StructuredData.DataModelGraph;
     ...
     */
    singletonArray(): Array_Type<Genai.StructuredData.DataModelGraph>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.StructuredData.DataModelGraph> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.StructuredData.DataModelGraph> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.StructuredData.DataModelGraph>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.StructuredData.DataModelGraph> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.StructuredData.DataModelGraph> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.StructuredData.DataModelGraph> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.StructuredData.DataModelGraph>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.StructuredData.DataModelGraph>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.StructuredData.DataModelGraph;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.StructuredData.DataModelGraph;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.StructuredData.DataModelGraph;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.StructuredData.DataModelGraph;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.StructuredData.DataModelGraph;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.StructuredData.DataModelGraph;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.StructuredData.DataModelGraph | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.StructuredData.DataModelGraph;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.StructuredData.DataModelGraph;
     ...
     */
    static cachedEmptyInst(): Genai.StructuredData.DataModelGraph;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.StructuredData.DataModelGraph> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.StructuredData.DataModelGraph;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.StructuredData.DataModelGraph | null;
     ...
     */
    static forName(name: string, failIfMissing?: boolean): Genai.StructuredData.DataModelGraph | null;
     ...
     */
    static allCached(): Stream<Genai.StructuredData.DataModelGraph> | null;
     ...
     */
    static find(filter?: string): Stream<Genai.StructuredData.DataModelGraph> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<Genai.StructuredData.DataModelGraph> | null;

    /**
     * @return cached instance.
     */
    getCached(): Genai.StructuredData.DataModelGraph | null;

    /**
     * @return cached instance by the key.
     */
    static forCacheKey(key: string): Genai.StructuredData.DataModelGraph | null;
     ...
     */
    static produce(key: string): Genai.StructuredData.DataModelGraph | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, Genai.StructuredData.DataModelGraph> | null;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Genai.StructuredData.DataModelGraph>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Genai.StructuredData.DataModelGraph>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Genai.StructuredData.DataModelGraph> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Genai.StructuredData.DataModelGraph>> | null;
     ...
     */
    get(include?: string): Genai.StructuredData.DataModelGraph | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Genai.StructuredData.DataModelGraph | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Genai.StructuredData.DataModelGraph;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Genai.StructuredData.DataModelGraph | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Genai.StructuredData.DataModelGraph;
     ...
     */
    create(spec?: UpsertSpec): Genai.StructuredData.DataModelGraph | null;
     ...
     */
    static createBatch(objs: Array_Type<Genai.StructuredData.DataModelGraph>, spec?: UpsertSpec): ObjList<Genai.StructuredData.DataModelGraph> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Genai.StructuredData.DataModelGraph>, spec?: CreateBatchObjStreamSpec): ObjList<Genai.StructuredData.DataModelGraph> | null;
     ...
     */
    update(srcObj?: Genai.StructuredData.DataModelGraph, spec?: UpsertSpec): Genai.StructuredData.DataModelGraph | null;
     ...
     */
    upsert(srcObj?: Genai.StructuredData.DataModelGraph, spec?: UpsertSpec): Genai.StructuredData.DataModelGraph | null;
     ...
     */
    merge(spec?: MergeSpec): Genai.StructuredData.DataModelGraph | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Genai.StructuredData.DataModelGraph | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Genai.StructuredData.DataModelGraph | null;
     ...
     */
    static updateBatch(objs: Array_Type<Genai.StructuredData.DataModelGraph>, srcObjs?: Array_Type<Genai.StructuredData.DataModelGraph>, spec?: UpsertSpec): ObjList<Genai.StructuredData.DataModelGraph> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Genai.StructuredData.DataModelGraph> | null>, spec?: UpsertSpec): ObjList<Genai.StructuredData.DataModelGraph> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Genai.StructuredData.DataModelGraph>, srcObjs?: Array_Type<Genai.StructuredData.DataModelGraph>, spec?: UpsertSpec): ObjList<Genai.StructuredData.DataModelGraph> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Genai.StructuredData.DataModelGraph> | null>, spec?: UpsertSpec): ObjList<Genai.StructuredData.DataModelGraph> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Genai.StructuredData.DataModelGraph>, spec?: TouchSpec): ObjList<Genai.StructuredData.DataModelGraph> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.StructuredData.DataModelGraph>, spec?: MergeSpec): ObjList<Genai.StructuredData.DataModelGraph> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.StructuredData.DataModelGraph>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.StructuredData.DataModelGraph> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Genai.StructuredData.DataModelGraph> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.StructuredData.DataModelGraph> | null;
     ...
     */
    static mergeAll(mergeObj: Genai.StructuredData.DataModelGraph, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Genai.StructuredData.DataModelGraph, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Genai.StructuredData.DataModelGraph>, spec?: UpsertSpec): ObjList<Genai.StructuredData.DataModelGraph> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Genai.StructuredData.DataModelGraph>, spec?: UpsertSpec): ObjList<Genai.StructuredData.DataModelGraph> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Genai.StructuredData.DataModelGraph | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Genai.StructuredData.DataModelGraph>): ObjList<Genai.StructuredData.DataModelGraph>;
     ...
     */
    static beforeUpdate(objs: Array_Type<Genai.StructuredData.DataModelGraph>): ObjList<Genai.StructuredData.DataModelGraph>;

    /**
     * Delete the {@link File} containing the serialized `networkx.DiGraph` object before removing the instance.
     */
    static beforeRemove(objs: Array_Type<Genai.StructuredData.DataModelGraph>): ObjList<Genai.StructuredData.DataModelGraph>;
     ...
     */
    static afterCreate(objs: Array_Type<Genai.StructuredData.DataModelGraph>): Array_Type<ObjError> | null;

    /**
     * Create the `networkx.DiGraph` object from the #whitelistedDataModel and serialize it to the #graphFile after
     * persisting the instance.
     */
    static afterUpdate(objs: Array_Type<Genai.StructuredData.DataModelGraph>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Genai.StructuredData.DataModelGraph>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Genai.StructuredData.DataModelGraph>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Genai.StructuredData.DataModelGraph>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.StructuredData.DataModelGraph | null;
     ...
     */
    withoutIdentity(): Genai.StructuredData.DataModelGraph | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Genai.StructuredData.DataModelGraph>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Genai.StructuredData.DataModelGraph, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Genai.StructuredData.DataModelGraph>, callback?: λFunction<Genai.StructuredData.DataModelGraph | null, Genai.StructuredData.DataModelGraph | null>): ObjList<Genai.StructuredData.DataModelGraph>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Genai.StructuredData.DataModelGraph>, callback?: λFunction<Genai.StructuredData.DataModelGraph | null, Genai.StructuredData.DataModelGraph | null>): Array_Type<ObjError> | null;
     ...
     */
    publish(subPath?: string, contentType?: string): Genai.StructuredData.DataModelGraph;
     ...
     */
    static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<Genai.StructuredData.DataModelGraph> | null;
     ...
     */
    createSeedData(spec?: UpsertSpec): Genai.StructuredData.DataModelGraph | null;
     ...
     */
    static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<Genai.StructuredData.DataModelGraph> | null;
     ...
     */
    updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): Genai.StructuredData.DataModelGraph | null;
     ...
     */
    static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<Genai.StructuredData.DataModelGraph> | null;
     ...
     * @return updated obj instance, same as {@link Persistable#update} return value.
     */
    clearUserUpdates(spec?: MergeSpec): Genai.StructuredData.DataModelGraph | null;
     ...
     *         {@link Persistable#updateBatch}.
     */
    static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<Genai.StructuredData.DataModelGraph> | null;
    ...
    dependencies(): SeedDataDeps<Genai.StructuredData.DataModelGraph> | null;
     ...
     */
    updateCachedValues(): Genai.StructuredData.DataModelGraph;
     ...
     */
    buildDataModelDocumentation(excludeDocumentation?: boolean, nExampleStringValues?: number = '0'): string;
     ...
     * @return The generated documentation as a string.
     */
    static buildDataModelDocumentationFromNative(graph: any, excludeDocumentation?: boolean, overrideDocs?: any, nExampleStringValues?: number = '0'): string;
     ...
     */
    findReachableFields(srcType: string, depthLimit?: number = '3'): Array_Type<Set_Type<string>>;
     ...
     */
    static combineDataModelGraphs(dataModelGraphs: Array_Type<Genai.StructuredData.DataModelGraph>, mergedDataModelName?: string): Genai.StructuredData.DataModelGraph;
     ...
     */
    visualize(figsize?: DoublePair, drawKwargs?: Map_Type<string, any>, spiralLayoutLwargs?: Map_Type<string, any>): Image;
     ...
     */
    loadMetricsDocumentationVectorStore(overwriteExisting?: boolean): any;
     ...
     *               fields: {FIELD_NAME: NEW_DOCSTRING}}}
     */
    static buildDataModelWithMetricsDocFromJson(excludeDocumentation?: boolean, metricsByType?: any, overrideDocs?: any): string;
     ...
     *               fields: {FIELD_NAME: NEW_DOCSTRING}}}
     */
    static buildDataModelWithMetricsDocumentation(query: string, nMetricsToRetrieve?: number = '20', excludeDocumentation?: boolean, overrideDocs?: any): string;
     ...
     */
    whiteListedFields(overrideDataModel?: any): any | null;
