// TypeScript definitions for the C3 type Genai.Memory.DynamicAgentFewShot

/**
 * A memory record set by the user to be retrieved for each query.
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.Memory.DynamicAgentFewShot
 */
declare namespace Genai.Memory {
  export interface IDynamicAgentFewShot {
 ...
 */
declare namespace Genai.Memory {
  export class DynamicAgentFewShot extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): Genai.Memory.DynamicAgentFewShot;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Genai.Memory.DynamicAgentFewShot;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): Genai.Memory.DynamicAgentFewShot;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Genai.Memory.DynamicAgentFewShot;
    ...
    withVersion(version: number | null): Genai.Memory.DynamicAgentFewShot;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Genai.Memory.DynamicAgentFewShot;
    ...
    withMemory(memory: string | null): Genai.Memory.DynamicAgentFewShot;
    ...
    withEmbedding(embedding: string): Genai.Memory.DynamicAgentFewShot;
    ...
    withDisplayText(displayText: string): Genai.Memory.DynamicAgentFewShot;
    ...
    withQuery(query: string | null): Genai.Memory.DynamicAgentFewShot;
    ...
    withDescription(description: string | null): Genai.Memory.DynamicAgentFewShot;
    ...
    withSpecialization(specialization: string): Genai.Memory.DynamicAgentFewShot;
    ...
    withProject(project: IGenai.Project | null): Genai.Memory.DynamicAgentFewShot;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.Memory.DynamicAgentFewShot | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.Memory.DynamicAgentFewShot | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.Memory.DynamicAgentFewShot | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.Memory.DynamicAgentFewShot | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.Memory.DynamicAgentFewShot;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Memory.DynamicAgentFewShot;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Memory.DynamicAgentFewShot;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Memory.DynamicAgentFewShot>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Memory.DynamicAgentFewShot>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.Memory.DynamicAgentFewShot;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Memory.DynamicAgentFewShot;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Memory.DynamicAgentFewShot;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.Memory.DynamicAgentFewShot;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.Memory.DynamicAgentFewShot;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.Memory.DynamicAgentFewShot;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.Memory.DynamicAgentFewShot;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.Memory.DynamicAgentFewShot;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.Memory.DynamicAgentFewShot;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.Memory.DynamicAgentFewShot;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.Memory.DynamicAgentFewShot;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.Memory.DynamicAgentFewShot;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.Memory.DynamicAgentFewShot;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.Memory.DynamicAgentFewShot;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.Memory.DynamicAgentFewShot;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.Memory.DynamicAgentFewShot;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.Memory.DynamicAgentFewShot;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.Memory.DynamicAgentFewShot;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.Memory.DynamicAgentFewShot;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.Memory.DynamicAgentFewShot;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.Memory.DynamicAgentFewShot;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.Memory.DynamicAgentFewShot;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.Memory.DynamicAgentFewShot;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.Memory.DynamicAgentFewShot;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.Memory.DynamicAgentFewShot;

    mergeJson(json: any): Genai.Memory.DynamicAgentFewShot;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.Memory.DynamicAgentFewShot;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.Memory.DynamicAgentFewShot;
     ...
     */
    singletonArray(): Array_Type<Genai.Memory.DynamicAgentFewShot>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.Memory.DynamicAgentFewShot> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.Memory.DynamicAgentFewShot> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.Memory.DynamicAgentFewShot>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.Memory.DynamicAgentFewShot> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.Memory.DynamicAgentFewShot> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.Memory.DynamicAgentFewShot> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.Memory.DynamicAgentFewShot>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.Memory.DynamicAgentFewShot>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.Memory.DynamicAgentFewShot;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.Memory.DynamicAgentFewShot;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.Memory.DynamicAgentFewShot;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.Memory.DynamicAgentFewShot;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.Memory.DynamicAgentFewShot;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.Memory.DynamicAgentFewShot;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.Memory.DynamicAgentFewShot | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.Memory.DynamicAgentFewShot;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.Memory.DynamicAgentFewShot;
     ...
     */
    static cachedEmptyInst(): Genai.Memory.DynamicAgentFewShot;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.Memory.DynamicAgentFewShot> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.Memory.DynamicAgentFewShot;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Genai.Memory.DynamicAgentFewShot>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Genai.Memory.DynamicAgentFewShot>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Genai.Memory.DynamicAgentFewShot> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Genai.Memory.DynamicAgentFewShot>> | null;
     ...
     */
    get(include?: string): Genai.Memory.DynamicAgentFewShot | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Genai.Memory.DynamicAgentFewShot | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Genai.Memory.DynamicAgentFewShot;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Genai.Memory.DynamicAgentFewShot | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Genai.Memory.DynamicAgentFewShot;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.Memory.DynamicAgentFewShot | null;
     ...
     */
    create(spec?: UpsertSpec): Genai.Memory.DynamicAgentFewShot | null;
     ...
     */
    static createBatch(objs: Array_Type<Genai.Memory.DynamicAgentFewShot>, spec?: UpsertSpec): ObjList<Genai.Memory.DynamicAgentFewShot> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Genai.Memory.DynamicAgentFewShot>, spec?: CreateBatchObjStreamSpec): ObjList<Genai.Memory.DynamicAgentFewShot> | null;
     ...
     */
    update(srcObj?: Genai.Memory.DynamicAgentFewShot, spec?: UpsertSpec): Genai.Memory.DynamicAgentFewShot | null;
     ...
     */
    upsert(srcObj?: Genai.Memory.DynamicAgentFewShot, spec?: UpsertSpec): Genai.Memory.DynamicAgentFewShot | null;
     ...
     */
    merge(spec?: MergeSpec): Genai.Memory.DynamicAgentFewShot | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Genai.Memory.DynamicAgentFewShot | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Genai.Memory.DynamicAgentFewShot | null;
     ...
     */
    static updateBatch(objs: Array_Type<Genai.Memory.DynamicAgentFewShot>, srcObjs?: Array_Type<Genai.Memory.DynamicAgentFewShot>, spec?: UpsertSpec): ObjList<Genai.Memory.DynamicAgentFewShot> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Genai.Memory.DynamicAgentFewShot> | null>, spec?: UpsertSpec): ObjList<Genai.Memory.DynamicAgentFewShot> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Genai.Memory.DynamicAgentFewShot>, srcObjs?: Array_Type<Genai.Memory.DynamicAgentFewShot>, spec?: UpsertSpec): ObjList<Genai.Memory.DynamicAgentFewShot> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Genai.Memory.DynamicAgentFewShot> | null>, spec?: UpsertSpec): ObjList<Genai.Memory.DynamicAgentFewShot> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Genai.Memory.DynamicAgentFewShot>, spec?: TouchSpec): ObjList<Genai.Memory.DynamicAgentFewShot> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.Memory.DynamicAgentFewShot>, spec?: MergeSpec): ObjList<Genai.Memory.DynamicAgentFewShot> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.Memory.DynamicAgentFewShot>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.Memory.DynamicAgentFewShot> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Genai.Memory.DynamicAgentFewShot> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.Memory.DynamicAgentFewShot> | null;
     ...
     */
    static mergeAll(mergeObj: Genai.Memory.DynamicAgentFewShot, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Genai.Memory.DynamicAgentFewShot, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Genai.Memory.DynamicAgentFewShot>, spec?: UpsertSpec): ObjList<Genai.Memory.DynamicAgentFewShot> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Genai.Memory.DynamicAgentFewShot>, spec?: UpsertSpec): ObjList<Genai.Memory.DynamicAgentFewShot> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Genai.Memory.DynamicAgentFewShot | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Genai.Memory.DynamicAgentFewShot>): ObjList<Genai.Memory.DynamicAgentFewShot>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<Genai.Memory.DynamicAgentFewShot>): ObjList<Genai.Memory.DynamicAgentFewShot>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Genai.Memory.DynamicAgentFewShot>): ObjList<Genai.Memory.DynamicAgentFewShot>;
     ...
     */
    static afterCreate(objs: Array_Type<Genai.Memory.DynamicAgentFewShot>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Genai.Memory.DynamicAgentFewShot>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Genai.Memory.DynamicAgentFewShot>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Genai.Memory.DynamicAgentFewShot>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Genai.Memory.DynamicAgentFewShot>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.Memory.DynamicAgentFewShot | null;
     ...
     */
    withoutIdentity(): Genai.Memory.DynamicAgentFewShot | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Genai.Memory.DynamicAgentFewShot>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Genai.Memory.DynamicAgentFewShot, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Genai.Memory.DynamicAgentFewShot>, callback?: λFunction<Genai.Memory.DynamicAgentFewShot | null, Genai.Memory.DynamicAgentFewShot | null>): ObjList<Genai.Memory.DynamicAgentFewShot>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Genai.Memory.DynamicAgentFewShot>, callback?: λFunction<Genai.Memory.DynamicAgentFewShot | null, Genai.Memory.DynamicAgentFewShot | null>): Array_Type<ObjError> | null;
