// TypeScript definitions for the C3 type Genai.Llm.BatchRequestJob

/**
 * A batch job for generating responses from an LLM.
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.Llm.BatchRequestJob
 */
...
declare namespace Genai.Llm {
  export class BatchRequestJob extends Obj  {
    ...
    withTypeIdent(typeIdent: string | null): Genai.Llm.BatchRequestJob;
     ...
     */
    readonly id: string;
    withId(id: string): Genai.Llm.BatchRequestJob;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Genai.Llm.BatchRequestJob;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): Genai.Llm.BatchRequestJob;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Genai.Llm.BatchRequestJob;
    ...
    withVersion(version: number | null): Genai.Llm.BatchRequestJob;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Genai.Llm.BatchRequestJob;

    /**
     * The prompts passed to the LLM.
     */
    readonly prompts: Array_Type<string>;
    withPrompts(prompts: Array_Type<string> | Array<string>): Genai.Llm.BatchRequestJob;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.Llm.BatchRequestJob | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.Llm.BatchRequestJob | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.Llm.BatchRequestJob | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.Llm.BatchRequestJob | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.Llm.BatchRequestJob;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Llm.BatchRequestJob;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Llm.BatchRequestJob;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Llm.BatchRequestJob>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Llm.BatchRequestJob>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.Llm.BatchRequestJob;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Llm.BatchRequestJob;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Llm.BatchRequestJob;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.Llm.BatchRequestJob;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.Llm.BatchRequestJob;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.Llm.BatchRequestJob;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.Llm.BatchRequestJob;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.Llm.BatchRequestJob;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.Llm.BatchRequestJob;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.Llm.BatchRequestJob;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.Llm.BatchRequestJob;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.Llm.BatchRequestJob;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.Llm.BatchRequestJob;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.Llm.BatchRequestJob;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.Llm.BatchRequestJob;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.Llm.BatchRequestJob;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.Llm.BatchRequestJob;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.Llm.BatchRequestJob;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.Llm.BatchRequestJob;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.Llm.BatchRequestJob;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.Llm.BatchRequestJob;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.Llm.BatchRequestJob;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.Llm.BatchRequestJob;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.Llm.BatchRequestJob;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.Llm.BatchRequestJob;

    mergeJson(json: any): Genai.Llm.BatchRequestJob;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.Llm.BatchRequestJob;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.Llm.BatchRequestJob;
     ...
     */
    singletonArray(): Array_Type<Genai.Llm.BatchRequestJob>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.Llm.BatchRequestJob> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.Llm.BatchRequestJob> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.Llm.BatchRequestJob>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.Llm.BatchRequestJob> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.Llm.BatchRequestJob> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.Llm.BatchRequestJob> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.Llm.BatchRequestJob>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.Llm.BatchRequestJob>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.Llm.BatchRequestJob;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.Llm.BatchRequestJob;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.Llm.BatchRequestJob;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.Llm.BatchRequestJob;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.Llm.BatchRequestJob;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.Llm.BatchRequestJob;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.Llm.BatchRequestJob | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.Llm.BatchRequestJob;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.Llm.BatchRequestJob;
     ...
     */
    static cachedEmptyInst(): Genai.Llm.BatchRequestJob;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.Llm.BatchRequestJob> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.Llm.BatchRequestJob;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Genai.Llm.BatchRequestJob>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Genai.Llm.BatchRequestJob>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Genai.Llm.BatchRequestJob> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Genai.Llm.BatchRequestJob>> | null;
     ...
     */
    get(include?: string): Genai.Llm.BatchRequestJob | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Genai.Llm.BatchRequestJob | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Genai.Llm.BatchRequestJob;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Genai.Llm.BatchRequestJob | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Genai.Llm.BatchRequestJob;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.Llm.BatchRequestJob | null;
     ...
     */
    create(spec?: UpsertSpec): Genai.Llm.BatchRequestJob | null;
     ...
     */
    static createBatch(objs: Array_Type<Genai.Llm.BatchRequestJob>, spec?: UpsertSpec): ObjList<Genai.Llm.BatchRequestJob> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Genai.Llm.BatchRequestJob>, spec?: CreateBatchObjStreamSpec): ObjList<Genai.Llm.BatchRequestJob> | null;
     ...
     */
    update(srcObj?: Genai.Llm.BatchRequestJob, spec?: UpsertSpec): Genai.Llm.BatchRequestJob | null;
     ...
     */
    upsert(srcObj?: Genai.Llm.BatchRequestJob, spec?: UpsertSpec): Genai.Llm.BatchRequestJob | null;
     ...
     */
    merge(spec?: MergeSpec): Genai.Llm.BatchRequestJob | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Genai.Llm.BatchRequestJob | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Genai.Llm.BatchRequestJob | null;
     ...
     */
    static updateBatch(objs: Array_Type<Genai.Llm.BatchRequestJob>, srcObjs?: Array_Type<Genai.Llm.BatchRequestJob>, spec?: UpsertSpec): ObjList<Genai.Llm.BatchRequestJob> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Genai.Llm.BatchRequestJob> | null>, spec?: UpsertSpec): ObjList<Genai.Llm.BatchRequestJob> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Genai.Llm.BatchRequestJob>, srcObjs?: Array_Type<Genai.Llm.BatchRequestJob>, spec?: UpsertSpec): ObjList<Genai.Llm.BatchRequestJob> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Genai.Llm.BatchRequestJob> | null>, spec?: UpsertSpec): ObjList<Genai.Llm.BatchRequestJob> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Genai.Llm.BatchRequestJob>, spec?: TouchSpec): ObjList<Genai.Llm.BatchRequestJob> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.Llm.BatchRequestJob>, spec?: MergeSpec): ObjList<Genai.Llm.BatchRequestJob> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.Llm.BatchRequestJob>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.Llm.BatchRequestJob> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Genai.Llm.BatchRequestJob> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.Llm.BatchRequestJob> | null;
     ...
     */
    static mergeAll(mergeObj: Genai.Llm.BatchRequestJob, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Genai.Llm.BatchRequestJob, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Genai.Llm.BatchRequestJob>, spec?: UpsertSpec): ObjList<Genai.Llm.BatchRequestJob> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Genai.Llm.BatchRequestJob>, spec?: UpsertSpec): ObjList<Genai.Llm.BatchRequestJob> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Genai.Llm.BatchRequestJob | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Genai.Llm.BatchRequestJob>): ObjList<Genai.Llm.BatchRequestJob>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<Genai.Llm.BatchRequestJob>): ObjList<Genai.Llm.BatchRequestJob>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Genai.Llm.BatchRequestJob>): ObjList<Genai.Llm.BatchRequestJob>;
     ...
     */
    static afterCreate(objs: Array_Type<Genai.Llm.BatchRequestJob>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Genai.Llm.BatchRequestJob>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Genai.Llm.BatchRequestJob>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Genai.Llm.BatchRequestJob>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Genai.Llm.BatchRequestJob>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.Llm.BatchRequestJob | null;
     ...
     */
    withoutIdentity(): Genai.Llm.BatchRequestJob | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Genai.Llm.BatchRequestJob>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Genai.Llm.BatchRequestJob, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Genai.Llm.BatchRequestJob>, callback?: λFunction<Genai.Llm.BatchRequestJob | null, Genai.Llm.BatchRequestJob | null>): ObjList<Genai.Llm.BatchRequestJob>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Genai.Llm.BatchRequestJob>, callback?: λFunction<Genai.Llm.BatchRequestJob | null, Genai.Llm.BatchRequestJob | null>): Array_Type<ObjError> | null;
