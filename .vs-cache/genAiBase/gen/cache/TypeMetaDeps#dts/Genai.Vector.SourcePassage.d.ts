// TypeScript definitions for the C3 type Genai.Vector.SourcePassage

/**
 * A Genai.Vector subtype that stores the entire SourcePassage in postgres.
 * Used primarily by {@link Genai.Retriever.PgVector}
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.Vector.SourcePassage
 */
declare namespace Genai.Vector {
  export interface ISourcePassage {
 ...
 */
declare namespace Genai.Vector {
  export class SourcePassage extends Obj  {

    /**
     * The retriever for which this vector was created
     */
    readonly retriever: Genai.Retriever;
    withRetriever(retriever: IGenai.Retriever): Genai.Vector.SourcePassage;

    /**
     * The source from which the passage for the embedding was drawn. Used for filtering on source metadata.
     */
    readonly source?: Genai.Source;
    withSource(source: IGenai.Source | null): Genai.Vector.SourcePassage;

    /**
     * If true, the vector should not be included in searches.
     */
    readonly inactive?: boolean;
    withInactive(inactive: boolean): Genai.Vector.SourcePassage;

    /**
     * The vector embedding.
     */
    readonly emb?: string;
    withEmb(emb: string | null): Genai.Vector.SourcePassage;
    ...
    withTypeIdent(typeIdent: string | null): Genai.Vector.SourcePassage;
     ...
     */
    readonly id: string;
    withId(id: string): Genai.Vector.SourcePassage;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Genai.Vector.SourcePassage;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): Genai.Vector.SourcePassage;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Genai.Vector.SourcePassage;
    ...
    withVersion(version: number | null): Genai.Vector.SourcePassage;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Genai.Vector.SourcePassage;

    /**
     * The passage whose contents are embedded in the vector.
     */
    readonly sourcePassage: Genai.SourcePassage;
    withSourcePassage(sourcePassage: IGenai.SourcePassage): Genai.Vector.SourcePassage;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.Vector.SourcePassage | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.Vector.SourcePassage | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.Vector.SourcePassage | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.Vector.SourcePassage | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.Vector.SourcePassage;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Vector.SourcePassage;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Vector.SourcePassage;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Vector.SourcePassage>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Vector.SourcePassage>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.Vector.SourcePassage;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Vector.SourcePassage;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Vector.SourcePassage;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.Vector.SourcePassage;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.Vector.SourcePassage;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.Vector.SourcePassage;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.Vector.SourcePassage;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.Vector.SourcePassage;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.Vector.SourcePassage;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.Vector.SourcePassage;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.Vector.SourcePassage;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.Vector.SourcePassage;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.Vector.SourcePassage;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.Vector.SourcePassage;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.Vector.SourcePassage;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.Vector.SourcePassage;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.Vector.SourcePassage;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.Vector.SourcePassage;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.Vector.SourcePassage;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.Vector.SourcePassage;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.Vector.SourcePassage;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.Vector.SourcePassage;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.Vector.SourcePassage;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.Vector.SourcePassage;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.Vector.SourcePassage;

    mergeJson(json: any): Genai.Vector.SourcePassage;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.Vector.SourcePassage;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.Vector.SourcePassage;
     ...
     */
    singletonArray(): Array_Type<Genai.Vector.SourcePassage>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.Vector.SourcePassage> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.Vector.SourcePassage> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.Vector.SourcePassage>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.Vector.SourcePassage> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.Vector.SourcePassage> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.Vector.SourcePassage> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.Vector.SourcePassage>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.Vector.SourcePassage>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.Vector.SourcePassage;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.Vector.SourcePassage;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.Vector.SourcePassage;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.Vector.SourcePassage;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.Vector.SourcePassage;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.Vector.SourcePassage;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.Vector.SourcePassage | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.Vector.SourcePassage;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.Vector.SourcePassage;
     ...
     */
    static cachedEmptyInst(): Genai.Vector.SourcePassage;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.Vector.SourcePassage> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.Vector.SourcePassage;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Genai.Vector.SourcePassage>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Genai.Vector.SourcePassage>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Genai.Vector.SourcePassage> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Genai.Vector.SourcePassage>> | null;
     ...
     */
    get(include?: string): Genai.Vector.SourcePassage | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Genai.Vector.SourcePassage | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Genai.Vector.SourcePassage;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Genai.Vector.SourcePassage | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Genai.Vector.SourcePassage;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.Vector.SourcePassage | null;
     ...
     */
    create(spec?: UpsertSpec): Genai.Vector.SourcePassage | null;
     ...
     */
    static createBatch(objs: Array_Type<Genai.Vector.SourcePassage>, spec?: UpsertSpec): ObjList<Genai.Vector.SourcePassage> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Genai.Vector.SourcePassage>, spec?: CreateBatchObjStreamSpec): ObjList<Genai.Vector.SourcePassage> | null;
     ...
     */
    update(srcObj?: Genai.Vector.SourcePassage, spec?: UpsertSpec): Genai.Vector.SourcePassage | null;
     ...
     */
    upsert(srcObj?: Genai.Vector.SourcePassage, spec?: UpsertSpec): Genai.Vector.SourcePassage | null;
     ...
     */
    merge(spec?: MergeSpec): Genai.Vector.SourcePassage | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Genai.Vector.SourcePassage | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Genai.Vector.SourcePassage | null;
     ...
     */
    static updateBatch(objs: Array_Type<Genai.Vector.SourcePassage>, srcObjs?: Array_Type<Genai.Vector.SourcePassage>, spec?: UpsertSpec): ObjList<Genai.Vector.SourcePassage> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Genai.Vector.SourcePassage> | null>, spec?: UpsertSpec): ObjList<Genai.Vector.SourcePassage> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Genai.Vector.SourcePassage>, srcObjs?: Array_Type<Genai.Vector.SourcePassage>, spec?: UpsertSpec): ObjList<Genai.Vector.SourcePassage> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Genai.Vector.SourcePassage> | null>, spec?: UpsertSpec): ObjList<Genai.Vector.SourcePassage> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Genai.Vector.SourcePassage>, spec?: TouchSpec): ObjList<Genai.Vector.SourcePassage> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.Vector.SourcePassage>, spec?: MergeSpec): ObjList<Genai.Vector.SourcePassage> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.Vector.SourcePassage>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.Vector.SourcePassage> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Genai.Vector.SourcePassage> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.Vector.SourcePassage> | null;
     ...
     */
    static mergeAll(mergeObj: Genai.Vector.SourcePassage, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Genai.Vector.SourcePassage, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Genai.Vector.SourcePassage>, spec?: UpsertSpec): ObjList<Genai.Vector.SourcePassage> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Genai.Vector.SourcePassage>, spec?: UpsertSpec): ObjList<Genai.Vector.SourcePassage> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Genai.Vector.SourcePassage | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Genai.Vector.SourcePassage>): ObjList<Genai.Vector.SourcePassage>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<Genai.Vector.SourcePassage>): ObjList<Genai.Vector.SourcePassage>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Genai.Vector.SourcePassage>): ObjList<Genai.Vector.SourcePassage>;
     ...
     */
    static afterCreate(objs: Array_Type<Genai.Vector.SourcePassage>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Genai.Vector.SourcePassage>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Genai.Vector.SourcePassage>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Genai.Vector.SourcePassage>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Genai.Vector.SourcePassage>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.Vector.SourcePassage | null;
     ...
     */
    withoutIdentity(): Genai.Vector.SourcePassage | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Genai.Vector.SourcePassage>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Genai.Vector.SourcePassage, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Genai.Vector.SourcePassage>, callback?: λFunction<Genai.Vector.SourcePassage | null, Genai.Vector.SourcePassage | null>): ObjList<Genai.Vector.SourcePassage>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Genai.Vector.SourcePassage>, callback?: λFunction<Genai.Vector.SourcePassage | null, Genai.Vector.SourcePassage | null>): Array_Type<ObjError> | null;
