// TypeScript definitions for the C3 type Genai.FewShotExample.VariableAssignment

/**
 * Persists few-shot examples for FunctionCallStep execution kwargs with its embedding in pgvector.
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.FewShotExample.VariableAssignment
 */
declare namespace Genai.FewShotExample {
 ...
 */
declare namespace Genai.FewShotExample {
  export class VariableAssignment extends Obj  {
    ...
    withTypeIdent(typeIdent: string | null): Genai.FewShotExample.VariableAssignment;
     ...
     */
    readonly id: string;
    withId(id: string): Genai.FewShotExample.VariableAssignment;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Genai.FewShotExample.VariableAssignment;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): Genai.FewShotExample.VariableAssignment;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Genai.FewShotExample.VariableAssignment;
    ...
    withVersion(version: number | null): Genai.FewShotExample.VariableAssignment;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Genai.FewShotExample.VariableAssignment;

    /**
     * The query associated with the example.
     */
    readonly query: string;
    withQuery(query: string): Genai.FewShotExample.VariableAssignment;

    /**
     * An E5 embedding of the query.
     */
    readonly emb?: string;
    withEmb(emb: string | null): Genai.FewShotExample.VariableAssignment;

    /**
     * Flag indicating if this was added manually or by an automatic process.
     */
    readonly manuallyAdded?: boolean;
    withManuallyAdded(manuallyAdded: boolean): Genai.FewShotExample.VariableAssignment;
    ...
    withProject(project: IGenai.Project | null): Genai.FewShotExample.VariableAssignment;

    /**
     * The {@link User} who created the {@link Genai.FewShotExample}.
     */
    readonly createdBy?: User;
    withCreatedBy(createdBy: IUser | null): Genai.FewShotExample.VariableAssignment;

    /**
     * Keyword arguments to be passed to the tool function during execution.
     */
    readonly executionKwargs: any;
    withExecutionKwargs(executionKwargs: any): Genai.FewShotExample.VariableAssignment;

    /**
     * The name of the tool that this kwargs were used for.
     */
    readonly toolName: string;
    withToolName(toolName: string): Genai.FewShotExample.VariableAssignment;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.FewShotExample.VariableAssignment | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.FewShotExample.VariableAssignment | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.FewShotExample.VariableAssignment | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.FewShotExample.VariableAssignment | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.FewShotExample.VariableAssignment;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.FewShotExample.VariableAssignment;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.FewShotExample.VariableAssignment;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.FewShotExample.VariableAssignment>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.FewShotExample.VariableAssignment>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.FewShotExample.VariableAssignment;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.FewShotExample.VariableAssignment;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.FewShotExample.VariableAssignment;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.FewShotExample.VariableAssignment;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.FewShotExample.VariableAssignment;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.FewShotExample.VariableAssignment;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.FewShotExample.VariableAssignment;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.FewShotExample.VariableAssignment;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.FewShotExample.VariableAssignment;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.FewShotExample.VariableAssignment;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.FewShotExample.VariableAssignment;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.FewShotExample.VariableAssignment;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.FewShotExample.VariableAssignment;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.FewShotExample.VariableAssignment;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.FewShotExample.VariableAssignment;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.FewShotExample.VariableAssignment;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.FewShotExample.VariableAssignment;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.FewShotExample.VariableAssignment;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.FewShotExample.VariableAssignment;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.FewShotExample.VariableAssignment;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.FewShotExample.VariableAssignment;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.FewShotExample.VariableAssignment;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.FewShotExample.VariableAssignment;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.FewShotExample.VariableAssignment;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.FewShotExample.VariableAssignment;

    mergeJson(json: any): Genai.FewShotExample.VariableAssignment;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.FewShotExample.VariableAssignment;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.FewShotExample.VariableAssignment;
     ...
     */
    singletonArray(): Array_Type<Genai.FewShotExample.VariableAssignment>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.FewShotExample.VariableAssignment> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.FewShotExample.VariableAssignment> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.FewShotExample.VariableAssignment>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.FewShotExample.VariableAssignment> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.FewShotExample.VariableAssignment> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.FewShotExample.VariableAssignment> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.FewShotExample.VariableAssignment>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.FewShotExample.VariableAssignment>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.FewShotExample.VariableAssignment;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.FewShotExample.VariableAssignment;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.FewShotExample.VariableAssignment;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.FewShotExample.VariableAssignment;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.FewShotExample.VariableAssignment;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.FewShotExample.VariableAssignment;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.FewShotExample.VariableAssignment | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.FewShotExample.VariableAssignment;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.FewShotExample.VariableAssignment;
     ...
     */
    static cachedEmptyInst(): Genai.FewShotExample.VariableAssignment;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.FewShotExample.VariableAssignment> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.FewShotExample.VariableAssignment;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Genai.FewShotExample.VariableAssignment>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Genai.FewShotExample.VariableAssignment>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Genai.FewShotExample.VariableAssignment> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Genai.FewShotExample.VariableAssignment>> | null;
     ...
     */
    get(include?: string): Genai.FewShotExample.VariableAssignment | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Genai.FewShotExample.VariableAssignment | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Genai.FewShotExample.VariableAssignment;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Genai.FewShotExample.VariableAssignment | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Genai.FewShotExample.VariableAssignment;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.FewShotExample.VariableAssignment | null;
     ...
     */
    create(spec?: UpsertSpec): Genai.FewShotExample.VariableAssignment | null;
     ...
     */
    static createBatch(objs: Array_Type<Genai.FewShotExample.VariableAssignment>, spec?: UpsertSpec): ObjList<Genai.FewShotExample.VariableAssignment> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Genai.FewShotExample.VariableAssignment>, spec?: CreateBatchObjStreamSpec): ObjList<Genai.FewShotExample.VariableAssignment> | null;
     ...
     */
    update(srcObj?: Genai.FewShotExample.VariableAssignment, spec?: UpsertSpec): Genai.FewShotExample.VariableAssignment | null;
     ...
     */
    upsert(srcObj?: Genai.FewShotExample.VariableAssignment, spec?: UpsertSpec): Genai.FewShotExample.VariableAssignment | null;
     ...
     */
    merge(spec?: MergeSpec): Genai.FewShotExample.VariableAssignment | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Genai.FewShotExample.VariableAssignment | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Genai.FewShotExample.VariableAssignment | null;
     ...
     */
    static updateBatch(objs: Array_Type<Genai.FewShotExample.VariableAssignment>, srcObjs?: Array_Type<Genai.FewShotExample.VariableAssignment>, spec?: UpsertSpec): ObjList<Genai.FewShotExample.VariableAssignment> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Genai.FewShotExample.VariableAssignment> | null>, spec?: UpsertSpec): ObjList<Genai.FewShotExample.VariableAssignment> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Genai.FewShotExample.VariableAssignment>, srcObjs?: Array_Type<Genai.FewShotExample.VariableAssignment>, spec?: UpsertSpec): ObjList<Genai.FewShotExample.VariableAssignment> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Genai.FewShotExample.VariableAssignment> | null>, spec?: UpsertSpec): ObjList<Genai.FewShotExample.VariableAssignment> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Genai.FewShotExample.VariableAssignment>, spec?: TouchSpec): ObjList<Genai.FewShotExample.VariableAssignment> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.FewShotExample.VariableAssignment>, spec?: MergeSpec): ObjList<Genai.FewShotExample.VariableAssignment> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.FewShotExample.VariableAssignment>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.FewShotExample.VariableAssignment> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Genai.FewShotExample.VariableAssignment> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.FewShotExample.VariableAssignment> | null;
     ...
     */
    static mergeAll(mergeObj: Genai.FewShotExample.VariableAssignment, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Genai.FewShotExample.VariableAssignment, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Genai.FewShotExample.VariableAssignment>, spec?: UpsertSpec): ObjList<Genai.FewShotExample.VariableAssignment> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Genai.FewShotExample.VariableAssignment>, spec?: UpsertSpec): ObjList<Genai.FewShotExample.VariableAssignment> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Genai.FewShotExample.VariableAssignment | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Genai.FewShotExample.VariableAssignment>): ObjList<Genai.FewShotExample.VariableAssignment>;
     ...
     */
    static beforeUpdate(objs: Array_Type<Genai.FewShotExample.VariableAssignment>): ObjList<Genai.FewShotExample.VariableAssignment>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Genai.FewShotExample.VariableAssignment>): ObjList<Genai.FewShotExample.VariableAssignment>;
     ...
     */
    static afterCreate(objs: Array_Type<Genai.FewShotExample.VariableAssignment>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Genai.FewShotExample.VariableAssignment>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Genai.FewShotExample.VariableAssignment>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Genai.FewShotExample.VariableAssignment>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Genai.FewShotExample.VariableAssignment>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.FewShotExample.VariableAssignment | null;
     ...
     */
    withoutIdentity(): Genai.FewShotExample.VariableAssignment | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Genai.FewShotExample.VariableAssignment>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Genai.FewShotExample.VariableAssignment, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Genai.FewShotExample.VariableAssignment>, callback?: λFunction<Genai.FewShotExample.VariableAssignment | null, Genai.FewShotExample.VariableAssignment | null>): ObjList<Genai.FewShotExample.VariableAssignment>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Genai.FewShotExample.VariableAssignment>, callback?: λFunction<Genai.FewShotExample.VariableAssignment | null, Genai.FewShotExample.VariableAssignment | null>): Array_Type<ObjError> | null;
     ...
     */
    static addEmbeddingsForQueries(objs: Array_Type<Genai.FewShotExample>, queries: Array_Type<string>): ObjList<Genai.FewShotExample.VariableAssignment>;
  }
}
