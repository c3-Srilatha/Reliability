// TypeScript definitions for the C3 type Genai.Retriever

/**
 * A {@link Genai.Retriever} that holds the index of the emebeddings and supports searching for similar passages.
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.Retriever
 */
 ...
 * A {@link Genai.Retriever} that holds the index of the emebeddings and supports searching for similar passages.
 *
 * @remarks this represents a made instance of Genai.Retriever
 */
declare namespace Genai {
  export class Retriever extends Obj  {
    ...
    withTypeIdent(typeIdent: string | null): Genai.Retriever;
     ...
     */
    readonly id: string;
    withId(id: string): Genai.Retriever;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Genai.Retriever;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): Genai.Retriever;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Genai.Retriever;
    ...
    withVersion(version: number | null): Genai.Retriever;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Genai.Retriever;

    /**
     * All of the index actions dispatched asynchronously for this retriever
     */
    readonly indexActions?: Array_Type<Genai.Retriever.IndexAction>;
    withIndexActions(indexActions: Array_Type<Genai.Retriever.IndexAction> | Array<IGenai.Retriever.IndexAction> | null): Genai.Retriever;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.Retriever | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.Retriever | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.Retriever | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.Retriever | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.Retriever;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Retriever;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Retriever;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Retriever>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Retriever>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.Retriever;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Retriever;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Retriever;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.Retriever;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.Retriever;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.Retriever;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.Retriever;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.Retriever;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.Retriever;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.Retriever;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.Retriever;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.Retriever;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.Retriever;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.Retriever;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.Retriever;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.Retriever;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.Retriever;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.Retriever;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.Retriever;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.Retriever;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.Retriever;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.Retriever;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.Retriever;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.Retriever;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.Retriever;

    mergeJson(json: any): Genai.Retriever;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.Retriever;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.Retriever;
     ...
     */
    singletonArray(): Array_Type<Genai.Retriever>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.Retriever> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.Retriever> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.Retriever>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.Retriever> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.Retriever> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.Retriever> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.Retriever>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.Retriever>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.Retriever;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.Retriever;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.Retriever;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.Retriever;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.Retriever;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.Retriever;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.Retriever | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.Retriever;
     ...
     */
    static cachedEmptyInst(): Genai.Retriever;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.Retriever> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.Retriever;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Genai.Retriever>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Genai.Retriever>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Genai.Retriever> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Genai.Retriever>> | null;
     ...
     */
    get(include?: string): Genai.Retriever | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Genai.Retriever | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Genai.Retriever;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Genai.Retriever | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Genai.Retriever;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.Retriever | null;
     ...
     */
    create(spec?: UpsertSpec): Genai.Retriever | null;
     ...
     */
    static createBatch(objs: Array_Type<Genai.Retriever>, spec?: UpsertSpec): ObjList<Genai.Retriever> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Genai.Retriever>, spec?: CreateBatchObjStreamSpec): ObjList<Genai.Retriever> | null;
     ...
     */
    update(srcObj?: Genai.Retriever, spec?: UpsertSpec): Genai.Retriever | null;
     ...
     */
    upsert(srcObj?: Genai.Retriever, spec?: UpsertSpec): Genai.Retriever | null;
     ...
     */
    merge(spec?: MergeSpec): Genai.Retriever | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Genai.Retriever | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Genai.Retriever | null;
     ...
     */
    static updateBatch(objs: Array_Type<Genai.Retriever>, srcObjs?: Array_Type<Genai.Retriever>, spec?: UpsertSpec): ObjList<Genai.Retriever> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Genai.Retriever> | null>, spec?: UpsertSpec): ObjList<Genai.Retriever> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Genai.Retriever>, srcObjs?: Array_Type<Genai.Retriever>, spec?: UpsertSpec): ObjList<Genai.Retriever> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Genai.Retriever> | null>, spec?: UpsertSpec): ObjList<Genai.Retriever> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Genai.Retriever>, spec?: TouchSpec): ObjList<Genai.Retriever> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.Retriever>, spec?: MergeSpec): ObjList<Genai.Retriever> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.Retriever>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.Retriever> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Genai.Retriever> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.Retriever> | null;
     ...
     */
    static mergeAll(mergeObj: Genai.Retriever, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Genai.Retriever, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Genai.Retriever>, spec?: UpsertSpec): ObjList<Genai.Retriever> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Genai.Retriever>, spec?: UpsertSpec): ObjList<Genai.Retriever> | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Genai.Retriever>): ObjList<Genai.Retriever>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<Genai.Retriever>): ObjList<Genai.Retriever>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Genai.Retriever>): ObjList<Genai.Retriever>;
     ...
     */
    static afterCreate(objs: Array_Type<Genai.Retriever>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Genai.Retriever>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Genai.Retriever>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Genai.Retriever>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Genai.Retriever>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.Retriever | null;
     ...
     */
    withoutIdentity(): Genai.Retriever | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Genai.Retriever>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Genai.Retriever, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Genai.Retriever>, callback?: λFunction<Genai.Retriever | null, Genai.Retriever | null>): ObjList<Genai.Retriever>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Genai.Retriever>, callback?: λFunction<Genai.Retriever | null, Genai.Retriever | null>): Array_Type<ObjError> | null;
