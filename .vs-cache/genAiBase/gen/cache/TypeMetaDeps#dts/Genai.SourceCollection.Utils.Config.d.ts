// TypeScript definitions for the C3 type Genai.SourceCollection.Utils.Config

/**
 * Configuration for functionality inside {@link Genai.SourceCollection.Utils}.
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.SourceCollection.Utils.Config
 */
declare namespace Genai.SourceCollection.Utils {
...
declare namespace Genai.SourceCollection.Utils {
  export class Config extends Obj  {
    ...
    withConfigOverride(configOverride: string | null): Genai.SourceCollection.Utils.Config;

    static readonly configOverride?: string;

    readonly secretOverride?: string;
    withSecretOverride(secretOverride: string | null): Genai.SourceCollection.Utils.Config;
    ...
    withIssues(issues: Array_Type<string> | Array<string> | null): Genai.SourceCollection.Utils.Config;
     ...
     * unindexing of files.
     */
    readonly jobWaitDuration: Duration;
    withJobWaitDuration(jobWaitDuration: IDuration): Genai.SourceCollection.Utils.Config;
     ...
     * unindexing of files.
     */
    static readonly jobWaitDuration: Duration;

    /**
     * Default {@link Genai.SourceCollection} for files uploaded on Documents Page.
     */
    readonly defaultCollection?: Genai.SourceCollection;
    withDefaultCollection(defaultCollection: IGenai.SourceCollection | null): Genai.SourceCollection.Utils.Config;

    /**
     * Default {@link Genai.SourceCollection} for files uploaded on Documents Page.
     */
    static readonly defaultCollection?: Genai.SourceCollection;

    /**
     * @return the one and only instance to be used when member functions are called on this type.
     */
    static inst(): Genai.SourceCollection.Utils.Config;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.SourceCollection.Utils.Config | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.SourceCollection.Utils.Config | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.SourceCollection.Utils.Config | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.SourceCollection.Utils.Config | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.SourceCollection.Utils.Config;
     ...
     * This method is used during live metadata update
     */
    static replaceType(old: Type, new_: Type): Genai.SourceCollection.Utils.Config;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.SourceCollection.Utils.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.SourceCollection.Utils.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.SourceCollection.Utils.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.SourceCollection.Utils.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.SourceCollection.Utils.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.SourceCollection.Utils.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.SourceCollection.Utils.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.SourceCollection.Utils.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.SourceCollection.Utils.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.SourceCollection.Utils.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.SourceCollection.Utils.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.SourceCollection.Utils.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.SourceCollection.Utils.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.SourceCollection.Utils.Config;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.SourceCollection.Utils.Config;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    static validateObj(): Genai.SourceCollection.Utils.Config;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.SourceCollection.Utils.Config;
     ...
     * @see #defaultField
     */
    static withField(field: string, value: any, doNotConvert?: boolean): Genai.SourceCollection.Utils.Config;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.SourceCollection.Utils.Config;
     ...
     * @see #defaultField
     */
    static withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.SourceCollection.Utils.Config;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.SourceCollection.Utils.Config;
     ...
     * @return new Obj
     */
    static withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.SourceCollection.Utils.Config;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.SourceCollection.Utils.Config;
     ...
     * @return new Obj
     */
    static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.SourceCollection.Utils.Config;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.SourceCollection.Utils.Config;
     ...
     * @see #withoutField
     */
    static withoutFieldAtPath(path: string): Genai.SourceCollection.Utils.Config;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.SourceCollection.Utils.Config;
     ...
     * @see #removeField
     */
    static withoutField(field: string): Genai.SourceCollection.Utils.Config;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.SourceCollection.Utils.Config;
     ...
     * @see #removeField
     */
    static withoutField(field: FieldType): Genai.SourceCollection.Utils.Config;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.SourceCollection.Utils.Config;
     ...
     * @return new Obj with removed fields
     */
    static withoutFields(fields: Array_Type<string>): Genai.SourceCollection.Utils.Config;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.SourceCollection.Utils.Config;
     ...
     * @return new Obj with removed fields
     */
    static withoutFieldsByType(fields: Array_Type<FieldType>): Genai.SourceCollection.Utils.Config;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.SourceCollection.Utils.Config;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    static withoutSecretFields(): Genai.SourceCollection.Utils.Config;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.SourceCollection.Utils.Config;
     ...
     * @see FieldType#defaultValue
     */
    static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.SourceCollection.Utils.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.SourceCollection.Utils.Config;
     ...
     * @see #unsetField
     */
    static defaultField(field: string): Genai.SourceCollection.Utils.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.SourceCollection.Utils.Config;
     ...
     * @see #unsetField
     */
    static defaultField(field: FieldType): Genai.SourceCollection.Utils.Config;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.SourceCollection.Utils.Config;
     ...
     * @see #removeField
     */
    static unsetField(field: string): Genai.SourceCollection.Utils.Config;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.SourceCollection.Utils.Config;
     ...
     * @see #removeField
     */
    static unsetField(field: FieldType): Genai.SourceCollection.Utils.Config;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.SourceCollection.Utils.Config;
     ...
     * @see #unsetField
     */
    static removeField(field: string): Genai.SourceCollection.Utils.Config;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.SourceCollection.Utils.Config;
     ...
     * @see #unsetField
     */
    static removeField(field: FieldType): Genai.SourceCollection.Utils.Config;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.SourceCollection.Utils.Config;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.SourceCollection.Utils.Config;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.SourceCollection.Utils.Config;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj, otherFieldsFilter: Type): Genai.SourceCollection.Utils.Config;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.SourceCollection.Utils.Config;
     ...
     *        the same key or index.
     */
    static mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.SourceCollection.Utils.Config;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.SourceCollection.Utils.Config;
     ...
     * traverse child reference and collection fields.
     */
    static mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.SourceCollection.Utils.Config;

    mergeJson(json: any): Genai.SourceCollection.Utils.Config;

    static mergeJson(json: any): Genai.SourceCollection.Utils.Config;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.SourceCollection.Utils.Config;
     ...
     * @return Obj with child references merged
     */
    static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.SourceCollection.Utils.Config;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.SourceCollection.Utils.Config;
     ...
     * references with same name and collection elements at same index or key.
     */
    static sumObj(other: Obj, deep?: boolean): Genai.SourceCollection.Utils.Config;
     ...
     */
    singletonArray(): Array_Type<Genai.SourceCollection.Utils.Config>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonArray(): Array_Type<Genai.SourceCollection.Utils.Config>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.SourceCollection.Utils.Config> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.SourceCollection.Utils.Config> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.SourceCollection.Utils.Config>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonSet(): Set_Type<Genai.SourceCollection.Utils.Config>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.SourceCollection.Utils.Config> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.SourceCollection.Utils.Config> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.SourceCollection.Utils.Config> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.SourceCollection.Utils.Config>;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    static toBuilder(): ObjBuilder<Genai.SourceCollection.Utils.Config>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.SourceCollection.Utils.Config>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.SourceCollection.Utils.Config;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.SourceCollection.Utils.Config;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.SourceCollection.Utils.Config;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.SourceCollection.Utils.Config;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.SourceCollection.Utils.Config;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.SourceCollection.Utils.Config;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.SourceCollection.Utils.Config;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.SourceCollection.Utils.Config;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    static afterMake(): Genai.SourceCollection.Utils.Config;
     ...
     */
    static cachedEmptyInst(): Genai.SourceCollection.Utils.Config;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.SourceCollection.Utils.Config> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.SourceCollection.Utils.Config;
     ...
     */
    static allCached(): Stream<Genai.SourceCollection.Utils.Config> | null;
     ...
     */
    static find(filter?: string): Stream<Genai.SourceCollection.Utils.Config> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<Genai.SourceCollection.Utils.Config> | null;

    /**
     * @return cached instance.
     */
    getCached(): Genai.SourceCollection.Utils.Config | null;

    /**
     * @return cached instance.
     */
    static getCached(): Genai.SourceCollection.Utils.Config | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string): Genai.SourceCollection.Utils.Config | null;
     ...
     */
    static produce(key: string): Genai.SourceCollection.Utils.Config | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, Genai.SourceCollection.Utils.Config> | null;
     ...
     */
    getConfig(): Genai.SourceCollection.Utils.Config;
     ...
     * Note that typical pattern is to use Configurable#config instead of this method.
     */
    static getConfig(): Genai.SourceCollection.Utils.Config;
     ...
     */
    getSecret(): Genai.SourceCollection.Utils.Config;
     ...
     * Note that typical pattern is to use Configurable#configWithSecrets instead of this method.
     */
    static getSecret(): Genai.SourceCollection.Utils.Config;
     ...
     */
    withConfigKey(configKey: string): Genai.SourceCollection.Utils.Config;
     ...
     *     config.configKey() => "folder1/abc"
     */
    static withConfigKey(configKey: string): Genai.SourceCollection.Utils.Config;

    /**
     * @return copy without config key.
     */
    withoutConfigKey(): Genai.SourceCollection.Utils.Config;

    /**
     * @return copy without config key.
     */
    static withoutConfigKey(): Genai.SourceCollection.Utils.Config;

    /**
     * @return return cached config instance for provided config key.
     */
    static forConfigKey(configKey: string): Genai.SourceCollection.Utils.Config | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string>): Stream<Genai.SourceCollection.Utils.Config> | null;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: Genai.SourceCollection.Utils.Config, override?: string): void;
     ...
     * @see setConfigValue
     */
    static setConfigValues(from: Genai.SourceCollection.Utils.Config, override?: string): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): Genai.SourceCollection.Utils.Config | null;
     ...
     */
    removeSecrets(): Genai.SourceCollection.Utils.Config | null;

    /**
     * @return this config without any secret values.
     */
    static removeSecrets(): Genai.SourceCollection.Utils.Config | null;

    /**
     * @return this config with only secret values.
     */
    removeNonSecrets(): Genai.SourceCollection.Utils.Config | null;

    /**
     * @return this config with only secret values.
     */
    static removeNonSecrets(): Genai.SourceCollection.Utils.Config | null;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    validate(): Genai.SourceCollection.Utils.Config;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    static validate(): Genai.SourceCollection.Utils.Config;
