// TypeScript definitions for the C3 type Genai.TestLlmConfig

/**
 * This type is only used for testing purposes.
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.TestLlmConfig
 */
declare namespace Genai {
  export interface ITestLlmConfig {
 ...
 * This type is only used for testing purposes.
 *
 * @remarks this represents a made instance of Genai.TestLlmConfig
 */
declare namespace Genai {
  export class TestLlmConfig extends Obj  {

    /**
     * The unique and required name of this instance.
     */
    readonly name: string;
    withName(name: string): Genai.TestLlmConfig;
    ...
    withConfigOverride(configOverride: string | null): Genai.TestLlmConfig;

    static readonly configOverride?: string;

    readonly secretOverride?: string;
    withSecretOverride(secretOverride: string | null): Genai.TestLlmConfig;
    ...
    withIssues(issues: Array_Type<string> | Array<string> | null): Genai.TestLlmConfig;
    ...
    withMaxBackoffSeconds(maxBackoffSeconds: number | null): Genai.TestLlmConfig;
    ...
    withMaxRetryCount(maxRetryCount: number | null): Genai.TestLlmConfig;
    ...
    withAlternateCredentials(alternateCredentials: Array_Type<any> | Array<any> | null): Genai.TestLlmConfig;
    ...
    withField1(field1: string): Genai.TestLlmConfig;

    /**
     * Field1 for test.
     */
    static readonly field1: string;

    /**
     * Field2 for test.
     */
    readonly field2: number;
    withField2(field2: number): Genai.TestLlmConfig;

    /**
     * Field2 for test.
     */
    static readonly field2: number;

    /**
     * Field3 for test.
     */
    readonly field3?: string;
    withField3(field3: string | null): Genai.TestLlmConfig;

    /**
     * Field3 for test.
     */
    static readonly field3?: string;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.TestLlmConfig | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.TestLlmConfig | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.TestLlmConfig | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.TestLlmConfig | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.TestLlmConfig;
     ...
     * This method is used during live metadata update
     */
    static replaceType(old: Type, new_: Type): Genai.TestLlmConfig;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.TestLlmConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.TestLlmConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.TestLlmConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.TestLlmConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.TestLlmConfig>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.TestLlmConfig>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.TestLlmConfig>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.TestLlmConfig>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.TestLlmConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.TestLlmConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.TestLlmConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.TestLlmConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.TestLlmConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.TestLlmConfig;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.TestLlmConfig;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    static validateObj(): Genai.TestLlmConfig;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.TestLlmConfig;
     ...
     * @see #defaultField
     */
    static withField(field: string, value: any, doNotConvert?: boolean): Genai.TestLlmConfig;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.TestLlmConfig;
     ...
     * @see #defaultField
     */
    static withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.TestLlmConfig;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.TestLlmConfig;
     ...
     * @return new Obj
     */
    static withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.TestLlmConfig;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.TestLlmConfig;
     ...
     * @return new Obj
     */
    static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.TestLlmConfig;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.TestLlmConfig;
     ...
     * @see #withoutField
     */
    static withoutFieldAtPath(path: string): Genai.TestLlmConfig;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.TestLlmConfig;
     ...
     * @see #removeField
     */
    static withoutField(field: string): Genai.TestLlmConfig;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.TestLlmConfig;
     ...
     * @see #removeField
     */
    static withoutField(field: FieldType): Genai.TestLlmConfig;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.TestLlmConfig;
     ...
     * @return new Obj with removed fields
     */
    static withoutFields(fields: Array_Type<string>): Genai.TestLlmConfig;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.TestLlmConfig;
     ...
     * @return new Obj with removed fields
     */
    static withoutFieldsByType(fields: Array_Type<FieldType>): Genai.TestLlmConfig;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.TestLlmConfig;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    static withoutSecretFields(): Genai.TestLlmConfig;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.TestLlmConfig;
     ...
     * @see FieldType#defaultValue
     */
    static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.TestLlmConfig;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.TestLlmConfig;
     ...
     * @see #unsetField
     */
    static defaultField(field: string): Genai.TestLlmConfig;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.TestLlmConfig;
     ...
     * @see #unsetField
     */
    static defaultField(field: FieldType): Genai.TestLlmConfig;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.TestLlmConfig;
     ...
     * @see #removeField
     */
    static unsetField(field: string): Genai.TestLlmConfig;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.TestLlmConfig;
     ...
     * @see #removeField
     */
    static unsetField(field: FieldType): Genai.TestLlmConfig;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.TestLlmConfig;
     ...
     * @see #unsetField
     */
    static removeField(field: string): Genai.TestLlmConfig;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.TestLlmConfig;
     ...
     * @see #unsetField
     */
    static removeField(field: FieldType): Genai.TestLlmConfig;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.TestLlmConfig;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.TestLlmConfig;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.TestLlmConfig;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj, otherFieldsFilter: Type): Genai.TestLlmConfig;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.TestLlmConfig;
     ...
     *        the same key or index.
     */
    static mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.TestLlmConfig;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.TestLlmConfig;
     ...
     * traverse child reference and collection fields.
     */
    static mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.TestLlmConfig;

    mergeJson(json: any): Genai.TestLlmConfig;

    static mergeJson(json: any): Genai.TestLlmConfig;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.TestLlmConfig;
     ...
     * @return Obj with child references merged
     */
    static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.TestLlmConfig;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.TestLlmConfig;
     ...
     * references with same name and collection elements at same index or key.
     */
    static sumObj(other: Obj, deep?: boolean): Genai.TestLlmConfig;
     ...
     */
    singletonArray(): Array_Type<Genai.TestLlmConfig>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonArray(): Array_Type<Genai.TestLlmConfig>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.TestLlmConfig> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.TestLlmConfig> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.TestLlmConfig>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonSet(): Set_Type<Genai.TestLlmConfig>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.TestLlmConfig> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.TestLlmConfig> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.TestLlmConfig> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.TestLlmConfig>;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    static toBuilder(): ObjBuilder<Genai.TestLlmConfig>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.TestLlmConfig>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.TestLlmConfig;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.TestLlmConfig;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.TestLlmConfig;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.TestLlmConfig;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.TestLlmConfig;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.TestLlmConfig;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.TestLlmConfig | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.TestLlmConfig;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    static afterMake(): Genai.TestLlmConfig;
     ...
     */
    static cachedEmptyInst(): Genai.TestLlmConfig;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.TestLlmConfig> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.TestLlmConfig;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.TestLlmConfig | null;
     ...
     */
    static forName(name: string, failIfMissing?: boolean): Genai.TestLlmConfig | null;
     ...
     */
    static inst(): Genai.TestLlmConfig;
     ...
     */
    static allCached(): Stream<Genai.TestLlmConfig> | null;
     ...
     */
    static find(filter?: string): Stream<Genai.TestLlmConfig> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<Genai.TestLlmConfig> | null;

    /**
     * @return cached instance.
     */
    getCached(): Genai.TestLlmConfig | null;

    /**
     * @return cached instance.
     */
    static getCached(): Genai.TestLlmConfig | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string): Genai.TestLlmConfig | null;
     ...
     */
    static produce(key: string): Genai.TestLlmConfig | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, Genai.TestLlmConfig> | null;
     ...
     * Note that typical pattern is to use Configurable#config instead of this method.
     */
    static getConfig(): Genai.TestLlmConfig;
     ...
     * Note that typical pattern is to use Configurable#configWithSecrets instead of this method.
     */
    static getSecret(): Genai.TestLlmConfig;
     ...
     */
    withConfigKey(configKey: string): Genai.TestLlmConfig;
     ...
     *     config.configKey() => "folder1/abc"
     */
    static withConfigKey(configKey: string): Genai.TestLlmConfig;

    /**
     * @return copy without config key.
     */
    withoutConfigKey(): Genai.TestLlmConfig;

    /**
     * @return copy without config key.
     */
    static withoutConfigKey(): Genai.TestLlmConfig;

    /**
     * @return return cached config instance for provided config key.
     */
    static forConfigKey(configKey: string): Genai.TestLlmConfig | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string>): Stream<Genai.TestLlmConfig> | null;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: Genai.TestLlmConfig, override?: string): void;
     ...
     * @see setConfigValue
     */
    static setConfigValues(from: Genai.TestLlmConfig, override?: string): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): Genai.TestLlmConfig | null;
     ...
     */
    removeSecrets(): Genai.TestLlmConfig | null;

    /**
     * @return this config without any secret values.
     */
    static removeSecrets(): Genai.TestLlmConfig | null;

    /**
     * @return this config with only secret values.
     */
    removeNonSecrets(): Genai.TestLlmConfig | null;

    /**
     * @return this config with only secret values.
     */
    static removeNonSecrets(): Genai.TestLlmConfig | null;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    validate(): Genai.TestLlmConfig;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    static validate(): Genai.TestLlmConfig;
