// TypeScript definitions for the C3 type Genai.Translator.Llm.Config

/**
 * Enter the Type purposes and use cases with code examples.
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.Translator.Llm.Config
 */
declare namespace Genai.Translator.Llm {
  export interface IConfig {
     ...
     */
    detectLanguagePrompt: IGenai.Prompt;

    /**
     * Prompt for translating text
     */
    translateTextPrompt: IGenai.Prompt;
  }
}
...
declare namespace Genai.Translator.Llm {
  export class Config extends Obj  {
    ...
    withName(name: string): Genai.Translator.Llm.Config;

    readonly configOverride?: string;
    withConfigOverride(configOverride: string | null): Genai.Translator.Llm.Config;

    readonly secretOverride?: string;
    withSecretOverride(secretOverride: string | null): Genai.Translator.Llm.Config;

    /**
     * Captures any issues that occurred while deserializing from filesystem
     */
    readonly issues?: Array_Type<string>;
    withIssues(issues: Array_Type<string> | Array<string> | null): Genai.Translator.Llm.Config;

    /**
     * The name of the Llm config to use for translation.
     */
    readonly llmModelName: string;
    withLlmModelName(llmModelName: string): Genai.Translator.Llm.Config;

    /**
     * token limits for Llms
     */
    readonly tokenLimit?: number;
    withTokenLimit(tokenLimit: number | null): Genai.Translator.Llm.Config;

    /**
     * Prompt for detecting language
     */
    readonly detectLanguagePrompt: Genai.Prompt;
    withDetectLanguagePrompt(detectLanguagePrompt: IGenai.Prompt): Genai.Translator.Llm.Config;

    /**
     * Prompt for translating text
     */
    readonly translateTextPrompt: Genai.Prompt;
    withTranslateTextPrompt(translateTextPrompt: IGenai.Prompt): Genai.Translator.Llm.Config;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.Translator.Llm.Config | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.Translator.Llm.Config | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.Translator.Llm.Config | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.Translator.Llm.Config | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.Translator.Llm.Config;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Translator.Llm.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Translator.Llm.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Translator.Llm.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Translator.Llm.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.Translator.Llm.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Translator.Llm.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Translator.Llm.Config;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.Translator.Llm.Config;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.Translator.Llm.Config;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.Translator.Llm.Config;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.Translator.Llm.Config;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.Translator.Llm.Config;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.Translator.Llm.Config;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.Translator.Llm.Config;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.Translator.Llm.Config;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.Translator.Llm.Config;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.Translator.Llm.Config;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.Translator.Llm.Config;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.Translator.Llm.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.Translator.Llm.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.Translator.Llm.Config;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.Translator.Llm.Config;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.Translator.Llm.Config;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.Translator.Llm.Config;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.Translator.Llm.Config;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.Translator.Llm.Config;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.Translator.Llm.Config;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.Translator.Llm.Config;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.Translator.Llm.Config;

    mergeJson(json: any): Genai.Translator.Llm.Config;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.Translator.Llm.Config;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.Translator.Llm.Config;
     ...
     */
    singletonArray(): Array_Type<Genai.Translator.Llm.Config>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.Translator.Llm.Config> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.Translator.Llm.Config> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.Translator.Llm.Config>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.Translator.Llm.Config> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.Translator.Llm.Config> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.Translator.Llm.Config> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.Translator.Llm.Config>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.Translator.Llm.Config>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.Translator.Llm.Config;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.Translator.Llm.Config;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.Translator.Llm.Config;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.Translator.Llm.Config;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.Translator.Llm.Config;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.Translator.Llm.Config;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.Translator.Llm.Config | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.Translator.Llm.Config;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.Translator.Llm.Config;
     ...
     */
    static cachedEmptyInst(): Genai.Translator.Llm.Config;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.Translator.Llm.Config> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.Translator.Llm.Config;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.Translator.Llm.Config | null;
     ...
     */
    static forName(name: string, failIfMissing?: boolean): Genai.Translator.Llm.Config | null;
     ...
     */
    static allCached(): Stream<Genai.Translator.Llm.Config> | null;
     ...
     */
    static find(filter?: string): Stream<Genai.Translator.Llm.Config> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<Genai.Translator.Llm.Config> | null;

    /**
     * @return cached instance.
     */
    getCached(): Genai.Translator.Llm.Config | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string): Genai.Translator.Llm.Config | null;
     ...
     */
    static produce(key: string): Genai.Translator.Llm.Config | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, Genai.Translator.Llm.Config> | null;
     ...
     */
    getConfig(): Genai.Translator.Llm.Config;
     ...
     */
    getSecret(): Genai.Translator.Llm.Config;
     ...
     */
    withConfigKey(configKey: string): Genai.Translator.Llm.Config;

    /**
     * @return copy without config key.
     */
    withoutConfigKey(): Genai.Translator.Llm.Config;

    /**
     * @return return cached config instance for provided config key.
     */
    static forConfigKey(configKey: string): Genai.Translator.Llm.Config | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string>): Stream<Genai.Translator.Llm.Config> | null;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: Genai.Translator.Llm.Config, override?: string): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): Genai.Translator.Llm.Config | null;
