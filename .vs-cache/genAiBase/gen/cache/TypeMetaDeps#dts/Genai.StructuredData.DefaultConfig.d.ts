// TypeScript definitions for the C3 type Genai.StructuredData.DefaultConfig

/**
 * Default Config for {@link Genai.StructuredData.Config}
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.StructuredData.DefaultConfig
 */
declare namespace Genai.StructuredData {
  export interface IDefaultConfig {
     ...
     */
    structuredDataConfigName: string;
  }
}
...
declare namespace Genai.StructuredData {
  export class DefaultConfig extends Obj  {
    ...
    withConfigOverride(configOverride: string | null): Genai.StructuredData.DefaultConfig;

    static readonly configOverride?: string;

    readonly secretOverride?: string;
    withSecretOverride(secretOverride: string | null): Genai.StructuredData.DefaultConfig;
    ...
    withIssues(issues: Array_Type<string> | Array<string> | null): Genai.StructuredData.DefaultConfig;
     ...
     * Name of {@link Genai.StructuredData.Config} that should be used by default.
     */
    readonly structuredDataConfigName: string;
    withStructuredDataConfigName(structuredDataConfigName: string): Genai.StructuredData.DefaultConfig;

    /**
     * Name of {@link Genai.StructuredData.Config} that should be used by default.
     */
    static readonly structuredDataConfigName: string;

    /**
     * @return the one and only instance to be used when member functions are called on this type.
     */
    static inst(): Genai.StructuredData.DefaultConfig;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.StructuredData.DefaultConfig | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.StructuredData.DefaultConfig | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.StructuredData.DefaultConfig | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.StructuredData.DefaultConfig | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.StructuredData.DefaultConfig;
     ...
     * This method is used during live metadata update
     */
    static replaceType(old: Type, new_: Type): Genai.StructuredData.DefaultConfig;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.StructuredData.DefaultConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.StructuredData.DefaultConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.StructuredData.DefaultConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.StructuredData.DefaultConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.StructuredData.DefaultConfig>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.StructuredData.DefaultConfig>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.StructuredData.DefaultConfig>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.StructuredData.DefaultConfig>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.StructuredData.DefaultConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.StructuredData.DefaultConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.StructuredData.DefaultConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.StructuredData.DefaultConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.StructuredData.DefaultConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.StructuredData.DefaultConfig;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.StructuredData.DefaultConfig;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    static validateObj(): Genai.StructuredData.DefaultConfig;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.StructuredData.DefaultConfig;
     ...
     * @see #defaultField
     */
    static withField(field: string, value: any, doNotConvert?: boolean): Genai.StructuredData.DefaultConfig;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.StructuredData.DefaultConfig;
     ...
     * @see #defaultField
     */
    static withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.StructuredData.DefaultConfig;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.StructuredData.DefaultConfig;
     ...
     * @return new Obj
     */
    static withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.StructuredData.DefaultConfig;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.StructuredData.DefaultConfig;
     ...
     * @return new Obj
     */
    static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.StructuredData.DefaultConfig;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.StructuredData.DefaultConfig;
     ...
     * @see #withoutField
     */
    static withoutFieldAtPath(path: string): Genai.StructuredData.DefaultConfig;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.StructuredData.DefaultConfig;
     ...
     * @see #removeField
     */
    static withoutField(field: string): Genai.StructuredData.DefaultConfig;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.StructuredData.DefaultConfig;
     ...
     * @see #removeField
     */
    static withoutField(field: FieldType): Genai.StructuredData.DefaultConfig;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.StructuredData.DefaultConfig;
     ...
     * @return new Obj with removed fields
     */
    static withoutFields(fields: Array_Type<string>): Genai.StructuredData.DefaultConfig;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.StructuredData.DefaultConfig;
     ...
     * @return new Obj with removed fields
     */
    static withoutFieldsByType(fields: Array_Type<FieldType>): Genai.StructuredData.DefaultConfig;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.StructuredData.DefaultConfig;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    static withoutSecretFields(): Genai.StructuredData.DefaultConfig;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.StructuredData.DefaultConfig;
     ...
     * @see FieldType#defaultValue
     */
    static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.StructuredData.DefaultConfig;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.StructuredData.DefaultConfig;
     ...
     * @see #unsetField
     */
    static defaultField(field: string): Genai.StructuredData.DefaultConfig;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.StructuredData.DefaultConfig;
     ...
     * @see #unsetField
     */
    static defaultField(field: FieldType): Genai.StructuredData.DefaultConfig;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.StructuredData.DefaultConfig;
     ...
     * @see #removeField
     */
    static unsetField(field: string): Genai.StructuredData.DefaultConfig;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.StructuredData.DefaultConfig;
     ...
     * @see #removeField
     */
    static unsetField(field: FieldType): Genai.StructuredData.DefaultConfig;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.StructuredData.DefaultConfig;
     ...
     * @see #unsetField
     */
    static removeField(field: string): Genai.StructuredData.DefaultConfig;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.StructuredData.DefaultConfig;
     ...
     * @see #unsetField
     */
    static removeField(field: FieldType): Genai.StructuredData.DefaultConfig;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.StructuredData.DefaultConfig;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.StructuredData.DefaultConfig;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.StructuredData.DefaultConfig;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj, otherFieldsFilter: Type): Genai.StructuredData.DefaultConfig;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.StructuredData.DefaultConfig;
     ...
     *        the same key or index.
     */
    static mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.StructuredData.DefaultConfig;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.StructuredData.DefaultConfig;
     ...
     * traverse child reference and collection fields.
     */
    static mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.StructuredData.DefaultConfig;

    mergeJson(json: any): Genai.StructuredData.DefaultConfig;

    static mergeJson(json: any): Genai.StructuredData.DefaultConfig;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.StructuredData.DefaultConfig;
     ...
     * @return Obj with child references merged
     */
    static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.StructuredData.DefaultConfig;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.StructuredData.DefaultConfig;
     ...
     * references with same name and collection elements at same index or key.
     */
    static sumObj(other: Obj, deep?: boolean): Genai.StructuredData.DefaultConfig;
     ...
     */
    singletonArray(): Array_Type<Genai.StructuredData.DefaultConfig>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonArray(): Array_Type<Genai.StructuredData.DefaultConfig>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.StructuredData.DefaultConfig> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.StructuredData.DefaultConfig> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.StructuredData.DefaultConfig>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonSet(): Set_Type<Genai.StructuredData.DefaultConfig>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.StructuredData.DefaultConfig> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.StructuredData.DefaultConfig> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.StructuredData.DefaultConfig> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.StructuredData.DefaultConfig>;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    static toBuilder(): ObjBuilder<Genai.StructuredData.DefaultConfig>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.StructuredData.DefaultConfig>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.StructuredData.DefaultConfig;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.StructuredData.DefaultConfig;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.StructuredData.DefaultConfig;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.StructuredData.DefaultConfig;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.StructuredData.DefaultConfig;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.StructuredData.DefaultConfig;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.StructuredData.DefaultConfig;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.StructuredData.DefaultConfig;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    static afterMake(): Genai.StructuredData.DefaultConfig;
     ...
     */
    static cachedEmptyInst(): Genai.StructuredData.DefaultConfig;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.StructuredData.DefaultConfig> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.StructuredData.DefaultConfig;
     ...
     */
    static allCached(): Stream<Genai.StructuredData.DefaultConfig> | null;
     ...
     */
    static find(filter?: string): Stream<Genai.StructuredData.DefaultConfig> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<Genai.StructuredData.DefaultConfig> | null;

    /**
     * @return cached instance.
     */
    getCached(): Genai.StructuredData.DefaultConfig | null;

    /**
     * @return cached instance.
     */
    static getCached(): Genai.StructuredData.DefaultConfig | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string): Genai.StructuredData.DefaultConfig | null;
     ...
     */
    static produce(key: string): Genai.StructuredData.DefaultConfig | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, Genai.StructuredData.DefaultConfig> | null;
     ...
     */
    getConfig(): Genai.StructuredData.DefaultConfig;
     ...
     * Note that typical pattern is to use Configurable#config instead of this method.
     */
    static getConfig(): Genai.StructuredData.DefaultConfig;
     ...
     */
    getSecret(): Genai.StructuredData.DefaultConfig;
     ...
     * Note that typical pattern is to use Configurable#configWithSecrets instead of this method.
     */
    static getSecret(): Genai.StructuredData.DefaultConfig;
     ...
     */
    withConfigKey(configKey: string): Genai.StructuredData.DefaultConfig;
     ...
     *     config.configKey() => "folder1/abc"
     */
    static withConfigKey(configKey: string): Genai.StructuredData.DefaultConfig;

    /**
     * @return copy without config key.
     */
    withoutConfigKey(): Genai.StructuredData.DefaultConfig;

    /**
     * @return copy without config key.
     */
    static withoutConfigKey(): Genai.StructuredData.DefaultConfig;

    /**
     * @return return cached config instance for provided config key.
     */
    static forConfigKey(configKey: string): Genai.StructuredData.DefaultConfig | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string>): Stream<Genai.StructuredData.DefaultConfig> | null;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: Genai.StructuredData.DefaultConfig, override?: string): void;
     ...
     * @see setConfigValue
     */
    static setConfigValues(from: Genai.StructuredData.DefaultConfig, override?: string): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): Genai.StructuredData.DefaultConfig | null;
     ...
     */
    removeSecrets(): Genai.StructuredData.DefaultConfig | null;

    /**
     * @return this config without any secret values.
     */
    static removeSecrets(): Genai.StructuredData.DefaultConfig | null;

    /**
     * @return this config with only secret values.
     */
    removeNonSecrets(): Genai.StructuredData.DefaultConfig | null;

    /**
     * @return this config with only secret values.
     */
    static removeNonSecrets(): Genai.StructuredData.DefaultConfig | null;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    validate(): Genai.StructuredData.DefaultConfig;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    static validate(): Genai.StructuredData.DefaultConfig;
