// TypeScript definitions for the C3 type Genai.AircraftMeasurement

/**
 * An aircraft sensor measurement.
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.AircraftMeasurement
 */
declare namespace Genai {
  export interface IAircraftMeasurement {
    ...
    parent: IGenai.AircraftMeasurementSeries;
 ...
 */
declare namespace Genai {
  export class AircraftMeasurement extends Obj  {

    /**
     * start date for the data point
     */
    readonly start: DateTime;
    withStart(start: DateTime | Date | string): Genai.AircraftMeasurement;
    ...
    withOutlierCode(outlierCode: number | null): Genai.AircraftMeasurement;

    /**
     * (Optional) any comments for the data point
     */
    readonly comments?: string;
    withComments(comments: string | null): Genai.AircraftMeasurement;

    /**
     * Denotes if the value is an actual value or an estimated value. default = null (actual value)
     */
    readonly isEstimated?: boolean;
    withIsEstimated(isEstimated: boolean): Genai.AircraftMeasurement;
    ...
    withDataVersion(dataVersion: number | null): Genai.AircraftMeasurement;

    /**
     * Customer specific status code for the data point (may be used to denote data quality)
     */
    readonly statusCode?: string;
    withStatusCode(statusCode: string | null): Genai.AircraftMeasurement;

    /**
     * Partition key Bin separator used to separate partition key from bin id
     */
    readonly PK_BIN_SEPARATOR?: string;
    withPK_BIN_SEPARATOR(PK_BIN_SEPARATOR: string | null): Genai.AircraftMeasurement;

    readonly parent: Genai.AircraftMeasurementSeries;
    withParent(parent: IGenai.AircraftMeasurementSeries): Genai.AircraftMeasurement;
     ...
     */
    readonly id: string;
    withId(id: string): Genai.AircraftMeasurement;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Genai.AircraftMeasurement;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): Genai.AircraftMeasurement;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Genai.AircraftMeasurement;
    ...
    withVersion(version: number | null): Genai.AircraftMeasurement;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Genai.AircraftMeasurement;

    /**
     * The value of the sensor at a specific point in time
     */
    readonly value?: number;
    withValue(value: number | null): Genai.AircraftMeasurement;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.AircraftMeasurement | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.AircraftMeasurement | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.AircraftMeasurement | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.AircraftMeasurement | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.AircraftMeasurement;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.AircraftMeasurement;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.AircraftMeasurement;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.AircraftMeasurement>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.AircraftMeasurement>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.AircraftMeasurement;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.AircraftMeasurement;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.AircraftMeasurement;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.AircraftMeasurement;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.AircraftMeasurement;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.AircraftMeasurement;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.AircraftMeasurement;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.AircraftMeasurement;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.AircraftMeasurement;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.AircraftMeasurement;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.AircraftMeasurement;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.AircraftMeasurement;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.AircraftMeasurement;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.AircraftMeasurement;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.AircraftMeasurement;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.AircraftMeasurement;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.AircraftMeasurement;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.AircraftMeasurement;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.AircraftMeasurement;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.AircraftMeasurement;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.AircraftMeasurement;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.AircraftMeasurement;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.AircraftMeasurement;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.AircraftMeasurement;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.AircraftMeasurement;

    mergeJson(json: any): Genai.AircraftMeasurement;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.AircraftMeasurement;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.AircraftMeasurement;
     ...
     */
    singletonArray(): Array_Type<Genai.AircraftMeasurement>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.AircraftMeasurement> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.AircraftMeasurement> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.AircraftMeasurement>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.AircraftMeasurement> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.AircraftMeasurement> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.AircraftMeasurement> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.AircraftMeasurement>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.AircraftMeasurement>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.AircraftMeasurement;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.AircraftMeasurement;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.AircraftMeasurement;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.AircraftMeasurement;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.AircraftMeasurement;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.AircraftMeasurement;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.AircraftMeasurement | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.AircraftMeasurement;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.AircraftMeasurement;
     ...
     */
    static cachedEmptyInst(): Genai.AircraftMeasurement;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.AircraftMeasurement> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.AircraftMeasurement;

    /**
     * Extract the partition key from the given obj
     */
    partitionKey(failIfMissing?: boolean): Genai.AircraftMeasurementSeries | null;
     ...
     */
    static partition(objs?: Stream<Genai.AircraftMeasurement>, spec?: PartitionBucketStrategy): Map_Type<string, KvDataPartition> | null;
     ...
     */
    static fromPartitions(partitions?: Stream<KvDataPartition>): Stream<Genai.AircraftMeasurement> | null;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Genai.AircraftMeasurement>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Genai.AircraftMeasurement>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Genai.AircraftMeasurement> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Genai.AircraftMeasurement>> | null;
     ...
     */
    get(include?: string): Genai.AircraftMeasurement | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Genai.AircraftMeasurement | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Genai.AircraftMeasurement;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Genai.AircraftMeasurement | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Genai.AircraftMeasurement;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.AircraftMeasurement | null;
     ...
     */
    create(spec?: UpsertSpec): Genai.AircraftMeasurement | null;
     ...
     */
    static createBatch(objs: Array_Type<Genai.AircraftMeasurement>, spec?: UpsertSpec): ObjList<Genai.AircraftMeasurement> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Genai.AircraftMeasurement>, spec?: CreateBatchObjStreamSpec): ObjList<Genai.AircraftMeasurement> | null;
     ...
     */
    update(srcObj?: Genai.AircraftMeasurement, spec?: UpsertSpec): Genai.AircraftMeasurement | null;
     ...
     */
    upsert(srcObj?: Genai.AircraftMeasurement, spec?: UpsertSpec): Genai.AircraftMeasurement | null;
     ...
     */
    merge(spec?: MergeSpec): Genai.AircraftMeasurement | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Genai.AircraftMeasurement | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Genai.AircraftMeasurement | null;
     ...
     */
    static updateBatch(objs: Array_Type<Genai.AircraftMeasurement>, srcObjs?: Array_Type<Genai.AircraftMeasurement>, spec?: UpsertSpec): ObjList<Genai.AircraftMeasurement> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Genai.AircraftMeasurement> | null>, spec?: UpsertSpec): ObjList<Genai.AircraftMeasurement> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Genai.AircraftMeasurement>, srcObjs?: Array_Type<Genai.AircraftMeasurement>, spec?: UpsertSpec): ObjList<Genai.AircraftMeasurement> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Genai.AircraftMeasurement> | null>, spec?: UpsertSpec): ObjList<Genai.AircraftMeasurement> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Genai.AircraftMeasurement>, spec?: TouchSpec): ObjList<Genai.AircraftMeasurement> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.AircraftMeasurement>, spec?: MergeSpec): ObjList<Genai.AircraftMeasurement> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.AircraftMeasurement>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.AircraftMeasurement> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Genai.AircraftMeasurement> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.AircraftMeasurement> | null;
     ...
     */
    static mergeAll(mergeObj: Genai.AircraftMeasurement, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Genai.AircraftMeasurement, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Genai.AircraftMeasurement>, spec?: UpsertSpec): ObjList<Genai.AircraftMeasurement> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Genai.AircraftMeasurement>, spec?: UpsertSpec): ObjList<Genai.AircraftMeasurement> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Genai.AircraftMeasurement | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Genai.AircraftMeasurement>): ObjList<Genai.AircraftMeasurement>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<Genai.AircraftMeasurement>): ObjList<Genai.AircraftMeasurement>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Genai.AircraftMeasurement>): ObjList<Genai.AircraftMeasurement>;
     ...
     */
    static afterCreate(objs: Array_Type<Genai.AircraftMeasurement>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Genai.AircraftMeasurement>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Genai.AircraftMeasurement>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Genai.AircraftMeasurement>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Genai.AircraftMeasurement>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.AircraftMeasurement | null;
     ...
     */
    withoutIdentity(): Genai.AircraftMeasurement | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Genai.AircraftMeasurement>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Genai.AircraftMeasurement, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Genai.AircraftMeasurement>, callback?: λFunction<Genai.AircraftMeasurement | null, Genai.AircraftMeasurement | null>): ObjList<Genai.AircraftMeasurement>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Genai.AircraftMeasurement>, callback?: λFunction<Genai.AircraftMeasurement | null, Genai.AircraftMeasurement | null>): Array_Type<ObjError> | null;
