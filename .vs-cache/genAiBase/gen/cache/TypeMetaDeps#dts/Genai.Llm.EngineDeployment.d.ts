// TypeScript definitions for the C3 type Genai.Llm.EngineDeployment

/**
 * The Engine Deployment for {@link Genai.Llm}.
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.Llm.EngineDeployment
 */
 ...
 * The Engine Deployment for {@link Genai.Llm}.
 *
 * @remarks this represents a made instance of Genai.Llm.EngineDeployment
 */
declare namespace Genai.Llm {
  export class EngineDeployment extends Obj  {
    ...
    withName(name: string): Genai.Llm.EngineDeployment;
    ...
    withNodeRole(nodeRole: string | null): Genai.Llm.EngineDeployment;
    ...
    withAltNodeRoles(altNodeRoles: Array_Type<string> | Array<string> | null): Genai.Llm.EngineDeployment;
    ...
    withNodePools(nodePools: Array_Type<string> | Array<string> | null): Genai.Llm.EngineDeployment;
    ...
    withDedicatedThreadPool(dedicatedThreadPool: boolean): Genai.Llm.EngineDeployment;

    /**
     * If set to `true` then this {@link Engine} will auto start on every node of every target node-pool.
     */
    readonly autoStart?: boolean;
    withAutoStart(autoStart: boolean): Genai.Llm.EngineDeployment;
    ...
    withInactive(inactive: boolean): Genai.Llm.EngineDeployment;
    ...
    withFailActionIfEngineNotReady(failActionIfEngineNotReady: boolean): Genai.Llm.EngineDeployment;
    ...
    withInitializingNodeAvoidanceDuration(initializingNodeAvoidanceDuration: string | null): Genai.Llm.EngineDeployment;

    readonly configOverride?: string;
    withConfigOverride(configOverride: string | null): Genai.Llm.EngineDeployment;

    readonly secretOverride?: string;
    withSecretOverride(secretOverride: string | null): Genai.Llm.EngineDeployment;

    /**
     * Captures any issues that occurred while deserializing from filesystem
     */
    readonly issues?: Array_Type<string>;
    withIssues(issues: Array_Type<string> | Array<string> | null): Genai.Llm.EngineDeployment;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.Llm.EngineDeployment | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.Llm.EngineDeployment | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.Llm.EngineDeployment | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.Llm.EngineDeployment | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.Llm.EngineDeployment;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Llm.EngineDeployment;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Llm.EngineDeployment;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Llm.EngineDeployment>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Llm.EngineDeployment>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.Llm.EngineDeployment;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Llm.EngineDeployment;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Llm.EngineDeployment;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.Llm.EngineDeployment;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.Llm.EngineDeployment;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.Llm.EngineDeployment;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.Llm.EngineDeployment;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.Llm.EngineDeployment;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.Llm.EngineDeployment;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.Llm.EngineDeployment;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.Llm.EngineDeployment;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.Llm.EngineDeployment;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.Llm.EngineDeployment;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.Llm.EngineDeployment;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.Llm.EngineDeployment;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.Llm.EngineDeployment;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.Llm.EngineDeployment;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.Llm.EngineDeployment;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.Llm.EngineDeployment;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.Llm.EngineDeployment;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.Llm.EngineDeployment;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.Llm.EngineDeployment;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.Llm.EngineDeployment;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.Llm.EngineDeployment;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.Llm.EngineDeployment;

    mergeJson(json: any): Genai.Llm.EngineDeployment;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.Llm.EngineDeployment;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.Llm.EngineDeployment;
     ...
     */
    singletonArray(): Array_Type<Genai.Llm.EngineDeployment>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.Llm.EngineDeployment> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.Llm.EngineDeployment> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.Llm.EngineDeployment>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.Llm.EngineDeployment> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.Llm.EngineDeployment> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.Llm.EngineDeployment> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.Llm.EngineDeployment>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.Llm.EngineDeployment>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.Llm.EngineDeployment;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.Llm.EngineDeployment;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.Llm.EngineDeployment;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.Llm.EngineDeployment;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.Llm.EngineDeployment;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.Llm.EngineDeployment;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.Llm.EngineDeployment | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.Llm.EngineDeployment;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.Llm.EngineDeployment;
     ...
     */
    static cachedEmptyInst(): Genai.Llm.EngineDeployment;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.Llm.EngineDeployment> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.Llm.EngineDeployment;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.Llm.EngineDeployment | null;
     ...
     */
    static forName(name: string, failIfMissing?: boolean): Genai.Llm.EngineDeployment | null;
     ...
     */
    static allCached(): Stream<Genai.Llm.EngineDeployment> | null;
     ...
     */
    static find(filter?: string): Stream<Genai.Llm.EngineDeployment> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<Genai.Llm.EngineDeployment> | null;

    /**
     * @return cached instance.
     */
    getCached(): Genai.Llm.EngineDeployment | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string): Genai.Llm.EngineDeployment | null;
     ...
     */
    static produce(key: string): Genai.Llm.EngineDeployment | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, Genai.Llm.EngineDeployment> | null;
     ...
     */
    getConfig(): Genai.Llm.EngineDeployment;
     ...
     */
    getSecret(): Genai.Llm.EngineDeployment;
     ...
     */
    withConfigKey(configKey: string): Genai.Llm.EngineDeployment;

    /**
     * @return copy without config key.
     */
    withoutConfigKey(): Genai.Llm.EngineDeployment;

    /**
     * @return return cached config instance for provided config key.
     */
    static forConfigKey(configKey: string): Genai.Llm.EngineDeployment | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string>): Stream<Genai.Llm.EngineDeployment> | null;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: Genai.Llm.EngineDeployment, override?: string): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): Genai.Llm.EngineDeployment | null;
     ...
     */
    engineType(): Type<<Genai.Llm>> | null;
     ...
     */
    static fromDeploySpec(spec: Engine.DeploySpec): Genai.Llm.EngineDeployment | null;
  }
}
