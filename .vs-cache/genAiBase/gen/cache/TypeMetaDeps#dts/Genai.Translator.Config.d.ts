// TypeScript definitions for the C3 type Genai.Translator.Config

/**
 * Config for the translation service.
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.Translator.Config
 */
declare namespace Genai.Translator {
...
declare namespace Genai.Translator {
  export class Config extends Obj  {
    ...
    withConfigOverride(configOverride: string | null): Genai.Translator.Config;

    static readonly configOverride?: string;

    readonly secretOverride?: string;
    withSecretOverride(secretOverride: string | null): Genai.Translator.Config;
    ...
    withIssues(issues: Array_Type<string> | Array<string> | null): Genai.Translator.Config;
    ...
    withEnabled(enabled: boolean): Genai.Translator.Config;
    ...
    withTranslatorTypeName(translatorTypeName: string | null): Genai.Translator.Config;
    ...
    withLlmConfigName(llmConfigName: string | null): Genai.Translator.Config;
    ...
    withDocumentTranslatorTypeName(documentTranslatorTypeName: string | null): Genai.Translator.Config;
    ...
    withLanguageDetectionHandlerTypeName(languageDetectionHandlerTypeName: string | null): Genai.Translator.Config;
    ...
    withQueryTranslatorTypeName(queryTranslatorTypeName: string | null): Genai.Translator.Config;
    ...
    withSupportedFileTypes(supportedFileTypes: Array_Type<string> | Array<string> | null): Genai.Translator.Config;
    ...
    withUnsupportedLanguageCodes(unsupportedLanguageCodes: Array_Type<string> | Array<string> | null): Genai.Translator.Config;
    ...
    withLanguageConfidenceThreshold(languageConfidenceThreshold: number): Genai.Translator.Config;
     ...
     */
    static inst(): Genai.Translator.Config;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.Translator.Config | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.Translator.Config | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.Translator.Config | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.Translator.Config | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.Translator.Config;
     ...
     * This method is used during live metadata update
     */
    static replaceType(old: Type, new_: Type): Genai.Translator.Config;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Translator.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Translator.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Translator.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Translator.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Translator.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Translator.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Translator.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Translator.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.Translator.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.Translator.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Translator.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Translator.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Translator.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Translator.Config;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.Translator.Config;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    static validateObj(): Genai.Translator.Config;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.Translator.Config;
     ...
     * @see #defaultField
     */
    static withField(field: string, value: any, doNotConvert?: boolean): Genai.Translator.Config;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.Translator.Config;
     ...
     * @see #defaultField
     */
    static withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.Translator.Config;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.Translator.Config;
     ...
     * @return new Obj
     */
    static withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.Translator.Config;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.Translator.Config;
     ...
     * @return new Obj
     */
    static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.Translator.Config;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.Translator.Config;
     ...
     * @see #withoutField
     */
    static withoutFieldAtPath(path: string): Genai.Translator.Config;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.Translator.Config;
     ...
     * @see #removeField
     */
    static withoutField(field: string): Genai.Translator.Config;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.Translator.Config;
     ...
     * @see #removeField
     */
    static withoutField(field: FieldType): Genai.Translator.Config;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.Translator.Config;
     ...
     * @return new Obj with removed fields
     */
    static withoutFields(fields: Array_Type<string>): Genai.Translator.Config;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.Translator.Config;
     ...
     * @return new Obj with removed fields
     */
    static withoutFieldsByType(fields: Array_Type<FieldType>): Genai.Translator.Config;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.Translator.Config;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    static withoutSecretFields(): Genai.Translator.Config;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.Translator.Config;
     ...
     * @see FieldType#defaultValue
     */
    static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.Translator.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.Translator.Config;
     ...
     * @see #unsetField
     */
    static defaultField(field: string): Genai.Translator.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.Translator.Config;
     ...
     * @see #unsetField
     */
    static defaultField(field: FieldType): Genai.Translator.Config;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.Translator.Config;
     ...
     * @see #removeField
     */
    static unsetField(field: string): Genai.Translator.Config;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.Translator.Config;
     ...
     * @see #removeField
     */
    static unsetField(field: FieldType): Genai.Translator.Config;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.Translator.Config;
     ...
     * @see #unsetField
     */
    static removeField(field: string): Genai.Translator.Config;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.Translator.Config;
     ...
     * @see #unsetField
     */
    static removeField(field: FieldType): Genai.Translator.Config;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.Translator.Config;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.Translator.Config;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.Translator.Config;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj, otherFieldsFilter: Type): Genai.Translator.Config;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.Translator.Config;
     ...
     *        the same key or index.
     */
    static mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.Translator.Config;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.Translator.Config;
     ...
     * traverse child reference and collection fields.
     */
    static mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.Translator.Config;

    mergeJson(json: any): Genai.Translator.Config;

    static mergeJson(json: any): Genai.Translator.Config;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.Translator.Config;
     ...
     * @return Obj with child references merged
     */
    static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.Translator.Config;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.Translator.Config;
     ...
     * references with same name and collection elements at same index or key.
     */
    static sumObj(other: Obj, deep?: boolean): Genai.Translator.Config;
     ...
     */
    singletonArray(): Array_Type<Genai.Translator.Config>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonArray(): Array_Type<Genai.Translator.Config>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.Translator.Config> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.Translator.Config> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.Translator.Config>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonSet(): Set_Type<Genai.Translator.Config>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.Translator.Config> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.Translator.Config> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.Translator.Config> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.Translator.Config>;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    static toBuilder(): ObjBuilder<Genai.Translator.Config>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.Translator.Config>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.Translator.Config;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.Translator.Config;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.Translator.Config;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.Translator.Config;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.Translator.Config;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.Translator.Config;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.Translator.Config;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.Translator.Config;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    static afterMake(): Genai.Translator.Config;
     ...
     */
    static cachedEmptyInst(): Genai.Translator.Config;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.Translator.Config> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.Translator.Config;
     ...
     */
    static allCached(): Stream<Genai.Translator.Config> | null;
     ...
     */
    static find(filter?: string): Stream<Genai.Translator.Config> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<Genai.Translator.Config> | null;

    /**
     * @return cached instance.
     */
    getCached(): Genai.Translator.Config | null;

    /**
     * @return cached instance.
     */
    static getCached(): Genai.Translator.Config | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string): Genai.Translator.Config | null;
     ...
     */
    static produce(key: string): Genai.Translator.Config | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, Genai.Translator.Config> | null;
     ...
     */
    getConfig(): Genai.Translator.Config;
     ...
     * Note that typical pattern is to use Configurable#config instead of this method.
     */
    static getConfig(): Genai.Translator.Config;
     ...
     */
    getSecret(): Genai.Translator.Config;
     ...
     * Note that typical pattern is to use Configurable#configWithSecrets instead of this method.
     */
    static getSecret(): Genai.Translator.Config;
     ...
     */
    withConfigKey(configKey: string): Genai.Translator.Config;
     ...
     *     config.configKey() => "folder1/abc"
     */
    static withConfigKey(configKey: string): Genai.Translator.Config;

    /**
     * @return copy without config key.
     */
    withoutConfigKey(): Genai.Translator.Config;

    /**
     * @return copy without config key.
     */
    static withoutConfigKey(): Genai.Translator.Config;

    /**
     * @return return cached config instance for provided config key.
     */
    static forConfigKey(configKey: string): Genai.Translator.Config | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string>): Stream<Genai.Translator.Config> | null;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: Genai.Translator.Config, override?: string): void;
     ...
     * @see setConfigValue
     */
    static setConfigValues(from: Genai.Translator.Config, override?: string): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): Genai.Translator.Config | null;
     ...
     */
    removeSecrets(): Genai.Translator.Config | null;

    /**
     * @return this config without any secret values.
     */
    static removeSecrets(): Genai.Translator.Config | null;

    /**
     * @return this config with only secret values.
     */
    removeNonSecrets(): Genai.Translator.Config | null;

    /**
     * @return this config with only secret values.
     */
    static removeNonSecrets(): Genai.Translator.Config | null;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    validate(): Genai.Translator.Config;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    static validate(): Genai.Translator.Config;
