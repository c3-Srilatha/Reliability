// TypeScript definitions for the C3 type Genai.Agent.Tool.MultiSourceSynthesizer
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.Agent.Tool.MultiSourceSynthesizer
 */
declare namespace Genai.Agent.Tool {
  export interface IMultiSourceSynthesizer {
 ...
 */
declare namespace Genai.Agent.Tool {
  export class MultiSourceSynthesizer extends Obj  {

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Genai.Agent.Tool.MultiSourceSynthesizer;

    /**
     * The unique and required id of this instance.
     */
    readonly id: string;
    withId(id: string): Genai.Agent.Tool.MultiSourceSynthesizer;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.Agent.Tool.MultiSourceSynthesizer | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.Agent.Tool.MultiSourceSynthesizer | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.Agent.Tool.MultiSourceSynthesizer | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.Agent.Tool.MultiSourceSynthesizer | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.Agent.Tool.MultiSourceSynthesizer;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Agent.Tool.MultiSourceSynthesizer;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Agent.Tool.MultiSourceSynthesizer;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Agent.Tool.MultiSourceSynthesizer>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Agent.Tool.MultiSourceSynthesizer>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.Agent.Tool.MultiSourceSynthesizer;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Agent.Tool.MultiSourceSynthesizer;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Agent.Tool.MultiSourceSynthesizer;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.Agent.Tool.MultiSourceSynthesizer;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.Agent.Tool.MultiSourceSynthesizer;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.Agent.Tool.MultiSourceSynthesizer;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.Agent.Tool.MultiSourceSynthesizer;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.Agent.Tool.MultiSourceSynthesizer;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.Agent.Tool.MultiSourceSynthesizer;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.Agent.Tool.MultiSourceSynthesizer;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.Agent.Tool.MultiSourceSynthesizer;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.Agent.Tool.MultiSourceSynthesizer;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.Agent.Tool.MultiSourceSynthesizer;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.Agent.Tool.MultiSourceSynthesizer;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.Agent.Tool.MultiSourceSynthesizer;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.Agent.Tool.MultiSourceSynthesizer;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.Agent.Tool.MultiSourceSynthesizer;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.Agent.Tool.MultiSourceSynthesizer;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.Agent.Tool.MultiSourceSynthesizer;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.Agent.Tool.MultiSourceSynthesizer;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.Agent.Tool.MultiSourceSynthesizer;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.Agent.Tool.MultiSourceSynthesizer;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.Agent.Tool.MultiSourceSynthesizer;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.Agent.Tool.MultiSourceSynthesizer;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.Agent.Tool.MultiSourceSynthesizer;

    mergeJson(json: any): Genai.Agent.Tool.MultiSourceSynthesizer;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.Agent.Tool.MultiSourceSynthesizer;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.Agent.Tool.MultiSourceSynthesizer;
     ...
     */
    singletonArray(): Array_Type<Genai.Agent.Tool.MultiSourceSynthesizer>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.Agent.Tool.MultiSourceSynthesizer> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.Agent.Tool.MultiSourceSynthesizer> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.Agent.Tool.MultiSourceSynthesizer>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.Agent.Tool.MultiSourceSynthesizer> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.Agent.Tool.MultiSourceSynthesizer> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.Agent.Tool.MultiSourceSynthesizer> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.Agent.Tool.MultiSourceSynthesizer>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.Agent.Tool.MultiSourceSynthesizer>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.Agent.Tool.MultiSourceSynthesizer;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.Agent.Tool.MultiSourceSynthesizer;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.Agent.Tool.MultiSourceSynthesizer;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.Agent.Tool.MultiSourceSynthesizer;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.Agent.Tool.MultiSourceSynthesizer;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.Agent.Tool.MultiSourceSynthesizer;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.Agent.Tool.MultiSourceSynthesizer | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.Agent.Tool.MultiSourceSynthesizer;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.Agent.Tool.MultiSourceSynthesizer;
     ...
     */
    static cachedEmptyInst(): Genai.Agent.Tool.MultiSourceSynthesizer;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.Agent.Tool.MultiSourceSynthesizer> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.Agent.Tool.MultiSourceSynthesizer;
     ...
     */
    config(secrets?: boolean): Genai.Agent.Tool.MultiSourceSynthesizer.Config;
     ...
     */
    static typeConfig(): Genai.Agent.Tool.MultiSourceSynthesizer.Config;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Genai.Agent.Tool.MultiSourceSynthesizer>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Genai.Agent.Tool.MultiSourceSynthesizer>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Genai.Agent.Tool.MultiSourceSynthesizer> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Genai.Agent.Tool.MultiSourceSynthesizer>> | null;
     ...
     */
    dependencies(): MetadataDeps<Genai.Agent.Tool.MultiSourceSynthesizer>;

    save(subPath?: string, contentType?: string): Genai.Agent.Tool.MultiSourceSynthesizer;
    ...
    update(srcObj?: Genai.Agent.Tool.MultiSourceSynthesizer, spec?: UpsertSpec): Genai.Agent.Tool.MultiSourceSynthesizer | null;

    upsert(srcObj?: Genai.Agent.Tool.MultiSourceSynthesizer, spec?: UpsertSpec): Genai.Agent.Tool.MultiSourceSynthesizer | null;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.Agent.Tool.MultiSourceSynthesizer | null;

    /**
     * @return single instance of this Identified type by id.
     */
    static forId(id: string, failIfMissing?: boolean): Genai.Agent.Tool.MultiSourceSynthesizer | null;
     ...
     */
    static ensureId(tool: Genai.Agent.Tool<any>): Genai.Agent.Tool.MultiSourceSynthesizer;
