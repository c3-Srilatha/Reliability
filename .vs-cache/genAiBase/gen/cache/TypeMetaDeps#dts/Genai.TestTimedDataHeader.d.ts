// TypeScript definitions for the C3 type Genai.TestTimedDataHeader

/**
 * Test type used for explicitly testing `load_metric_documentation_vectorstore.py` when a type has inherited fields.
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.TestTimedDataHeader
 */
declare namespace Genai {
  export interface ITestTimedDataHeader {
     ...
     */
    data?: Array_Type<Genai.TestTimedDataPoint> | Array<IGenai.TestTimedDataPoint>;
     ...
     */
    declaredData?: Array_Type<Genai.TestTimedDataPoint> | Array<IGenai.TestTimedDataPoint>;
  }
}
 ...
 */
declare namespace Genai {
  export class TestTimedDataHeader extends Obj  {

    /**
     * Populated on normalization. Indicates the earliest data point across various timeseries fields.
     */
    readonly earliest?: DateTime;
    withEarliest(earliest: DateTime | Date | string | null): Genai.TestTimedDataHeader;

    /**
     * Populated on normalization. Indicates the latest data point across various timeseries fields.
     */
    readonly latest?: DateTime;
    withLatest(latest: DateTime | Date | string | null): Genai.TestTimedDataHeader;

    /**
     * Populated on normalization. Indicates the earliest data point for each {@link Ann.Ts} fields.
     */
    readonly earliestTsDp?: Map_Type<string, TSDataPoint>;
    withEarliestTsDp(earliestTsDp: Map_Type<string, TSDataPoint> | {[key: string]: ITSDataPoint} | null): Genai.TestTimedDataHeader;

    /**
     * Populated on normalization. Indicates the latest data point for each {@link Ann.Ts} fields.
     */
    readonly latestTsDp?: Map_Type<string, TSDataPoint>;
    withLatestTsDp(latestTsDp: Map_Type<string, TSDataPoint> | {[key: string]: ITSDataPoint} | null): Genai.TestTimedDataHeader;
    ...
    withInterval(interval: string | null): Genai.TestTimedDataHeader;

    /**
     * If set, the time series will be normalized in the specified zone.
     */
    readonly timeZone?: string;
    withTimeZone(timeZone: string | null): Genai.TestTimedDataHeader;

    /**
     * If set, disables normalizing this time series. Invalidations will still continue to happen for this series normally.
     */
    readonly doNotNormalize?: boolean;
    withDoNotNormalize(doNotNormalize: boolean): Genai.TestTimedDataHeader;

    /**
     * Data points corresponding to this timeseries header
     */
    readonly data?: Array_Type<Genai.TestTimedDataPoint>;
    withData(data: Array_Type<Genai.TestTimedDataPoint> | Array<IGenai.TestTimedDataPoint> | null): Genai.TestTimedDataHeader;

    /**
     * Use this field to specify the interpolation mechanism to be applied for gaps in interval timeseries. Default: `ZERO_INTERPOLATOR`.
     */
    readonly interpolator?: string;
    withInterpolator(interpolator: string | null): Genai.TestTimedDataHeader;

    /**
     * Use this field to specify how normalization should handle duplicate data points. A duplicate point is one that has the same start, end, value, unit, and {@link TimedDataPointFields#isEstimated} values. Default: `IGNORE`.
     */
    readonly duplicateHandling?: string;
    withDuplicateHandling(duplicateHandling: string | null): Genai.TestTimedDataHeader;

    /**
     * Used to specify how normalization should handle overlapping data points. Default: `AVG`.
     */
    readonly overlapHandling?: string;
    withOverlapHandling(overlapHandling: string | null): Genai.TestTimedDataHeader;
    ...
    withBucketInterval(bucketInterval: string | null): Genai.TestTimedDataHeader;
    ...
    withNormalizationPartitionStrategy(normalizationPartitionStrategy: INormalizationPartitionStrategy | null): Genai.TestTimedDataHeader;

    /**
     * Indicates whether the last data point should be repeated until infinity
     */
    readonly extrapolate?: boolean;
    withExtrapolate(extrapolate: boolean): Genai.TestTimedDataHeader;
     ...
     */
    readonly id: string;
    withId(id: string): Genai.TestTimedDataHeader;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Genai.TestTimedDataHeader;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): Genai.TestTimedDataHeader;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Genai.TestTimedDataHeader;
    ...
    withVersion(version: number | null): Genai.TestTimedDataHeader;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Genai.TestTimedDataHeader;

    /**
     * Explicit declared field to test validation of {@link SimpleMetric#tsDecl}
     */
    readonly declaredData?: Array_Type<Genai.TestTimedDataPoint>;
    withDeclaredData(declaredData: Array_Type<Genai.TestTimedDataPoint> | Array<IGenai.TestTimedDataPoint> | null): Genai.TestTimedDataHeader;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.TestTimedDataHeader | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.TestTimedDataHeader | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.TestTimedDataHeader | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.TestTimedDataHeader | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.TestTimedDataHeader;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.TestTimedDataHeader;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.TestTimedDataHeader;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.TestTimedDataHeader>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.TestTimedDataHeader>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.TestTimedDataHeader;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.TestTimedDataHeader;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.TestTimedDataHeader;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.TestTimedDataHeader;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.TestTimedDataHeader;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.TestTimedDataHeader;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.TestTimedDataHeader;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.TestTimedDataHeader;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.TestTimedDataHeader;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.TestTimedDataHeader;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.TestTimedDataHeader;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.TestTimedDataHeader;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.TestTimedDataHeader;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.TestTimedDataHeader;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.TestTimedDataHeader;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.TestTimedDataHeader;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.TestTimedDataHeader;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.TestTimedDataHeader;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.TestTimedDataHeader;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.TestTimedDataHeader;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.TestTimedDataHeader;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.TestTimedDataHeader;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.TestTimedDataHeader;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.TestTimedDataHeader;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.TestTimedDataHeader;

    mergeJson(json: any): Genai.TestTimedDataHeader;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.TestTimedDataHeader;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.TestTimedDataHeader;
     ...
     */
    singletonArray(): Array_Type<Genai.TestTimedDataHeader>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.TestTimedDataHeader> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.TestTimedDataHeader> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.TestTimedDataHeader>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.TestTimedDataHeader> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.TestTimedDataHeader> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.TestTimedDataHeader> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.TestTimedDataHeader>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.TestTimedDataHeader>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.TestTimedDataHeader;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.TestTimedDataHeader;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.TestTimedDataHeader;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.TestTimedDataHeader;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.TestTimedDataHeader;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.TestTimedDataHeader;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.TestTimedDataHeader | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.TestTimedDataHeader;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.TestTimedDataHeader;
     ...
     */
    static cachedEmptyInst(): Genai.TestTimedDataHeader;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.TestTimedDataHeader> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.TestTimedDataHeader;
     ...
     */
    static normalizeTimeseries(timeseries?: TimedDataFields<Genai.TestTimedDataPoint>, start?: DateTime, end?: DateTime, overrideGrain?: string, forceGrainDetection?: boolean, force?: boolean): void;
     ...
     */
    static normalize(timeseries?: TimedDataFields<Genai.TestTimedDataPoint>, start?: DateTime, end?: DateTime, overrideGrain?: string, forceGrainDetection?: boolean): NormalizationResult | null;
     ...
     */
    static normalizationUnit(rawHeader: TimedDataFields<Genai.TestTimedDataPoint>, tsField: string): Unit | null;
     ...
     */
    static normalizationTreatment(rawHeader: TimedDataFields<Genai.TestTimedDataPoint>, tsField: string): string;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Genai.TestTimedDataHeader>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Genai.TestTimedDataHeader>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Genai.TestTimedDataHeader> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Genai.TestTimedDataHeader>> | null;
     ...
     */
    get(include?: string): Genai.TestTimedDataHeader | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Genai.TestTimedDataHeader | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Genai.TestTimedDataHeader;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Genai.TestTimedDataHeader | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Genai.TestTimedDataHeader;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.TestTimedDataHeader | null;
     ...
     */
    create(spec?: UpsertSpec): Genai.TestTimedDataHeader | null;
     ...
     */
    static createBatch(objs: Array_Type<Genai.TestTimedDataHeader>, spec?: UpsertSpec): ObjList<Genai.TestTimedDataHeader> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Genai.TestTimedDataHeader>, spec?: CreateBatchObjStreamSpec): ObjList<Genai.TestTimedDataHeader> | null;
     ...
     */
    update(srcObj?: Genai.TestTimedDataHeader, spec?: UpsertSpec): Genai.TestTimedDataHeader | null;
     ...
     */
    upsert(srcObj?: Genai.TestTimedDataHeader, spec?: UpsertSpec): Genai.TestTimedDataHeader | null;
     ...
     */
    merge(spec?: MergeSpec): Genai.TestTimedDataHeader | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Genai.TestTimedDataHeader | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Genai.TestTimedDataHeader | null;
     ...
     */
    static updateBatch(objs: Array_Type<Genai.TestTimedDataHeader>, srcObjs?: Array_Type<Genai.TestTimedDataHeader>, spec?: UpsertSpec): ObjList<Genai.TestTimedDataHeader> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Genai.TestTimedDataHeader> | null>, spec?: UpsertSpec): ObjList<Genai.TestTimedDataHeader> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Genai.TestTimedDataHeader>, srcObjs?: Array_Type<Genai.TestTimedDataHeader>, spec?: UpsertSpec): ObjList<Genai.TestTimedDataHeader> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Genai.TestTimedDataHeader> | null>, spec?: UpsertSpec): ObjList<Genai.TestTimedDataHeader> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Genai.TestTimedDataHeader>, spec?: TouchSpec): ObjList<Genai.TestTimedDataHeader> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.TestTimedDataHeader>, spec?: MergeSpec): ObjList<Genai.TestTimedDataHeader> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.TestTimedDataHeader>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.TestTimedDataHeader> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Genai.TestTimedDataHeader> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.TestTimedDataHeader> | null;
     ...
     */
    static mergeAll(mergeObj: Genai.TestTimedDataHeader, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Genai.TestTimedDataHeader, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Genai.TestTimedDataHeader>, spec?: UpsertSpec): ObjList<Genai.TestTimedDataHeader> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Genai.TestTimedDataHeader>, spec?: UpsertSpec): ObjList<Genai.TestTimedDataHeader> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Genai.TestTimedDataHeader | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Genai.TestTimedDataHeader>): ObjList<Genai.TestTimedDataHeader>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<Genai.TestTimedDataHeader>): ObjList<Genai.TestTimedDataHeader>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Genai.TestTimedDataHeader>): ObjList<Genai.TestTimedDataHeader>;
     ...
     */
    static afterCreate(objs: Array_Type<Genai.TestTimedDataHeader>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Genai.TestTimedDataHeader>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Genai.TestTimedDataHeader>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Genai.TestTimedDataHeader>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Genai.TestTimedDataHeader>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.TestTimedDataHeader | null;
     ...
     */
    withoutIdentity(): Genai.TestTimedDataHeader | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Genai.TestTimedDataHeader>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Genai.TestTimedDataHeader, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Genai.TestTimedDataHeader>, callback?: λFunction<Genai.TestTimedDataHeader | null, Genai.TestTimedDataHeader | null>): ObjList<Genai.TestTimedDataHeader>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Genai.TestTimedDataHeader>, callback?: λFunction<Genai.TestTimedDataHeader | null, Genai.TestTimedDataHeader | null>): Array_Type<ObjError> | null;
