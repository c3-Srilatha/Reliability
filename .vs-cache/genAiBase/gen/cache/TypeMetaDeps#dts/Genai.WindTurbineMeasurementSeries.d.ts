// TypeScript definitions for the C3 type Genai.WindTurbineMeasurementSeries

/**
 * A series of measurements taken from a single {@link Genai.WindTurbine}.
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.WindTurbineMeasurementSeries
 */
declare namespace Genai {
  export interface IWindTurbineMeasurementSeries {
     ...
     */
    data?: Array_Type<Genai.WindTurbineMeasurement> | Array<IGenai.WindTurbineMeasurement>;
     ...
     */
    windTurbine?: IGenai.WindTurbine;
 ...
 */
declare namespace Genai {
  export class WindTurbineMeasurementSeries extends Obj  {

    /**
     * Populated on normalization. Indicates the earliest data point across various timeseries fields.
     */
    readonly earliest?: DateTime;
    withEarliest(earliest: DateTime | Date | string | null): Genai.WindTurbineMeasurementSeries;

    /**
     * Populated on normalization. Indicates the latest data point across various timeseries fields.
     */
    readonly latest?: DateTime;
    withLatest(latest: DateTime | Date | string | null): Genai.WindTurbineMeasurementSeries;

    /**
     * Populated on normalization. Indicates the earliest data point for each {@link Ann.Ts} fields.
     */
    readonly earliestTsDp?: Map_Type<string, TSDataPoint>;
    withEarliestTsDp(earliestTsDp: Map_Type<string, TSDataPoint> | {[key: string]: ITSDataPoint} | null): Genai.WindTurbineMeasurementSeries;

    /**
     * Populated on normalization. Indicates the latest data point for each {@link Ann.Ts} fields.
     */
    readonly latestTsDp?: Map_Type<string, TSDataPoint>;
    withLatestTsDp(latestTsDp: Map_Type<string, TSDataPoint> | {[key: string]: ITSDataPoint} | null): Genai.WindTurbineMeasurementSeries;
    ...
    withInterval(interval: string | null): Genai.WindTurbineMeasurementSeries;

    /**
     * If set, the time series will be normalized in the specified zone.
     */
    readonly timeZone?: string;
    withTimeZone(timeZone: string | null): Genai.WindTurbineMeasurementSeries;

    /**
     * If set, disables normalizing this time series. Invalidations will still continue to happen for this series normally.
     */
    readonly doNotNormalize?: boolean;
    withDoNotNormalize(doNotNormalize: boolean): Genai.WindTurbineMeasurementSeries;

    /**
     * Data points corresponding to this timeseries header
     */
    readonly data?: Array_Type<Genai.WindTurbineMeasurement>;
    withData(data: Array_Type<Genai.WindTurbineMeasurement> | Array<IGenai.WindTurbineMeasurement> | null): Genai.WindTurbineMeasurementSeries;

    /**
     * Use this field to specify the interpolation mechanism to be applied for gaps in interval timeseries. Default: `ZERO_INTERPOLATOR`.
     */
    readonly interpolator?: string;
    withInterpolator(interpolator: string | null): Genai.WindTurbineMeasurementSeries;

    /**
     * Use this field to specify how normalization should handle duplicate data points. A duplicate point is one that has the same start, end, value, unit, and {@link TimedDataPointFields#isEstimated} values. Default: `IGNORE`.
     */
    readonly duplicateHandling?: string;
    withDuplicateHandling(duplicateHandling: string | null): Genai.WindTurbineMeasurementSeries;

    /**
     * Used to specify how normalization should handle overlapping data points. Default: `AVG`.
     */
    readonly overlapHandling?: string;
    withOverlapHandling(overlapHandling: string | null): Genai.WindTurbineMeasurementSeries;
    ...
    withBucketInterval(bucketInterval: string | null): Genai.WindTurbineMeasurementSeries;
    ...
    withNormalizationPartitionStrategy(normalizationPartitionStrategy: INormalizationPartitionStrategy | null): Genai.WindTurbineMeasurementSeries;

    /**
     * Indicates whether the last data point should be repeated until infinity
     */
    readonly extrapolate?: boolean;
    withExtrapolate(extrapolate: boolean): Genai.WindTurbineMeasurementSeries;
     ...
     */
    readonly id: string;
    withId(id: string): Genai.WindTurbineMeasurementSeries;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Genai.WindTurbineMeasurementSeries;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): Genai.WindTurbineMeasurementSeries;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Genai.WindTurbineMeasurementSeries;
    ...
    withVersion(version: number | null): Genai.WindTurbineMeasurementSeries;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Genai.WindTurbineMeasurementSeries;

    /**
     * The {@link Genai.WindTurbine} for which measurements were taken.
     */
    readonly windTurbine?: Genai.WindTurbine;
    withWindTurbine(windTurbine: IGenai.WindTurbine | null): Genai.WindTurbineMeasurementSeries;

    /**
     * The aggregation/disaggregation treatment to use for the measurements.
     */
    readonly treatment?: string;
    withTreatment(treatment: string | null): Genai.WindTurbineMeasurementSeries;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.WindTurbineMeasurementSeries | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.WindTurbineMeasurementSeries | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.WindTurbineMeasurementSeries | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.WindTurbineMeasurementSeries | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.WindTurbineMeasurementSeries;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.WindTurbineMeasurementSeries;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.WindTurbineMeasurementSeries;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.WindTurbineMeasurementSeries>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.WindTurbineMeasurementSeries>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.WindTurbineMeasurementSeries;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.WindTurbineMeasurementSeries;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.WindTurbineMeasurementSeries;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.WindTurbineMeasurementSeries;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.WindTurbineMeasurementSeries;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.WindTurbineMeasurementSeries;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.WindTurbineMeasurementSeries;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.WindTurbineMeasurementSeries;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.WindTurbineMeasurementSeries;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.WindTurbineMeasurementSeries;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.WindTurbineMeasurementSeries;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.WindTurbineMeasurementSeries;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.WindTurbineMeasurementSeries;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.WindTurbineMeasurementSeries;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.WindTurbineMeasurementSeries;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.WindTurbineMeasurementSeries;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.WindTurbineMeasurementSeries;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.WindTurbineMeasurementSeries;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.WindTurbineMeasurementSeries;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.WindTurbineMeasurementSeries;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.WindTurbineMeasurementSeries;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.WindTurbineMeasurementSeries;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.WindTurbineMeasurementSeries;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.WindTurbineMeasurementSeries;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.WindTurbineMeasurementSeries;

    mergeJson(json: any): Genai.WindTurbineMeasurementSeries;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.WindTurbineMeasurementSeries;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.WindTurbineMeasurementSeries;
     ...
     */
    singletonArray(): Array_Type<Genai.WindTurbineMeasurementSeries>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.WindTurbineMeasurementSeries> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.WindTurbineMeasurementSeries> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.WindTurbineMeasurementSeries>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.WindTurbineMeasurementSeries> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.WindTurbineMeasurementSeries> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.WindTurbineMeasurementSeries> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.WindTurbineMeasurementSeries>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.WindTurbineMeasurementSeries>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.WindTurbineMeasurementSeries;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.WindTurbineMeasurementSeries;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.WindTurbineMeasurementSeries;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.WindTurbineMeasurementSeries;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.WindTurbineMeasurementSeries;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.WindTurbineMeasurementSeries;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.WindTurbineMeasurementSeries | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.WindTurbineMeasurementSeries;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.WindTurbineMeasurementSeries;
     ...
     */
    static cachedEmptyInst(): Genai.WindTurbineMeasurementSeries;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.WindTurbineMeasurementSeries> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.WindTurbineMeasurementSeries;
     ...
     */
    static normalizeTimeseries(timeseries?: TimedDataFields<Genai.WindTurbineMeasurement>, start?: DateTime, end?: DateTime, overrideGrain?: string, forceGrainDetection?: boolean, force?: boolean): void;
     ...
     */
    static normalize(timeseries?: TimedDataFields<Genai.WindTurbineMeasurement>, start?: DateTime, end?: DateTime, overrideGrain?: string, forceGrainDetection?: boolean): NormalizationResult | null;
     ...
     */
    static normalizationUnit(rawHeader: TimedDataFields<Genai.WindTurbineMeasurement>, tsField: string): Unit | null;
     ...
     */
    static normalizationTreatment(rawHeader: TimedDataFields<Genai.WindTurbineMeasurement>, tsField: string): string;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Genai.WindTurbineMeasurementSeries>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Genai.WindTurbineMeasurementSeries>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Genai.WindTurbineMeasurementSeries> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Genai.WindTurbineMeasurementSeries>> | null;
     ...
     */
    get(include?: string): Genai.WindTurbineMeasurementSeries | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Genai.WindTurbineMeasurementSeries | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Genai.WindTurbineMeasurementSeries;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Genai.WindTurbineMeasurementSeries | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Genai.WindTurbineMeasurementSeries;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.WindTurbineMeasurementSeries | null;
     ...
     */
    create(spec?: UpsertSpec): Genai.WindTurbineMeasurementSeries | null;
     ...
     */
    static createBatch(objs: Array_Type<Genai.WindTurbineMeasurementSeries>, spec?: UpsertSpec): ObjList<Genai.WindTurbineMeasurementSeries> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Genai.WindTurbineMeasurementSeries>, spec?: CreateBatchObjStreamSpec): ObjList<Genai.WindTurbineMeasurementSeries> | null;
     ...
     */
    update(srcObj?: Genai.WindTurbineMeasurementSeries, spec?: UpsertSpec): Genai.WindTurbineMeasurementSeries | null;
     ...
     */
    upsert(srcObj?: Genai.WindTurbineMeasurementSeries, spec?: UpsertSpec): Genai.WindTurbineMeasurementSeries | null;
     ...
     */
    merge(spec?: MergeSpec): Genai.WindTurbineMeasurementSeries | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Genai.WindTurbineMeasurementSeries | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Genai.WindTurbineMeasurementSeries | null;
     ...
     */
    static updateBatch(objs: Array_Type<Genai.WindTurbineMeasurementSeries>, srcObjs?: Array_Type<Genai.WindTurbineMeasurementSeries>, spec?: UpsertSpec): ObjList<Genai.WindTurbineMeasurementSeries> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Genai.WindTurbineMeasurementSeries> | null>, spec?: UpsertSpec): ObjList<Genai.WindTurbineMeasurementSeries> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Genai.WindTurbineMeasurementSeries>, srcObjs?: Array_Type<Genai.WindTurbineMeasurementSeries>, spec?: UpsertSpec): ObjList<Genai.WindTurbineMeasurementSeries> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Genai.WindTurbineMeasurementSeries> | null>, spec?: UpsertSpec): ObjList<Genai.WindTurbineMeasurementSeries> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Genai.WindTurbineMeasurementSeries>, spec?: TouchSpec): ObjList<Genai.WindTurbineMeasurementSeries> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.WindTurbineMeasurementSeries>, spec?: MergeSpec): ObjList<Genai.WindTurbineMeasurementSeries> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.WindTurbineMeasurementSeries>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.WindTurbineMeasurementSeries> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Genai.WindTurbineMeasurementSeries> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.WindTurbineMeasurementSeries> | null;
     ...
     */
    static mergeAll(mergeObj: Genai.WindTurbineMeasurementSeries, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Genai.WindTurbineMeasurementSeries, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Genai.WindTurbineMeasurementSeries>, spec?: UpsertSpec): ObjList<Genai.WindTurbineMeasurementSeries> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Genai.WindTurbineMeasurementSeries>, spec?: UpsertSpec): ObjList<Genai.WindTurbineMeasurementSeries> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Genai.WindTurbineMeasurementSeries | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Genai.WindTurbineMeasurementSeries>): ObjList<Genai.WindTurbineMeasurementSeries>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<Genai.WindTurbineMeasurementSeries>): ObjList<Genai.WindTurbineMeasurementSeries>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Genai.WindTurbineMeasurementSeries>): ObjList<Genai.WindTurbineMeasurementSeries>;
     ...
     */
    static afterCreate(objs: Array_Type<Genai.WindTurbineMeasurementSeries>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Genai.WindTurbineMeasurementSeries>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Genai.WindTurbineMeasurementSeries>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Genai.WindTurbineMeasurementSeries>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Genai.WindTurbineMeasurementSeries>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.WindTurbineMeasurementSeries | null;
     ...
     */
    withoutIdentity(): Genai.WindTurbineMeasurementSeries | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Genai.WindTurbineMeasurementSeries>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Genai.WindTurbineMeasurementSeries, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Genai.WindTurbineMeasurementSeries>, callback?: λFunction<Genai.WindTurbineMeasurementSeries | null, Genai.WindTurbineMeasurementSeries | null>): ObjList<Genai.WindTurbineMeasurementSeries>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Genai.WindTurbineMeasurementSeries>, callback?: λFunction<Genai.WindTurbineMeasurementSeries | null, Genai.WindTurbineMeasurementSeries | null>): Array_Type<ObjError> | null;
