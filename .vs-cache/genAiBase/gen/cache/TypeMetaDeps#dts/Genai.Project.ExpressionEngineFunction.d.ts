// TypeScript definitions for the C3 type Genai.Project.ExpressionEngineFunction

/**
 * Custom {@link ExpressionEngineFunction}s used to calculate calc fields for {@link Genai.Project}
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.Project.ExpressionEngineFunction
 */
...
declare namespace Genai.Project {
  export class ExpressionEngineFunction {
     ...
     */
    static getCollections(id: string): Array_Type<Genai.SourceCollection> | null;
  }
}
