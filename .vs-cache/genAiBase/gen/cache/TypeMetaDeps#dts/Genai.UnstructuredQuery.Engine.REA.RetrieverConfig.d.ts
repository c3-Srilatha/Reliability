// TypeScript definitions for the C3 type Genai.UnstructuredQuery.Engine.REA.RetrieverConfig

/**
 * Defines the config for setting up the retriever.
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.UnstructuredQuery.Engine.REA.RetrieverConfig
 */
declare namespace Genai.UnstructuredQuery.Engine.REA {
  export interface IRetrieverConfig {
    ...
    /**
     * Specifying the maximum number of tokens in the query, which should be strictly larger than 0.
     * The default value is 32.
     */
    queryMaxLen?: number;

    /**
     * Number of passages to be retrieved, default value is 4
     */
    numRetrievedPassages?: number;

    /**
     *  The limit for #numRetrievedPassages, so it is not set too large when #numRetrievedPassages is modified by users.
     * # 25 is a somewhat arbitrary limit, but if users start setting the number too large, similaritySearch will slow down
     * # and we will start hitting token limits.
     */
    maxNumRetrievedPassages?: number;

    /**
     * Whether to filter our passages with score less than doc_filter_threshold, default is False.
     */
    filterDocs?: boolean;

    /**
     * The threshold used for filtering passages out, default is 15. It is ignored if
     * filter_docs is False. The range for this parameter is between 0 and 1 if normalize_scores is set to True and
     * it is between 0 and query_max_len otherwise.
     */
    docFilterThreshold?: number;

    /**
     * Whether to normalize the score by query length or not. The default is False.
     */
    normalizeScores?: boolean;

    /**
     * Spec for MMR (Maximal Marginal Relevance) post-processing of the similarity search results
     * to support summarization.
     */
    mmrSpec?: IGenai.Retriever.MmrSpec;
  }
}
 ...
 * Defines the config for setting up the retriever.
 *
 * @remarks this represents a made instance of Genai.UnstructuredQuery.Engine.REA.RetrieverConfig
 */
declare namespace Genai.UnstructuredQuery.Engine.REA {
  export class RetrieverConfig extends Obj  {

    /**
     * The unique and required name of this instance.
     */
    readonly name: string;
    withName(name: string): Genai.UnstructuredQuery.Engine.REA.RetrieverConfig;

    readonly configOverride?: string;
    withConfigOverride(configOverride: string | null): Genai.UnstructuredQuery.Engine.REA.RetrieverConfig;

    readonly secretOverride?: string;
    withSecretOverride(secretOverride: string | null): Genai.UnstructuredQuery.Engine.REA.RetrieverConfig;

    /**
     * Captures any issues that occurred while deserializing from filesystem
     */
    readonly issues?: Array_Type<string>;
    withIssues(issues: Array_Type<string> | Array<string> | null): Genai.UnstructuredQuery.Engine.REA.RetrieverConfig;
    ...
    withQueryMaxLen(queryMaxLen: number | null): Genai.UnstructuredQuery.Engine.REA.RetrieverConfig;

    /**
     * Number of passages to be retrieved, default value is 4
     */
    readonly numRetrievedPassages?: number;
    withNumRetrievedPassages(numRetrievedPassages: number | null): Genai.UnstructuredQuery.Engine.REA.RetrieverConfig;
     ...
     * # and we will start hitting token limits.
     */
    readonly maxNumRetrievedPassages?: number;
    withMaxNumRetrievedPassages(maxNumRetrievedPassages: number | null): Genai.UnstructuredQuery.Engine.REA.RetrieverConfig;

    /**
     * Whether to filter our passages with score less than doc_filter_threshold, default is False.
     */
    readonly filterDocs?: boolean;
    withFilterDocs(filterDocs: boolean): Genai.UnstructuredQuery.Engine.REA.RetrieverConfig;
     ...
     * it is between 0 and query_max_len otherwise.
     */
    readonly docFilterThreshold?: number;
    withDocFilterThreshold(docFilterThreshold: number | null): Genai.UnstructuredQuery.Engine.REA.RetrieverConfig;

    /**
     * Whether to normalize the score by query length or not. The default is False.
     */
    readonly normalizeScores?: boolean;
    withNormalizeScores(normalizeScores: boolean): Genai.UnstructuredQuery.Engine.REA.RetrieverConfig;

    /**
     * Spec for MMR (Maximal Marginal Relevance) post-processing of the similarity search results
     * to support summarization.
     */
    readonly mmrSpec?: Genai.Retriever.MmrSpec;
    withMmrSpec(mmrSpec: IGenai.Retriever.MmrSpec | null): Genai.UnstructuredQuery.Engine.REA.RetrieverConfig;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.UnstructuredQuery.Engine.REA.RetrieverConfig | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.UnstructuredQuery.Engine.REA.RetrieverConfig | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.UnstructuredQuery.Engine.REA.RetrieverConfig | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.UnstructuredQuery.Engine.REA.RetrieverConfig | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.UnstructuredQuery.Engine.REA.RetrieverConfig;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.UnstructuredQuery.Engine.REA.RetrieverConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.UnstructuredQuery.Engine.REA.RetrieverConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.UnstructuredQuery.Engine.REA.RetrieverConfig>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.UnstructuredQuery.Engine.REA.RetrieverConfig>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.UnstructuredQuery.Engine.REA.RetrieverConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.UnstructuredQuery.Engine.REA.RetrieverConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.UnstructuredQuery.Engine.REA.RetrieverConfig;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.UnstructuredQuery.Engine.REA.RetrieverConfig;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.UnstructuredQuery.Engine.REA.RetrieverConfig;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.UnstructuredQuery.Engine.REA.RetrieverConfig;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.UnstructuredQuery.Engine.REA.RetrieverConfig;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.UnstructuredQuery.Engine.REA.RetrieverConfig;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.UnstructuredQuery.Engine.REA.RetrieverConfig;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.UnstructuredQuery.Engine.REA.RetrieverConfig;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.UnstructuredQuery.Engine.REA.RetrieverConfig;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.UnstructuredQuery.Engine.REA.RetrieverConfig;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.UnstructuredQuery.Engine.REA.RetrieverConfig;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.UnstructuredQuery.Engine.REA.RetrieverConfig;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.UnstructuredQuery.Engine.REA.RetrieverConfig;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.UnstructuredQuery.Engine.REA.RetrieverConfig;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.UnstructuredQuery.Engine.REA.RetrieverConfig;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.UnstructuredQuery.Engine.REA.RetrieverConfig;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.UnstructuredQuery.Engine.REA.RetrieverConfig;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.UnstructuredQuery.Engine.REA.RetrieverConfig;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.UnstructuredQuery.Engine.REA.RetrieverConfig;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.UnstructuredQuery.Engine.REA.RetrieverConfig;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.UnstructuredQuery.Engine.REA.RetrieverConfig;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.UnstructuredQuery.Engine.REA.RetrieverConfig;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.UnstructuredQuery.Engine.REA.RetrieverConfig;

    mergeJson(json: any): Genai.UnstructuredQuery.Engine.REA.RetrieverConfig;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.UnstructuredQuery.Engine.REA.RetrieverConfig;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.UnstructuredQuery.Engine.REA.RetrieverConfig;
     ...
     */
    singletonArray(): Array_Type<Genai.UnstructuredQuery.Engine.REA.RetrieverConfig>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.UnstructuredQuery.Engine.REA.RetrieverConfig> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.UnstructuredQuery.Engine.REA.RetrieverConfig> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.UnstructuredQuery.Engine.REA.RetrieverConfig>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.UnstructuredQuery.Engine.REA.RetrieverConfig> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.UnstructuredQuery.Engine.REA.RetrieverConfig> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.UnstructuredQuery.Engine.REA.RetrieverConfig> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.UnstructuredQuery.Engine.REA.RetrieverConfig>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.UnstructuredQuery.Engine.REA.RetrieverConfig>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.UnstructuredQuery.Engine.REA.RetrieverConfig;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.UnstructuredQuery.Engine.REA.RetrieverConfig;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.UnstructuredQuery.Engine.REA.RetrieverConfig;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.UnstructuredQuery.Engine.REA.RetrieverConfig;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.UnstructuredQuery.Engine.REA.RetrieverConfig;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.UnstructuredQuery.Engine.REA.RetrieverConfig;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.UnstructuredQuery.Engine.REA.RetrieverConfig | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.UnstructuredQuery.Engine.REA.RetrieverConfig;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.UnstructuredQuery.Engine.REA.RetrieverConfig;
     ...
     */
    static cachedEmptyInst(): Genai.UnstructuredQuery.Engine.REA.RetrieverConfig;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.UnstructuredQuery.Engine.REA.RetrieverConfig> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.UnstructuredQuery.Engine.REA.RetrieverConfig;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.UnstructuredQuery.Engine.REA.RetrieverConfig | null;
     ...
     */
    static forName(name: string, failIfMissing?: boolean): Genai.UnstructuredQuery.Engine.REA.RetrieverConfig | null;
     ...
     */
    static allCached(): Stream<Genai.UnstructuredQuery.Engine.REA.RetrieverConfig> | null;
     ...
     */
    static find(filter?: string): Stream<Genai.UnstructuredQuery.Engine.REA.RetrieverConfig> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<Genai.UnstructuredQuery.Engine.REA.RetrieverConfig> | null;

    /**
     * @return cached instance.
     */
    getCached(): Genai.UnstructuredQuery.Engine.REA.RetrieverConfig | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string): Genai.UnstructuredQuery.Engine.REA.RetrieverConfig | null;
     ...
     */
    static produce(key: string): Genai.UnstructuredQuery.Engine.REA.RetrieverConfig | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, Genai.UnstructuredQuery.Engine.REA.RetrieverConfig> | null;
     ...
     */
    getConfig(): Genai.UnstructuredQuery.Engine.REA.RetrieverConfig;
     ...
     */
    getSecret(): Genai.UnstructuredQuery.Engine.REA.RetrieverConfig;
     ...
     */
    withConfigKey(configKey: string): Genai.UnstructuredQuery.Engine.REA.RetrieverConfig;

    /**
     * @return copy without config key.
     */
    withoutConfigKey(): Genai.UnstructuredQuery.Engine.REA.RetrieverConfig;

    /**
     * @return return cached config instance for provided config key.
     */
    static forConfigKey(configKey: string): Genai.UnstructuredQuery.Engine.REA.RetrieverConfig | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string>): Stream<Genai.UnstructuredQuery.Engine.REA.RetrieverConfig> | null;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: Genai.UnstructuredQuery.Engine.REA.RetrieverConfig, override?: string): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): Genai.UnstructuredQuery.Engine.REA.RetrieverConfig | null;
     ...
     */
    removeSecrets(): Genai.UnstructuredQuery.Engine.REA.RetrieverConfig | null;

    /**
     * @return this config with only secret values.
     */
    removeNonSecrets(): Genai.UnstructuredQuery.Engine.REA.RetrieverConfig | null;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    validate(): Genai.UnstructuredQuery.Engine.REA.RetrieverConfig;
