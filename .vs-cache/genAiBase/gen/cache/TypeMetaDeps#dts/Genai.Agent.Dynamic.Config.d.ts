// TypeScript definitions for the C3 type Genai.Agent.Dynamic.Config

/**
 * Config for {@link Genai.Agent.Dynamic}
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.Agent.Dynamic.Config
 */
declare namespace Genai.Agent.Dynamic {
  export interface IConfig {
     ...
     */
    toolkit?: IGenai.Agent.Dynamic.Toolkit;
     ...
     */
    chatManagerSpec: IGenai.Agent.Dynamic.ChatManagerSpec;

    /**
     * Map of `tagType` to {@link Genai.Agent.DynamicTrajectory.Step}.
     */
    tagStepMap?: Map_Type<string, string> | {[key: string]: string};
     ...
     */
    codeExecutionCallbacks?: IGenai.Agent.Dynamic.CodeExecutionCallbackSpec;

    /**
     * Defines the spec for managing python agent callbacks, used to manage the lifecycle
     * of PythonAgent steps and calls.
     */
    onStepCallbacksSpec?: IGenai.Agent.Dynamic.OnStepCallbackSpec;
     ...
     */
    formatObjectForLLMKwargs?: any;

    /**
     * The parameters for the in-memory session store cache.
     */
    sessionStoreInMemoryCacheParams?: IGenaiCore.SessionStore.InMemory.CacheParams;

    /**
     * A {@link Lambda} that can be used to override the default object reference creation defined in object_reference.py.
     * execution outputs.
     */
    objectReferenceCreator?: ILambda<function(id: any, obj?: any, formatObjectForLlmKwargs?: any): any>;
    ...
    /**
     * The name of the {@link Genai.Agent.Dynamic.Config} to use
     * for {@link Genai.Agent.Dynamic.Persistable#queryFromTestCase}
     */
    testAgentConfigName?: string;
  }
}
 ...
 * Config for {@link Genai.Agent.Dynamic}
 *
 * @remarks this represents a made instance of Genai.Agent.Dynamic.Config
 */
declare namespace Genai.Agent.Dynamic {
  export class Config extends Obj  {
    ...
    withName(name: string): Genai.Agent.Dynamic.Config;
    ...
    withConfigOverride(configOverride: string | null): Genai.Agent.Dynamic.Config;

    static readonly configOverride?: string;

    readonly secretOverride?: string;
    withSecretOverride(secretOverride: string | null): Genai.Agent.Dynamic.Config;
    ...
    withIssues(issues: Array_Type<string> | Array<string> | null): Genai.Agent.Dynamic.Config;
    ...
    withLlmConfigName(llmConfigName: string): Genai.Agent.Dynamic.Config;
    ...
    withEnableFollowUpSuggestions(enableFollowUpSuggestions: boolean): Genai.Agent.Dynamic.Config;
     ...
     * The toolkit the agent has access to.
     */
    readonly toolkit?: Genai.Agent.Dynamic.Toolkit;
    withToolkit(toolkit: IGenai.Agent.Dynamic.Toolkit | null): Genai.Agent.Dynamic.Config;

    /**
     * The toolkit the agent has access to.
     */
    static readonly toolkit?: Genai.Agent.Dynamic.Toolkit;
    ...
    withMaxSteps(maxSteps: number): Genai.Agent.Dynamic.Config;
    ...
    withMaxSeconds(maxSeconds: number): Genai.Agent.Dynamic.Config;
     ...
     * Spec containing the arguments that we want to pass to the agent's interal chat manager.
     */
    readonly chatManagerSpec: Genai.Agent.Dynamic.ChatManagerSpec;
    withChatManagerSpec(chatManagerSpec: IGenai.Agent.Dynamic.ChatManagerSpec): Genai.Agent.Dynamic.Config;

    /**
     * Spec containing the arguments that we want to pass to the agent's interal chat manager.
     */
    static readonly chatManagerSpec: Genai.Agent.Dynamic.ChatManagerSpec;

    /**
     * Map of `tagType` to {@link Genai.Agent.DynamicTrajectory.Step}.
     */
    readonly tagStepMap?: Map_Type<string, string>;
    withTagStepMap(tagStepMap: Map_Type<string, string> | {[key: string]: string} | null): Genai.Agent.Dynamic.Config;

    /**
     * Map of `tagType` to {@link Genai.Agent.DynamicTrajectory.Step}.
     */
    static readonly tagStepMap?: Map_Type<string, string>;
    ...
    withSpecialization(specialization: string | null): Genai.Agent.Dynamic.Config;
     ...
     * examples in {@link Genai.FewShotExample.PythonAgent} associated with the agent.
     */
    static readonly specialization?: string;

    /**
     * The maximum number of few-shot examples to retrieve for prompt generation.
     */
    readonly numFewShots?: number;
    withNumFewShots(numFewShots: number | null): Genai.Agent.Dynamic.Config;

    /**
     * The maximum number of few-shot examples to retrieve for prompt generation.
     */
    static readonly numFewShots?: number;

    /**
     * Manages the lifecycle of `PythonAgentCodeExecutor` callbacks for code execution workflows.
     */
    readonly codeExecutionCallbacks?: Genai.Agent.Dynamic.CodeExecutionCallbackSpec;
    withCodeExecutionCallbacks(codeExecutionCallbacks: IGenai.Agent.Dynamic.CodeExecutionCallbackSpec | null): Genai.Agent.Dynamic.Config;

    /**
     * Manages the lifecycle of `PythonAgentCodeExecutor` callbacks for code execution workflows.
     */
    static readonly codeExecutionCallbacks?: Genai.Agent.Dynamic.CodeExecutionCallbackSpec;

    /**
     * Defines the spec for managing python agent callbacks, used to manage the lifecycle
     * of PythonAgent steps and calls.
     */
    readonly onStepCallbacksSpec?: Genai.Agent.Dynamic.OnStepCallbackSpec;
    withOnStepCallbacksSpec(onStepCallbacksSpec: IGenai.Agent.Dynamic.OnStepCallbackSpec | null): Genai.Agent.Dynamic.Config;

    /**
     * Defines the spec for managing python agent callbacks, used to manage the lifecycle
     * of PythonAgent steps and calls.
     */
    static readonly onStepCallbacksSpec?: Genai.Agent.Dynamic.OnStepCallbackSpec;
    ...
    withInputVariablesPrompt(inputVariablesPrompt: string | null): Genai.Agent.Dynamic.Config;
     ...
     * string will print out the input variables in the user query.
     */
    static readonly inputVariablesPrompt?: string;
    ...
    withRewriteConversationToSingleStepPrompt(rewriteConversationToSingleStepPrompt: string | null): Genai.Agent.Dynamic.Config;

    /**
     * Template prompt used for rewriting the conversation to a single step.
     * A default template will be used if not specified.
     */
    static readonly rewriteConversationToSingleStepPrompt?: string;
    ...
    withVerbosity(verbosity: number | null): Genai.Agent.Dynamic.Config;
     ...
     * If not set, the images will be saved to <file system root url>/ObjectReferenceManagerFiles
     */
    readonly imageFileFolderPath?: string;
    withImageFileFolderPath(imageFileFolderPath: string | null): Genai.Agent.Dynamic.Config;

    /**
     * The path to the folder in which to save the images output from the {@link Genai.Agent.Dynamic}.
     * If not set, the images will be saved to <file system root url>/ObjectReferenceManagerFiles
     */
    static readonly imageFileFolderPath?: string;
     ...
     * providing formatting arguments for each subclass defined in object_reference.py.
     */
    readonly formatObjectForLLMKwargs?: any;
    withFormatObjectForLLMKwargs(formatObjectForLLMKwargs: any | null): Genai.Agent.Dynamic.Config;
     ...
     * providing formatting arguments for each subclass defined in object_reference.py.
     */
    static readonly formatObjectForLLMKwargs?: any;

    /**
     * The parameters for the in-memory session store cache.
     */
    readonly sessionStoreInMemoryCacheParams?: GenaiCore.SessionStore.InMemory.CacheParams;
    withSessionStoreInMemoryCacheParams(sessionStoreInMemoryCacheParams: IGenaiCore.SessionStore.InMemory.CacheParams | null): Genai.Agent.Dynamic.Config;

    /**
     * The parameters for the in-memory session store cache.
     */
    static readonly sessionStoreInMemoryCacheParams?: GenaiCore.SessionStore.InMemory.CacheParams;

    /**
     * A {@link Lambda} that can be used to override the default object reference creation defined in object_reference.py.
     * execution outputs.
     */
    readonly objectReferenceCreator?: Lambda<function(id: any, obj?: any, formatObjectForLlmKwargs?: any): any>;
    withObjectReferenceCreator(objectReferenceCreator: ILambda<function(id: any, obj?: any, formatObjectForLlmKwargs?: any): any> | null): Genai.Agent.Dynamic.Config;

    /**
     * A {@link Lambda} that can be used to override the default object reference creation defined in object_reference.py.
     * execution outputs.
     */
    static readonly objectReferenceCreator?: Lambda<function(id: any, obj?: any, formatObjectForLlmKwargs?: any): any>;
     ...
     * },
     */
    readonly uiDataCreator?: any;
    withUiDataCreator(uiDataCreator: any | null): Genai.Agent.Dynamic.Config;
     ...
     * },
     */
    static readonly uiDataCreator?: any;

    /**
     * The name of the {@link Genai.Agent.Dynamic.Config} to use
     * for {@link Genai.Agent.Dynamic.Persistable#queryFromTestCase}
     */
    readonly testAgentConfigName?: string;
    withTestAgentConfigName(testAgentConfigName: string | null): Genai.Agent.Dynamic.Config;

    /**
     * The name of the {@link Genai.Agent.Dynamic.Config} to use
     * for {@link Genai.Agent.Dynamic.Persistable#queryFromTestCase}
     */
    static readonly testAgentConfigName?: string;
     ...
     */
    static inst(): Genai.Agent.Dynamic.Config;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.Agent.Dynamic.Config | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.Agent.Dynamic.Config | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.Agent.Dynamic.Config | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.Agent.Dynamic.Config | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.Agent.Dynamic.Config;
     ...
     * This method is used during live metadata update
     */
    static replaceType(old: Type, new_: Type): Genai.Agent.Dynamic.Config;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Agent.Dynamic.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Agent.Dynamic.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Agent.Dynamic.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Agent.Dynamic.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Agent.Dynamic.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Agent.Dynamic.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Agent.Dynamic.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Agent.Dynamic.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.Agent.Dynamic.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.Agent.Dynamic.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Agent.Dynamic.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Agent.Dynamic.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Agent.Dynamic.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Agent.Dynamic.Config;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.Agent.Dynamic.Config;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    static validateObj(): Genai.Agent.Dynamic.Config;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.Agent.Dynamic.Config;
     ...
     * @see #defaultField
     */
    static withField(field: string, value: any, doNotConvert?: boolean): Genai.Agent.Dynamic.Config;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.Agent.Dynamic.Config;
     ...
     * @see #defaultField
     */
    static withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.Agent.Dynamic.Config;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.Agent.Dynamic.Config;
     ...
     * @return new Obj
     */
    static withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.Agent.Dynamic.Config;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.Agent.Dynamic.Config;
     ...
     * @return new Obj
     */
    static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.Agent.Dynamic.Config;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.Agent.Dynamic.Config;
     ...
     * @see #withoutField
     */
    static withoutFieldAtPath(path: string): Genai.Agent.Dynamic.Config;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.Agent.Dynamic.Config;
     ...
     * @see #removeField
     */
    static withoutField(field: string): Genai.Agent.Dynamic.Config;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.Agent.Dynamic.Config;
     ...
     * @see #removeField
     */
    static withoutField(field: FieldType): Genai.Agent.Dynamic.Config;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.Agent.Dynamic.Config;
     ...
     * @return new Obj with removed fields
     */
    static withoutFields(fields: Array_Type<string>): Genai.Agent.Dynamic.Config;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.Agent.Dynamic.Config;
     ...
     * @return new Obj with removed fields
     */
    static withoutFieldsByType(fields: Array_Type<FieldType>): Genai.Agent.Dynamic.Config;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.Agent.Dynamic.Config;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    static withoutSecretFields(): Genai.Agent.Dynamic.Config;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.Agent.Dynamic.Config;
     ...
     * @see FieldType#defaultValue
     */
    static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.Agent.Dynamic.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.Agent.Dynamic.Config;
     ...
     * @see #unsetField
     */
    static defaultField(field: string): Genai.Agent.Dynamic.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.Agent.Dynamic.Config;
     ...
     * @see #unsetField
     */
    static defaultField(field: FieldType): Genai.Agent.Dynamic.Config;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.Agent.Dynamic.Config;
     ...
     * @see #removeField
     */
    static unsetField(field: string): Genai.Agent.Dynamic.Config;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.Agent.Dynamic.Config;
     ...
     * @see #removeField
     */
    static unsetField(field: FieldType): Genai.Agent.Dynamic.Config;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.Agent.Dynamic.Config;
     ...
     * @see #unsetField
     */
    static removeField(field: string): Genai.Agent.Dynamic.Config;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.Agent.Dynamic.Config;
     ...
     * @see #unsetField
     */
    static removeField(field: FieldType): Genai.Agent.Dynamic.Config;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.Agent.Dynamic.Config;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.Agent.Dynamic.Config;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.Agent.Dynamic.Config;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj, otherFieldsFilter: Type): Genai.Agent.Dynamic.Config;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.Agent.Dynamic.Config;
     ...
     *        the same key or index.
     */
    static mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.Agent.Dynamic.Config;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.Agent.Dynamic.Config;
     ...
     * traverse child reference and collection fields.
     */
    static mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.Agent.Dynamic.Config;

    mergeJson(json: any): Genai.Agent.Dynamic.Config;

    static mergeJson(json: any): Genai.Agent.Dynamic.Config;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.Agent.Dynamic.Config;
     ...
     * @return Obj with child references merged
     */
    static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.Agent.Dynamic.Config;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.Agent.Dynamic.Config;
     ...
     * references with same name and collection elements at same index or key.
     */
    static sumObj(other: Obj, deep?: boolean): Genai.Agent.Dynamic.Config;
     ...
     */
    singletonArray(): Array_Type<Genai.Agent.Dynamic.Config>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonArray(): Array_Type<Genai.Agent.Dynamic.Config>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.Agent.Dynamic.Config> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.Agent.Dynamic.Config> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.Agent.Dynamic.Config>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonSet(): Set_Type<Genai.Agent.Dynamic.Config>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.Agent.Dynamic.Config> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.Agent.Dynamic.Config> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.Agent.Dynamic.Config> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.Agent.Dynamic.Config>;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    static toBuilder(): ObjBuilder<Genai.Agent.Dynamic.Config>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.Agent.Dynamic.Config>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.Agent.Dynamic.Config;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.Agent.Dynamic.Config;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.Agent.Dynamic.Config;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.Agent.Dynamic.Config;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.Agent.Dynamic.Config;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.Agent.Dynamic.Config;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.Agent.Dynamic.Config | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.Agent.Dynamic.Config;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.Agent.Dynamic.Config;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    static afterMake(): Genai.Agent.Dynamic.Config;
     ...
     */
    static cachedEmptyInst(): Genai.Agent.Dynamic.Config;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.Agent.Dynamic.Config> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.Agent.Dynamic.Config;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.Agent.Dynamic.Config | null;
     ...
     */
    static forName(name: string, failIfMissing?: boolean): Genai.Agent.Dynamic.Config | null;
     ...
     */
    static allCached(): Stream<Genai.Agent.Dynamic.Config> | null;
     ...
     */
    static find(filter?: string): Stream<Genai.Agent.Dynamic.Config> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<Genai.Agent.Dynamic.Config> | null;

    /**
     * @return cached instance.
     */
    getCached(): Genai.Agent.Dynamic.Config | null;

    /**
     * @return cached instance.
     */
    static getCached(): Genai.Agent.Dynamic.Config | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string): Genai.Agent.Dynamic.Config | null;
     ...
     */
    static produce(key: string): Genai.Agent.Dynamic.Config | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, Genai.Agent.Dynamic.Config> | null;
     ...
     */
    getConfig(): Genai.Agent.Dynamic.Config;
     ...
     * Note that typical pattern is to use Configurable#config instead of this method.
     */
    static getConfig(): Genai.Agent.Dynamic.Config;
     ...
     */
    getSecret(): Genai.Agent.Dynamic.Config;
     ...
     * Note that typical pattern is to use Configurable#configWithSecrets instead of this method.
     */
    static getSecret(): Genai.Agent.Dynamic.Config;
     ...
     */
    withConfigKey(configKey: string): Genai.Agent.Dynamic.Config;
     ...
     *     config.configKey() => "folder1/abc"
     */
    static withConfigKey(configKey: string): Genai.Agent.Dynamic.Config;

    /**
     * @return copy without config key.
     */
    withoutConfigKey(): Genai.Agent.Dynamic.Config;

    /**
     * @return copy without config key.
     */
    static withoutConfigKey(): Genai.Agent.Dynamic.Config;

    /**
     * @return return cached config instance for provided config key.
     */
    static forConfigKey(configKey: string): Genai.Agent.Dynamic.Config | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string>): Stream<Genai.Agent.Dynamic.Config> | null;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: Genai.Agent.Dynamic.Config, override?: string): void;
     ...
     * @see setConfigValue
     */
    static setConfigValues(from: Genai.Agent.Dynamic.Config, override?: string): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): Genai.Agent.Dynamic.Config | null;
     ...
     */
    removeSecrets(): Genai.Agent.Dynamic.Config | null;

    /**
     * @return this config without any secret values.
     */
    static removeSecrets(): Genai.Agent.Dynamic.Config | null;

    /**
     * @return this config with only secret values.
     */
    removeNonSecrets(): Genai.Agent.Dynamic.Config | null;

    /**
     * @return this config with only secret values.
     */
    static removeNonSecrets(): Genai.Agent.Dynamic.Config | null;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    validate(): Genai.Agent.Dynamic.Config;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    static validate(): Genai.Agent.Dynamic.Config;
     ...
     */
    static setRecursive(configJson: any, useSetConfigValues?: boolean, override?: string): Genai.Agent.Dynamic.Config;
    ...
    /**
     * Retrieve the {@link Genai.StructuredData.DataModelGraph#whitelistedDataModel} from each tool if
     * one is available
     * @return collection of whitelistedDataModels
     */
    getWhitelistedDataModels(): Array_Type<any> | null;
     ...
     * @return collection of whitelistedDataModels
     */
    static getWhitelistedDataModels(): Array_Type<any> | null;

    /**
     * Update the system prompt with the data model documentation
     * @param dataModelGraph the data model graph to use for documentation
     */
    updateSystemPromptWithDataModel(dataModelGraph: Genai.StructuredData.DataModelGraph): void;

    /**
     * Update the system prompt with the data model documentation
     * @param dataModelGraph the data model graph to use for documentation
     */
    static updateSystemPromptWithDataModel(dataModelGraph: Genai.StructuredData.DataModelGraph): void;
  }
}
