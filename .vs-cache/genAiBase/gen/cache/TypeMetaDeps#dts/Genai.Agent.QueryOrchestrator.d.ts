// TypeScript definitions for the C3 type Genai.Agent.QueryOrchestrator

/**
 * Handles queries that may be routed to either structured or unstructured tools.
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.Agent.QueryOrchestrator
 */
 ...
 */
declare namespace Genai.Agent {
  export class QueryOrchestrator extends Obj  {

    /**
     * The unique and required name of this instance.
     */
    readonly name: string;
    withName(name: string): Genai.Agent.QueryOrchestrator;
     ...
     */
    readonly id: string;
    withId(id: string): Genai.Agent.QueryOrchestrator;
    ...
    with_deploymentCache(_deploymentCache: any | null): Genai.Agent.QueryOrchestrator;
    ...
    with_onStartError(_onStartError: string | null): Genai.Agent.QueryOrchestrator;
     ...
     */
    static inst(): Genai.Agent.QueryOrchestrator;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.Agent.QueryOrchestrator | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.Agent.QueryOrchestrator | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.Agent.QueryOrchestrator | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.Agent.QueryOrchestrator | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.Agent.QueryOrchestrator;
     ...
     * This method is used during live metadata update
     */
    static replaceType(old: Type, new_: Type): Genai.Agent.QueryOrchestrator;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Agent.QueryOrchestrator;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Agent.QueryOrchestrator;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Agent.QueryOrchestrator;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Agent.QueryOrchestrator;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Agent.QueryOrchestrator>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Agent.QueryOrchestrator>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Agent.QueryOrchestrator>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Agent.QueryOrchestrator>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.Agent.QueryOrchestrator;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.Agent.QueryOrchestrator;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Agent.QueryOrchestrator;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Agent.QueryOrchestrator;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Agent.QueryOrchestrator;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Agent.QueryOrchestrator;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.Agent.QueryOrchestrator;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    static validateObj(): Genai.Agent.QueryOrchestrator;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.Agent.QueryOrchestrator;
     ...
     * @see #defaultField
     */
    static withField(field: string, value: any, doNotConvert?: boolean): Genai.Agent.QueryOrchestrator;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.Agent.QueryOrchestrator;
     ...
     * @see #defaultField
     */
    static withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.Agent.QueryOrchestrator;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.Agent.QueryOrchestrator;
     ...
     * @return new Obj
     */
    static withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.Agent.QueryOrchestrator;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.Agent.QueryOrchestrator;
     ...
     * @return new Obj
     */
    static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.Agent.QueryOrchestrator;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.Agent.QueryOrchestrator;
     ...
     * @see #withoutField
     */
    static withoutFieldAtPath(path: string): Genai.Agent.QueryOrchestrator;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.Agent.QueryOrchestrator;
     ...
     * @see #removeField
     */
    static withoutField(field: string): Genai.Agent.QueryOrchestrator;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.Agent.QueryOrchestrator;
     ...
     * @see #removeField
     */
    static withoutField(field: FieldType): Genai.Agent.QueryOrchestrator;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.Agent.QueryOrchestrator;
     ...
     * @return new Obj with removed fields
     */
    static withoutFields(fields: Array_Type<string>): Genai.Agent.QueryOrchestrator;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.Agent.QueryOrchestrator;
     ...
     * @return new Obj with removed fields
     */
    static withoutFieldsByType(fields: Array_Type<FieldType>): Genai.Agent.QueryOrchestrator;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.Agent.QueryOrchestrator;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    static withoutSecretFields(): Genai.Agent.QueryOrchestrator;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.Agent.QueryOrchestrator;
     ...
     * @see FieldType#defaultValue
     */
    static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.Agent.QueryOrchestrator;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.Agent.QueryOrchestrator;
     ...
     * @see #unsetField
     */
    static defaultField(field: string): Genai.Agent.QueryOrchestrator;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.Agent.QueryOrchestrator;
     ...
     * @see #unsetField
     */
    static defaultField(field: FieldType): Genai.Agent.QueryOrchestrator;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.Agent.QueryOrchestrator;
     ...
     * @see #removeField
     */
    static unsetField(field: string): Genai.Agent.QueryOrchestrator;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.Agent.QueryOrchestrator;
     ...
     * @see #removeField
     */
    static unsetField(field: FieldType): Genai.Agent.QueryOrchestrator;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.Agent.QueryOrchestrator;
     ...
     * @see #unsetField
     */
    static removeField(field: string): Genai.Agent.QueryOrchestrator;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.Agent.QueryOrchestrator;
     ...
     * @see #unsetField
     */
    static removeField(field: FieldType): Genai.Agent.QueryOrchestrator;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.Agent.QueryOrchestrator;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.Agent.QueryOrchestrator;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.Agent.QueryOrchestrator;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj, otherFieldsFilter: Type): Genai.Agent.QueryOrchestrator;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.Agent.QueryOrchestrator;
     ...
     *        the same key or index.
     */
    static mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.Agent.QueryOrchestrator;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.Agent.QueryOrchestrator;
     ...
     * traverse child reference and collection fields.
     */
    static mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.Agent.QueryOrchestrator;

    mergeJson(json: any): Genai.Agent.QueryOrchestrator;

    static mergeJson(json: any): Genai.Agent.QueryOrchestrator;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.Agent.QueryOrchestrator;
     ...
     * @return Obj with child references merged
     */
    static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.Agent.QueryOrchestrator;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.Agent.QueryOrchestrator;
     ...
     * references with same name and collection elements at same index or key.
     */
    static sumObj(other: Obj, deep?: boolean): Genai.Agent.QueryOrchestrator;
     ...
     */
    singletonArray(): Array_Type<Genai.Agent.QueryOrchestrator>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonArray(): Array_Type<Genai.Agent.QueryOrchestrator>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.Agent.QueryOrchestrator> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.Agent.QueryOrchestrator> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.Agent.QueryOrchestrator>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonSet(): Set_Type<Genai.Agent.QueryOrchestrator>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.Agent.QueryOrchestrator> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.Agent.QueryOrchestrator> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.Agent.QueryOrchestrator> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.Agent.QueryOrchestrator>;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    static toBuilder(): ObjBuilder<Genai.Agent.QueryOrchestrator>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.Agent.QueryOrchestrator>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.Agent.QueryOrchestrator;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.Agent.QueryOrchestrator;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.Agent.QueryOrchestrator;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.Agent.QueryOrchestrator;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.Agent.QueryOrchestrator;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.Agent.QueryOrchestrator;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.Agent.QueryOrchestrator | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.Agent.QueryOrchestrator;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.Agent.QueryOrchestrator;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    static afterMake(): Genai.Agent.QueryOrchestrator;
     ...
     */
    static cachedEmptyInst(): Genai.Agent.QueryOrchestrator;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.Agent.QueryOrchestrator> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.Agent.QueryOrchestrator;
     ...
     */
    query(inProgressResult: Genai.Query.Result, input?: any): Genai.Query.Result;

    /**
     * The function to query from the planner. For {@link Genai.Agent.Dynamic} do {@link Genai.Agent.Dynamic#run}.
     */
    static query(inProgressResult: Genai.Query.Result, input?: any): Genai.Query.Result;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.Agent.QueryOrchestrator | null;
     ...
     */
    static forName(name: string, failIfMissing?: boolean): Genai.Agent.QueryOrchestrator | null;
     ...
     */
    config(secrets?: boolean): Genai.Agent.Config;
     ...
     * @return instance of configuration - never `null`.
     */
    static config(secrets?: boolean): Genai.Agent.Config;
     ...
     */
    static typeConfig(): Genai.Agent.Config;
     ...
     * @return The native python globals set during initialization.
     */
    static initialize(forceReload?: boolean): any | null;
     ...
     */
    run(input: any, inProgressResult: Genai.Query.Result, streamResponse?: boolean): Stream<string> | Genai.Query.Result;
     ...
     * @return The query result
     */
    static run(input: any, inProgressResult: Genai.Query.Result, streamResponse?: boolean): Stream<string> | Genai.Query.Result;
     ...
     * @return The query result
     */
    run(input: any, inProgressResult: Genai.Query.Result, streamResponse?: string): Stream<string> | Genai.Query.Result;
     ...
     * @return The query result
     */
    static run(input: any, inProgressResult: Genai.Query.Result, streamResponse?: string): Stream<string> | Genai.Query.Result;

    /**
     * @return single instance of this Identified type by id.
     */
    static forId(id: string, failIfMissing?: boolean): Genai.Agent.QueryOrchestrator | null;
     ...
     */
    static deploy(spec: Engine.DeploySpec): Genai.Agent.QueryOrchestrator;
     ...
     */
    deployment(): Genai.Agent.QueryOrchestrator.Deployment;
     ...
     * {@link Engine} was deployed.
     */
    static deployment(): Genai.Agent.QueryOrchestrator.Deployment;
     ...
     */
    configuredDeployment(): Genai.Agent.QueryOrchestrator.Deployment;
     ...
     * May be `null` if {@link Engine} is stopping. Use {@link #deployment} instead.
     */
    static configuredDeployment(): Genai.Agent.QueryOrchestrator.Deployment;

    /**
     * @return deployment type for this engine
     */
    static deploymentType(): Type<<Genai.Agent.QueryOrchestrator.Deployment>>;
     ...
     */
    restart(): Genai.Agent.QueryOrchestrator;

    /**
     * Restarts this engine
     */
    static restart(): Genai.Agent.QueryOrchestrator;
     ...
     */
    start(waitForReady?: boolean, spec?: WaitableSpec): Genai.Agent.QueryOrchestrator | null;
     ...
     * @return `null` if not waiting for ready and ready instance of the {@link Engine} otherwise.
     */
    static start(waitForReady?: boolean, spec?: WaitableSpec): Genai.Agent.QueryOrchestrator | null;

    doStart(): Genai.Agent.QueryOrchestrator;

    static doStart(): Genai.Agent.QueryOrchestrator;
     ...
     */
    call(action: Lambda<function(engine: Genai.Agent.QueryOrchestrator): T | null>): T | null;

    /**
     * call `action` on a specific engine
     */
    static call(action: Lambda<function(engine: Genai.Agent.QueryOrchestrator): T | null>): T | null;
     ...
     */
    onStart(): Genai.Agent.QueryOrchestrator;
     ...
     * @see #onEngineThreadStart
     */
    static onStart(): Genai.Agent.QueryOrchestrator;
     ...
     * @see #update
     */
    onUpdate(oldDeployment: Genai.Agent.QueryOrchestrator.Deployment): void;
     ...
     * @see #update
     */
    static onUpdate(oldDeployment: Genai.Agent.QueryOrchestrator.Deployment): void;
     ...
     * @see: #terminate
     */
    static list(): Array_Type<Genai.Agent.QueryOrchestrator> | null;
     ...
     */
    static allHandlers(): Array_Type<Genai.Agent.QueryOrchestrator> | null;

    /**
     * Stops all running handlers
     */
    static stopAllHandlers(): Array_Type<Genai.Agent.QueryOrchestrator> | null;
     ...
     */
    ensureInitialized(forceRefresh?: boolean): void;
     ...
     *   * or {@link Genai.Agent.Config#name} is different than that with which the agent was initialized
     */
    static ensureInitialized(forceRefresh?: boolean): void;
     ...
     */
    initializeRaiseErrorIfLogitBiasIsUsed(forceReload?: boolean, raiseErrorIfLogitBiasUsed?: boolean): void;
     ...
     *           If true, an python error will be raised within guidance if logit_biases are used.
     */
    static initializeRaiseErrorIfLogitBiasIsUsed(forceReload?: boolean, raiseErrorIfLogitBiasUsed?: boolean): void;

    /**
     * Internal function used to get the current list of {@link Genai.Agent.Tool} names cached.
     */
    toolNames(exitToolsOnly?: boolean, excludeExitTools?: boolean): Array_Type<string> | null;

    /**
     * Internal function used to get the current list of {@link Genai.Agent.Tool} names cached.
     */
    static toolNames(exitToolsOnly?: boolean, excludeExitTools?: boolean): Array_Type<string> | null;

    /**
     * Returns whether the orchestrator's toolkit contains a {@link Genai.Agent.Tool.UnstructuredDataQuery}
     */
    hasUnstructuredQueryTool(): boolean;

    /**
     * Returns whether the orchestrator's toolkit contains a {@link Genai.Agent.Tool.UnstructuredDataQuery}
     */
    static hasUnstructuredQueryTool(): boolean;

    /**
     * Internal function used to format the base prompt for the agent, including all the steps taken so far.
     */
    formatBasePrompt(userQuestion: string, toolNames?: Array_Type<string>, previousSteps?: Array_Type<Genai.Agent.Step>): string;

    /**
     * Internal function used to format the base prompt for the agent, including all the steps taken so far.
     */
    static formatBasePrompt(userQuestion: string, toolNames?: Array_Type<string>, previousSteps?: Array_Type<Genai.Agent.Step>): string;
     ...
     */
    pickNextTool(input: string, inProgressResult?: Genai.Query.Result, toolNames?: Array_Type<string>, previousSteps?: Array_Type<Genai.Agent.Step>): string | null;
     ...
     * For multi-hop scenarios, it's wrapping two extra function calls: #getNextStepThought and #getNextStepActionName.
     */
    static pickNextTool(input: string, inProgressResult?: Genai.Query.Result, toolNames?: Array_Type<string>, previousSteps?: Array_Type<Genai.Agent.Step>): string | null;
     ...
     * Invalid names will be filtered out based on the cached list of tool names.
     */
    getNextStepThought(input: string, inProgressResult?: Genai.Query.Result, toolNames?: Array_Type<string>, previousSteps?: Array_Type<Genai.Agent.Step>): string | null;
     ...
     * Invalid names will be filtered out based on the cached list of tool names.
     */
    static getNextStepThought(input: string, inProgressResult?: Genai.Query.Result, toolNames?: Array_Type<string>, previousSteps?: Array_Type<Genai.Agent.Step>): string | null;
     ...
     * Invalid names will be filtered out based on the cached list of tool names.
     */
    getNextStepActionName(input: string, inProgressResult?: Genai.Query.Result, toolNames?: Array_Type<string>, previousSteps?: Array_Type<Genai.Agent.Step>): string | null;
     ...
     * Invalid names will be filtered out based on the cached list of tool names.
     */
    static getNextStepActionName(input: string, inProgressResult?: Genai.Query.Result, toolNames?: Array_Type<string>, previousSteps?: Array_Type<Genai.Agent.Step>): string | null;
     ...
     * Invalid names will be filtered out based on the cached list of tool names.
     */
    getNextStepActionInput(input: string, inProgressResult?: Genai.Query.Result, toolNames?: Array_Type<string>, previousSteps?: Array_Type<Genai.Agent.Step>): string | null;
     ...
     * Invalid names will be filtered out based on the cached list of tool names.
     */
    static getNextStepActionInput(input: string, inProgressResult?: Genai.Query.Result, toolNames?: Array_Type<string>, previousSteps?: Array_Type<Genai.Agent.Step>): string | null;
     ...
     */
    runWithTiming(input: any, inProgressResult: Genai.Query.Result): any | null;
     ...
     * execute in the same process as the initialized orchestrator.
     */
    static runWithTiming(input: any, inProgressResult: Genai.Query.Result): any | null;

    /**
     * Returns the QueryOrchestrator corresponding to the {@link Genai.Agent.Config}'s key for the application.
     */
    static forConfigKey(configKey: string): Genai.Agent.QueryOrchestrator;
     ...
     *    the error to check
     */
    static isEmptyRetrieverError(error?: any): boolean;
     ...
     */
    static getActiveConfigName(): string;
     ...
     */
    loadAgent(agent?: Genai.Agent.Persistable<any, any>, forceReload?: boolean): void;
     ...
     * @param forceReload If true, the agent's configs and setup will be re-run (instead of reusing already-loaded values)
     */
    static loadAgent(agent?: Genai.Agent.Persistable<any, any>, forceReload?: boolean): void;
  }
}
