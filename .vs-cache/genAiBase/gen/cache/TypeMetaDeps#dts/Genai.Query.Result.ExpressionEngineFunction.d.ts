// TypeScript definitions for the C3 type Genai.Query.Result.ExpressionEngineFunction

/**
 * Custom {@link ExpressionEngineFunction}s used to calculate complex calc fields for {@link Genai.Query.Result}
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.Query.Result.ExpressionEngineFunction
 */
 ...
 * Custom {@link ExpressionEngineFunction}s used to calculate complex calc fields for {@link Genai.Query.Result}
 *
 * @remarks this represents a made instance of Genai.Query.Result.ExpressionEngineFunction
 */
declare namespace Genai.Query.Result {
  export class ExpressionEngineFunction {
    ...
    /**
     * Function to obtain the time in milliseconds that the query took from creation to completion.
     * @param id
     *        The ID of the {@link Genai.Query.Result}.
     * @return The latency of the query in milliseconds.
     */
    static getQueryLatency(id: string): number;

    /**
     * Returns the parsed JSON of a {@link Genai.Query.Result}.
     * @param id
     *        The ID of the {@link Genai.Query.Result}.
     * @return The parsed engine log JSON.
     */
    static getParsedEngineLog(id: string): any;

    /**
     * Function to obtain the email of the user that created the query
     * @param userId
     *           the id of the user
     * @return the email associated with the provided user id
     */
    static getUserEmail(userId?: string): string;

    /**
     * Function to obtain the UI result for the provided {@link Genai.Query.Result} id
     */
    static retrieveGetForUiResult(id: string): Genai.Query.Result.GetForUiResult;
  }
}
