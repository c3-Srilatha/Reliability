// TypeScript definitions for the C3 type Genai.SourceFile.Job.SyncBatchJob

/**
 * Performs sync for {@link Genai.SourceFile}s
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.SourceFile.Job.SyncBatchJob
 */
declare namespace Genai.SourceFile.Job {
  export interface ISyncBatchJob {
 ...
 */
declare namespace Genai.SourceFile.Job {
  export class SyncBatchJob extends Obj  {

    /**
     * current or last job execution for this instance
     */
    readonly run?: BatchJobRun;
    withRun(run: IBatchJobRun | null): Genai.SourceFile.Job.SyncBatchJob;

    /**
     * previous job executions for this instance
     */
    readonly runs?: Array_Type<BatchJobRun>;
    withRuns(runs: Array_Type<BatchJobRun> | Array<IBatchJobRun> | null): Genai.SourceFile.Job.SyncBatchJob;

    /**
     * FOR INTERNAL USE ONLY - Specify options in call to {@link start}.
     */
    readonly options?: Obj;
    withOptions(options: IObj | null): Genai.SourceFile.Job.SyncBatchJob;
    ...
    withOnCompleteCallback(onCompleteCallback: IJobBase.Callback | null): Genai.SourceFile.Job.SyncBatchJob;
    ...
    withPriority(priority: number | null): Genai.SourceFile.Job.SyncBatchJob;
    ...
    withDisabled(disabled: boolean): Genai.SourceFile.Job.SyncBatchJob;
    ...
    withMaxConcurrency(maxConcurrency: number | null): Genai.SourceFile.Job.SyncBatchJob;
    ...
    withMaxConcurrencyPerNode(maxConcurrencyPerNode: number | null): Genai.SourceFile.Job.SyncBatchJob;
    ...
    withRunAsUser(runAsUser: boolean): Genai.SourceFile.Job.SyncBatchJob;

    /**
     * Don't set this field in the BatchJob, set it in the BatchJobOptions when calling `start`
     */
    readonly nodePool?: string;
    withNodePool(nodePool: string | null): Genai.SourceFile.Job.SyncBatchJob;
    ...
    withSkipIfRunning(skipIfRunning: boolean): Genai.SourceFile.Job.SyncBatchJob;

    /**
     * Set to between 1 and 5 to enable auto recovery. See {@link invalidation-queues.c3doc Invalidation Queues} for detailed documentation.
     */
    readonly numAutoRecoveryAttempts?: number;
    withNumAutoRecoveryAttempts(numAutoRecoveryAttempts: number | null): Genai.SourceFile.Job.SyncBatchJob;
    ...
    withTypeIdent(typeIdent: string | null): Genai.SourceFile.Job.SyncBatchJob;
     ...
     */
    readonly id: string;
    withId(id: string): Genai.SourceFile.Job.SyncBatchJob;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Genai.SourceFile.Job.SyncBatchJob;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): Genai.SourceFile.Job.SyncBatchJob;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Genai.SourceFile.Job.SyncBatchJob;
    ...
    withVersion(version: number | null): Genai.SourceFile.Job.SyncBatchJob;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Genai.SourceFile.Job.SyncBatchJob;
    ...
    withAbortOnError(abortOnError: boolean): Genai.SourceFile.Job.SyncBatchJob;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.SourceFile.Job.SyncBatchJob | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.SourceFile.Job.SyncBatchJob | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.SourceFile.Job.SyncBatchJob | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.SourceFile.Job.SyncBatchJob | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.SourceFile.Job.SyncBatchJob;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.SourceFile.Job.SyncBatchJob;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.SourceFile.Job.SyncBatchJob;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.SourceFile.Job.SyncBatchJob>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.SourceFile.Job.SyncBatchJob>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.SourceFile.Job.SyncBatchJob;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.SourceFile.Job.SyncBatchJob;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.SourceFile.Job.SyncBatchJob;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.SourceFile.Job.SyncBatchJob;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.SourceFile.Job.SyncBatchJob;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.SourceFile.Job.SyncBatchJob;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.SourceFile.Job.SyncBatchJob;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.SourceFile.Job.SyncBatchJob;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.SourceFile.Job.SyncBatchJob;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.SourceFile.Job.SyncBatchJob;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.SourceFile.Job.SyncBatchJob;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.SourceFile.Job.SyncBatchJob;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.SourceFile.Job.SyncBatchJob;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.SourceFile.Job.SyncBatchJob;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.SourceFile.Job.SyncBatchJob;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.SourceFile.Job.SyncBatchJob;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.SourceFile.Job.SyncBatchJob;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.SourceFile.Job.SyncBatchJob;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.SourceFile.Job.SyncBatchJob;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.SourceFile.Job.SyncBatchJob;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.SourceFile.Job.SyncBatchJob;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.SourceFile.Job.SyncBatchJob;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.SourceFile.Job.SyncBatchJob;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.SourceFile.Job.SyncBatchJob;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.SourceFile.Job.SyncBatchJob;

    mergeJson(json: any): Genai.SourceFile.Job.SyncBatchJob;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.SourceFile.Job.SyncBatchJob;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.SourceFile.Job.SyncBatchJob;
     ...
     */
    singletonArray(): Array_Type<Genai.SourceFile.Job.SyncBatchJob>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.SourceFile.Job.SyncBatchJob> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.SourceFile.Job.SyncBatchJob> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.SourceFile.Job.SyncBatchJob>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.SourceFile.Job.SyncBatchJob> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.SourceFile.Job.SyncBatchJob> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.SourceFile.Job.SyncBatchJob> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.SourceFile.Job.SyncBatchJob>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.SourceFile.Job.SyncBatchJob>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.SourceFile.Job.SyncBatchJob;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.SourceFile.Job.SyncBatchJob;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.SourceFile.Job.SyncBatchJob;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.SourceFile.Job.SyncBatchJob;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.SourceFile.Job.SyncBatchJob;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.SourceFile.Job.SyncBatchJob;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.SourceFile.Job.SyncBatchJob | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.SourceFile.Job.SyncBatchJob;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.SourceFile.Job.SyncBatchJob;
     ...
     */
    static cachedEmptyInst(): Genai.SourceFile.Job.SyncBatchJob;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.SourceFile.Job.SyncBatchJob> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.SourceFile.Job.SyncBatchJob;
     ...
     */
    start(options?: Genai.SourceFile.Job.SyncBatchJobOptions): BatchJobStatus | null;
     ...
     */
    cleanup(options?: Genai.SourceFile.Job.SyncBatchJobOptions): void;
    ...
    cancelJob(removeResults?: boolean, force?: boolean): JobBase<BatchJobRun, BatchJobStatus, Genai.SourceFile.Job.SyncBatchJobOptions> | null;

    failJob(run: JobRun<BatchJobStatusBase>): JobBase<BatchJobRun, BatchJobStatus, Genai.SourceFile.Job.SyncBatchJobOptions> | null;
    ...
    validateStart(options?: Genai.SourceFile.Job.SyncBatchJobOptions): void;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Genai.SourceFile.Job.SyncBatchJob>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Genai.SourceFile.Job.SyncBatchJob>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Genai.SourceFile.Job.SyncBatchJob> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Genai.SourceFile.Job.SyncBatchJob>> | null;
     ...
     */
    get(include?: string): Genai.SourceFile.Job.SyncBatchJob | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Genai.SourceFile.Job.SyncBatchJob | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Genai.SourceFile.Job.SyncBatchJob;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Genai.SourceFile.Job.SyncBatchJob | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Genai.SourceFile.Job.SyncBatchJob;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.SourceFile.Job.SyncBatchJob | null;
     ...
     */
    create(spec?: UpsertSpec): Genai.SourceFile.Job.SyncBatchJob | null;
     ...
     */
    static createBatch(objs: Array_Type<Genai.SourceFile.Job.SyncBatchJob>, spec?: UpsertSpec): ObjList<Genai.SourceFile.Job.SyncBatchJob> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Genai.SourceFile.Job.SyncBatchJob>, spec?: CreateBatchObjStreamSpec): ObjList<Genai.SourceFile.Job.SyncBatchJob> | null;
     ...
     */
    update(srcObj?: Genai.SourceFile.Job.SyncBatchJob, spec?: UpsertSpec): Genai.SourceFile.Job.SyncBatchJob | null;
     ...
     */
    upsert(srcObj?: Genai.SourceFile.Job.SyncBatchJob, spec?: UpsertSpec): Genai.SourceFile.Job.SyncBatchJob | null;
     ...
     */
    merge(spec?: MergeSpec): Genai.SourceFile.Job.SyncBatchJob | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Genai.SourceFile.Job.SyncBatchJob | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Genai.SourceFile.Job.SyncBatchJob | null;
     ...
     */
    static updateBatch(objs: Array_Type<Genai.SourceFile.Job.SyncBatchJob>, srcObjs?: Array_Type<Genai.SourceFile.Job.SyncBatchJob>, spec?: UpsertSpec): ObjList<Genai.SourceFile.Job.SyncBatchJob> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Genai.SourceFile.Job.SyncBatchJob> | null>, spec?: UpsertSpec): ObjList<Genai.SourceFile.Job.SyncBatchJob> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Genai.SourceFile.Job.SyncBatchJob>, srcObjs?: Array_Type<Genai.SourceFile.Job.SyncBatchJob>, spec?: UpsertSpec): ObjList<Genai.SourceFile.Job.SyncBatchJob> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Genai.SourceFile.Job.SyncBatchJob> | null>, spec?: UpsertSpec): ObjList<Genai.SourceFile.Job.SyncBatchJob> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Genai.SourceFile.Job.SyncBatchJob>, spec?: TouchSpec): ObjList<Genai.SourceFile.Job.SyncBatchJob> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.SourceFile.Job.SyncBatchJob>, spec?: MergeSpec): ObjList<Genai.SourceFile.Job.SyncBatchJob> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.SourceFile.Job.SyncBatchJob>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.SourceFile.Job.SyncBatchJob> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Genai.SourceFile.Job.SyncBatchJob> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.SourceFile.Job.SyncBatchJob> | null;
     ...
     */
    static mergeAll(mergeObj: Genai.SourceFile.Job.SyncBatchJob, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Genai.SourceFile.Job.SyncBatchJob, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Genai.SourceFile.Job.SyncBatchJob>, spec?: UpsertSpec): ObjList<Genai.SourceFile.Job.SyncBatchJob> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Genai.SourceFile.Job.SyncBatchJob>, spec?: UpsertSpec): ObjList<Genai.SourceFile.Job.SyncBatchJob> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Genai.SourceFile.Job.SyncBatchJob | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Genai.SourceFile.Job.SyncBatchJob>): ObjList<Genai.SourceFile.Job.SyncBatchJob>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<Genai.SourceFile.Job.SyncBatchJob>): ObjList<Genai.SourceFile.Job.SyncBatchJob>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Genai.SourceFile.Job.SyncBatchJob>): ObjList<Genai.SourceFile.Job.SyncBatchJob>;
     ...
     */
    static afterCreate(objs: Array_Type<Genai.SourceFile.Job.SyncBatchJob>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Genai.SourceFile.Job.SyncBatchJob>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Genai.SourceFile.Job.SyncBatchJob>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Genai.SourceFile.Job.SyncBatchJob>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Genai.SourceFile.Job.SyncBatchJob>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.SourceFile.Job.SyncBatchJob | null;
     ...
     */
    withoutIdentity(): Genai.SourceFile.Job.SyncBatchJob | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Genai.SourceFile.Job.SyncBatchJob>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Genai.SourceFile.Job.SyncBatchJob, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Genai.SourceFile.Job.SyncBatchJob>, callback?: λFunction<Genai.SourceFile.Job.SyncBatchJob | null, Genai.SourceFile.Job.SyncBatchJob | null>): ObjList<Genai.SourceFile.Job.SyncBatchJob>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Genai.SourceFile.Job.SyncBatchJob>, callback?: λFunction<Genai.SourceFile.Job.SyncBatchJob | null, Genai.SourceFile.Job.SyncBatchJob | null>): Array_Type<ObjError> | null;
     ...
     */
    static doStart(job?: Genai.SourceFile.Job.SyncBatchJob, options?: Genai.SourceFile.Job.SyncBatchJobOptions): void;
     ...
     */
    static processBatch(batch?: Genai.SourceFile.Job.SyncBatchJobBatch, job?: Genai.SourceFile.Job.SyncBatchJob, options?: Genai.SourceFile.Job.SyncBatchJobOptions): void;
     ...
     */
    static allComplete(job: Genai.SourceFile.Job.SyncBatchJob, options?: Genai.SourceFile.Job.SyncBatchJobOptions): string | null;
     ...
     *           Options the job was run with.
     */
    static failed(job: Genai.SourceFile.Job.SyncBatchJob, status: BatchJobStatus, options?: Genai.SourceFile.Job.SyncBatchJobOptions): void;
     ...
     *        Batch to schedule.
     */
    scheduleBatch(batch?: Genai.SourceFile.Job.SyncBatchJobBatch): void;
     ...
     *        Batches to schedule.
     */
    scheduleBatches(batches?: Array_Type<Genai.SourceFile.Job.SyncBatchJobBatch>): void;
     ...
     */
    static scheduleObjBatch(job?: Genai.SourceFile.Job.SyncBatchJob, objBatch?: ObjBatch, logPrefix?: string): number | null;
