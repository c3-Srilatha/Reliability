// TypeScript definitions for the C3 type Genai.Agent.Tool.WebSearch.Config

/**
 * Config for an instance of {@link Genai.Agent.Tool.WebSearch}
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.Agent.Tool.WebSearch.Config
 */
declare namespace Genai.Agent.Tool.WebSearch {
  export interface IConfig {
     ...
     */
    initializeLambda: λFunction<Genai.Agent.Tool.WebSearch.Config, any>;

    /**
     * Lambda to search the web for information and return the results.
     */
    searchLambda: λTriFunction<any, string, string | null, Array_Type<Genai.Agent.Tool.WebSearch.Result> | Array<IGenai.Agent.Tool.WebSearch.Result> | null>;
...
declare namespace Genai.Agent.Tool.WebSearch {
  export class Config extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): Genai.Agent.Tool.WebSearch.Config;

    readonly configOverride?: string;
    withConfigOverride(configOverride: string | null): Genai.Agent.Tool.WebSearch.Config;

    readonly secretOverride?: string;
    withSecretOverride(secretOverride: string | null): Genai.Agent.Tool.WebSearch.Config;

    /**
     * Captures any issues that occurred while deserializing from filesystem
     */
    readonly issues?: Array_Type<string>;
    withIssues(issues: Array_Type<string> | Array<string> | null): Genai.Agent.Tool.WebSearch.Config;

    /**
     * Semantic name for the tool. Used for agent prompts.
     */
    readonly toolName: string;
    withToolName(toolName: string): Genai.Agent.Tool.WebSearch.Config;

    /**
     * Natural language description for the tool. Used for agent prompts.
     */
    readonly toolDescription: string;
    withToolDescription(toolDescription: string): Genai.Agent.Tool.WebSearch.Config;
    ...
    withFormattingMessage(formattingMessage: string | null): Genai.Agent.Tool.WebSearch.Config;

    /**
     * Array of {@link Genai.Agent.Tool.Example}s for this tool.
     */
    readonly examples?: Array_Type<Genai.Agent.Tool.Example>;
    withExamples(examples: Array_Type<Genai.Agent.Tool.Example> | Array<IGenai.Agent.Tool.Example> | null): Genai.Agent.Tool.WebSearch.Config;
    ...
    withUiOptions(uiOptions: IGenai.Agent.Tool.Config.UiOptions | null): Genai.Agent.Tool.WebSearch.Config;
    ...
    withOverrideRuntimeKwargs(overrideRuntimeKwargs: any | null): Genai.Agent.Tool.WebSearch.Config;

    /**
     * Tool description used by {@link Genai.Agent.Tool.MultiSourceSynthesizer}
     */
    readonly descriptionForMultiTool?: string;
    withDescriptionForMultiTool(descriptionForMultiTool: string | null): Genai.Agent.Tool.WebSearch.Config;

    /**
     * Description for data returned by {@link Genai.Agent.Tool.DataRetriever.Output}
     */
    readonly retrievedDataDescription?: Array_Type<string>;
    withRetrievedDataDescription(retrievedDataDescription: Array_Type<string> | Array<string> | null): Genai.Agent.Tool.WebSearch.Config;

    /**
     * Prompt for {@link Genai.Agent.Tool.DataRetriever#formatData}
     */
    readonly formatDataPrompt?: Genai.Prompt;
    withFormatDataPrompt(formatDataPrompt: IGenai.Prompt | null): Genai.Agent.Tool.WebSearch.Config;

    /**
     * Lambda to initialize the tool and return the native instance of the client to perform the search.
     */
    readonly initializeLambda: λFunction<Genai.Agent.Tool.WebSearch.Config, any>;
    withInitializeLambda(initializeLambda: λFunction<Genai.Agent.Tool.WebSearch.Config, any>): Genai.Agent.Tool.WebSearch.Config;

    /**
     * Lambda to search the web for information and return the results.
     */
    readonly searchLambda: λTriFunction<any, string, string | null, Array_Type<Genai.Agent.Tool.WebSearch.Result> | null>;
    withSearchLambda(searchLambda: λTriFunction<any, string, string | null, Array_Type<Genai.Agent.Tool.WebSearch.Result> | Array<IGenai.Agent.Tool.WebSearch.Result> | null>): Genai.Agent.Tool.WebSearch.Config;

    /**
     * The authentication key for search client.
     */
    readonly apiKey: string;
    withApiKey(apiKey: string): Genai.Agent.Tool.WebSearch.Config;

    /**
     * The endpoint for the search client.
     */
    readonly endpoint: string;
    withEndpoint(endpoint: string): Genai.Agent.Tool.WebSearch.Config;

    /**
     * Parameters to use for the search API. Consult your API documentation for the supported parameters.
     */
    readonly params?: any;
    withParams(params: any | null): Genai.Agent.Tool.WebSearch.Config;

    /**
     * Name of the {@link Genai.UnstructuredQuery.Engine.ModelConfig} to use
     */
    readonly llmConfigName: string;
    withLlmConfigName(llmConfigName: string): Genai.Agent.Tool.WebSearch.Config;

    /**
     * The prompt to use for generating the answer to the user query
     */
    readonly answerPrompt: Genai.Prompt;
    withAnswerPrompt(answerPrompt: IGenai.Prompt): Genai.Agent.Tool.WebSearch.Config;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.Agent.Tool.WebSearch.Config | null;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.Agent.Tool.WebSearch.Config | null;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.Agent.Tool.WebSearch.Config;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.Agent.Tool.WebSearch.Config;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.Agent.Tool.WebSearch.Config;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.Agent.Tool.WebSearch.Config;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.Agent.Tool.WebSearch.Config | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.Agent.Tool.WebSearch.Config | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.Agent.Tool.WebSearch.Config | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.Agent.Tool.WebSearch.Config | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.Agent.Tool.WebSearch.Config;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Agent.Tool.WebSearch.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Agent.Tool.WebSearch.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Agent.Tool.WebSearch.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Agent.Tool.WebSearch.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.Agent.Tool.WebSearch.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Agent.Tool.WebSearch.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Agent.Tool.WebSearch.Config;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.Agent.Tool.WebSearch.Config;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.Agent.Tool.WebSearch.Config;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.Agent.Tool.WebSearch.Config;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.Agent.Tool.WebSearch.Config;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.Agent.Tool.WebSearch.Config;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.Agent.Tool.WebSearch.Config;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.Agent.Tool.WebSearch.Config;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.Agent.Tool.WebSearch.Config;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.Agent.Tool.WebSearch.Config;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.Agent.Tool.WebSearch.Config;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.Agent.Tool.WebSearch.Config;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.Agent.Tool.WebSearch.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.Agent.Tool.WebSearch.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.Agent.Tool.WebSearch.Config;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.Agent.Tool.WebSearch.Config;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.Agent.Tool.WebSearch.Config;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.Agent.Tool.WebSearch.Config;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.Agent.Tool.WebSearch.Config;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.Agent.Tool.WebSearch.Config;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.Agent.Tool.WebSearch.Config;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.Agent.Tool.WebSearch.Config;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.Agent.Tool.WebSearch.Config;

    mergeJson(json: any): Genai.Agent.Tool.WebSearch.Config;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.Agent.Tool.WebSearch.Config;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.Agent.Tool.WebSearch.Config;
     ...
     */
    singletonArray(): Array_Type<Genai.Agent.Tool.WebSearch.Config>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.Agent.Tool.WebSearch.Config> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.Agent.Tool.WebSearch.Config> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.Agent.Tool.WebSearch.Config>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.Agent.Tool.WebSearch.Config> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.Agent.Tool.WebSearch.Config> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.Agent.Tool.WebSearch.Config> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.Agent.Tool.WebSearch.Config>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.Agent.Tool.WebSearch.Config>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.Agent.Tool.WebSearch.Config;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.Agent.Tool.WebSearch.Config;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.Agent.Tool.WebSearch.Config;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.Agent.Tool.WebSearch.Config;
     ...
     */
    static cachedEmptyInst(): Genai.Agent.Tool.WebSearch.Config;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.Agent.Tool.WebSearch.Config> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.Agent.Tool.WebSearch.Config;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.Agent.Tool.WebSearch.Config | null;
     ...
     */
    static allCached(): Stream<Genai.Agent.Tool.WebSearch.Config> | null;
     ...
     */
    static find(filter?: string): Stream<Genai.Agent.Tool.WebSearch.Config> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<Genai.Agent.Tool.WebSearch.Config> | null;

    /**
     * @return cached instance.
     */
    getCached(): Genai.Agent.Tool.WebSearch.Config | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string): Genai.Agent.Tool.WebSearch.Config | null;
     ...
     */
    static produce(key: string): Genai.Agent.Tool.WebSearch.Config | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, Genai.Agent.Tool.WebSearch.Config> | null;
     ...
     */
    getConfig(): Genai.Agent.Tool.WebSearch.Config;
     ...
     */
    getSecret(): Genai.Agent.Tool.WebSearch.Config;
     ...
     */
    withConfigKey(configKey: string): Genai.Agent.Tool.WebSearch.Config;

    /**
     * @return copy without config key.
     */
    withoutConfigKey(): Genai.Agent.Tool.WebSearch.Config;

    /**
     * @return return cached config instance for provided config key.
     */
    static forConfigKey(configKey: string): Genai.Agent.Tool.WebSearch.Config | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string>): Stream<Genai.Agent.Tool.WebSearch.Config> | null;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: Genai.Agent.Tool.WebSearch.Config, override?: string): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): Genai.Agent.Tool.WebSearch.Config | null;
