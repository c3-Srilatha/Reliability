// TypeScript definitions for the C3 type Genai.Agent.Tool.DataRetriever.Config

/**
 * Config for tools which are {@link Genai.Agent.Tool.DataRetriever}s
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.Agent.Tool.DataRetriever.Config
 */
declare namespace Genai.Agent.Tool.DataRetriever {
  export interface IConfig {
     ...
     */
    doNotGenerateAnswerFromLlm?: boolean;
     ...
     */
    textAnswerFromDataModelConfigName?: string;
...
declare namespace Genai.Agent.Tool.DataRetriever {
  export class Config extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): Genai.Agent.Tool.DataRetriever.Config;

    readonly configOverride?: string;
    withConfigOverride(configOverride: string | null): Genai.Agent.Tool.DataRetriever.Config;

    readonly secretOverride?: string;
    withSecretOverride(secretOverride: string | null): Genai.Agent.Tool.DataRetriever.Config;

    /**
     * Captures any issues that occurred while deserializing from filesystem
     */
    readonly issues?: Array_Type<string>;
    withIssues(issues: Array_Type<string> | Array<string> | null): Genai.Agent.Tool.DataRetriever.Config;

    /**
     * Semantic name for the tool. Used for agent prompts.
     */
    readonly toolName: string;
    withToolName(toolName: string): Genai.Agent.Tool.DataRetriever.Config;

    /**
     * Natural language description for the tool. Used for agent prompts.
     */
    readonly toolDescription: string;
    withToolDescription(toolDescription: string): Genai.Agent.Tool.DataRetriever.Config;
    ...
    withFormattingMessage(formattingMessage: string | null): Genai.Agent.Tool.DataRetriever.Config;

    /**
     * Array of {@link Genai.Agent.Tool.Example}s for this tool.
     */
    readonly examples?: Array_Type<Genai.Agent.Tool.Example>;
    withExamples(examples: Array_Type<Genai.Agent.Tool.Example> | Array<IGenai.Agent.Tool.Example> | null): Genai.Agent.Tool.DataRetriever.Config;
    ...
    withUiOptions(uiOptions: IGenai.Agent.Tool.Config.UiOptions | null): Genai.Agent.Tool.DataRetriever.Config;
    ...
    withOverrideRuntimeKwargs(overrideRuntimeKwargs: any | null): Genai.Agent.Tool.DataRetriever.Config;

    /**
     * If true, then the few-shot implementation of the tool will be used for spec generation. Currently only supported
     * for EvalQueryTool.
     */
    readonly useFewShotSpecGeneration?: boolean;
    withUseFewShotSpecGeneration(useFewShotSpecGeneration: boolean): Genai.Agent.Tool.DataRetriever.Config;

    /**
     * Prompt used for getting a natural language answer to the question from structured data.
     */
    readonly textAnswerFromDataPrompt: string;
    withTextAnswerFromDataPrompt(textAnswerFromDataPrompt: string): Genai.Agent.Tool.DataRetriever.Config;

    /**
     * If set to true, we do not generate a textual answer from llm.
     * The default is to generate a textual answer from llm using the prompt from #textAnswerFromDataPrompt.
     */
    readonly doNotGenerateAnswerFromLlm?: boolean;
    withDoNotGenerateAnswerFromLlm(doNotGenerateAnswerFromLlm: boolean): Genai.Agent.Tool.DataRetriever.Config;

    /**
     * The number of rows that is passed to the LLM model for generating the natural language answer when #doNotGenerateAnswerFromLlm is enabled.
     * This config is only used in EvalQueryTool.
     */
    readonly numRowsForLlm?: number;
    withNumRowsForLlm(numRowsForLlm: number | null): Genai.Agent.Tool.DataRetriever.Config;

    /**
     * Name of {@link Genai.UnstructuredQuery.Engine.ModelConfig} that should be used for getting a natural language answer from structured data.
     */
    readonly textAnswerFromDataModelConfigName?: string;
    withTextAnswerFromDataModelConfigName(textAnswerFromDataModelConfigName: string | null): Genai.Agent.Tool.DataRetriever.Config;

    /**
     * Tool description used by {@link Genai.Agent.Tool.MultiSourceSynthesizer}
     */
    readonly descriptionForMultiTool?: string;
    withDescriptionForMultiTool(descriptionForMultiTool: string | null): Genai.Agent.Tool.DataRetriever.Config;

    /**
     * Description for data returned by {@link Genai.Agent.Tool.DataRetriever.Output}
     */
    readonly retrievedDataDescription?: Array_Type<string>;
    withRetrievedDataDescription(retrievedDataDescription: Array_Type<string> | Array<string> | null): Genai.Agent.Tool.DataRetriever.Config;

    /**
     * Prompt for {@link Genai.Agent.Tool.DataRetriever#formatData}
     */
    readonly formatDataPrompt?: Genai.Prompt;
    withFormatDataPrompt(formatDataPrompt: IGenai.Prompt | null): Genai.Agent.Tool.DataRetriever.Config;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.Agent.Tool.DataRetriever.Config | null;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.Agent.Tool.DataRetriever.Config | null;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.Agent.Tool.DataRetriever.Config;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.Agent.Tool.DataRetriever.Config;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.Agent.Tool.DataRetriever.Config;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.Agent.Tool.DataRetriever.Config;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.Agent.Tool.DataRetriever.Config | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.Agent.Tool.DataRetriever.Config | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.Agent.Tool.DataRetriever.Config | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.Agent.Tool.DataRetriever.Config | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.Agent.Tool.DataRetriever.Config;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Agent.Tool.DataRetriever.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Agent.Tool.DataRetriever.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Agent.Tool.DataRetriever.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Agent.Tool.DataRetriever.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.Agent.Tool.DataRetriever.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Agent.Tool.DataRetriever.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Agent.Tool.DataRetriever.Config;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.Agent.Tool.DataRetriever.Config;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.Agent.Tool.DataRetriever.Config;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.Agent.Tool.DataRetriever.Config;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.Agent.Tool.DataRetriever.Config;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.Agent.Tool.DataRetriever.Config;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.Agent.Tool.DataRetriever.Config;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.Agent.Tool.DataRetriever.Config;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.Agent.Tool.DataRetriever.Config;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.Agent.Tool.DataRetriever.Config;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.Agent.Tool.DataRetriever.Config;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.Agent.Tool.DataRetriever.Config;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.Agent.Tool.DataRetriever.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.Agent.Tool.DataRetriever.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.Agent.Tool.DataRetriever.Config;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.Agent.Tool.DataRetriever.Config;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.Agent.Tool.DataRetriever.Config;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.Agent.Tool.DataRetriever.Config;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.Agent.Tool.DataRetriever.Config;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.Agent.Tool.DataRetriever.Config;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.Agent.Tool.DataRetriever.Config;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.Agent.Tool.DataRetriever.Config;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.Agent.Tool.DataRetriever.Config;

    mergeJson(json: any): Genai.Agent.Tool.DataRetriever.Config;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.Agent.Tool.DataRetriever.Config;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.Agent.Tool.DataRetriever.Config;
     ...
     */
    singletonArray(): Array_Type<Genai.Agent.Tool.DataRetriever.Config>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.Agent.Tool.DataRetriever.Config> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.Agent.Tool.DataRetriever.Config> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.Agent.Tool.DataRetriever.Config>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.Agent.Tool.DataRetriever.Config> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.Agent.Tool.DataRetriever.Config> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.Agent.Tool.DataRetriever.Config> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.Agent.Tool.DataRetriever.Config>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.Agent.Tool.DataRetriever.Config>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.Agent.Tool.DataRetriever.Config;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.Agent.Tool.DataRetriever.Config;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.Agent.Tool.DataRetriever.Config;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.Agent.Tool.DataRetriever.Config;
     ...
     */
    static cachedEmptyInst(): Genai.Agent.Tool.DataRetriever.Config;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.Agent.Tool.DataRetriever.Config> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.Agent.Tool.DataRetriever.Config;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.Agent.Tool.DataRetriever.Config | null;
     ...
     */
    static allCached(): Stream<Genai.Agent.Tool.DataRetriever.Config> | null;
     ...
     */
    static find(filter?: string): Stream<Genai.Agent.Tool.DataRetriever.Config> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<Genai.Agent.Tool.DataRetriever.Config> | null;

    /**
     * @return cached instance.
     */
    getCached(): Genai.Agent.Tool.DataRetriever.Config | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string): Genai.Agent.Tool.DataRetriever.Config | null;
     ...
     */
    static produce(key: string): Genai.Agent.Tool.DataRetriever.Config | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, Genai.Agent.Tool.DataRetriever.Config> | null;
     ...
     */
    getConfig(): Genai.Agent.Tool.DataRetriever.Config;
     ...
     */
    getSecret(): Genai.Agent.Tool.DataRetriever.Config;
     ...
     */
    withConfigKey(configKey: string): Genai.Agent.Tool.DataRetriever.Config;

    /**
     * @return copy without config key.
     */
    withoutConfigKey(): Genai.Agent.Tool.DataRetriever.Config;

    /**
     * @return return cached config instance for provided config key.
     */
    static forConfigKey(configKey: string): Genai.Agent.Tool.DataRetriever.Config | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string>): Stream<Genai.Agent.Tool.DataRetriever.Config> | null;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: Genai.Agent.Tool.DataRetriever.Config, override?: string): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): Genai.Agent.Tool.DataRetriever.Config | null;
     ...
     */
    removeSecrets(): Genai.Agent.Tool.DataRetriever.Config | null;

    /**
     * @return this config with only secret values.
     */
    removeNonSecrets(): Genai.Agent.Tool.DataRetriever.Config | null;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    validate(): Genai.Agent.Tool.DataRetriever.Config;
     ...
     */
    static setRecursive(configJson: any, useSetConfigValues?: boolean, override?: string): Genai.Agent.Tool.DataRetriever.Config;
