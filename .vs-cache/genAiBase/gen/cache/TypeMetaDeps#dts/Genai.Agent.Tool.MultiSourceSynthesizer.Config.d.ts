// TypeScript definitions for the C3 type Genai.Agent.Tool.MultiSourceSynthesizer.Config

/**
 * Config for {@link Genai.Agent.Tool.MultiSourceSynthesizer}
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.Agent.Tool.MultiSourceSynthesizer.Config
 */
declare namespace Genai.Agent.Tool.MultiSourceSynthesizer {
  export interface IConfig {
     ...
     */
    formattingMessage?: string;

    /**
     * Array of {@link Genai.Agent.Tool.Example}s for this tool.
     */
    examples?: Array_Type<Genai.Agent.Tool.Example> | Array<IGenai.Agent.Tool.Example>;
     ...
     */
    uiOptions?: IGenai.Agent.Tool.Config.UiOptions;
     ...
     */
    nativeToolDocumentationOverride?: any;
     ...
     */
    serializeInputsForFunctionCall?: boolean;
     ...
     */
    sourceFilteringPrompt?: IGenai.Prompt;
     ...
     */
    answerPrompt: IGenai.Prompt;

    /**
     * The template prompt used for describing the user query
     */
    queryDescriptionPrompt: IGenai.Prompt;
  }
}
...
declare namespace Genai.Agent.Tool.MultiSourceSynthesizer {
  export class Config extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): Genai.Agent.Tool.MultiSourceSynthesizer.Config;
    ...
    withConfigOverride(configOverride: string | null): Genai.Agent.Tool.MultiSourceSynthesizer.Config;

    static readonly configOverride?: string;

    readonly secretOverride?: string;
    withSecretOverride(secretOverride: string | null): Genai.Agent.Tool.MultiSourceSynthesizer.Config;
    ...
    withIssues(issues: Array_Type<string> | Array<string> | null): Genai.Agent.Tool.MultiSourceSynthesizer.Config;
    ...
    withToolName(toolName: string): Genai.Agent.Tool.MultiSourceSynthesizer.Config;
    ...
    withToolDescription(toolDescription: string): Genai.Agent.Tool.MultiSourceSynthesizer.Config;
     ...
     * e.g. "\n[SYSTEM MESSAGE: {toolName} requires inputing a start date and end date.]"
     */
    readonly formattingMessage?: string;
    withFormattingMessage(formattingMessage: string | null): Genai.Agent.Tool.MultiSourceSynthesizer.Config;
     ...
     * e.g. "\n[SYSTEM MESSAGE: {toolName} requires inputing a start date and end date.]"
     */
    static readonly formattingMessage?: string;

    /**
     * Array of {@link Genai.Agent.Tool.Example}s for this tool.
     */
    readonly examples?: Array_Type<Genai.Agent.Tool.Example>;
    withExamples(examples: Array_Type<Genai.Agent.Tool.Example> | Array<IGenai.Agent.Tool.Example> | null): Genai.Agent.Tool.MultiSourceSynthesizer.Config;

    /**
     * Array of {@link Genai.Agent.Tool.Example}s for this tool.
     */
    static readonly examples?: Array_Type<Genai.Agent.Tool.Example>;

    /**
     * Configuration for how this will be shown as a UI drop-down option if {@link Genai.Agent.Config}
     * uiToolOptions includes this tool.
     */
    readonly uiOptions?: Genai.Agent.Tool.Config.UiOptions;
    withUiOptions(uiOptions: IGenai.Agent.Tool.Config.UiOptions | null): Genai.Agent.Tool.MultiSourceSynthesizer.Config;

    /**
     * Configuration for how this will be shown as a UI drop-down option if {@link Genai.Agent.Config}
     * uiToolOptions includes this tool.
     */
    static readonly uiOptions?: Genai.Agent.Tool.Config.UiOptions;
     ...
     * ```
     */
    readonly overrideRuntimeKwargs?: any;
    withOverrideRuntimeKwargs(overrideRuntimeKwargs: any | null): Genai.Agent.Tool.MultiSourceSynthesizer.Config;
     ...
     * ```
     */
    static readonly overrideRuntimeKwargs?: any;
     ...
     * representation (or json.dumps from python) of the dictionary instead of the dictionary itself.
     */
    readonly nativeToolDocumentationOverride?: any;
    withNativeToolDocumentationOverride(nativeToolDocumentationOverride: any | null): Genai.Agent.Tool.MultiSourceSynthesizer.Config;
     ...
     * representation (or json.dumps from python) of the dictionary instead of the dictionary itself.
     */
    static readonly nativeToolDocumentationOverride?: any;

    /**
     * If true, the {@link Genai.Agent.Planner} will serialize inputs for the function call.
     * Otherwise, the in-memory references will be passed.
     */
    readonly serializeInputsForFunctionCall?: boolean;
    withSerializeInputsForFunctionCall(serializeInputsForFunctionCall: boolean): Genai.Agent.Tool.MultiSourceSynthesizer.Config;

    /**
     * If true, the {@link Genai.Agent.Planner} will serialize inputs for the function call.
     * Otherwise, the in-memory references will be passed.
     */
    static readonly serializeInputsForFunctionCall?: boolean;
    ...
    withToolkitName(toolkitName: string): Genai.Agent.Tool.MultiSourceSynthesizer.Config;
     ...
     * produced them) from all of the tools to get an answer.
     */
    readonly useSourceAnswers?: boolean;
    withUseSourceAnswers(useSourceAnswers: boolean): Genai.Agent.Tool.MultiSourceSynthesizer.Config;
     ...
     * produced them) from all of the tools to get an answer.
     */
    static readonly useSourceAnswers?: boolean;

    /**
     * By default, the synthesizer will get the data sources/information from all of its available tools and use that data to get the synthesized answer.
     * If set to true, the synthesizer will `run` each tool so that each can also provide its own answer. The synthesizer's answer will still be composed from the raw data retrieved and not the sub-tools answers.
     */
    readonly produceSubtoolAnswers?: boolean;
    withProduceSubtoolAnswers(produceSubtoolAnswers: boolean): Genai.Agent.Tool.MultiSourceSynthesizer.Config;

    /**
     * By default, the synthesizer will get the data sources/information from all of its available tools and use that data to get the synthesized answer.
     * If set to true, the synthesizer will `run` each tool so that each can also provide its own answer. The synthesizer's answer will still be composed from the raw data retrieved and not the sub-tools answers.
     */
    static readonly produceSubtoolAnswers?: boolean;
     ...
     * using threading found in {@link Genai.PyUtil#runLambdaTasksInParallel}
     */
    readonly useParallelization?: boolean;
    withUseParallelization(useParallelization: boolean): Genai.Agent.Tool.MultiSourceSynthesizer.Config;
     ...
     * using threading found in {@link Genai.PyUtil#runLambdaTasksInParallel}
     */
    static readonly useParallelization?: boolean;
     ...
     * outputs is potentially relevant to the user's question and only include those which are when generating the final answer.
     */
    readonly sourceFilteringPrompt?: Genai.Prompt;
    withSourceFilteringPrompt(sourceFilteringPrompt: IGenai.Prompt | null): Genai.Agent.Tool.MultiSourceSynthesizer.Config;
     ...
     * outputs is potentially relevant to the user's question and only include those which are when generating the final answer.
     */
    static readonly sourceFilteringPrompt?: Genai.Prompt;

    /**
     * The LLM model used to answer the question. Must correspond to a {@link Genai.UnstructuredQuery.Engine.ModelConfig}.
     */
    readonly llmModelName?: string;
    withLlmModelName(llmModelName: string | null): Genai.Agent.Tool.MultiSourceSynthesizer.Config;

    /**
     * The LLM model used to answer the question. Must correspond to a {@link Genai.UnstructuredQuery.Engine.ModelConfig}.
     */
    static readonly llmModelName?: string;

    /**
     * The template prompt used for generating the LLM-based answer
     */
    readonly answerPrompt: Genai.Prompt;
    withAnswerPrompt(answerPrompt: IGenai.Prompt): Genai.Agent.Tool.MultiSourceSynthesizer.Config;

    /**
     * The template prompt used for generating the LLM-based answer
     */
    static readonly answerPrompt: Genai.Prompt;

    /**
     * The template prompt used for describing the user query
     */
    readonly queryDescriptionPrompt: Genai.Prompt;
    withQueryDescriptionPrompt(queryDescriptionPrompt: IGenai.Prompt): Genai.Agent.Tool.MultiSourceSynthesizer.Config;

    /**
     * The template prompt used for describing the user query
     */
    static readonly queryDescriptionPrompt: Genai.Prompt;
     ...
     */
    static inst(): Genai.Agent.Tool.MultiSourceSynthesizer.Config;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.Agent.Tool.MultiSourceSynthesizer.Config | null;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.Agent.Tool.MultiSourceSynthesizer.Config | null;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.Agent.Tool.MultiSourceSynthesizer.Config;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.Agent.Tool.MultiSourceSynthesizer.Config;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.Agent.Tool.MultiSourceSynthesizer.Config;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.Agent.Tool.MultiSourceSynthesizer.Config;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.Agent.Tool.MultiSourceSynthesizer.Config | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.Agent.Tool.MultiSourceSynthesizer.Config | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.Agent.Tool.MultiSourceSynthesizer.Config | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.Agent.Tool.MultiSourceSynthesizer.Config | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.Agent.Tool.MultiSourceSynthesizer.Config;
     ...
     * This method is used during live metadata update
     */
    static replaceType(old: Type, new_: Type): Genai.Agent.Tool.MultiSourceSynthesizer.Config;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Agent.Tool.MultiSourceSynthesizer.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Agent.Tool.MultiSourceSynthesizer.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Agent.Tool.MultiSourceSynthesizer.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Agent.Tool.MultiSourceSynthesizer.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Agent.Tool.MultiSourceSynthesizer.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Agent.Tool.MultiSourceSynthesizer.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Agent.Tool.MultiSourceSynthesizer.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Agent.Tool.MultiSourceSynthesizer.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.Agent.Tool.MultiSourceSynthesizer.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.Agent.Tool.MultiSourceSynthesizer.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Agent.Tool.MultiSourceSynthesizer.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Agent.Tool.MultiSourceSynthesizer.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Agent.Tool.MultiSourceSynthesizer.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Agent.Tool.MultiSourceSynthesizer.Config;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.Agent.Tool.MultiSourceSynthesizer.Config;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    static validateObj(): Genai.Agent.Tool.MultiSourceSynthesizer.Config;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.Agent.Tool.MultiSourceSynthesizer.Config;
     ...
     * @see #defaultField
     */
    static withField(field: string, value: any, doNotConvert?: boolean): Genai.Agent.Tool.MultiSourceSynthesizer.Config;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.Agent.Tool.MultiSourceSynthesizer.Config;
     ...
     * @see #defaultField
     */
    static withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.Agent.Tool.MultiSourceSynthesizer.Config;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.Agent.Tool.MultiSourceSynthesizer.Config;
     ...
     * @return new Obj
     */
    static withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.Agent.Tool.MultiSourceSynthesizer.Config;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.Agent.Tool.MultiSourceSynthesizer.Config;
     ...
     * @return new Obj
     */
    static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.Agent.Tool.MultiSourceSynthesizer.Config;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.Agent.Tool.MultiSourceSynthesizer.Config;
     ...
     * @see #withoutField
     */
    static withoutFieldAtPath(path: string): Genai.Agent.Tool.MultiSourceSynthesizer.Config;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.Agent.Tool.MultiSourceSynthesizer.Config;
     ...
     * @see #removeField
     */
    static withoutField(field: string): Genai.Agent.Tool.MultiSourceSynthesizer.Config;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.Agent.Tool.MultiSourceSynthesizer.Config;
     ...
     * @see #removeField
     */
    static withoutField(field: FieldType): Genai.Agent.Tool.MultiSourceSynthesizer.Config;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.Agent.Tool.MultiSourceSynthesizer.Config;
     ...
     * @return new Obj with removed fields
     */
    static withoutFields(fields: Array_Type<string>): Genai.Agent.Tool.MultiSourceSynthesizer.Config;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.Agent.Tool.MultiSourceSynthesizer.Config;
     ...
     * @return new Obj with removed fields
     */
    static withoutFieldsByType(fields: Array_Type<FieldType>): Genai.Agent.Tool.MultiSourceSynthesizer.Config;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.Agent.Tool.MultiSourceSynthesizer.Config;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    static withoutSecretFields(): Genai.Agent.Tool.MultiSourceSynthesizer.Config;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.Agent.Tool.MultiSourceSynthesizer.Config;
     ...
     * @see FieldType#defaultValue
     */
    static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.Agent.Tool.MultiSourceSynthesizer.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.Agent.Tool.MultiSourceSynthesizer.Config;
     ...
     * @see #unsetField
     */
    static defaultField(field: string): Genai.Agent.Tool.MultiSourceSynthesizer.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.Agent.Tool.MultiSourceSynthesizer.Config;
     ...
     * @see #unsetField
     */
    static defaultField(field: FieldType): Genai.Agent.Tool.MultiSourceSynthesizer.Config;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.Agent.Tool.MultiSourceSynthesizer.Config;
     ...
     * @see #removeField
     */
    static unsetField(field: string): Genai.Agent.Tool.MultiSourceSynthesizer.Config;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.Agent.Tool.MultiSourceSynthesizer.Config;
     ...
     * @see #removeField
     */
    static unsetField(field: FieldType): Genai.Agent.Tool.MultiSourceSynthesizer.Config;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.Agent.Tool.MultiSourceSynthesizer.Config;
     ...
     * @see #unsetField
     */
    static removeField(field: string): Genai.Agent.Tool.MultiSourceSynthesizer.Config;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.Agent.Tool.MultiSourceSynthesizer.Config;
     ...
     * @see #unsetField
     */
    static removeField(field: FieldType): Genai.Agent.Tool.MultiSourceSynthesizer.Config;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.Agent.Tool.MultiSourceSynthesizer.Config;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.Agent.Tool.MultiSourceSynthesizer.Config;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.Agent.Tool.MultiSourceSynthesizer.Config;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj, otherFieldsFilter: Type): Genai.Agent.Tool.MultiSourceSynthesizer.Config;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.Agent.Tool.MultiSourceSynthesizer.Config;
     ...
     *        the same key or index.
     */
    static mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.Agent.Tool.MultiSourceSynthesizer.Config;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.Agent.Tool.MultiSourceSynthesizer.Config;
     ...
     * traverse child reference and collection fields.
     */
    static mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.Agent.Tool.MultiSourceSynthesizer.Config;

    mergeJson(json: any): Genai.Agent.Tool.MultiSourceSynthesizer.Config;

    static mergeJson(json: any): Genai.Agent.Tool.MultiSourceSynthesizer.Config;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.Agent.Tool.MultiSourceSynthesizer.Config;
     ...
     * @return Obj with child references merged
     */
    static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.Agent.Tool.MultiSourceSynthesizer.Config;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.Agent.Tool.MultiSourceSynthesizer.Config;
     ...
     * references with same name and collection elements at same index or key.
     */
    static sumObj(other: Obj, deep?: boolean): Genai.Agent.Tool.MultiSourceSynthesizer.Config;
     ...
     */
    singletonArray(): Array_Type<Genai.Agent.Tool.MultiSourceSynthesizer.Config>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonArray(): Array_Type<Genai.Agent.Tool.MultiSourceSynthesizer.Config>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.Agent.Tool.MultiSourceSynthesizer.Config> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.Agent.Tool.MultiSourceSynthesizer.Config> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.Agent.Tool.MultiSourceSynthesizer.Config>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonSet(): Set_Type<Genai.Agent.Tool.MultiSourceSynthesizer.Config>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.Agent.Tool.MultiSourceSynthesizer.Config> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.Agent.Tool.MultiSourceSynthesizer.Config> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.Agent.Tool.MultiSourceSynthesizer.Config> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.Agent.Tool.MultiSourceSynthesizer.Config>;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    static toBuilder(): ObjBuilder<Genai.Agent.Tool.MultiSourceSynthesizer.Config>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.Agent.Tool.MultiSourceSynthesizer.Config>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.Agent.Tool.MultiSourceSynthesizer.Config;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.Agent.Tool.MultiSourceSynthesizer.Config;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.Agent.Tool.MultiSourceSynthesizer.Config;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.Agent.Tool.MultiSourceSynthesizer.Config;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    static afterMake(): Genai.Agent.Tool.MultiSourceSynthesizer.Config;
     ...
     */
    static cachedEmptyInst(): Genai.Agent.Tool.MultiSourceSynthesizer.Config;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.Agent.Tool.MultiSourceSynthesizer.Config> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.Agent.Tool.MultiSourceSynthesizer.Config;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.Agent.Tool.MultiSourceSynthesizer.Config | null;
     ...
     */
    static allCached(): Stream<Genai.Agent.Tool.MultiSourceSynthesizer.Config> | null;
     ...
     */
    static find(filter?: string): Stream<Genai.Agent.Tool.MultiSourceSynthesizer.Config> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<Genai.Agent.Tool.MultiSourceSynthesizer.Config> | null;

    /**
     * @return cached instance.
     */
    getCached(): Genai.Agent.Tool.MultiSourceSynthesizer.Config | null;

    /**
     * @return cached instance.
     */
    static getCached(): Genai.Agent.Tool.MultiSourceSynthesizer.Config | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string): Genai.Agent.Tool.MultiSourceSynthesizer.Config | null;
     ...
     */
    static produce(key: string): Genai.Agent.Tool.MultiSourceSynthesizer.Config | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, Genai.Agent.Tool.MultiSourceSynthesizer.Config> | null;
     ...
     */
    getConfig(): Genai.Agent.Tool.MultiSourceSynthesizer.Config;
     ...
     * Note that typical pattern is to use Configurable#config instead of this method.
     */
    static getConfig(): Genai.Agent.Tool.MultiSourceSynthesizer.Config;
     ...
     */
    getSecret(): Genai.Agent.Tool.MultiSourceSynthesizer.Config;
     ...
     * Note that typical pattern is to use Configurable#configWithSecrets instead of this method.
     */
    static getSecret(): Genai.Agent.Tool.MultiSourceSynthesizer.Config;
     ...
     */
    withConfigKey(configKey: string): Genai.Agent.Tool.MultiSourceSynthesizer.Config;
     ...
     *     config.configKey() => "folder1/abc"
     */
    static withConfigKey(configKey: string): Genai.Agent.Tool.MultiSourceSynthesizer.Config;

    /**
     * @return copy without config key.
     */
    withoutConfigKey(): Genai.Agent.Tool.MultiSourceSynthesizer.Config;

    /**
     * @return copy without config key.
     */
    static withoutConfigKey(): Genai.Agent.Tool.MultiSourceSynthesizer.Config;

    /**
     * @return return cached config instance for provided config key.
     */
    static forConfigKey(configKey: string): Genai.Agent.Tool.MultiSourceSynthesizer.Config | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string>): Stream<Genai.Agent.Tool.MultiSourceSynthesizer.Config> | null;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: Genai.Agent.Tool.MultiSourceSynthesizer.Config, override?: string): void;
     ...
     * @see setConfigValue
     */
    static setConfigValues(from: Genai.Agent.Tool.MultiSourceSynthesizer.Config, override?: string): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): Genai.Agent.Tool.MultiSourceSynthesizer.Config | null;
     ...
     */
    removeSecrets(): Genai.Agent.Tool.MultiSourceSynthesizer.Config | null;

    /**
     * @return this config without any secret values.
     */
    static removeSecrets(): Genai.Agent.Tool.MultiSourceSynthesizer.Config | null;

    /**
     * @return this config with only secret values.
     */
    removeNonSecrets(): Genai.Agent.Tool.MultiSourceSynthesizer.Config | null;

    /**
     * @return this config with only secret values.
     */
    static removeNonSecrets(): Genai.Agent.Tool.MultiSourceSynthesizer.Config | null;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    validate(): Genai.Agent.Tool.MultiSourceSynthesizer.Config;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    static validate(): Genai.Agent.Tool.MultiSourceSynthesizer.Config;
