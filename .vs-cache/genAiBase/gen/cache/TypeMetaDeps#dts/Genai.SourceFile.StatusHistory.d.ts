// TypeScript definitions for the C3 type Genai.SourceFile.StatusHistory

/**
 * The history of statuses of a {@link Genai.SourceFile} throughout its data ingestion lifecycle.
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.SourceFile.StatusHistory
 */
 ...
 */
declare namespace Genai.SourceFile {
  export class StatusHistory extends Obj  {

    /**
     * Text for transformed error, likely generated by the #transformErrorString method
     */
    readonly transformedError?: string;
    withTransformedError(transformedError: string | null): Genai.SourceFile.StatusHistory;

    /**
     * Timestamp for the value.
     */
    readonly timestamp: DateTime;
    withTimestamp(timestamp: DateTime | Date | string): Genai.SourceFile.StatusHistory;

    /**
     * Parent/owning obj instance.
     */
    readonly parent: Genai.SourceFile;
    withParent(parent: IGenai.SourceFile): Genai.SourceFile.StatusHistory;

    /**
     * The status of the {@link Genai.SourceFile}
     */
    readonly value: string;
    withValue(value: string): Genai.SourceFile.StatusHistory;
    ...
    withErrorMessage(errorMessage: string | null): Genai.SourceFile.StatusHistory;
    ...
    withLastProcessedBy(lastProcessedBy: string | null): Genai.SourceFile.StatusHistory;
     ...
     */
    readonly id: string;
    withId(id: string): Genai.SourceFile.StatusHistory;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Genai.SourceFile.StatusHistory;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): Genai.SourceFile.StatusHistory;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Genai.SourceFile.StatusHistory;
    ...
    withVersion(version: number | null): Genai.SourceFile.StatusHistory;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Genai.SourceFile.StatusHistory;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.SourceFile.StatusHistory | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.SourceFile.StatusHistory | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.SourceFile.StatusHistory | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.SourceFile.StatusHistory | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.SourceFile.StatusHistory;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.SourceFile.StatusHistory;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.SourceFile.StatusHistory;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.SourceFile.StatusHistory>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.SourceFile.StatusHistory>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.SourceFile.StatusHistory;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.SourceFile.StatusHistory;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.SourceFile.StatusHistory;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.SourceFile.StatusHistory;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.SourceFile.StatusHistory;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.SourceFile.StatusHistory;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.SourceFile.StatusHistory;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.SourceFile.StatusHistory;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.SourceFile.StatusHistory;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.SourceFile.StatusHistory;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.SourceFile.StatusHistory;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.SourceFile.StatusHistory;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.SourceFile.StatusHistory;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.SourceFile.StatusHistory;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.SourceFile.StatusHistory;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.SourceFile.StatusHistory;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.SourceFile.StatusHistory;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.SourceFile.StatusHistory;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.SourceFile.StatusHistory;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.SourceFile.StatusHistory;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.SourceFile.StatusHistory;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.SourceFile.StatusHistory;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.SourceFile.StatusHistory;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.SourceFile.StatusHistory;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.SourceFile.StatusHistory;

    mergeJson(json: any): Genai.SourceFile.StatusHistory;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.SourceFile.StatusHistory;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.SourceFile.StatusHistory;
     ...
     */
    singletonArray(): Array_Type<Genai.SourceFile.StatusHistory>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.SourceFile.StatusHistory> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.SourceFile.StatusHistory> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.SourceFile.StatusHistory>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.SourceFile.StatusHistory> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.SourceFile.StatusHistory> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.SourceFile.StatusHistory> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.SourceFile.StatusHistory>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.SourceFile.StatusHistory>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.SourceFile.StatusHistory;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.SourceFile.StatusHistory;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.SourceFile.StatusHistory;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.SourceFile.StatusHistory;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.SourceFile.StatusHistory;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.SourceFile.StatusHistory;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.SourceFile.StatusHistory | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.SourceFile.StatusHistory;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.SourceFile.StatusHistory;
     ...
     */
    static cachedEmptyInst(): Genai.SourceFile.StatusHistory;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.SourceFile.StatusHistory> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.SourceFile.StatusHistory;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Genai.SourceFile.StatusHistory>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Genai.SourceFile.StatusHistory>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Genai.SourceFile.StatusHistory> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Genai.SourceFile.StatusHistory>> | null;
     ...
     */
    get(include?: string): Genai.SourceFile.StatusHistory | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Genai.SourceFile.StatusHistory | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Genai.SourceFile.StatusHistory;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Genai.SourceFile.StatusHistory | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Genai.SourceFile.StatusHistory;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.SourceFile.StatusHistory | null;
     ...
     */
    create(spec?: UpsertSpec): Genai.SourceFile.StatusHistory | null;
     ...
     */
    static createBatch(objs: Array_Type<Genai.SourceFile.StatusHistory>, spec?: UpsertSpec): ObjList<Genai.SourceFile.StatusHistory> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Genai.SourceFile.StatusHistory>, spec?: CreateBatchObjStreamSpec): ObjList<Genai.SourceFile.StatusHistory> | null;
     ...
     */
    update(srcObj?: Genai.SourceFile.StatusHistory, spec?: UpsertSpec): Genai.SourceFile.StatusHistory | null;
     ...
     */
    upsert(srcObj?: Genai.SourceFile.StatusHistory, spec?: UpsertSpec): Genai.SourceFile.StatusHistory | null;
     ...
     */
    merge(spec?: MergeSpec): Genai.SourceFile.StatusHistory | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Genai.SourceFile.StatusHistory | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Genai.SourceFile.StatusHistory | null;
     ...
     */
    static updateBatch(objs: Array_Type<Genai.SourceFile.StatusHistory>, srcObjs?: Array_Type<Genai.SourceFile.StatusHistory>, spec?: UpsertSpec): ObjList<Genai.SourceFile.StatusHistory> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Genai.SourceFile.StatusHistory> | null>, spec?: UpsertSpec): ObjList<Genai.SourceFile.StatusHistory> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Genai.SourceFile.StatusHistory>, srcObjs?: Array_Type<Genai.SourceFile.StatusHistory>, spec?: UpsertSpec): ObjList<Genai.SourceFile.StatusHistory> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Genai.SourceFile.StatusHistory> | null>, spec?: UpsertSpec): ObjList<Genai.SourceFile.StatusHistory> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Genai.SourceFile.StatusHistory>, spec?: TouchSpec): ObjList<Genai.SourceFile.StatusHistory> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.SourceFile.StatusHistory>, spec?: MergeSpec): ObjList<Genai.SourceFile.StatusHistory> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.SourceFile.StatusHistory>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.SourceFile.StatusHistory> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Genai.SourceFile.StatusHistory> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.SourceFile.StatusHistory> | null;
     ...
     */
    static mergeAll(mergeObj: Genai.SourceFile.StatusHistory, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Genai.SourceFile.StatusHistory, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Genai.SourceFile.StatusHistory>, spec?: UpsertSpec): ObjList<Genai.SourceFile.StatusHistory> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Genai.SourceFile.StatusHistory>, spec?: UpsertSpec): ObjList<Genai.SourceFile.StatusHistory> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Genai.SourceFile.StatusHistory | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Genai.SourceFile.StatusHistory>): ObjList<Genai.SourceFile.StatusHistory>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<Genai.SourceFile.StatusHistory>): ObjList<Genai.SourceFile.StatusHistory>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Genai.SourceFile.StatusHistory>): ObjList<Genai.SourceFile.StatusHistory>;
     ...
     */
    static afterCreate(objs: Array_Type<Genai.SourceFile.StatusHistory>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Genai.SourceFile.StatusHistory>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Genai.SourceFile.StatusHistory>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Genai.SourceFile.StatusHistory>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Genai.SourceFile.StatusHistory>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.SourceFile.StatusHistory | null;
     ...
     */
    withoutIdentity(): Genai.SourceFile.StatusHistory | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Genai.SourceFile.StatusHistory>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Genai.SourceFile.StatusHistory, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Genai.SourceFile.StatusHistory>, callback?: λFunction<Genai.SourceFile.StatusHistory | null, Genai.SourceFile.StatusHistory | null>): ObjList<Genai.SourceFile.StatusHistory>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Genai.SourceFile.StatusHistory>, callback?: λFunction<Genai.SourceFile.StatusHistory | null, Genai.SourceFile.StatusHistory | null>): Array_Type<ObjError> | null;
