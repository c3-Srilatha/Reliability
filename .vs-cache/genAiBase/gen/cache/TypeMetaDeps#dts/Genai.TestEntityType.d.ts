// TypeScript definitions for the C3 type Genai.TestEntityType

/**
 * Used to test that both entities & non-entities are properly searched when building the Genai graph data model (cf.
 * {@link Genai.StructuredData.Config#makeDataModelGraph}).
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.TestEntityType
 */
declare namespace Genai {
  export interface ITestEntityType {
    ...
    /**
     * An int representing the data stored in the entity type which is to be retrieved.
     */
    value?: number;

    /**
     * Refers to a non-entity type that we want to search & get values from.
     */
    nonEntityField?: IGenai.TestNonEntityType;

    /**
     * Stored calc field.
     */
    storedCalcField?: boolean;

    /**
     * Read calc field.
     */
    readCalcField?: boolean;

    /**
     * A collection field of primitive string.
     */
    primitiveCollectionField?: Array_Type<string> | Array<string>;

    /**
     * A collection of foreing key collections.
     */
    fkeyCollection?: Array_Type<Genai.TestEntityType> | Array<IGenai.TestEntityType>;

    /**
     * Foreign key.
     */
    referredBy?: IGenai.TestEntityType;
  }
}
 ...
 * {@link Genai.StructuredData.Config#makeDataModelGraph}).
 *
 * @remarks this represents a made instance of Genai.TestEntityType
 */
declare namespace Genai {
  export class TestEntityType extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): Genai.TestEntityType;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Genai.TestEntityType;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): Genai.TestEntityType;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Genai.TestEntityType;
    ...
    withVersion(version: number | null): Genai.TestEntityType;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Genai.TestEntityType;

    /**
     * An int representing the data stored in the entity type which is to be retrieved.
     */
    readonly value?: number;
    withValue(value: number | null): Genai.TestEntityType;

    /**
     * Refers to a non-entity type that we want to search & get values from.
     */
    readonly nonEntityField?: Genai.TestNonEntityType;
    withNonEntityField(nonEntityField: IGenai.TestNonEntityType | null): Genai.TestEntityType;

    /**
     * Stored calc field.
     */
    readonly storedCalcField?: boolean;
    withStoredCalcField(storedCalcField: boolean): Genai.TestEntityType;

    /**
     * Read calc field.
     */
    readonly readCalcField?: boolean;
    withReadCalcField(readCalcField: boolean): Genai.TestEntityType;

    /**
     * A collection field of primitive string.
     */
    readonly primitiveCollectionField?: Array_Type<string>;
    withPrimitiveCollectionField(primitiveCollectionField: Array_Type<string> | Array<string> | null): Genai.TestEntityType;

    /**
     * A collection of foreing key collections.
     */
    readonly fkeyCollection?: Array_Type<Genai.TestEntityType>;
    withFkeyCollection(fkeyCollection: Array_Type<Genai.TestEntityType> | Array<IGenai.TestEntityType> | null): Genai.TestEntityType;

    /**
     * Foreign key.
     */
    readonly referredBy?: Genai.TestEntityType;
    withReferredBy(referredBy: IGenai.TestEntityType | null): Genai.TestEntityType;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.TestEntityType | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.TestEntityType | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.TestEntityType | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.TestEntityType | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.TestEntityType;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.TestEntityType;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.TestEntityType;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.TestEntityType>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.TestEntityType>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.TestEntityType;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.TestEntityType;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.TestEntityType;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.TestEntityType;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.TestEntityType;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.TestEntityType;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.TestEntityType;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.TestEntityType;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.TestEntityType;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.TestEntityType;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.TestEntityType;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.TestEntityType;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.TestEntityType;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.TestEntityType;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.TestEntityType;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.TestEntityType;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.TestEntityType;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.TestEntityType;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.TestEntityType;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.TestEntityType;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.TestEntityType;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.TestEntityType;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.TestEntityType;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.TestEntityType;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.TestEntityType;

    mergeJson(json: any): Genai.TestEntityType;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.TestEntityType;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.TestEntityType;
     ...
     */
    singletonArray(): Array_Type<Genai.TestEntityType>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.TestEntityType> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.TestEntityType> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.TestEntityType>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.TestEntityType> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.TestEntityType> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.TestEntityType> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.TestEntityType>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.TestEntityType>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.TestEntityType;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.TestEntityType;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.TestEntityType;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.TestEntityType;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.TestEntityType;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.TestEntityType;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.TestEntityType | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.TestEntityType;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.TestEntityType;
     ...
     */
    static cachedEmptyInst(): Genai.TestEntityType;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.TestEntityType> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.TestEntityType;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Genai.TestEntityType>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Genai.TestEntityType>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Genai.TestEntityType> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Genai.TestEntityType>> | null;
     ...
     */
    get(include?: string): Genai.TestEntityType | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Genai.TestEntityType | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Genai.TestEntityType;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Genai.TestEntityType | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Genai.TestEntityType;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.TestEntityType | null;
     ...
     */
    create(spec?: UpsertSpec): Genai.TestEntityType | null;
     ...
     */
    static createBatch(objs: Array_Type<Genai.TestEntityType>, spec?: UpsertSpec): ObjList<Genai.TestEntityType> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Genai.TestEntityType>, spec?: CreateBatchObjStreamSpec): ObjList<Genai.TestEntityType> | null;
     ...
     */
    update(srcObj?: Genai.TestEntityType, spec?: UpsertSpec): Genai.TestEntityType | null;
     ...
     */
    upsert(srcObj?: Genai.TestEntityType, spec?: UpsertSpec): Genai.TestEntityType | null;
     ...
     */
    merge(spec?: MergeSpec): Genai.TestEntityType | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Genai.TestEntityType | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Genai.TestEntityType | null;
     ...
     */
    static updateBatch(objs: Array_Type<Genai.TestEntityType>, srcObjs?: Array_Type<Genai.TestEntityType>, spec?: UpsertSpec): ObjList<Genai.TestEntityType> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Genai.TestEntityType> | null>, spec?: UpsertSpec): ObjList<Genai.TestEntityType> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Genai.TestEntityType>, srcObjs?: Array_Type<Genai.TestEntityType>, spec?: UpsertSpec): ObjList<Genai.TestEntityType> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Genai.TestEntityType> | null>, spec?: UpsertSpec): ObjList<Genai.TestEntityType> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Genai.TestEntityType>, spec?: TouchSpec): ObjList<Genai.TestEntityType> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.TestEntityType>, spec?: MergeSpec): ObjList<Genai.TestEntityType> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.TestEntityType>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.TestEntityType> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Genai.TestEntityType> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.TestEntityType> | null;
     ...
     */
    static mergeAll(mergeObj: Genai.TestEntityType, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Genai.TestEntityType, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Genai.TestEntityType>, spec?: UpsertSpec): ObjList<Genai.TestEntityType> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Genai.TestEntityType>, spec?: UpsertSpec): ObjList<Genai.TestEntityType> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Genai.TestEntityType | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Genai.TestEntityType>): ObjList<Genai.TestEntityType>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<Genai.TestEntityType>): ObjList<Genai.TestEntityType>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Genai.TestEntityType>): ObjList<Genai.TestEntityType>;
     ...
     */
    static afterCreate(objs: Array_Type<Genai.TestEntityType>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Genai.TestEntityType>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Genai.TestEntityType>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Genai.TestEntityType>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Genai.TestEntityType>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.TestEntityType | null;
     ...
     */
    withoutIdentity(): Genai.TestEntityType | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Genai.TestEntityType>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Genai.TestEntityType, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Genai.TestEntityType>, callback?: λFunction<Genai.TestEntityType | null, Genai.TestEntityType | null>): ObjList<Genai.TestEntityType>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Genai.TestEntityType>, callback?: λFunction<Genai.TestEntityType | null, Genai.TestEntityType | null>): Array_Type<ObjError> | null;
