// TypeScript definitions for the C3 type Genai.Prompt.TestConfig

/**
 * Test type for having prompts in configs.
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.Prompt.TestConfig
 */
declare namespace Genai.Prompt {
  export interface ITestConfig {
     ...
     * Test field
     */
    jsonInConfig: IGenai.Prompt;

    /**
     * Test field
     */
    stringInConfig: IGenai.Prompt;

    /**
     * Test field
     */
    entityIdInConfig: IGenai.Prompt;

    /**
     * Test field
     */
    filePathInConfig: IGenai.Prompt;
  }
}
 ...
 */
declare namespace Genai.Prompt {
  export class TestConfig extends Obj  {

    /**
     * The unique and required id of this instance.
     */
    readonly id: string;
    withId(id: string): Genai.Prompt.TestConfig;

    readonly configOverride?: string;
    withConfigOverride(configOverride: string | null): Genai.Prompt.TestConfig;

    readonly secretOverride?: string;
    withSecretOverride(secretOverride: string | null): Genai.Prompt.TestConfig;

    /**
     * Captures any issues that occurred while deserializing from filesystem
     */
    readonly issues?: Array_Type<string>;
    withIssues(issues: Array_Type<string> | Array<string> | null): Genai.Prompt.TestConfig;

    /**
     * Test field
     */
    readonly jsonInConfig: Genai.Prompt;
    withJsonInConfig(jsonInConfig: IGenai.Prompt): Genai.Prompt.TestConfig;

    /**
     * Test field
     */
    readonly stringInConfig: Genai.Prompt;
    withStringInConfig(stringInConfig: IGenai.Prompt): Genai.Prompt.TestConfig;

    /**
     * Test field
     */
    readonly entityIdInConfig: Genai.Prompt;
    withEntityIdInConfig(entityIdInConfig: IGenai.Prompt): Genai.Prompt.TestConfig;

    /**
     * Test field
     */
    readonly filePathInConfig: Genai.Prompt;
    withFilePathInConfig(filePathInConfig: IGenai.Prompt): Genai.Prompt.TestConfig;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.Prompt.TestConfig | null;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.Prompt.TestConfig | null;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.Prompt.TestConfig;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.Prompt.TestConfig;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.Prompt.TestConfig;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.Prompt.TestConfig;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.Prompt.TestConfig | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.Prompt.TestConfig | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.Prompt.TestConfig | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.Prompt.TestConfig | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.Prompt.TestConfig;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Prompt.TestConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Prompt.TestConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Prompt.TestConfig>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Prompt.TestConfig>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.Prompt.TestConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Prompt.TestConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Prompt.TestConfig;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.Prompt.TestConfig;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.Prompt.TestConfig;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.Prompt.TestConfig;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.Prompt.TestConfig;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.Prompt.TestConfig;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.Prompt.TestConfig;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.Prompt.TestConfig;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.Prompt.TestConfig;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.Prompt.TestConfig;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.Prompt.TestConfig;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.Prompt.TestConfig;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.Prompt.TestConfig;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.Prompt.TestConfig;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.Prompt.TestConfig;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.Prompt.TestConfig;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.Prompt.TestConfig;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.Prompt.TestConfig;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.Prompt.TestConfig;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.Prompt.TestConfig;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.Prompt.TestConfig;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.Prompt.TestConfig;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.Prompt.TestConfig;

    mergeJson(json: any): Genai.Prompt.TestConfig;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.Prompt.TestConfig;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.Prompt.TestConfig;
     ...
     */
    singletonArray(): Array_Type<Genai.Prompt.TestConfig>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.Prompt.TestConfig> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.Prompt.TestConfig> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.Prompt.TestConfig>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.Prompt.TestConfig> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.Prompt.TestConfig> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.Prompt.TestConfig> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.Prompt.TestConfig>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.Prompt.TestConfig>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.Prompt.TestConfig;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.Prompt.TestConfig;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.Prompt.TestConfig;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.Prompt.TestConfig;
     ...
     */
    static cachedEmptyInst(): Genai.Prompt.TestConfig;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.Prompt.TestConfig> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.Prompt.TestConfig;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.Prompt.TestConfig | null;
     ...
     */
    static allCached(): Stream<Genai.Prompt.TestConfig> | null;
     ...
     */
    static find(filter?: string): Stream<Genai.Prompt.TestConfig> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<Genai.Prompt.TestConfig> | null;

    /**
     * @return cached instance.
     */
    getCached(): Genai.Prompt.TestConfig | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string): Genai.Prompt.TestConfig | null;
     ...
     */
    static produce(key: string): Genai.Prompt.TestConfig | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, Genai.Prompt.TestConfig> | null;
     ...
     */
    getConfig(): Genai.Prompt.TestConfig;
     ...
     */
    getSecret(): Genai.Prompt.TestConfig;
     ...
     */
    withConfigKey(configKey: string): Genai.Prompt.TestConfig;

    /**
     * @return copy without config key.
     */
    withoutConfigKey(): Genai.Prompt.TestConfig;

    /**
     * @return return cached config instance for provided config key.
     */
    static forConfigKey(configKey: string): Genai.Prompt.TestConfig | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string>): Stream<Genai.Prompt.TestConfig> | null;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: Genai.Prompt.TestConfig, override?: string): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): Genai.Prompt.TestConfig | null;
