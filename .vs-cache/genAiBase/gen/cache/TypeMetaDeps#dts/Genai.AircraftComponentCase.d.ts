// TypeScript definitions for the C3 type Genai.AircraftComponentCase
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.AircraftComponentCase
 */
declare namespace Genai {
  export interface IAircraftComponentCase {
    ...
    /**
     * The component this maintenance case has been generated for.
     */
    component: IGenai.AircraftComponent;

    /**
     * The details about this maintenance case.
     */
    details?: string;

    /**
     * The date when this aircraft component maintenance case was created. Should be used to answer questions about the date when the maintenance case was created.
     */
    createdTimestamp: DateTime | Date | string;

    /**
     * The date when this aircraft component maintenance case was closed. Should be used to answer questions about the date when the maintenance case was closed.
     */
    closedTimestamp?: DateTime | Date | string;

    /**
     * The status of this aircraft component maintenance case.  The status progression is `Open` to `Assigned` to `Closed`,
     */
    status?: string;

    /**
     * The age of the maintenance case in days.
     */
    caseAge?: number;
  }
}
 ...
 * A maintenance case for a component. Use this to answer questions about aircraft component cases, which often relate to case details, case creation timestamps, case closing timestamps, statuses and case ages.
 *
 * @remarks this represents a made instance of Genai.AircraftComponentCase
 */
declare namespace Genai {
  export class AircraftComponentCase extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): Genai.AircraftComponentCase;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Genai.AircraftComponentCase;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): Genai.AircraftComponentCase;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Genai.AircraftComponentCase;
    ...
    withVersion(version: number | null): Genai.AircraftComponentCase;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Genai.AircraftComponentCase;

    /**
     * The component this maintenance case has been generated for.
     */
    readonly component: Genai.AircraftComponent;
    withComponent(component: IGenai.AircraftComponent): Genai.AircraftComponentCase;

    /**
     * The details about this maintenance case.
     */
    readonly details?: string;
    withDetails(details: string | null): Genai.AircraftComponentCase;

    /**
     * The date when this aircraft component maintenance case was created. Should be used to answer questions about the date when the maintenance case was created.
     */
    readonly createdTimestamp: DateTime;
    withCreatedTimestamp(createdTimestamp: DateTime | Date | string): Genai.AircraftComponentCase;

    /**
     * The date when this aircraft component maintenance case was closed. Should be used to answer questions about the date when the maintenance case was closed.
     */
    readonly closedTimestamp?: DateTime;
    withClosedTimestamp(closedTimestamp: DateTime | Date | string | null): Genai.AircraftComponentCase;

    /**
     * The status of this aircraft component maintenance case.  The status progression is `Open` to `Assigned` to `Closed`,
     */
    readonly status?: string;
    withStatus(status: string | null): Genai.AircraftComponentCase;

    /**
     * The age of the maintenance case in days.
     */
    readonly caseAge?: number;
    withCaseAge(caseAge: number | null): Genai.AircraftComponentCase;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.AircraftComponentCase | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.AircraftComponentCase | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.AircraftComponentCase | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.AircraftComponentCase | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.AircraftComponentCase;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.AircraftComponentCase;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.AircraftComponentCase;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.AircraftComponentCase>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.AircraftComponentCase>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.AircraftComponentCase;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.AircraftComponentCase;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.AircraftComponentCase;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.AircraftComponentCase;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.AircraftComponentCase;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.AircraftComponentCase;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.AircraftComponentCase;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.AircraftComponentCase;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.AircraftComponentCase;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.AircraftComponentCase;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.AircraftComponentCase;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.AircraftComponentCase;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.AircraftComponentCase;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.AircraftComponentCase;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.AircraftComponentCase;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.AircraftComponentCase;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.AircraftComponentCase;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.AircraftComponentCase;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.AircraftComponentCase;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.AircraftComponentCase;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.AircraftComponentCase;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.AircraftComponentCase;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.AircraftComponentCase;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.AircraftComponentCase;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.AircraftComponentCase;

    mergeJson(json: any): Genai.AircraftComponentCase;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.AircraftComponentCase;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.AircraftComponentCase;
     ...
     */
    singletonArray(): Array_Type<Genai.AircraftComponentCase>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.AircraftComponentCase> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.AircraftComponentCase> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.AircraftComponentCase>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.AircraftComponentCase> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.AircraftComponentCase> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.AircraftComponentCase> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.AircraftComponentCase>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.AircraftComponentCase>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.AircraftComponentCase;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.AircraftComponentCase;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.AircraftComponentCase;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.AircraftComponentCase;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.AircraftComponentCase;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.AircraftComponentCase;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.AircraftComponentCase | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.AircraftComponentCase;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.AircraftComponentCase;
     ...
     */
    static cachedEmptyInst(): Genai.AircraftComponentCase;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.AircraftComponentCase> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.AircraftComponentCase;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Genai.AircraftComponentCase>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Genai.AircraftComponentCase>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Genai.AircraftComponentCase> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Genai.AircraftComponentCase>> | null;
     ...
     */
    get(include?: string): Genai.AircraftComponentCase | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Genai.AircraftComponentCase | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Genai.AircraftComponentCase;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Genai.AircraftComponentCase | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Genai.AircraftComponentCase;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.AircraftComponentCase | null;
     ...
     */
    create(spec?: UpsertSpec): Genai.AircraftComponentCase | null;
     ...
     */
    static createBatch(objs: Array_Type<Genai.AircraftComponentCase>, spec?: UpsertSpec): ObjList<Genai.AircraftComponentCase> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Genai.AircraftComponentCase>, spec?: CreateBatchObjStreamSpec): ObjList<Genai.AircraftComponentCase> | null;
     ...
     */
    update(srcObj?: Genai.AircraftComponentCase, spec?: UpsertSpec): Genai.AircraftComponentCase | null;
     ...
     */
    upsert(srcObj?: Genai.AircraftComponentCase, spec?: UpsertSpec): Genai.AircraftComponentCase | null;
     ...
     */
    merge(spec?: MergeSpec): Genai.AircraftComponentCase | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Genai.AircraftComponentCase | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Genai.AircraftComponentCase | null;
     ...
     */
    static updateBatch(objs: Array_Type<Genai.AircraftComponentCase>, srcObjs?: Array_Type<Genai.AircraftComponentCase>, spec?: UpsertSpec): ObjList<Genai.AircraftComponentCase> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Genai.AircraftComponentCase> | null>, spec?: UpsertSpec): ObjList<Genai.AircraftComponentCase> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Genai.AircraftComponentCase>, srcObjs?: Array_Type<Genai.AircraftComponentCase>, spec?: UpsertSpec): ObjList<Genai.AircraftComponentCase> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Genai.AircraftComponentCase> | null>, spec?: UpsertSpec): ObjList<Genai.AircraftComponentCase> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Genai.AircraftComponentCase>, spec?: TouchSpec): ObjList<Genai.AircraftComponentCase> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.AircraftComponentCase>, spec?: MergeSpec): ObjList<Genai.AircraftComponentCase> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.AircraftComponentCase>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.AircraftComponentCase> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Genai.AircraftComponentCase> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.AircraftComponentCase> | null;
     ...
     */
    static mergeAll(mergeObj: Genai.AircraftComponentCase, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Genai.AircraftComponentCase, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Genai.AircraftComponentCase>, spec?: UpsertSpec): ObjList<Genai.AircraftComponentCase> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Genai.AircraftComponentCase>, spec?: UpsertSpec): ObjList<Genai.AircraftComponentCase> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Genai.AircraftComponentCase | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Genai.AircraftComponentCase>): ObjList<Genai.AircraftComponentCase>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<Genai.AircraftComponentCase>): ObjList<Genai.AircraftComponentCase>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Genai.AircraftComponentCase>): ObjList<Genai.AircraftComponentCase>;
     ...
     */
    static afterCreate(objs: Array_Type<Genai.AircraftComponentCase>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Genai.AircraftComponentCase>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Genai.AircraftComponentCase>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Genai.AircraftComponentCase>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Genai.AircraftComponentCase>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.AircraftComponentCase | null;
     ...
     */
    withoutIdentity(): Genai.AircraftComponentCase | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Genai.AircraftComponentCase>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Genai.AircraftComponentCase, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Genai.AircraftComponentCase>, callback?: λFunction<Genai.AircraftComponentCase | null, Genai.AircraftComponentCase | null>): ObjList<Genai.AircraftComponentCase>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Genai.AircraftComponentCase>, callback?: λFunction<Genai.AircraftComponentCase | null, Genai.AircraftComponentCase | null>): Array_Type<ObjError> | null;
