// TypeScript definitions for the C3 type Genai.Agent.Dynamic.Callback

/**
 * Entity type for managing OnStepCallbacks for {@link Genai.Agent.Dynamic}.
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.Agent.Dynamic.Callback
 */
declare namespace Genai.Agent.Dynamic {
  export interface ICallback {
     ...
     */
    configKwargs?: Map_Type<string, any> | {[key: string]: any};
 ...
 */
declare namespace Genai.Agent.Dynamic {
  export class Callback extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): Genai.Agent.Dynamic.Callback;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Genai.Agent.Dynamic.Callback;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): Genai.Agent.Dynamic.Callback;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Genai.Agent.Dynamic.Callback;
    ...
    withVersion(version: number | null): Genai.Agent.Dynamic.Callback;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Genai.Agent.Dynamic.Callback;

    /**
     * Reference to a Type's method
     */
    readonly callback: ActionRef;
    withCallback(callback: IActionRef): Genai.Agent.Dynamic.Callback;

    /**
     * Type of this callback. See {@link Genai.Agent.Dynamic.Callback.Type}.
     */
    readonly callbackType: string;
    withCallbackType(callbackType: string): Genai.Agent.Dynamic.Callback;
     ...
     * configKwargs = {"dataModelGraph": dataModelGraph}.
     */
    readonly configKwargs?: Map_Type<string, any>;
    withConfigKwargs(configKwargs: Map_Type<string, any> | {[key: string]: any} | null): Genai.Agent.Dynamic.Callback;
    ...
    withDescription(description: string | null): Genai.Agent.Dynamic.Callback;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.Agent.Dynamic.Callback | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.Agent.Dynamic.Callback | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.Agent.Dynamic.Callback | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.Agent.Dynamic.Callback | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.Agent.Dynamic.Callback;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Agent.Dynamic.Callback;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Agent.Dynamic.Callback;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Agent.Dynamic.Callback>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Agent.Dynamic.Callback>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.Agent.Dynamic.Callback;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Agent.Dynamic.Callback;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Agent.Dynamic.Callback;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.Agent.Dynamic.Callback;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.Agent.Dynamic.Callback;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.Agent.Dynamic.Callback;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.Agent.Dynamic.Callback;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.Agent.Dynamic.Callback;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.Agent.Dynamic.Callback;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.Agent.Dynamic.Callback;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.Agent.Dynamic.Callback;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.Agent.Dynamic.Callback;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.Agent.Dynamic.Callback;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.Agent.Dynamic.Callback;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.Agent.Dynamic.Callback;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.Agent.Dynamic.Callback;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.Agent.Dynamic.Callback;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.Agent.Dynamic.Callback;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.Agent.Dynamic.Callback;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.Agent.Dynamic.Callback;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.Agent.Dynamic.Callback;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.Agent.Dynamic.Callback;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.Agent.Dynamic.Callback;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.Agent.Dynamic.Callback;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.Agent.Dynamic.Callback;

    mergeJson(json: any): Genai.Agent.Dynamic.Callback;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.Agent.Dynamic.Callback;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.Agent.Dynamic.Callback;
     ...
     */
    singletonArray(): Array_Type<Genai.Agent.Dynamic.Callback>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.Agent.Dynamic.Callback> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.Agent.Dynamic.Callback> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.Agent.Dynamic.Callback>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.Agent.Dynamic.Callback> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.Agent.Dynamic.Callback> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.Agent.Dynamic.Callback> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.Agent.Dynamic.Callback>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.Agent.Dynamic.Callback>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.Agent.Dynamic.Callback;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.Agent.Dynamic.Callback;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.Agent.Dynamic.Callback;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.Agent.Dynamic.Callback;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.Agent.Dynamic.Callback;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.Agent.Dynamic.Callback;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.Agent.Dynamic.Callback | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.Agent.Dynamic.Callback;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.Agent.Dynamic.Callback;
     ...
     */
    static cachedEmptyInst(): Genai.Agent.Dynamic.Callback;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.Agent.Dynamic.Callback> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.Agent.Dynamic.Callback;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Genai.Agent.Dynamic.Callback>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Genai.Agent.Dynamic.Callback>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Genai.Agent.Dynamic.Callback> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Genai.Agent.Dynamic.Callback>> | null;
     ...
     */
    get(include?: string): Genai.Agent.Dynamic.Callback | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Genai.Agent.Dynamic.Callback | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Genai.Agent.Dynamic.Callback;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Genai.Agent.Dynamic.Callback | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Genai.Agent.Dynamic.Callback;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.Agent.Dynamic.Callback | null;
     ...
     */
    create(spec?: UpsertSpec): Genai.Agent.Dynamic.Callback | null;
     ...
     */
    static createBatch(objs: Array_Type<Genai.Agent.Dynamic.Callback>, spec?: UpsertSpec): ObjList<Genai.Agent.Dynamic.Callback> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Genai.Agent.Dynamic.Callback>, spec?: CreateBatchObjStreamSpec): ObjList<Genai.Agent.Dynamic.Callback> | null;
     ...
     */
    update(srcObj?: Genai.Agent.Dynamic.Callback, spec?: UpsertSpec): Genai.Agent.Dynamic.Callback | null;
     ...
     */
    upsert(srcObj?: Genai.Agent.Dynamic.Callback, spec?: UpsertSpec): Genai.Agent.Dynamic.Callback | null;
     ...
     */
    merge(spec?: MergeSpec): Genai.Agent.Dynamic.Callback | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Genai.Agent.Dynamic.Callback | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Genai.Agent.Dynamic.Callback | null;
     ...
     */
    static updateBatch(objs: Array_Type<Genai.Agent.Dynamic.Callback>, srcObjs?: Array_Type<Genai.Agent.Dynamic.Callback>, spec?: UpsertSpec): ObjList<Genai.Agent.Dynamic.Callback> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Genai.Agent.Dynamic.Callback> | null>, spec?: UpsertSpec): ObjList<Genai.Agent.Dynamic.Callback> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Genai.Agent.Dynamic.Callback>, srcObjs?: Array_Type<Genai.Agent.Dynamic.Callback>, spec?: UpsertSpec): ObjList<Genai.Agent.Dynamic.Callback> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Genai.Agent.Dynamic.Callback> | null>, spec?: UpsertSpec): ObjList<Genai.Agent.Dynamic.Callback> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Genai.Agent.Dynamic.Callback>, spec?: TouchSpec): ObjList<Genai.Agent.Dynamic.Callback> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.Agent.Dynamic.Callback>, spec?: MergeSpec): ObjList<Genai.Agent.Dynamic.Callback> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.Agent.Dynamic.Callback>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.Agent.Dynamic.Callback> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Genai.Agent.Dynamic.Callback> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.Agent.Dynamic.Callback> | null;
     ...
     */
    static mergeAll(mergeObj: Genai.Agent.Dynamic.Callback, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Genai.Agent.Dynamic.Callback, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Genai.Agent.Dynamic.Callback>, spec?: UpsertSpec): ObjList<Genai.Agent.Dynamic.Callback> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Genai.Agent.Dynamic.Callback>, spec?: UpsertSpec): ObjList<Genai.Agent.Dynamic.Callback> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Genai.Agent.Dynamic.Callback | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Genai.Agent.Dynamic.Callback>): ObjList<Genai.Agent.Dynamic.Callback>;
     ...
     */
    static beforeUpdate(objs: Array_Type<Genai.Agent.Dynamic.Callback>): ObjList<Genai.Agent.Dynamic.Callback>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Genai.Agent.Dynamic.Callback>): ObjList<Genai.Agent.Dynamic.Callback>;
     ...
     */
    static afterCreate(objs: Array_Type<Genai.Agent.Dynamic.Callback>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Genai.Agent.Dynamic.Callback>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Genai.Agent.Dynamic.Callback>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Genai.Agent.Dynamic.Callback>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Genai.Agent.Dynamic.Callback>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.Agent.Dynamic.Callback | null;
     ...
     */
    withoutIdentity(): Genai.Agent.Dynamic.Callback | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Genai.Agent.Dynamic.Callback>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Genai.Agent.Dynamic.Callback, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Genai.Agent.Dynamic.Callback>, callback?: λFunction<Genai.Agent.Dynamic.Callback | null, Genai.Agent.Dynamic.Callback | null>): ObjList<Genai.Agent.Dynamic.Callback>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Genai.Agent.Dynamic.Callback>, callback?: λFunction<Genai.Agent.Dynamic.Callback | null, Genai.Agent.Dynamic.Callback | null>): Array_Type<ObjError> | null;
