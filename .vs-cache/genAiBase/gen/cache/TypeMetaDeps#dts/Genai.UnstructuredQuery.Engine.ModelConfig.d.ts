// TypeScript definitions for the C3 type Genai.UnstructuredQuery.Engine.ModelConfig

/**
 * Config for how {@link Genai.UnstructuredQuery.Engine} should use the llm model.
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.UnstructuredQuery.Engine.ModelConfig
 */
 ...
 * Config for how {@link Genai.UnstructuredQuery.Engine} should use the llm model.
 *
 * @remarks this represents a made instance of Genai.UnstructuredQuery.Engine.ModelConfig
 */
declare namespace Genai.UnstructuredQuery.Engine {
  export class ModelConfig extends Obj  {

    /**
     * The unique and required name of this instance.
     */
    readonly name: string;
    withName(name: string): Genai.UnstructuredQuery.Engine.ModelConfig;

    readonly configOverride?: string;
    withConfigOverride(configOverride: string | null): Genai.UnstructuredQuery.Engine.ModelConfig;

    readonly secretOverride?: string;
    withSecretOverride(secretOverride: string | null): Genai.UnstructuredQuery.Engine.ModelConfig;

    /**
     * Captures any issues that occurred while deserializing from filesystem
     */
    readonly issues?: Array_Type<string>;
    withIssues(issues: Array_Type<string> | Array<string> | null): Genai.UnstructuredQuery.Engine.ModelConfig;

    /**
     * Get the user friendly name for the LLM instance. This will be used in the UI.
     */
    readonly userFriendlyName?: string;
    withUserFriendlyName(userFriendlyName: string | null): Genai.UnstructuredQuery.Engine.ModelConfig;

    /**
     * The name of the deployment to use for the llm model.
     */
    readonly llmDeployment: string;
    withLlmDeployment(llmDeployment: string): Genai.UnstructuredQuery.Engine.ModelConfig;

    /**
     * The {@link Genai.Prompt} that can be used to generate prompts for the LLM.
     */
    readonly prompt?: Genai.Prompt;
    withPrompt(prompt: IGenai.Prompt | null): Genai.UnstructuredQuery.Engine.ModelConfig;

    /**
     * The type of LLM being used.
     */
    readonly llmType?: string;
    withLlmType(llmType: string | null): Genai.UnstructuredQuery.Engine.ModelConfig;

    /**
     * Keyword arguments to pass to the native LLM's interface.
     * Look at azureGpt35.json for an example.
     */
    readonly llmKwargs: any;
    withLlmKwargs(llmKwargs: any): Genai.UnstructuredQuery.Engine.ModelConfig;

    /**
     * Configuration for how this will be shown as a UI drop-down option
     */
    readonly uiOptions?: Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig.UiOptions;
    withUiOptions(uiOptions: IGenai.UnstructuredQuery.Engine.REA.ModelInferenceConfig.UiOptions | null): Genai.UnstructuredQuery.Engine.ModelConfig;
    ...
    withConfigSuffix(configSuffix: string | null): Genai.UnstructuredQuery.Engine.ModelConfig;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.UnstructuredQuery.Engine.ModelConfig | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.UnstructuredQuery.Engine.ModelConfig | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.UnstructuredQuery.Engine.ModelConfig | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.UnstructuredQuery.Engine.ModelConfig | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.UnstructuredQuery.Engine.ModelConfig;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.UnstructuredQuery.Engine.ModelConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.UnstructuredQuery.Engine.ModelConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.UnstructuredQuery.Engine.ModelConfig>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.UnstructuredQuery.Engine.ModelConfig>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.UnstructuredQuery.Engine.ModelConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.UnstructuredQuery.Engine.ModelConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.UnstructuredQuery.Engine.ModelConfig;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.UnstructuredQuery.Engine.ModelConfig;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.UnstructuredQuery.Engine.ModelConfig;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.UnstructuredQuery.Engine.ModelConfig;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.UnstructuredQuery.Engine.ModelConfig;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.UnstructuredQuery.Engine.ModelConfig;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.UnstructuredQuery.Engine.ModelConfig;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.UnstructuredQuery.Engine.ModelConfig;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.UnstructuredQuery.Engine.ModelConfig;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.UnstructuredQuery.Engine.ModelConfig;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.UnstructuredQuery.Engine.ModelConfig;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.UnstructuredQuery.Engine.ModelConfig;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.UnstructuredQuery.Engine.ModelConfig;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.UnstructuredQuery.Engine.ModelConfig;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.UnstructuredQuery.Engine.ModelConfig;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.UnstructuredQuery.Engine.ModelConfig;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.UnstructuredQuery.Engine.ModelConfig;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.UnstructuredQuery.Engine.ModelConfig;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.UnstructuredQuery.Engine.ModelConfig;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.UnstructuredQuery.Engine.ModelConfig;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.UnstructuredQuery.Engine.ModelConfig;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.UnstructuredQuery.Engine.ModelConfig;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.UnstructuredQuery.Engine.ModelConfig;

    mergeJson(json: any): Genai.UnstructuredQuery.Engine.ModelConfig;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.UnstructuredQuery.Engine.ModelConfig;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.UnstructuredQuery.Engine.ModelConfig;
     ...
     */
    singletonArray(): Array_Type<Genai.UnstructuredQuery.Engine.ModelConfig>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.UnstructuredQuery.Engine.ModelConfig> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.UnstructuredQuery.Engine.ModelConfig> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.UnstructuredQuery.Engine.ModelConfig>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.UnstructuredQuery.Engine.ModelConfig> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.UnstructuredQuery.Engine.ModelConfig> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.UnstructuredQuery.Engine.ModelConfig> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.UnstructuredQuery.Engine.ModelConfig>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.UnstructuredQuery.Engine.ModelConfig>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.UnstructuredQuery.Engine.ModelConfig;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.UnstructuredQuery.Engine.ModelConfig;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.UnstructuredQuery.Engine.ModelConfig;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.UnstructuredQuery.Engine.ModelConfig;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.UnstructuredQuery.Engine.ModelConfig;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.UnstructuredQuery.Engine.ModelConfig;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.UnstructuredQuery.Engine.ModelConfig | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.UnstructuredQuery.Engine.ModelConfig;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.UnstructuredQuery.Engine.ModelConfig;
     ...
     */
    static cachedEmptyInst(): Genai.UnstructuredQuery.Engine.ModelConfig;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.UnstructuredQuery.Engine.ModelConfig> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.UnstructuredQuery.Engine.ModelConfig;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.UnstructuredQuery.Engine.ModelConfig | null;
     ...
     */
    static forName(name: string, failIfMissing?: boolean): Genai.UnstructuredQuery.Engine.ModelConfig | null;
     ...
     */
    static allCached(): Stream<Genai.UnstructuredQuery.Engine.ModelConfig> | null;
     ...
     */
    static find(filter?: string): Stream<Genai.UnstructuredQuery.Engine.ModelConfig> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<Genai.UnstructuredQuery.Engine.ModelConfig> | null;

    /**
     * @return cached instance.
     */
    getCached(): Genai.UnstructuredQuery.Engine.ModelConfig | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string): Genai.UnstructuredQuery.Engine.ModelConfig | null;
     ...
     */
    static produce(key: string): Genai.UnstructuredQuery.Engine.ModelConfig | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, Genai.UnstructuredQuery.Engine.ModelConfig> | null;
     ...
     */
    getConfig(): Genai.UnstructuredQuery.Engine.ModelConfig;
     ...
     */
    getSecret(): Genai.UnstructuredQuery.Engine.ModelConfig;
     ...
     */
    withConfigKey(configKey: string): Genai.UnstructuredQuery.Engine.ModelConfig;

    /**
     * @return copy without config key.
     */
    withoutConfigKey(): Genai.UnstructuredQuery.Engine.ModelConfig;

    /**
     * @return return cached config instance for provided config key.
     */
    static forConfigKey(configKey: string): Genai.UnstructuredQuery.Engine.ModelConfig | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string>): Stream<Genai.UnstructuredQuery.Engine.ModelConfig> | null;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: Genai.UnstructuredQuery.Engine.ModelConfig, override?: string): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): Genai.UnstructuredQuery.Engine.ModelConfig | null;
     ...
     */
    removeSecrets(): Genai.UnstructuredQuery.Engine.ModelConfig | null;

    /**
     * @return this config with only secret values.
     */
    removeNonSecrets(): Genai.UnstructuredQuery.Engine.ModelConfig | null;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    validate(): Genai.UnstructuredQuery.Engine.ModelConfig;
     ...
     */
    generateText(llmInput: Map_Type<any, any>): any;
     ...
     */
    generateTextBatch(llmInput: Map_Type<any, any>): Genai.Llm.BatchRequestJob;
     ...
     */
    static deleteConfig(credential: string): Genai.Llm.ExternalLlm.DeleteResult;
     ...
     */
    static setFromSpec(spec: Genai.ModelConfigSpec, overwrite?: boolean): string | null;
