// TypeScript definitions for the C3 type Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig

/**
 * Describes the config for setting up the question rewriter.
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig
 */
declare namespace Genai.UnstructuredQuery.Engine.REA {
  export interface IQuestionRewritingConfig {
    ...
    /**
     * Name of the {@link Genai.UnstructuredQuery.Engine.ModelConfig} for the Llm.
     */
    modelInferenceConfigName: string;

    /**
     * The number of conversation QA pairs to store  and consider for rewriting. Default is 16 QA pairs.
     * When the conversation limit is exceeded, QA pairs are removed in a FIFO manner.
     */
    conversationLimit?: number;

    /**
     * The lambda to use for combining the latest question with the existing chat history.
     * This is an Optional parameter used to provide more conversational context to question answering model.
     * For example, the lambda can be used to combine the chat history with the latest question in a specific
     * format best suited to a given question answering model.
     *
     * The expected format for `histories` is alternating Q/A in conversation order.
     * - Example: `['Q1', 'A1', 'Q2', 'A2']`.
     * originalQuestion is the latest question asked in chat.
     * rewrittenQuestion is the rewritten question created by question rewriter.
     * It returns the combined question and chat history.
     * - Example: `"Q1: ..., A1: ..., Q2: ..., A2: ..., Latest Question: ..."`
     */
    chatHistoryCombinationLambda?: λTriFunction<Array_Type<string>, string, string, string>;

    /**
     * The {@link Genai.Query} query field to use when combining chat history in question answering.
     * This is used within question answering and question rewriting in chat.
     */
    searchQueryFieldForHistory?: string;
  }
}
 ...
 * Describes the config for setting up the question rewriter.
 *
 * @remarks this represents a made instance of Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig
 */
declare namespace Genai.UnstructuredQuery.Engine.REA {
  export class QuestionRewritingConfig extends Obj  {

    /**
     * The unique and required name of this instance.
     */
    readonly name: string;
    withName(name: string): Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig;

    readonly configOverride?: string;
    withConfigOverride(configOverride: string | null): Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig;

    readonly secretOverride?: string;
    withSecretOverride(secretOverride: string | null): Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig;

    /**
     * Captures any issues that occurred while deserializing from filesystem
     */
    readonly issues?: Array_Type<string>;
    withIssues(issues: Array_Type<string> | Array<string> | null): Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig;

    /**
     * Name of the {@link Genai.UnstructuredQuery.Engine.ModelConfig} for the Llm.
     */
    readonly modelInferenceConfigName: string;
    withModelInferenceConfigName(modelInferenceConfigName: string): Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig;
    ...
    withConversationLimit(conversationLimit: number | null): Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig;
     ...
     * - Example: `"Q1: ..., A1: ..., Q2: ..., A2: ..., Latest Question: ..."`
     */
    readonly chatHistoryCombinationLambda?: λTriFunction<Array_Type<string>, string, string, string>;
    withChatHistoryCombinationLambda(chatHistoryCombinationLambda: λTriFunction<Array_Type<string>, string, string, string> | null): Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig;

    /**
     * The {@link Genai.Query} query field to use when combining chat history in question answering.
     * This is used within question answering and question rewriting in chat.
     */
    readonly searchQueryFieldForHistory?: string;
    withSearchQueryFieldForHistory(searchQueryFieldForHistory: string | null): Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig;

    mergeJson(json: any): Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig;
     ...
     */
    singletonArray(): Array_Type<Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig;
     ...
     */
    static cachedEmptyInst(): Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig | null;
     ...
     */
    static forName(name: string, failIfMissing?: boolean): Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig | null;
     ...
     */
    static allCached(): Stream<Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig> | null;
     ...
     */
    static find(filter?: string): Stream<Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig> | null;

    /**
     * @return cached instance.
     */
    getCached(): Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string): Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig | null;
     ...
     */
    static produce(key: string): Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig> | null;
     ...
     */
    getConfig(): Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig;
     ...
     */
    getSecret(): Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig;
     ...
     */
    withConfigKey(configKey: string): Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig;

    /**
     * @return copy without config key.
     */
    withoutConfigKey(): Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig;

    /**
     * @return return cached config instance for provided config key.
     */
    static forConfigKey(configKey: string): Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string>): Stream<Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig> | null;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig, override?: string): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig | null;
     ...
     */
    removeSecrets(): Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig | null;

    /**
     * @return this config with only secret values.
     */
    removeNonSecrets(): Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig | null;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    validate(): Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig;
     ...
     */
    static setRecursive(configJson: any, useSetConfigValues?: boolean, override?: string): Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig;
