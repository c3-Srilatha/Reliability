// TypeScript definitions for the C3 type Genai.Agent.DynamicTrajectory

/**
 * Mutable series of steps for answering a user query.
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.Agent.DynamicTrajectory
 */
declare namespace Genai.Agent {
  export interface IDynamicTrajectory {

    /**
     * The {@link Genai.Query.Result} that the plan is created for.
     */
    queryResult: IGenai.Query.Result;
     ...
     */
    steps?: Array_Type<Genai.Agent.DynamicTrajectory.Step> | Array<IGenai.Agent.DynamicTrajectory.Step>;
 ...
 */
declare namespace Genai.Agent {
  export class DynamicTrajectory extends Obj  {

    /**
     * The {@link Genai.Query.Result} that the plan is created for.
     */
    readonly queryResult: Genai.Query.Result;
    withQueryResult(queryResult: IGenai.Query.Result): Genai.Agent.DynamicTrajectory;
     ...
     */
    readonly id: string;
    withId(id: string): Genai.Agent.DynamicTrajectory;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Genai.Agent.DynamicTrajectory;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): Genai.Agent.DynamicTrajectory;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Genai.Agent.DynamicTrajectory;
    ...
    withVersion(version: number | null): Genai.Agent.DynamicTrajectory;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Genai.Agent.DynamicTrajectory;

    /**
     * The steps to execute the plan.
     */
    readonly steps?: Array_Type<Genai.Agent.DynamicTrajectory.Step>;
    withSteps(steps: Array_Type<Genai.Agent.DynamicTrajectory.Step> | Array<IGenai.Agent.DynamicTrajectory.Step> | null): Genai.Agent.DynamicTrajectory;

    /**
     * Returns the time taken to generate the plan in milliseconds.
     */
    readonly planGenerationLatency?: number;
    withPlanGenerationLatency(planGenerationLatency: number | null): Genai.Agent.DynamicTrajectory;

    /**
     * Returns the time taken to execute the plan in milliseconds.
     */
    readonly planExecutionLatency?: number;
    withPlanExecutionLatency(planExecutionLatency: number | null): Genai.Agent.DynamicTrajectory;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.Agent.DynamicTrajectory | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.Agent.DynamicTrajectory | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.Agent.DynamicTrajectory | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.Agent.DynamicTrajectory | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.Agent.DynamicTrajectory;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Agent.DynamicTrajectory;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Agent.DynamicTrajectory;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Agent.DynamicTrajectory>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Agent.DynamicTrajectory>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.Agent.DynamicTrajectory;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Agent.DynamicTrajectory;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Agent.DynamicTrajectory;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.Agent.DynamicTrajectory;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.Agent.DynamicTrajectory;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.Agent.DynamicTrajectory;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.Agent.DynamicTrajectory;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.Agent.DynamicTrajectory;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.Agent.DynamicTrajectory;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.Agent.DynamicTrajectory;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.Agent.DynamicTrajectory;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.Agent.DynamicTrajectory;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.Agent.DynamicTrajectory;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.Agent.DynamicTrajectory;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.Agent.DynamicTrajectory;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.Agent.DynamicTrajectory;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.Agent.DynamicTrajectory;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.Agent.DynamicTrajectory;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.Agent.DynamicTrajectory;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.Agent.DynamicTrajectory;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.Agent.DynamicTrajectory;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.Agent.DynamicTrajectory;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.Agent.DynamicTrajectory;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.Agent.DynamicTrajectory;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.Agent.DynamicTrajectory;

    mergeJson(json: any): Genai.Agent.DynamicTrajectory;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.Agent.DynamicTrajectory;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.Agent.DynamicTrajectory;
     ...
     */
    singletonArray(): Array_Type<Genai.Agent.DynamicTrajectory>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.Agent.DynamicTrajectory> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.Agent.DynamicTrajectory> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.Agent.DynamicTrajectory>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.Agent.DynamicTrajectory> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.Agent.DynamicTrajectory> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.Agent.DynamicTrajectory> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.Agent.DynamicTrajectory>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.Agent.DynamicTrajectory>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.Agent.DynamicTrajectory;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.Agent.DynamicTrajectory;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.Agent.DynamicTrajectory;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.Agent.DynamicTrajectory;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.Agent.DynamicTrajectory;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.Agent.DynamicTrajectory;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.Agent.DynamicTrajectory | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.Agent.DynamicTrajectory;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.Agent.DynamicTrajectory;
     ...
     */
    static cachedEmptyInst(): Genai.Agent.DynamicTrajectory;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.Agent.DynamicTrajectory> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.Agent.DynamicTrajectory;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Genai.Agent.DynamicTrajectory>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Genai.Agent.DynamicTrajectory>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Genai.Agent.DynamicTrajectory> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Genai.Agent.DynamicTrajectory>> | null;
     ...
     */
    get(include?: string): Genai.Agent.DynamicTrajectory | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Genai.Agent.DynamicTrajectory | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Genai.Agent.DynamicTrajectory;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Genai.Agent.DynamicTrajectory | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Genai.Agent.DynamicTrajectory;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.Agent.DynamicTrajectory | null;
     ...
     */
    create(spec?: UpsertSpec): Genai.Agent.DynamicTrajectory | null;
     ...
     */
    static createBatch(objs: Array_Type<Genai.Agent.DynamicTrajectory>, spec?: UpsertSpec): ObjList<Genai.Agent.DynamicTrajectory> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Genai.Agent.DynamicTrajectory>, spec?: CreateBatchObjStreamSpec): ObjList<Genai.Agent.DynamicTrajectory> | null;
     ...
     */
    update(srcObj?: Genai.Agent.DynamicTrajectory, spec?: UpsertSpec): Genai.Agent.DynamicTrajectory | null;
     ...
     */
    upsert(srcObj?: Genai.Agent.DynamicTrajectory, spec?: UpsertSpec): Genai.Agent.DynamicTrajectory | null;
     ...
     */
    merge(spec?: MergeSpec): Genai.Agent.DynamicTrajectory | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Genai.Agent.DynamicTrajectory | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Genai.Agent.DynamicTrajectory | null;
     ...
     */
    static updateBatch(objs: Array_Type<Genai.Agent.DynamicTrajectory>, srcObjs?: Array_Type<Genai.Agent.DynamicTrajectory>, spec?: UpsertSpec): ObjList<Genai.Agent.DynamicTrajectory> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Genai.Agent.DynamicTrajectory> | null>, spec?: UpsertSpec): ObjList<Genai.Agent.DynamicTrajectory> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Genai.Agent.DynamicTrajectory>, srcObjs?: Array_Type<Genai.Agent.DynamicTrajectory>, spec?: UpsertSpec): ObjList<Genai.Agent.DynamicTrajectory> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Genai.Agent.DynamicTrajectory> | null>, spec?: UpsertSpec): ObjList<Genai.Agent.DynamicTrajectory> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Genai.Agent.DynamicTrajectory>, spec?: TouchSpec): ObjList<Genai.Agent.DynamicTrajectory> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.Agent.DynamicTrajectory>, spec?: MergeSpec): ObjList<Genai.Agent.DynamicTrajectory> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.Agent.DynamicTrajectory>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.Agent.DynamicTrajectory> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Genai.Agent.DynamicTrajectory> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.Agent.DynamicTrajectory> | null;
     ...
     */
    static mergeAll(mergeObj: Genai.Agent.DynamicTrajectory, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Genai.Agent.DynamicTrajectory, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Genai.Agent.DynamicTrajectory>, spec?: UpsertSpec): ObjList<Genai.Agent.DynamicTrajectory> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Genai.Agent.DynamicTrajectory>, spec?: UpsertSpec): ObjList<Genai.Agent.DynamicTrajectory> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Genai.Agent.DynamicTrajectory | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Genai.Agent.DynamicTrajectory>): ObjList<Genai.Agent.DynamicTrajectory>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<Genai.Agent.DynamicTrajectory>): ObjList<Genai.Agent.DynamicTrajectory>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Genai.Agent.DynamicTrajectory>): ObjList<Genai.Agent.DynamicTrajectory>;
     ...
     */
    static afterCreate(objs: Array_Type<Genai.Agent.DynamicTrajectory>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Genai.Agent.DynamicTrajectory>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Genai.Agent.DynamicTrajectory>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Genai.Agent.DynamicTrajectory>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Genai.Agent.DynamicTrajectory>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.Agent.DynamicTrajectory | null;
     ...
     */
    withoutIdentity(): Genai.Agent.DynamicTrajectory | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Genai.Agent.DynamicTrajectory>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Genai.Agent.DynamicTrajectory, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Genai.Agent.DynamicTrajectory>, callback?: λFunction<Genai.Agent.DynamicTrajectory | null, Genai.Agent.DynamicTrajectory | null>): ObjList<Genai.Agent.DynamicTrajectory>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Genai.Agent.DynamicTrajectory>, callback?: λFunction<Genai.Agent.DynamicTrajectory | null, Genai.Agent.DynamicTrajectory | null>): Array_Type<ObjError> | null;
