// TypeScript definitions for the C3 type Genai.UnstructuredQuery.EngineDeployment

/**
 * The Engine Deployment for {@link Genai.UnstructuredQuery.Engine}.
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.UnstructuredQuery.EngineDeployment
 */
declare namespace Genai.UnstructuredQuery {
  export interface IEngineDeployment {
 ...
 * The Engine Deployment for {@link Genai.UnstructuredQuery.Engine}.
 *
 * @remarks this represents a made instance of Genai.UnstructuredQuery.EngineDeployment
 */
declare namespace Genai.UnstructuredQuery {
  export class EngineDeployment extends Obj  {

    /**
     * Name of the Engine
     */
    readonly name: string;
    withName(name: string): Genai.UnstructuredQuery.EngineDeployment;
    ...
    withNodeRole(nodeRole: string | null): Genai.UnstructuredQuery.EngineDeployment;
    ...
    withAltNodeRoles(altNodeRoles: Array_Type<string> | Array<string> | null): Genai.UnstructuredQuery.EngineDeployment;
    ...
    withNodePools(nodePools: Array_Type<string> | Array<string> | null): Genai.UnstructuredQuery.EngineDeployment;
    ...
    withDedicatedThreadPool(dedicatedThreadPool: boolean): Genai.UnstructuredQuery.EngineDeployment;

    /**
     * If set to `true` then this {@link Engine} will auto start on every node of every target node-pool.
     */
    readonly autoStart?: boolean;
    withAutoStart(autoStart: boolean): Genai.UnstructuredQuery.EngineDeployment;
    ...
    withInactive(inactive: boolean): Genai.UnstructuredQuery.EngineDeployment;
    ...
    withFailActionIfEngineNotReady(failActionIfEngineNotReady: boolean): Genai.UnstructuredQuery.EngineDeployment;
    ...
    withInitializingNodeAvoidanceDuration(initializingNodeAvoidanceDuration: string | null): Genai.UnstructuredQuery.EngineDeployment;

    readonly configOverride?: string;
    withConfigOverride(configOverride: string | null): Genai.UnstructuredQuery.EngineDeployment;

    readonly secretOverride?: string;
    withSecretOverride(secretOverride: string | null): Genai.UnstructuredQuery.EngineDeployment;

    /**
     * Captures any issues that occurred while deserializing from filesystem
     */
    readonly issues?: Array_Type<string>;
    withIssues(issues: Array_Type<string> | Array<string> | null): Genai.UnstructuredQuery.EngineDeployment;

    /**
     * The configuration for the engine.
     */
    readonly configName: string;
    withConfigName(configName: string): Genai.UnstructuredQuery.EngineDeployment;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.UnstructuredQuery.EngineDeployment | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.UnstructuredQuery.EngineDeployment | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.UnstructuredQuery.EngineDeployment | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.UnstructuredQuery.EngineDeployment | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.UnstructuredQuery.EngineDeployment;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.UnstructuredQuery.EngineDeployment;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.UnstructuredQuery.EngineDeployment;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.UnstructuredQuery.EngineDeployment>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.UnstructuredQuery.EngineDeployment>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.UnstructuredQuery.EngineDeployment;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.UnstructuredQuery.EngineDeployment;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.UnstructuredQuery.EngineDeployment;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.UnstructuredQuery.EngineDeployment;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.UnstructuredQuery.EngineDeployment;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.UnstructuredQuery.EngineDeployment;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.UnstructuredQuery.EngineDeployment;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.UnstructuredQuery.EngineDeployment;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.UnstructuredQuery.EngineDeployment;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.UnstructuredQuery.EngineDeployment;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.UnstructuredQuery.EngineDeployment;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.UnstructuredQuery.EngineDeployment;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.UnstructuredQuery.EngineDeployment;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.UnstructuredQuery.EngineDeployment;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.UnstructuredQuery.EngineDeployment;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.UnstructuredQuery.EngineDeployment;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.UnstructuredQuery.EngineDeployment;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.UnstructuredQuery.EngineDeployment;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.UnstructuredQuery.EngineDeployment;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.UnstructuredQuery.EngineDeployment;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.UnstructuredQuery.EngineDeployment;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.UnstructuredQuery.EngineDeployment;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.UnstructuredQuery.EngineDeployment;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.UnstructuredQuery.EngineDeployment;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.UnstructuredQuery.EngineDeployment;

    mergeJson(json: any): Genai.UnstructuredQuery.EngineDeployment;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.UnstructuredQuery.EngineDeployment;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.UnstructuredQuery.EngineDeployment;
     ...
     */
    singletonArray(): Array_Type<Genai.UnstructuredQuery.EngineDeployment>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.UnstructuredQuery.EngineDeployment> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.UnstructuredQuery.EngineDeployment> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.UnstructuredQuery.EngineDeployment>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.UnstructuredQuery.EngineDeployment> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.UnstructuredQuery.EngineDeployment> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.UnstructuredQuery.EngineDeployment> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.UnstructuredQuery.EngineDeployment>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.UnstructuredQuery.EngineDeployment>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.UnstructuredQuery.EngineDeployment;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.UnstructuredQuery.EngineDeployment;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.UnstructuredQuery.EngineDeployment;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.UnstructuredQuery.EngineDeployment;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.UnstructuredQuery.EngineDeployment;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.UnstructuredQuery.EngineDeployment;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.UnstructuredQuery.EngineDeployment | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.UnstructuredQuery.EngineDeployment;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.UnstructuredQuery.EngineDeployment;
     ...
     */
    static cachedEmptyInst(): Genai.UnstructuredQuery.EngineDeployment;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.UnstructuredQuery.EngineDeployment> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.UnstructuredQuery.EngineDeployment;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.UnstructuredQuery.EngineDeployment | null;
     ...
     */
    static forName(name: string, failIfMissing?: boolean): Genai.UnstructuredQuery.EngineDeployment | null;
     ...
     */
    static allCached(): Stream<Genai.UnstructuredQuery.EngineDeployment> | null;
     ...
     */
    static find(filter?: string): Stream<Genai.UnstructuredQuery.EngineDeployment> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<Genai.UnstructuredQuery.EngineDeployment> | null;

    /**
     * @return cached instance.
     */
    getCached(): Genai.UnstructuredQuery.EngineDeployment | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string): Genai.UnstructuredQuery.EngineDeployment | null;
     ...
     */
    static produce(key: string): Genai.UnstructuredQuery.EngineDeployment | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, Genai.UnstructuredQuery.EngineDeployment> | null;
     ...
     */
    getConfig(): Genai.UnstructuredQuery.EngineDeployment;
     ...
     */
    getSecret(): Genai.UnstructuredQuery.EngineDeployment;
     ...
     */
    withConfigKey(configKey: string): Genai.UnstructuredQuery.EngineDeployment;

    /**
     * @return copy without config key.
     */
    withoutConfigKey(): Genai.UnstructuredQuery.EngineDeployment;

    /**
     * @return return cached config instance for provided config key.
     */
    static forConfigKey(configKey: string): Genai.UnstructuredQuery.EngineDeployment | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string>): Stream<Genai.UnstructuredQuery.EngineDeployment> | null;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: Genai.UnstructuredQuery.EngineDeployment, override?: string): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): Genai.UnstructuredQuery.EngineDeployment | null;
     ...
     */
    removeSecrets(): Genai.UnstructuredQuery.EngineDeployment | null;

    /**
     * @return this config with only secret values.
     */
    removeNonSecrets(): Genai.UnstructuredQuery.EngineDeployment | null;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    validate(): Genai.UnstructuredQuery.EngineDeployment;
     ...
     */
    engineType(): Type<<Genai.UnstructuredQuery.Engine>> | null;
     ...
     */
    static fromDeploySpec(spec: Engine.DeploySpec): Genai.UnstructuredQuery.EngineDeployment | null;
  }
}
