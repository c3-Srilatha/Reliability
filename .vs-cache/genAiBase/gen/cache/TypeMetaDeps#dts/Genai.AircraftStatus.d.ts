// TypeScript definitions for the C3 type Genai.AircraftStatus

/**
 * The mission status of an aircraft.  For example FMC (Fully Mission Capable), PMC (Partially Mission Capable), etc.
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.AircraftStatus
 */
declare namespace Genai {
  export interface IAircraftStatus {
 ...
 */
declare namespace Genai {
  export class AircraftStatus extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): Genai.AircraftStatus;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Genai.AircraftStatus;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): Genai.AircraftStatus;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Genai.AircraftStatus;
    ...
    withVersion(version: number | null): Genai.AircraftStatus;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Genai.AircraftStatus;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.AircraftStatus | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.AircraftStatus | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.AircraftStatus | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.AircraftStatus | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.AircraftStatus;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.AircraftStatus;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.AircraftStatus;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.AircraftStatus>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.AircraftStatus>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.AircraftStatus;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.AircraftStatus;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.AircraftStatus;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.AircraftStatus;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.AircraftStatus;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.AircraftStatus;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.AircraftStatus;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.AircraftStatus;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.AircraftStatus;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.AircraftStatus;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.AircraftStatus;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.AircraftStatus;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.AircraftStatus;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.AircraftStatus;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.AircraftStatus;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.AircraftStatus;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.AircraftStatus;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.AircraftStatus;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.AircraftStatus;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.AircraftStatus;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.AircraftStatus;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.AircraftStatus;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.AircraftStatus;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.AircraftStatus;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.AircraftStatus;

    mergeJson(json: any): Genai.AircraftStatus;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.AircraftStatus;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.AircraftStatus;
     ...
     */
    singletonArray(): Array_Type<Genai.AircraftStatus>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.AircraftStatus> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.AircraftStatus> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.AircraftStatus>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.AircraftStatus> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.AircraftStatus> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.AircraftStatus> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.AircraftStatus>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.AircraftStatus>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.AircraftStatus;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.AircraftStatus;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.AircraftStatus;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.AircraftStatus;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.AircraftStatus;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.AircraftStatus;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.AircraftStatus | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.AircraftStatus;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.AircraftStatus;
     ...
     */
    static cachedEmptyInst(): Genai.AircraftStatus;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.AircraftStatus> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.AircraftStatus;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Genai.AircraftStatus>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Genai.AircraftStatus>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Genai.AircraftStatus> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Genai.AircraftStatus>> | null;
     ...
     */
    get(include?: string): Genai.AircraftStatus | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Genai.AircraftStatus | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Genai.AircraftStatus;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Genai.AircraftStatus | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Genai.AircraftStatus;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.AircraftStatus | null;
     ...
     */
    create(spec?: UpsertSpec): Genai.AircraftStatus | null;
     ...
     */
    static createBatch(objs: Array_Type<Genai.AircraftStatus>, spec?: UpsertSpec): ObjList<Genai.AircraftStatus> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Genai.AircraftStatus>, spec?: CreateBatchObjStreamSpec): ObjList<Genai.AircraftStatus> | null;
     ...
     */
    update(srcObj?: Genai.AircraftStatus, spec?: UpsertSpec): Genai.AircraftStatus | null;
     ...
     */
    upsert(srcObj?: Genai.AircraftStatus, spec?: UpsertSpec): Genai.AircraftStatus | null;
     ...
     */
    merge(spec?: MergeSpec): Genai.AircraftStatus | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Genai.AircraftStatus | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Genai.AircraftStatus | null;
     ...
     */
    static updateBatch(objs: Array_Type<Genai.AircraftStatus>, srcObjs?: Array_Type<Genai.AircraftStatus>, spec?: UpsertSpec): ObjList<Genai.AircraftStatus> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Genai.AircraftStatus> | null>, spec?: UpsertSpec): ObjList<Genai.AircraftStatus> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Genai.AircraftStatus>, srcObjs?: Array_Type<Genai.AircraftStatus>, spec?: UpsertSpec): ObjList<Genai.AircraftStatus> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Genai.AircraftStatus> | null>, spec?: UpsertSpec): ObjList<Genai.AircraftStatus> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Genai.AircraftStatus>, spec?: TouchSpec): ObjList<Genai.AircraftStatus> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.AircraftStatus>, spec?: MergeSpec): ObjList<Genai.AircraftStatus> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.AircraftStatus>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.AircraftStatus> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Genai.AircraftStatus> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.AircraftStatus> | null;
     ...
     */
    static mergeAll(mergeObj: Genai.AircraftStatus, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Genai.AircraftStatus, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Genai.AircraftStatus>, spec?: UpsertSpec): ObjList<Genai.AircraftStatus> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Genai.AircraftStatus>, spec?: UpsertSpec): ObjList<Genai.AircraftStatus> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Genai.AircraftStatus | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Genai.AircraftStatus>): ObjList<Genai.AircraftStatus>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<Genai.AircraftStatus>): ObjList<Genai.AircraftStatus>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Genai.AircraftStatus>): ObjList<Genai.AircraftStatus>;
     ...
     */
    static afterCreate(objs: Array_Type<Genai.AircraftStatus>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Genai.AircraftStatus>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Genai.AircraftStatus>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Genai.AircraftStatus>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Genai.AircraftStatus>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.AircraftStatus | null;
     ...
     */
    withoutIdentity(): Genai.AircraftStatus | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Genai.AircraftStatus>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Genai.AircraftStatus, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Genai.AircraftStatus>, callback?: λFunction<Genai.AircraftStatus | null, Genai.AircraftStatus | null>): ObjList<Genai.AircraftStatus>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Genai.AircraftStatus>, callback?: λFunction<Genai.AircraftStatus | null, Genai.AircraftStatus | null>): Array_Type<ObjError> | null;
