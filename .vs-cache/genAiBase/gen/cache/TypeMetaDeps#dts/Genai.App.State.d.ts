// TypeScript definitions for the C3 type Genai.App.State

/**
 * Server-side application state for the Gen AI app.
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.App.State
 */
...
declare namespace Genai.App {
  export class State extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): Genai.App.State;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Genai.App.State;
    ...
    withName(name: string | null): Genai.App.State;
     ...
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Genai.App.State;
    ...
    withVersion(version: number | null): Genai.App.State;
    ...
    withTypeWithBindings(typeWithBindings: IType | null): Genai.App.State;
     ...
     * Current state of the Gen AI Data Model
     */
    readonly dataModelState?: string;
    withDataModelState(dataModelState: string | null): Genai.App.State;

    /**
     * Current state of the Gen AI Data Model
     */
    static readonly dataModelState?: string;
     ...
     * - STALE: The configs have been updated in the file system, but the python processes might have not been restarted to capture the new values.
     */
    readonly configsState?: string;
    withConfigsState(configsState: string | null): Genai.App.State;
     ...
     * - STALE: The configs have been updated in the file system, but the python processes might have not been restarted to capture the new values.
     */
    static readonly configsState?: string;
     ...
     * - STALE: The agents have been updated, but the python processes might have not been restarted to capture the new values.
     */
    readonly agentsState?: string;
    withAgentsState(agentsState: string | null): Genai.App.State;
     ...
     * - STALE: The agents have been updated, but the python processes might have not been restarted to capture the new values.
     */
    static readonly agentsState?: string;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.App.State | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.App.State | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.App.State | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.App.State | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.App.State;
     ...
     * This method is used during live metadata update
     */
    static replaceType(old: Type, new_: Type): Genai.App.State;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.App.State;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.App.State;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.App.State;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.App.State;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.App.State>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.App.State>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.App.State>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.App.State>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.App.State;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.App.State;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.App.State;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.App.State;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.App.State;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.App.State;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.App.State;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    static validateObj(): Genai.App.State;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.App.State;
     ...
     * @see #defaultField
     */
    static withField(field: string, value: any, doNotConvert?: boolean): Genai.App.State;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.App.State;
     ...
     * @see #defaultField
     */
    static withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.App.State;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.App.State;
     ...
     * @return new Obj
     */
    static withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.App.State;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.App.State;
     ...
     * @return new Obj
     */
    static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.App.State;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.App.State;
     ...
     * @see #withoutField
     */
    static withoutFieldAtPath(path: string): Genai.App.State;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.App.State;
     ...
     * @see #removeField
     */
    static withoutField(field: string): Genai.App.State;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.App.State;
     ...
     * @see #removeField
     */
    static withoutField(field: FieldType): Genai.App.State;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.App.State;
     ...
     * @return new Obj with removed fields
     */
    static withoutFields(fields: Array_Type<string>): Genai.App.State;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.App.State;
     ...
     * @return new Obj with removed fields
     */
    static withoutFieldsByType(fields: Array_Type<FieldType>): Genai.App.State;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.App.State;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    static withoutSecretFields(): Genai.App.State;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.App.State;
     ...
     * @see FieldType#defaultValue
     */
    static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.App.State;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.App.State;
     ...
     * @see #unsetField
     */
    static defaultField(field: string): Genai.App.State;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.App.State;
     ...
     * @see #unsetField
     */
    static defaultField(field: FieldType): Genai.App.State;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.App.State;
     ...
     * @see #removeField
     */
    static unsetField(field: string): Genai.App.State;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.App.State;
     ...
     * @see #removeField
     */
    static unsetField(field: FieldType): Genai.App.State;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.App.State;
     ...
     * @see #unsetField
     */
    static removeField(field: string): Genai.App.State;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.App.State;
     ...
     * @see #unsetField
     */
    static removeField(field: FieldType): Genai.App.State;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.App.State;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.App.State;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.App.State;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj, otherFieldsFilter: Type): Genai.App.State;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.App.State;
     ...
     *        the same key or index.
     */
    static mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.App.State;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.App.State;
     ...
     * traverse child reference and collection fields.
     */
    static mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.App.State;

    mergeJson(json: any): Genai.App.State;

    static mergeJson(json: any): Genai.App.State;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.App.State;
     ...
     * @return Obj with child references merged
     */
    static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.App.State;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.App.State;
     ...
     * references with same name and collection elements at same index or key.
     */
    static sumObj(other: Obj, deep?: boolean): Genai.App.State;
     ...
     */
    singletonArray(): Array_Type<Genai.App.State>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonArray(): Array_Type<Genai.App.State>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.App.State> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.App.State> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.App.State>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonSet(): Set_Type<Genai.App.State>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.App.State> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.App.State> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.App.State> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.App.State>;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    static toBuilder(): ObjBuilder<Genai.App.State>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.App.State>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.App.State;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.App.State;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.App.State;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.App.State;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.App.State;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.App.State;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.App.State | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.App.State;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    static afterMake(): Genai.App.State;
     ...
     */
    static cachedEmptyInst(): Genai.App.State;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.App.State> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.App.State;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Genai.App.State>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Genai.App.State>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Genai.App.State> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Genai.App.State>> | null;
     ...
     */
    get(include?: string): Genai.App.State | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    static get(include?: string): Genai.App.State | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Genai.App.State | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    static getSpecific(include?: string): Genai.App.State | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Genai.App.State;
     ...
     * @return instance of the obj with all requested fields.
     */
    static getMissing(spec: GetMissingSpec): Genai.App.State;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Genai.App.State | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    static getDirect(include?: string): Genai.App.State | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Genai.App.State;
     ...
     * @return The instance after applying the reverse edit.
     */
    static applyReverseEdit(versionEdit: VersionEdit): Genai.App.State;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.App.State | null;
     ...
     */
    create(spec?: UpsertSpec): Genai.App.State | null;
     ...
     *         will have only those fields populated. Otherwise only the id field will be populated.
     */
    static create(spec?: UpsertSpec): Genai.App.State | null;
     ...
     */
    static createBatch(objs: Array_Type<Genai.App.State>, spec?: UpsertSpec): ObjList<Genai.App.State> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Genai.App.State>, spec?: CreateBatchObjStreamSpec): ObjList<Genai.App.State> | null;
     ...
     */
    update(srcObj?: Genai.App.State, spec?: UpsertSpec): Genai.App.State | null;
     ...
     *         obj will have only those fields populated. Otherwise only the id field will be populated.
     */
    static update(srcObj?: Genai.App.State, spec?: UpsertSpec): Genai.App.State | null;
     ...
     */
    upsert(srcObj?: Genai.App.State, spec?: UpsertSpec): Genai.App.State | null;
     ...
     *         returned obj will have only those fields populated. Otherwise only the id field will be populated.
     */
    static upsert(srcObj?: Genai.App.State, spec?: UpsertSpec): Genai.App.State | null;
     ...
     */
    merge(spec?: MergeSpec): Genai.App.State | null;
     ...
     * @see Mergespec#csvInclude
     */
    static merge(spec?: MergeSpec): Genai.App.State | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Genai.App.State | null;
     ...
     * @return The created or updated obj.
     */
    static merge(mergeInclude: string, spec?: MergeSpec): Genai.App.State | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Genai.App.State | null;
     ...
     * @return The created or updated obj.
     */
    static touch(spec?: TouchSpec): Genai.App.State | null;
     ...
     */
    static updateBatch(objs: Array_Type<Genai.App.State>, srcObjs?: Array_Type<Genai.App.State>, spec?: UpsertSpec): ObjList<Genai.App.State> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Genai.App.State> | null>, spec?: UpsertSpec): ObjList<Genai.App.State> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Genai.App.State>, srcObjs?: Array_Type<Genai.App.State>, spec?: UpsertSpec): ObjList<Genai.App.State> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Genai.App.State> | null>, spec?: UpsertSpec): ObjList<Genai.App.State> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Genai.App.State>, spec?: TouchSpec): ObjList<Genai.App.State> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.App.State>, spec?: MergeSpec): ObjList<Genai.App.State> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.App.State>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.App.State> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Genai.App.State> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.App.State> | null;
     ...
     */
    static mergeAll(mergeObj: Genai.App.State, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Genai.App.State, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Genai.App.State>, spec?: UpsertSpec): ObjList<Genai.App.State> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Genai.App.State>, spec?: UpsertSpec): ObjList<Genai.App.State> | null;
     ...
     * @see Ann.Db#archive
     */
    static unremove(): Genai.App.State | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Genai.App.State>): ObjList<Genai.App.State>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<Genai.App.State>): ObjList<Genai.App.State>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Genai.App.State>): ObjList<Genai.App.State>;
     ...
     */
    static afterCreate(objs: Array_Type<Genai.App.State>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Genai.App.State>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Genai.App.State>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Genai.App.State>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Genai.App.State>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.App.State | null;
     ...
     */
    withoutIdentity(): Genai.App.State | null;
     ...
     * @return The requested obj without any of its identifying fields.
     */
    static withoutIdentity(): Genai.App.State | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Genai.App.State>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Genai.App.State, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Genai.App.State>, callback?: λFunction<Genai.App.State | null, Genai.App.State | null>): ObjList<Genai.App.State>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Genai.App.State>, callback?: λFunction<Genai.App.State | null, Genai.App.State | null>): Array_Type<ObjError> | null;
     ...
     */
    static setDataModelState(dataModelState: string): Genai.App.State;
     ...
     * @return The updated state of the Gen AI app
     */
    static setState(stateField: string, stateValue: string): Genai.App.State;
  }
}
