// TypeScript definitions for the C3 type Genai.Aircraft

/**
 * An aircraft entity. Can be used to answer questions related to aircraft.
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.Aircraft
 */
declare namespace Genai {
  export interface IAircraft {
    ...
    /**
     * The current mission status of this aircraft.
     */
    status?: IGenai.AircraftStatus;

    /**
     * Sensors on the aircraft
     */
    sensors?: Array_Type<Genai.AircraftMeasurementSeries> | Array<IGenai.AircraftMeasurementSeries>;
     ...
     */
    components?: Array_Type<Genai.AircraftComponent> | Array<IGenai.AircraftComponent>;

    /**
     * All the alerts associated with this aircraft.
     */
    alerts?: Array_Type<Genai.AircraftComponentAlert> | Array<IGenai.AircraftComponentAlert>;
     ...
     */
    latestAlert?: IGenai.AircraftComponentAlert;

    /**
     * All the maintenance cases associated with this aircraft.
     */
    cases?: Array_Type<Genai.AircraftComponentCase> | Array<IGenai.AircraftComponentCase>;

    /**
     * The single most recent maintenance case for this aircraft. Can be used to access the latest maintenance case on an aircraft, but cannot be used to provide further information about the case itself.
     */
    latestCase?: IGenai.AircraftComponentCase;

    /**
     * The model of this aircraft.
     */
    model?: IGenai.AircraftModel;

    /**
     * The current location of this aircraft. The location is an airport that is located in a city, country and state, each with latitudes and longitudes. An aircraft is always located at an airport.
     */
    location?: IGenai.Airport;

    /**
     * Flag indicating if the aircraft is assigned to a pilot.
     */
    isAssignedToPilot?: boolean;

    /**
     * The descriptions for all the component codes in this aircraft.
     */
    componentCodesDescription?: Array_Type<string> | Array<string>;

    /**
     * The unique descriptions for all the component codes in this aircraft. Stored as set.
     */
    componentCodesDescriptionAsSet?: Set_Type<string> | Array<string>;

    /**
     * Usage purpose of the Genai.Aircraft.
     */
    usage?: string;
 ...
 * An aircraft entity. Can be used to answer questions related to aircraft.
 *
 * @remarks this represents a made instance of Genai.Aircraft
 */
declare namespace Genai {
  export class Aircraft extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): Genai.Aircraft;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Genai.Aircraft;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): Genai.Aircraft;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Genai.Aircraft;
    ...
    withVersion(version: number | null): Genai.Aircraft;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Genai.Aircraft;

    /**
     * The current mission status of this aircraft.
     */
    readonly status?: Genai.AircraftStatus;
    withStatus(status: IGenai.AircraftStatus | null): Genai.Aircraft;

    /**
     * Sensors on the aircraft
     */
    readonly sensors?: Array_Type<Genai.AircraftMeasurementSeries>;
    withSensors(sensors: Array_Type<Genai.AircraftMeasurementSeries> | Array<IGenai.AircraftMeasurementSeries> | null): Genai.Aircraft;

    /**
     * The current risk score of this aircraft. This should be used to answer questions relating to aircraft risk scores e.g. questions relating to highest aircraft risk score, lowest aircraft risk score, average aircraft risk score etc.
     */
    readonly riskScore?: number;
    withRiskScore(riskScore: number | null): Genai.Aircraft;

    /**
     * The inner components belonging to this aircraft.
     */
    readonly components?: Array_Type<Genai.AircraftComponent>;
    withComponents(components: Array_Type<Genai.AircraftComponent> | Array<IGenai.AircraftComponent> | null): Genai.Aircraft;

    /**
     * All the alerts associated with this aircraft.
     */
    readonly alerts?: Array_Type<Genai.AircraftComponentAlert>;
    withAlerts(alerts: Array_Type<Genai.AircraftComponentAlert> | Array<IGenai.AircraftComponentAlert> | null): Genai.Aircraft;

    /**
     * The single most recent alert for this aircraft. Can be used to access the latest alert on an aircraft, but cannot be used to provide further information about the alert itself. #latestAlert.triggeredTimestamp is the date when the alert was triggered.
     */
    readonly latestAlert?: Genai.AircraftComponentAlert;
    withLatestAlert(latestAlert: IGenai.AircraftComponentAlert | null): Genai.Aircraft;

    /**
     * All the maintenance cases associated with this aircraft.
     */
    readonly cases?: Array_Type<Genai.AircraftComponentCase>;
    withCases(cases: Array_Type<Genai.AircraftComponentCase> | Array<IGenai.AircraftComponentCase> | null): Genai.Aircraft;

    /**
     * The single most recent maintenance case for this aircraft. Can be used to access the latest maintenance case on an aircraft, but cannot be used to provide further information about the case itself.
     */
    readonly latestCase?: Genai.AircraftComponentCase;
    withLatestCase(latestCase: IGenai.AircraftComponentCase | null): Genai.Aircraft;

    /**
     * The model of this aircraft.
     */
    readonly model?: Genai.AircraftModel;
    withModel(model: IGenai.AircraftModel | null): Genai.Aircraft;

    /**
     * The current location of this aircraft. The location is an airport that is located in a city, country and state, each with latitudes and longitudes. An aircraft is always located at an airport.
     */
    readonly location?: Genai.Airport;
    withLocation(location: IGenai.Airport | null): Genai.Aircraft;

    /**
     * Flag indicating if the aircraft is assigned to a pilot.
     */
    readonly isAssignedToPilot?: boolean;
    withIsAssignedToPilot(isAssignedToPilot: boolean): Genai.Aircraft;

    /**
     * The descriptions for all the component codes in this aircraft.
     */
    readonly componentCodesDescription?: Array_Type<string>;
    withComponentCodesDescription(componentCodesDescription: Array_Type<string> | Array<string> | null): Genai.Aircraft;

    /**
     * The unique descriptions for all the component codes in this aircraft. Stored as set.
     */
    readonly componentCodesDescriptionAsSet?: Set_Type<string>;
    withComponentCodesDescriptionAsSet(componentCodesDescriptionAsSet: Set_Type<string> | Array<string> | null): Genai.Aircraft;

    /**
     * Usage purpose of the Genai.Aircraft.
     */
    readonly usage?: string;
    withUsage(usage: string | null): Genai.Aircraft;

    /**
     * The type of engine.
     */
    readonly engineType?: string;
    withEngineType(engineType: string | null): Genai.Aircraft;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.Aircraft | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.Aircraft | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.Aircraft | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.Aircraft | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.Aircraft;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Aircraft;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Aircraft;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Aircraft>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Aircraft>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.Aircraft;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Aircraft;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Aircraft;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.Aircraft;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.Aircraft;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.Aircraft;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.Aircraft;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.Aircraft;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.Aircraft;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.Aircraft;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.Aircraft;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.Aircraft;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.Aircraft;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.Aircraft;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.Aircraft;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.Aircraft;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.Aircraft;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.Aircraft;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.Aircraft;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.Aircraft;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.Aircraft;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.Aircraft;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.Aircraft;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.Aircraft;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.Aircraft;

    mergeJson(json: any): Genai.Aircraft;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.Aircraft;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.Aircraft;
     ...
     */
    singletonArray(): Array_Type<Genai.Aircraft>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.Aircraft> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.Aircraft> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.Aircraft>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.Aircraft> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.Aircraft> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.Aircraft> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.Aircraft>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.Aircraft>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.Aircraft;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.Aircraft;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.Aircraft;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.Aircraft;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.Aircraft;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.Aircraft;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.Aircraft | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.Aircraft;
     ...
     */
    static cachedEmptyInst(): Genai.Aircraft;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.Aircraft> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.Aircraft;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Genai.Aircraft>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Genai.Aircraft>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Genai.Aircraft> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Genai.Aircraft>> | null;
     ...
     */
    static evalFeatureSetBatch(batch: Array_Type<Genai.Aircraft>, featureSet: Feature.Set, spec?: EvalFeatureSpec): Data | null;
     ...
     * ```
     */
    static evalFeaturesBatch(batch: Array_Type<Genai.Aircraft>, features: Array_Type<string>, spec?: EvalFeaturesSpec): Data | null;
     ...
     */
    get(include?: string): Genai.Aircraft | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Genai.Aircraft | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Genai.Aircraft;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Genai.Aircraft | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Genai.Aircraft;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.Aircraft | null;
     ...
     */
    create(spec?: UpsertSpec): Genai.Aircraft | null;
     ...
     */
    static createBatch(objs: Array_Type<Genai.Aircraft>, spec?: UpsertSpec): ObjList<Genai.Aircraft> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Genai.Aircraft>, spec?: CreateBatchObjStreamSpec): ObjList<Genai.Aircraft> | null;
     ...
     */
    update(srcObj?: Genai.Aircraft, spec?: UpsertSpec): Genai.Aircraft | null;
     ...
     */
    upsert(srcObj?: Genai.Aircraft, spec?: UpsertSpec): Genai.Aircraft | null;
     ...
     */
    merge(spec?: MergeSpec): Genai.Aircraft | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Genai.Aircraft | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Genai.Aircraft | null;
     ...
     */
    static updateBatch(objs: Array_Type<Genai.Aircraft>, srcObjs?: Array_Type<Genai.Aircraft>, spec?: UpsertSpec): ObjList<Genai.Aircraft> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Genai.Aircraft> | null>, spec?: UpsertSpec): ObjList<Genai.Aircraft> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Genai.Aircraft>, srcObjs?: Array_Type<Genai.Aircraft>, spec?: UpsertSpec): ObjList<Genai.Aircraft> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Genai.Aircraft> | null>, spec?: UpsertSpec): ObjList<Genai.Aircraft> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Genai.Aircraft>, spec?: TouchSpec): ObjList<Genai.Aircraft> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.Aircraft>, spec?: MergeSpec): ObjList<Genai.Aircraft> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.Aircraft>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.Aircraft> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Genai.Aircraft> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.Aircraft> | null;
     ...
     */
    static mergeAll(mergeObj: Genai.Aircraft, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Genai.Aircraft, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Genai.Aircraft>, spec?: UpsertSpec): ObjList<Genai.Aircraft> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Genai.Aircraft>, spec?: UpsertSpec): ObjList<Genai.Aircraft> | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Genai.Aircraft>): ObjList<Genai.Aircraft>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<Genai.Aircraft>): ObjList<Genai.Aircraft>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Genai.Aircraft>): ObjList<Genai.Aircraft>;
     ...
     */
    static afterCreate(objs: Array_Type<Genai.Aircraft>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Genai.Aircraft>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Genai.Aircraft>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Genai.Aircraft>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Genai.Aircraft>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.Aircraft | null;
     ...
     */
    withoutIdentity(): Genai.Aircraft | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Genai.Aircraft>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Genai.Aircraft, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Genai.Aircraft>, callback?: λFunction<Genai.Aircraft | null, Genai.Aircraft | null>): ObjList<Genai.Aircraft>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Genai.Aircraft>, callback?: λFunction<Genai.Aircraft | null, Genai.Aircraft | null>): Array_Type<ObjError> | null;
