// TypeScript definitions for the C3 type Genai.Llm.CredentialConfig

/**
 * Base type for configs for llm config from UI
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.Llm.CredentialConfig
 */
declare namespace Genai.Llm {
  export interface ICredentialConfig {
    ...
    /**
     * The default model name for Azure OpenAI.
     */
    azureDefaultModelName: string;

    /**
     * The default model name for AWS Bedrock.
     */
    awsDefaultModelName: string;

    /**
     * The default model name for Vertex AI.
     */
    vertexDefaultModelName: string;

    /**
     * The default timeout for LLM requests in seconds.
     */
    timeout: number;
  }
}
 ...
 * Base type for configs for llm config from UI
 *
 * @remarks this represents a made instance of Genai.Llm.CredentialConfig
 */
declare namespace Genai.Llm {
  export class CredentialConfig extends Obj  {

    /**
     * The unique and required name of this instance.
     */
    readonly name: string;
    withName(name: string): Genai.Llm.CredentialConfig;
    ...
    withConfigOverride(configOverride: string | null): Genai.Llm.CredentialConfig;

    static readonly configOverride?: string;

    readonly secretOverride?: string;
    withSecretOverride(secretOverride: string | null): Genai.Llm.CredentialConfig;
    ...
    withIssues(issues: Array_Type<string> | Array<string> | null): Genai.Llm.CredentialConfig;
     ...
     * The default model name for Azure OpenAI.
     */
    readonly azureDefaultModelName: string;
    withAzureDefaultModelName(azureDefaultModelName: string): Genai.Llm.CredentialConfig;

    /**
     * The default model name for Azure OpenAI.
     */
    static readonly azureDefaultModelName: string;

    /**
     * The default model name for AWS Bedrock.
     */
    readonly awsDefaultModelName: string;
    withAwsDefaultModelName(awsDefaultModelName: string): Genai.Llm.CredentialConfig;

    /**
     * The default model name for AWS Bedrock.
     */
    static readonly awsDefaultModelName: string;

    /**
     * The default model name for Vertex AI.
     */
    readonly vertexDefaultModelName: string;
    withVertexDefaultModelName(vertexDefaultModelName: string): Genai.Llm.CredentialConfig;

    /**
     * The default model name for Vertex AI.
     */
    static readonly vertexDefaultModelName: string;

    /**
     * The default timeout for LLM requests in seconds.
     */
    readonly timeout: number;
    withTimeout(timeout: number): Genai.Llm.CredentialConfig;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.Llm.CredentialConfig | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.Llm.CredentialConfig | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.Llm.CredentialConfig | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.Llm.CredentialConfig | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.Llm.CredentialConfig;
     ...
     * This method is used during live metadata update
     */
    static replaceType(old: Type, new_: Type): Genai.Llm.CredentialConfig;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Llm.CredentialConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Llm.CredentialConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Llm.CredentialConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Llm.CredentialConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Llm.CredentialConfig>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Llm.CredentialConfig>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Llm.CredentialConfig>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Llm.CredentialConfig>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.Llm.CredentialConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.Llm.CredentialConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Llm.CredentialConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Llm.CredentialConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Llm.CredentialConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Llm.CredentialConfig;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.Llm.CredentialConfig;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    static validateObj(): Genai.Llm.CredentialConfig;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.Llm.CredentialConfig;
     ...
     * @see #defaultField
     */
    static withField(field: string, value: any, doNotConvert?: boolean): Genai.Llm.CredentialConfig;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.Llm.CredentialConfig;
     ...
     * @see #defaultField
     */
    static withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.Llm.CredentialConfig;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.Llm.CredentialConfig;
     ...
     * @return new Obj
     */
    static withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.Llm.CredentialConfig;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.Llm.CredentialConfig;
     ...
     * @return new Obj
     */
    static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.Llm.CredentialConfig;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.Llm.CredentialConfig;
     ...
     * @see #withoutField
     */
    static withoutFieldAtPath(path: string): Genai.Llm.CredentialConfig;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.Llm.CredentialConfig;
     ...
     * @see #removeField
     */
    static withoutField(field: string): Genai.Llm.CredentialConfig;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.Llm.CredentialConfig;
     ...
     * @see #removeField
     */
    static withoutField(field: FieldType): Genai.Llm.CredentialConfig;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.Llm.CredentialConfig;
     ...
     * @return new Obj with removed fields
     */
    static withoutFields(fields: Array_Type<string>): Genai.Llm.CredentialConfig;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.Llm.CredentialConfig;
     ...
     * @return new Obj with removed fields
     */
    static withoutFieldsByType(fields: Array_Type<FieldType>): Genai.Llm.CredentialConfig;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.Llm.CredentialConfig;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    static withoutSecretFields(): Genai.Llm.CredentialConfig;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.Llm.CredentialConfig;
     ...
     * @see FieldType#defaultValue
     */
    static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.Llm.CredentialConfig;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.Llm.CredentialConfig;
     ...
     * @see #unsetField
     */
    static defaultField(field: string): Genai.Llm.CredentialConfig;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.Llm.CredentialConfig;
     ...
     * @see #unsetField
     */
    static defaultField(field: FieldType): Genai.Llm.CredentialConfig;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.Llm.CredentialConfig;
     ...
     * @see #removeField
     */
    static unsetField(field: string): Genai.Llm.CredentialConfig;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.Llm.CredentialConfig;
     ...
     * @see #removeField
     */
    static unsetField(field: FieldType): Genai.Llm.CredentialConfig;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.Llm.CredentialConfig;
     ...
     * @see #unsetField
     */
    static removeField(field: string): Genai.Llm.CredentialConfig;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.Llm.CredentialConfig;
     ...
     * @see #unsetField
     */
    static removeField(field: FieldType): Genai.Llm.CredentialConfig;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.Llm.CredentialConfig;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.Llm.CredentialConfig;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.Llm.CredentialConfig;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj, otherFieldsFilter: Type): Genai.Llm.CredentialConfig;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.Llm.CredentialConfig;
     ...
     *        the same key or index.
     */
    static mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.Llm.CredentialConfig;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.Llm.CredentialConfig;
     ...
     * traverse child reference and collection fields.
     */
    static mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.Llm.CredentialConfig;

    mergeJson(json: any): Genai.Llm.CredentialConfig;

    static mergeJson(json: any): Genai.Llm.CredentialConfig;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.Llm.CredentialConfig;
     ...
     * @return Obj with child references merged
     */
    static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.Llm.CredentialConfig;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.Llm.CredentialConfig;
     ...
     * references with same name and collection elements at same index or key.
     */
    static sumObj(other: Obj, deep?: boolean): Genai.Llm.CredentialConfig;
     ...
     */
    singletonArray(): Array_Type<Genai.Llm.CredentialConfig>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonArray(): Array_Type<Genai.Llm.CredentialConfig>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.Llm.CredentialConfig> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.Llm.CredentialConfig> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.Llm.CredentialConfig>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonSet(): Set_Type<Genai.Llm.CredentialConfig>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.Llm.CredentialConfig> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.Llm.CredentialConfig> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.Llm.CredentialConfig> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.Llm.CredentialConfig>;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    static toBuilder(): ObjBuilder<Genai.Llm.CredentialConfig>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.Llm.CredentialConfig>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.Llm.CredentialConfig;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.Llm.CredentialConfig;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.Llm.CredentialConfig;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.Llm.CredentialConfig;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.Llm.CredentialConfig;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.Llm.CredentialConfig;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.Llm.CredentialConfig | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.Llm.CredentialConfig;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.Llm.CredentialConfig;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    static afterMake(): Genai.Llm.CredentialConfig;
     ...
     */
    static cachedEmptyInst(): Genai.Llm.CredentialConfig;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.Llm.CredentialConfig> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.Llm.CredentialConfig;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.Llm.CredentialConfig | null;
     ...
     */
    static forName(name: string, failIfMissing?: boolean): Genai.Llm.CredentialConfig | null;
     ...
     */
    static inst(): Genai.Llm.CredentialConfig;
     ...
     */
    static allCached(): Stream<Genai.Llm.CredentialConfig> | null;
     ...
     */
    static find(filter?: string): Stream<Genai.Llm.CredentialConfig> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<Genai.Llm.CredentialConfig> | null;

    /**
     * @return cached instance.
     */
    getCached(): Genai.Llm.CredentialConfig | null;

    /**
     * @return cached instance.
     */
    static getCached(): Genai.Llm.CredentialConfig | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string): Genai.Llm.CredentialConfig | null;
     ...
     */
    static produce(key: string): Genai.Llm.CredentialConfig | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, Genai.Llm.CredentialConfig> | null;
     ...
     */
    getConfig(): Genai.Llm.CredentialConfig;
     ...
     * Note that typical pattern is to use Configurable#config instead of this method.
     */
    static getConfig(): Genai.Llm.CredentialConfig;
     ...
     */
    getSecret(): Genai.Llm.CredentialConfig;
     ...
     * Note that typical pattern is to use Configurable#configWithSecrets instead of this method.
     */
    static getSecret(): Genai.Llm.CredentialConfig;
     ...
     */
    withConfigKey(configKey: string): Genai.Llm.CredentialConfig;
     ...
     *     config.configKey() => "folder1/abc"
     */
    static withConfigKey(configKey: string): Genai.Llm.CredentialConfig;

    /**
     * @return copy without config key.
     */
    withoutConfigKey(): Genai.Llm.CredentialConfig;

    /**
     * @return copy without config key.
     */
    static withoutConfigKey(): Genai.Llm.CredentialConfig;

    /**
     * @return return cached config instance for provided config key.
     */
    static forConfigKey(configKey: string): Genai.Llm.CredentialConfig | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string>): Stream<Genai.Llm.CredentialConfig> | null;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: Genai.Llm.CredentialConfig, override?: string): void;
     ...
     * @see setConfigValue
     */
    static setConfigValues(from: Genai.Llm.CredentialConfig, override?: string): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): Genai.Llm.CredentialConfig | null;
     ...
     */
    removeSecrets(): Genai.Llm.CredentialConfig | null;

    /**
     * @return this config without any secret values.
     */
    static removeSecrets(): Genai.Llm.CredentialConfig | null;

    /**
     * @return this config with only secret values.
     */
    removeNonSecrets(): Genai.Llm.CredentialConfig | null;

    /**
     * @return this config with only secret values.
     */
    static removeNonSecrets(): Genai.Llm.CredentialConfig | null;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    validate(): Genai.Llm.CredentialConfig;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    static validate(): Genai.Llm.CredentialConfig;
