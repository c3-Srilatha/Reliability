// TypeScript definitions for the C3 type Genai.UnstructuredQuery.Engine.REA.PipelineConfig

/**
 * Describes the config for setting up the REA pipeline.
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.UnstructuredQuery.Engine.REA.PipelineConfig
 */
declare namespace Genai.UnstructuredQuery.Engine.REA {
  export interface IPipelineConfig {
    ...
    /**
     * If specified, then this is the {@link Genai.Retriever} that will be used by the Genai.UnstructuredQuery.Engine to retrive
     * similar passages.
     */
    vectorStore?: IGenai.Retriever;

    /**
     * The number of relevant passages to query the vector store for search results that populate
     * the grid below the main answer and rationale. This parameter DOES NOT affect either the answer or rationale.
     * This is typically much higher than executorParams -> numSources which corresponds to the
     * number of sources retrieved for each hop.
     */
    numPassages: number;

    /**
     * If true, then source relations will be not be persisted or returned for results when using this config.
     * This may be useful for cases where the data points to only a single source file.
     */
    suppressSourceRelations?: boolean;

    /**
     * If true, then {@link Genai.Query.ResultToUrlSourceRelation}s will be created for the query result, if {@link Genai.Source#sourceUrl}
     * exists for the cited source.
     * Note that url source relations will be created if this config is set to true and if #suppressSourceRelations is set to false.
     */
    createUrlSourceRelations?: boolean;
     ...
     */
    attributionSpec?: IGenai.Agent.Tool.Util.Attributor.Spec;

    /**
     * Whether to invoke the question answering model if all extracts are none or not.
     * If True we return "I am unable to answer your question" and will not invoke question answering. The default is False.
     */
    noPredictionsWithNoneExtracts?: boolean;

    /**
     * The maximum output tokens to be generated
     *  (only used for the API-based models for controlling cost). The default is 1000.
     */
    maxOutputTokens?: number;

    /**
     * The temperature variable used for increasing randomness of predictions o
     * (only used for the API-based models for controlling determinism). The default is 0 (fully deterministic).
     */
    temperature?: number;

    /**
     * If adding metadata before running the extractor into the contexts from the {@link Genai.SourceFile.Metadata}, the format to use e.g. `{page_content} filename:{fileName}`. If `{page_content}` is omitted, it will be prepended when formatting the contexts.
     */
    extractorMetadataFormat?: string;

    /**
     * If adding metadata before running the reranker into the contexts from the {@link Genai.SourceFile.Metadata}, the format to use e.g. `{page_content} filename:{fileName}`. If `{page_content}` is omitted, it will be prepended when formatting the contexts.
     */
    rerankerMetadataFormat?: string;

    /**
     * Whether to extract and remove tags before using the contexts for contextual QA
     */
    contextualQARemoveTags?: boolean;

    /**
     * If adding metadata before running the contextual question answerer into the contexts from the {@link Genai.SourceFile.Metadata}, the format to use e.g. `{page_content} filename:{fileName}`. If `{page_content}` is omitted, it will be prepended when formatting the contexts.
     */
    contextualQAMetadataFormat?: string;
 ...
 * Describes the config for setting up the REA pipeline.
 *
 * @remarks this represents a made instance of Genai.UnstructuredQuery.Engine.REA.PipelineConfig
 */
declare namespace Genai.UnstructuredQuery.Engine.REA {
  export class PipelineConfig extends Obj  {

    /**
     * The unique and required name of this instance.
     */
    readonly name: string;
    withName(name: string): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;
    ...
    withConfigOverride(configOverride: string | null): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;

    static readonly configOverride?: string;

    readonly secretOverride?: string;
    withSecretOverride(secretOverride: string | null): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;
    ...
    withIssues(issues: Array_Type<string> | Array<string> | null): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;
     ...
     * similar passages.
     */
    readonly vectorStore?: Genai.Retriever;
    withVectorStore(vectorStore: IGenai.Retriever | null): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;

    /**
     * If specified, then this is the {@link Genai.Retriever} that will be used by the Genai.UnstructuredQuery.Engine to retrive
     * similar passages.
     */
    static readonly vectorStore?: Genai.Retriever;
     ...
     * number of sources retrieved for each hop.
     */
    readonly numPassages: number;
    withNumPassages(numPassages: number): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;
     ...
     * number of sources retrieved for each hop.
     */
    static readonly numPassages: number;

    /**
     * If true, then source relations will be not be persisted or returned for results when using this config.
     * This may be useful for cases where the data points to only a single source file.
     */
    readonly suppressSourceRelations?: boolean;
    withSuppressSourceRelations(suppressSourceRelations: boolean): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;

    /**
     * If true, then source relations will be not be persisted or returned for results when using this config.
     * This may be useful for cases where the data points to only a single source file.
     */
    static readonly suppressSourceRelations?: boolean;
     ...
     * Note that url source relations will be created if this config is set to true and if #suppressSourceRelations is set to false.
     */
    readonly createUrlSourceRelations?: boolean;
    withCreateUrlSourceRelations(createUrlSourceRelations: boolean): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;
     ...
     * Note that url source relations will be created if this config is set to true and if #suppressSourceRelations is set to false.
     */
    static readonly createUrlSourceRelations?: boolean;

    /**
     * The Retriever config {@link Genai.UnstructuredQuery.Engine.REA.RetrieverConfig} name.
     */
    readonly retrieverConfigName: string;
    withRetrieverConfigName(retrieverConfigName: string): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;

    /**
     * The Retriever config {@link Genai.UnstructuredQuery.Engine.REA.RetrieverConfig} name.
     */
    static readonly retrieverConfigName: string;

    /**
     * The Extractor config {@link Genai.UnstructuredQuery.Engine.REA.ExtractorConfig} name.
     * If empty, the extractor step will be skipped.
     */
    readonly extractionConfigName?: string;
    withExtractionConfigName(extractionConfigName: string | null): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;

    /**
     * The Extractor config {@link Genai.UnstructuredQuery.Engine.REA.ExtractorConfig} name.
     * If empty, the extractor step will be skipped.
     */
    static readonly extractionConfigName?: string;

    /**
     * The Reranker config {@link Genai.UnstructuredQuery.Engine.REA.RerankerConfig} name.
     * If empty, the reranking step will be skipped.
     */
    readonly rerankerConfigName?: string;
    withRerankerConfigName(rerankerConfigName: string | null): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;

    /**
     * The Reranker config {@link Genai.UnstructuredQuery.Engine.REA.RerankerConfig} name.
     * If empty, the reranking step will be skipped.
     */
    static readonly rerankerConfigName?: string;

    /**
     * The {@link Genai.UnstructuredQuery.Engine.REA.ContextualQaConfig} name.
     */
    readonly questionAnsweringConfigName: string;
    withQuestionAnsweringConfigName(questionAnsweringConfigName: string): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;

    /**
     * The {@link Genai.UnstructuredQuery.Engine.REA.ContextualQaConfig} name.
     */
    static readonly questionAnsweringConfigName: string;

    /**
     * The Question Answerer Config {@link Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig} name.
     */
    readonly questionRewritingConfigName: string;
    withQuestionRewritingConfigName(questionRewritingConfigName: string): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;

    /**
     * The Question Answerer Config {@link Genai.UnstructuredQuery.Engine.REA.QuestionRewritingConfig} name.
     */
    static readonly questionRewritingConfigName: string;
     ...
     * If this is set to true, the full chat history can be passed to the LLM, along with the latest (non-rewritten) question.
     */
    readonly chatWithFullHistory?: boolean;
    withChatWithFullHistory(chatWithFullHistory: boolean): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;
     ...
     * If this is set to true, the full chat history can be passed to the LLM, along with the latest (non-rewritten) question.
     */
    static readonly chatWithFullHistory?: boolean;

    /**
     * Spec for {@link Genai.Agent.Tool.Util.Attributor#attribute}.
     * If not set, new attribution with corroboration will not run.
     */
    readonly attributionSpec?: Genai.Agent.Tool.Util.Attributor.Spec;
    withAttributionSpec(attributionSpec: IGenai.Agent.Tool.Util.Attributor.Spec | null): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;

    /**
     * Spec for {@link Genai.Agent.Tool.Util.Attributor#attribute}.
     * If not set, new attribution with corroboration will not run.
     */
    static readonly attributionSpec?: Genai.Agent.Tool.Util.Attributor.Spec;

    /**
     * Whether to invoke the question answering model if all extracts are none or not.
     * If True we return "I am unable to answer your question" and will not invoke question answering. The default is False.
     */
    readonly noPredictionsWithNoneExtracts?: boolean;
    withNoPredictionsWithNoneExtracts(noPredictionsWithNoneExtracts: boolean): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;

    /**
     * Whether to invoke the question answering model if all extracts are none or not.
     * If True we return "I am unable to answer your question" and will not invoke question answering. The default is False.
     */
    static readonly noPredictionsWithNoneExtracts?: boolean;
    ...
    withMaxOutputTokens(maxOutputTokens: number | null): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;

    /**
     * The maximum output tokens to be generated
     *  (only used for the API-based models for controlling cost). The default is 1000.
     */
    static readonly maxOutputTokens?: number;
    ...
    withTemperature(temperature: number | null): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;

    /**
     * The temperature variable used for increasing randomness of predictions o
     * (only used for the API-based models for controlling determinism). The default is 0 (fully deterministic).
     */
    static readonly temperature?: number;

    /**
     * If adding metadata before running the extractor into the contexts from the {@link Genai.SourceFile.Metadata}, the format to use e.g. `{page_content} filename:{fileName}`. If `{page_content}` is omitted, it will be prepended when formatting the contexts.
     */
    readonly extractorMetadataFormat?: string;
    withExtractorMetadataFormat(extractorMetadataFormat: string | null): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;

    /**
     * If adding metadata before running the extractor into the contexts from the {@link Genai.SourceFile.Metadata}, the format to use e.g. `{page_content} filename:{fileName}`. If `{page_content}` is omitted, it will be prepended when formatting the contexts.
     */
    static readonly extractorMetadataFormat?: string;

    /**
     * If adding metadata before running the reranker into the contexts from the {@link Genai.SourceFile.Metadata}, the format to use e.g. `{page_content} filename:{fileName}`. If `{page_content}` is omitted, it will be prepended when formatting the contexts.
     */
    readonly rerankerMetadataFormat?: string;
    withRerankerMetadataFormat(rerankerMetadataFormat: string | null): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;

    /**
     * If adding metadata before running the reranker into the contexts from the {@link Genai.SourceFile.Metadata}, the format to use e.g. `{page_content} filename:{fileName}`. If `{page_content}` is omitted, it will be prepended when formatting the contexts.
     */
    static readonly rerankerMetadataFormat?: string;

    /**
     * Whether to extract and remove tags before using the contexts for contextual QA
     */
    readonly contextualQARemoveTags?: boolean;
    withContextualQARemoveTags(contextualQARemoveTags: boolean): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;

    /**
     * Whether to extract and remove tags before using the contexts for contextual QA
     */
    static readonly contextualQARemoveTags?: boolean;

    /**
     * If adding metadata before running the contextual question answerer into the contexts from the {@link Genai.SourceFile.Metadata}, the format to use e.g. `{page_content} filename:{fileName}`. If `{page_content}` is omitted, it will be prepended when formatting the contexts.
     */
    readonly contextualQAMetadataFormat?: string;
    withContextualQAMetadataFormat(contextualQAMetadataFormat: string | null): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;

    /**
     * If adding metadata before running the contextual question answerer into the contexts from the {@link Genai.SourceFile.Metadata}, the format to use e.g. `{page_content} filename:{fileName}`. If `{page_content}` is omitted, it will be prepended when formatting the contexts.
     */
    static readonly contextualQAMetadataFormat?: string;
    ...
    withEngineThreadPoolSpec(engineThreadPoolSpec: IApp.Node.ThreadPool.Spec | null): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;
    ...
    withStreamTimeoutSeconds(streamTimeoutSeconds: number | null): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;

    /**
     * For any response that is streamed, consider it failed after this many seconds.
     */
    static readonly streamTimeoutSeconds?: number;
     ...
     */
    static inst(): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.UnstructuredQuery.Engine.REA.PipelineConfig | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.UnstructuredQuery.Engine.REA.PipelineConfig | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.UnstructuredQuery.Engine.REA.PipelineConfig | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.UnstructuredQuery.Engine.REA.PipelineConfig | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;
     ...
     * This method is used during live metadata update
     */
    static replaceType(old: Type, new_: Type): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.UnstructuredQuery.Engine.REA.PipelineConfig>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.UnstructuredQuery.Engine.REA.PipelineConfig>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.UnstructuredQuery.Engine.REA.PipelineConfig>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.UnstructuredQuery.Engine.REA.PipelineConfig>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    static validateObj(): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;
     ...
     * @see #defaultField
     */
    static withField(field: string, value: any, doNotConvert?: boolean): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;
     ...
     * @see #defaultField
     */
    static withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;
     ...
     * @return new Obj
     */
    static withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;
     ...
     * @return new Obj
     */
    static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;
     ...
     * @see #withoutField
     */
    static withoutFieldAtPath(path: string): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;
     ...
     * @see #removeField
     */
    static withoutField(field: string): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;
     ...
     * @see #removeField
     */
    static withoutField(field: FieldType): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;
     ...
     * @return new Obj with removed fields
     */
    static withoutFields(fields: Array_Type<string>): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;
     ...
     * @return new Obj with removed fields
     */
    static withoutFieldsByType(fields: Array_Type<FieldType>): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    static withoutSecretFields(): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;
     ...
     * @see FieldType#defaultValue
     */
    static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;
     ...
     * @see #unsetField
     */
    static defaultField(field: string): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;
     ...
     * @see #unsetField
     */
    static defaultField(field: FieldType): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;
     ...
     * @see #removeField
     */
    static unsetField(field: string): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;
     ...
     * @see #removeField
     */
    static unsetField(field: FieldType): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;
     ...
     * @see #unsetField
     */
    static removeField(field: string): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;
     ...
     * @see #unsetField
     */
    static removeField(field: FieldType): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj, otherFieldsFilter: Type): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;
     ...
     *        the same key or index.
     */
    static mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;
     ...
     * traverse child reference and collection fields.
     */
    static mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;

    mergeJson(json: any): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;

    static mergeJson(json: any): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;
     ...
     * @return Obj with child references merged
     */
    static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;
     ...
     * references with same name and collection elements at same index or key.
     */
    static sumObj(other: Obj, deep?: boolean): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;
     ...
     */
    singletonArray(): Array_Type<Genai.UnstructuredQuery.Engine.REA.PipelineConfig>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonArray(): Array_Type<Genai.UnstructuredQuery.Engine.REA.PipelineConfig>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.UnstructuredQuery.Engine.REA.PipelineConfig> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.UnstructuredQuery.Engine.REA.PipelineConfig> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.UnstructuredQuery.Engine.REA.PipelineConfig>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonSet(): Set_Type<Genai.UnstructuredQuery.Engine.REA.PipelineConfig>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.UnstructuredQuery.Engine.REA.PipelineConfig> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.UnstructuredQuery.Engine.REA.PipelineConfig> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.UnstructuredQuery.Engine.REA.PipelineConfig> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.UnstructuredQuery.Engine.REA.PipelineConfig>;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    static toBuilder(): ObjBuilder<Genai.UnstructuredQuery.Engine.REA.PipelineConfig>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.UnstructuredQuery.Engine.REA.PipelineConfig>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.UnstructuredQuery.Engine.REA.PipelineConfig | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    static afterMake(): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;
     ...
     */
    static cachedEmptyInst(): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.UnstructuredQuery.Engine.REA.PipelineConfig> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.UnstructuredQuery.Engine.REA.PipelineConfig | null;
     ...
     */
    static forName(name: string, failIfMissing?: boolean): Genai.UnstructuredQuery.Engine.REA.PipelineConfig | null;
     ...
     */
    static allCached(): Stream<Genai.UnstructuredQuery.Engine.REA.PipelineConfig> | null;
     ...
     */
    static find(filter?: string): Stream<Genai.UnstructuredQuery.Engine.REA.PipelineConfig> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<Genai.UnstructuredQuery.Engine.REA.PipelineConfig> | null;

    /**
     * @return cached instance.
     */
    getCached(): Genai.UnstructuredQuery.Engine.REA.PipelineConfig | null;

    /**
     * @return cached instance.
     */
    static getCached(): Genai.UnstructuredQuery.Engine.REA.PipelineConfig | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string): Genai.UnstructuredQuery.Engine.REA.PipelineConfig | null;
     ...
     */
    static produce(key: string): Genai.UnstructuredQuery.Engine.REA.PipelineConfig | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, Genai.UnstructuredQuery.Engine.REA.PipelineConfig> | null;
     ...
     */
    getConfig(): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;
     ...
     * Note that typical pattern is to use Configurable#config instead of this method.
     */
    static getConfig(): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;
     ...
     */
    getSecret(): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;
     ...
     * Note that typical pattern is to use Configurable#configWithSecrets instead of this method.
     */
    static getSecret(): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;
     ...
     */
    withConfigKey(configKey: string): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;
     ...
     *     config.configKey() => "folder1/abc"
     */
    static withConfigKey(configKey: string): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;

    /**
     * @return copy without config key.
     */
    withoutConfigKey(): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;

    /**
     * @return copy without config key.
     */
    static withoutConfigKey(): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;

    /**
     * @return return cached config instance for provided config key.
     */
    static forConfigKey(configKey: string): Genai.UnstructuredQuery.Engine.REA.PipelineConfig | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string>): Stream<Genai.UnstructuredQuery.Engine.REA.PipelineConfig> | null;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: Genai.UnstructuredQuery.Engine.REA.PipelineConfig, override?: string): void;
     ...
     * @see setConfigValue
     */
    static setConfigValues(from: Genai.UnstructuredQuery.Engine.REA.PipelineConfig, override?: string): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): Genai.UnstructuredQuery.Engine.REA.PipelineConfig | null;
     ...
     */
    removeSecrets(): Genai.UnstructuredQuery.Engine.REA.PipelineConfig | null;

    /**
     * @return this config without any secret values.
     */
    static removeSecrets(): Genai.UnstructuredQuery.Engine.REA.PipelineConfig | null;

    /**
     * @return this config with only secret values.
     */
    removeNonSecrets(): Genai.UnstructuredQuery.Engine.REA.PipelineConfig | null;

    /**
     * @return this config with only secret values.
     */
    static removeNonSecrets(): Genai.UnstructuredQuery.Engine.REA.PipelineConfig | null;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    validate(): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    static validate(): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;
     ...
     */
    static setRecursive(configJson: any, useSetConfigValues?: boolean, override?: string): Genai.UnstructuredQuery.Engine.REA.PipelineConfig;
