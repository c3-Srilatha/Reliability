// TypeScript definitions for the C3 type Genai.Tutorial.REAEngine
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.Tutorial.REAEngine
 */
declare namespace Genai.Tutorial {
  export interface IREAEngine {
 ...
 */
declare namespace Genai.Tutorial {
  export class REAEngine extends Obj  {

    /**
     * The unique and required name of this instance.
     */
    readonly name: string;
    withName(name: string): Genai.Tutorial.REAEngine;
     ...
     */
    readonly id: string;
    withId(id: string): Genai.Tutorial.REAEngine;
    ...
    with_deploymentCache(_deploymentCache: any | null): Genai.Tutorial.REAEngine;
    ...
    with_onStartError(_onStartError: string | null): Genai.Tutorial.REAEngine;
     ...
     */
    static inst(): Genai.Tutorial.REAEngine;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.Tutorial.REAEngine | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.Tutorial.REAEngine | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.Tutorial.REAEngine | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.Tutorial.REAEngine | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.Tutorial.REAEngine;
     ...
     * This method is used during live metadata update
     */
    static replaceType(old: Type, new_: Type): Genai.Tutorial.REAEngine;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Tutorial.REAEngine;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Tutorial.REAEngine;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Tutorial.REAEngine;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Tutorial.REAEngine;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Tutorial.REAEngine>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Tutorial.REAEngine>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Tutorial.REAEngine>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Tutorial.REAEngine>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.Tutorial.REAEngine;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.Tutorial.REAEngine;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Tutorial.REAEngine;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Tutorial.REAEngine;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Tutorial.REAEngine;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Tutorial.REAEngine;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.Tutorial.REAEngine;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    static validateObj(): Genai.Tutorial.REAEngine;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.Tutorial.REAEngine;
     ...
     * @see #defaultField
     */
    static withField(field: string, value: any, doNotConvert?: boolean): Genai.Tutorial.REAEngine;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.Tutorial.REAEngine;
     ...
     * @see #defaultField
     */
    static withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.Tutorial.REAEngine;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.Tutorial.REAEngine;
     ...
     * @return new Obj
     */
    static withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.Tutorial.REAEngine;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.Tutorial.REAEngine;
     ...
     * @return new Obj
     */
    static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.Tutorial.REAEngine;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.Tutorial.REAEngine;
     ...
     * @see #withoutField
     */
    static withoutFieldAtPath(path: string): Genai.Tutorial.REAEngine;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.Tutorial.REAEngine;
     ...
     * @see #removeField
     */
    static withoutField(field: string): Genai.Tutorial.REAEngine;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.Tutorial.REAEngine;
     ...
     * @see #removeField
     */
    static withoutField(field: FieldType): Genai.Tutorial.REAEngine;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.Tutorial.REAEngine;
     ...
     * @return new Obj with removed fields
     */
    static withoutFields(fields: Array_Type<string>): Genai.Tutorial.REAEngine;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.Tutorial.REAEngine;
     ...
     * @return new Obj with removed fields
     */
    static withoutFieldsByType(fields: Array_Type<FieldType>): Genai.Tutorial.REAEngine;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.Tutorial.REAEngine;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    static withoutSecretFields(): Genai.Tutorial.REAEngine;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.Tutorial.REAEngine;
     ...
     * @see FieldType#defaultValue
     */
    static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.Tutorial.REAEngine;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.Tutorial.REAEngine;
     ...
     * @see #unsetField
     */
    static defaultField(field: string): Genai.Tutorial.REAEngine;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.Tutorial.REAEngine;
     ...
     * @see #unsetField
     */
    static defaultField(field: FieldType): Genai.Tutorial.REAEngine;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.Tutorial.REAEngine;
     ...
     * @see #removeField
     */
    static unsetField(field: string): Genai.Tutorial.REAEngine;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.Tutorial.REAEngine;
     ...
     * @see #removeField
     */
    static unsetField(field: FieldType): Genai.Tutorial.REAEngine;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.Tutorial.REAEngine;
     ...
     * @see #unsetField
     */
    static removeField(field: string): Genai.Tutorial.REAEngine;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.Tutorial.REAEngine;
     ...
     * @see #unsetField
     */
    static removeField(field: FieldType): Genai.Tutorial.REAEngine;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.Tutorial.REAEngine;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.Tutorial.REAEngine;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.Tutorial.REAEngine;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj, otherFieldsFilter: Type): Genai.Tutorial.REAEngine;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.Tutorial.REAEngine;
     ...
     *        the same key or index.
     */
    static mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.Tutorial.REAEngine;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.Tutorial.REAEngine;
     ...
     * traverse child reference and collection fields.
     */
    static mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.Tutorial.REAEngine;

    mergeJson(json: any): Genai.Tutorial.REAEngine;

    static mergeJson(json: any): Genai.Tutorial.REAEngine;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.Tutorial.REAEngine;
     ...
     * @return Obj with child references merged
     */
    static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.Tutorial.REAEngine;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.Tutorial.REAEngine;
     ...
     * references with same name and collection elements at same index or key.
     */
    static sumObj(other: Obj, deep?: boolean): Genai.Tutorial.REAEngine;
     ...
     */
    singletonArray(): Array_Type<Genai.Tutorial.REAEngine>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonArray(): Array_Type<Genai.Tutorial.REAEngine>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.Tutorial.REAEngine> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.Tutorial.REAEngine> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.Tutorial.REAEngine>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonSet(): Set_Type<Genai.Tutorial.REAEngine>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.Tutorial.REAEngine> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.Tutorial.REAEngine> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.Tutorial.REAEngine> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.Tutorial.REAEngine>;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    static toBuilder(): ObjBuilder<Genai.Tutorial.REAEngine>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.Tutorial.REAEngine>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.Tutorial.REAEngine;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.Tutorial.REAEngine;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.Tutorial.REAEngine;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.Tutorial.REAEngine;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.Tutorial.REAEngine;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.Tutorial.REAEngine;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.Tutorial.REAEngine | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.Tutorial.REAEngine;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.Tutorial.REAEngine;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    static afterMake(): Genai.Tutorial.REAEngine;
     ...
     */
    static cachedEmptyInst(): Genai.Tutorial.REAEngine;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.Tutorial.REAEngine> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.Tutorial.REAEngine;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.Tutorial.REAEngine | null;
     ...
     */
    static forName(name: string, failIfMissing?: boolean): Genai.Tutorial.REAEngine | null;

    /**
     * @return single instance of this Identified type by id.
     */
    static forId(id: string, failIfMissing?: boolean): Genai.Tutorial.REAEngine | null;
     ...
     */
    static deploy(spec: Genai.UnstructuredQuery.EngineDeploySpec): Genai.Tutorial.REAEngine;
     ...
     */
    restart(): Genai.Tutorial.REAEngine;

    /**
     * Restarts this engine
     */
    static restart(): Genai.Tutorial.REAEngine;
     ...
     */
    start(waitForReady?: boolean, spec?: WaitableSpec): Genai.Tutorial.REAEngine | null;
     ...
     * @return `null` if not waiting for ready and ready instance of the {@link Engine} otherwise.
     */
    static start(waitForReady?: boolean, spec?: WaitableSpec): Genai.Tutorial.REAEngine | null;

    doStart(): Genai.Tutorial.REAEngine;

    static doStart(): Genai.Tutorial.REAEngine;
     ...
     */
    call(action: Lambda<function(engine: Genai.Tutorial.REAEngine): T | null>): T | null;

    /**
     * call `action` on a specific engine
     */
    static call(action: Lambda<function(engine: Genai.Tutorial.REAEngine): T | null>): T | null;
     ...
     */
    onStart(): Genai.Tutorial.REAEngine;
     ...
     * @see #onEngineThreadStart
     */
    static onStart(): Genai.Tutorial.REAEngine;
     ...
     * @see: #terminate
     */
    static list(): Array_Type<Genai.Tutorial.REAEngine> | null;
     ...
     */
    static allHandlers(): Array_Type<Genai.Tutorial.REAEngine> | null;

    /**
     * Stops all running handlers
     */
    static stopAllHandlers(): Array_Type<Genai.Tutorial.REAEngine> | null;
     ...
     */
    static forConfig(config: Genai.UnstructuredQuery.Engine.Config): Genai.Tutorial.REAEngine | null;

    /**
     * Initialize the engine
     */
    initialize(forceReload?: boolean): Genai.Tutorial.REAEngine;

    /**
     * Initialize the engine
     */
    static initialize(forceReload?: boolean): Genai.Tutorial.REAEngine;
