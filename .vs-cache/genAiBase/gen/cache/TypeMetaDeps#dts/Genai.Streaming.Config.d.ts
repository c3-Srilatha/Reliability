// TypeScript definitions for the C3 type Genai.Streaming.Config

/**
 * Configuration type for the text streaming feature.
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.Streaming.Config
 */
...
declare namespace Genai.Streaming {
  export class Config extends Obj  {
    ...
    withConfigOverride(configOverride: string | null): Genai.Streaming.Config;

    readonly secretOverride?: string;
    withSecretOverride(secretOverride: string | null): Genai.Streaming.Config;

    /**
     * Captures any issues that occurred while deserializing from filesystem
     */
    readonly issues?: Array_Type<string>;
    withIssues(issues: Array_Type<string> | Array<string> | null): Genai.Streaming.Config;

    /**
     * Whether text streaming to the UI should be enabled or disabled.
     */
    readonly enabled?: boolean;
    withEnabled(enabled: boolean): Genai.Streaming.Config;

    /**
     * The frequency in milliseconds at which the UI should check for new stream chunks.
     */
    readonly streamingFrequencyMs?: number;
    withStreamingFrequencyMs(streamingFrequencyMs: number | null): Genai.Streaming.Config;

    /**
     * The interval in seconds between writes of the streaming data to the database
     */
    readonly dbStreamingIntervalSeconds?: number;
    withDbStreamingIntervalSeconds(dbStreamingIntervalSeconds: number | null): Genai.Streaming.Config;
     ...
     * since the the UI would spend more time waiting on the next stream chunk to be returned.
     */
    readonly typewriterKeyDelayInProgress?: number;
    withTypewriterKeyDelayInProgress(typewriterKeyDelayInProgress: number | null): Genai.Streaming.Config;

    /**
     * The amount of delay in milliseconds between each render when all chunks have been received.
     */
    readonly typewriterKeyDelayFinished?: number;
    withTypewriterKeyDelayFinished(typewriterKeyDelayFinished: number | null): Genai.Streaming.Config;
    ...
    withContextSize(contextSize: number | null): Genai.Streaming.Config;

    /**
     * The minimum number of characters a returned sentence chunk must have.
     * Shorter sentences are concatenated with the following sentence.
     */
    readonly minimumSentenceLength?: number;
    withMinimumSentenceLength(minimumSentenceLength: number | null): Genai.Streaming.Config;

    /**
     * The strategy for streaming text to the UI.
     */
    readonly strategy?: string;
    withStrategy(strategy: string | null): Genai.Streaming.Config;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.Streaming.Config | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.Streaming.Config | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.Streaming.Config | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.Streaming.Config | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.Streaming.Config;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Streaming.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Streaming.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Streaming.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Streaming.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.Streaming.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Streaming.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Streaming.Config;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.Streaming.Config;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.Streaming.Config;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.Streaming.Config;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.Streaming.Config;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.Streaming.Config;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.Streaming.Config;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.Streaming.Config;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.Streaming.Config;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.Streaming.Config;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.Streaming.Config;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.Streaming.Config;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.Streaming.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.Streaming.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.Streaming.Config;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.Streaming.Config;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.Streaming.Config;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.Streaming.Config;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.Streaming.Config;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.Streaming.Config;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.Streaming.Config;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.Streaming.Config;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.Streaming.Config;

    mergeJson(json: any): Genai.Streaming.Config;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.Streaming.Config;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.Streaming.Config;
     ...
     */
    singletonArray(): Array_Type<Genai.Streaming.Config>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.Streaming.Config> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.Streaming.Config> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.Streaming.Config>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.Streaming.Config> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.Streaming.Config> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.Streaming.Config> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.Streaming.Config>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.Streaming.Config>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.Streaming.Config;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.Streaming.Config;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.Streaming.Config;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.Streaming.Config;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.Streaming.Config;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.Streaming.Config;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.Streaming.Config;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.Streaming.Config;
     ...
     */
    static cachedEmptyInst(): Genai.Streaming.Config;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.Streaming.Config> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.Streaming.Config;
     ...
     */
    static allCached(): Stream<Genai.Streaming.Config> | null;
     ...
     */
    static find(filter?: string): Stream<Genai.Streaming.Config> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<Genai.Streaming.Config> | null;

    /**
     * @return cached instance.
     */
    getCached(): Genai.Streaming.Config | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string): Genai.Streaming.Config | null;
     ...
     */
    static produce(key: string): Genai.Streaming.Config | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, Genai.Streaming.Config> | null;
     ...
     */
    getConfig(): Genai.Streaming.Config;
     ...
     */
    getSecret(): Genai.Streaming.Config;
     ...
     */
    withConfigKey(configKey: string): Genai.Streaming.Config;

    /**
     * @return copy without config key.
     */
    withoutConfigKey(): Genai.Streaming.Config;

    /**
     * @return return cached config instance for provided config key.
     */
    static forConfigKey(configKey: string): Genai.Streaming.Config | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string>): Stream<Genai.Streaming.Config> | null;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: Genai.Streaming.Config, override?: string): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): Genai.Streaming.Config | null;
