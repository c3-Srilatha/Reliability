// TypeScript definitions for the C3 type Genai.Agent.Dynamic.Toolkit

/**
 * Type representing a toolkit for a {@link Genai.Agent.Dynamic} agent.
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.Agent.Dynamic.Toolkit
 */
 ...
 */
declare namespace Genai.Agent.Dynamic {
  export class Toolkit extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): Genai.Agent.Dynamic.Toolkit;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Genai.Agent.Dynamic.Toolkit;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): Genai.Agent.Dynamic.Toolkit;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Genai.Agent.Dynamic.Toolkit;
    ...
    withVersion(version: number | null): Genai.Agent.Dynamic.Toolkit;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Genai.Agent.Dynamic.Toolkit;
    ...
    withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): Genai.Agent.Dynamic.Toolkit;
    ...
    withHidden(hidden: boolean): Genai.Agent.Dynamic.Toolkit;
    ...
    withUserOwned(userOwned: boolean): Genai.Agent.Dynamic.Toolkit;
    ...
    withTypeIdent(typeIdent: string | null): Genai.Agent.Dynamic.Toolkit;

    /**
     * A brief description of the logical group of tools specified in #tools.
     */
    readonly description?: string;
    withDescription(description: string | null): Genai.Agent.Dynamic.Toolkit;

    /**
     * All tools (or toolkits) available in this toolkit.
     */
    readonly tools?: Array_Type<GenaiCore.Tool | GenaiCore.Toolkit>;
    withTools(tools: Array_Type<GenaiCore.Tool | GenaiCore.Toolkit> | Array<IGenaiCore.Tool | IGenaiCore.Toolkit> | null): Genai.Agent.Dynamic.Toolkit;

    /**
     * The flag used to mark whether the toolkit has been published. Defaults to `false`.
     */
    readonly isPublished?: boolean;
    withIsPublished(isPublished: boolean): Genai.Agent.Dynamic.Toolkit;

    /**
     * Description of this toolkit, targeted for user information. This is not shown to the agent.
     */
    readonly descriptionForUser?: string;
    withDescriptionForUser(descriptionForUser: string | null): Genai.Agent.Dynamic.Toolkit;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.Agent.Dynamic.Toolkit | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.Agent.Dynamic.Toolkit | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.Agent.Dynamic.Toolkit | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.Agent.Dynamic.Toolkit | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.Agent.Dynamic.Toolkit;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Agent.Dynamic.Toolkit;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Agent.Dynamic.Toolkit;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Agent.Dynamic.Toolkit>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Agent.Dynamic.Toolkit>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.Agent.Dynamic.Toolkit;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Agent.Dynamic.Toolkit;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Agent.Dynamic.Toolkit;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.Agent.Dynamic.Toolkit;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.Agent.Dynamic.Toolkit;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.Agent.Dynamic.Toolkit;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.Agent.Dynamic.Toolkit;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.Agent.Dynamic.Toolkit;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.Agent.Dynamic.Toolkit;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.Agent.Dynamic.Toolkit;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.Agent.Dynamic.Toolkit;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.Agent.Dynamic.Toolkit;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.Agent.Dynamic.Toolkit;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.Agent.Dynamic.Toolkit;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.Agent.Dynamic.Toolkit;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.Agent.Dynamic.Toolkit;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.Agent.Dynamic.Toolkit;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.Agent.Dynamic.Toolkit;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.Agent.Dynamic.Toolkit;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.Agent.Dynamic.Toolkit;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.Agent.Dynamic.Toolkit;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.Agent.Dynamic.Toolkit;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.Agent.Dynamic.Toolkit;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.Agent.Dynamic.Toolkit;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.Agent.Dynamic.Toolkit;

    mergeJson(json: any): Genai.Agent.Dynamic.Toolkit;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.Agent.Dynamic.Toolkit;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.Agent.Dynamic.Toolkit;
     ...
     */
    singletonArray(): Array_Type<Genai.Agent.Dynamic.Toolkit>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.Agent.Dynamic.Toolkit> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.Agent.Dynamic.Toolkit> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.Agent.Dynamic.Toolkit>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.Agent.Dynamic.Toolkit> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.Agent.Dynamic.Toolkit> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.Agent.Dynamic.Toolkit> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.Agent.Dynamic.Toolkit>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.Agent.Dynamic.Toolkit>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.Agent.Dynamic.Toolkit;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.Agent.Dynamic.Toolkit;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.Agent.Dynamic.Toolkit;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.Agent.Dynamic.Toolkit;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.Agent.Dynamic.Toolkit;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.Agent.Dynamic.Toolkit;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.Agent.Dynamic.Toolkit | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.Agent.Dynamic.Toolkit;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.Agent.Dynamic.Toolkit;
     ...
     */
    static cachedEmptyInst(): Genai.Agent.Dynamic.Toolkit;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.Agent.Dynamic.Toolkit> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.Agent.Dynamic.Toolkit;
     ...
     */
    static allCached(): Stream<Genai.Agent.Dynamic.Toolkit> | null;
     ...
     */
    static find(filter?: string): Stream<Genai.Agent.Dynamic.Toolkit> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<Genai.Agent.Dynamic.Toolkit> | null;

    /**
     * @return cached instance.
     */
    getCached(): Genai.Agent.Dynamic.Toolkit | null;

    /**
     * @return cached instance by the key.
     */
    static forCacheKey(key: string): Genai.Agent.Dynamic.Toolkit | null;
     ...
     */
    static produce(key: string): Genai.Agent.Dynamic.Toolkit | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, Genai.Agent.Dynamic.Toolkit> | null;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Genai.Agent.Dynamic.Toolkit>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Genai.Agent.Dynamic.Toolkit>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Genai.Agent.Dynamic.Toolkit> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Genai.Agent.Dynamic.Toolkit>> | null;
     ...
     */
    get(include?: string): Genai.Agent.Dynamic.Toolkit | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Genai.Agent.Dynamic.Toolkit | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Genai.Agent.Dynamic.Toolkit;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Genai.Agent.Dynamic.Toolkit | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Genai.Agent.Dynamic.Toolkit;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.Agent.Dynamic.Toolkit | null;
     ...
     */
    create(spec?: UpsertSpec): Genai.Agent.Dynamic.Toolkit | null;
     ...
     */
    static createBatch(objs: Array_Type<Genai.Agent.Dynamic.Toolkit>, spec?: UpsertSpec): ObjList<Genai.Agent.Dynamic.Toolkit> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Genai.Agent.Dynamic.Toolkit>, spec?: CreateBatchObjStreamSpec): ObjList<Genai.Agent.Dynamic.Toolkit> | null;
     ...
     */
    update(srcObj?: Genai.Agent.Dynamic.Toolkit, spec?: UpsertSpec): Genai.Agent.Dynamic.Toolkit | null;
     ...
     */
    upsert(srcObj?: Genai.Agent.Dynamic.Toolkit, spec?: UpsertSpec): Genai.Agent.Dynamic.Toolkit | null;
     ...
     */
    merge(spec?: MergeSpec): Genai.Agent.Dynamic.Toolkit | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Genai.Agent.Dynamic.Toolkit | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Genai.Agent.Dynamic.Toolkit | null;
     ...
     */
    static updateBatch(objs: Array_Type<Genai.Agent.Dynamic.Toolkit>, srcObjs?: Array_Type<Genai.Agent.Dynamic.Toolkit>, spec?: UpsertSpec): ObjList<Genai.Agent.Dynamic.Toolkit> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Genai.Agent.Dynamic.Toolkit> | null>, spec?: UpsertSpec): ObjList<Genai.Agent.Dynamic.Toolkit> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Genai.Agent.Dynamic.Toolkit>, srcObjs?: Array_Type<Genai.Agent.Dynamic.Toolkit>, spec?: UpsertSpec): ObjList<Genai.Agent.Dynamic.Toolkit> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Genai.Agent.Dynamic.Toolkit> | null>, spec?: UpsertSpec): ObjList<Genai.Agent.Dynamic.Toolkit> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Genai.Agent.Dynamic.Toolkit>, spec?: TouchSpec): ObjList<Genai.Agent.Dynamic.Toolkit> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.Agent.Dynamic.Toolkit>, spec?: MergeSpec): ObjList<Genai.Agent.Dynamic.Toolkit> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.Agent.Dynamic.Toolkit>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.Agent.Dynamic.Toolkit> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Genai.Agent.Dynamic.Toolkit> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.Agent.Dynamic.Toolkit> | null;
     ...
     */
    static mergeAll(mergeObj: Genai.Agent.Dynamic.Toolkit, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Genai.Agent.Dynamic.Toolkit, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Genai.Agent.Dynamic.Toolkit>, spec?: UpsertSpec): ObjList<Genai.Agent.Dynamic.Toolkit> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Genai.Agent.Dynamic.Toolkit>, spec?: UpsertSpec): ObjList<Genai.Agent.Dynamic.Toolkit> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Genai.Agent.Dynamic.Toolkit | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Genai.Agent.Dynamic.Toolkit>): ObjList<Genai.Agent.Dynamic.Toolkit>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<Genai.Agent.Dynamic.Toolkit>): ObjList<Genai.Agent.Dynamic.Toolkit>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Genai.Agent.Dynamic.Toolkit>): ObjList<Genai.Agent.Dynamic.Toolkit>;
     ...
     */
    static afterCreate(objs: Array_Type<Genai.Agent.Dynamic.Toolkit>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Genai.Agent.Dynamic.Toolkit>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Genai.Agent.Dynamic.Toolkit>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Genai.Agent.Dynamic.Toolkit>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Genai.Agent.Dynamic.Toolkit>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.Agent.Dynamic.Toolkit | null;
     ...
     */
    withoutIdentity(): Genai.Agent.Dynamic.Toolkit | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Genai.Agent.Dynamic.Toolkit>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Genai.Agent.Dynamic.Toolkit, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Genai.Agent.Dynamic.Toolkit>, callback?: λFunction<Genai.Agent.Dynamic.Toolkit | null, Genai.Agent.Dynamic.Toolkit | null>): ObjList<Genai.Agent.Dynamic.Toolkit>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Genai.Agent.Dynamic.Toolkit>, callback?: λFunction<Genai.Agent.Dynamic.Toolkit | null, Genai.Agent.Dynamic.Toolkit | null>): Array_Type<ObjError> | null;
     ...
     */
    publish(subPath?: string, contentType?: string): Genai.Agent.Dynamic.Toolkit;
     ...
     */
    static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<Genai.Agent.Dynamic.Toolkit> | null;
     ...
     */
    createSeedData(spec?: UpsertSpec): Genai.Agent.Dynamic.Toolkit | null;
     ...
     */
    static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<Genai.Agent.Dynamic.Toolkit> | null;
     ...
     */
    updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): Genai.Agent.Dynamic.Toolkit | null;
     ...
     */
    static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<Genai.Agent.Dynamic.Toolkit> | null;
     ...
     * @return updated obj instance, same as {@link Persistable#update} return value.
     */
    clearUserUpdates(spec?: MergeSpec): Genai.Agent.Dynamic.Toolkit | null;
     ...
     *         {@link Persistable#updateBatch}.
     */
    static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<Genai.Agent.Dynamic.Toolkit> | null;
    ...
    dependencies(): SeedDataDeps<Genai.Agent.Dynamic.Toolkit> | null;
     ...
     */
    allTools(): Array_Type<GenaiCore.Tool> | null;
     ...
     */
    publishToolkit(republish?: boolean): Genai.Agent.Dynamic.Toolkit;

    /**
     * Initializes the toolkit and its {@link Genai.Agent.Dynamic.Tool}s.
     */
    initialize(forceReload?: boolean): any;
     ...
     *    The toolkit.
     */
    static fromLocalFileList(name: string, specList: Array_Type<Genai.Agent.Dynamic.Tool.FromLocalFileSpec>, overrideIfExists?: boolean): Genai.Agent.Dynamic.Toolkit;
  }
}
