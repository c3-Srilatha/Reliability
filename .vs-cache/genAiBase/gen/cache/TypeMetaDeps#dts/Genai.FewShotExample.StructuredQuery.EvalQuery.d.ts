// TypeScript definitions for the C3 type Genai.FewShotExample.StructuredQuery.EvalQuery

/**
 * A few-shot example for the {@link Genai.Agent.Tool.EvalQuery} tool.
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.FewShotExample.StructuredQuery.EvalQuery
 */
declare namespace Genai.FewShotExample.StructuredQuery {
  export interface IEvalQuery {
     ...
     */
    spec: IGenai.StructuredQuery.Spec;
  }
}
 ...
 */
declare namespace Genai.FewShotExample.StructuredQuery {
  export class EvalQuery extends Obj  {
    ...
    withTypeIdent(typeIdent: string | null): Genai.FewShotExample.StructuredQuery.EvalQuery;
     ...
     */
    readonly id: string;
    withId(id: string): Genai.FewShotExample.StructuredQuery.EvalQuery;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Genai.FewShotExample.StructuredQuery.EvalQuery;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): Genai.FewShotExample.StructuredQuery.EvalQuery;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Genai.FewShotExample.StructuredQuery.EvalQuery;
    ...
    withVersion(version: number | null): Genai.FewShotExample.StructuredQuery.EvalQuery;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Genai.FewShotExample.StructuredQuery.EvalQuery;

    /**
     * The query associated with the example.
     */
    readonly query: string;
    withQuery(query: string): Genai.FewShotExample.StructuredQuery.EvalQuery;

    /**
     * An E5 embedding of the query.
     */
    readonly emb?: string;
    withEmb(emb: string | null): Genai.FewShotExample.StructuredQuery.EvalQuery;

    /**
     * Flag indicating if this was added manually or by an automatic process.
     */
    readonly manuallyAdded?: boolean;
    withManuallyAdded(manuallyAdded: boolean): Genai.FewShotExample.StructuredQuery.EvalQuery;
    ...
    withProject(project: IGenai.Project | null): Genai.FewShotExample.StructuredQuery.EvalQuery;

    /**
     * The {@link User} who created the {@link Genai.FewShotExample}.
     */
    readonly createdBy?: User;
    withCreatedBy(createdBy: IUser | null): Genai.FewShotExample.StructuredQuery.EvalQuery;

    /**
     * The {@link EvalSpec}, {@link EvaluateSpec} or {@link EvalMetricsSpec} that answers the query.
     */
    readonly spec: Genai.StructuredQuery.Spec;
    withSpec(spec: IGenai.StructuredQuery.Spec): Genai.FewShotExample.StructuredQuery.EvalQuery;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.FewShotExample.StructuredQuery.EvalQuery | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.FewShotExample.StructuredQuery.EvalQuery | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.FewShotExample.StructuredQuery.EvalQuery | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.FewShotExample.StructuredQuery.EvalQuery | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.FewShotExample.StructuredQuery.EvalQuery;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.FewShotExample.StructuredQuery.EvalQuery;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.FewShotExample.StructuredQuery.EvalQuery;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.FewShotExample.StructuredQuery.EvalQuery>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.FewShotExample.StructuredQuery.EvalQuery>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.FewShotExample.StructuredQuery.EvalQuery;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.FewShotExample.StructuredQuery.EvalQuery;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.FewShotExample.StructuredQuery.EvalQuery;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.FewShotExample.StructuredQuery.EvalQuery;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.FewShotExample.StructuredQuery.EvalQuery;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.FewShotExample.StructuredQuery.EvalQuery;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.FewShotExample.StructuredQuery.EvalQuery;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.FewShotExample.StructuredQuery.EvalQuery;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.FewShotExample.StructuredQuery.EvalQuery;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.FewShotExample.StructuredQuery.EvalQuery;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.FewShotExample.StructuredQuery.EvalQuery;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.FewShotExample.StructuredQuery.EvalQuery;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.FewShotExample.StructuredQuery.EvalQuery;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.FewShotExample.StructuredQuery.EvalQuery;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.FewShotExample.StructuredQuery.EvalQuery;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.FewShotExample.StructuredQuery.EvalQuery;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.FewShotExample.StructuredQuery.EvalQuery;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.FewShotExample.StructuredQuery.EvalQuery;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.FewShotExample.StructuredQuery.EvalQuery;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.FewShotExample.StructuredQuery.EvalQuery;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.FewShotExample.StructuredQuery.EvalQuery;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.FewShotExample.StructuredQuery.EvalQuery;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.FewShotExample.StructuredQuery.EvalQuery;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.FewShotExample.StructuredQuery.EvalQuery;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.FewShotExample.StructuredQuery.EvalQuery;

    mergeJson(json: any): Genai.FewShotExample.StructuredQuery.EvalQuery;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.FewShotExample.StructuredQuery.EvalQuery;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.FewShotExample.StructuredQuery.EvalQuery;
     ...
     */
    singletonArray(): Array_Type<Genai.FewShotExample.StructuredQuery.EvalQuery>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.FewShotExample.StructuredQuery.EvalQuery> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.FewShotExample.StructuredQuery.EvalQuery> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.FewShotExample.StructuredQuery.EvalQuery>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.FewShotExample.StructuredQuery.EvalQuery> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.FewShotExample.StructuredQuery.EvalQuery> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.FewShotExample.StructuredQuery.EvalQuery> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.FewShotExample.StructuredQuery.EvalQuery>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.FewShotExample.StructuredQuery.EvalQuery>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.FewShotExample.StructuredQuery.EvalQuery;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.FewShotExample.StructuredQuery.EvalQuery;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.FewShotExample.StructuredQuery.EvalQuery;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.FewShotExample.StructuredQuery.EvalQuery;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.FewShotExample.StructuredQuery.EvalQuery;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.FewShotExample.StructuredQuery.EvalQuery;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.FewShotExample.StructuredQuery.EvalQuery | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.FewShotExample.StructuredQuery.EvalQuery;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.FewShotExample.StructuredQuery.EvalQuery;
     ...
     */
    static cachedEmptyInst(): Genai.FewShotExample.StructuredQuery.EvalQuery;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.FewShotExample.StructuredQuery.EvalQuery> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.FewShotExample.StructuredQuery.EvalQuery;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Genai.FewShotExample.StructuredQuery.EvalQuery>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Genai.FewShotExample.StructuredQuery.EvalQuery>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Genai.FewShotExample.StructuredQuery.EvalQuery> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Genai.FewShotExample.StructuredQuery.EvalQuery>> | null;
     ...
     */
    get(include?: string): Genai.FewShotExample.StructuredQuery.EvalQuery | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Genai.FewShotExample.StructuredQuery.EvalQuery | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Genai.FewShotExample.StructuredQuery.EvalQuery;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Genai.FewShotExample.StructuredQuery.EvalQuery | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Genai.FewShotExample.StructuredQuery.EvalQuery;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.FewShotExample.StructuredQuery.EvalQuery | null;
     ...
     */
    create(spec?: UpsertSpec): Genai.FewShotExample.StructuredQuery.EvalQuery | null;
     ...
     */
    static createBatch(objs: Array_Type<Genai.FewShotExample.StructuredQuery.EvalQuery>, spec?: UpsertSpec): ObjList<Genai.FewShotExample.StructuredQuery.EvalQuery> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Genai.FewShotExample.StructuredQuery.EvalQuery>, spec?: CreateBatchObjStreamSpec): ObjList<Genai.FewShotExample.StructuredQuery.EvalQuery> | null;
     ...
     */
    update(srcObj?: Genai.FewShotExample.StructuredQuery.EvalQuery, spec?: UpsertSpec): Genai.FewShotExample.StructuredQuery.EvalQuery | null;
     ...
     */
    upsert(srcObj?: Genai.FewShotExample.StructuredQuery.EvalQuery, spec?: UpsertSpec): Genai.FewShotExample.StructuredQuery.EvalQuery | null;
     ...
     */
    merge(spec?: MergeSpec): Genai.FewShotExample.StructuredQuery.EvalQuery | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Genai.FewShotExample.StructuredQuery.EvalQuery | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Genai.FewShotExample.StructuredQuery.EvalQuery | null;
     ...
     */
    static updateBatch(objs: Array_Type<Genai.FewShotExample.StructuredQuery.EvalQuery>, srcObjs?: Array_Type<Genai.FewShotExample.StructuredQuery.EvalQuery>, spec?: UpsertSpec): ObjList<Genai.FewShotExample.StructuredQuery.EvalQuery> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Genai.FewShotExample.StructuredQuery.EvalQuery> | null>, spec?: UpsertSpec): ObjList<Genai.FewShotExample.StructuredQuery.EvalQuery> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Genai.FewShotExample.StructuredQuery.EvalQuery>, srcObjs?: Array_Type<Genai.FewShotExample.StructuredQuery.EvalQuery>, spec?: UpsertSpec): ObjList<Genai.FewShotExample.StructuredQuery.EvalQuery> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Genai.FewShotExample.StructuredQuery.EvalQuery> | null>, spec?: UpsertSpec): ObjList<Genai.FewShotExample.StructuredQuery.EvalQuery> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Genai.FewShotExample.StructuredQuery.EvalQuery>, spec?: TouchSpec): ObjList<Genai.FewShotExample.StructuredQuery.EvalQuery> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.FewShotExample.StructuredQuery.EvalQuery>, spec?: MergeSpec): ObjList<Genai.FewShotExample.StructuredQuery.EvalQuery> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.FewShotExample.StructuredQuery.EvalQuery>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.FewShotExample.StructuredQuery.EvalQuery> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Genai.FewShotExample.StructuredQuery.EvalQuery> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.FewShotExample.StructuredQuery.EvalQuery> | null;
     ...
     */
    static mergeAll(mergeObj: Genai.FewShotExample.StructuredQuery.EvalQuery, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Genai.FewShotExample.StructuredQuery.EvalQuery, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Genai.FewShotExample.StructuredQuery.EvalQuery>, spec?: UpsertSpec): ObjList<Genai.FewShotExample.StructuredQuery.EvalQuery> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Genai.FewShotExample.StructuredQuery.EvalQuery>, spec?: UpsertSpec): ObjList<Genai.FewShotExample.StructuredQuery.EvalQuery> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Genai.FewShotExample.StructuredQuery.EvalQuery | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Genai.FewShotExample.StructuredQuery.EvalQuery>): ObjList<Genai.FewShotExample.StructuredQuery.EvalQuery>;
     ...
     */
    static beforeUpdate(objs: Array_Type<Genai.FewShotExample.StructuredQuery.EvalQuery>): ObjList<Genai.FewShotExample.StructuredQuery.EvalQuery>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Genai.FewShotExample.StructuredQuery.EvalQuery>): ObjList<Genai.FewShotExample.StructuredQuery.EvalQuery>;
     ...
     */
    static afterCreate(objs: Array_Type<Genai.FewShotExample.StructuredQuery.EvalQuery>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Genai.FewShotExample.StructuredQuery.EvalQuery>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Genai.FewShotExample.StructuredQuery.EvalQuery>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Genai.FewShotExample.StructuredQuery.EvalQuery>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Genai.FewShotExample.StructuredQuery.EvalQuery>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.FewShotExample.StructuredQuery.EvalQuery | null;
     ...
     */
    withoutIdentity(): Genai.FewShotExample.StructuredQuery.EvalQuery | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Genai.FewShotExample.StructuredQuery.EvalQuery>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Genai.FewShotExample.StructuredQuery.EvalQuery, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Genai.FewShotExample.StructuredQuery.EvalQuery>, callback?: λFunction<Genai.FewShotExample.StructuredQuery.EvalQuery | null, Genai.FewShotExample.StructuredQuery.EvalQuery | null>): ObjList<Genai.FewShotExample.StructuredQuery.EvalQuery>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Genai.FewShotExample.StructuredQuery.EvalQuery>, callback?: λFunction<Genai.FewShotExample.StructuredQuery.EvalQuery | null, Genai.FewShotExample.StructuredQuery.EvalQuery | null>): Array_Type<ObjError> | null;
     ...
     */
    parseForTemplate(args?: any): string;
     ...
     */
    static addEmbeddingsForQueries(objs: Array_Type<Genai.FewShotExample>, queries: Array_Type<string>): ObjList<Genai.FewShotExample.StructuredQuery.EvalQuery>;
     ...
     */
    static addFewShots(queryResult: Genai.Query.Result): void;
  }
}
