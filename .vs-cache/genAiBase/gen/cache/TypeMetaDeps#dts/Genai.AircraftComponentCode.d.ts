// TypeScript definitions for the C3 type Genai.AircraftComponentCode

/**
 * Lookup for the aircraft component descriptions.
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.AircraftComponentCode
 */
declare namespace Genai {
  export interface IAircraftComponentCode {
 ...
 */
declare namespace Genai {
  export class AircraftComponentCode extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): Genai.AircraftComponentCode;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Genai.AircraftComponentCode;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): Genai.AircraftComponentCode;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Genai.AircraftComponentCode;
    ...
    withVersion(version: number | null): Genai.AircraftComponentCode;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Genai.AircraftComponentCode;
    ...
    withDescription(description: string | null): Genai.AircraftComponentCode;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.AircraftComponentCode | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.AircraftComponentCode | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.AircraftComponentCode | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.AircraftComponentCode | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.AircraftComponentCode;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.AircraftComponentCode;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.AircraftComponentCode;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.AircraftComponentCode>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.AircraftComponentCode>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.AircraftComponentCode;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.AircraftComponentCode;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.AircraftComponentCode;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.AircraftComponentCode;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.AircraftComponentCode;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.AircraftComponentCode;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.AircraftComponentCode;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.AircraftComponentCode;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.AircraftComponentCode;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.AircraftComponentCode;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.AircraftComponentCode;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.AircraftComponentCode;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.AircraftComponentCode;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.AircraftComponentCode;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.AircraftComponentCode;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.AircraftComponentCode;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.AircraftComponentCode;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.AircraftComponentCode;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.AircraftComponentCode;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.AircraftComponentCode;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.AircraftComponentCode;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.AircraftComponentCode;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.AircraftComponentCode;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.AircraftComponentCode;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.AircraftComponentCode;

    mergeJson(json: any): Genai.AircraftComponentCode;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.AircraftComponentCode;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.AircraftComponentCode;
     ...
     */
    singletonArray(): Array_Type<Genai.AircraftComponentCode>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.AircraftComponentCode> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.AircraftComponentCode> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.AircraftComponentCode>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.AircraftComponentCode> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.AircraftComponentCode> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.AircraftComponentCode> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.AircraftComponentCode>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.AircraftComponentCode>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.AircraftComponentCode;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.AircraftComponentCode;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.AircraftComponentCode;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.AircraftComponentCode;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.AircraftComponentCode;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.AircraftComponentCode;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.AircraftComponentCode | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.AircraftComponentCode;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.AircraftComponentCode;
     ...
     */
    static cachedEmptyInst(): Genai.AircraftComponentCode;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.AircraftComponentCode> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.AircraftComponentCode;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Genai.AircraftComponentCode>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Genai.AircraftComponentCode>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Genai.AircraftComponentCode> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Genai.AircraftComponentCode>> | null;
     ...
     */
    get(include?: string): Genai.AircraftComponentCode | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Genai.AircraftComponentCode | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Genai.AircraftComponentCode;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Genai.AircraftComponentCode | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Genai.AircraftComponentCode;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.AircraftComponentCode | null;
     ...
     */
    create(spec?: UpsertSpec): Genai.AircraftComponentCode | null;
     ...
     */
    static createBatch(objs: Array_Type<Genai.AircraftComponentCode>, spec?: UpsertSpec): ObjList<Genai.AircraftComponentCode> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Genai.AircraftComponentCode>, spec?: CreateBatchObjStreamSpec): ObjList<Genai.AircraftComponentCode> | null;
     ...
     */
    update(srcObj?: Genai.AircraftComponentCode, spec?: UpsertSpec): Genai.AircraftComponentCode | null;
     ...
     */
    upsert(srcObj?: Genai.AircraftComponentCode, spec?: UpsertSpec): Genai.AircraftComponentCode | null;
     ...
     */
    merge(spec?: MergeSpec): Genai.AircraftComponentCode | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Genai.AircraftComponentCode | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Genai.AircraftComponentCode | null;
     ...
     */
    static updateBatch(objs: Array_Type<Genai.AircraftComponentCode>, srcObjs?: Array_Type<Genai.AircraftComponentCode>, spec?: UpsertSpec): ObjList<Genai.AircraftComponentCode> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Genai.AircraftComponentCode> | null>, spec?: UpsertSpec): ObjList<Genai.AircraftComponentCode> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Genai.AircraftComponentCode>, srcObjs?: Array_Type<Genai.AircraftComponentCode>, spec?: UpsertSpec): ObjList<Genai.AircraftComponentCode> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Genai.AircraftComponentCode> | null>, spec?: UpsertSpec): ObjList<Genai.AircraftComponentCode> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Genai.AircraftComponentCode>, spec?: TouchSpec): ObjList<Genai.AircraftComponentCode> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.AircraftComponentCode>, spec?: MergeSpec): ObjList<Genai.AircraftComponentCode> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.AircraftComponentCode>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.AircraftComponentCode> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Genai.AircraftComponentCode> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.AircraftComponentCode> | null;
     ...
     */
    static mergeAll(mergeObj: Genai.AircraftComponentCode, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Genai.AircraftComponentCode, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Genai.AircraftComponentCode>, spec?: UpsertSpec): ObjList<Genai.AircraftComponentCode> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Genai.AircraftComponentCode>, spec?: UpsertSpec): ObjList<Genai.AircraftComponentCode> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Genai.AircraftComponentCode | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Genai.AircraftComponentCode>): ObjList<Genai.AircraftComponentCode>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<Genai.AircraftComponentCode>): ObjList<Genai.AircraftComponentCode>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Genai.AircraftComponentCode>): ObjList<Genai.AircraftComponentCode>;
     ...
     */
    static afterCreate(objs: Array_Type<Genai.AircraftComponentCode>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Genai.AircraftComponentCode>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Genai.AircraftComponentCode>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Genai.AircraftComponentCode>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Genai.AircraftComponentCode>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.AircraftComponentCode | null;
     ...
     */
    withoutIdentity(): Genai.AircraftComponentCode | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Genai.AircraftComponentCode>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Genai.AircraftComponentCode, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Genai.AircraftComponentCode>, callback?: λFunction<Genai.AircraftComponentCode | null, Genai.AircraftComponentCode | null>): ObjList<Genai.AircraftComponentCode>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Genai.AircraftComponentCode>, callback?: λFunction<Genai.AircraftComponentCode | null, Genai.AircraftComponentCode | null>): Array_Type<ObjError> | null;
