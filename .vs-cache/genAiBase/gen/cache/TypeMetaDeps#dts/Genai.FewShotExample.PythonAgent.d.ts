// TypeScript definitions for the C3 type Genai.FewShotExample.PythonAgent

/**
 * Persists few-shot examples for a python agent along with its embedding in pgvector.
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.FewShotExample.PythonAgent
 */
 ...
 */
declare namespace Genai.FewShotExample {
  export class PythonAgent extends Obj  {
    ...
    withTypeIdent(typeIdent: string | null): Genai.FewShotExample.PythonAgent;
     ...
     */
    readonly id: string;
    withId(id: string): Genai.FewShotExample.PythonAgent;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Genai.FewShotExample.PythonAgent;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): Genai.FewShotExample.PythonAgent;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Genai.FewShotExample.PythonAgent;
    ...
    withVersion(version: number | null): Genai.FewShotExample.PythonAgent;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Genai.FewShotExample.PythonAgent;

    /**
     * The query associated with the example.
     */
    readonly query: string;
    withQuery(query: string): Genai.FewShotExample.PythonAgent;

    /**
     * An E5 embedding of the query.
     */
    readonly emb?: string;
    withEmb(emb: string | null): Genai.FewShotExample.PythonAgent;

    /**
     * Flag indicating if this was added manually or by an automatic process.
     */
    readonly manuallyAdded?: boolean;
    withManuallyAdded(manuallyAdded: boolean): Genai.FewShotExample.PythonAgent;
    ...
    withProject(project: IGenai.Project | null): Genai.FewShotExample.PythonAgent;

    /**
     * The {@link User} who created the {@link Genai.FewShotExample}.
     */
    readonly createdBy?: User;
    withCreatedBy(createdBy: IUser | null): Genai.FewShotExample.PythonAgent;

    /**
     * The code executed by the python agent.
     */
    readonly code: string;
    withCode(code: string): Genai.FewShotExample.PythonAgent;

    /**
     * The description of what the code intends to do.
     */
    readonly subQuery?: string;
    withSubQuery(subQuery: string | null): Genai.FewShotExample.PythonAgent;

    /**
     * Description of the few-shot.
     */
    readonly description?: string;
    withDescription(description: string | null): Genai.FewShotExample.PythonAgent;
    ...
    withSpecialization(specialization: string): Genai.FewShotExample.PythonAgent;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.FewShotExample.PythonAgent | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.FewShotExample.PythonAgent | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.FewShotExample.PythonAgent | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.FewShotExample.PythonAgent | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.FewShotExample.PythonAgent;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.FewShotExample.PythonAgent;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.FewShotExample.PythonAgent;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.FewShotExample.PythonAgent>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.FewShotExample.PythonAgent>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.FewShotExample.PythonAgent;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.FewShotExample.PythonAgent;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.FewShotExample.PythonAgent;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.FewShotExample.PythonAgent;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.FewShotExample.PythonAgent;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.FewShotExample.PythonAgent;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.FewShotExample.PythonAgent;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.FewShotExample.PythonAgent;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.FewShotExample.PythonAgent;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.FewShotExample.PythonAgent;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.FewShotExample.PythonAgent;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.FewShotExample.PythonAgent;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.FewShotExample.PythonAgent;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.FewShotExample.PythonAgent;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.FewShotExample.PythonAgent;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.FewShotExample.PythonAgent;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.FewShotExample.PythonAgent;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.FewShotExample.PythonAgent;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.FewShotExample.PythonAgent;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.FewShotExample.PythonAgent;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.FewShotExample.PythonAgent;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.FewShotExample.PythonAgent;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.FewShotExample.PythonAgent;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.FewShotExample.PythonAgent;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.FewShotExample.PythonAgent;

    mergeJson(json: any): Genai.FewShotExample.PythonAgent;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.FewShotExample.PythonAgent;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.FewShotExample.PythonAgent;
     ...
     */
    singletonArray(): Array_Type<Genai.FewShotExample.PythonAgent>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.FewShotExample.PythonAgent> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.FewShotExample.PythonAgent> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.FewShotExample.PythonAgent>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.FewShotExample.PythonAgent> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.FewShotExample.PythonAgent> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.FewShotExample.PythonAgent> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.FewShotExample.PythonAgent>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.FewShotExample.PythonAgent>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.FewShotExample.PythonAgent;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.FewShotExample.PythonAgent;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.FewShotExample.PythonAgent;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.FewShotExample.PythonAgent;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.FewShotExample.PythonAgent;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.FewShotExample.PythonAgent;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.FewShotExample.PythonAgent | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.FewShotExample.PythonAgent;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.FewShotExample.PythonAgent;
     ...
     */
    static cachedEmptyInst(): Genai.FewShotExample.PythonAgent;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.FewShotExample.PythonAgent> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.FewShotExample.PythonAgent;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Genai.FewShotExample.PythonAgent>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Genai.FewShotExample.PythonAgent>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Genai.FewShotExample.PythonAgent> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Genai.FewShotExample.PythonAgent>> | null;
     ...
     */
    get(include?: string): Genai.FewShotExample.PythonAgent | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Genai.FewShotExample.PythonAgent | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Genai.FewShotExample.PythonAgent;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Genai.FewShotExample.PythonAgent | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Genai.FewShotExample.PythonAgent;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.FewShotExample.PythonAgent | null;
     ...
     */
    create(spec?: UpsertSpec): Genai.FewShotExample.PythonAgent | null;
     ...
     */
    static createBatch(objs: Array_Type<Genai.FewShotExample.PythonAgent>, spec?: UpsertSpec): ObjList<Genai.FewShotExample.PythonAgent> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Genai.FewShotExample.PythonAgent>, spec?: CreateBatchObjStreamSpec): ObjList<Genai.FewShotExample.PythonAgent> | null;
     ...
     */
    update(srcObj?: Genai.FewShotExample.PythonAgent, spec?: UpsertSpec): Genai.FewShotExample.PythonAgent | null;
     ...
     */
    upsert(srcObj?: Genai.FewShotExample.PythonAgent, spec?: UpsertSpec): Genai.FewShotExample.PythonAgent | null;
     ...
     */
    merge(spec?: MergeSpec): Genai.FewShotExample.PythonAgent | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Genai.FewShotExample.PythonAgent | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Genai.FewShotExample.PythonAgent | null;
     ...
     */
    static updateBatch(objs: Array_Type<Genai.FewShotExample.PythonAgent>, srcObjs?: Array_Type<Genai.FewShotExample.PythonAgent>, spec?: UpsertSpec): ObjList<Genai.FewShotExample.PythonAgent> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Genai.FewShotExample.PythonAgent> | null>, spec?: UpsertSpec): ObjList<Genai.FewShotExample.PythonAgent> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Genai.FewShotExample.PythonAgent>, srcObjs?: Array_Type<Genai.FewShotExample.PythonAgent>, spec?: UpsertSpec): ObjList<Genai.FewShotExample.PythonAgent> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Genai.FewShotExample.PythonAgent> | null>, spec?: UpsertSpec): ObjList<Genai.FewShotExample.PythonAgent> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Genai.FewShotExample.PythonAgent>, spec?: TouchSpec): ObjList<Genai.FewShotExample.PythonAgent> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.FewShotExample.PythonAgent>, spec?: MergeSpec): ObjList<Genai.FewShotExample.PythonAgent> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.FewShotExample.PythonAgent>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.FewShotExample.PythonAgent> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Genai.FewShotExample.PythonAgent> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.FewShotExample.PythonAgent> | null;
     ...
     */
    static mergeAll(mergeObj: Genai.FewShotExample.PythonAgent, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Genai.FewShotExample.PythonAgent, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Genai.FewShotExample.PythonAgent>, spec?: UpsertSpec): ObjList<Genai.FewShotExample.PythonAgent> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Genai.FewShotExample.PythonAgent>, spec?: UpsertSpec): ObjList<Genai.FewShotExample.PythonAgent> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Genai.FewShotExample.PythonAgent | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Genai.FewShotExample.PythonAgent>): ObjList<Genai.FewShotExample.PythonAgent>;
     ...
     */
    static beforeUpdate(objs: Array_Type<Genai.FewShotExample.PythonAgent>): ObjList<Genai.FewShotExample.PythonAgent>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Genai.FewShotExample.PythonAgent>): ObjList<Genai.FewShotExample.PythonAgent>;
     ...
     */
    static afterCreate(objs: Array_Type<Genai.FewShotExample.PythonAgent>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Genai.FewShotExample.PythonAgent>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Genai.FewShotExample.PythonAgent>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Genai.FewShotExample.PythonAgent>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Genai.FewShotExample.PythonAgent>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.FewShotExample.PythonAgent | null;
     ...
     */
    withoutIdentity(): Genai.FewShotExample.PythonAgent | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Genai.FewShotExample.PythonAgent>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Genai.FewShotExample.PythonAgent, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Genai.FewShotExample.PythonAgent>, callback?: λFunction<Genai.FewShotExample.PythonAgent | null, Genai.FewShotExample.PythonAgent | null>): ObjList<Genai.FewShotExample.PythonAgent>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Genai.FewShotExample.PythonAgent>, callback?: λFunction<Genai.FewShotExample.PythonAgent | null, Genai.FewShotExample.PythonAgent | null>): Array_Type<ObjError> | null;
     ...
     */
    static addEmbeddingsForQueries(objs: Array_Type<Genai.FewShotExample>, queries: Array_Type<string>): ObjList<Genai.FewShotExample.PythonAgent>;
  }
}
