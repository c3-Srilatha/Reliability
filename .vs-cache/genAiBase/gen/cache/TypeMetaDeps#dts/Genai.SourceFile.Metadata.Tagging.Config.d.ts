// TypeScript definitions for the C3 type Genai.SourceFile.Metadata.Tagging.Config

/**
 * Config used in the Automatic Metadata Extraction process.
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.SourceFile.Metadata.Tagging.Config
 */
declare namespace Genai.SourceFile.Metadata.Tagging {
  export interface IConfig {
     ...
     */
    numInitialPassages: number;

    /**
     * The number of final pages to process.
     */
    numFinalPassages: number;
     ...
     */
    filterEntityCategories: Array_Type<string> | Array<string>;
     ...
     */
    topicLabelingPrompt: IGenai.Prompt;
     ...
     */
    seededCategories: Array_Type<string> | Array<string>;

    /**
     * The list of fields to omit from the metadata extraction.
     */
    blacklistFields: Array_Type<string> | Array<string>;

    /**
     * The {@link Genai.Prompt} to use for the clustering of the metadata.
     */
    clusteringPrompt: IGenai.Prompt;
...
declare namespace Genai.SourceFile.Metadata.Tagging {
  export class Config extends Obj  {
    ...
    withName(name: string): Genai.SourceFile.Metadata.Tagging.Config;
    ...
    withConfigOverride(configOverride: string | null): Genai.SourceFile.Metadata.Tagging.Config;

    static readonly configOverride?: string;

    readonly secretOverride?: string;
    withSecretOverride(secretOverride: string | null): Genai.SourceFile.Metadata.Tagging.Config;
    ...
    withIssues(issues: Array_Type<string> | Array<string> | null): Genai.SourceFile.Metadata.Tagging.Config;
    ...
    withModel(model: string): Genai.SourceFile.Metadata.Tagging.Config;
    ...
    withNumEntities(numEntities: number): Genai.SourceFile.Metadata.Tagging.Config;

    /**
     * The number of entities to extract.
     */
    static readonly numEntities: number;

    /**
     * The number of themes to extract.
     */
    readonly themes: number;
    withThemes(themes: number): Genai.SourceFile.Metadata.Tagging.Config;

    /**
     * The number of themes to extract.
     */
    static readonly themes: number;

    /**
     * The number of examples to extract.
     */
    readonly examples: number;
    withExamples(examples: number): Genai.SourceFile.Metadata.Tagging.Config;

    /**
     * The number of examples to extract.
     */
    static readonly examples: number;

    /**
     * The natural language processing model to use.
     */
    readonly nlp: string;
    withNlp(nlp: string): Genai.SourceFile.Metadata.Tagging.Config;

    /**
     * The natural language processing model to use.
     */
    static readonly nlp: string;

    /**
     * The number of initial pages to process.
     */
    readonly numInitialPassages: number;
    withNumInitialPassages(numInitialPassages: number): Genai.SourceFile.Metadata.Tagging.Config;

    /**
     * The number of initial pages to process.
     */
    static readonly numInitialPassages: number;

    /**
     * The number of final pages to process.
     */
    readonly numFinalPassages: number;
    withNumFinalPassages(numFinalPassages: number): Genai.SourceFile.Metadata.Tagging.Config;

    /**
     * The number of final pages to process.
     */
    static readonly numFinalPassages: number;

    /**
     * The number of maximum tokens to process.
     */
    readonly numMaxTokens: number;
    withNumMaxTokens(numMaxTokens: number): Genai.SourceFile.Metadata.Tagging.Config;

    /**
     * The number of maximum tokens to process.
     */
    static readonly numMaxTokens: number;

    /**
     * List of filter catergories to use.
     */
    readonly filterEntityCategories: Array_Type<string>;
    withFilterEntityCategories(filterEntityCategories: Array_Type<string> | Array<string>): Genai.SourceFile.Metadata.Tagging.Config;

    /**
     * List of filter catergories to use.
     */
    static readonly filterEntityCategories: Array_Type<string>;
     ...
     * string_lda - The string to use for the LDA model.
     */
    readonly topicLabelingPrompt: Genai.Prompt;
    withTopicLabelingPrompt(topicLabelingPrompt: IGenai.Prompt): Genai.SourceFile.Metadata.Tagging.Config;
     ...
     * string_lda - The string to use for the LDA model.
     */
    static readonly topicLabelingPrompt: Genai.Prompt;
     ...
     * num_tags - The number maximum of tags to be extracted.
     */
    readonly metadataExtractionPrompt: Genai.Prompt;
    withMetadataExtractionPrompt(metadataExtractionPrompt: IGenai.Prompt): Genai.SourceFile.Metadata.Tagging.Config;
     ...
     * num_tags - The number maximum of tags to be extracted.
     */
    static readonly metadataExtractionPrompt: Genai.Prompt;

    /**
     * The prompt used to fix and invalid JSON generated in the metadata extraction
     * of a {@link Genai.Prompt}.
     */
    readonly fixJsonPrompt: Genai.Prompt;
    withFixJsonPrompt(fixJsonPrompt: IGenai.Prompt): Genai.SourceFile.Metadata.Tagging.Config;

    /**
     * The prompt used to fix and invalid JSON generated in the metadata extraction
     * of a {@link Genai.Prompt}.
     */
    static readonly fixJsonPrompt: Genai.Prompt;

    /**
     * The number of maximum tags to extract.
     */
    readonly numTags: number;
    withNumTags(numTags: number): Genai.SourceFile.Metadata.Tagging.Config;

    /**
     * The number of maximum tags to extract.
     */
    static readonly numTags: number;

    /**
     * The number of maximum keywords to extract.
     */
    readonly numKeywords: number;
    withNumKeywords(numKeywords: number): Genai.SourceFile.Metadata.Tagging.Config;

    /**
     * The number of maximum keywords to extract.
     */
    static readonly numKeywords: number;
     ...
     * If set to -1, identifyFilterCategories will run on all documents of the user's active project.
     */
    readonly documentSampleSize: number;
    withDocumentSampleSize(documentSampleSize: number): Genai.SourceFile.Metadata.Tagging.Config;
     ...
     * If set to -1, identifyFilterCategories will run on all documents of the user's active project.
     */
    static readonly documentSampleSize: number;

    /**
     * The number of documents to process in a batch when performing automated tagging in all source files.
     */
    readonly documentBatchSize: number;
    withDocumentBatchSize(documentBatchSize: number): Genai.SourceFile.Metadata.Tagging.Config;

    /**
     * The number of documents to process in a batch when performing automated tagging in all source files.
     */
    static readonly documentBatchSize: number;
    ...
    withDateFieldName(dateFieldName: string): Genai.SourceFile.Metadata.Tagging.Config;

    /**
     * The name of the field to correspond to the category name ("date") that
     * will be converted to a datetme.
     */
    static readonly dateFieldName: string;

    /**
     * Categories to use for the seeded categories.
     */
    readonly seededCategories: Array_Type<string>;
    withSeededCategories(seededCategories: Array_Type<string> | Array<string>): Genai.SourceFile.Metadata.Tagging.Config;

    /**
     * Categories to use for the seeded categories.
     */
    static readonly seededCategories: Array_Type<string>;

    /**
     * The list of fields to omit from the metadata extraction.
     */
    readonly blacklistFields: Array_Type<string>;
    withBlacklistFields(blacklistFields: Array_Type<string> | Array<string>): Genai.SourceFile.Metadata.Tagging.Config;

    /**
     * The list of fields to omit from the metadata extraction.
     */
    static readonly blacklistFields: Array_Type<string>;

    /**
     * The {@link Genai.Prompt} to use for the clustering of the metadata.
     */
    readonly clusteringPrompt: Genai.Prompt;
    withClusteringPrompt(clusteringPrompt: IGenai.Prompt): Genai.SourceFile.Metadata.Tagging.Config;

    /**
     * The {@link Genai.Prompt} to use for the clustering of the metadata.
     */
    static readonly clusteringPrompt: Genai.Prompt;

    /**
     * Enable automatic metadata tagging for {@link Genai.SourceFile#process}.
     */
    readonly disableMetadataTagging?: boolean;
    withDisableMetadataTagging(disableMetadataTagging: boolean): Genai.SourceFile.Metadata.Tagging.Config;

    /**
     * Enable automatic metadata tagging for {@link Genai.SourceFile#process}.
     */
    static readonly disableMetadataTagging?: boolean;
     ...
     * - `text_parser_spec` in {@link Genai.SourceFile.Chunker.Mew3.Config#pipelineSpec}
     */
    readonly allowOverlapInExtractedText?: boolean;
    withAllowOverlapInExtractedText(allowOverlapInExtractedText: boolean): Genai.SourceFile.Metadata.Tagging.Config;
     ...
     * - `text_parser_spec` in {@link Genai.SourceFile.Chunker.Mew3.Config#pipelineSpec}
     */
    static readonly allowOverlapInExtractedText?: boolean;

    /**
     * Will update tags for previously indexed files without having to reindex them with the verbalization
     * of the new tag embedded.
     */
    readonly allowRetaggingWithoutReindexing?: boolean;
    withAllowRetaggingWithoutReindexing(allowRetaggingWithoutReindexing: boolean): Genai.SourceFile.Metadata.Tagging.Config;

    /**
     * Will update tags for previously indexed files without having to reindex them with the verbalization
     * of the new tag embedded.
     */
    static readonly allowRetaggingWithoutReindexing?: boolean;
     ...
     * is determined by {#allowRetaggingWithoutReindexing}.
     */
    readonly skipPreindexedFilesForTagging?: boolean;
    withSkipPreindexedFilesForTagging(skipPreindexedFilesForTagging: boolean): Genai.SourceFile.Metadata.Tagging.Config;
     ...
     * is determined by {#allowRetaggingWithoutReindexing}.
     */
    static readonly skipPreindexedFilesForTagging?: boolean;
     ...
     */
    static inst(): Genai.SourceFile.Metadata.Tagging.Config;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.SourceFile.Metadata.Tagging.Config | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.SourceFile.Metadata.Tagging.Config | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.SourceFile.Metadata.Tagging.Config | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.SourceFile.Metadata.Tagging.Config | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.SourceFile.Metadata.Tagging.Config;
     ...
     * This method is used during live metadata update
     */
    static replaceType(old: Type, new_: Type): Genai.SourceFile.Metadata.Tagging.Config;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.SourceFile.Metadata.Tagging.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.SourceFile.Metadata.Tagging.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.SourceFile.Metadata.Tagging.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.SourceFile.Metadata.Tagging.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.SourceFile.Metadata.Tagging.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.SourceFile.Metadata.Tagging.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.SourceFile.Metadata.Tagging.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.SourceFile.Metadata.Tagging.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.SourceFile.Metadata.Tagging.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.SourceFile.Metadata.Tagging.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.SourceFile.Metadata.Tagging.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.SourceFile.Metadata.Tagging.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.SourceFile.Metadata.Tagging.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.SourceFile.Metadata.Tagging.Config;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.SourceFile.Metadata.Tagging.Config;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    static validateObj(): Genai.SourceFile.Metadata.Tagging.Config;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.SourceFile.Metadata.Tagging.Config;
     ...
     * @see #defaultField
     */
    static withField(field: string, value: any, doNotConvert?: boolean): Genai.SourceFile.Metadata.Tagging.Config;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.SourceFile.Metadata.Tagging.Config;
     ...
     * @see #defaultField
     */
    static withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.SourceFile.Metadata.Tagging.Config;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.SourceFile.Metadata.Tagging.Config;
     ...
     * @return new Obj
     */
    static withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.SourceFile.Metadata.Tagging.Config;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.SourceFile.Metadata.Tagging.Config;
     ...
     * @return new Obj
     */
    static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.SourceFile.Metadata.Tagging.Config;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.SourceFile.Metadata.Tagging.Config;
     ...
     * @see #withoutField
     */
    static withoutFieldAtPath(path: string): Genai.SourceFile.Metadata.Tagging.Config;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.SourceFile.Metadata.Tagging.Config;
     ...
     * @see #removeField
     */
    static withoutField(field: string): Genai.SourceFile.Metadata.Tagging.Config;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.SourceFile.Metadata.Tagging.Config;
     ...
     * @see #removeField
     */
    static withoutField(field: FieldType): Genai.SourceFile.Metadata.Tagging.Config;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.SourceFile.Metadata.Tagging.Config;
     ...
     * @return new Obj with removed fields
     */
    static withoutFields(fields: Array_Type<string>): Genai.SourceFile.Metadata.Tagging.Config;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.SourceFile.Metadata.Tagging.Config;
     ...
     * @return new Obj with removed fields
     */
    static withoutFieldsByType(fields: Array_Type<FieldType>): Genai.SourceFile.Metadata.Tagging.Config;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.SourceFile.Metadata.Tagging.Config;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    static withoutSecretFields(): Genai.SourceFile.Metadata.Tagging.Config;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.SourceFile.Metadata.Tagging.Config;
     ...
     * @see FieldType#defaultValue
     */
    static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.SourceFile.Metadata.Tagging.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.SourceFile.Metadata.Tagging.Config;
     ...
     * @see #unsetField
     */
    static defaultField(field: string): Genai.SourceFile.Metadata.Tagging.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.SourceFile.Metadata.Tagging.Config;
     ...
     * @see #unsetField
     */
    static defaultField(field: FieldType): Genai.SourceFile.Metadata.Tagging.Config;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.SourceFile.Metadata.Tagging.Config;
     ...
     * @see #removeField
     */
    static unsetField(field: string): Genai.SourceFile.Metadata.Tagging.Config;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.SourceFile.Metadata.Tagging.Config;
     ...
     * @see #removeField
     */
    static unsetField(field: FieldType): Genai.SourceFile.Metadata.Tagging.Config;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.SourceFile.Metadata.Tagging.Config;
     ...
     * @see #unsetField
     */
    static removeField(field: string): Genai.SourceFile.Metadata.Tagging.Config;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.SourceFile.Metadata.Tagging.Config;
     ...
     * @see #unsetField
     */
    static removeField(field: FieldType): Genai.SourceFile.Metadata.Tagging.Config;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.SourceFile.Metadata.Tagging.Config;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.SourceFile.Metadata.Tagging.Config;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.SourceFile.Metadata.Tagging.Config;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj, otherFieldsFilter: Type): Genai.SourceFile.Metadata.Tagging.Config;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.SourceFile.Metadata.Tagging.Config;
     ...
     *        the same key or index.
     */
    static mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.SourceFile.Metadata.Tagging.Config;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.SourceFile.Metadata.Tagging.Config;
     ...
     * traverse child reference and collection fields.
     */
    static mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.SourceFile.Metadata.Tagging.Config;

    mergeJson(json: any): Genai.SourceFile.Metadata.Tagging.Config;

    static mergeJson(json: any): Genai.SourceFile.Metadata.Tagging.Config;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.SourceFile.Metadata.Tagging.Config;
     ...
     * @return Obj with child references merged
     */
    static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.SourceFile.Metadata.Tagging.Config;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.SourceFile.Metadata.Tagging.Config;
     ...
     * references with same name and collection elements at same index or key.
     */
    static sumObj(other: Obj, deep?: boolean): Genai.SourceFile.Metadata.Tagging.Config;
     ...
     */
    singletonArray(): Array_Type<Genai.SourceFile.Metadata.Tagging.Config>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonArray(): Array_Type<Genai.SourceFile.Metadata.Tagging.Config>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.SourceFile.Metadata.Tagging.Config> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.SourceFile.Metadata.Tagging.Config> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.SourceFile.Metadata.Tagging.Config>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonSet(): Set_Type<Genai.SourceFile.Metadata.Tagging.Config>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.SourceFile.Metadata.Tagging.Config> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.SourceFile.Metadata.Tagging.Config> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.SourceFile.Metadata.Tagging.Config> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.SourceFile.Metadata.Tagging.Config>;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    static toBuilder(): ObjBuilder<Genai.SourceFile.Metadata.Tagging.Config>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.SourceFile.Metadata.Tagging.Config>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.SourceFile.Metadata.Tagging.Config;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.SourceFile.Metadata.Tagging.Config;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.SourceFile.Metadata.Tagging.Config;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.SourceFile.Metadata.Tagging.Config;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.SourceFile.Metadata.Tagging.Config;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.SourceFile.Metadata.Tagging.Config;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.SourceFile.Metadata.Tagging.Config | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.SourceFile.Metadata.Tagging.Config;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.SourceFile.Metadata.Tagging.Config;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    static afterMake(): Genai.SourceFile.Metadata.Tagging.Config;
     ...
     */
    static cachedEmptyInst(): Genai.SourceFile.Metadata.Tagging.Config;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.SourceFile.Metadata.Tagging.Config> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.SourceFile.Metadata.Tagging.Config;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.SourceFile.Metadata.Tagging.Config | null;
     ...
     */
    static forName(name: string, failIfMissing?: boolean): Genai.SourceFile.Metadata.Tagging.Config | null;
     ...
     */
    static allCached(): Stream<Genai.SourceFile.Metadata.Tagging.Config> | null;
     ...
     */
    static find(filter?: string): Stream<Genai.SourceFile.Metadata.Tagging.Config> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<Genai.SourceFile.Metadata.Tagging.Config> | null;

    /**
     * @return cached instance.
     */
    getCached(): Genai.SourceFile.Metadata.Tagging.Config | null;

    /**
     * @return cached instance.
     */
    static getCached(): Genai.SourceFile.Metadata.Tagging.Config | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string): Genai.SourceFile.Metadata.Tagging.Config | null;
     ...
     */
    static produce(key: string): Genai.SourceFile.Metadata.Tagging.Config | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, Genai.SourceFile.Metadata.Tagging.Config> | null;
     ...
     */
    getConfig(): Genai.SourceFile.Metadata.Tagging.Config;
     ...
     * Note that typical pattern is to use Configurable#config instead of this method.
     */
    static getConfig(): Genai.SourceFile.Metadata.Tagging.Config;
     ...
     */
    getSecret(): Genai.SourceFile.Metadata.Tagging.Config;
     ...
     * Note that typical pattern is to use Configurable#configWithSecrets instead of this method.
     */
    static getSecret(): Genai.SourceFile.Metadata.Tagging.Config;
     ...
     */
    withConfigKey(configKey: string): Genai.SourceFile.Metadata.Tagging.Config;
     ...
     *     config.configKey() => "folder1/abc"
     */
    static withConfigKey(configKey: string): Genai.SourceFile.Metadata.Tagging.Config;

    /**
     * @return copy without config key.
     */
    withoutConfigKey(): Genai.SourceFile.Metadata.Tagging.Config;

    /**
     * @return copy without config key.
     */
    static withoutConfigKey(): Genai.SourceFile.Metadata.Tagging.Config;

    /**
     * @return return cached config instance for provided config key.
     */
    static forConfigKey(configKey: string): Genai.SourceFile.Metadata.Tagging.Config | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string>): Stream<Genai.SourceFile.Metadata.Tagging.Config> | null;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: Genai.SourceFile.Metadata.Tagging.Config, override?: string): void;
     ...
     * @see setConfigValue
     */
    static setConfigValues(from: Genai.SourceFile.Metadata.Tagging.Config, override?: string): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): Genai.SourceFile.Metadata.Tagging.Config | null;
     ...
     */
    removeSecrets(): Genai.SourceFile.Metadata.Tagging.Config | null;

    /**
     * @return this config without any secret values.
     */
    static removeSecrets(): Genai.SourceFile.Metadata.Tagging.Config | null;

    /**
     * @return this config with only secret values.
     */
    removeNonSecrets(): Genai.SourceFile.Metadata.Tagging.Config | null;

    /**
     * @return this config with only secret values.
     */
    static removeNonSecrets(): Genai.SourceFile.Metadata.Tagging.Config | null;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    validate(): Genai.SourceFile.Metadata.Tagging.Config;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    static validate(): Genai.SourceFile.Metadata.Tagging.Config;
     ...
     */
    static setRecursive(configJson: any, useSetConfigValues?: boolean, override?: string): Genai.SourceFile.Metadata.Tagging.Config;
