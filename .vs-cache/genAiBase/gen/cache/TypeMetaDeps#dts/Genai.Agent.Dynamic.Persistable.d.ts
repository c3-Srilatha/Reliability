// TypeScript definitions for the C3 type Genai.Agent.Dynamic.Persistable
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.Agent.Dynamic.Persistable
 */
declare namespace Genai.Agent.Dynamic {
  export interface IPersistable {
     ...
     */
    promptParamValues?: Map_Type<string, string> | {[key: string]: string};

    /**
     * The configuration of the agent.
     */
    config: IGenai.Agent.Dynamic.Config;
 ...
 */
declare namespace Genai.Agent.Dynamic {
  export class Persistable extends Obj  {

    /**
     * The {@link Genai.Project} this instance is linked to.
     */
    readonly projects?: Array_Type<Genai.Project>;
    withProjects(projects: Array_Type<Genai.Project> | Array<IGenai.Project> | null): Genai.Agent.Dynamic.Persistable;
    ...
    withTypeIdent(typeIdent: string | null): Genai.Agent.Dynamic.Persistable;
     ...
     */
    readonly id: string;
    withId(id: string): Genai.Agent.Dynamic.Persistable;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Genai.Agent.Dynamic.Persistable;

    /**
     * User friendly name of the agent. It must be unique.
     */
    readonly name: string;
    withName(name: string): Genai.Agent.Dynamic.Persistable;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Genai.Agent.Dynamic.Persistable;
    ...
    withVersion(version: number | null): Genai.Agent.Dynamic.Persistable;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Genai.Agent.Dynamic.Persistable;
     ...
     * Currently, this is used for storing the "instructions" users can set from the UI for the agent.
     */
    readonly promptParamValues?: Map_Type<string, string>;
    withPromptParamValues(promptParamValues: Map_Type<string, string> | {[key: string]: string} | null): Genai.Agent.Dynamic.Persistable;

    /**
     * The configuration of the agent.
     */
    readonly config: Genai.Agent.Dynamic.Config;
    withConfig(config: IGenai.Agent.Dynamic.Config): Genai.Agent.Dynamic.Persistable;

    /**
     * The agent's active state. If inactive, the agent will not be displayed in the tool selector in the UI.
     */
    readonly inactive?: boolean;
    withInactive(inactive: boolean): Genai.Agent.Dynamic.Persistable;

    /**
     * Configuration for how this will be shown as a UI drop-down option
     */
    readonly uiOptions?: Genai.Agent.Tool.Config.UiOptions;
    withUiOptions(uiOptions: IGenai.Agent.Tool.Config.UiOptions | null): Genai.Agent.Dynamic.Persistable;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.Agent.Dynamic.Persistable | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.Agent.Dynamic.Persistable | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.Agent.Dynamic.Persistable | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.Agent.Dynamic.Persistable | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.Agent.Dynamic.Persistable;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Agent.Dynamic.Persistable;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Agent.Dynamic.Persistable;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Agent.Dynamic.Persistable>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Agent.Dynamic.Persistable>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.Agent.Dynamic.Persistable;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Agent.Dynamic.Persistable;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Agent.Dynamic.Persistable;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.Agent.Dynamic.Persistable;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.Agent.Dynamic.Persistable;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.Agent.Dynamic.Persistable;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.Agent.Dynamic.Persistable;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.Agent.Dynamic.Persistable;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.Agent.Dynamic.Persistable;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.Agent.Dynamic.Persistable;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.Agent.Dynamic.Persistable;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.Agent.Dynamic.Persistable;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.Agent.Dynamic.Persistable;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.Agent.Dynamic.Persistable;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.Agent.Dynamic.Persistable;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.Agent.Dynamic.Persistable;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.Agent.Dynamic.Persistable;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.Agent.Dynamic.Persistable;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.Agent.Dynamic.Persistable;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.Agent.Dynamic.Persistable;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.Agent.Dynamic.Persistable;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.Agent.Dynamic.Persistable;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.Agent.Dynamic.Persistable;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.Agent.Dynamic.Persistable;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.Agent.Dynamic.Persistable;

    mergeJson(json: any): Genai.Agent.Dynamic.Persistable;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.Agent.Dynamic.Persistable;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.Agent.Dynamic.Persistable;
     ...
     */
    singletonArray(): Array_Type<Genai.Agent.Dynamic.Persistable>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.Agent.Dynamic.Persistable> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.Agent.Dynamic.Persistable> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.Agent.Dynamic.Persistable>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.Agent.Dynamic.Persistable> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.Agent.Dynamic.Persistable> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.Agent.Dynamic.Persistable> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.Agent.Dynamic.Persistable>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.Agent.Dynamic.Persistable>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.Agent.Dynamic.Persistable;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.Agent.Dynamic.Persistable;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.Agent.Dynamic.Persistable;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.Agent.Dynamic.Persistable;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.Agent.Dynamic.Persistable;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.Agent.Dynamic.Persistable;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.Agent.Dynamic.Persistable | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.Agent.Dynamic.Persistable;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.Agent.Dynamic.Persistable;
     ...
     */
    static cachedEmptyInst(): Genai.Agent.Dynamic.Persistable;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.Agent.Dynamic.Persistable> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.Agent.Dynamic.Persistable;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Genai.Agent.Dynamic.Persistable>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Genai.Agent.Dynamic.Persistable>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Genai.Agent.Dynamic.Persistable> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Genai.Agent.Dynamic.Persistable>> | null;
     ...
     */
    get(include?: string): Genai.Agent.Dynamic.Persistable | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Genai.Agent.Dynamic.Persistable | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Genai.Agent.Dynamic.Persistable;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Genai.Agent.Dynamic.Persistable | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Genai.Agent.Dynamic.Persistable;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.Agent.Dynamic.Persistable | null;
     ...
     */
    create(spec?: UpsertSpec): Genai.Agent.Dynamic.Persistable | null;
     ...
     */
    static createBatch(objs: Array_Type<Genai.Agent.Dynamic.Persistable>, spec?: UpsertSpec): ObjList<Genai.Agent.Dynamic.Persistable> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Genai.Agent.Dynamic.Persistable>, spec?: CreateBatchObjStreamSpec): ObjList<Genai.Agent.Dynamic.Persistable> | null;
     ...
     */
    update(srcObj?: Genai.Agent.Dynamic.Persistable, spec?: UpsertSpec): Genai.Agent.Dynamic.Persistable | null;
     ...
     */
    upsert(srcObj?: Genai.Agent.Dynamic.Persistable, spec?: UpsertSpec): Genai.Agent.Dynamic.Persistable | null;
     ...
     */
    merge(spec?: MergeSpec): Genai.Agent.Dynamic.Persistable | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Genai.Agent.Dynamic.Persistable | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Genai.Agent.Dynamic.Persistable | null;
     ...
     */
    static updateBatch(objs: Array_Type<Genai.Agent.Dynamic.Persistable>, srcObjs?: Array_Type<Genai.Agent.Dynamic.Persistable>, spec?: UpsertSpec): ObjList<Genai.Agent.Dynamic.Persistable> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Genai.Agent.Dynamic.Persistable> | null>, spec?: UpsertSpec): ObjList<Genai.Agent.Dynamic.Persistable> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Genai.Agent.Dynamic.Persistable>, srcObjs?: Array_Type<Genai.Agent.Dynamic.Persistable>, spec?: UpsertSpec): ObjList<Genai.Agent.Dynamic.Persistable> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Genai.Agent.Dynamic.Persistable> | null>, spec?: UpsertSpec): ObjList<Genai.Agent.Dynamic.Persistable> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Genai.Agent.Dynamic.Persistable>, spec?: TouchSpec): ObjList<Genai.Agent.Dynamic.Persistable> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.Agent.Dynamic.Persistable>, spec?: MergeSpec): ObjList<Genai.Agent.Dynamic.Persistable> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.Agent.Dynamic.Persistable>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.Agent.Dynamic.Persistable> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Genai.Agent.Dynamic.Persistable> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.Agent.Dynamic.Persistable> | null;
     ...
     */
    static mergeAll(mergeObj: Genai.Agent.Dynamic.Persistable, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Genai.Agent.Dynamic.Persistable, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Genai.Agent.Dynamic.Persistable>, spec?: UpsertSpec): ObjList<Genai.Agent.Dynamic.Persistable> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Genai.Agent.Dynamic.Persistable>, spec?: UpsertSpec): ObjList<Genai.Agent.Dynamic.Persistable> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Genai.Agent.Dynamic.Persistable | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Genai.Agent.Dynamic.Persistable>): ObjList<Genai.Agent.Dynamic.Persistable>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<Genai.Agent.Dynamic.Persistable>): ObjList<Genai.Agent.Dynamic.Persistable>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Genai.Agent.Dynamic.Persistable>): ObjList<Genai.Agent.Dynamic.Persistable>;
     ...
     */
    static afterCreate(objs: Array_Type<Genai.Agent.Dynamic.Persistable>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Genai.Agent.Dynamic.Persistable>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Genai.Agent.Dynamic.Persistable>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Genai.Agent.Dynamic.Persistable>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Genai.Agent.Dynamic.Persistable>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.Agent.Dynamic.Persistable | null;
     ...
     */
    withoutIdentity(): Genai.Agent.Dynamic.Persistable | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Genai.Agent.Dynamic.Persistable>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Genai.Agent.Dynamic.Persistable, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Genai.Agent.Dynamic.Persistable>, callback?: λFunction<Genai.Agent.Dynamic.Persistable | null, Genai.Agent.Dynamic.Persistable | null>): ObjList<Genai.Agent.Dynamic.Persistable>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Genai.Agent.Dynamic.Persistable>, callback?: λFunction<Genai.Agent.Dynamic.Persistable | null, Genai.Agent.Dynamic.Persistable | null>): Array_Type<ObjError> | null;
     ...
     */
    setActiveOrInactive(active: boolean): void;
     ...
     */
    static save(spec: Genai.Agent.Persistable.SaveSpec<Genai.Agent.Dynamic.InitializationSpec>): Genai.Agent.Persistable<any, any>;
     ...
     */
    static fetchFormData(id?: string): Genai.Agent.Persistable<any, any>;
     ...
     */
    queryFromTestCase(spec: Genai.Agent.Dynamic.TestSpec, inProgressQueryResult: Genai.Query.Result): Genai.Query.Result;

    /**
     * Convenience function to get the {@link Genai.Agent.Dynamic.Persistable.Engine}.
     * @return the engine
     */
    engine(): Genai.Agent.Dynamic.Persistable.Engine;
