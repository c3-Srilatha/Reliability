// TypeScript definitions for the C3 type Genai.Llm.Gcp.BatchRequestJob
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.Llm.Gcp.BatchRequestJob
 */
...
declare namespace Genai.Llm.Gcp {
  export class BatchRequestJob extends Obj  {
    ...
    withTypeIdent(typeIdent: string | null): Genai.Llm.Gcp.BatchRequestJob;
     ...
     */
    readonly id: string;
    withId(id: string): Genai.Llm.Gcp.BatchRequestJob;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Genai.Llm.Gcp.BatchRequestJob;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): Genai.Llm.Gcp.BatchRequestJob;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Genai.Llm.Gcp.BatchRequestJob;
    ...
    withVersion(version: number | null): Genai.Llm.Gcp.BatchRequestJob;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Genai.Llm.Gcp.BatchRequestJob;

    /**
     * The prompts passed to the LLM.
     */
    readonly prompts: Array_Type<string>;
    withPrompts(prompts: Array_Type<string> | Array<string>): Genai.Llm.Gcp.BatchRequestJob;

    /**
     * The JSONL file containing the prompts passed to the LLM.
     */
    readonly inputFile: File;
    withInputFile(inputFile: IFile): Genai.Llm.Gcp.BatchRequestJob;
    ...
    withOutputDir(outputDir: IFile): Genai.Llm.Gcp.BatchRequestJob;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.Llm.Gcp.BatchRequestJob | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.Llm.Gcp.BatchRequestJob | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.Llm.Gcp.BatchRequestJob | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.Llm.Gcp.BatchRequestJob | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.Llm.Gcp.BatchRequestJob;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Llm.Gcp.BatchRequestJob;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Llm.Gcp.BatchRequestJob;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Llm.Gcp.BatchRequestJob>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Llm.Gcp.BatchRequestJob>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.Llm.Gcp.BatchRequestJob;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Llm.Gcp.BatchRequestJob;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Llm.Gcp.BatchRequestJob;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.Llm.Gcp.BatchRequestJob;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.Llm.Gcp.BatchRequestJob;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.Llm.Gcp.BatchRequestJob;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.Llm.Gcp.BatchRequestJob;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.Llm.Gcp.BatchRequestJob;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.Llm.Gcp.BatchRequestJob;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.Llm.Gcp.BatchRequestJob;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.Llm.Gcp.BatchRequestJob;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.Llm.Gcp.BatchRequestJob;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.Llm.Gcp.BatchRequestJob;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.Llm.Gcp.BatchRequestJob;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.Llm.Gcp.BatchRequestJob;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.Llm.Gcp.BatchRequestJob;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.Llm.Gcp.BatchRequestJob;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.Llm.Gcp.BatchRequestJob;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.Llm.Gcp.BatchRequestJob;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.Llm.Gcp.BatchRequestJob;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.Llm.Gcp.BatchRequestJob;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.Llm.Gcp.BatchRequestJob;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.Llm.Gcp.BatchRequestJob;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.Llm.Gcp.BatchRequestJob;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.Llm.Gcp.BatchRequestJob;

    mergeJson(json: any): Genai.Llm.Gcp.BatchRequestJob;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.Llm.Gcp.BatchRequestJob;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.Llm.Gcp.BatchRequestJob;
     ...
     */
    singletonArray(): Array_Type<Genai.Llm.Gcp.BatchRequestJob>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.Llm.Gcp.BatchRequestJob> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.Llm.Gcp.BatchRequestJob> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.Llm.Gcp.BatchRequestJob>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.Llm.Gcp.BatchRequestJob> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.Llm.Gcp.BatchRequestJob> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.Llm.Gcp.BatchRequestJob> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.Llm.Gcp.BatchRequestJob>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.Llm.Gcp.BatchRequestJob>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.Llm.Gcp.BatchRequestJob;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.Llm.Gcp.BatchRequestJob;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.Llm.Gcp.BatchRequestJob;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.Llm.Gcp.BatchRequestJob;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.Llm.Gcp.BatchRequestJob;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.Llm.Gcp.BatchRequestJob;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.Llm.Gcp.BatchRequestJob | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.Llm.Gcp.BatchRequestJob;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.Llm.Gcp.BatchRequestJob;
     ...
     */
    static cachedEmptyInst(): Genai.Llm.Gcp.BatchRequestJob;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.Llm.Gcp.BatchRequestJob> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.Llm.Gcp.BatchRequestJob;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Genai.Llm.Gcp.BatchRequestJob>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Genai.Llm.Gcp.BatchRequestJob>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Genai.Llm.Gcp.BatchRequestJob> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Genai.Llm.Gcp.BatchRequestJob>> | null;
     ...
     */
    get(include?: string): Genai.Llm.Gcp.BatchRequestJob | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Genai.Llm.Gcp.BatchRequestJob | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Genai.Llm.Gcp.BatchRequestJob;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Genai.Llm.Gcp.BatchRequestJob | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Genai.Llm.Gcp.BatchRequestJob;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.Llm.Gcp.BatchRequestJob | null;
     ...
     */
    create(spec?: UpsertSpec): Genai.Llm.Gcp.BatchRequestJob | null;
     ...
     */
    static createBatch(objs: Array_Type<Genai.Llm.Gcp.BatchRequestJob>, spec?: UpsertSpec): ObjList<Genai.Llm.Gcp.BatchRequestJob> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Genai.Llm.Gcp.BatchRequestJob>, spec?: CreateBatchObjStreamSpec): ObjList<Genai.Llm.Gcp.BatchRequestJob> | null;
     ...
     */
    update(srcObj?: Genai.Llm.Gcp.BatchRequestJob, spec?: UpsertSpec): Genai.Llm.Gcp.BatchRequestJob | null;
     ...
     */
    upsert(srcObj?: Genai.Llm.Gcp.BatchRequestJob, spec?: UpsertSpec): Genai.Llm.Gcp.BatchRequestJob | null;
     ...
     */
    merge(spec?: MergeSpec): Genai.Llm.Gcp.BatchRequestJob | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Genai.Llm.Gcp.BatchRequestJob | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Genai.Llm.Gcp.BatchRequestJob | null;
     ...
     */
    static updateBatch(objs: Array_Type<Genai.Llm.Gcp.BatchRequestJob>, srcObjs?: Array_Type<Genai.Llm.Gcp.BatchRequestJob>, spec?: UpsertSpec): ObjList<Genai.Llm.Gcp.BatchRequestJob> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Genai.Llm.Gcp.BatchRequestJob> | null>, spec?: UpsertSpec): ObjList<Genai.Llm.Gcp.BatchRequestJob> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Genai.Llm.Gcp.BatchRequestJob>, srcObjs?: Array_Type<Genai.Llm.Gcp.BatchRequestJob>, spec?: UpsertSpec): ObjList<Genai.Llm.Gcp.BatchRequestJob> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Genai.Llm.Gcp.BatchRequestJob> | null>, spec?: UpsertSpec): ObjList<Genai.Llm.Gcp.BatchRequestJob> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Genai.Llm.Gcp.BatchRequestJob>, spec?: TouchSpec): ObjList<Genai.Llm.Gcp.BatchRequestJob> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.Llm.Gcp.BatchRequestJob>, spec?: MergeSpec): ObjList<Genai.Llm.Gcp.BatchRequestJob> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.Llm.Gcp.BatchRequestJob>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.Llm.Gcp.BatchRequestJob> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Genai.Llm.Gcp.BatchRequestJob> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.Llm.Gcp.BatchRequestJob> | null;
     ...
     */
    static mergeAll(mergeObj: Genai.Llm.Gcp.BatchRequestJob, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Genai.Llm.Gcp.BatchRequestJob, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Genai.Llm.Gcp.BatchRequestJob>, spec?: UpsertSpec): ObjList<Genai.Llm.Gcp.BatchRequestJob> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Genai.Llm.Gcp.BatchRequestJob>, spec?: UpsertSpec): ObjList<Genai.Llm.Gcp.BatchRequestJob> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Genai.Llm.Gcp.BatchRequestJob | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Genai.Llm.Gcp.BatchRequestJob>): ObjList<Genai.Llm.Gcp.BatchRequestJob>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<Genai.Llm.Gcp.BatchRequestJob>): ObjList<Genai.Llm.Gcp.BatchRequestJob>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Genai.Llm.Gcp.BatchRequestJob>): ObjList<Genai.Llm.Gcp.BatchRequestJob>;
     ...
     */
    static afterCreate(objs: Array_Type<Genai.Llm.Gcp.BatchRequestJob>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Genai.Llm.Gcp.BatchRequestJob>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Genai.Llm.Gcp.BatchRequestJob>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Genai.Llm.Gcp.BatchRequestJob>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Genai.Llm.Gcp.BatchRequestJob>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.Llm.Gcp.BatchRequestJob | null;
     ...
     */
    withoutIdentity(): Genai.Llm.Gcp.BatchRequestJob | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Genai.Llm.Gcp.BatchRequestJob>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Genai.Llm.Gcp.BatchRequestJob, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Genai.Llm.Gcp.BatchRequestJob>, callback?: λFunction<Genai.Llm.Gcp.BatchRequestJob | null, Genai.Llm.Gcp.BatchRequestJob | null>): ObjList<Genai.Llm.Gcp.BatchRequestJob>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Genai.Llm.Gcp.BatchRequestJob>, callback?: λFunction<Genai.Llm.Gcp.BatchRequestJob | null, Genai.Llm.Gcp.BatchRequestJob | null>): Array_Type<ObjError> | null;
