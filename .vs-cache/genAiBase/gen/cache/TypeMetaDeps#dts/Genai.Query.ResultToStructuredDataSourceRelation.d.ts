// TypeScript definitions for the C3 type Genai.Query.ResultToStructuredDataSourceRelation
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.Query.ResultToStructuredDataSourceRelation
 */
declare namespace Genai.Query {
  export interface IResultToStructuredDataSourceRelation {
     ...
     */
    to: IGenai.Query.Result.Source.StructuredData;
    ...
    /**
     * The number of rows in the source type's table at time of query.
     */
    numRows?: number;
  }
}
 ...
 * allows for a many-to-many relationship between query results and sources.
 *
 * @remarks this represents a made instance of Genai.Query.ResultToStructuredDataSourceRelation
 */
declare namespace Genai.Query {
  export class ResultToStructuredDataSourceRelation extends Obj  {
    ...
    withTypeIdent(typeIdent: string | null): Genai.Query.ResultToStructuredDataSourceRelation;
     ...
     */
    readonly id: string;
    withId(id: string): Genai.Query.ResultToStructuredDataSourceRelation;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Genai.Query.ResultToStructuredDataSourceRelation;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): Genai.Query.ResultToStructuredDataSourceRelation;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Genai.Query.ResultToStructuredDataSourceRelation;
    ...
    withVersion(version: number | null): Genai.Query.ResultToStructuredDataSourceRelation;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Genai.Query.ResultToStructuredDataSourceRelation;

    /**
     * The {@link Genai.Query.Result} that this relation is associated with.
     */
    readonly from?: Genai.Query.Result;
    withFrom(from: IGenai.Query.Result | null): Genai.Query.ResultToStructuredDataSourceRelation;

    /**
     * The {@link Genai.Agent.DynamicTrajectory.Step} that this relation is associated with.
     */
    readonly fromStep?: Genai.Agent.DynamicTrajectory.Step;
    withFromStep(fromStep: IGenai.Agent.DynamicTrajectory.Step | null): Genai.Query.ResultToStructuredDataSourceRelation;

    /**
     * The structured data source that was used to generate the query result.
     */
    readonly to: Genai.Query.Result.Source.StructuredData;
    withTo(to: IGenai.Query.Result.Source.StructuredData): Genai.Query.ResultToStructuredDataSourceRelation;
    ...
    withPassageUiDisplayIndex(passageUiDisplayIndex: number | null): Genai.Query.ResultToStructuredDataSourceRelation;
    ...
    withDisplayName(displayName: string | null): Genai.Query.ResultToStructuredDataSourceRelation;

    /**
     * The number of rows in the source type's table at time of query.
     */
    readonly numRows?: number;
    withNumRows(numRows: number | null): Genai.Query.ResultToStructuredDataSourceRelation;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.Query.ResultToStructuredDataSourceRelation | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.Query.ResultToStructuredDataSourceRelation | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.Query.ResultToStructuredDataSourceRelation | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.Query.ResultToStructuredDataSourceRelation | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.Query.ResultToStructuredDataSourceRelation;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Query.ResultToStructuredDataSourceRelation;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Query.ResultToStructuredDataSourceRelation;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Query.ResultToStructuredDataSourceRelation>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Query.ResultToStructuredDataSourceRelation>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.Query.ResultToStructuredDataSourceRelation;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Query.ResultToStructuredDataSourceRelation;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Query.ResultToStructuredDataSourceRelation;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.Query.ResultToStructuredDataSourceRelation;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.Query.ResultToStructuredDataSourceRelation;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.Query.ResultToStructuredDataSourceRelation;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.Query.ResultToStructuredDataSourceRelation;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.Query.ResultToStructuredDataSourceRelation;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.Query.ResultToStructuredDataSourceRelation;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.Query.ResultToStructuredDataSourceRelation;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.Query.ResultToStructuredDataSourceRelation;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.Query.ResultToStructuredDataSourceRelation;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.Query.ResultToStructuredDataSourceRelation;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.Query.ResultToStructuredDataSourceRelation;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.Query.ResultToStructuredDataSourceRelation;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.Query.ResultToStructuredDataSourceRelation;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.Query.ResultToStructuredDataSourceRelation;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.Query.ResultToStructuredDataSourceRelation;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.Query.ResultToStructuredDataSourceRelation;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.Query.ResultToStructuredDataSourceRelation;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.Query.ResultToStructuredDataSourceRelation;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.Query.ResultToStructuredDataSourceRelation;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.Query.ResultToStructuredDataSourceRelation;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.Query.ResultToStructuredDataSourceRelation;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.Query.ResultToStructuredDataSourceRelation;

    mergeJson(json: any): Genai.Query.ResultToStructuredDataSourceRelation;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.Query.ResultToStructuredDataSourceRelation;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.Query.ResultToStructuredDataSourceRelation;
     ...
     */
    singletonArray(): Array_Type<Genai.Query.ResultToStructuredDataSourceRelation>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.Query.ResultToStructuredDataSourceRelation> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.Query.ResultToStructuredDataSourceRelation> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.Query.ResultToStructuredDataSourceRelation>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.Query.ResultToStructuredDataSourceRelation> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.Query.ResultToStructuredDataSourceRelation> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.Query.ResultToStructuredDataSourceRelation> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.Query.ResultToStructuredDataSourceRelation>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.Query.ResultToStructuredDataSourceRelation>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.Query.ResultToStructuredDataSourceRelation;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.Query.ResultToStructuredDataSourceRelation;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.Query.ResultToStructuredDataSourceRelation;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.Query.ResultToStructuredDataSourceRelation;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.Query.ResultToStructuredDataSourceRelation;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.Query.ResultToStructuredDataSourceRelation;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.Query.ResultToStructuredDataSourceRelation | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.Query.ResultToStructuredDataSourceRelation;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.Query.ResultToStructuredDataSourceRelation;
     ...
     */
    static cachedEmptyInst(): Genai.Query.ResultToStructuredDataSourceRelation;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.Query.ResultToStructuredDataSourceRelation> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.Query.ResultToStructuredDataSourceRelation;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Genai.Query.ResultToStructuredDataSourceRelation>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Genai.Query.ResultToStructuredDataSourceRelation>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Genai.Query.ResultToStructuredDataSourceRelation> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Genai.Query.ResultToStructuredDataSourceRelation>> | null;
     ...
     */
    get(include?: string): Genai.Query.ResultToStructuredDataSourceRelation | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Genai.Query.ResultToStructuredDataSourceRelation | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Genai.Query.ResultToStructuredDataSourceRelation;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Genai.Query.ResultToStructuredDataSourceRelation | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Genai.Query.ResultToStructuredDataSourceRelation;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.Query.ResultToStructuredDataSourceRelation | null;
     ...
     */
    create(spec?: UpsertSpec): Genai.Query.ResultToStructuredDataSourceRelation | null;
     ...
     */
    static createBatch(objs: Array_Type<Genai.Query.ResultToStructuredDataSourceRelation>, spec?: UpsertSpec): ObjList<Genai.Query.ResultToStructuredDataSourceRelation> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Genai.Query.ResultToStructuredDataSourceRelation>, spec?: CreateBatchObjStreamSpec): ObjList<Genai.Query.ResultToStructuredDataSourceRelation> | null;
     ...
     */
    update(srcObj?: Genai.Query.ResultToStructuredDataSourceRelation, spec?: UpsertSpec): Genai.Query.ResultToStructuredDataSourceRelation | null;
     ...
     */
    upsert(srcObj?: Genai.Query.ResultToStructuredDataSourceRelation, spec?: UpsertSpec): Genai.Query.ResultToStructuredDataSourceRelation | null;
     ...
     */
    merge(spec?: MergeSpec): Genai.Query.ResultToStructuredDataSourceRelation | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Genai.Query.ResultToStructuredDataSourceRelation | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Genai.Query.ResultToStructuredDataSourceRelation | null;
     ...
     */
    static updateBatch(objs: Array_Type<Genai.Query.ResultToStructuredDataSourceRelation>, srcObjs?: Array_Type<Genai.Query.ResultToStructuredDataSourceRelation>, spec?: UpsertSpec): ObjList<Genai.Query.ResultToStructuredDataSourceRelation> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Genai.Query.ResultToStructuredDataSourceRelation> | null>, spec?: UpsertSpec): ObjList<Genai.Query.ResultToStructuredDataSourceRelation> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Genai.Query.ResultToStructuredDataSourceRelation>, srcObjs?: Array_Type<Genai.Query.ResultToStructuredDataSourceRelation>, spec?: UpsertSpec): ObjList<Genai.Query.ResultToStructuredDataSourceRelation> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Genai.Query.ResultToStructuredDataSourceRelation> | null>, spec?: UpsertSpec): ObjList<Genai.Query.ResultToStructuredDataSourceRelation> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Genai.Query.ResultToStructuredDataSourceRelation>, spec?: TouchSpec): ObjList<Genai.Query.ResultToStructuredDataSourceRelation> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.Query.ResultToStructuredDataSourceRelation>, spec?: MergeSpec): ObjList<Genai.Query.ResultToStructuredDataSourceRelation> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.Query.ResultToStructuredDataSourceRelation>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.Query.ResultToStructuredDataSourceRelation> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Genai.Query.ResultToStructuredDataSourceRelation> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.Query.ResultToStructuredDataSourceRelation> | null;
     ...
     */
    static mergeAll(mergeObj: Genai.Query.ResultToStructuredDataSourceRelation, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Genai.Query.ResultToStructuredDataSourceRelation, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Genai.Query.ResultToStructuredDataSourceRelation>, spec?: UpsertSpec): ObjList<Genai.Query.ResultToStructuredDataSourceRelation> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Genai.Query.ResultToStructuredDataSourceRelation>, spec?: UpsertSpec): ObjList<Genai.Query.ResultToStructuredDataSourceRelation> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Genai.Query.ResultToStructuredDataSourceRelation | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Genai.Query.ResultToStructuredDataSourceRelation>): ObjList<Genai.Query.ResultToStructuredDataSourceRelation>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<Genai.Query.ResultToStructuredDataSourceRelation>): ObjList<Genai.Query.ResultToStructuredDataSourceRelation>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Genai.Query.ResultToStructuredDataSourceRelation>): ObjList<Genai.Query.ResultToStructuredDataSourceRelation>;
     ...
     */
    static afterCreate(objs: Array_Type<Genai.Query.ResultToStructuredDataSourceRelation>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Genai.Query.ResultToStructuredDataSourceRelation>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Genai.Query.ResultToStructuredDataSourceRelation>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Genai.Query.ResultToStructuredDataSourceRelation>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Genai.Query.ResultToStructuredDataSourceRelation>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.Query.ResultToStructuredDataSourceRelation | null;
     ...
     */
    withoutIdentity(): Genai.Query.ResultToStructuredDataSourceRelation | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Genai.Query.ResultToStructuredDataSourceRelation>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Genai.Query.ResultToStructuredDataSourceRelation, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Genai.Query.ResultToStructuredDataSourceRelation>, callback?: λFunction<Genai.Query.ResultToStructuredDataSourceRelation | null, Genai.Query.ResultToStructuredDataSourceRelation | null>): ObjList<Genai.Query.ResultToStructuredDataSourceRelation>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Genai.Query.ResultToStructuredDataSourceRelation>, callback?: λFunction<Genai.Query.ResultToStructuredDataSourceRelation | null, Genai.Query.ResultToStructuredDataSourceRelation | null>): Array_Type<ObjError> | null;
     ...
     */
    static cloneTo(srcResult: Genai.Query.Result, destResult: Genai.Query.Result): Array_Type<Genai.Query.ResultToStructuredDataSourceRelation>;
     ...
     */
    static cloneRelationsToParent(queryResult: Genai.Query.Result): Array_Type<Genai.Query.ResultToStructuredDataSourceRelation> | null;
     ...
     * @return the list of relations for parent
     */
    static relationsForParent(queryResult: Genai.Query.Result): Array_Type<Genai.Query.ResultToStructuredDataSourceRelation> | null;
