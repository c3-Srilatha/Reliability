// TypeScript definitions for the C3 type Genai.TestFileSourceCollectionType1

/**
 * This entity type represents measurements of a flower.
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.TestFileSourceCollectionType1
 */
declare namespace Genai {
  export interface ITestFileSourceCollectionType1 {
    ...
    /**
     * The encoding of the measurement.
     */
    encoded?: string;
  }
}
 ...
 * This entity type represents measurements of a flower.
 *
 * @remarks this represents a made instance of Genai.TestFileSourceCollectionType1
 */
declare namespace Genai {
  export class TestFileSourceCollectionType1 extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): Genai.TestFileSourceCollectionType1;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Genai.TestFileSourceCollectionType1;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): Genai.TestFileSourceCollectionType1;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Genai.TestFileSourceCollectionType1;
    ...
    withVersion(version: number | null): Genai.TestFileSourceCollectionType1;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Genai.TestFileSourceCollectionType1;

    /**
     * The id of the measurement.
     */
    readonly idAlias?: number;
    withIdAlias(idAlias: number | null): Genai.TestFileSourceCollectionType1;

    /**
     * The length of the petal in centimeters.
     */
    readonly petalLengthCm?: number;
    withPetalLengthCm(petalLengthCm: number | null): Genai.TestFileSourceCollectionType1;

    /**
     * The width of the petal in centimeters.
     */
    readonly petalWidthCm?: number;
    withPetalWidthCm(petalWidthCm: number | null): Genai.TestFileSourceCollectionType1;

    /**
     * The length of the sepal in centimeters.
     */
    readonly sepalLengthCm?: number;
    withSepalLengthCm(sepalLengthCm: number | null): Genai.TestFileSourceCollectionType1;

    /**
     * The width of the sepal in centimeters.
     */
    readonly sepalWidthCm?: number;
    withSepalWidthCm(sepalWidthCm: number | null): Genai.TestFileSourceCollectionType1;

    /**
     * The species of the flower.
     */
    readonly species?: string;
    withSpecies(species: string | null): Genai.TestFileSourceCollectionType1;

    /**
     * The encoding of the measurement.
     */
    readonly encoded?: string;
    withEncoded(encoded: string | null): Genai.TestFileSourceCollectionType1;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.TestFileSourceCollectionType1 | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.TestFileSourceCollectionType1 | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.TestFileSourceCollectionType1 | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.TestFileSourceCollectionType1 | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.TestFileSourceCollectionType1;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.TestFileSourceCollectionType1;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.TestFileSourceCollectionType1;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.TestFileSourceCollectionType1>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.TestFileSourceCollectionType1>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.TestFileSourceCollectionType1;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.TestFileSourceCollectionType1;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.TestFileSourceCollectionType1;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.TestFileSourceCollectionType1;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.TestFileSourceCollectionType1;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.TestFileSourceCollectionType1;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.TestFileSourceCollectionType1;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.TestFileSourceCollectionType1;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.TestFileSourceCollectionType1;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.TestFileSourceCollectionType1;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.TestFileSourceCollectionType1;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.TestFileSourceCollectionType1;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.TestFileSourceCollectionType1;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.TestFileSourceCollectionType1;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.TestFileSourceCollectionType1;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.TestFileSourceCollectionType1;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.TestFileSourceCollectionType1;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.TestFileSourceCollectionType1;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.TestFileSourceCollectionType1;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.TestFileSourceCollectionType1;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.TestFileSourceCollectionType1;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.TestFileSourceCollectionType1;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.TestFileSourceCollectionType1;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.TestFileSourceCollectionType1;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.TestFileSourceCollectionType1;

    mergeJson(json: any): Genai.TestFileSourceCollectionType1;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.TestFileSourceCollectionType1;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.TestFileSourceCollectionType1;
     ...
     */
    singletonArray(): Array_Type<Genai.TestFileSourceCollectionType1>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.TestFileSourceCollectionType1> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.TestFileSourceCollectionType1> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.TestFileSourceCollectionType1>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.TestFileSourceCollectionType1> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.TestFileSourceCollectionType1> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.TestFileSourceCollectionType1> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.TestFileSourceCollectionType1>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.TestFileSourceCollectionType1>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.TestFileSourceCollectionType1;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.TestFileSourceCollectionType1;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.TestFileSourceCollectionType1;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.TestFileSourceCollectionType1;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.TestFileSourceCollectionType1;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.TestFileSourceCollectionType1;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.TestFileSourceCollectionType1 | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.TestFileSourceCollectionType1;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.TestFileSourceCollectionType1;
     ...
     */
    static cachedEmptyInst(): Genai.TestFileSourceCollectionType1;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.TestFileSourceCollectionType1> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.TestFileSourceCollectionType1;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Genai.TestFileSourceCollectionType1>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Genai.TestFileSourceCollectionType1>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Genai.TestFileSourceCollectionType1> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Genai.TestFileSourceCollectionType1>> | null;
     ...
     */
    get(include?: string): Genai.TestFileSourceCollectionType1 | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Genai.TestFileSourceCollectionType1 | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Genai.TestFileSourceCollectionType1;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Genai.TestFileSourceCollectionType1 | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Genai.TestFileSourceCollectionType1;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.TestFileSourceCollectionType1 | null;
     ...
     */
    create(spec?: UpsertSpec): Genai.TestFileSourceCollectionType1 | null;
     ...
     */
    static createBatch(objs: Array_Type<Genai.TestFileSourceCollectionType1>, spec?: UpsertSpec): ObjList<Genai.TestFileSourceCollectionType1> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Genai.TestFileSourceCollectionType1>, spec?: CreateBatchObjStreamSpec): ObjList<Genai.TestFileSourceCollectionType1> | null;
     ...
     */
    update(srcObj?: Genai.TestFileSourceCollectionType1, spec?: UpsertSpec): Genai.TestFileSourceCollectionType1 | null;
     ...
     */
    upsert(srcObj?: Genai.TestFileSourceCollectionType1, spec?: UpsertSpec): Genai.TestFileSourceCollectionType1 | null;
     ...
     */
    merge(spec?: MergeSpec): Genai.TestFileSourceCollectionType1 | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Genai.TestFileSourceCollectionType1 | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Genai.TestFileSourceCollectionType1 | null;
     ...
     */
    static updateBatch(objs: Array_Type<Genai.TestFileSourceCollectionType1>, srcObjs?: Array_Type<Genai.TestFileSourceCollectionType1>, spec?: UpsertSpec): ObjList<Genai.TestFileSourceCollectionType1> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Genai.TestFileSourceCollectionType1> | null>, spec?: UpsertSpec): ObjList<Genai.TestFileSourceCollectionType1> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Genai.TestFileSourceCollectionType1>, srcObjs?: Array_Type<Genai.TestFileSourceCollectionType1>, spec?: UpsertSpec): ObjList<Genai.TestFileSourceCollectionType1> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Genai.TestFileSourceCollectionType1> | null>, spec?: UpsertSpec): ObjList<Genai.TestFileSourceCollectionType1> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Genai.TestFileSourceCollectionType1>, spec?: TouchSpec): ObjList<Genai.TestFileSourceCollectionType1> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.TestFileSourceCollectionType1>, spec?: MergeSpec): ObjList<Genai.TestFileSourceCollectionType1> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.TestFileSourceCollectionType1>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.TestFileSourceCollectionType1> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Genai.TestFileSourceCollectionType1> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.TestFileSourceCollectionType1> | null;
     ...
     */
    static mergeAll(mergeObj: Genai.TestFileSourceCollectionType1, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Genai.TestFileSourceCollectionType1, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Genai.TestFileSourceCollectionType1>, spec?: UpsertSpec): ObjList<Genai.TestFileSourceCollectionType1> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Genai.TestFileSourceCollectionType1>, spec?: UpsertSpec): ObjList<Genai.TestFileSourceCollectionType1> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Genai.TestFileSourceCollectionType1 | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Genai.TestFileSourceCollectionType1>): ObjList<Genai.TestFileSourceCollectionType1>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<Genai.TestFileSourceCollectionType1>): ObjList<Genai.TestFileSourceCollectionType1>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Genai.TestFileSourceCollectionType1>): ObjList<Genai.TestFileSourceCollectionType1>;
     ...
     */
    static afterCreate(objs: Array_Type<Genai.TestFileSourceCollectionType1>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Genai.TestFileSourceCollectionType1>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Genai.TestFileSourceCollectionType1>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Genai.TestFileSourceCollectionType1>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Genai.TestFileSourceCollectionType1>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.TestFileSourceCollectionType1 | null;
     ...
     */
    withoutIdentity(): Genai.TestFileSourceCollectionType1 | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Genai.TestFileSourceCollectionType1>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Genai.TestFileSourceCollectionType1, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Genai.TestFileSourceCollectionType1>, callback?: λFunction<Genai.TestFileSourceCollectionType1 | null, Genai.TestFileSourceCollectionType1 | null>): ObjList<Genai.TestFileSourceCollectionType1>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Genai.TestFileSourceCollectionType1>, callback?: λFunction<Genai.TestFileSourceCollectionType1 | null, Genai.TestFileSourceCollectionType1 | null>): Array_Type<ObjError> | null;
