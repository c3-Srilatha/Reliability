// TypeScript definitions for the C3 type Genai.FieldValueData

/**
 * A data sample with its embedding defined in pgvector.
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.FieldValueData
 */
declare namespace Genai {
  export interface IFieldValueData {
 ...
 */
declare namespace Genai {
  export class FieldValueData extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): Genai.FieldValueData;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Genai.FieldValueData;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): Genai.FieldValueData;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Genai.FieldValueData;
    ...
    withVersion(version: number | null): Genai.FieldValueData;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Genai.FieldValueData;

    /**
     * The source type of the value.
     */
    readonly sourceType: string;
    withSourceType(sourceType: string): Genai.FieldValueData;

    /**
     * The field name of the value.
     */
    readonly fieldName: string;
    withFieldName(fieldName: string): Genai.FieldValueData;

    /**
     * The string representation of the data value.
     */
    readonly dataValue: string;
    withDataValue(dataValue: string): Genai.FieldValueData;

    /**
     * The text content used to generate the embedding.
     */
    readonly content?: string;
    withContent(content: string | null): Genai.FieldValueData;

    /**
     * An embedding of the data value representation.
     */
    readonly emb?: string;
    withEmb(emb: string | null): Genai.FieldValueData;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.FieldValueData | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.FieldValueData | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.FieldValueData | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.FieldValueData | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.FieldValueData;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.FieldValueData;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.FieldValueData;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.FieldValueData>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.FieldValueData>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.FieldValueData;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.FieldValueData;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.FieldValueData;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.FieldValueData;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.FieldValueData;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.FieldValueData;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.FieldValueData;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.FieldValueData;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.FieldValueData;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.FieldValueData;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.FieldValueData;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.FieldValueData;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.FieldValueData;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.FieldValueData;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.FieldValueData;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.FieldValueData;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.FieldValueData;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.FieldValueData;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.FieldValueData;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.FieldValueData;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.FieldValueData;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.FieldValueData;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.FieldValueData;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.FieldValueData;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.FieldValueData;

    mergeJson(json: any): Genai.FieldValueData;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.FieldValueData;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.FieldValueData;
     ...
     */
    singletonArray(): Array_Type<Genai.FieldValueData>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.FieldValueData> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.FieldValueData> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.FieldValueData>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.FieldValueData> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.FieldValueData> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.FieldValueData> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.FieldValueData>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.FieldValueData>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.FieldValueData;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.FieldValueData;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.FieldValueData;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.FieldValueData;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.FieldValueData;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.FieldValueData;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.FieldValueData | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.FieldValueData;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.FieldValueData;
     ...
     */
    static cachedEmptyInst(): Genai.FieldValueData;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.FieldValueData> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.FieldValueData;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Genai.FieldValueData>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Genai.FieldValueData>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Genai.FieldValueData> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Genai.FieldValueData>> | null;
     ...
     */
    get(include?: string): Genai.FieldValueData | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Genai.FieldValueData | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Genai.FieldValueData;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Genai.FieldValueData | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Genai.FieldValueData;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.FieldValueData | null;
     ...
     */
    create(spec?: UpsertSpec): Genai.FieldValueData | null;
     ...
     */
    static createBatch(objs: Array_Type<Genai.FieldValueData>, spec?: UpsertSpec): ObjList<Genai.FieldValueData> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Genai.FieldValueData>, spec?: CreateBatchObjStreamSpec): ObjList<Genai.FieldValueData> | null;
     ...
     */
    update(srcObj?: Genai.FieldValueData, spec?: UpsertSpec): Genai.FieldValueData | null;
     ...
     */
    upsert(srcObj?: Genai.FieldValueData, spec?: UpsertSpec): Genai.FieldValueData | null;
     ...
     */
    merge(spec?: MergeSpec): Genai.FieldValueData | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Genai.FieldValueData | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Genai.FieldValueData | null;
     ...
     */
    static updateBatch(objs: Array_Type<Genai.FieldValueData>, srcObjs?: Array_Type<Genai.FieldValueData>, spec?: UpsertSpec): ObjList<Genai.FieldValueData> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Genai.FieldValueData> | null>, spec?: UpsertSpec): ObjList<Genai.FieldValueData> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Genai.FieldValueData>, srcObjs?: Array_Type<Genai.FieldValueData>, spec?: UpsertSpec): ObjList<Genai.FieldValueData> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Genai.FieldValueData> | null>, spec?: UpsertSpec): ObjList<Genai.FieldValueData> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Genai.FieldValueData>, spec?: TouchSpec): ObjList<Genai.FieldValueData> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.FieldValueData>, spec?: MergeSpec): ObjList<Genai.FieldValueData> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.FieldValueData>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.FieldValueData> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Genai.FieldValueData> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.FieldValueData> | null;
     ...
     */
    static mergeAll(mergeObj: Genai.FieldValueData, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Genai.FieldValueData, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Genai.FieldValueData>, spec?: UpsertSpec): ObjList<Genai.FieldValueData> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Genai.FieldValueData>, spec?: UpsertSpec): ObjList<Genai.FieldValueData> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Genai.FieldValueData | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Genai.FieldValueData>): ObjList<Genai.FieldValueData>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<Genai.FieldValueData>): ObjList<Genai.FieldValueData>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Genai.FieldValueData>): ObjList<Genai.FieldValueData>;
     ...
     */
    static afterCreate(objs: Array_Type<Genai.FieldValueData>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Genai.FieldValueData>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Genai.FieldValueData>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Genai.FieldValueData>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Genai.FieldValueData>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.FieldValueData | null;
     ...
     */
    withoutIdentity(): Genai.FieldValueData | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Genai.FieldValueData>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Genai.FieldValueData, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Genai.FieldValueData>, callback?: λFunction<Genai.FieldValueData | null, Genai.FieldValueData | null>): ObjList<Genai.FieldValueData>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Genai.FieldValueData>, callback?: λFunction<Genai.FieldValueData | null, Genai.FieldValueData | null>): Array_Type<ObjError> | null;
