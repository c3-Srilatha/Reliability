// TypeScript definitions for the C3 type Genai.SourceFile.Metadata.Tagging.ScanResult
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.SourceFile.Metadata.Tagging.ScanResult
 */
declare namespace Genai.SourceFile.Metadata.Tagging {
  export interface IScanResult {
     ...
     */
    categories?: Map_Type<string, Array_Type<string>> | {[key: string]: Array_Type<string> | Array<string>};
 ...
 */
declare namespace Genai.SourceFile.Metadata.Tagging {
  export class ScanResult extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): Genai.SourceFile.Metadata.Tagging.ScanResult;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Genai.SourceFile.Metadata.Tagging.ScanResult;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): Genai.SourceFile.Metadata.Tagging.ScanResult;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Genai.SourceFile.Metadata.Tagging.ScanResult;
    ...
    withVersion(version: number | null): Genai.SourceFile.Metadata.Tagging.ScanResult;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Genai.SourceFile.Metadata.Tagging.ScanResult;

    /**
     * Filter Categories for the process of metadata tagging
     */
    readonly categories?: Map_Type<string, Array_Type<string>>;
    withCategories(categories: Map_Type<string, Array_Type<string>> | {[key: string]: Array_Type<string> | Array<string>} | null): Genai.SourceFile.Metadata.Tagging.ScanResult;

    /**
     * Value for the active filter to be use in the process of metadata tagging
     */
    readonly active: boolean;
    withActive(active: boolean): Genai.SourceFile.Metadata.Tagging.ScanResult;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.SourceFile.Metadata.Tagging.ScanResult | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.SourceFile.Metadata.Tagging.ScanResult | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.SourceFile.Metadata.Tagging.ScanResult | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.SourceFile.Metadata.Tagging.ScanResult | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.SourceFile.Metadata.Tagging.ScanResult;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.SourceFile.Metadata.Tagging.ScanResult;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.SourceFile.Metadata.Tagging.ScanResult;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.SourceFile.Metadata.Tagging.ScanResult>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.SourceFile.Metadata.Tagging.ScanResult>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.SourceFile.Metadata.Tagging.ScanResult;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.SourceFile.Metadata.Tagging.ScanResult;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.SourceFile.Metadata.Tagging.ScanResult;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.SourceFile.Metadata.Tagging.ScanResult;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.SourceFile.Metadata.Tagging.ScanResult;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.SourceFile.Metadata.Tagging.ScanResult;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.SourceFile.Metadata.Tagging.ScanResult;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.SourceFile.Metadata.Tagging.ScanResult;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.SourceFile.Metadata.Tagging.ScanResult;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.SourceFile.Metadata.Tagging.ScanResult;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.SourceFile.Metadata.Tagging.ScanResult;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.SourceFile.Metadata.Tagging.ScanResult;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.SourceFile.Metadata.Tagging.ScanResult;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.SourceFile.Metadata.Tagging.ScanResult;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.SourceFile.Metadata.Tagging.ScanResult;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.SourceFile.Metadata.Tagging.ScanResult;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.SourceFile.Metadata.Tagging.ScanResult;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.SourceFile.Metadata.Tagging.ScanResult;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.SourceFile.Metadata.Tagging.ScanResult;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.SourceFile.Metadata.Tagging.ScanResult;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.SourceFile.Metadata.Tagging.ScanResult;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.SourceFile.Metadata.Tagging.ScanResult;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.SourceFile.Metadata.Tagging.ScanResult;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.SourceFile.Metadata.Tagging.ScanResult;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.SourceFile.Metadata.Tagging.ScanResult;

    mergeJson(json: any): Genai.SourceFile.Metadata.Tagging.ScanResult;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.SourceFile.Metadata.Tagging.ScanResult;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.SourceFile.Metadata.Tagging.ScanResult;
     ...
     */
    singletonArray(): Array_Type<Genai.SourceFile.Metadata.Tagging.ScanResult>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.SourceFile.Metadata.Tagging.ScanResult> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.SourceFile.Metadata.Tagging.ScanResult> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.SourceFile.Metadata.Tagging.ScanResult>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.SourceFile.Metadata.Tagging.ScanResult> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.SourceFile.Metadata.Tagging.ScanResult> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.SourceFile.Metadata.Tagging.ScanResult> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.SourceFile.Metadata.Tagging.ScanResult>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.SourceFile.Metadata.Tagging.ScanResult>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.SourceFile.Metadata.Tagging.ScanResult;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.SourceFile.Metadata.Tagging.ScanResult;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.SourceFile.Metadata.Tagging.ScanResult;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.SourceFile.Metadata.Tagging.ScanResult;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.SourceFile.Metadata.Tagging.ScanResult;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.SourceFile.Metadata.Tagging.ScanResult;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.SourceFile.Metadata.Tagging.ScanResult | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.SourceFile.Metadata.Tagging.ScanResult;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.SourceFile.Metadata.Tagging.ScanResult;
     ...
     */
    static cachedEmptyInst(): Genai.SourceFile.Metadata.Tagging.ScanResult;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.SourceFile.Metadata.Tagging.ScanResult> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.SourceFile.Metadata.Tagging.ScanResult;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Genai.SourceFile.Metadata.Tagging.ScanResult>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Genai.SourceFile.Metadata.Tagging.ScanResult>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Genai.SourceFile.Metadata.Tagging.ScanResult> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Genai.SourceFile.Metadata.Tagging.ScanResult>> | null;
     ...
     */
    get(include?: string): Genai.SourceFile.Metadata.Tagging.ScanResult | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Genai.SourceFile.Metadata.Tagging.ScanResult | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Genai.SourceFile.Metadata.Tagging.ScanResult;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Genai.SourceFile.Metadata.Tagging.ScanResult | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Genai.SourceFile.Metadata.Tagging.ScanResult;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.SourceFile.Metadata.Tagging.ScanResult | null;
     ...
     */
    create(spec?: UpsertSpec): Genai.SourceFile.Metadata.Tagging.ScanResult | null;
     ...
     */
    static createBatch(objs: Array_Type<Genai.SourceFile.Metadata.Tagging.ScanResult>, spec?: UpsertSpec): ObjList<Genai.SourceFile.Metadata.Tagging.ScanResult> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Genai.SourceFile.Metadata.Tagging.ScanResult>, spec?: CreateBatchObjStreamSpec): ObjList<Genai.SourceFile.Metadata.Tagging.ScanResult> | null;
     ...
     */
    update(srcObj?: Genai.SourceFile.Metadata.Tagging.ScanResult, spec?: UpsertSpec): Genai.SourceFile.Metadata.Tagging.ScanResult | null;
     ...
     */
    upsert(srcObj?: Genai.SourceFile.Metadata.Tagging.ScanResult, spec?: UpsertSpec): Genai.SourceFile.Metadata.Tagging.ScanResult | null;
     ...
     */
    merge(spec?: MergeSpec): Genai.SourceFile.Metadata.Tagging.ScanResult | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Genai.SourceFile.Metadata.Tagging.ScanResult | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Genai.SourceFile.Metadata.Tagging.ScanResult | null;
     ...
     */
    static updateBatch(objs: Array_Type<Genai.SourceFile.Metadata.Tagging.ScanResult>, srcObjs?: Array_Type<Genai.SourceFile.Metadata.Tagging.ScanResult>, spec?: UpsertSpec): ObjList<Genai.SourceFile.Metadata.Tagging.ScanResult> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Genai.SourceFile.Metadata.Tagging.ScanResult> | null>, spec?: UpsertSpec): ObjList<Genai.SourceFile.Metadata.Tagging.ScanResult> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Genai.SourceFile.Metadata.Tagging.ScanResult>, srcObjs?: Array_Type<Genai.SourceFile.Metadata.Tagging.ScanResult>, spec?: UpsertSpec): ObjList<Genai.SourceFile.Metadata.Tagging.ScanResult> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Genai.SourceFile.Metadata.Tagging.ScanResult> | null>, spec?: UpsertSpec): ObjList<Genai.SourceFile.Metadata.Tagging.ScanResult> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Genai.SourceFile.Metadata.Tagging.ScanResult>, spec?: TouchSpec): ObjList<Genai.SourceFile.Metadata.Tagging.ScanResult> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.SourceFile.Metadata.Tagging.ScanResult>, spec?: MergeSpec): ObjList<Genai.SourceFile.Metadata.Tagging.ScanResult> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.SourceFile.Metadata.Tagging.ScanResult>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.SourceFile.Metadata.Tagging.ScanResult> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Genai.SourceFile.Metadata.Tagging.ScanResult> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.SourceFile.Metadata.Tagging.ScanResult> | null;
     ...
     */
    static mergeAll(mergeObj: Genai.SourceFile.Metadata.Tagging.ScanResult, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Genai.SourceFile.Metadata.Tagging.ScanResult, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Genai.SourceFile.Metadata.Tagging.ScanResult>, spec?: UpsertSpec): ObjList<Genai.SourceFile.Metadata.Tagging.ScanResult> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Genai.SourceFile.Metadata.Tagging.ScanResult>, spec?: UpsertSpec): ObjList<Genai.SourceFile.Metadata.Tagging.ScanResult> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Genai.SourceFile.Metadata.Tagging.ScanResult | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Genai.SourceFile.Metadata.Tagging.ScanResult>): ObjList<Genai.SourceFile.Metadata.Tagging.ScanResult>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<Genai.SourceFile.Metadata.Tagging.ScanResult>): ObjList<Genai.SourceFile.Metadata.Tagging.ScanResult>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Genai.SourceFile.Metadata.Tagging.ScanResult>): ObjList<Genai.SourceFile.Metadata.Tagging.ScanResult>;
     ...
     */
    static afterCreate(objs: Array_Type<Genai.SourceFile.Metadata.Tagging.ScanResult>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Genai.SourceFile.Metadata.Tagging.ScanResult>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Genai.SourceFile.Metadata.Tagging.ScanResult>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Genai.SourceFile.Metadata.Tagging.ScanResult>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Genai.SourceFile.Metadata.Tagging.ScanResult>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.SourceFile.Metadata.Tagging.ScanResult | null;
     ...
     */
    withoutIdentity(): Genai.SourceFile.Metadata.Tagging.ScanResult | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Genai.SourceFile.Metadata.Tagging.ScanResult>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Genai.SourceFile.Metadata.Tagging.ScanResult, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Genai.SourceFile.Metadata.Tagging.ScanResult>, callback?: λFunction<Genai.SourceFile.Metadata.Tagging.ScanResult | null, Genai.SourceFile.Metadata.Tagging.ScanResult | null>): ObjList<Genai.SourceFile.Metadata.Tagging.ScanResult>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Genai.SourceFile.Metadata.Tagging.ScanResult>, callback?: λFunction<Genai.SourceFile.Metadata.Tagging.ScanResult | null, Genai.SourceFile.Metadata.Tagging.ScanResult | null>): Array_Type<ObjError> | null;
