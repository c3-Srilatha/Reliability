// TypeScript definitions for the C3 type Genai.SchemaUpgradeUtil

/**
 * Schema Upgrade utils for types.
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.SchemaUpgradeUtil
 */
declare namespace Genai {
  export interface ISchemaUpgradeUtil {
  }
}
 ...
 */
declare namespace Genai {
  export class SchemaUpgradeUtil extends Obj  {
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.SchemaUpgradeUtil | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.SchemaUpgradeUtil | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.SchemaUpgradeUtil | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.SchemaUpgradeUtil | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.SchemaUpgradeUtil;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.SchemaUpgradeUtil;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.SchemaUpgradeUtil;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.SchemaUpgradeUtil>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.SchemaUpgradeUtil>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.SchemaUpgradeUtil;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.SchemaUpgradeUtil;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.SchemaUpgradeUtil;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.SchemaUpgradeUtil;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.SchemaUpgradeUtil;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.SchemaUpgradeUtil;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.SchemaUpgradeUtil;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.SchemaUpgradeUtil;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.SchemaUpgradeUtil;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.SchemaUpgradeUtil;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.SchemaUpgradeUtil;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.SchemaUpgradeUtil;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.SchemaUpgradeUtil;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.SchemaUpgradeUtil;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.SchemaUpgradeUtil;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.SchemaUpgradeUtil;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.SchemaUpgradeUtil;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.SchemaUpgradeUtil;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.SchemaUpgradeUtil;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.SchemaUpgradeUtil;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.SchemaUpgradeUtil;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.SchemaUpgradeUtil;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.SchemaUpgradeUtil;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.SchemaUpgradeUtil;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.SchemaUpgradeUtil;

    mergeJson(json: any): Genai.SchemaUpgradeUtil;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.SchemaUpgradeUtil;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.SchemaUpgradeUtil;
     ...
     */
    singletonArray(): Array_Type<Genai.SchemaUpgradeUtil>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.SchemaUpgradeUtil> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.SchemaUpgradeUtil> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.SchemaUpgradeUtil>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.SchemaUpgradeUtil> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.SchemaUpgradeUtil> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.SchemaUpgradeUtil> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.SchemaUpgradeUtil>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.SchemaUpgradeUtil>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.SchemaUpgradeUtil;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.SchemaUpgradeUtil;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.SchemaUpgradeUtil;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.SchemaUpgradeUtil;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.SchemaUpgradeUtil;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.SchemaUpgradeUtil;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.SchemaUpgradeUtil;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.SchemaUpgradeUtil;
     ...
     */
    static cachedEmptyInst(): Genai.SchemaUpgradeUtil;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.SchemaUpgradeUtil> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.SchemaUpgradeUtil;
     ...
     */
    static upgradeMultiLingualTemplates_1(includeString?: string): Array_Type<any> | null;
     ...
     */
    static upgradeProjects_2(typesToUpdate?: Array_Type<string>): void;
     ...
     */
    static upgradeProjectsIsTutorial_3(includeString?: string): Array_Type<Genai.Project> | null;
     ...
     */
    static upgradeModelConfigurationTemplates_4(): void;
