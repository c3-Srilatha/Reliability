// TypeScript definitions for the C3 type Genai.Vector.SourcePassage.Cosine

/**
 * A version of Genai.Vector.SourcePassage that uses cosine similarity for nearest neighbor search.
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.Vector.SourcePassage.Cosine
 */
declare namespace Genai.Vector.SourcePassage {
  export interface ICosine {
     ...
     */
    sourcePassage: IGenai.SourcePassage;
  }
}
 ...
 */
declare namespace Genai.Vector.SourcePassage {
  export class Cosine extends Obj  {

    /**
     * The retriever for which this vector was created
     */
    readonly retriever: Genai.Retriever;
    withRetriever(retriever: IGenai.Retriever): Genai.Vector.SourcePassage.Cosine;

    /**
     * The source from which the passage for the embedding was drawn. Used for filtering on source metadata.
     */
    readonly source?: Genai.Source;
    withSource(source: IGenai.Source | null): Genai.Vector.SourcePassage.Cosine;

    /**
     * If true, the vector should not be included in searches.
     */
    readonly inactive?: boolean;
    withInactive(inactive: boolean): Genai.Vector.SourcePassage.Cosine;

    /**
     * The vector embedding.
     */
    readonly emb?: string;
    withEmb(emb: string | null): Genai.Vector.SourcePassage.Cosine;
    ...
    withTypeIdent(typeIdent: string | null): Genai.Vector.SourcePassage.Cosine;
     ...
     */
    readonly id: string;
    withId(id: string): Genai.Vector.SourcePassage.Cosine;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Genai.Vector.SourcePassage.Cosine;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): Genai.Vector.SourcePassage.Cosine;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Genai.Vector.SourcePassage.Cosine;
    ...
    withVersion(version: number | null): Genai.Vector.SourcePassage.Cosine;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Genai.Vector.SourcePassage.Cosine;

    /**
     * The passage whose contents are embedded in the vector.
     */
    readonly sourcePassage: Genai.SourcePassage;
    withSourcePassage(sourcePassage: IGenai.SourcePassage): Genai.Vector.SourcePassage.Cosine;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.Vector.SourcePassage.Cosine | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.Vector.SourcePassage.Cosine | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.Vector.SourcePassage.Cosine | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.Vector.SourcePassage.Cosine | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.Vector.SourcePassage.Cosine;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Vector.SourcePassage.Cosine;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Vector.SourcePassage.Cosine;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Vector.SourcePassage.Cosine>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Vector.SourcePassage.Cosine>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.Vector.SourcePassage.Cosine;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Vector.SourcePassage.Cosine;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Vector.SourcePassage.Cosine;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.Vector.SourcePassage.Cosine;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.Vector.SourcePassage.Cosine;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.Vector.SourcePassage.Cosine;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.Vector.SourcePassage.Cosine;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.Vector.SourcePassage.Cosine;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.Vector.SourcePassage.Cosine;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.Vector.SourcePassage.Cosine;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.Vector.SourcePassage.Cosine;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.Vector.SourcePassage.Cosine;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.Vector.SourcePassage.Cosine;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.Vector.SourcePassage.Cosine;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.Vector.SourcePassage.Cosine;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.Vector.SourcePassage.Cosine;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.Vector.SourcePassage.Cosine;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.Vector.SourcePassage.Cosine;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.Vector.SourcePassage.Cosine;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.Vector.SourcePassage.Cosine;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.Vector.SourcePassage.Cosine;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.Vector.SourcePassage.Cosine;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.Vector.SourcePassage.Cosine;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.Vector.SourcePassage.Cosine;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.Vector.SourcePassage.Cosine;

    mergeJson(json: any): Genai.Vector.SourcePassage.Cosine;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.Vector.SourcePassage.Cosine;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.Vector.SourcePassage.Cosine;
     ...
     */
    singletonArray(): Array_Type<Genai.Vector.SourcePassage.Cosine>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.Vector.SourcePassage.Cosine> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.Vector.SourcePassage.Cosine> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.Vector.SourcePassage.Cosine>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.Vector.SourcePassage.Cosine> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.Vector.SourcePassage.Cosine> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.Vector.SourcePassage.Cosine> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.Vector.SourcePassage.Cosine>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.Vector.SourcePassage.Cosine>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.Vector.SourcePassage.Cosine;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.Vector.SourcePassage.Cosine;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.Vector.SourcePassage.Cosine;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.Vector.SourcePassage.Cosine;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.Vector.SourcePassage.Cosine;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.Vector.SourcePassage.Cosine;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.Vector.SourcePassage.Cosine | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.Vector.SourcePassage.Cosine;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.Vector.SourcePassage.Cosine;
     ...
     */
    static cachedEmptyInst(): Genai.Vector.SourcePassage.Cosine;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.Vector.SourcePassage.Cosine> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.Vector.SourcePassage.Cosine;

    /**
     * Update the #inactive field for the given vectorIds.
     */
    static markVectorsActiveOrInactive(vectorType: Type, vectorIds: Array_Type<string>, inactive?: boolean): void;
     ...
     */
    static formatEmbedding(embeddingArray?: Array_Type<number> | any, vectorDimension?: number): string;
     ...
     */
    static vectorDistanceString(embeddingArray?: Array_Type<number> | any, embeddingFieldName?: string = '\'emb\'', spec?: Expr.DistanceSpec, vectorDimension?: number): string;
     ...
     */
    static scoresFromVectorDistances(distances: Array_Type<number>): Array_Type<number>;
     ...
     */
    static persistEmbeddingVectors(retrieverId: string, documents: Array_Type<any>, corpusEmbeddings?: Array_Type<Array_Type<number>> | Array_Type<any>, markVectorsInactive?: boolean, vectorIds?: Array_Type<string>, otherFieldsDicts?: Array_Type<any>, vectorDimension?: number): void;
     ...
     */
    static persistBatchSize(): number;
     ...
     */
    static filterIdLimit(): number;

    /**
     * The embedding dimension.
     * Derived from the value of the vector annotation.
     */
    static inferEmbSize(): number;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Genai.Vector.SourcePassage.Cosine>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Genai.Vector.SourcePassage.Cosine>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Genai.Vector.SourcePassage.Cosine> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Genai.Vector.SourcePassage.Cosine>> | null;
     ...
     */
    get(include?: string): Genai.Vector.SourcePassage.Cosine | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Genai.Vector.SourcePassage.Cosine | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Genai.Vector.SourcePassage.Cosine;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Genai.Vector.SourcePassage.Cosine | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Genai.Vector.SourcePassage.Cosine;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.Vector.SourcePassage.Cosine | null;
     ...
     */
    create(spec?: UpsertSpec): Genai.Vector.SourcePassage.Cosine | null;
     ...
     */
    static createBatch(objs: Array_Type<Genai.Vector.SourcePassage.Cosine>, spec?: UpsertSpec): ObjList<Genai.Vector.SourcePassage.Cosine> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Genai.Vector.SourcePassage.Cosine>, spec?: CreateBatchObjStreamSpec): ObjList<Genai.Vector.SourcePassage.Cosine> | null;
     ...
     */
    update(srcObj?: Genai.Vector.SourcePassage.Cosine, spec?: UpsertSpec): Genai.Vector.SourcePassage.Cosine | null;
     ...
     */
    upsert(srcObj?: Genai.Vector.SourcePassage.Cosine, spec?: UpsertSpec): Genai.Vector.SourcePassage.Cosine | null;
     ...
     */
    merge(spec?: MergeSpec): Genai.Vector.SourcePassage.Cosine | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Genai.Vector.SourcePassage.Cosine | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Genai.Vector.SourcePassage.Cosine | null;
     ...
     */
    static updateBatch(objs: Array_Type<Genai.Vector.SourcePassage.Cosine>, srcObjs?: Array_Type<Genai.Vector.SourcePassage.Cosine>, spec?: UpsertSpec): ObjList<Genai.Vector.SourcePassage.Cosine> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Genai.Vector.SourcePassage.Cosine> | null>, spec?: UpsertSpec): ObjList<Genai.Vector.SourcePassage.Cosine> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Genai.Vector.SourcePassage.Cosine>, srcObjs?: Array_Type<Genai.Vector.SourcePassage.Cosine>, spec?: UpsertSpec): ObjList<Genai.Vector.SourcePassage.Cosine> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Genai.Vector.SourcePassage.Cosine> | null>, spec?: UpsertSpec): ObjList<Genai.Vector.SourcePassage.Cosine> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Genai.Vector.SourcePassage.Cosine>, spec?: TouchSpec): ObjList<Genai.Vector.SourcePassage.Cosine> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.Vector.SourcePassage.Cosine>, spec?: MergeSpec): ObjList<Genai.Vector.SourcePassage.Cosine> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.Vector.SourcePassage.Cosine>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.Vector.SourcePassage.Cosine> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Genai.Vector.SourcePassage.Cosine> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.Vector.SourcePassage.Cosine> | null;
     ...
     */
    static mergeAll(mergeObj: Genai.Vector.SourcePassage.Cosine, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Genai.Vector.SourcePassage.Cosine, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Genai.Vector.SourcePassage.Cosine>, spec?: UpsertSpec): ObjList<Genai.Vector.SourcePassage.Cosine> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Genai.Vector.SourcePassage.Cosine>, spec?: UpsertSpec): ObjList<Genai.Vector.SourcePassage.Cosine> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Genai.Vector.SourcePassage.Cosine | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Genai.Vector.SourcePassage.Cosine>): ObjList<Genai.Vector.SourcePassage.Cosine>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<Genai.Vector.SourcePassage.Cosine>): ObjList<Genai.Vector.SourcePassage.Cosine>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Genai.Vector.SourcePassage.Cosine>): ObjList<Genai.Vector.SourcePassage.Cosine>;
     ...
     */
    static afterCreate(objs: Array_Type<Genai.Vector.SourcePassage.Cosine>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Genai.Vector.SourcePassage.Cosine>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Genai.Vector.SourcePassage.Cosine>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Genai.Vector.SourcePassage.Cosine>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Genai.Vector.SourcePassage.Cosine>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.Vector.SourcePassage.Cosine | null;
     ...
     */
    withoutIdentity(): Genai.Vector.SourcePassage.Cosine | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Genai.Vector.SourcePassage.Cosine>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Genai.Vector.SourcePassage.Cosine, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Genai.Vector.SourcePassage.Cosine>, callback?: λFunction<Genai.Vector.SourcePassage.Cosine | null, Genai.Vector.SourcePassage.Cosine | null>): ObjList<Genai.Vector.SourcePassage.Cosine>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Genai.Vector.SourcePassage.Cosine>, callback?: λFunction<Genai.Vector.SourcePassage.Cosine | null, Genai.Vector.SourcePassage.Cosine | null>): Array_Type<ObjError> | null;
