// TypeScript definitions for the C3 type Genai.SourceCollection.Metadata.Config

/**
 * Config to define the behavior for implicit filtering for {@link Genai.SourceFile}s in vector store similarity search.
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.SourceCollection.Metadata.Config
 */
declare namespace Genai.SourceCollection.Metadata {
  export interface IConfig {
     ...
     */
    fieldsToInclude?: Array_Type<string> | Array<string>;
  }
}
...
declare namespace Genai.SourceCollection.Metadata {
  export class Config extends Obj  {
    ...
    withConfigOverride(configOverride: string | null): Genai.SourceCollection.Metadata.Config;

    readonly secretOverride?: string;
    withSecretOverride(secretOverride: string | null): Genai.SourceCollection.Metadata.Config;

    /**
     * Captures any issues that occurred while deserializing from filesystem
     */
    readonly issues?: Array_Type<string>;
    withIssues(issues: Array_Type<string> | Array<string> | null): Genai.SourceCollection.Metadata.Config;

    /**
     * The id of this instance.
     */
    readonly id?: string;
    withId(id: string | null): Genai.SourceCollection.Metadata.Config;
    ...
    withEmbedMetadata(embedMetadata: boolean): Genai.SourceCollection.Metadata.Config;

    /**
     * Fields to be included as a part of the vector store embedding.
     * If not specified, all fields in {@link Genai.SourceFile.Metadata} will be included in the embedding.
     */
    readonly fieldsToInclude?: Array_Type<string>;
    withFieldsToInclude(fieldsToInclude: Array_Type<string> | Array<string> | null): Genai.SourceCollection.Metadata.Config;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.SourceCollection.Metadata.Config | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.SourceCollection.Metadata.Config | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.SourceCollection.Metadata.Config | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.SourceCollection.Metadata.Config | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.SourceCollection.Metadata.Config;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.SourceCollection.Metadata.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.SourceCollection.Metadata.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.SourceCollection.Metadata.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.SourceCollection.Metadata.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.SourceCollection.Metadata.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.SourceCollection.Metadata.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.SourceCollection.Metadata.Config;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.SourceCollection.Metadata.Config;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.SourceCollection.Metadata.Config;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.SourceCollection.Metadata.Config;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.SourceCollection.Metadata.Config;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.SourceCollection.Metadata.Config;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.SourceCollection.Metadata.Config;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.SourceCollection.Metadata.Config;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.SourceCollection.Metadata.Config;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.SourceCollection.Metadata.Config;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.SourceCollection.Metadata.Config;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.SourceCollection.Metadata.Config;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.SourceCollection.Metadata.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.SourceCollection.Metadata.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.SourceCollection.Metadata.Config;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.SourceCollection.Metadata.Config;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.SourceCollection.Metadata.Config;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.SourceCollection.Metadata.Config;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.SourceCollection.Metadata.Config;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.SourceCollection.Metadata.Config;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.SourceCollection.Metadata.Config;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.SourceCollection.Metadata.Config;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.SourceCollection.Metadata.Config;

    mergeJson(json: any): Genai.SourceCollection.Metadata.Config;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.SourceCollection.Metadata.Config;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.SourceCollection.Metadata.Config;
     ...
     */
    singletonArray(): Array_Type<Genai.SourceCollection.Metadata.Config>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.SourceCollection.Metadata.Config> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.SourceCollection.Metadata.Config> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.SourceCollection.Metadata.Config>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.SourceCollection.Metadata.Config> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.SourceCollection.Metadata.Config> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.SourceCollection.Metadata.Config> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.SourceCollection.Metadata.Config>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.SourceCollection.Metadata.Config>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.SourceCollection.Metadata.Config;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.SourceCollection.Metadata.Config;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.SourceCollection.Metadata.Config;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.SourceCollection.Metadata.Config;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.SourceCollection.Metadata.Config;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.SourceCollection.Metadata.Config;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.SourceCollection.Metadata.Config | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.SourceCollection.Metadata.Config;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.SourceCollection.Metadata.Config;
     ...
     */
    static cachedEmptyInst(): Genai.SourceCollection.Metadata.Config;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.SourceCollection.Metadata.Config> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.SourceCollection.Metadata.Config;
     ...
     */
    static allCached(): Stream<Genai.SourceCollection.Metadata.Config> | null;
     ...
     */
    static find(filter?: string): Stream<Genai.SourceCollection.Metadata.Config> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<Genai.SourceCollection.Metadata.Config> | null;

    /**
     * @return cached instance.
     */
    getCached(): Genai.SourceCollection.Metadata.Config | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string): Genai.SourceCollection.Metadata.Config | null;
     ...
     */
    static produce(key: string): Genai.SourceCollection.Metadata.Config | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, Genai.SourceCollection.Metadata.Config> | null;
     ...
     */
    getConfig(): Genai.SourceCollection.Metadata.Config;
     ...
     */
    getSecret(): Genai.SourceCollection.Metadata.Config;
     ...
     */
    withConfigKey(configKey: string): Genai.SourceCollection.Metadata.Config;

    /**
     * @return copy without config key.
     */
    withoutConfigKey(): Genai.SourceCollection.Metadata.Config;

    /**
     * @return return cached config instance for provided config key.
     */
    static forConfigKey(configKey: string): Genai.SourceCollection.Metadata.Config | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string>): Stream<Genai.SourceCollection.Metadata.Config> | null;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: Genai.SourceCollection.Metadata.Config, override?: string): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): Genai.SourceCollection.Metadata.Config | null;
     ...
     */
    removeSecrets(): Genai.SourceCollection.Metadata.Config | null;

    /**
     * @return this config with only secret values.
     */
    removeNonSecrets(): Genai.SourceCollection.Metadata.Config | null;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    validate(): Genai.SourceCollection.Metadata.Config;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.SourceCollection.Metadata.Config | null;
  }
}
