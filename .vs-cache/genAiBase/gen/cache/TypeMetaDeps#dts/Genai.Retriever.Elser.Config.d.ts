// TypeScript definitions for the C3 type Genai.Retriever.Elser.Config

/**
 * Config to be used by a {@link Genai.Retriever.Elser}
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.Retriever.Elser.Config
 */
declare namespace Genai.Retriever.Elser {
...
declare namespace Genai.Retriever.Elser {
  export class Config extends Obj  {
    ...
    withName(name: string): Genai.Retriever.Elser.Config;

    readonly configOverride?: string;
    withConfigOverride(configOverride: string | null): Genai.Retriever.Elser.Config;

    readonly secretOverride?: string;
    withSecretOverride(secretOverride: string | null): Genai.Retriever.Elser.Config;

    /**
     * Captures any issues that occurred while deserializing from filesystem
     */
    readonly issues?: Array_Type<string>;
    withIssues(issues: Array_Type<string> | Array<string> | null): Genai.Retriever.Elser.Config;

    /**
     * The apikey to access Elastic API endpoint.
     */
    readonly apikey?: string;
    withApikey(apikey: string | null): Genai.Retriever.Elser.Config;

    /**
     * The URL of the Elasticsearch endpoint.
     */
    readonly url?: string;
    withUrl(url: string | null): Genai.Retriever.Elser.Config;

    /**
     * The ELSER model to use.
     */
    readonly elserModelId?: string;
    withElserModelId(elserModelId: string | null): Genai.Retriever.Elser.Config;

    /**
     * The field to use for the ELSER model
     */
    readonly elserModelField?: string;
    withElserModelField(elserModelField: string | null): Genai.Retriever.Elser.Config;
     ...
     * {@link https://elasticsearch-py.readthedocs.io/en/v8.14.0/api/elasticsearch.html#elasticsearch}
     */
    readonly additionalClientParams?: any;
    withAdditionalClientParams(additionalClientParams: any | null): Genai.Retriever.Elser.Config;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.Retriever.Elser.Config | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.Retriever.Elser.Config | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.Retriever.Elser.Config | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.Retriever.Elser.Config | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.Retriever.Elser.Config;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Retriever.Elser.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Retriever.Elser.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Retriever.Elser.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Retriever.Elser.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.Retriever.Elser.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Retriever.Elser.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Retriever.Elser.Config;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.Retriever.Elser.Config;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.Retriever.Elser.Config;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.Retriever.Elser.Config;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.Retriever.Elser.Config;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.Retriever.Elser.Config;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.Retriever.Elser.Config;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.Retriever.Elser.Config;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.Retriever.Elser.Config;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.Retriever.Elser.Config;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.Retriever.Elser.Config;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.Retriever.Elser.Config;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.Retriever.Elser.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.Retriever.Elser.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.Retriever.Elser.Config;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.Retriever.Elser.Config;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.Retriever.Elser.Config;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.Retriever.Elser.Config;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.Retriever.Elser.Config;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.Retriever.Elser.Config;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.Retriever.Elser.Config;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.Retriever.Elser.Config;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.Retriever.Elser.Config;

    mergeJson(json: any): Genai.Retriever.Elser.Config;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.Retriever.Elser.Config;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.Retriever.Elser.Config;
     ...
     */
    singletonArray(): Array_Type<Genai.Retriever.Elser.Config>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.Retriever.Elser.Config> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.Retriever.Elser.Config> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.Retriever.Elser.Config>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.Retriever.Elser.Config> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.Retriever.Elser.Config> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.Retriever.Elser.Config> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.Retriever.Elser.Config>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.Retriever.Elser.Config>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.Retriever.Elser.Config;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.Retriever.Elser.Config;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.Retriever.Elser.Config;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.Retriever.Elser.Config;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.Retriever.Elser.Config;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.Retriever.Elser.Config;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.Retriever.Elser.Config | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.Retriever.Elser.Config;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.Retriever.Elser.Config;
     ...
     */
    static cachedEmptyInst(): Genai.Retriever.Elser.Config;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.Retriever.Elser.Config> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.Retriever.Elser.Config;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.Retriever.Elser.Config | null;
     ...
     */
    static forName(name: string, failIfMissing?: boolean): Genai.Retriever.Elser.Config | null;
     ...
     */
    static allCached(): Stream<Genai.Retriever.Elser.Config> | null;
     ...
     */
    static find(filter?: string): Stream<Genai.Retriever.Elser.Config> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<Genai.Retriever.Elser.Config> | null;

    /**
     * @return cached instance.
     */
    getCached(): Genai.Retriever.Elser.Config | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string): Genai.Retriever.Elser.Config | null;
     ...
     */
    static produce(key: string): Genai.Retriever.Elser.Config | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, Genai.Retriever.Elser.Config> | null;
     ...
     */
    getConfig(): Genai.Retriever.Elser.Config;
     ...
     */
    getSecret(): Genai.Retriever.Elser.Config;
     ...
     */
    withConfigKey(configKey: string): Genai.Retriever.Elser.Config;

    /**
     * @return copy without config key.
     */
    withoutConfigKey(): Genai.Retriever.Elser.Config;

    /**
     * @return return cached config instance for provided config key.
     */
    static forConfigKey(configKey: string): Genai.Retriever.Elser.Config | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string>): Stream<Genai.Retriever.Elser.Config> | null;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: Genai.Retriever.Elser.Config, override?: string): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): Genai.Retriever.Elser.Config | null;
