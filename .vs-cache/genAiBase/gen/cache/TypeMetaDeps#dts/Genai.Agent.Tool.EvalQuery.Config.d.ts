// TypeScript definitions for the C3 type Genai.Agent.Tool.EvalQuery.Config

/**
 * Config for {@link Genai.Agent.Tool.EvalQuery}
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.Agent.Tool.EvalQuery.Config
 */
declare namespace Genai.Agent.Tool.EvalQuery {
  export interface IConfig {
     ...
     */
    specGenerationModelSpec: IGenai.Agent.Tool.Util.EvalQuery.SpecGenerationModel.Spec;

    /**
     * Spec to instantiate the {@link Genai.Agent.Tool.Util.TableAnsweringModel}.
     */
    tableAnsweringModelSpec: IGenai.Agent.Tool.Util.TableAnsweringModel.Spec;

    /**
     * Spec to instantiate the {@link Genai.Agent.Tool.Util.EvalQuery.SpecProcessor}.
     */
    specProcessorSpec?: IGenai.Agent.Tool.Util.EvalQuery.SpecProcessor.Spec;
...
declare namespace Genai.Agent.Tool.EvalQuery {
  export class Config extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): Genai.Agent.Tool.EvalQuery.Config;
    ...
    withConfigOverride(configOverride: string | null): Genai.Agent.Tool.EvalQuery.Config;

    static readonly configOverride?: string;

    readonly secretOverride?: string;
    withSecretOverride(secretOverride: string | null): Genai.Agent.Tool.EvalQuery.Config;
    ...
    withIssues(issues: Array_Type<string> | Array<string> | null): Genai.Agent.Tool.EvalQuery.Config;
    ...
    withToolName(toolName: string): Genai.Agent.Tool.EvalQuery.Config;
    ...
    withToolDescription(toolDescription: string): Genai.Agent.Tool.EvalQuery.Config;
    ...
    withFormattingMessage(formattingMessage: string | null): Genai.Agent.Tool.EvalQuery.Config;
    ...
    withExamples(examples: Array_Type<Genai.Agent.Tool.Example> | Array<IGenai.Agent.Tool.Example> | null): Genai.Agent.Tool.EvalQuery.Config;
    ...
    withUiOptions(uiOptions: IGenai.Agent.Tool.Config.UiOptions | null): Genai.Agent.Tool.EvalQuery.Config;
    ...
    withOverrideRuntimeKwargs(overrideRuntimeKwargs: any | null): Genai.Agent.Tool.EvalQuery.Config;
    ...
    withDescriptionForMultiTool(descriptionForMultiTool: string | null): Genai.Agent.Tool.EvalQuery.Config;
    ...
    withRetrievedDataDescription(retrievedDataDescription: Array_Type<string> | Array<string> | null): Genai.Agent.Tool.EvalQuery.Config;
    ...
    withFormatDataPrompt(formatDataPrompt: IGenai.Prompt | null): Genai.Agent.Tool.EvalQuery.Config;
     ...
     * Whether the {@link Genai.Agent.Tool.EvalQuery}'s modules should be initialized.
     */
    readonly doNotInitialize?: boolean;
    withDoNotInitialize(doNotInitialize: boolean): Genai.Agent.Tool.EvalQuery.Config;

    /**
     * Whether the {@link Genai.Agent.Tool.EvalQuery}'s modules should be initialized.
     */
    static readonly doNotInitialize?: boolean;

    /**
     * The data model graph that the tool should use
     */
    readonly dataModelGraph: Genai.StructuredData.DataModelGraph;
    withDataModelGraph(dataModelGraph: IGenai.StructuredData.DataModelGraph): Genai.Agent.Tool.EvalQuery.Config;

    /**
     * The data model graph that the tool should use
     */
    static readonly dataModelGraph: Genai.StructuredData.DataModelGraph;

    /**
     * Spec containing the relevant arguments for the eval spec generation mode.
     */
    readonly specGenerationModelSpec: Genai.Agent.Tool.Util.EvalQuery.SpecGenerationModel.Spec;
    withSpecGenerationModelSpec(specGenerationModelSpec: IGenai.Agent.Tool.Util.EvalQuery.SpecGenerationModel.Spec): Genai.Agent.Tool.EvalQuery.Config;

    /**
     * Spec containing the relevant arguments for the eval spec generation mode.
     */
    static readonly specGenerationModelSpec: Genai.Agent.Tool.Util.EvalQuery.SpecGenerationModel.Spec;

    /**
     * Spec to instantiate the {@link Genai.Agent.Tool.Util.TableAnsweringModel}.
     */
    readonly tableAnsweringModelSpec: Genai.Agent.Tool.Util.TableAnsweringModel.Spec;
    withTableAnsweringModelSpec(tableAnsweringModelSpec: IGenai.Agent.Tool.Util.TableAnsweringModel.Spec): Genai.Agent.Tool.EvalQuery.Config;

    /**
     * Spec to instantiate the {@link Genai.Agent.Tool.Util.TableAnsweringModel}.
     */
    static readonly tableAnsweringModelSpec: Genai.Agent.Tool.Util.TableAnsweringModel.Spec;

    /**
     * Spec to instantiate the {@link Genai.Agent.Tool.Util.EvalQuery.SpecProcessor}.
     */
    readonly specProcessorSpec?: Genai.Agent.Tool.Util.EvalQuery.SpecProcessor.Spec;
    withSpecProcessorSpec(specProcessorSpec: IGenai.Agent.Tool.Util.EvalQuery.SpecProcessor.Spec | null): Genai.Agent.Tool.EvalQuery.Config;

    /**
     * Spec to instantiate the {@link Genai.Agent.Tool.Util.EvalQuery.SpecProcessor}.
     */
    static readonly specProcessorSpec?: Genai.Agent.Tool.Util.EvalQuery.SpecProcessor.Spec;
    ...
    withFuzzyMatcherSpec(fuzzyMatcherSpec: IGenai.Agent.Tool.Util.StringFuzzyMatcher.InitializationSpec | null): Genai.Agent.Tool.EvalQuery.Config;
     ...
     * they must be consistent.
     */
    static readonly fuzzyMatcherSpec?: Genai.Agent.Tool.Util.StringFuzzyMatcher.InitializationSpec;
     ...
     */
    static inst(): Genai.Agent.Tool.EvalQuery.Config;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.Agent.Tool.EvalQuery.Config | null;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.Agent.Tool.EvalQuery.Config | null;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.Agent.Tool.EvalQuery.Config;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.Agent.Tool.EvalQuery.Config;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.Agent.Tool.EvalQuery.Config;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.Agent.Tool.EvalQuery.Config;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.Agent.Tool.EvalQuery.Config | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.Agent.Tool.EvalQuery.Config | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.Agent.Tool.EvalQuery.Config | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.Agent.Tool.EvalQuery.Config | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.Agent.Tool.EvalQuery.Config;
     ...
     * This method is used during live metadata update
     */
    static replaceType(old: Type, new_: Type): Genai.Agent.Tool.EvalQuery.Config;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Agent.Tool.EvalQuery.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Agent.Tool.EvalQuery.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Agent.Tool.EvalQuery.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Agent.Tool.EvalQuery.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Agent.Tool.EvalQuery.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Agent.Tool.EvalQuery.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Agent.Tool.EvalQuery.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Agent.Tool.EvalQuery.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.Agent.Tool.EvalQuery.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.Agent.Tool.EvalQuery.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Agent.Tool.EvalQuery.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Agent.Tool.EvalQuery.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Agent.Tool.EvalQuery.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Agent.Tool.EvalQuery.Config;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.Agent.Tool.EvalQuery.Config;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    static validateObj(): Genai.Agent.Tool.EvalQuery.Config;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.Agent.Tool.EvalQuery.Config;
     ...
     * @see #defaultField
     */
    static withField(field: string, value: any, doNotConvert?: boolean): Genai.Agent.Tool.EvalQuery.Config;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.Agent.Tool.EvalQuery.Config;
     ...
     * @see #defaultField
     */
    static withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.Agent.Tool.EvalQuery.Config;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.Agent.Tool.EvalQuery.Config;
     ...
     * @return new Obj
     */
    static withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.Agent.Tool.EvalQuery.Config;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.Agent.Tool.EvalQuery.Config;
     ...
     * @return new Obj
     */
    static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.Agent.Tool.EvalQuery.Config;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.Agent.Tool.EvalQuery.Config;
     ...
     * @see #withoutField
     */
    static withoutFieldAtPath(path: string): Genai.Agent.Tool.EvalQuery.Config;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.Agent.Tool.EvalQuery.Config;
     ...
     * @see #removeField
     */
    static withoutField(field: string): Genai.Agent.Tool.EvalQuery.Config;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.Agent.Tool.EvalQuery.Config;
     ...
     * @see #removeField
     */
    static withoutField(field: FieldType): Genai.Agent.Tool.EvalQuery.Config;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.Agent.Tool.EvalQuery.Config;
     ...
     * @return new Obj with removed fields
     */
    static withoutFields(fields: Array_Type<string>): Genai.Agent.Tool.EvalQuery.Config;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.Agent.Tool.EvalQuery.Config;
     ...
     * @return new Obj with removed fields
     */
    static withoutFieldsByType(fields: Array_Type<FieldType>): Genai.Agent.Tool.EvalQuery.Config;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.Agent.Tool.EvalQuery.Config;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    static withoutSecretFields(): Genai.Agent.Tool.EvalQuery.Config;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.Agent.Tool.EvalQuery.Config;
     ...
     * @see FieldType#defaultValue
     */
    static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.Agent.Tool.EvalQuery.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.Agent.Tool.EvalQuery.Config;
     ...
     * @see #unsetField
     */
    static defaultField(field: string): Genai.Agent.Tool.EvalQuery.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.Agent.Tool.EvalQuery.Config;
     ...
     * @see #unsetField
     */
    static defaultField(field: FieldType): Genai.Agent.Tool.EvalQuery.Config;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.Agent.Tool.EvalQuery.Config;
     ...
     * @see #removeField
     */
    static unsetField(field: string): Genai.Agent.Tool.EvalQuery.Config;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.Agent.Tool.EvalQuery.Config;
     ...
     * @see #removeField
     */
    static unsetField(field: FieldType): Genai.Agent.Tool.EvalQuery.Config;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.Agent.Tool.EvalQuery.Config;
     ...
     * @see #unsetField
     */
    static removeField(field: string): Genai.Agent.Tool.EvalQuery.Config;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.Agent.Tool.EvalQuery.Config;
     ...
     * @see #unsetField
     */
    static removeField(field: FieldType): Genai.Agent.Tool.EvalQuery.Config;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.Agent.Tool.EvalQuery.Config;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.Agent.Tool.EvalQuery.Config;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.Agent.Tool.EvalQuery.Config;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj, otherFieldsFilter: Type): Genai.Agent.Tool.EvalQuery.Config;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.Agent.Tool.EvalQuery.Config;
     ...
     *        the same key or index.
     */
    static mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.Agent.Tool.EvalQuery.Config;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.Agent.Tool.EvalQuery.Config;
     ...
     * traverse child reference and collection fields.
     */
    static mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.Agent.Tool.EvalQuery.Config;

    mergeJson(json: any): Genai.Agent.Tool.EvalQuery.Config;

    static mergeJson(json: any): Genai.Agent.Tool.EvalQuery.Config;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.Agent.Tool.EvalQuery.Config;
     ...
     * @return Obj with child references merged
     */
    static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.Agent.Tool.EvalQuery.Config;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.Agent.Tool.EvalQuery.Config;
     ...
     * references with same name and collection elements at same index or key.
     */
    static sumObj(other: Obj, deep?: boolean): Genai.Agent.Tool.EvalQuery.Config;
     ...
     */
    singletonArray(): Array_Type<Genai.Agent.Tool.EvalQuery.Config>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonArray(): Array_Type<Genai.Agent.Tool.EvalQuery.Config>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.Agent.Tool.EvalQuery.Config> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.Agent.Tool.EvalQuery.Config> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.Agent.Tool.EvalQuery.Config>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonSet(): Set_Type<Genai.Agent.Tool.EvalQuery.Config>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.Agent.Tool.EvalQuery.Config> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.Agent.Tool.EvalQuery.Config> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.Agent.Tool.EvalQuery.Config> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.Agent.Tool.EvalQuery.Config>;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    static toBuilder(): ObjBuilder<Genai.Agent.Tool.EvalQuery.Config>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.Agent.Tool.EvalQuery.Config>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.Agent.Tool.EvalQuery.Config;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.Agent.Tool.EvalQuery.Config;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.Agent.Tool.EvalQuery.Config;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.Agent.Tool.EvalQuery.Config;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    static afterMake(): Genai.Agent.Tool.EvalQuery.Config;
     ...
     */
    static cachedEmptyInst(): Genai.Agent.Tool.EvalQuery.Config;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.Agent.Tool.EvalQuery.Config> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.Agent.Tool.EvalQuery.Config;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.Agent.Tool.EvalQuery.Config | null;
     ...
     */
    static allCached(): Stream<Genai.Agent.Tool.EvalQuery.Config> | null;
     ...
     */
    static find(filter?: string): Stream<Genai.Agent.Tool.EvalQuery.Config> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<Genai.Agent.Tool.EvalQuery.Config> | null;

    /**
     * @return cached instance.
     */
    getCached(): Genai.Agent.Tool.EvalQuery.Config | null;

    /**
     * @return cached instance.
     */
    static getCached(): Genai.Agent.Tool.EvalQuery.Config | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string): Genai.Agent.Tool.EvalQuery.Config | null;
     ...
     */
    static produce(key: string): Genai.Agent.Tool.EvalQuery.Config | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, Genai.Agent.Tool.EvalQuery.Config> | null;
     ...
     */
    getConfig(): Genai.Agent.Tool.EvalQuery.Config;
     ...
     * Note that typical pattern is to use Configurable#config instead of this method.
     */
    static getConfig(): Genai.Agent.Tool.EvalQuery.Config;
     ...
     */
    getSecret(): Genai.Agent.Tool.EvalQuery.Config;
     ...
     * Note that typical pattern is to use Configurable#configWithSecrets instead of this method.
     */
    static getSecret(): Genai.Agent.Tool.EvalQuery.Config;
     ...
     */
    withConfigKey(configKey: string): Genai.Agent.Tool.EvalQuery.Config;
     ...
     *     config.configKey() => "folder1/abc"
     */
    static withConfigKey(configKey: string): Genai.Agent.Tool.EvalQuery.Config;

    /**
     * @return copy without config key.
     */
    withoutConfigKey(): Genai.Agent.Tool.EvalQuery.Config;

    /**
     * @return copy without config key.
     */
    static withoutConfigKey(): Genai.Agent.Tool.EvalQuery.Config;

    /**
     * @return return cached config instance for provided config key.
     */
    static forConfigKey(configKey: string): Genai.Agent.Tool.EvalQuery.Config | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string>): Stream<Genai.Agent.Tool.EvalQuery.Config> | null;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: Genai.Agent.Tool.EvalQuery.Config, override?: string): void;
     ...
     * @see setConfigValue
     */
    static setConfigValues(from: Genai.Agent.Tool.EvalQuery.Config, override?: string): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): Genai.Agent.Tool.EvalQuery.Config | null;
     ...
     */
    removeSecrets(): Genai.Agent.Tool.EvalQuery.Config | null;

    /**
     * @return this config without any secret values.
     */
    static removeSecrets(): Genai.Agent.Tool.EvalQuery.Config | null;

    /**
     * @return this config with only secret values.
     */
    removeNonSecrets(): Genai.Agent.Tool.EvalQuery.Config | null;

    /**
     * @return this config with only secret values.
     */
    static removeNonSecrets(): Genai.Agent.Tool.EvalQuery.Config | null;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    validate(): Genai.Agent.Tool.EvalQuery.Config;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    static validate(): Genai.Agent.Tool.EvalQuery.Config;
     ...
     */
    updateDataModelGraph(whiteListedDataModel?: any): Genai.StructuredData.DataModelGraph;
     ...
     * @return The updated data model graph.
     */
    static updateDataModelGraph(whiteListedDataModel?: any): Genai.StructuredData.DataModelGraph;
  }
}
