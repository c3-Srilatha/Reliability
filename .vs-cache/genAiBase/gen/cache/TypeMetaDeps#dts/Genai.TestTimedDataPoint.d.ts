// TypeScript definitions for the C3 type Genai.TestTimedDataPoint
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.TestTimedDataPoint
 */
declare namespace Genai {
  export interface ITestTimedDataPoint {
    ...
    parent: IGenai.TestTimedDataHeader;
 ...
 */
declare namespace Genai {
  export class TestTimedDataPoint extends Obj  {

    /**
     * start date for the data point
     */
    readonly start: DateTime;
    withStart(start: DateTime | Date | string): Genai.TestTimedDataPoint;
    ...
    withOutlierCode(outlierCode: number | null): Genai.TestTimedDataPoint;

    /**
     * (Optional) any comments for the data point
     */
    readonly comments?: string;
    withComments(comments: string | null): Genai.TestTimedDataPoint;

    /**
     * Denotes if the value is an actual value or an estimated value. default = null (actual value)
     */
    readonly isEstimated?: boolean;
    withIsEstimated(isEstimated: boolean): Genai.TestTimedDataPoint;
    ...
    withDataVersion(dataVersion: number | null): Genai.TestTimedDataPoint;

    /**
     * Customer specific status code for the data point (may be used to denote data quality)
     */
    readonly statusCode?: string;
    withStatusCode(statusCode: string | null): Genai.TestTimedDataPoint;

    /**
     * Partition key Bin separator used to separate partition key from bin id
     */
    readonly PK_BIN_SEPARATOR?: string;
    withPK_BIN_SEPARATOR(PK_BIN_SEPARATOR: string | null): Genai.TestTimedDataPoint;

    readonly parent: Genai.TestTimedDataHeader;
    withParent(parent: IGenai.TestTimedDataHeader): Genai.TestTimedDataPoint;
     ...
     */
    readonly id: string;
    withId(id: string): Genai.TestTimedDataPoint;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Genai.TestTimedDataPoint;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): Genai.TestTimedDataPoint;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Genai.TestTimedDataPoint;
    ...
    withVersion(version: number | null): Genai.TestTimedDataPoint;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Genai.TestTimedDataPoint;

    /**
     * The value at a given point in time.
     */
    readonly value?: number;
    withValue(value: number | null): Genai.TestTimedDataPoint;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.TestTimedDataPoint | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.TestTimedDataPoint | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.TestTimedDataPoint | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.TestTimedDataPoint | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.TestTimedDataPoint;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.TestTimedDataPoint;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.TestTimedDataPoint;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.TestTimedDataPoint>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.TestTimedDataPoint>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.TestTimedDataPoint;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.TestTimedDataPoint;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.TestTimedDataPoint;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.TestTimedDataPoint;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.TestTimedDataPoint;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.TestTimedDataPoint;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.TestTimedDataPoint;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.TestTimedDataPoint;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.TestTimedDataPoint;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.TestTimedDataPoint;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.TestTimedDataPoint;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.TestTimedDataPoint;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.TestTimedDataPoint;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.TestTimedDataPoint;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.TestTimedDataPoint;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.TestTimedDataPoint;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.TestTimedDataPoint;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.TestTimedDataPoint;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.TestTimedDataPoint;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.TestTimedDataPoint;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.TestTimedDataPoint;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.TestTimedDataPoint;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.TestTimedDataPoint;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.TestTimedDataPoint;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.TestTimedDataPoint;

    mergeJson(json: any): Genai.TestTimedDataPoint;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.TestTimedDataPoint;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.TestTimedDataPoint;
     ...
     */
    singletonArray(): Array_Type<Genai.TestTimedDataPoint>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.TestTimedDataPoint> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.TestTimedDataPoint> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.TestTimedDataPoint>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.TestTimedDataPoint> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.TestTimedDataPoint> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.TestTimedDataPoint> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.TestTimedDataPoint>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.TestTimedDataPoint>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.TestTimedDataPoint;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.TestTimedDataPoint;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.TestTimedDataPoint;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.TestTimedDataPoint;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.TestTimedDataPoint;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.TestTimedDataPoint;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.TestTimedDataPoint | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.TestTimedDataPoint;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.TestTimedDataPoint;
     ...
     */
    static cachedEmptyInst(): Genai.TestTimedDataPoint;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.TestTimedDataPoint> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.TestTimedDataPoint;

    /**
     * Extract the partition key from the given obj
     */
    partitionKey(failIfMissing?: boolean): Genai.TestTimedDataHeader | null;
     ...
     */
    static partition(objs?: Stream<Genai.TestTimedDataPoint>, spec?: PartitionBucketStrategy): Map_Type<string, KvDataPartition> | null;
     ...
     */
    static fromPartitions(partitions?: Stream<KvDataPartition>): Stream<Genai.TestTimedDataPoint> | null;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Genai.TestTimedDataPoint>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Genai.TestTimedDataPoint>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Genai.TestTimedDataPoint> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Genai.TestTimedDataPoint>> | null;
     ...
     */
    get(include?: string): Genai.TestTimedDataPoint | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Genai.TestTimedDataPoint | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Genai.TestTimedDataPoint;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Genai.TestTimedDataPoint | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Genai.TestTimedDataPoint;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.TestTimedDataPoint | null;
     ...
     */
    create(spec?: UpsertSpec): Genai.TestTimedDataPoint | null;
     ...
     */
    static createBatch(objs: Array_Type<Genai.TestTimedDataPoint>, spec?: UpsertSpec): ObjList<Genai.TestTimedDataPoint> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Genai.TestTimedDataPoint>, spec?: CreateBatchObjStreamSpec): ObjList<Genai.TestTimedDataPoint> | null;
     ...
     */
    update(srcObj?: Genai.TestTimedDataPoint, spec?: UpsertSpec): Genai.TestTimedDataPoint | null;
     ...
     */
    upsert(srcObj?: Genai.TestTimedDataPoint, spec?: UpsertSpec): Genai.TestTimedDataPoint | null;
     ...
     */
    merge(spec?: MergeSpec): Genai.TestTimedDataPoint | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Genai.TestTimedDataPoint | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Genai.TestTimedDataPoint | null;
     ...
     */
    static updateBatch(objs: Array_Type<Genai.TestTimedDataPoint>, srcObjs?: Array_Type<Genai.TestTimedDataPoint>, spec?: UpsertSpec): ObjList<Genai.TestTimedDataPoint> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Genai.TestTimedDataPoint> | null>, spec?: UpsertSpec): ObjList<Genai.TestTimedDataPoint> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Genai.TestTimedDataPoint>, srcObjs?: Array_Type<Genai.TestTimedDataPoint>, spec?: UpsertSpec): ObjList<Genai.TestTimedDataPoint> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Genai.TestTimedDataPoint> | null>, spec?: UpsertSpec): ObjList<Genai.TestTimedDataPoint> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Genai.TestTimedDataPoint>, spec?: TouchSpec): ObjList<Genai.TestTimedDataPoint> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.TestTimedDataPoint>, spec?: MergeSpec): ObjList<Genai.TestTimedDataPoint> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.TestTimedDataPoint>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.TestTimedDataPoint> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Genai.TestTimedDataPoint> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.TestTimedDataPoint> | null;
     ...
     */
    static mergeAll(mergeObj: Genai.TestTimedDataPoint, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Genai.TestTimedDataPoint, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Genai.TestTimedDataPoint>, spec?: UpsertSpec): ObjList<Genai.TestTimedDataPoint> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Genai.TestTimedDataPoint>, spec?: UpsertSpec): ObjList<Genai.TestTimedDataPoint> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Genai.TestTimedDataPoint | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Genai.TestTimedDataPoint>): ObjList<Genai.TestTimedDataPoint>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<Genai.TestTimedDataPoint>): ObjList<Genai.TestTimedDataPoint>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Genai.TestTimedDataPoint>): ObjList<Genai.TestTimedDataPoint>;
     ...
     */
    static afterCreate(objs: Array_Type<Genai.TestTimedDataPoint>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Genai.TestTimedDataPoint>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Genai.TestTimedDataPoint>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Genai.TestTimedDataPoint>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Genai.TestTimedDataPoint>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.TestTimedDataPoint | null;
     ...
     */
    withoutIdentity(): Genai.TestTimedDataPoint | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Genai.TestTimedDataPoint>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Genai.TestTimedDataPoint, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Genai.TestTimedDataPoint>, callback?: λFunction<Genai.TestTimedDataPoint | null, Genai.TestTimedDataPoint | null>): ObjList<Genai.TestTimedDataPoint>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Genai.TestTimedDataPoint>, callback?: λFunction<Genai.TestTimedDataPoint | null, Genai.TestTimedDataPoint | null>): Array_Type<ObjError> | null;
