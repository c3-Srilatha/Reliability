// TypeScript definitions for the C3 type Genai.Agent.Toolkit

/**
 * Non-persistable type with information about the sub-tools or sub-toolkits available to the {@link Genai.Agent}
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.Agent.Toolkit
 */
declare namespace Genai.Agent {
  export interface IToolkit {
    ...
    /**
     * Brief, human-readable description of the toolkit
     */
    description?: string;

    /**
     * The {@link Genai.Agent.Tool} that are available as part of this toolkit.
     */
    tools: Array_Type<Genai.Agent.Tool<any>> | Array<IGenai.Agent.Tool<any>>;

    /**
     * The child toolkits part of this toolkit. Including a toolkit makes all of that toolkits tools
     * available to this toolkit.
     */
    toolkits?: Array_Type<Genai.Agent.Toolkit> | Array<IGenai.Agent.Toolkit>;
  }
}
 ...
 * Non-persistable type with information about the sub-tools or sub-toolkits available to the {@link Genai.Agent}
 *
 * @remarks this represents a made instance of Genai.Agent.Toolkit
 */
declare namespace Genai.Agent {
  export class Toolkit extends Obj  {
    ...
    withName(name: string): Genai.Agent.Toolkit;

    readonly configOverride?: string;
    withConfigOverride(configOverride: string | null): Genai.Agent.Toolkit;

    readonly secretOverride?: string;
    withSecretOverride(secretOverride: string | null): Genai.Agent.Toolkit;

    /**
     * Captures any issues that occurred while deserializing from filesystem
     */
    readonly issues?: Array_Type<string>;
    withIssues(issues: Array_Type<string> | Array<string> | null): Genai.Agent.Toolkit;

    /**
     * Brief, human-readable description of the toolkit
     */
    readonly description?: string;
    withDescription(description: string | null): Genai.Agent.Toolkit;

    /**
     * The {@link Genai.Agent.Tool} that are available as part of this toolkit.
     */
    readonly tools: Array_Type<Genai.Agent.Tool<any>>;
    withTools(tools: Array_Type<Genai.Agent.Tool<any>> | Array<IGenai.Agent.Tool<any>>): Genai.Agent.Toolkit;

    /**
     * The child toolkits part of this toolkit. Including a toolkit makes all of that toolkits tools
     * available to this toolkit.
     */
    readonly toolkits?: Array_Type<Genai.Agent.Toolkit>;
    withToolkits(toolkits: Array_Type<Genai.Agent.Toolkit> | Array<IGenai.Agent.Toolkit> | null): Genai.Agent.Toolkit;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.Agent.Toolkit | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.Agent.Toolkit | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.Agent.Toolkit | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.Agent.Toolkit | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.Agent.Toolkit;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Agent.Toolkit;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Agent.Toolkit;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Agent.Toolkit>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Agent.Toolkit>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.Agent.Toolkit;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Agent.Toolkit;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Agent.Toolkit;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.Agent.Toolkit;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.Agent.Toolkit;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.Agent.Toolkit;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.Agent.Toolkit;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.Agent.Toolkit;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.Agent.Toolkit;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.Agent.Toolkit;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.Agent.Toolkit;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.Agent.Toolkit;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.Agent.Toolkit;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.Agent.Toolkit;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.Agent.Toolkit;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.Agent.Toolkit;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.Agent.Toolkit;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.Agent.Toolkit;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.Agent.Toolkit;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.Agent.Toolkit;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.Agent.Toolkit;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.Agent.Toolkit;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.Agent.Toolkit;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.Agent.Toolkit;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.Agent.Toolkit;

    mergeJson(json: any): Genai.Agent.Toolkit;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.Agent.Toolkit;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.Agent.Toolkit;
     ...
     */
    singletonArray(): Array_Type<Genai.Agent.Toolkit>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.Agent.Toolkit> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.Agent.Toolkit> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.Agent.Toolkit>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.Agent.Toolkit> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.Agent.Toolkit> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.Agent.Toolkit> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.Agent.Toolkit>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.Agent.Toolkit>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.Agent.Toolkit;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.Agent.Toolkit;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.Agent.Toolkit;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.Agent.Toolkit;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.Agent.Toolkit;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.Agent.Toolkit;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.Agent.Toolkit | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.Agent.Toolkit;
     ...
     */
    static cachedEmptyInst(): Genai.Agent.Toolkit;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.Agent.Toolkit> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.Agent.Toolkit;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.Agent.Toolkit | null;

    /**
     * Returns the ToolKit for the specified name
     */
    static forName(name: string, failIfMissing?: boolean): Genai.Agent.Toolkit | null;
     ...
     */
    static allCached(): Stream<Genai.Agent.Toolkit> | null;
     ...
     */
    static find(filter?: string): Stream<Genai.Agent.Toolkit> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<Genai.Agent.Toolkit> | null;

    /**
     * @return cached instance.
     */
    getCached(): Genai.Agent.Toolkit | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string): Genai.Agent.Toolkit | null;
     ...
     */
    static produce(key: string): Genai.Agent.Toolkit | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, Genai.Agent.Toolkit> | null;
     ...
     */
    withConfigKey(configKey: string): Genai.Agent.Toolkit;

    /**
     * @return copy without config key.
     */
    withoutConfigKey(): Genai.Agent.Toolkit;

    /**
     * @return return cached config instance for provided config key.
     */
    static forConfigKey(configKey: string): Genai.Agent.Toolkit | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string>): Stream<Genai.Agent.Toolkit> | null;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: Genai.Agent.Toolkit, override?: string): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): Genai.Agent.Toolkit | null;
    ...
    /**
     * Generate string representation of the toolkit by concatenating descriptions of individual tools.
     */
    descriptionForAgent(): Array_Type<Genai.Agent.Tool.Description> | null;

    /**
     * A flattened list of all {@link Genai.Agent.Tool} from the tools and toolkits in #tools.
     */
    allTools(): Array_Type<Genai.Agent.Tool<any>>;

    /**
     * Returns whether this toolkit contains a {@link Genai.Agent.Tool.UnstructuredDataQuery}.
     */
