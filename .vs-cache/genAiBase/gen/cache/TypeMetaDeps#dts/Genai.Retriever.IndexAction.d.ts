// TypeScript definitions for the C3 type Genai.Retriever.IndexAction

/**
 * Mapping between a Retriever and all of the index actions run via AsyncAction
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.Retriever.IndexAction
 */
declare namespace Genai.Retriever {
  export interface IIndexAction {
     ...
     */
    asyncActionSpec: IAsyncActionSpec;
 ...
 * Mapping between a Retriever and all of the index actions run via AsyncAction
 *
 * @remarks this represents a made instance of Genai.Retriever.IndexAction
 */
declare namespace Genai.Retriever {
  export class IndexAction extends Obj  {
    ...
    withTypeIdent(typeIdent: string | null): Genai.Retriever.IndexAction;
     ...
     */
    readonly id: string;
    withId(id: string): Genai.Retriever.IndexAction;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Genai.Retriever.IndexAction;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): Genai.Retriever.IndexAction;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Genai.Retriever.IndexAction;
    ...
    withVersion(version: number | null): Genai.Retriever.IndexAction;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Genai.Retriever.IndexAction;

    /**
     * The Retriever for which the action was created.
     */
    readonly retriever: Genai.Retriever;
    withRetriever(retriever: IGenai.Retriever): Genai.Retriever.IndexAction;

    /**
     * The AsyncAction
     */
    readonly asyncAction: AsyncAction;
    withAsyncAction(asyncAction: IAsyncAction): Genai.Retriever.IndexAction;

    /**
     * The {@link AsyncActionSpec}, necessary for submitting the action for the first time.
     */
    readonly asyncActionSpec: AsyncActionSpec;
    withAsyncActionSpec(asyncActionSpec: IAsyncActionSpec): Genai.Retriever.IndexAction;
     ...
     * #processQueues.
     */
    readonly numTries: number;
    withNumTries(numTries: number): Genai.Retriever.IndexAction;
    ...
    withIndexNumber(indexNumber: number | null): Genai.Retriever.IndexAction;
     ...
     * the #processQueues cron job.
     */
    readonly processedForFailure?: boolean;
    withProcessedForFailure(processedForFailure: boolean): Genai.Retriever.IndexAction;

    /**
     * The number of passages in this indexing action.
     */
    readonly passageCount?: number;
    withPassageCount(passageCount: number | null): Genai.Retriever.IndexAction;
    ...
    withStartTime(startTime: DateTime | Date | string | null): Genai.Retriever.IndexAction;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.Retriever.IndexAction | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.Retriever.IndexAction | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.Retriever.IndexAction | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.Retriever.IndexAction | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.Retriever.IndexAction;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Retriever.IndexAction;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Retriever.IndexAction;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Retriever.IndexAction>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Retriever.IndexAction>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.Retriever.IndexAction;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Retriever.IndexAction;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Retriever.IndexAction;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.Retriever.IndexAction;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.Retriever.IndexAction;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.Retriever.IndexAction;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.Retriever.IndexAction;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.Retriever.IndexAction;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.Retriever.IndexAction;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.Retriever.IndexAction;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.Retriever.IndexAction;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.Retriever.IndexAction;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.Retriever.IndexAction;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.Retriever.IndexAction;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.Retriever.IndexAction;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.Retriever.IndexAction;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.Retriever.IndexAction;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.Retriever.IndexAction;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.Retriever.IndexAction;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.Retriever.IndexAction;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.Retriever.IndexAction;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.Retriever.IndexAction;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.Retriever.IndexAction;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.Retriever.IndexAction;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.Retriever.IndexAction;

    mergeJson(json: any): Genai.Retriever.IndexAction;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.Retriever.IndexAction;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.Retriever.IndexAction;
     ...
     */
    singletonArray(): Array_Type<Genai.Retriever.IndexAction>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.Retriever.IndexAction> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.Retriever.IndexAction> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.Retriever.IndexAction>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.Retriever.IndexAction> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.Retriever.IndexAction> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.Retriever.IndexAction> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.Retriever.IndexAction>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.Retriever.IndexAction>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.Retriever.IndexAction;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.Retriever.IndexAction;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.Retriever.IndexAction;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.Retriever.IndexAction;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.Retriever.IndexAction;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.Retriever.IndexAction;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.Retriever.IndexAction | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.Retriever.IndexAction;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.Retriever.IndexAction;
     ...
     */
    static cachedEmptyInst(): Genai.Retriever.IndexAction;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.Retriever.IndexAction> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.Retriever.IndexAction;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Genai.Retriever.IndexAction>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Genai.Retriever.IndexAction>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Genai.Retriever.IndexAction> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Genai.Retriever.IndexAction>> | null;
     ...
     */
    get(include?: string): Genai.Retriever.IndexAction | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Genai.Retriever.IndexAction | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Genai.Retriever.IndexAction;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Genai.Retriever.IndexAction | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Genai.Retriever.IndexAction;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.Retriever.IndexAction | null;
     ...
     */
    create(spec?: UpsertSpec): Genai.Retriever.IndexAction | null;
     ...
     */
    static createBatch(objs: Array_Type<Genai.Retriever.IndexAction>, spec?: UpsertSpec): ObjList<Genai.Retriever.IndexAction> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Genai.Retriever.IndexAction>, spec?: CreateBatchObjStreamSpec): ObjList<Genai.Retriever.IndexAction> | null;
     ...
     */
    update(srcObj?: Genai.Retriever.IndexAction, spec?: UpsertSpec): Genai.Retriever.IndexAction | null;
     ...
     */
    upsert(srcObj?: Genai.Retriever.IndexAction, spec?: UpsertSpec): Genai.Retriever.IndexAction | null;
     ...
     */
    merge(spec?: MergeSpec): Genai.Retriever.IndexAction | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Genai.Retriever.IndexAction | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Genai.Retriever.IndexAction | null;
     ...
     */
    static updateBatch(objs: Array_Type<Genai.Retriever.IndexAction>, srcObjs?: Array_Type<Genai.Retriever.IndexAction>, spec?: UpsertSpec): ObjList<Genai.Retriever.IndexAction> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Genai.Retriever.IndexAction> | null>, spec?: UpsertSpec): ObjList<Genai.Retriever.IndexAction> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Genai.Retriever.IndexAction>, srcObjs?: Array_Type<Genai.Retriever.IndexAction>, spec?: UpsertSpec): ObjList<Genai.Retriever.IndexAction> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Genai.Retriever.IndexAction> | null>, spec?: UpsertSpec): ObjList<Genai.Retriever.IndexAction> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Genai.Retriever.IndexAction>, spec?: TouchSpec): ObjList<Genai.Retriever.IndexAction> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.Retriever.IndexAction>, spec?: MergeSpec): ObjList<Genai.Retriever.IndexAction> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.Retriever.IndexAction>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.Retriever.IndexAction> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Genai.Retriever.IndexAction> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.Retriever.IndexAction> | null;
     ...
     */
    static mergeAll(mergeObj: Genai.Retriever.IndexAction, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Genai.Retriever.IndexAction, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Genai.Retriever.IndexAction>, spec?: UpsertSpec): ObjList<Genai.Retriever.IndexAction> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Genai.Retriever.IndexAction>, spec?: UpsertSpec): ObjList<Genai.Retriever.IndexAction> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Genai.Retriever.IndexAction | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Genai.Retriever.IndexAction>): ObjList<Genai.Retriever.IndexAction>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<Genai.Retriever.IndexAction>): ObjList<Genai.Retriever.IndexAction>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Genai.Retriever.IndexAction>): ObjList<Genai.Retriever.IndexAction>;
     ...
     */
    static afterCreate(objs: Array_Type<Genai.Retriever.IndexAction>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Genai.Retriever.IndexAction>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Genai.Retriever.IndexAction>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Genai.Retriever.IndexAction>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Genai.Retriever.IndexAction>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.Retriever.IndexAction | null;
     ...
     */
    withoutIdentity(): Genai.Retriever.IndexAction | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Genai.Retriever.IndexAction>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Genai.Retriever.IndexAction, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Genai.Retriever.IndexAction>, callback?: λFunction<Genai.Retriever.IndexAction | null, Genai.Retriever.IndexAction | null>): ObjList<Genai.Retriever.IndexAction>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Genai.Retriever.IndexAction>, callback?: λFunction<Genai.Retriever.IndexAction | null, Genai.Retriever.IndexAction | null>): Array_Type<ObjError> | null;
     ...
     */
    static processQueues(retrievers?: Array_Type<Genai.Retriever>): void;
     ...
     */
    static monitorLongRunningIndexAction(now: DateTime, firstAction: Genai.Retriever.IndexAction, retriever: Genai.Retriever): void;
     ...
     */
    static processFailedActions(retriever: Genai.Retriever): void;
     ...
     */
    static indexActionCount(retriever: Genai.Retriever, completed?: boolean): number | null;
  }
}
