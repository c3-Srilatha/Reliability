// TypeScript definitions for the C3 type Genai.HospitalStatistic

/**
 * This entity type is only for testing purposes.
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.HospitalStatistic
 */
declare namespace Genai {
  export interface IHospitalStatistic {
     ...
     */
    data?: Array_Type<Genai.HospitalStatisticMeasurement> | Array<IGenai.HospitalStatisticMeasurement>;
     ...
     */
    hospitalStatistics?: IGenai.HospitalStatistics;
  }
}
 ...
 */
declare namespace Genai {
  export class HospitalStatistic extends Obj  {

    /**
     * Populated on normalization. Indicates the earliest data point across various timeseries fields.
     */
    readonly earliest?: DateTime;
    withEarliest(earliest: DateTime | Date | string | null): Genai.HospitalStatistic;

    /**
     * Populated on normalization. Indicates the latest data point across various timeseries fields.
     */
    readonly latest?: DateTime;
    withLatest(latest: DateTime | Date | string | null): Genai.HospitalStatistic;

    /**
     * Populated on normalization. Indicates the earliest data point for each {@link Ann.Ts} fields.
     */
    readonly earliestTsDp?: Map_Type<string, TSDataPoint>;
    withEarliestTsDp(earliestTsDp: Map_Type<string, TSDataPoint> | {[key: string]: ITSDataPoint} | null): Genai.HospitalStatistic;

    /**
     * Populated on normalization. Indicates the latest data point for each {@link Ann.Ts} fields.
     */
    readonly latestTsDp?: Map_Type<string, TSDataPoint>;
    withLatestTsDp(latestTsDp: Map_Type<string, TSDataPoint> | {[key: string]: ITSDataPoint} | null): Genai.HospitalStatistic;
    ...
    withInterval(interval: string | null): Genai.HospitalStatistic;

    /**
     * If set, the time series will be normalized in the specified zone.
     */
    readonly timeZone?: string;
    withTimeZone(timeZone: string | null): Genai.HospitalStatistic;

    /**
     * If set, disables normalizing this time series. Invalidations will still continue to happen for this series normally.
     */
    readonly doNotNormalize?: boolean;
    withDoNotNormalize(doNotNormalize: boolean): Genai.HospitalStatistic;

    /**
     * Data points corresponding to this timeseries header
     */
    readonly data?: Array_Type<Genai.HospitalStatisticMeasurement>;
    withData(data: Array_Type<Genai.HospitalStatisticMeasurement> | Array<IGenai.HospitalStatisticMeasurement> | null): Genai.HospitalStatistic;

    /**
     * Use this field to specify the interpolation mechanism to be applied for gaps in interval timeseries. Default: `ZERO_INTERPOLATOR`.
     */
    readonly interpolator?: string;
    withInterpolator(interpolator: string | null): Genai.HospitalStatistic;

    /**
     * Use this field to specify how normalization should handle duplicate data points. A duplicate point is one that has the same start, end, value, unit, and {@link TimedDataPointFields#isEstimated} values. Default: `IGNORE`.
     */
    readonly duplicateHandling?: string;
    withDuplicateHandling(duplicateHandling: string | null): Genai.HospitalStatistic;

    /**
     * Used to specify how normalization should handle overlapping data points. Default: `AVG`.
     */
    readonly overlapHandling?: string;
    withOverlapHandling(overlapHandling: string | null): Genai.HospitalStatistic;
    ...
    withBucketInterval(bucketInterval: string | null): Genai.HospitalStatistic;
    ...
    withNormalizationPartitionStrategy(normalizationPartitionStrategy: INormalizationPartitionStrategy | null): Genai.HospitalStatistic;

    /**
     * Indicates whether the last data point should be repeated until infinity
     */
    readonly extrapolate?: boolean;
    withExtrapolate(extrapolate: boolean): Genai.HospitalStatistic;
     ...
     */
    readonly id: string;
    withId(id: string): Genai.HospitalStatistic;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Genai.HospitalStatistic;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): Genai.HospitalStatistic;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Genai.HospitalStatistic;
    ...
    withVersion(version: number | null): Genai.HospitalStatistic;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Genai.HospitalStatistic;

    /**
     * The hospital statistics for the hospital.
     */
    readonly hospitalStatistics?: Genai.HospitalStatistics;
    withHospitalStatistics(hospitalStatistics: IGenai.HospitalStatistics | null): Genai.HospitalStatistic;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.HospitalStatistic | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.HospitalStatistic | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.HospitalStatistic | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.HospitalStatistic | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.HospitalStatistic;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.HospitalStatistic;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.HospitalStatistic;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.HospitalStatistic>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.HospitalStatistic>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.HospitalStatistic;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.HospitalStatistic;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.HospitalStatistic;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.HospitalStatistic;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.HospitalStatistic;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.HospitalStatistic;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.HospitalStatistic;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.HospitalStatistic;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.HospitalStatistic;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.HospitalStatistic;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.HospitalStatistic;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.HospitalStatistic;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.HospitalStatistic;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.HospitalStatistic;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.HospitalStatistic;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.HospitalStatistic;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.HospitalStatistic;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.HospitalStatistic;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.HospitalStatistic;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.HospitalStatistic;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.HospitalStatistic;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.HospitalStatistic;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.HospitalStatistic;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.HospitalStatistic;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.HospitalStatistic;

    mergeJson(json: any): Genai.HospitalStatistic;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.HospitalStatistic;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.HospitalStatistic;
     ...
     */
    singletonArray(): Array_Type<Genai.HospitalStatistic>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.HospitalStatistic> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.HospitalStatistic> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.HospitalStatistic>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.HospitalStatistic> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.HospitalStatistic> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.HospitalStatistic> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.HospitalStatistic>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.HospitalStatistic>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.HospitalStatistic;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.HospitalStatistic;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.HospitalStatistic;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.HospitalStatistic;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.HospitalStatistic;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.HospitalStatistic;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.HospitalStatistic | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.HospitalStatistic;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.HospitalStatistic;
     ...
     */
    static cachedEmptyInst(): Genai.HospitalStatistic;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.HospitalStatistic> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.HospitalStatistic;
     ...
     */
    static normalizeTimeseries(timeseries?: TimedDataFields<Genai.HospitalStatisticMeasurement>, start?: DateTime, end?: DateTime, overrideGrain?: string, forceGrainDetection?: boolean, force?: boolean): void;
     ...
     */
    static normalize(timeseries?: TimedDataFields<Genai.HospitalStatisticMeasurement>, start?: DateTime, end?: DateTime, overrideGrain?: string, forceGrainDetection?: boolean): NormalizationResult | null;
     ...
     */
    static normalizationUnit(rawHeader: TimedDataFields<Genai.HospitalStatisticMeasurement>, tsField: string): Unit | null;
     ...
     */
    static normalizationTreatment(rawHeader: TimedDataFields<Genai.HospitalStatisticMeasurement>, tsField: string): string;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Genai.HospitalStatistic>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Genai.HospitalStatistic>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Genai.HospitalStatistic> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Genai.HospitalStatistic>> | null;
     ...
     */
    get(include?: string): Genai.HospitalStatistic | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Genai.HospitalStatistic | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Genai.HospitalStatistic;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Genai.HospitalStatistic | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Genai.HospitalStatistic;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.HospitalStatistic | null;
     ...
     */
    create(spec?: UpsertSpec): Genai.HospitalStatistic | null;
     ...
     */
    static createBatch(objs: Array_Type<Genai.HospitalStatistic>, spec?: UpsertSpec): ObjList<Genai.HospitalStatistic> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Genai.HospitalStatistic>, spec?: CreateBatchObjStreamSpec): ObjList<Genai.HospitalStatistic> | null;
     ...
     */
    update(srcObj?: Genai.HospitalStatistic, spec?: UpsertSpec): Genai.HospitalStatistic | null;
     ...
     */
    upsert(srcObj?: Genai.HospitalStatistic, spec?: UpsertSpec): Genai.HospitalStatistic | null;
     ...
     */
    merge(spec?: MergeSpec): Genai.HospitalStatistic | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Genai.HospitalStatistic | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Genai.HospitalStatistic | null;
     ...
     */
    static updateBatch(objs: Array_Type<Genai.HospitalStatistic>, srcObjs?: Array_Type<Genai.HospitalStatistic>, spec?: UpsertSpec): ObjList<Genai.HospitalStatistic> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Genai.HospitalStatistic> | null>, spec?: UpsertSpec): ObjList<Genai.HospitalStatistic> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Genai.HospitalStatistic>, srcObjs?: Array_Type<Genai.HospitalStatistic>, spec?: UpsertSpec): ObjList<Genai.HospitalStatistic> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Genai.HospitalStatistic> | null>, spec?: UpsertSpec): ObjList<Genai.HospitalStatistic> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Genai.HospitalStatistic>, spec?: TouchSpec): ObjList<Genai.HospitalStatistic> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.HospitalStatistic>, spec?: MergeSpec): ObjList<Genai.HospitalStatistic> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.HospitalStatistic>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.HospitalStatistic> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Genai.HospitalStatistic> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.HospitalStatistic> | null;
     ...
     */
    static mergeAll(mergeObj: Genai.HospitalStatistic, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Genai.HospitalStatistic, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Genai.HospitalStatistic>, spec?: UpsertSpec): ObjList<Genai.HospitalStatistic> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Genai.HospitalStatistic>, spec?: UpsertSpec): ObjList<Genai.HospitalStatistic> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Genai.HospitalStatistic | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Genai.HospitalStatistic>): ObjList<Genai.HospitalStatistic>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<Genai.HospitalStatistic>): ObjList<Genai.HospitalStatistic>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Genai.HospitalStatistic>): ObjList<Genai.HospitalStatistic>;
     ...
     */
    static afterCreate(objs: Array_Type<Genai.HospitalStatistic>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Genai.HospitalStatistic>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Genai.HospitalStatistic>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Genai.HospitalStatistic>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Genai.HospitalStatistic>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.HospitalStatistic | null;
     ...
     */
    withoutIdentity(): Genai.HospitalStatistic | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Genai.HospitalStatistic>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Genai.HospitalStatistic, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Genai.HospitalStatistic>, callback?: λFunction<Genai.HospitalStatistic | null, Genai.HospitalStatistic | null>): ObjList<Genai.HospitalStatistic>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Genai.HospitalStatistic>, callback?: λFunction<Genai.HospitalStatistic | null, Genai.HospitalStatistic | null>): Array_Type<ObjError> | null;
