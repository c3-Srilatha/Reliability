// TypeScript definitions for the C3 type Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig

/**
 * Defines the specification used for running inference.
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig
 */
declare namespace Genai.UnstructuredQuery.Engine.REA {
  export interface IModelInferenceConfig {
     ...
     */
    stopSequences?: Array_Type<string> | Array<string>;
     ...
     */
    uiOptions?: IGenai.UnstructuredQuery.Engine.REA.ModelInferenceConfig.UiOptions;
  }
}
 ...
 */
declare namespace Genai.UnstructuredQuery.Engine.REA {
  export class ModelInferenceConfig extends Obj  {

    /**
     * The unique and required name of this instance.
     */
    readonly name: string;
    withName(name: string): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig;

    readonly configOverride?: string;
    withConfigOverride(configOverride: string | null): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig;

    readonly secretOverride?: string;
    withSecretOverride(secretOverride: string | null): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig;

    /**
     * Captures any issues that occurred while deserializing from filesystem
     */
    readonly issues?: Array_Type<string>;
    withIssues(issues: Array_Type<string> | Array<string> | null): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig;
    ...
    withLlmConfigName(llmConfigName: string | null): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig;

    /**
     * The name of the model to be used. May be a path to a local model, a huggingface model name,
     */
    readonly modelName: string;
    withModelName(modelName: string): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig;

    /**
     * Get the user friendly name for the LLM instance. This will be used in the UI.
     */
    readonly userFriendlyName?: string;
    withUserFriendlyName(userFriendlyName: string | null): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig;

    /**
     * The name of the {@link Genai.UnstructuredQuery.Engine.REA.ModelInference.Prompt.Config} that should be used.
     */
    readonly promptConfigName: string;
    withPromptConfigName(promptConfigName: string): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig;
    ...
    withTokenizerName(tokenizerName: string | null): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig;
    ...
    withContextLength(contextLength: number | null): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig;

    /**
     * The secret endpoint of the Hosted VLLM, only used if llmType is set to VLLM.
     */
    readonly vllmEndpoint?: string;
    withVllmEndpoint(vllmEndpoint: string | null): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig;

    /**
     * The model route for the model inference service (MIS) hosted models
     */
    readonly route?: string;
    withRoute(route: string | null): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig;
    ...
    withTemperature(temperature: number | null): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig;

    /**
     * The maximum number of generated sequence.
     */
    readonly maxOutputTokens?: number;
    withMaxOutputTokens(maxOutputTokens: number | null): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig;
    ...
    withMaxOutputTokensLimit(maxOutputTokensLimit: number | null): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig;
    ...
    withTopP(topP: number | null): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig;
    ...
    withTopK(topK: number | null): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig;

    /**
     * Whether to use beam search instead of sampling. Default is set to False.
     */
    readonly useBeamSearch?: boolean;
    withUseBeamSearch(useBeamSearch: boolean): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig;

    /**
     * The number of beams used by Beam search sampling, default set to 5. If not using Beam search, it is ignored.
     */
    readonly nBeams?: number;
    withNBeams(nBeams: number | null): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig;

    /**
     * A list of strings that is used to stop model's text generation.
     * Default is None. This is used for the question answering model.
     */
    readonly stopSequences?: Array_Type<string>;
    withStopSequences(stopSequences: Array_Type<string> | Array<string> | null): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig;

    /**
     * Float that penalizes sequences based on their length. Used in beam search. Default is 1.0.
     */
    readonly lengthPenalty?: number;
    withLengthPenalty(lengthPenalty: number | null): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig;
    ...
    withEarlyStopping(earlyStopping: boolean): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig;
    ...
    withPresencePenalty(presencePenalty: number | null): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig;
    ...
    withFrequencyPenalty(frequencyPenalty: number | null): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig;

    /**
     * Whether to have a streaming output. Default is set to False.
     */
    readonly streamResponse?: boolean;
    withStreamResponse(streamResponse: boolean): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig;

    /**
     * The timeout parameter
     */
    readonly timeout?: number;
    withTimeout(timeout: number | null): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig;

    /**
     * When the prompt needs to be truncated to fit the context size, whether to remove the entire prompt
     * or trim it so that it fits given the number of available tokens.
     */
    readonly truncatePromptTotally?: boolean;
    withTruncatePromptTotally(truncatePromptTotally: boolean): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig;

    /**
     * The API version to be used for the LLM. Currently, only applicable for AWS Bedrock Claude 3 models.
     */
    readonly apiVersion?: string;
    withApiVersion(apiVersion: string | null): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig;

    /**
     * The type of llm pipe to use.
     */
    readonly llmType: string;
    withLlmType(llmType: string): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig;

    /**
     * Configuration for how this will be shown as a UI drop-down option.
     */
    readonly uiOptions?: Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig.UiOptions;
    withUiOptions(uiOptions: IGenai.UnstructuredQuery.Engine.REA.ModelInferenceConfig.UiOptions | null): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig;

    mergeJson(json: any): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig;
     ...
     */
    singletonArray(): Array_Type<Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig;
     ...
     */
    static cachedEmptyInst(): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig | null;
     ...
     */
    static forName(name: string, failIfMissing?: boolean): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig | null;
     ...
     */
    static allCached(): Stream<Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig> | null;
     ...
     */
    static find(filter?: string): Stream<Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig> | null;

    /**
     * @return cached instance.
     */
    getCached(): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig | null;
     ...
     */
    static produce(key: string): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig> | null;
     ...
     */
    getConfig(): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig;
     ...
     */
    getSecret(): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig;
     ...
     */
    withConfigKey(configKey: string): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig;

    /**
     * @return copy without config key.
     */
    withoutConfigKey(): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig;

    /**
     * @return return cached config instance for provided config key.
     */
    static forConfigKey(configKey: string): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string>): Stream<Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig> | null;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig, override?: string): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig | null;
     ...
     */
    removeSecrets(): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig | null;

    /**
     * @return this config with only secret values.
     */
    removeNonSecrets(): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig | null;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    validate(): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig;
     ...
     */
    static setRecursive(configJson: any, useSetConfigValues?: boolean, override?: string): Genai.UnstructuredQuery.Engine.REA.ModelInferenceConfig;
