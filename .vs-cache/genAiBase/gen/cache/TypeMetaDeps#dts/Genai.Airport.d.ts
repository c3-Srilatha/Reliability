// TypeScript definitions for the C3 type Genai.Airport

/**
 * An airport facility where an aircraft can take off from and arrive at. Is the location for all aircraft.
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.Airport
 */
 ...
 */
declare namespace Genai {
  export class Airport extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): Genai.Airport;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Genai.Airport;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): Genai.Airport;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Genai.Airport;
    ...
    withVersion(version: number | null): Genai.Airport;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Genai.Airport;

    /**
     * The city where this airport and aircraft in it are located
     */
    readonly city?: string;
    withCity(city: string | null): Genai.Airport;

    /**
     * The state where this airport and aircraft in it are located
     */
    readonly state?: string;
    withState(state: string | null): Genai.Airport;

    /**
     * The country where this airport and aircraft in it are located
     */
    readonly country?: string;
    withCountry(country: string | null): Genai.Airport;

    /**
     * The latitude coordinate where this airport and aircraft in it are located
     */
    readonly latitude?: number;
    withLatitude(latitude: number | null): Genai.Airport;

    /**
     * The longitude coordinate where this airport and aircraft in it are located
     */
    readonly longitude?: number;
    withLongitude(longitude: number | null): Genai.Airport;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.Airport | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.Airport | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.Airport | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.Airport | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.Airport;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Airport;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Airport;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Airport>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Airport>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.Airport;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Airport;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Airport;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.Airport;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.Airport;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.Airport;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.Airport;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.Airport;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.Airport;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.Airport;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.Airport;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.Airport;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.Airport;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.Airport;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.Airport;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.Airport;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.Airport;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.Airport;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.Airport;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.Airport;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.Airport;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.Airport;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.Airport;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.Airport;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.Airport;

    mergeJson(json: any): Genai.Airport;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.Airport;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.Airport;
     ...
     */
    singletonArray(): Array_Type<Genai.Airport>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.Airport> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.Airport> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.Airport>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.Airport> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.Airport> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.Airport> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.Airport>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.Airport>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.Airport;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.Airport;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.Airport;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.Airport;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.Airport;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.Airport;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.Airport | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.Airport;
     ...
     */
    static cachedEmptyInst(): Genai.Airport;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.Airport> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.Airport;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Genai.Airport>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Genai.Airport>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Genai.Airport> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Genai.Airport>> | null;
     ...
     */
    get(include?: string): Genai.Airport | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Genai.Airport | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Genai.Airport;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Genai.Airport | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Genai.Airport;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.Airport | null;
     ...
     */
    create(spec?: UpsertSpec): Genai.Airport | null;
     ...
     */
    static createBatch(objs: Array_Type<Genai.Airport>, spec?: UpsertSpec): ObjList<Genai.Airport> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Genai.Airport>, spec?: CreateBatchObjStreamSpec): ObjList<Genai.Airport> | null;
     ...
     */
    update(srcObj?: Genai.Airport, spec?: UpsertSpec): Genai.Airport | null;
     ...
     */
    upsert(srcObj?: Genai.Airport, spec?: UpsertSpec): Genai.Airport | null;
     ...
     */
    merge(spec?: MergeSpec): Genai.Airport | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Genai.Airport | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Genai.Airport | null;
     ...
     */
    static updateBatch(objs: Array_Type<Genai.Airport>, srcObjs?: Array_Type<Genai.Airport>, spec?: UpsertSpec): ObjList<Genai.Airport> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Genai.Airport> | null>, spec?: UpsertSpec): ObjList<Genai.Airport> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Genai.Airport>, srcObjs?: Array_Type<Genai.Airport>, spec?: UpsertSpec): ObjList<Genai.Airport> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Genai.Airport> | null>, spec?: UpsertSpec): ObjList<Genai.Airport> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Genai.Airport>, spec?: TouchSpec): ObjList<Genai.Airport> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.Airport>, spec?: MergeSpec): ObjList<Genai.Airport> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.Airport>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.Airport> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Genai.Airport> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.Airport> | null;
     ...
     */
    static mergeAll(mergeObj: Genai.Airport, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Genai.Airport, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Genai.Airport>, spec?: UpsertSpec): ObjList<Genai.Airport> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Genai.Airport>, spec?: UpsertSpec): ObjList<Genai.Airport> | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Genai.Airport>): ObjList<Genai.Airport>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<Genai.Airport>): ObjList<Genai.Airport>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Genai.Airport>): ObjList<Genai.Airport>;
     ...
     */
    static afterCreate(objs: Array_Type<Genai.Airport>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Genai.Airport>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Genai.Airport>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Genai.Airport>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Genai.Airport>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.Airport | null;
     ...
     */
    withoutIdentity(): Genai.Airport | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Genai.Airport>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Genai.Airport, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Genai.Airport>, callback?: λFunction<Genai.Airport | null, Genai.Airport | null>): ObjList<Genai.Airport>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Genai.Airport>, callback?: λFunction<Genai.Airport | null, Genai.Airport | null>): Array_Type<ObjError> | null;
