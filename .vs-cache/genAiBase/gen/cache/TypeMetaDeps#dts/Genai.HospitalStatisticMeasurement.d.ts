// TypeScript definitions for the C3 type Genai.HospitalStatisticMeasurement

/**
 * This entity type is only for testing purposes.
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.HospitalStatisticMeasurement
 */
declare namespace Genai {
  export interface IHospitalStatisticMeasurement {
    ...
    parent: IGenai.HospitalStatistic;
    ...
    /**
     * The hospital total patient count
     */
    totalPatients?: number;

    /**
     * The hospital total doctor count
     */
    totalDoctors?: number;

    /**
     * The hospital total nurse count
     */
    totalAppointments?: number;

    /**
     * The hospital total prescriptions count
     */
    totalPrescriptions?: number;

    /**
     * The hospital total lab tests count
     */
    totalLabTests?: number;

    /**
     * The hospital statistics for the hospital.
     */
    busiestDay?: string;

    /**
     * The hospital common condition
     */
    mostCommonCondition?: string;

    /**
     * The hospital most prescribed medication
     */
    mostPrescribedMedication?: string;

    /**
     * The hospital most performed test
     */
 ...
 * This entity type is only for testing purposes.
 *
 * @remarks this represents a made instance of Genai.HospitalStatisticMeasurement
 */
declare namespace Genai {
  export class HospitalStatisticMeasurement extends Obj  {

    /**
     * start date for the data point
     */
    readonly start: DateTime;
    withStart(start: DateTime | Date | string): Genai.HospitalStatisticMeasurement;
    ...
    withOutlierCode(outlierCode: number | null): Genai.HospitalStatisticMeasurement;

    /**
     * (Optional) any comments for the data point
     */
    readonly comments?: string;
    withComments(comments: string | null): Genai.HospitalStatisticMeasurement;

    /**
     * Denotes if the value is an actual value or an estimated value. default = null (actual value)
     */
    readonly isEstimated?: boolean;
    withIsEstimated(isEstimated: boolean): Genai.HospitalStatisticMeasurement;
    ...
    withDataVersion(dataVersion: number | null): Genai.HospitalStatisticMeasurement;

    /**
     * Customer specific status code for the data point (may be used to denote data quality)
     */
    readonly statusCode?: string;
    withStatusCode(statusCode: string | null): Genai.HospitalStatisticMeasurement;

    /**
     * Partition key Bin separator used to separate partition key from bin id
     */
    readonly PK_BIN_SEPARATOR?: string;
    withPK_BIN_SEPARATOR(PK_BIN_SEPARATOR: string | null): Genai.HospitalStatisticMeasurement;

    readonly parent: Genai.HospitalStatistic;
    withParent(parent: IGenai.HospitalStatistic): Genai.HospitalStatisticMeasurement;
     ...
     */
    readonly id: string;
    withId(id: string): Genai.HospitalStatisticMeasurement;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Genai.HospitalStatisticMeasurement;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): Genai.HospitalStatisticMeasurement;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Genai.HospitalStatisticMeasurement;
    ...
    withVersion(version: number | null): Genai.HospitalStatisticMeasurement;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Genai.HospitalStatisticMeasurement;

    /**
     * The timestamp of the measurement.
     */
    readonly timestamp?: DateTime;
    withTimestamp(timestamp: DateTime | Date | string | null): Genai.HospitalStatisticMeasurement;

    /**
     * The hospital total patient count
     */
    readonly totalPatients?: number;
    withTotalPatients(totalPatients: number | null): Genai.HospitalStatisticMeasurement;

    /**
     * The hospital total doctor count
     */
    readonly totalDoctors?: number;
    withTotalDoctors(totalDoctors: number | null): Genai.HospitalStatisticMeasurement;

    /**
     * The hospital total nurse count
     */
    readonly totalAppointments?: number;
    withTotalAppointments(totalAppointments: number | null): Genai.HospitalStatisticMeasurement;

    /**
     * The hospital total prescriptions count
     */
    readonly totalPrescriptions?: number;
    withTotalPrescriptions(totalPrescriptions: number | null): Genai.HospitalStatisticMeasurement;

    /**
     * The hospital total lab tests count
     */
    readonly totalLabTests?: number;
    withTotalLabTests(totalLabTests: number | null): Genai.HospitalStatisticMeasurement;

    /**
     * The hospital statistics for the hospital.
     */
    readonly busiestDay?: string;
    withBusiestDay(busiestDay: string | null): Genai.HospitalStatisticMeasurement;

    /**
     * The hospital common condition
     */
    readonly mostCommonCondition?: string;
    withMostCommonCondition(mostCommonCondition: string | null): Genai.HospitalStatisticMeasurement;

    /**
     * The hospital most prescribed medication
     */
    readonly mostPrescribedMedication?: string;
    withMostPrescribedMedication(mostPrescribedMedication: string | null): Genai.HospitalStatisticMeasurement;

    /**
     * The hospital most performed test
     */
    readonly mostPerformedTest?: string;
    withMostPerformedTest(mostPerformedTest: string | null): Genai.HospitalStatisticMeasurement;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.HospitalStatisticMeasurement | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.HospitalStatisticMeasurement | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.HospitalStatisticMeasurement | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.HospitalStatisticMeasurement | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.HospitalStatisticMeasurement;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.HospitalStatisticMeasurement;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.HospitalStatisticMeasurement;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.HospitalStatisticMeasurement>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.HospitalStatisticMeasurement>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.HospitalStatisticMeasurement;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.HospitalStatisticMeasurement;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.HospitalStatisticMeasurement;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.HospitalStatisticMeasurement;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.HospitalStatisticMeasurement;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.HospitalStatisticMeasurement;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.HospitalStatisticMeasurement;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.HospitalStatisticMeasurement;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.HospitalStatisticMeasurement;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.HospitalStatisticMeasurement;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.HospitalStatisticMeasurement;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.HospitalStatisticMeasurement;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.HospitalStatisticMeasurement;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.HospitalStatisticMeasurement;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.HospitalStatisticMeasurement;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.HospitalStatisticMeasurement;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.HospitalStatisticMeasurement;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.HospitalStatisticMeasurement;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.HospitalStatisticMeasurement;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.HospitalStatisticMeasurement;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.HospitalStatisticMeasurement;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.HospitalStatisticMeasurement;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.HospitalStatisticMeasurement;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.HospitalStatisticMeasurement;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.HospitalStatisticMeasurement;

    mergeJson(json: any): Genai.HospitalStatisticMeasurement;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.HospitalStatisticMeasurement;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.HospitalStatisticMeasurement;
     ...
     */
    singletonArray(): Array_Type<Genai.HospitalStatisticMeasurement>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.HospitalStatisticMeasurement> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.HospitalStatisticMeasurement> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.HospitalStatisticMeasurement>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.HospitalStatisticMeasurement> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.HospitalStatisticMeasurement> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.HospitalStatisticMeasurement> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.HospitalStatisticMeasurement>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.HospitalStatisticMeasurement>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.HospitalStatisticMeasurement;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.HospitalStatisticMeasurement;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.HospitalStatisticMeasurement;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.HospitalStatisticMeasurement;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.HospitalStatisticMeasurement;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.HospitalStatisticMeasurement;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.HospitalStatisticMeasurement | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.HospitalStatisticMeasurement;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.HospitalStatisticMeasurement;
     ...
     */
    static cachedEmptyInst(): Genai.HospitalStatisticMeasurement;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.HospitalStatisticMeasurement> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.HospitalStatisticMeasurement;

    /**
     * Extract the partition key from the given obj
     */
    partitionKey(failIfMissing?: boolean): Genai.HospitalStatistic | null;
     ...
     */
    static partition(objs?: Stream<Genai.HospitalStatisticMeasurement>, spec?: PartitionBucketStrategy): Map_Type<string, KvDataPartition> | null;
     ...
     */
    static fromPartitions(partitions?: Stream<KvDataPartition>): Stream<Genai.HospitalStatisticMeasurement> | null;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Genai.HospitalStatisticMeasurement>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Genai.HospitalStatisticMeasurement>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Genai.HospitalStatisticMeasurement> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Genai.HospitalStatisticMeasurement>> | null;
     ...
     */
    get(include?: string): Genai.HospitalStatisticMeasurement | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Genai.HospitalStatisticMeasurement | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Genai.HospitalStatisticMeasurement;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Genai.HospitalStatisticMeasurement | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Genai.HospitalStatisticMeasurement;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.HospitalStatisticMeasurement | null;
     ...
     */
    create(spec?: UpsertSpec): Genai.HospitalStatisticMeasurement | null;
     ...
     */
    static createBatch(objs: Array_Type<Genai.HospitalStatisticMeasurement>, spec?: UpsertSpec): ObjList<Genai.HospitalStatisticMeasurement> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Genai.HospitalStatisticMeasurement>, spec?: CreateBatchObjStreamSpec): ObjList<Genai.HospitalStatisticMeasurement> | null;
     ...
     */
    update(srcObj?: Genai.HospitalStatisticMeasurement, spec?: UpsertSpec): Genai.HospitalStatisticMeasurement | null;
     ...
     */
    upsert(srcObj?: Genai.HospitalStatisticMeasurement, spec?: UpsertSpec): Genai.HospitalStatisticMeasurement | null;
     ...
     */
    merge(spec?: MergeSpec): Genai.HospitalStatisticMeasurement | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Genai.HospitalStatisticMeasurement | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Genai.HospitalStatisticMeasurement | null;
     ...
     */
    static updateBatch(objs: Array_Type<Genai.HospitalStatisticMeasurement>, srcObjs?: Array_Type<Genai.HospitalStatisticMeasurement>, spec?: UpsertSpec): ObjList<Genai.HospitalStatisticMeasurement> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Genai.HospitalStatisticMeasurement> | null>, spec?: UpsertSpec): ObjList<Genai.HospitalStatisticMeasurement> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Genai.HospitalStatisticMeasurement>, srcObjs?: Array_Type<Genai.HospitalStatisticMeasurement>, spec?: UpsertSpec): ObjList<Genai.HospitalStatisticMeasurement> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Genai.HospitalStatisticMeasurement> | null>, spec?: UpsertSpec): ObjList<Genai.HospitalStatisticMeasurement> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Genai.HospitalStatisticMeasurement>, spec?: TouchSpec): ObjList<Genai.HospitalStatisticMeasurement> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.HospitalStatisticMeasurement>, spec?: MergeSpec): ObjList<Genai.HospitalStatisticMeasurement> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.HospitalStatisticMeasurement>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.HospitalStatisticMeasurement> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Genai.HospitalStatisticMeasurement> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.HospitalStatisticMeasurement> | null;
     ...
     */
    static mergeAll(mergeObj: Genai.HospitalStatisticMeasurement, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Genai.HospitalStatisticMeasurement, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Genai.HospitalStatisticMeasurement>, spec?: UpsertSpec): ObjList<Genai.HospitalStatisticMeasurement> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Genai.HospitalStatisticMeasurement>, spec?: UpsertSpec): ObjList<Genai.HospitalStatisticMeasurement> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Genai.HospitalStatisticMeasurement | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Genai.HospitalStatisticMeasurement>): ObjList<Genai.HospitalStatisticMeasurement>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<Genai.HospitalStatisticMeasurement>): ObjList<Genai.HospitalStatisticMeasurement>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Genai.HospitalStatisticMeasurement>): ObjList<Genai.HospitalStatisticMeasurement>;
     ...
     */
    static afterCreate(objs: Array_Type<Genai.HospitalStatisticMeasurement>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Genai.HospitalStatisticMeasurement>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Genai.HospitalStatisticMeasurement>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Genai.HospitalStatisticMeasurement>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Genai.HospitalStatisticMeasurement>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.HospitalStatisticMeasurement | null;
     ...
     */
    withoutIdentity(): Genai.HospitalStatisticMeasurement | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Genai.HospitalStatisticMeasurement>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Genai.HospitalStatisticMeasurement, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Genai.HospitalStatisticMeasurement>, callback?: λFunction<Genai.HospitalStatisticMeasurement | null, Genai.HospitalStatisticMeasurement | null>): ObjList<Genai.HospitalStatisticMeasurement>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Genai.HospitalStatisticMeasurement>, callback?: λFunction<Genai.HospitalStatisticMeasurement | null, Genai.HospitalStatisticMeasurement | null>): Array_Type<ObjError> | null;
