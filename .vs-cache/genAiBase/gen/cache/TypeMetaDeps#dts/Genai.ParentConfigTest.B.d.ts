// TypeScript definitions for the C3 type Genai.ParentConfigTest.B

/**
 * Test type
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.ParentConfigTest.B
 */
 ...
 */
declare namespace Genai.ParentConfigTest {
  export class B extends Obj  {

    readonly configOverride?: string;
    withConfigOverride(configOverride: string | null): Genai.ParentConfigTest.B;

    readonly secretOverride?: string;
    withSecretOverride(secretOverride: string | null): Genai.ParentConfigTest.B;

    /**
     * Captures any issues that occurred while deserializing from filesystem
     */
    readonly issues?: Array_Type<string>;
    withIssues(issues: Array_Type<string> | Array<string> | null): Genai.ParentConfigTest.B;

    /**
     * The unique and required name of this instance.
     */
    readonly name: string;
    withName(name: string): Genai.ParentConfigTest.B;

    /**
     * Test string
     */
    readonly str?: string;
    withStr(str: string | null): Genai.ParentConfigTest.B;

    /**
     * name of d config
     */
    readonly dConfigName?: string;
    withDConfigName(dConfigName: string | null): Genai.ParentConfigTest.B;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.ParentConfigTest.B | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.ParentConfigTest.B | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.ParentConfigTest.B | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.ParentConfigTest.B | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.ParentConfigTest.B;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.ParentConfigTest.B;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.ParentConfigTest.B;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.ParentConfigTest.B>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.ParentConfigTest.B>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.ParentConfigTest.B;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.ParentConfigTest.B;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.ParentConfigTest.B;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.ParentConfigTest.B;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.ParentConfigTest.B;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.ParentConfigTest.B;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.ParentConfigTest.B;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.ParentConfigTest.B;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.ParentConfigTest.B;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.ParentConfigTest.B;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.ParentConfigTest.B;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.ParentConfigTest.B;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.ParentConfigTest.B;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.ParentConfigTest.B;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.ParentConfigTest.B;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.ParentConfigTest.B;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.ParentConfigTest.B;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.ParentConfigTest.B;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.ParentConfigTest.B;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.ParentConfigTest.B;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.ParentConfigTest.B;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.ParentConfigTest.B;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.ParentConfigTest.B;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.ParentConfigTest.B;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.ParentConfigTest.B;

    mergeJson(json: any): Genai.ParentConfigTest.B;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.ParentConfigTest.B;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.ParentConfigTest.B;
     ...
     */
    singletonArray(): Array_Type<Genai.ParentConfigTest.B>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.ParentConfigTest.B> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.ParentConfigTest.B> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.ParentConfigTest.B>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.ParentConfigTest.B> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.ParentConfigTest.B> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.ParentConfigTest.B> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.ParentConfigTest.B>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.ParentConfigTest.B>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.ParentConfigTest.B;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.ParentConfigTest.B;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.ParentConfigTest.B;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.ParentConfigTest.B;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.ParentConfigTest.B;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.ParentConfigTest.B;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.ParentConfigTest.B | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.ParentConfigTest.B;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.ParentConfigTest.B;
     ...
     */
    static cachedEmptyInst(): Genai.ParentConfigTest.B;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.ParentConfigTest.B> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.ParentConfigTest.B;
     ...
     */
    static allCached(): Stream<Genai.ParentConfigTest.B> | null;
     ...
     */
    static find(filter?: string): Stream<Genai.ParentConfigTest.B> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<Genai.ParentConfigTest.B> | null;

    /**
     * @return cached instance.
     */
    getCached(): Genai.ParentConfigTest.B | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string): Genai.ParentConfigTest.B | null;
     ...
     */
    static produce(key: string): Genai.ParentConfigTest.B | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, Genai.ParentConfigTest.B> | null;
     ...
     */
    getConfig(): Genai.ParentConfigTest.B;
     ...
     */
    getSecret(): Genai.ParentConfigTest.B;
     ...
     */
    withConfigKey(configKey: string): Genai.ParentConfigTest.B;

    /**
     * @return copy without config key.
     */
    withoutConfigKey(): Genai.ParentConfigTest.B;

    /**
     * @return return cached config instance for provided config key.
     */
    static forConfigKey(configKey: string): Genai.ParentConfigTest.B | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string>): Stream<Genai.ParentConfigTest.B> | null;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: Genai.ParentConfigTest.B, override?: string): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): Genai.ParentConfigTest.B | null;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.ParentConfigTest.B | null;
     ...
     */
    static forName(name: string, failIfMissing?: boolean): Genai.ParentConfigTest.B | null;
     ...
     */
    static setRecursive(configJson: any, useSetConfigValues?: boolean, override?: string): Genai.ParentConfigTest.B;
