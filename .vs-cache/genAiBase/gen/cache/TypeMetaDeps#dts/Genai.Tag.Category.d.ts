// TypeScript definitions for the C3 type Genai.Tag.Category

/**
 * A Genai.Tag.Category is an arbitrary string label that a user can
 * set on any {@link Genai.Tag}.
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.Tag.Category
 */
declare namespace Genai.Tag {
  export interface ICategory {
     ...
     */
    tags?: Array_Type<Genai.Tag> | Array<IGenai.Tag>;
 ...
 */
declare namespace Genai.Tag {
  export class Category extends Obj  {

    /**
     * The {@link Genai.Project} this instance is linked to.
     */
    readonly projects?: Array_Type<Genai.Project>;
    withProjects(projects: Array_Type<Genai.Project> | Array<IGenai.Project> | null): Genai.Tag.Category;
    ...
    withTypeIdent(typeIdent: string | null): Genai.Tag.Category;
     ...
     */
    readonly id: string;
    withId(id: string): Genai.Tag.Category;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Genai.Tag.Category;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): Genai.Tag.Category;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Genai.Tag.Category;
    ...
    withVersion(version: number | null): Genai.Tag.Category;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Genai.Tag.Category;

    /**
     * The label of the category.
     */
    readonly label: string;
    withLabel(label: string): Genai.Tag.Category;

    /**
     * The {@link Genai.Tag}s that belong to this category.
     */
    readonly tags?: Array_Type<Genai.Tag>;
    withTags(tags: Array_Type<Genai.Tag> | Array<IGenai.Tag> | null): Genai.Tag.Category;

    /**
     * The {@link User} that created this category.
     */
    readonly createdBy?: string;
    withCreatedBy(createdBy: string | null): Genai.Tag.Category;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.Tag.Category | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.Tag.Category | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.Tag.Category | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.Tag.Category | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.Tag.Category;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Tag.Category;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Tag.Category;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Tag.Category>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Tag.Category>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.Tag.Category;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Tag.Category;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Tag.Category;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.Tag.Category;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.Tag.Category;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.Tag.Category;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.Tag.Category;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.Tag.Category;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.Tag.Category;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.Tag.Category;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.Tag.Category;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.Tag.Category;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.Tag.Category;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.Tag.Category;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.Tag.Category;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.Tag.Category;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.Tag.Category;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.Tag.Category;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.Tag.Category;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.Tag.Category;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.Tag.Category;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.Tag.Category;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.Tag.Category;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.Tag.Category;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.Tag.Category;

    mergeJson(json: any): Genai.Tag.Category;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.Tag.Category;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.Tag.Category;
     ...
     */
    singletonArray(): Array_Type<Genai.Tag.Category>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.Tag.Category> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.Tag.Category> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.Tag.Category>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.Tag.Category> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.Tag.Category> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.Tag.Category> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.Tag.Category>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.Tag.Category>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.Tag.Category;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.Tag.Category;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.Tag.Category;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.Tag.Category;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.Tag.Category;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.Tag.Category;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.Tag.Category | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.Tag.Category;
     ...
     */
    static cachedEmptyInst(): Genai.Tag.Category;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.Tag.Category> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.Tag.Category;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Genai.Tag.Category>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Genai.Tag.Category>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Genai.Tag.Category> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Genai.Tag.Category>> | null;
     ...
     */
    get(include?: string): Genai.Tag.Category | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Genai.Tag.Category | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Genai.Tag.Category;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Genai.Tag.Category | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Genai.Tag.Category;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.Tag.Category | null;
     ...
     */
    create(spec?: UpsertSpec): Genai.Tag.Category | null;
     ...
     */
    static createBatch(objs: Array_Type<Genai.Tag.Category>, spec?: UpsertSpec): ObjList<Genai.Tag.Category> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Genai.Tag.Category>, spec?: CreateBatchObjStreamSpec): ObjList<Genai.Tag.Category> | null;
     ...
     */
    update(srcObj?: Genai.Tag.Category, spec?: UpsertSpec): Genai.Tag.Category | null;
     ...
     */
    upsert(srcObj?: Genai.Tag.Category, spec?: UpsertSpec): Genai.Tag.Category | null;
     ...
     */
    merge(spec?: MergeSpec): Genai.Tag.Category | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Genai.Tag.Category | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Genai.Tag.Category | null;
     ...
     */
    static updateBatch(objs: Array_Type<Genai.Tag.Category>, srcObjs?: Array_Type<Genai.Tag.Category>, spec?: UpsertSpec): ObjList<Genai.Tag.Category> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Genai.Tag.Category> | null>, spec?: UpsertSpec): ObjList<Genai.Tag.Category> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Genai.Tag.Category>, srcObjs?: Array_Type<Genai.Tag.Category>, spec?: UpsertSpec): ObjList<Genai.Tag.Category> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Genai.Tag.Category> | null>, spec?: UpsertSpec): ObjList<Genai.Tag.Category> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Genai.Tag.Category>, spec?: TouchSpec): ObjList<Genai.Tag.Category> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.Tag.Category>, spec?: MergeSpec): ObjList<Genai.Tag.Category> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.Tag.Category>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.Tag.Category> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Genai.Tag.Category> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.Tag.Category> | null;
     ...
     */
    static mergeAll(mergeObj: Genai.Tag.Category, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Genai.Tag.Category, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Genai.Tag.Category>, spec?: UpsertSpec): ObjList<Genai.Tag.Category> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Genai.Tag.Category>, spec?: UpsertSpec): ObjList<Genai.Tag.Category> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Genai.Tag.Category | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Genai.Tag.Category>): ObjList<Genai.Tag.Category>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<Genai.Tag.Category>): ObjList<Genai.Tag.Category>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Genai.Tag.Category>): ObjList<Genai.Tag.Category>;
     ...
     */
    static afterCreate(objs: Array_Type<Genai.Tag.Category>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Genai.Tag.Category>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Genai.Tag.Category>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Genai.Tag.Category>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Genai.Tag.Category>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.Tag.Category | null;
     ...
     */
    withoutIdentity(): Genai.Tag.Category | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Genai.Tag.Category>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Genai.Tag.Category, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Genai.Tag.Category>, callback?: λFunction<Genai.Tag.Category | null, Genai.Tag.Category | null>): ObjList<Genai.Tag.Category>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Genai.Tag.Category>, callback?: λFunction<Genai.Tag.Category | null, Genai.Tag.Category | null>): Array_Type<ObjError> | null;
