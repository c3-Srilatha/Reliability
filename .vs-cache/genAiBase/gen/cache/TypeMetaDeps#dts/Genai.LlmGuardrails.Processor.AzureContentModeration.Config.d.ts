// TypeScript definitions for the C3 type Genai.LlmGuardrails.Processor.AzureContentModeration.Config

/**
 * Configuration for the Azure Content Moderation.
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.LlmGuardrails.Processor.AzureContentModeration.Config
 */
declare namespace Genai.LlmGuardrails.Processor.AzureContentModeration {
...
declare namespace Genai.LlmGuardrails.Processor.AzureContentModeration {
  export class Config extends Obj  {
    ...
    withConfigOverride(configOverride: string | null): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;

    static readonly configOverride?: string;

    readonly secretOverride?: string;
    withSecretOverride(secretOverride: string | null): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;
    ...
    withIssues(issues: Array_Type<string> | Array<string> | null): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;
    ...
    withApiKey(apiKey: string): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;
    ...
    withEndPoint(endPoint: string): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;
    ...
    withRegion(region: string): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;
    ...
    withApiVersion(apiVersion: string): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.LlmGuardrails.Processor.AzureContentModeration.Config | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.LlmGuardrails.Processor.AzureContentModeration.Config | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.LlmGuardrails.Processor.AzureContentModeration.Config | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.LlmGuardrails.Processor.AzureContentModeration.Config | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;
     ...
     * This method is used during live metadata update
     */
    static replaceType(old: Type, new_: Type): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.LlmGuardrails.Processor.AzureContentModeration.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.LlmGuardrails.Processor.AzureContentModeration.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.LlmGuardrails.Processor.AzureContentModeration.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.LlmGuardrails.Processor.AzureContentModeration.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    static validateObj(): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;
     ...
     * @see #defaultField
     */
    static withField(field: string, value: any, doNotConvert?: boolean): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;
     ...
     * @see #defaultField
     */
    static withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;
     ...
     * @return new Obj
     */
    static withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;
     ...
     * @return new Obj
     */
    static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;
     ...
     * @see #withoutField
     */
    static withoutFieldAtPath(path: string): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;
     ...
     * @see #removeField
     */
    static withoutField(field: string): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;
     ...
     * @see #removeField
     */
    static withoutField(field: FieldType): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;
     ...
     * @return new Obj with removed fields
     */
    static withoutFields(fields: Array_Type<string>): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;
     ...
     * @return new Obj with removed fields
     */
    static withoutFieldsByType(fields: Array_Type<FieldType>): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    static withoutSecretFields(): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;
     ...
     * @see FieldType#defaultValue
     */
    static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;
     ...
     * @see #unsetField
     */
    static defaultField(field: string): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;
     ...
     * @see #unsetField
     */
    static defaultField(field: FieldType): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;
     ...
     * @see #removeField
     */
    static unsetField(field: string): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;
     ...
     * @see #removeField
     */
    static unsetField(field: FieldType): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;
     ...
     * @see #unsetField
     */
    static removeField(field: string): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;
     ...
     * @see #unsetField
     */
    static removeField(field: FieldType): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj, otherFieldsFilter: Type): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;
     ...
     *        the same key or index.
     */
    static mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;
     ...
     * traverse child reference and collection fields.
     */
    static mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;

    mergeJson(json: any): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;

    static mergeJson(json: any): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;
     ...
     * @return Obj with child references merged
     */
    static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;
     ...
     * references with same name and collection elements at same index or key.
     */
    static sumObj(other: Obj, deep?: boolean): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;
     ...
     */
    singletonArray(): Array_Type<Genai.LlmGuardrails.Processor.AzureContentModeration.Config>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonArray(): Array_Type<Genai.LlmGuardrails.Processor.AzureContentModeration.Config>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.LlmGuardrails.Processor.AzureContentModeration.Config> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.LlmGuardrails.Processor.AzureContentModeration.Config> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.LlmGuardrails.Processor.AzureContentModeration.Config>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonSet(): Set_Type<Genai.LlmGuardrails.Processor.AzureContentModeration.Config>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.LlmGuardrails.Processor.AzureContentModeration.Config> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.LlmGuardrails.Processor.AzureContentModeration.Config> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.LlmGuardrails.Processor.AzureContentModeration.Config> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.LlmGuardrails.Processor.AzureContentModeration.Config>;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    static toBuilder(): ObjBuilder<Genai.LlmGuardrails.Processor.AzureContentModeration.Config>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.LlmGuardrails.Processor.AzureContentModeration.Config>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    static afterMake(): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;
     ...
     */
    static cachedEmptyInst(): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.LlmGuardrails.Processor.AzureContentModeration.Config> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;
     ...
     */
    static allCached(): Stream<Genai.LlmGuardrails.Processor.AzureContentModeration.Config> | null;
     ...
     */
    static find(filter?: string): Stream<Genai.LlmGuardrails.Processor.AzureContentModeration.Config> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<Genai.LlmGuardrails.Processor.AzureContentModeration.Config> | null;

    /**
     * @return cached instance.
     */
    getCached(): Genai.LlmGuardrails.Processor.AzureContentModeration.Config | null;

    /**
     * @return cached instance.
     */
    static getCached(): Genai.LlmGuardrails.Processor.AzureContentModeration.Config | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string): Genai.LlmGuardrails.Processor.AzureContentModeration.Config | null;
     ...
     */
    static produce(key: string): Genai.LlmGuardrails.Processor.AzureContentModeration.Config | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, Genai.LlmGuardrails.Processor.AzureContentModeration.Config> | null;
     ...
     */
    getConfig(): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;
     ...
     * Note that typical pattern is to use Configurable#config instead of this method.
     */
    static getConfig(): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;
     ...
     */
    getSecret(): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;
     ...
     * Note that typical pattern is to use Configurable#configWithSecrets instead of this method.
     */
    static getSecret(): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;
     ...
     */
    withConfigKey(configKey: string): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;
     ...
     *     config.configKey() => "folder1/abc"
     */
    static withConfigKey(configKey: string): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;

    /**
     * @return copy without config key.
     */
    withoutConfigKey(): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;

    /**
     * @return copy without config key.
     */
    static withoutConfigKey(): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;

    /**
     * @return return cached config instance for provided config key.
     */
    static forConfigKey(configKey: string): Genai.LlmGuardrails.Processor.AzureContentModeration.Config | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string>): Stream<Genai.LlmGuardrails.Processor.AzureContentModeration.Config> | null;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: Genai.LlmGuardrails.Processor.AzureContentModeration.Config, override?: string): void;
     ...
     * @see setConfigValue
     */
    static setConfigValues(from: Genai.LlmGuardrails.Processor.AzureContentModeration.Config, override?: string): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): Genai.LlmGuardrails.Processor.AzureContentModeration.Config | null;
     ...
     */
    removeSecrets(): Genai.LlmGuardrails.Processor.AzureContentModeration.Config | null;

    /**
     * @return this config without any secret values.
     */
    static removeSecrets(): Genai.LlmGuardrails.Processor.AzureContentModeration.Config | null;

    /**
     * @return this config with only secret values.
     */
    removeNonSecrets(): Genai.LlmGuardrails.Processor.AzureContentModeration.Config | null;

    /**
     * @return this config with only secret values.
     */
    static removeNonSecrets(): Genai.LlmGuardrails.Processor.AzureContentModeration.Config | null;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    validate(): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    static validate(): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;
     ...
     */
    static inst(): Genai.LlmGuardrails.Processor.AzureContentModeration.Config;
  }
}
