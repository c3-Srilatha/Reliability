// TypeScript definitions for the C3 type Genai.Query.Result.InterimStatusHistory

/**
 * The history of statuses of a {@link Genai.Query.Result} throughout its generation cycle.
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.Query.Result.InterimStatusHistory
 */
declare namespace Genai.Query.Result {
  export interface IInterimStatusHistory {
    ...
    /**
     * The interim status of the generative AI result
     */
    status?: string;

    /**
     * Used internally to ensure the correct order of interim statuses
     */
    sortIndex?: number;

    /**
     * If this status is part of a larger status update, this is its parent. {@see Genai.Query.Result#updateStatus}
     */
    statusParent?: IGenai.Query.Result.InterimStatusHistory;
 ...
 * The history of statuses of a {@link Genai.Query.Result} throughout its generation cycle.
 *
 * @remarks this represents a made instance of Genai.Query.Result.InterimStatusHistory
 */
declare namespace Genai.Query.Result {
  export class InterimStatusHistory extends Obj  {

    /**
     * Timestamp for the value.
     */
    readonly timestamp: DateTime;
    withTimestamp(timestamp: DateTime | Date | string): Genai.Query.Result.InterimStatusHistory;

    /**
     * Parent/owning obj instance.
     */
    readonly parent: Genai.Query.Result;
    withParent(parent: IGenai.Query.Result): Genai.Query.Result.InterimStatusHistory;

    /**
     * The interim status of the generative AI result
     */
    readonly status?: string;
    withStatus(status: string | null): Genai.Query.Result.InterimStatusHistory;

    /**
     * Used internally to ensure the correct order of interim statuses
     */
    readonly sortIndex?: number;
    withSortIndex(sortIndex: number | null): Genai.Query.Result.InterimStatusHistory;

    /**
     * If this status is part of a larger status update, this is its parent. {@see Genai.Query.Result#updateStatus}
     */
    readonly statusParent?: Genai.Query.Result.InterimStatusHistory;
    withStatusParent(statusParent: IGenai.Query.Result.InterimStatusHistory | null): Genai.Query.Result.InterimStatusHistory;
     ...
     */
    readonly id: string;
    withId(id: string): Genai.Query.Result.InterimStatusHistory;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Genai.Query.Result.InterimStatusHistory;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): Genai.Query.Result.InterimStatusHistory;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Genai.Query.Result.InterimStatusHistory;
    ...
    withVersion(version: number | null): Genai.Query.Result.InterimStatusHistory;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Genai.Query.Result.InterimStatusHistory;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.Query.Result.InterimStatusHistory | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.Query.Result.InterimStatusHistory | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.Query.Result.InterimStatusHistory | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.Query.Result.InterimStatusHistory | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.Query.Result.InterimStatusHistory;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Query.Result.InterimStatusHistory;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Query.Result.InterimStatusHistory;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Query.Result.InterimStatusHistory>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Query.Result.InterimStatusHistory>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.Query.Result.InterimStatusHistory;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Query.Result.InterimStatusHistory;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Query.Result.InterimStatusHistory;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.Query.Result.InterimStatusHistory;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.Query.Result.InterimStatusHistory;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.Query.Result.InterimStatusHistory;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.Query.Result.InterimStatusHistory;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.Query.Result.InterimStatusHistory;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.Query.Result.InterimStatusHistory;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.Query.Result.InterimStatusHistory;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.Query.Result.InterimStatusHistory;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.Query.Result.InterimStatusHistory;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.Query.Result.InterimStatusHistory;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.Query.Result.InterimStatusHistory;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.Query.Result.InterimStatusHistory;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.Query.Result.InterimStatusHistory;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.Query.Result.InterimStatusHistory;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.Query.Result.InterimStatusHistory;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.Query.Result.InterimStatusHistory;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.Query.Result.InterimStatusHistory;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.Query.Result.InterimStatusHistory;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.Query.Result.InterimStatusHistory;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.Query.Result.InterimStatusHistory;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.Query.Result.InterimStatusHistory;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.Query.Result.InterimStatusHistory;

    mergeJson(json: any): Genai.Query.Result.InterimStatusHistory;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.Query.Result.InterimStatusHistory;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.Query.Result.InterimStatusHistory;
     ...
     */
    singletonArray(): Array_Type<Genai.Query.Result.InterimStatusHistory>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.Query.Result.InterimStatusHistory> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.Query.Result.InterimStatusHistory> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.Query.Result.InterimStatusHistory>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.Query.Result.InterimStatusHistory> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.Query.Result.InterimStatusHistory> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.Query.Result.InterimStatusHistory> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.Query.Result.InterimStatusHistory>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.Query.Result.InterimStatusHistory>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.Query.Result.InterimStatusHistory;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.Query.Result.InterimStatusHistory;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.Query.Result.InterimStatusHistory;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.Query.Result.InterimStatusHistory;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.Query.Result.InterimStatusHistory;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.Query.Result.InterimStatusHistory;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.Query.Result.InterimStatusHistory | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.Query.Result.InterimStatusHistory;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.Query.Result.InterimStatusHistory;
     ...
     */
    static cachedEmptyInst(): Genai.Query.Result.InterimStatusHistory;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.Query.Result.InterimStatusHistory> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.Query.Result.InterimStatusHistory;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Genai.Query.Result.InterimStatusHistory>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Genai.Query.Result.InterimStatusHistory>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Genai.Query.Result.InterimStatusHistory> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Genai.Query.Result.InterimStatusHistory>> | null;
     ...
     */
    get(include?: string): Genai.Query.Result.InterimStatusHistory | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Genai.Query.Result.InterimStatusHistory | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Genai.Query.Result.InterimStatusHistory;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Genai.Query.Result.InterimStatusHistory | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Genai.Query.Result.InterimStatusHistory;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.Query.Result.InterimStatusHistory | null;
     ...
     */
    create(spec?: UpsertSpec): Genai.Query.Result.InterimStatusHistory | null;
     ...
     */
    static createBatch(objs: Array_Type<Genai.Query.Result.InterimStatusHistory>, spec?: UpsertSpec): ObjList<Genai.Query.Result.InterimStatusHistory> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Genai.Query.Result.InterimStatusHistory>, spec?: CreateBatchObjStreamSpec): ObjList<Genai.Query.Result.InterimStatusHistory> | null;
     ...
     */
    update(srcObj?: Genai.Query.Result.InterimStatusHistory, spec?: UpsertSpec): Genai.Query.Result.InterimStatusHistory | null;
     ...
     */
    upsert(srcObj?: Genai.Query.Result.InterimStatusHistory, spec?: UpsertSpec): Genai.Query.Result.InterimStatusHistory | null;
     ...
     */
    merge(spec?: MergeSpec): Genai.Query.Result.InterimStatusHistory | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Genai.Query.Result.InterimStatusHistory | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Genai.Query.Result.InterimStatusHistory | null;
     ...
     */
    static updateBatch(objs: Array_Type<Genai.Query.Result.InterimStatusHistory>, srcObjs?: Array_Type<Genai.Query.Result.InterimStatusHistory>, spec?: UpsertSpec): ObjList<Genai.Query.Result.InterimStatusHistory> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Genai.Query.Result.InterimStatusHistory> | null>, spec?: UpsertSpec): ObjList<Genai.Query.Result.InterimStatusHistory> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Genai.Query.Result.InterimStatusHistory>, srcObjs?: Array_Type<Genai.Query.Result.InterimStatusHistory>, spec?: UpsertSpec): ObjList<Genai.Query.Result.InterimStatusHistory> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Genai.Query.Result.InterimStatusHistory> | null>, spec?: UpsertSpec): ObjList<Genai.Query.Result.InterimStatusHistory> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Genai.Query.Result.InterimStatusHistory>, spec?: TouchSpec): ObjList<Genai.Query.Result.InterimStatusHistory> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.Query.Result.InterimStatusHistory>, spec?: MergeSpec): ObjList<Genai.Query.Result.InterimStatusHistory> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.Query.Result.InterimStatusHistory>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.Query.Result.InterimStatusHistory> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Genai.Query.Result.InterimStatusHistory> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.Query.Result.InterimStatusHistory> | null;
     ...
     */
    static mergeAll(mergeObj: Genai.Query.Result.InterimStatusHistory, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Genai.Query.Result.InterimStatusHistory, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Genai.Query.Result.InterimStatusHistory>, spec?: UpsertSpec): ObjList<Genai.Query.Result.InterimStatusHistory> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Genai.Query.Result.InterimStatusHistory>, spec?: UpsertSpec): ObjList<Genai.Query.Result.InterimStatusHistory> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Genai.Query.Result.InterimStatusHistory | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Genai.Query.Result.InterimStatusHistory>): ObjList<Genai.Query.Result.InterimStatusHistory>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<Genai.Query.Result.InterimStatusHistory>): ObjList<Genai.Query.Result.InterimStatusHistory>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Genai.Query.Result.InterimStatusHistory>): ObjList<Genai.Query.Result.InterimStatusHistory>;
     ...
     */
    static afterCreate(objs: Array_Type<Genai.Query.Result.InterimStatusHistory>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Genai.Query.Result.InterimStatusHistory>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Genai.Query.Result.InterimStatusHistory>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Genai.Query.Result.InterimStatusHistory>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Genai.Query.Result.InterimStatusHistory>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.Query.Result.InterimStatusHistory | null;
     ...
     */
    withoutIdentity(): Genai.Query.Result.InterimStatusHistory | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Genai.Query.Result.InterimStatusHistory>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Genai.Query.Result.InterimStatusHistory, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Genai.Query.Result.InterimStatusHistory>, callback?: λFunction<Genai.Query.Result.InterimStatusHistory | null, Genai.Query.Result.InterimStatusHistory | null>): ObjList<Genai.Query.Result.InterimStatusHistory>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Genai.Query.Result.InterimStatusHistory>, callback?: λFunction<Genai.Query.Result.InterimStatusHistory | null, Genai.Query.Result.InterimStatusHistory | null>): Array_Type<ObjError> | null;
