// TypeScript definitions for the C3 type Genai.Mail.Template

/**
 * A template for an email that can be sent to users.
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.Mail.Template
 */
declare namespace Genai.Mail {
  export interface ITemplate {
     ...
     */
    cc?: Array_Type<string> | Array<string>;

    /**
     * A list of email addresses to add to the Bcc field
     */
    bcc?: Array_Type<string> | Array<string>;
     ...
     */
    contentTemplateMetaPath?: string;
     ...
     */
    commonReplaceTokens?: Array_Type<string> | Array<string>;
     ...
     * the token.
     */
    customReplaceTokens?: Map_Type<string, string> | {[key: string]: string};
...
declare namespace Genai.Mail {
  export class Template extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): Genai.Mail.Template;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Genai.Mail.Template;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): Genai.Mail.Template;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Genai.Mail.Template;
    ...
    withVersion(version: number | null): Genai.Mail.Template;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Genai.Mail.Template;

    /**
     * The email address that will appear in the "From" field of the email
     */
    readonly from?: string;
    withFrom(from: string | null): Genai.Mail.Template;

    /**
     * Optional email subject
     */
    readonly subject?: string;
    withSubject(subject: string | null): Genai.Mail.Template;

    /**
     * A list of email addresses to add to the Cc field
     */
    readonly cc?: Array_Type<string>;
    withCc(cc: Array_Type<string> | Array<string> | null): Genai.Mail.Template;

    /**
     * A list of email addresses to add to the Bcc field
     */
    readonly bcc?: Array_Type<string>;
    withBcc(bcc: Array_Type<string> | Array<string> | null): Genai.Mail.Template;

    /**
     * A token to use to dynamically populate the {@link Mail#to} field
     */
    readonly dynamicTo?: string;
    withDynamicTo(dynamicTo: string | null): Genai.Mail.Template;

    /**
     * A token to use to dynamically populate the {@link Mail#cc} field
     */
    readonly dynamicCc?: string;
    withDynamicCc(dynamicCc: string | null): Genai.Mail.Template;

    /**
     * A token to use to dynamically populate the {@link Mail#bcc} field
     */
    readonly dynamicBcc?: string;
    withDynamicBcc(dynamicBcc: string | null): Genai.Mail.Template;
     ...
     * Example: `'meta://genAiSearch/resource/emailTemplates/newUserInvitationEmail.html'
     */
    readonly contentTemplateMetaPath?: string;
    withContentTemplateMetaPath(contentTemplateMetaPath: string | null): Genai.Mail.Template;
     ...
     * If a #contentTemplateMetaPath is provided, it will be used instead.
     */
    readonly contentTemplateString?: string;
    withContentTemplateString(contentTemplateString: string | null): Genai.Mail.Template;
     ...
     * tokens can be provided instead, where the expression is baked into the code base.
     */
    readonly commonReplaceTokens?: Array_Type<string>;
    withCommonReplaceTokens(commonReplaceTokens: Array_Type<string> | Array<string> | null): Genai.Mail.Template;
     ...
     * the token.
     */
    readonly customReplaceTokens?: Map_Type<string, string>;
    withCustomReplaceTokens(customReplaceTokens: Map_Type<string, string> | {[key: string]: string} | null): Genai.Mail.Template;

    /**
     * The content type to use for the email.
     */
    readonly contentType?: string;
    withContentType(contentType: string | null): Genai.Mail.Template;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.Mail.Template | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.Mail.Template | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.Mail.Template | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.Mail.Template | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.Mail.Template;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Mail.Template;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Mail.Template;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Mail.Template>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Mail.Template>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.Mail.Template;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Mail.Template;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Mail.Template;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.Mail.Template;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.Mail.Template;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.Mail.Template;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.Mail.Template;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.Mail.Template;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.Mail.Template;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.Mail.Template;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.Mail.Template;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.Mail.Template;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.Mail.Template;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.Mail.Template;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.Mail.Template;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.Mail.Template;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.Mail.Template;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.Mail.Template;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.Mail.Template;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.Mail.Template;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.Mail.Template;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.Mail.Template;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.Mail.Template;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.Mail.Template;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.Mail.Template;

    mergeJson(json: any): Genai.Mail.Template;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.Mail.Template;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.Mail.Template;
     ...
     */
    singletonArray(): Array_Type<Genai.Mail.Template>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.Mail.Template> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.Mail.Template> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.Mail.Template>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.Mail.Template> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.Mail.Template> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.Mail.Template> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.Mail.Template>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.Mail.Template>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.Mail.Template;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.Mail.Template;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.Mail.Template;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.Mail.Template;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.Mail.Template;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.Mail.Template;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.Mail.Template | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.Mail.Template;
     ...
     */
    static cachedEmptyInst(): Genai.Mail.Template;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.Mail.Template> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.Mail.Template;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Genai.Mail.Template>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Genai.Mail.Template>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Genai.Mail.Template> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Genai.Mail.Template>> | null;
     ...
     */
    get(include?: string): Genai.Mail.Template | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Genai.Mail.Template | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Genai.Mail.Template;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Genai.Mail.Template | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Genai.Mail.Template;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.Mail.Template | null;
     ...
     */
    create(spec?: UpsertSpec): Genai.Mail.Template | null;
     ...
     */
    static createBatch(objs: Array_Type<Genai.Mail.Template>, spec?: UpsertSpec): ObjList<Genai.Mail.Template> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Genai.Mail.Template>, spec?: CreateBatchObjStreamSpec): ObjList<Genai.Mail.Template> | null;
     ...
     */
    update(srcObj?: Genai.Mail.Template, spec?: UpsertSpec): Genai.Mail.Template | null;
     ...
     */
    upsert(srcObj?: Genai.Mail.Template, spec?: UpsertSpec): Genai.Mail.Template | null;
     ...
     */
    merge(spec?: MergeSpec): Genai.Mail.Template | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Genai.Mail.Template | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Genai.Mail.Template | null;
     ...
     */
    static updateBatch(objs: Array_Type<Genai.Mail.Template>, srcObjs?: Array_Type<Genai.Mail.Template>, spec?: UpsertSpec): ObjList<Genai.Mail.Template> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Genai.Mail.Template> | null>, spec?: UpsertSpec): ObjList<Genai.Mail.Template> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Genai.Mail.Template>, srcObjs?: Array_Type<Genai.Mail.Template>, spec?: UpsertSpec): ObjList<Genai.Mail.Template> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Genai.Mail.Template> | null>, spec?: UpsertSpec): ObjList<Genai.Mail.Template> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Genai.Mail.Template>, spec?: TouchSpec): ObjList<Genai.Mail.Template> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.Mail.Template>, spec?: MergeSpec): ObjList<Genai.Mail.Template> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.Mail.Template>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.Mail.Template> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Genai.Mail.Template> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.Mail.Template> | null;
     ...
     */
    static mergeAll(mergeObj: Genai.Mail.Template, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Genai.Mail.Template, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Genai.Mail.Template>, spec?: UpsertSpec): ObjList<Genai.Mail.Template> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Genai.Mail.Template>, spec?: UpsertSpec): ObjList<Genai.Mail.Template> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Genai.Mail.Template | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Genai.Mail.Template>): ObjList<Genai.Mail.Template>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<Genai.Mail.Template>): ObjList<Genai.Mail.Template>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Genai.Mail.Template>): ObjList<Genai.Mail.Template>;
     ...
     */
    static afterCreate(objs: Array_Type<Genai.Mail.Template>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Genai.Mail.Template>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Genai.Mail.Template>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Genai.Mail.Template>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Genai.Mail.Template>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.Mail.Template | null;
     ...
     */
    withoutIdentity(): Genai.Mail.Template | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Genai.Mail.Template>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Genai.Mail.Template, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Genai.Mail.Template>, callback?: λFunction<Genai.Mail.Template | null, Genai.Mail.Template | null>): ObjList<Genai.Mail.Template>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Genai.Mail.Template>, callback?: λFunction<Genai.Mail.Template | null, Genai.Mail.Template | null>): Array_Type<ObjError> | null;
