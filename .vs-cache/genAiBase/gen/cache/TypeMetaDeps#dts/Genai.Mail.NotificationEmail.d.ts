// TypeScript definitions for the C3 type Genai.Mail.NotificationEmail
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.Mail.NotificationEmail
 */
 ...
 */
declare namespace Genai.Mail {
  export class NotificationEmail extends Obj  {
    ...
    withTypeIdent(typeIdent: string | null): Genai.Mail.NotificationEmail;
     ...
     */
    readonly id: string;
    withId(id: string): Genai.Mail.NotificationEmail;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Genai.Mail.NotificationEmail;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): Genai.Mail.NotificationEmail;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Genai.Mail.NotificationEmail;
    ...
    withVersion(version: number | null): Genai.Mail.NotificationEmail;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Genai.Mail.NotificationEmail;

    /**
     * A description of the email and when/why it is sent.
     */
    readonly description?: string;
    withDescription(description: string | null): Genai.Mail.NotificationEmail;

    /**
     * The id of the {@link Genai.Mail.Template} to use for the email.
     */
    readonly emailTemplateId?: string;
    withEmailTemplateId(emailTemplateId: string | null): Genai.Mail.NotificationEmail;

    /**
     * This can be used to filter on emails that have not yet been sent. If an email has been sent, this field will be
     * populated with the time the email was sent.
     */
    readonly lastSent?: DateTime;
    withLastSent(lastSent: DateTime | Date | string | null): Genai.Mail.NotificationEmail;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.Mail.NotificationEmail | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.Mail.NotificationEmail | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.Mail.NotificationEmail | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.Mail.NotificationEmail | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.Mail.NotificationEmail;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Mail.NotificationEmail;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Mail.NotificationEmail;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Mail.NotificationEmail>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Mail.NotificationEmail>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.Mail.NotificationEmail;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Mail.NotificationEmail;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Mail.NotificationEmail;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.Mail.NotificationEmail;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.Mail.NotificationEmail;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.Mail.NotificationEmail;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.Mail.NotificationEmail;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.Mail.NotificationEmail;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.Mail.NotificationEmail;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.Mail.NotificationEmail;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.Mail.NotificationEmail;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.Mail.NotificationEmail;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.Mail.NotificationEmail;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.Mail.NotificationEmail;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.Mail.NotificationEmail;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.Mail.NotificationEmail;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.Mail.NotificationEmail;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.Mail.NotificationEmail;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.Mail.NotificationEmail;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.Mail.NotificationEmail;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.Mail.NotificationEmail;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.Mail.NotificationEmail;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.Mail.NotificationEmail;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.Mail.NotificationEmail;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.Mail.NotificationEmail;

    mergeJson(json: any): Genai.Mail.NotificationEmail;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.Mail.NotificationEmail;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.Mail.NotificationEmail;
     ...
     */
    singletonArray(): Array_Type<Genai.Mail.NotificationEmail>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.Mail.NotificationEmail> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.Mail.NotificationEmail> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.Mail.NotificationEmail>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.Mail.NotificationEmail> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.Mail.NotificationEmail> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.Mail.NotificationEmail> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.Mail.NotificationEmail>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.Mail.NotificationEmail>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.Mail.NotificationEmail;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.Mail.NotificationEmail;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.Mail.NotificationEmail;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.Mail.NotificationEmail;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.Mail.NotificationEmail;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.Mail.NotificationEmail;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.Mail.NotificationEmail | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.Mail.NotificationEmail;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.Mail.NotificationEmail;
     ...
     */
    static cachedEmptyInst(): Genai.Mail.NotificationEmail;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.Mail.NotificationEmail> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.Mail.NotificationEmail;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Genai.Mail.NotificationEmail>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Genai.Mail.NotificationEmail>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Genai.Mail.NotificationEmail> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Genai.Mail.NotificationEmail>> | null;
     ...
     */
    get(include?: string): Genai.Mail.NotificationEmail | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Genai.Mail.NotificationEmail | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Genai.Mail.NotificationEmail;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Genai.Mail.NotificationEmail | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Genai.Mail.NotificationEmail;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.Mail.NotificationEmail | null;
     ...
     */
    create(spec?: UpsertSpec): Genai.Mail.NotificationEmail | null;
     ...
     */
    static createBatch(objs: Array_Type<Genai.Mail.NotificationEmail>, spec?: UpsertSpec): ObjList<Genai.Mail.NotificationEmail> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Genai.Mail.NotificationEmail>, spec?: CreateBatchObjStreamSpec): ObjList<Genai.Mail.NotificationEmail> | null;
     ...
     */
    update(srcObj?: Genai.Mail.NotificationEmail, spec?: UpsertSpec): Genai.Mail.NotificationEmail | null;
     ...
     */
    upsert(srcObj?: Genai.Mail.NotificationEmail, spec?: UpsertSpec): Genai.Mail.NotificationEmail | null;
     ...
     */
    merge(spec?: MergeSpec): Genai.Mail.NotificationEmail | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Genai.Mail.NotificationEmail | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Genai.Mail.NotificationEmail | null;
     ...
     */
    static updateBatch(objs: Array_Type<Genai.Mail.NotificationEmail>, srcObjs?: Array_Type<Genai.Mail.NotificationEmail>, spec?: UpsertSpec): ObjList<Genai.Mail.NotificationEmail> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Genai.Mail.NotificationEmail> | null>, spec?: UpsertSpec): ObjList<Genai.Mail.NotificationEmail> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Genai.Mail.NotificationEmail>, srcObjs?: Array_Type<Genai.Mail.NotificationEmail>, spec?: UpsertSpec): ObjList<Genai.Mail.NotificationEmail> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Genai.Mail.NotificationEmail> | null>, spec?: UpsertSpec): ObjList<Genai.Mail.NotificationEmail> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Genai.Mail.NotificationEmail>, spec?: TouchSpec): ObjList<Genai.Mail.NotificationEmail> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.Mail.NotificationEmail>, spec?: MergeSpec): ObjList<Genai.Mail.NotificationEmail> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.Mail.NotificationEmail>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.Mail.NotificationEmail> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Genai.Mail.NotificationEmail> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.Mail.NotificationEmail> | null;
     ...
     */
    static mergeAll(mergeObj: Genai.Mail.NotificationEmail, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Genai.Mail.NotificationEmail, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Genai.Mail.NotificationEmail>, spec?: UpsertSpec): ObjList<Genai.Mail.NotificationEmail> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Genai.Mail.NotificationEmail>, spec?: UpsertSpec): ObjList<Genai.Mail.NotificationEmail> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Genai.Mail.NotificationEmail | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Genai.Mail.NotificationEmail>): ObjList<Genai.Mail.NotificationEmail>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<Genai.Mail.NotificationEmail>): ObjList<Genai.Mail.NotificationEmail>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Genai.Mail.NotificationEmail>): ObjList<Genai.Mail.NotificationEmail>;
     ...
     */
    static afterCreate(objs: Array_Type<Genai.Mail.NotificationEmail>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Genai.Mail.NotificationEmail>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Genai.Mail.NotificationEmail>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Genai.Mail.NotificationEmail>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Genai.Mail.NotificationEmail>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.Mail.NotificationEmail | null;
     ...
     */
    withoutIdentity(): Genai.Mail.NotificationEmail | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Genai.Mail.NotificationEmail>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Genai.Mail.NotificationEmail, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Genai.Mail.NotificationEmail>, callback?: λFunction<Genai.Mail.NotificationEmail | null, Genai.Mail.NotificationEmail | null>): ObjList<Genai.Mail.NotificationEmail>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Genai.Mail.NotificationEmail>, callback?: λFunction<Genai.Mail.NotificationEmail | null, Genai.Mail.NotificationEmail | null>): Array_Type<ObjError> | null;
