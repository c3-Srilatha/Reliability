// TypeScript definitions for the C3 type Genai.SourceFile.Job.ChunkMapReduce
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.SourceFile.Job.ChunkMapReduce
 */
declare namespace Genai.SourceFile.Job {
  export interface IChunkMapReduce {
 ...
 */
declare namespace Genai.SourceFile.Job {
  export class ChunkMapReduce extends Obj  {

    /**
     * current or last job execution for this instance
     */
    readonly run?: MapReduceRun;
    withRun(run: IMapReduceRun | null): Genai.SourceFile.Job.ChunkMapReduce;

    /**
     * previous job executions for this instance
     */
    readonly runs?: Array_Type<MapReduceRun>;
    withRuns(runs: Array_Type<MapReduceRun> | Array<IMapReduceRun> | null): Genai.SourceFile.Job.ChunkMapReduce;

    /**
     * FOR INTERNAL USE ONLY - Specify options in call to {@link start}.
     */
    readonly options?: Obj;
    withOptions(options: IObj | null): Genai.SourceFile.Job.ChunkMapReduce;
    ...
    withOnCompleteCallback(onCompleteCallback: IJobBase.Callback | null): Genai.SourceFile.Job.ChunkMapReduce;
    ...
    withPriority(priority: number | null): Genai.SourceFile.Job.ChunkMapReduce;
    ...
    withDisabled(disabled: boolean): Genai.SourceFile.Job.ChunkMapReduce;
    ...
    withMaxConcurrency(maxConcurrency: number | null): Genai.SourceFile.Job.ChunkMapReduce;
    ...
    withMaxConcurrencyPerNode(maxConcurrencyPerNode: number | null): Genai.SourceFile.Job.ChunkMapReduce;
    ...
    withRunAsUser(runAsUser: boolean): Genai.SourceFile.Job.ChunkMapReduce;

    /**
     * Don't set this field in the MapReduce job, set it in the MapReduceOptions when calling `start`.
     */
    readonly nodePool?: string;
    withNodePool(nodePool: string | null): Genai.SourceFile.Job.ChunkMapReduce;
    ...
    withSkipIfRunning(skipIfRunning: boolean): Genai.SourceFile.Job.ChunkMapReduce;

    /**
     * Set to between 1 and 5 to enable auto recovery. See {@link invalidation-queues.c3doc Invalidation Queues} for detailed documentation.
     */
    readonly numAutoRecoveryAttempts?: number;
    withNumAutoRecoveryAttempts(numAutoRecoveryAttempts: number | null): Genai.SourceFile.Job.ChunkMapReduce;
    ...
    withTargetType(targetType: IType | null): Genai.SourceFile.Job.ChunkMapReduce;
    ...
    withUseFileSystemForInterVals(useFileSystemForInterVals: boolean): Genai.SourceFile.Job.ChunkMapReduce;
    ...
    withUseBatchIdsForReadInput(useBatchIdsForReadInput: boolean): Genai.SourceFile.Job.ChunkMapReduce;
    ...
    withInclude(include: string | null): Genai.SourceFile.Job.ChunkMapReduce;

    /**
     * optional filter spec
     */
    readonly filter?: string;
    withFilter(filter: string | null): Genai.SourceFile.Job.ChunkMapReduce;
    ...
    withOrder(order: string | null): Genai.SourceFile.Job.ChunkMapReduce;
    ...
    withLimit(limit: number | null): Genai.SourceFile.Job.ChunkMapReduce;
    ...
    withSamplePct(samplePct: number | null): Genai.SourceFile.Job.ChunkMapReduce;
    ...
    withBatchSize(batchSize: number | null): Genai.SourceFile.Job.ChunkMapReduce;
    ...
    withSubBatchSize(subBatchSize: number | null): Genai.SourceFile.Job.ChunkMapReduce;
    ...
    withNumBatches(numBatches: number | null): Genai.SourceFile.Job.ChunkMapReduce;
    ...
    withAbortOnError(abortOnError: boolean): Genai.SourceFile.Job.ChunkMapReduce;
    ...
    withTypeIdent(typeIdent: string | null): Genai.SourceFile.Job.ChunkMapReduce;
     ...
     */
    readonly id: string;
    withId(id: string): Genai.SourceFile.Job.ChunkMapReduce;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Genai.SourceFile.Job.ChunkMapReduce;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): Genai.SourceFile.Job.ChunkMapReduce;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Genai.SourceFile.Job.ChunkMapReduce;
    ...
    withVersion(version: number | null): Genai.SourceFile.Job.ChunkMapReduce;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Genai.SourceFile.Job.ChunkMapReduce;

    /**
     * Optional target type instance to be used as the filter for the job.  When specified, the {~link map} function will
     * only be called for that obj.
     */
    readonly targetFilter?: Genai.SourceFile;
    withTargetFilter(targetFilter: IGenai.SourceFile | null): Genai.SourceFile.Job.ChunkMapReduce;

    /**
     * Specifies chunker spec, batch size, and whether to index files on job completion
     */
    readonly spec?: Genai.SourceFile.Job.ChunkMapReduceSpec;
    withSpec(spec: IGenai.SourceFile.Job.ChunkMapReduceSpec | null): Genai.SourceFile.Job.ChunkMapReduce;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.SourceFile.Job.ChunkMapReduce | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.SourceFile.Job.ChunkMapReduce | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.SourceFile.Job.ChunkMapReduce | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.SourceFile.Job.ChunkMapReduce | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.SourceFile.Job.ChunkMapReduce;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.SourceFile.Job.ChunkMapReduce;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.SourceFile.Job.ChunkMapReduce;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.SourceFile.Job.ChunkMapReduce>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.SourceFile.Job.ChunkMapReduce>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.SourceFile.Job.ChunkMapReduce;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.SourceFile.Job.ChunkMapReduce;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.SourceFile.Job.ChunkMapReduce;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.SourceFile.Job.ChunkMapReduce;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.SourceFile.Job.ChunkMapReduce;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.SourceFile.Job.ChunkMapReduce;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.SourceFile.Job.ChunkMapReduce;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.SourceFile.Job.ChunkMapReduce;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.SourceFile.Job.ChunkMapReduce;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.SourceFile.Job.ChunkMapReduce;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.SourceFile.Job.ChunkMapReduce;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.SourceFile.Job.ChunkMapReduce;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.SourceFile.Job.ChunkMapReduce;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.SourceFile.Job.ChunkMapReduce;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.SourceFile.Job.ChunkMapReduce;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.SourceFile.Job.ChunkMapReduce;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.SourceFile.Job.ChunkMapReduce;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.SourceFile.Job.ChunkMapReduce;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.SourceFile.Job.ChunkMapReduce;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.SourceFile.Job.ChunkMapReduce;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.SourceFile.Job.ChunkMapReduce;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.SourceFile.Job.ChunkMapReduce;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.SourceFile.Job.ChunkMapReduce;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.SourceFile.Job.ChunkMapReduce;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.SourceFile.Job.ChunkMapReduce;

    mergeJson(json: any): Genai.SourceFile.Job.ChunkMapReduce;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.SourceFile.Job.ChunkMapReduce;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.SourceFile.Job.ChunkMapReduce;
     ...
     */
    singletonArray(): Array_Type<Genai.SourceFile.Job.ChunkMapReduce>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.SourceFile.Job.ChunkMapReduce> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.SourceFile.Job.ChunkMapReduce> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.SourceFile.Job.ChunkMapReduce>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.SourceFile.Job.ChunkMapReduce> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.SourceFile.Job.ChunkMapReduce> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.SourceFile.Job.ChunkMapReduce> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.SourceFile.Job.ChunkMapReduce>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.SourceFile.Job.ChunkMapReduce>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.SourceFile.Job.ChunkMapReduce;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.SourceFile.Job.ChunkMapReduce;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.SourceFile.Job.ChunkMapReduce;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.SourceFile.Job.ChunkMapReduce;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.SourceFile.Job.ChunkMapReduce;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.SourceFile.Job.ChunkMapReduce;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.SourceFile.Job.ChunkMapReduce | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.SourceFile.Job.ChunkMapReduce;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.SourceFile.Job.ChunkMapReduce;
     ...
     */
    static cachedEmptyInst(): Genai.SourceFile.Job.ChunkMapReduce;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.SourceFile.Job.ChunkMapReduce> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.SourceFile.Job.ChunkMapReduce;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Genai.SourceFile.Job.ChunkMapReduce>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Genai.SourceFile.Job.ChunkMapReduce>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Genai.SourceFile.Job.ChunkMapReduce> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Genai.SourceFile.Job.ChunkMapReduce>> | null;
     ...
     */
    get(include?: string): Genai.SourceFile.Job.ChunkMapReduce | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Genai.SourceFile.Job.ChunkMapReduce | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Genai.SourceFile.Job.ChunkMapReduce;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Genai.SourceFile.Job.ChunkMapReduce | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Genai.SourceFile.Job.ChunkMapReduce;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.SourceFile.Job.ChunkMapReduce | null;
     ...
     */
    create(spec?: UpsertSpec): Genai.SourceFile.Job.ChunkMapReduce | null;
     ...
     */
    static createBatch(objs: Array_Type<Genai.SourceFile.Job.ChunkMapReduce>, spec?: UpsertSpec): ObjList<Genai.SourceFile.Job.ChunkMapReduce> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Genai.SourceFile.Job.ChunkMapReduce>, spec?: CreateBatchObjStreamSpec): ObjList<Genai.SourceFile.Job.ChunkMapReduce> | null;
     ...
     */
    update(srcObj?: Genai.SourceFile.Job.ChunkMapReduce, spec?: UpsertSpec): Genai.SourceFile.Job.ChunkMapReduce | null;
     ...
     */
    upsert(srcObj?: Genai.SourceFile.Job.ChunkMapReduce, spec?: UpsertSpec): Genai.SourceFile.Job.ChunkMapReduce | null;
     ...
     */
    merge(spec?: MergeSpec): Genai.SourceFile.Job.ChunkMapReduce | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Genai.SourceFile.Job.ChunkMapReduce | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Genai.SourceFile.Job.ChunkMapReduce | null;
     ...
     */
    static updateBatch(objs: Array_Type<Genai.SourceFile.Job.ChunkMapReduce>, srcObjs?: Array_Type<Genai.SourceFile.Job.ChunkMapReduce>, spec?: UpsertSpec): ObjList<Genai.SourceFile.Job.ChunkMapReduce> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Genai.SourceFile.Job.ChunkMapReduce> | null>, spec?: UpsertSpec): ObjList<Genai.SourceFile.Job.ChunkMapReduce> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Genai.SourceFile.Job.ChunkMapReduce>, srcObjs?: Array_Type<Genai.SourceFile.Job.ChunkMapReduce>, spec?: UpsertSpec): ObjList<Genai.SourceFile.Job.ChunkMapReduce> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Genai.SourceFile.Job.ChunkMapReduce> | null>, spec?: UpsertSpec): ObjList<Genai.SourceFile.Job.ChunkMapReduce> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Genai.SourceFile.Job.ChunkMapReduce>, spec?: TouchSpec): ObjList<Genai.SourceFile.Job.ChunkMapReduce> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.SourceFile.Job.ChunkMapReduce>, spec?: MergeSpec): ObjList<Genai.SourceFile.Job.ChunkMapReduce> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.SourceFile.Job.ChunkMapReduce>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.SourceFile.Job.ChunkMapReduce> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Genai.SourceFile.Job.ChunkMapReduce> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.SourceFile.Job.ChunkMapReduce> | null;
     ...
     */
    static mergeAll(mergeObj: Genai.SourceFile.Job.ChunkMapReduce, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Genai.SourceFile.Job.ChunkMapReduce, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Genai.SourceFile.Job.ChunkMapReduce>, spec?: UpsertSpec): ObjList<Genai.SourceFile.Job.ChunkMapReduce> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Genai.SourceFile.Job.ChunkMapReduce>, spec?: UpsertSpec): ObjList<Genai.SourceFile.Job.ChunkMapReduce> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Genai.SourceFile.Job.ChunkMapReduce | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Genai.SourceFile.Job.ChunkMapReduce>): ObjList<Genai.SourceFile.Job.ChunkMapReduce>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<Genai.SourceFile.Job.ChunkMapReduce>): ObjList<Genai.SourceFile.Job.ChunkMapReduce>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Genai.SourceFile.Job.ChunkMapReduce>): ObjList<Genai.SourceFile.Job.ChunkMapReduce>;
     ...
     */
    static afterCreate(objs: Array_Type<Genai.SourceFile.Job.ChunkMapReduce>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Genai.SourceFile.Job.ChunkMapReduce>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Genai.SourceFile.Job.ChunkMapReduce>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Genai.SourceFile.Job.ChunkMapReduce>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Genai.SourceFile.Job.ChunkMapReduce>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.SourceFile.Job.ChunkMapReduce | null;
     ...
     */
    withoutIdentity(): Genai.SourceFile.Job.ChunkMapReduce | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Genai.SourceFile.Job.ChunkMapReduce>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Genai.SourceFile.Job.ChunkMapReduce, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Genai.SourceFile.Job.ChunkMapReduce>, callback?: λFunction<Genai.SourceFile.Job.ChunkMapReduce | null, Genai.SourceFile.Job.ChunkMapReduce | null>): ObjList<Genai.SourceFile.Job.ChunkMapReduce>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Genai.SourceFile.Job.ChunkMapReduce>, callback?: λFunction<Genai.SourceFile.Job.ChunkMapReduce | null, Genai.SourceFile.Job.ChunkMapReduce | null>): Array_Type<ObjError> | null;
     ...
     */
    static map(batch?: number, objs?: Array_Type<Genai.SourceFile>, job?: MapReduce<Genai.SourceFile, string, ObjList<Genai.SourceFile>, ObjList<Genai.SourceFile>>, subBatch?: number): Map_Type<string, ObjList<Genai.SourceFile>> | null;

    /**
     * Generates combined list of chunked files
     */
    static reduce(outKey?: string, interValues?: Array_Type<ObjList<Genai.SourceFile>>, job?: MapReduce<Genai.SourceFile, string, ObjList<Genai.SourceFile>, ObjList<Genai.SourceFile>>): ObjList<Genai.SourceFile> | Array_Type<ObjList<Genai.SourceFile>> | null;
     ...
     */
    static mapCompleted(job?: MapReduce<Genai.SourceFile, string, ObjList<Genai.SourceFile>, ObjList<Genai.SourceFile>>): void;
     ...
     */
    static completed(job?: MapReduce<Genai.SourceFile, string, ObjList<Genai.SourceFile>, ObjList<Genai.SourceFile>>): string | null;

    /**
     * Transitions files to "failed" status if chunking fails
     */
    static failed(job: MapReduce<Genai.SourceFile, string, ObjList<Genai.SourceFile>, ObjList<Genai.SourceFile>>, status: MapReduceStatus, options?: MapReduceOptions): void;
     ...
     */
    results(limit?: number = '10000'): Map_Type<string, ObjList<Genai.SourceFile> | Array_Type<ObjList<Genai.SourceFile>>> | null;
     ...
     */
    static startJob(spec: Genai.SourceFile.Job.ChunkMapReduceSpec): Genai.SourceFile.Job.ChunkMapReduce;
  }
}
