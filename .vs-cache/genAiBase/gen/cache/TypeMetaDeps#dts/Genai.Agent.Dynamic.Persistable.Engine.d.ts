// TypeScript definitions for the C3 type Genai.Agent.Dynamic.Persistable.Engine

/**
 * Engine for persisted agents. Allows running tests and saving configurations.
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.Agent.Dynamic.Persistable.Engine
 */
declare namespace Genai.Agent.Dynamic.Persistable {
...
declare namespace Genai.Agent.Dynamic.Persistable {
  export class Engine extends Obj  {
    ...
    withName(name: string): Genai.Agent.Dynamic.Persistable.Engine;

    /**
     * The unique and required id of this instance.
     */
    readonly id: string;
    withId(id: string): Genai.Agent.Dynamic.Persistable.Engine;
    ...
    with_deploymentCache(_deploymentCache: any | null): Genai.Agent.Dynamic.Persistable.Engine;

    /**
     * Errors that are captured during engine start
     */
    readonly _onStartError?: string;
    with_onStartError(_onStartError: string | null): Genai.Agent.Dynamic.Persistable.Engine;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.Agent.Dynamic.Persistable.Engine | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.Agent.Dynamic.Persistable.Engine | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.Agent.Dynamic.Persistable.Engine | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.Agent.Dynamic.Persistable.Engine | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.Agent.Dynamic.Persistable.Engine;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Agent.Dynamic.Persistable.Engine;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Agent.Dynamic.Persistable.Engine;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Agent.Dynamic.Persistable.Engine>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Agent.Dynamic.Persistable.Engine>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.Agent.Dynamic.Persistable.Engine;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Agent.Dynamic.Persistable.Engine;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Agent.Dynamic.Persistable.Engine;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.Agent.Dynamic.Persistable.Engine;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.Agent.Dynamic.Persistable.Engine;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.Agent.Dynamic.Persistable.Engine;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.Agent.Dynamic.Persistable.Engine;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.Agent.Dynamic.Persistable.Engine;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.Agent.Dynamic.Persistable.Engine;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.Agent.Dynamic.Persistable.Engine;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.Agent.Dynamic.Persistable.Engine;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.Agent.Dynamic.Persistable.Engine;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.Agent.Dynamic.Persistable.Engine;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.Agent.Dynamic.Persistable.Engine;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.Agent.Dynamic.Persistable.Engine;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.Agent.Dynamic.Persistable.Engine;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.Agent.Dynamic.Persistable.Engine;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.Agent.Dynamic.Persistable.Engine;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.Agent.Dynamic.Persistable.Engine;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.Agent.Dynamic.Persistable.Engine;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.Agent.Dynamic.Persistable.Engine;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.Agent.Dynamic.Persistable.Engine;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.Agent.Dynamic.Persistable.Engine;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.Agent.Dynamic.Persistable.Engine;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.Agent.Dynamic.Persistable.Engine;

    mergeJson(json: any): Genai.Agent.Dynamic.Persistable.Engine;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.Agent.Dynamic.Persistable.Engine;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.Agent.Dynamic.Persistable.Engine;
     ...
     */
    singletonArray(): Array_Type<Genai.Agent.Dynamic.Persistable.Engine>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.Agent.Dynamic.Persistable.Engine> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.Agent.Dynamic.Persistable.Engine> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.Agent.Dynamic.Persistable.Engine>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.Agent.Dynamic.Persistable.Engine> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.Agent.Dynamic.Persistable.Engine> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.Agent.Dynamic.Persistable.Engine> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.Agent.Dynamic.Persistable.Engine>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.Agent.Dynamic.Persistable.Engine>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.Agent.Dynamic.Persistable.Engine;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.Agent.Dynamic.Persistable.Engine;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.Agent.Dynamic.Persistable.Engine;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.Agent.Dynamic.Persistable.Engine;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.Agent.Dynamic.Persistable.Engine;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.Agent.Dynamic.Persistable.Engine;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.Agent.Dynamic.Persistable.Engine | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.Agent.Dynamic.Persistable.Engine;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.Agent.Dynamic.Persistable.Engine;
     ...
     */
    static cachedEmptyInst(): Genai.Agent.Dynamic.Persistable.Engine;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.Agent.Dynamic.Persistable.Engine> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.Agent.Dynamic.Persistable.Engine;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.Agent.Dynamic.Persistable.Engine | null;
     ...
     */
    static forName(name: string, failIfMissing?: boolean): Genai.Agent.Dynamic.Persistable.Engine | null;

    /**
     * @return single instance of this Identified type by id.
     */
    static forId(id: string, failIfMissing?: boolean): Genai.Agent.Dynamic.Persistable.Engine | null;
     ...
     */
    static deploy(spec: Engine.DeploySpec): Genai.Agent.Dynamic.Persistable.Engine;
     ...
     */
    deployment(): Genai.Agent.Dynamic.Persistable.Engine.Deployment;
     ...
     */
    configuredDeployment(): Genai.Agent.Dynamic.Persistable.Engine.Deployment;

    /**
     * @return deployment type for this engine
     */
    static deploymentType(): Type<<Genai.Agent.Dynamic.Persistable.Engine.Deployment>>;
     ...
     */
    restart(): Genai.Agent.Dynamic.Persistable.Engine;
     ...
     */
    start(waitForReady?: boolean, spec?: WaitableSpec): Genai.Agent.Dynamic.Persistable.Engine | null;

    doStart(): Genai.Agent.Dynamic.Persistable.Engine;
     ...
     */
    call(action: Lambda<function(engine: Genai.Agent.Dynamic.Persistable.Engine): T | null>): T | null;
     ...
     */
    onStart(): Genai.Agent.Dynamic.Persistable.Engine;
     ...
     * @see #update
     */
    onUpdate(oldDeployment: Genai.Agent.Dynamic.Persistable.Engine.Deployment): void;
     ...
     * @see: #terminate
     */
    static list(): Array_Type<Genai.Agent.Dynamic.Persistable.Engine> | null;
