// TypeScript definitions for the C3 type Genai.Agent.Tool.C3Method.Config

/**
 * Config for an instance of {@link Genai.Agent.Tool.C3Method}
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.Agent.Tool.C3Method.Config
 */
declare namespace Genai.Agent.Tool.C3Method {
  export interface IConfig {
     ...
     */
    invokeMethodOverrideLambda?: λTriFunction<Genai.Agent.Tool.C3Method, Map_Type<string, any> | null, Genai.Query.Result, IGenai.Agent.Tool.Output>;

    /**
     * Optional override of {@link Genai.Agent.Tool.C3Method#toolOutputFromMethodResult}
     */
    toolOutputFromMethodResultOverrideLambda?: λTriFunction<Genai.Agent.Tool.C3Method, any | null, Genai.Query.Result, IGenai.Agent.Tool.Output>;
  }
}
...
declare namespace Genai.Agent.Tool.C3Method {
  export class Config extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): Genai.Agent.Tool.C3Method.Config;

    readonly configOverride?: string;
    withConfigOverride(configOverride: string | null): Genai.Agent.Tool.C3Method.Config;

    readonly secretOverride?: string;
    withSecretOverride(secretOverride: string | null): Genai.Agent.Tool.C3Method.Config;

    /**
     * Captures any issues that occurred while deserializing from filesystem
     */
    readonly issues?: Array_Type<string>;
    withIssues(issues: Array_Type<string> | Array<string> | null): Genai.Agent.Tool.C3Method.Config;

    /**
     * Semantic name for the tool. Used for agent prompts.
     */
    readonly toolName: string;
    withToolName(toolName: string): Genai.Agent.Tool.C3Method.Config;

    /**
     * Natural language description for the tool. Used for agent prompts.
     */
    readonly toolDescription: string;
    withToolDescription(toolDescription: string): Genai.Agent.Tool.C3Method.Config;
    ...
    withFormattingMessage(formattingMessage: string | null): Genai.Agent.Tool.C3Method.Config;

    /**
     * Array of {@link Genai.Agent.Tool.Example}s for this tool.
     */
    readonly examples?: Array_Type<Genai.Agent.Tool.Example>;
    withExamples(examples: Array_Type<Genai.Agent.Tool.Example> | Array<IGenai.Agent.Tool.Example> | null): Genai.Agent.Tool.C3Method.Config;
    ...
    withUiOptions(uiOptions: IGenai.Agent.Tool.Config.UiOptions | null): Genai.Agent.Tool.C3Method.Config;
    ...
    withOverrideRuntimeKwargs(overrideRuntimeKwargs: any | null): Genai.Agent.Tool.C3Method.Config;
     ...
     *     4. One remaining parameter (`query`) for the user's query
     */
    readonly generateArgsPrompt: Genai.Prompt;
    withGenerateArgsPrompt(generateArgsPrompt: IGenai.Prompt): Genai.Agent.Tool.C3Method.Config;

    /**
     * The {@link Genai.UnstructuredQuery.Engine.ModelConfig} to be used for generating the arguments for the method call
     */
    readonly generateArgsLlmConfigName: string;
    withGenerateArgsLlmConfigName(generateArgsLlmConfigName: string): Genai.Agent.Tool.C3Method.Config;

    /**
     * Optional override of {@link Genai.Agent.Tool.C3Method#fillPrompt} to customize the prompt generation.
     */
    readonly fillPromptOverrideLambda?: λTriFunction<Genai.Agent.Tool.C3Method, Genai.Query, Genai.Query.Result, string>;
    withFillPromptOverrideLambda(fillPromptOverrideLambda: λTriFunction<Genai.Agent.Tool.C3Method, Genai.Query, Genai.Query.Result, string> | null): Genai.Agent.Tool.C3Method.Config;

    /**
     * Optional override of {@link Genai.Agent.Tool.C3Method#generateArgs} to customize how the args are generated
     */
    readonly generateArgsOverrideLambda?: λTriFunction<Genai.Agent.Tool.C3Method, string, Genai.Query.Result, Map_Type<string, any> | null>;
    withGenerateArgsOverrideLambda(generateArgsOverrideLambda: λTriFunction<Genai.Agent.Tool.C3Method, string, Genai.Query.Result, Map_Type<string, any> | {[key: string]: any} | null> | null): Genai.Agent.Tool.C3Method.Config;

    /**
     * Optional override of {@link Genai.Agent.Tool.C3Method#invokeMethod} to customize how the method is invoked
     * given the arguments from {@link Genai.Agent.Tool.C3Method}.
     */
    readonly invokeMethodOverrideLambda?: λTriFunction<Genai.Agent.Tool.C3Method, Map_Type<string, any> | null, Genai.Query.Result, Genai.Agent.Tool.Output>;
    withInvokeMethodOverrideLambda(invokeMethodOverrideLambda: λTriFunction<Genai.Agent.Tool.C3Method, Map_Type<string, any> | null, Genai.Query.Result, IGenai.Agent.Tool.Output> | null): Genai.Agent.Tool.C3Method.Config;

    /**
     * Optional override of {@link Genai.Agent.Tool.C3Method#toolOutputFromMethodResult}
     */
    readonly toolOutputFromMethodResultOverrideLambda?: λTriFunction<Genai.Agent.Tool.C3Method, any | null, Genai.Query.Result, Genai.Agent.Tool.Output>;
    withToolOutputFromMethodResultOverrideLambda(toolOutputFromMethodResultOverrideLambda: λTriFunction<Genai.Agent.Tool.C3Method, any | null, Genai.Query.Result, IGenai.Agent.Tool.Output> | null): Genai.Agent.Tool.C3Method.Config;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.Agent.Tool.C3Method.Config | null;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.Agent.Tool.C3Method.Config | null;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.Agent.Tool.C3Method.Config;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.Agent.Tool.C3Method.Config;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.Agent.Tool.C3Method.Config;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.Agent.Tool.C3Method.Config;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.Agent.Tool.C3Method.Config | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.Agent.Tool.C3Method.Config | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.Agent.Tool.C3Method.Config | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.Agent.Tool.C3Method.Config | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.Agent.Tool.C3Method.Config;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Agent.Tool.C3Method.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Agent.Tool.C3Method.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Agent.Tool.C3Method.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Agent.Tool.C3Method.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.Agent.Tool.C3Method.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Agent.Tool.C3Method.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Agent.Tool.C3Method.Config;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.Agent.Tool.C3Method.Config;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.Agent.Tool.C3Method.Config;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.Agent.Tool.C3Method.Config;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.Agent.Tool.C3Method.Config;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.Agent.Tool.C3Method.Config;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.Agent.Tool.C3Method.Config;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.Agent.Tool.C3Method.Config;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.Agent.Tool.C3Method.Config;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.Agent.Tool.C3Method.Config;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.Agent.Tool.C3Method.Config;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.Agent.Tool.C3Method.Config;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.Agent.Tool.C3Method.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.Agent.Tool.C3Method.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.Agent.Tool.C3Method.Config;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.Agent.Tool.C3Method.Config;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.Agent.Tool.C3Method.Config;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.Agent.Tool.C3Method.Config;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.Agent.Tool.C3Method.Config;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.Agent.Tool.C3Method.Config;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.Agent.Tool.C3Method.Config;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.Agent.Tool.C3Method.Config;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.Agent.Tool.C3Method.Config;

    mergeJson(json: any): Genai.Agent.Tool.C3Method.Config;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.Agent.Tool.C3Method.Config;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.Agent.Tool.C3Method.Config;
     ...
     */
    singletonArray(): Array_Type<Genai.Agent.Tool.C3Method.Config>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.Agent.Tool.C3Method.Config> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.Agent.Tool.C3Method.Config> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.Agent.Tool.C3Method.Config>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.Agent.Tool.C3Method.Config> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.Agent.Tool.C3Method.Config> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.Agent.Tool.C3Method.Config> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.Agent.Tool.C3Method.Config>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.Agent.Tool.C3Method.Config>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.Agent.Tool.C3Method.Config;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.Agent.Tool.C3Method.Config;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.Agent.Tool.C3Method.Config;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.Agent.Tool.C3Method.Config;
     ...
     */
    static cachedEmptyInst(): Genai.Agent.Tool.C3Method.Config;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.Agent.Tool.C3Method.Config> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.Agent.Tool.C3Method.Config;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.Agent.Tool.C3Method.Config | null;
     ...
     */
    static allCached(): Stream<Genai.Agent.Tool.C3Method.Config> | null;
     ...
     */
    static find(filter?: string): Stream<Genai.Agent.Tool.C3Method.Config> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<Genai.Agent.Tool.C3Method.Config> | null;

    /**
     * @return cached instance.
     */
    getCached(): Genai.Agent.Tool.C3Method.Config | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string): Genai.Agent.Tool.C3Method.Config | null;
     ...
     */
    static produce(key: string): Genai.Agent.Tool.C3Method.Config | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, Genai.Agent.Tool.C3Method.Config> | null;
     ...
     */
    getConfig(): Genai.Agent.Tool.C3Method.Config;
     ...
     */
    getSecret(): Genai.Agent.Tool.C3Method.Config;
     ...
     */
    withConfigKey(configKey: string): Genai.Agent.Tool.C3Method.Config;

    /**
     * @return copy without config key.
     */
    withoutConfigKey(): Genai.Agent.Tool.C3Method.Config;

    /**
     * @return return cached config instance for provided config key.
     */
    static forConfigKey(configKey: string): Genai.Agent.Tool.C3Method.Config | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string>): Stream<Genai.Agent.Tool.C3Method.Config> | null;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: Genai.Agent.Tool.C3Method.Config, override?: string): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): Genai.Agent.Tool.C3Method.Config | null;
     ...
     */
    static validatePrompt(prompt: Genai.Prompt): void;
  }
}
