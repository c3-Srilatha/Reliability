// TypeScript definitions for the C3 type Genai.Llm.MockLlmConfig

/**
 * Config to control the behavior of the mock LLM.
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.Llm.MockLlmConfig
 */
declare namespace Genai.Llm {
  export interface IMockLlmConfig {
 ...
 * Config to control the behavior of the mock LLM.
 *
 * @remarks this represents a made instance of Genai.Llm.MockLlmConfig
 */
declare namespace Genai.Llm {
  export class MockLlmConfig extends Obj  {

    readonly configOverride?: string;
    withConfigOverride(configOverride: string | null): Genai.Llm.MockLlmConfig;

    static readonly configOverride?: string;

    readonly secretOverride?: string;
    withSecretOverride(secretOverride: string | null): Genai.Llm.MockLlmConfig;
    ...
    withIssues(issues: Array_Type<string> | Array<string> | null): Genai.Llm.MockLlmConfig;
     ...
     * call at "'/tmp/' + C3.pkg().name() + '/test/resource/mockLlmCallLog/' + filename + 'unmatched_calls.txt'".
     */
    readonly callLogFilePath?: string;
    withCallLogFilePath(callLogFilePath: string | null): Genai.Llm.MockLlmConfig;
     ...
     * call at "'/tmp/' + C3.pkg().name() + '/test/resource/mockLlmCallLog/' + filename + 'unmatched_calls.txt'".
     */
    static readonly callLogFilePath?: string;
    ...
    withMode(mode: string): Genai.Llm.MockLlmConfig;
     ...
     */
    static inst(): Genai.Llm.MockLlmConfig;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.Llm.MockLlmConfig | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.Llm.MockLlmConfig | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.Llm.MockLlmConfig | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.Llm.MockLlmConfig | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.Llm.MockLlmConfig;
     ...
     * This method is used during live metadata update
     */
    static replaceType(old: Type, new_: Type): Genai.Llm.MockLlmConfig;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Llm.MockLlmConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Llm.MockLlmConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Llm.MockLlmConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Llm.MockLlmConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Llm.MockLlmConfig>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Llm.MockLlmConfig>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Llm.MockLlmConfig>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Llm.MockLlmConfig>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.Llm.MockLlmConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.Llm.MockLlmConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Llm.MockLlmConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Llm.MockLlmConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Llm.MockLlmConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Llm.MockLlmConfig;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.Llm.MockLlmConfig;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    static validateObj(): Genai.Llm.MockLlmConfig;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.Llm.MockLlmConfig;
     ...
     * @see #defaultField
     */
    static withField(field: string, value: any, doNotConvert?: boolean): Genai.Llm.MockLlmConfig;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.Llm.MockLlmConfig;
     ...
     * @see #defaultField
     */
    static withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.Llm.MockLlmConfig;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.Llm.MockLlmConfig;
     ...
     * @return new Obj
     */
    static withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.Llm.MockLlmConfig;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.Llm.MockLlmConfig;
     ...
     * @return new Obj
     */
    static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.Llm.MockLlmConfig;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.Llm.MockLlmConfig;
     ...
     * @see #withoutField
     */
    static withoutFieldAtPath(path: string): Genai.Llm.MockLlmConfig;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.Llm.MockLlmConfig;
     ...
     * @see #removeField
     */
    static withoutField(field: string): Genai.Llm.MockLlmConfig;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.Llm.MockLlmConfig;
     ...
     * @see #removeField
     */
    static withoutField(field: FieldType): Genai.Llm.MockLlmConfig;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.Llm.MockLlmConfig;
     ...
     * @return new Obj with removed fields
     */
    static withoutFields(fields: Array_Type<string>): Genai.Llm.MockLlmConfig;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.Llm.MockLlmConfig;
     ...
     * @return new Obj with removed fields
     */
    static withoutFieldsByType(fields: Array_Type<FieldType>): Genai.Llm.MockLlmConfig;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.Llm.MockLlmConfig;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    static withoutSecretFields(): Genai.Llm.MockLlmConfig;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.Llm.MockLlmConfig;
     ...
     * @see FieldType#defaultValue
     */
    static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.Llm.MockLlmConfig;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.Llm.MockLlmConfig;
     ...
     * @see #unsetField
     */
    static defaultField(field: string): Genai.Llm.MockLlmConfig;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.Llm.MockLlmConfig;
     ...
     * @see #unsetField
     */
    static defaultField(field: FieldType): Genai.Llm.MockLlmConfig;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.Llm.MockLlmConfig;
     ...
     * @see #removeField
     */
    static unsetField(field: string): Genai.Llm.MockLlmConfig;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.Llm.MockLlmConfig;
     ...
     * @see #removeField
     */
    static unsetField(field: FieldType): Genai.Llm.MockLlmConfig;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.Llm.MockLlmConfig;
     ...
     * @see #unsetField
     */
    static removeField(field: string): Genai.Llm.MockLlmConfig;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.Llm.MockLlmConfig;
     ...
     * @see #unsetField
     */
    static removeField(field: FieldType): Genai.Llm.MockLlmConfig;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.Llm.MockLlmConfig;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.Llm.MockLlmConfig;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.Llm.MockLlmConfig;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj, otherFieldsFilter: Type): Genai.Llm.MockLlmConfig;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.Llm.MockLlmConfig;
     ...
     *        the same key or index.
     */
    static mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.Llm.MockLlmConfig;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.Llm.MockLlmConfig;
     ...
     * traverse child reference and collection fields.
     */
    static mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.Llm.MockLlmConfig;

    mergeJson(json: any): Genai.Llm.MockLlmConfig;

    static mergeJson(json: any): Genai.Llm.MockLlmConfig;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.Llm.MockLlmConfig;
     ...
     * @return Obj with child references merged
     */
    static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.Llm.MockLlmConfig;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.Llm.MockLlmConfig;
     ...
     * references with same name and collection elements at same index or key.
     */
    static sumObj(other: Obj, deep?: boolean): Genai.Llm.MockLlmConfig;
     ...
     */
    singletonArray(): Array_Type<Genai.Llm.MockLlmConfig>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonArray(): Array_Type<Genai.Llm.MockLlmConfig>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.Llm.MockLlmConfig> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.Llm.MockLlmConfig> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.Llm.MockLlmConfig>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonSet(): Set_Type<Genai.Llm.MockLlmConfig>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.Llm.MockLlmConfig> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.Llm.MockLlmConfig> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.Llm.MockLlmConfig> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.Llm.MockLlmConfig>;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    static toBuilder(): ObjBuilder<Genai.Llm.MockLlmConfig>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.Llm.MockLlmConfig>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.Llm.MockLlmConfig;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.Llm.MockLlmConfig;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.Llm.MockLlmConfig;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.Llm.MockLlmConfig;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.Llm.MockLlmConfig;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.Llm.MockLlmConfig;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.Llm.MockLlmConfig;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.Llm.MockLlmConfig;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    static afterMake(): Genai.Llm.MockLlmConfig;
     ...
     */
    static cachedEmptyInst(): Genai.Llm.MockLlmConfig;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.Llm.MockLlmConfig> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.Llm.MockLlmConfig;
     ...
     */
    static allCached(): Stream<Genai.Llm.MockLlmConfig> | null;
     ...
     */
    static find(filter?: string): Stream<Genai.Llm.MockLlmConfig> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<Genai.Llm.MockLlmConfig> | null;

    /**
     * @return cached instance.
     */
    getCached(): Genai.Llm.MockLlmConfig | null;

    /**
     * @return cached instance.
     */
    static getCached(): Genai.Llm.MockLlmConfig | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string): Genai.Llm.MockLlmConfig | null;
     ...
     */
    static produce(key: string): Genai.Llm.MockLlmConfig | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, Genai.Llm.MockLlmConfig> | null;
     ...
     */
    getConfig(): Genai.Llm.MockLlmConfig;
     ...
     * Note that typical pattern is to use Configurable#config instead of this method.
     */
    static getConfig(): Genai.Llm.MockLlmConfig;
     ...
     */
    getSecret(): Genai.Llm.MockLlmConfig;
     ...
     * Note that typical pattern is to use Configurable#configWithSecrets instead of this method.
     */
    static getSecret(): Genai.Llm.MockLlmConfig;
     ...
     */
    withConfigKey(configKey: string): Genai.Llm.MockLlmConfig;
     ...
     *     config.configKey() => "folder1/abc"
     */
    static withConfigKey(configKey: string): Genai.Llm.MockLlmConfig;

    /**
     * @return copy without config key.
     */
    withoutConfigKey(): Genai.Llm.MockLlmConfig;

    /**
     * @return copy without config key.
     */
    static withoutConfigKey(): Genai.Llm.MockLlmConfig;

    /**
     * @return return cached config instance for provided config key.
     */
    static forConfigKey(configKey: string): Genai.Llm.MockLlmConfig | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string>): Stream<Genai.Llm.MockLlmConfig> | null;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: Genai.Llm.MockLlmConfig, override?: string): void;
     ...
     * @see setConfigValue
     */
    static setConfigValues(from: Genai.Llm.MockLlmConfig, override?: string): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): Genai.Llm.MockLlmConfig | null;
     ...
     */
    removeSecrets(): Genai.Llm.MockLlmConfig | null;

    /**
     * @return this config without any secret values.
     */
    static removeSecrets(): Genai.Llm.MockLlmConfig | null;

    /**
     * @return this config with only secret values.
     */
    removeNonSecrets(): Genai.Llm.MockLlmConfig | null;

    /**
     * @return this config with only secret values.
     */
    static removeNonSecrets(): Genai.Llm.MockLlmConfig | null;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    validate(): Genai.Llm.MockLlmConfig;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    static validate(): Genai.Llm.MockLlmConfig;
     ...
     */
    static validateConfig(): Genai.Llm.MockLlmConfig;
     ...
     */
    static filePathForTest(filename: string, mode: string): string;
     ...
     */
    static copyTestLogToMetadataFile(filename: string): void;
  }
}
