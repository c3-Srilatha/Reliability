...
var filename = 'test_UnstructuredQuery_Engine_RA_azure_withSuppressSourceRelations';
...
describe(filename, function () {
  ...
  beforeAll(function () {
    ...
    Genai.UnstructuredQuery.Engine.Config.inst().setConfigValue('suppressSourceRelations', true);
  ...
  describe('with question-answering agent', function () {
