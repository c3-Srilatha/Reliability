// TypeScript definitions for the C3 type AiVisionFlight

/**
 * Represents a flight of a plane, with departure and arrival airports.
 *
 * @remarks this represents a value passed to a method that expects an instance of AiVisionFlight
 */
declare interface IAiVisionFlight {
 ...
 */
declare class AiVisionFlight extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): AiVisionFlight | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): AiVisionFlight | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): AiVisionFlight | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): AiVisionFlight | null;
   ...
   */
  replaceType(old: Type, new_: Type): AiVisionFlight;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): AiVisionFlight;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): AiVisionFlight;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<AiVisionFlight | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<AiVisionFlight | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): AiVisionFlight;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): AiVisionFlight;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): AiVisionFlight;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): AiVisionFlight;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): AiVisionFlight;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): AiVisionFlight;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): AiVisionFlight;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): AiVisionFlight;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): AiVisionFlight;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): AiVisionFlight;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): AiVisionFlight;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): AiVisionFlight;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): AiVisionFlight;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): AiVisionFlight;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): AiVisionFlight;
   ...
   * @see #unsetField
   */
  defaultField(field: string): AiVisionFlight;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): AiVisionFlight;
   ...
   * @see #removeField
   */
  unsetField(field: string): AiVisionFlight;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): AiVisionFlight;
   ...
   * @see #unsetField
   */
  removeField(field: string): AiVisionFlight;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): AiVisionFlight;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): AiVisionFlight;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): AiVisionFlight;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): AiVisionFlight;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): AiVisionFlight;

  mergeJson(json: any | null): AiVisionFlight;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): AiVisionFlight;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): AiVisionFlight;
   ...
   */
  singletonArray(): C3.Array<AiVisionFlight | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<AiVisionFlight | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<AiVisionFlight | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<AiVisionFlight | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<AiVisionFlight | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, AiVisionFlight | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, AiVisionFlight | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<AiVisionFlight | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<AiVisionFlight | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): AiVisionFlight;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): AiVisionFlight;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): AiVisionFlight;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): AiVisionFlight;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): AiVisionFlight;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): AiVisionFlight;
   ...
   * @see #fromString
   */
  static make(s: string | null): AiVisionFlight | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): AiVisionFlight;
   ...
   */
  static cachedEmptyInst(): AiVisionFlight;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<AiVisionFlight>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): AiVisionFlight;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<AiVisionFlight | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<AiVisionFlight | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<AiVisionFlight | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<AiVisionFlight | null> | null>;
   ...
   */
  get(include?: string | null): AiVisionFlight | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): AiVisionFlight | null;
   ...
   */
  getMissing(spec: GetMissingSpec): AiVisionFlight;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): AiVisionFlight | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): AiVisionFlight;
   ...
   * @see #toString
   */
  static fromString(s: string | null): AiVisionFlight | null;
   ...
   */
  create(spec?: UpsertSpec | null): AiVisionFlight | null;
   ...
   */
  static createBatch(objs: C3.Array<AiVisionFlight | null> | null, spec?: UpsertSpec | null): ObjList<AiVisionFlight | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<AiVisionFlight | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<AiVisionFlight | null> | null;
   ...
   */
  update(srcObj?: AiVisionFlight | null, spec?: UpsertSpec | null): AiVisionFlight | null;
   ...
   */
  upsert(srcObj?: AiVisionFlight | null, spec?: UpsertSpec | null): AiVisionFlight | null;
   ...
   */
  merge(spec?: MergeSpec | null): AiVisionFlight | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): AiVisionFlight | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): AiVisionFlight | null;
   ...
   */
  static updateBatch(objs: C3.Array<AiVisionFlight | null> | null, srcObjs?: C3.Array<AiVisionFlight | null>, spec?: UpsertSpec | null): ObjList<AiVisionFlight | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<AiVisionFlight | null>>, spec?: UpsertSpec | null): ObjList<AiVisionFlight | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<AiVisionFlight | null> | null, srcObjs?: C3.Array<AiVisionFlight | null>, spec?: UpsertSpec | null): ObjList<AiVisionFlight | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<AiVisionFlight | null>>, spec?: UpsertSpec | null): ObjList<AiVisionFlight | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<AiVisionFlight | null> | null, spec?: TouchSpec | null): ObjList<AiVisionFlight | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<AiVisionFlight | null> | null, spec?: MergeSpec | null): ObjList<AiVisionFlight | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<AiVisionFlight | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<AiVisionFlight | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<AiVisionFlight | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<AiVisionFlight | null> | null;
   ...
   */
  static mergeAll(mergeObj: AiVisionFlight | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: AiVisionFlight | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<AiVisionFlight | null> | null, spec?: UpsertSpec | null): ObjList<AiVisionFlight | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<AiVisionFlight | null> | null, spec?: UpsertSpec | null): ObjList<AiVisionFlight | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<AiVisionFlight | null> | null): ObjList<AiVisionFlight | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<AiVisionFlight | null> | null): ObjList<AiVisionFlight | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<AiVisionFlight | null> | null): ObjList<AiVisionFlight | null>;
   ...
   */
  static afterCreate(objs: C3.Array<AiVisionFlight | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<AiVisionFlight | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<AiVisionFlight | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<AiVisionFlight | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<AiVisionFlight | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): AiVisionFlight | null;
   ...
   */
  withoutIdentity(): AiVisionFlight | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<AiVisionFlight | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: AiVisionFlight | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<AiVisionFlight | null> | null, callback?: λFunction<AiVisionFlight | null, AiVisionFlight | null> | null): ObjList<AiVisionFlight | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<AiVisionFlight | null> | null, callback?: λFunction<AiVisionFlight | null, AiVisionFlight | null> | null): C3.Array<ObjError | null>;
