// TypeScript definitions for the C3 type AiVisionMissilesPositionDataHeader

/**
 * Header for a set of {@link AiVisionMissilesPositionDataPoint} measurements.
 *
 * @remarks this represents a value passed to a method that expects an instance of AiVisionMissilesPositionDataHeader
 */
declare interface IAiVisionMissilesPositionDataHeader {
   ...
   */
  data?: C3.Array<AiVisionMissilesPositionDataPoint | null> | Array<IAiVisionMissilesPositionDataPoint | null>;
   ...
   */
  missileLaunch?: IAiVisionMissileLaunch | null;
}
 ...
 */
declare class AiVisionMissilesPositionDataHeader extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): AiVisionMissilesPositionDataHeader | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): AiVisionMissilesPositionDataHeader | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): AiVisionMissilesPositionDataHeader | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): AiVisionMissilesPositionDataHeader | null;
   ...
   */
  replaceType(old: Type, new_: Type): AiVisionMissilesPositionDataHeader;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): AiVisionMissilesPositionDataHeader;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): AiVisionMissilesPositionDataHeader;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<AiVisionMissilesPositionDataHeader | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<AiVisionMissilesPositionDataHeader | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): AiVisionMissilesPositionDataHeader;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): AiVisionMissilesPositionDataHeader;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): AiVisionMissilesPositionDataHeader;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): AiVisionMissilesPositionDataHeader;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): AiVisionMissilesPositionDataHeader;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): AiVisionMissilesPositionDataHeader;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): AiVisionMissilesPositionDataHeader;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): AiVisionMissilesPositionDataHeader;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): AiVisionMissilesPositionDataHeader;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): AiVisionMissilesPositionDataHeader;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): AiVisionMissilesPositionDataHeader;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): AiVisionMissilesPositionDataHeader;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): AiVisionMissilesPositionDataHeader;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): AiVisionMissilesPositionDataHeader;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): AiVisionMissilesPositionDataHeader;
   ...
   * @see #unsetField
   */
  defaultField(field: string): AiVisionMissilesPositionDataHeader;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): AiVisionMissilesPositionDataHeader;
   ...
   * @see #removeField
   */
  unsetField(field: string): AiVisionMissilesPositionDataHeader;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): AiVisionMissilesPositionDataHeader;
   ...
   * @see #unsetField
   */
  removeField(field: string): AiVisionMissilesPositionDataHeader;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): AiVisionMissilesPositionDataHeader;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): AiVisionMissilesPositionDataHeader;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): AiVisionMissilesPositionDataHeader;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): AiVisionMissilesPositionDataHeader;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): AiVisionMissilesPositionDataHeader;

  mergeJson(json: any | null): AiVisionMissilesPositionDataHeader;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): AiVisionMissilesPositionDataHeader;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): AiVisionMissilesPositionDataHeader;
   ...
   */
  singletonArray(): C3.Array<AiVisionMissilesPositionDataHeader | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<AiVisionMissilesPositionDataHeader | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<AiVisionMissilesPositionDataHeader | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<AiVisionMissilesPositionDataHeader | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<AiVisionMissilesPositionDataHeader | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, AiVisionMissilesPositionDataHeader | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, AiVisionMissilesPositionDataHeader | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<AiVisionMissilesPositionDataHeader | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<AiVisionMissilesPositionDataHeader | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): AiVisionMissilesPositionDataHeader;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): AiVisionMissilesPositionDataHeader;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): AiVisionMissilesPositionDataHeader;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): AiVisionMissilesPositionDataHeader;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): AiVisionMissilesPositionDataHeader;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): AiVisionMissilesPositionDataHeader;
   ...
   * @see #fromString
   */
  static make(s: string | null): AiVisionMissilesPositionDataHeader | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): AiVisionMissilesPositionDataHeader;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): AiVisionMissilesPositionDataHeader;
   ...
   */
  static cachedEmptyInst(): AiVisionMissilesPositionDataHeader;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<AiVisionMissilesPositionDataHeader>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): AiVisionMissilesPositionDataHeader;
   ...
   */
  static normalizeTimeseries(timeseries?: TimedDataFields<AiVisionMissilesPositionDataPoint | null> | null, start?: DateTime | null, end?: DateTime | null, overrideGrain?: string | null, forceGrainDetection?: boolean, force?: boolean): void;
   ...
   */
  static normalize(timeseries?: TimedDataFields<AiVisionMissilesPositionDataPoint | null> | null, start?: DateTime | null, end?: DateTime | null, overrideGrain?: string | null, forceGrainDetection?: boolean): NormalizationResult | null;
   ...
   */
  static normalizationUnit(rawHeader: TimedDataFields<AiVisionMissilesPositionDataPoint | null>, tsField: string): Unit | null;
   ...
   */
  static normalizationTreatment(rawHeader: TimedDataFields<AiVisionMissilesPositionDataPoint | null>, tsField: string): string;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<AiVisionMissilesPositionDataHeader | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<AiVisionMissilesPositionDataHeader | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<AiVisionMissilesPositionDataHeader | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<AiVisionMissilesPositionDataHeader | null> | null>;
   ...
   */
  get(include?: string | null): AiVisionMissilesPositionDataHeader | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): AiVisionMissilesPositionDataHeader | null;
   ...
   */
  getMissing(spec: GetMissingSpec): AiVisionMissilesPositionDataHeader;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): AiVisionMissilesPositionDataHeader | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): AiVisionMissilesPositionDataHeader;
   ...
   * @see #toString
   */
  static fromString(s: string | null): AiVisionMissilesPositionDataHeader | null;
   ...
   */
  create(spec?: UpsertSpec | null): AiVisionMissilesPositionDataHeader | null;
   ...
   */
  static createBatch(objs: C3.Array<AiVisionMissilesPositionDataHeader | null> | null, spec?: UpsertSpec | null): ObjList<AiVisionMissilesPositionDataHeader | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<AiVisionMissilesPositionDataHeader | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<AiVisionMissilesPositionDataHeader | null> | null;
   ...
   */
  update(srcObj?: AiVisionMissilesPositionDataHeader | null, spec?: UpsertSpec | null): AiVisionMissilesPositionDataHeader | null;
   ...
   */
  upsert(srcObj?: AiVisionMissilesPositionDataHeader | null, spec?: UpsertSpec | null): AiVisionMissilesPositionDataHeader | null;
   ...
   */
  merge(spec?: MergeSpec | null): AiVisionMissilesPositionDataHeader | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): AiVisionMissilesPositionDataHeader | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): AiVisionMissilesPositionDataHeader | null;
   ...
   */
  static updateBatch(objs: C3.Array<AiVisionMissilesPositionDataHeader | null> | null, srcObjs?: C3.Array<AiVisionMissilesPositionDataHeader | null>, spec?: UpsertSpec | null): ObjList<AiVisionMissilesPositionDataHeader | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<AiVisionMissilesPositionDataHeader | null>>, spec?: UpsertSpec | null): ObjList<AiVisionMissilesPositionDataHeader | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<AiVisionMissilesPositionDataHeader | null> | null, srcObjs?: C3.Array<AiVisionMissilesPositionDataHeader | null>, spec?: UpsertSpec | null): ObjList<AiVisionMissilesPositionDataHeader | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<AiVisionMissilesPositionDataHeader | null>>, spec?: UpsertSpec | null): ObjList<AiVisionMissilesPositionDataHeader | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<AiVisionMissilesPositionDataHeader | null> | null, spec?: TouchSpec | null): ObjList<AiVisionMissilesPositionDataHeader | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<AiVisionMissilesPositionDataHeader | null> | null, spec?: MergeSpec | null): ObjList<AiVisionMissilesPositionDataHeader | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<AiVisionMissilesPositionDataHeader | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<AiVisionMissilesPositionDataHeader | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<AiVisionMissilesPositionDataHeader | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<AiVisionMissilesPositionDataHeader | null> | null;
   ...
   */
  static mergeAll(mergeObj: AiVisionMissilesPositionDataHeader | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: AiVisionMissilesPositionDataHeader | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<AiVisionMissilesPositionDataHeader | null> | null, spec?: UpsertSpec | null): ObjList<AiVisionMissilesPositionDataHeader | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<AiVisionMissilesPositionDataHeader | null> | null, spec?: UpsertSpec | null): ObjList<AiVisionMissilesPositionDataHeader | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): AiVisionMissilesPositionDataHeader | null;
   ...
   */
  static beforeCreate(objs: C3.Array<AiVisionMissilesPositionDataHeader | null> | null): ObjList<AiVisionMissilesPositionDataHeader | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<AiVisionMissilesPositionDataHeader | null> | null): ObjList<AiVisionMissilesPositionDataHeader | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<AiVisionMissilesPositionDataHeader | null> | null): ObjList<AiVisionMissilesPositionDataHeader | null>;
   ...
   */
  static afterCreate(objs: C3.Array<AiVisionMissilesPositionDataHeader | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<AiVisionMissilesPositionDataHeader | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<AiVisionMissilesPositionDataHeader | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<AiVisionMissilesPositionDataHeader | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<AiVisionMissilesPositionDataHeader | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): AiVisionMissilesPositionDataHeader | null;
   ...
   */
  withoutIdentity(): AiVisionMissilesPositionDataHeader | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<AiVisionMissilesPositionDataHeader | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: AiVisionMissilesPositionDataHeader | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<AiVisionMissilesPositionDataHeader | null> | null, callback?: λFunction<AiVisionMissilesPositionDataHeader | null, AiVisionMissilesPositionDataHeader | null> | null): ObjList<AiVisionMissilesPositionDataHeader | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<AiVisionMissilesPositionDataHeader | null> | null, callback?: λFunction<AiVisionMissilesPositionDataHeader | null, AiVisionMissilesPositionDataHeader | null> | null): C3.Array<ObjError | null>;
