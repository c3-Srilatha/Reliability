// TypeScript definitions for the C3 type AiVisionMissileLaunch

/**
 * Represents a missile launch, with base location and target.
 *
 * @remarks this represents a value passed to a method that expects an instance of AiVisionMissileLaunch
 */
declare interface IAiVisionMissileLaunch {
  ...
  /**
   * The base location of the missile.
   */
  base?: string | null;

  /**
   * The target location of the missile.
   */
  target?: string | null;
}
 ...
 * Represents a missile launch, with base location and target.
 *
 * @remarks this represents a made instance of AiVisionMissileLaunch
 */
declare class AiVisionMissileLaunch extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): AiVisionMissileLaunch | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): AiVisionMissileLaunch | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): AiVisionMissileLaunch | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): AiVisionMissileLaunch | null;
   ...
   */
  replaceType(old: Type, new_: Type): AiVisionMissileLaunch;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): AiVisionMissileLaunch;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): AiVisionMissileLaunch;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<AiVisionMissileLaunch | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<AiVisionMissileLaunch | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): AiVisionMissileLaunch;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): AiVisionMissileLaunch;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): AiVisionMissileLaunch;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): AiVisionMissileLaunch;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): AiVisionMissileLaunch;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): AiVisionMissileLaunch;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): AiVisionMissileLaunch;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): AiVisionMissileLaunch;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): AiVisionMissileLaunch;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): AiVisionMissileLaunch;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): AiVisionMissileLaunch;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): AiVisionMissileLaunch;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): AiVisionMissileLaunch;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): AiVisionMissileLaunch;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): AiVisionMissileLaunch;
   ...
   * @see #unsetField
   */
  defaultField(field: string): AiVisionMissileLaunch;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): AiVisionMissileLaunch;
   ...
   * @see #removeField
   */
  unsetField(field: string): AiVisionMissileLaunch;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): AiVisionMissileLaunch;
   ...
   * @see #unsetField
   */
  removeField(field: string): AiVisionMissileLaunch;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): AiVisionMissileLaunch;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): AiVisionMissileLaunch;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): AiVisionMissileLaunch;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): AiVisionMissileLaunch;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): AiVisionMissileLaunch;

  mergeJson(json: any | null): AiVisionMissileLaunch;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): AiVisionMissileLaunch;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): AiVisionMissileLaunch;
   ...
   */
  singletonArray(): C3.Array<AiVisionMissileLaunch | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<AiVisionMissileLaunch | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<AiVisionMissileLaunch | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<AiVisionMissileLaunch | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<AiVisionMissileLaunch | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, AiVisionMissileLaunch | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, AiVisionMissileLaunch | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<AiVisionMissileLaunch | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<AiVisionMissileLaunch | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): AiVisionMissileLaunch;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): AiVisionMissileLaunch;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): AiVisionMissileLaunch;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): AiVisionMissileLaunch;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): AiVisionMissileLaunch;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): AiVisionMissileLaunch;
   ...
   * @see #fromString
   */
  static make(s: string | null): AiVisionMissileLaunch | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): AiVisionMissileLaunch;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): AiVisionMissileLaunch;
   ...
   */
  static cachedEmptyInst(): AiVisionMissileLaunch;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<AiVisionMissileLaunch>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): AiVisionMissileLaunch;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<AiVisionMissileLaunch | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<AiVisionMissileLaunch | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<AiVisionMissileLaunch | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<AiVisionMissileLaunch | null> | null>;
   ...
   */
  get(include?: string | null): AiVisionMissileLaunch | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): AiVisionMissileLaunch | null;
   ...
   */
  getMissing(spec: GetMissingSpec): AiVisionMissileLaunch;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): AiVisionMissileLaunch | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): AiVisionMissileLaunch;
   ...
   * @see #toString
   */
  static fromString(s: string | null): AiVisionMissileLaunch | null;
   ...
   */
  create(spec?: UpsertSpec | null): AiVisionMissileLaunch | null;
   ...
   */
  static createBatch(objs: C3.Array<AiVisionMissileLaunch | null> | null, spec?: UpsertSpec | null): ObjList<AiVisionMissileLaunch | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<AiVisionMissileLaunch | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<AiVisionMissileLaunch | null> | null;
   ...
   */
  update(srcObj?: AiVisionMissileLaunch | null, spec?: UpsertSpec | null): AiVisionMissileLaunch | null;
   ...
   */
  upsert(srcObj?: AiVisionMissileLaunch | null, spec?: UpsertSpec | null): AiVisionMissileLaunch | null;
   ...
   */
  merge(spec?: MergeSpec | null): AiVisionMissileLaunch | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): AiVisionMissileLaunch | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): AiVisionMissileLaunch | null;
   ...
   */
  static updateBatch(objs: C3.Array<AiVisionMissileLaunch | null> | null, srcObjs?: C3.Array<AiVisionMissileLaunch | null>, spec?: UpsertSpec | null): ObjList<AiVisionMissileLaunch | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<AiVisionMissileLaunch | null>>, spec?: UpsertSpec | null): ObjList<AiVisionMissileLaunch | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<AiVisionMissileLaunch | null> | null, srcObjs?: C3.Array<AiVisionMissileLaunch | null>, spec?: UpsertSpec | null): ObjList<AiVisionMissileLaunch | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<AiVisionMissileLaunch | null>>, spec?: UpsertSpec | null): ObjList<AiVisionMissileLaunch | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<AiVisionMissileLaunch | null> | null, spec?: TouchSpec | null): ObjList<AiVisionMissileLaunch | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<AiVisionMissileLaunch | null> | null, spec?: MergeSpec | null): ObjList<AiVisionMissileLaunch | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<AiVisionMissileLaunch | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<AiVisionMissileLaunch | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<AiVisionMissileLaunch | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<AiVisionMissileLaunch | null> | null;
   ...
   */
  static mergeAll(mergeObj: AiVisionMissileLaunch | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: AiVisionMissileLaunch | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<AiVisionMissileLaunch | null> | null, spec?: UpsertSpec | null): ObjList<AiVisionMissileLaunch | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<AiVisionMissileLaunch | null> | null, spec?: UpsertSpec | null): ObjList<AiVisionMissileLaunch | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): AiVisionMissileLaunch | null;
   ...
   */
  static beforeCreate(objs: C3.Array<AiVisionMissileLaunch | null> | null): ObjList<AiVisionMissileLaunch | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<AiVisionMissileLaunch | null> | null): ObjList<AiVisionMissileLaunch | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<AiVisionMissileLaunch | null> | null): ObjList<AiVisionMissileLaunch | null>;
   ...
   */
  static afterCreate(objs: C3.Array<AiVisionMissileLaunch | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<AiVisionMissileLaunch | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<AiVisionMissileLaunch | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<AiVisionMissileLaunch | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<AiVisionMissileLaunch | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): AiVisionMissileLaunch | null;
   ...
   */
  withoutIdentity(): AiVisionMissileLaunch | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<AiVisionMissileLaunch | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: AiVisionMissileLaunch | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<AiVisionMissileLaunch | null> | null, callback?: λFunction<AiVisionMissileLaunch | null, AiVisionMissileLaunch | null> | null): ObjList<AiVisionMissileLaunch | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<AiVisionMissileLaunch | null> | null, callback?: λFunction<AiVisionMissileLaunch | null, AiVisionMissileLaunch | null> | null): C3.Array<ObjError | null>;
