// TypeScript definitions for the C3 type UiSdlConfig

/**
 * The UiSdlConfig type defines app-level UI configuration settings.
 *
 * @remarks this represents a value passed to a method that expects an instance of UiSdlConfig
 */
declare interface IUiSdlConfig {
  ...
  /**
   * UI configurations related to internationalization.
   */
  i18n?: IUiSdlI18nConfig | null;

  /**
   * Infrastructure level configurations.
   *
   * These configurations determine bundler or metadata processing settings.
   */
  infrastructure?: IUiSdlInfrastructureConfig | null;

  /**
   * UI configurations related to security.
   */
  security?: IUiSdlSecurityConfig | null;

  /**
   * UI configurations related to application style.
   */
  style?: IUiSdlStyleConfig | null;

  /**
   * UI configuration related to performance measurement.
   */
  performanceMeasurement?: IUiSdlPerformanceMeasureConfig | null;

  /**
   * Configuration to set whether or not components of a certain {@link UiSdlRoute#targetModuleName} should
   * send requests while having `undefined` values for contextVars.
   *
   * Example:
   * { SDLDemo: true, SDL: false }
   *
   * In this case, every component whose IDs start with `SDLDemo` (for example SDLDemo.ExampleComponent) will
   * only allow network requests due to contextVar resolution when the resolved value is not `undefined`.
   * On the other hand, components that start with `SDL` will make the network requests every time that contextVars
   * re-resolve, regardless of the values.
   */
  ignoreRequestsWithFalsyContextVars?: C3.Map<string | null, boolean> | {[key: string | null]: boolean};

  /**
   * Application specific configurations.
   *
   * Application developers can add extra configurations by remixing {@link UiSdlApplicationConfig}
   */
  app?: IUiSdlApplicationConfig | null;

  /**
   * Configurations for Cesium's capabilities and features including 3d content streaming
   * server URL, access tokens and other flags.
   */
  cesium?: ICesiumConfig | null;
}

/**
 * The UiSdlConfig type defines app-level UI configuration settings.
 *
 * @remarks this represents a made instance of UiSdlConfig
 */
declare class UiSdlConfig extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlConfig | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlConfig | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlConfig | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlConfig | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlConfig;
   ...
   * This method is used during live metadata update
   */
  static replaceType(old: Type, new_: Type): UiSdlConfig;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  static validateObj(): UiSdlConfig;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlConfig;
   ...
   * @see #defaultField
   */
  static withField(field: string, value: any, doNotConvert?: boolean): UiSdlConfig;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlConfig;
   ...
   * @see #defaultField
   */
  static withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlConfig;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlConfig;
   ...
   * @return new Obj
   */
  static withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlConfig;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlConfig;
   ...
   * @return new Obj
   */
  static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlConfig;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlConfig;
   ...
   * @see #withoutField
   */
  static withoutFieldAtPath(path: string): UiSdlConfig;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlConfig;
   ...
   * @see #removeField
   */
  static withoutField(field: string | null): UiSdlConfig;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlConfig;
   ...
   * @see #removeField
   */
  static withoutField(field: FieldType | null): UiSdlConfig;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlConfig;
   ...
   * @return new Obj with removed fields
   */
  static withoutFields(fields: C3.Array<string | null> | null): UiSdlConfig;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlConfig;
   ...
   * @return new Obj with removed fields
   */
  static withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  static withoutSecretFields(): UiSdlConfig;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlConfig;
   ...
   * @see FieldType#defaultValue
   */
  static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlConfig;
   ...
   * @see #unsetField
   */
  static defaultField(field: string): UiSdlConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlConfig;
   ...
   * @see #unsetField
   */
  static defaultField(field: FieldType): UiSdlConfig;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlConfig;
   ...
   * @see #removeField
   */
  static unsetField(field: string): UiSdlConfig;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlConfig;
   ...
   * @see #removeField
   */
  static unsetField(field: FieldType): UiSdlConfig;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlConfig;
   ...
   * @see #unsetField
   */
  static removeField(field: string): UiSdlConfig;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlConfig;
   ...
   * @see #unsetField
   */
  static removeField(field: FieldType): UiSdlConfig;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlConfig;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlConfig;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlConfig;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlConfig;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlConfig;
   ...
   *        the same key or index.
   */
  static mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlConfig;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlConfig;
   ...
   * traverse child reference and collection fields.
   */
  static mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlConfig;

  mergeJson(json: any | null): UiSdlConfig;

  static mergeJson(json: any | null): UiSdlConfig;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlConfig;
   ...
   * @return Obj with child references merged
   */
  static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlConfig;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlConfig;
   ...
   * references with same name and collection elements at same index or key.
   */
  static sumObj(other: Obj | null, deep?: boolean): UiSdlConfig;
   ...
   */
  singletonArray(): C3.Array<UiSdlConfig | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonArray(): C3.Array<UiSdlConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlConfig | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlConfig | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonSet(): C3.Set<UiSdlConfig | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlConfig | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlConfig | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlConfig | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlConfig | null>;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  static toBuilder(): ObjBuilder<UiSdlConfig | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlConfig | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlConfig;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlConfig;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlConfig;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlConfig;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlConfig;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlConfig;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlConfig;
   ...
   */
  static cachedEmptyInst(): UiSdlConfig;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlConfig>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlConfig;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<UiSdlConfig | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<UiSdlConfig | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<UiSdlConfig | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): UiSdlConfig | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string | null): UiSdlConfig | null;
   ...
   * @see findByCacheKey
   */
  static getCached(): UiSdlConfig | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): UiSdlConfig | null;

  /**
   * @return newly produced cached instance.
   */
  static refreshCache(): UiSdlConfig | null;
   ...
   */
  static produce(key: string): UiSdlConfig | null;
   ...
   */
  static produceAll(): C3.Map<string | null, UiSdlConfig | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, UiSdlConfig | null>;
   ...
   */
  static forConfigKey(configKey: string | null): UiSdlConfig | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<UiSdlConfig | null>;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: UiSdlConfig, override?: string | null): void;

  /**
   * Sets multiple field values to be the same as the passed instance.
   * @see setConfigValue
   */
  static setConfigValues(from: UiSdlConfig, override?: string | null): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: UiSdlConfig, override?: string | null): void;

  /**
   * Sets multiple secret field values to be the same as the passed instance.
   * @see setSecretValue
   */
  static setSecretValues(from: UiSdlConfig, override?: string | null): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): UiSdlConfig | null;
   ...
   */
  removeSecrets(): UiSdlConfig | null;

  /**
   * @return this config without any secret values.
   */
  static removeSecrets(): UiSdlConfig | null;

  /**
   * @return this config with only secret values.
   */
  removeNonSecrets(): UiSdlConfig | null;

  /**
   * @return this config with only secret values.
   */
  static removeNonSecrets(): UiSdlConfig | null;

  /**
   * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
   * validation and setup.
   */
  validate(): UiSdlConfig;

  /**
   * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
   * validation and setup.
   */
  static validate(): UiSdlConfig;
   ...
   */
  static inst(): UiSdlConfig;

  /**
   * Returns flattened config values and field types.
   */
  getFlattenedConfigValuesAndFieldTypes(includePrivateFields?: boolean): any;

  /**
   * Returns flattened config values and field types.
   */
  static getFlattenedConfigValuesAndFieldTypes(includePrivateFields?: boolean): any;

  /**
   * Sets the config using the provided spec.
   *
   * Saves the provided config values to a {@link Config} metadata file under the path 'UiSdlConfig/UiSdlConfig.json'.
   */
  static setConfigFromSpec(spec?: any | null): void;

  /**
   * Gets the infrastructure webpack mode. If not set, fall back based on the App mode:
   * return 'development' for 'dev' and 'trial' App mode, or 'production' for 'prod' and 'test' mode.
   */
  static getWebpackMode(): string | null;

  /**
   * Returns the bundler max memory by finding the infrastructure.bundlerMaxMem config value.
   */
  static getBundlerMaxMem(): string | null;

  /**
   * Helper function that returns the infrastructure webpack mode based on {@link UiSdlConfig} value and app mode.
   */
  static webpackModeorFallbackMode(webpackMode?: string | null, appMode?: string | null): string | null;
}
