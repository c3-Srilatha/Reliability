// TypeScript definitions for the C3 type AiVisionManyStaticPlaneData

/**
 * @remarks this represents a value passed to a method that expects an instance of AiVisionManyStaticPlaneData
 */
declare interface IAiVisionManyStaticPlaneData {
 ...
 */
declare class AiVisionManyStaticPlaneData extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): AiVisionManyStaticPlaneData | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): AiVisionManyStaticPlaneData | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): AiVisionManyStaticPlaneData | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): AiVisionManyStaticPlaneData | null;
   ...
   */
  replaceType(old: Type, new_: Type): AiVisionManyStaticPlaneData;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): AiVisionManyStaticPlaneData;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): AiVisionManyStaticPlaneData;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<AiVisionManyStaticPlaneData | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<AiVisionManyStaticPlaneData | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): AiVisionManyStaticPlaneData;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): AiVisionManyStaticPlaneData;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): AiVisionManyStaticPlaneData;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): AiVisionManyStaticPlaneData;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): AiVisionManyStaticPlaneData;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): AiVisionManyStaticPlaneData;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): AiVisionManyStaticPlaneData;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): AiVisionManyStaticPlaneData;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): AiVisionManyStaticPlaneData;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): AiVisionManyStaticPlaneData;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): AiVisionManyStaticPlaneData;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): AiVisionManyStaticPlaneData;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): AiVisionManyStaticPlaneData;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): AiVisionManyStaticPlaneData;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): AiVisionManyStaticPlaneData;
   ...
   * @see #unsetField
   */
  defaultField(field: string): AiVisionManyStaticPlaneData;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): AiVisionManyStaticPlaneData;
   ...
   * @see #removeField
   */
  unsetField(field: string): AiVisionManyStaticPlaneData;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): AiVisionManyStaticPlaneData;
   ...
   * @see #unsetField
   */
  removeField(field: string): AiVisionManyStaticPlaneData;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): AiVisionManyStaticPlaneData;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): AiVisionManyStaticPlaneData;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): AiVisionManyStaticPlaneData;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): AiVisionManyStaticPlaneData;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): AiVisionManyStaticPlaneData;

  mergeJson(json: any | null): AiVisionManyStaticPlaneData;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): AiVisionManyStaticPlaneData;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): AiVisionManyStaticPlaneData;
   ...
   */
  singletonArray(): C3.Array<AiVisionManyStaticPlaneData | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<AiVisionManyStaticPlaneData | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<AiVisionManyStaticPlaneData | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<AiVisionManyStaticPlaneData | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<AiVisionManyStaticPlaneData | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, AiVisionManyStaticPlaneData | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, AiVisionManyStaticPlaneData | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<AiVisionManyStaticPlaneData | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<AiVisionManyStaticPlaneData | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): AiVisionManyStaticPlaneData;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): AiVisionManyStaticPlaneData;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): AiVisionManyStaticPlaneData;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): AiVisionManyStaticPlaneData;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): AiVisionManyStaticPlaneData;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): AiVisionManyStaticPlaneData;
   ...
   * @see #fromString
   */
  static make(s: string | null): AiVisionManyStaticPlaneData | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): AiVisionManyStaticPlaneData;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): AiVisionManyStaticPlaneData;
   ...
   */
  static cachedEmptyInst(): AiVisionManyStaticPlaneData;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<AiVisionManyStaticPlaneData>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): AiVisionManyStaticPlaneData;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<AiVisionManyStaticPlaneData | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<AiVisionManyStaticPlaneData | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<AiVisionManyStaticPlaneData | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): AiVisionManyStaticPlaneData | null;
   ...
   * @see findByCacheKey
   */
  static forCacheKey(key: string | null): AiVisionManyStaticPlaneData | null;
   ...
   * @see findByCacheKey
   */
  getCached(): AiVisionManyStaticPlaneData | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): AiVisionManyStaticPlaneData | null;
   ...
   */
  static produce(key: string): AiVisionManyStaticPlaneData | null;
   ...
   */
  static produceAll(): C3.Map<string | null, AiVisionManyStaticPlaneData | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, AiVisionManyStaticPlaneData | null>;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<AiVisionManyStaticPlaneData | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<AiVisionManyStaticPlaneData | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<AiVisionManyStaticPlaneData | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<AiVisionManyStaticPlaneData | null> | null>;
   ...
   */
  get(include?: string | null): AiVisionManyStaticPlaneData | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): AiVisionManyStaticPlaneData | null;
   ...
   */
  getMissing(spec: GetMissingSpec): AiVisionManyStaticPlaneData;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): AiVisionManyStaticPlaneData | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): AiVisionManyStaticPlaneData;
   ...
   * @see #toString
   */
  static fromString(s: string | null): AiVisionManyStaticPlaneData | null;
   ...
   */
  create(spec?: UpsertSpec | null): AiVisionManyStaticPlaneData | null;
   ...
   */
  static createBatch(objs: C3.Array<AiVisionManyStaticPlaneData | null> | null, spec?: UpsertSpec | null): ObjList<AiVisionManyStaticPlaneData | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<AiVisionManyStaticPlaneData | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<AiVisionManyStaticPlaneData | null> | null;
   ...
   */
  update(srcObj?: AiVisionManyStaticPlaneData | null, spec?: UpsertSpec | null): AiVisionManyStaticPlaneData | null;
   ...
   */
  upsert(srcObj?: AiVisionManyStaticPlaneData | null, spec?: UpsertSpec | null): AiVisionManyStaticPlaneData | null;
   ...
   */
  merge(spec?: MergeSpec | null): AiVisionManyStaticPlaneData | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): AiVisionManyStaticPlaneData | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): AiVisionManyStaticPlaneData | null;
   ...
   */
  static updateBatch(objs: C3.Array<AiVisionManyStaticPlaneData | null> | null, srcObjs?: C3.Array<AiVisionManyStaticPlaneData | null>, spec?: UpsertSpec | null): ObjList<AiVisionManyStaticPlaneData | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<AiVisionManyStaticPlaneData | null>>, spec?: UpsertSpec | null): ObjList<AiVisionManyStaticPlaneData | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<AiVisionManyStaticPlaneData | null> | null, srcObjs?: C3.Array<AiVisionManyStaticPlaneData | null>, spec?: UpsertSpec | null): ObjList<AiVisionManyStaticPlaneData | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<AiVisionManyStaticPlaneData | null>>, spec?: UpsertSpec | null): ObjList<AiVisionManyStaticPlaneData | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<AiVisionManyStaticPlaneData | null> | null, spec?: TouchSpec | null): ObjList<AiVisionManyStaticPlaneData | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<AiVisionManyStaticPlaneData | null> | null, spec?: MergeSpec | null): ObjList<AiVisionManyStaticPlaneData | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<AiVisionManyStaticPlaneData | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<AiVisionManyStaticPlaneData | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<AiVisionManyStaticPlaneData | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<AiVisionManyStaticPlaneData | null> | null;
   ...
   */
  static mergeAll(mergeObj: AiVisionManyStaticPlaneData | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: AiVisionManyStaticPlaneData | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<AiVisionManyStaticPlaneData | null> | null, spec?: UpsertSpec | null): ObjList<AiVisionManyStaticPlaneData | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<AiVisionManyStaticPlaneData | null> | null, spec?: UpsertSpec | null): ObjList<AiVisionManyStaticPlaneData | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): AiVisionManyStaticPlaneData | null;
   ...
   */
  static beforeCreate(objs: C3.Array<AiVisionManyStaticPlaneData | null> | null): ObjList<AiVisionManyStaticPlaneData | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<AiVisionManyStaticPlaneData | null> | null): ObjList<AiVisionManyStaticPlaneData | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<AiVisionManyStaticPlaneData | null> | null): ObjList<AiVisionManyStaticPlaneData | null>;
   ...
   */
  static afterCreate(objs: C3.Array<AiVisionManyStaticPlaneData | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<AiVisionManyStaticPlaneData | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<AiVisionManyStaticPlaneData | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<AiVisionManyStaticPlaneData | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<AiVisionManyStaticPlaneData | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): AiVisionManyStaticPlaneData | null;
   ...
   */
  withoutIdentity(): AiVisionManyStaticPlaneData | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<AiVisionManyStaticPlaneData | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: AiVisionManyStaticPlaneData | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<AiVisionManyStaticPlaneData | null> | null, callback?: λFunction<AiVisionManyStaticPlaneData | null, AiVisionManyStaticPlaneData | null> | null): ObjList<AiVisionManyStaticPlaneData | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<AiVisionManyStaticPlaneData | null> | null, callback?: λFunction<AiVisionManyStaticPlaneData | null, AiVisionManyStaticPlaneData | null> | null): C3.Array<ObjError | null>;
   ...
   */
  publish(subPath?: string | null, contentType?: string | null): AiVisionManyStaticPlaneData;
   ...
   */
  static removeSeedDataBatch(objs?: C3.Array<SeedData | null>, spec?: UpsertSpec | null): ObjList<AiVisionManyStaticPlaneData | null> | null;
   ...
   */
  createSeedData(spec?: UpsertSpec | null): AiVisionManyStaticPlaneData | null;
   ...
   */
  static createSeedDataBatch(objs?: C3.Array<SeedData | null>, spec?: UpsertSpec | null): ObjList<AiVisionManyStaticPlaneData | null> | null;
   ...
   */
  updateSeedData(srcObj?: SeedData | null, spec?: UpsertSpec | null): AiVisionManyStaticPlaneData | null;
   ...
   */
  static updateSeedDataBatch(objs?: C3.Array<SeedData | null>, srcObjs?: C3.Array<SeedData | null>, spec?: UpsertSpec | null): ObjList<AiVisionManyStaticPlaneData | null> | null;
   ...
   * @return updated obj instance, same as {@link Persistable#update} return value.
   */
  clearUserUpdates(spec?: MergeSpec | null): AiVisionManyStaticPlaneData | null;
   ...
   *         {@link Persistable#updateBatch}.
   */
  static clearUserUpdatesBatch(objs?: C3.Array<SeedData | null>, spec?: MergeSpec | null): ObjList<AiVisionManyStaticPlaneData | null> | null;
  ...
  dependencies(): SeedDataDeps<AiVisionManyStaticPlaneData | null> | null;
