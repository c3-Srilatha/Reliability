// TypeScript definitions for the C3 type AiVisionMissilesPositionDataPoint

/**
 * Data points that represent the position of an missile in a launch.
 *
 * @remarks this represents a value passed to a method that expects an instance of AiVisionMissilesPositionDataPoint
 */
declare interface IAiVisionMissilesPositionDataPoint {
  ...
  parent: IAiVisionMissilesPositionDataHeader;
 ...
 */
declare class AiVisionMissilesPositionDataPoint extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): AiVisionMissilesPositionDataPoint | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): AiVisionMissilesPositionDataPoint | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): AiVisionMissilesPositionDataPoint | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): AiVisionMissilesPositionDataPoint | null;
   ...
   */
  replaceType(old: Type, new_: Type): AiVisionMissilesPositionDataPoint;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): AiVisionMissilesPositionDataPoint;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): AiVisionMissilesPositionDataPoint;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<AiVisionMissilesPositionDataPoint | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<AiVisionMissilesPositionDataPoint | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): AiVisionMissilesPositionDataPoint;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): AiVisionMissilesPositionDataPoint;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): AiVisionMissilesPositionDataPoint;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): AiVisionMissilesPositionDataPoint;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): AiVisionMissilesPositionDataPoint;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): AiVisionMissilesPositionDataPoint;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): AiVisionMissilesPositionDataPoint;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): AiVisionMissilesPositionDataPoint;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): AiVisionMissilesPositionDataPoint;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): AiVisionMissilesPositionDataPoint;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): AiVisionMissilesPositionDataPoint;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): AiVisionMissilesPositionDataPoint;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): AiVisionMissilesPositionDataPoint;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): AiVisionMissilesPositionDataPoint;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): AiVisionMissilesPositionDataPoint;
   ...
   * @see #unsetField
   */
  defaultField(field: string): AiVisionMissilesPositionDataPoint;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): AiVisionMissilesPositionDataPoint;
   ...
   * @see #removeField
   */
  unsetField(field: string): AiVisionMissilesPositionDataPoint;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): AiVisionMissilesPositionDataPoint;
   ...
   * @see #unsetField
   */
  removeField(field: string): AiVisionMissilesPositionDataPoint;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): AiVisionMissilesPositionDataPoint;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): AiVisionMissilesPositionDataPoint;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): AiVisionMissilesPositionDataPoint;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): AiVisionMissilesPositionDataPoint;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): AiVisionMissilesPositionDataPoint;

  mergeJson(json: any | null): AiVisionMissilesPositionDataPoint;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): AiVisionMissilesPositionDataPoint;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): AiVisionMissilesPositionDataPoint;
   ...
   */
  singletonArray(): C3.Array<AiVisionMissilesPositionDataPoint | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<AiVisionMissilesPositionDataPoint | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<AiVisionMissilesPositionDataPoint | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<AiVisionMissilesPositionDataPoint | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<AiVisionMissilesPositionDataPoint | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, AiVisionMissilesPositionDataPoint | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, AiVisionMissilesPositionDataPoint | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<AiVisionMissilesPositionDataPoint | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<AiVisionMissilesPositionDataPoint | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): AiVisionMissilesPositionDataPoint;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): AiVisionMissilesPositionDataPoint;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): AiVisionMissilesPositionDataPoint;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): AiVisionMissilesPositionDataPoint;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): AiVisionMissilesPositionDataPoint;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): AiVisionMissilesPositionDataPoint;
   ...
   * @see #fromString
   */
  static make(s: string | null): AiVisionMissilesPositionDataPoint | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): AiVisionMissilesPositionDataPoint;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): AiVisionMissilesPositionDataPoint;
   ...
   */
  static cachedEmptyInst(): AiVisionMissilesPositionDataPoint;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<AiVisionMissilesPositionDataPoint>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): AiVisionMissilesPositionDataPoint;

  /**
   * Extract the partition key from the given obj
   */
  partitionKey(failIfMissing?: boolean): AiVisionMissilesPositionDataHeader | null;
   ...
   */
  static partition(objs?: Stream<AiVisionMissilesPositionDataPoint | null>, spec?: PartitionBucketStrategy | null): C3.Map<string | null, KvDataPartition | null>;
   ...
   */
  static fromPartitions(partitions?: Stream<KvDataPartition | null>): Stream<AiVisionMissilesPositionDataPoint | null>;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<AiVisionMissilesPositionDataPoint | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<AiVisionMissilesPositionDataPoint | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<AiVisionMissilesPositionDataPoint | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<AiVisionMissilesPositionDataPoint | null> | null>;
   ...
   */
  get(include?: string | null): AiVisionMissilesPositionDataPoint | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): AiVisionMissilesPositionDataPoint | null;
   ...
   */
  getMissing(spec: GetMissingSpec): AiVisionMissilesPositionDataPoint;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): AiVisionMissilesPositionDataPoint | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): AiVisionMissilesPositionDataPoint;
   ...
   * @see #toString
   */
  static fromString(s: string | null): AiVisionMissilesPositionDataPoint | null;
   ...
   */
  create(spec?: UpsertSpec | null): AiVisionMissilesPositionDataPoint | null;
   ...
   */
  static createBatch(objs: C3.Array<AiVisionMissilesPositionDataPoint | null> | null, spec?: UpsertSpec | null): ObjList<AiVisionMissilesPositionDataPoint | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<AiVisionMissilesPositionDataPoint | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<AiVisionMissilesPositionDataPoint | null> | null;
   ...
   */
  update(srcObj?: AiVisionMissilesPositionDataPoint | null, spec?: UpsertSpec | null): AiVisionMissilesPositionDataPoint | null;
   ...
   */
  upsert(srcObj?: AiVisionMissilesPositionDataPoint | null, spec?: UpsertSpec | null): AiVisionMissilesPositionDataPoint | null;
   ...
   */
  merge(spec?: MergeSpec | null): AiVisionMissilesPositionDataPoint | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): AiVisionMissilesPositionDataPoint | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): AiVisionMissilesPositionDataPoint | null;
   ...
   */
  static updateBatch(objs: C3.Array<AiVisionMissilesPositionDataPoint | null> | null, srcObjs?: C3.Array<AiVisionMissilesPositionDataPoint | null>, spec?: UpsertSpec | null): ObjList<AiVisionMissilesPositionDataPoint | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<AiVisionMissilesPositionDataPoint | null>>, spec?: UpsertSpec | null): ObjList<AiVisionMissilesPositionDataPoint | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<AiVisionMissilesPositionDataPoint | null> | null, srcObjs?: C3.Array<AiVisionMissilesPositionDataPoint | null>, spec?: UpsertSpec | null): ObjList<AiVisionMissilesPositionDataPoint | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<AiVisionMissilesPositionDataPoint | null>>, spec?: UpsertSpec | null): ObjList<AiVisionMissilesPositionDataPoint | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<AiVisionMissilesPositionDataPoint | null> | null, spec?: TouchSpec | null): ObjList<AiVisionMissilesPositionDataPoint | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<AiVisionMissilesPositionDataPoint | null> | null, spec?: MergeSpec | null): ObjList<AiVisionMissilesPositionDataPoint | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<AiVisionMissilesPositionDataPoint | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<AiVisionMissilesPositionDataPoint | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<AiVisionMissilesPositionDataPoint | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<AiVisionMissilesPositionDataPoint | null> | null;
   ...
   */
  static mergeAll(mergeObj: AiVisionMissilesPositionDataPoint | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: AiVisionMissilesPositionDataPoint | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<AiVisionMissilesPositionDataPoint | null> | null, spec?: UpsertSpec | null): ObjList<AiVisionMissilesPositionDataPoint | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<AiVisionMissilesPositionDataPoint | null> | null, spec?: UpsertSpec | null): ObjList<AiVisionMissilesPositionDataPoint | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): AiVisionMissilesPositionDataPoint | null;
   ...
   */
  static beforeCreate(objs: C3.Array<AiVisionMissilesPositionDataPoint | null> | null): ObjList<AiVisionMissilesPositionDataPoint | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<AiVisionMissilesPositionDataPoint | null> | null): ObjList<AiVisionMissilesPositionDataPoint | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<AiVisionMissilesPositionDataPoint | null> | null): ObjList<AiVisionMissilesPositionDataPoint | null>;
   ...
   */
  static afterCreate(objs: C3.Array<AiVisionMissilesPositionDataPoint | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<AiVisionMissilesPositionDataPoint | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<AiVisionMissilesPositionDataPoint | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<AiVisionMissilesPositionDataPoint | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<AiVisionMissilesPositionDataPoint | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): AiVisionMissilesPositionDataPoint | null;
   ...
   */
  withoutIdentity(): AiVisionMissilesPositionDataPoint | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<AiVisionMissilesPositionDataPoint | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: AiVisionMissilesPositionDataPoint | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<AiVisionMissilesPositionDataPoint | null> | null, callback?: λFunction<AiVisionMissilesPositionDataPoint | null, AiVisionMissilesPositionDataPoint | null> | null): ObjList<AiVisionMissilesPositionDataPoint | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<AiVisionMissilesPositionDataPoint | null> | null, callback?: λFunction<AiVisionMissilesPositionDataPoint | null, AiVisionMissilesPositionDataPoint | null> | null): C3.Array<ObjError | null>;
