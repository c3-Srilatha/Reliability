// TypeScript definitions for the C3 type AiVisionFlightsPositionDataPoint

/**
 * Data points that represent the position of an aircraft in a flight.
 *
 * @remarks this represents a value passed to a method that expects an instance of AiVisionFlightsPositionDataPoint
 */
declare interface IAiVisionFlightsPositionDataPoint {
  ...
  parent: IAiVisionFlightsPositionDataHeader;
 ...
 */
declare class AiVisionFlightsPositionDataPoint extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): AiVisionFlightsPositionDataPoint | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): AiVisionFlightsPositionDataPoint | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): AiVisionFlightsPositionDataPoint | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): AiVisionFlightsPositionDataPoint | null;
   ...
   */
  replaceType(old: Type, new_: Type): AiVisionFlightsPositionDataPoint;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): AiVisionFlightsPositionDataPoint;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): AiVisionFlightsPositionDataPoint;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<AiVisionFlightsPositionDataPoint | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<AiVisionFlightsPositionDataPoint | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): AiVisionFlightsPositionDataPoint;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): AiVisionFlightsPositionDataPoint;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): AiVisionFlightsPositionDataPoint;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): AiVisionFlightsPositionDataPoint;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): AiVisionFlightsPositionDataPoint;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): AiVisionFlightsPositionDataPoint;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): AiVisionFlightsPositionDataPoint;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): AiVisionFlightsPositionDataPoint;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): AiVisionFlightsPositionDataPoint;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): AiVisionFlightsPositionDataPoint;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): AiVisionFlightsPositionDataPoint;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): AiVisionFlightsPositionDataPoint;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): AiVisionFlightsPositionDataPoint;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): AiVisionFlightsPositionDataPoint;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): AiVisionFlightsPositionDataPoint;
   ...
   * @see #unsetField
   */
  defaultField(field: string): AiVisionFlightsPositionDataPoint;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): AiVisionFlightsPositionDataPoint;
   ...
   * @see #removeField
   */
  unsetField(field: string): AiVisionFlightsPositionDataPoint;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): AiVisionFlightsPositionDataPoint;
   ...
   * @see #unsetField
   */
  removeField(field: string): AiVisionFlightsPositionDataPoint;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): AiVisionFlightsPositionDataPoint;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): AiVisionFlightsPositionDataPoint;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): AiVisionFlightsPositionDataPoint;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): AiVisionFlightsPositionDataPoint;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): AiVisionFlightsPositionDataPoint;

  mergeJson(json: any | null): AiVisionFlightsPositionDataPoint;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): AiVisionFlightsPositionDataPoint;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): AiVisionFlightsPositionDataPoint;
   ...
   */
  singletonArray(): C3.Array<AiVisionFlightsPositionDataPoint | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<AiVisionFlightsPositionDataPoint | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<AiVisionFlightsPositionDataPoint | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<AiVisionFlightsPositionDataPoint | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<AiVisionFlightsPositionDataPoint | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, AiVisionFlightsPositionDataPoint | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, AiVisionFlightsPositionDataPoint | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<AiVisionFlightsPositionDataPoint | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<AiVisionFlightsPositionDataPoint | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): AiVisionFlightsPositionDataPoint;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): AiVisionFlightsPositionDataPoint;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): AiVisionFlightsPositionDataPoint;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): AiVisionFlightsPositionDataPoint;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): AiVisionFlightsPositionDataPoint;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): AiVisionFlightsPositionDataPoint;
   ...
   * @see #fromString
   */
  static make(s: string | null): AiVisionFlightsPositionDataPoint | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): AiVisionFlightsPositionDataPoint;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): AiVisionFlightsPositionDataPoint;
   ...
   */
  static cachedEmptyInst(): AiVisionFlightsPositionDataPoint;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<AiVisionFlightsPositionDataPoint>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): AiVisionFlightsPositionDataPoint;

  /**
   * Extract the partition key from the given obj
   */
  partitionKey(failIfMissing?: boolean): AiVisionFlightsPositionDataHeader | null;
   ...
   */
  static partition(objs?: Stream<AiVisionFlightsPositionDataPoint | null>, spec?: PartitionBucketStrategy | null): C3.Map<string | null, KvDataPartition | null>;
   ...
   */
  static fromPartitions(partitions?: Stream<KvDataPartition | null>): Stream<AiVisionFlightsPositionDataPoint | null>;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<AiVisionFlightsPositionDataPoint | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<AiVisionFlightsPositionDataPoint | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<AiVisionFlightsPositionDataPoint | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<AiVisionFlightsPositionDataPoint | null> | null>;
   ...
   */
  get(include?: string | null): AiVisionFlightsPositionDataPoint | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): AiVisionFlightsPositionDataPoint | null;
   ...
   */
  getMissing(spec: GetMissingSpec): AiVisionFlightsPositionDataPoint;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): AiVisionFlightsPositionDataPoint | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): AiVisionFlightsPositionDataPoint;
   ...
   * @see #toString
   */
  static fromString(s: string | null): AiVisionFlightsPositionDataPoint | null;
   ...
   */
  create(spec?: UpsertSpec | null): AiVisionFlightsPositionDataPoint | null;
   ...
   */
  static createBatch(objs: C3.Array<AiVisionFlightsPositionDataPoint | null> | null, spec?: UpsertSpec | null): ObjList<AiVisionFlightsPositionDataPoint | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<AiVisionFlightsPositionDataPoint | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<AiVisionFlightsPositionDataPoint | null> | null;
   ...
   */
  update(srcObj?: AiVisionFlightsPositionDataPoint | null, spec?: UpsertSpec | null): AiVisionFlightsPositionDataPoint | null;
   ...
   */
  upsert(srcObj?: AiVisionFlightsPositionDataPoint | null, spec?: UpsertSpec | null): AiVisionFlightsPositionDataPoint | null;
   ...
   */
  merge(spec?: MergeSpec | null): AiVisionFlightsPositionDataPoint | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): AiVisionFlightsPositionDataPoint | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): AiVisionFlightsPositionDataPoint | null;
   ...
   */
  static updateBatch(objs: C3.Array<AiVisionFlightsPositionDataPoint | null> | null, srcObjs?: C3.Array<AiVisionFlightsPositionDataPoint | null>, spec?: UpsertSpec | null): ObjList<AiVisionFlightsPositionDataPoint | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<AiVisionFlightsPositionDataPoint | null>>, spec?: UpsertSpec | null): ObjList<AiVisionFlightsPositionDataPoint | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<AiVisionFlightsPositionDataPoint | null> | null, srcObjs?: C3.Array<AiVisionFlightsPositionDataPoint | null>, spec?: UpsertSpec | null): ObjList<AiVisionFlightsPositionDataPoint | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<AiVisionFlightsPositionDataPoint | null>>, spec?: UpsertSpec | null): ObjList<AiVisionFlightsPositionDataPoint | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<AiVisionFlightsPositionDataPoint | null> | null, spec?: TouchSpec | null): ObjList<AiVisionFlightsPositionDataPoint | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<AiVisionFlightsPositionDataPoint | null> | null, spec?: MergeSpec | null): ObjList<AiVisionFlightsPositionDataPoint | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<AiVisionFlightsPositionDataPoint | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<AiVisionFlightsPositionDataPoint | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<AiVisionFlightsPositionDataPoint | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<AiVisionFlightsPositionDataPoint | null> | null;
   ...
   */
  static mergeAll(mergeObj: AiVisionFlightsPositionDataPoint | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: AiVisionFlightsPositionDataPoint | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<AiVisionFlightsPositionDataPoint | null> | null, spec?: UpsertSpec | null): ObjList<AiVisionFlightsPositionDataPoint | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<AiVisionFlightsPositionDataPoint | null> | null, spec?: UpsertSpec | null): ObjList<AiVisionFlightsPositionDataPoint | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): AiVisionFlightsPositionDataPoint | null;
   ...
   */
  static beforeCreate(objs: C3.Array<AiVisionFlightsPositionDataPoint | null> | null): ObjList<AiVisionFlightsPositionDataPoint | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<AiVisionFlightsPositionDataPoint | null> | null): ObjList<AiVisionFlightsPositionDataPoint | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<AiVisionFlightsPositionDataPoint | null> | null): ObjList<AiVisionFlightsPositionDataPoint | null>;
   ...
   */
  static afterCreate(objs: C3.Array<AiVisionFlightsPositionDataPoint | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<AiVisionFlightsPositionDataPoint | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<AiVisionFlightsPositionDataPoint | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<AiVisionFlightsPositionDataPoint | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<AiVisionFlightsPositionDataPoint | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): AiVisionFlightsPositionDataPoint | null;
   ...
   */
  withoutIdentity(): AiVisionFlightsPositionDataPoint | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<AiVisionFlightsPositionDataPoint | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: AiVisionFlightsPositionDataPoint | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<AiVisionFlightsPositionDataPoint | null> | null, callback?: λFunction<AiVisionFlightsPositionDataPoint | null, AiVisionFlightsPositionDataPoint | null> | null): ObjList<AiVisionFlightsPositionDataPoint | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<AiVisionFlightsPositionDataPoint | null> | null, callback?: λFunction<AiVisionFlightsPositionDataPoint | null, AiVisionFlightsPositionDataPoint | null> | null): C3.Array<ObjError | null>;
