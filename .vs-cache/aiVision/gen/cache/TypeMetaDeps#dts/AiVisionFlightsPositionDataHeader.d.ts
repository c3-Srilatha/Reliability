// TypeScript definitions for the C3 type AiVisionFlightsPositionDataHeader

/**
 * Header for a set of {@link AiVisionFlightsPositionDataPoint} measurements.
 *
 * @remarks this represents a value passed to a method that expects an instance of AiVisionFlightsPositionDataHeader
 */
declare interface IAiVisionFlightsPositionDataHeader {
   ...
   */
  data?: C3.Array<AiVisionFlightsPositionDataPoint | null> | Array<IAiVisionFlightsPositionDataPoint | null>;
 ...
 */
declare class AiVisionFlightsPositionDataHeader extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): AiVisionFlightsPositionDataHeader | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): AiVisionFlightsPositionDataHeader | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): AiVisionFlightsPositionDataHeader | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): AiVisionFlightsPositionDataHeader | null;
   ...
   */
  replaceType(old: Type, new_: Type): AiVisionFlightsPositionDataHeader;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): AiVisionFlightsPositionDataHeader;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): AiVisionFlightsPositionDataHeader;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<AiVisionFlightsPositionDataHeader | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<AiVisionFlightsPositionDataHeader | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): AiVisionFlightsPositionDataHeader;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): AiVisionFlightsPositionDataHeader;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): AiVisionFlightsPositionDataHeader;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): AiVisionFlightsPositionDataHeader;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): AiVisionFlightsPositionDataHeader;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): AiVisionFlightsPositionDataHeader;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): AiVisionFlightsPositionDataHeader;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): AiVisionFlightsPositionDataHeader;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): AiVisionFlightsPositionDataHeader;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): AiVisionFlightsPositionDataHeader;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): AiVisionFlightsPositionDataHeader;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): AiVisionFlightsPositionDataHeader;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): AiVisionFlightsPositionDataHeader;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): AiVisionFlightsPositionDataHeader;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): AiVisionFlightsPositionDataHeader;
   ...
   * @see #unsetField
   */
  defaultField(field: string): AiVisionFlightsPositionDataHeader;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): AiVisionFlightsPositionDataHeader;
   ...
   * @see #removeField
   */
  unsetField(field: string): AiVisionFlightsPositionDataHeader;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): AiVisionFlightsPositionDataHeader;
   ...
   * @see #unsetField
   */
  removeField(field: string): AiVisionFlightsPositionDataHeader;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): AiVisionFlightsPositionDataHeader;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): AiVisionFlightsPositionDataHeader;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): AiVisionFlightsPositionDataHeader;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): AiVisionFlightsPositionDataHeader;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): AiVisionFlightsPositionDataHeader;

  mergeJson(json: any | null): AiVisionFlightsPositionDataHeader;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): AiVisionFlightsPositionDataHeader;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): AiVisionFlightsPositionDataHeader;
   ...
   */
  singletonArray(): C3.Array<AiVisionFlightsPositionDataHeader | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<AiVisionFlightsPositionDataHeader | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<AiVisionFlightsPositionDataHeader | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<AiVisionFlightsPositionDataHeader | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<AiVisionFlightsPositionDataHeader | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, AiVisionFlightsPositionDataHeader | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, AiVisionFlightsPositionDataHeader | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<AiVisionFlightsPositionDataHeader | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<AiVisionFlightsPositionDataHeader | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): AiVisionFlightsPositionDataHeader;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): AiVisionFlightsPositionDataHeader;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): AiVisionFlightsPositionDataHeader;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): AiVisionFlightsPositionDataHeader;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): AiVisionFlightsPositionDataHeader;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): AiVisionFlightsPositionDataHeader;
   ...
   * @see #fromString
   */
  static make(s: string | null): AiVisionFlightsPositionDataHeader | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): AiVisionFlightsPositionDataHeader;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): AiVisionFlightsPositionDataHeader;
   ...
   */
  static cachedEmptyInst(): AiVisionFlightsPositionDataHeader;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<AiVisionFlightsPositionDataHeader>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): AiVisionFlightsPositionDataHeader;
   ...
   */
  static normalizeTimeseries(timeseries?: TimedDataFields<AiVisionFlightsPositionDataPoint | null> | null, start?: DateTime | null, end?: DateTime | null, overrideGrain?: string | null, forceGrainDetection?: boolean, force?: boolean): void;
   ...
   */
  static normalize(timeseries?: TimedDataFields<AiVisionFlightsPositionDataPoint | null> | null, start?: DateTime | null, end?: DateTime | null, overrideGrain?: string | null, forceGrainDetection?: boolean): NormalizationResult | null;
   ...
   */
  static normalizationUnit(rawHeader: TimedDataFields<AiVisionFlightsPositionDataPoint | null>, tsField: string): Unit | null;
   ...
   */
  static normalizationTreatment(rawHeader: TimedDataFields<AiVisionFlightsPositionDataPoint | null>, tsField: string): string;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<AiVisionFlightsPositionDataHeader | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<AiVisionFlightsPositionDataHeader | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<AiVisionFlightsPositionDataHeader | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<AiVisionFlightsPositionDataHeader | null> | null>;
   ...
   */
  get(include?: string | null): AiVisionFlightsPositionDataHeader | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): AiVisionFlightsPositionDataHeader | null;
   ...
   */
  getMissing(spec: GetMissingSpec): AiVisionFlightsPositionDataHeader;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): AiVisionFlightsPositionDataHeader | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): AiVisionFlightsPositionDataHeader;
   ...
   * @see #toString
   */
  static fromString(s: string | null): AiVisionFlightsPositionDataHeader | null;
   ...
   */
  create(spec?: UpsertSpec | null): AiVisionFlightsPositionDataHeader | null;
   ...
   */
  static createBatch(objs: C3.Array<AiVisionFlightsPositionDataHeader | null> | null, spec?: UpsertSpec | null): ObjList<AiVisionFlightsPositionDataHeader | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<AiVisionFlightsPositionDataHeader | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<AiVisionFlightsPositionDataHeader | null> | null;
   ...
   */
  update(srcObj?: AiVisionFlightsPositionDataHeader | null, spec?: UpsertSpec | null): AiVisionFlightsPositionDataHeader | null;
   ...
   */
  upsert(srcObj?: AiVisionFlightsPositionDataHeader | null, spec?: UpsertSpec | null): AiVisionFlightsPositionDataHeader | null;
   ...
   */
  merge(spec?: MergeSpec | null): AiVisionFlightsPositionDataHeader | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): AiVisionFlightsPositionDataHeader | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): AiVisionFlightsPositionDataHeader | null;
   ...
   */
  static updateBatch(objs: C3.Array<AiVisionFlightsPositionDataHeader | null> | null, srcObjs?: C3.Array<AiVisionFlightsPositionDataHeader | null>, spec?: UpsertSpec | null): ObjList<AiVisionFlightsPositionDataHeader | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<AiVisionFlightsPositionDataHeader | null>>, spec?: UpsertSpec | null): ObjList<AiVisionFlightsPositionDataHeader | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<AiVisionFlightsPositionDataHeader | null> | null, srcObjs?: C3.Array<AiVisionFlightsPositionDataHeader | null>, spec?: UpsertSpec | null): ObjList<AiVisionFlightsPositionDataHeader | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<AiVisionFlightsPositionDataHeader | null>>, spec?: UpsertSpec | null): ObjList<AiVisionFlightsPositionDataHeader | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<AiVisionFlightsPositionDataHeader | null> | null, spec?: TouchSpec | null): ObjList<AiVisionFlightsPositionDataHeader | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<AiVisionFlightsPositionDataHeader | null> | null, spec?: MergeSpec | null): ObjList<AiVisionFlightsPositionDataHeader | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<AiVisionFlightsPositionDataHeader | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<AiVisionFlightsPositionDataHeader | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<AiVisionFlightsPositionDataHeader | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<AiVisionFlightsPositionDataHeader | null> | null;
   ...
   */
  static mergeAll(mergeObj: AiVisionFlightsPositionDataHeader | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: AiVisionFlightsPositionDataHeader | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<AiVisionFlightsPositionDataHeader | null> | null, spec?: UpsertSpec | null): ObjList<AiVisionFlightsPositionDataHeader | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<AiVisionFlightsPositionDataHeader | null> | null, spec?: UpsertSpec | null): ObjList<AiVisionFlightsPositionDataHeader | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): AiVisionFlightsPositionDataHeader | null;
   ...
   */
  static beforeCreate(objs: C3.Array<AiVisionFlightsPositionDataHeader | null> | null): ObjList<AiVisionFlightsPositionDataHeader | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<AiVisionFlightsPositionDataHeader | null> | null): ObjList<AiVisionFlightsPositionDataHeader | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<AiVisionFlightsPositionDataHeader | null> | null): ObjList<AiVisionFlightsPositionDataHeader | null>;
   ...
   */
  static afterCreate(objs: C3.Array<AiVisionFlightsPositionDataHeader | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<AiVisionFlightsPositionDataHeader | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<AiVisionFlightsPositionDataHeader | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<AiVisionFlightsPositionDataHeader | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<AiVisionFlightsPositionDataHeader | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): AiVisionFlightsPositionDataHeader | null;
   ...
   */
  withoutIdentity(): AiVisionFlightsPositionDataHeader | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<AiVisionFlightsPositionDataHeader | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: AiVisionFlightsPositionDataHeader | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<AiVisionFlightsPositionDataHeader | null> | null, callback?: λFunction<AiVisionFlightsPositionDataHeader | null, AiVisionFlightsPositionDataHeader | null> | null): ObjList<AiVisionFlightsPositionDataHeader | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<AiVisionFlightsPositionDataHeader | null> | null, callback?: λFunction<AiVisionFlightsPositionDataHeader | null, AiVisionFlightsPositionDataHeader | null> | null): C3.Array<ObjError | null>;
