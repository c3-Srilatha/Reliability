// TypeScript definitions for the C3 type Item

/**
 * Entity type representing an item/asset. An item can be a physical asset or a virtual asset.
 *
 * @remarks this represents a value passed to a method that expects an instance of Item
 */
 ...
 */
declare class Item extends Obj  {
  ...
  withTypeIdent(typeIdent: string | null): Item;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Item;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): Item;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): Item;
  ...
  withVersion(version: number | null): Item;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): Item;

  /**
   * Description of the item
   */
  readonly description?: string;
  withDescription(description: string | null): Item;
   ...
   * @see #toJson
   */
  static fromJson(json: any): Item | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): Item | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): Item | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): Item | null;
   ...
   */
  replaceType(old: Type, new_: Type): Item;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Item;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Item;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Item>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Item>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Item;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Item;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Item;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): Item;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): Item;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Item;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Item;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): Item;
   ...
   * @see #removeField
   */
  withoutField(field: string): Item;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): Item;
   ...
   */
  withoutFields(fields: Array_Type<string>): Item;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): Item;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): Item;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Item;
   ...
   * @see #unsetField
   */
  defaultField(field: string): Item;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): Item;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): Item;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): Item;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Item;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): Item;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Item;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Item;

  mergeJson(json: any): Item;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Item;
   ...
   */
  sumObj(other: Obj, deep?: boolean): Item;
   ...
   */
  singletonArray(): Array_Type<Item>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<Item> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<Item> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<Item>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<Item> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, Item> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, Item> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<Item>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<Item>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Item;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Item;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Item;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): Item;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Item;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): Item;
   ...
   * @see #fromString
   */
  static make(s: string): Item | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Item;
   ...
   */
  static cachedEmptyInst(): Item;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<Item> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): Item;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<Item>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<Item>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<Item> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Item>> | null;
   ...
   */
  static evalFeatureSetBatch(batch: Array_Type<Item>, featureSet: Feature.Set, spec?: EvalFeatureSpec): Data | null;
   ...
   * ```
   */
  static evalFeaturesBatch(batch: Array_Type<Item>, features: Array_Type<string>, spec?: EvalFeaturesSpec): Data | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): Item | null;
   ...
   */
  getMissing(spec: GetMissingSpec): Item;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): Item | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): Item;
   ...
   * @see #toString
   */
  static fromString(s: string): Item | null;
   ...
   */
  create(spec?: UpsertSpec): Item | null;
   ...
   */
  static createBatch(objs: Array_Type<Item>, spec?: UpsertSpec): ObjList<Item> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<Item>, spec?: CreateBatchObjStreamSpec): ObjList<Item> | null;
   ...
   */
  update(srcObj?: Item, spec?: UpsertSpec): Item | null;
   ...
   */
  upsert(srcObj?: Item, spec?: UpsertSpec): Item | null;
   ...
   */
  merge(spec?: MergeSpec): Item | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): Item | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): Item | null;
   ...
   */
  static updateBatch(objs: Array_Type<Item>, srcObjs?: Array_Type<Item>, spec?: UpsertSpec): ObjList<Item> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<Item> | null>, spec?: UpsertSpec): ObjList<Item> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<Item>, srcObjs?: Array_Type<Item>, spec?: UpsertSpec): ObjList<Item> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<Item> | null>, spec?: UpsertSpec): ObjList<Item> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<Item>, spec?: TouchSpec): ObjList<Item> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<Item>, spec?: MergeSpec): ObjList<Item> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<Item>, mergeInclude: string, spec?: MergeSpec): ObjList<Item> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<Item> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Item> | null;
   ...
   */
  static mergeAll(mergeObj: Item, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: Item, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<Item>, spec?: UpsertSpec): ObjList<Item> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<Item>, spec?: UpsertSpec): ObjList<Item> | null;
   ...
   */
  static beforeCreate(objs: Array_Type<Item>): ObjList<Item>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<Item>): ObjList<Item>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<Item>): ObjList<Item>;
   ...
   */
  static afterCreate(objs: Array_Type<Item>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<Item>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<Item>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<Item>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Item>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): Item | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<Item>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: Item, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<Item>, callback?: λFunction<Item | null, Item | null>): ObjList<Item>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<Item>, callback?: λFunction<Item | null, Item | null>): Array_Type<ObjError> | null;
