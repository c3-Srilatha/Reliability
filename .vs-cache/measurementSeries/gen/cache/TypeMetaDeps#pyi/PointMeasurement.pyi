...
class PointMeasurement(TimedDataPoint[PointPhysicalMeasurementSeries], Quantity):
    """
    Each entry represents a discrete measurement for a specific point in time.
    
    Thus far, most of them have been specific register read values.
    ...
    """
    def __init__(self, start: Optional[datetime]=None, outlierCode: Optional[int]=None, comments: Optional[str]=None, isEstimated: Optional[bool]=None, dataVersion: Optional[float]=None, statusCode: Optional[str]=None, PK_BIN_SEPARATOR: Optional[str]=None, parent: Optional[PointPhysicalMeasurementSeries]=None, quantity: Optional[ExactDimension]=None, id: Optional[str]=None, versionEdits: Optional[Array[VersionEdit]]=None, name: Optional[str]=None, meta: Optional[Meta]=None, version: Optional[int]=None, typeWithBindings: Optional[Type]=None) -> None: ...
