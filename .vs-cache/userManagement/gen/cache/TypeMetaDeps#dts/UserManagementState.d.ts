// TypeScript definitions for the C3 type UserManagementState

/**
 * Application state to manage data related to User Management.
 *
 * @remarks this represents a value passed to a method that expects an instance of UserManagementState
 */
declare interface IUserManagementState {
   ...
   */
  selectedUserGroupState?: string | null;
   ...
   */
  userGroups?: C3.Array<UserGroup | null> | Array<IUserGroup | null>;

  /**
   * Whether or not the parent package depends on uiInfrastructure
   */
  uiInfraDependent?: boolean;
}
 ...
 */
declare class UserManagementState extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UserManagementState | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UserManagementState | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UserManagementState | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UserManagementState | null;
   ...
   */
  replaceType(old: Type, new_: Type): UserManagementState;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UserManagementState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UserManagementState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UserManagementState | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UserManagementState | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UserManagementState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UserManagementState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UserManagementState;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UserManagementState;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UserManagementState;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UserManagementState;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UserManagementState;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UserManagementState;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UserManagementState;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UserManagementState;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UserManagementState;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UserManagementState;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UserManagementState;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UserManagementState;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UserManagementState;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UserManagementState;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UserManagementState;
   ...
   * @see #removeField
   */
  unsetField(field: string): UserManagementState;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UserManagementState;
   ...
   * @see #unsetField
   */
  removeField(field: string): UserManagementState;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UserManagementState;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UserManagementState;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UserManagementState;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UserManagementState;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UserManagementState;

  mergeJson(json: any | null): UserManagementState;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UserManagementState;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UserManagementState;
   ...
   */
  singletonArray(): C3.Array<UserManagementState | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UserManagementState | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UserManagementState | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UserManagementState | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UserManagementState | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UserManagementState | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UserManagementState | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UserManagementState | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UserManagementState | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UserManagementState;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UserManagementState;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UserManagementState;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UserManagementState;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UserManagementState;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UserManagementState;
   ...
   * @see #fromString
   */
  static make(s: string | null): UserManagementState | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UserManagementState;
   ...
   */
  static cachedEmptyInst(): UserManagementState;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UserManagementState>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UserManagementState;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<UserManagementState | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<UserManagementState | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<UserManagementState | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<UserManagementState | null> | null>;
   ...
   */
  dependencies(): MetadataDeps<UserManagementState | null>;

  save(subPath?: string | null, contentType?: string | null): UserManagementState;
  ...
  update(srcObj?: UserManagementState | null, spec?: UpsertSpec | null): UserManagementState | null;

  upsert(srcObj?: UserManagementState | null, spec?: UpsertSpec | null): UserManagementState | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): UserManagementState | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string | null, failIfMissing?: boolean): UserManagementState | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: UserManagementState, state: UiSdlReduxState): UserManagementState | null;
   ...
   */
  static setUiInfraDependentAction(uiInfraDependent?: boolean): UiSdlReduxAction<any>;
   ...
   * @returns a new Redux state
   */
  static uiInfraDependentSetReducer(state: UiSdlReduxState, action: UiSdlReduxAction<any>): UiSdlReduxState;
   ...
   */
  static setSelectedUserGroupAction(selectedUserGroup?: UserGroup | null): UiSdlReduxAction<any>;
   ...
   * @returns a new Redux state
   */
  static selectedUserGroupSetReducer(state: UiSdlReduxState, action: UiSdlReduxAction<any>): UiSdlReduxState;
   ...
   */
  static setSelectedUserGroupStateAction(selectedGroupState?: string | null): UiSdlReduxAction<any>;
   ...
   * @returns a new Redux state
   */
  static selectedUserGroupStateSetReducer(state: UiSdlReduxState, action: UiSdlReduxAction<any>): UiSdlReduxState;
   ...
   */
  static setUserGroupsAction(userGroups?: C3.Array<UserGroup | null>): UiSdlReduxAction<any>;

  /**
   * Returns the active user groups
   */
  static getUserGroups(state: UiSdlReduxState): C3.Array<UserGroup | null>;
   ...
   */
  static fetchUserGroupsAction(spec?: FetchSpec | null): UiSdlReduxAction<any>;
   ...
   * @returns a new Redux state
   */
  static userGroupsSetReducer(state: UiSdlReduxState, action: UiSdlReduxAction<any>): UiSdlReduxState;

  /**
   * Fetches and sets the `userGroups` in the application state.
   */
  static userGroupsFetchEpic(actionStream: UiSdlActionsObservable, stateStream: UiSdlStatesObservable): UiSdlActionsObservable;
   ...
   */
  static setApplicationAction(application?: string | null): UiSdlReduxAction<any>;
   ...
   */
  static fetchApplicationAction(): UiSdlReduxAction<any>;
   ...
   * @returns a new Redux state
   */
  static applicationSetReducer(state: UiSdlReduxState, action: UiSdlReduxAction<any>): UiSdlReduxState;

  /**
   * Fetches and sets the {@link #application} in the application state.
   */
  static applicationFetchEpic(actionStream: UiSdlActionsObservable, stateStream: UiSdlStatesObservable): UiSdlActionsObservable;

  /**
   * Returns the selected {@link UserGroup}
   */
  static getSelectedUserGroup(state: UiSdlReduxState): UserGroup | null;

  /**
   * Returns the current {@link #application}
   */
  static getApplication(state: UiSdlReduxState): App | null;

  /**
   * The Users grids are versioned, depending on application version - return the current user grid
   */
  static currentUsersGrid(state: UiSdlReduxState, gridContext?: string | null): string | null;
   ...
   */
  static setSelectedUserAction(selectedUser?: User | null): UiSdlReduxAction<any>;
   ...
   * @returns a new Redux state
   */
  static setSelectedUserReducer(state: UiSdlReduxState, action: UiSdlReduxAction<any>): UiSdlReduxState;
   ...
   */
  static usersChangedAction(): UiSdlReduxAction<any>;

  /**
   * Dispatches actions to make sure the UI is reflecting the latest data when {@link User}s change.
   */
  static usersChangedEpic(actionStream: UiSdlActionsObservable, stateStream: UiSdlStatesObservable): UiSdlActionsObservable;
   ...
   */
  static clearAppStateReducer(state: UiSdlReduxState): UiSdlReduxState;
}
