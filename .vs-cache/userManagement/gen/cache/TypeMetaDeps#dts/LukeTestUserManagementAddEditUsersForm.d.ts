// TypeScript definitions for the C3 type LukeTestUserManagementAddEditUsersForm

/**
 * Representation of a Add/Edit Users form for testing purposes
 *
 * @remarks this represents a value passed to a method that expects an instance of LukeTestUserManagementAddEditUsersForm
 */
declare interface ILukeTestUserManagementAddEditUsersForm {
  ...
  modalParentSelector?: string | null;

  /**
   * The testing {@link LukeTestUiSdlSelectInput} selected groups of the form
   */
  selectedGroupsInput?: ILukeTestUiSdlSelectInput | null;
}
 ...
 */
declare class LukeTestUserManagementAddEditUsersForm extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): LukeTestUserManagementAddEditUsersForm | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): LukeTestUserManagementAddEditUsersForm | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): LukeTestUserManagementAddEditUsersForm | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): LukeTestUserManagementAddEditUsersForm | null;
   ...
   */
  replaceType(old: Type, new_: Type): LukeTestUserManagementAddEditUsersForm;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): LukeTestUserManagementAddEditUsersForm;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): LukeTestUserManagementAddEditUsersForm;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<LukeTestUserManagementAddEditUsersForm | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<LukeTestUserManagementAddEditUsersForm | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): LukeTestUserManagementAddEditUsersForm;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): LukeTestUserManagementAddEditUsersForm;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): LukeTestUserManagementAddEditUsersForm;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): LukeTestUserManagementAddEditUsersForm;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): LukeTestUserManagementAddEditUsersForm;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): LukeTestUserManagementAddEditUsersForm;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): LukeTestUserManagementAddEditUsersForm;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): LukeTestUserManagementAddEditUsersForm;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): LukeTestUserManagementAddEditUsersForm;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): LukeTestUserManagementAddEditUsersForm;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): LukeTestUserManagementAddEditUsersForm;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): LukeTestUserManagementAddEditUsersForm;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): LukeTestUserManagementAddEditUsersForm;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): LukeTestUserManagementAddEditUsersForm;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): LukeTestUserManagementAddEditUsersForm;
   ...
   * @see #unsetField
   */
  defaultField(field: string): LukeTestUserManagementAddEditUsersForm;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): LukeTestUserManagementAddEditUsersForm;
   ...
   * @see #removeField
   */
  unsetField(field: string): LukeTestUserManagementAddEditUsersForm;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): LukeTestUserManagementAddEditUsersForm;
   ...
   * @see #unsetField
   */
  removeField(field: string): LukeTestUserManagementAddEditUsersForm;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): LukeTestUserManagementAddEditUsersForm;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): LukeTestUserManagementAddEditUsersForm;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): LukeTestUserManagementAddEditUsersForm;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): LukeTestUserManagementAddEditUsersForm;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): LukeTestUserManagementAddEditUsersForm;

  mergeJson(json: any | null): LukeTestUserManagementAddEditUsersForm;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): LukeTestUserManagementAddEditUsersForm;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): LukeTestUserManagementAddEditUsersForm;
   ...
   */
  singletonArray(): C3.Array<LukeTestUserManagementAddEditUsersForm | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<LukeTestUserManagementAddEditUsersForm | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<LukeTestUserManagementAddEditUsersForm | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<LukeTestUserManagementAddEditUsersForm | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<LukeTestUserManagementAddEditUsersForm | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, LukeTestUserManagementAddEditUsersForm | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, LukeTestUserManagementAddEditUsersForm | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<LukeTestUserManagementAddEditUsersForm | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<LukeTestUserManagementAddEditUsersForm | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): LukeTestUserManagementAddEditUsersForm;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): LukeTestUserManagementAddEditUsersForm;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): LukeTestUserManagementAddEditUsersForm;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): LukeTestUserManagementAddEditUsersForm;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): LukeTestUserManagementAddEditUsersForm;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): LukeTestUserManagementAddEditUsersForm;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): LukeTestUserManagementAddEditUsersForm;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): LukeTestUserManagementAddEditUsersForm;
   ...
   */
  static cachedEmptyInst(): LukeTestUserManagementAddEditUsersForm;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<LukeTestUserManagementAddEditUsersForm>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): LukeTestUserManagementAddEditUsersForm;
   ...
   */
  static init(luke: LukeBrowser): LukeTestUserManagementAddEditUsersForm | null;
}
