// TypeScript definitions for the C3 type LukeTestAutomationPage

/**
 * LukeTestAutomationPage is the base page type for local UI Luke test pages
 *
 * @remarks this represents a value passed to a method that expects an instance of LukeTestAutomationPage
 */
declare interface ILukeTestAutomationPage {
 ...
 */
declare class LukeTestAutomationPage extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): LukeTestAutomationPage | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): LukeTestAutomationPage | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): LukeTestAutomationPage | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): LukeTestAutomationPage | null;
   ...
   */
  replaceType(old: Type, new_: Type): LukeTestAutomationPage;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): LukeTestAutomationPage;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): LukeTestAutomationPage;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<LukeTestAutomationPage | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<LukeTestAutomationPage | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): LukeTestAutomationPage;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): LukeTestAutomationPage;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): LukeTestAutomationPage;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): LukeTestAutomationPage;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): LukeTestAutomationPage;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): LukeTestAutomationPage;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): LukeTestAutomationPage;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): LukeTestAutomationPage;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): LukeTestAutomationPage;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): LukeTestAutomationPage;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): LukeTestAutomationPage;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): LukeTestAutomationPage;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): LukeTestAutomationPage;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): LukeTestAutomationPage;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): LukeTestAutomationPage;
   ...
   * @see #unsetField
   */
  defaultField(field: string): LukeTestAutomationPage;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): LukeTestAutomationPage;
   ...
   * @see #removeField
   */
  unsetField(field: string): LukeTestAutomationPage;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): LukeTestAutomationPage;
   ...
   * @see #unsetField
   */
  removeField(field: string): LukeTestAutomationPage;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): LukeTestAutomationPage;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): LukeTestAutomationPage;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): LukeTestAutomationPage;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): LukeTestAutomationPage;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): LukeTestAutomationPage;

  mergeJson(json: any | null): LukeTestAutomationPage;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): LukeTestAutomationPage;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): LukeTestAutomationPage;
   ...
   */
  singletonArray(): C3.Array<LukeTestAutomationPage | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<LukeTestAutomationPage | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<LukeTestAutomationPage | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<LukeTestAutomationPage | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<LukeTestAutomationPage | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, LukeTestAutomationPage | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, LukeTestAutomationPage | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<LukeTestAutomationPage | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<LukeTestAutomationPage | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): LukeTestAutomationPage;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): LukeTestAutomationPage;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): LukeTestAutomationPage;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): LukeTestAutomationPage;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): LukeTestAutomationPage;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): LukeTestAutomationPage;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): LukeTestAutomationPage;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): LukeTestAutomationPage;
   ...
   */
  static cachedEmptyInst(): LukeTestAutomationPage;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<LukeTestAutomationPage>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): LukeTestAutomationPage;
   ...
   */
  static init(luke?: LukeBrowser | null, urlParams?: [pathParams: any | null, queryParams: any | null] | null, ...args: any[]): LukeTestAutomationPage | null;

  static _init(luke?: LukeBrowser | null, urlParams?: [pathParams: any | null, queryParams: any | null] | null, ...args: any[]): LukeTestAutomationPage | null;

  /**
   * Base implementation of {@link #init} that allows any remixer of this page to still call the base implementation.
   */
  static initInternal(luke?: LukeBrowser | null, urlParams?: [pathParams: any | null, queryParams: any | null] | null, ...args: any[]): LukeTestAutomationPage | null;
