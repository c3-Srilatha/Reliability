// TypeScript definitions for the C3 type LukeTestAutomationUser

/**
 * Luke Test Automation User Config to handle user/password for automation purposes
 *
 * @remarks this represents a value passed to a method that expects an instance of LukeTestAutomationUser
 */
declare interface ILukeTestAutomationUser {
 ...
 */
declare class LukeTestAutomationUser extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): LukeTestAutomationUser | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): LukeTestAutomationUser | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): LukeTestAutomationUser | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): LukeTestAutomationUser | null;
   ...
   */
  replaceType(old: Type, new_: Type): LukeTestAutomationUser;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): LukeTestAutomationUser;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): LukeTestAutomationUser;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<LukeTestAutomationUser | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<LukeTestAutomationUser | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): LukeTestAutomationUser;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): LukeTestAutomationUser;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): LukeTestAutomationUser;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): LukeTestAutomationUser;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): LukeTestAutomationUser;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): LukeTestAutomationUser;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): LukeTestAutomationUser;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): LukeTestAutomationUser;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): LukeTestAutomationUser;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): LukeTestAutomationUser;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): LukeTestAutomationUser;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): LukeTestAutomationUser;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): LukeTestAutomationUser;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): LukeTestAutomationUser;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): LukeTestAutomationUser;
   ...
   * @see #unsetField
   */
  defaultField(field: string): LukeTestAutomationUser;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): LukeTestAutomationUser;
   ...
   * @see #removeField
   */
  unsetField(field: string): LukeTestAutomationUser;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): LukeTestAutomationUser;
   ...
   * @see #unsetField
   */
  removeField(field: string): LukeTestAutomationUser;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): LukeTestAutomationUser;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): LukeTestAutomationUser;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): LukeTestAutomationUser;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): LukeTestAutomationUser;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): LukeTestAutomationUser;

  mergeJson(json: any | null): LukeTestAutomationUser;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): LukeTestAutomationUser;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): LukeTestAutomationUser;
   ...
   */
  singletonArray(): C3.Array<LukeTestAutomationUser | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<LukeTestAutomationUser | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<LukeTestAutomationUser | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<LukeTestAutomationUser | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<LukeTestAutomationUser | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, LukeTestAutomationUser | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, LukeTestAutomationUser | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<LukeTestAutomationUser | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<LukeTestAutomationUser | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): LukeTestAutomationUser;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): LukeTestAutomationUser;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): LukeTestAutomationUser;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): LukeTestAutomationUser;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): LukeTestAutomationUser;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): LukeTestAutomationUser;
   ...
   * @see #fromString
   */
  static make(s: string | null): LukeTestAutomationUser | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): LukeTestAutomationUser;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): LukeTestAutomationUser;
   ...
   */
  static cachedEmptyInst(): LukeTestAutomationUser;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<LukeTestAutomationUser>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): LukeTestAutomationUser;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<LukeTestAutomationUser | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<LukeTestAutomationUser | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<LukeTestAutomationUser | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): LukeTestAutomationUser | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string | null): LukeTestAutomationUser | null;
   ...
   * @see findByCacheKey
   */
  getCached(): LukeTestAutomationUser | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): LukeTestAutomationUser | null;
   ...
   */
  static produce(key: string): LukeTestAutomationUser | null;
   ...
   */
  static produceAll(): C3.Map<string | null, LukeTestAutomationUser | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, LukeTestAutomationUser | null>;
   ...
   */
  getConfig(): LukeTestAutomationUser;
   ...
   */
  getSecret(): LukeTestAutomationUser;
   ...
   */
  static forConfigKey(configKey: string | null): LukeTestAutomationUser | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<LukeTestAutomationUser | null>;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: LukeTestAutomationUser, override?: string | null): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: LukeTestAutomationUser, override?: string | null): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): LukeTestAutomationUser | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): LukeTestAutomationUser | null;
   ...
   */
  static forName(name: string | null, failIfMissing?: boolean): LukeTestAutomationUser | null;
   ...
   */
  static setTesterUser(luke: LukeBrowser, configName: string): string | null;
   ...
   */
  static getTesterUser(luke: LukeBrowser): string | null;
}
