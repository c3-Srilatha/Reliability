...
const filename = 'test_AzureFileSystemDataConnectorFlow';
...
LukeBrowser.runJasmine(filename, function () {
  describe(filename + ' @testApp(mode=dev)', function () {
    beforeAll(function () {
      ...
      this.connectorForm = LukeTestSelfServiceDIAzureConnectorForm.make({ luke: this.client }, true);
    ...
    describe('select connector', function () {
      beforeAll(function () {
        ...
        this.urlProtocol = 'azure://';
        this.absBucketUrl = this.urlProtocol + 'c3-local-env/';
        ...
        this.formValues = {
          ...
          bucketUrl: 'c3-local-env/',
          region: 'eastus',
          accountId: '',
          accountName: '',
          accessKey: '',
        };
        this.connectorSelector = '.data-connector-categories-list-container button[aria-label="Azure Blob"]';
      ...
      describe('::Azure Connector', function () {
        describe('select Azure', function () {
          beforeAll(function () {
          ...
          describe('clicking next', function () {
            ...
            describe('set fields in data connector form', function () {
              ...
              describe('region', function () {
                beforeAll(function () {
                  this.connectorForm.setRegion(this.formValues.region);
                });

                it('is correctly set', function () {
                  this.connectorForm.getRegion().assert(LukeAssertionMatcher.TO_EQUAL, this.formValues.region);
                });
              });

              describe('accessKey', function () {
                beforeAll(function () {
                  this.connectorForm.setAccessKey(this.formValues.accessKey);
                });

                it('is correctly set', function () {
                  this.connectorForm.getAccessKey().assert(LukeAssertionMatcher.TO_EQUAL, this.formValues.accessKey);
                });

                describe('removing the accessKey field', function () {
                  beforeAll(function () {
                    this.connectorForm.setAccessKey('');
                  });
                  ...
                  it('shows correct error', function () {
                    this.connectorForm.hasAccessKeyError();
                  });
                });
              });
              ...
              describe('accountId', function () {
                beforeAll(function () {
                  this.connectorForm.setAccountId(this.formValues.accountId);
                });

                it('is correctly set', function () {
                  this.connectorForm.getAccountId().assert(LukeAssertionMatcher.TO_EQUAL, this.formValues.accountId);
                });

                describe('removing the accountId field', function () {
                  beforeAll(function () {
                    this.connectorForm.setAccountId('');
                  });
                  ...
                  it('shows correct error', function () {
                    this.connectorForm.hasAccountIdError();
                  });
                });
              });
              ...
              describe('accountName', function () {
                beforeAll(function () {
                  this.connectorForm.setAccountName(this.formValues.accountName);
                });

                it('is correctly set', function () {
                  this.connectorForm
                    .getAccountName()
                    .assert(LukeAssertionMatcher.TO_EQUAL, this.formValues.accountName);
                });

                describe('removing the accountName field', function () {
                  beforeAll(function () {
                    this.connectorForm.setAccountName('');
                  });
                  ...
                  it('shows correct error', function () {
                    this.connectorForm.hasAccountNameError();
                  });
                });
              });
              ...
              describe('connection status', function () {
                ...
                describe('when accessKey is incorrect', function () {
                  beforeAll(function () {
                    this.connectorForm.setAccessKey('randomKey');
                    wait1Seconds();
                    this.connectorForm.clickTestConnectionButton();
                  });
                ...
                describe('when accountName is incorrect', function () {
                  beforeAll(function () {
                    this.connectorForm.setAccountName('randomAccountName');
                    wait1Seconds();
                    this.connectorForm.clickTestConnectionButton();
                  });
                  ...
                  it('shows inline error message', function () {
                    ...
                    this.errorInlineNotification
                      ...
                      .assert(
                        LukeAssertionMatcher.TO_EQUAL,
                        Translation.getTranslationForLocale(
                          'SelfServiceDI.DataConnectorForm.currentConnectStatus.timeout.text'
                        )
                      );
                  });
                });
              ...
              describe('clicking the correct tree node', function () {
                ...
                it('location is correct', function () {
                  ...
                  this.selfServiceDIPage
                    ...
                    .text()
                    .assert(LukeAssertionMatcher.TO_EQUAL, this.formValues.region);
                });
      ...
      describe('clicking on connection properties and changing description and bucketUrl', function () {
        describe('from the treeNodeActions', function () {
          beforeAll(function () {
            ...
            AzureFileSystem.inst().setMount('testMount', this.newAbsBucketUrl);
          ...
          afterAll(function () {
            ...
            this.connectorForm.setAccessKey(this.formValues.accessKey);
            this.selfServiceDIPage.multiStepComponent.proceed();
            AzureFileSystem.inst().removeMount('testMount');
            wait1Seconds();
            this.selfServiceDIPage.openPage();
          });
            ...
            describe('clicking cancel', function () {
              ...
              describe('and refreshing the page', function () {
                ...
                it('presentation tree view component shows failed inline notification', function () {
                  ...
                  this.selfServiceDIPage
                    .search('.c3-metadata-id-selfservicedi-sidepanelinlinenotification .inline-notification-link-text')
                    .text()
                    .assert(
                      LukeAssertionMatcher.TO_EQUAL,
                      Translation.getTranslationForLocale(
