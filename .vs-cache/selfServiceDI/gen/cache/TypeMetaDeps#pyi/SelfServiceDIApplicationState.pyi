...
# Python definitions for the C3 type SelfServiceDIApplicationState


class SelfServiceDIApplicationState(UiSdlSingletonApplicationState):
    """
    ...
    reservedTypeNames: Optional[Set[str]]=None
    """
    ...
    selectedSourceSystemCacheItem: Optional[SelfServiceDISourceSystemCacheItem]=None
    """
    Details about the currently selected source system cache item in the tree view.
    """

    selectedSourceCollectionCacheItem: Optional[SelfServiceDISourceCollectionCacheItem]=None
    """
    Details about the currently selected source collection cache item in the tree view.
    """

    selectedDataSourcePreviewTypeMeta: Optional[TypeMeta]=None
    """
    The type metadata for the current selection when previewing a data source in the landing page.
    """

    selectedDataSource: Optional[str]=None
    """
    The selected data source, currently used for selecting a data source to delete.
    """

    previewSourceDataErrors: Optional[Array[UiSdlInlineNotification]]=None

    selectedInlineNotification: Optional[Obj]=None

    schemaTabInlineNotification: Optional[UiSdlInlineNotification]=None
    """
    Used by multiple conditional renderers to decide which error inline notification to render
    """

    shouldRedirectToSchemaTab: Optional[bool]=None
    """
    -------------- SHOULD REDIRECT TO SCHEMA TAB --------------
    """

    selectedTableSchemaCacheItem: Optional[SelfServiceDITableSchemaCacheItem]=None
    """
    Details about the currently selected source collection's table schema cache item.
    """

    deletedSourceFiles: Optional[Map[str, Array[str]]]=None
    """
    ...
    expressionEngineFunctions: Optional[any]=None
    """
    The expression engine functions available in an application. used for providing suggestion and validating transforms
    """

    currentDiagramId: Optional[str]=None
    """
    The current diagram ID
    """

    dataConnectorsConnectionConfiguration: Optional[Map[str, any]]=None
    """
    ...
    fileSystemsMountsOptions: Optional[Map[str, Any]]=None
    """
    ...
    dataConnectorConfigFormData: Optional[Map[str, Any]]=None
    """
    Properties stored with values for Data Connector Config form
    """
    def __init__(self, meta: Optional[Meta]=None, id: Optional[str]=None, name: Optional[str]=None, dataSpec: Optional[UiSdlNoData]=None, disableDataRequestOnFirstRender: Optional[bool]=None, triggersRegistered: Optional[bool]=None, wrapWithMetadataId: Optional[bool]=None, REDUX_NAMESPACE: Optional[str]=None, effectTriggers: Optional[Array[UiSdlEffectTrigger]]=None, dataLoadMountPath: Optional[str]=None, rootPkg: Optional[str]=None, persistableKeywords: Optional[Array[str]]=None, persistableSchemaNames: Optional[Array[str]]=None, reservedTypeNames: Optional[Set[str]]=None, selectedSourceSystemCacheItem: Optional[SelfServiceDISourceSystemCacheItem]=None, selectedSourceCollectionCacheItem: Optional[SelfServiceDISourceCollectionCacheItem]=None, selectedDataSourcePreviewTypeMeta: Optional[TypeMeta]=None, selectedDataSource: Optional[str]=None, previewSourceDataErrors: Optional[Array[UiSdlInlineNotification]]=None, selectedInlineNotification: Optional[Obj]=None, schemaTabInlineNotification: Optional[UiSdlInlineNotification]=None, shouldRedirectToSchemaTab: Optional[bool]=None, selectedTableSchemaCacheItem: Optional[SelfServiceDITableSchemaCacheItem]=None, deletedSourceFiles: Optional[Map[str, Array[str]]]=None, expressionEngineFunctions: Optional[any]=None, currentDiagramId: Optional[str]=None, dataConnectorsConnectionConfiguration: Optional[Map[str, any]]=None, fileSystemsMountsOptions: Optional[Map[str, Any]]=None, dataConnectorConfigFormData: Optional[Map[str, Any]]=None) -> None: ...
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[SelfServiceDIApplicationState]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[SelfServiceDIApplicationState]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[SelfServiceDIApplicationState]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[SelfServiceDIApplicationState]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> SelfServiceDIApplicationState:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> SelfServiceDIApplicationState:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> SelfServiceDIApplicationState:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[SelfServiceDIApplicationState]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[SelfServiceDIApplicationState]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> SelfServiceDIApplicationState:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> SelfServiceDIApplicationState:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> SelfServiceDIApplicationState:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> SelfServiceDIApplicationState:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> SelfServiceDIApplicationState:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> SelfServiceDIApplicationState:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> SelfServiceDIApplicationState:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> SelfServiceDIApplicationState:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> SelfServiceDIApplicationState:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> SelfServiceDIApplicationState:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> SelfServiceDIApplicationState:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> SelfServiceDIApplicationState:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> SelfServiceDIApplicationState:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> SelfServiceDIApplicationState:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> SelfServiceDIApplicationState:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> SelfServiceDIApplicationState:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> SelfServiceDIApplicationState:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> SelfServiceDIApplicationState:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> SelfServiceDIApplicationState:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> SelfServiceDIApplicationState:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> SelfServiceDIApplicationState:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> SelfServiceDIApplicationState:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> SelfServiceDIApplicationState:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> SelfServiceDIApplicationState:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> SelfServiceDIApplicationState:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> SelfServiceDIApplicationState:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> SelfServiceDIApplicationState:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> SelfServiceDIApplicationState:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[SelfServiceDIApplicationState]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[SelfServiceDIApplicationState]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[SelfServiceDIApplicationState]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[SelfServiceDIApplicationState]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[SelfServiceDIApplicationState]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, SelfServiceDIApplicationState]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, SelfServiceDIApplicationState]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[SelfServiceDIApplicationState]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[SelfServiceDIApplicationState]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> SelfServiceDIApplicationState:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> SelfServiceDIApplicationState:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> SelfServiceDIApplicationState:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> SelfServiceDIApplicationState:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> SelfServiceDIApplicationState:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> SelfServiceDIApplicationState:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[SelfServiceDIApplicationState]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> SelfServiceDIApplicationState:
    """
    ...
    """
        ...
    def afterMake(self) -> SelfServiceDIApplicationState:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> SelfServiceDIApplicationState:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[SelfServiceDIApplicationState]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> SelfServiceDIApplicationState:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, spec: FetchSpec=None) -> FetchResult[SelfServiceDIApplicationState]:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, filter: Filter) -> FetchResult[SelfServiceDIApplicationState]:
    """
    ...
    """
        ...
    @classmethod
    def fetchObjStream(cls, spec: FetchStreamSpec=None) -> Union[Stream[SelfServiceDIApplicationState]]:
    """
    Fetches multiple obj instances based on a specification.  Only objs that the caller is authorized to fetch will be
    returned.
    ...
    """
        ...
    @classmethod
    def fetchMultiLocale(cls, spec: MultiLocaleFetchSpec=None) -> Union[Map[str, FetchResult[SelfServiceDIApplicationState]]]:
    """
    ...
    """
        ...
    def dependencies(self) -> MetadataDeps[SelfServiceDIApplicationState]:
    """
    Retrieves dependencies to types or other metadata elements for the given instance of metadata.
    """
        ...
    def save(self, subPath: str=None, contentType: str=None) -> SelfServiceDIApplicationState:
        ...
    ...
    def removeAll(cls, removeFilter: str=None) -> int:
        ...
    def update(self, srcObj: SelfServiceDIApplicationState=None, spec: UpsertSpec=None) -> Union[SelfServiceDIApplicationState]:
        ...
    def upsert(self, srcObj: SelfServiceDIApplicationState=None, spec: UpsertSpec=None) -> Union[SelfServiceDIApplicationState]:
        ...
    @classmethod
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[SelfServiceDIApplicationState]:
    """
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[SelfServiceDIApplicationState]:
    """
    ...
    def jsonify(cls, value: Any=None) -> Union[str]:
        ...
    @classmethod
    def doDataMerge(cls, componentId: str, dataSpecFieldName: str, dataDestinationFieldName: str, props: SelfServiceDIApplicationState, state: UiSdlReduxState) -> Union[SelfServiceDIApplicationState]:
    """
    ...
    """
        ...
    @classmethod
    def setDataLoadMountPathAction(cls, dataLoadMountPath: str=None) -> Union[UiSdlReduxAction[Any]]:
    """
    An action to set the dataLoadMountPath in state.
    """
        ...
    @classmethod
    def setDataLoadMountPathReducer(cls, state: UiSdlReduxState, action: UiSdlReduxAction[Any]) -> UiSdlReduxState:
    """
    Listens for actions of type `SET_DATA_LOAD_MOUNT_PATH` and sets dataLoadMountPath in state.
    """
        ...
    @classmethod
    def getDataLoadMountPath(cls, state: UiSdlReduxState) -> Union[str]:
    """
    Retrieves the dataLoadMountPath from state
    """
        ...
    @classmethod
    def setRootPkgAction(cls, rootPkg: str=None) -> Union[UiSdlReduxAction[Any]]:
    """
    Action to set the `rootPkg`
    """
        ...
    @classmethod
    def setRootPkgReducer(cls, state: UiSdlReduxState, action: UiSdlReduxAction[Any]) -> UiSdlReduxState:
    """
    Listens for actions of type `SET_ROOT_PKG`
    """
        ...
    @classmethod
    def setPersistableKeywordsAction(cls, persistableKeywords: Array[str]=None) -> Union[UiSdlReduxAction[Any]]:
    """
    Action to set the `persistableKeywords`, The fields and methods of {@link Persistable}
    """
        ...
    @classmethod
    def setPersistableKeywordsReducer(cls, state: UiSdlReduxState, action: UiSdlReduxAction[Any]) -> UiSdlReduxState:
    """
    Listens for actions of type `SET_PERSISTABLE_KEYWORDS`
    """
        ...
    @classmethod
    def getPersistableKeywords(cls, state: UiSdlReduxState) -> Union[Array[str]]:
    """
    Retrieves `persistableKeywords` from state
    """
        ...
    @classmethod
    def setPersistableSchemaNamesAction(cls, persistableSchemaNames: Array[str]=None) -> Union[UiSdlReduxAction[Any]]:
    """
    Action to set the `persistableSchemaNames`
    """
        ...
    @classmethod
    def setPersistableSchemaNamesReducer(cls, state: UiSdlReduxState, action: UiSdlReduxAction[Any]) -> UiSdlReduxState:
    """
    Listens for actions of type `SET_PERSISTABLE_SCHEMA_NAMES` and sets `persistableSchemaNames` in state
    """
        ...
    @classmethod
    def getPersistableSchemaNames(cls, state: UiSdlReduxState) -> Union[Array[str]]:
    """
    Retrieves `persistableSchemaNames` from state
    """
        ...
    @classmethod
    def setReservedTypeNamesAction(cls, typeNames: Set[str]=None) -> Union[UiSdlReduxAction[Any]]:
    """
    Action to set the `reservedTypeNames`
    """
        ...
    @classmethod
    def setReservedTypeNamesReducer(cls, state: UiSdlReduxState, action: UiSdlReduxAction[Any]) -> UiSdlReduxState:
    """
    Listens for actions of type `SET_RESERVED_TYPE_NAMES` and sets `reservedTypeNames` in state
    """
        ...
    @classmethod
    def getReservedTypeNames(cls, state: UiSdlReduxState) -> Union[Set[str]]:
    """
    Retrieves `reservedTypeNames`, which are the type names for the entire pkg.
    """
        ...
    @classmethod
    def setSelectedSourceSystemCacheItemAction(cls, sourceSystemCacheItem: SelfServiceDISourceSystemCacheItem=None) -> UiSdlReduxAction[Any]:
    """
    An action to set the {@link selectedSourceSystemCacheItem}
    """
        ...
    @classmethod
    def setSelectedSourceSystemCacheItemReducer(cls, state: UiSdlReduxState, action: UiSdlReduxAction[Any]) -> UiSdlReduxState:
    """
    Listens for actions of type `SET_SELECTED_SOURCE_SYSTEM_CACHE_ITEM` and sets {@link selectedSourceSystemCacheItem} in state.
    """
        ...
    @classmethod
    def getSelectedSourceSystemCacheItem(cls, state: UiSdlReduxState) -> Union[SelfServiceDISourceSystemCacheItem]:
    """
    Returns the {@link selectedSourceSystemCacheItem} from the state.
    """
        ...
    @classmethod
    def setSelectedSourceCollectionCacheItemAction(cls, sourceCollectionCacheItem: SelfServiceDISourceCollectionCacheItem=None) -> UiSdlReduxAction[Any]:
    """
    An action to set the {@link selectedSourceCollectionCacheItem}
    """
        ...
    @classmethod
    def setSelectedSourceCollectionCacheItemReducer(cls, state: UiSdlReduxState, action: UiSdlReduxAction[Any]) -> UiSdlReduxState:
    """
    ...
    """
        ...
    @classmethod
    def getSelectedSourceCollectionCacheItem(cls, state: UiSdlReduxState) -> Union[SelfServiceDISourceCollectionCacheItem]:
    """
    Returns the {@link selectedSourceCollectionCacheItem} from the state.
    """
        ...
    @classmethod
    def getSelectedSourceCollection(cls, state: UiSdlReduxState) -> Union[SourceCollection[SourceCollection.Config]]:
    """
    Returns the {@link selectedSourceCollection} from the state.
    """
        ...
    @classmethod
    def setSelectedDataSourcePreviewTypeMetaAction(cls, typeMeta: TypeMeta=None) -> UiSdlReduxAction[Any]:
    """
    An action to set the `selectedDataSourcePreviewTypeMeta`
    """
        ...
    @classmethod
    def setSelectedDataSourcePreviewTypeMetaReducer(cls, state: UiSdlReduxState, action: UiSdlReduxAction[Any]) -> UiSdlReduxState:
    """
    Sets the `selectedDataSourcePreviewTypeMeta`
    """
        ...
    @classmethod
    def getSelectedDataSourcePreviewTypeMeta(cls, state: UiSdlReduxState) -> Union[TypeMeta]:
    """
    Retrieves the `selectedDataSourcePreviewTypeMeta`
    """
        ...
    @classmethod
    def setSelectedDataSourceAction(cls, selectedDataSource: str=None) -> UiSdlReduxAction[Any]:
    """
    An action to set `selectedDataSource`
    """
        ...
    @classmethod
    def setSelectedDataSourceReducer(cls, state: UiSdlReduxState, action: UiSdlReduxAction[Any]) -> UiSdlReduxState:
    """
    Listens for actions of type `SET_SELECTED_DATA_SOURCE`
    """
        ...
    @classmethod
    def setPreviewSourceDataErrorsAction(cls, errors: Array[UiSdlInlineNotification]=None) -> UiSdlReduxAction[Any]:
    """
    An action to set the current errors that may occur when a user is previewing remote data.
    """
        ...
    @classmethod
    def setPreviewSourceDataErrorsReducer(cls, state: UiSdlReduxState, action: UiSdlReduxAction[Any]) -> UiSdlReduxState:
    """
    Listens for actions of type `SET_PREVIEW_SOURCE_DATA_ERRORS` and sets the previewSourceDataErrors in state.
    """
        ...
    @classmethod
    def setSelectedInlineNotificationAction(cls, selectedInlineNotification: Obj=None) -> UiSdlReduxAction[Any]:
    """
    An action set selectedInlineNotification, the object of id and the linkText
    """
        ...
    @classmethod
    def setSchemaTabInlineNotificationAction(cls, component: UiSdlInlineNotification=None) -> UiSdlReduxAction[Any]:
    """
    An action to set `schemaTabInlineNotification`
    """
        ...
    @classmethod
    def setSchemaTabInlineNotificationReducer(cls, state: UiSdlReduxState, action: UiSdlReduxAction[Any]) -> UiSdlReduxState:
    """
    Listens for actions of type `SET_SCHEMA_TAB_INLINE_NOTIFICATION` and sets `schemaTabInlineNotification`
    """
        ...
    @classmethod
    def setShouldRedirectToSchemaTabAction(cls, shouldRedirect: bool=None) -> UiSdlReduxAction[Any]:
    """
    ...
    """
        ...
    @classmethod
    def setShouldRedirectToSchemaTabReducer(cls, state: UiSdlReduxState, action: UiSdlReduxAction[Any]) -> UiSdlReduxState:
    """
    Listens for actions of type `SET_SHOULD_REDIRECT_TO_SCHEMA_TAB` and sets `shouldRedirectToSchemaTab`
    """
        ...
    @classmethod
    def getShouldRedirectToSchemaTab(cls, state: UiSdlReduxState) -> bool:
    """
    Retrieves `shouldRedirectToSchemaTab`
    """
        ...
    @classmethod
    def setSelectedTableSchemaCacheItemAction(cls, tableSchemaCacheItem: SelfServiceDITableSchemaCacheItem=None) -> UiSdlReduxAction[Any]:
    """
    An action to set the {@link selectedTableSchemaCacheItem}
    """
        ...
    @classmethod
    def setSelectedTableSchemaCacheItemReducer(cls, state: UiSdlReduxState, action: UiSdlReduxAction[Any]) -> UiSdlReduxState:
    """
    Listens for actions of type `SET_SELECTED_TABLE_SCHEMA_CACHE_ITEM` and sets {@link selectedTableSchemaCacheItem} in state.
    """
        ...
    @classmethod
    def getSelectedTableSchemaCacheItem(cls, state: UiSdlReduxState) -> Union[any]:
    """
    Returns the {@link selectedTableSchemaCacheItem} from the state.
    """
        ...
    @classmethod
    def setDeletedSourceFilesAction(cls, deletedSourceFiles: Map[str, Array[str]]=None) -> UiSdlReduxAction[Any]:
    """
    An action to set `deletedSourceFiles`
    """
        ...
    @classmethod
    def setDeletedSourceFilesReducer(cls, state: UiSdlReduxState, action: UiSdlReduxAction[Any]) -> UiSdlReduxState:
    """
    Listens for actions of type `SET_DELETED_SOURCE_FILES` and sets `deletedSourceFiles`
    """
        ...
    @classmethod
    def fetchExpressionEngineFunctionsAction(cls) -> Union[UiSdlReduxAction[Any]]:
    """
    Action to fetch all the expression engine functions from the {@link TypeMeta}'s
    """
        ...
    @classmethod
    def setExpressionEngineFunctionsAction(cls) -> Union[UiSdlReduxAction[Any]]:
    """
    Action to set the available expression engine functions in state
    """
        ...
    @classmethod
    def setExpressionEngineFunctionsReducer(cls, state: UiSdlReduxState, action: UiSdlReduxAction[Any]) -> UiSdlReduxState:
    """
    Listens for actions of type `SET_EXPRESSION_ENGINE_FUNCTIONS`
    """
        ...
    @classmethod
    def getExpressionEngineFunctions(cls, state: UiSdlReduxState) -> Union[any]:
    """
    Returns the available `expressionEngineFunctions` from state
    """
        ...
    @classmethod
    def loadExpressionEngineFunctionsEpic(cls, actionStream: UiSdlActionsObservable, stateStream: UiSdlStatesObservable) -> UiSdlActionsObservable:
        ...
    @classmethod
    ...
    """
        ...
    @classmethod
    def setCurrentDiagramIdAction(cls, diagramId: str=None) -> UiSdlReduxAction[Any]:
    """
    Sets the current diagram ID in state
    """
        ...
    @classmethod
    def setCurrentDiagramIdReducer(cls, state: UiSdlReduxState, action: UiSdlReduxAction[Any]) -> UiSdlReduxState:
    """
    Listens for action of type `SET_CURRENT_DIAGRAM_ID` and sets the diagramId in state.
    """
        ...
    @classmethod
    def getCurrentDiagramId(cls, state: UiSdlReduxState) -> Union[str]:
    """
    Returns the currentDiagramId from the state.
    """
        ...
    @classmethod
    def setDataConnectorsConnectionConfigurationAction(cls, dataConnectorsConnectionConfiguration: Map[str, any]=None) -> Union[UiSdlReduxAction[Any]]:
    """
    Action to set the `dataConnectorsConnectionConfiguration`
    """
        ...
    @classmethod
    def setDataConnectorsConnectionConfigurationReducer(cls, state: UiSdlReduxState, action: UiSdlReduxAction[Any]) -> UiSdlReduxState:
    """
    Listens for actions of type `SET_DATA_CONNECTORS_CONNECTION_CONFIGURATION`
    """
        ...
    @classmethod
    def getDataConnectorsConnectionConfiguration(cls, state: UiSdlReduxState) -> Union[Map[str, any]]:
    """
    Returns the data connectors configuration from the state.
    """
        ...
    @classmethod
    def setFileSystemsMountsOptionsAction(cls, fileSystemsMountsOptions: Map[str, Any]=None) -> UiSdlReduxAction[Any]:
    """
    Action to set the `fileSystemsMountsOptions`
    """
        ...
    @classmethod
    def setFileSystemsMountsOptionsReducer(cls, state: UiSdlReduxState, action: UiSdlReduxAction[Any]) -> UiSdlReduxState:
    """
    Listens for actions of type `SET_FILE_SYSTEMS_MOUNTS_OPTIONS`
    """
        ...
    @classmethod
    def getFileSystemsMountsOptions(cls, state: UiSdlReduxState) -> Union[Map[str, Any]]:
    """
    Returns fileSystemsMountsOptions from state.
    """
        ...
    @classmethod
    def setDataConnectorFormDataAction(cls, dataConnectorConfigFormData: Map[str, Any]=None) -> UiSdlReduxAction[Any]:
    """
    Action to set the `dataConnectorConfigFormData`
    """
        ...
    @classmethod
    def setDataConnectorFormDataReducer(cls, state: UiSdlReduxState, action: UiSdlReduxAction[Any]) -> UiSdlReduxState:
    """
    Listens for actions of type `SET_DATA_CONNECTOR_FORM_DATA`
    """
        ...
    @classmethod
    def getDataConnectorFormData(cls, state: UiSdlReduxState) -> Union[Map[str, Any]]:
    """
