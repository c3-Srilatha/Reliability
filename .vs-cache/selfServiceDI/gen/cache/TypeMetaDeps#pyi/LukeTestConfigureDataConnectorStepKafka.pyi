...
# Python definitions for the C3 type LukeTestConfigureDataConnectorStepKafka


class LukeTestConfigureDataConnectorStepKafka(LukeTestConfigureDataConnectorStepCloudMessageConnector):
    """
    The connector type for Cloud Message connectors which holds shared items of all Cloud Message connectors
    
    @remarks this represents a made instance of LukeTestConfigureDataConnectorStepKafka
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[LukeTestConfigureDataConnectorStepKafka]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[LukeTestConfigureDataConnectorStepKafka]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[LukeTestConfigureDataConnectorStepKafka]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[LukeTestConfigureDataConnectorStepKafka]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> LukeTestConfigureDataConnectorStepKafka:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> LukeTestConfigureDataConnectorStepKafka:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> LukeTestConfigureDataConnectorStepKafka:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[LukeTestConfigureDataConnectorStepKafka]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[LukeTestConfigureDataConnectorStepKafka]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> LukeTestConfigureDataConnectorStepKafka:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> LukeTestConfigureDataConnectorStepKafka:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> LukeTestConfigureDataConnectorStepKafka:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> LukeTestConfigureDataConnectorStepKafka:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> LukeTestConfigureDataConnectorStepKafka:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> LukeTestConfigureDataConnectorStepKafka:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> LukeTestConfigureDataConnectorStepKafka:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> LukeTestConfigureDataConnectorStepKafka:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> LukeTestConfigureDataConnectorStepKafka:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> LukeTestConfigureDataConnectorStepKafka:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> LukeTestConfigureDataConnectorStepKafka:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> LukeTestConfigureDataConnectorStepKafka:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> LukeTestConfigureDataConnectorStepKafka:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> LukeTestConfigureDataConnectorStepKafka:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> LukeTestConfigureDataConnectorStepKafka:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> LukeTestConfigureDataConnectorStepKafka:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> LukeTestConfigureDataConnectorStepKafka:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> LukeTestConfigureDataConnectorStepKafka:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> LukeTestConfigureDataConnectorStepKafka:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> LukeTestConfigureDataConnectorStepKafka:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> LukeTestConfigureDataConnectorStepKafka:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> LukeTestConfigureDataConnectorStepKafka:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> LukeTestConfigureDataConnectorStepKafka:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> LukeTestConfigureDataConnectorStepKafka:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> LukeTestConfigureDataConnectorStepKafka:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> LukeTestConfigureDataConnectorStepKafka:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> LukeTestConfigureDataConnectorStepKafka:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> LukeTestConfigureDataConnectorStepKafka:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[LukeTestConfigureDataConnectorStepKafka]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[LukeTestConfigureDataConnectorStepKafka]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[LukeTestConfigureDataConnectorStepKafka]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[LukeTestConfigureDataConnectorStepKafka]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[LukeTestConfigureDataConnectorStepKafka]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, LukeTestConfigureDataConnectorStepKafka]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, LukeTestConfigureDataConnectorStepKafka]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[LukeTestConfigureDataConnectorStepKafka]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[LukeTestConfigureDataConnectorStepKafka]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> LukeTestConfigureDataConnectorStepKafka:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> LukeTestConfigureDataConnectorStepKafka:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> LukeTestConfigureDataConnectorStepKafka:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> LukeTestConfigureDataConnectorStepKafka:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> LukeTestConfigureDataConnectorStepKafka:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> LukeTestConfigureDataConnectorStepKafka:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> LukeTestConfigureDataConnectorStepKafka:
    """
    ...
    """
        ...
    def afterMake(self) -> LukeTestConfigureDataConnectorStepKafka:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> LukeTestConfigureDataConnectorStepKafka:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[LukeTestConfigureDataConnectorStepKafka]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> LukeTestConfigureDataConnectorStepKafka:
    """
    ...
    @param credentials
              The inputted credentials to be given in the form for the connector
               streamName
                 The topic name to be given in the form for the connector
               endpoint
                 The endpoint to be given in the form for the connector
               apiKey
                 The api key to be given in the form for the connector
               apiSecret
                 The api secret to be given in the form for the connector
