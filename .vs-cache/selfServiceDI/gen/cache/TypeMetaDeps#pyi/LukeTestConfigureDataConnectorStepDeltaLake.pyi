...
# Python definitions for the C3 type LukeTestConfigureDataConnectorStepDeltaLake


class LukeTestConfigureDataConnectorStepDeltaLake(LukeTestConfigureDataConnectorStepSqlConnector):
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[LukeTestConfigureDataConnectorStepDeltaLake]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[LukeTestConfigureDataConnectorStepDeltaLake]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[LukeTestConfigureDataConnectorStepDeltaLake]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[LukeTestConfigureDataConnectorStepDeltaLake]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> LukeTestConfigureDataConnectorStepDeltaLake:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> LukeTestConfigureDataConnectorStepDeltaLake:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> LukeTestConfigureDataConnectorStepDeltaLake:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[LukeTestConfigureDataConnectorStepDeltaLake]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[LukeTestConfigureDataConnectorStepDeltaLake]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> LukeTestConfigureDataConnectorStepDeltaLake:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> LukeTestConfigureDataConnectorStepDeltaLake:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> LukeTestConfigureDataConnectorStepDeltaLake:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> LukeTestConfigureDataConnectorStepDeltaLake:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> LukeTestConfigureDataConnectorStepDeltaLake:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> LukeTestConfigureDataConnectorStepDeltaLake:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> LukeTestConfigureDataConnectorStepDeltaLake:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> LukeTestConfigureDataConnectorStepDeltaLake:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> LukeTestConfigureDataConnectorStepDeltaLake:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> LukeTestConfigureDataConnectorStepDeltaLake:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> LukeTestConfigureDataConnectorStepDeltaLake:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> LukeTestConfigureDataConnectorStepDeltaLake:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> LukeTestConfigureDataConnectorStepDeltaLake:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> LukeTestConfigureDataConnectorStepDeltaLake:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> LukeTestConfigureDataConnectorStepDeltaLake:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> LukeTestConfigureDataConnectorStepDeltaLake:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> LukeTestConfigureDataConnectorStepDeltaLake:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> LukeTestConfigureDataConnectorStepDeltaLake:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> LukeTestConfigureDataConnectorStepDeltaLake:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> LukeTestConfigureDataConnectorStepDeltaLake:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> LukeTestConfigureDataConnectorStepDeltaLake:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> LukeTestConfigureDataConnectorStepDeltaLake:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> LukeTestConfigureDataConnectorStepDeltaLake:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> LukeTestConfigureDataConnectorStepDeltaLake:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> LukeTestConfigureDataConnectorStepDeltaLake:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> LukeTestConfigureDataConnectorStepDeltaLake:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> LukeTestConfigureDataConnectorStepDeltaLake:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> LukeTestConfigureDataConnectorStepDeltaLake:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[LukeTestConfigureDataConnectorStepDeltaLake]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[LukeTestConfigureDataConnectorStepDeltaLake]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[LukeTestConfigureDataConnectorStepDeltaLake]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[LukeTestConfigureDataConnectorStepDeltaLake]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[LukeTestConfigureDataConnectorStepDeltaLake]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, LukeTestConfigureDataConnectorStepDeltaLake]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, LukeTestConfigureDataConnectorStepDeltaLake]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[LukeTestConfigureDataConnectorStepDeltaLake]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[LukeTestConfigureDataConnectorStepDeltaLake]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> LukeTestConfigureDataConnectorStepDeltaLake:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> LukeTestConfigureDataConnectorStepDeltaLake:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> LukeTestConfigureDataConnectorStepDeltaLake:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> LukeTestConfigureDataConnectorStepDeltaLake:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> LukeTestConfigureDataConnectorStepDeltaLake:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> LukeTestConfigureDataConnectorStepDeltaLake:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> LukeTestConfigureDataConnectorStepDeltaLake:
    """
    ...
    """
        ...
    def afterMake(self) -> LukeTestConfigureDataConnectorStepDeltaLake:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> LukeTestConfigureDataConnectorStepDeltaLake:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[LukeTestConfigureDataConnectorStepDeltaLake]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> LukeTestConfigureDataConnectorStepDeltaLake:
    """
