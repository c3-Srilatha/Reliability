...
# Python definitions for the C3 type LukeTestConfigureDataConnectorStepAzureBlob


class LukeTestConfigureDataConnectorStepAzureBlob(LukeTestConfigureDataConnectorStepExternalFileConnector):
    """
    The connector type for Azure Blob
    
    @remarks this represents a made instance of LukeTestConfigureDataConnectorStepAzureBlob
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[LukeTestConfigureDataConnectorStepAzureBlob]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[LukeTestConfigureDataConnectorStepAzureBlob]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[LukeTestConfigureDataConnectorStepAzureBlob]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[LukeTestConfigureDataConnectorStepAzureBlob]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> LukeTestConfigureDataConnectorStepAzureBlob:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> LukeTestConfigureDataConnectorStepAzureBlob:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> LukeTestConfigureDataConnectorStepAzureBlob:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[LukeTestConfigureDataConnectorStepAzureBlob]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[LukeTestConfigureDataConnectorStepAzureBlob]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> LukeTestConfigureDataConnectorStepAzureBlob:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> LukeTestConfigureDataConnectorStepAzureBlob:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> LukeTestConfigureDataConnectorStepAzureBlob:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> LukeTestConfigureDataConnectorStepAzureBlob:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> LukeTestConfigureDataConnectorStepAzureBlob:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> LukeTestConfigureDataConnectorStepAzureBlob:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> LukeTestConfigureDataConnectorStepAzureBlob:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> LukeTestConfigureDataConnectorStepAzureBlob:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> LukeTestConfigureDataConnectorStepAzureBlob:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> LukeTestConfigureDataConnectorStepAzureBlob:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> LukeTestConfigureDataConnectorStepAzureBlob:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> LukeTestConfigureDataConnectorStepAzureBlob:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> LukeTestConfigureDataConnectorStepAzureBlob:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> LukeTestConfigureDataConnectorStepAzureBlob:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> LukeTestConfigureDataConnectorStepAzureBlob:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> LukeTestConfigureDataConnectorStepAzureBlob:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> LukeTestConfigureDataConnectorStepAzureBlob:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> LukeTestConfigureDataConnectorStepAzureBlob:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> LukeTestConfigureDataConnectorStepAzureBlob:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> LukeTestConfigureDataConnectorStepAzureBlob:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> LukeTestConfigureDataConnectorStepAzureBlob:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> LukeTestConfigureDataConnectorStepAzureBlob:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> LukeTestConfigureDataConnectorStepAzureBlob:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> LukeTestConfigureDataConnectorStepAzureBlob:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> LukeTestConfigureDataConnectorStepAzureBlob:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> LukeTestConfigureDataConnectorStepAzureBlob:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> LukeTestConfigureDataConnectorStepAzureBlob:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> LukeTestConfigureDataConnectorStepAzureBlob:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[LukeTestConfigureDataConnectorStepAzureBlob]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[LukeTestConfigureDataConnectorStepAzureBlob]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[LukeTestConfigureDataConnectorStepAzureBlob]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[LukeTestConfigureDataConnectorStepAzureBlob]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[LukeTestConfigureDataConnectorStepAzureBlob]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, LukeTestConfigureDataConnectorStepAzureBlob]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, LukeTestConfigureDataConnectorStepAzureBlob]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[LukeTestConfigureDataConnectorStepAzureBlob]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[LukeTestConfigureDataConnectorStepAzureBlob]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> LukeTestConfigureDataConnectorStepAzureBlob:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> LukeTestConfigureDataConnectorStepAzureBlob:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> LukeTestConfigureDataConnectorStepAzureBlob:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> LukeTestConfigureDataConnectorStepAzureBlob:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> LukeTestConfigureDataConnectorStepAzureBlob:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> LukeTestConfigureDataConnectorStepAzureBlob:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> LukeTestConfigureDataConnectorStepAzureBlob:
    """
    ...
    """
        ...
    def afterMake(self) -> LukeTestConfigureDataConnectorStepAzureBlob:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> LukeTestConfigureDataConnectorStepAzureBlob:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[LukeTestConfigureDataConnectorStepAzureBlob]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> LukeTestConfigureDataConnectorStepAzureBlob:
    """
