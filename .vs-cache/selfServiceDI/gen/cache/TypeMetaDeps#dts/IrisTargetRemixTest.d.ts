// TypeScript definitions for the C3 type IrisTargetRemixTest
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of IrisTargetRemixTest
 */
declare interface IIrisTargetRemixTest {
 ...
 */
declare class IrisTargetRemixTest extends Obj {
   ...
   * Sample field added for testing
   */
  readonly newRemixTargetField: string;
  withNewRemixTargetField(newRemixTargetField: string): IrisTargetRemixTest;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): IrisTargetRemixTest | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): IrisTargetRemixTest | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): IrisTargetRemixTest | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): IrisTargetRemixTest | null;
   ...
   */
  replaceType(old: Type, new_: Type): IrisTargetRemixTest;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): IrisTargetRemixTest;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): IrisTargetRemixTest;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<IrisTargetRemixTest | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<IrisTargetRemixTest | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): IrisTargetRemixTest;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): IrisTargetRemixTest;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): IrisTargetRemixTest;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): IrisTargetRemixTest;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): IrisTargetRemixTest;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): IrisTargetRemixTest;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): IrisTargetRemixTest;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): IrisTargetRemixTest;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): IrisTargetRemixTest;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): IrisTargetRemixTest;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): IrisTargetRemixTest;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): IrisTargetRemixTest;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): IrisTargetRemixTest;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): IrisTargetRemixTest;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): IrisTargetRemixTest;
   ...
   * @see #unsetField
   */
  defaultField(field: string): IrisTargetRemixTest;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): IrisTargetRemixTest;
   ...
   * @see #removeField
   */
  unsetField(field: string): IrisTargetRemixTest;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): IrisTargetRemixTest;
   ...
   * @see #unsetField
   */
  removeField(field: string): IrisTargetRemixTest;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): IrisTargetRemixTest;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): IrisTargetRemixTest;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): IrisTargetRemixTest;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): IrisTargetRemixTest;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): IrisTargetRemixTest;

  mergeJson(json: any | null): IrisTargetRemixTest;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): IrisTargetRemixTest;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): IrisTargetRemixTest;
   ...
   */
  singletonArray(): C3.Array<IrisTargetRemixTest | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<IrisTargetRemixTest | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<IrisTargetRemixTest | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<IrisTargetRemixTest | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<IrisTargetRemixTest | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, IrisTargetRemixTest | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, IrisTargetRemixTest | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<IrisTargetRemixTest | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<IrisTargetRemixTest | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): IrisTargetRemixTest;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): IrisTargetRemixTest;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): IrisTargetRemixTest;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): IrisTargetRemixTest;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): IrisTargetRemixTest;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): IrisTargetRemixTest;
   ...
   * @see #fromString
   */
  static make(s: string | null): IrisTargetRemixTest | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): IrisTargetRemixTest;
   ...
   */
  static cachedEmptyInst(): IrisTargetRemixTest;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<IrisTargetRemixTest>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): IrisTargetRemixTest;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<IrisTargetRemixTest | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<IrisTargetRemixTest | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<IrisTargetRemixTest | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<IrisTargetRemixTest | null> | null>;
   ...
   */
  get(include?: string | null): IrisTargetRemixTest | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): IrisTargetRemixTest | null;
   ...
   */
  getMissing(spec: GetMissingSpec): IrisTargetRemixTest;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): IrisTargetRemixTest | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): IrisTargetRemixTest;
   ...
   * @see #toString
   */
  static fromString(s: string | null): IrisTargetRemixTest | null;
   ...
   */
  create(spec?: UpsertSpec | null): IrisTargetRemixTest | null;
   ...
   */
  static createBatch(objs: C3.Array<IrisTargetRemixTest | null> | null, spec?: UpsertSpec | null): ObjList<IrisTargetRemixTest | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<IrisTargetRemixTest | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<IrisTargetRemixTest | null> | null;
   ...
   */
  update(srcObj?: IrisTargetRemixTest | null, spec?: UpsertSpec | null): IrisTargetRemixTest | null;
   ...
   */
  upsert(srcObj?: IrisTargetRemixTest | null, spec?: UpsertSpec | null): IrisTargetRemixTest | null;
   ...
   */
  merge(spec?: MergeSpec | null): IrisTargetRemixTest | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): IrisTargetRemixTest | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): IrisTargetRemixTest | null;
   ...
   */
  static updateBatch(objs: C3.Array<IrisTargetRemixTest | null> | null, srcObjs?: C3.Array<IrisTargetRemixTest | null>, spec?: UpsertSpec | null): ObjList<IrisTargetRemixTest | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<IrisTargetRemixTest | null>>, spec?: UpsertSpec | null): ObjList<IrisTargetRemixTest | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<IrisTargetRemixTest | null> | null, srcObjs?: C3.Array<IrisTargetRemixTest | null>, spec?: UpsertSpec | null): ObjList<IrisTargetRemixTest | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<IrisTargetRemixTest | null>>, spec?: UpsertSpec | null): ObjList<IrisTargetRemixTest | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<IrisTargetRemixTest | null> | null, spec?: TouchSpec | null): ObjList<IrisTargetRemixTest | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<IrisTargetRemixTest | null> | null, spec?: MergeSpec | null): ObjList<IrisTargetRemixTest | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<IrisTargetRemixTest | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<IrisTargetRemixTest | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<IrisTargetRemixTest | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<IrisTargetRemixTest | null> | null;
   ...
   */
  static mergeAll(mergeObj: IrisTargetRemixTest | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: IrisTargetRemixTest | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<IrisTargetRemixTest | null> | null, spec?: UpsertSpec | null): ObjList<IrisTargetRemixTest | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<IrisTargetRemixTest | null> | null, spec?: UpsertSpec | null): ObjList<IrisTargetRemixTest | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): IrisTargetRemixTest | null;
   ...
   */
  static beforeCreate(objs: C3.Array<IrisTargetRemixTest | null> | null): ObjList<IrisTargetRemixTest | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<IrisTargetRemixTest | null> | null): ObjList<IrisTargetRemixTest | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<IrisTargetRemixTest | null> | null): ObjList<IrisTargetRemixTest | null>;
   ...
   */
  static afterCreate(objs: C3.Array<IrisTargetRemixTest | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<IrisTargetRemixTest | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<IrisTargetRemixTest | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<IrisTargetRemixTest | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<IrisTargetRemixTest | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): IrisTargetRemixTest | null;
   ...
   */
  withoutIdentity(): IrisTargetRemixTest | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<IrisTargetRemixTest | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: IrisTargetRemixTest | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<IrisTargetRemixTest | null> | null, callback?: λFunction<IrisTargetRemixTest | null, IrisTargetRemixTest | null> | null): ObjList<IrisTargetRemixTest | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<IrisTargetRemixTest | null> | null, callback?: λFunction<IrisTargetRemixTest | null, IrisTargetRemixTest | null> | null): C3.Array<ObjError | null>;
