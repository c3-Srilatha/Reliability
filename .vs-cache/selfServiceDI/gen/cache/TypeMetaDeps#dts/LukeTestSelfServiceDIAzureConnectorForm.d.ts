// TypeScript definitions for the C3 type LukeTestSelfServiceDIAzureConnectorForm

/**
 * A test component for the Azure Connector Form
 *
 * @remarks this represents a value passed to a method that expects an instance of LukeTestSelfServiceDIAzureConnectorForm
 */
declare interface ILukeTestSelfServiceDIAzureConnectorForm {
 ...
 */
declare class LukeTestSelfServiceDIAzureConnectorForm extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): LukeTestSelfServiceDIAzureConnectorForm | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): LukeTestSelfServiceDIAzureConnectorForm | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): LukeTestSelfServiceDIAzureConnectorForm | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): LukeTestSelfServiceDIAzureConnectorForm | null;
   ...
   */
  replaceType(old: Type, new_: Type): LukeTestSelfServiceDIAzureConnectorForm;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): LukeTestSelfServiceDIAzureConnectorForm;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): LukeTestSelfServiceDIAzureConnectorForm;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<LukeTestSelfServiceDIAzureConnectorForm | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<LukeTestSelfServiceDIAzureConnectorForm | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): LukeTestSelfServiceDIAzureConnectorForm;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): LukeTestSelfServiceDIAzureConnectorForm;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): LukeTestSelfServiceDIAzureConnectorForm;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): LukeTestSelfServiceDIAzureConnectorForm;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): LukeTestSelfServiceDIAzureConnectorForm;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): LukeTestSelfServiceDIAzureConnectorForm;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): LukeTestSelfServiceDIAzureConnectorForm;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): LukeTestSelfServiceDIAzureConnectorForm;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): LukeTestSelfServiceDIAzureConnectorForm;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): LukeTestSelfServiceDIAzureConnectorForm;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): LukeTestSelfServiceDIAzureConnectorForm;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): LukeTestSelfServiceDIAzureConnectorForm;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): LukeTestSelfServiceDIAzureConnectorForm;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): LukeTestSelfServiceDIAzureConnectorForm;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): LukeTestSelfServiceDIAzureConnectorForm;
   ...
   * @see #unsetField
   */
  defaultField(field: string): LukeTestSelfServiceDIAzureConnectorForm;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): LukeTestSelfServiceDIAzureConnectorForm;
   ...
   * @see #removeField
   */
  unsetField(field: string): LukeTestSelfServiceDIAzureConnectorForm;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): LukeTestSelfServiceDIAzureConnectorForm;
   ...
   * @see #unsetField
   */
  removeField(field: string): LukeTestSelfServiceDIAzureConnectorForm;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): LukeTestSelfServiceDIAzureConnectorForm;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): LukeTestSelfServiceDIAzureConnectorForm;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): LukeTestSelfServiceDIAzureConnectorForm;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): LukeTestSelfServiceDIAzureConnectorForm;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): LukeTestSelfServiceDIAzureConnectorForm;

  mergeJson(json: any | null): LukeTestSelfServiceDIAzureConnectorForm;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): LukeTestSelfServiceDIAzureConnectorForm;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): LukeTestSelfServiceDIAzureConnectorForm;
   ...
   */
  singletonArray(): C3.Array<LukeTestSelfServiceDIAzureConnectorForm | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<LukeTestSelfServiceDIAzureConnectorForm | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<LukeTestSelfServiceDIAzureConnectorForm | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<LukeTestSelfServiceDIAzureConnectorForm | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<LukeTestSelfServiceDIAzureConnectorForm | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, LukeTestSelfServiceDIAzureConnectorForm | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, LukeTestSelfServiceDIAzureConnectorForm | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<LukeTestSelfServiceDIAzureConnectorForm | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<LukeTestSelfServiceDIAzureConnectorForm | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): LukeTestSelfServiceDIAzureConnectorForm;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): LukeTestSelfServiceDIAzureConnectorForm;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): LukeTestSelfServiceDIAzureConnectorForm;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): LukeTestSelfServiceDIAzureConnectorForm;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): LukeTestSelfServiceDIAzureConnectorForm;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): LukeTestSelfServiceDIAzureConnectorForm;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): LukeTestSelfServiceDIAzureConnectorForm;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): LukeTestSelfServiceDIAzureConnectorForm;
   ...
   */
  static cachedEmptyInst(): LukeTestSelfServiceDIAzureConnectorForm;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<LukeTestSelfServiceDIAzureConnectorForm>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): LukeTestSelfServiceDIAzureConnectorForm;
   ...
   * @return a {@link LukeAsyncQueueNode}.
   */
  setRegion(value?: string | null, timeout?: number | null): LukeAsyncQueueNode | null;
   ...
   * @return a {@link LukeAsyncQueueNode}.
   */
  getRegion(timeout?: number | null): LukeAsyncQueueNode | null;
   ...
   * @return a {@link LukeAsyncQueueNode}.
   */
  hasRegionError(timeout?: number | null): LukeAsyncQueueNode | null;
   ...
   * @return a {@link LukeAsyncQueueNode}.
   */
  setAccountId(value?: string | null, timeout?: number | null): LukeAsyncQueueNode | null;
   ...
   * @return a {@link LukeAsyncQueueNode}.
   */
  getAccountId(timeout?: number | null): LukeAsyncQueueNode | null;
   ...
   * @return a {@link LukeAsyncQueueNode}.
   */
  hasAccountIdError(timeout?: number | null): LukeAsyncQueueNode | null;
   ...
   * @return a {@link LukeAsyncQueueNode}.
   */
  setAccountName(value?: string | null, timeout?: number | null): LukeAsyncQueueNode | null;
   ...
   * @return a {@link LukeAsyncQueueNode}.
   */
  getAccountName(timeout?: number | null): LukeAsyncQueueNode | null;
   ...
   * @return a {@link LukeAsyncQueueNode}.
   */
  hasAccountNameError(timeout?: number | null): LukeAsyncQueueNode | null;
}
