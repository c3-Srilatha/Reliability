// TypeScript definitions for the C3 type LukeTestSelfServiceDIConnectorForm

/**
 * A test component for the main page on SelfServiceDI
 *
 * @remarks this represents a value passed to a method that expects an instance of LukeTestSelfServiceDIConnectorForm
 */
declare interface ILukeTestSelfServiceDIConnectorForm {
 ...
 */
declare class LukeTestSelfServiceDIConnectorForm extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): LukeTestSelfServiceDIConnectorForm | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): LukeTestSelfServiceDIConnectorForm | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): LukeTestSelfServiceDIConnectorForm | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): LukeTestSelfServiceDIConnectorForm | null;
   ...
   */
  replaceType(old: Type, new_: Type): LukeTestSelfServiceDIConnectorForm;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): LukeTestSelfServiceDIConnectorForm;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): LukeTestSelfServiceDIConnectorForm;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<LukeTestSelfServiceDIConnectorForm | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<LukeTestSelfServiceDIConnectorForm | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): LukeTestSelfServiceDIConnectorForm;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): LukeTestSelfServiceDIConnectorForm;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): LukeTestSelfServiceDIConnectorForm;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): LukeTestSelfServiceDIConnectorForm;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): LukeTestSelfServiceDIConnectorForm;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): LukeTestSelfServiceDIConnectorForm;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): LukeTestSelfServiceDIConnectorForm;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): LukeTestSelfServiceDIConnectorForm;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): LukeTestSelfServiceDIConnectorForm;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): LukeTestSelfServiceDIConnectorForm;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): LukeTestSelfServiceDIConnectorForm;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): LukeTestSelfServiceDIConnectorForm;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): LukeTestSelfServiceDIConnectorForm;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): LukeTestSelfServiceDIConnectorForm;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): LukeTestSelfServiceDIConnectorForm;
   ...
   * @see #unsetField
   */
  defaultField(field: string): LukeTestSelfServiceDIConnectorForm;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): LukeTestSelfServiceDIConnectorForm;
   ...
   * @see #removeField
   */
  unsetField(field: string): LukeTestSelfServiceDIConnectorForm;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): LukeTestSelfServiceDIConnectorForm;
   ...
   * @see #unsetField
   */
  removeField(field: string): LukeTestSelfServiceDIConnectorForm;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): LukeTestSelfServiceDIConnectorForm;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): LukeTestSelfServiceDIConnectorForm;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): LukeTestSelfServiceDIConnectorForm;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): LukeTestSelfServiceDIConnectorForm;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): LukeTestSelfServiceDIConnectorForm;

  mergeJson(json: any | null): LukeTestSelfServiceDIConnectorForm;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): LukeTestSelfServiceDIConnectorForm;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): LukeTestSelfServiceDIConnectorForm;
   ...
   */
  singletonArray(): C3.Array<LukeTestSelfServiceDIConnectorForm | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<LukeTestSelfServiceDIConnectorForm | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<LukeTestSelfServiceDIConnectorForm | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<LukeTestSelfServiceDIConnectorForm | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<LukeTestSelfServiceDIConnectorForm | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, LukeTestSelfServiceDIConnectorForm | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, LukeTestSelfServiceDIConnectorForm | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<LukeTestSelfServiceDIConnectorForm | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<LukeTestSelfServiceDIConnectorForm | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): LukeTestSelfServiceDIConnectorForm;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): LukeTestSelfServiceDIConnectorForm;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): LukeTestSelfServiceDIConnectorForm;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): LukeTestSelfServiceDIConnectorForm;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): LukeTestSelfServiceDIConnectorForm;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): LukeTestSelfServiceDIConnectorForm;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): LukeTestSelfServiceDIConnectorForm;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): LukeTestSelfServiceDIConnectorForm;
   ...
   */
  static cachedEmptyInst(): LukeTestSelfServiceDIConnectorForm;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<LukeTestSelfServiceDIConnectorForm>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): LukeTestSelfServiceDIConnectorForm;
