// TypeScript definitions for the C3 type SelfServiceDIJdbcStoreConfig
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of SelfServiceDIJdbcStoreConfig
 */
declare interface ISelfServiceDIJdbcStoreConfig {
 ...
 */
declare class SelfServiceDIJdbcStoreConfig extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): SelfServiceDIJdbcStoreConfig | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): SelfServiceDIJdbcStoreConfig | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): SelfServiceDIJdbcStoreConfig | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): SelfServiceDIJdbcStoreConfig | null;
   ...
   */
  replaceType(old: Type, new_: Type): SelfServiceDIJdbcStoreConfig;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): SelfServiceDIJdbcStoreConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): SelfServiceDIJdbcStoreConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<SelfServiceDIJdbcStoreConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<SelfServiceDIJdbcStoreConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): SelfServiceDIJdbcStoreConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SelfServiceDIJdbcStoreConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SelfServiceDIJdbcStoreConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): SelfServiceDIJdbcStoreConfig;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): SelfServiceDIJdbcStoreConfig;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): SelfServiceDIJdbcStoreConfig;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): SelfServiceDIJdbcStoreConfig;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): SelfServiceDIJdbcStoreConfig;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): SelfServiceDIJdbcStoreConfig;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): SelfServiceDIJdbcStoreConfig;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): SelfServiceDIJdbcStoreConfig;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): SelfServiceDIJdbcStoreConfig;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): SelfServiceDIJdbcStoreConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): SelfServiceDIJdbcStoreConfig;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): SelfServiceDIJdbcStoreConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: string): SelfServiceDIJdbcStoreConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): SelfServiceDIJdbcStoreConfig;
   ...
   * @see #removeField
   */
  unsetField(field: string): SelfServiceDIJdbcStoreConfig;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): SelfServiceDIJdbcStoreConfig;
   ...
   * @see #unsetField
   */
  removeField(field: string): SelfServiceDIJdbcStoreConfig;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): SelfServiceDIJdbcStoreConfig;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): SelfServiceDIJdbcStoreConfig;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): SelfServiceDIJdbcStoreConfig;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): SelfServiceDIJdbcStoreConfig;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): SelfServiceDIJdbcStoreConfig;

  mergeJson(json: any | null): SelfServiceDIJdbcStoreConfig;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): SelfServiceDIJdbcStoreConfig;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): SelfServiceDIJdbcStoreConfig;
   ...
   */
  singletonArray(): C3.Array<SelfServiceDIJdbcStoreConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<SelfServiceDIJdbcStoreConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<SelfServiceDIJdbcStoreConfig | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<SelfServiceDIJdbcStoreConfig | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<SelfServiceDIJdbcStoreConfig | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, SelfServiceDIJdbcStoreConfig | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, SelfServiceDIJdbcStoreConfig | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<SelfServiceDIJdbcStoreConfig | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<SelfServiceDIJdbcStoreConfig | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): SelfServiceDIJdbcStoreConfig;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): SelfServiceDIJdbcStoreConfig;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): SelfServiceDIJdbcStoreConfig;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): SelfServiceDIJdbcStoreConfig;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): SelfServiceDIJdbcStoreConfig;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): SelfServiceDIJdbcStoreConfig;
   ...
   * @see #fromString
   */
  static make(s: string | null): SelfServiceDIJdbcStoreConfig | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): SelfServiceDIJdbcStoreConfig;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): SelfServiceDIJdbcStoreConfig;
   ...
   */
  static cachedEmptyInst(): SelfServiceDIJdbcStoreConfig;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<SelfServiceDIJdbcStoreConfig>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): SelfServiceDIJdbcStoreConfig;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<SelfServiceDIJdbcStoreConfig | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<SelfServiceDIJdbcStoreConfig | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<SelfServiceDIJdbcStoreConfig | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): SelfServiceDIJdbcStoreConfig | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string | null): SelfServiceDIJdbcStoreConfig | null;
   ...
   * @see findByCacheKey
   */
  getCached(): SelfServiceDIJdbcStoreConfig | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): SelfServiceDIJdbcStoreConfig | null;
   ...
   */
  static produce(key: string): SelfServiceDIJdbcStoreConfig | null;
   ...
   */
  static produceAll(): C3.Map<string | null, SelfServiceDIJdbcStoreConfig | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, SelfServiceDIJdbcStoreConfig | null>;
   ...
   */
  getConfig(): SelfServiceDIJdbcStoreConfig;
   ...
   */
  getSecret(): SelfServiceDIJdbcStoreConfig;
   ...
   */
  static forConfigKey(configKey: string | null): SelfServiceDIJdbcStoreConfig | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<SelfServiceDIJdbcStoreConfig | null>;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: SelfServiceDIJdbcStoreConfig, override?: string | null): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: SelfServiceDIJdbcStoreConfig, override?: string | null): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): SelfServiceDIJdbcStoreConfig | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): SelfServiceDIJdbcStoreConfig | null;

  /**
   * the function that can get the SelfServiceDIJdbcStoreConfig
   */
  static forName(name: string | null, failIfMissing?: boolean): SelfServiceDIJdbcStoreConfig | null;
}
