// TypeScript definitions for the C3 type LukeTestPostConfigurationLandingPage

/**
 * @remarks this represents a value passed to a method that expects an instance of LukeTestPostConfigurationLandingPage
 */
declare interface ILukeTestPostConfigurationLandingPage {
 ...
 */
declare class LukeTestPostConfigurationLandingPage extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): LukeTestPostConfigurationLandingPage | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): LukeTestPostConfigurationLandingPage | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): LukeTestPostConfigurationLandingPage | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): LukeTestPostConfigurationLandingPage | null;
   ...
   */
  replaceType(old: Type, new_: Type): LukeTestPostConfigurationLandingPage;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): LukeTestPostConfigurationLandingPage;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): LukeTestPostConfigurationLandingPage;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<LukeTestPostConfigurationLandingPage | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<LukeTestPostConfigurationLandingPage | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): LukeTestPostConfigurationLandingPage;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): LukeTestPostConfigurationLandingPage;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): LukeTestPostConfigurationLandingPage;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): LukeTestPostConfigurationLandingPage;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): LukeTestPostConfigurationLandingPage;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): LukeTestPostConfigurationLandingPage;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): LukeTestPostConfigurationLandingPage;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): LukeTestPostConfigurationLandingPage;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): LukeTestPostConfigurationLandingPage;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): LukeTestPostConfigurationLandingPage;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): LukeTestPostConfigurationLandingPage;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): LukeTestPostConfigurationLandingPage;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): LukeTestPostConfigurationLandingPage;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): LukeTestPostConfigurationLandingPage;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): LukeTestPostConfigurationLandingPage;
   ...
   * @see #unsetField
   */
  defaultField(field: string): LukeTestPostConfigurationLandingPage;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): LukeTestPostConfigurationLandingPage;
   ...
   * @see #removeField
   */
  unsetField(field: string): LukeTestPostConfigurationLandingPage;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): LukeTestPostConfigurationLandingPage;
   ...
   * @see #unsetField
   */
  removeField(field: string): LukeTestPostConfigurationLandingPage;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): LukeTestPostConfigurationLandingPage;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): LukeTestPostConfigurationLandingPage;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): LukeTestPostConfigurationLandingPage;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): LukeTestPostConfigurationLandingPage;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): LukeTestPostConfigurationLandingPage;

  mergeJson(json: any | null): LukeTestPostConfigurationLandingPage;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): LukeTestPostConfigurationLandingPage;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): LukeTestPostConfigurationLandingPage;
   ...
   */
  singletonArray(): C3.Array<LukeTestPostConfigurationLandingPage | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<LukeTestPostConfigurationLandingPage | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<LukeTestPostConfigurationLandingPage | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<LukeTestPostConfigurationLandingPage | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<LukeTestPostConfigurationLandingPage | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, LukeTestPostConfigurationLandingPage | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, LukeTestPostConfigurationLandingPage | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<LukeTestPostConfigurationLandingPage | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<LukeTestPostConfigurationLandingPage | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): LukeTestPostConfigurationLandingPage;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): LukeTestPostConfigurationLandingPage;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): LukeTestPostConfigurationLandingPage;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): LukeTestPostConfigurationLandingPage;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): LukeTestPostConfigurationLandingPage;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): LukeTestPostConfigurationLandingPage;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): LukeTestPostConfigurationLandingPage;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): LukeTestPostConfigurationLandingPage;
   ...
   */
  static cachedEmptyInst(): LukeTestPostConfigurationLandingPage;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<LukeTestPostConfigurationLandingPage>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): LukeTestPostConfigurationLandingPage;
