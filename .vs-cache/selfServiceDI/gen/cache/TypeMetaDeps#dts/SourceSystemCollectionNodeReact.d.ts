// TypeScript definitions for the C3 type SourceSystemCollectionNodeReact

/**
 * The react component of type {@link SourceSystemCollectionNode}
 *
 * @remarks this represents a value passed to a method that expects an instance of SourceSystemCollectionNodeReact
 */
declare interface ISourceSystemCollectionNodeReact {
   ...
   */
  data?: ISourceSystemCollectionNode | null;
}
 ...
 */
declare class SourceSystemCollectionNodeReact extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): SourceSystemCollectionNodeReact | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): SourceSystemCollectionNodeReact | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): SourceSystemCollectionNodeReact | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): SourceSystemCollectionNodeReact | null;
   ...
   */
  replaceType(old: Type, new_: Type): SourceSystemCollectionNodeReact;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): SourceSystemCollectionNodeReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): SourceSystemCollectionNodeReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<SourceSystemCollectionNodeReact | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<SourceSystemCollectionNodeReact | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): SourceSystemCollectionNodeReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SourceSystemCollectionNodeReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SourceSystemCollectionNodeReact;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): SourceSystemCollectionNodeReact;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): SourceSystemCollectionNodeReact;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): SourceSystemCollectionNodeReact;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): SourceSystemCollectionNodeReact;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): SourceSystemCollectionNodeReact;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): SourceSystemCollectionNodeReact;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): SourceSystemCollectionNodeReact;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): SourceSystemCollectionNodeReact;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): SourceSystemCollectionNodeReact;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): SourceSystemCollectionNodeReact;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): SourceSystemCollectionNodeReact;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): SourceSystemCollectionNodeReact;
   ...
   * @see #unsetField
   */
  defaultField(field: string): SourceSystemCollectionNodeReact;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): SourceSystemCollectionNodeReact;
   ...
   * @see #removeField
   */
  unsetField(field: string): SourceSystemCollectionNodeReact;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): SourceSystemCollectionNodeReact;
   ...
   * @see #unsetField
   */
  removeField(field: string): SourceSystemCollectionNodeReact;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): SourceSystemCollectionNodeReact;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): SourceSystemCollectionNodeReact;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): SourceSystemCollectionNodeReact;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): SourceSystemCollectionNodeReact;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): SourceSystemCollectionNodeReact;

  mergeJson(json: any | null): SourceSystemCollectionNodeReact;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): SourceSystemCollectionNodeReact;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): SourceSystemCollectionNodeReact;
   ...
   */
  singletonArray(): C3.Array<SourceSystemCollectionNodeReact | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<SourceSystemCollectionNodeReact | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<SourceSystemCollectionNodeReact | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<SourceSystemCollectionNodeReact | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<SourceSystemCollectionNodeReact | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, SourceSystemCollectionNodeReact | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, SourceSystemCollectionNodeReact | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<SourceSystemCollectionNodeReact | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<SourceSystemCollectionNodeReact | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): SourceSystemCollectionNodeReact;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): SourceSystemCollectionNodeReact;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): SourceSystemCollectionNodeReact;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): SourceSystemCollectionNodeReact;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): SourceSystemCollectionNodeReact;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): SourceSystemCollectionNodeReact;
   ...
   * @see #fromString
   */
  static make(s: string | null): SourceSystemCollectionNodeReact | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): SourceSystemCollectionNodeReact;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): SourceSystemCollectionNodeReact;
   ...
   */
  static cachedEmptyInst(): SourceSystemCollectionNodeReact;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<SourceSystemCollectionNodeReact>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): SourceSystemCollectionNodeReact;
   ...
   */
  static render(props?: SourceSystemCollectionNodeReact | null): void;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<SourceSystemCollectionNodeReact | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<SourceSystemCollectionNodeReact | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<SourceSystemCollectionNodeReact | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<SourceSystemCollectionNodeReact | null> | null>;
   ...
   */
  dependencies(): MetadataDeps<SourceSystemCollectionNodeReact | null>;

  save(subPath?: string | null, contentType?: string | null): SourceSystemCollectionNodeReact;
  ...
  update(srcObj?: SourceSystemCollectionNodeReact | null, spec?: UpsertSpec | null): SourceSystemCollectionNodeReact | null;

  upsert(srcObj?: SourceSystemCollectionNodeReact | null, spec?: UpsertSpec | null): SourceSystemCollectionNodeReact | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): SourceSystemCollectionNodeReact | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string | null, failIfMissing?: boolean): SourceSystemCollectionNodeReact | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: SourceSystemCollectionNodeReact, state: UiSdlReduxState): SourceSystemCollectionNodeReact | null;
