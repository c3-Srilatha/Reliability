// TypeScript definitions for the C3 type TestTarget
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of TestTarget
 */
declare interface ITestTarget {
 ...
 */
declare class TestTarget extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): TestTarget | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): TestTarget | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): TestTarget | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): TestTarget | null;
   ...
   */
  replaceType(old: Type, new_: Type): TestTarget;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TestTarget;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TestTarget;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TestTarget | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TestTarget | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): TestTarget;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TestTarget;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TestTarget;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): TestTarget;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): TestTarget;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): TestTarget;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): TestTarget;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): TestTarget;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): TestTarget;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): TestTarget;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): TestTarget;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): TestTarget;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): TestTarget;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): TestTarget;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): TestTarget;
   ...
   * @see #unsetField
   */
  defaultField(field: string): TestTarget;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): TestTarget;
   ...
   * @see #removeField
   */
  unsetField(field: string): TestTarget;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): TestTarget;
   ...
   * @see #unsetField
   */
  removeField(field: string): TestTarget;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): TestTarget;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): TestTarget;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): TestTarget;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): TestTarget;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): TestTarget;

  mergeJson(json: any | null): TestTarget;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): TestTarget;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): TestTarget;
   ...
   */
  singletonArray(): C3.Array<TestTarget | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<TestTarget | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<TestTarget | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<TestTarget | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<TestTarget | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, TestTarget | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, TestTarget | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<TestTarget | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<TestTarget | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): TestTarget;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): TestTarget;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): TestTarget;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): TestTarget;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): TestTarget;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): TestTarget;
   ...
   * @see #fromString
   */
  static make(s: string | null): TestTarget | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): TestTarget;
   ...
   */
  static cachedEmptyInst(): TestTarget;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<TestTarget>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): TestTarget;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<TestTarget | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<TestTarget | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<TestTarget | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<TestTarget | null> | null>;
   ...
   */
  get(include?: string | null): TestTarget | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): TestTarget | null;
   ...
   */
  getMissing(spec: GetMissingSpec): TestTarget;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): TestTarget | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): TestTarget;
   ...
   * @see #toString
   */
  static fromString(s: string | null): TestTarget | null;
   ...
   */
  create(spec?: UpsertSpec | null): TestTarget | null;
   ...
   */
  static createBatch(objs: C3.Array<TestTarget | null> | null, spec?: UpsertSpec | null): ObjList<TestTarget | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<TestTarget | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<TestTarget | null> | null;
   ...
   */
  update(srcObj?: TestTarget | null, spec?: UpsertSpec | null): TestTarget | null;
   ...
   */
  upsert(srcObj?: TestTarget | null, spec?: UpsertSpec | null): TestTarget | null;
   ...
   */
  merge(spec?: MergeSpec | null): TestTarget | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): TestTarget | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): TestTarget | null;
   ...
   */
  static updateBatch(objs: C3.Array<TestTarget | null> | null, srcObjs?: C3.Array<TestTarget | null>, spec?: UpsertSpec | null): ObjList<TestTarget | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<TestTarget | null>>, spec?: UpsertSpec | null): ObjList<TestTarget | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<TestTarget | null> | null, srcObjs?: C3.Array<TestTarget | null>, spec?: UpsertSpec | null): ObjList<TestTarget | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<TestTarget | null>>, spec?: UpsertSpec | null): ObjList<TestTarget | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<TestTarget | null> | null, spec?: TouchSpec | null): ObjList<TestTarget | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<TestTarget | null> | null, spec?: MergeSpec | null): ObjList<TestTarget | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<TestTarget | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<TestTarget | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<TestTarget | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<TestTarget | null> | null;
   ...
   */
  static mergeAll(mergeObj: TestTarget | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: TestTarget | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<TestTarget | null> | null, spec?: UpsertSpec | null): ObjList<TestTarget | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<TestTarget | null> | null, spec?: UpsertSpec | null): ObjList<TestTarget | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<TestTarget | null> | null): ObjList<TestTarget | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<TestTarget | null> | null): ObjList<TestTarget | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<TestTarget | null> | null): ObjList<TestTarget | null>;
   ...
   */
  static afterCreate(objs: C3.Array<TestTarget | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<TestTarget | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<TestTarget | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<TestTarget | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<TestTarget | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): TestTarget | null;
   ...
   */
  withoutIdentity(): TestTarget | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<TestTarget | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: TestTarget | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<TestTarget | null> | null, callback?: λFunction<TestTarget | null, TestTarget | null> | null): ObjList<TestTarget | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<TestTarget | null> | null, callback?: λFunction<TestTarget | null, TestTarget | null> | null): C3.Array<ObjError | null>;
