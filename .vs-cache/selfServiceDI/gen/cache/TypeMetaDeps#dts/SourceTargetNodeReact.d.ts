// TypeScript definitions for the C3 type SourceTargetNodeReact

/**
 * @remarks this represents a value passed to a method that expects an instance of SourceTargetNodeReact
 */
declare interface ISourceTargetNodeReact {
   ...
   */
  data?: ISourceTargetNode | null;
}

/**
 * @remarks this represents a made instance of SourceTargetNodeReact
 */
declare class SourceTargetNodeReact extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): SourceTargetNodeReact | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): SourceTargetNodeReact | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): SourceTargetNodeReact | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): SourceTargetNodeReact | null;
   ...
   */
  replaceType(old: Type, new_: Type): SourceTargetNodeReact;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): SourceTargetNodeReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): SourceTargetNodeReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<SourceTargetNodeReact | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<SourceTargetNodeReact | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): SourceTargetNodeReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SourceTargetNodeReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SourceTargetNodeReact;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): SourceTargetNodeReact;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): SourceTargetNodeReact;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): SourceTargetNodeReact;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): SourceTargetNodeReact;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): SourceTargetNodeReact;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): SourceTargetNodeReact;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): SourceTargetNodeReact;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): SourceTargetNodeReact;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): SourceTargetNodeReact;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): SourceTargetNodeReact;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): SourceTargetNodeReact;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): SourceTargetNodeReact;
   ...
   * @see #unsetField
   */
  defaultField(field: string): SourceTargetNodeReact;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): SourceTargetNodeReact;
   ...
   * @see #removeField
   */
  unsetField(field: string): SourceTargetNodeReact;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): SourceTargetNodeReact;
   ...
   * @see #unsetField
   */
  removeField(field: string): SourceTargetNodeReact;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): SourceTargetNodeReact;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): SourceTargetNodeReact;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): SourceTargetNodeReact;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): SourceTargetNodeReact;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): SourceTargetNodeReact;

  mergeJson(json: any | null): SourceTargetNodeReact;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): SourceTargetNodeReact;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): SourceTargetNodeReact;
   ...
   */
  singletonArray(): C3.Array<SourceTargetNodeReact | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<SourceTargetNodeReact | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<SourceTargetNodeReact | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<SourceTargetNodeReact | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<SourceTargetNodeReact | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, SourceTargetNodeReact | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, SourceTargetNodeReact | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<SourceTargetNodeReact | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<SourceTargetNodeReact | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): SourceTargetNodeReact;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): SourceTargetNodeReact;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): SourceTargetNodeReact;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): SourceTargetNodeReact;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): SourceTargetNodeReact;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): SourceTargetNodeReact;
   ...
   * @see #fromString
   */
  static make(s: string | null): SourceTargetNodeReact | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): SourceTargetNodeReact;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): SourceTargetNodeReact;
   ...
   */
  static cachedEmptyInst(): SourceTargetNodeReact;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<SourceTargetNodeReact>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): SourceTargetNodeReact;
   ...
   */
  static render(props?: SourceTargetNodeReact | null): void;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<SourceTargetNodeReact | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<SourceTargetNodeReact | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<SourceTargetNodeReact | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<SourceTargetNodeReact | null> | null>;
   ...
   */
  dependencies(): MetadataDeps<SourceTargetNodeReact | null>;

  save(subPath?: string | null, contentType?: string | null): SourceTargetNodeReact;
  ...
  update(srcObj?: SourceTargetNodeReact | null, spec?: UpsertSpec | null): SourceTargetNodeReact | null;

  upsert(srcObj?: SourceTargetNodeReact | null, spec?: UpsertSpec | null): SourceTargetNodeReact | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): SourceTargetNodeReact | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string | null, failIfMissing?: boolean): SourceTargetNodeReact | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: SourceTargetNodeReact, state: UiSdlReduxState): SourceTargetNodeReact | null;
