// TypeScript definitions for the C3 type LukeTestSelfServiceDIConfigureDataConnectorStep

/**
 * A base test component for a connector
 *
 * @remarks this represents a value passed to a method that expects an instance of LukeTestSelfServiceDIConfigureDataConnectorStep
 */
declare interface ILukeTestSelfServiceDIConfigureDataConnectorStep {
 ...
 * A base test component for a connector
 *
 * @remarks this represents a made instance of LukeTestSelfServiceDIConfigureDataConnectorStep
 */
declare class LukeTestSelfServiceDIConfigureDataConnectorStep extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): LukeTestSelfServiceDIConfigureDataConnectorStep | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): LukeTestSelfServiceDIConfigureDataConnectorStep | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): LukeTestSelfServiceDIConfigureDataConnectorStep | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): LukeTestSelfServiceDIConfigureDataConnectorStep | null;
   ...
   */
  replaceType(old: Type, new_: Type): LukeTestSelfServiceDIConfigureDataConnectorStep;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): LukeTestSelfServiceDIConfigureDataConnectorStep;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): LukeTestSelfServiceDIConfigureDataConnectorStep;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<LukeTestSelfServiceDIConfigureDataConnectorStep | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<LukeTestSelfServiceDIConfigureDataConnectorStep | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): LukeTestSelfServiceDIConfigureDataConnectorStep;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): LukeTestSelfServiceDIConfigureDataConnectorStep;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): LukeTestSelfServiceDIConfigureDataConnectorStep;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): LukeTestSelfServiceDIConfigureDataConnectorStep;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): LukeTestSelfServiceDIConfigureDataConnectorStep;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): LukeTestSelfServiceDIConfigureDataConnectorStep;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): LukeTestSelfServiceDIConfigureDataConnectorStep;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): LukeTestSelfServiceDIConfigureDataConnectorStep;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): LukeTestSelfServiceDIConfigureDataConnectorStep;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): LukeTestSelfServiceDIConfigureDataConnectorStep;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): LukeTestSelfServiceDIConfigureDataConnectorStep;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): LukeTestSelfServiceDIConfigureDataConnectorStep;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): LukeTestSelfServiceDIConfigureDataConnectorStep;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): LukeTestSelfServiceDIConfigureDataConnectorStep;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): LukeTestSelfServiceDIConfigureDataConnectorStep;
   ...
   * @see #unsetField
   */
  defaultField(field: string): LukeTestSelfServiceDIConfigureDataConnectorStep;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): LukeTestSelfServiceDIConfigureDataConnectorStep;
   ...
   * @see #removeField
   */
  unsetField(field: string): LukeTestSelfServiceDIConfigureDataConnectorStep;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): LukeTestSelfServiceDIConfigureDataConnectorStep;
   ...
   * @see #unsetField
   */
  removeField(field: string): LukeTestSelfServiceDIConfigureDataConnectorStep;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): LukeTestSelfServiceDIConfigureDataConnectorStep;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): LukeTestSelfServiceDIConfigureDataConnectorStep;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): LukeTestSelfServiceDIConfigureDataConnectorStep;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): LukeTestSelfServiceDIConfigureDataConnectorStep;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): LukeTestSelfServiceDIConfigureDataConnectorStep;

  mergeJson(json: any | null): LukeTestSelfServiceDIConfigureDataConnectorStep;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): LukeTestSelfServiceDIConfigureDataConnectorStep;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): LukeTestSelfServiceDIConfigureDataConnectorStep;
   ...
   */
  singletonArray(): C3.Array<LukeTestSelfServiceDIConfigureDataConnectorStep | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<LukeTestSelfServiceDIConfigureDataConnectorStep | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<LukeTestSelfServiceDIConfigureDataConnectorStep | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<LukeTestSelfServiceDIConfigureDataConnectorStep | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<LukeTestSelfServiceDIConfigureDataConnectorStep | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, LukeTestSelfServiceDIConfigureDataConnectorStep | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, LukeTestSelfServiceDIConfigureDataConnectorStep | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<LukeTestSelfServiceDIConfigureDataConnectorStep | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<LukeTestSelfServiceDIConfigureDataConnectorStep | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): LukeTestSelfServiceDIConfigureDataConnectorStep;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): LukeTestSelfServiceDIConfigureDataConnectorStep;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): LukeTestSelfServiceDIConfigureDataConnectorStep;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): LukeTestSelfServiceDIConfigureDataConnectorStep;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): LukeTestSelfServiceDIConfigureDataConnectorStep;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): LukeTestSelfServiceDIConfigureDataConnectorStep;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): LukeTestSelfServiceDIConfigureDataConnectorStep;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): LukeTestSelfServiceDIConfigureDataConnectorStep;
   ...
   */
  static cachedEmptyInst(): LukeTestSelfServiceDIConfigureDataConnectorStep;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<LukeTestSelfServiceDIConfigureDataConnectorStep>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): LukeTestSelfServiceDIConfigureDataConnectorStep;
