// TypeScript definitions for the C3 type Test2Target
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of Test2Target
 */
declare interface ITest2Target {
 ...
 */
declare class Test2Target extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): Test2Target | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): Test2Target | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): Test2Target | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): Test2Target | null;
   ...
   */
  replaceType(old: Type, new_: Type): Test2Target;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Test2Target;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Test2Target;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Test2Target | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Test2Target | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Test2Target;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Test2Target;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Test2Target;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): Test2Target;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): Test2Target;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): Test2Target;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Test2Target;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Test2Target;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): Test2Target;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): Test2Target;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): Test2Target;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): Test2Target;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Test2Target;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): Test2Target;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Test2Target;
   ...
   * @see #unsetField
   */
  defaultField(field: string): Test2Target;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): Test2Target;
   ...
   * @see #removeField
   */
  unsetField(field: string): Test2Target;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): Test2Target;
   ...
   * @see #unsetField
   */
  removeField(field: string): Test2Target;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): Test2Target;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Test2Target;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): Test2Target;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Test2Target;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Test2Target;

  mergeJson(json: any | null): Test2Target;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Test2Target;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): Test2Target;
   ...
   */
  singletonArray(): C3.Array<Test2Target | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<Test2Target | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<Test2Target | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<Test2Target | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<Test2Target | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, Test2Target | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, Test2Target | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<Test2Target | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<Test2Target | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Test2Target;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Test2Target;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Test2Target;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): Test2Target;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Test2Target;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): Test2Target;
   ...
   * @see #fromString
   */
  static make(s: string | null): Test2Target | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Test2Target;
   ...
   */
  static cachedEmptyInst(): Test2Target;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Test2Target>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): Test2Target;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<Test2Target | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<Test2Target | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<Test2Target | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<Test2Target | null> | null>;
   ...
   */
  get(include?: string | null): Test2Target | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): Test2Target | null;
   ...
   */
  getMissing(spec: GetMissingSpec): Test2Target;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): Test2Target | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): Test2Target;
   ...
   * @see #toString
   */
  static fromString(s: string | null): Test2Target | null;
   ...
   */
  create(spec?: UpsertSpec | null): Test2Target | null;
   ...
   */
  static createBatch(objs: C3.Array<Test2Target | null> | null, spec?: UpsertSpec | null): ObjList<Test2Target | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<Test2Target | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<Test2Target | null> | null;
   ...
   */
  update(srcObj?: Test2Target | null, spec?: UpsertSpec | null): Test2Target | null;
   ...
   */
  upsert(srcObj?: Test2Target | null, spec?: UpsertSpec | null): Test2Target | null;
   ...
   */
  merge(spec?: MergeSpec | null): Test2Target | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): Test2Target | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): Test2Target | null;
   ...
   */
  static updateBatch(objs: C3.Array<Test2Target | null> | null, srcObjs?: C3.Array<Test2Target | null>, spec?: UpsertSpec | null): ObjList<Test2Target | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<Test2Target | null>>, spec?: UpsertSpec | null): ObjList<Test2Target | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<Test2Target | null> | null, srcObjs?: C3.Array<Test2Target | null>, spec?: UpsertSpec | null): ObjList<Test2Target | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<Test2Target | null>>, spec?: UpsertSpec | null): ObjList<Test2Target | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<Test2Target | null> | null, spec?: TouchSpec | null): ObjList<Test2Target | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<Test2Target | null> | null, spec?: MergeSpec | null): ObjList<Test2Target | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<Test2Target | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<Test2Target | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<Test2Target | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<Test2Target | null> | null;
   ...
   */
  static mergeAll(mergeObj: Test2Target | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: Test2Target | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<Test2Target | null> | null, spec?: UpsertSpec | null): ObjList<Test2Target | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<Test2Target | null> | null, spec?: UpsertSpec | null): ObjList<Test2Target | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<Test2Target | null> | null): ObjList<Test2Target | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<Test2Target | null> | null): ObjList<Test2Target | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<Test2Target | null> | null): ObjList<Test2Target | null>;
   ...
   */
  static afterCreate(objs: C3.Array<Test2Target | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<Test2Target | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<Test2Target | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<Test2Target | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<Test2Target | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): Test2Target | null;
   ...
   */
  withoutIdentity(): Test2Target | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<Test2Target | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: Test2Target | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<Test2Target | null> | null, callback?: λFunction<Test2Target | null, Test2Target | null> | null): ObjList<Test2Target | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<Test2Target | null> | null, callback?: λFunction<Test2Target | null, Test2Target | null> | null): C3.Array<ObjError | null>;
