// TypeScript definitions for the C3 type LukeTestSelfServiceDIS3ConnectorForm

/**
 * A test component for the S3 Connector Form
 *
 * @remarks this represents a value passed to a method that expects an instance of LukeTestSelfServiceDIS3ConnectorForm
 */
declare interface ILukeTestSelfServiceDIS3ConnectorForm {
 ...
 */
declare class LukeTestSelfServiceDIS3ConnectorForm extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): LukeTestSelfServiceDIS3ConnectorForm | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): LukeTestSelfServiceDIS3ConnectorForm | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): LukeTestSelfServiceDIS3ConnectorForm | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): LukeTestSelfServiceDIS3ConnectorForm | null;
   ...
   */
  replaceType(old: Type, new_: Type): LukeTestSelfServiceDIS3ConnectorForm;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): LukeTestSelfServiceDIS3ConnectorForm;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): LukeTestSelfServiceDIS3ConnectorForm;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<LukeTestSelfServiceDIS3ConnectorForm | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<LukeTestSelfServiceDIS3ConnectorForm | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): LukeTestSelfServiceDIS3ConnectorForm;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): LukeTestSelfServiceDIS3ConnectorForm;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): LukeTestSelfServiceDIS3ConnectorForm;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): LukeTestSelfServiceDIS3ConnectorForm;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): LukeTestSelfServiceDIS3ConnectorForm;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): LukeTestSelfServiceDIS3ConnectorForm;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): LukeTestSelfServiceDIS3ConnectorForm;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): LukeTestSelfServiceDIS3ConnectorForm;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): LukeTestSelfServiceDIS3ConnectorForm;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): LukeTestSelfServiceDIS3ConnectorForm;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): LukeTestSelfServiceDIS3ConnectorForm;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): LukeTestSelfServiceDIS3ConnectorForm;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): LukeTestSelfServiceDIS3ConnectorForm;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): LukeTestSelfServiceDIS3ConnectorForm;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): LukeTestSelfServiceDIS3ConnectorForm;
   ...
   * @see #unsetField
   */
  defaultField(field: string): LukeTestSelfServiceDIS3ConnectorForm;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): LukeTestSelfServiceDIS3ConnectorForm;
   ...
   * @see #removeField
   */
  unsetField(field: string): LukeTestSelfServiceDIS3ConnectorForm;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): LukeTestSelfServiceDIS3ConnectorForm;
   ...
   * @see #unsetField
   */
  removeField(field: string): LukeTestSelfServiceDIS3ConnectorForm;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): LukeTestSelfServiceDIS3ConnectorForm;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): LukeTestSelfServiceDIS3ConnectorForm;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): LukeTestSelfServiceDIS3ConnectorForm;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): LukeTestSelfServiceDIS3ConnectorForm;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): LukeTestSelfServiceDIS3ConnectorForm;

  mergeJson(json: any | null): LukeTestSelfServiceDIS3ConnectorForm;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): LukeTestSelfServiceDIS3ConnectorForm;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): LukeTestSelfServiceDIS3ConnectorForm;
   ...
   */
  singletonArray(): C3.Array<LukeTestSelfServiceDIS3ConnectorForm | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<LukeTestSelfServiceDIS3ConnectorForm | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<LukeTestSelfServiceDIS3ConnectorForm | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<LukeTestSelfServiceDIS3ConnectorForm | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<LukeTestSelfServiceDIS3ConnectorForm | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, LukeTestSelfServiceDIS3ConnectorForm | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, LukeTestSelfServiceDIS3ConnectorForm | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<LukeTestSelfServiceDIS3ConnectorForm | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<LukeTestSelfServiceDIS3ConnectorForm | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): LukeTestSelfServiceDIS3ConnectorForm;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): LukeTestSelfServiceDIS3ConnectorForm;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): LukeTestSelfServiceDIS3ConnectorForm;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): LukeTestSelfServiceDIS3ConnectorForm;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): LukeTestSelfServiceDIS3ConnectorForm;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): LukeTestSelfServiceDIS3ConnectorForm;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): LukeTestSelfServiceDIS3ConnectorForm;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): LukeTestSelfServiceDIS3ConnectorForm;
   ...
   */
  static cachedEmptyInst(): LukeTestSelfServiceDIS3ConnectorForm;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<LukeTestSelfServiceDIS3ConnectorForm>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): LukeTestSelfServiceDIS3ConnectorForm;
   ...
   */
  setName(value?: string | null, timeout?: number | null): LukeAsyncQueueNode | null;
   ...
   * @return a {@link LukeAsyncQueueNode}.
   */
  getName(timeout?: number | null): LukeAsyncQueueNode | null;
   ...
   * @return a {@link LukeAsyncQueueNode}.
   */
  getNameError(timeout?: number | null): LukeAsyncQueueNode | null;
   ...
   * @return a {@link LukeAsyncQueueNode}.
   */
  setDescription(value?: string | null, timeout?: number | null): LukeAsyncQueueNode | null;
   ...
   * @return a {@link LukeAsyncQueueNode}.
   */
  getDescription(timeout?: number | null): LukeAsyncQueueNode | null;
   ...
   * @return a {@link LukeAsyncQueueNode}.
   */
  getDescriptionError(timeout?: number | null): LukeAsyncQueueNode | null;
   ...
   */
  clickTestConnectionButton(timeout?: number | null): LukeAsyncQueueNode | null;
   ...
   * @return a {@link LukeAsyncQueueNode} that will be resolved when the click action is completed
   */
  getTestConnectionStatus(timeout?: number | null): LukeAsyncQueueNode | null;
   ...
   * @return a {@link LukeAsyncQueueNode}.
   */
  setNewBucketUrl(value?: string | null, timeout?: number | null): LukeAsyncQueueNode | null;
   ...
   * @return a {@link LukeAsyncQueueNode}.
   */
  selectNewBucketUrl(value?: string | null, timeout?: number | null): LukeAsyncQueueNode | null;
   ...
   * @return a {@link LukeAsyncQueueNode}.
   */
  getBucketUrl(timeout?: number | null): LukeAsyncQueueNode | null;
   ...
   * @return a {@link LukeAsyncQueueNode}.
   */
  clearSelectedBucketUrl(timeout?: number | null): LukeAsyncQueueNode | null;
   ...
   * @return a {@link LukeAsyncQueueNode}.
   */
  selectBucketRegion(value?: string | null, timeout?: number | null): LukeAsyncQueueNode | null;
   ...
   * @return a {@link LukeAsyncQueueNode}.
   */
  getSelectedBucketRegion(timeout?: number | null): LukeAsyncQueueNode | null;
   ...
   * @return a {@link LukeAsyncQueueNode}.
   */
  clearSelectedBucketRegion(timeout?: number | null): LukeAsyncQueueNode | null;
   ...
   * @return a {@link LukeAsyncQueueNode}.
   */
  setAccessKey(value?: string | null, timeout?: number | null): LukeAsyncQueueNode | null;
   ...
   * @return a {@link LukeAsyncQueueNode}.
   */
  getAccessKey(timeout?: number | null): LukeAsyncQueueNode | null;
   ...
   * @return a {@link LukeAsyncQueueNode}.
   */
  hasAccessKeyError(timeout?: number | null): LukeAsyncQueueNode | null;
   ...
   * @return a {@link LukeAsyncQueueNode}.
   */
  setSecretKey(value?: string | null, timeout?: number | null): LukeAsyncQueueNode | null;
   ...
   * @return a {@link LukeAsyncQueueNode}.
   */
  getSecretKey(timeout?: number | null): LukeAsyncQueueNode | null;
   ...
   * @return a {@link LukeAsyncQueueNode}.
   */
  hasSecretKeyError(timeout?: number | null): LukeAsyncQueueNode | null;
}
