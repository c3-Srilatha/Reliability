// TypeScript definitions for the C3 type TargetNodeReact

/**
 * React renderer for {@link TargetNodeReact}
 *
 * @remarks this represents a value passed to a method that expects an instance of TargetNodeReact
 */
declare interface ITargetNodeReact {
 ...
 */
declare class TargetNodeReact extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): TargetNodeReact | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): TargetNodeReact | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): TargetNodeReact | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): TargetNodeReact | null;
   ...
   */
  replaceType(old: Type, new_: Type): TargetNodeReact;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TargetNodeReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TargetNodeReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TargetNodeReact | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TargetNodeReact | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): TargetNodeReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TargetNodeReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TargetNodeReact;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): TargetNodeReact;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): TargetNodeReact;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): TargetNodeReact;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): TargetNodeReact;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): TargetNodeReact;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): TargetNodeReact;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): TargetNodeReact;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): TargetNodeReact;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): TargetNodeReact;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): TargetNodeReact;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): TargetNodeReact;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): TargetNodeReact;
   ...
   * @see #unsetField
   */
  defaultField(field: string): TargetNodeReact;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): TargetNodeReact;
   ...
   * @see #removeField
   */
  unsetField(field: string): TargetNodeReact;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): TargetNodeReact;
   ...
   * @see #unsetField
   */
  removeField(field: string): TargetNodeReact;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): TargetNodeReact;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): TargetNodeReact;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): TargetNodeReact;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): TargetNodeReact;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): TargetNodeReact;

  mergeJson(json: any | null): TargetNodeReact;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): TargetNodeReact;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): TargetNodeReact;
   ...
   */
  singletonArray(): C3.Array<TargetNodeReact | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<TargetNodeReact | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<TargetNodeReact | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<TargetNodeReact | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<TargetNodeReact | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, TargetNodeReact | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, TargetNodeReact | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<TargetNodeReact | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<TargetNodeReact | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): TargetNodeReact;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): TargetNodeReact;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): TargetNodeReact;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): TargetNodeReact;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): TargetNodeReact;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): TargetNodeReact;
   ...
   * @see #fromString
   */
  static make(s: string | null): TargetNodeReact | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): TargetNodeReact;
   ...
   */
  static cachedEmptyInst(): TargetNodeReact;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<TargetNodeReact>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): TargetNodeReact;
   ...
   */
  static render(props?: TargetNodeReact | null): void;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<TargetNodeReact | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<TargetNodeReact | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<TargetNodeReact | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<TargetNodeReact | null> | null>;
   ...
   */
  dependencies(): MetadataDeps<TargetNodeReact | null>;

  save(subPath?: string | null, contentType?: string | null): TargetNodeReact;
  ...
  update(srcObj?: TargetNodeReact | null, spec?: UpsertSpec | null): TargetNodeReact | null;

  upsert(srcObj?: TargetNodeReact | null, spec?: UpsertSpec | null): TargetNodeReact | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): TargetNodeReact | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string | null, failIfMissing?: boolean): TargetNodeReact | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: TargetNodeReact, state: UiSdlReduxState): TargetNodeReact | null;
