// TypeScript definitions for the C3 type MappingNodeReact

/**
 * React renderer for {@link MappingNodeReact}
 *
 * @remarks this represents a value passed to a method that expects an instance of MappingNodeReact
 */
declare interface IMappingNodeReact {
 ...
 */
declare class MappingNodeReact extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): MappingNodeReact | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): MappingNodeReact | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): MappingNodeReact | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): MappingNodeReact | null;
   ...
   */
  replaceType(old: Type, new_: Type): MappingNodeReact;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): MappingNodeReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): MappingNodeReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<MappingNodeReact | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<MappingNodeReact | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): MappingNodeReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): MappingNodeReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): MappingNodeReact;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): MappingNodeReact;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): MappingNodeReact;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): MappingNodeReact;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): MappingNodeReact;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): MappingNodeReact;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): MappingNodeReact;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): MappingNodeReact;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): MappingNodeReact;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): MappingNodeReact;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): MappingNodeReact;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): MappingNodeReact;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): MappingNodeReact;
   ...
   * @see #unsetField
   */
  defaultField(field: string): MappingNodeReact;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): MappingNodeReact;
   ...
   * @see #removeField
   */
  unsetField(field: string): MappingNodeReact;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): MappingNodeReact;
   ...
   * @see #unsetField
   */
  removeField(field: string): MappingNodeReact;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): MappingNodeReact;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): MappingNodeReact;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): MappingNodeReact;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): MappingNodeReact;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): MappingNodeReact;

  mergeJson(json: any | null): MappingNodeReact;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): MappingNodeReact;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): MappingNodeReact;
   ...
   */
  singletonArray(): C3.Array<MappingNodeReact | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<MappingNodeReact | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<MappingNodeReact | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<MappingNodeReact | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<MappingNodeReact | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, MappingNodeReact | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, MappingNodeReact | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<MappingNodeReact | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<MappingNodeReact | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): MappingNodeReact;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): MappingNodeReact;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): MappingNodeReact;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): MappingNodeReact;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): MappingNodeReact;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): MappingNodeReact;
   ...
   * @see #fromString
   */
  static make(s: string | null): MappingNodeReact | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): MappingNodeReact;
   ...
   */
  static cachedEmptyInst(): MappingNodeReact;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<MappingNodeReact>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): MappingNodeReact;
   ...
   */
  static render(props?: MappingNodeReact | null): void;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<MappingNodeReact | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<MappingNodeReact | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<MappingNodeReact | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<MappingNodeReact | null> | null>;
   ...
   */
  dependencies(): MetadataDeps<MappingNodeReact | null>;

  save(subPath?: string | null, contentType?: string | null): MappingNodeReact;
  ...
  update(srcObj?: MappingNodeReact | null, spec?: UpsertSpec | null): MappingNodeReact | null;

  upsert(srcObj?: MappingNodeReact | null, spec?: UpsertSpec | null): MappingNodeReact | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): MappingNodeReact | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string | null, failIfMissing?: boolean): MappingNodeReact | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: MappingNodeReact, state: UiSdlReduxState): MappingNodeReact | null;
