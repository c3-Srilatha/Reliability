// TypeScript definitions for the C3 type MetadataExtractorPreviewDataContainer
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of MetadataExtractorPreviewDataContainer
 */
declare interface IMetadataExtractorPreviewDataContainer {
 ...
 */
declare class MetadataExtractorPreviewDataContainer extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): MetadataExtractorPreviewDataContainer | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): MetadataExtractorPreviewDataContainer | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): MetadataExtractorPreviewDataContainer | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): MetadataExtractorPreviewDataContainer | null;
   ...
   */
  replaceType(old: Type, new_: Type): MetadataExtractorPreviewDataContainer;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): MetadataExtractorPreviewDataContainer;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): MetadataExtractorPreviewDataContainer;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<MetadataExtractorPreviewDataContainer | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<MetadataExtractorPreviewDataContainer | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): MetadataExtractorPreviewDataContainer;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): MetadataExtractorPreviewDataContainer;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): MetadataExtractorPreviewDataContainer;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): MetadataExtractorPreviewDataContainer;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): MetadataExtractorPreviewDataContainer;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): MetadataExtractorPreviewDataContainer;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): MetadataExtractorPreviewDataContainer;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): MetadataExtractorPreviewDataContainer;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): MetadataExtractorPreviewDataContainer;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): MetadataExtractorPreviewDataContainer;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): MetadataExtractorPreviewDataContainer;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): MetadataExtractorPreviewDataContainer;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): MetadataExtractorPreviewDataContainer;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): MetadataExtractorPreviewDataContainer;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): MetadataExtractorPreviewDataContainer;
   ...
   * @see #unsetField
   */
  defaultField(field: string): MetadataExtractorPreviewDataContainer;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): MetadataExtractorPreviewDataContainer;
   ...
   * @see #removeField
   */
  unsetField(field: string): MetadataExtractorPreviewDataContainer;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): MetadataExtractorPreviewDataContainer;
   ...
   * @see #unsetField
   */
  removeField(field: string): MetadataExtractorPreviewDataContainer;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): MetadataExtractorPreviewDataContainer;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): MetadataExtractorPreviewDataContainer;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): MetadataExtractorPreviewDataContainer;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): MetadataExtractorPreviewDataContainer;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): MetadataExtractorPreviewDataContainer;

  mergeJson(json: any | null): MetadataExtractorPreviewDataContainer;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): MetadataExtractorPreviewDataContainer;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): MetadataExtractorPreviewDataContainer;
   ...
   */
  singletonArray(): C3.Array<MetadataExtractorPreviewDataContainer | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<MetadataExtractorPreviewDataContainer | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<MetadataExtractorPreviewDataContainer | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<MetadataExtractorPreviewDataContainer | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<MetadataExtractorPreviewDataContainer | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, MetadataExtractorPreviewDataContainer | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, MetadataExtractorPreviewDataContainer | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<MetadataExtractorPreviewDataContainer | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<MetadataExtractorPreviewDataContainer | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): MetadataExtractorPreviewDataContainer;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): MetadataExtractorPreviewDataContainer;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): MetadataExtractorPreviewDataContainer;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): MetadataExtractorPreviewDataContainer;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): MetadataExtractorPreviewDataContainer;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): MetadataExtractorPreviewDataContainer;
   ...
   * @see #fromString
   */
  static make(s: string | null): MetadataExtractorPreviewDataContainer | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): MetadataExtractorPreviewDataContainer;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): MetadataExtractorPreviewDataContainer;
   ...
   */
  static cachedEmptyInst(): MetadataExtractorPreviewDataContainer;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<MetadataExtractorPreviewDataContainer>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): MetadataExtractorPreviewDataContainer;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<MetadataExtractorPreviewDataContainer | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<MetadataExtractorPreviewDataContainer | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<MetadataExtractorPreviewDataContainer | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<MetadataExtractorPreviewDataContainer | null> | null>;
   ...
   */
  dependencies(): MetadataDeps<MetadataExtractorPreviewDataContainer | null>;

  save(subPath?: string | null, contentType?: string | null): MetadataExtractorPreviewDataContainer;
  ...
  update(srcObj?: MetadataExtractorPreviewDataContainer | null, spec?: UpsertSpec | null): MetadataExtractorPreviewDataContainer | null;

  upsert(srcObj?: MetadataExtractorPreviewDataContainer | null, spec?: UpsertSpec | null): MetadataExtractorPreviewDataContainer | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): MetadataExtractorPreviewDataContainer | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string | null, failIfMissing?: boolean): MetadataExtractorPreviewDataContainer | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: MetadataExtractorPreviewDataContainer, state: UiSdlReduxState): MetadataExtractorPreviewDataContainer | null;
