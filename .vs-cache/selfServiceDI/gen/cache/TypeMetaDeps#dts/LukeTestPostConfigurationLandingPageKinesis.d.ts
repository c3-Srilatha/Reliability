// TypeScript definitions for the C3 type LukeTestPostConfigurationLandingPageKinesis

/**
 * The Post Configuration Landing Page type for Kinesis
 *
 * @remarks this represents a value passed to a method that expects an instance of LukeTestPostConfigurationLandingPageKinesis
 */
declare interface ILukeTestPostConfigurationLandingPageKinesis {
 ...
 */
declare class LukeTestPostConfigurationLandingPageKinesis extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): LukeTestPostConfigurationLandingPageKinesis | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): LukeTestPostConfigurationLandingPageKinesis | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): LukeTestPostConfigurationLandingPageKinesis | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): LukeTestPostConfigurationLandingPageKinesis | null;
   ...
   */
  replaceType(old: Type, new_: Type): LukeTestPostConfigurationLandingPageKinesis;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): LukeTestPostConfigurationLandingPageKinesis;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): LukeTestPostConfigurationLandingPageKinesis;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<LukeTestPostConfigurationLandingPageKinesis | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<LukeTestPostConfigurationLandingPageKinesis | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): LukeTestPostConfigurationLandingPageKinesis;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): LukeTestPostConfigurationLandingPageKinesis;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): LukeTestPostConfigurationLandingPageKinesis;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): LukeTestPostConfigurationLandingPageKinesis;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): LukeTestPostConfigurationLandingPageKinesis;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): LukeTestPostConfigurationLandingPageKinesis;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): LukeTestPostConfigurationLandingPageKinesis;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): LukeTestPostConfigurationLandingPageKinesis;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): LukeTestPostConfigurationLandingPageKinesis;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): LukeTestPostConfigurationLandingPageKinesis;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): LukeTestPostConfigurationLandingPageKinesis;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): LukeTestPostConfigurationLandingPageKinesis;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): LukeTestPostConfigurationLandingPageKinesis;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): LukeTestPostConfigurationLandingPageKinesis;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): LukeTestPostConfigurationLandingPageKinesis;
   ...
   * @see #unsetField
   */
  defaultField(field: string): LukeTestPostConfigurationLandingPageKinesis;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): LukeTestPostConfigurationLandingPageKinesis;
   ...
   * @see #removeField
   */
  unsetField(field: string): LukeTestPostConfigurationLandingPageKinesis;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): LukeTestPostConfigurationLandingPageKinesis;
   ...
   * @see #unsetField
   */
  removeField(field: string): LukeTestPostConfigurationLandingPageKinesis;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): LukeTestPostConfigurationLandingPageKinesis;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): LukeTestPostConfigurationLandingPageKinesis;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): LukeTestPostConfigurationLandingPageKinesis;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): LukeTestPostConfigurationLandingPageKinesis;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): LukeTestPostConfigurationLandingPageKinesis;

  mergeJson(json: any | null): LukeTestPostConfigurationLandingPageKinesis;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): LukeTestPostConfigurationLandingPageKinesis;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): LukeTestPostConfigurationLandingPageKinesis;
   ...
   */
  singletonArray(): C3.Array<LukeTestPostConfigurationLandingPageKinesis | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<LukeTestPostConfigurationLandingPageKinesis | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<LukeTestPostConfigurationLandingPageKinesis | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<LukeTestPostConfigurationLandingPageKinesis | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<LukeTestPostConfigurationLandingPageKinesis | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, LukeTestPostConfigurationLandingPageKinesis | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, LukeTestPostConfigurationLandingPageKinesis | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<LukeTestPostConfigurationLandingPageKinesis | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<LukeTestPostConfigurationLandingPageKinesis | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): LukeTestPostConfigurationLandingPageKinesis;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): LukeTestPostConfigurationLandingPageKinesis;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): LukeTestPostConfigurationLandingPageKinesis;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): LukeTestPostConfigurationLandingPageKinesis;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): LukeTestPostConfigurationLandingPageKinesis;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): LukeTestPostConfigurationLandingPageKinesis;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): LukeTestPostConfigurationLandingPageKinesis;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): LukeTestPostConfigurationLandingPageKinesis;
   ...
   */
  static cachedEmptyInst(): LukeTestPostConfigurationLandingPageKinesis;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<LukeTestPostConfigurationLandingPageKinesis>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): LukeTestPostConfigurationLandingPageKinesis;
