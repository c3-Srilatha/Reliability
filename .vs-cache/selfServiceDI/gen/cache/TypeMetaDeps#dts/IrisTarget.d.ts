// TypeScript definitions for the C3 type IrisTarget
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of IrisTarget
 */
declare interface IIrisTarget {
 ...
 */
declare class IrisTarget extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): IrisTarget | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): IrisTarget | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): IrisTarget | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): IrisTarget | null;
   ...
   */
  replaceType(old: Type, new_: Type): IrisTarget;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): IrisTarget;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): IrisTarget;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<IrisTarget | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<IrisTarget | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): IrisTarget;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): IrisTarget;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): IrisTarget;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): IrisTarget;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): IrisTarget;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): IrisTarget;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): IrisTarget;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): IrisTarget;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): IrisTarget;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): IrisTarget;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): IrisTarget;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): IrisTarget;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): IrisTarget;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): IrisTarget;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): IrisTarget;
   ...
   * @see #unsetField
   */
  defaultField(field: string): IrisTarget;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): IrisTarget;
   ...
   * @see #removeField
   */
  unsetField(field: string): IrisTarget;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): IrisTarget;
   ...
   * @see #unsetField
   */
  removeField(field: string): IrisTarget;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): IrisTarget;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): IrisTarget;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): IrisTarget;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): IrisTarget;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): IrisTarget;

  mergeJson(json: any | null): IrisTarget;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): IrisTarget;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): IrisTarget;
   ...
   */
  singletonArray(): C3.Array<IrisTarget | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<IrisTarget | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<IrisTarget | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<IrisTarget | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<IrisTarget | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, IrisTarget | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, IrisTarget | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<IrisTarget | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<IrisTarget | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): IrisTarget;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): IrisTarget;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): IrisTarget;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): IrisTarget;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): IrisTarget;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): IrisTarget;
   ...
   * @see #fromString
   */
  static make(s: string | null): IrisTarget | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): IrisTarget;
   ...
   */
  static cachedEmptyInst(): IrisTarget;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<IrisTarget>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): IrisTarget;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<IrisTarget | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<IrisTarget | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<IrisTarget | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<IrisTarget | null> | null>;
   ...
   */
  get(include?: string | null): IrisTarget | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): IrisTarget | null;
   ...
   */
  getMissing(spec: GetMissingSpec): IrisTarget;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): IrisTarget | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): IrisTarget;
   ...
   * @see #toString
   */
  static fromString(s: string | null): IrisTarget | null;
   ...
   */
  create(spec?: UpsertSpec | null): IrisTarget | null;
   ...
   */
  static createBatch(objs: C3.Array<IrisTarget | null> | null, spec?: UpsertSpec | null): ObjList<IrisTarget | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<IrisTarget | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<IrisTarget | null> | null;
   ...
   */
  update(srcObj?: IrisTarget | null, spec?: UpsertSpec | null): IrisTarget | null;
   ...
   */
  upsert(srcObj?: IrisTarget | null, spec?: UpsertSpec | null): IrisTarget | null;
   ...
   */
  merge(spec?: MergeSpec | null): IrisTarget | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): IrisTarget | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): IrisTarget | null;
   ...
   */
  static updateBatch(objs: C3.Array<IrisTarget | null> | null, srcObjs?: C3.Array<IrisTarget | null>, spec?: UpsertSpec | null): ObjList<IrisTarget | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<IrisTarget | null>>, spec?: UpsertSpec | null): ObjList<IrisTarget | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<IrisTarget | null> | null, srcObjs?: C3.Array<IrisTarget | null>, spec?: UpsertSpec | null): ObjList<IrisTarget | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<IrisTarget | null>>, spec?: UpsertSpec | null): ObjList<IrisTarget | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<IrisTarget | null> | null, spec?: TouchSpec | null): ObjList<IrisTarget | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<IrisTarget | null> | null, spec?: MergeSpec | null): ObjList<IrisTarget | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<IrisTarget | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<IrisTarget | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<IrisTarget | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<IrisTarget | null> | null;
   ...
   */
  static mergeAll(mergeObj: IrisTarget | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: IrisTarget | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<IrisTarget | null> | null, spec?: UpsertSpec | null): ObjList<IrisTarget | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<IrisTarget | null> | null, spec?: UpsertSpec | null): ObjList<IrisTarget | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<IrisTarget | null> | null): ObjList<IrisTarget | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<IrisTarget | null> | null): ObjList<IrisTarget | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<IrisTarget | null> | null): ObjList<IrisTarget | null>;
   ...
   */
  static afterCreate(objs: C3.Array<IrisTarget | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<IrisTarget | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<IrisTarget | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<IrisTarget | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<IrisTarget | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): IrisTarget | null;
   ...
   */
  withoutIdentity(): IrisTarget | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<IrisTarget | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: IrisTarget | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<IrisTarget | null> | null, callback?: λFunction<IrisTarget | null, IrisTarget | null> | null): ObjList<IrisTarget | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<IrisTarget | null> | null, callback?: λFunction<IrisTarget | null, IrisTarget | null> | null): C3.Array<ObjError | null>;
