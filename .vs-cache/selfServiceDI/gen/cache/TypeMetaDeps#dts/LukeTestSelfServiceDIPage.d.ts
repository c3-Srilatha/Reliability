// TypeScript definitions for the C3 type LukeTestSelfServiceDIPage

/**
 * A test page for the selfServiceDI main flow
 *
 * @remarks this represents a value passed to a method that expects an instance of LukeTestSelfServiceDIPage
 */
declare interface ILukeTestSelfServiceDIPage {
   ...
   */
  externalSourcesSidePanel?: ILukeTestUiSdlSidePanel | null;

  /**
   * The connectorForm associated with this page
   */
  connectorForm?: ILukeTestSelfServiceDIConnectorForm | null;

  /**
   * The datagrid with this page
   */
  dataGrid?: ILukeTestPreviewSqlTableDataGrid | null;

  /**
   * The  Tab Panel associated with this page
   */
  tabPanel?: ILukeTestSelfServiceDITabPanel | null;

  /**
   * The datagrid for the with this page
   */
  externalSourceDetailsCheckboxGrid?: ILukeTestExternalSourceDetailsCheckboxGrid | null;

  /**
   * The datagrid with this page
   */
  externalSourceDetailsGrid?: ILukeTestExternalSourceDetailsGrid | null;

  /**
   * The multiStepComponent with this page
   */
  multiStepComponent?: ILukeTestMultiStepComponent | null;
   ...
   */
  selectDataConnectorStep?: ILukeTestSelectDataConnectorStep | null;

  /**
   * The selector for sidePanelTreeviewEmptyStateSelector
   */
  sidePanelTreeviewEmptyStateSelector?: string | null;

  /**
   * The selector for externalSourcesEmptyStateSelector
   */
  externalSourcesEmptyStateSelector?: string | null;

  /**
   * The selector for addDataSourceButtonSelector
   */
  addDataSourceButtonSelector?: string | null;

  /**
   * The selector for fileUploadButtonSelector
   */
  fileUploadButtonSelector?: string | null;

  /**
   * The file upload component integrated as a child of this page
   */
  fileUpload?: ILukeTestUiSdlFileUpload | null;
}
 ...
 */
declare class LukeTestSelfServiceDIPage extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): LukeTestSelfServiceDIPage | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): LukeTestSelfServiceDIPage | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): LukeTestSelfServiceDIPage | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): LukeTestSelfServiceDIPage | null;
   ...
   */
  replaceType(old: Type, new_: Type): LukeTestSelfServiceDIPage;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): LukeTestSelfServiceDIPage;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): LukeTestSelfServiceDIPage;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<LukeTestSelfServiceDIPage | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<LukeTestSelfServiceDIPage | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): LukeTestSelfServiceDIPage;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): LukeTestSelfServiceDIPage;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): LukeTestSelfServiceDIPage;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): LukeTestSelfServiceDIPage;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): LukeTestSelfServiceDIPage;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): LukeTestSelfServiceDIPage;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): LukeTestSelfServiceDIPage;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): LukeTestSelfServiceDIPage;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): LukeTestSelfServiceDIPage;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): LukeTestSelfServiceDIPage;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): LukeTestSelfServiceDIPage;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): LukeTestSelfServiceDIPage;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): LukeTestSelfServiceDIPage;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): LukeTestSelfServiceDIPage;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): LukeTestSelfServiceDIPage;
   ...
   * @see #unsetField
   */
  defaultField(field: string): LukeTestSelfServiceDIPage;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): LukeTestSelfServiceDIPage;
   ...
   * @see #removeField
   */
  unsetField(field: string): LukeTestSelfServiceDIPage;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): LukeTestSelfServiceDIPage;
   ...
   * @see #unsetField
   */
  removeField(field: string): LukeTestSelfServiceDIPage;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): LukeTestSelfServiceDIPage;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): LukeTestSelfServiceDIPage;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): LukeTestSelfServiceDIPage;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): LukeTestSelfServiceDIPage;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): LukeTestSelfServiceDIPage;

  mergeJson(json: any | null): LukeTestSelfServiceDIPage;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): LukeTestSelfServiceDIPage;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): LukeTestSelfServiceDIPage;
   ...
   */
  singletonArray(): C3.Array<LukeTestSelfServiceDIPage | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<LukeTestSelfServiceDIPage | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<LukeTestSelfServiceDIPage | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<LukeTestSelfServiceDIPage | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<LukeTestSelfServiceDIPage | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, LukeTestSelfServiceDIPage | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, LukeTestSelfServiceDIPage | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<LukeTestSelfServiceDIPage | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<LukeTestSelfServiceDIPage | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): LukeTestSelfServiceDIPage;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): LukeTestSelfServiceDIPage;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): LukeTestSelfServiceDIPage;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): LukeTestSelfServiceDIPage;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): LukeTestSelfServiceDIPage;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): LukeTestSelfServiceDIPage;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): LukeTestSelfServiceDIPage;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): LukeTestSelfServiceDIPage;
   ...
   */
  static cachedEmptyInst(): LukeTestSelfServiceDIPage;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<LukeTestSelfServiceDIPage>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): LukeTestSelfServiceDIPage;
   ...
   */
  openPage(tabTitle?: string | null, timeout?: number | null): void;
   ...
   */
  addDataSource(timeout?: number | null): LukeAsyncQueueNode | null;
   ...
   */
  startFileUploadFlow(files?: C3.Array<string | null>): LukeAsyncQueueNode | null;
