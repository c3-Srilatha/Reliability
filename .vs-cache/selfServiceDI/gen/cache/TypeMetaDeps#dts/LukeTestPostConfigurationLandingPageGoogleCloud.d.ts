// TypeScript definitions for the C3 type LukeTestPostConfigurationLandingPageGoogleCloud

/**
 * The Post Configuration Landing Page type for Google Cloud
 *
 * @remarks this represents a value passed to a method that expects an instance of LukeTestPostConfigurationLandingPageGoogleCloud
 */
declare interface ILukeTestPostConfigurationLandingPageGoogleCloud {
 ...
 */
declare class LukeTestPostConfigurationLandingPageGoogleCloud extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): LukeTestPostConfigurationLandingPageGoogleCloud | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): LukeTestPostConfigurationLandingPageGoogleCloud | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): LukeTestPostConfigurationLandingPageGoogleCloud | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): LukeTestPostConfigurationLandingPageGoogleCloud | null;
   ...
   */
  replaceType(old: Type, new_: Type): LukeTestPostConfigurationLandingPageGoogleCloud;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): LukeTestPostConfigurationLandingPageGoogleCloud;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): LukeTestPostConfigurationLandingPageGoogleCloud;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<LukeTestPostConfigurationLandingPageGoogleCloud | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<LukeTestPostConfigurationLandingPageGoogleCloud | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): LukeTestPostConfigurationLandingPageGoogleCloud;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): LukeTestPostConfigurationLandingPageGoogleCloud;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): LukeTestPostConfigurationLandingPageGoogleCloud;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): LukeTestPostConfigurationLandingPageGoogleCloud;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): LukeTestPostConfigurationLandingPageGoogleCloud;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): LukeTestPostConfigurationLandingPageGoogleCloud;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): LukeTestPostConfigurationLandingPageGoogleCloud;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): LukeTestPostConfigurationLandingPageGoogleCloud;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): LukeTestPostConfigurationLandingPageGoogleCloud;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): LukeTestPostConfigurationLandingPageGoogleCloud;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): LukeTestPostConfigurationLandingPageGoogleCloud;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): LukeTestPostConfigurationLandingPageGoogleCloud;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): LukeTestPostConfigurationLandingPageGoogleCloud;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): LukeTestPostConfigurationLandingPageGoogleCloud;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): LukeTestPostConfigurationLandingPageGoogleCloud;
   ...
   * @see #unsetField
   */
  defaultField(field: string): LukeTestPostConfigurationLandingPageGoogleCloud;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): LukeTestPostConfigurationLandingPageGoogleCloud;
   ...
   * @see #removeField
   */
  unsetField(field: string): LukeTestPostConfigurationLandingPageGoogleCloud;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): LukeTestPostConfigurationLandingPageGoogleCloud;
   ...
   * @see #unsetField
   */
  removeField(field: string): LukeTestPostConfigurationLandingPageGoogleCloud;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): LukeTestPostConfigurationLandingPageGoogleCloud;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): LukeTestPostConfigurationLandingPageGoogleCloud;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): LukeTestPostConfigurationLandingPageGoogleCloud;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): LukeTestPostConfigurationLandingPageGoogleCloud;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): LukeTestPostConfigurationLandingPageGoogleCloud;

  mergeJson(json: any | null): LukeTestPostConfigurationLandingPageGoogleCloud;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): LukeTestPostConfigurationLandingPageGoogleCloud;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): LukeTestPostConfigurationLandingPageGoogleCloud;
   ...
   */
  singletonArray(): C3.Array<LukeTestPostConfigurationLandingPageGoogleCloud | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<LukeTestPostConfigurationLandingPageGoogleCloud | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<LukeTestPostConfigurationLandingPageGoogleCloud | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<LukeTestPostConfigurationLandingPageGoogleCloud | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<LukeTestPostConfigurationLandingPageGoogleCloud | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, LukeTestPostConfigurationLandingPageGoogleCloud | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, LukeTestPostConfigurationLandingPageGoogleCloud | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<LukeTestPostConfigurationLandingPageGoogleCloud | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<LukeTestPostConfigurationLandingPageGoogleCloud | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): LukeTestPostConfigurationLandingPageGoogleCloud;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): LukeTestPostConfigurationLandingPageGoogleCloud;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): LukeTestPostConfigurationLandingPageGoogleCloud;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): LukeTestPostConfigurationLandingPageGoogleCloud;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): LukeTestPostConfigurationLandingPageGoogleCloud;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): LukeTestPostConfigurationLandingPageGoogleCloud;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): LukeTestPostConfigurationLandingPageGoogleCloud;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): LukeTestPostConfigurationLandingPageGoogleCloud;
   ...
   */
  static cachedEmptyInst(): LukeTestPostConfigurationLandingPageGoogleCloud;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<LukeTestPostConfigurationLandingPageGoogleCloud>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): LukeTestPostConfigurationLandingPageGoogleCloud;
