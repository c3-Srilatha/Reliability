// TypeScript definitions for the C3 type FilterNodeReact

/**
 * The react component of type {@link FilterNode}
 *
 * @remarks this represents a value passed to a method that expects an instance of FilterNodeReact
 */
declare interface IFilterNodeReact {
 ...
 */
declare class FilterNodeReact extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): FilterNodeReact | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): FilterNodeReact | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): FilterNodeReact | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): FilterNodeReact | null;
   ...
   */
  replaceType(old: Type, new_: Type): FilterNodeReact;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): FilterNodeReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): FilterNodeReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<FilterNodeReact | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<FilterNodeReact | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): FilterNodeReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): FilterNodeReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): FilterNodeReact;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): FilterNodeReact;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): FilterNodeReact;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): FilterNodeReact;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): FilterNodeReact;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): FilterNodeReact;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): FilterNodeReact;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): FilterNodeReact;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): FilterNodeReact;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): FilterNodeReact;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): FilterNodeReact;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): FilterNodeReact;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): FilterNodeReact;
   ...
   * @see #unsetField
   */
  defaultField(field: string): FilterNodeReact;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): FilterNodeReact;
   ...
   * @see #removeField
   */
  unsetField(field: string): FilterNodeReact;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): FilterNodeReact;
   ...
   * @see #unsetField
   */
  removeField(field: string): FilterNodeReact;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): FilterNodeReact;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): FilterNodeReact;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): FilterNodeReact;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): FilterNodeReact;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): FilterNodeReact;

  mergeJson(json: any | null): FilterNodeReact;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): FilterNodeReact;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): FilterNodeReact;
   ...
   */
  singletonArray(): C3.Array<FilterNodeReact | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<FilterNodeReact | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<FilterNodeReact | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<FilterNodeReact | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<FilterNodeReact | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, FilterNodeReact | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, FilterNodeReact | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<FilterNodeReact | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<FilterNodeReact | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): FilterNodeReact;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): FilterNodeReact;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): FilterNodeReact;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): FilterNodeReact;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): FilterNodeReact;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): FilterNodeReact;
   ...
   * @see #fromString
   */
  static make(s: string | null): FilterNodeReact | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): FilterNodeReact;
   ...
   */
  static cachedEmptyInst(): FilterNodeReact;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<FilterNodeReact>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): FilterNodeReact;
   ...
   */
  static render(props?: FilterNodeReact | null): void;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<FilterNodeReact | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<FilterNodeReact | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<FilterNodeReact | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<FilterNodeReact | null> | null>;
   ...
   */
  dependencies(): MetadataDeps<FilterNodeReact | null>;

  save(subPath?: string | null, contentType?: string | null): FilterNodeReact;
  ...
  update(srcObj?: FilterNodeReact | null, spec?: UpsertSpec | null): FilterNodeReact | null;

  upsert(srcObj?: FilterNodeReact | null, spec?: UpsertSpec | null): FilterNodeReact | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): FilterNodeReact | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string | null, failIfMissing?: boolean): FilterNodeReact | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: FilterNodeReact, state: UiSdlReduxState): FilterNodeReact | null;
