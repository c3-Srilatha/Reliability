// TypeScript definitions for the C3 type LukeTestConfigureDataConnectorStepCloudMessageConnector

/**
 * The connector type for Cloud Message connectors which holds shared items of all Cloud Message connectors
 *
 * @remarks this represents a value passed to a method that expects an instance of LukeTestConfigureDataConnectorStepCloudMessageConnector
 */
declare interface ILukeTestConfigureDataConnectorStepCloudMessageConnector {
 ...
 */
declare class LukeTestConfigureDataConnectorStepCloudMessageConnector extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): LukeTestConfigureDataConnectorStepCloudMessageConnector | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): LukeTestConfigureDataConnectorStepCloudMessageConnector | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): LukeTestConfigureDataConnectorStepCloudMessageConnector | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): LukeTestConfigureDataConnectorStepCloudMessageConnector | null;
   ...
   */
  replaceType(old: Type, new_: Type): LukeTestConfigureDataConnectorStepCloudMessageConnector;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): LukeTestConfigureDataConnectorStepCloudMessageConnector;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): LukeTestConfigureDataConnectorStepCloudMessageConnector;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<LukeTestConfigureDataConnectorStepCloudMessageConnector | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<LukeTestConfigureDataConnectorStepCloudMessageConnector | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): LukeTestConfigureDataConnectorStepCloudMessageConnector;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): LukeTestConfigureDataConnectorStepCloudMessageConnector;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): LukeTestConfigureDataConnectorStepCloudMessageConnector;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): LukeTestConfigureDataConnectorStepCloudMessageConnector;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): LukeTestConfigureDataConnectorStepCloudMessageConnector;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): LukeTestConfigureDataConnectorStepCloudMessageConnector;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): LukeTestConfigureDataConnectorStepCloudMessageConnector;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): LukeTestConfigureDataConnectorStepCloudMessageConnector;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): LukeTestConfigureDataConnectorStepCloudMessageConnector;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): LukeTestConfigureDataConnectorStepCloudMessageConnector;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): LukeTestConfigureDataConnectorStepCloudMessageConnector;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): LukeTestConfigureDataConnectorStepCloudMessageConnector;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): LukeTestConfigureDataConnectorStepCloudMessageConnector;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): LukeTestConfigureDataConnectorStepCloudMessageConnector;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): LukeTestConfigureDataConnectorStepCloudMessageConnector;
   ...
   * @see #unsetField
   */
  defaultField(field: string): LukeTestConfigureDataConnectorStepCloudMessageConnector;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): LukeTestConfigureDataConnectorStepCloudMessageConnector;
   ...
   * @see #removeField
   */
  unsetField(field: string): LukeTestConfigureDataConnectorStepCloudMessageConnector;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): LukeTestConfigureDataConnectorStepCloudMessageConnector;
   ...
   * @see #unsetField
   */
  removeField(field: string): LukeTestConfigureDataConnectorStepCloudMessageConnector;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): LukeTestConfigureDataConnectorStepCloudMessageConnector;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): LukeTestConfigureDataConnectorStepCloudMessageConnector;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): LukeTestConfigureDataConnectorStepCloudMessageConnector;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): LukeTestConfigureDataConnectorStepCloudMessageConnector;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): LukeTestConfigureDataConnectorStepCloudMessageConnector;

  mergeJson(json: any | null): LukeTestConfigureDataConnectorStepCloudMessageConnector;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): LukeTestConfigureDataConnectorStepCloudMessageConnector;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): LukeTestConfigureDataConnectorStepCloudMessageConnector;
   ...
   */
  singletonArray(): C3.Array<LukeTestConfigureDataConnectorStepCloudMessageConnector | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<LukeTestConfigureDataConnectorStepCloudMessageConnector | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<LukeTestConfigureDataConnectorStepCloudMessageConnector | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<LukeTestConfigureDataConnectorStepCloudMessageConnector | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<LukeTestConfigureDataConnectorStepCloudMessageConnector | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, LukeTestConfigureDataConnectorStepCloudMessageConnector | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, LukeTestConfigureDataConnectorStepCloudMessageConnector | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<LukeTestConfigureDataConnectorStepCloudMessageConnector | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<LukeTestConfigureDataConnectorStepCloudMessageConnector | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): LukeTestConfigureDataConnectorStepCloudMessageConnector;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): LukeTestConfigureDataConnectorStepCloudMessageConnector;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): LukeTestConfigureDataConnectorStepCloudMessageConnector;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): LukeTestConfigureDataConnectorStepCloudMessageConnector;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): LukeTestConfigureDataConnectorStepCloudMessageConnector;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): LukeTestConfigureDataConnectorStepCloudMessageConnector;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): LukeTestConfigureDataConnectorStepCloudMessageConnector;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): LukeTestConfigureDataConnectorStepCloudMessageConnector;
   ...
   */
  static cachedEmptyInst(): LukeTestConfigureDataConnectorStepCloudMessageConnector;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<LukeTestConfigureDataConnectorStepCloudMessageConnector>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): LukeTestConfigureDataConnectorStepCloudMessageConnector;
