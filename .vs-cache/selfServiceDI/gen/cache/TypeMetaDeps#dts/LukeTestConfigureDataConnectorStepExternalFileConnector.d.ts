// TypeScript definitions for the C3 type LukeTestConfigureDataConnectorStepExternalFileConnector

/**
 * The connector type for Exteral file Message connectors which holds shared items of all Cloud Message connectors
 *
 * @remarks this represents a value passed to a method that expects an instance of LukeTestConfigureDataConnectorStepExternalFileConnector
 */
declare interface ILukeTestConfigureDataConnectorStepExternalFileConnector {
   ...
   */
  bucketDropdownInputSelector?: string | null;

  /**
   * The selector for the new url option in the bucket dropdown
   */
  bucketDropdownNewUrlSelector?: string | null;
}
 ...
 */
declare class LukeTestConfigureDataConnectorStepExternalFileConnector extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): LukeTestConfigureDataConnectorStepExternalFileConnector | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): LukeTestConfigureDataConnectorStepExternalFileConnector | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): LukeTestConfigureDataConnectorStepExternalFileConnector | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): LukeTestConfigureDataConnectorStepExternalFileConnector | null;
   ...
   */
  replaceType(old: Type, new_: Type): LukeTestConfigureDataConnectorStepExternalFileConnector;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): LukeTestConfigureDataConnectorStepExternalFileConnector;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): LukeTestConfigureDataConnectorStepExternalFileConnector;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<LukeTestConfigureDataConnectorStepExternalFileConnector | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<LukeTestConfigureDataConnectorStepExternalFileConnector | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): LukeTestConfigureDataConnectorStepExternalFileConnector;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): LukeTestConfigureDataConnectorStepExternalFileConnector;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): LukeTestConfigureDataConnectorStepExternalFileConnector;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): LukeTestConfigureDataConnectorStepExternalFileConnector;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): LukeTestConfigureDataConnectorStepExternalFileConnector;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): LukeTestConfigureDataConnectorStepExternalFileConnector;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): LukeTestConfigureDataConnectorStepExternalFileConnector;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): LukeTestConfigureDataConnectorStepExternalFileConnector;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): LukeTestConfigureDataConnectorStepExternalFileConnector;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): LukeTestConfigureDataConnectorStepExternalFileConnector;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): LukeTestConfigureDataConnectorStepExternalFileConnector;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): LukeTestConfigureDataConnectorStepExternalFileConnector;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): LukeTestConfigureDataConnectorStepExternalFileConnector;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): LukeTestConfigureDataConnectorStepExternalFileConnector;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): LukeTestConfigureDataConnectorStepExternalFileConnector;
   ...
   * @see #unsetField
   */
  defaultField(field: string): LukeTestConfigureDataConnectorStepExternalFileConnector;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): LukeTestConfigureDataConnectorStepExternalFileConnector;
   ...
   * @see #removeField
   */
  unsetField(field: string): LukeTestConfigureDataConnectorStepExternalFileConnector;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): LukeTestConfigureDataConnectorStepExternalFileConnector;
   ...
   * @see #unsetField
   */
  removeField(field: string): LukeTestConfigureDataConnectorStepExternalFileConnector;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): LukeTestConfigureDataConnectorStepExternalFileConnector;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): LukeTestConfigureDataConnectorStepExternalFileConnector;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): LukeTestConfigureDataConnectorStepExternalFileConnector;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): LukeTestConfigureDataConnectorStepExternalFileConnector;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): LukeTestConfigureDataConnectorStepExternalFileConnector;

  mergeJson(json: any | null): LukeTestConfigureDataConnectorStepExternalFileConnector;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): LukeTestConfigureDataConnectorStepExternalFileConnector;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): LukeTestConfigureDataConnectorStepExternalFileConnector;
   ...
   */
  singletonArray(): C3.Array<LukeTestConfigureDataConnectorStepExternalFileConnector | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<LukeTestConfigureDataConnectorStepExternalFileConnector | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<LukeTestConfigureDataConnectorStepExternalFileConnector | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<LukeTestConfigureDataConnectorStepExternalFileConnector | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<LukeTestConfigureDataConnectorStepExternalFileConnector | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, LukeTestConfigureDataConnectorStepExternalFileConnector | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, LukeTestConfigureDataConnectorStepExternalFileConnector | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<LukeTestConfigureDataConnectorStepExternalFileConnector | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<LukeTestConfigureDataConnectorStepExternalFileConnector | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): LukeTestConfigureDataConnectorStepExternalFileConnector;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): LukeTestConfigureDataConnectorStepExternalFileConnector;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): LukeTestConfigureDataConnectorStepExternalFileConnector;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): LukeTestConfigureDataConnectorStepExternalFileConnector;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): LukeTestConfigureDataConnectorStepExternalFileConnector;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): LukeTestConfigureDataConnectorStepExternalFileConnector;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): LukeTestConfigureDataConnectorStepExternalFileConnector;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): LukeTestConfigureDataConnectorStepExternalFileConnector;
   ...
   */
  static cachedEmptyInst(): LukeTestConfigureDataConnectorStepExternalFileConnector;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<LukeTestConfigureDataConnectorStepExternalFileConnector>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): LukeTestConfigureDataConnectorStepExternalFileConnector;
   ...
   */
  setBucketUrl(bucketUrl?: string | null): void;
}
