// TypeScript definitions for the C3 type LukeTestConfigureDataConnectorStepSapHana

/**
 * The connector type for Sap Hana connectors
 *
 * @remarks this represents a value passed to a method that expects an instance of LukeTestConfigureDataConnectorStepSapHana
 */
declare interface ILukeTestConfigureDataConnectorStepSapHana {
 ...
 */
declare class LukeTestConfigureDataConnectorStepSapHana extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): LukeTestConfigureDataConnectorStepSapHana | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): LukeTestConfigureDataConnectorStepSapHana | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): LukeTestConfigureDataConnectorStepSapHana | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): LukeTestConfigureDataConnectorStepSapHana | null;
   ...
   */
  replaceType(old: Type, new_: Type): LukeTestConfigureDataConnectorStepSapHana;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): LukeTestConfigureDataConnectorStepSapHana;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): LukeTestConfigureDataConnectorStepSapHana;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<LukeTestConfigureDataConnectorStepSapHana | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<LukeTestConfigureDataConnectorStepSapHana | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): LukeTestConfigureDataConnectorStepSapHana;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): LukeTestConfigureDataConnectorStepSapHana;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): LukeTestConfigureDataConnectorStepSapHana;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): LukeTestConfigureDataConnectorStepSapHana;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): LukeTestConfigureDataConnectorStepSapHana;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): LukeTestConfigureDataConnectorStepSapHana;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): LukeTestConfigureDataConnectorStepSapHana;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): LukeTestConfigureDataConnectorStepSapHana;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): LukeTestConfigureDataConnectorStepSapHana;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): LukeTestConfigureDataConnectorStepSapHana;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): LukeTestConfigureDataConnectorStepSapHana;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): LukeTestConfigureDataConnectorStepSapHana;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): LukeTestConfigureDataConnectorStepSapHana;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): LukeTestConfigureDataConnectorStepSapHana;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): LukeTestConfigureDataConnectorStepSapHana;
   ...
   * @see #unsetField
   */
  defaultField(field: string): LukeTestConfigureDataConnectorStepSapHana;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): LukeTestConfigureDataConnectorStepSapHana;
   ...
   * @see #removeField
   */
  unsetField(field: string): LukeTestConfigureDataConnectorStepSapHana;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): LukeTestConfigureDataConnectorStepSapHana;
   ...
   * @see #unsetField
   */
  removeField(field: string): LukeTestConfigureDataConnectorStepSapHana;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): LukeTestConfigureDataConnectorStepSapHana;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): LukeTestConfigureDataConnectorStepSapHana;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): LukeTestConfigureDataConnectorStepSapHana;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): LukeTestConfigureDataConnectorStepSapHana;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): LukeTestConfigureDataConnectorStepSapHana;

  mergeJson(json: any | null): LukeTestConfigureDataConnectorStepSapHana;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): LukeTestConfigureDataConnectorStepSapHana;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): LukeTestConfigureDataConnectorStepSapHana;
   ...
   */
  singletonArray(): C3.Array<LukeTestConfigureDataConnectorStepSapHana | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<LukeTestConfigureDataConnectorStepSapHana | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<LukeTestConfigureDataConnectorStepSapHana | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<LukeTestConfigureDataConnectorStepSapHana | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<LukeTestConfigureDataConnectorStepSapHana | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, LukeTestConfigureDataConnectorStepSapHana | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, LukeTestConfigureDataConnectorStepSapHana | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<LukeTestConfigureDataConnectorStepSapHana | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<LukeTestConfigureDataConnectorStepSapHana | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): LukeTestConfigureDataConnectorStepSapHana;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): LukeTestConfigureDataConnectorStepSapHana;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): LukeTestConfigureDataConnectorStepSapHana;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): LukeTestConfigureDataConnectorStepSapHana;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): LukeTestConfigureDataConnectorStepSapHana;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): LukeTestConfigureDataConnectorStepSapHana;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): LukeTestConfigureDataConnectorStepSapHana;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): LukeTestConfigureDataConnectorStepSapHana;
   ...
   */
  static cachedEmptyInst(): LukeTestConfigureDataConnectorStepSapHana;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<LukeTestConfigureDataConnectorStepSapHana>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): LukeTestConfigureDataConnectorStepSapHana;
