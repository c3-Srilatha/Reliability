// TypeScript definitions for the C3 type UnstructuredDINodeReact

/**
 * The react component of type {@link UnstructuredDINode}
 *
 * @remarks this represents a value passed to a method that expects an instance of UnstructuredDINodeReact
 */
declare interface IUnstructuredDINodeReact {
 ...
 */
declare class UnstructuredDINodeReact extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UnstructuredDINodeReact | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UnstructuredDINodeReact | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UnstructuredDINodeReact | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UnstructuredDINodeReact | null;
   ...
   */
  replaceType(old: Type, new_: Type): UnstructuredDINodeReact;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UnstructuredDINodeReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UnstructuredDINodeReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UnstructuredDINodeReact | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UnstructuredDINodeReact | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UnstructuredDINodeReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UnstructuredDINodeReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UnstructuredDINodeReact;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UnstructuredDINodeReact;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UnstructuredDINodeReact;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UnstructuredDINodeReact;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UnstructuredDINodeReact;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UnstructuredDINodeReact;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UnstructuredDINodeReact;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UnstructuredDINodeReact;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UnstructuredDINodeReact;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UnstructuredDINodeReact;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UnstructuredDINodeReact;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UnstructuredDINodeReact;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UnstructuredDINodeReact;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UnstructuredDINodeReact;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UnstructuredDINodeReact;
   ...
   * @see #removeField
   */
  unsetField(field: string): UnstructuredDINodeReact;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UnstructuredDINodeReact;
   ...
   * @see #unsetField
   */
  removeField(field: string): UnstructuredDINodeReact;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UnstructuredDINodeReact;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UnstructuredDINodeReact;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UnstructuredDINodeReact;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UnstructuredDINodeReact;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UnstructuredDINodeReact;

  mergeJson(json: any | null): UnstructuredDINodeReact;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UnstructuredDINodeReact;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UnstructuredDINodeReact;
   ...
   */
  singletonArray(): C3.Array<UnstructuredDINodeReact | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UnstructuredDINodeReact | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UnstructuredDINodeReact | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UnstructuredDINodeReact | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UnstructuredDINodeReact | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UnstructuredDINodeReact | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UnstructuredDINodeReact | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UnstructuredDINodeReact | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UnstructuredDINodeReact | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UnstructuredDINodeReact;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UnstructuredDINodeReact;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UnstructuredDINodeReact;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UnstructuredDINodeReact;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UnstructuredDINodeReact;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UnstructuredDINodeReact;
   ...
   * @see #fromString
   */
  static make(s: string | null): UnstructuredDINodeReact | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UnstructuredDINodeReact;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): UnstructuredDINodeReact;
   ...
   */
  static cachedEmptyInst(): UnstructuredDINodeReact;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UnstructuredDINodeReact>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UnstructuredDINodeReact;
   ...
   */
  static render(props?: UnstructuredDINodeReact | null): void;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<UnstructuredDINodeReact | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<UnstructuredDINodeReact | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<UnstructuredDINodeReact | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<UnstructuredDINodeReact | null> | null>;
   ...
   */
  dependencies(): MetadataDeps<UnstructuredDINodeReact | null>;

  save(subPath?: string | null, contentType?: string | null): UnstructuredDINodeReact;
  ...
  update(srcObj?: UnstructuredDINodeReact | null, spec?: UpsertSpec | null): UnstructuredDINodeReact | null;

  upsert(srcObj?: UnstructuredDINodeReact | null, spec?: UpsertSpec | null): UnstructuredDINodeReact | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): UnstructuredDINodeReact | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string | null, failIfMissing?: boolean): UnstructuredDINodeReact | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: UnstructuredDINodeReact, state: UiSdlReduxState): UnstructuredDINodeReact | null;
