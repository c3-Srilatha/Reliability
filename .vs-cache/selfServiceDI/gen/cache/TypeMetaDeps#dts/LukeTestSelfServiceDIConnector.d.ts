// TypeScript definitions for the C3 type LukeTestSelfServiceDIConnector

/**
 * A base test component for a connector
 *
 * @remarks this represents a value passed to a method that expects an instance of LukeTestSelfServiceDIConnector
 */
declare interface ILukeTestSelfServiceDIConnector {
 ...
 */
declare class LukeTestSelfServiceDIConnector extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): LukeTestSelfServiceDIConnector | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): LukeTestSelfServiceDIConnector | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): LukeTestSelfServiceDIConnector | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): LukeTestSelfServiceDIConnector | null;
   ...
   */
  replaceType(old: Type, new_: Type): LukeTestSelfServiceDIConnector;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): LukeTestSelfServiceDIConnector;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): LukeTestSelfServiceDIConnector;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<LukeTestSelfServiceDIConnector | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<LukeTestSelfServiceDIConnector | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): LukeTestSelfServiceDIConnector;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): LukeTestSelfServiceDIConnector;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): LukeTestSelfServiceDIConnector;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): LukeTestSelfServiceDIConnector;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): LukeTestSelfServiceDIConnector;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): LukeTestSelfServiceDIConnector;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): LukeTestSelfServiceDIConnector;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): LukeTestSelfServiceDIConnector;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): LukeTestSelfServiceDIConnector;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): LukeTestSelfServiceDIConnector;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): LukeTestSelfServiceDIConnector;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): LukeTestSelfServiceDIConnector;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): LukeTestSelfServiceDIConnector;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): LukeTestSelfServiceDIConnector;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): LukeTestSelfServiceDIConnector;
   ...
   * @see #unsetField
   */
  defaultField(field: string): LukeTestSelfServiceDIConnector;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): LukeTestSelfServiceDIConnector;
   ...
   * @see #removeField
   */
  unsetField(field: string): LukeTestSelfServiceDIConnector;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): LukeTestSelfServiceDIConnector;
   ...
   * @see #unsetField
   */
  removeField(field: string): LukeTestSelfServiceDIConnector;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): LukeTestSelfServiceDIConnector;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): LukeTestSelfServiceDIConnector;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): LukeTestSelfServiceDIConnector;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): LukeTestSelfServiceDIConnector;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): LukeTestSelfServiceDIConnector;

  mergeJson(json: any | null): LukeTestSelfServiceDIConnector;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): LukeTestSelfServiceDIConnector;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): LukeTestSelfServiceDIConnector;
   ...
   */
  singletonArray(): C3.Array<LukeTestSelfServiceDIConnector | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<LukeTestSelfServiceDIConnector | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<LukeTestSelfServiceDIConnector | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<LukeTestSelfServiceDIConnector | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<LukeTestSelfServiceDIConnector | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, LukeTestSelfServiceDIConnector | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, LukeTestSelfServiceDIConnector | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<LukeTestSelfServiceDIConnector | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<LukeTestSelfServiceDIConnector | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): LukeTestSelfServiceDIConnector;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): LukeTestSelfServiceDIConnector;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): LukeTestSelfServiceDIConnector;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): LukeTestSelfServiceDIConnector;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): LukeTestSelfServiceDIConnector;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): LukeTestSelfServiceDIConnector;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): LukeTestSelfServiceDIConnector;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): LukeTestSelfServiceDIConnector;
   ...
   */
  static cachedEmptyInst(): LukeTestSelfServiceDIConnector;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<LukeTestSelfServiceDIConnector>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): LukeTestSelfServiceDIConnector;
