// TypeScript definitions for the C3 type LukeTestCsvEditForm

/**
 * A test component for editing csv file settings in the file upload flow
 *
 * @remarks this represents a value passed to a method that expects an instance of LukeTestCsvEditForm
 */
declare interface ILukeTestCsvEditForm {
 ...
 */
declare class LukeTestCsvEditForm extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): LukeTestCsvEditForm | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): LukeTestCsvEditForm | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): LukeTestCsvEditForm | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): LukeTestCsvEditForm | null;
   ...
   */
  replaceType(old: Type, new_: Type): LukeTestCsvEditForm;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): LukeTestCsvEditForm;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): LukeTestCsvEditForm;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<LukeTestCsvEditForm | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<LukeTestCsvEditForm | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): LukeTestCsvEditForm;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): LukeTestCsvEditForm;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): LukeTestCsvEditForm;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): LukeTestCsvEditForm;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): LukeTestCsvEditForm;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): LukeTestCsvEditForm;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): LukeTestCsvEditForm;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): LukeTestCsvEditForm;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): LukeTestCsvEditForm;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): LukeTestCsvEditForm;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): LukeTestCsvEditForm;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): LukeTestCsvEditForm;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): LukeTestCsvEditForm;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): LukeTestCsvEditForm;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): LukeTestCsvEditForm;
   ...
   * @see #unsetField
   */
  defaultField(field: string): LukeTestCsvEditForm;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): LukeTestCsvEditForm;
   ...
   * @see #removeField
   */
  unsetField(field: string): LukeTestCsvEditForm;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): LukeTestCsvEditForm;
   ...
   * @see #unsetField
   */
  removeField(field: string): LukeTestCsvEditForm;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): LukeTestCsvEditForm;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): LukeTestCsvEditForm;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): LukeTestCsvEditForm;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): LukeTestCsvEditForm;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): LukeTestCsvEditForm;

  mergeJson(json: any | null): LukeTestCsvEditForm;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): LukeTestCsvEditForm;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): LukeTestCsvEditForm;
   ...
   */
  singletonArray(): C3.Array<LukeTestCsvEditForm | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<LukeTestCsvEditForm | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<LukeTestCsvEditForm | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<LukeTestCsvEditForm | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<LukeTestCsvEditForm | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, LukeTestCsvEditForm | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, LukeTestCsvEditForm | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<LukeTestCsvEditForm | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<LukeTestCsvEditForm | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): LukeTestCsvEditForm;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): LukeTestCsvEditForm;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): LukeTestCsvEditForm;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): LukeTestCsvEditForm;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): LukeTestCsvEditForm;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): LukeTestCsvEditForm;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): LukeTestCsvEditForm;
   ...
   */
  static cachedEmptyInst(): LukeTestCsvEditForm;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<LukeTestCsvEditForm>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): LukeTestCsvEditForm;
   ...
   */
  setDelimiter(optionName?: string | null, timeout?: number | null): LukeAsyncQueueNode | null;
   ...
   * @returns an {@link LukeAsyncQueueNode} for clicking the dropdown
   */
  setQuote(optionName?: string | null, timeout?: number | null): LukeAsyncQueueNode | null;
   ...
   * @returns an {@link LukeAsyncQueueNode} for clicking the dropdown
   */
  setEscape(optionName?: string | null, timeout?: number | null): LukeAsyncQueueNode | null;
}
