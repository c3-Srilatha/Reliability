// TypeScript definitions for the C3 type MetadataExtractionConfigForm
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of MetadataExtractionConfigForm
 */
declare interface IMetadataExtractionConfigForm {
 ...
 */
declare class MetadataExtractionConfigForm extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): MetadataExtractionConfigForm | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): MetadataExtractionConfigForm | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): MetadataExtractionConfigForm | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): MetadataExtractionConfigForm | null;
   ...
   */
  replaceType(old: Type, new_: Type): MetadataExtractionConfigForm;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): MetadataExtractionConfigForm;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): MetadataExtractionConfigForm;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<MetadataExtractionConfigForm | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<MetadataExtractionConfigForm | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): MetadataExtractionConfigForm;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): MetadataExtractionConfigForm;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): MetadataExtractionConfigForm;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): MetadataExtractionConfigForm;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): MetadataExtractionConfigForm;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): MetadataExtractionConfigForm;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): MetadataExtractionConfigForm;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): MetadataExtractionConfigForm;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): MetadataExtractionConfigForm;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): MetadataExtractionConfigForm;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): MetadataExtractionConfigForm;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): MetadataExtractionConfigForm;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): MetadataExtractionConfigForm;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): MetadataExtractionConfigForm;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): MetadataExtractionConfigForm;
   ...
   * @see #unsetField
   */
  defaultField(field: string): MetadataExtractionConfigForm;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): MetadataExtractionConfigForm;
   ...
   * @see #removeField
   */
  unsetField(field: string): MetadataExtractionConfigForm;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): MetadataExtractionConfigForm;
   ...
   * @see #unsetField
   */
  removeField(field: string): MetadataExtractionConfigForm;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): MetadataExtractionConfigForm;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): MetadataExtractionConfigForm;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): MetadataExtractionConfigForm;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): MetadataExtractionConfigForm;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): MetadataExtractionConfigForm;

  mergeJson(json: any | null): MetadataExtractionConfigForm;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): MetadataExtractionConfigForm;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): MetadataExtractionConfigForm;
   ...
   */
  singletonArray(): C3.Array<MetadataExtractionConfigForm | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<MetadataExtractionConfigForm | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<MetadataExtractionConfigForm | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<MetadataExtractionConfigForm | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<MetadataExtractionConfigForm | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, MetadataExtractionConfigForm | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, MetadataExtractionConfigForm | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<MetadataExtractionConfigForm | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<MetadataExtractionConfigForm | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): MetadataExtractionConfigForm;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): MetadataExtractionConfigForm;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): MetadataExtractionConfigForm;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): MetadataExtractionConfigForm;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): MetadataExtractionConfigForm;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): MetadataExtractionConfigForm;
   ...
   * @see #fromString
   */
  static make(s: string | null): MetadataExtractionConfigForm | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): MetadataExtractionConfigForm;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): MetadataExtractionConfigForm;
   ...
   */
  static cachedEmptyInst(): MetadataExtractionConfigForm;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<MetadataExtractionConfigForm>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): MetadataExtractionConfigForm;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<MetadataExtractionConfigForm | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<MetadataExtractionConfigForm | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<MetadataExtractionConfigForm | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<MetadataExtractionConfigForm | null> | null>;
   ...
   */
  dependencies(): MetadataDeps<MetadataExtractionConfigForm | null>;

  save(subPath?: string | null, contentType?: string | null): MetadataExtractionConfigForm;
  ...
  update(srcObj?: MetadataExtractionConfigForm | null, spec?: UpsertSpec | null): MetadataExtractionConfigForm | null;

  upsert(srcObj?: MetadataExtractionConfigForm | null, spec?: UpsertSpec | null): MetadataExtractionConfigForm | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): MetadataExtractionConfigForm | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string | null, failIfMissing?: boolean): MetadataExtractionConfigForm | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: MetadataExtractionConfigForm, state: UiSdlReduxState): MetadataExtractionConfigForm | null;
