// TypeScript definitions for the C3 type SourceTargetNodeAdderEdgeReact

/**
 * The react component of type {@link SourceTargetNodeAdderEdge}
 *
 * @remarks this represents a value passed to a method that expects an instance of SourceTargetNodeAdderEdgeReact
 */
declare interface ISourceTargetNodeAdderEdgeReact {
   ...
   */
  data?: ISourceTargetNodeAdderEdge | null;
}
 ...
 */
declare class SourceTargetNodeAdderEdgeReact extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): SourceTargetNodeAdderEdgeReact | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): SourceTargetNodeAdderEdgeReact | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): SourceTargetNodeAdderEdgeReact | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): SourceTargetNodeAdderEdgeReact | null;
   ...
   */
  replaceType(old: Type, new_: Type): SourceTargetNodeAdderEdgeReact;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): SourceTargetNodeAdderEdgeReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): SourceTargetNodeAdderEdgeReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<SourceTargetNodeAdderEdgeReact | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<SourceTargetNodeAdderEdgeReact | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): SourceTargetNodeAdderEdgeReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SourceTargetNodeAdderEdgeReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SourceTargetNodeAdderEdgeReact;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): SourceTargetNodeAdderEdgeReact;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): SourceTargetNodeAdderEdgeReact;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): SourceTargetNodeAdderEdgeReact;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): SourceTargetNodeAdderEdgeReact;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): SourceTargetNodeAdderEdgeReact;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): SourceTargetNodeAdderEdgeReact;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): SourceTargetNodeAdderEdgeReact;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): SourceTargetNodeAdderEdgeReact;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): SourceTargetNodeAdderEdgeReact;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): SourceTargetNodeAdderEdgeReact;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): SourceTargetNodeAdderEdgeReact;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): SourceTargetNodeAdderEdgeReact;
   ...
   * @see #unsetField
   */
  defaultField(field: string): SourceTargetNodeAdderEdgeReact;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): SourceTargetNodeAdderEdgeReact;
   ...
   * @see #removeField
   */
  unsetField(field: string): SourceTargetNodeAdderEdgeReact;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): SourceTargetNodeAdderEdgeReact;
   ...
   * @see #unsetField
   */
  removeField(field: string): SourceTargetNodeAdderEdgeReact;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): SourceTargetNodeAdderEdgeReact;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): SourceTargetNodeAdderEdgeReact;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): SourceTargetNodeAdderEdgeReact;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): SourceTargetNodeAdderEdgeReact;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): SourceTargetNodeAdderEdgeReact;

  mergeJson(json: any | null): SourceTargetNodeAdderEdgeReact;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): SourceTargetNodeAdderEdgeReact;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): SourceTargetNodeAdderEdgeReact;
   ...
   */
  singletonArray(): C3.Array<SourceTargetNodeAdderEdgeReact | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<SourceTargetNodeAdderEdgeReact | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<SourceTargetNodeAdderEdgeReact | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<SourceTargetNodeAdderEdgeReact | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<SourceTargetNodeAdderEdgeReact | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, SourceTargetNodeAdderEdgeReact | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, SourceTargetNodeAdderEdgeReact | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<SourceTargetNodeAdderEdgeReact | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<SourceTargetNodeAdderEdgeReact | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): SourceTargetNodeAdderEdgeReact;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): SourceTargetNodeAdderEdgeReact;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): SourceTargetNodeAdderEdgeReact;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): SourceTargetNodeAdderEdgeReact;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): SourceTargetNodeAdderEdgeReact;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): SourceTargetNodeAdderEdgeReact;
   ...
   * @see #fromString
   */
  static make(s: string | null): SourceTargetNodeAdderEdgeReact | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): SourceTargetNodeAdderEdgeReact;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): SourceTargetNodeAdderEdgeReact;
   ...
   */
  static cachedEmptyInst(): SourceTargetNodeAdderEdgeReact;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<SourceTargetNodeAdderEdgeReact>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): SourceTargetNodeAdderEdgeReact;
   ...
   */
  static render(props?: SourceTargetNodeAdderEdgeReact | null): void;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<SourceTargetNodeAdderEdgeReact | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<SourceTargetNodeAdderEdgeReact | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<SourceTargetNodeAdderEdgeReact | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<SourceTargetNodeAdderEdgeReact | null> | null>;
   ...
   */
  dependencies(): MetadataDeps<SourceTargetNodeAdderEdgeReact | null>;

  save(subPath?: string | null, contentType?: string | null): SourceTargetNodeAdderEdgeReact;
  ...
  update(srcObj?: SourceTargetNodeAdderEdgeReact | null, spec?: UpsertSpec | null): SourceTargetNodeAdderEdgeReact | null;

  upsert(srcObj?: SourceTargetNodeAdderEdgeReact | null, spec?: UpsertSpec | null): SourceTargetNodeAdderEdgeReact | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): SourceTargetNodeAdderEdgeReact | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string | null, failIfMissing?: boolean): SourceTargetNodeAdderEdgeReact | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: SourceTargetNodeAdderEdgeReact, state: UiSdlReduxState): SourceTargetNodeAdderEdgeReact | null;
