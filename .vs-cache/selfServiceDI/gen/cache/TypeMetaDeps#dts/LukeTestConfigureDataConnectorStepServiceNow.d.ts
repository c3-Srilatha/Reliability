// TypeScript definitions for the C3 type LukeTestConfigureDataConnectorStepServiceNow

/**
 * The connector type for Service Now connectors
 *
 * @remarks this represents a value passed to a method that expects an instance of LukeTestConfigureDataConnectorStepServiceNow
 */
declare interface ILukeTestConfigureDataConnectorStepServiceNow {
 ...
 * The connector type for Service Now connectors
 *
 * @remarks this represents a made instance of LukeTestConfigureDataConnectorStepServiceNow
 */
declare class LukeTestConfigureDataConnectorStepServiceNow extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): LukeTestConfigureDataConnectorStepServiceNow | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): LukeTestConfigureDataConnectorStepServiceNow | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): LukeTestConfigureDataConnectorStepServiceNow | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): LukeTestConfigureDataConnectorStepServiceNow | null;
   ...
   */
  replaceType(old: Type, new_: Type): LukeTestConfigureDataConnectorStepServiceNow;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): LukeTestConfigureDataConnectorStepServiceNow;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): LukeTestConfigureDataConnectorStepServiceNow;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<LukeTestConfigureDataConnectorStepServiceNow | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<LukeTestConfigureDataConnectorStepServiceNow | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): LukeTestConfigureDataConnectorStepServiceNow;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): LukeTestConfigureDataConnectorStepServiceNow;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): LukeTestConfigureDataConnectorStepServiceNow;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): LukeTestConfigureDataConnectorStepServiceNow;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): LukeTestConfigureDataConnectorStepServiceNow;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): LukeTestConfigureDataConnectorStepServiceNow;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): LukeTestConfigureDataConnectorStepServiceNow;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): LukeTestConfigureDataConnectorStepServiceNow;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): LukeTestConfigureDataConnectorStepServiceNow;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): LukeTestConfigureDataConnectorStepServiceNow;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): LukeTestConfigureDataConnectorStepServiceNow;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): LukeTestConfigureDataConnectorStepServiceNow;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): LukeTestConfigureDataConnectorStepServiceNow;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): LukeTestConfigureDataConnectorStepServiceNow;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): LukeTestConfigureDataConnectorStepServiceNow;
   ...
   * @see #unsetField
   */
  defaultField(field: string): LukeTestConfigureDataConnectorStepServiceNow;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): LukeTestConfigureDataConnectorStepServiceNow;
   ...
   * @see #removeField
   */
  unsetField(field: string): LukeTestConfigureDataConnectorStepServiceNow;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): LukeTestConfigureDataConnectorStepServiceNow;
   ...
   * @see #unsetField
   */
  removeField(field: string): LukeTestConfigureDataConnectorStepServiceNow;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): LukeTestConfigureDataConnectorStepServiceNow;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): LukeTestConfigureDataConnectorStepServiceNow;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): LukeTestConfigureDataConnectorStepServiceNow;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): LukeTestConfigureDataConnectorStepServiceNow;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): LukeTestConfigureDataConnectorStepServiceNow;

  mergeJson(json: any | null): LukeTestConfigureDataConnectorStepServiceNow;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): LukeTestConfigureDataConnectorStepServiceNow;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): LukeTestConfigureDataConnectorStepServiceNow;
   ...
   */
  singletonArray(): C3.Array<LukeTestConfigureDataConnectorStepServiceNow | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<LukeTestConfigureDataConnectorStepServiceNow | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<LukeTestConfigureDataConnectorStepServiceNow | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<LukeTestConfigureDataConnectorStepServiceNow | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<LukeTestConfigureDataConnectorStepServiceNow | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, LukeTestConfigureDataConnectorStepServiceNow | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, LukeTestConfigureDataConnectorStepServiceNow | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<LukeTestConfigureDataConnectorStepServiceNow | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<LukeTestConfigureDataConnectorStepServiceNow | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): LukeTestConfigureDataConnectorStepServiceNow;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): LukeTestConfigureDataConnectorStepServiceNow;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): LukeTestConfigureDataConnectorStepServiceNow;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): LukeTestConfigureDataConnectorStepServiceNow;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): LukeTestConfigureDataConnectorStepServiceNow;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): LukeTestConfigureDataConnectorStepServiceNow;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): LukeTestConfigureDataConnectorStepServiceNow;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): LukeTestConfigureDataConnectorStepServiceNow;
   ...
   */
  static cachedEmptyInst(): LukeTestConfigureDataConnectorStepServiceNow;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<LukeTestConfigureDataConnectorStepServiceNow>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): LukeTestConfigureDataConnectorStepServiceNow;
