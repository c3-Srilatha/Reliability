// TypeScript definitions for the C3 type TransformNodeReact

/**
 * @remarks this represents a value passed to a method that expects an instance of TransformNodeReact
 */
declare interface ITransformNodeReact {
   ...
   */
  data?: ITransformNode | null;
}

/**
 * @remarks this represents a made instance of TransformNodeReact
 */
declare class TransformNodeReact extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): TransformNodeReact | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): TransformNodeReact | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): TransformNodeReact | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): TransformNodeReact | null;
   ...
   */
  replaceType(old: Type, new_: Type): TransformNodeReact;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TransformNodeReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TransformNodeReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TransformNodeReact | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TransformNodeReact | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): TransformNodeReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TransformNodeReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TransformNodeReact;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): TransformNodeReact;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): TransformNodeReact;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): TransformNodeReact;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): TransformNodeReact;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): TransformNodeReact;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): TransformNodeReact;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): TransformNodeReact;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): TransformNodeReact;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): TransformNodeReact;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): TransformNodeReact;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): TransformNodeReact;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): TransformNodeReact;
   ...
   * @see #unsetField
   */
  defaultField(field: string): TransformNodeReact;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): TransformNodeReact;
   ...
   * @see #removeField
   */
  unsetField(field: string): TransformNodeReact;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): TransformNodeReact;
   ...
   * @see #unsetField
   */
  removeField(field: string): TransformNodeReact;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): TransformNodeReact;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): TransformNodeReact;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): TransformNodeReact;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): TransformNodeReact;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): TransformNodeReact;

  mergeJson(json: any | null): TransformNodeReact;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): TransformNodeReact;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): TransformNodeReact;
   ...
   */
  singletonArray(): C3.Array<TransformNodeReact | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<TransformNodeReact | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<TransformNodeReact | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<TransformNodeReact | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<TransformNodeReact | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, TransformNodeReact | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, TransformNodeReact | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<TransformNodeReact | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<TransformNodeReact | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): TransformNodeReact;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): TransformNodeReact;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): TransformNodeReact;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): TransformNodeReact;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): TransformNodeReact;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): TransformNodeReact;
   ...
   * @see #fromString
   */
  static make(s: string | null): TransformNodeReact | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): TransformNodeReact;
   ...
   */
  static cachedEmptyInst(): TransformNodeReact;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<TransformNodeReact>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): TransformNodeReact;
   ...
   */
  static render(props?: TransformNodeReact | null): void;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<TransformNodeReact | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<TransformNodeReact | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<TransformNodeReact | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<TransformNodeReact | null> | null>;
   ...
   */
  dependencies(): MetadataDeps<TransformNodeReact | null>;

  save(subPath?: string | null, contentType?: string | null): TransformNodeReact;
  ...
  update(srcObj?: TransformNodeReact | null, spec?: UpsertSpec | null): TransformNodeReact | null;

  upsert(srcObj?: TransformNodeReact | null, spec?: UpsertSpec | null): TransformNodeReact | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): TransformNodeReact | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string | null, failIfMissing?: boolean): TransformNodeReact | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: TransformNodeReact, state: UiSdlReduxState): TransformNodeReact | null;
