// TypeScript definitions for the C3 type SourceFieldNodeReact

/**
 * React renderer for {@link SourceFieldNodeReact}
 *
 * @remarks this represents a value passed to a method that expects an instance of SourceFieldNodeReact
 */
declare interface ISourceFieldNodeReact {
 ...
 */
declare class SourceFieldNodeReact extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): SourceFieldNodeReact | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): SourceFieldNodeReact | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): SourceFieldNodeReact | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): SourceFieldNodeReact | null;
   ...
   */
  replaceType(old: Type, new_: Type): SourceFieldNodeReact;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): SourceFieldNodeReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): SourceFieldNodeReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<SourceFieldNodeReact | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<SourceFieldNodeReact | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): SourceFieldNodeReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SourceFieldNodeReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SourceFieldNodeReact;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): SourceFieldNodeReact;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): SourceFieldNodeReact;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): SourceFieldNodeReact;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): SourceFieldNodeReact;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): SourceFieldNodeReact;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): SourceFieldNodeReact;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): SourceFieldNodeReact;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): SourceFieldNodeReact;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): SourceFieldNodeReact;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): SourceFieldNodeReact;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): SourceFieldNodeReact;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): SourceFieldNodeReact;
   ...
   * @see #unsetField
   */
  defaultField(field: string): SourceFieldNodeReact;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): SourceFieldNodeReact;
   ...
   * @see #removeField
   */
  unsetField(field: string): SourceFieldNodeReact;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): SourceFieldNodeReact;
   ...
   * @see #unsetField
   */
  removeField(field: string): SourceFieldNodeReact;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): SourceFieldNodeReact;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): SourceFieldNodeReact;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): SourceFieldNodeReact;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): SourceFieldNodeReact;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): SourceFieldNodeReact;

  mergeJson(json: any | null): SourceFieldNodeReact;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): SourceFieldNodeReact;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): SourceFieldNodeReact;
   ...
   */
  singletonArray(): C3.Array<SourceFieldNodeReact | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<SourceFieldNodeReact | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<SourceFieldNodeReact | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<SourceFieldNodeReact | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<SourceFieldNodeReact | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, SourceFieldNodeReact | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, SourceFieldNodeReact | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<SourceFieldNodeReact | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<SourceFieldNodeReact | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): SourceFieldNodeReact;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): SourceFieldNodeReact;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): SourceFieldNodeReact;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): SourceFieldNodeReact;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): SourceFieldNodeReact;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): SourceFieldNodeReact;
   ...
   * @see #fromString
   */
  static make(s: string | null): SourceFieldNodeReact | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): SourceFieldNodeReact;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): SourceFieldNodeReact;
   ...
   */
  static cachedEmptyInst(): SourceFieldNodeReact;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<SourceFieldNodeReact>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): SourceFieldNodeReact;
   ...
   */
  static render(props?: SourceFieldNodeReact | null): void;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<SourceFieldNodeReact | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<SourceFieldNodeReact | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<SourceFieldNodeReact | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<SourceFieldNodeReact | null> | null>;
   ...
   */
  dependencies(): MetadataDeps<SourceFieldNodeReact | null>;

  save(subPath?: string | null, contentType?: string | null): SourceFieldNodeReact;
  ...
  update(srcObj?: SourceFieldNodeReact | null, spec?: UpsertSpec | null): SourceFieldNodeReact | null;

  upsert(srcObj?: SourceFieldNodeReact | null, spec?: UpsertSpec | null): SourceFieldNodeReact | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): SourceFieldNodeReact | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string | null, failIfMissing?: boolean): SourceFieldNodeReact | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: SourceFieldNodeReact, state: UiSdlReduxState): SourceFieldNodeReact | null;
