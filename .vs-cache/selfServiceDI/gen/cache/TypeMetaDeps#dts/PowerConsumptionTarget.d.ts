// TypeScript definitions for the C3 type PowerConsumptionTarget

/**
 * Enter the Type purposes and use cases with code examples.
 *
 * @remarks this represents a value passed to a method that expects an instance of PowerConsumptionTarget
 */
declare interface IPowerConsumptionTarget {
  ...
  dateTime?: DateTime | Date | string | null;
  ...
  generalDiffuseFlows?: number | null;

  diffuseFlows?: string | null;

  powerConsumptionZone1?: number | null;

  powerConsumptionZone2?: number | null;

  powerConsumptionZone3?: number | null;
}
 ...
 */
declare class PowerConsumptionTarget extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): PowerConsumptionTarget | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): PowerConsumptionTarget | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): PowerConsumptionTarget | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): PowerConsumptionTarget | null;
   ...
   */
  replaceType(old: Type, new_: Type): PowerConsumptionTarget;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): PowerConsumptionTarget;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): PowerConsumptionTarget;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<PowerConsumptionTarget | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<PowerConsumptionTarget | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): PowerConsumptionTarget;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): PowerConsumptionTarget;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): PowerConsumptionTarget;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): PowerConsumptionTarget;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): PowerConsumptionTarget;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): PowerConsumptionTarget;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): PowerConsumptionTarget;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): PowerConsumptionTarget;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): PowerConsumptionTarget;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): PowerConsumptionTarget;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): PowerConsumptionTarget;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): PowerConsumptionTarget;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): PowerConsumptionTarget;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): PowerConsumptionTarget;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): PowerConsumptionTarget;
   ...
   * @see #unsetField
   */
  defaultField(field: string): PowerConsumptionTarget;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): PowerConsumptionTarget;
   ...
   * @see #removeField
   */
  unsetField(field: string): PowerConsumptionTarget;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): PowerConsumptionTarget;
   ...
   * @see #unsetField
   */
  removeField(field: string): PowerConsumptionTarget;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): PowerConsumptionTarget;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): PowerConsumptionTarget;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): PowerConsumptionTarget;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): PowerConsumptionTarget;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): PowerConsumptionTarget;

  mergeJson(json: any | null): PowerConsumptionTarget;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): PowerConsumptionTarget;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): PowerConsumptionTarget;
   ...
   */
  singletonArray(): C3.Array<PowerConsumptionTarget | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<PowerConsumptionTarget | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<PowerConsumptionTarget | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<PowerConsumptionTarget | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<PowerConsumptionTarget | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, PowerConsumptionTarget | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, PowerConsumptionTarget | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<PowerConsumptionTarget | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<PowerConsumptionTarget | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): PowerConsumptionTarget;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): PowerConsumptionTarget;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): PowerConsumptionTarget;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): PowerConsumptionTarget;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): PowerConsumptionTarget;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): PowerConsumptionTarget;
   ...
   * @see #fromString
   */
  static make(s: string | null): PowerConsumptionTarget | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): PowerConsumptionTarget;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): PowerConsumptionTarget;
   ...
   */
  static cachedEmptyInst(): PowerConsumptionTarget;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<PowerConsumptionTarget>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): PowerConsumptionTarget;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<PowerConsumptionTarget | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<PowerConsumptionTarget | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<PowerConsumptionTarget | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<PowerConsumptionTarget | null> | null>;
   ...
   */
  get(include?: string | null): PowerConsumptionTarget | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): PowerConsumptionTarget | null;
   ...
   */
  getMissing(spec: GetMissingSpec): PowerConsumptionTarget;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): PowerConsumptionTarget | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): PowerConsumptionTarget;
   ...
   * @see #toString
   */
  static fromString(s: string | null): PowerConsumptionTarget | null;
   ...
   */
  create(spec?: UpsertSpec | null): PowerConsumptionTarget | null;
   ...
   */
  static createBatch(objs: C3.Array<PowerConsumptionTarget | null> | null, spec?: UpsertSpec | null): ObjList<PowerConsumptionTarget | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<PowerConsumptionTarget | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<PowerConsumptionTarget | null> | null;
   ...
   */
  update(srcObj?: PowerConsumptionTarget | null, spec?: UpsertSpec | null): PowerConsumptionTarget | null;
   ...
   */
  upsert(srcObj?: PowerConsumptionTarget | null, spec?: UpsertSpec | null): PowerConsumptionTarget | null;
   ...
   */
  merge(spec?: MergeSpec | null): PowerConsumptionTarget | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): PowerConsumptionTarget | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): PowerConsumptionTarget | null;
   ...
   */
  static updateBatch(objs: C3.Array<PowerConsumptionTarget | null> | null, srcObjs?: C3.Array<PowerConsumptionTarget | null>, spec?: UpsertSpec | null): ObjList<PowerConsumptionTarget | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<PowerConsumptionTarget | null>>, spec?: UpsertSpec | null): ObjList<PowerConsumptionTarget | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<PowerConsumptionTarget | null> | null, srcObjs?: C3.Array<PowerConsumptionTarget | null>, spec?: UpsertSpec | null): ObjList<PowerConsumptionTarget | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<PowerConsumptionTarget | null>>, spec?: UpsertSpec | null): ObjList<PowerConsumptionTarget | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<PowerConsumptionTarget | null> | null, spec?: TouchSpec | null): ObjList<PowerConsumptionTarget | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<PowerConsumptionTarget | null> | null, spec?: MergeSpec | null): ObjList<PowerConsumptionTarget | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<PowerConsumptionTarget | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<PowerConsumptionTarget | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<PowerConsumptionTarget | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<PowerConsumptionTarget | null> | null;
   ...
   */
  static mergeAll(mergeObj: PowerConsumptionTarget | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: PowerConsumptionTarget | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<PowerConsumptionTarget | null> | null, spec?: UpsertSpec | null): ObjList<PowerConsumptionTarget | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<PowerConsumptionTarget | null> | null, spec?: UpsertSpec | null): ObjList<PowerConsumptionTarget | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): PowerConsumptionTarget | null;
   ...
   */
  static beforeCreate(objs: C3.Array<PowerConsumptionTarget | null> | null): ObjList<PowerConsumptionTarget | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<PowerConsumptionTarget | null> | null): ObjList<PowerConsumptionTarget | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<PowerConsumptionTarget | null> | null): ObjList<PowerConsumptionTarget | null>;
   ...
   */
  static afterCreate(objs: C3.Array<PowerConsumptionTarget | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<PowerConsumptionTarget | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<PowerConsumptionTarget | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<PowerConsumptionTarget | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<PowerConsumptionTarget | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): PowerConsumptionTarget | null;
   ...
   */
  withoutIdentity(): PowerConsumptionTarget | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<PowerConsumptionTarget | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: PowerConsumptionTarget | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<PowerConsumptionTarget | null> | null, callback?: λFunction<PowerConsumptionTarget | null, PowerConsumptionTarget | null> | null): ObjList<PowerConsumptionTarget | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<PowerConsumptionTarget | null> | null, callback?: λFunction<PowerConsumptionTarget | null, PowerConsumptionTarget | null> | null): C3.Array<ObjError | null>;
