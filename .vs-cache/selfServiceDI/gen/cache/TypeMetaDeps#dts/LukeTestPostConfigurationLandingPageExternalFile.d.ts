// TypeScript definitions for the C3 type LukeTestPostConfigurationLandingPageExternalFile

/**
 * The Post Configuration Landing Page type for External File
 *
 * @remarks this represents a value passed to a method that expects an instance of LukeTestPostConfigurationLandingPageExternalFile
 */
declare interface ILukeTestPostConfigurationLandingPageExternalFile {
   ...
   */
  presentationalTreeView?: ILukeTestPresentationalTreeView | null;

  /**
   * The selector for the connection configuration modal
   */
  connectionConfigurationModalSelector?: string | null;

  /**
   * The selector for the connection configuration modal close button
   */
  connectionConfigurationXSelector?: string | null;

  /**
   * List of all the headers of the bucket details on external file landing page
   */
  bucketDetailsHeaders?: C3.Array<string | null> | Array<string | null>;

  /**
   * The selector for the Estimate button
   */
  externalFileEstimateButtonSelector?: string | null;

  /**
   * The selector for the Connection properties button
   */
  externalFileConnectionPropertiesButtonSelector?: string | null;
}
 ...
 */
declare class LukeTestPostConfigurationLandingPageExternalFile extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): LukeTestPostConfigurationLandingPageExternalFile | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): LukeTestPostConfigurationLandingPageExternalFile | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): LukeTestPostConfigurationLandingPageExternalFile | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): LukeTestPostConfigurationLandingPageExternalFile | null;
   ...
   */
  replaceType(old: Type, new_: Type): LukeTestPostConfigurationLandingPageExternalFile;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): LukeTestPostConfigurationLandingPageExternalFile;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): LukeTestPostConfigurationLandingPageExternalFile;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<LukeTestPostConfigurationLandingPageExternalFile | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<LukeTestPostConfigurationLandingPageExternalFile | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): LukeTestPostConfigurationLandingPageExternalFile;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): LukeTestPostConfigurationLandingPageExternalFile;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): LukeTestPostConfigurationLandingPageExternalFile;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): LukeTestPostConfigurationLandingPageExternalFile;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): LukeTestPostConfigurationLandingPageExternalFile;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): LukeTestPostConfigurationLandingPageExternalFile;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): LukeTestPostConfigurationLandingPageExternalFile;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): LukeTestPostConfigurationLandingPageExternalFile;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): LukeTestPostConfigurationLandingPageExternalFile;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): LukeTestPostConfigurationLandingPageExternalFile;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): LukeTestPostConfigurationLandingPageExternalFile;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): LukeTestPostConfigurationLandingPageExternalFile;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): LukeTestPostConfigurationLandingPageExternalFile;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): LukeTestPostConfigurationLandingPageExternalFile;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): LukeTestPostConfigurationLandingPageExternalFile;
   ...
   * @see #unsetField
   */
  defaultField(field: string): LukeTestPostConfigurationLandingPageExternalFile;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): LukeTestPostConfigurationLandingPageExternalFile;
   ...
   * @see #removeField
   */
  unsetField(field: string): LukeTestPostConfigurationLandingPageExternalFile;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): LukeTestPostConfigurationLandingPageExternalFile;
   ...
   * @see #unsetField
   */
  removeField(field: string): LukeTestPostConfigurationLandingPageExternalFile;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): LukeTestPostConfigurationLandingPageExternalFile;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): LukeTestPostConfigurationLandingPageExternalFile;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): LukeTestPostConfigurationLandingPageExternalFile;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): LukeTestPostConfigurationLandingPageExternalFile;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): LukeTestPostConfigurationLandingPageExternalFile;

  mergeJson(json: any | null): LukeTestPostConfigurationLandingPageExternalFile;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): LukeTestPostConfigurationLandingPageExternalFile;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): LukeTestPostConfigurationLandingPageExternalFile;
   ...
   */
  singletonArray(): C3.Array<LukeTestPostConfigurationLandingPageExternalFile | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<LukeTestPostConfigurationLandingPageExternalFile | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<LukeTestPostConfigurationLandingPageExternalFile | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<LukeTestPostConfigurationLandingPageExternalFile | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<LukeTestPostConfigurationLandingPageExternalFile | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, LukeTestPostConfigurationLandingPageExternalFile | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, LukeTestPostConfigurationLandingPageExternalFile | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<LukeTestPostConfigurationLandingPageExternalFile | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<LukeTestPostConfigurationLandingPageExternalFile | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): LukeTestPostConfigurationLandingPageExternalFile;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): LukeTestPostConfigurationLandingPageExternalFile;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): LukeTestPostConfigurationLandingPageExternalFile;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): LukeTestPostConfigurationLandingPageExternalFile;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): LukeTestPostConfigurationLandingPageExternalFile;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): LukeTestPostConfigurationLandingPageExternalFile;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): LukeTestPostConfigurationLandingPageExternalFile;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): LukeTestPostConfigurationLandingPageExternalFile;
   ...
   */
  static cachedEmptyInst(): LukeTestPostConfigurationLandingPageExternalFile;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<LukeTestPostConfigurationLandingPageExternalFile>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): LukeTestPostConfigurationLandingPageExternalFile;
   ...
   */
  static createInstance(connector: any, lukeBrowserInstance?: LukeBrowser | null): LukeTestPostConfigurationLandingPage | null;
}
