// TypeScript definitions for the C3 type LukeTestPostConfigurationLandingPageKafka

/**
 * The Post Configuration Landing Page type for Kafka
 *
 * @remarks this represents a value passed to a method that expects an instance of LukeTestPostConfigurationLandingPageKafka
 */
declare interface ILukeTestPostConfigurationLandingPageKafka {
 ...
 */
declare class LukeTestPostConfigurationLandingPageKafka extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): LukeTestPostConfigurationLandingPageKafka | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): LukeTestPostConfigurationLandingPageKafka | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): LukeTestPostConfigurationLandingPageKafka | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): LukeTestPostConfigurationLandingPageKafka | null;
   ...
   */
  replaceType(old: Type, new_: Type): LukeTestPostConfigurationLandingPageKafka;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): LukeTestPostConfigurationLandingPageKafka;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): LukeTestPostConfigurationLandingPageKafka;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<LukeTestPostConfigurationLandingPageKafka | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<LukeTestPostConfigurationLandingPageKafka | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): LukeTestPostConfigurationLandingPageKafka;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): LukeTestPostConfigurationLandingPageKafka;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): LukeTestPostConfigurationLandingPageKafka;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): LukeTestPostConfigurationLandingPageKafka;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): LukeTestPostConfigurationLandingPageKafka;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): LukeTestPostConfigurationLandingPageKafka;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): LukeTestPostConfigurationLandingPageKafka;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): LukeTestPostConfigurationLandingPageKafka;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): LukeTestPostConfigurationLandingPageKafka;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): LukeTestPostConfigurationLandingPageKafka;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): LukeTestPostConfigurationLandingPageKafka;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): LukeTestPostConfigurationLandingPageKafka;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): LukeTestPostConfigurationLandingPageKafka;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): LukeTestPostConfigurationLandingPageKafka;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): LukeTestPostConfigurationLandingPageKafka;
   ...
   * @see #unsetField
   */
  defaultField(field: string): LukeTestPostConfigurationLandingPageKafka;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): LukeTestPostConfigurationLandingPageKafka;
   ...
   * @see #removeField
   */
  unsetField(field: string): LukeTestPostConfigurationLandingPageKafka;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): LukeTestPostConfigurationLandingPageKafka;
   ...
   * @see #unsetField
   */
  removeField(field: string): LukeTestPostConfigurationLandingPageKafka;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): LukeTestPostConfigurationLandingPageKafka;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): LukeTestPostConfigurationLandingPageKafka;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): LukeTestPostConfigurationLandingPageKafka;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): LukeTestPostConfigurationLandingPageKafka;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): LukeTestPostConfigurationLandingPageKafka;

  mergeJson(json: any | null): LukeTestPostConfigurationLandingPageKafka;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): LukeTestPostConfigurationLandingPageKafka;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): LukeTestPostConfigurationLandingPageKafka;
   ...
   */
  singletonArray(): C3.Array<LukeTestPostConfigurationLandingPageKafka | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<LukeTestPostConfigurationLandingPageKafka | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<LukeTestPostConfigurationLandingPageKafka | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<LukeTestPostConfigurationLandingPageKafka | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<LukeTestPostConfigurationLandingPageKafka | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, LukeTestPostConfigurationLandingPageKafka | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, LukeTestPostConfigurationLandingPageKafka | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<LukeTestPostConfigurationLandingPageKafka | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<LukeTestPostConfigurationLandingPageKafka | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): LukeTestPostConfigurationLandingPageKafka;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): LukeTestPostConfigurationLandingPageKafka;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): LukeTestPostConfigurationLandingPageKafka;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): LukeTestPostConfigurationLandingPageKafka;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): LukeTestPostConfigurationLandingPageKafka;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): LukeTestPostConfigurationLandingPageKafka;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): LukeTestPostConfigurationLandingPageKafka;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): LukeTestPostConfigurationLandingPageKafka;
   ...
   */
  static cachedEmptyInst(): LukeTestPostConfigurationLandingPageKafka;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<LukeTestPostConfigurationLandingPageKafka>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): LukeTestPostConfigurationLandingPageKafka;
