// TypeScript definitions for the C3 type TransformDesignerNodeDiagramGroupReact

/**
 * @remarks this represents a value passed to a method that expects an instance of TransformDesignerNodeDiagramGroupReact
 */
declare interface ITransformDesignerNodeDiagramGroupReact {
   ...
   */
  data?: INodeDiagramGroup | null;
}

/**
 * @remarks this represents a made instance of TransformDesignerNodeDiagramGroupReact
 */
declare class TransformDesignerNodeDiagramGroupReact extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): TransformDesignerNodeDiagramGroupReact | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): TransformDesignerNodeDiagramGroupReact | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): TransformDesignerNodeDiagramGroupReact | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): TransformDesignerNodeDiagramGroupReact | null;
   ...
   */
  replaceType(old: Type, new_: Type): TransformDesignerNodeDiagramGroupReact;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TransformDesignerNodeDiagramGroupReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TransformDesignerNodeDiagramGroupReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TransformDesignerNodeDiagramGroupReact | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TransformDesignerNodeDiagramGroupReact | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): TransformDesignerNodeDiagramGroupReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TransformDesignerNodeDiagramGroupReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TransformDesignerNodeDiagramGroupReact;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): TransformDesignerNodeDiagramGroupReact;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): TransformDesignerNodeDiagramGroupReact;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): TransformDesignerNodeDiagramGroupReact;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): TransformDesignerNodeDiagramGroupReact;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): TransformDesignerNodeDiagramGroupReact;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): TransformDesignerNodeDiagramGroupReact;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): TransformDesignerNodeDiagramGroupReact;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): TransformDesignerNodeDiagramGroupReact;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): TransformDesignerNodeDiagramGroupReact;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): TransformDesignerNodeDiagramGroupReact;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): TransformDesignerNodeDiagramGroupReact;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): TransformDesignerNodeDiagramGroupReact;
   ...
   * @see #unsetField
   */
  defaultField(field: string): TransformDesignerNodeDiagramGroupReact;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): TransformDesignerNodeDiagramGroupReact;
   ...
   * @see #removeField
   */
  unsetField(field: string): TransformDesignerNodeDiagramGroupReact;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): TransformDesignerNodeDiagramGroupReact;
   ...
   * @see #unsetField
   */
  removeField(field: string): TransformDesignerNodeDiagramGroupReact;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): TransformDesignerNodeDiagramGroupReact;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): TransformDesignerNodeDiagramGroupReact;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): TransformDesignerNodeDiagramGroupReact;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): TransformDesignerNodeDiagramGroupReact;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): TransformDesignerNodeDiagramGroupReact;

  mergeJson(json: any | null): TransformDesignerNodeDiagramGroupReact;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): TransformDesignerNodeDiagramGroupReact;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): TransformDesignerNodeDiagramGroupReact;
   ...
   */
  singletonArray(): C3.Array<TransformDesignerNodeDiagramGroupReact | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<TransformDesignerNodeDiagramGroupReact | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<TransformDesignerNodeDiagramGroupReact | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<TransformDesignerNodeDiagramGroupReact | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<TransformDesignerNodeDiagramGroupReact | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, TransformDesignerNodeDiagramGroupReact | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, TransformDesignerNodeDiagramGroupReact | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<TransformDesignerNodeDiagramGroupReact | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<TransformDesignerNodeDiagramGroupReact | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): TransformDesignerNodeDiagramGroupReact;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): TransformDesignerNodeDiagramGroupReact;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): TransformDesignerNodeDiagramGroupReact;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): TransformDesignerNodeDiagramGroupReact;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): TransformDesignerNodeDiagramGroupReact;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): TransformDesignerNodeDiagramGroupReact;
   ...
   * @see #fromString
   */
  static make(s: string | null): TransformDesignerNodeDiagramGroupReact | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): TransformDesignerNodeDiagramGroupReact;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): TransformDesignerNodeDiagramGroupReact;
   ...
   */
  static cachedEmptyInst(): TransformDesignerNodeDiagramGroupReact;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<TransformDesignerNodeDiagramGroupReact>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): TransformDesignerNodeDiagramGroupReact;
   ...
   */
  static render(props?: TransformDesignerNodeDiagramGroupReact | null): void;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<TransformDesignerNodeDiagramGroupReact | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<TransformDesignerNodeDiagramGroupReact | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<TransformDesignerNodeDiagramGroupReact | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<TransformDesignerNodeDiagramGroupReact | null> | null>;
   ...
   */
  dependencies(): MetadataDeps<TransformDesignerNodeDiagramGroupReact | null>;

  save(subPath?: string | null, contentType?: string | null): TransformDesignerNodeDiagramGroupReact;
  ...
  update(srcObj?: TransformDesignerNodeDiagramGroupReact | null, spec?: UpsertSpec | null): TransformDesignerNodeDiagramGroupReact | null;

  upsert(srcObj?: TransformDesignerNodeDiagramGroupReact | null, spec?: UpsertSpec | null): TransformDesignerNodeDiagramGroupReact | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): TransformDesignerNodeDiagramGroupReact | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string | null, failIfMissing?: boolean): TransformDesignerNodeDiagramGroupReact | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: TransformDesignerNodeDiagramGroupReact, state: UiSdlReduxState): TransformDesignerNodeDiagramGroupReact | null;
