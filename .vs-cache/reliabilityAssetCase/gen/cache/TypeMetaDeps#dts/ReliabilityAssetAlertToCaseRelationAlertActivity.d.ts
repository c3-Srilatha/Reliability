// TypeScript definitions for the C3 type ReliabilityAssetAlertToCaseRelationAlertActivity

/**
 * Type to represent the action for a {@link ReliabilityAssetAlert} of adding or removing a {@link ReliabilityAssetAlert} to or from a {@link ReliabilityAssetCase}.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityAssetAlertToCaseRelationAlertActivity
 */
declare interface IReliabilityAssetAlertToCaseRelationAlertActivity {
  ...
  /**
   * Description of the activity, such as comments, state change, or value change.
   */
  description?: string;
   ...
   */
  parent: IReliabilityAssetAlert;

  /**
   * The type of this activity, categorized by {@link ReliabilityActivity}.
   */
  activityType?: string;
 ...
 * Type to represent the action for a {@link ReliabilityAssetAlert} of adding or removing a {@link ReliabilityAssetAlert} to or from a {@link ReliabilityAssetCase}.
 *
 * @remarks this represents a made instance of ReliabilityAssetAlertToCaseRelationAlertActivity
 */
declare class ReliabilityAssetAlertToCaseRelationAlertActivity extends Obj  {

  /**
   * Timestamp indicating when the activity occurred.
   */
  readonly timestamp: DateTime;
  withTimestamp(timestamp: DateTime | Date | string): ReliabilityAssetAlertToCaseRelationAlertActivity;

  /**
   * Description of the activity, such as comments, state change, or value change.
   */
  readonly description?: string;
  withDescription(description: string | null): ReliabilityAssetAlertToCaseRelationAlertActivity;

  /**
   * The entity that this activity is associated with.
   */
  readonly parent: ReliabilityAssetAlert;
  withParent(parent: IReliabilityAssetAlert): ReliabilityAssetAlertToCaseRelationAlertActivity;

  /**
   * The type of this activity, categorized by {@link ReliabilityActivity}.
   */
  readonly activityType?: string;
  withActivityType(activityType: string | null): ReliabilityAssetAlertToCaseRelationAlertActivity;
   ...
   */
  readonly id: string;
  withId(id: string): ReliabilityAssetAlertToCaseRelationAlertActivity;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityAssetAlertToCaseRelationAlertActivity;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): ReliabilityAssetAlertToCaseRelationAlertActivity;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): ReliabilityAssetAlertToCaseRelationAlertActivity;
  ...
  withVersion(version: number | null): ReliabilityAssetAlertToCaseRelationAlertActivity;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): ReliabilityAssetAlertToCaseRelationAlertActivity;

  /**
   * @inheritdoc
   */
  readonly facilityFilterPaths?: Array_Type<string>;
  withFacilityFilterPaths(facilityFilterPaths: Array_Type<string> | Array<string> | null): ReliabilityAssetAlertToCaseRelationAlertActivity;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ReliabilityAssetAlertToCaseRelationAlertActivity | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ReliabilityAssetAlertToCaseRelationAlertActivity | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ReliabilityAssetAlertToCaseRelationAlertActivity | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ReliabilityAssetAlertToCaseRelationAlertActivity | null;
   ...
   */
  replaceType(old: Type, new_: Type): ReliabilityAssetAlertToCaseRelationAlertActivity;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityAssetAlertToCaseRelationAlertActivity;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityAssetAlertToCaseRelationAlertActivity;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityAssetAlertToCaseRelationAlertActivity>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityAssetAlertToCaseRelationAlertActivity>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityAssetAlertToCaseRelationAlertActivity;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityAssetAlertToCaseRelationAlertActivity;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityAssetAlertToCaseRelationAlertActivity;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ReliabilityAssetAlertToCaseRelationAlertActivity;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ReliabilityAssetAlertToCaseRelationAlertActivity;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityAssetAlertToCaseRelationAlertActivity;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityAssetAlertToCaseRelationAlertActivity;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityAssetAlertToCaseRelationAlertActivity;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ReliabilityAssetAlertToCaseRelationAlertActivity;
   ...
   * @see #removeField
   */
  withoutField(field: string): ReliabilityAssetAlertToCaseRelationAlertActivity;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ReliabilityAssetAlertToCaseRelationAlertActivity;
   ...
   */
  withoutFields(fields: Array_Type<string>): ReliabilityAssetAlertToCaseRelationAlertActivity;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityAssetAlertToCaseRelationAlertActivity;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ReliabilityAssetAlertToCaseRelationAlertActivity;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityAssetAlertToCaseRelationAlertActivity;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ReliabilityAssetAlertToCaseRelationAlertActivity;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ReliabilityAssetAlertToCaseRelationAlertActivity;
   ...
   * @see #removeField
   */
  unsetField(field: string): ReliabilityAssetAlertToCaseRelationAlertActivity;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ReliabilityAssetAlertToCaseRelationAlertActivity;
   ...
   * @see #unsetField
   */
  removeField(field: string): ReliabilityAssetAlertToCaseRelationAlertActivity;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ReliabilityAssetAlertToCaseRelationAlertActivity;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityAssetAlertToCaseRelationAlertActivity;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityAssetAlertToCaseRelationAlertActivity;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityAssetAlertToCaseRelationAlertActivity;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityAssetAlertToCaseRelationAlertActivity;

  mergeJson(json: any): ReliabilityAssetAlertToCaseRelationAlertActivity;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityAssetAlertToCaseRelationAlertActivity;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ReliabilityAssetAlertToCaseRelationAlertActivity;
   ...
   */
  singletonArray(): Array_Type<ReliabilityAssetAlertToCaseRelationAlertActivity>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityAssetAlertToCaseRelationAlertActivity> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ReliabilityAssetAlertToCaseRelationAlertActivity> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ReliabilityAssetAlertToCaseRelationAlertActivity>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ReliabilityAssetAlertToCaseRelationAlertActivity> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ReliabilityAssetAlertToCaseRelationAlertActivity> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityAssetAlertToCaseRelationAlertActivity> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ReliabilityAssetAlertToCaseRelationAlertActivity>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ReliabilityAssetAlertToCaseRelationAlertActivity>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityAssetAlertToCaseRelationAlertActivity;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityAssetAlertToCaseRelationAlertActivity;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityAssetAlertToCaseRelationAlertActivity;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ReliabilityAssetAlertToCaseRelationAlertActivity;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityAssetAlertToCaseRelationAlertActivity;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ReliabilityAssetAlertToCaseRelationAlertActivity;
   ...
   * @see #fromString
   */
  static make(s: string): ReliabilityAssetAlertToCaseRelationAlertActivity | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityAssetAlertToCaseRelationAlertActivity;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ReliabilityAssetAlertToCaseRelationAlertActivity;
   ...
   */
  static cachedEmptyInst(): ReliabilityAssetAlertToCaseRelationAlertActivity;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityAssetAlertToCaseRelationAlertActivity> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ReliabilityAssetAlertToCaseRelationAlertActivity;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<ReliabilityAssetAlertToCaseRelationAlertActivity>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ReliabilityAssetAlertToCaseRelationAlertActivity>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityAssetAlertToCaseRelationAlertActivity> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityAssetAlertToCaseRelationAlertActivity>> | null;
   ...
   */
  get(include?: string): ReliabilityAssetAlertToCaseRelationAlertActivity | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): ReliabilityAssetAlertToCaseRelationAlertActivity | null;
   ...
   */
  getMissing(spec: GetMissingSpec): ReliabilityAssetAlertToCaseRelationAlertActivity;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): ReliabilityAssetAlertToCaseRelationAlertActivity | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): ReliabilityAssetAlertToCaseRelationAlertActivity;
   ...
   * @see #toString
   */
  static fromString(s: string): ReliabilityAssetAlertToCaseRelationAlertActivity | null;
   ...
   */
  create(spec?: UpsertSpec): ReliabilityAssetAlertToCaseRelationAlertActivity | null;
   ...
   */
  static createBatch(objs: Array_Type<ReliabilityAssetAlertToCaseRelationAlertActivity>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlertToCaseRelationAlertActivity> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ReliabilityAssetAlertToCaseRelationAlertActivity>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityAssetAlertToCaseRelationAlertActivity> | null;
   ...
   */
  update(srcObj?: ReliabilityAssetAlertToCaseRelationAlertActivity, spec?: UpsertSpec): ReliabilityAssetAlertToCaseRelationAlertActivity | null;
   ...
   */
  upsert(srcObj?: ReliabilityAssetAlertToCaseRelationAlertActivity, spec?: UpsertSpec): ReliabilityAssetAlertToCaseRelationAlertActivity | null;
   ...
   */
  merge(spec?: MergeSpec): ReliabilityAssetAlertToCaseRelationAlertActivity | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): ReliabilityAssetAlertToCaseRelationAlertActivity | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): ReliabilityAssetAlertToCaseRelationAlertActivity | null;
   ...
   */
  static updateBatch(objs: Array_Type<ReliabilityAssetAlertToCaseRelationAlertActivity>, srcObjs?: Array_Type<ReliabilityAssetAlertToCaseRelationAlertActivity>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlertToCaseRelationAlertActivity> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<ReliabilityAssetAlertToCaseRelationAlertActivity> | null>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlertToCaseRelationAlertActivity> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<ReliabilityAssetAlertToCaseRelationAlertActivity>, srcObjs?: Array_Type<ReliabilityAssetAlertToCaseRelationAlertActivity>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlertToCaseRelationAlertActivity> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<ReliabilityAssetAlertToCaseRelationAlertActivity> | null>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlertToCaseRelationAlertActivity> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<ReliabilityAssetAlertToCaseRelationAlertActivity>, spec?: TouchSpec): ObjList<ReliabilityAssetAlertToCaseRelationAlertActivity> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityAssetAlertToCaseRelationAlertActivity>, spec?: MergeSpec): ObjList<ReliabilityAssetAlertToCaseRelationAlertActivity> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityAssetAlertToCaseRelationAlertActivity>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityAssetAlertToCaseRelationAlertActivity> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<ReliabilityAssetAlertToCaseRelationAlertActivity> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityAssetAlertToCaseRelationAlertActivity> | null;
   ...
   */
  static mergeAll(mergeObj: ReliabilityAssetAlertToCaseRelationAlertActivity, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ReliabilityAssetAlertToCaseRelationAlertActivity, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<ReliabilityAssetAlertToCaseRelationAlertActivity>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlertToCaseRelationAlertActivity> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<ReliabilityAssetAlertToCaseRelationAlertActivity>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlertToCaseRelationAlertActivity> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): ReliabilityAssetAlertToCaseRelationAlertActivity | null;
   ...
   */
  static beforeCreate(objs: Array_Type<ReliabilityAssetAlertToCaseRelationAlertActivity>): ObjList<ReliabilityAssetAlertToCaseRelationAlertActivity>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<ReliabilityAssetAlertToCaseRelationAlertActivity>): ObjList<ReliabilityAssetAlertToCaseRelationAlertActivity>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<ReliabilityAssetAlertToCaseRelationAlertActivity>): ObjList<ReliabilityAssetAlertToCaseRelationAlertActivity>;
   ...
   */
  static afterCreate(objs: Array_Type<ReliabilityAssetAlertToCaseRelationAlertActivity>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<ReliabilityAssetAlertToCaseRelationAlertActivity>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<ReliabilityAssetAlertToCaseRelationAlertActivity>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityAssetAlertToCaseRelationAlertActivity>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityAssetAlertToCaseRelationAlertActivity>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): ReliabilityAssetAlertToCaseRelationAlertActivity | null;
   ...
   */
  withoutIdentity(): ReliabilityAssetAlertToCaseRelationAlertActivity | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<ReliabilityAssetAlertToCaseRelationAlertActivity>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: ReliabilityAssetAlertToCaseRelationAlertActivity, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<ReliabilityAssetAlertToCaseRelationAlertActivity>, callback?: λFunction<ReliabilityAssetAlertToCaseRelationAlertActivity | null, ReliabilityAssetAlertToCaseRelationAlertActivity | null>): ObjList<ReliabilityAssetAlertToCaseRelationAlertActivity>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<ReliabilityAssetAlertToCaseRelationAlertActivity>, callback?: λFunction<ReliabilityAssetAlertToCaseRelationAlertActivity | null, ReliabilityAssetAlertToCaseRelationAlertActivity | null>): Array_Type<ObjError> | null;
