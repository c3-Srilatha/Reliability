// TypeScript definitions for the C3 type ReliabilityAssetAlertToCaseRelationCaseActivity

/**
 * Type to represent the action for a {@link ReliabilityAssetCase} of adding or removing a {@link ReliabilityAssetAlert} to or from a {@link ReliabilityAssetCase}.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityAssetAlertToCaseRelationCaseActivity
 */
declare interface IReliabilityAssetAlertToCaseRelationCaseActivity {
 ...
 * Type to represent the action for a {@link ReliabilityAssetCase} of adding or removing a {@link ReliabilityAssetAlert} to or from a {@link ReliabilityAssetCase}.
 *
 * @remarks this represents a made instance of ReliabilityAssetAlertToCaseRelationCaseActivity
 */
declare class ReliabilityAssetAlertToCaseRelationCaseActivity extends Obj  {

  /**
   * Timestamp indicating when the activity occurred.
   */
  readonly timestamp: DateTime;
  withTimestamp(timestamp: DateTime | Date | string): ReliabilityAssetAlertToCaseRelationCaseActivity;

  /**
   * Description of the activity, such as comments, state change, or value change.
   */
  readonly description?: string;
  withDescription(description: string | null): ReliabilityAssetAlertToCaseRelationCaseActivity;

  /**
   * The entity that this activity is associated with.
   */
  readonly parent: ReliabilityAssetCase;
  withParent(parent: IReliabilityAssetCase): ReliabilityAssetAlertToCaseRelationCaseActivity;

  /**
   * The type of this activity, categorized by {@link ReliabilityActivity}.
   */
  readonly activityType?: string;
  withActivityType(activityType: string | null): ReliabilityAssetAlertToCaseRelationCaseActivity;
   ...
   */
  readonly id: string;
  withId(id: string): ReliabilityAssetAlertToCaseRelationCaseActivity;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityAssetAlertToCaseRelationCaseActivity;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): ReliabilityAssetAlertToCaseRelationCaseActivity;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): ReliabilityAssetAlertToCaseRelationCaseActivity;
  ...
  withVersion(version: number | null): ReliabilityAssetAlertToCaseRelationCaseActivity;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): ReliabilityAssetAlertToCaseRelationCaseActivity;

  /**
   * @inheritdoc
   */
  readonly facilityFilterPaths?: Array_Type<string>;
  withFacilityFilterPaths(facilityFilterPaths: Array_Type<string> | Array<string> | null): ReliabilityAssetAlertToCaseRelationCaseActivity;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ReliabilityAssetAlertToCaseRelationCaseActivity | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ReliabilityAssetAlertToCaseRelationCaseActivity | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ReliabilityAssetAlertToCaseRelationCaseActivity | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ReliabilityAssetAlertToCaseRelationCaseActivity | null;
   ...
   */
  replaceType(old: Type, new_: Type): ReliabilityAssetAlertToCaseRelationCaseActivity;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityAssetAlertToCaseRelationCaseActivity;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityAssetAlertToCaseRelationCaseActivity;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityAssetAlertToCaseRelationCaseActivity>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityAssetAlertToCaseRelationCaseActivity>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityAssetAlertToCaseRelationCaseActivity;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityAssetAlertToCaseRelationCaseActivity;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityAssetAlertToCaseRelationCaseActivity;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ReliabilityAssetAlertToCaseRelationCaseActivity;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ReliabilityAssetAlertToCaseRelationCaseActivity;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityAssetAlertToCaseRelationCaseActivity;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityAssetAlertToCaseRelationCaseActivity;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityAssetAlertToCaseRelationCaseActivity;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ReliabilityAssetAlertToCaseRelationCaseActivity;
   ...
   * @see #removeField
   */
  withoutField(field: string): ReliabilityAssetAlertToCaseRelationCaseActivity;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ReliabilityAssetAlertToCaseRelationCaseActivity;
   ...
   */
  withoutFields(fields: Array_Type<string>): ReliabilityAssetAlertToCaseRelationCaseActivity;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityAssetAlertToCaseRelationCaseActivity;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ReliabilityAssetAlertToCaseRelationCaseActivity;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityAssetAlertToCaseRelationCaseActivity;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ReliabilityAssetAlertToCaseRelationCaseActivity;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ReliabilityAssetAlertToCaseRelationCaseActivity;
   ...
   * @see #removeField
   */
  unsetField(field: string): ReliabilityAssetAlertToCaseRelationCaseActivity;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ReliabilityAssetAlertToCaseRelationCaseActivity;
   ...
   * @see #unsetField
   */
  removeField(field: string): ReliabilityAssetAlertToCaseRelationCaseActivity;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ReliabilityAssetAlertToCaseRelationCaseActivity;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityAssetAlertToCaseRelationCaseActivity;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityAssetAlertToCaseRelationCaseActivity;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityAssetAlertToCaseRelationCaseActivity;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityAssetAlertToCaseRelationCaseActivity;

  mergeJson(json: any): ReliabilityAssetAlertToCaseRelationCaseActivity;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityAssetAlertToCaseRelationCaseActivity;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ReliabilityAssetAlertToCaseRelationCaseActivity;
   ...
   */
  singletonArray(): Array_Type<ReliabilityAssetAlertToCaseRelationCaseActivity>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityAssetAlertToCaseRelationCaseActivity> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ReliabilityAssetAlertToCaseRelationCaseActivity> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ReliabilityAssetAlertToCaseRelationCaseActivity>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ReliabilityAssetAlertToCaseRelationCaseActivity> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ReliabilityAssetAlertToCaseRelationCaseActivity> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityAssetAlertToCaseRelationCaseActivity> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ReliabilityAssetAlertToCaseRelationCaseActivity>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ReliabilityAssetAlertToCaseRelationCaseActivity>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityAssetAlertToCaseRelationCaseActivity;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityAssetAlertToCaseRelationCaseActivity;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityAssetAlertToCaseRelationCaseActivity;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ReliabilityAssetAlertToCaseRelationCaseActivity;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityAssetAlertToCaseRelationCaseActivity;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ReliabilityAssetAlertToCaseRelationCaseActivity;
   ...
   * @see #fromString
   */
  static make(s: string): ReliabilityAssetAlertToCaseRelationCaseActivity | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityAssetAlertToCaseRelationCaseActivity;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ReliabilityAssetAlertToCaseRelationCaseActivity;
   ...
   */
  static cachedEmptyInst(): ReliabilityAssetAlertToCaseRelationCaseActivity;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityAssetAlertToCaseRelationCaseActivity> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ReliabilityAssetAlertToCaseRelationCaseActivity;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<ReliabilityAssetAlertToCaseRelationCaseActivity>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ReliabilityAssetAlertToCaseRelationCaseActivity>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityAssetAlertToCaseRelationCaseActivity> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityAssetAlertToCaseRelationCaseActivity>> | null;
   ...
   */
  get(include?: string): ReliabilityAssetAlertToCaseRelationCaseActivity | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): ReliabilityAssetAlertToCaseRelationCaseActivity | null;
   ...
   */
  getMissing(spec: GetMissingSpec): ReliabilityAssetAlertToCaseRelationCaseActivity;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): ReliabilityAssetAlertToCaseRelationCaseActivity | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): ReliabilityAssetAlertToCaseRelationCaseActivity;
   ...
   * @see #toString
   */
  static fromString(s: string): ReliabilityAssetAlertToCaseRelationCaseActivity | null;
   ...
   */
  create(spec?: UpsertSpec): ReliabilityAssetAlertToCaseRelationCaseActivity | null;
   ...
   */
  static createBatch(objs: Array_Type<ReliabilityAssetAlertToCaseRelationCaseActivity>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlertToCaseRelationCaseActivity> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ReliabilityAssetAlertToCaseRelationCaseActivity>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityAssetAlertToCaseRelationCaseActivity> | null;
   ...
   */
  update(srcObj?: ReliabilityAssetAlertToCaseRelationCaseActivity, spec?: UpsertSpec): ReliabilityAssetAlertToCaseRelationCaseActivity | null;
   ...
   */
  upsert(srcObj?: ReliabilityAssetAlertToCaseRelationCaseActivity, spec?: UpsertSpec): ReliabilityAssetAlertToCaseRelationCaseActivity | null;
   ...
   */
  merge(spec?: MergeSpec): ReliabilityAssetAlertToCaseRelationCaseActivity | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): ReliabilityAssetAlertToCaseRelationCaseActivity | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): ReliabilityAssetAlertToCaseRelationCaseActivity | null;
   ...
   */
  static updateBatch(objs: Array_Type<ReliabilityAssetAlertToCaseRelationCaseActivity>, srcObjs?: Array_Type<ReliabilityAssetAlertToCaseRelationCaseActivity>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlertToCaseRelationCaseActivity> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<ReliabilityAssetAlertToCaseRelationCaseActivity> | null>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlertToCaseRelationCaseActivity> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<ReliabilityAssetAlertToCaseRelationCaseActivity>, srcObjs?: Array_Type<ReliabilityAssetAlertToCaseRelationCaseActivity>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlertToCaseRelationCaseActivity> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<ReliabilityAssetAlertToCaseRelationCaseActivity> | null>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlertToCaseRelationCaseActivity> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<ReliabilityAssetAlertToCaseRelationCaseActivity>, spec?: TouchSpec): ObjList<ReliabilityAssetAlertToCaseRelationCaseActivity> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityAssetAlertToCaseRelationCaseActivity>, spec?: MergeSpec): ObjList<ReliabilityAssetAlertToCaseRelationCaseActivity> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityAssetAlertToCaseRelationCaseActivity>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityAssetAlertToCaseRelationCaseActivity> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<ReliabilityAssetAlertToCaseRelationCaseActivity> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityAssetAlertToCaseRelationCaseActivity> | null;
   ...
   */
  static mergeAll(mergeObj: ReliabilityAssetAlertToCaseRelationCaseActivity, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ReliabilityAssetAlertToCaseRelationCaseActivity, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<ReliabilityAssetAlertToCaseRelationCaseActivity>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlertToCaseRelationCaseActivity> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<ReliabilityAssetAlertToCaseRelationCaseActivity>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlertToCaseRelationCaseActivity> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): ReliabilityAssetAlertToCaseRelationCaseActivity | null;
   ...
   */
  static beforeCreate(objs: Array_Type<ReliabilityAssetAlertToCaseRelationCaseActivity>): ObjList<ReliabilityAssetAlertToCaseRelationCaseActivity>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<ReliabilityAssetAlertToCaseRelationCaseActivity>): ObjList<ReliabilityAssetAlertToCaseRelationCaseActivity>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<ReliabilityAssetAlertToCaseRelationCaseActivity>): ObjList<ReliabilityAssetAlertToCaseRelationCaseActivity>;
   ...
   */
  static afterCreate(objs: Array_Type<ReliabilityAssetAlertToCaseRelationCaseActivity>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<ReliabilityAssetAlertToCaseRelationCaseActivity>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<ReliabilityAssetAlertToCaseRelationCaseActivity>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityAssetAlertToCaseRelationCaseActivity>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityAssetAlertToCaseRelationCaseActivity>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): ReliabilityAssetAlertToCaseRelationCaseActivity | null;
   ...
   */
  withoutIdentity(): ReliabilityAssetAlertToCaseRelationCaseActivity | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<ReliabilityAssetAlertToCaseRelationCaseActivity>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: ReliabilityAssetAlertToCaseRelationCaseActivity, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<ReliabilityAssetAlertToCaseRelationCaseActivity>, callback?: λFunction<ReliabilityAssetAlertToCaseRelationCaseActivity | null, ReliabilityAssetAlertToCaseRelationCaseActivity | null>): ObjList<ReliabilityAssetAlertToCaseRelationCaseActivity>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<ReliabilityAssetAlertToCaseRelationCaseActivity>, callback?: λFunction<ReliabilityAssetAlertToCaseRelationCaseActivity | null, ReliabilityAssetAlertToCaseRelationCaseActivity | null>): Array_Type<ObjError> | null;
