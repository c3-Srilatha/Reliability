// TypeScript definitions for the C3 type WorkOrder

/**
 * @inheritdoc
 *
 * @remarks this represents a value passed to a method that expects an instance of WorkOrder
 */
declare interface IWorkOrder {
   ...
   */
  workStartDate?: DateTime | Date | string;
   ...
   */
  workEndDate?: DateTime | Date | string;

  /**
   * The opened date for the WorkOrder
   */
  openedDate?: DateTime | Date | string;
   ...
   */
  resolutionTime?: IExactDimension;
   ...
   */
  childWorkOrders?: Array_Type<WorkOrder> | Array<IWorkOrder>;

  /**
   * The work items for the WorkOrder
   * specific sub-tasks that are associated with the work order.
   */
  workItems?: Array_Type<WorkItem> | Array<IWorkItem>;
   ...
   */
  workDueDate?: DateTime | Date | string;
   ...
   */
  workOrderPartsSimilarity?: Array_Type<WorkOrderPartsSimilarityPredictions> | Array<IWorkOrderPartsSimilarityPredictions>;
   ...
   */
  partsListInventory?: Map_Type<string, number> | {[key: string]: number};

  /**
   * The maintenance cost of the work order (worker cost + plant loss + parts cost)
   */
  workOrderCost?: IMonetaryValue;
  ...
  /**
   * {@link ReliabilityAssetCase} associated with the work order.
   */
  assetCase?: IReliabilityAssetCase;

  /**
   * Display name for the {@link assignee}.
   * Calculated from assignee's `firstName` or `lastName`. If either exists, it trims and concatenates them to display the full name.
   * If neither `firstName` nor `lastName` exists, it checks if assignee.email exists, and if so, returns the email.
   * If email doesn't exist either, it falls back to returning `name` field of assignee.
   */
  assigneeName?: string;
}
 ...
 * @inheritdoc
 *
 * @remarks this represents a made instance of WorkOrder
 */
declare class WorkOrder extends Obj  {
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): WorkOrder;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): WorkOrder;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): WorkOrder;
  ...
  withVersion(version: number | null): WorkOrder;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): WorkOrder;

  /**
   * @inheritdoc
   */
  readonly facilityFilterPaths?: Array_Type<string>;
  withFacilityFilterPaths(facilityFilterPaths: Array_Type<string> | Array<string> | null): WorkOrder;
  ...
  withTypeIdent(typeIdent: string | null): WorkOrder;

  /**
   * The Facility associated with the WorkOrder
   */
  readonly facility?: Facility;
  withFacility(facility: IFacility | null): WorkOrder;
  ...
  withStatus(status: string | null): WorkOrder;
  ...
  withStatusCode(statusCode: string | null): WorkOrder;
  ...
  withWorkOrderNumber(workOrderNumber: string | null): WorkOrder;

  /**
   * The description of the WorkOrder
   */
  readonly description?: string;
  withDescription(description: string | null): WorkOrder;
  ...
  withWorkOrderType(workOrderType: string | null): WorkOrder;
   ...
   * or indicate that a new customer has moved in
   */
  readonly workSubtype?: string;
  withWorkSubtype(workSubtype: string | null): WorkOrder;
  ...
  withWorkType(workType: string | null): WorkOrder;

  /**
   * The work start date of the WorkOrder
   */
  readonly workStartDate?: DateTime;
  withWorkStartDate(workStartDate: DateTime | Date | string | null): WorkOrder;

  /**
   * The work end date of the WorkOrder
   * The more important of the two dates in most metrics as it indicates when to start looking for aberrant behavior
   */
  readonly workEndDate?: DateTime;
  withWorkEndDate(workEndDate: DateTime | Date | string | null): WorkOrder;

  /**
   * The opened date for the WorkOrder
   */
  readonly openedDate?: DateTime;
  withOpenedDate(openedDate: DateTime | Date | string | null): WorkOrder;

  /**
   * Allows back office or field investigators to provide other important information about the work order
   */
  readonly comments?: string;
  withComments(comments: string | null): WorkOrder;
  ...
  withResolution(resolution: string | null): WorkOrder;

  /**
   * The time it took to resolve the WorkOrder
   * specified by ExactDimension with value and unit of measurement
   */
  readonly resolutionTime?: ExactDimension;
  withResolutionTime(resolutionTime: IExactDimension | null): WorkOrder;
  ...
  withTimestamp(timestamp: DateTime | Date | string | null): WorkOrder;

  /**
   * The service group responsible for the WorkOrder
   */
  readonly serviceGroup?: string;
  withServiceGroup(serviceGroup: string | null): WorkOrder;

  /**
   * The service team within the service group responsible for the WorkOrder
   */
  readonly serviceTeam?: string;
  withServiceTeam(serviceTeam: string | null): WorkOrder;

  /**
   * The technician associated with the WorkOrder
   */
  readonly technician?: Person;
  withTechnician(technician: IPerson | null): WorkOrder;

  /**
   * The asset associated with the WorkOrder
   */
  readonly asset?: FixedAsset;
  withAsset(asset: IFixedAsset | null): WorkOrder;

  /**
   * The customer associated with the WorkOrder
   */
  readonly customer?: Customer;
  withCustomer(customer: ICustomer | null): WorkOrder;

  /**
   * The location associated with the WorkOrder
   */
  readonly location?: Location;
  withLocation(location: ILocation | null): WorkOrder;

  /**
   * The organization associated with the WorkOrder
   */
  readonly customerOrg?: Organization;
  withCustomerOrg(customerOrg: IOrganization | null): WorkOrder;

  /**
   * The original WorkOrder created, this could have subtasks such as child WorkOrders or WorkItems
   */
  readonly parentWorkOrder?: WorkOrder;
  withParentWorkOrder(parentWorkOrder: IWorkOrder | null): WorkOrder;
   ...
   * but that was confusing and made the WorkOrder table too large to be performant.
   */
  readonly childWorkOrders?: Array_Type<WorkOrder>;
  withChildWorkOrders(childWorkOrders: Array_Type<WorkOrder> | Array<IWorkOrder> | null): WorkOrder;

  /**
   * The work items for the WorkOrder
   * specific sub-tasks that are associated with the work order.
   */
  readonly workItems?: Array_Type<WorkItem>;
  withWorkItems(workItems: Array_Type<WorkItem> | Array<IWorkItem> | null): WorkOrder;

  /**
   * The internal code that corresponds with the reason for the work order
   */
  readonly reasonCode?: string;
  withReasonCode(reasonCode: string | null): WorkOrder;

  /**
   * Symptom code of the work order to help understand root cause.
   */
  readonly symptomCode?: string;
  withSymptomCode(symptomCode: string | null): WorkOrder;

  /**
   * Cause text of the work order to help understand root cause.
   */
  readonly causeText?: string;
  withCauseText(causeText: string | null): WorkOrder;

  /**
   * {@link ReliabilityAsset} associated with the work order.
   */
  readonly parent: ReliabilityAsset;
  withParent(parent: IReliabilityAsset): WorkOrder;

  /**
   * Type of the maintenance activity of this work order.
   */
  readonly maintActivityType?: string;
  withMaintActivityType(maintActivityType: string | null): WorkOrder;

  /**
   * A translated representation of {@link WorkOrder#status} to be used in the UI.
   */
  readonly displayStatus?: string;
  withDisplayStatus(displayStatus: string | null): WorkOrder;

  /**
   * The date that the work order is due.
   */
  readonly workDueDate?: DateTime;
  withWorkDueDate(workDueDate: DateTime | Date | string | null): WorkOrder;

  /**
   * Reference to {@link Item} for maintenance in this work order.
   */
  readonly maintItem?: Item;
  withMaintItem(maintItem: IItem | null): WorkOrder;

  /**
   * A translated representation of {@link WorkOrder#partStatus} to be used in the UI.
   */
  readonly uiPartStatus?: string;
  withUiPartStatus(uiPartStatus: string | null): WorkOrder;

  /**
   * The priority field that is populated directly from customer data source.
   * We don't know what values would be in here so we don't use enum field of priority. DS team will decide how to map this field to priority.
   */
  readonly workOrderPriority?: string;
  withWorkOrderPriority(workOrderPriority: string | null): WorkOrder;

  /**
   * The list of similar parts from work orders tied to this work order from {@link WorkOrderPartsSimilarityPredictions}.
   */
  readonly workOrderPartsSimilarity?: Array_Type<WorkOrderPartsSimilarityPredictions>;
  withWorkOrderPartsSimilarity(workOrderPartsSimilarity: Array_Type<WorkOrderPartsSimilarityPredictions> | Array<IWorkOrderPartsSimilarityPredictions> | null): WorkOrder;

  /**
   * Date time when work order was requested.
   */
  readonly requiredStartDatetime?: DateTime;
  withRequiredStartDatetime(requiredStartDatetime: DateTime | Date | string | null): WorkOrder;

  /**
   * Coding that includes text field to help understand the root cause.
   */
  readonly codingIncludingTextField?: string;
  withCodingIncludingTextField(codingIncludingTextField: string | null): WorkOrder;

  /**
   * Apparent cause of the work order to help understand root cause.
   */
  readonly apparentCause?: string;
  withApparentCause(apparentCause: string | null): WorkOrder;

  /**
   * The status of the parts for the WorkOrder. Enumerated via {@link WorkOrderPartStatusEnum}
   */
  readonly partStatus?: string;
  withPartStatus(partStatus: string | null): WorkOrder;

  /**
   * This is the preventive maintenance type for this work order, if applicable.
   */
  readonly preventiveMaintenanceType?: string;
  withPreventiveMaintenanceType(preventiveMaintenanceType: string | null): WorkOrder;
   ...
   * at the time the work order is to be executed as the value.
   */
  readonly partsListInventory?: Map_Type<string, number>;
  withPartsListInventory(partsListInventory: Map_Type<string, number> | {[key: string]: number} | null): WorkOrder;

  /**
   * The maintenance cost of the work order (worker cost + plant loss + parts cost)
   */
  readonly workOrderCost?: MonetaryValue;
  withWorkOrderCost(workOrderCost: IMonetaryValue | null): WorkOrder;

  /**
   * The priority of the work order.
   */
  readonly priority?: string;
  withPriority(priority: string | null): WorkOrder;

  /**
   * The creation date for the workorder, to be used in UI.
   */
  readonly creationDate?: DateTime;
  withCreationDate(creationDate: DateTime | Date | string | null): WorkOrder;

  /**
   * The list of parts associated with this work order tied to {@link InventorySeries}.
   * The structure is a map, with the {@link InventorySeries} id as the key and the quantity as the value.
   */
  readonly partsList?: Map_Type<string, number>;
  withPartsList(partsList: Map_Type<string, number> | {[key: string]: number} | null): WorkOrder;

  /**
   * The list of similar work orders tied to this work order from {@link WorkOrderSimilarityPredictions}.
   */
  readonly workOrderSimilarity?: Array_Type<WorkOrderSimilarityPredictions>;
  withWorkOrderSimilarity(workOrderSimilarity: Array_Type<WorkOrderSimilarityPredictions> | Array<IWorkOrderSimilarityPredictions> | null): WorkOrder;
  ...
  withFailureMode(failureMode: string | null): WorkOrder;
  ...
  withCreatedBy(createdBy: IUser | null): WorkOrder;

  /**
   * Functional location that ensures connection between work order and subsystem.
   */
  readonly functionalLocation?: string;
  withFunctionalLocation(functionalLocation: string | null): WorkOrder;

  /**
   * Description according to the priority code.
   */
  readonly priorityDescription?: string;
  withPriorityDescription(priorityDescription: string | null): WorkOrder;

  /**
   * {@link User} who has been assigned to perform this work order.
   */
  readonly assignee?: User;
  withAssignee(assignee: IUser | null): WorkOrder;

  /**
   * Total cost of activity to identify importance of the work order.
   */
  readonly totalActCosts?: number;
  withTotalActCosts(totalActCosts: number | null): WorkOrder;

  /**
   * {@link ReliabilityAssetCase} associated with the work order.
   */
  readonly assetCase?: ReliabilityAssetCase;
  withAssetCase(assetCase: IReliabilityAssetCase | null): WorkOrder;
  ...
  withAssigneeName(assigneeName: string | null): WorkOrder;
   ...
   * @see #toJson
   */
  static fromJson(json: any): WorkOrder | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): WorkOrder | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): WorkOrder | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): WorkOrder | null;
   ...
   */
  replaceType(old: Type, new_: Type): WorkOrder;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): WorkOrder;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): WorkOrder;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<WorkOrder>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<WorkOrder>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): WorkOrder;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): WorkOrder;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): WorkOrder;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): WorkOrder;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): WorkOrder;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): WorkOrder;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): WorkOrder;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): WorkOrder;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): WorkOrder;
   ...
   * @see #removeField
   */
  withoutField(field: string): WorkOrder;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): WorkOrder;
   ...
   */
  withoutFields(fields: Array_Type<string>): WorkOrder;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): WorkOrder;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): WorkOrder;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): WorkOrder;
   ...
   * @see #unsetField
   */
  defaultField(field: string): WorkOrder;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): WorkOrder;
   ...
   * @see #removeField
   */
  unsetField(field: string): WorkOrder;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): WorkOrder;
   ...
   * @see #unsetField
   */
  removeField(field: string): WorkOrder;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): WorkOrder;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): WorkOrder;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): WorkOrder;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): WorkOrder;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): WorkOrder;

  mergeJson(json: any): WorkOrder;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): WorkOrder;
   ...
   */
  sumObj(other: Obj, deep?: boolean): WorkOrder;
   ...
   */
  singletonArray(): Array_Type<WorkOrder>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<WorkOrder> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<WorkOrder> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<WorkOrder>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<WorkOrder> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, WorkOrder> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, WorkOrder> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<WorkOrder>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<WorkOrder>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): WorkOrder;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): WorkOrder;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): WorkOrder;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): WorkOrder;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): WorkOrder;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): WorkOrder;
   ...
   * @see #fromString
   */
  static make(s: string): WorkOrder | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): WorkOrder;
   ...
   */
  static cachedEmptyInst(): WorkOrder;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<WorkOrder> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): WorkOrder;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<WorkOrder>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<WorkOrder>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<WorkOrder> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<WorkOrder>> | null;
   ...
   */
  get(include?: string): WorkOrder | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): WorkOrder | null;
   ...
   */
  getMissing(spec: GetMissingSpec): WorkOrder;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): WorkOrder | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): WorkOrder;
   ...
   * @see #toString
   */
  static fromString(s: string): WorkOrder | null;
   ...
   */
  create(spec?: UpsertSpec): WorkOrder | null;
   ...
   */
  static createBatch(objs: Array_Type<WorkOrder>, spec?: UpsertSpec): ObjList<WorkOrder> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<WorkOrder>, spec?: CreateBatchObjStreamSpec): ObjList<WorkOrder> | null;
   ...
   */
  update(srcObj?: WorkOrder, spec?: UpsertSpec): WorkOrder | null;
   ...
   */
  upsert(srcObj?: WorkOrder, spec?: UpsertSpec): WorkOrder | null;
   ...
   */
  merge(spec?: MergeSpec): WorkOrder | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): WorkOrder | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): WorkOrder | null;
   ...
   */
  static updateBatch(objs: Array_Type<WorkOrder>, srcObjs?: Array_Type<WorkOrder>, spec?: UpsertSpec): ObjList<WorkOrder> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<WorkOrder> | null>, spec?: UpsertSpec): ObjList<WorkOrder> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<WorkOrder>, srcObjs?: Array_Type<WorkOrder>, spec?: UpsertSpec): ObjList<WorkOrder> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<WorkOrder> | null>, spec?: UpsertSpec): ObjList<WorkOrder> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<WorkOrder>, spec?: TouchSpec): ObjList<WorkOrder> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<WorkOrder>, spec?: MergeSpec): ObjList<WorkOrder> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<WorkOrder>, mergeInclude: string, spec?: MergeSpec): ObjList<WorkOrder> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<WorkOrder> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<WorkOrder> | null;
   ...
   */
  static mergeAll(mergeObj: WorkOrder, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: WorkOrder, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<WorkOrder>, spec?: UpsertSpec): ObjList<WorkOrder> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<WorkOrder>, spec?: UpsertSpec): ObjList<WorkOrder> | null;
   ...
   */
  static beforeCreate(objs: Array_Type<WorkOrder>): ObjList<WorkOrder>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<WorkOrder>): ObjList<WorkOrder>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<WorkOrder>): ObjList<WorkOrder>;
   ...
   */
  static afterCreate(objs: Array_Type<WorkOrder>): Array_Type<ObjError> | null;
   ...
   */
  static afterUpdate(objs: Array_Type<WorkOrder>): Array_Type<ObjError> | null;
   ...
   */
  static afterRemove(objs: Array_Type<WorkOrder>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<WorkOrder>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<WorkOrder>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): WorkOrder | null;
   ...
   */
  withoutIdentity(): WorkOrder | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<WorkOrder>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: WorkOrder, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<WorkOrder>, callback?: λFunction<WorkOrder | null, WorkOrder | null>): ObjList<WorkOrder>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<WorkOrder>, callback?: λFunction<WorkOrder | null, WorkOrder | null>): Array_Type<ObjError> | null;
   ...
   */
  static getSimilarPartsForWorkOrder(workOrderId?: string, spec?: FetchSpec): any | null;
   ...
   */
  static getPartsList(workOrderId?: string, spec?: FetchSpec): any | null;
   ...
   */
  static getSimilarPartsByIds(workOrderId?: string, partIds?: string, spec?: FetchSpec): any | null;
   ...
   * no parts list.
   */
  static getWorkOrderStatistics(facilityIds?: string): any | null;

  /**
   * Returns the `totalCount` of work orders returned from {#getSimilarPartsForWorkOrder}.
   */
  static getSimilarPartsForWorkOrderCount(workOrderId?: string, spec?: FetchSpec): number | null;
   ...
   */
  static getSimilarWorkOrders(partId?: string, workOrderId?: string, spec?: FetchSpec): any | null;

  /**
   * Returns the `totalCount` of parts returned from {#getPartsList}.
   */
  static getPartsListCount(workOrderId?: string, spec?: FetchSpec): number | null;

  /**
   * Updates work order and parts similarity predictions by starting a {@link ReliabilitySparePartsSimilarityJob} BatchJob.
   */
  static updateSimilarityPredictions(spec?: ReliabilitySparePartsSimilarityJobSpec): void;

  /**
   * Updates parts forecast by starting a {@link ReliabilitySparePartsForecastJob} BatchJob.
   */
  static updateWorkOrderPartsForecast(options?: ReliabilitySparePartsForecastJobOptions): void;

  /**
   * Returns the projected inventory based on {@link WorkOrderPartsForecast}
   */
  static getProjectedInventory(workOrderId?: string, partId?: string): number | null;

  /**
   * Returns the `totalCount` of work orders returned from {#getSimilarWorkOrders}.
   */
  static getSimilarWorkOrdersCount(partId?: string, workOrderId?: string, spec?: FetchSpec): number | null;

  /**
   * Fetches a list of {@link WorkOrder}s and converts timestamps to the {@link ReliabilityTimezoneConfig#uiTimezone}.
   *
   * @returns A list of {@link WorkOrder}s matching the `uiTimezone`.
   */
  static localizedFetch(spec: FetchSpec): FetchResult<WorkOrder>;

  /**
   * Create a new {@link WorkOrder} from a form.
   */
  static createFromForm(formObject: any): WorkOrder | null;

  /**
   * Modifies an existing {@link WorkOrder} from a form.
   */
  static mergeFromForm(formObject: WorkOrderSpec, mergeSpec?: MergeSpec): WorkOrder | null;

  /**
   * Generates a PDF with all the work orders specified by the given {@link FetchSpec}. Returns the URL to the PDF.
   */
  static generatePdf(spec: FetchSpec): string;
}
