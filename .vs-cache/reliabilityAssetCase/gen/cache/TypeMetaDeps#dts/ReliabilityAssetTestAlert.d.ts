// TypeScript definitions for the C3 type ReliabilityAssetTestAlert

/**
 * An extension of {@link ReliabilityAssetAlert} for testing purposes.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityAssetTestAlert
 */
declare interface IReliabilityAssetTestAlert {
 ...
 * An extension of {@link ReliabilityAssetAlert} for testing purposes.
 *
 * @remarks this represents a made instance of ReliabilityAssetTestAlert
 */
declare class ReliabilityAssetTestAlert extends Obj  {

  /**
   * Timestamp for the value.
   */
  readonly timestamp?: DateTime;
  withTimestamp(timestamp: DateTime | Date | string | null): ReliabilityAssetTestAlert;
   ...
   */
  readonly id: string;
  withId(id: string): ReliabilityAssetTestAlert;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityAssetTestAlert;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): ReliabilityAssetTestAlert;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): ReliabilityAssetTestAlert;
  ...
  withVersion(version: number | null): ReliabilityAssetTestAlert;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): ReliabilityAssetTestAlert;

  /**
   * The {@link ReliabilityAsset} linked to this alert.
   */
  readonly parent: ReliabilityAsset;
  withParent(parent: IReliabilityAsset): ReliabilityAssetTestAlert;

  /**
   * The {@link ReliabilityMlModel} which triggered this alert.
   */
  readonly triggeringModel?: ReliabilityMlModel;
  withTriggeringModel(triggeringModel: IReliabilityMlModel | null): ReliabilityAssetTestAlert;

  /**
   * The id of the {@link ReliabilityAssetAlert#triggeringModel}.
   */
  readonly triggeringModelId?: string;
  withTriggeringModelId(triggeringModelId: string | null): ReliabilityAssetTestAlert;
  ...
  withFeatureContributionMap(featureContributionMap: Map_Type<string, number> | {[key: string]: number} | null): ReliabilityAssetTestAlert;
  ...
  withPrimaryModelOutput(primaryModelOutput: IReliabilityAssetAlert.ModelOutput | null): ReliabilityAssetTestAlert;
  ...
  withAllPrimaryModelOutputs(allPrimaryModelOutputs: Map_Type<string, ReliabilityAssetAlert.ModelOutput> | {[key: string]: IReliabilityAssetAlert.ModelOutput} | null): ReliabilityAssetTestAlert;

  /**
   * @inheritdoc
   */
  readonly facilityFilterPaths?: Array_Type<string>;
  withFacilityFilterPaths(facilityFilterPaths: Array_Type<string> | Array<string> | null): ReliabilityAssetTestAlert;
  ...
  withTypeIdent(typeIdent: string | null): ReliabilityAssetTestAlert;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ReliabilityAssetTestAlert | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ReliabilityAssetTestAlert | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ReliabilityAssetTestAlert | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ReliabilityAssetTestAlert | null;
   ...
   */
  replaceType(old: Type, new_: Type): ReliabilityAssetTestAlert;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityAssetTestAlert;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityAssetTestAlert;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityAssetTestAlert>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityAssetTestAlert>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityAssetTestAlert;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityAssetTestAlert;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityAssetTestAlert;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ReliabilityAssetTestAlert;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ReliabilityAssetTestAlert;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityAssetTestAlert;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityAssetTestAlert;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityAssetTestAlert;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ReliabilityAssetTestAlert;
   ...
   * @see #removeField
   */
  withoutField(field: string): ReliabilityAssetTestAlert;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ReliabilityAssetTestAlert;
   ...
   */
  withoutFields(fields: Array_Type<string>): ReliabilityAssetTestAlert;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityAssetTestAlert;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ReliabilityAssetTestAlert;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityAssetTestAlert;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ReliabilityAssetTestAlert;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ReliabilityAssetTestAlert;
   ...
   * @see #removeField
   */
  unsetField(field: string): ReliabilityAssetTestAlert;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ReliabilityAssetTestAlert;
   ...
   * @see #unsetField
   */
  removeField(field: string): ReliabilityAssetTestAlert;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ReliabilityAssetTestAlert;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityAssetTestAlert;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityAssetTestAlert;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityAssetTestAlert;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityAssetTestAlert;

  mergeJson(json: any): ReliabilityAssetTestAlert;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityAssetTestAlert;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ReliabilityAssetTestAlert;
   ...
   */
  singletonArray(): Array_Type<ReliabilityAssetTestAlert>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityAssetTestAlert> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ReliabilityAssetTestAlert> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ReliabilityAssetTestAlert>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ReliabilityAssetTestAlert> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ReliabilityAssetTestAlert> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityAssetTestAlert> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ReliabilityAssetTestAlert>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ReliabilityAssetTestAlert>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityAssetTestAlert;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityAssetTestAlert;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityAssetTestAlert;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ReliabilityAssetTestAlert;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityAssetTestAlert;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ReliabilityAssetTestAlert;
   ...
   * @see #fromString
   */
  static make(s: string): ReliabilityAssetTestAlert | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityAssetTestAlert;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ReliabilityAssetTestAlert;
   ...
   */
  static cachedEmptyInst(): ReliabilityAssetTestAlert;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityAssetTestAlert> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ReliabilityAssetTestAlert;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<ReliabilityAssetTestAlert>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ReliabilityAssetTestAlert>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityAssetTestAlert> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityAssetTestAlert>> | null;
   ...
   */
  get(include?: string): ReliabilityAssetTestAlert | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): ReliabilityAssetTestAlert | null;
   ...
   */
  getMissing(spec: GetMissingSpec): ReliabilityAssetTestAlert;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): ReliabilityAssetTestAlert | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): ReliabilityAssetTestAlert;
   ...
   * @see #toString
   */
  static fromString(s: string): ReliabilityAssetTestAlert | null;
   ...
   */
  create(spec?: UpsertSpec): ReliabilityAssetTestAlert | null;
   ...
   */
  static createBatch(objs: Array_Type<ReliabilityAssetTestAlert>, spec?: UpsertSpec): ObjList<ReliabilityAssetTestAlert> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ReliabilityAssetTestAlert>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityAssetTestAlert> | null;
   ...
   */
  update(srcObj?: ReliabilityAssetTestAlert, spec?: UpsertSpec): ReliabilityAssetTestAlert | null;
   ...
   */
  upsert(srcObj?: ReliabilityAssetTestAlert, spec?: UpsertSpec): ReliabilityAssetTestAlert | null;
   ...
   */
  merge(spec?: MergeSpec): ReliabilityAssetTestAlert | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): ReliabilityAssetTestAlert | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): ReliabilityAssetTestAlert | null;
   ...
   */
  static updateBatch(objs: Array_Type<ReliabilityAssetTestAlert>, srcObjs?: Array_Type<ReliabilityAssetTestAlert>, spec?: UpsertSpec): ObjList<ReliabilityAssetTestAlert> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<ReliabilityAssetTestAlert> | null>, spec?: UpsertSpec): ObjList<ReliabilityAssetTestAlert> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<ReliabilityAssetTestAlert>, srcObjs?: Array_Type<ReliabilityAssetTestAlert>, spec?: UpsertSpec): ObjList<ReliabilityAssetTestAlert> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<ReliabilityAssetTestAlert> | null>, spec?: UpsertSpec): ObjList<ReliabilityAssetTestAlert> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<ReliabilityAssetTestAlert>, spec?: TouchSpec): ObjList<ReliabilityAssetTestAlert> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityAssetTestAlert>, spec?: MergeSpec): ObjList<ReliabilityAssetTestAlert> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityAssetTestAlert>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityAssetTestAlert> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<ReliabilityAssetTestAlert> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityAssetTestAlert> | null;
   ...
   */
  static mergeAll(mergeObj: ReliabilityAssetTestAlert, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ReliabilityAssetTestAlert, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<ReliabilityAssetTestAlert>, spec?: UpsertSpec): ObjList<ReliabilityAssetTestAlert> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<ReliabilityAssetTestAlert>, spec?: UpsertSpec): ObjList<ReliabilityAssetTestAlert> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): ReliabilityAssetTestAlert | null;
   ...
   */
  static beforeCreate(objs: Array_Type<ReliabilityAssetTestAlert>): ObjList<ReliabilityAssetTestAlert>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<ReliabilityAssetTestAlert>): ObjList<ReliabilityAssetTestAlert>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<ReliabilityAssetTestAlert>): ObjList<ReliabilityAssetTestAlert>;
   ...
   */
  static afterCreate(objs: Array_Type<ReliabilityAssetTestAlert>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<ReliabilityAssetTestAlert>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<ReliabilityAssetTestAlert>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityAssetTestAlert>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityAssetTestAlert>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): ReliabilityAssetTestAlert | null;
   ...
   */
  withoutIdentity(): ReliabilityAssetTestAlert | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<ReliabilityAssetTestAlert>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: ReliabilityAssetTestAlert, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<ReliabilityAssetTestAlert>, callback?: λFunction<ReliabilityAssetTestAlert | null, ReliabilityAssetTestAlert | null>): ObjList<ReliabilityAssetTestAlert>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<ReliabilityAssetTestAlert>, callback?: λFunction<ReliabilityAssetTestAlert | null, ReliabilityAssetTestAlert | null>): Array_Type<ObjError> | null;
   ...
   */
  static evalFeatureSetBatch(batch: Array_Type<ReliabilityAssetTestAlert>, featureSet: Feature.Set, spec?: EvalFeatureSpec): Data | null;
   ...
   * ```
   */
  static evalFeaturesBatch(batch: Array_Type<ReliabilityAssetTestAlert>, features: Array_Type<string>, spec?: EvalFeaturesSpec): Data | null;
