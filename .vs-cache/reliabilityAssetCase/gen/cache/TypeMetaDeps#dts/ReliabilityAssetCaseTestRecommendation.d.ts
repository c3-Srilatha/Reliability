// TypeScript definitions for the C3 type ReliabilityAssetCaseTestRecommendation

/**
 * Test type to verify the recommendation generator gets called.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityAssetCaseTestRecommendation
 */
declare interface IReliabilityAssetCaseTestRecommendation {
 ...
 * Test type to verify the recommendation generator gets called.
 *
 * @remarks this represents a made instance of ReliabilityAssetCaseTestRecommendation
 */
declare class ReliabilityAssetCaseTestRecommendation extends Obj  {
   ...
   */
  readonly id: string;
  withId(id: string): ReliabilityAssetCaseTestRecommendation;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityAssetCaseTestRecommendation;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): ReliabilityAssetCaseTestRecommendation;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): ReliabilityAssetCaseTestRecommendation;
  ...
  withVersion(version: number | null): ReliabilityAssetCaseTestRecommendation;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): ReliabilityAssetCaseTestRecommendation;

  /**
   * The case id
   */
  readonly caseId?: string;
  withCaseId(caseId: string | null): ReliabilityAssetCaseTestRecommendation;

  /**
   * The recommendation type
   */
  readonly recommendationType?: string;
  withRecommendationType(recommendationType: string | null): ReliabilityAssetCaseTestRecommendation;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ReliabilityAssetCaseTestRecommendation | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ReliabilityAssetCaseTestRecommendation | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ReliabilityAssetCaseTestRecommendation | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ReliabilityAssetCaseTestRecommendation | null;
   ...
   */
  replaceType(old: Type, new_: Type): ReliabilityAssetCaseTestRecommendation;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityAssetCaseTestRecommendation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityAssetCaseTestRecommendation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityAssetCaseTestRecommendation>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityAssetCaseTestRecommendation>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityAssetCaseTestRecommendation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityAssetCaseTestRecommendation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityAssetCaseTestRecommendation;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ReliabilityAssetCaseTestRecommendation;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ReliabilityAssetCaseTestRecommendation;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityAssetCaseTestRecommendation;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityAssetCaseTestRecommendation;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityAssetCaseTestRecommendation;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ReliabilityAssetCaseTestRecommendation;
   ...
   * @see #removeField
   */
  withoutField(field: string): ReliabilityAssetCaseTestRecommendation;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ReliabilityAssetCaseTestRecommendation;
   ...
   */
  withoutFields(fields: Array_Type<string>): ReliabilityAssetCaseTestRecommendation;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityAssetCaseTestRecommendation;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ReliabilityAssetCaseTestRecommendation;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityAssetCaseTestRecommendation;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ReliabilityAssetCaseTestRecommendation;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ReliabilityAssetCaseTestRecommendation;
   ...
   * @see #removeField
   */
  unsetField(field: string): ReliabilityAssetCaseTestRecommendation;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ReliabilityAssetCaseTestRecommendation;
   ...
   * @see #unsetField
   */
  removeField(field: string): ReliabilityAssetCaseTestRecommendation;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ReliabilityAssetCaseTestRecommendation;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityAssetCaseTestRecommendation;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityAssetCaseTestRecommendation;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityAssetCaseTestRecommendation;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityAssetCaseTestRecommendation;

  mergeJson(json: any): ReliabilityAssetCaseTestRecommendation;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityAssetCaseTestRecommendation;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ReliabilityAssetCaseTestRecommendation;
   ...
   */
  singletonArray(): Array_Type<ReliabilityAssetCaseTestRecommendation>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityAssetCaseTestRecommendation> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ReliabilityAssetCaseTestRecommendation> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ReliabilityAssetCaseTestRecommendation>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ReliabilityAssetCaseTestRecommendation> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ReliabilityAssetCaseTestRecommendation> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityAssetCaseTestRecommendation> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ReliabilityAssetCaseTestRecommendation>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ReliabilityAssetCaseTestRecommendation>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityAssetCaseTestRecommendation;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityAssetCaseTestRecommendation;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityAssetCaseTestRecommendation;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ReliabilityAssetCaseTestRecommendation;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityAssetCaseTestRecommendation;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ReliabilityAssetCaseTestRecommendation;
   ...
   * @see #fromString
   */
  static make(s: string): ReliabilityAssetCaseTestRecommendation | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityAssetCaseTestRecommendation;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ReliabilityAssetCaseTestRecommendation;
   ...
   */
  static cachedEmptyInst(): ReliabilityAssetCaseTestRecommendation;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityAssetCaseTestRecommendation> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ReliabilityAssetCaseTestRecommendation;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<ReliabilityAssetCaseTestRecommendation>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ReliabilityAssetCaseTestRecommendation>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityAssetCaseTestRecommendation> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityAssetCaseTestRecommendation>> | null;
   ...
   */
  get(include?: string): ReliabilityAssetCaseTestRecommendation | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): ReliabilityAssetCaseTestRecommendation | null;
   ...
   */
  getMissing(spec: GetMissingSpec): ReliabilityAssetCaseTestRecommendation;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): ReliabilityAssetCaseTestRecommendation | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): ReliabilityAssetCaseTestRecommendation;
   ...
   * @see #toString
   */
  static fromString(s: string): ReliabilityAssetCaseTestRecommendation | null;
   ...
   */
  create(spec?: UpsertSpec): ReliabilityAssetCaseTestRecommendation | null;
   ...
   */
  static createBatch(objs: Array_Type<ReliabilityAssetCaseTestRecommendation>, spec?: UpsertSpec): ObjList<ReliabilityAssetCaseTestRecommendation> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ReliabilityAssetCaseTestRecommendation>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityAssetCaseTestRecommendation> | null;
   ...
   */
  update(srcObj?: ReliabilityAssetCaseTestRecommendation, spec?: UpsertSpec): ReliabilityAssetCaseTestRecommendation | null;
   ...
   */
  upsert(srcObj?: ReliabilityAssetCaseTestRecommendation, spec?: UpsertSpec): ReliabilityAssetCaseTestRecommendation | null;
   ...
   */
  merge(spec?: MergeSpec): ReliabilityAssetCaseTestRecommendation | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): ReliabilityAssetCaseTestRecommendation | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): ReliabilityAssetCaseTestRecommendation | null;
   ...
   */
  static updateBatch(objs: Array_Type<ReliabilityAssetCaseTestRecommendation>, srcObjs?: Array_Type<ReliabilityAssetCaseTestRecommendation>, spec?: UpsertSpec): ObjList<ReliabilityAssetCaseTestRecommendation> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<ReliabilityAssetCaseTestRecommendation> | null>, spec?: UpsertSpec): ObjList<ReliabilityAssetCaseTestRecommendation> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<ReliabilityAssetCaseTestRecommendation>, srcObjs?: Array_Type<ReliabilityAssetCaseTestRecommendation>, spec?: UpsertSpec): ObjList<ReliabilityAssetCaseTestRecommendation> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<ReliabilityAssetCaseTestRecommendation> | null>, spec?: UpsertSpec): ObjList<ReliabilityAssetCaseTestRecommendation> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<ReliabilityAssetCaseTestRecommendation>, spec?: TouchSpec): ObjList<ReliabilityAssetCaseTestRecommendation> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityAssetCaseTestRecommendation>, spec?: MergeSpec): ObjList<ReliabilityAssetCaseTestRecommendation> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityAssetCaseTestRecommendation>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityAssetCaseTestRecommendation> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<ReliabilityAssetCaseTestRecommendation> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityAssetCaseTestRecommendation> | null;
   ...
   */
  static mergeAll(mergeObj: ReliabilityAssetCaseTestRecommendation, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ReliabilityAssetCaseTestRecommendation, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<ReliabilityAssetCaseTestRecommendation>, spec?: UpsertSpec): ObjList<ReliabilityAssetCaseTestRecommendation> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<ReliabilityAssetCaseTestRecommendation>, spec?: UpsertSpec): ObjList<ReliabilityAssetCaseTestRecommendation> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): ReliabilityAssetCaseTestRecommendation | null;
   ...
   */
  static beforeCreate(objs: Array_Type<ReliabilityAssetCaseTestRecommendation>): ObjList<ReliabilityAssetCaseTestRecommendation>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<ReliabilityAssetCaseTestRecommendation>): ObjList<ReliabilityAssetCaseTestRecommendation>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<ReliabilityAssetCaseTestRecommendation>): ObjList<ReliabilityAssetCaseTestRecommendation>;
   ...
   */
  static afterCreate(objs: Array_Type<ReliabilityAssetCaseTestRecommendation>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<ReliabilityAssetCaseTestRecommendation>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<ReliabilityAssetCaseTestRecommendation>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityAssetCaseTestRecommendation>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityAssetCaseTestRecommendation>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): ReliabilityAssetCaseTestRecommendation | null;
   ...
   */
  withoutIdentity(): ReliabilityAssetCaseTestRecommendation | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<ReliabilityAssetCaseTestRecommendation>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: ReliabilityAssetCaseTestRecommendation, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<ReliabilityAssetCaseTestRecommendation>, callback?: λFunction<ReliabilityAssetCaseTestRecommendation | null, ReliabilityAssetCaseTestRecommendation | null>): ObjList<ReliabilityAssetCaseTestRecommendation>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<ReliabilityAssetCaseTestRecommendation>, callback?: λFunction<ReliabilityAssetCaseTestRecommendation | null, ReliabilityAssetCaseTestRecommendation | null>): Array_Type<ObjError> | null;
  ...
  /**
   * Generate a test recommendation for a case
   */
  static generateCaseRecommendation(args?: Map_Type<string, any>, recommendationType?: string): void;
}
