// TypeScript definitions for the C3 type ReliabilityAssetAlertToCaseRelation

/**
 * Represents the relationship between a {@link ReliabilityAssetAlert} and a {@link ReliabilityAssetCase}.
 * This type links an alert that was triggered on a ReliabilityAsset to the case created to investigate
 * or resolve that alert. It helps track which alerts are being handled by specific cases.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityAssetAlertToCaseRelation
 */
declare interface IReliabilityAssetAlertToCaseRelation {
  ...
  /**
   * The {@link ReliabilityAssetAlert} in this relation.
   */
  from: IReliabilityAssetAlert;

  /**
   * The {@link ReliabilityAssetCase} in this relation.
   */
  to: IReliabilityAssetCase;

  /**
   * Whether or not this {@link ReliabilityAssetAlert} was added automatically to this {@link ReliabilityAssetCase}.
   */
  addedThroughAutomaticAlertGrouping?: boolean;

  /**
   * Displayed value for whether or not this {@link ReliabilityAssetAlert} was added automatically to this {@link ReliabilityAssetCase}.
   */
  displayedAddedThroughAutomaticAlertGrouping?: string;
}
 ...
 * or resolve that alert. It helps track which alerts are being handled by specific cases.
 *
 * @remarks this represents a made instance of ReliabilityAssetAlertToCaseRelation
 */
declare class ReliabilityAssetAlertToCaseRelation extends Obj  {
   ...
   */
  readonly id: string;
  withId(id: string): ReliabilityAssetAlertToCaseRelation;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityAssetAlertToCaseRelation;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): ReliabilityAssetAlertToCaseRelation;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): ReliabilityAssetAlertToCaseRelation;
  ...
  withVersion(version: number | null): ReliabilityAssetAlertToCaseRelation;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): ReliabilityAssetAlertToCaseRelation;

  /**
   * @inheritdoc
   */
  readonly facilityFilterPaths?: Array_Type<string>;
  withFacilityFilterPaths(facilityFilterPaths: Array_Type<string> | Array<string> | null): ReliabilityAssetAlertToCaseRelation;

  /**
   * The {@link ReliabilityAssetAlert} in this relation.
   */
  readonly from: ReliabilityAssetAlert;
  withFrom(from: IReliabilityAssetAlert): ReliabilityAssetAlertToCaseRelation;

  /**
   * The {@link ReliabilityAssetCase} in this relation.
   */
  readonly to: ReliabilityAssetCase;
  withTo(to: IReliabilityAssetCase): ReliabilityAssetAlertToCaseRelation;

  /**
   * Whether or not this {@link ReliabilityAssetAlert} was added automatically to this {@link ReliabilityAssetCase}.
   */
  readonly addedThroughAutomaticAlertGrouping?: boolean;
  withAddedThroughAutomaticAlertGrouping(addedThroughAutomaticAlertGrouping: boolean): ReliabilityAssetAlertToCaseRelation;

  /**
   * Displayed value for whether or not this {@link ReliabilityAssetAlert} was added automatically to this {@link ReliabilityAssetCase}.
   */
  readonly displayedAddedThroughAutomaticAlertGrouping?: string;
  withDisplayedAddedThroughAutomaticAlertGrouping(displayedAddedThroughAutomaticAlertGrouping: string | null): ReliabilityAssetAlertToCaseRelation;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ReliabilityAssetAlertToCaseRelation | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ReliabilityAssetAlertToCaseRelation | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ReliabilityAssetAlertToCaseRelation | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ReliabilityAssetAlertToCaseRelation | null;
   ...
   */
  replaceType(old: Type, new_: Type): ReliabilityAssetAlertToCaseRelation;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityAssetAlertToCaseRelation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityAssetAlertToCaseRelation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityAssetAlertToCaseRelation>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityAssetAlertToCaseRelation>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityAssetAlertToCaseRelation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityAssetAlertToCaseRelation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityAssetAlertToCaseRelation;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ReliabilityAssetAlertToCaseRelation;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ReliabilityAssetAlertToCaseRelation;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityAssetAlertToCaseRelation;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityAssetAlertToCaseRelation;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityAssetAlertToCaseRelation;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ReliabilityAssetAlertToCaseRelation;
   ...
   * @see #removeField
   */
  withoutField(field: string): ReliabilityAssetAlertToCaseRelation;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ReliabilityAssetAlertToCaseRelation;
   ...
   */
  withoutFields(fields: Array_Type<string>): ReliabilityAssetAlertToCaseRelation;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityAssetAlertToCaseRelation;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ReliabilityAssetAlertToCaseRelation;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityAssetAlertToCaseRelation;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ReliabilityAssetAlertToCaseRelation;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ReliabilityAssetAlertToCaseRelation;
   ...
   * @see #removeField
   */
  unsetField(field: string): ReliabilityAssetAlertToCaseRelation;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ReliabilityAssetAlertToCaseRelation;
   ...
   * @see #unsetField
   */
  removeField(field: string): ReliabilityAssetAlertToCaseRelation;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ReliabilityAssetAlertToCaseRelation;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityAssetAlertToCaseRelation;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityAssetAlertToCaseRelation;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityAssetAlertToCaseRelation;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityAssetAlertToCaseRelation;

  mergeJson(json: any): ReliabilityAssetAlertToCaseRelation;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityAssetAlertToCaseRelation;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ReliabilityAssetAlertToCaseRelation;
   ...
   */
  singletonArray(): Array_Type<ReliabilityAssetAlertToCaseRelation>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityAssetAlertToCaseRelation> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ReliabilityAssetAlertToCaseRelation> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ReliabilityAssetAlertToCaseRelation>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ReliabilityAssetAlertToCaseRelation> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ReliabilityAssetAlertToCaseRelation> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityAssetAlertToCaseRelation> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ReliabilityAssetAlertToCaseRelation>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ReliabilityAssetAlertToCaseRelation>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityAssetAlertToCaseRelation;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityAssetAlertToCaseRelation;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityAssetAlertToCaseRelation;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ReliabilityAssetAlertToCaseRelation;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityAssetAlertToCaseRelation;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ReliabilityAssetAlertToCaseRelation;
   ...
   * @see #fromString
   */
  static make(s: string): ReliabilityAssetAlertToCaseRelation | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityAssetAlertToCaseRelation;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ReliabilityAssetAlertToCaseRelation;
   ...
   */
  static cachedEmptyInst(): ReliabilityAssetAlertToCaseRelation;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityAssetAlertToCaseRelation> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ReliabilityAssetAlertToCaseRelation;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<ReliabilityAssetAlertToCaseRelation>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ReliabilityAssetAlertToCaseRelation>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityAssetAlertToCaseRelation> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityAssetAlertToCaseRelation>> | null;
   ...
   */
  get(include?: string): ReliabilityAssetAlertToCaseRelation | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): ReliabilityAssetAlertToCaseRelation | null;
   ...
   */
  getMissing(spec: GetMissingSpec): ReliabilityAssetAlertToCaseRelation;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): ReliabilityAssetAlertToCaseRelation | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): ReliabilityAssetAlertToCaseRelation;
   ...
   * @see #toString
   */
  static fromString(s: string): ReliabilityAssetAlertToCaseRelation | null;
   ...
   */
  create(spec?: UpsertSpec): ReliabilityAssetAlertToCaseRelation | null;
   ...
   */
  static createBatch(objs: Array_Type<ReliabilityAssetAlertToCaseRelation>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlertToCaseRelation> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ReliabilityAssetAlertToCaseRelation>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityAssetAlertToCaseRelation> | null;
   ...
   */
  update(srcObj?: ReliabilityAssetAlertToCaseRelation, spec?: UpsertSpec): ReliabilityAssetAlertToCaseRelation | null;
   ...
   */
  upsert(srcObj?: ReliabilityAssetAlertToCaseRelation, spec?: UpsertSpec): ReliabilityAssetAlertToCaseRelation | null;
   ...
   */
  merge(spec?: MergeSpec): ReliabilityAssetAlertToCaseRelation | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): ReliabilityAssetAlertToCaseRelation | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): ReliabilityAssetAlertToCaseRelation | null;
   ...
   */
  static updateBatch(objs: Array_Type<ReliabilityAssetAlertToCaseRelation>, srcObjs?: Array_Type<ReliabilityAssetAlertToCaseRelation>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlertToCaseRelation> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<ReliabilityAssetAlertToCaseRelation> | null>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlertToCaseRelation> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<ReliabilityAssetAlertToCaseRelation>, srcObjs?: Array_Type<ReliabilityAssetAlertToCaseRelation>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlertToCaseRelation> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<ReliabilityAssetAlertToCaseRelation> | null>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlertToCaseRelation> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<ReliabilityAssetAlertToCaseRelation>, spec?: TouchSpec): ObjList<ReliabilityAssetAlertToCaseRelation> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityAssetAlertToCaseRelation>, spec?: MergeSpec): ObjList<ReliabilityAssetAlertToCaseRelation> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityAssetAlertToCaseRelation>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityAssetAlertToCaseRelation> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<ReliabilityAssetAlertToCaseRelation> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityAssetAlertToCaseRelation> | null;
   ...
   */
  static mergeAll(mergeObj: ReliabilityAssetAlertToCaseRelation, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ReliabilityAssetAlertToCaseRelation, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<ReliabilityAssetAlertToCaseRelation>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlertToCaseRelation> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<ReliabilityAssetAlertToCaseRelation>, spec?: UpsertSpec): ObjList<ReliabilityAssetAlertToCaseRelation> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): ReliabilityAssetAlertToCaseRelation | null;
   ...
   */
  static beforeCreate(objs: Array_Type<ReliabilityAssetAlertToCaseRelation>): ObjList<ReliabilityAssetAlertToCaseRelation>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<ReliabilityAssetAlertToCaseRelation>): ObjList<ReliabilityAssetAlertToCaseRelation>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<ReliabilityAssetAlertToCaseRelation>): ObjList<ReliabilityAssetAlertToCaseRelation>;

  /**
   * Create a {@link ReliabilityAssetAlertToCaseRelationCaseActivity} and a {@link ReliabilityAssetAlertToCaseRelationAlertActivity} to log the action of adding a {@link ReliabilityAssetAlert}
   * to a {@link ReliabilityAssetCase}.
   */
  static afterCreate(objs: Array_Type<ReliabilityAssetAlertToCaseRelation>): Array_Type<ObjError> | null;
   ...
   */
  static afterUpdate(objs: Array_Type<ReliabilityAssetAlertToCaseRelation>): Array_Type<ObjError> | null;

  /**
   * Create a {@link ReliabilityAssetAlertToCaseRelationCaseActivity} and a {@link ReliabilityAssetAlertToCaseRelationAlertActivity} to log the action of removing a {@link ReliabilityAssetAlert}
   * from a {@link ReliabilityAssetCase}.
   */
  static afterRemove(objs: Array_Type<ReliabilityAssetAlertToCaseRelation>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityAssetAlertToCaseRelation>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityAssetAlertToCaseRelation>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): ReliabilityAssetAlertToCaseRelation | null;
   ...
   */
  withoutIdentity(): ReliabilityAssetAlertToCaseRelation | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<ReliabilityAssetAlertToCaseRelation>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: ReliabilityAssetAlertToCaseRelation, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<ReliabilityAssetAlertToCaseRelation>, callback?: λFunction<ReliabilityAssetAlertToCaseRelation | null, ReliabilityAssetAlertToCaseRelation | null>): ObjList<ReliabilityAssetAlertToCaseRelation>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<ReliabilityAssetAlertToCaseRelation>, callback?: λFunction<ReliabilityAssetAlertToCaseRelation | null, ReliabilityAssetAlertToCaseRelation | null>): Array_Type<ObjError> | null;
