// TypeScript definitions for the C3 type CaseCommentAttachment

/**
 * Type representing an attachment to a {@link CaseComment}
 *
 * @remarks this represents a value passed to a method that expects an instance of CaseCommentAttachment
 */
declare interface ICaseCommentAttachment {
 ...
 */
declare class CaseCommentAttachment extends Obj  {

  /**
   * The entity that is associated with the {@link File}
   */
  readonly parent: CaseComment;
  withParent(parent: ICaseComment): CaseCommentAttachment;

  /**
   * The {@link FileMeta} of the {@link File}
   */
  readonly fileMeta: FileMeta;
  withFileMeta(fileMeta: IFileMeta): CaseCommentAttachment;
   ...
   */
  readonly id: string;
  withId(id: string): CaseCommentAttachment;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): CaseCommentAttachment;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): CaseCommentAttachment;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): CaseCommentAttachment;
  ...
  withVersion(version: number | null): CaseCommentAttachment;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): CaseCommentAttachment;

  /**
   * @inheritdoc
   */
  readonly facilityFilterPaths?: Array_Type<string>;
  withFacilityFilterPaths(facilityFilterPaths: Array_Type<string> | Array<string> | null): CaseCommentAttachment;
   ...
   * @see #toJson
   */
  static fromJson(json: any): CaseCommentAttachment | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): CaseCommentAttachment | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): CaseCommentAttachment | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): CaseCommentAttachment | null;
   ...
   */
  replaceType(old: Type, new_: Type): CaseCommentAttachment;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): CaseCommentAttachment;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): CaseCommentAttachment;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<CaseCommentAttachment>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<CaseCommentAttachment>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): CaseCommentAttachment;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): CaseCommentAttachment;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): CaseCommentAttachment;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): CaseCommentAttachment;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): CaseCommentAttachment;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): CaseCommentAttachment;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): CaseCommentAttachment;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): CaseCommentAttachment;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): CaseCommentAttachment;
   ...
   * @see #removeField
   */
  withoutField(field: string): CaseCommentAttachment;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): CaseCommentAttachment;
   ...
   */
  withoutFields(fields: Array_Type<string>): CaseCommentAttachment;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): CaseCommentAttachment;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): CaseCommentAttachment;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): CaseCommentAttachment;
   ...
   * @see #unsetField
   */
  defaultField(field: string): CaseCommentAttachment;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): CaseCommentAttachment;
   ...
   * @see #removeField
   */
  unsetField(field: string): CaseCommentAttachment;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): CaseCommentAttachment;
   ...
   * @see #unsetField
   */
  removeField(field: string): CaseCommentAttachment;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): CaseCommentAttachment;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): CaseCommentAttachment;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): CaseCommentAttachment;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): CaseCommentAttachment;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): CaseCommentAttachment;

  mergeJson(json: any): CaseCommentAttachment;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): CaseCommentAttachment;
   ...
   */
  sumObj(other: Obj, deep?: boolean): CaseCommentAttachment;
   ...
   */
  singletonArray(): Array_Type<CaseCommentAttachment>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<CaseCommentAttachment> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<CaseCommentAttachment> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<CaseCommentAttachment>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<CaseCommentAttachment> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, CaseCommentAttachment> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, CaseCommentAttachment> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<CaseCommentAttachment>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<CaseCommentAttachment>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): CaseCommentAttachment;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): CaseCommentAttachment;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): CaseCommentAttachment;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): CaseCommentAttachment;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): CaseCommentAttachment;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): CaseCommentAttachment;
   ...
   * @see #fromString
   */
  static make(s: string): CaseCommentAttachment | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): CaseCommentAttachment;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): CaseCommentAttachment;
   ...
   */
  static cachedEmptyInst(): CaseCommentAttachment;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<CaseCommentAttachment> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): CaseCommentAttachment;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<CaseCommentAttachment>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<CaseCommentAttachment>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<CaseCommentAttachment> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<CaseCommentAttachment>> | null;
   ...
   */
  get(include?: string): CaseCommentAttachment | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): CaseCommentAttachment | null;
   ...
   */
  getMissing(spec: GetMissingSpec): CaseCommentAttachment;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): CaseCommentAttachment | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): CaseCommentAttachment;
   ...
   * @see #toString
   */
  static fromString(s: string): CaseCommentAttachment | null;
   ...
   */
  create(spec?: UpsertSpec): CaseCommentAttachment | null;
   ...
   */
  static createBatch(objs: Array_Type<CaseCommentAttachment>, spec?: UpsertSpec): ObjList<CaseCommentAttachment> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<CaseCommentAttachment>, spec?: CreateBatchObjStreamSpec): ObjList<CaseCommentAttachment> | null;
   ...
   */
  update(srcObj?: CaseCommentAttachment, spec?: UpsertSpec): CaseCommentAttachment | null;
   ...
   */
  upsert(srcObj?: CaseCommentAttachment, spec?: UpsertSpec): CaseCommentAttachment | null;
   ...
   */
  merge(spec?: MergeSpec): CaseCommentAttachment | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): CaseCommentAttachment | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): CaseCommentAttachment | null;
   ...
   */
  static updateBatch(objs: Array_Type<CaseCommentAttachment>, srcObjs?: Array_Type<CaseCommentAttachment>, spec?: UpsertSpec): ObjList<CaseCommentAttachment> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<CaseCommentAttachment> | null>, spec?: UpsertSpec): ObjList<CaseCommentAttachment> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<CaseCommentAttachment>, srcObjs?: Array_Type<CaseCommentAttachment>, spec?: UpsertSpec): ObjList<CaseCommentAttachment> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<CaseCommentAttachment> | null>, spec?: UpsertSpec): ObjList<CaseCommentAttachment> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<CaseCommentAttachment>, spec?: TouchSpec): ObjList<CaseCommentAttachment> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<CaseCommentAttachment>, spec?: MergeSpec): ObjList<CaseCommentAttachment> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<CaseCommentAttachment>, mergeInclude: string, spec?: MergeSpec): ObjList<CaseCommentAttachment> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<CaseCommentAttachment> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<CaseCommentAttachment> | null;
   ...
   */
  static mergeAll(mergeObj: CaseCommentAttachment, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: CaseCommentAttachment, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<CaseCommentAttachment>, spec?: UpsertSpec): ObjList<CaseCommentAttachment> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<CaseCommentAttachment>, spec?: UpsertSpec): ObjList<CaseCommentAttachment> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): CaseCommentAttachment | null;
   ...
   */
  static beforeCreate(objs: Array_Type<CaseCommentAttachment>): ObjList<CaseCommentAttachment>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<CaseCommentAttachment>): ObjList<CaseCommentAttachment>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<CaseCommentAttachment>): ObjList<CaseCommentAttachment>;
   ...
   */
  static afterCreate(objs: Array_Type<CaseCommentAttachment>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<CaseCommentAttachment>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<CaseCommentAttachment>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<CaseCommentAttachment>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<CaseCommentAttachment>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): CaseCommentAttachment | null;
   ...
   */
  withoutIdentity(): CaseCommentAttachment | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<CaseCommentAttachment>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: CaseCommentAttachment, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<CaseCommentAttachment>, callback?: λFunction<CaseCommentAttachment | null, CaseCommentAttachment | null>): ObjList<CaseCommentAttachment>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<CaseCommentAttachment>, callback?: λFunction<CaseCommentAttachment | null, CaseCommentAttachment | null>): Array_Type<ObjError> | null;
