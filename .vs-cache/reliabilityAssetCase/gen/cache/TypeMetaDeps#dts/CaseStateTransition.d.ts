// TypeScript definitions for the C3 type CaseStateTransition

/**
 * The {@link StateMachineTransition} representing a state transition for a CaseState.
 *
 * @remarks this represents a value passed to a method that expects an instance of CaseStateTransition
 */
declare interface ICaseStateTransition {
 ...
 */
declare class CaseStateTransition extends Obj  {
   ...
   */
  readonly id: string;
  withId(id: string): CaseStateTransition;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): CaseStateTransition;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): CaseStateTransition;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): CaseStateTransition;
  ...
  withVersion(version: number | null): CaseStateTransition;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): CaseStateTransition;
  ...
  withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): CaseStateTransition;
  ...
  withHidden(hidden: boolean): CaseStateTransition;
  ...
  withUserOwned(userOwned: boolean): CaseStateTransition;

  /**
   * List of {@link AclEntry} entries governing who can read/update/remove Objs.
   */
  readonly acl?: Array_Type<AclEntry>;
  withAcl(acl: Array_Type<AclEntry> | Array<IAclEntry> | null): CaseStateTransition;

  /**
   * The {@link StateMachineState} to transition from.
   */
  readonly from: CaseState;
  withFrom(from: ICaseState): CaseStateTransition;

  /**
   * The {@link StateMachineState} to transition to.
   */
  readonly to: CaseState;
  withTo(to: ICaseState): CaseStateTransition;

  /**
   * Used to soft delete a record so all state histories still have valid pointers.
   */
  readonly deleted?: boolean;
  withDeleted(deleted: boolean): CaseStateTransition;

  /**
   * A transition is only valid if the {@link from}, {@link to}, and itself are not deleted.
   */
  readonly isValid?: boolean;
  withIsValid(isValid: boolean): CaseStateTransition;

  /**
   * The trigger that must be satisfied in order for this transition to take place.
   */
  readonly trigger?: TransitionTrigger;
  withTrigger(trigger: ITransitionTrigger | null): CaseStateTransition;
  ...
  withCondition(condition: string | null): CaseStateTransition;

  /**
   * Used to include fields on the source type for exitAction and entryAction.
   */
  readonly includeSpec?: string;
  withIncludeSpec(includeSpec: string | null): CaseStateTransition;

  /**
   * The action to be taken during this {@link StateMachineTransition}.
   */
  readonly action?: λConsumer<any | null>;
  withAction(action: λConsumer<any | null> | null): CaseStateTransition;
   ...
   * @see #toJson
   */
  static fromJson(json: any): CaseStateTransition | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): CaseStateTransition | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): CaseStateTransition | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): CaseStateTransition | null;
   ...
   */
  replaceType(old: Type, new_: Type): CaseStateTransition;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): CaseStateTransition;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): CaseStateTransition;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<CaseStateTransition>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<CaseStateTransition>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): CaseStateTransition;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): CaseStateTransition;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): CaseStateTransition;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): CaseStateTransition;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): CaseStateTransition;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): CaseStateTransition;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): CaseStateTransition;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): CaseStateTransition;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): CaseStateTransition;
   ...
   * @see #removeField
   */
  withoutField(field: string): CaseStateTransition;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): CaseStateTransition;
   ...
   */
  withoutFields(fields: Array_Type<string>): CaseStateTransition;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): CaseStateTransition;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): CaseStateTransition;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): CaseStateTransition;
   ...
   * @see #unsetField
   */
  defaultField(field: string): CaseStateTransition;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): CaseStateTransition;
   ...
   * @see #removeField
   */
  unsetField(field: string): CaseStateTransition;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): CaseStateTransition;
   ...
   * @see #unsetField
   */
  removeField(field: string): CaseStateTransition;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): CaseStateTransition;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): CaseStateTransition;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): CaseStateTransition;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): CaseStateTransition;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): CaseStateTransition;

  mergeJson(json: any): CaseStateTransition;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): CaseStateTransition;
   ...
   */
  sumObj(other: Obj, deep?: boolean): CaseStateTransition;
   ...
   */
  singletonArray(): Array_Type<CaseStateTransition>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<CaseStateTransition> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<CaseStateTransition> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<CaseStateTransition>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<CaseStateTransition> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, CaseStateTransition> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, CaseStateTransition> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<CaseStateTransition>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<CaseStateTransition>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): CaseStateTransition;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): CaseStateTransition;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): CaseStateTransition;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): CaseStateTransition;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): CaseStateTransition;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): CaseStateTransition;
   ...
   * @see #fromString
   */
  static make(s: string): CaseStateTransition | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): CaseStateTransition;
   ...
   */
  static cachedEmptyInst(): CaseStateTransition;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<CaseStateTransition> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): CaseStateTransition;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<CaseStateTransition> | null;
   ...
   */
  static find(filter?: string, doNotProduceAll?: boolean): Stream<CaseStateTransition> | null;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<CaseStateTransition> | null;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): CaseStateTransition | null;
   ...
   * @see findByCacheKey
   */
  static forCacheKey(key: string): CaseStateTransition | null;
   ...
   * @see findByCacheKey
   */
  getCached(): CaseStateTransition | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): CaseStateTransition | null;
   ...
   */
  static produce(key: string): CaseStateTransition | null;
   ...
   */
  static produceAll(): Map_Type<string, CaseStateTransition> | null;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): Map_Type<string, CaseStateTransition> | null;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<CaseStateTransition>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<CaseStateTransition>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<CaseStateTransition> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<CaseStateTransition>> | null;
   ...
   */
  get(include?: string): CaseStateTransition | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): CaseStateTransition | null;
   ...
   */
  getMissing(spec: GetMissingSpec): CaseStateTransition;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): CaseStateTransition | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): CaseStateTransition;
   ...
   * @see #toString
   */
  static fromString(s: string): CaseStateTransition | null;
   ...
   */
  create(spec?: UpsertSpec): CaseStateTransition | null;
   ...
   */
  static createBatch(objs: Array_Type<CaseStateTransition>, spec?: UpsertSpec): ObjList<CaseStateTransition> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<CaseStateTransition>, spec?: CreateBatchObjStreamSpec): ObjList<CaseStateTransition> | null;
   ...
   */
  update(srcObj?: CaseStateTransition, spec?: UpsertSpec): CaseStateTransition | null;
   ...
   */
  upsert(srcObj?: CaseStateTransition, spec?: UpsertSpec): CaseStateTransition | null;
   ...
   */
  merge(spec?: MergeSpec): CaseStateTransition | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): CaseStateTransition | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): CaseStateTransition | null;
   ...
   */
  static updateBatch(objs: Array_Type<CaseStateTransition>, srcObjs?: Array_Type<CaseStateTransition>, spec?: UpsertSpec): ObjList<CaseStateTransition> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<CaseStateTransition> | null>, spec?: UpsertSpec): ObjList<CaseStateTransition> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<CaseStateTransition>, srcObjs?: Array_Type<CaseStateTransition>, spec?: UpsertSpec): ObjList<CaseStateTransition> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<CaseStateTransition> | null>, spec?: UpsertSpec): ObjList<CaseStateTransition> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<CaseStateTransition>, spec?: TouchSpec): ObjList<CaseStateTransition> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<CaseStateTransition>, spec?: MergeSpec): ObjList<CaseStateTransition> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<CaseStateTransition>, mergeInclude: string, spec?: MergeSpec): ObjList<CaseStateTransition> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<CaseStateTransition> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<CaseStateTransition> | null;
   ...
   */
  static mergeAll(mergeObj: CaseStateTransition, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: CaseStateTransition, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<CaseStateTransition>, spec?: UpsertSpec): ObjList<CaseStateTransition> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<CaseStateTransition>, spec?: UpsertSpec): ObjList<CaseStateTransition> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): CaseStateTransition | null;
   ...
   */
  static beforeCreate(objs: Array_Type<CaseStateTransition>): ObjList<CaseStateTransition>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<CaseStateTransition>): ObjList<CaseStateTransition>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<CaseStateTransition>): ObjList<CaseStateTransition>;
   ...
   */
  static afterCreate(objs: Array_Type<CaseStateTransition>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<CaseStateTransition>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<CaseStateTransition>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<CaseStateTransition>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<CaseStateTransition>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): CaseStateTransition | null;
   ...
   */
  withoutIdentity(): CaseStateTransition | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<CaseStateTransition>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: CaseStateTransition, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<CaseStateTransition>, callback?: λFunction<CaseStateTransition | null, CaseStateTransition | null>): ObjList<CaseStateTransition>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<CaseStateTransition>, callback?: λFunction<CaseStateTransition | null, CaseStateTransition | null>): Array_Type<ObjError> | null;
   ...
   */
  publish(subPath?: string, contentType?: string): CaseStateTransition;
   ...
   */
  static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<CaseStateTransition> | null;
   ...
   */
  createSeedData(spec?: UpsertSpec): CaseStateTransition | null;
   ...
   */
  static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<CaseStateTransition> | null;
   ...
   */
  updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): CaseStateTransition | null;
   ...
   */
  static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<CaseStateTransition> | null;
   ...
   * @return updated obj instance, same as {@link Persistable#update} return value.
   */
  clearUserUpdates(spec?: MergeSpec): CaseStateTransition | null;
   ...
   *         {@link Persistable#updateBatch}.
   */
  static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<CaseStateTransition> | null;
  ...
  dependencies(): SeedDataDeps<CaseStateTransition> | null;
   ...
   */
  static populateAcl(objs?: Array_Type<CaseStateTransition>): number | null;
   ...
   */
  grantMemberReadUpdateRemove(member: AccessControlEntity): CaseStateTransition;
   ...
   */
  mergeAclEntry(entry: AclEntry): CaseStateTransition;
   ...
   * @return the obj with the new acl after merging the indicated entry.
   */
  mergeAclEntries(entries: Array_Type<AclEntry>): CaseStateTransition;
