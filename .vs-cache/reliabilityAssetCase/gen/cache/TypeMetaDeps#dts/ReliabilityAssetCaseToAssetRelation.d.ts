// TypeScript definitions for the C3 type ReliabilityAssetCaseToAssetRelation

/**
 * Represents the relationship between a {@link ReliabilityAssetCase} and a {@link ReliabilityAsset}.
 * This type links a case to the specific asset being investigated or monitored, ensuring that all
 * investigations, alerts, and work orders are tied to the correct asset.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityAssetCaseToAssetRelation
 */
declare interface IReliabilityAssetCaseToAssetRelation {
   ...
   */
  from: IReliabilityAssetCase;

  /**
   * The {@link ReliabilityAsset} in this relation.
   */
 ...
 * investigations, alerts, and work orders are tied to the correct asset.
 *
 * @remarks this represents a made instance of ReliabilityAssetCaseToAssetRelation
 */
declare class ReliabilityAssetCaseToAssetRelation extends Obj  {
   ...
   */
  readonly id: string;
  withId(id: string): ReliabilityAssetCaseToAssetRelation;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityAssetCaseToAssetRelation;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): ReliabilityAssetCaseToAssetRelation;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): ReliabilityAssetCaseToAssetRelation;
  ...
  withVersion(version: number | null): ReliabilityAssetCaseToAssetRelation;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): ReliabilityAssetCaseToAssetRelation;

  /**
   * @inheritdoc
   */
  readonly facilityFilterPaths?: Array_Type<string>;
  withFacilityFilterPaths(facilityFilterPaths: Array_Type<string> | Array<string> | null): ReliabilityAssetCaseToAssetRelation;

  /**
   * The {@link ReliabilityAssetCase} in this relation.
   */
  readonly from: ReliabilityAssetCase;
  withFrom(from: IReliabilityAssetCase): ReliabilityAssetCaseToAssetRelation;

  /**
   * The {@link ReliabilityAsset} in this relation.
   */
  readonly to: ReliabilityAsset;
  withTo(to: IReliabilityAsset): ReliabilityAssetCaseToAssetRelation;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ReliabilityAssetCaseToAssetRelation | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ReliabilityAssetCaseToAssetRelation | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ReliabilityAssetCaseToAssetRelation | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ReliabilityAssetCaseToAssetRelation | null;
   ...
   */
  replaceType(old: Type, new_: Type): ReliabilityAssetCaseToAssetRelation;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityAssetCaseToAssetRelation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityAssetCaseToAssetRelation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityAssetCaseToAssetRelation>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityAssetCaseToAssetRelation>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityAssetCaseToAssetRelation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityAssetCaseToAssetRelation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityAssetCaseToAssetRelation;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ReliabilityAssetCaseToAssetRelation;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ReliabilityAssetCaseToAssetRelation;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityAssetCaseToAssetRelation;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityAssetCaseToAssetRelation;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityAssetCaseToAssetRelation;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ReliabilityAssetCaseToAssetRelation;
   ...
   * @see #removeField
   */
  withoutField(field: string): ReliabilityAssetCaseToAssetRelation;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ReliabilityAssetCaseToAssetRelation;
   ...
   */
  withoutFields(fields: Array_Type<string>): ReliabilityAssetCaseToAssetRelation;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityAssetCaseToAssetRelation;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ReliabilityAssetCaseToAssetRelation;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityAssetCaseToAssetRelation;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ReliabilityAssetCaseToAssetRelation;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ReliabilityAssetCaseToAssetRelation;
   ...
   * @see #removeField
   */
  unsetField(field: string): ReliabilityAssetCaseToAssetRelation;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ReliabilityAssetCaseToAssetRelation;
   ...
   * @see #unsetField
   */
  removeField(field: string): ReliabilityAssetCaseToAssetRelation;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ReliabilityAssetCaseToAssetRelation;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityAssetCaseToAssetRelation;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityAssetCaseToAssetRelation;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityAssetCaseToAssetRelation;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityAssetCaseToAssetRelation;

  mergeJson(json: any): ReliabilityAssetCaseToAssetRelation;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityAssetCaseToAssetRelation;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ReliabilityAssetCaseToAssetRelation;
   ...
   */
  singletonArray(): Array_Type<ReliabilityAssetCaseToAssetRelation>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityAssetCaseToAssetRelation> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ReliabilityAssetCaseToAssetRelation> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ReliabilityAssetCaseToAssetRelation>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ReliabilityAssetCaseToAssetRelation> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ReliabilityAssetCaseToAssetRelation> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityAssetCaseToAssetRelation> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ReliabilityAssetCaseToAssetRelation>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ReliabilityAssetCaseToAssetRelation>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityAssetCaseToAssetRelation;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityAssetCaseToAssetRelation;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityAssetCaseToAssetRelation;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ReliabilityAssetCaseToAssetRelation;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityAssetCaseToAssetRelation;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ReliabilityAssetCaseToAssetRelation;
   ...
   * @see #fromString
   */
  static make(s: string): ReliabilityAssetCaseToAssetRelation | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityAssetCaseToAssetRelation;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ReliabilityAssetCaseToAssetRelation;
   ...
   */
  static cachedEmptyInst(): ReliabilityAssetCaseToAssetRelation;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityAssetCaseToAssetRelation> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ReliabilityAssetCaseToAssetRelation;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<ReliabilityAssetCaseToAssetRelation>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ReliabilityAssetCaseToAssetRelation>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityAssetCaseToAssetRelation> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityAssetCaseToAssetRelation>> | null;
   ...
   */
  get(include?: string): ReliabilityAssetCaseToAssetRelation | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): ReliabilityAssetCaseToAssetRelation | null;
   ...
   */
  getMissing(spec: GetMissingSpec): ReliabilityAssetCaseToAssetRelation;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): ReliabilityAssetCaseToAssetRelation | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): ReliabilityAssetCaseToAssetRelation;
   ...
   * @see #toString
   */
  static fromString(s: string): ReliabilityAssetCaseToAssetRelation | null;
   ...
   */
  create(spec?: UpsertSpec): ReliabilityAssetCaseToAssetRelation | null;
   ...
   */
  static createBatch(objs: Array_Type<ReliabilityAssetCaseToAssetRelation>, spec?: UpsertSpec): ObjList<ReliabilityAssetCaseToAssetRelation> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ReliabilityAssetCaseToAssetRelation>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityAssetCaseToAssetRelation> | null;
   ...
   */
  update(srcObj?: ReliabilityAssetCaseToAssetRelation, spec?: UpsertSpec): ReliabilityAssetCaseToAssetRelation | null;
   ...
   */
  upsert(srcObj?: ReliabilityAssetCaseToAssetRelation, spec?: UpsertSpec): ReliabilityAssetCaseToAssetRelation | null;
   ...
   */
  merge(spec?: MergeSpec): ReliabilityAssetCaseToAssetRelation | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): ReliabilityAssetCaseToAssetRelation | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): ReliabilityAssetCaseToAssetRelation | null;
   ...
   */
  static updateBatch(objs: Array_Type<ReliabilityAssetCaseToAssetRelation>, srcObjs?: Array_Type<ReliabilityAssetCaseToAssetRelation>, spec?: UpsertSpec): ObjList<ReliabilityAssetCaseToAssetRelation> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<ReliabilityAssetCaseToAssetRelation> | null>, spec?: UpsertSpec): ObjList<ReliabilityAssetCaseToAssetRelation> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<ReliabilityAssetCaseToAssetRelation>, srcObjs?: Array_Type<ReliabilityAssetCaseToAssetRelation>, spec?: UpsertSpec): ObjList<ReliabilityAssetCaseToAssetRelation> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<ReliabilityAssetCaseToAssetRelation> | null>, spec?: UpsertSpec): ObjList<ReliabilityAssetCaseToAssetRelation> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<ReliabilityAssetCaseToAssetRelation>, spec?: TouchSpec): ObjList<ReliabilityAssetCaseToAssetRelation> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityAssetCaseToAssetRelation>, spec?: MergeSpec): ObjList<ReliabilityAssetCaseToAssetRelation> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityAssetCaseToAssetRelation>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityAssetCaseToAssetRelation> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<ReliabilityAssetCaseToAssetRelation> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityAssetCaseToAssetRelation> | null;
   ...
   */
  static mergeAll(mergeObj: ReliabilityAssetCaseToAssetRelation, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ReliabilityAssetCaseToAssetRelation, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<ReliabilityAssetCaseToAssetRelation>, spec?: UpsertSpec): ObjList<ReliabilityAssetCaseToAssetRelation> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<ReliabilityAssetCaseToAssetRelation>, spec?: UpsertSpec): ObjList<ReliabilityAssetCaseToAssetRelation> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): ReliabilityAssetCaseToAssetRelation | null;
   ...
   */
  static beforeCreate(objs: Array_Type<ReliabilityAssetCaseToAssetRelation>): ObjList<ReliabilityAssetCaseToAssetRelation>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<ReliabilityAssetCaseToAssetRelation>): ObjList<ReliabilityAssetCaseToAssetRelation>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<ReliabilityAssetCaseToAssetRelation>): ObjList<ReliabilityAssetCaseToAssetRelation>;
   ...
   */
  static afterCreate(objs: Array_Type<ReliabilityAssetCaseToAssetRelation>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<ReliabilityAssetCaseToAssetRelation>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<ReliabilityAssetCaseToAssetRelation>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityAssetCaseToAssetRelation>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityAssetCaseToAssetRelation>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): ReliabilityAssetCaseToAssetRelation | null;
   ...
   */
  withoutIdentity(): ReliabilityAssetCaseToAssetRelation | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<ReliabilityAssetCaseToAssetRelation>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: ReliabilityAssetCaseToAssetRelation, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<ReliabilityAssetCaseToAssetRelation>, callback?: λFunction<ReliabilityAssetCaseToAssetRelation | null, ReliabilityAssetCaseToAssetRelation | null>): ObjList<ReliabilityAssetCaseToAssetRelation>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<ReliabilityAssetCaseToAssetRelation>, callback?: λFunction<ReliabilityAssetCaseToAssetRelation | null, ReliabilityAssetCaseToAssetRelation | null>): Array_Type<ObjError> | null;
