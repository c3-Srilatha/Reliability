...
# Python definitions for the C3 type ReliabilityPriorityEnum


class ReliabilityPriorityEnum():
    """
    ...
    """
    def __init__(self, P0: Optional[str]=None, P1: Optional[str]=None, P2: Optional[str]=None) -> None: ...
