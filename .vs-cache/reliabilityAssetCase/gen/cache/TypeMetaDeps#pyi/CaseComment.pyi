...
from c3.fileAttachment.UploadAttachmentSpec import UploadAttachmentSpec
...
from c3.reliabilityAssetCase.CaseCommentAttachment import CaseCommentAttachment
...
# Python definitions for the C3 type CaseComment


class CaseComment(FileAttachmentParent[CaseCommentAttachment], UserInformation, CommentMixin, TaggedComment[ReliabilityAssetCase], FilterableByFacility):
    """
    Type representing comment on a {@link ReliabilityAssetCase}
    
    @remarks this represents a made instance of CaseComment
    """
    
    fileAttachments: Optional[Array[CaseCommentAttachment]]=None
    """
    The file attachments associated with this parent object.
    """
    ...
    isCloseComment: Optional[bool]=None
    """
    Flag indicating if the comment was made when closing a case.
    """
    ...
    """
    Raw comment that may contained tagged users.
    
    To tag a user will use `[~userId]` format.
    """

    parent: Optional[ReliabilityAssetCase]
    """
    The entity this message is a comment for.
    """

    taggedUsers: Optional[Array[User]]=None
    """
    List of users mentioned in comment.
    
    This be the list of recipients of the notification.
    """

    url: Optional[str]=None
    """
    If exists, the page url the tagged mention was submitted from.
    
    A user will use this link to go directly to page that contains this mentioned comment.
    """
    ...
    @inheritdoc
    """
    def __init__(self, fileAttachments: Optional[Array[CaseCommentAttachment]]=None, createdByUser: Optional[User]=None, isCloseComment: Optional[bool]=None, id: Optional[str]=None, versionEdits: Optional[Array[VersionEdit]]=None, name: Optional[str]=None, meta: Optional[Meta]=None, version: Optional[int]=None, typeWithBindings: Optional[Type]=None, comment: Optional[str]=None, parent: Optional[ReliabilityAssetCase]=None, taggedUsers: Optional[Array[User]]=None, url: Optional[str]=None, facilityFilterPaths: Optional[Array[str]]=None) -> None: ...
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[CaseComment]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[CaseComment]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[CaseComment]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[CaseComment]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> CaseComment:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> CaseComment:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> CaseComment:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[CaseComment]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[CaseComment]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> CaseComment:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> CaseComment:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> CaseComment:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> CaseComment:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> CaseComment:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> CaseComment:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> CaseComment:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> CaseComment:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> CaseComment:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> CaseComment:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> CaseComment:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> CaseComment:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> CaseComment:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> CaseComment:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> CaseComment:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> CaseComment:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> CaseComment:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> CaseComment:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> CaseComment:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> CaseComment:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> CaseComment:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> CaseComment:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> CaseComment:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> CaseComment:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> CaseComment:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> CaseComment:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> CaseComment:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> CaseComment:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[CaseComment]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[CaseComment]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[CaseComment]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[CaseComment]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[CaseComment]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, CaseComment]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, CaseComment]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[CaseComment]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[CaseComment]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> CaseComment:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> CaseComment:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> CaseComment:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> CaseComment:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> CaseComment:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> CaseComment:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[CaseComment]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> CaseComment:
    """
    ...
    """
        ...
    def afterMake(self) -> CaseComment:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> CaseComment:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[CaseComment]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> CaseComment:
    """
    ...
    """
        ...
    @classmethod
    def downloadAttachments(cls, fileMetas: Array[FileMeta], rootFolder: str='\'zip\'') -> Union[str]:
    """
    Returns a relative file endpoint url for the files passed as arguments
    
    @param fileMetas
           Array of {@link FileMeta} of attachments we want to download
    @param rootFolder
           When zipping is required, the zip file is saved to `{rootFolder}/{current date}/` directory in
           FileSystemMount.ATTACHMENT mount.
    @return If a single file is requested its relative file endpoint url is returned. If multiple files are requested,
            relative file endpoint url of a zip archive containing all the files is returned
    """
        ...
    @classmethod
    def zipFiles(cls, fileMetas: Array[FileMeta], rootFolder: str='\'zip\'') -> File:
    """
    Generates a zip archive containing all the files passed as arguments
    
    @param fileMetas
           Array of {@link FileMeta}s which should be included in the zip archive
    @param rootFolder
           The zip file is saved to `{rootFolder}/{current date}/` directory in
           FileSystemMount.ATTACHMENT mount.
    @return The zip file
    """
        ...
    def uploadAttachment(self, spec: UploadAttachmentSpec) -> Union[CaseCommentAttachment]:
    """
    Save the given new file in {@link FileSystemMount#ATTACHMENT}, update its ACL,
    and create the corresponding file attachment instance
    
    @param spec
           The specification on what and how to upload the file
    @return The created file attachment instance for this attachment
    """
        ...
    @classmethod
    def createFileMeta(cls, spec: UploadAttachmentSpec) -> Union[FileMeta]:
    """
    Save the given new file in FileSystemMount.ATTACHMENT, update its ACL.
    @param spec
           The specification on what and how to upload the file
    @return The created file meta
    """
        ...
    def createFileAttachment(self, fileMeta: FileMeta) -> Union[CaseCommentAttachment]:
    """
    Create corresponding file attachment for a FileMeta.
    @param fileMeta
           The FileMeta for the file attachment.
    @return The file attachment instance
    """
        ...
    @classmethod
    def getDownloadUrl(cls, comments: Array[CaseComment]) -> Union[str]:
    """
    Return a url to download a single file or group of files as a zip. The files are the {@link FileAttachment} that
    are linked to the comments passed into the function.
    @param comments The list of comments with file attachments.
    @return The download URL as a string.
    """
        ...
    @classmethod
    def getUploadConfig(cls) -> Union[any]:
    """
    Returns a configuration object to upload files to the server.
    @return JSON object with the keys: `{env: <env>, app: <app>}`.
    """
        ...
    @classmethod
    def fetchCommentsWithAttachments(cls, spec: FetchSpec=None) -> FetchResult[CaseComment]:
    """
    Fetch comments that have attachments.
    @param spec
           The filter criteria for fetching comments.
    @return A list of comments with attachments.
    """
        ...
    @classmethod
    def fetchCountCommentsWithAttachments(cls, spec: FetchSpec=None) -> int:
    """
    Fetch count of comments that have attachments.
    @param spec
           The filter criteria for fetching comment count.
    @return Count of comments with attachments.
    """
        ...
    @classmethod
    def removeCommentsAndAttachments(cls, commentIds: Array[str], parent: str) -> Union[Array[str]]:
    """
    Removes a comment and any attachments associated with it.
    @param commentIds
           List of comment IDs to remove.
    @param parent
           The ID of the parent entity associated with the comment.
    @return List of removed comment IDs.
    """
        ...
    @overload
    @classmethod
    def fetch(cls, spec: FetchSpec=None) -> FetchResult[CaseComment]:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, filter: Filter) -> FetchResult[CaseComment]:
    """
    ...
    """
        ...
    @classmethod
    def fetchObjStream(cls, spec: FetchStreamSpec=None) -> Union[Stream[CaseComment]]:
    """
    Fetches multiple obj instances based on a specification.  Only objs that the caller is authorized to fetch will be
    returned.
    ...
    """
        ...
    @classmethod
    def fetchMultiLocale(cls, spec: MultiLocaleFetchSpec=None) -> Union[Map[str, FetchResult[CaseComment]]]:
    """
    ...
    """
        ...
    def get(self, include: str=None) -> Union[CaseComment]:
    """
    ...
    """
        ...
    def getSpecific(self, include: str=None) -> Union[CaseComment]:
    """
    ...
    """
        ...
    def getMissing(self, spec: GetMissingSpec) -> CaseComment:
    """
    ...
    """
        ...
    def getDirect(self, include: str=None) -> Union[CaseComment]:
    """
    ...
    """
        ...
    def applyReverseEdit(self, versionEdit: VersionEdit) -> CaseComment:
    """
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[CaseComment]:
    """
    ...
    """
        ...
    def create(self, spec: UpsertSpec=None) -> Union[CaseComment]:
    """
    ...
    """
        ...
    @classmethod
    def createBatch(cls, objs: Array[CaseComment], spec: UpsertSpec=None) -> Union[ObjList[CaseComment]]:
    """
    ...
    """
        ...
    @classmethod
    def createBatchObjStream(cls, objs: Stream[CaseComment], spec: CreateBatchObjStreamSpec=None) -> Union[ObjList[CaseComment]]:
    """
    Creates multiple instances of a C3 type. If the operation fails and {@link UpsertSpec#dontThrowOnBatchError} is not
    specified (the default), then a C3BatchException will be thrown.  Otherwise {@link errors will be reported in the
    returned {@link ObjList}.  This will fail if any of the instances already exist.
    ...
    """
        ...
    def update(self, srcObj: CaseComment=None, spec: UpsertSpec=None) -> Union[CaseComment]:
    """
    ...
    """
        ...
    def upsert(self, srcObj: CaseComment=None, spec: UpsertSpec=None) -> Union[CaseComment]:
    """
    ...
    """
        ...
    @overload
    def merge(self, spec: MergeSpec=None) -> Union[CaseComment]:
    """
    ...
    """
        ...
    @overload
    def merge(self, mergeInclude: str, spec: MergeSpec=None) -> Union[CaseComment]:
    """
    ...
    """
        ...
    def touch(self, spec: TouchSpec=None) -> Union[CaseComment]:
    """
    ...
    """
        ...
    @classmethod
    def updateBatch(cls, objs: Array[CaseComment], srcObjs: Array[CaseComment]=None, spec: UpsertSpec=None) -> Union[ObjList[CaseComment]]:
    """
    ...
    """
        ...
    @classmethod
    def updateObjs(cls, objs: Callable[[], Union[Array[CaseComment]]], spec: UpsertSpec=None) -> Union[ObjList[CaseComment]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertBatch(cls, objs: Array[CaseComment], srcObjs: Array[CaseComment]=None, spec: UpsertSpec=None) -> Union[ObjList[CaseComment]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertObjs(cls, objs: Callable[[], Union[Array[CaseComment]]], spec: UpsertSpec=None) -> Union[ObjList[CaseComment]]:
    """
    Creates instances of a C3 type if they don't already exist and updates them if they do exist. If the operation
    ...
    """
        ...
    @classmethod
    def touchBatch(cls, objs: Array[CaseComment], spec: TouchSpec=None) -> Union[ObjList[CaseComment]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[CaseComment], spec: MergeSpec=None) -> Union[ObjList[CaseComment]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[CaseComment], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[CaseComment]]:
    """
    Merges multiple instances of a C3 type or creates them if they don't exist. If the operation fails and {@link
    UpsertSpec#dontThrowOnBatchError} is not specified (the default), then a C3BatchException will be thrown.
    Otherwise errors will be reported in the returned {@link ObjList}.  The merge operation is described in the {@link
    ...
    """
        ...
    @classmethod
    def mergeObjs(cls, objs: Callable[[], Union[Array[CaseComment]]], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[CaseComment]]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: CaseComment, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: CaseComment, mergeInclude: str, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def removeBatch(cls, objs: Array[CaseComment], spec: UpsertSpec=None) -> Union[ObjList[CaseComment]]:
    """
    ...
    """
        ...
    @classmethod
    def replace(cls, objs: Array[CaseComment], spec: UpsertSpec=None) -> Union[ObjList[CaseComment]]:
    """
    ...
    """
        ...
    def unremove(self) -> Union[CaseComment]:
    """
    ...
    """
        ...
    @classmethod
    def beforeCreate(cls, objs: Array[CaseComment]) -> ObjList[CaseComment]:
    """
    ...
    """
        ...
    @classmethod
    def beforeUpdate(cls, objs: Array[CaseComment]) -> ObjList[CaseComment]:
    """
    ...
    """
        ...
    @classmethod
    def beforeRemove(cls, objs: Array[CaseComment]) -> ObjList[CaseComment]:
    """
    ...
    """
        ...
    @classmethod
    def afterCreate(cls, objs: Array[CaseComment]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterUpdate(cls, objs: Array[CaseComment]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterRemove(cls, objs: Array[CaseComment]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def startImportData(cls, spec: StartImportDataSpec=None) -> PushStream[CaseComment]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    @classmethod
    def startImportDataWithStats(cls, spec: StartImportDataSpec=None) -> PushStreamWithStats[CaseComment]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[CaseComment]:
    """
    ...
    """
        ...
    def withoutIdentity(self) -> Union[CaseComment]:
    """
    ...
    """
        ...
    @classmethod
    def typeOfBatch(cls, objs: Array[CaseComment]) -> Union[Array[EntityType]]:
    """
    ...
    """
        ...
    @classmethod
    def dbEcho(cls, template: CaseComment=None, count: int=None, sendBack: bool=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def callbackLogic(cls, objs: Array[CaseComment], callback: Callable[[Union[CaseComment]], Union[CaseComment]]=None) -> ObjList[CaseComment]:
    """
    ...
    """
        ...
    @classmethod
    def afterCallbackLogic(cls, objs: Array[CaseComment], callback: Callable[[Union[CaseComment]], Union[CaseComment]]=None) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    def createNotificationSubject(self) -> Union[str]:
    """
    This method is called in beforeCreate to create the subject for NotificationUserRecipient.scheduleNotificationToUsers
    Developers can override this function to have different subject formats for different types of tagged comments.
    
    @return A string of the notification subject.
    """
        ...
    def createNotificationContent(self) -> Union[str]:
    """
    This method is called in beforeCreate to create the content for NotificationUserRecipient.scheduleNotificationToUsers
    Developers can override this function to have different content formats for different types of tagged comments.
    
    @return A string of the notification content.
    """
        ...
    @classmethod
