...
# Python definitions for the C3 type CaseCodeEnum
...
class CaseCodeEnum():
    ...
    SENSOR_ISSUE: Optional[str]=None
    """
    ...
    """
    def __init__(self, GOOD_CATCH: Optional[str]=None, FALSE_ALARM: Optional[str]=None, SENSOR_ISSUE: Optional[str]=None, DATA_ISSUE: Optional[str]=None) -> None: ...
