...
# Python definitions for the C3 type CaseEstimatedDowntimeAvoidedEnum


class CaseEstimatedDowntimeAvoidedEnum():
    """
    ...
    ZERO_TO_SIX: Optional[str]=None
    """
    Represents a case where the downtime avoided is between 0 and 6 hours.
    """

    SIX_TO_TWELVE: Optional[str]=None
    """
    Indicates that downtime avoided is between 6 and 12 hours.
    """

    TWELVE_TO_FORTY_EIGHT: Optional[str]=None
    """
    Represents downtime avoided between 12 and 48 hours.
    """

    FORTY_EIGHT_PLUS: Optional[str]=None
    """
    Indicates downtime avoided is greater than 48 hours.
    """
    def __init__(self, ZERO_TO_SIX: Optional[str]=None, SIX_TO_TWELVE: Optional[str]=None, TWELVE_TO_FORTY_EIGHT: Optional[str]=None, FORTY_EIGHT_PLUS: Optional[str]=None) -> None: ...
