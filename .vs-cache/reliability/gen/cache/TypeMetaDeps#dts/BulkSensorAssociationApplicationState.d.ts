// TypeScript definitions for the C3 type BulkSensorAssociationApplicationState

/**
 * Application state that stores all the UI logic Build Sensor Association.
 *
 * @remarks this represents a value passed to a method that expects an instance of BulkSensorAssociationApplicationState
 */
declare interface IBulkSensorAssociationApplicationState {
   ...
   */
  settings?: IBulkSensorAssociationUiSettings;
   ...
   */
  checkingSensorAssociationValidity?: boolean;
   ...
   */
  currentlyOpenSensorAssociationJob?: IReliabilityAssetSensorAssociationJob;

  /**
   * Indicates that the user is currently in this workflow. Used to prevent closing the modal without confirmation.
   */
  sensorAssociationWorkflowInProgress?: boolean;
 ...
 */
declare class BulkSensorAssociationApplicationState extends Obj  {
  ...
  withEffectTriggers(effectTriggers: Array_Type<UiSdlEffectTrigger> | Array<IUiSdlEffectTrigger> | null): BulkSensorAssociationApplicationState;

  /**
   * Settings set by users from the Bulk Sensor Association UI.
   */
  readonly settings?: BulkSensorAssociationUiSettings;
   ...
   * The currently open {@link ReliabilityAssetSensorAssociationJob} in the Sensor Correlation Grid on the Model Management, Jobs Page
   */
  readonly currentlyOpenSensorAssociationJob?: ReliabilityAssetSensorAssociationJob;
   ...
   * @see #toJson
   */
  static fromJson(json: any): BulkSensorAssociationApplicationState | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): BulkSensorAssociationApplicationState | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): BulkSensorAssociationApplicationState | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): BulkSensorAssociationApplicationState | null;
   ...
   */
  replaceType(old: Type, new_: Type): BulkSensorAssociationApplicationState;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): BulkSensorAssociationApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): BulkSensorAssociationApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<BulkSensorAssociationApplicationState>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<BulkSensorAssociationApplicationState>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): BulkSensorAssociationApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): BulkSensorAssociationApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): BulkSensorAssociationApplicationState;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): BulkSensorAssociationApplicationState;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): BulkSensorAssociationApplicationState;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): BulkSensorAssociationApplicationState;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): BulkSensorAssociationApplicationState;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): BulkSensorAssociationApplicationState;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): BulkSensorAssociationApplicationState;
   ...
   * @see #removeField
   */
  withoutField(field: string): BulkSensorAssociationApplicationState;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): BulkSensorAssociationApplicationState;
   ...
   */
  withoutFields(fields: Array_Type<string>): BulkSensorAssociationApplicationState;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): BulkSensorAssociationApplicationState;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): BulkSensorAssociationApplicationState;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): BulkSensorAssociationApplicationState;
   ...
   * @see #unsetField
   */
  defaultField(field: string): BulkSensorAssociationApplicationState;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): BulkSensorAssociationApplicationState;
   ...
   * @see #removeField
   */
  unsetField(field: string): BulkSensorAssociationApplicationState;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): BulkSensorAssociationApplicationState;
   ...
   * @see #unsetField
   */
  removeField(field: string): BulkSensorAssociationApplicationState;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): BulkSensorAssociationApplicationState;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): BulkSensorAssociationApplicationState;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): BulkSensorAssociationApplicationState;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): BulkSensorAssociationApplicationState;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): BulkSensorAssociationApplicationState;

  mergeJson(json: any): BulkSensorAssociationApplicationState;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): BulkSensorAssociationApplicationState;
   ...
   */
  sumObj(other: Obj, deep?: boolean): BulkSensorAssociationApplicationState;
   ...
   */
  singletonArray(): Array_Type<BulkSensorAssociationApplicationState>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<BulkSensorAssociationApplicationState> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<BulkSensorAssociationApplicationState> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<BulkSensorAssociationApplicationState>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<BulkSensorAssociationApplicationState> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, BulkSensorAssociationApplicationState> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, BulkSensorAssociationApplicationState> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<BulkSensorAssociationApplicationState>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<BulkSensorAssociationApplicationState>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): BulkSensorAssociationApplicationState;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): BulkSensorAssociationApplicationState;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): BulkSensorAssociationApplicationState;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): BulkSensorAssociationApplicationState;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): BulkSensorAssociationApplicationState;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): BulkSensorAssociationApplicationState;
   ...
   * @see #fromString
   */
  static make(s: string): BulkSensorAssociationApplicationState | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): BulkSensorAssociationApplicationState;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): BulkSensorAssociationApplicationState;
   ...
   */
  static cachedEmptyInst(): BulkSensorAssociationApplicationState;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<BulkSensorAssociationApplicationState> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): BulkSensorAssociationApplicationState;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<BulkSensorAssociationApplicationState>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<BulkSensorAssociationApplicationState>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<BulkSensorAssociationApplicationState> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<BulkSensorAssociationApplicationState>> | null;
   ...
   */
  dependencies(): MetadataDeps<BulkSensorAssociationApplicationState>;

  save(subPath?: string, contentType?: string): BulkSensorAssociationApplicationState;
  ...
  update(srcObj?: BulkSensorAssociationApplicationState, spec?: UpsertSpec): BulkSensorAssociationApplicationState | null;

  upsert(srcObj?: BulkSensorAssociationApplicationState, spec?: UpsertSpec): BulkSensorAssociationApplicationState | null;
   ...
   * @see #toString
   */
  static fromString(s: string): BulkSensorAssociationApplicationState | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string, failIfMissing?: boolean): BulkSensorAssociationApplicationState | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: BulkSensorAssociationApplicationState, state: UiSdlReduxState): BulkSensorAssociationApplicationState | null;
   ...
   */
  static startUiWorkflowAction(): UiSdlReduxAction<any>;
   ...
   * @return An observable stream of UI SDL actions
   */
  static showExitModalEpic(actionStream: UiSdlActionsObservable, stateStream: UiSdlStatesObservable): UiSdlActionsObservable;
   ...
   */
  static startSensorAssociationAction(): UiSdlReduxAction<any>;
   ...
   * @return An Observable action stream.
   */
  static startSensorAssociationEpic(actionStream: UiSdlActionsObservable, stateStream: UiSdlStatesObservable): UiSdlActionsObservable;
}
