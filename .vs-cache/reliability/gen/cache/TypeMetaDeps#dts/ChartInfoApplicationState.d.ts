// TypeScript definitions for the C3 type ChartInfoApplicationState

/**
 * Application state that stores all chart data and config related information.
 *
 * @remarks this represents a value passed to a method that expects an instance of ChartInfoApplicationState
 */
declare interface IChartInfoApplicationState {
  ...
  /**
   * Maps of chart IDs to UiSdlTimeseriesLineBarChart configuration. The UI Chart components should use
   * derivedProps to set their configurations based on the fields of a specific configuration in this map.
   */
  chartToConfig?: Map_Type<string, any> | {[key: string]: any};

  /**
   * Maps of chart IDs to an array of data transforms to run on the yAxisField data
   * after the default UI framework transforms. Every transform listed here MUST be added
   * to {@link ChartInfoTransformMap}.
   */
  chartToDataTransforms?: Map_Type<string, Array_Type<string>> | {[key: string]: Array_Type<string> | Array<string>};

  /**
   * The name of the type implementing ChartHelper that will be used.
   * This field MUST be set in the JSON configuration of a specific application state for {@link getChartInfo}
   * to function properly.
   */
  chartHelperType: string;
}

/**
 * Application state that stores all chart data and config related information.
 *
 * @remarks this represents a made instance of ChartInfoApplicationState
 */
declare class ChartInfoApplicationState extends Obj  {

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): ChartInfoApplicationState;

  /**
   * Unique identifier for the logical object that instance of this type represents.
   */
  readonly id?: string;
  withId(id: string | null): ChartInfoApplicationState;

  /**
   * The name of the component. Optional field for informational purposes only.
   */
  readonly name?: string;
  withName(name: string | null): ChartInfoApplicationState;
  ...
  withDataSpec(dataSpec: IUiSdlNoData | null): ChartInfoApplicationState;

  /**
   * Disable if you want to avoid sending any and all requests for this component on first render.
   */
  readonly disableDataRequestOnFirstRender?: boolean;
  withDisableDataRequestOnFirstRender(disableDataRequestOnFirstRender: boolean): ChartInfoApplicationState;

  /**
   * Whether the effect triggers and epics have been registered
   */
  readonly triggersRegistered?: boolean;
  withTriggersRegistered(triggersRegistered: boolean): ChartInfoApplicationState;

  /**
   * Whether to wrap the component with a div which has a class name of its metdata id. Useful for targeting with css.
   */
  readonly wrapWithMetadataId?: boolean;
  withWrapWithMetadataId(wrapWithMetadataId: boolean): ChartInfoApplicationState;

  /**
   * The Redux namespace for the application state to indicate where the application data is stored in the Redux state.
   */
  readonly REDUX_NAMESPACE?: string;
  withREDUX_NAMESPACE(REDUX_NAMESPACE: string | null): ChartInfoApplicationState;

  /**
   * Collection of extra async {@link UiSdlEffectTrigger}.
   */
  readonly effectTriggers?: Array_Type<UiSdlEffectTrigger>;
  withEffectTriggers(effectTriggers: Array_Type<UiSdlEffectTrigger> | Array<IUiSdlEffectTrigger> | null): ChartInfoApplicationState;

  /**
   * Maps of chart IDs to UiSdlTimeseriesLineBarChart configuration. The UI Chart components should use
   * derivedProps to set their configurations based on the fields of a specific configuration in this map.
   */
  readonly chartToConfig?: Map_Type<string, any>;
  withChartToConfig(chartToConfig: Map_Type<string, any> | {[key: string]: any} | null): ChartInfoApplicationState;
   ...
   * to {@link ChartInfoTransformMap}.
   */
  readonly chartToDataTransforms?: Map_Type<string, Array_Type<string>>;
  withChartToDataTransforms(chartToDataTransforms: Map_Type<string, Array_Type<string>> | {[key: string]: Array_Type<string> | Array<string>} | null): ChartInfoApplicationState;
   ...
   * to function properly.
   */
  readonly chartHelperType: string;
  withChartHelperType(chartHelperType: string): ChartInfoApplicationState;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ChartInfoApplicationState | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ChartInfoApplicationState | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ChartInfoApplicationState | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ChartInfoApplicationState | null;
   ...
   */
  replaceType(old: Type, new_: Type): ChartInfoApplicationState;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ChartInfoApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ChartInfoApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ChartInfoApplicationState>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ChartInfoApplicationState>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ChartInfoApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ChartInfoApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ChartInfoApplicationState;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ChartInfoApplicationState;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ChartInfoApplicationState;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ChartInfoApplicationState;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ChartInfoApplicationState;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ChartInfoApplicationState;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ChartInfoApplicationState;
   ...
   * @see #removeField
   */
  withoutField(field: string): ChartInfoApplicationState;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ChartInfoApplicationState;
   ...
   */
  withoutFields(fields: Array_Type<string>): ChartInfoApplicationState;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ChartInfoApplicationState;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ChartInfoApplicationState;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ChartInfoApplicationState;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ChartInfoApplicationState;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ChartInfoApplicationState;
   ...
   * @see #removeField
   */
  unsetField(field: string): ChartInfoApplicationState;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ChartInfoApplicationState;
   ...
   * @see #unsetField
   */
  removeField(field: string): ChartInfoApplicationState;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ChartInfoApplicationState;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ChartInfoApplicationState;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ChartInfoApplicationState;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ChartInfoApplicationState;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ChartInfoApplicationState;

  mergeJson(json: any): ChartInfoApplicationState;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ChartInfoApplicationState;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ChartInfoApplicationState;
   ...
   */
  singletonArray(): Array_Type<ChartInfoApplicationState>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ChartInfoApplicationState> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ChartInfoApplicationState> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ChartInfoApplicationState>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ChartInfoApplicationState> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ChartInfoApplicationState> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ChartInfoApplicationState> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ChartInfoApplicationState>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ChartInfoApplicationState>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ChartInfoApplicationState;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ChartInfoApplicationState;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ChartInfoApplicationState;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ChartInfoApplicationState;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ChartInfoApplicationState;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ChartInfoApplicationState;
   ...
   * @see #fromString
   */
  static make(s: string): ChartInfoApplicationState | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ChartInfoApplicationState;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ChartInfoApplicationState;
   ...
   */
  static cachedEmptyInst(): ChartInfoApplicationState;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ChartInfoApplicationState> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ChartInfoApplicationState;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<ChartInfoApplicationState>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ChartInfoApplicationState>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<ChartInfoApplicationState> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ChartInfoApplicationState>> | null;
   ...
   */
  dependencies(): MetadataDeps<ChartInfoApplicationState>;

  save(subPath?: string, contentType?: string): ChartInfoApplicationState;
  ...
  update(srcObj?: ChartInfoApplicationState, spec?: UpsertSpec): ChartInfoApplicationState | null;

  upsert(srcObj?: ChartInfoApplicationState, spec?: UpsertSpec): ChartInfoApplicationState | null;
   ...
   * @see #toString
   */
  static fromString(s: string): ChartInfoApplicationState | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string, failIfMissing?: boolean): ChartInfoApplicationState | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: ChartInfoApplicationState, state: UiSdlReduxState): ChartInfoApplicationState | null;
  ...
  /**
   * An action to indicate chart information has been loaded.
   *
   * @param stateId
   *           The ID of the state
   * @param chartInfo
   *           The chart information that has been loaded
   * @return A Redux action of type `LOADED_CHART_INFO`.
   */
  static loadedChartInfoAction(stateId?: string, chartInfo?: ChartInfo): UiSdlReduxAction<any>;

  /**
   * An action to indicate chart information retrieval.
   *
   * @param spec
   *            The spec to provide to the underlying {@link ChartHelper} function that may be called after the action.
   * @param chartHelperName
   *            The name of type that mixes and implements {@link ChartHelper}.
   * @return A Redux action of type `GET_CHART_INFO`.
   */
  static getChartInfoAction(stateId?: string, spec?: any, chartHelperName?: string): UiSdlReduxAction<any>;

  /**
   * Gets chart configurations and data using a passed in chartHelperType that implements {@link ChartHelper}.
   * It also takes a spec for the chartHelperType to use.
   *
   * @param actionStream
   ...
   */
  static getChartInfo(actionStream: UiSdlActionsObservable, stateStream: UiSdlStatesObservable): UiSdlActionsObservable;
}
