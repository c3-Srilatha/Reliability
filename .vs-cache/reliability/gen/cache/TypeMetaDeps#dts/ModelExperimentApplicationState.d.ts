...
declare interface IModelExperimentApplicationState {
   ...
   */
  experimentModelPreviewData?: IExperimentalPreviewHelper.ChartData;
...
declare class ModelExperimentApplicationState extends Obj  {
  ...
  withEffectTriggers(effectTriggers: Array_Type<UiSdlEffectTrigger> | Array<IUiSdlEffectTrigger> | null): ModelExperimentApplicationState;
   ...
   * This field holds the data for the experimental model preview chart, alerts grid, features grid, and other related data.
   */
  readonly experimentModelPreviewData?: ExperimentalPreviewHelper.ChartData;
   ...
   * This field holds the name of the experimental model.
   */
  readonly experimentModelName?: string;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ModelExperimentApplicationState | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ModelExperimentApplicationState | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ModelExperimentApplicationState | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ModelExperimentApplicationState | null;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ModelExperimentApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ModelExperimentApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ModelExperimentApplicationState>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ModelExperimentApplicationState>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ModelExperimentApplicationState;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ModelExperimentApplicationState;
   ...
   * @see #removeField
   */
  withoutField(field: string): ModelExperimentApplicationState;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ModelExperimentApplicationState;
   ...
   */
  withoutFields(fields: Array_Type<string>): ModelExperimentApplicationState;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ModelExperimentApplicationState;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ModelExperimentApplicationState;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ModelExperimentApplicationState;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ModelExperimentApplicationState;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ModelExperimentApplicationState;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ModelExperimentApplicationState;

  mergeJson(json: any): ModelExperimentApplicationState;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ModelExperimentApplicationState;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ModelExperimentApplicationState;
   ...
   */
  singletonArray(): Array_Type<ModelExperimentApplicationState>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ModelExperimentApplicationState> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ModelExperimentApplicationState> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ModelExperimentApplicationState>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ModelExperimentApplicationState> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ModelExperimentApplicationState> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ModelExperimentApplicationState> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ModelExperimentApplicationState>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ModelExperimentApplicationState>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ModelExperimentApplicationState;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ModelExperimentApplicationState;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ModelExperimentApplicationState;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ModelExperimentApplicationState;
   ...
   * @see #fromString
   */
  static make(s: string): ModelExperimentApplicationState | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ModelExperimentApplicationState;
   ...
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ModelExperimentApplicationState> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ModelExperimentApplicationState;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<ModelExperimentApplicationState>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ModelExperimentApplicationState>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<ModelExperimentApplicationState> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ModelExperimentApplicationState>> | null;
   ...
   */
  dependencies(): MetadataDeps<ModelExperimentApplicationState>;

  save(subPath?: string, contentType?: string): ModelExperimentApplicationState;
  ...
  update(srcObj?: ModelExperimentApplicationState, spec?: UpsertSpec): ModelExperimentApplicationState | null;

  upsert(srcObj?: ModelExperimentApplicationState, spec?: UpsertSpec): ModelExperimentApplicationState | null;
   ...
   * @see #toString
   */
  static fromString(s: string): ModelExperimentApplicationState | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string, failIfMissing?: boolean): ModelExperimentApplicationState | null;
   ...
   */
  static setModelExperimentStatusAction(stateId: string, field: string, value?: any, path?: string, sourceId?: string): UiSdlReduxAction<any>;
