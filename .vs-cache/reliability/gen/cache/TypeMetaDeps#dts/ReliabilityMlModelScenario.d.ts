// TypeScript definitions for the C3 type ReliabilityMlModelScenario

/**
 * @inheritdoc
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityMlModelScenario
 */
declare interface IReliabilityMlModelScenario {
   ...
   */
  scenarioPipelineData?: Map_Type<string, any> | {[key: string]: any};
   ...
   */
  originalAlgorithmData?: IData.Persisted;
   ...
   *           not persisting the map correctly, so we can use `any` to store it as a `Boxed<json>` instead.
   */
  featureOutputData?: Map_Type<string, any> | {[key: string]: any};

  /**
   * The spec used to generate the scenario.
   */
  spec?: IReliabilityOrchestrator.ModelScenarioProcess.Spec;
 ...
 */
declare class ReliabilityMlModelScenario extends Obj  {
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityMlModelScenario;
  ...
  withFacilityFilterPaths(facilityFilterPaths: Array_Type<string> | Array<string> | null): ReliabilityMlModelScenario;
   ...
   * The translation key for the status of the scenario, which is used for display purposes.
   */
  readonly translatedStatusKey?: string;
   ...
   *           not persisting the map correctly, so we can use `any` to store it as a `Boxed<json>` instead.
   */
  readonly scenarioPipelineData?: Map_Type<string, any>;
  withScenarioPipelineData(scenarioPipelineData: Map_Type<string, any> | {[key: string]: any} | null): ReliabilityMlModelScenario;
   ...
   *   (`featureInterpretations`).
   */
  readonly alertData?: Data.Persisted;
   ...
   * ```
   */
  readonly algorithmData?: Data.Persisted;
   ...
   * {@link Feature}s data instead of #scenarioPipelineData, and is stored the same as #algorithmData.
   */
  readonly originalAlgorithmData?: Data.Persisted;
   ...
   *           not persisting the map correctly, so we can use `any` to store it as a `Boxed<json>` instead.
   */
  readonly featureOutputData?: Map_Type<string, any>;
  withFeatureOutputData(featureOutputData: Map_Type<string, any> | {[key: string]: any} | null): ReliabilityMlModelScenario;

  /**
   * The spec used to generate the scenario.
   */
  readonly spec?: ReliabilityOrchestrator.ModelScenarioProcess.Spec;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ReliabilityMlModelScenario | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ReliabilityMlModelScenario | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ReliabilityMlModelScenario | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ReliabilityMlModelScenario | null;
   ...
   */
  replaceType(old: Type, new_: Type): ReliabilityMlModelScenario;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityMlModelScenario;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityMlModelScenario;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityMlModelScenario>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityMlModelScenario>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityMlModelScenario;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityMlModelScenario;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityMlModelScenario;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ReliabilityMlModelScenario;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ReliabilityMlModelScenario;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityMlModelScenario;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityMlModelScenario;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityMlModelScenario;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ReliabilityMlModelScenario;
   ...
   * @see #removeField
   */
  withoutField(field: string): ReliabilityMlModelScenario;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ReliabilityMlModelScenario;
   ...
   */
  withoutFields(fields: Array_Type<string>): ReliabilityMlModelScenario;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityMlModelScenario;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ReliabilityMlModelScenario;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityMlModelScenario;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ReliabilityMlModelScenario;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ReliabilityMlModelScenario;
   ...
   * @see #removeField
   */
  unsetField(field: string): ReliabilityMlModelScenario;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ReliabilityMlModelScenario;
   ...
   * @see #unsetField
   */
  removeField(field: string): ReliabilityMlModelScenario;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ReliabilityMlModelScenario;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityMlModelScenario;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityMlModelScenario;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityMlModelScenario;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityMlModelScenario;

  mergeJson(json: any): ReliabilityMlModelScenario;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityMlModelScenario;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ReliabilityMlModelScenario;
   ...
   */
  singletonArray(): Array_Type<ReliabilityMlModelScenario>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityMlModelScenario> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ReliabilityMlModelScenario> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ReliabilityMlModelScenario>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ReliabilityMlModelScenario> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ReliabilityMlModelScenario> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityMlModelScenario> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ReliabilityMlModelScenario>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ReliabilityMlModelScenario>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityMlModelScenario;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityMlModelScenario;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityMlModelScenario;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ReliabilityMlModelScenario;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityMlModelScenario;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ReliabilityMlModelScenario;
   ...
   * @see #fromString
   */
  static make(s: string): ReliabilityMlModelScenario | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityMlModelScenario;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ReliabilityMlModelScenario;
   ...
   */
  static cachedEmptyInst(): ReliabilityMlModelScenario;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityMlModelScenario> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ReliabilityMlModelScenario;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<ReliabilityMlModelScenario>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ReliabilityMlModelScenario>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityMlModelScenario> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityMlModelScenario>> | null;
   ...
   */
  get(include?: string): ReliabilityMlModelScenario | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): ReliabilityMlModelScenario | null;
   ...
   */
  getMissing(spec: GetMissingSpec): ReliabilityMlModelScenario;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): ReliabilityMlModelScenario | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): ReliabilityMlModelScenario;
   ...
   * @see #toString
   */
  static fromString(s: string): ReliabilityMlModelScenario | null;
   ...
   */
  create(spec?: UpsertSpec): ReliabilityMlModelScenario | null;
   ...
   */
  static createBatch(objs: Array_Type<ReliabilityMlModelScenario>, spec?: UpsertSpec): ObjList<ReliabilityMlModelScenario> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ReliabilityMlModelScenario>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityMlModelScenario> | null;
   ...
   */
  update(srcObj?: ReliabilityMlModelScenario, spec?: UpsertSpec): ReliabilityMlModelScenario | null;
   ...
   */
  upsert(srcObj?: ReliabilityMlModelScenario, spec?: UpsertSpec): ReliabilityMlModelScenario | null;
   ...
   */
  merge(spec?: MergeSpec): ReliabilityMlModelScenario | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): ReliabilityMlModelScenario | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): ReliabilityMlModelScenario | null;
   ...
   */
  static updateBatch(objs: Array_Type<ReliabilityMlModelScenario>, srcObjs?: Array_Type<ReliabilityMlModelScenario>, spec?: UpsertSpec): ObjList<ReliabilityMlModelScenario> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<ReliabilityMlModelScenario> | null>, spec?: UpsertSpec): ObjList<ReliabilityMlModelScenario> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<ReliabilityMlModelScenario>, srcObjs?: Array_Type<ReliabilityMlModelScenario>, spec?: UpsertSpec): ObjList<ReliabilityMlModelScenario> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<ReliabilityMlModelScenario> | null>, spec?: UpsertSpec): ObjList<ReliabilityMlModelScenario> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<ReliabilityMlModelScenario>, spec?: TouchSpec): ObjList<ReliabilityMlModelScenario> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityMlModelScenario>, spec?: MergeSpec): ObjList<ReliabilityMlModelScenario> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityMlModelScenario>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityMlModelScenario> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<ReliabilityMlModelScenario> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityMlModelScenario> | null;
   ...
   */
  static mergeAll(mergeObj: ReliabilityMlModelScenario, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ReliabilityMlModelScenario, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<ReliabilityMlModelScenario>, spec?: UpsertSpec): ObjList<ReliabilityMlModelScenario> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<ReliabilityMlModelScenario>, spec?: UpsertSpec): ObjList<ReliabilityMlModelScenario> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): ReliabilityMlModelScenario | null;
   ...
   */
  static beforeCreate(objs: Array_Type<ReliabilityMlModelScenario>): ObjList<ReliabilityMlModelScenario>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<ReliabilityMlModelScenario>): ObjList<ReliabilityMlModelScenario>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<ReliabilityMlModelScenario>): ObjList<ReliabilityMlModelScenario>;
   ...
   */
  static afterCreate(objs: Array_Type<ReliabilityMlModelScenario>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<ReliabilityMlModelScenario>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<ReliabilityMlModelScenario>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityMlModelScenario>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityMlModelScenario>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): ReliabilityMlModelScenario | null;
   ...
   */
  withoutIdentity(): ReliabilityMlModelScenario | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<ReliabilityMlModelScenario>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: ReliabilityMlModelScenario, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<ReliabilityMlModelScenario>, callback?: λFunction<ReliabilityMlModelScenario | null, ReliabilityMlModelScenario | null>): ObjList<ReliabilityMlModelScenario>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<ReliabilityMlModelScenario>, callback?: λFunction<ReliabilityMlModelScenario | null, ReliabilityMlModelScenario | null>): Array_Type<ObjError> | null;
   ...
   */
  getDetailChartInfo(): ReliabilityMlModelScenario.UiData | null;
}
