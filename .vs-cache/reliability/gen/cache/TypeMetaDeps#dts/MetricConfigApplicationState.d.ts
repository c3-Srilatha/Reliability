// TypeScript definitions for the C3 type MetricConfigApplicationState

/**
 * Application state for the {@link ReliabilityMetric} configuration workflow.
 *
 * @remarks this represents a value passed to a method that expects an instance of MetricConfigApplicationState
 */
declare interface IMetricConfigApplicationState {
 ...
 */
declare class MetricConfigApplicationState extends Obj  {
  ...
  withEffectTriggers(effectTriggers: Array_Type<UiSdlEffectTrigger> | Array<IUiSdlEffectTrigger> | null): MetricConfigApplicationState;
   ...
   * Useful populating data related a {@link ReliabilityMetric} in the side panel.
   */
  readonly selectedMetricRowData?: ReliabilityMetric;
  withSelectedMetricRowData(selectedMetricRowData: IReliabilityMetric | null): MetricConfigApplicationState;

  /**
   * The values of the {@link ReliabilityMetric} in the current form.
   */
  readonly metricFormValues?: ReliabilityMetric;
  withMetricFormValues(metricFormValues: IReliabilityMetric | null): MetricConfigApplicationState;

  /**
   * The list of {@link ReliabilityMetric}s that are associated with the current {@link ReliabilityMetric}.
   */
  readonly childMetrics?: Array_Type<ReliabilityMetric>;
  withChildMetrics(childMetrics: Array_Type<ReliabilityMetric> | Array<IReliabilityMetric> | null): MetricConfigApplicationState;

  /**
   * The current {@link CreateMetricConfigurationPreviewChartHelperSpec} that is being used to plot the preview chart.
   */
  readonly currentPlottedMetricSpec?: CreateMetricConfigurationPreviewChartHelperSpec;
   ...
   * @see #toJson
   */
  static fromJson(json: any): MetricConfigApplicationState | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): MetricConfigApplicationState | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): MetricConfigApplicationState | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): MetricConfigApplicationState | null;
   ...
   */
  replaceType(old: Type, new_: Type): MetricConfigApplicationState;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): MetricConfigApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): MetricConfigApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<MetricConfigApplicationState>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<MetricConfigApplicationState>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): MetricConfigApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): MetricConfigApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): MetricConfigApplicationState;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): MetricConfigApplicationState;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): MetricConfigApplicationState;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): MetricConfigApplicationState;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): MetricConfigApplicationState;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): MetricConfigApplicationState;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): MetricConfigApplicationState;
   ...
   * @see #removeField
   */
  withoutField(field: string): MetricConfigApplicationState;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): MetricConfigApplicationState;
   ...
   */
  withoutFields(fields: Array_Type<string>): MetricConfigApplicationState;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): MetricConfigApplicationState;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): MetricConfigApplicationState;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): MetricConfigApplicationState;
   ...
   * @see #unsetField
   */
  defaultField(field: string): MetricConfigApplicationState;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): MetricConfigApplicationState;
   ...
   * @see #removeField
   */
  unsetField(field: string): MetricConfigApplicationState;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): MetricConfigApplicationState;
   ...
   * @see #unsetField
   */
  removeField(field: string): MetricConfigApplicationState;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): MetricConfigApplicationState;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): MetricConfigApplicationState;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): MetricConfigApplicationState;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): MetricConfigApplicationState;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): MetricConfigApplicationState;

  mergeJson(json: any): MetricConfigApplicationState;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): MetricConfigApplicationState;
   ...
   */
  sumObj(other: Obj, deep?: boolean): MetricConfigApplicationState;
   ...
   */
  singletonArray(): Array_Type<MetricConfigApplicationState>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<MetricConfigApplicationState> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<MetricConfigApplicationState> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<MetricConfigApplicationState>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<MetricConfigApplicationState> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, MetricConfigApplicationState> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, MetricConfigApplicationState> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<MetricConfigApplicationState>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<MetricConfigApplicationState>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): MetricConfigApplicationState;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): MetricConfigApplicationState;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): MetricConfigApplicationState;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): MetricConfigApplicationState;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): MetricConfigApplicationState;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): MetricConfigApplicationState;
   ...
   * @see #fromString
   */
  static make(s: string): MetricConfigApplicationState | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): MetricConfigApplicationState;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): MetricConfigApplicationState;
   ...
   */
  static cachedEmptyInst(): MetricConfigApplicationState;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<MetricConfigApplicationState> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): MetricConfigApplicationState;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<MetricConfigApplicationState>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<MetricConfigApplicationState>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<MetricConfigApplicationState> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<MetricConfigApplicationState>> | null;
   ...
   */
  dependencies(): MetadataDeps<MetricConfigApplicationState>;

  save(subPath?: string, contentType?: string): MetricConfigApplicationState;
  ...
  update(srcObj?: MetricConfigApplicationState, spec?: UpsertSpec): MetricConfigApplicationState | null;

  upsert(srcObj?: MetricConfigApplicationState, spec?: UpsertSpec): MetricConfigApplicationState | null;
   ...
   * @see #toString
   */
  static fromString(s: string): MetricConfigApplicationState | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string, failIfMissing?: boolean): MetricConfigApplicationState | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: MetricConfigApplicationState, state: UiSdlReduxState): MetricConfigApplicationState | null;
   ...
   */
  static setMetricRowDataEpic(actionStream: UiSdlActionsObservable, stateStream: UiSdlStatesObservable): UiSdlActionsObservable;
}
