// TypeScript definitions for the C3 type ReliabilityUIDisableFieldsConfig

/**
 * Configurations for Reliability application UI where we can set fields to be disabled and mark un-editable by users.
 * Here is an example of how you can set values within this config:
 *
 * ReliabilityUIDisableFieldsConfig.inst().setConfigValue(
 *     'disabledConfigFields',
 *         C3.Map.fromJson({
 *             "type": "map<string, any>",
 *             "ReliabilityMLConfig": ['reliabilityRiskMLProjectId']
 *           })
 *     )
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityUIDisableFieldsConfig
 */
declare interface IReliabilityUIDisableFieldsConfig {
  ...
  /**
   * The mapping for disabling fields in the UI for Implementation form configs
   * For each entry within map:
   * key = Form config name eg. 'ReliabilityMLConfig'
   * value = Collection of fields from this config which should be disabled on the UI eg. ['reliabilityRiskMLProjectId']
   */
  disabledConfigFields?: Map_Type<string, Array_Type<string>> | {[key: string]: Array_Type<string> | Array<string>};
}
 ...
 *     )
 *
 * @remarks this represents a made instance of ReliabilityUIDisableFieldsConfig
 */
declare class ReliabilityUIDisableFieldsConfig extends Obj  {

  readonly configOverride?: string;
  withConfigOverride(configOverride: string | null): ReliabilityUIDisableFieldsConfig;

  static readonly configOverride?: string;

  readonly secretOverride?: string;
  withSecretOverride(secretOverride: string | null): ReliabilityUIDisableFieldsConfig;
  ...
  withIssues(issues: Array_Type<string> | Array<string> | null): ReliabilityUIDisableFieldsConfig;
   ...
   * value = Collection of fields from this config which should be disabled on the UI eg. ['reliabilityRiskMLProjectId']
   */
  readonly disabledConfigFields?: Map_Type<string, Array_Type<string>>;
  withDisabledConfigFields(disabledConfigFields: Map_Type<string, Array_Type<string>> | {[key: string]: Array_Type<string> | Array<string>} | null): ReliabilityUIDisableFieldsConfig;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ReliabilityUIDisableFieldsConfig | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ReliabilityUIDisableFieldsConfig | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ReliabilityUIDisableFieldsConfig | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ReliabilityUIDisableFieldsConfig | null;
   ...
   */
  replaceType(old: Type, new_: Type): ReliabilityUIDisableFieldsConfig;
   ...
   * This method is used during live metadata update
   */
  static replaceType(old: Type, new_: Type): ReliabilityUIDisableFieldsConfig;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityUIDisableFieldsConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityUIDisableFieldsConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityUIDisableFieldsConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityUIDisableFieldsConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityUIDisableFieldsConfig>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityUIDisableFieldsConfig>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityUIDisableFieldsConfig>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityUIDisableFieldsConfig>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityUIDisableFieldsConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityUIDisableFieldsConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityUIDisableFieldsConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityUIDisableFieldsConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityUIDisableFieldsConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityUIDisableFieldsConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ReliabilityUIDisableFieldsConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  static validateObj(): ReliabilityUIDisableFieldsConfig;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ReliabilityUIDisableFieldsConfig;
   ...
   * @see #defaultField
   */
  static withField(field: string, value: any, doNotConvert?: boolean): ReliabilityUIDisableFieldsConfig;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityUIDisableFieldsConfig;
   ...
   * @see #defaultField
   */
  static withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityUIDisableFieldsConfig;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityUIDisableFieldsConfig;
   ...
   * @return new Obj
   */
  static withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityUIDisableFieldsConfig;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityUIDisableFieldsConfig;
   ...
   * @return new Obj
   */
  static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityUIDisableFieldsConfig;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ReliabilityUIDisableFieldsConfig;
   ...
   * @see #withoutField
   */
  static withoutFieldAtPath(path: string): ReliabilityUIDisableFieldsConfig;
   ...
   * @see #removeField
   */
  withoutField(field: string): ReliabilityUIDisableFieldsConfig;
   ...
   * @see #removeField
   */
  static withoutField(field: string): ReliabilityUIDisableFieldsConfig;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ReliabilityUIDisableFieldsConfig;
   ...
   * @see #removeField
   */
  static withoutField(field: FieldType): ReliabilityUIDisableFieldsConfig;
   ...
   */
  withoutFields(fields: Array_Type<string>): ReliabilityUIDisableFieldsConfig;
   ...
   * @return new Obj with removed fields
   */
  static withoutFields(fields: Array_Type<string>): ReliabilityUIDisableFieldsConfig;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityUIDisableFieldsConfig;
   ...
   * @return new Obj with removed fields
   */
  static withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityUIDisableFieldsConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ReliabilityUIDisableFieldsConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  static withoutSecretFields(): ReliabilityUIDisableFieldsConfig;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityUIDisableFieldsConfig;
   ...
   * @see FieldType#defaultValue
   */
  static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityUIDisableFieldsConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ReliabilityUIDisableFieldsConfig;
   ...
   * @see #unsetField
   */
  static defaultField(field: string): ReliabilityUIDisableFieldsConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ReliabilityUIDisableFieldsConfig;
   ...
   * @see #unsetField
   */
  static defaultField(field: FieldType): ReliabilityUIDisableFieldsConfig;
   ...
   * @see #removeField
   */
  unsetField(field: string): ReliabilityUIDisableFieldsConfig;
   ...
   * @see #removeField
   */
  static unsetField(field: string): ReliabilityUIDisableFieldsConfig;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ReliabilityUIDisableFieldsConfig;
   ...
   * @see #removeField
   */
  static unsetField(field: FieldType): ReliabilityUIDisableFieldsConfig;
   ...
   * @see #unsetField
   */
  removeField(field: string): ReliabilityUIDisableFieldsConfig;
   ...
   * @see #unsetField
   */
  static removeField(field: string): ReliabilityUIDisableFieldsConfig;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ReliabilityUIDisableFieldsConfig;
   ...
   * @see #unsetField
   */
  static removeField(field: FieldType): ReliabilityUIDisableFieldsConfig;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityUIDisableFieldsConfig;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityUIDisableFieldsConfig;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityUIDisableFieldsConfig;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityUIDisableFieldsConfig;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityUIDisableFieldsConfig;
   ...
   *        the same key or index.
   */
  static mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityUIDisableFieldsConfig;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityUIDisableFieldsConfig;
   ...
   * traverse child reference and collection fields.
   */
  static mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityUIDisableFieldsConfig;

  mergeJson(json: any): ReliabilityUIDisableFieldsConfig;

  static mergeJson(json: any): ReliabilityUIDisableFieldsConfig;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityUIDisableFieldsConfig;
   ...
   * @return Obj with child references merged
   */
  static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityUIDisableFieldsConfig;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ReliabilityUIDisableFieldsConfig;
   ...
   * references with same name and collection elements at same index or key.
   */
  static sumObj(other: Obj, deep?: boolean): ReliabilityUIDisableFieldsConfig;
   ...
   */
  singletonArray(): Array_Type<ReliabilityUIDisableFieldsConfig>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonArray(): Array_Type<ReliabilityUIDisableFieldsConfig>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityUIDisableFieldsConfig> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ReliabilityUIDisableFieldsConfig> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ReliabilityUIDisableFieldsConfig>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonSet(): Set_Type<ReliabilityUIDisableFieldsConfig>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ReliabilityUIDisableFieldsConfig> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ReliabilityUIDisableFieldsConfig> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityUIDisableFieldsConfig> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ReliabilityUIDisableFieldsConfig>;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  static toBuilder(): ObjBuilder<ReliabilityUIDisableFieldsConfig>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ReliabilityUIDisableFieldsConfig>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityUIDisableFieldsConfig;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityUIDisableFieldsConfig;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityUIDisableFieldsConfig;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ReliabilityUIDisableFieldsConfig;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityUIDisableFieldsConfig;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ReliabilityUIDisableFieldsConfig;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityUIDisableFieldsConfig;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ReliabilityUIDisableFieldsConfig;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  static afterMake(): ReliabilityUIDisableFieldsConfig;
   ...
   */
  static cachedEmptyInst(): ReliabilityUIDisableFieldsConfig;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityUIDisableFieldsConfig> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ReliabilityUIDisableFieldsConfig;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<ReliabilityUIDisableFieldsConfig> | null;
   ...
   */
  static find(filter?: string, doNotProduceAll?: boolean): Stream<ReliabilityUIDisableFieldsConfig> | null;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<ReliabilityUIDisableFieldsConfig> | null;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): ReliabilityUIDisableFieldsConfig | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string): ReliabilityUIDisableFieldsConfig | null;
   ...
   * @see findByCacheKey
   */
  getCached(): ReliabilityUIDisableFieldsConfig | null;
   ...
   * @see findByCacheKey
   */
  static getCached(): ReliabilityUIDisableFieldsConfig | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): ReliabilityUIDisableFieldsConfig | null;

  /**
   * @return newly produced cached instance.
   */
  static refreshCache(): ReliabilityUIDisableFieldsConfig | null;
   ...
   */
  static produce(key: string): ReliabilityUIDisableFieldsConfig | null;
   ...
   */
  static produceAll(): Map_Type<string, ReliabilityUIDisableFieldsConfig> | null;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): Map_Type<string, ReliabilityUIDisableFieldsConfig> | null;
   ...
   */
  getConfig(): ReliabilityUIDisableFieldsConfig;
   ...
   * Note that typical pattern is to use Configurable#config instead of this method.
   */
  static getConfig(): ReliabilityUIDisableFieldsConfig;
   ...
   */
  getSecret(): ReliabilityUIDisableFieldsConfig;
   ...
   * Note that typical pattern is to use Configurable#configWithSecrets instead of this method.
   */
  static getSecret(): ReliabilityUIDisableFieldsConfig;
   ...
   */
  withConfigKey(configKey: string): ReliabilityUIDisableFieldsConfig;
   ...
   *     config.configKey() => "folder1/abc"
   */
  static withConfigKey(configKey: string): ReliabilityUIDisableFieldsConfig;

  /**
   * @return copy without config key.
   */
  withoutConfigKey(): ReliabilityUIDisableFieldsConfig;

  /**
   * @return copy without config key.
   */
  static withoutConfigKey(): ReliabilityUIDisableFieldsConfig;

  /**
   * @return return cached config instance for provided config key.
   */
  static forConfigKey(configKey: string): ReliabilityUIDisableFieldsConfig | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string>): Stream<ReliabilityUIDisableFieldsConfig> | null;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: ReliabilityUIDisableFieldsConfig, override?: string): void;

  /**
   * Sets multiple field values to be the same as the passed instance.
   * @see setConfigValue
   */
  static setConfigValues(from: ReliabilityUIDisableFieldsConfig, override?: string): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: ReliabilityUIDisableFieldsConfig, override?: string): void;

  /**
   * Sets multiple secret field values to be the same as the passed instance.
   * @see setSecretValue
   */
  static setSecretValues(from: ReliabilityUIDisableFieldsConfig, override?: string): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): ReliabilityUIDisableFieldsConfig | null;
   ...
   */
  removeSecrets(): ReliabilityUIDisableFieldsConfig | null;

  /**
   * @return this config without any secret values.
   */
  static removeSecrets(): ReliabilityUIDisableFieldsConfig | null;

  /**
   * @return this config with only secret values.
   */
  removeNonSecrets(): ReliabilityUIDisableFieldsConfig | null;

  /**
   * @return this config with only secret values.
   */
  static removeNonSecrets(): ReliabilityUIDisableFieldsConfig | null;

  /**
   * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
   * validation and setup.
   */
  validate(): ReliabilityUIDisableFieldsConfig;

  /**
   * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
   * validation and setup.
   */
  static validate(): ReliabilityUIDisableFieldsConfig;
