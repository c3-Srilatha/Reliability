...
declare interface IReliabilityMapAssetRelation {
   ...
   */
  points?: Array_Type<LatLong> | Array<ILatLong>;
   ...
   */
  facilities?: Array_Type<Facility> | Array<IFacility>;
}
...
declare class ReliabilityMapAssetRelation extends Obj  {
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityMapAssetRelation;
  ...
  withFacilityFilterPaths(facilityFilterPaths: Array_Type<string> | Array<string> | null): ReliabilityMapAssetRelation;
   ...
   * The points that are used to draw the line between the `from` and `to` assets.
   */
  readonly points?: Array_Type<LatLong>;
  withPoints(points: Array_Type<LatLong> | Array<ILatLong> | null): ReliabilityMapAssetRelation;
   ...
   * but if they belong to a different facility, then #facilities will contain both the facilities.
   */
  readonly facilities?: Array_Type<Facility>;
  withFacilities(facilities: Array_Type<Facility> | Array<IFacility> | null): ReliabilityMapAssetRelation;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ReliabilityMapAssetRelation | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ReliabilityMapAssetRelation | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ReliabilityMapAssetRelation | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ReliabilityMapAssetRelation | null;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityMapAssetRelation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityMapAssetRelation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityMapAssetRelation>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityMapAssetRelation>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityMapAssetRelation;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityMapAssetRelation;
   ...
   * @see #removeField
   */
  withoutField(field: string): ReliabilityMapAssetRelation;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ReliabilityMapAssetRelation;
   ...
   */
  withoutFields(fields: Array_Type<string>): ReliabilityMapAssetRelation;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityMapAssetRelation;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityMapAssetRelation;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityMapAssetRelation;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityMapAssetRelation;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityMapAssetRelation;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityMapAssetRelation;

  mergeJson(json: any): ReliabilityMapAssetRelation;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityMapAssetRelation;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ReliabilityMapAssetRelation;
   ...
   */
  singletonArray(): Array_Type<ReliabilityMapAssetRelation>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityMapAssetRelation> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ReliabilityMapAssetRelation> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ReliabilityMapAssetRelation>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ReliabilityMapAssetRelation> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ReliabilityMapAssetRelation> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityMapAssetRelation> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ReliabilityMapAssetRelation>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ReliabilityMapAssetRelation>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityMapAssetRelation;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityMapAssetRelation;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityMapAssetRelation;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityMapAssetRelation;
   ...
   * @see #fromString
   */
  static make(s: string): ReliabilityMapAssetRelation | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityMapAssetRelation;
   ...
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityMapAssetRelation> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ReliabilityMapAssetRelation;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<ReliabilityMapAssetRelation>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ReliabilityMapAssetRelation>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityMapAssetRelation> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityMapAssetRelation>> | null;
   ...
   */
  get(include?: string): ReliabilityMapAssetRelation | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): ReliabilityMapAssetRelation | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): ReliabilityMapAssetRelation | null;
   ...
   * @see #toString
   */
  static fromString(s: string): ReliabilityMapAssetRelation | null;
   ...
   */
  create(spec?: UpsertSpec): ReliabilityMapAssetRelation | null;
   ...
   */
  static createBatch(objs: Array_Type<ReliabilityMapAssetRelation>, spec?: UpsertSpec): ObjList<ReliabilityMapAssetRelation> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ReliabilityMapAssetRelation>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityMapAssetRelation> | null;
   ...
   */
  update(srcObj?: ReliabilityMapAssetRelation, spec?: UpsertSpec): ReliabilityMapAssetRelation | null;
   ...
   */
  upsert(srcObj?: ReliabilityMapAssetRelation, spec?: UpsertSpec): ReliabilityMapAssetRelation | null;
   ...
   */
  merge(spec?: MergeSpec): ReliabilityMapAssetRelation | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): ReliabilityMapAssetRelation | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): ReliabilityMapAssetRelation | null;
   ...
   */
  static updateBatch(objs: Array_Type<ReliabilityMapAssetRelation>, srcObjs?: Array_Type<ReliabilityMapAssetRelation>, spec?: UpsertSpec): ObjList<ReliabilityMapAssetRelation> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<ReliabilityMapAssetRelation> | null>, spec?: UpsertSpec): ObjList<ReliabilityMapAssetRelation> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<ReliabilityMapAssetRelation>, srcObjs?: Array_Type<ReliabilityMapAssetRelation>, spec?: UpsertSpec): ObjList<ReliabilityMapAssetRelation> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<ReliabilityMapAssetRelation> | null>, spec?: UpsertSpec): ObjList<ReliabilityMapAssetRelation> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<ReliabilityMapAssetRelation>, spec?: TouchSpec): ObjList<ReliabilityMapAssetRelation> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityMapAssetRelation>, spec?: MergeSpec): ObjList<ReliabilityMapAssetRelation> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityMapAssetRelation>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityMapAssetRelation> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<ReliabilityMapAssetRelation> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityMapAssetRelation> | null;
   ...
   */
  static mergeAll(mergeObj: ReliabilityMapAssetRelation, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ReliabilityMapAssetRelation, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<ReliabilityMapAssetRelation>, spec?: UpsertSpec): ObjList<ReliabilityMapAssetRelation> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<ReliabilityMapAssetRelation>, spec?: UpsertSpec): ObjList<ReliabilityMapAssetRelation> | null;
   ...
   */
  static beforeCreate(objs: Array_Type<ReliabilityMapAssetRelation>): ObjList<ReliabilityMapAssetRelation>;

  /**
   * Before updating the entity we should ensure its a valid relation.
   */
  static beforeUpdate(objs: Array_Type<ReliabilityMapAssetRelation>): ObjList<ReliabilityMapAssetRelation>;
   ...
   */
  static beforeRemove(objs: Array_Type<ReliabilityMapAssetRelation>): ObjList<ReliabilityMapAssetRelation>;
   ...
   */
  static afterCreate(objs: Array_Type<ReliabilityMapAssetRelation>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<ReliabilityMapAssetRelation>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<ReliabilityMapAssetRelation>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityMapAssetRelation>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityMapAssetRelation>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): ReliabilityMapAssetRelation | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<ReliabilityMapAssetRelation>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: ReliabilityMapAssetRelation, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<ReliabilityMapAssetRelation>, callback?: λFunction<ReliabilityMapAssetRelation | null, ReliabilityMapAssetRelation | null>): ObjList<ReliabilityMapAssetRelation>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<ReliabilityMapAssetRelation>, callback?: λFunction<ReliabilityMapAssetRelation | null, ReliabilityMapAssetRelation | null>): Array_Type<ObjError> | null;
