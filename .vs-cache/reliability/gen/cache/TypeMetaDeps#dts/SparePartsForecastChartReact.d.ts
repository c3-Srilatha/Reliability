// TypeScript definitions for the C3 type SparePartsForecastChartReact

/**
 * React renderer for {@link SparePartsForecastChart}
 *
 * @remarks this represents a value passed to a method that expects an instance of SparePartsForecastChartReact
 */
declare interface ISparePartsForecastChartReact {
  ...
  /**
   * The {@link InventorySeries#partNumber} of the part currently plotted on the chart.
   */
   ...
   */
  chartData?: ISparePartsForecastChartData;
}

/**
 * React renderer for {@link SparePartsForecastChart}
 *
 * @remarks this represents a made instance of SparePartsForecastChartReact
 */
declare class SparePartsForecastChartReact extends Obj  {

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): SparePartsForecastChartReact;

  /**
   * Unique identifier for the logical object that instance of this type represents.
   */
  readonly id?: string;
  withId(id: string | null): SparePartsForecastChartReact;

  /**
   * The name of the component. Optional field for informational purposes only.
   */
  readonly name?: string;
  withName(name: string | null): SparePartsForecastChartReact;

  /**
   * The specification used for retrieving data displayed by the grid.
   */
  readonly dataSpec?: UiSdlTimeseriesLineBarChartDataSpec;
  withDataSpec(dataSpec: IUiSdlTimeseriesLineBarChartDataSpec | null): SparePartsForecastChartReact;

  /**
   * Disable if you want to avoid sending any and all requests for this component on first render.
   */
  readonly disableDataRequestOnFirstRender?: boolean;
  withDisableDataRequestOnFirstRender(disableDataRequestOnFirstRender: boolean): SparePartsForecastChartReact;

  /**
   * Whether the effect triggers and epics have been registered
   */
  readonly triggersRegistered?: boolean;
  withTriggersRegistered(triggersRegistered: boolean): SparePartsForecastChartReact;

  /**
   * Whether to wrap the component with a div which has a class name of its metdata id. Useful for targeting with css.
   */
  readonly wrapWithMetadataId?: boolean;
  withWrapWithMetadataId(wrapWithMetadataId: boolean): SparePartsForecastChartReact;

  /**
   * A list of hidden series id.
   */
  readonly hiddenSeries?: Array_Type<string>;
  withHiddenSeries(hiddenSeries: Array_Type<string> | Array<string> | null): SparePartsForecastChartReact;
  ...
  withDefaultColors(defaultColors: Array_Type<string> | Array<string> | null): SparePartsForecastChartReact;

  /**
   * The background style for the chart.
   */
  readonly backgroundStyle?: string;
  withBackgroundStyle(backgroundStyle: string | null): SparePartsForecastChartReact;

  /**
   * The height of the component in pixels.
   */
  readonly height?: number;
  withHeight(height: number | null): SparePartsForecastChartReact;

  /**
   * Whether to enable tooltips.
   */
  readonly tooltipEnabled?: boolean;
  withTooltipEnabled(tooltipEnabled: boolean): SparePartsForecastChartReact;

  /**
   * The decimal precision to show on tooltip values.
   */
  readonly tooltipValuesDecimalPrecision?: number;
  withTooltipValuesDecimalPrecision(tooltipValuesDecimalPrecision: number | null): SparePartsForecastChartReact;

  /**
   * Whether or not to show units in tooltip
   */
  readonly tooltipUnitEnabled?: boolean;
  withTooltipUnitEnabled(tooltipUnitEnabled: boolean): SparePartsForecastChartReact;

  readonly tooltipConfig?: UiSdlTooltipBaseSettings;
  withTooltipConfig(tooltipConfig: IUiSdlTooltipBaseSettings | null): SparePartsForecastChartReact;
  ...
  withToolboxDataZoom(toolboxDataZoom: boolean): SparePartsForecastChartReact;

  /**
   * Holds the data to display in the grid.
   */
  readonly data?: Array_Type<Obj>;
  withData(data: Array_Type<Obj> | Array<IObj> | null): SparePartsForecastChartReact;

  /**
   * Chart header.
   */
  readonly header?: UiSdlComponentHeader;
  withHeader(header: IUiSdlComponentHeader | null): SparePartsForecastChartReact;

  /**
   * Y-axis config type.
   */
  readonly yAxis?: UiSdlLineBarChartYAxisConfig;
  withYAxis(yAxis: IUiSdlLineBarChartYAxisConfig | null): SparePartsForecastChartReact;
  ...
  withGrid(grid: IUiSdlChartEChartsGrid | null): SparePartsForecastChartReact;

  /**
   * The chart legend - information for each series.
   */
  readonly legend?: UiSdlChartLegend;
  withLegend(legend: IUiSdlChartLegend | null): SparePartsForecastChartReact;
  ...
  withZoomEnabled(zoomEnabled: boolean): SparePartsForecastChartReact;
  ...
  withDefaultChartType(defaultChartType: string | null): SparePartsForecastChartReact;
  ...
  withShowDownloadOptions(showDownloadOptions: boolean): SparePartsForecastChartReact;

  /**
   * Show a toggle next to the download options that will display data labels
   */
  readonly showDataLabelsToggle?: boolean;
  withShowDataLabelsToggle(showDataLabelsToggle: boolean): SparePartsForecastChartReact;

  /**
   * If `true`, stack all series whose series type is `'bar'`.
   */
  readonly stackBars?: boolean;
  withStackBars(stackBars: boolean): SparePartsForecastChartReact;
  ...
  withEmptyState(emptyState: IUiSdlComponentRef<UiSdlEmptyState> | null): SparePartsForecastChartReact;

  /**
   * The number of actions to display on the chart header.
   */
  readonly chartActionsCollapseThreshold?: number;
  withChartActionsCollapseThreshold(chartActionsCollapseThreshold: number | null): SparePartsForecastChartReact;

  /**
   * What is used to fill in missing seriesData when exporting to .csv data
   */
  readonly csvMissingDataFiller?: string;
  withCsvMissingDataFiller(csvMissingDataFiller: string | null): SparePartsForecastChartReact;

  /**
   * Whether or not to show the timezone label below chart.
   */
  readonly showTimeZoneLabel?: boolean;
  withShowTimeZoneLabel(showTimeZoneLabel: boolean): SparePartsForecastChartReact;
  ...
  withTimeZoneLabel(timeZoneLabel: string | IUiSdlDynamicValueSpec | null): SparePartsForecastChartReact;
  ...
  withTimeZoneNameFormat(timeZoneNameFormat: string | null): SparePartsForecastChartReact;

  /**
   * The specification used to retrieve event data displayed by this chart.
   */
  readonly eventDataSpec?: UiSdlTimeseriesLineBarChartEventDataSpec;
  withEventDataSpec(eventDataSpec: IUiSdlTimeseriesLineBarChartEventDataSpec | null): SparePartsForecastChartReact;

  /**
   * Stores the FetchResults retrieved by {@link #eventDataSpec}.
   */
  readonly eventData?: Obj;
  withEventData(eventData: IObj | null): SparePartsForecastChartReact;
  ...
  withEvalDataSpec(evalDataSpec: IUiSdlTimeseriesLineBarChartEvalDataSpec | null): SparePartsForecastChartReact;
  ...
  withShowCrosshair(showCrosshair: boolean): SparePartsForecastChartReact;
  ...
  withXAxis(xAxis: IUiSdlTimeseriesLineBarChartXAxisConfig | IUiSdlTimeseriesLineBarChartXAxisStaticConfig | null): SparePartsForecastChartReact;

  /**
   * Whether or not to display the "now" line on the chart.
   */
  readonly showNowLine?: boolean;
  withShowNowLine(showNowLine: boolean): SparePartsForecastChartReact;
  ...
  withCollapseXAxis(collapseXAxis: boolean): SparePartsForecastChartReact;

  /**
   * Style configurations of vertical line at the "now" point of time according to the interval of data being plotted.
   */
  readonly nowLineConfig?: UiSdlTimeseriesLineBarChartNowLineConfig;
  withNowLineConfig(nowLineConfig: IUiSdlTimeseriesLineBarChartNowLineConfig | null): SparePartsForecastChartReact;

  /**
   * Configuration to add vertical line at any date on the graph.
   */
  readonly dateLines?: Array_Type<UiSdlTimeseriesLineBarChartDateLineConfig>;
  withDateLines(dateLines: Array_Type<UiSdlTimeseriesLineBarChartDateLineConfig> | Array<IUiSdlTimeseriesLineBarChartDateLineConfig> | null): SparePartsForecastChartReact;

  /**
   * Configurations to add vertical line at any date on the graph requiring a fetch call.
   */
  readonly dateLinesDataSpec?: UiSdlTimeseriesLineBarChartDateLineDataSpec;
  withDateLinesDataSpec(dateLinesDataSpec: IUiSdlTimeseriesLineBarChartDateLineDataSpec | null): SparePartsForecastChartReact;

  /**
   * Whether or not to plot and show data at timestamps where there are 100% missing values.
   */
  readonly hideMissingDataPoints?: boolean;
  withHideMissingDataPoints(hideMissingDataPoints: boolean): SparePartsForecastChartReact;
  ...
  withNoTimeZoneConversion(noTimeZoneConversion: boolean): SparePartsForecastChartReact;
  ...
  withShowAllTimestampInfoOnTooltip(showAllTimestampInfoOnTooltip: boolean): SparePartsForecastChartReact;

  /**
   * Whether or not to show the start date of the chart.
   */
  readonly showStartAndEndDate?: boolean;
  withShowStartAndEndDate(showStartAndEndDate: boolean): SparePartsForecastChartReact;

  /**
   * Start date displayed in the chart shown only when dataSelection is enabled.
   */
  readonly displayStartDate?: string;
  withDisplayStartDate(displayStartDate: string | null): SparePartsForecastChartReact;

  /**
   * End date displayed in the chart shown only when dataSelection is enabled.
   */
  readonly displayEndDate?: string;
  withDisplayEndDate(displayEndDate: string | null): SparePartsForecastChartReact;

  readonly markerIdentifiersToCollapse?: Array_Type<string>;
  withMarkerIdentifiersToCollapse(markerIdentifiersToCollapse: Array_Type<string> | Array<string> | null): SparePartsForecastChartReact;
  ...
  withDisplayInterval(displayInterval: string | null): SparePartsForecastChartReact;

  /**
   * Interval display options in the chart shown only when dataSelection is enabled.
   */
  readonly displayIntervalOptions?: Array_Type<string>;
  withDisplayIntervalOptions(displayIntervalOptions: Array_Type<string> | Array<string> | null): SparePartsForecastChartReact;

  /**
   * Whether or not to override user config ID with data generated ID.
   */
  readonly shouldOverrideUserConfigIdWithDataGeneratedId?: boolean;
  withShouldOverrideUserConfigIdWithDataGeneratedId(shouldOverrideUserConfigIdWithDataGeneratedId: boolean): SparePartsForecastChartReact;

  /**
   * Whether or not to show the data selector. For example, the date range and interval selectors.
   */
  readonly dataSelection?: boolean;
  withDataSelection(dataSelection: boolean): SparePartsForecastChartReact;
  ...
  withDataSelectionControlsDataZoom(dataSelectionControlsDataZoom: boolean): SparePartsForecastChartReact;

  /**
   * Start value used in the datazoom to filter a certain range of chart.
   */
  readonly dataZoomStartValue?: string;
  withDataZoomStartValue(dataZoomStartValue: string | null): SparePartsForecastChartReact;

  /**
   * End value used in the datazoom to filter a certain range of chart.
   */
  readonly dataZoomEndValue?: string;
  withDataZoomEndValue(dataZoomEndValue: string | null): SparePartsForecastChartReact;
  ...
  withSynchronized(synchronized: boolean): SparePartsForecastChartReact;
  ...
  withSuppressOrderSeriesById(suppressOrderSeriesById: boolean): SparePartsForecastChartReact;

  /**
   * The id of the component to show when there is no data.
   */
  readonly noDataComponentId?: string;
  withNoDataComponentId(noDataComponentId: string | null): SparePartsForecastChartReact;

  /**
   * The {@link InventorySeries#partNumber} of the part currently plotted on the chart.
   */
  readonly selectedPartNumber?: string;
  withSelectedPartNumber(selectedPartNumber: string | null): SparePartsForecastChartReact;

  /**
   * The start of the zoom range.
   */
  readonly zoomRangeStart?: DateTime;
  withZoomRangeStart(zoomRangeStart: DateTime | Date | string | null): SparePartsForecastChartReact;

  /**
   * The end of the zoom range.
   */
  readonly zoomRangeEnd?: DateTime;
  withZoomRangeEnd(zoomRangeEnd: DateTime | Date | string | null): SparePartsForecastChartReact;
  ...
  withDataRange(dataRange: Map_Type<string, DateTime> | {[key: string]: DateTime | Date | string} | null): SparePartsForecastChartReact;

  /**
   * The chart data to display.
   */
  readonly chartData?: SparePartsForecastChartData;
  withChartData(chartData: ISparePartsForecastChartData | null): SparePartsForecastChartReact;
   ...
   * @see #toJson
   */
  static fromJson(json: any): SparePartsForecastChartReact | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): SparePartsForecastChartReact | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): SparePartsForecastChartReact | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): SparePartsForecastChartReact | null;
   ...
   */
  replaceType(old: Type, new_: Type): SparePartsForecastChartReact;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): SparePartsForecastChartReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): SparePartsForecastChartReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<SparePartsForecastChartReact>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<SparePartsForecastChartReact>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): SparePartsForecastChartReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SparePartsForecastChartReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SparePartsForecastChartReact;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): SparePartsForecastChartReact;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): SparePartsForecastChartReact;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): SparePartsForecastChartReact;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): SparePartsForecastChartReact;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): SparePartsForecastChartReact;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): SparePartsForecastChartReact;
   ...
   * @see #removeField
   */
  withoutField(field: string): SparePartsForecastChartReact;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): SparePartsForecastChartReact;
   ...
   */
  withoutFields(fields: Array_Type<string>): SparePartsForecastChartReact;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): SparePartsForecastChartReact;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): SparePartsForecastChartReact;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): SparePartsForecastChartReact;
   ...
   * @see #unsetField
   */
  defaultField(field: string): SparePartsForecastChartReact;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): SparePartsForecastChartReact;
   ...
   * @see #removeField
   */
  unsetField(field: string): SparePartsForecastChartReact;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): SparePartsForecastChartReact;
   ...
   * @see #unsetField
   */
  removeField(field: string): SparePartsForecastChartReact;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): SparePartsForecastChartReact;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): SparePartsForecastChartReact;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): SparePartsForecastChartReact;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): SparePartsForecastChartReact;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): SparePartsForecastChartReact;

  mergeJson(json: any): SparePartsForecastChartReact;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): SparePartsForecastChartReact;
   ...
   */
  sumObj(other: Obj, deep?: boolean): SparePartsForecastChartReact;
   ...
   */
  singletonArray(): Array_Type<SparePartsForecastChartReact>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<SparePartsForecastChartReact> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<SparePartsForecastChartReact> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<SparePartsForecastChartReact>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<SparePartsForecastChartReact> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, SparePartsForecastChartReact> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, SparePartsForecastChartReact> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<SparePartsForecastChartReact>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<SparePartsForecastChartReact>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): SparePartsForecastChartReact;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): SparePartsForecastChartReact;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): SparePartsForecastChartReact;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): SparePartsForecastChartReact;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): SparePartsForecastChartReact;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): SparePartsForecastChartReact;
   ...
   * @see #fromString
   */
  static make(s: string): SparePartsForecastChartReact | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): SparePartsForecastChartReact;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): SparePartsForecastChartReact;
   ...
   */
  static cachedEmptyInst(): SparePartsForecastChartReact;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<SparePartsForecastChartReact> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): SparePartsForecastChartReact;
   ...
   */
  static render(props?: SparePartsForecastChartReact): void;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<SparePartsForecastChartReact>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<SparePartsForecastChartReact>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<SparePartsForecastChartReact> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<SparePartsForecastChartReact>> | null;
   ...
   */
  dependencies(): MetadataDeps<SparePartsForecastChartReact>;

  save(subPath?: string, contentType?: string): SparePartsForecastChartReact;
  ...
  update(srcObj?: SparePartsForecastChartReact, spec?: UpsertSpec): SparePartsForecastChartReact | null;

  upsert(srcObj?: SparePartsForecastChartReact, spec?: UpsertSpec): SparePartsForecastChartReact | null;
   ...
   * @see #toString
   */
  static fromString(s: string): SparePartsForecastChartReact | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string, failIfMissing?: boolean): SparePartsForecastChartReact | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: SparePartsForecastChartReact, state: UiSdlReduxState): SparePartsForecastChartReact | null;
   ...
   *
   * @param componentId
   *        The {@link InventorySeries#id} of the component to affect.
   * @param partId
   *        The {@link InventorySeries#partNumber} to fetch data for.
   * @param partNumber
   *        The {@link InventorySeries#partNumber} to display in the subtitle
   * @param useDefaultTimeRange
   *        If true, use the default time range that is read from (@link ReliabilitySparePartsConfig#lookBackTimeWindow} and {@link ReliabilitySparePartsConfig#lookAheadTimeWindow}.
   *        If false, read the time range from `Reliability.SparePartsForecastChart.displayStartDate` and `Reliability.SparePartsForecastChart.displayEndDate`.
   * @return A Redux action to get data
   */
  static getDataAction(componentId: string, partId?: string, partNumber?: string, useDefaultTimeRange?: boolean): UiSdlReduxAction<any>;

  /**
   * When the `GET_DATA` action is triggered, this epic will set the `data` field with the returned data from
   * {@link SparePartsForecastChartDataGetter#getData}.
   *
   * @param actionStream
  ...
  /**
   * Resets the chart to its state after `GET_DATA` action was called.
   * @param componentId
