...
declare namespace ReliabilityOrchestrator.ModelScenarioProcess {
  export class Spec extends Obj  {
     ...
     */
    static buildAlertObjsFromScenario(project: ReliabilityMl.Project, alertData: any, algorithmData: any, featuresData: any): FetchResultWithTotalCount<any> | null;
     ...
     */
    static buildChartDataFromScenario(algorithmData: any, originalAlgorithmData: any, featuresData: any, alertData?: FetchResultWithTotalCount<any>): UiApTimeseriesChartDataConfig | null;
  }
}
