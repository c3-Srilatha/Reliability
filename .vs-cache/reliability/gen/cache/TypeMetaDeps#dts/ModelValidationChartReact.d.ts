// TypeScript definitions for the C3 type ModelValidationChartReact

/**
 * React renderer for {@link ModelValidationChart}
 *
 * @remarks this represents a value passed to a method that expects an instance of ModelValidationChartReact
 */
declare interface IModelValidationChartReact {
 ...
 * React renderer for {@link ModelValidationChart}
 *
 * @remarks this represents a made instance of ModelValidationChartReact
 */
declare class ModelValidationChartReact extends Obj  {

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): ModelValidationChartReact;

  /**
   * Unique identifier for the logical object that instance of this type represents.
   */
  readonly id?: string;
  withId(id: string | null): ModelValidationChartReact;

  /**
   * The name of the component. Optional field for informational purposes only.
   */
  readonly name?: string;
  withName(name: string | null): ModelValidationChartReact;

  /**
   * The specification used for retrieving data displayed by the grid.
   */
  readonly dataSpec?: UiSdlTimeseriesLineBarChartDataSpec;
  withDataSpec(dataSpec: IUiSdlTimeseriesLineBarChartDataSpec | null): ModelValidationChartReact;

  /**
   * Disable if you want to avoid sending any and all requests for this component on first render.
   */
  readonly disableDataRequestOnFirstRender?: boolean;
  withDisableDataRequestOnFirstRender(disableDataRequestOnFirstRender: boolean): ModelValidationChartReact;

  /**
   * Whether the effect triggers and epics have been registered
   */
  readonly triggersRegistered?: boolean;
  withTriggersRegistered(triggersRegistered: boolean): ModelValidationChartReact;

  /**
   * Whether to wrap the component with a div which has a class name of its metdata id. Useful for targeting with css.
   */
  readonly wrapWithMetadataId?: boolean;
  withWrapWithMetadataId(wrapWithMetadataId: boolean): ModelValidationChartReact;

  /**
   * A list of hidden series id.
   */
  readonly hiddenSeries?: Array_Type<string>;
  withHiddenSeries(hiddenSeries: Array_Type<string> | Array<string> | null): ModelValidationChartReact;
  ...
  withDefaultColors(defaultColors: Array_Type<string> | Array<string> | null): ModelValidationChartReact;

  /**
   * The background style for the chart.
   */
  readonly backgroundStyle?: string;
  withBackgroundStyle(backgroundStyle: string | null): ModelValidationChartReact;

  /**
   * The height of the component in pixels.
   */
  readonly height?: number;
  withHeight(height: number | null): ModelValidationChartReact;

  /**
   * Whether to enable tooltips.
   */
  readonly tooltipEnabled?: boolean;
  withTooltipEnabled(tooltipEnabled: boolean): ModelValidationChartReact;

  /**
   * The decimal precision to show on tooltip values.
   */
  readonly tooltipValuesDecimalPrecision?: number;
  withTooltipValuesDecimalPrecision(tooltipValuesDecimalPrecision: number | null): ModelValidationChartReact;

  /**
   * Whether or not to show units in tooltip
   */
  readonly tooltipUnitEnabled?: boolean;
  withTooltipUnitEnabled(tooltipUnitEnabled: boolean): ModelValidationChartReact;

  readonly tooltipConfig?: UiSdlTooltipBaseSettings;
  withTooltipConfig(tooltipConfig: IUiSdlTooltipBaseSettings | null): ModelValidationChartReact;
  ...
  withToolboxDataZoom(toolboxDataZoom: boolean): ModelValidationChartReact;

  /**
   * Holds the data to display in the grid.
   */
  readonly data?: Array_Type<Obj>;
  withData(data: Array_Type<Obj> | Array<IObj> | null): ModelValidationChartReact;

  /**
   * Chart header.
   */
  readonly header?: UiSdlComponentHeader;
  withHeader(header: IUiSdlComponentHeader | null): ModelValidationChartReact;

  /**
   * Y-axis config type.
   */
  readonly yAxis?: UiSdlLineBarChartYAxisConfig;
  withYAxis(yAxis: IUiSdlLineBarChartYAxisConfig | null): ModelValidationChartReact;
  ...
  withGrid(grid: IUiSdlChartEChartsGrid | null): ModelValidationChartReact;

  /**
   * The chart legend - information for each series.
   */
  readonly legend?: UiSdlChartLegend;
  withLegend(legend: IUiSdlChartLegend | null): ModelValidationChartReact;
  ...
  withZoomEnabled(zoomEnabled: boolean): ModelValidationChartReact;
  ...
  withDefaultChartType(defaultChartType: string | null): ModelValidationChartReact;
  ...
  withShowDownloadOptions(showDownloadOptions: boolean): ModelValidationChartReact;

  /**
   * Show a toggle next to the download options that will display data labels
   */
  readonly showDataLabelsToggle?: boolean;
  withShowDataLabelsToggle(showDataLabelsToggle: boolean): ModelValidationChartReact;

  /**
   * If `true`, stack all series whose series type is `'bar'`.
   */
  readonly stackBars?: boolean;
  withStackBars(stackBars: boolean): ModelValidationChartReact;
  ...
  withEmptyState(emptyState: IUiSdlComponentRef<UiSdlEmptyState> | null): ModelValidationChartReact;

  /**
   * The number of actions to display on the chart header.
   */
  readonly chartActionsCollapseThreshold?: number;
  withChartActionsCollapseThreshold(chartActionsCollapseThreshold: number | null): ModelValidationChartReact;

  /**
   * What is used to fill in missing seriesData when exporting to .csv data
   */
  readonly csvMissingDataFiller?: string;
  withCsvMissingDataFiller(csvMissingDataFiller: string | null): ModelValidationChartReact;

  /**
   * Whether or not to show the timezone label below chart.
   */
  readonly showTimeZoneLabel?: boolean;
  withShowTimeZoneLabel(showTimeZoneLabel: boolean): ModelValidationChartReact;
  ...
  withTimeZoneLabel(timeZoneLabel: string | IUiSdlDynamicValueSpec | null): ModelValidationChartReact;
  ...
  withTimeZoneNameFormat(timeZoneNameFormat: string | null): ModelValidationChartReact;

  /**
   * The specification used to retrieve event data displayed by this chart.
   */
  readonly eventDataSpec?: UiSdlTimeseriesLineBarChartEventDataSpec;
  withEventDataSpec(eventDataSpec: IUiSdlTimeseriesLineBarChartEventDataSpec | null): ModelValidationChartReact;

  /**
   * Stores the FetchResults retrieved by {@link #eventDataSpec}.
   */
  readonly eventData?: Obj;
  withEventData(eventData: IObj | null): ModelValidationChartReact;
  ...
  withEvalDataSpec(evalDataSpec: IUiSdlTimeseriesLineBarChartEvalDataSpec | null): ModelValidationChartReact;
  ...
  withShowCrosshair(showCrosshair: boolean): ModelValidationChartReact;
  ...
  withXAxis(xAxis: IUiSdlTimeseriesLineBarChartXAxisConfig | IUiSdlTimeseriesLineBarChartXAxisStaticConfig | null): ModelValidationChartReact;

  /**
   * Whether or not to display the "now" line on the chart.
   */
  readonly showNowLine?: boolean;
  withShowNowLine(showNowLine: boolean): ModelValidationChartReact;
  ...
  withCollapseXAxis(collapseXAxis: boolean): ModelValidationChartReact;

  /**
   * Style configurations of vertical line at the "now" point of time according to the interval of data being plotted.
   */
  readonly nowLineConfig?: UiSdlTimeseriesLineBarChartNowLineConfig;
  withNowLineConfig(nowLineConfig: IUiSdlTimeseriesLineBarChartNowLineConfig | null): ModelValidationChartReact;

  /**
   * Configuration to add vertical line at any date on the graph.
   */
  readonly dateLines?: Array_Type<UiSdlTimeseriesLineBarChartDateLineConfig>;
  withDateLines(dateLines: Array_Type<UiSdlTimeseriesLineBarChartDateLineConfig> | Array<IUiSdlTimeseriesLineBarChartDateLineConfig> | null): ModelValidationChartReact;

  /**
   * Configurations to add vertical line at any date on the graph requiring a fetch call.
   */
  readonly dateLinesDataSpec?: UiSdlTimeseriesLineBarChartDateLineDataSpec;
  withDateLinesDataSpec(dateLinesDataSpec: IUiSdlTimeseriesLineBarChartDateLineDataSpec | null): ModelValidationChartReact;

  /**
   * Whether or not to plot and show data at timestamps where there are 100% missing values.
   */
  readonly hideMissingDataPoints?: boolean;
  withHideMissingDataPoints(hideMissingDataPoints: boolean): ModelValidationChartReact;
  ...
  withNoTimeZoneConversion(noTimeZoneConversion: boolean): ModelValidationChartReact;
  ...
  withShowAllTimestampInfoOnTooltip(showAllTimestampInfoOnTooltip: boolean): ModelValidationChartReact;

  /**
   * Whether or not to show the start date of the chart.
   */
  readonly showStartAndEndDate?: boolean;
  withShowStartAndEndDate(showStartAndEndDate: boolean): ModelValidationChartReact;

  /**
   * Start date displayed in the chart shown only when dataSelection is enabled.
   */
  readonly displayStartDate?: string;
  withDisplayStartDate(displayStartDate: string | null): ModelValidationChartReact;

  /**
   * End date displayed in the chart shown only when dataSelection is enabled.
   */
  readonly displayEndDate?: string;
  withDisplayEndDate(displayEndDate: string | null): ModelValidationChartReact;

  readonly markerIdentifiersToCollapse?: Array_Type<string>;
  withMarkerIdentifiersToCollapse(markerIdentifiersToCollapse: Array_Type<string> | Array<string> | null): ModelValidationChartReact;
  ...
  withDisplayInterval(displayInterval: string | null): ModelValidationChartReact;

  /**
   * Interval display options in the chart shown only when dataSelection is enabled.
   */
  readonly displayIntervalOptions?: Array_Type<string>;
  withDisplayIntervalOptions(displayIntervalOptions: Array_Type<string> | Array<string> | null): ModelValidationChartReact;

  /**
   * Whether or not to override user config ID with data generated ID.
   */
  readonly shouldOverrideUserConfigIdWithDataGeneratedId?: boolean;
  withShouldOverrideUserConfigIdWithDataGeneratedId(shouldOverrideUserConfigIdWithDataGeneratedId: boolean): ModelValidationChartReact;

  /**
   * Whether or not to show the data selector. For example, the date range and interval selectors.
   */
  readonly dataSelection?: boolean;
  withDataSelection(dataSelection: boolean): ModelValidationChartReact;
  ...
  withDataSelectionControlsDataZoom(dataSelectionControlsDataZoom: boolean): ModelValidationChartReact;

  /**
   * Start value used in the datazoom to filter a certain range of chart.
   */
  readonly dataZoomStartValue?: string;
  withDataZoomStartValue(dataZoomStartValue: string | null): ModelValidationChartReact;

  /**
   * End value used in the datazoom to filter a certain range of chart.
   */
  readonly dataZoomEndValue?: string;
  withDataZoomEndValue(dataZoomEndValue: string | null): ModelValidationChartReact;
  ...
  withSynchronized(synchronized: boolean): ModelValidationChartReact;
  ...
  withSuppressOrderSeriesById(suppressOrderSeriesById: boolean): ModelValidationChartReact;

  /**
   * The id of the component to show when there is no data.
   */
  readonly noDataComponentId?: string;
  withNoDataComponentId(noDataComponentId: string | null): ModelValidationChartReact;

  /**
   * The ids of the series that are currently plotted on the chart.
   */
  readonly selectedFeatureId?: string;
  withSelectedFeatureId(selectedFeatureId: string | null): ModelValidationChartReact;

  /**
   * The start of the zoom range.
   */
  readonly zoomRangeStart?: DateTime;
  withZoomRangeStart(zoomRangeStart: DateTime | Date | string | null): ModelValidationChartReact;

  /**
   * The end of the zoom range.
   */
  readonly zoomRangeEnd?: DateTime;
  withZoomRangeEnd(zoomRangeEnd: DateTime | Date | string | null): ModelValidationChartReact;

  /**
   * The risk score threshold to plot.
   */
  readonly riskScoreThreshold?: number;
  withRiskScoreThreshold(riskScoreThreshold: number | null): ModelValidationChartReact;
  ...
  withDataRange(dataRange: Map_Type<string, DateTime> | {[key: string]: DateTime | Date | string} | null): ModelValidationChartReact;

  /**
   * The chart data to display.
   */
  readonly chartData?: ModelValidationChartData;
  withChartData(chartData: IModelValidationChartData | null): ModelValidationChartReact;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ModelValidationChartReact | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ModelValidationChartReact | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ModelValidationChartReact | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ModelValidationChartReact | null;
   ...
   */
  replaceType(old: Type, new_: Type): ModelValidationChartReact;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ModelValidationChartReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ModelValidationChartReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ModelValidationChartReact>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ModelValidationChartReact>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ModelValidationChartReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ModelValidationChartReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ModelValidationChartReact;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ModelValidationChartReact;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ModelValidationChartReact;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ModelValidationChartReact;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ModelValidationChartReact;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ModelValidationChartReact;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ModelValidationChartReact;
   ...
   * @see #removeField
   */
  withoutField(field: string): ModelValidationChartReact;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ModelValidationChartReact;
   ...
   */
  withoutFields(fields: Array_Type<string>): ModelValidationChartReact;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ModelValidationChartReact;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ModelValidationChartReact;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ModelValidationChartReact;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ModelValidationChartReact;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ModelValidationChartReact;
   ...
   * @see #removeField
   */
  unsetField(field: string): ModelValidationChartReact;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ModelValidationChartReact;
   ...
   * @see #unsetField
   */
  removeField(field: string): ModelValidationChartReact;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ModelValidationChartReact;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ModelValidationChartReact;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ModelValidationChartReact;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ModelValidationChartReact;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ModelValidationChartReact;

  mergeJson(json: any): ModelValidationChartReact;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ModelValidationChartReact;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ModelValidationChartReact;
   ...
   */
  singletonArray(): Array_Type<ModelValidationChartReact>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ModelValidationChartReact> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ModelValidationChartReact> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ModelValidationChartReact>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ModelValidationChartReact> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ModelValidationChartReact> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ModelValidationChartReact> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ModelValidationChartReact>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ModelValidationChartReact>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ModelValidationChartReact;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ModelValidationChartReact;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ModelValidationChartReact;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ModelValidationChartReact;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ModelValidationChartReact;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ModelValidationChartReact;
   ...
   * @see #fromString
   */
  static make(s: string): ModelValidationChartReact | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ModelValidationChartReact;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ModelValidationChartReact;
   ...
   */
  static cachedEmptyInst(): ModelValidationChartReact;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ModelValidationChartReact> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ModelValidationChartReact;
   ...
   */
  static render(props?: ModelValidationChartReact): void;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<ModelValidationChartReact>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ModelValidationChartReact>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<ModelValidationChartReact> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ModelValidationChartReact>> | null;
   ...
   */
  dependencies(): MetadataDeps<ModelValidationChartReact>;

  save(subPath?: string, contentType?: string): ModelValidationChartReact;
  ...
  update(srcObj?: ModelValidationChartReact, spec?: UpsertSpec): ModelValidationChartReact | null;

  upsert(srcObj?: ModelValidationChartReact, spec?: UpsertSpec): ModelValidationChartReact | null;
   ...
   * @see #toString
   */
  static fromString(s: string): ModelValidationChartReact | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string, failIfMissing?: boolean): ModelValidationChartReact | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: ModelValidationChartReact, state: UiSdlReduxState): ModelValidationChartReact | null;
