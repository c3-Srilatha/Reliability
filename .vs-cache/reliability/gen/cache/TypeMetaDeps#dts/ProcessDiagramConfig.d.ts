...
declare class ProcessDiagramConfig extends Obj  {
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ProcessDiagramConfig;
   ...
   * The parent asset that represents the whole process flow diagram.
   */
  readonly parentAsset?: PhysicalAsset;
  withParentAsset(parentAsset: IPhysicalAsset | null): ProcessDiagramConfig;

  /**
   * The component asset that represents one component in the process flow diagram.
   */
  readonly componentAsset?: PhysicalAsset;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ProcessDiagramConfig | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ProcessDiagramConfig | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ProcessDiagramConfig | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ProcessDiagramConfig | null;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ProcessDiagramConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ProcessDiagramConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ProcessDiagramConfig>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ProcessDiagramConfig>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ProcessDiagramConfig;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ProcessDiagramConfig;
   ...
   * @see #removeField
   */
  withoutField(field: string): ProcessDiagramConfig;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ProcessDiagramConfig;
   ...
   */
  withoutFields(fields: Array_Type<string>): ProcessDiagramConfig;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ProcessDiagramConfig;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ProcessDiagramConfig;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ProcessDiagramConfig;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ProcessDiagramConfig;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ProcessDiagramConfig;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ProcessDiagramConfig;

  mergeJson(json: any): ProcessDiagramConfig;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ProcessDiagramConfig;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ProcessDiagramConfig;
   ...
   */
  singletonArray(): Array_Type<ProcessDiagramConfig>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ProcessDiagramConfig> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ProcessDiagramConfig> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ProcessDiagramConfig>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ProcessDiagramConfig> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ProcessDiagramConfig> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ProcessDiagramConfig> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ProcessDiagramConfig>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ProcessDiagramConfig>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ProcessDiagramConfig;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ProcessDiagramConfig;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ProcessDiagramConfig;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ProcessDiagramConfig;
   ...
   * @see #fromString
   */
  static make(s: string): ProcessDiagramConfig | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ProcessDiagramConfig;
   ...
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ProcessDiagramConfig> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ProcessDiagramConfig;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<ProcessDiagramConfig>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ProcessDiagramConfig>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<ProcessDiagramConfig> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ProcessDiagramConfig>> | null;
   ...
   */
  get(include?: string): ProcessDiagramConfig | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): ProcessDiagramConfig | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): ProcessDiagramConfig | null;
   ...
   * @see #toString
   */
  static fromString(s: string): ProcessDiagramConfig | null;
   ...
   */
  create(spec?: UpsertSpec): ProcessDiagramConfig | null;
   ...
   */
  static createBatch(objs: Array_Type<ProcessDiagramConfig>, spec?: UpsertSpec): ObjList<ProcessDiagramConfig> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ProcessDiagramConfig>, spec?: CreateBatchObjStreamSpec): ObjList<ProcessDiagramConfig> | null;
   ...
   */
  update(srcObj?: ProcessDiagramConfig, spec?: UpsertSpec): ProcessDiagramConfig | null;
   ...
   */
  upsert(srcObj?: ProcessDiagramConfig, spec?: UpsertSpec): ProcessDiagramConfig | null;
   ...
   */
  merge(spec?: MergeSpec): ProcessDiagramConfig | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): ProcessDiagramConfig | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): ProcessDiagramConfig | null;
   ...
   */
  static updateBatch(objs: Array_Type<ProcessDiagramConfig>, srcObjs?: Array_Type<ProcessDiagramConfig>, spec?: UpsertSpec): ObjList<ProcessDiagramConfig> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<ProcessDiagramConfig> | null>, spec?: UpsertSpec): ObjList<ProcessDiagramConfig> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<ProcessDiagramConfig>, srcObjs?: Array_Type<ProcessDiagramConfig>, spec?: UpsertSpec): ObjList<ProcessDiagramConfig> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<ProcessDiagramConfig> | null>, spec?: UpsertSpec): ObjList<ProcessDiagramConfig> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<ProcessDiagramConfig>, spec?: TouchSpec): ObjList<ProcessDiagramConfig> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ProcessDiagramConfig>, spec?: MergeSpec): ObjList<ProcessDiagramConfig> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ProcessDiagramConfig>, mergeInclude: string, spec?: MergeSpec): ObjList<ProcessDiagramConfig> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<ProcessDiagramConfig> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ProcessDiagramConfig> | null;
   ...
   */
  static mergeAll(mergeObj: ProcessDiagramConfig, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ProcessDiagramConfig, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<ProcessDiagramConfig>, spec?: UpsertSpec): ObjList<ProcessDiagramConfig> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<ProcessDiagramConfig>, spec?: UpsertSpec): ObjList<ProcessDiagramConfig> | null;
   ...
   */
  static beforeCreate(objs: Array_Type<ProcessDiagramConfig>): ObjList<ProcessDiagramConfig>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<ProcessDiagramConfig>): ObjList<ProcessDiagramConfig>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<ProcessDiagramConfig>): ObjList<ProcessDiagramConfig>;
   ...
   */
  static afterCreate(objs: Array_Type<ProcessDiagramConfig>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<ProcessDiagramConfig>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<ProcessDiagramConfig>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<ProcessDiagramConfig>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ProcessDiagramConfig>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): ProcessDiagramConfig | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<ProcessDiagramConfig>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: ProcessDiagramConfig, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<ProcessDiagramConfig>, callback?: λFunction<ProcessDiagramConfig | null, ProcessDiagramConfig | null>): ObjList<ProcessDiagramConfig>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<ProcessDiagramConfig>, callback?: λFunction<ProcessDiagramConfig | null, ProcessDiagramConfig | null>): Array_Type<ObjError> | null;
