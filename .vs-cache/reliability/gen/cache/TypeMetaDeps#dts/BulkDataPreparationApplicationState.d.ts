...
declare class BulkDataPreparationApplicationState extends Obj  {
  ...
  withNonOperationalMasks(nonOperationalMasks: Array_Type<ReliabilityDataPreparationRuleMaskSpec> | Array<IReliabilityDataPreparationRuleMaskSpec> | null): BulkDataPreparationApplicationState;

  /**
   * Array of rules indicating the time period when {@link ReliabilityAsset} was non-operational
   * {@link Triple} includes {@link Sensor}, operator (e.g. '>'), and value for the rule.
   */
  static readonly nonOperationalMasks?: Array_Type<ReliabilityDataPreparationRuleMaskSpec>;
   ...
   * to exclude {@link Sensor} data for training.
   */
  static readonly preNonOperationalMaskPeriod?: Period;
   ...
   * to exclude {@link Sensor} data for training. This does not apply to inference.
   */
  static readonly postNonOperationalTrainingMaskPeriod?: Period;
   ...
   * to exclude {@link Sensor} data for training. This does not apply to inference.
   */
  static readonly postNonOperationalInferenceMaskPeriod?: Period;
  ...
  withDateRangeMaskTimeRanges(dateRangeMaskTimeRanges: Array_Type<TimeRange> | Array<ITimeRange> | null): BulkDataPreparationApplicationState;

  /**
   * {@link TimeRange}s to exclude {@Sensor} data from training data.
   */
  static readonly dateRangeMaskTimeRanges?: Array_Type<TimeRange>;
  ...
  withTrainingRuleMasks(trainingRuleMasks: Array_Type<ReliabilityDataPreparationRuleMaskSpec> | Array<IReliabilityDataPreparationRuleMaskSpec> | null): BulkDataPreparationApplicationState;

  /**
   * Array of rules indicating the time periods to exclude {@link Sensor} data from training data.
   * {@link Triple} includes {@link Sensor}, operator (e.g. '>'), and value for the rule.
   */
  static readonly trainingRuleMasks?: Array_Type<ReliabilityDataPreparationRuleMaskSpec>;
  ...
  withInferenceRuleMasks(inferenceRuleMasks: Array_Type<ReliabilityDataPreparationRuleMaskSpec> | Array<IReliabilityDataPreparationRuleMaskSpec> | null): BulkDataPreparationApplicationState;

  /**
   * Array of rules indicating the time periods to exclude {@link Sensor} data from inference data.
   * {@link Triple} includes {@link Sensor}, operator (e.g. '>'), and value for the rule.
   */
  static readonly inferenceRuleMasks?: Array_Type<ReliabilityDataPreparationRuleMaskSpec>;
   ...
   * String of rules indicating the time period when {@link ReliabilityAsset} was non-operational
   */
  static readonly nonOperationalMasksExpression?: string;
   ...
   * String of rules indicating the time periods to exclude {@link Sensor} data from training data.
   */
  static readonly trainingRuleMasksExpression?: string;
   ...
   * String of rules indicating the time periods to exclude {@link Sensor} data from inference data.
   */
  static readonly inferenceRuleMasksExpression?: string;
   ...
   * The flatline sensor data threshold to use for the Data Preparation Job
   */
  static readonly flatlineThreshold?: number;
   ...
   * The missing sensor data threshold to use for the Data Preparation Job
   */
  static readonly missingDataThreshold?: number;
   ...
   * Start Date of the dataset used for training.
   */
  static readonly trainStart?: DateTime;
   ...
   * End Date of the dataset used for training.
   */
  static readonly trainEnd?: DateTime;
   ...
   * Start Date of the dataset used for Validating.
   */
  static readonly validStart?: DateTime;
   ...
   * End Date of the dataset used for Validating.
   */
  static readonly validEnd?: DateTime;
   ...
   * This field is not set by the user.
   */
  static readonly numAssets?: number;
  ...
  withTargetAssets(targetAssets: Array_Type<ReliabilityAsset> | Array<IReliabilityAsset> | null): BulkDataPreparationApplicationState;

  /**
   * The assets that we want to run data preparation on. Used to filter {@link ReliabilityMlDatasetPreparationJob}
   * by asset.
   */
  static readonly targetAssets?: Array_Type<ReliabilityAsset>;
  ...
  withIncludeSensors(includeSensors: Array_Type<Sensor> | Array<ISensor> | null): BulkDataPreparationApplicationState;
   ...
   * {@link BulkModelSetupUiSettings#startBulkModelSetup}, not by the user.
   */
  static readonly includeSensors?: Array_Type<Sensor>;
  ...
  withExcludeSensors(excludeSensors: Array_Type<Sensor> | Array<ISensor> | null): BulkDataPreparationApplicationState;
   ...
   * {@link BulkModelSetupUiSettings#startBulkModelSetup}, not by the user.
   */
  static readonly excludeSensors?: Array_Type<Sensor>;
   ...
   * Variance value used to filter {@link SensorDataReport}
   */
  static readonly variance?: number;
   ...
   * Stores the id of the {@link MlProject} that the user selected to create the new dataset
   */
  static readonly project?: ReliabilityMl.Project;

  /**
   * The date time ranges selected by the user for training
   */
  readonly trainingDatasetTimeRanges?: Array_Type<TimeRange>;
  withTrainingDatasetTimeRanges(trainingDatasetTimeRanges: Array_Type<TimeRange> | Array<ITimeRange> | null): BulkDataPreparationApplicationState;

  /**
   * The date time ranges selected by the user for training
   */
  static readonly trainingDatasetTimeRanges?: Array_Type<TimeRange>;

  /**
   * The date time ranges selected by the user for validation
   */
  readonly validateDatasetTimeRanges?: Array_Type<TimeRange>;
  withValidateDatasetTimeRanges(validateDatasetTimeRanges: Array_Type<TimeRange> | Array<ITimeRange> | null): BulkDataPreparationApplicationState;

  /**
   * The date time ranges selected by the user for validation
   */
  static readonly validateDatasetTimeRanges?: Array_Type<TimeRange>;
  ...
  withExtraTimeRangeMasks(extraTimeRangeMasks: Array_Type<TimeRange> | Array<ITimeRange> | null): BulkDataPreparationApplicationState;
   ...
   * `mask_AdHocTraining` type masks.
   */
  static readonly extraTimeRangeMasks?: Array_Type<TimeRange>;
   ...
   * @uiSdlDesignerCustomRenderer(rendererType='')
   */
  static readonly dataSpec?: UiSdlNoData;
   ...
   * The Redux namespace for the application state to indicate where the application data is stored in the Redux state.
   */
  static readonly REDUX_NAMESPACE?: string;

  /**
   * Collection of extra async {@link UiSdlEffectTrigger}.
   */
  readonly effectTriggers?: Array_Type<UiSdlEffectTrigger>;
  withEffectTriggers(effectTriggers: Array_Type<UiSdlEffectTrigger> | Array<IUiSdlEffectTrigger> | null): BulkDataPreparationApplicationState;

  /**
   * Collection of extra async {@link UiSdlEffectTrigger}.
   */
  static readonly effectTriggers?: Array_Type<UiSdlEffectTrigger>;
  ...
  withIssues(issues: Array_Type<string> | Array<string> | null): BulkDataPreparationApplicationState;
   ...
   * @see #toJson
   */
  static fromJson(json: any): BulkDataPreparationApplicationState | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): BulkDataPreparationApplicationState | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): BulkDataPreparationApplicationState | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): BulkDataPreparationApplicationState | null;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): BulkDataPreparationApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): BulkDataPreparationApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): BulkDataPreparationApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): BulkDataPreparationApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<BulkDataPreparationApplicationState>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<BulkDataPreparationApplicationState>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<BulkDataPreparationApplicationState>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<BulkDataPreparationApplicationState>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): BulkDataPreparationApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): BulkDataPreparationApplicationState;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): BulkDataPreparationApplicationState;
   ...
   * @return new Obj
   */
  static withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): BulkDataPreparationApplicationState;
   ...
   * @see #removeField
   */
  withoutField(field: string): BulkDataPreparationApplicationState;
   ...
   * @see #removeField
   */
  static withoutField(field: string): BulkDataPreparationApplicationState;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): BulkDataPreparationApplicationState;
   ...
   * @see #removeField
   */
  static withoutField(field: FieldType): BulkDataPreparationApplicationState;
   ...
   */
  withoutFields(fields: Array_Type<string>): BulkDataPreparationApplicationState;
   ...
   * @return new Obj with removed fields
   */
  static withoutFields(fields: Array_Type<string>): BulkDataPreparationApplicationState;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): BulkDataPreparationApplicationState;
   ...
   * @return new Obj with removed fields
   */
  static withoutFieldsByType(fields: Array_Type<FieldType>): BulkDataPreparationApplicationState;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): BulkDataPreparationApplicationState;
   ...
   * @see FieldType#defaultValue
   */
  static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): BulkDataPreparationApplicationState;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): BulkDataPreparationApplicationState;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): BulkDataPreparationApplicationState;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): BulkDataPreparationApplicationState;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj, otherFieldsFilter: Type): BulkDataPreparationApplicationState;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): BulkDataPreparationApplicationState;
   ...
   *        the same key or index.
   */
  static mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): BulkDataPreparationApplicationState;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): BulkDataPreparationApplicationState;
   ...
   * traverse child reference and collection fields.
   */
  static mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): BulkDataPreparationApplicationState;

  mergeJson(json: any): BulkDataPreparationApplicationState;

  static mergeJson(json: any): BulkDataPreparationApplicationState;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): BulkDataPreparationApplicationState;
   ...
   * @return Obj with child references merged
   */
  static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): BulkDataPreparationApplicationState;
   ...
   */
  sumObj(other: Obj, deep?: boolean): BulkDataPreparationApplicationState;
   ...
   * references with same name and collection elements at same index or key.
   */
  static sumObj(other: Obj, deep?: boolean): BulkDataPreparationApplicationState;
   ...
   */
  singletonArray(): Array_Type<BulkDataPreparationApplicationState>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonArray(): Array_Type<BulkDataPreparationApplicationState>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<BulkDataPreparationApplicationState> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<BulkDataPreparationApplicationState> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<BulkDataPreparationApplicationState>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonSet(): Set_Type<BulkDataPreparationApplicationState>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<BulkDataPreparationApplicationState> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, BulkDataPreparationApplicationState> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, BulkDataPreparationApplicationState> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<BulkDataPreparationApplicationState>;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  static toBuilder(): ObjBuilder<BulkDataPreparationApplicationState>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<BulkDataPreparationApplicationState>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): BulkDataPreparationApplicationState;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): BulkDataPreparationApplicationState;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): BulkDataPreparationApplicationState;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): BulkDataPreparationApplicationState;
   ...
   * @see #fromString
   */
  static make(s: string): BulkDataPreparationApplicationState | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): BulkDataPreparationApplicationState;
   ...
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<BulkDataPreparationApplicationState> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): BulkDataPreparationApplicationState;
   ...
   * @return A map of override feature field to either Feature objects or metric expression strings.
   */
  static createMaskOverrides(interval?: string, returnMetricExpressions?: boolean): Map_Type<string, Feature> | Map_Type<string, string> | null;
   ...
   * @return A spec that can be used to start a {@link ReliabilityMlDatasetPreparationJob}
   */
  static makeBaseSpec(includedSensorIds?: Array_Type<string>, excludedSensorIds?: Array_Type<string>, additionalRasrs?: Array_Type<ReliabilityAssetSensorRelation>): ReliabilityMlDatasetPreparationSpec;
   ...
   * @return An array of {@link TimeRange} objects representing unselected time ranges.
   */
  static getUnselectedTimeRanges(): Array_Type<TimeRange> | null;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<BulkDataPreparationApplicationState>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<BulkDataPreparationApplicationState>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<BulkDataPreparationApplicationState> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<BulkDataPreparationApplicationState>> | null;
   ...
   */
  dependencies(): MetadataDeps<BulkDataPreparationApplicationState>;

  /**
   * Retrieves dependencies to types or other metadata elements for the given instance of metadata.
   */
  static dependencies(): MetadataDeps<BulkDataPreparationApplicationState>;

  save(subPath?: string, contentType?: string): BulkDataPreparationApplicationState;

  static save(subPath?: string, contentType?: string): BulkDataPreparationApplicationState;
  ...
  update(srcObj?: BulkDataPreparationApplicationState, spec?: UpsertSpec): BulkDataPreparationApplicationState | null;

  static update(srcObj?: BulkDataPreparationApplicationState, spec?: UpsertSpec): BulkDataPreparationApplicationState | null;

  upsert(srcObj?: BulkDataPreparationApplicationState, spec?: UpsertSpec): BulkDataPreparationApplicationState | null;

  static upsert(srcObj?: BulkDataPreparationApplicationState, spec?: UpsertSpec): BulkDataPreparationApplicationState | null;
   ...
   * @see #toString
   */
  static fromString(s: string): BulkDataPreparationApplicationState | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string, failIfMissing?: boolean): BulkDataPreparationApplicationState | null;
   ...
   */
  static find(filter?: string, doNotProduceAll?: boolean): Stream<BulkDataPreparationApplicationState> | null;
   ...
   */
  static forCacheKey(key: string): BulkDataPreparationApplicationState | null;
   ...
   */
  static produceAll(): Map_Type<string, BulkDataPreparationApplicationState> | null;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): Map_Type<string, BulkDataPreparationApplicationState> | null;
   ...
   */
  withConfigKey(configKey: string): BulkDataPreparationApplicationState;
   ...
   *     config.configKey() => "folder1/abc"
   */
  static withConfigKey(configKey: string): BulkDataPreparationApplicationState;

  /**
   * @return copy without config key.
   */
  withoutConfigKey(): BulkDataPreparationApplicationState;

  /**
   * @return copy without config key.
   */
  static withoutConfigKey(): BulkDataPreparationApplicationState;

  /**
   * @return return cached config instance for provided config key.
   */
  static forConfigKey(configKey: string): BulkDataPreparationApplicationState | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string>): Stream<BulkDataPreparationApplicationState> | null;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: BulkDataPreparationApplicationState, override?: string): void;

  /**
   * Sets multiple field values to be the same as the passed instance.
   * @see setConfigValue
   */
  static setConfigValues(from: BulkDataPreparationApplicationState, override?: string): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: BulkDataPreparationApplicationState, override?: string): void;

  /**
   * Sets multiple secret field values to be the same as the passed instance.
   * @see setSecretValue
   */
  static setSecretValues(from: BulkDataPreparationApplicationState, override?: string): void;
