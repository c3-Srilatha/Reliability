...
declare interface IDataPreparationApplicationState {
   ...
   */
  currentlyOpenDataPreparationJob?: IReliabilityMlDatasetPreparationJob;
...
declare class DataPreparationApplicationState extends Obj  {
  ...
  withNonOperationalMasks(nonOperationalMasks: Array_Type<ReliabilityDataPreparationRuleMaskSpec> | Array<IReliabilityDataPreparationRuleMaskSpec> | null): DataPreparationApplicationState;
  ...
  withDateRangeMaskTimeRanges(dateRangeMaskTimeRanges: Array_Type<TimeRange> | Array<ITimeRange> | null): DataPreparationApplicationState;
  ...
  withTrainingRuleMasks(trainingRuleMasks: Array_Type<ReliabilityDataPreparationRuleMaskSpec> | Array<IReliabilityDataPreparationRuleMaskSpec> | null): DataPreparationApplicationState;
  ...
  withInferenceRuleMasks(inferenceRuleMasks: Array_Type<ReliabilityDataPreparationRuleMaskSpec> | Array<IReliabilityDataPreparationRuleMaskSpec> | null): DataPreparationApplicationState;
  ...
  withTargetAssets(targetAssets: Array_Type<ReliabilityAsset> | Array<IReliabilityAsset> | null): DataPreparationApplicationState;
  ...
  withIncludeSensors(includeSensors: Array_Type<Sensor> | Array<ISensor> | null): DataPreparationApplicationState;
  ...
  withExcludeSensors(excludeSensors: Array_Type<Sensor> | Array<ISensor> | null): DataPreparationApplicationState;
  ...
  withTrainingDatasetTimeRanges(trainingDatasetTimeRanges: Array_Type<TimeRange> | Array<ITimeRange> | null): DataPreparationApplicationState;

  /**
   * The date time ranges selected by the user for validation
   */
  readonly validateDatasetTimeRanges?: Array_Type<TimeRange>;
  withValidateDatasetTimeRanges(validateDatasetTimeRanges: Array_Type<TimeRange> | Array<ITimeRange> | null): DataPreparationApplicationState;
  ...
  withExtraTimeRangeMasks(extraTimeRangeMasks: Array_Type<TimeRange> | Array<ITimeRange> | null): DataPreparationApplicationState;
  ...
  withManuallyExcludedSensors(manuallyExcludedSensors: Array_Type<string> | Array<string> | null): DataPreparationApplicationState;

  /**
   * Array of {@link SensorDataReport#id}s manually included in data preparation.
   */
  readonly manuallyIncludedSensors?: Array_Type<string>;
  withManuallyIncludedSensors(manuallyIncludedSensors: Array_Type<string> | Array<string> | null): DataPreparationApplicationState;

  /**
   * Array of additional {@link Sensor#id}s that have to be included in the dataset preparation.
   */
  readonly additionalSensors?: Array_Type<string>;
  withAdditionalSensors(additionalSensors: Array_Type<string> | Array<string> | null): DataPreparationApplicationState;

  /**
   * Array of additional {@link ReliabilityAssetSensorRelation#id}s that have to be included in the dataset preparation.
   */
  readonly additionalRasrs?: Array_Type<string>;
  withAdditionalRasrs(additionalRasrs: Array_Type<string> | Array<string> | null): DataPreparationApplicationState;
  ...
  withEffectTriggers(effectTriggers: Array_Type<UiSdlEffectTrigger> | Array<IUiSdlEffectTrigger> | null): DataPreparationApplicationState;

  /**
   * The {@link Interval} to display in the dataset preview.
   */
  readonly previewInterval?: string;
  withPreviewInterval(previewInterval: string | null): DataPreparationApplicationState;

  /**
   * The percentage of the dataset used for validation.
   */
  readonly validationPercentage?: number;
  withValidationPercentage(validationPercentage: number | null): DataPreparationApplicationState;

  /**
   * The subset of the dataset to use for validation.
   */
  readonly validationSubset?: string;
   ...
   * The currently open dataset preparation job in the Data Preparation Grid on the Model Management, Jobs Page
   */
  readonly currentlyOpenDataPreparationJob?: ReliabilityMlDatasetPreparationJob;
   ...
   * @see #toJson
   */
  static fromJson(json: any): DataPreparationApplicationState | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): DataPreparationApplicationState | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): DataPreparationApplicationState | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): DataPreparationApplicationState | null;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): DataPreparationApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): DataPreparationApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<DataPreparationApplicationState>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<DataPreparationApplicationState>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): DataPreparationApplicationState;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): DataPreparationApplicationState;
   ...
   * @see #removeField
   */
  withoutField(field: string): DataPreparationApplicationState;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): DataPreparationApplicationState;
   ...
   */
  withoutFields(fields: Array_Type<string>): DataPreparationApplicationState;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): DataPreparationApplicationState;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): DataPreparationApplicationState;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): DataPreparationApplicationState;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): DataPreparationApplicationState;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): DataPreparationApplicationState;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): DataPreparationApplicationState;

  mergeJson(json: any): DataPreparationApplicationState;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): DataPreparationApplicationState;
   ...
   */
  sumObj(other: Obj, deep?: boolean): DataPreparationApplicationState;
   ...
   */
  singletonArray(): Array_Type<DataPreparationApplicationState>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<DataPreparationApplicationState> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<DataPreparationApplicationState> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<DataPreparationApplicationState>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<DataPreparationApplicationState> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, DataPreparationApplicationState> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, DataPreparationApplicationState> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<DataPreparationApplicationState>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<DataPreparationApplicationState>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): DataPreparationApplicationState;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): DataPreparationApplicationState;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): DataPreparationApplicationState;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): DataPreparationApplicationState;
   ...
   * @see #fromString
   */
  static make(s: string): DataPreparationApplicationState | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): DataPreparationApplicationState;
   ...
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<DataPreparationApplicationState> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): DataPreparationApplicationState;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<DataPreparationApplicationState>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<DataPreparationApplicationState>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<DataPreparationApplicationState> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<DataPreparationApplicationState>> | null;
   ...
   */
  dependencies(): MetadataDeps<DataPreparationApplicationState>;

  save(subPath?: string, contentType?: string): DataPreparationApplicationState;
  ...
  update(srcObj?: DataPreparationApplicationState, spec?: UpsertSpec): DataPreparationApplicationState | null;

  upsert(srcObj?: DataPreparationApplicationState, spec?: UpsertSpec): DataPreparationApplicationState | null;
   ...
   * @see #toString
   */
  static fromString(s: string): DataPreparationApplicationState | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string, failIfMissing?: boolean): DataPreparationApplicationState | null;
