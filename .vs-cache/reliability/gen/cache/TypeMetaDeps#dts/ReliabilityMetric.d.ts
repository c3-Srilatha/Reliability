...
declare interface IReliabilityMetric {
   ...
   */
  dependencyMetrics?: Array_Type<ReliabilityMetricDependencies> | Array<IReliabilityMetricDependencies>;
   ...
   * Will be fetched from the {@link ReliabilityMetricDependencies} based on the `relationType`.
   */
  childMetrics?: Array_Type<ReliabilityMetricDependencies> | Array<IReliabilityMetricDependencies>;
   ...
   */
  assetsDisplayStrInSidePanel?: string;
}
...
declare class ReliabilityMetric extends Obj  {
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ReliabilityMetric;
  ...
  withFacilityFilterPaths(facilityFilterPaths: Array_Type<string> | Array<string> | null): ReliabilityMetric;
   ...
   * Will be fetched from the {@link ReliabilityMetricDependencies} based on the `relationType`.
   */
  readonly dependencyMetrics?: Array_Type<ReliabilityMetricDependencies>;
  withDependencyMetrics(dependencyMetrics: Array_Type<ReliabilityMetricDependencies> | Array<IReliabilityMetricDependencies> | null): ReliabilityMetric;
   ...
   * Will be fetched from the {@link ReliabilityMetricDependencies} based on the `relationType`.
   */
  readonly childMetrics?: Array_Type<ReliabilityMetricDependencies>;
  withChildMetrics(childMetrics: Array_Type<ReliabilityMetricDependencies> | Array<IReliabilityMetricDependencies> | null): ReliabilityMetric;
  ...
  withAssets(assets: Array_Type<ReliabilityAsset> | Array<IReliabilityAsset> | null): ReliabilityMetric;
   ...
   * Translation of {@link permission}.
   */
  readonly displayPermission?: string;
   ...
   * {@link ReliabilityMetric}. "..." is appended if more than 3 {@link #assets} are associated.
   */
  readonly assetsDisplayStr?: string;
   ...
   * this {@link ReliabilityMetric}. "..." is appended if more than 20 {@link #assets} are associated.
   */
  readonly assetsDisplayStrInSidePanel?: string;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ReliabilityMetric | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ReliabilityMetric | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ReliabilityMetric | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ReliabilityMetric | null;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityMetric;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityMetric;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityMetric>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityMetric>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityMetric;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityMetric;
   ...
   * @see #removeField
   */
  withoutField(field: string): ReliabilityMetric;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ReliabilityMetric;
   ...
   */
  withoutFields(fields: Array_Type<string>): ReliabilityMetric;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityMetric;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityMetric;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityMetric;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityMetric;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityMetric;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityMetric;

  mergeJson(json: any): ReliabilityMetric;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityMetric;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ReliabilityMetric;
   ...
   */
  singletonArray(): Array_Type<ReliabilityMetric>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityMetric> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ReliabilityMetric> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ReliabilityMetric>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ReliabilityMetric> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ReliabilityMetric> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityMetric> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ReliabilityMetric>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ReliabilityMetric>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityMetric;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityMetric;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityMetric;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityMetric;
   ...
   * @see #fromString
   */
  static make(s: string): ReliabilityMetric | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityMetric;
   ...
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityMetric> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ReliabilityMetric;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<ReliabilityMetric>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ReliabilityMetric>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<ReliabilityMetric> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ReliabilityMetric>> | null;
   ...
   */
  get(include?: string): ReliabilityMetric | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): ReliabilityMetric | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): ReliabilityMetric | null;
   ...
   * @see #toString
   */
  static fromString(s: string): ReliabilityMetric | null;
   ...
   */
  create(spec?: UpsertSpec): ReliabilityMetric | null;
   ...
   */
  static createBatch(objs: Array_Type<ReliabilityMetric>, spec?: UpsertSpec): ObjList<ReliabilityMetric> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ReliabilityMetric>, spec?: CreateBatchObjStreamSpec): ObjList<ReliabilityMetric> | null;
   ...
   */
  update(srcObj?: ReliabilityMetric, spec?: UpsertSpec): ReliabilityMetric | null;
   ...
   */
  upsert(srcObj?: ReliabilityMetric, spec?: UpsertSpec): ReliabilityMetric | null;
   ...
   */
  merge(spec?: MergeSpec): ReliabilityMetric | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): ReliabilityMetric | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): ReliabilityMetric | null;
   ...
   */
  static updateBatch(objs: Array_Type<ReliabilityMetric>, srcObjs?: Array_Type<ReliabilityMetric>, spec?: UpsertSpec): ObjList<ReliabilityMetric> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<ReliabilityMetric> | null>, spec?: UpsertSpec): ObjList<ReliabilityMetric> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<ReliabilityMetric>, srcObjs?: Array_Type<ReliabilityMetric>, spec?: UpsertSpec): ObjList<ReliabilityMetric> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<ReliabilityMetric> | null>, spec?: UpsertSpec): ObjList<ReliabilityMetric> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<ReliabilityMetric>, spec?: TouchSpec): ObjList<ReliabilityMetric> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityMetric>, spec?: MergeSpec): ObjList<ReliabilityMetric> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ReliabilityMetric>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityMetric> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<ReliabilityMetric> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ReliabilityMetric> | null;
   ...
   */
  static mergeAll(mergeObj: ReliabilityMetric, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ReliabilityMetric, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<ReliabilityMetric>, spec?: UpsertSpec): ObjList<ReliabilityMetric> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<ReliabilityMetric>, spec?: UpsertSpec): ObjList<ReliabilityMetric> | null;
   ...
   */
  static beforeCreate(objs: Array_Type<ReliabilityMetric>): ObjList<ReliabilityMetric>;
   ...
   */
  static beforeUpdate(objs: Array_Type<ReliabilityMetric>): ObjList<ReliabilityMetric>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<ReliabilityMetric>): ObjList<ReliabilityMetric>;
   ...
   */
  static afterCreate(objs: Array_Type<ReliabilityMetric>): Array_Type<ObjError> | null;
   ...
   */
  static afterUpdate(objs: Array_Type<ReliabilityMetric>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<ReliabilityMetric>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<ReliabilityMetric>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ReliabilityMetric>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): ReliabilityMetric | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<ReliabilityMetric>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: ReliabilityMetric, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<ReliabilityMetric>, callback?: λFunction<ReliabilityMetric | null, ReliabilityMetric | null>): ObjList<ReliabilityMetric>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<ReliabilityMetric>, callback?: λFunction<ReliabilityMetric | null, ReliabilityMetric | null>): Array_Type<ObjError> | null;
   ...
   */
  static createMetric(formObject: ReliabilityMetricSpec, childMetrics?: Array_Type<ReliabilityMetric>): ReliabilityMetric | null;
   ...
   */
  static modifyMetric(formObject: ReliabilityMetricSpec, childMetrics?: Array_Type<ReliabilityMetric>): ReliabilityMetric | null;
   ...
   */
  static deleteMetric(metricId?: string): ReliabilityMetric | null;
   ...
   */
  static isNameDuplicated(name: string, id?: string): boolean;
   ...
   */
  static fetchMetricByCurrentUser(spec?: FetchSpec): FetchResult<ReliabilityMetric> | null;
   ...
   */
  static parseExpression(metricExpression: string): Array_Type<string> | null;
   ...
   */
  static replaceSensorTag(expression?: string): string | null;
   ...
   */
  static replaceMetricExpandedExpression(expression?: string, metrics?: Array_Type<ReliabilityMetric>): string | null;
   ...
   */
  static evalMetrics(metrics: Array_Type<ReliabilityMetric>, start: DateTime, end: DateTime, interval: string): Map_Type<string, Timeseries<any>> | null;
   ...
   */
  static fetchChildMetrics(expression: string, spec?: FetchSpec): FetchResultWithTotalCount<ReliabilityMetric> | null;
   ...
   */
  static fetchDependentMetrics(metricId: string, spec?: FetchSpec): FetchResultWithTotalCount<ReliabilityMetric> | null;
   ...
   */
  static getAssetsForMetrics(sensorObjs?: Array_Type<Sensor>, metricObjs?: Array_Type<ReliabilityMetric>): Array_Type<string> | null;
   ...
   */
  static validateMetricExpression(expression?: string): string | null;
   ...
   * @returns The translation key of the error message if the expression is invalid, else returns `null`.
   */
  static validateExpression(expressionIdentifiers?: Array_Type<string>): string | null;
}
