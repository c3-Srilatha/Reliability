// TypeScript definitions for the C3 type SparePartsForecastChart

/**
 * The UI component that handles showing Spare Parts Inventory and Forecast data in a chart.
 *
 * @remarks this represents a value passed to a method that expects an instance of SparePartsForecastChart
 */
declare interface ISparePartsForecastChart {
 ...
 * The UI component that handles showing Spare Parts Inventory and Forecast data in a chart.
 *
 * @remarks this represents a made instance of SparePartsForecastChart
 */
declare class SparePartsForecastChart extends Obj  {

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): SparePartsForecastChart;

  /**
   * Unique identifier for the logical object that instance of this type represents.
   */
  readonly id?: string;
  withId(id: string | null): SparePartsForecastChart;

  /**
   * The name of the component. Optional field for informational purposes only.
   */
  readonly name?: string;
  withName(name: string | null): SparePartsForecastChart;

  /**
   * The specification used for retrieving data displayed by the grid.
   */
  readonly dataSpec?: UiSdlTimeseriesLineBarChartDataSpec;
  withDataSpec(dataSpec: IUiSdlTimeseriesLineBarChartDataSpec | null): SparePartsForecastChart;

  /**
   * Disable if you want to avoid sending any and all requests for this component on first render.
   */
  readonly disableDataRequestOnFirstRender?: boolean;
  withDisableDataRequestOnFirstRender(disableDataRequestOnFirstRender: boolean): SparePartsForecastChart;

  /**
   * Whether the effect triggers and epics have been registered
   */
  readonly triggersRegistered?: boolean;
  withTriggersRegistered(triggersRegistered: boolean): SparePartsForecastChart;

  /**
   * Whether to wrap the component with a div which has a class name of its metdata id. Useful for targeting with css.
   */
  readonly wrapWithMetadataId?: boolean;
  withWrapWithMetadataId(wrapWithMetadataId: boolean): SparePartsForecastChart;

  /**
   * A list of hidden series id.
   */
  readonly hiddenSeries?: Array_Type<string>;
  withHiddenSeries(hiddenSeries: Array_Type<string> | Array<string> | null): SparePartsForecastChart;
  ...
  withDefaultColors(defaultColors: Array_Type<string> | Array<string> | null): SparePartsForecastChart;

  /**
   * The background style for the chart.
   */
  readonly backgroundStyle?: string;
  withBackgroundStyle(backgroundStyle: string | null): SparePartsForecastChart;

  /**
   * The height of the component in pixels.
   */
  readonly height?: number;
  withHeight(height: number | null): SparePartsForecastChart;

  /**
   * Whether to enable tooltips.
   */
  readonly tooltipEnabled?: boolean;
  withTooltipEnabled(tooltipEnabled: boolean): SparePartsForecastChart;

  /**
   * The decimal precision to show on tooltip values.
   */
  readonly tooltipValuesDecimalPrecision?: number;
  withTooltipValuesDecimalPrecision(tooltipValuesDecimalPrecision: number | null): SparePartsForecastChart;

  /**
   * Whether or not to show units in tooltip
   */
  readonly tooltipUnitEnabled?: boolean;
  withTooltipUnitEnabled(tooltipUnitEnabled: boolean): SparePartsForecastChart;

  readonly tooltipConfig?: UiSdlTooltipBaseSettings;
  withTooltipConfig(tooltipConfig: IUiSdlTooltipBaseSettings | null): SparePartsForecastChart;
  ...
  withToolboxDataZoom(toolboxDataZoom: boolean): SparePartsForecastChart;

  /**
   * Holds the data to display in the grid.
   */
  readonly data?: Array_Type<Obj>;
  withData(data: Array_Type<Obj> | Array<IObj> | null): SparePartsForecastChart;

  /**
   * Chart header.
   */
  readonly header?: UiSdlComponentHeader;
  withHeader(header: IUiSdlComponentHeader | null): SparePartsForecastChart;

  /**
   * Y-axis config type.
   */
  readonly yAxis?: UiSdlLineBarChartYAxisConfig;
  withYAxis(yAxis: IUiSdlLineBarChartYAxisConfig | null): SparePartsForecastChart;
  ...
  withGrid(grid: IUiSdlChartEChartsGrid | null): SparePartsForecastChart;

  /**
   * The chart legend - information for each series.
   */
  readonly legend?: UiSdlChartLegend;
  withLegend(legend: IUiSdlChartLegend | null): SparePartsForecastChart;
  ...
  withZoomEnabled(zoomEnabled: boolean): SparePartsForecastChart;
  ...
  withDefaultChartType(defaultChartType: string | null): SparePartsForecastChart;
  ...
  withShowDownloadOptions(showDownloadOptions: boolean): SparePartsForecastChart;

  /**
   * Show a toggle next to the download options that will display data labels
   */
  readonly showDataLabelsToggle?: boolean;
  withShowDataLabelsToggle(showDataLabelsToggle: boolean): SparePartsForecastChart;

  /**
   * If `true`, stack all series whose series type is `'bar'`.
   */
  readonly stackBars?: boolean;
  withStackBars(stackBars: boolean): SparePartsForecastChart;
  ...
  withEmptyState(emptyState: IUiSdlComponentRef<UiSdlEmptyState> | null): SparePartsForecastChart;

  /**
   * The number of actions to display on the chart header.
   */
  readonly chartActionsCollapseThreshold?: number;
  withChartActionsCollapseThreshold(chartActionsCollapseThreshold: number | null): SparePartsForecastChart;

  /**
   * What is used to fill in missing seriesData when exporting to .csv data
   */
  readonly csvMissingDataFiller?: string;
  withCsvMissingDataFiller(csvMissingDataFiller: string | null): SparePartsForecastChart;

  /**
   * Whether or not to show the timezone label below chart.
   */
  readonly showTimeZoneLabel?: boolean;
  withShowTimeZoneLabel(showTimeZoneLabel: boolean): SparePartsForecastChart;
  ...
  withTimeZoneLabel(timeZoneLabel: string | IUiSdlDynamicValueSpec | null): SparePartsForecastChart;
  ...
  withTimeZoneNameFormat(timeZoneNameFormat: string | null): SparePartsForecastChart;

  /**
   * The specification used to retrieve event data displayed by this chart.
   */
  readonly eventDataSpec?: UiSdlTimeseriesLineBarChartEventDataSpec;
  withEventDataSpec(eventDataSpec: IUiSdlTimeseriesLineBarChartEventDataSpec | null): SparePartsForecastChart;

  /**
   * Stores the FetchResults retrieved by {@link #eventDataSpec}.
   */
  readonly eventData?: Obj;
  withEventData(eventData: IObj | null): SparePartsForecastChart;
  ...
  withEvalDataSpec(evalDataSpec: IUiSdlTimeseriesLineBarChartEvalDataSpec | null): SparePartsForecastChart;
  ...
  withShowCrosshair(showCrosshair: boolean): SparePartsForecastChart;
  ...
  withXAxis(xAxis: IUiSdlTimeseriesLineBarChartXAxisConfig | IUiSdlTimeseriesLineBarChartXAxisStaticConfig | null): SparePartsForecastChart;

  /**
   * Whether or not to display the "now" line on the chart.
   */
  readonly showNowLine?: boolean;
  withShowNowLine(showNowLine: boolean): SparePartsForecastChart;
  ...
  withCollapseXAxis(collapseXAxis: boolean): SparePartsForecastChart;

  /**
   * Style configurations of vertical line at the "now" point of time according to the interval of data being plotted.
   */
  readonly nowLineConfig?: UiSdlTimeseriesLineBarChartNowLineConfig;
  withNowLineConfig(nowLineConfig: IUiSdlTimeseriesLineBarChartNowLineConfig | null): SparePartsForecastChart;

  /**
   * Configuration to add vertical line at any date on the graph.
   */
  readonly dateLines?: Array_Type<UiSdlTimeseriesLineBarChartDateLineConfig>;
  withDateLines(dateLines: Array_Type<UiSdlTimeseriesLineBarChartDateLineConfig> | Array<IUiSdlTimeseriesLineBarChartDateLineConfig> | null): SparePartsForecastChart;

  /**
   * Configurations to add vertical line at any date on the graph requiring a fetch call.
   */
  readonly dateLinesDataSpec?: UiSdlTimeseriesLineBarChartDateLineDataSpec;
  withDateLinesDataSpec(dateLinesDataSpec: IUiSdlTimeseriesLineBarChartDateLineDataSpec | null): SparePartsForecastChart;

  /**
   * Whether or not to plot and show data at timestamps where there are 100% missing values.
   */
  readonly hideMissingDataPoints?: boolean;
  withHideMissingDataPoints(hideMissingDataPoints: boolean): SparePartsForecastChart;
  ...
  withNoTimeZoneConversion(noTimeZoneConversion: boolean): SparePartsForecastChart;
  ...
  withShowAllTimestampInfoOnTooltip(showAllTimestampInfoOnTooltip: boolean): SparePartsForecastChart;

  /**
   * Whether or not to show the start date of the chart.
   */
  readonly showStartAndEndDate?: boolean;
  withShowStartAndEndDate(showStartAndEndDate: boolean): SparePartsForecastChart;

  /**
   * Start date displayed in the chart shown only when dataSelection is enabled.
   */
  readonly displayStartDate?: string;
  withDisplayStartDate(displayStartDate: string | null): SparePartsForecastChart;

  /**
   * End date displayed in the chart shown only when dataSelection is enabled.
   */
  readonly displayEndDate?: string;
  withDisplayEndDate(displayEndDate: string | null): SparePartsForecastChart;

  readonly markerIdentifiersToCollapse?: Array_Type<string>;
  withMarkerIdentifiersToCollapse(markerIdentifiersToCollapse: Array_Type<string> | Array<string> | null): SparePartsForecastChart;
  ...
  withDisplayInterval(displayInterval: string | null): SparePartsForecastChart;

  /**
   * Interval display options in the chart shown only when dataSelection is enabled.
   */
  readonly displayIntervalOptions?: Array_Type<string>;
  withDisplayIntervalOptions(displayIntervalOptions: Array_Type<string> | Array<string> | null): SparePartsForecastChart;

  /**
   * Whether or not to override user config ID with data generated ID.
   */
  readonly shouldOverrideUserConfigIdWithDataGeneratedId?: boolean;
  withShouldOverrideUserConfigIdWithDataGeneratedId(shouldOverrideUserConfigIdWithDataGeneratedId: boolean): SparePartsForecastChart;

  /**
   * Whether or not to show the data selector. For example, the date range and interval selectors.
   */
  readonly dataSelection?: boolean;
  withDataSelection(dataSelection: boolean): SparePartsForecastChart;
  ...
  withDataSelectionControlsDataZoom(dataSelectionControlsDataZoom: boolean): SparePartsForecastChart;

  /**
   * Start value used in the datazoom to filter a certain range of chart.
   */
  readonly dataZoomStartValue?: string;
  withDataZoomStartValue(dataZoomStartValue: string | null): SparePartsForecastChart;

  /**
   * End value used in the datazoom to filter a certain range of chart.
   */
  readonly dataZoomEndValue?: string;
  withDataZoomEndValue(dataZoomEndValue: string | null): SparePartsForecastChart;
  ...
  withSynchronized(synchronized: boolean): SparePartsForecastChart;
  ...
  withSuppressOrderSeriesById(suppressOrderSeriesById: boolean): SparePartsForecastChart;

  /**
   * The id of the component to show when there is no data.
   */
  readonly noDataComponentId?: string;
  withNoDataComponentId(noDataComponentId: string | null): SparePartsForecastChart;

  /**
   * The {@link InventorySeries#partNumber} of the part currently plotted on the chart.
   */
  readonly selectedPartNumber?: string;
  withSelectedPartNumber(selectedPartNumber: string | null): SparePartsForecastChart;

  /**
   * The start of the zoom range.
   */
  readonly zoomRangeStart?: DateTime;
  withZoomRangeStart(zoomRangeStart: DateTime | Date | string | null): SparePartsForecastChart;

  /**
   * The end of the zoom range.
   */
  readonly zoomRangeEnd?: DateTime;
  withZoomRangeEnd(zoomRangeEnd: DateTime | Date | string | null): SparePartsForecastChart;
  ...
  withDataRange(dataRange: Map_Type<string, DateTime> | {[key: string]: DateTime | Date | string} | null): SparePartsForecastChart;

  /**
   * The chart data to display.
   */
  readonly chartData?: SparePartsForecastChartData;
  withChartData(chartData: ISparePartsForecastChartData | null): SparePartsForecastChart;
   ...
   * @see #toJson
   */
  static fromJson(json: any): SparePartsForecastChart | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): SparePartsForecastChart | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): SparePartsForecastChart | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): SparePartsForecastChart | null;
   ...
   */
  replaceType(old: Type, new_: Type): SparePartsForecastChart;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): SparePartsForecastChart;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): SparePartsForecastChart;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<SparePartsForecastChart>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<SparePartsForecastChart>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): SparePartsForecastChart;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SparePartsForecastChart;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SparePartsForecastChart;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): SparePartsForecastChart;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): SparePartsForecastChart;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): SparePartsForecastChart;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): SparePartsForecastChart;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): SparePartsForecastChart;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): SparePartsForecastChart;
   ...
   * @see #removeField
   */
  withoutField(field: string): SparePartsForecastChart;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): SparePartsForecastChart;
   ...
   */
  withoutFields(fields: Array_Type<string>): SparePartsForecastChart;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): SparePartsForecastChart;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): SparePartsForecastChart;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): SparePartsForecastChart;
   ...
   * @see #unsetField
   */
  defaultField(field: string): SparePartsForecastChart;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): SparePartsForecastChart;
   ...
   * @see #removeField
   */
  unsetField(field: string): SparePartsForecastChart;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): SparePartsForecastChart;
   ...
   * @see #unsetField
   */
  removeField(field: string): SparePartsForecastChart;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): SparePartsForecastChart;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): SparePartsForecastChart;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): SparePartsForecastChart;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): SparePartsForecastChart;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): SparePartsForecastChart;

  mergeJson(json: any): SparePartsForecastChart;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): SparePartsForecastChart;
   ...
   */
  sumObj(other: Obj, deep?: boolean): SparePartsForecastChart;
   ...
   */
  singletonArray(): Array_Type<SparePartsForecastChart>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<SparePartsForecastChart> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<SparePartsForecastChart> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<SparePartsForecastChart>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<SparePartsForecastChart> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, SparePartsForecastChart> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, SparePartsForecastChart> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<SparePartsForecastChart>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<SparePartsForecastChart>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): SparePartsForecastChart;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): SparePartsForecastChart;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): SparePartsForecastChart;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): SparePartsForecastChart;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): SparePartsForecastChart;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): SparePartsForecastChart;
   ...
   * @see #fromString
   */
  static make(s: string): SparePartsForecastChart | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): SparePartsForecastChart;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): SparePartsForecastChart;
   ...
   */
  static cachedEmptyInst(): SparePartsForecastChart;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<SparePartsForecastChart> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): SparePartsForecastChart;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<SparePartsForecastChart>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<SparePartsForecastChart>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<SparePartsForecastChart> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<SparePartsForecastChart>> | null;
   ...
   */
  dependencies(): MetadataDeps<SparePartsForecastChart>;

  save(subPath?: string, contentType?: string): SparePartsForecastChart;
  ...
  update(srcObj?: SparePartsForecastChart, spec?: UpsertSpec): SparePartsForecastChart | null;

  upsert(srcObj?: SparePartsForecastChart, spec?: UpsertSpec): SparePartsForecastChart | null;
   ...
   * @see #toString
   */
  static fromString(s: string): SparePartsForecastChart | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string, failIfMissing?: boolean): SparePartsForecastChart | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: SparePartsForecastChart, state: UiSdlReduxState): SparePartsForecastChart | null;
