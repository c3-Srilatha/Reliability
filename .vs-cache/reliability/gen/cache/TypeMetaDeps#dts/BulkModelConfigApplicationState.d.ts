// TypeScript definitions for the C3 type BulkModelConfigApplicationState

/**
 * Application state that stores all the UI logic for Bulk Model Configuration.
 *
 * @remarks this represents a value passed to a method that expects an instance of BulkModelConfigApplicationState
 */
declare interface IBulkModelConfigApplicationState {
   ...
   */
  settings?: IBulkModelConfigUiSettings;
   ...
   */
  hyperparameterData?: Map_Type<string, any> | {[key: string]: any};
   ...
   */
  currentlyOpenModelConfigRun?: IModelConfigRun;
   ...
   */
  selectedAssetIdsWithoutDataset?: Array_Type<ReliabilityAsset> | Array<IReliabilityAsset>;
   ...
   */
  selectedAssetIdsWithDataset?: Array_Type<ReliabilityAsset> | Array<IReliabilityAsset>;

  /**
   * The list of model templates that can be chosen.
   */
  templateData?: Array_Type<ModelTemplate> | Array<IModelTemplate>;
   ...
   */
  selectedModels?: Array_Type<string> | Array<string>;
   ...
   */
  selectedCVs?: Array_Type<string> | Array<string>;
   ...
   */
  usingBulkSensorAssociation?: boolean;
   ...
   */
  sensorAssociationFlowTargetAssetIds?: Array_Type<string> | Array<string>;

  /**
   * When `isSensorAssociationFlow` is `true`, this field contains the ids of the assets that are not ready for
   * model configuration.
   */
  sensorAssociationFlowErrorAssets?: Array_Type<ReliabilityAsset> | Array<IReliabilityAsset>;
}
 ...
 */
declare class BulkModelConfigApplicationState extends Obj  {
  ...
  withEffectTriggers(effectTriggers: Array_Type<UiSdlEffectTrigger> | Array<IUiSdlEffectTrigger> | null): BulkModelConfigApplicationState;

  /**
   * Settings set by users from the Bulk Model Config UI.
   */
  readonly settings?: BulkModelConfigUiSettings;
   ...
   * Contains the hyperparameter data for the selected bulk model template.
   */
  readonly hyperparameterData?: Map_Type<string, any>;
  withHyperparameterData(hyperparameterData: Map_Type<string, any> | {[key: string]: any} | null): BulkModelConfigApplicationState;
   ...
   * Currently open ModelConfigRun in Model Configuration Jobs grid in Mondel Management
   */
  readonly currentlyOpenModelConfigRun?: ModelConfigRun;
   ...
   * This information is used to display the "Assets With No Dataset" grid in the Bulk Model Config Check Modal.
   */
  readonly selectedAssetIdsWithoutDataset?: Array_Type<ReliabilityAsset>;
  withSelectedAssetIdsWithoutDataset(selectedAssetIdsWithoutDataset: Array_Type<ReliabilityAsset> | Array<IReliabilityAsset> | null): BulkModelConfigApplicationState;

  /**
   * The list of {@link ReliabilityAsset} IDs selected by the user that have a {@link ReliabilityMlDatasetPreparationRun}.
   * This information is used to display the "Assets With Dataset" grid in the Bulk Model Config Check Modal.
   */
  readonly selectedAssetIdsWithDataset?: Array_Type<ReliabilityAsset>;
  withSelectedAssetIdsWithDataset(selectedAssetIdsWithDataset: Array_Type<ReliabilityAsset> | Array<IReliabilityAsset> | null): BulkModelConfigApplicationState;

  /**
   * The list of model templates that can be chosen.
   */
  readonly templateData?: Array_Type<ModelTemplate>;
  withTemplateData(templateData: Array_Type<ModelTemplate> | Array<IModelTemplate> | null): BulkModelConfigApplicationState;
   ...
   * This field is used to filter the fetched models on "Selected Models" grid under the Bulk Model Config Modal.
   */
  readonly selectedModels?: Array_Type<string>;
  withSelectedModels(selectedModels: Array_Type<string> | Array<string> | null): BulkModelConfigApplicationState;
   ...
   * This field is used to filter the fetched models on "Selected CVs" grid under the Bulk Model Config Modal.
   */
  readonly selectedCVs?: Array_Type<string>;
  withSelectedCVs(selectedCVs: Array_Type<string> | Array<string> | null): BulkModelConfigApplicationState;
   ...
   * based on the selected assets from the grid, or the assets selected from the sensor association flow.
   */
  readonly sensorAssociationFlowTargetAssetIds?: Array_Type<string>;
  withSensorAssociationFlowTargetAssetIds(sensorAssociationFlowTargetAssetIds: Array_Type<string> | Array<string> | null): BulkModelConfigApplicationState;

  /**
   * When `isSensorAssociationFlow` is `true`, this field contains the ids of the assets that are not ready for
   * model configuration.
   */
  readonly sensorAssociationFlowErrorAssets?: Array_Type<ReliabilityAsset>;
  withSensorAssociationFlowErrorAssets(sensorAssociationFlowErrorAssets: Array_Type<ReliabilityAsset> | Array<IReliabilityAsset> | null): BulkModelConfigApplicationState;
   ...
   * @see #toJson
   */
  static fromJson(json: any): BulkModelConfigApplicationState | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): BulkModelConfigApplicationState | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): BulkModelConfigApplicationState | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): BulkModelConfigApplicationState | null;
   ...
   */
  replaceType(old: Type, new_: Type): BulkModelConfigApplicationState;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): BulkModelConfigApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): BulkModelConfigApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<BulkModelConfigApplicationState>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<BulkModelConfigApplicationState>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): BulkModelConfigApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): BulkModelConfigApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): BulkModelConfigApplicationState;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): BulkModelConfigApplicationState;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): BulkModelConfigApplicationState;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): BulkModelConfigApplicationState;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): BulkModelConfigApplicationState;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): BulkModelConfigApplicationState;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): BulkModelConfigApplicationState;
   ...
   * @see #removeField
   */
  withoutField(field: string): BulkModelConfigApplicationState;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): BulkModelConfigApplicationState;
   ...
   */
  withoutFields(fields: Array_Type<string>): BulkModelConfigApplicationState;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): BulkModelConfigApplicationState;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): BulkModelConfigApplicationState;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): BulkModelConfigApplicationState;
   ...
   * @see #unsetField
   */
  defaultField(field: string): BulkModelConfigApplicationState;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): BulkModelConfigApplicationState;
   ...
   * @see #removeField
   */
  unsetField(field: string): BulkModelConfigApplicationState;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): BulkModelConfigApplicationState;
   ...
   * @see #unsetField
   */
  removeField(field: string): BulkModelConfigApplicationState;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): BulkModelConfigApplicationState;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): BulkModelConfigApplicationState;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): BulkModelConfigApplicationState;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): BulkModelConfigApplicationState;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): BulkModelConfigApplicationState;

  mergeJson(json: any): BulkModelConfigApplicationState;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): BulkModelConfigApplicationState;
   ...
   */
  sumObj(other: Obj, deep?: boolean): BulkModelConfigApplicationState;
   ...
   */
  singletonArray(): Array_Type<BulkModelConfigApplicationState>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<BulkModelConfigApplicationState> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<BulkModelConfigApplicationState> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<BulkModelConfigApplicationState>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<BulkModelConfigApplicationState> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, BulkModelConfigApplicationState> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, BulkModelConfigApplicationState> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<BulkModelConfigApplicationState>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<BulkModelConfigApplicationState>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): BulkModelConfigApplicationState;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): BulkModelConfigApplicationState;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): BulkModelConfigApplicationState;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): BulkModelConfigApplicationState;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): BulkModelConfigApplicationState;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): BulkModelConfigApplicationState;
   ...
   * @see #fromString
   */
  static make(s: string): BulkModelConfigApplicationState | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): BulkModelConfigApplicationState;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): BulkModelConfigApplicationState;
   ...
   */
  static cachedEmptyInst(): BulkModelConfigApplicationState;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<BulkModelConfigApplicationState> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): BulkModelConfigApplicationState;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<BulkModelConfigApplicationState>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<BulkModelConfigApplicationState>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<BulkModelConfigApplicationState> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<BulkModelConfigApplicationState>> | null;
   ...
   */
  dependencies(): MetadataDeps<BulkModelConfigApplicationState>;

  save(subPath?: string, contentType?: string): BulkModelConfigApplicationState;
  ...
  update(srcObj?: BulkModelConfigApplicationState, spec?: UpsertSpec): BulkModelConfigApplicationState | null;

  upsert(srcObj?: BulkModelConfigApplicationState, spec?: UpsertSpec): BulkModelConfigApplicationState | null;
   ...
   * @see #toString
   */
  static fromString(s: string): BulkModelConfigApplicationState | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string, failIfMissing?: boolean): BulkModelConfigApplicationState | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: BulkModelConfigApplicationState, state: UiSdlReduxState): BulkModelConfigApplicationState | null;
   ...
   */
  static changeStepAction(shouldGoNext: boolean): UiSdlReduxAction<any>;
   ...
   */
  static setTemplateDataAction(templateData?: Array_Type<ModelTemplate>): UiSdlReduxAction<any>;
   ...
   */
  static setTemplateDataReducer(state: UiSdlReduxState, action: UiSdlReduxAction<any>): UiSdlReduxState;
   ...
   */
  static loadHyperparametersAction(modelTemplateId: string): UiSdlReduxAction<any>;
   ...
   * @return An observable stream of UI SDL actions
   */
  static loadHyperparametersEpic(actionStream: UiSdlActionsObservable, stateStream: UiSdlStatesObservable): UiSdlActionsObservable;
   ...
   * @return a new Redux state
   */
  static setProjectFromBulkDataPrepReducer(state: UiSdlReduxState, action: UiSdlReduxAction<any>): UiSdlReduxState;
   ...
   */
  static startUiWorkflowAction(usingBulkDataPrep?: boolean, usingBulkSensorAssociation?: boolean, isSensorAssociationFlow?: boolean, dataType?: string, dataItemIds?: Array_Type<string>): UiSdlReduxAction<any>;
   ...
   * @return An observable stream of UI SDL actions
   */
  static exitUiWorkflowEpic(actionStream: UiSdlActionsObservable, stateStream: UiSdlStatesObservable): UiSdlActionsObservable;
   ...
   */
  static startModelTraining(): UiSdlReduxAction<any>;
   ...
   * @return An Observable action stream.
   */
  static startModelTrainingEpic(actionStream: UiSdlActionsObservable, stateStream: UiSdlStatesObservable): UiSdlActionsObservable;
}
