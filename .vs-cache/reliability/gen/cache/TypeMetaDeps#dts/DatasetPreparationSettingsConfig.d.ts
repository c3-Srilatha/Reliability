// TypeScript definitions for the C3 type DatasetPreparationSettingsConfig

/**
 * Type of configurations of dataset preparation workflow.
 *
 * @remarks this represents a value passed to a method that expects an instance of DatasetPreparationSettingsConfig
 */
declare interface IDatasetPreparationSettingsConfig {

  /**
   * A {@link Period} to specify the {@link ReliabilityAsset} time window for {@link Sensor} data utilized in the dataset.
   */
  defaultWindow?: IPeriod;

  /**
   * Default start {@link datetime} of window for {@link Sensor} data utilized in the dataset.
   */
  defaultWindowStart?: DateTime | Date | string;

  /**
   * Default end {@link datetime} of window for {@link Sensor} data utilized in the dataset.
   */
  defaultWindowEnd?: DateTime | Date | string;

  /**
   * The default data {@link Interval} to analyze the data of the {@link Sensor}.
   */
  defaultDataInterval?: string;

  /**
   * The default training percentage.
   */
  defaultTrainingPercentage?: number;

  /**
   * The default validation percentage.
   */
  defaultValidationPercentage?: number;
   ...
   */
  dataPreparationJobTimeout?: IDuration;
}

/**
 * Type of configurations of dataset preparation workflow.
 *
 * @remarks this represents a made instance of DatasetPreparationSettingsConfig
 */
declare class DatasetPreparationSettingsConfig extends Obj  {

  /**
   * A {@link Period} to specify the {@link ReliabilityAsset} time window for {@link Sensor} data utilized in the dataset.
   */
  readonly defaultWindow?: Period;
  withDefaultWindow(defaultWindow: IPeriod | null): DatasetPreparationSettingsConfig;

  /**
   * A {@link Period} to specify the {@link ReliabilityAsset} time window for {@link Sensor} data utilized in the dataset.
   */
  static readonly defaultWindow?: Period;

  /**
   * Default start {@link datetime} of window for {@link Sensor} data utilized in the dataset.
   */
  readonly defaultWindowStart?: DateTime;
  withDefaultWindowStart(defaultWindowStart: DateTime | Date | string | null): DatasetPreparationSettingsConfig;

  /**
   * Default start {@link datetime} of window for {@link Sensor} data utilized in the dataset.
   */
  static readonly defaultWindowStart?: DateTime;

  /**
   * Default end {@link datetime} of window for {@link Sensor} data utilized in the dataset.
   */
  readonly defaultWindowEnd?: DateTime;
  withDefaultWindowEnd(defaultWindowEnd: DateTime | Date | string | null): DatasetPreparationSettingsConfig;

  /**
   * Default end {@link datetime} of window for {@link Sensor} data utilized in the dataset.
   */
  static readonly defaultWindowEnd?: DateTime;

  /**
   * The default data {@link Interval} to analyze the data of the {@link Sensor}.
   */
  readonly defaultDataInterval?: string;
  withDefaultDataInterval(defaultDataInterval: string | null): DatasetPreparationSettingsConfig;

  /**
   * The default data {@link Interval} to analyze the data of the {@link Sensor}.
   */
  static readonly defaultDataInterval?: string;

  /**
   * The default training percentage.
   */
  readonly defaultTrainingPercentage?: number;
  withDefaultTrainingPercentage(defaultTrainingPercentage: number | null): DatasetPreparationSettingsConfig;

  /**
   * The default training percentage.
   */
  static readonly defaultTrainingPercentage?: number;

  /**
   * The default validation percentage.
   */
  readonly defaultValidationPercentage?: number;
  withDefaultValidationPercentage(defaultValidationPercentage: number | null): DatasetPreparationSettingsConfig;

  /**
   * The default validation percentage.
   */
  static readonly defaultValidationPercentage?: number;

  /**
   * A threshold of {@link Sensor} flatline percentage.
   * The {@link Sensor}s will be excluded by default for the values below the missing data threshold.
   */
  readonly defaultFlatlineThreshold?: number;
  withDefaultFlatlineThreshold(defaultFlatlineThreshold: number | null): DatasetPreparationSettingsConfig;

  /**
   * A threshold of {@link Sensor} flatline percentage.
   * The {@link Sensor}s will be excluded by default for the values below the missing data threshold.
   */
  static readonly defaultFlatlineThreshold?: number;

  /**
   * A threshold of {@link Sensor} missing data percentage.
   * The {@link Sensor}s will be excluded by default for the values below the missing data threshold.
   */
  readonly defaultMissingDataThreshold?: number;
  withDefaultMissingDataThreshold(defaultMissingDataThreshold: number | null): DatasetPreparationSettingsConfig;

  /**
   * A threshold of {@link Sensor} missing data percentage.
   * The {@link Sensor}s will be excluded by default for the values below the missing data threshold.
   */
  static readonly defaultMissingDataThreshold?: number;

  /**
   * The size of dataset for training.
   */
  readonly defaultTrainingDataset?: number;
  withDefaultTrainingDataset(defaultTrainingDataset: number | null): DatasetPreparationSettingsConfig;

  /**
   * The size of dataset for training.
   */
  static readonly defaultTrainingDataset?: number;

  /**
   * A {@link Period} of time before each event to exclude {@link Sensor} data for training.
   */
  readonly defaultPreEventMaskPeriod?: Period;
  withDefaultPreEventMaskPeriod(defaultPreEventMaskPeriod: IPeriod | null): DatasetPreparationSettingsConfig;

  /**
   * A {@link Period} of time before each event to exclude {@link Sensor} data for training.
   */
  static readonly defaultPreEventMaskPeriod?: Period;

  /**
   * A {@link Period} of time after each event to exclude {@link Sensor} data for training and inference.
   */
  readonly defaultPostEventMaskPeriod?: Period;
  withDefaultPostEventMaskPeriod(defaultPostEventMaskPeriod: IPeriod | null): DatasetPreparationSettingsConfig;

  /**
   * A {@link Period} of time after each event to exclude {@link Sensor} data for training and inference.
   */
  static readonly defaultPostEventMaskPeriod?: Period;

  /**
   * A {@link Interval} of time to analize the data of the {@link Sensor}.
   */
  readonly defaultInterval?: string;
  withDefaultInterval(defaultInterval: string | null): DatasetPreparationSettingsConfig;
  ...
  withDefaultTrainingSubset(defaultTrainingSubset: string): DatasetPreparationSettingsConfig;
  ...
  withDefaultVariance(defaultVariance: number | null): DatasetPreparationSettingsConfig;

  /**
   * Default value for {@link ReliabilityDataPreparationUiBaseSettings#variance}.
   */
  static readonly defaultVariance?: number;

  /**
   * Whether to disable the data interval input
   */
  readonly disableInterval?: boolean;
  withDisableInterval(disableInterval: boolean): DatasetPreparationSettingsConfig;
  ...
  withConfigOverride(configOverride: string | null): DatasetPreparationSettingsConfig;

  static readonly configOverride?: string;

  readonly secretOverride?: string;
  withSecretOverride(secretOverride: string | null): DatasetPreparationSettingsConfig;
  ...
  withIssues(issues: Array_Type<string> | Array<string> | null): DatasetPreparationSettingsConfig;
   ...
   * Defines the timeout to wait for the data preparation job to complete.
   */
  readonly dataPreparationJobTimeout?: Duration;
  withDataPreparationJobTimeout(dataPreparationJobTimeout: IDuration | null): DatasetPreparationSettingsConfig;

  /**
   * Defines the timeout to wait for the data preparation job to complete.
   */
  static readonly dataPreparationJobTimeout?: Duration;
   ...
   * @see #toJson
   */
  static fromJson(json: any): DatasetPreparationSettingsConfig | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): DatasetPreparationSettingsConfig | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): DatasetPreparationSettingsConfig | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): DatasetPreparationSettingsConfig | null;
   ...
   */
  replaceType(old: Type, new_: Type): DatasetPreparationSettingsConfig;
   ...
   * This method is used during live metadata update
   */
  static replaceType(old: Type, new_: Type): DatasetPreparationSettingsConfig;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): DatasetPreparationSettingsConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): DatasetPreparationSettingsConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): DatasetPreparationSettingsConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): DatasetPreparationSettingsConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<DatasetPreparationSettingsConfig>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<DatasetPreparationSettingsConfig>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<DatasetPreparationSettingsConfig>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<DatasetPreparationSettingsConfig>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): DatasetPreparationSettingsConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): DatasetPreparationSettingsConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DatasetPreparationSettingsConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DatasetPreparationSettingsConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DatasetPreparationSettingsConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DatasetPreparationSettingsConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): DatasetPreparationSettingsConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  static validateObj(): DatasetPreparationSettingsConfig;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): DatasetPreparationSettingsConfig;
   ...
   * @see #defaultField
   */
  static withField(field: string, value: any, doNotConvert?: boolean): DatasetPreparationSettingsConfig;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): DatasetPreparationSettingsConfig;
   ...
   * @see #defaultField
   */
  static withField(field: FieldType, value: any, doNotConvert?: boolean): DatasetPreparationSettingsConfig;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): DatasetPreparationSettingsConfig;
   ...
   * @return new Obj
   */
  static withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): DatasetPreparationSettingsConfig;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): DatasetPreparationSettingsConfig;
   ...
   * @return new Obj
   */
  static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): DatasetPreparationSettingsConfig;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): DatasetPreparationSettingsConfig;
   ...
   * @see #withoutField
   */
  static withoutFieldAtPath(path: string): DatasetPreparationSettingsConfig;
   ...
   * @see #removeField
   */
  withoutField(field: string): DatasetPreparationSettingsConfig;
   ...
   * @see #removeField
   */
  static withoutField(field: string): DatasetPreparationSettingsConfig;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): DatasetPreparationSettingsConfig;
   ...
   * @see #removeField
   */
  static withoutField(field: FieldType): DatasetPreparationSettingsConfig;
   ...
   */
  withoutFields(fields: Array_Type<string>): DatasetPreparationSettingsConfig;
   ...
   * @return new Obj with removed fields
   */
  static withoutFields(fields: Array_Type<string>): DatasetPreparationSettingsConfig;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): DatasetPreparationSettingsConfig;
   ...
   * @return new Obj with removed fields
   */
  static withoutFieldsByType(fields: Array_Type<FieldType>): DatasetPreparationSettingsConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): DatasetPreparationSettingsConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  static withoutSecretFields(): DatasetPreparationSettingsConfig;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): DatasetPreparationSettingsConfig;
   ...
   * @see FieldType#defaultValue
   */
  static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): DatasetPreparationSettingsConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: string): DatasetPreparationSettingsConfig;
   ...
   * @see #unsetField
   */
  static defaultField(field: string): DatasetPreparationSettingsConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): DatasetPreparationSettingsConfig;
   ...
   * @see #unsetField
   */
  static defaultField(field: FieldType): DatasetPreparationSettingsConfig;
   ...
   * @see #removeField
   */
  unsetField(field: string): DatasetPreparationSettingsConfig;
   ...
   * @see #removeField
   */
  static unsetField(field: string): DatasetPreparationSettingsConfig;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): DatasetPreparationSettingsConfig;
   ...
   * @see #removeField
   */
  static unsetField(field: FieldType): DatasetPreparationSettingsConfig;
   ...
   * @see #unsetField
   */
  removeField(field: string): DatasetPreparationSettingsConfig;
   ...
   * @see #unsetField
   */
  static removeField(field: string): DatasetPreparationSettingsConfig;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): DatasetPreparationSettingsConfig;
   ...
   * @see #unsetField
   */
  static removeField(field: FieldType): DatasetPreparationSettingsConfig;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): DatasetPreparationSettingsConfig;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): DatasetPreparationSettingsConfig;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): DatasetPreparationSettingsConfig;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj, otherFieldsFilter: Type): DatasetPreparationSettingsConfig;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): DatasetPreparationSettingsConfig;
   ...
   *        the same key or index.
   */
  static mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): DatasetPreparationSettingsConfig;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): DatasetPreparationSettingsConfig;
   ...
   * traverse child reference and collection fields.
   */
  static mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): DatasetPreparationSettingsConfig;

  mergeJson(json: any): DatasetPreparationSettingsConfig;

  static mergeJson(json: any): DatasetPreparationSettingsConfig;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): DatasetPreparationSettingsConfig;
   ...
   * @return Obj with child references merged
   */
  static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): DatasetPreparationSettingsConfig;
   ...
   */
  sumObj(other: Obj, deep?: boolean): DatasetPreparationSettingsConfig;
   ...
   * references with same name and collection elements at same index or key.
   */
  static sumObj(other: Obj, deep?: boolean): DatasetPreparationSettingsConfig;
   ...
   */
  singletonArray(): Array_Type<DatasetPreparationSettingsConfig>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonArray(): Array_Type<DatasetPreparationSettingsConfig>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<DatasetPreparationSettingsConfig> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<DatasetPreparationSettingsConfig> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<DatasetPreparationSettingsConfig>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonSet(): Set_Type<DatasetPreparationSettingsConfig>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<DatasetPreparationSettingsConfig> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, DatasetPreparationSettingsConfig> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, DatasetPreparationSettingsConfig> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<DatasetPreparationSettingsConfig>;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  static toBuilder(): ObjBuilder<DatasetPreparationSettingsConfig>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<DatasetPreparationSettingsConfig>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): DatasetPreparationSettingsConfig;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): DatasetPreparationSettingsConfig;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): DatasetPreparationSettingsConfig;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): DatasetPreparationSettingsConfig;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): DatasetPreparationSettingsConfig;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): DatasetPreparationSettingsConfig;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): DatasetPreparationSettingsConfig;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): DatasetPreparationSettingsConfig;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  static afterMake(): DatasetPreparationSettingsConfig;
   ...
   */
  static cachedEmptyInst(): DatasetPreparationSettingsConfig;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<DatasetPreparationSettingsConfig> | null;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<DatasetPreparationSettingsConfig> | null;
   ...
   */
  static find(filter?: string, doNotProduceAll?: boolean): Stream<DatasetPreparationSettingsConfig> | null;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<DatasetPreparationSettingsConfig> | null;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): DatasetPreparationSettingsConfig | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string): DatasetPreparationSettingsConfig | null;
   ...
   * @see findByCacheKey
   */
  getCached(): DatasetPreparationSettingsConfig | null;
   ...
   * @see findByCacheKey
   */
  static getCached(): DatasetPreparationSettingsConfig | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): DatasetPreparationSettingsConfig | null;

  /**
   * @return newly produced cached instance.
   */
  static refreshCache(): DatasetPreparationSettingsConfig | null;
   ...
   */
  static produce(key: string): DatasetPreparationSettingsConfig | null;
   ...
   */
  static produceAll(): Map_Type<string, DatasetPreparationSettingsConfig> | null;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): Map_Type<string, DatasetPreparationSettingsConfig> | null;
   ...
   */
  getConfig(): DatasetPreparationSettingsConfig;
   ...
   * Note that typical pattern is to use Configurable#config instead of this method.
   */
  static getConfig(): DatasetPreparationSettingsConfig;
   ...
   */
  getSecret(): DatasetPreparationSettingsConfig;
   ...
   * Note that typical pattern is to use Configurable#configWithSecrets instead of this method.
   */
  static getSecret(): DatasetPreparationSettingsConfig;
   ...
   */
  withConfigKey(configKey: string): DatasetPreparationSettingsConfig;
   ...
   *     config.configKey() => "folder1/abc"
   */
  static withConfigKey(configKey: string): DatasetPreparationSettingsConfig;

  /**
   * @return copy without config key.
   */
  withoutConfigKey(): DatasetPreparationSettingsConfig;

  /**
   * @return copy without config key.
   */
  static withoutConfigKey(): DatasetPreparationSettingsConfig;

  /**
   * @return return cached config instance for provided config key.
   */
  static forConfigKey(configKey: string): DatasetPreparationSettingsConfig | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string>): Stream<DatasetPreparationSettingsConfig> | null;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: DatasetPreparationSettingsConfig, override?: string): void;

  /**
   * Sets multiple field values to be the same as the passed instance.
   * @see setConfigValue
   */
  static setConfigValues(from: DatasetPreparationSettingsConfig, override?: string): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: DatasetPreparationSettingsConfig, override?: string): void;

  /**
   * Sets multiple secret field values to be the same as the passed instance.
   * @see setSecretValue
   */
  static setSecretValues(from: DatasetPreparationSettingsConfig, override?: string): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): DatasetPreparationSettingsConfig | null;
   ...
   */
  removeSecrets(): DatasetPreparationSettingsConfig | null;

  /**
   * @return this config without any secret values.
   */
  static removeSecrets(): DatasetPreparationSettingsConfig | null;

  /**
   * @return this config with only secret values.
   */
  removeNonSecrets(): DatasetPreparationSettingsConfig | null;

  /**
   * @return this config with only secret values.
   */
  static removeNonSecrets(): DatasetPreparationSettingsConfig | null;

  /**
   * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
   * validation and setup.
   */
  validate(): DatasetPreparationSettingsConfig;

  /**
   * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
   * validation and setup.
   */
  static validate(): DatasetPreparationSettingsConfig;
