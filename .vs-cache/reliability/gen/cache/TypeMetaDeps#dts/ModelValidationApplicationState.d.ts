// TypeScript definitions for the C3 type ModelValidationApplicationState

/**
 * Application state for the Model Validation workflow in Reliability.
 *
 * @remarks this represents a value passed to a method that expects an instance of ModelValidationApplicationState
 */
declare interface IModelValidationApplicationState {
  ...
  /**
   * A list of alert feedback options.
   * Used to populate the options for the {@link ReliabilityDropdownGridCell}.
   */
  alertFeedbackOptions?: any;
}

/**
 * Application state for the Model Validation workflow in Reliability.
 *
 * @remarks this represents a made instance of ModelValidationApplicationState
 */
declare class ModelValidationApplicationState extends Obj  {

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): ModelValidationApplicationState;

  /**
   * Unique identifier for the logical object that instance of this type represents.
   */
  readonly id?: string;
  withId(id: string | null): ModelValidationApplicationState;

  /**
   * The name of the component. Optional field for informational purposes only.
   */
  readonly name?: string;
  withName(name: string | null): ModelValidationApplicationState;
  ...
  withDataSpec(dataSpec: IUiSdlNoData | null): ModelValidationApplicationState;

  /**
   * Disable if you want to avoid sending any and all requests for this component on first render.
   */
  readonly disableDataRequestOnFirstRender?: boolean;
  withDisableDataRequestOnFirstRender(disableDataRequestOnFirstRender: boolean): ModelValidationApplicationState;

  /**
   * Whether the effect triggers and epics have been registered
   */
  readonly triggersRegistered?: boolean;
  withTriggersRegistered(triggersRegistered: boolean): ModelValidationApplicationState;

  /**
   * Whether to wrap the component with a div which has a class name of its metdata id. Useful for targeting with css.
   */
  readonly wrapWithMetadataId?: boolean;
  withWrapWithMetadataId(wrapWithMetadataId: boolean): ModelValidationApplicationState;

  /**
   * The Redux namespace for the application state to indicate where the application data is stored in the Redux state.
   */
  readonly REDUX_NAMESPACE?: string;
  withREDUX_NAMESPACE(REDUX_NAMESPACE: string | null): ModelValidationApplicationState;

  /**
   * Collection of extra async {@link UiSdlEffectTrigger}.
   */
  readonly effectTriggers?: Array_Type<UiSdlEffectTrigger>;
  withEffectTriggers(effectTriggers: Array_Type<UiSdlEffectTrigger> | Array<IUiSdlEffectTrigger> | null): ModelValidationApplicationState;

  /**
   * A list of alert feedback options.
   * Used to populate the options for the {@link ReliabilityDropdownGridCell}.
   */
  readonly alertFeedbackOptions?: any;
  withAlertFeedbackOptions(alertFeedbackOptions: any | null): ModelValidationApplicationState;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ModelValidationApplicationState | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ModelValidationApplicationState | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ModelValidationApplicationState | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ModelValidationApplicationState | null;
   ...
   */
  replaceType(old: Type, new_: Type): ModelValidationApplicationState;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ModelValidationApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ModelValidationApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ModelValidationApplicationState>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ModelValidationApplicationState>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ModelValidationApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ModelValidationApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ModelValidationApplicationState;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ModelValidationApplicationState;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ModelValidationApplicationState;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ModelValidationApplicationState;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ModelValidationApplicationState;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ModelValidationApplicationState;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ModelValidationApplicationState;
   ...
   * @see #removeField
   */
  withoutField(field: string): ModelValidationApplicationState;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ModelValidationApplicationState;
   ...
   */
  withoutFields(fields: Array_Type<string>): ModelValidationApplicationState;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ModelValidationApplicationState;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ModelValidationApplicationState;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ModelValidationApplicationState;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ModelValidationApplicationState;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ModelValidationApplicationState;
   ...
   * @see #removeField
   */
  unsetField(field: string): ModelValidationApplicationState;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ModelValidationApplicationState;
   ...
   * @see #unsetField
   */
  removeField(field: string): ModelValidationApplicationState;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ModelValidationApplicationState;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ModelValidationApplicationState;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ModelValidationApplicationState;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ModelValidationApplicationState;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ModelValidationApplicationState;

  mergeJson(json: any): ModelValidationApplicationState;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ModelValidationApplicationState;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ModelValidationApplicationState;
   ...
   */
  singletonArray(): Array_Type<ModelValidationApplicationState>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ModelValidationApplicationState> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ModelValidationApplicationState> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ModelValidationApplicationState>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ModelValidationApplicationState> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ModelValidationApplicationState> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ModelValidationApplicationState> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ModelValidationApplicationState>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ModelValidationApplicationState>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ModelValidationApplicationState;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ModelValidationApplicationState;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ModelValidationApplicationState;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ModelValidationApplicationState;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ModelValidationApplicationState;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ModelValidationApplicationState;
   ...
   * @see #fromString
   */
  static make(s: string): ModelValidationApplicationState | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ModelValidationApplicationState;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ModelValidationApplicationState;
   ...
   */
  static cachedEmptyInst(): ModelValidationApplicationState;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ModelValidationApplicationState> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ModelValidationApplicationState;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<ModelValidationApplicationState>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ModelValidationApplicationState>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<ModelValidationApplicationState> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ModelValidationApplicationState>> | null;
   ...
   */
  dependencies(): MetadataDeps<ModelValidationApplicationState>;

  save(subPath?: string, contentType?: string): ModelValidationApplicationState;
  ...
  update(srcObj?: ModelValidationApplicationState, spec?: UpsertSpec): ModelValidationApplicationState | null;

  upsert(srcObj?: ModelValidationApplicationState, spec?: UpsertSpec): ModelValidationApplicationState | null;
   ...
   * @see #toString
   */
  static fromString(s: string): ModelValidationApplicationState | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string, failIfMissing?: boolean): ModelValidationApplicationState | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: ModelValidationApplicationState, state: UiSdlReduxState): ModelValidationApplicationState | null;
