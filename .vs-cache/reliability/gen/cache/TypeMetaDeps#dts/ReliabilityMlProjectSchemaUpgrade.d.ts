// TypeScript definitions for the C3 type ReliabilityMlProjectSchemaUpgrade

/**
 * Schema upgrade for {@link ReliabilityMl.Project}.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityMlProjectSchemaUpgrade
 */
declare interface IReliabilityMlProjectSchemaUpgrade {
}
 ...
 */
declare class ReliabilityMlProjectSchemaUpgrade extends Obj  {
   ...
   * @see #toJson
   */
  static fromJson(json: any): ReliabilityMlProjectSchemaUpgrade | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ReliabilityMlProjectSchemaUpgrade | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ReliabilityMlProjectSchemaUpgrade | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ReliabilityMlProjectSchemaUpgrade | null;
   ...
   */
  replaceType(old: Type, new_: Type): ReliabilityMlProjectSchemaUpgrade;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityMlProjectSchemaUpgrade;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityMlProjectSchemaUpgrade;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityMlProjectSchemaUpgrade>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityMlProjectSchemaUpgrade>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityMlProjectSchemaUpgrade;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityMlProjectSchemaUpgrade;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityMlProjectSchemaUpgrade;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ReliabilityMlProjectSchemaUpgrade;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ReliabilityMlProjectSchemaUpgrade;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityMlProjectSchemaUpgrade;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityMlProjectSchemaUpgrade;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityMlProjectSchemaUpgrade;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ReliabilityMlProjectSchemaUpgrade;
   ...
   * @see #removeField
   */
  withoutField(field: string): ReliabilityMlProjectSchemaUpgrade;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ReliabilityMlProjectSchemaUpgrade;
   ...
   */
  withoutFields(fields: Array_Type<string>): ReliabilityMlProjectSchemaUpgrade;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityMlProjectSchemaUpgrade;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ReliabilityMlProjectSchemaUpgrade;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityMlProjectSchemaUpgrade;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ReliabilityMlProjectSchemaUpgrade;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ReliabilityMlProjectSchemaUpgrade;
   ...
   * @see #removeField
   */
  unsetField(field: string): ReliabilityMlProjectSchemaUpgrade;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ReliabilityMlProjectSchemaUpgrade;
   ...
   * @see #unsetField
   */
  removeField(field: string): ReliabilityMlProjectSchemaUpgrade;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ReliabilityMlProjectSchemaUpgrade;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityMlProjectSchemaUpgrade;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityMlProjectSchemaUpgrade;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityMlProjectSchemaUpgrade;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityMlProjectSchemaUpgrade;

  mergeJson(json: any): ReliabilityMlProjectSchemaUpgrade;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityMlProjectSchemaUpgrade;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ReliabilityMlProjectSchemaUpgrade;
   ...
   */
  singletonArray(): Array_Type<ReliabilityMlProjectSchemaUpgrade>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityMlProjectSchemaUpgrade> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ReliabilityMlProjectSchemaUpgrade> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ReliabilityMlProjectSchemaUpgrade>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ReliabilityMlProjectSchemaUpgrade> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ReliabilityMlProjectSchemaUpgrade> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityMlProjectSchemaUpgrade> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ReliabilityMlProjectSchemaUpgrade>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ReliabilityMlProjectSchemaUpgrade>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityMlProjectSchemaUpgrade;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityMlProjectSchemaUpgrade;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityMlProjectSchemaUpgrade;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ReliabilityMlProjectSchemaUpgrade;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityMlProjectSchemaUpgrade;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ReliabilityMlProjectSchemaUpgrade;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityMlProjectSchemaUpgrade;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ReliabilityMlProjectSchemaUpgrade;
   ...
   */
  static cachedEmptyInst(): ReliabilityMlProjectSchemaUpgrade;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityMlProjectSchemaUpgrade> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ReliabilityMlProjectSchemaUpgrade;
   ...
   */
  static migrateReliabilityMlProject_1(): void;
   ...
   */
  static migrateResidualRiskAddModelValidationChartOutputsCode_2(): void;
}
