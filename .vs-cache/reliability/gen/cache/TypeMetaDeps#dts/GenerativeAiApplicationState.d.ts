// TypeScript definitions for the C3 type GenerativeAiApplicationState

/**
 * Application state for the Generative AI workflow in Reliability.
 *
 * @remarks this represents a value passed to a method that expects an instance of GenerativeAiApplicationState
 */
declare interface IGenerativeAiApplicationState {
  ...
  /**
   * An array of sample questions to be displayed in the UI.
   */
  sampleQuestions?: Array_Type<string> | Array<string>;

  /**
   * The query from the most recently selected prompts
   * If a new chat is opened, it's set to empty
   */
  selectedQuestion?: string;

  /**
   * Indicates whether the user clicked in the trash icon to clear the chat.
   *
   * This flag is set to false every time the user submits a query in the chat.
   * This value changes to true when the clear chat action is triggered.
   */
 ...
 * Application state for the Generative AI workflow in Reliability.
 *
 * @remarks this represents a made instance of GenerativeAiApplicationState
 */
declare class GenerativeAiApplicationState extends Obj  {

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): GenerativeAiApplicationState;

  /**
   * Unique identifier for the logical object that instance of this type represents.
   */
  readonly id?: string;
  withId(id: string | null): GenerativeAiApplicationState;

  /**
   * The name of the component. Optional field for informational purposes only.
   */
  readonly name?: string;
  withName(name: string | null): GenerativeAiApplicationState;
  ...
  withDataSpec(dataSpec: IUiSdlNoData | null): GenerativeAiApplicationState;

  /**
   * Disable if you want to avoid sending any and all requests for this component on first render.
   */
  readonly disableDataRequestOnFirstRender?: boolean;
  withDisableDataRequestOnFirstRender(disableDataRequestOnFirstRender: boolean): GenerativeAiApplicationState;

  /**
   * Whether the effect triggers and epics have been registered
   */
  readonly triggersRegistered?: boolean;
  withTriggersRegistered(triggersRegistered: boolean): GenerativeAiApplicationState;

  /**
   * Whether to wrap the component with a div which has a class name of its metdata id. Useful for targeting with css.
   */
  readonly wrapWithMetadataId?: boolean;
  withWrapWithMetadataId(wrapWithMetadataId: boolean): GenerativeAiApplicationState;

  /**
   * The Redux namespace for the application state to indicate where the application data is stored in the Redux state.
   */
  readonly REDUX_NAMESPACE?: string;
  withREDUX_NAMESPACE(REDUX_NAMESPACE: string | null): GenerativeAiApplicationState;

  /**
   * Collection of extra async {@link UiSdlEffectTrigger}.
   */
  readonly effectTriggers?: Array_Type<UiSdlEffectTrigger>;
  withEffectTriggers(effectTriggers: Array_Type<UiSdlEffectTrigger> | Array<IUiSdlEffectTrigger> | null): GenerativeAiApplicationState;

  /**
   * An array of sample questions to be displayed in the UI.
   */
  readonly sampleQuestions?: Array_Type<string>;
  withSampleQuestions(sampleQuestions: Array_Type<string> | Array<string> | null): GenerativeAiApplicationState;
  ...
  withSelectedQuestion(selectedQuestion: string | null): GenerativeAiApplicationState;
   ...
   * This value changes to true when the clear chat action is triggered.
   */
  readonly isClearingChat?: boolean;
  withIsClearingChat(isClearingChat: boolean): GenerativeAiApplicationState;
   ...
   * @see #toJson
   */
  static fromJson(json: any): GenerativeAiApplicationState | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): GenerativeAiApplicationState | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): GenerativeAiApplicationState | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): GenerativeAiApplicationState | null;
   ...
   */
  replaceType(old: Type, new_: Type): GenerativeAiApplicationState;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenerativeAiApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenerativeAiApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<GenerativeAiApplicationState>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<GenerativeAiApplicationState>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): GenerativeAiApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenerativeAiApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenerativeAiApplicationState;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): GenerativeAiApplicationState;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): GenerativeAiApplicationState;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): GenerativeAiApplicationState;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): GenerativeAiApplicationState;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): GenerativeAiApplicationState;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): GenerativeAiApplicationState;
   ...
   * @see #removeField
   */
  withoutField(field: string): GenerativeAiApplicationState;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): GenerativeAiApplicationState;
   ...
   */
  withoutFields(fields: Array_Type<string>): GenerativeAiApplicationState;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): GenerativeAiApplicationState;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): GenerativeAiApplicationState;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): GenerativeAiApplicationState;
   ...
   * @see #unsetField
   */
  defaultField(field: string): GenerativeAiApplicationState;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): GenerativeAiApplicationState;
   ...
   * @see #removeField
   */
  unsetField(field: string): GenerativeAiApplicationState;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): GenerativeAiApplicationState;
   ...
   * @see #unsetField
   */
  removeField(field: string): GenerativeAiApplicationState;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): GenerativeAiApplicationState;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): GenerativeAiApplicationState;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): GenerativeAiApplicationState;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): GenerativeAiApplicationState;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): GenerativeAiApplicationState;

  mergeJson(json: any): GenerativeAiApplicationState;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): GenerativeAiApplicationState;
   ...
   */
  sumObj(other: Obj, deep?: boolean): GenerativeAiApplicationState;
   ...
   */
  singletonArray(): Array_Type<GenerativeAiApplicationState>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<GenerativeAiApplicationState> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<GenerativeAiApplicationState> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<GenerativeAiApplicationState>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<GenerativeAiApplicationState> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, GenerativeAiApplicationState> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, GenerativeAiApplicationState> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<GenerativeAiApplicationState>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<GenerativeAiApplicationState>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): GenerativeAiApplicationState;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): GenerativeAiApplicationState;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): GenerativeAiApplicationState;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): GenerativeAiApplicationState;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): GenerativeAiApplicationState;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): GenerativeAiApplicationState;
   ...
   * @see #fromString
   */
  static make(s: string): GenerativeAiApplicationState | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): GenerativeAiApplicationState;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): GenerativeAiApplicationState;
   ...
   */
  static cachedEmptyInst(): GenerativeAiApplicationState;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<GenerativeAiApplicationState> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): GenerativeAiApplicationState;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<GenerativeAiApplicationState>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<GenerativeAiApplicationState>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<GenerativeAiApplicationState> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<GenerativeAiApplicationState>> | null;
   ...
   */
  dependencies(): MetadataDeps<GenerativeAiApplicationState>;

  save(subPath?: string, contentType?: string): GenerativeAiApplicationState;
  ...
  update(srcObj?: GenerativeAiApplicationState, spec?: UpsertSpec): GenerativeAiApplicationState | null;

  upsert(srcObj?: GenerativeAiApplicationState, spec?: UpsertSpec): GenerativeAiApplicationState | null;
   ...
   * @see #toString
   */
  static fromString(s: string): GenerativeAiApplicationState | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string, failIfMissing?: boolean): GenerativeAiApplicationState | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: GenerativeAiApplicationState, state: UiSdlReduxState): GenerativeAiApplicationState | null;
