...
declare interface IModelScenarioApplicationState {
   ...
   */
  selectedItems?: Array_Type<string> | Array<string>;
   ...
   */
  scenarioWindowAtCSVUpload?: Array_Type<DateTime> | Array<IDateTime>;
   ...
   */
  lastPlottedTimeRange?: ITimeRange;
   ...
   */
  overriddenFeatures?: Map_Type<string, ReliabilityMlModelScenario.ValueGenerator> | {[key: string]: IReliabilityMlModelScenario.ValueGenerator};
}
...
declare class ModelScenarioApplicationState extends Obj  {
  ...
  withEffectTriggers(effectTriggers: Array_Type<UiSdlEffectTrigger> | Array<IUiSdlEffectTrigger> | null): ModelScenarioApplicationState;
  ...
  withActionMap(actionMap: Map_Type<string, UiApDataStoreAction> | {[key: string]: IUiApDataStoreAction} | null): ModelScenarioApplicationState;
  ...
  withResolvedActionMap(resolvedActionMap: Map_Type<string, UiApDataStoreAction> | {[key: string]: IUiApDataStoreAction} | null): ModelScenarioApplicationState;

  /**
   * A map of data IDs to the data that has been fetched.
   */
  readonly dataMap?: Map_Type<string, any>;
  withDataMap(dataMap: Map_Type<string, any> | {[key: string]: any} | null): ModelScenarioApplicationState;
  ...
  withContextVars(contextVars: Map_Type<string, UiSdlDynamicValueSpecParam> | {[key: string]: IUiSdlDynamicValueSpecParam} | null): ModelScenarioApplicationState;
  ...
  withResolvedContextVars(resolvedContextVars: Map_Type<string, any> | {[key: string]: any} | null): ModelScenarioApplicationState;

  /**
   * A map of data IDs to a boolean indicating if the data is currently being fetched.
   */
  readonly isLoadingMap?: Map_Type<string, boolean>;
  withIsLoadingMap(isLoadingMap: Map_Type<string, boolean> | {[key: string]: boolean} | null): ModelScenarioApplicationState;
   ...
   * The {@link Interval} the {@link ReliabilityMlModel#datasetPreparationRun} is configured to use.
   */
  readonly dataInterval?: string;
  withDataInterval(dataInterval: string | null): ModelScenarioApplicationState;

  /**
   * The array of {@link Feature}s that are plotted in the chart.
   */
  readonly selectedItems?: Array_Type<string>;
  withSelectedItems(selectedItems: Array_Type<string> | Array<string> | null): ModelScenarioApplicationState;
   ...
   * Array containing two {@link DateTime} values: `[startDate, endDate]`
   */
  readonly scenarioWindowAtCSVUpload?: Array_Type<DateTime>;
  withScenarioWindowAtCSVUpload(scenarioWindowAtCSVUpload: Array_Type<DateTime> | Array<IDateTime> | null): ModelScenarioApplicationState;

  /**
   * The most recent {@link TimeRange} used to request chart data.
   * It serves as a reference point for request optimization purposes.
   */
  readonly lastPlottedTimeRange?: TimeRange;
   ...
   * that will generate the {@link Data} for it.
   */
  readonly overriddenFeatures?: Map_Type<string, ReliabilityMlModelScenario.ValueGenerator>;
  withOverriddenFeatures(overriddenFeatures: Map_Type<string, ReliabilityMlModelScenario.ValueGenerator> | {[key: string]: IReliabilityMlModelScenario.ValueGenerator} | null): ModelScenarioApplicationState;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ModelScenarioApplicationState | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ModelScenarioApplicationState | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ModelScenarioApplicationState | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ModelScenarioApplicationState | null;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ModelScenarioApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ModelScenarioApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ModelScenarioApplicationState>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ModelScenarioApplicationState>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ModelScenarioApplicationState;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ModelScenarioApplicationState;
   ...
   * @see #removeField
   */
  withoutField(field: string): ModelScenarioApplicationState;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ModelScenarioApplicationState;
   ...
   */
  withoutFields(fields: Array_Type<string>): ModelScenarioApplicationState;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ModelScenarioApplicationState;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ModelScenarioApplicationState;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ModelScenarioApplicationState;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ModelScenarioApplicationState;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ModelScenarioApplicationState;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ModelScenarioApplicationState;

  mergeJson(json: any): ModelScenarioApplicationState;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ModelScenarioApplicationState;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ModelScenarioApplicationState;
   ...
   */
  singletonArray(): Array_Type<ModelScenarioApplicationState>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ModelScenarioApplicationState> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ModelScenarioApplicationState> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ModelScenarioApplicationState>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ModelScenarioApplicationState> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ModelScenarioApplicationState> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ModelScenarioApplicationState> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ModelScenarioApplicationState>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ModelScenarioApplicationState>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ModelScenarioApplicationState;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ModelScenarioApplicationState;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ModelScenarioApplicationState;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ModelScenarioApplicationState;
   ...
   * @see #fromString
   */
  static make(s: string): ModelScenarioApplicationState | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ModelScenarioApplicationState;
   ...
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ModelScenarioApplicationState> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ModelScenarioApplicationState;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<ModelScenarioApplicationState>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ModelScenarioApplicationState>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<ModelScenarioApplicationState> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ModelScenarioApplicationState>> | null;
   ...
   */
  dependencies(): MetadataDeps<ModelScenarioApplicationState>;

  save(subPath?: string, contentType?: string): ModelScenarioApplicationState;
  ...
  update(srcObj?: ModelScenarioApplicationState, spec?: UpsertSpec): ModelScenarioApplicationState | null;

  upsert(srcObj?: ModelScenarioApplicationState, spec?: UpsertSpec): ModelScenarioApplicationState | null;
   ...
   * @see #toString
   */
  static fromString(s: string): ModelScenarioApplicationState | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string, failIfMissing?: boolean): ModelScenarioApplicationState | null;
   ...
   */
  static clearPlotsAction(id: string, plotIds: Array_Type<string>, clearTsDataset?: boolean): UiSdlReduxAction<any>;
   ...
   */
  static clearDimensionsAction(id: string, dimensions: Array_Type<string>): UiSdlReduxAction<any>;
