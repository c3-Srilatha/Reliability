...
from c3.assetPerformanceUiLibrary.UiApDataStoreDataReceiveSpec import UiApDataStoreDataReceiveSpec
...
from c3.assetPerformanceUiLibrary.UiApDataStoreSetArgsSpec import UiApDataStoreSetArgsSpec
...
from c3.assetPerformanceUiLibrary.UiApDataStoreAction import UiApDataStoreAction
...
from c3.assetPerformanceUiLibrary.UiApDataStoreDataRequestSpec import UiApDataStoreDataRequestSpec
...
# Python definitions for the C3 type ModelScenarioApplicationState


class ModelScenarioApplicationState(UiApTimeseriesDataStore, ComponentStateRemover):
    """
    Application state that holds the model scenario information.
    
    @remarks this represents a made instance of ModelScenarioApplicationState
    """
    ...
    actionMap: Optional[Map[str, UiApDataStoreAction]]=None
    """
    ...
    resolvedActionMap: Optional[Map[str, UiApDataStoreAction]]=None
    """
    ...
    dataMap: Optional[Map[str, Any]]=None
    """
    ...
    resolvedContextVars: Optional[Map[str, Any]]=None
    """
    ...
    isLoadingMap: Optional[Map[str, bool]]=None
    """
    ...
    """
    The URL to redirect to when the user exits the model scenario.
    """

    jobName: Optional[str]=None
    """
    The name to be used for the scenario process job.
    
    @see ReliabilityOrchestrator.ModelScenarioProcess.Spec#name
    """

    lookbackDuration: Optional[str]=None
    """
    Holds the {@link ReliabilityMlModel#pipeline} `lookbackDuration` in seconds format.
    Used to calculate the data window from the scenario window.
    
    ```
    Scenario Window = [Start, End]
    Data Window = [Start - lookbackDuration, End]
    ```
    
    @see ReliabilityMl.Pipeline
    """

    asset: Optional[ReliabilityAsset]=None
    """
    The {@link ReliabilityAsset} that is associated with the {@link ReliabilityMlModel} the
    scenario is based on.
    """

    facility: Optional[Facility]=None
    """
    The {@link Facility} that is associated from the #asset that the {@link ReliabilityMlModel} belongs to.
    """

    dataInterval: Optional[str]=None
    """
    The {@link Interval} the {@link ReliabilityMlModel#datasetPreparationRun} is configured to use.
    """

    selectedItems: Optional[Array[str]]=None
    """
    The array of {@link Feature}s that are plotted in the chart.
    """

    scenarioWindowAtCSVUpload: Optional[Array[DateTime]]=None
    """
    This field captures the original time window that was selected by the user when they
    uploaded CSV data containing feature overrides. It serves as a reference point for
    comparison and restoration purposes.
    
    **Data Format:**
    Array containing two {@link DateTime} values: `[startDate, endDate]`
    """

    lastPlottedTimeRange: Optional[TimeRange]=None
    """
    The most recent {@link TimeRange} used to request chart data.
    It serves as a reference point for request optimization purposes.
    """
    ...
    """
    def __init__(self, meta: Optional[Meta]=None, id: Optional[str]=None, name: Optional[str]=None, dataSpec: Optional[UiSdlNoData]=None, disableDataRequestOnFirstRender: Optional[bool]=None, triggersRegistered: Optional[bool]=None, wrapWithMetadataId: Optional[bool]=None, REDUX_NAMESPACE: Optional[str]=None, effectTriggers: Optional[Array[UiSdlEffectTrigger]]=None, actionMap: Optional[Map[str, UiApDataStoreAction]]=None, resolvedActionMap: Optional[Map[str, UiApDataStoreAction]]=None, dataMap: Optional[Map[str, Any]]=None, contextVars: Optional[Map[str, UiSdlDynamicValueSpecParam]]=None, resolvedContextVars: Optional[Map[str, Any]]=None, isLoadingMap: Optional[Map[str, bool]]=None, redirectTo: Optional[str]=None, jobName: Optional[str]=None, lookbackDuration: Optional[str]=None, asset: Optional[ReliabilityAsset]=None, facility: Optional[Facility]=None, dataInterval: Optional[str]=None, selectedItems: Optional[Array[str]]=None, scenarioWindowAtCSVUpload: Optional[Array[DateTime]]=None, lastPlottedTimeRange: Optional[TimeRange]=None, overriddenFeatures: Optional[Map[str, ReliabilityMlModelScenario.ValueGenerator]]=None) -> None: ...
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[ModelScenarioApplicationState]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[ModelScenarioApplicationState]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[ModelScenarioApplicationState]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[ModelScenarioApplicationState]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> ModelScenarioApplicationState:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> ModelScenarioApplicationState:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> ModelScenarioApplicationState:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[ModelScenarioApplicationState]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[ModelScenarioApplicationState]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> ModelScenarioApplicationState:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> ModelScenarioApplicationState:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> ModelScenarioApplicationState:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> ModelScenarioApplicationState:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> ModelScenarioApplicationState:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> ModelScenarioApplicationState:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> ModelScenarioApplicationState:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> ModelScenarioApplicationState:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> ModelScenarioApplicationState:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> ModelScenarioApplicationState:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> ModelScenarioApplicationState:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> ModelScenarioApplicationState:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> ModelScenarioApplicationState:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> ModelScenarioApplicationState:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> ModelScenarioApplicationState:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> ModelScenarioApplicationState:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> ModelScenarioApplicationState:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> ModelScenarioApplicationState:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> ModelScenarioApplicationState:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> ModelScenarioApplicationState:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> ModelScenarioApplicationState:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> ModelScenarioApplicationState:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> ModelScenarioApplicationState:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> ModelScenarioApplicationState:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> ModelScenarioApplicationState:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> ModelScenarioApplicationState:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> ModelScenarioApplicationState:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> ModelScenarioApplicationState:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[ModelScenarioApplicationState]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[ModelScenarioApplicationState]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[ModelScenarioApplicationState]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[ModelScenarioApplicationState]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[ModelScenarioApplicationState]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, ModelScenarioApplicationState]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, ModelScenarioApplicationState]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[ModelScenarioApplicationState]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[ModelScenarioApplicationState]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> ModelScenarioApplicationState:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> ModelScenarioApplicationState:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> ModelScenarioApplicationState:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> ModelScenarioApplicationState:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> ModelScenarioApplicationState:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> ModelScenarioApplicationState:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[ModelScenarioApplicationState]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> ModelScenarioApplicationState:
    """
    ...
    """
        ...
    def afterMake(self) -> ModelScenarioApplicationState:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> ModelScenarioApplicationState:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[ModelScenarioApplicationState]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> ModelScenarioApplicationState:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, spec: FetchSpec=None) -> FetchResult[ModelScenarioApplicationState]:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, filter: Filter) -> FetchResult[ModelScenarioApplicationState]:
    """
    ...
    """
        ...
    @classmethod
    def fetchObjStream(cls, spec: FetchStreamSpec=None) -> Union[Stream[ModelScenarioApplicationState]]:
    """
    Fetches multiple obj instances based on a specification.  Only objs that the caller is authorized to fetch will be
    returned.
    ...
    """
        ...
    @classmethod
    def fetchMultiLocale(cls, spec: MultiLocaleFetchSpec=None) -> Union[Map[str, FetchResult[ModelScenarioApplicationState]]]:
    """
    ...
    """
        ...
    def dependencies(self) -> MetadataDeps[ModelScenarioApplicationState]:
    """
    Retrieves dependencies to types or other metadata elements for the given instance of metadata.
    """
        ...
    def save(self, subPath: str=None, contentType: str=None) -> ModelScenarioApplicationState:
        ...
    ...
    def removeAll(cls, removeFilter: str=None) -> int:
        ...
    def update(self, srcObj: ModelScenarioApplicationState=None, spec: UpsertSpec=None) -> Union[ModelScenarioApplicationState]:
        ...
    def upsert(self, srcObj: ModelScenarioApplicationState=None, spec: UpsertSpec=None) -> Union[ModelScenarioApplicationState]:
        ...
    @classmethod
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[ModelScenarioApplicationState]:
    """
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[ModelScenarioApplicationState]:
    """
    ...
    def jsonify(cls, value: Any=None) -> Union[str]:
        ...
    @classmethod
    def doDataMerge(cls, componentId: str, dataSpecFieldName: str, dataDestinationFieldName: str, props: ModelScenarioApplicationState, state: UiSdlReduxState) -> Union[ModelScenarioApplicationState]:
    """
    ...
    """
        ...
    @classmethod
    def setResolvedActionMapAction(cls, id: str=None, dataId: str=None, resolvedActionMap: Map[str, UiApDataStoreAction]=None) -> Union[UiSdlReduxAction[Any]]:
    """
    ...
    """
        ...
    @classmethod
    def setResolvedActionMapReducer(cls, state: UiSdlReduxState=None, action: UiSdlReduxAction[Any]=None) -> Union[UiSdlReduxState]:
    """
    ...
    """
        ...
    @classmethod
    def setArgsAction(cls, spec: UiApDataStoreSetArgsSpec=None) -> Union[UiSdlReduxAction[Any]]:
    """
    ...
    """
        ...
    @classmethod
    def setArgsReducer(cls, state: UiSdlReduxState=None, action: UiSdlReduxAction[Any]=None) -> Union[UiSdlReduxState]:
    """
    ...
    """
        ...
    @classmethod
    def dataRequestAction(cls, spec: UiApDataStoreDataRequestSpec=None) -> Union[UiSdlReduxAction[Any]]:
    """
    ...
    """
        ...
    @classmethod
    def dataReceiveAction(cls, spec: UiApDataStoreDataReceiveSpec=None) -> Union[UiSdlReduxAction[Any]]:
    """
    ...
    """
        ...
    @classmethod
    def dataReceiveReducer(cls, state: UiSdlReduxState=None, action: UiSdlReduxAction[Any]=None) -> Union[UiSdlReduxState]:
    """
    ...
    """
        ...
    @classmethod
    def dataRequestEpic(cls, actionStream: UiSdlActionsObservable=None, stateStream: UiSdlStatesObservable=None) -> Union[UiSdlActionsObservable]:
    """
    ...
    """
        ...
    @classmethod
    def dataErrorAction(cls, id: str=None, dataId: str=None, error: Any=None) -> Union[UiSdlReduxAction[Any]]:
    """
    ...
    """
        ...
    @classmethod
    def setResolvedContextVarsAction(cls, id: str=None, resolvedContextVars: Map[str, Any]=None) -> Union[UiSdlReduxAction[Any]]:
    """
    ...
    """
        ...
    @classmethod
    def setResolvedContextVarsReducer(cls, state: UiSdlReduxState=None, action: UiSdlReduxAction[Any]=None) -> Union[UiSdlReduxState]:
    """
    ...
    """
        ...
    @classmethod
    def registerUpdateResolvedActionsEpic(cls, actionStream: UiSdlActionsObservable=None, stateStream: UiSdlStatesObservable=None) -> Union[UiSdlActionsObservable]:
    """
    ...
    """
        ...
    @classmethod
    def clearPlotsAction(cls, id: str, plotIds: Array[str], clearTsDataset: bool=None) -> UiSdlReduxAction[Any]:
    """
    Creates an action to remove the indicated plots and all associated series.
    If `clearTsDataset` is true, the related data in `tsDataset` will also be cleared.
    
    @param id - The id of the application state to clear the plots from.
    @param plotIds - The IDs of the plots to clear.
    @param clearTsDataset - If true, the related data in `tsDataset` will also be cleared.
    @return - Redux action of type `CLEAR_PLOTS`.
    """
        ...
    @classmethod
    def clearPlotsReducer(cls, state: UiSdlReduxState, action: UiSdlReduxAction[Any]) -> UiSdlReduxState:
    """
    Reducer that listens for action of type `CLEAR_PLOTS` and removes the indicated plots, all associated series,
    and, optionally, the related data in `tsDataset`.
    
    @param state - Redux state.
    @param action - Redux action.
    @return - Redux state with cleared plots.
    """
        ...
    @classmethod
    def clearDimensionsAction(cls, id: str, dimensions: Array[str]) -> UiSdlReduxAction[Any]:
    """
    Creates an action to remove the indicated dimensions from `tsDataset` and related labels, units and source data.
    
    @param id - The id of the application state to clear the dimensions from.
    @param dimensions - The dimensions to remove from `tsDataset`.
    @return - Redux action of type `CLEAR_DIMENSIONS`.
    """
        ...
    @classmethod
    def clearDimensionsReducer(cls, state: UiSdlReduxState, action: UiSdlReduxAction[Any]) -> UiSdlReduxState:
    """
    Reducer that listens for action of type `CLEAR_DIMENSIONS` and removes the indicated dimensions from `tsDataset`.
    
    @param state - Redux state.
    @param action - Redux action.
    @return - Redux state with cleared dimensions in tsDataset.
    """
        ...
    @classmethod
    ...
    """
        ...
    @classmethod
    def getModelAndDataTimeRange(cls, state: UiSdlReduxState) -> Union[any]:
    """
    Retrieves the current {@link ReliabilityMlModel#id}, the user selection for scenario time window, and model
    data interval.
    
    @param state The current Redux state.
    @return A JSON object containing `modelId`, `start`, `end`, and `interval` fields.
    """
        ...
    @classmethod
    def buildScenarioSpec(cls, state: UiSdlReduxState) -> Union[ReliabilityOrchestrator.ModelScenarioProcess.Spec]:
    """
    Builds the {@link ReliabilityOrchestrator.ModelScenarioProcess.Spec} for the scenario using the
    current application state.
    
    @param state The current Redux state.
    @return The {@link ReliabilityOrchestrator.ModelScenarioProcess.Spec} for the scenario
    """
        ...
    @classmethod
    def blockAccessIfFeatureFlagDisabled(cls, state: UiSdlReduxState) -> Union[UiSdlActionsObservable]:
    """
    Helper function that returns an observable that emits {@link UiSdlModalOpenCloseAction} if
    {@link ReliabilityUIConfig#showUIModelScenarioFlow} is enabled else returns an `EMPTY` observable.
    
    @param state Redux state.
    @return The {@link UiSdlModalOpenCloseAction} or `EMPTY`.
    """
        ...
