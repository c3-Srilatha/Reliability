...
# Python definitions for the C3 type PlotMaskedSensorConfig


class PlotMaskedSensorConfig(Singleton, Config):
    """
    ...
    maskedRegex: Optional[str]=None
    """
    The regex to extract masked sensors.
    """

    maskExpressionFields: Optional[Array[str]]=None
    """
    The list of fields that will be masked in the expression.
    """
    def __init__(self, configOverride: Optional[str]=None, secretOverride: Optional[str]=None, issues: Optional[Array[str]]=None, maskedRegex: Optional[str]=None, maskExpressionFields: Optional[Array[str]]=None) -> None: ...

    @classmethod
    def inst(cls) -> PlotMaskedSensorConfig:
    """
    @return the one and only instance to be used when member functions are called on this type.
    """
        ...
    @classmethod
    def cachedInst(cls) -> Union[PlotMaskedSensorConfig]:
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[PlotMaskedSensorConfig]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[PlotMaskedSensorConfig]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[PlotMaskedSensorConfig]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[PlotMaskedSensorConfig]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> PlotMaskedSensorConfig:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> PlotMaskedSensorConfig:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> PlotMaskedSensorConfig:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[PlotMaskedSensorConfig]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[PlotMaskedSensorConfig]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> PlotMaskedSensorConfig:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> PlotMaskedSensorConfig:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> PlotMaskedSensorConfig:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> PlotMaskedSensorConfig:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> PlotMaskedSensorConfig:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> PlotMaskedSensorConfig:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> PlotMaskedSensorConfig:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> PlotMaskedSensorConfig:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> PlotMaskedSensorConfig:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> PlotMaskedSensorConfig:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> PlotMaskedSensorConfig:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> PlotMaskedSensorConfig:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> PlotMaskedSensorConfig:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> PlotMaskedSensorConfig:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> PlotMaskedSensorConfig:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> PlotMaskedSensorConfig:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> PlotMaskedSensorConfig:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> PlotMaskedSensorConfig:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> PlotMaskedSensorConfig:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> PlotMaskedSensorConfig:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> PlotMaskedSensorConfig:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> PlotMaskedSensorConfig:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> PlotMaskedSensorConfig:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> PlotMaskedSensorConfig:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> PlotMaskedSensorConfig:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> PlotMaskedSensorConfig:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> PlotMaskedSensorConfig:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> PlotMaskedSensorConfig:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[PlotMaskedSensorConfig]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[PlotMaskedSensorConfig]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[PlotMaskedSensorConfig]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[PlotMaskedSensorConfig]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[PlotMaskedSensorConfig]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, PlotMaskedSensorConfig]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, PlotMaskedSensorConfig]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[PlotMaskedSensorConfig]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[PlotMaskedSensorConfig]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> PlotMaskedSensorConfig:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> PlotMaskedSensorConfig:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> PlotMaskedSensorConfig:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> PlotMaskedSensorConfig:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> PlotMaskedSensorConfig:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> PlotMaskedSensorConfig:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> PlotMaskedSensorConfig:
    """
    ...
    """
        ...
    def afterMake(self) -> PlotMaskedSensorConfig:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> PlotMaskedSensorConfig:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[PlotMaskedSensorConfig]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> PlotMaskedSensorConfig:
    """
    ...
    """
        ...
    @classmethod
    def allCached(cls, doNotProduceAll: bool=None) -> Union[Stream[PlotMaskedSensorConfig]]:
    """
    ...
    """
        ...
    @classmethod
    def find(cls, filter: str=None, doNotProduceAll: bool=None) -> Union[Stream[PlotMaskedSensorConfig]]:
    """
    ...
    """
        ...
    @classmethod
    def findBy(cls, field: str, value: Any, doNotProduceAll: bool=None) -> Union[Stream[PlotMaskedSensorConfig]]:
    """
    @param doNotProduceAll if true, will not populate cache and only return available cached instances. Will call
           `produceAll` if cache is empty or if Ann.cache.all is true & data has not previously been fetched.
    @return existing instances of this type that satisfy filter from data cache.
    """
        ...
    @classmethod
    def findByCacheKey(cls, key: str) -> Union[PlotMaskedSensorConfig]:
    """
    ...
    """
        ...
    @classmethod
    def forCacheKey(cls, key: str) -> Union[PlotMaskedSensorConfig]:
    """
    Returns cached instance by key, with secrets removed.
    """
        ...
    def getCached(self) -> Union[PlotMaskedSensorConfig]:
    """
    ...
    """
        ...
    def refreshCache(self) -> Union[PlotMaskedSensorConfig]:
    """
    ...
    """
        ...
    @classmethod
    def produce(cls, key: str) -> Union[PlotMaskedSensorConfig]:
    """
    Should produce an entry for the cache key. This method should not be called directly.
    """
        ...
    @classmethod
    def produceAll(cls) -> Union[Map[str, PlotMaskedSensorConfig]]:
    """
    ...
    """
        ...
    @classmethod
    def doProduceAll(cls) -> Union[Map[str, PlotMaskedSensorConfig]]:
    """
    ...
    """
        ...
    def getConfig(self) -> PlotMaskedSensorConfig:
    """
    ...
    """
        ...
    def getSecret(self) -> PlotMaskedSensorConfig:
    """
    ...
    """
        ...
    def withConfigKey(self, configKey: str) -> PlotMaskedSensorConfig:
    """
    ...
    """
        ...
    def withoutConfigKey(self) -> PlotMaskedSensorConfig:
    """
    @return copy without config key.
    """
        ...
    @classmethod
    def forConfigKey(cls, configKey: str) -> Union[PlotMaskedSensorConfig]:
    """
    ...
    """
        ...
    @classmethod
    def listConfigs(cls, parallel: bool=None, filter: Callable[[str], bool]=None) -> Union[Stream[PlotMaskedSensorConfig]]:
    """
    @param
    ...
    """
        ...
    @overload
    def setConfigValues(self, from_: PlotMaskedSensorConfig, override: str=None) -> None:
    """
    ...
    """
        ...
    @overload
    def setSecretValues(self, from_: PlotMaskedSensorConfig, override: str=None) -> None:
    """
    ...
    """
        ...
    @classmethod
    def loadConfigAndSecret(cls, configKey: str) -> Union[PlotMaskedSensorConfig]:
    """
    ...
    """
        ...
    def removeSecrets(self) -> Union[PlotMaskedSensorConfig]:
    """
    @return this config without any secret values.
    """
        ...
    def removeNonSecrets(self) -> Union[PlotMaskedSensorConfig]:
    """
    @return this config with only secret values.
    """
        ...
    def validate(self) -> PlotMaskedSensorConfig:
    """
