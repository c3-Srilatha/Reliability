...
# Python definitions for the C3 type BulkSensorAssociationUiSettingsDefaultConfig


class BulkSensorAssociationUiSettingsDefaultConfig(BulkSensorAssociationUiDefaultableFields, Singleton, Config):
    """
    ...
    **NOTE**: It is expected for this field to be between 0 and 1.
    ...
    correlationThresholdMax: Optional[float]=None
    """
    ...
    **NOTE**: It is expected for this field to be between 0 and 1, and higher than #correlationThresholdMin.
    ...
    correlationThresholdMaxSensorsToReturn: Optional[int]=None
    """
    ...
    **NOTE**: This field will not be used for sensor correlation but for the underlying data preparation that
    ...
    excludeShortTimePeriodDurationAsDouble: Optional[float]=None
    """
    {@link BulkSensorAssociationUiSettings#excludeShortTimePeriod} expressed in days.
    """

    constantPeriodMinimumDurationDurationAsDouble: Optional[float]=None
    """
    {@link BulkSensorAssociationUiSettings#constantPeriodMinimumDuration} expressed in hours.
    """

    fastTransientLagPeriodDurationAsDouble: Optional[float]=None
    """
    {@link BulkSensorAssociationUiSettings#fastTransientLagPeriod} expressed in minutes.
    """
    def __init__(self, interval: Optional[str]=None, datasetPreparationInterval: Optional[str]=None, associationMethod: Optional[str]=None, correlationThresholdMin: Optional[float]=None, correlationThresholdMax: Optional[float]=None, correlationThresholdMaxSensorsToReturn: Optional[int]=None, enableMaintenanceDatabaseFilter: Optional[bool]=None, enableExtremeValueFilter: Optional[bool]=None, extremeValueFilterMin: Optional[float]=None, extremeValueFilterMax: Optional[float]=None, enableExcludeShortTimePeriodFilter: Optional[bool]=None, excludeShortTimePeriod: Optional[Duration]=None, enableManualModeFilter: Optional[bool]=None, ignoreAlmostConstantPeriod: Optional[bool]=None, constantPeriodMaximumAbsChange: Optional[float]=None, constantPeriodMinimumDuration: Optional[Duration]=None, enableFastTransientFilterExclusion: Optional[bool]=None, fastTransientLagPeriod: Optional[Duration]=None, fastTransientThreshold: Optional[float]=None, enableAlgorithmicTrainingMask: Optional[bool]=None, confidenceLevel: Optional[float]=None, configOverride: Optional[str]=None, secretOverride: Optional[str]=None, issues: Optional[Array[str]]=None, excludeShortTimePeriodDurationAsDouble: Optional[float]=None, constantPeriodMinimumDurationDurationAsDouble: Optional[float]=None, fastTransientLagPeriodDurationAsDouble: Optional[float]=None) -> None: ...
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[BulkSensorAssociationUiSettingsDefaultConfig]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[BulkSensorAssociationUiSettingsDefaultConfig]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[BulkSensorAssociationUiSettingsDefaultConfig]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[BulkSensorAssociationUiSettingsDefaultConfig]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> BulkSensorAssociationUiSettingsDefaultConfig:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> BulkSensorAssociationUiSettingsDefaultConfig:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> BulkSensorAssociationUiSettingsDefaultConfig:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[BulkSensorAssociationUiSettingsDefaultConfig]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[BulkSensorAssociationUiSettingsDefaultConfig]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> BulkSensorAssociationUiSettingsDefaultConfig:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> BulkSensorAssociationUiSettingsDefaultConfig:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> BulkSensorAssociationUiSettingsDefaultConfig:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> BulkSensorAssociationUiSettingsDefaultConfig:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> BulkSensorAssociationUiSettingsDefaultConfig:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> BulkSensorAssociationUiSettingsDefaultConfig:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> BulkSensorAssociationUiSettingsDefaultConfig:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> BulkSensorAssociationUiSettingsDefaultConfig:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> BulkSensorAssociationUiSettingsDefaultConfig:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> BulkSensorAssociationUiSettingsDefaultConfig:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> BulkSensorAssociationUiSettingsDefaultConfig:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> BulkSensorAssociationUiSettingsDefaultConfig:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> BulkSensorAssociationUiSettingsDefaultConfig:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> BulkSensorAssociationUiSettingsDefaultConfig:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> BulkSensorAssociationUiSettingsDefaultConfig:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> BulkSensorAssociationUiSettingsDefaultConfig:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> BulkSensorAssociationUiSettingsDefaultConfig:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> BulkSensorAssociationUiSettingsDefaultConfig:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> BulkSensorAssociationUiSettingsDefaultConfig:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> BulkSensorAssociationUiSettingsDefaultConfig:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> BulkSensorAssociationUiSettingsDefaultConfig:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> BulkSensorAssociationUiSettingsDefaultConfig:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> BulkSensorAssociationUiSettingsDefaultConfig:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> BulkSensorAssociationUiSettingsDefaultConfig:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> BulkSensorAssociationUiSettingsDefaultConfig:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> BulkSensorAssociationUiSettingsDefaultConfig:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> BulkSensorAssociationUiSettingsDefaultConfig:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> BulkSensorAssociationUiSettingsDefaultConfig:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[BulkSensorAssociationUiSettingsDefaultConfig]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[BulkSensorAssociationUiSettingsDefaultConfig]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[BulkSensorAssociationUiSettingsDefaultConfig]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[BulkSensorAssociationUiSettingsDefaultConfig]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[BulkSensorAssociationUiSettingsDefaultConfig]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, BulkSensorAssociationUiSettingsDefaultConfig]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, BulkSensorAssociationUiSettingsDefaultConfig]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[BulkSensorAssociationUiSettingsDefaultConfig]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[BulkSensorAssociationUiSettingsDefaultConfig]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> BulkSensorAssociationUiSettingsDefaultConfig:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> BulkSensorAssociationUiSettingsDefaultConfig:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> BulkSensorAssociationUiSettingsDefaultConfig:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> BulkSensorAssociationUiSettingsDefaultConfig:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> BulkSensorAssociationUiSettingsDefaultConfig:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> BulkSensorAssociationUiSettingsDefaultConfig:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> BulkSensorAssociationUiSettingsDefaultConfig:
    """
    ...
    """
        ...
    def afterMake(self) -> BulkSensorAssociationUiSettingsDefaultConfig:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> BulkSensorAssociationUiSettingsDefaultConfig:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[BulkSensorAssociationUiSettingsDefaultConfig]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> BulkSensorAssociationUiSettingsDefaultConfig:
    """
    ...
    """
        ...
    @classmethod
    def inst(cls) -> BulkSensorAssociationUiSettingsDefaultConfig:
    """
    @return the one and only instance to be used when member functions are called on this type.
    """
        ...
    @classmethod
    def cachedInst(cls) -> Union[BulkSensorAssociationUiSettingsDefaultConfig]:
    """
    ...
    """
        ...
    @classmethod
    def allCached(cls, doNotProduceAll: bool=None) -> Union[Stream[BulkSensorAssociationUiSettingsDefaultConfig]]:
    """
    ...
    """
        ...
    @classmethod
    def find(cls, filter: str=None, doNotProduceAll: bool=None) -> Union[Stream[BulkSensorAssociationUiSettingsDefaultConfig]]:
    """
    ...
    """
        ...
    @classmethod
    def findBy(cls, field: str, value: Any, doNotProduceAll: bool=None) -> Union[Stream[BulkSensorAssociationUiSettingsDefaultConfig]]:
    """
    @param doNotProduceAll if true, will not populate cache and only return available cached instances. Will call
           `produceAll` if cache is empty or if Ann.cache.all is true & data has not previously been fetched.
    @return existing instances of this type that satisfy filter from data cache.
    """
        ...
    @classmethod
    def findByCacheKey(cls, key: str) -> Union[BulkSensorAssociationUiSettingsDefaultConfig]:
    """
    ...
    """
        ...
    @classmethod
    def forCacheKey(cls, key: str) -> Union[BulkSensorAssociationUiSettingsDefaultConfig]:
    """
    Returns cached instance by key, with secrets removed.
    """
        ...
    def getCached(self) -> Union[BulkSensorAssociationUiSettingsDefaultConfig]:
    """
    ...
    """
        ...
    def refreshCache(self) -> Union[BulkSensorAssociationUiSettingsDefaultConfig]:
    """
    ...
    """
        ...
    @classmethod
    def produce(cls, key: str) -> Union[BulkSensorAssociationUiSettingsDefaultConfig]:
    """
    Should produce an entry for the cache key. This method should not be called directly.
    """
        ...
    @classmethod
    def produceAll(cls) -> Union[Map[str, BulkSensorAssociationUiSettingsDefaultConfig]]:
    """
    ...
    """
        ...
    @classmethod
    def doProduceAll(cls) -> Union[Map[str, BulkSensorAssociationUiSettingsDefaultConfig]]:
    """
    ...
    """
        ...
    def getConfig(self) -> BulkSensorAssociationUiSettingsDefaultConfig:
    """
    ...
    """
        ...
    def getSecret(self) -> BulkSensorAssociationUiSettingsDefaultConfig:
    """
    ...
    """
        ...
    def withConfigKey(self, configKey: str) -> BulkSensorAssociationUiSettingsDefaultConfig:
    """
    ...
    """
        ...
    def withoutConfigKey(self) -> BulkSensorAssociationUiSettingsDefaultConfig:
    """
    @return copy without config key.
    """
        ...
    @classmethod
    def forConfigKey(cls, configKey: str) -> Union[BulkSensorAssociationUiSettingsDefaultConfig]:
    """
    ...
    """
        ...
    @classmethod
    def listConfigs(cls, parallel: bool=None, filter: Callable[[str], bool]=None) -> Union[Stream[BulkSensorAssociationUiSettingsDefaultConfig]]:
    """
    @param
    ...
    """
        ...
    @overload
    def setConfigValues(self, from_: BulkSensorAssociationUiSettingsDefaultConfig, override: str=None) -> None:
    """
    ...
    """
        ...
    @overload
    def setSecretValues(self, from_: BulkSensorAssociationUiSettingsDefaultConfig, override: str=None) -> None:
    """
    ...
    """
        ...
    @classmethod
    def loadConfigAndSecret(cls, configKey: str) -> Union[BulkSensorAssociationUiSettingsDefaultConfig]:
    """
    ...
    """
        ...
    def removeSecrets(self) -> Union[BulkSensorAssociationUiSettingsDefaultConfig]:
    """
    @return this config without any secret values.
    """
        ...
    def removeNonSecrets(self) -> Union[BulkSensorAssociationUiSettingsDefaultConfig]:
    """
    @return this config with only secret values.
    """
        ...
    def validate(self) -> BulkSensorAssociationUiSettingsDefaultConfig:
    """
