...
# Python definitions for the C3 type SparePartsForecastChart


class SparePartsForecastChart(UiSdlTimeseriesLineBarChart):
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[SparePartsForecastChart]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[SparePartsForecastChart]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[SparePartsForecastChart]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[SparePartsForecastChart]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> SparePartsForecastChart:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> SparePartsForecastChart:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> SparePartsForecastChart:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[SparePartsForecastChart]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[SparePartsForecastChart]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> SparePartsForecastChart:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> SparePartsForecastChart:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> SparePartsForecastChart:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> SparePartsForecastChart:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> SparePartsForecastChart:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> SparePartsForecastChart:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> SparePartsForecastChart:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> SparePartsForecastChart:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> SparePartsForecastChart:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> SparePartsForecastChart:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> SparePartsForecastChart:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> SparePartsForecastChart:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> SparePartsForecastChart:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> SparePartsForecastChart:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> SparePartsForecastChart:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> SparePartsForecastChart:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> SparePartsForecastChart:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> SparePartsForecastChart:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> SparePartsForecastChart:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> SparePartsForecastChart:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> SparePartsForecastChart:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> SparePartsForecastChart:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> SparePartsForecastChart:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> SparePartsForecastChart:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> SparePartsForecastChart:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> SparePartsForecastChart:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> SparePartsForecastChart:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> SparePartsForecastChart:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[SparePartsForecastChart]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[SparePartsForecastChart]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[SparePartsForecastChart]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[SparePartsForecastChart]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[SparePartsForecastChart]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, SparePartsForecastChart]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, SparePartsForecastChart]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[SparePartsForecastChart]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[SparePartsForecastChart]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> SparePartsForecastChart:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> SparePartsForecastChart:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> SparePartsForecastChart:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> SparePartsForecastChart:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> SparePartsForecastChart:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> SparePartsForecastChart:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[SparePartsForecastChart]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> SparePartsForecastChart:
    """
    ...
    """
        ...
    def afterMake(self) -> SparePartsForecastChart:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> SparePartsForecastChart:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[SparePartsForecastChart]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> SparePartsForecastChart:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, spec: FetchSpec=None) -> FetchResult[SparePartsForecastChart]:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, filter: Filter) -> FetchResult[SparePartsForecastChart]:
    """
    ...
    """
        ...
    @classmethod
    def fetchObjStream(cls, spec: FetchStreamSpec=None) -> Union[Stream[SparePartsForecastChart]]:
    """
    Fetches multiple obj instances based on a specification.  Only objs that the caller is authorized to fetch will be
    returned.
    ...
    """
        ...
    @classmethod
    def fetchMultiLocale(cls, spec: MultiLocaleFetchSpec=None) -> Union[Map[str, FetchResult[SparePartsForecastChart]]]:
    """
    ...
    """
        ...
    def dependencies(self) -> MetadataDeps[SparePartsForecastChart]:
    """
    Retrieves dependencies to types or other metadata elements for the given instance of metadata.
    """
        ...
    def save(self, subPath: str=None, contentType: str=None) -> SparePartsForecastChart:
        ...
    ...
    def removeAll(cls, removeFilter: str=None) -> int:
        ...
    def update(self, srcObj: SparePartsForecastChart=None, spec: UpsertSpec=None) -> Union[SparePartsForecastChart]:
        ...
    def upsert(self, srcObj: SparePartsForecastChart=None, spec: UpsertSpec=None) -> Union[SparePartsForecastChart]:
        ...
    @classmethod
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[SparePartsForecastChart]:
    """
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[SparePartsForecastChart]:
    """
    ...
    def jsonify(cls, value: Any=None) -> Union[str]:
        ...
    @classmethod
    def doDataMerge(cls, componentId: str, dataSpecFieldName: str, dataDestinationFieldName: str, props: SparePartsForecastChart, state: UiSdlReduxState) -> Union[SparePartsForecastChart]:
    """
