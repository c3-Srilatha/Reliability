...
# Python definitions for the C3 type ModelValidationStatus


class ModelValidationStatus():
    """
    ...
    NEEDS_REVISION: Optional[str]=None
    """
    The model has been through a validation check and needs revision.
    """

    WAITING_FOR_REVIEW: Optional[str]=None
    """
    The model is waiting for review.
    """
    def __init__(self, COMPLETE: Optional[str]=None, NEEDS_REVISION: Optional[str]=None, WAITING_FOR_REVIEW: Optional[str]=None) -> None: ...
    ...
    ````
    [
      { value: 'Complete', translatedValue: 'Completado' },
      { value: 'Needs Revision', translatedValue: 'Necesita revisión' },
      { value: 'Waiting for Review', translatedValue: 'Esperando revisión' }
    ]
    ````
    """
        ...
