// TypeScript definitions for the C3 type UiSdlDiagramViewerAddOnDataSpec

/**
 * A specification that describes which addOns (if any) should be included
 * on this diagram.
 *
 * @remarks this represents a value passed to a method that expects an instance of UiSdlDiagramViewerAddOnDataSpec
 */
declare interface IUiSdlDiagramViewerAddOnDataSpec {
 ...
 */
declare class UiSdlDiagramViewerAddOnDataSpec extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlDiagramViewerAddOnDataSpec | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlDiagramViewerAddOnDataSpec | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlDiagramViewerAddOnDataSpec | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlDiagramViewerAddOnDataSpec | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlDiagramViewerAddOnDataSpec;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlDiagramViewerAddOnDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlDiagramViewerAddOnDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlDiagramViewerAddOnDataSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlDiagramViewerAddOnDataSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlDiagramViewerAddOnDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlDiagramViewerAddOnDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlDiagramViewerAddOnDataSpec;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlDiagramViewerAddOnDataSpec;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlDiagramViewerAddOnDataSpec;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlDiagramViewerAddOnDataSpec;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlDiagramViewerAddOnDataSpec;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlDiagramViewerAddOnDataSpec;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlDiagramViewerAddOnDataSpec;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlDiagramViewerAddOnDataSpec;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlDiagramViewerAddOnDataSpec;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlDiagramViewerAddOnDataSpec;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlDiagramViewerAddOnDataSpec;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlDiagramViewerAddOnDataSpec;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlDiagramViewerAddOnDataSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlDiagramViewerAddOnDataSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlDiagramViewerAddOnDataSpec;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlDiagramViewerAddOnDataSpec;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlDiagramViewerAddOnDataSpec;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlDiagramViewerAddOnDataSpec;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlDiagramViewerAddOnDataSpec;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlDiagramViewerAddOnDataSpec;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlDiagramViewerAddOnDataSpec;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlDiagramViewerAddOnDataSpec;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlDiagramViewerAddOnDataSpec;

  mergeJson(json: any | null): UiSdlDiagramViewerAddOnDataSpec;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlDiagramViewerAddOnDataSpec;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlDiagramViewerAddOnDataSpec;
   ...
   */
  singletonArray(): C3.Array<UiSdlDiagramViewerAddOnDataSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlDiagramViewerAddOnDataSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlDiagramViewerAddOnDataSpec | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlDiagramViewerAddOnDataSpec | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlDiagramViewerAddOnDataSpec | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlDiagramViewerAddOnDataSpec | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlDiagramViewerAddOnDataSpec | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlDiagramViewerAddOnDataSpec | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlDiagramViewerAddOnDataSpec | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlDiagramViewerAddOnDataSpec;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlDiagramViewerAddOnDataSpec;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlDiagramViewerAddOnDataSpec;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlDiagramViewerAddOnDataSpec;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlDiagramViewerAddOnDataSpec;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlDiagramViewerAddOnDataSpec;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlDiagramViewerAddOnDataSpec;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): UiSdlDiagramViewerAddOnDataSpec;
   ...
   */
  static cachedEmptyInst(): UiSdlDiagramViewerAddOnDataSpec;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlDiagramViewerAddOnDataSpec>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlDiagramViewerAddOnDataSpec;
   ...
   */
  static getDataTypeName(dataSpec?: UiSdlDiagramViewerAddOnDataSpec | null): string | null;
