// TypeScript definitions for the C3 type UiSdlHeatMap
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of UiSdlHeatMap
 */
declare interface IUiSdlHeatMap {
 ...
 */
declare class UiSdlHeatMap extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlHeatMap | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlHeatMap | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlHeatMap | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlHeatMap | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlHeatMap;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlHeatMap;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlHeatMap;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlHeatMap | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlHeatMap | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlHeatMap;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlHeatMap;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlHeatMap;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlHeatMap;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlHeatMap;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlHeatMap;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlHeatMap;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlHeatMap;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlHeatMap;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlHeatMap;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlHeatMap;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlHeatMap;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlHeatMap;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlHeatMap;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlHeatMap;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlHeatMap;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlHeatMap;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlHeatMap;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlHeatMap;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlHeatMap;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlHeatMap;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlHeatMap;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlHeatMap;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlHeatMap;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlHeatMap;

  mergeJson(json: any | null): UiSdlHeatMap;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlHeatMap;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlHeatMap;
   ...
   */
  singletonArray(): C3.Array<UiSdlHeatMap | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlHeatMap | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlHeatMap | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlHeatMap | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlHeatMap | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlHeatMap | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlHeatMap | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlHeatMap | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlHeatMap | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlHeatMap;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlHeatMap;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlHeatMap;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlHeatMap;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlHeatMap;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlHeatMap;
   ...
   * @see #fromString
   */
  static make(s: string | null): UiSdlHeatMap | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlHeatMap;
   ...
   */
  static cachedEmptyInst(): UiSdlHeatMap;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlHeatMap>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlHeatMap;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<UiSdlHeatMap | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<UiSdlHeatMap | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<UiSdlHeatMap | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<UiSdlHeatMap | null> | null>;
   ...
   */
  dependencies(): MetadataDeps<UiSdlHeatMap | null>;

  save(subPath?: string | null, contentType?: string | null): UiSdlHeatMap;
  ...
  update(srcObj?: UiSdlHeatMap | null, spec?: UpsertSpec | null): UiSdlHeatMap | null;

  upsert(srcObj?: UiSdlHeatMap | null, spec?: UpsertSpec | null): UiSdlHeatMap | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): UiSdlHeatMap | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string | null, failIfMissing?: boolean): UiSdlHeatMap | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: UiSdlHeatMap, state: UiSdlReduxState): UiSdlHeatMap | null;
