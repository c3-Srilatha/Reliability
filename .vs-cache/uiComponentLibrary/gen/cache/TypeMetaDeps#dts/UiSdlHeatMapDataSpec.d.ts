// TypeScript definitions for the C3 type UiSdlHeatMapDataSpec

/**
 * The specification of data retrieval for instances of the {@link UiSdlHeatMap} component type.
 *
 * @remarks this represents a value passed to a method that expects an instance of UiSdlHeatMapDataSpec
 */
declare interface IUiSdlHeatMapDataSpec {
   ...
   */
  dataSettings?: IUiSdlHeatMapDataSpecSetting | null;
}
 ...
 */
declare class UiSdlHeatMapDataSpec extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlHeatMapDataSpec | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlHeatMapDataSpec | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlHeatMapDataSpec | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlHeatMapDataSpec | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlHeatMapDataSpec;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlHeatMapDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlHeatMapDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlHeatMapDataSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlHeatMapDataSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlHeatMapDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlHeatMapDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlHeatMapDataSpec;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlHeatMapDataSpec;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlHeatMapDataSpec;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlHeatMapDataSpec;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlHeatMapDataSpec;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlHeatMapDataSpec;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlHeatMapDataSpec;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlHeatMapDataSpec;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlHeatMapDataSpec;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlHeatMapDataSpec;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlHeatMapDataSpec;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlHeatMapDataSpec;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlHeatMapDataSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlHeatMapDataSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlHeatMapDataSpec;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlHeatMapDataSpec;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlHeatMapDataSpec;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlHeatMapDataSpec;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlHeatMapDataSpec;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlHeatMapDataSpec;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlHeatMapDataSpec;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlHeatMapDataSpec;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlHeatMapDataSpec;

  mergeJson(json: any | null): UiSdlHeatMapDataSpec;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlHeatMapDataSpec;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlHeatMapDataSpec;
   ...
   */
  singletonArray(): C3.Array<UiSdlHeatMapDataSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlHeatMapDataSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlHeatMapDataSpec | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlHeatMapDataSpec | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlHeatMapDataSpec | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlHeatMapDataSpec | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlHeatMapDataSpec | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlHeatMapDataSpec | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlHeatMapDataSpec | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlHeatMapDataSpec;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlHeatMapDataSpec;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlHeatMapDataSpec;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlHeatMapDataSpec;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlHeatMapDataSpec;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlHeatMapDataSpec;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlHeatMapDataSpec;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): UiSdlHeatMapDataSpec;
   ...
   */
  static cachedEmptyInst(): UiSdlHeatMapDataSpec;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlHeatMapDataSpec>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlHeatMapDataSpec;
   ...
   */
  static getDataTypeName(dataSpec?: UiSdlHeatMapDataSpec | null): string | null;
   ...
   */
  static getStartDate(date?: string | null, interval?: string | null): string | null;
}
