// TypeScript definitions for the C3 type UiSdlDiagramViewerAddOnBoxGroupDataSpec
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of UiSdlDiagramViewerAddOnBoxGroupDataSpec
 */
declare interface IUiSdlDiagramViewerAddOnBoxGroupDataSpec {
   ...
   */
  xPos: IUiSdlFieldBasedDataSpecSetting;

  /**
   * The specification for y positioning of the addOn.
   */
  yPos: IUiSdlFieldBasedDataSpecSetting;

  /**
   * The specification for color of the addOn.
   */
  color?: IUiSdlFieldBasedDataSpecSetting | null | string | null | null;
   ...
   */
  legendLabel?: string | null | IUiSdlDynamicValueSpec | null | IUiSdlFieldBasedDataSpecSetting | null | null;

  /**
   * Specifications for this group of addOn's tooltip
   */
  tooltip?: IUiSdlDiagramViewerTooltip | null;

  /**
   * The setting to get heights for the rectangles
   */
  height?: IUiSdlFieldBasedDataSpecSetting | null;

  /**
   * The setting to get widths for the rectangles
   */
  width?: IUiSdlFieldBasedDataSpecSetting | null;

  /**
   * The setting to get border colors for the rectangles
   */
  borderColor?: IUiSdlFieldBasedDataSpecSetting | null | string | null | null;
}
 ...
 */
declare class UiSdlDiagramViewerAddOnBoxGroupDataSpec extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlDiagramViewerAddOnBoxGroupDataSpec | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlDiagramViewerAddOnBoxGroupDataSpec | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlDiagramViewerAddOnBoxGroupDataSpec | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlDiagramViewerAddOnBoxGroupDataSpec | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlDiagramViewerAddOnBoxGroupDataSpec;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlDiagramViewerAddOnBoxGroupDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlDiagramViewerAddOnBoxGroupDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlDiagramViewerAddOnBoxGroupDataSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlDiagramViewerAddOnBoxGroupDataSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlDiagramViewerAddOnBoxGroupDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlDiagramViewerAddOnBoxGroupDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlDiagramViewerAddOnBoxGroupDataSpec;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlDiagramViewerAddOnBoxGroupDataSpec;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlDiagramViewerAddOnBoxGroupDataSpec;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlDiagramViewerAddOnBoxGroupDataSpec;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlDiagramViewerAddOnBoxGroupDataSpec;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlDiagramViewerAddOnBoxGroupDataSpec;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlDiagramViewerAddOnBoxGroupDataSpec;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlDiagramViewerAddOnBoxGroupDataSpec;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlDiagramViewerAddOnBoxGroupDataSpec;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlDiagramViewerAddOnBoxGroupDataSpec;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlDiagramViewerAddOnBoxGroupDataSpec;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlDiagramViewerAddOnBoxGroupDataSpec;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlDiagramViewerAddOnBoxGroupDataSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlDiagramViewerAddOnBoxGroupDataSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlDiagramViewerAddOnBoxGroupDataSpec;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlDiagramViewerAddOnBoxGroupDataSpec;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlDiagramViewerAddOnBoxGroupDataSpec;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlDiagramViewerAddOnBoxGroupDataSpec;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlDiagramViewerAddOnBoxGroupDataSpec;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlDiagramViewerAddOnBoxGroupDataSpec;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlDiagramViewerAddOnBoxGroupDataSpec;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlDiagramViewerAddOnBoxGroupDataSpec;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlDiagramViewerAddOnBoxGroupDataSpec;

  mergeJson(json: any | null): UiSdlDiagramViewerAddOnBoxGroupDataSpec;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlDiagramViewerAddOnBoxGroupDataSpec;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlDiagramViewerAddOnBoxGroupDataSpec;
   ...
   */
  singletonArray(): C3.Array<UiSdlDiagramViewerAddOnBoxGroupDataSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlDiagramViewerAddOnBoxGroupDataSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlDiagramViewerAddOnBoxGroupDataSpec | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlDiagramViewerAddOnBoxGroupDataSpec | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlDiagramViewerAddOnBoxGroupDataSpec | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlDiagramViewerAddOnBoxGroupDataSpec | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlDiagramViewerAddOnBoxGroupDataSpec | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlDiagramViewerAddOnBoxGroupDataSpec | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlDiagramViewerAddOnBoxGroupDataSpec | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlDiagramViewerAddOnBoxGroupDataSpec;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlDiagramViewerAddOnBoxGroupDataSpec;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlDiagramViewerAddOnBoxGroupDataSpec;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlDiagramViewerAddOnBoxGroupDataSpec;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlDiagramViewerAddOnBoxGroupDataSpec;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlDiagramViewerAddOnBoxGroupDataSpec;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlDiagramViewerAddOnBoxGroupDataSpec;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): UiSdlDiagramViewerAddOnBoxGroupDataSpec;
   ...
   */
  static cachedEmptyInst(): UiSdlDiagramViewerAddOnBoxGroupDataSpec;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlDiagramViewerAddOnBoxGroupDataSpec>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlDiagramViewerAddOnBoxGroupDataSpec;
   ...
   */
  static getDataTypeName(dataSpec?: UiSdlDiagramViewerAddOnBoxGroupDataSpec | null): string | null;
