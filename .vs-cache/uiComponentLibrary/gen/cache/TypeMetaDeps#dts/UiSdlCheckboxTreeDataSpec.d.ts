// TypeScript definitions for the C3 type UiSdlCheckboxTreeDataSpec

/**
 * The specification of data retrieval for instances of the {@link UiSdlCheckboxTree} component type.
 *
 * @remarks this represents a value passed to a method that expects an instance of UiSdlCheckboxTreeDataSpec
 */
declare interface IUiSdlCheckboxTreeDataSpec {
 ...
 */
declare class UiSdlCheckboxTreeDataSpec extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlCheckboxTreeDataSpec | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlCheckboxTreeDataSpec | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlCheckboxTreeDataSpec | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlCheckboxTreeDataSpec | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlCheckboxTreeDataSpec;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlCheckboxTreeDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlCheckboxTreeDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlCheckboxTreeDataSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlCheckboxTreeDataSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlCheckboxTreeDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlCheckboxTreeDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlCheckboxTreeDataSpec;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlCheckboxTreeDataSpec;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlCheckboxTreeDataSpec;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlCheckboxTreeDataSpec;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlCheckboxTreeDataSpec;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlCheckboxTreeDataSpec;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlCheckboxTreeDataSpec;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlCheckboxTreeDataSpec;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlCheckboxTreeDataSpec;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlCheckboxTreeDataSpec;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlCheckboxTreeDataSpec;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlCheckboxTreeDataSpec;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlCheckboxTreeDataSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlCheckboxTreeDataSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlCheckboxTreeDataSpec;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlCheckboxTreeDataSpec;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlCheckboxTreeDataSpec;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlCheckboxTreeDataSpec;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlCheckboxTreeDataSpec;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlCheckboxTreeDataSpec;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlCheckboxTreeDataSpec;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlCheckboxTreeDataSpec;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlCheckboxTreeDataSpec;

  mergeJson(json: any | null): UiSdlCheckboxTreeDataSpec;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlCheckboxTreeDataSpec;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlCheckboxTreeDataSpec;
   ...
   */
  singletonArray(): C3.Array<UiSdlCheckboxTreeDataSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlCheckboxTreeDataSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlCheckboxTreeDataSpec | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlCheckboxTreeDataSpec | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlCheckboxTreeDataSpec | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlCheckboxTreeDataSpec | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlCheckboxTreeDataSpec | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlCheckboxTreeDataSpec | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlCheckboxTreeDataSpec | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlCheckboxTreeDataSpec;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlCheckboxTreeDataSpec;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlCheckboxTreeDataSpec;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlCheckboxTreeDataSpec;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlCheckboxTreeDataSpec;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlCheckboxTreeDataSpec;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlCheckboxTreeDataSpec;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): UiSdlCheckboxTreeDataSpec;
   ...
   */
  static cachedEmptyInst(): UiSdlCheckboxTreeDataSpec;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlCheckboxTreeDataSpec>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlCheckboxTreeDataSpec;
   ...
   */
  static getDataTypeName(dataSpec?: UiSdlCheckboxTreeDataSpec | null): string | null;
