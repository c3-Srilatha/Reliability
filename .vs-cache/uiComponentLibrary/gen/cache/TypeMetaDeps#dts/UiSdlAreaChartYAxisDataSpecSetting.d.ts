// TypeScript definitions for the C3 type UiSdlAreaChartYAxisDataSpecSetting

/**
 * The specification of data retrieval for instances of the {@link UiSdlAreaChart} component type.
 *
 * @remarks this represents a value passed to a method that expects an instance of UiSdlAreaChartYAxisDataSpecSetting
 */
declare interface IUiSdlAreaChartYAxisDataSpecSetting {
 ...
 */
declare class UiSdlAreaChartYAxisDataSpecSetting extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlAreaChartYAxisDataSpecSetting | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlAreaChartYAxisDataSpecSetting | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlAreaChartYAxisDataSpecSetting | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlAreaChartYAxisDataSpecSetting | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlAreaChartYAxisDataSpecSetting;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlAreaChartYAxisDataSpecSetting;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlAreaChartYAxisDataSpecSetting;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlAreaChartYAxisDataSpecSetting | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlAreaChartYAxisDataSpecSetting | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlAreaChartYAxisDataSpecSetting;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlAreaChartYAxisDataSpecSetting;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlAreaChartYAxisDataSpecSetting;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlAreaChartYAxisDataSpecSetting;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlAreaChartYAxisDataSpecSetting;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlAreaChartYAxisDataSpecSetting;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlAreaChartYAxisDataSpecSetting;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlAreaChartYAxisDataSpecSetting;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlAreaChartYAxisDataSpecSetting;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlAreaChartYAxisDataSpecSetting;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlAreaChartYAxisDataSpecSetting;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlAreaChartYAxisDataSpecSetting;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlAreaChartYAxisDataSpecSetting;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlAreaChartYAxisDataSpecSetting;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlAreaChartYAxisDataSpecSetting;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlAreaChartYAxisDataSpecSetting;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlAreaChartYAxisDataSpecSetting;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlAreaChartYAxisDataSpecSetting;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlAreaChartYAxisDataSpecSetting;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlAreaChartYAxisDataSpecSetting;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlAreaChartYAxisDataSpecSetting;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlAreaChartYAxisDataSpecSetting;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlAreaChartYAxisDataSpecSetting;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlAreaChartYAxisDataSpecSetting;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlAreaChartYAxisDataSpecSetting;

  mergeJson(json: any | null): UiSdlAreaChartYAxisDataSpecSetting;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlAreaChartYAxisDataSpecSetting;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlAreaChartYAxisDataSpecSetting;
   ...
   */
  singletonArray(): C3.Array<UiSdlAreaChartYAxisDataSpecSetting | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlAreaChartYAxisDataSpecSetting | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlAreaChartYAxisDataSpecSetting | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlAreaChartYAxisDataSpecSetting | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlAreaChartYAxisDataSpecSetting | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlAreaChartYAxisDataSpecSetting | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlAreaChartYAxisDataSpecSetting | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlAreaChartYAxisDataSpecSetting | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlAreaChartYAxisDataSpecSetting | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlAreaChartYAxisDataSpecSetting;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlAreaChartYAxisDataSpecSetting;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlAreaChartYAxisDataSpecSetting;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlAreaChartYAxisDataSpecSetting;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlAreaChartYAxisDataSpecSetting;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlAreaChartYAxisDataSpecSetting;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlAreaChartYAxisDataSpecSetting;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): UiSdlAreaChartYAxisDataSpecSetting;
   ...
   */
  static cachedEmptyInst(): UiSdlAreaChartYAxisDataSpecSetting;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlAreaChartYAxisDataSpecSetting>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlAreaChartYAxisDataSpecSetting;
