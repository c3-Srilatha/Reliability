// TypeScript definitions for the C3 type UiSdlDiagramViewerAddOnDotGroupDataSpec
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of UiSdlDiagramViewerAddOnDotGroupDataSpec
 */
declare interface IUiSdlDiagramViewerAddOnDotGroupDataSpec {
   ...
   */
  radius?: IUiSdlFieldBasedDataSpecSetting | null;
}
 ...
 */
declare class UiSdlDiagramViewerAddOnDotGroupDataSpec extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlDiagramViewerAddOnDotGroupDataSpec | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlDiagramViewerAddOnDotGroupDataSpec | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlDiagramViewerAddOnDotGroupDataSpec | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlDiagramViewerAddOnDotGroupDataSpec | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlDiagramViewerAddOnDotGroupDataSpec;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlDiagramViewerAddOnDotGroupDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlDiagramViewerAddOnDotGroupDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlDiagramViewerAddOnDotGroupDataSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlDiagramViewerAddOnDotGroupDataSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlDiagramViewerAddOnDotGroupDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlDiagramViewerAddOnDotGroupDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlDiagramViewerAddOnDotGroupDataSpec;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlDiagramViewerAddOnDotGroupDataSpec;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlDiagramViewerAddOnDotGroupDataSpec;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlDiagramViewerAddOnDotGroupDataSpec;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlDiagramViewerAddOnDotGroupDataSpec;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlDiagramViewerAddOnDotGroupDataSpec;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlDiagramViewerAddOnDotGroupDataSpec;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlDiagramViewerAddOnDotGroupDataSpec;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlDiagramViewerAddOnDotGroupDataSpec;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlDiagramViewerAddOnDotGroupDataSpec;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlDiagramViewerAddOnDotGroupDataSpec;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlDiagramViewerAddOnDotGroupDataSpec;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlDiagramViewerAddOnDotGroupDataSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlDiagramViewerAddOnDotGroupDataSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlDiagramViewerAddOnDotGroupDataSpec;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlDiagramViewerAddOnDotGroupDataSpec;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlDiagramViewerAddOnDotGroupDataSpec;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlDiagramViewerAddOnDotGroupDataSpec;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlDiagramViewerAddOnDotGroupDataSpec;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlDiagramViewerAddOnDotGroupDataSpec;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlDiagramViewerAddOnDotGroupDataSpec;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlDiagramViewerAddOnDotGroupDataSpec;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlDiagramViewerAddOnDotGroupDataSpec;

  mergeJson(json: any | null): UiSdlDiagramViewerAddOnDotGroupDataSpec;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlDiagramViewerAddOnDotGroupDataSpec;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlDiagramViewerAddOnDotGroupDataSpec;
   ...
   */
  singletonArray(): C3.Array<UiSdlDiagramViewerAddOnDotGroupDataSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlDiagramViewerAddOnDotGroupDataSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlDiagramViewerAddOnDotGroupDataSpec | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlDiagramViewerAddOnDotGroupDataSpec | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlDiagramViewerAddOnDotGroupDataSpec | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlDiagramViewerAddOnDotGroupDataSpec | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlDiagramViewerAddOnDotGroupDataSpec | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlDiagramViewerAddOnDotGroupDataSpec | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlDiagramViewerAddOnDotGroupDataSpec | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlDiagramViewerAddOnDotGroupDataSpec;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlDiagramViewerAddOnDotGroupDataSpec;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlDiagramViewerAddOnDotGroupDataSpec;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlDiagramViewerAddOnDotGroupDataSpec;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlDiagramViewerAddOnDotGroupDataSpec;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlDiagramViewerAddOnDotGroupDataSpec;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlDiagramViewerAddOnDotGroupDataSpec;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): UiSdlDiagramViewerAddOnDotGroupDataSpec;
   ...
   */
  static cachedEmptyInst(): UiSdlDiagramViewerAddOnDotGroupDataSpec;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlDiagramViewerAddOnDotGroupDataSpec>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlDiagramViewerAddOnDotGroupDataSpec;
   ...
   */
  static getDataTypeName(dataSpec?: UiSdlDiagramViewerAddOnDotGroupDataSpec | null): string | null;
