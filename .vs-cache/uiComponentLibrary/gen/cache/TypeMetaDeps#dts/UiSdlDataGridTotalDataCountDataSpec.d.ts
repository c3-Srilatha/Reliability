// TypeScript definitions for the C3 type UiSdlDataGridTotalDataCountDataSpec
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of UiSdlDataGridTotalDataCountDataSpec
 */
declare interface IUiSdlDataGridTotalDataCountDataSpec {
   ...
   */
  columnFields?: C3.Array<UiSdlBaseDataGridDataSpecColumnFieldSetting | null> | Array<IUiSdlBaseDataGridDataSpecColumnFieldSetting | null>;
 ...
 */
declare class UiSdlDataGridTotalDataCountDataSpec extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlDataGridTotalDataCountDataSpec | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlDataGridTotalDataCountDataSpec | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlDataGridTotalDataCountDataSpec | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlDataGridTotalDataCountDataSpec | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlDataGridTotalDataCountDataSpec;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlDataGridTotalDataCountDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlDataGridTotalDataCountDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlDataGridTotalDataCountDataSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlDataGridTotalDataCountDataSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlDataGridTotalDataCountDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlDataGridTotalDataCountDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlDataGridTotalDataCountDataSpec;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlDataGridTotalDataCountDataSpec;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlDataGridTotalDataCountDataSpec;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlDataGridTotalDataCountDataSpec;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlDataGridTotalDataCountDataSpec;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlDataGridTotalDataCountDataSpec;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlDataGridTotalDataCountDataSpec;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlDataGridTotalDataCountDataSpec;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlDataGridTotalDataCountDataSpec;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlDataGridTotalDataCountDataSpec;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlDataGridTotalDataCountDataSpec;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlDataGridTotalDataCountDataSpec;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlDataGridTotalDataCountDataSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlDataGridTotalDataCountDataSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlDataGridTotalDataCountDataSpec;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlDataGridTotalDataCountDataSpec;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlDataGridTotalDataCountDataSpec;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlDataGridTotalDataCountDataSpec;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlDataGridTotalDataCountDataSpec;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlDataGridTotalDataCountDataSpec;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlDataGridTotalDataCountDataSpec;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlDataGridTotalDataCountDataSpec;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlDataGridTotalDataCountDataSpec;

  mergeJson(json: any | null): UiSdlDataGridTotalDataCountDataSpec;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlDataGridTotalDataCountDataSpec;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlDataGridTotalDataCountDataSpec;
   ...
   */
  singletonArray(): C3.Array<UiSdlDataGridTotalDataCountDataSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlDataGridTotalDataCountDataSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlDataGridTotalDataCountDataSpec | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlDataGridTotalDataCountDataSpec | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlDataGridTotalDataCountDataSpec | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlDataGridTotalDataCountDataSpec | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlDataGridTotalDataCountDataSpec | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlDataGridTotalDataCountDataSpec | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlDataGridTotalDataCountDataSpec | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlDataGridTotalDataCountDataSpec;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlDataGridTotalDataCountDataSpec;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlDataGridTotalDataCountDataSpec;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlDataGridTotalDataCountDataSpec;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlDataGridTotalDataCountDataSpec;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlDataGridTotalDataCountDataSpec;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlDataGridTotalDataCountDataSpec;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): UiSdlDataGridTotalDataCountDataSpec;
   ...
   */
  static cachedEmptyInst(): UiSdlDataGridTotalDataCountDataSpec;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlDataGridTotalDataCountDataSpec>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlDataGridTotalDataCountDataSpec;
   ...
   */
  static getDataTypeName(dataSpec?: UiSdlDataGridTotalDataCountDataSpec | null): string | null;
