// TypeScript definitions for the C3 type UiSdlCollectionListDataSpec

/**
 * The specification of data retrieval for instances of the {@link UiSdlCollectionList} component type.
 *
 * @remarks this represents a value passed to a method that expects an instance of UiSdlCollectionListDataSpec
 */
declare interface IUiSdlCollectionListDataSpec {
   ...
   */
  primaryValueField?: IUiSdlCollectionListDataSpecSetting | null;

  /**
   * Secondary value for list item.
   */
  secondaryValueField?: IUiSdlCollectionListDataSpecSetting | null;

  /**
   * Configuration for the collection list value bar.
   */
  valueBarConfig?: IUiSdlCollectionListDataSpecValueBarSetting | null;

  /**
   * Configuration for the collection list item icon.
   */
  iconConfig?: IUiSdlCollectionListDataSpecIconSetting | null;
 ...
 */
declare class UiSdlCollectionListDataSpec extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlCollectionListDataSpec | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlCollectionListDataSpec | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlCollectionListDataSpec | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlCollectionListDataSpec | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlCollectionListDataSpec;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlCollectionListDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlCollectionListDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlCollectionListDataSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlCollectionListDataSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlCollectionListDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlCollectionListDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlCollectionListDataSpec;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlCollectionListDataSpec;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlCollectionListDataSpec;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlCollectionListDataSpec;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlCollectionListDataSpec;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlCollectionListDataSpec;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlCollectionListDataSpec;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlCollectionListDataSpec;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlCollectionListDataSpec;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlCollectionListDataSpec;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlCollectionListDataSpec;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlCollectionListDataSpec;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlCollectionListDataSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlCollectionListDataSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlCollectionListDataSpec;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlCollectionListDataSpec;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlCollectionListDataSpec;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlCollectionListDataSpec;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlCollectionListDataSpec;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlCollectionListDataSpec;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlCollectionListDataSpec;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlCollectionListDataSpec;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlCollectionListDataSpec;

  mergeJson(json: any | null): UiSdlCollectionListDataSpec;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlCollectionListDataSpec;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlCollectionListDataSpec;
   ...
   */
  singletonArray(): C3.Array<UiSdlCollectionListDataSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlCollectionListDataSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlCollectionListDataSpec | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlCollectionListDataSpec | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlCollectionListDataSpec | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlCollectionListDataSpec | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlCollectionListDataSpec | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlCollectionListDataSpec | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlCollectionListDataSpec | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlCollectionListDataSpec;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlCollectionListDataSpec;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlCollectionListDataSpec;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlCollectionListDataSpec;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlCollectionListDataSpec;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlCollectionListDataSpec;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlCollectionListDataSpec;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): UiSdlCollectionListDataSpec;
   ...
   */
  static cachedEmptyInst(): UiSdlCollectionListDataSpec;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlCollectionListDataSpec>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlCollectionListDataSpec;
   ...
   */
  static getDataTypeName(dataSpec?: UiSdlCollectionListDataSpec | null): string | null;
