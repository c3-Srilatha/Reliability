// TypeScript definitions for the C3 type LukeTestUiSdlNavMenu

/**
 * Representation of the {@link UiSdlNavMenu} component for testing purposes.
 *
 * @remarks this represents a value passed to a method that expects an instance of LukeTestUiSdlNavMenu
 */
declare interface ILukeTestUiSdlNavMenu {
   ...
   */
  footerMenuSelector?: string | null;
   ...
   */
  subMenuCollapseButtonSelector?: string | null;
}
 ...
 */
declare class LukeTestUiSdlNavMenu extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): LukeTestUiSdlNavMenu | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): LukeTestUiSdlNavMenu | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): LukeTestUiSdlNavMenu | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): LukeTestUiSdlNavMenu | null;
   ...
   */
  replaceType(old: Type, new_: Type): LukeTestUiSdlNavMenu;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): LukeTestUiSdlNavMenu;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): LukeTestUiSdlNavMenu;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<LukeTestUiSdlNavMenu | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<LukeTestUiSdlNavMenu | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): LukeTestUiSdlNavMenu;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): LukeTestUiSdlNavMenu;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): LukeTestUiSdlNavMenu;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): LukeTestUiSdlNavMenu;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): LukeTestUiSdlNavMenu;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): LukeTestUiSdlNavMenu;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): LukeTestUiSdlNavMenu;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): LukeTestUiSdlNavMenu;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): LukeTestUiSdlNavMenu;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): LukeTestUiSdlNavMenu;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): LukeTestUiSdlNavMenu;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): LukeTestUiSdlNavMenu;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): LukeTestUiSdlNavMenu;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): LukeTestUiSdlNavMenu;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): LukeTestUiSdlNavMenu;
   ...
   * @see #unsetField
   */
  defaultField(field: string): LukeTestUiSdlNavMenu;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): LukeTestUiSdlNavMenu;
   ...
   * @see #removeField
   */
  unsetField(field: string): LukeTestUiSdlNavMenu;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): LukeTestUiSdlNavMenu;
   ...
   * @see #unsetField
   */
  removeField(field: string): LukeTestUiSdlNavMenu;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): LukeTestUiSdlNavMenu;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): LukeTestUiSdlNavMenu;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): LukeTestUiSdlNavMenu;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): LukeTestUiSdlNavMenu;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): LukeTestUiSdlNavMenu;

  mergeJson(json: any | null): LukeTestUiSdlNavMenu;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): LukeTestUiSdlNavMenu;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): LukeTestUiSdlNavMenu;
   ...
   */
  singletonArray(): C3.Array<LukeTestUiSdlNavMenu | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<LukeTestUiSdlNavMenu | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<LukeTestUiSdlNavMenu | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<LukeTestUiSdlNavMenu | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<LukeTestUiSdlNavMenu | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, LukeTestUiSdlNavMenu | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, LukeTestUiSdlNavMenu | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<LukeTestUiSdlNavMenu | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<LukeTestUiSdlNavMenu | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): LukeTestUiSdlNavMenu;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): LukeTestUiSdlNavMenu;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): LukeTestUiSdlNavMenu;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): LukeTestUiSdlNavMenu;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): LukeTestUiSdlNavMenu;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): LukeTestUiSdlNavMenu;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): LukeTestUiSdlNavMenu;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): LukeTestUiSdlNavMenu;
   ...
   */
  static cachedEmptyInst(): LukeTestUiSdlNavMenu;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<LukeTestUiSdlNavMenu>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): LukeTestUiSdlNavMenu;
   ...
   */
  clickMenuItem(menuItemText: string, timeout?: number | null): LukeAsyncQueueNode | null;
   ...
   * item elements.
   */
  getMainMenuItems(timeout?: number | null): LukeAsyncQueueNode | null;
   ...
   */
  getMainMenuActiveMenuItem(): LukeWebElement<any> | null;
   ...
   */
  getSubMenuActiveMenuItem(subMenuType?: string | null): LukeWebElement<any> | null;
}
