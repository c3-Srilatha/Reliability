// TypeScript definitions for the C3 type UiSdlScatterPlotDataSpec
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of UiSdlScatterPlotDataSpec
 */
declare interface IUiSdlScatterPlotDataSpec {
   ...
   */
  xAxisField?: IUiSdlScatterPlotDataSpecFieldSetting | null;

  /**
   * The field on the data type that maps to the yAxis.
   */
  yAxisField?: IUiSdlScatterPlotDataSpecFieldSetting | null;

  /**
   * The field on the data type that maps to the size.
   */
  size?: IUiSdlScatterPlotSizeSetting | null;

  /**
   * The field on the data type that maps to the size.
   */
  tooltipHeader?: IUiSdlScatterPlotDataSpecFieldSetting | null;

  /**
   * The field on the data type that maps to the category.
   */
  category?: IUiSdlScatterPlotCategoryFieldSetting | null;

  /**
   * The field on the data type that maps to the tooltip.
   */
  tooltipAdditionalFields?: C3.Array<UiSdlScatterPlotDataSpecFieldSetting | null> | Array<IUiSdlScatterPlotDataSpecFieldSetting | null>;
}
 ...
 */
declare class UiSdlScatterPlotDataSpec extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlScatterPlotDataSpec | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlScatterPlotDataSpec | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlScatterPlotDataSpec | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlScatterPlotDataSpec | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlScatterPlotDataSpec;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlScatterPlotDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlScatterPlotDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlScatterPlotDataSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlScatterPlotDataSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlScatterPlotDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlScatterPlotDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlScatterPlotDataSpec;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlScatterPlotDataSpec;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlScatterPlotDataSpec;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlScatterPlotDataSpec;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlScatterPlotDataSpec;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlScatterPlotDataSpec;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlScatterPlotDataSpec;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlScatterPlotDataSpec;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlScatterPlotDataSpec;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlScatterPlotDataSpec;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlScatterPlotDataSpec;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlScatterPlotDataSpec;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlScatterPlotDataSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlScatterPlotDataSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlScatterPlotDataSpec;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlScatterPlotDataSpec;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlScatterPlotDataSpec;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlScatterPlotDataSpec;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlScatterPlotDataSpec;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlScatterPlotDataSpec;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlScatterPlotDataSpec;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlScatterPlotDataSpec;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlScatterPlotDataSpec;

  mergeJson(json: any | null): UiSdlScatterPlotDataSpec;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlScatterPlotDataSpec;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlScatterPlotDataSpec;
   ...
   */
  singletonArray(): C3.Array<UiSdlScatterPlotDataSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlScatterPlotDataSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlScatterPlotDataSpec | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlScatterPlotDataSpec | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlScatterPlotDataSpec | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlScatterPlotDataSpec | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlScatterPlotDataSpec | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlScatterPlotDataSpec | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlScatterPlotDataSpec | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlScatterPlotDataSpec;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlScatterPlotDataSpec;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlScatterPlotDataSpec;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlScatterPlotDataSpec;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlScatterPlotDataSpec;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlScatterPlotDataSpec;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlScatterPlotDataSpec;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): UiSdlScatterPlotDataSpec;
   ...
   */
  static cachedEmptyInst(): UiSdlScatterPlotDataSpec;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlScatterPlotDataSpec>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlScatterPlotDataSpec;
   ...
   */
  static getDataTypeName(dataSpec?: UiSdlScatterPlotDataSpec | null): string | null;
