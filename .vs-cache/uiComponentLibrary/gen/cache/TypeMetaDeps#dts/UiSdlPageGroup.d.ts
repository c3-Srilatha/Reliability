// TypeScript definitions for the C3 type UiSdlPageGroup

/**
 * Type to represent the a top-level menu item that has a sub menu in {@link UiSdlNavMenu}.
 *
 * @remarks this represents a value passed to a method that expects an instance of UiSdlPageGroup
 */
declare interface IUiSdlPageGroup {
   ...
   */
  pages?: C3.Array<UiSdlPage | null> | Array<IUiSdlPage | null>;
}
 ...
 */
declare class UiSdlPageGroup extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlPageGroup | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlPageGroup | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlPageGroup | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlPageGroup | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlPageGroup;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlPageGroup;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlPageGroup;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlPageGroup | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlPageGroup | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlPageGroup;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlPageGroup;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlPageGroup;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlPageGroup;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlPageGroup;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlPageGroup;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlPageGroup;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlPageGroup;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlPageGroup;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlPageGroup;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlPageGroup;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlPageGroup;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlPageGroup;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlPageGroup;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlPageGroup;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlPageGroup;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlPageGroup;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlPageGroup;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlPageGroup;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlPageGroup;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlPageGroup;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlPageGroup;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlPageGroup;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlPageGroup;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlPageGroup;

  mergeJson(json: any | null): UiSdlPageGroup;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlPageGroup;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlPageGroup;
   ...
   */
  singletonArray(): C3.Array<UiSdlPageGroup | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlPageGroup | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlPageGroup | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlPageGroup | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlPageGroup | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlPageGroup | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlPageGroup | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlPageGroup | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlPageGroup | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlPageGroup;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlPageGroup;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlPageGroup;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlPageGroup;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlPageGroup;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlPageGroup;
   ...
   * @see #fromString
   */
  static make(s: string | null): UiSdlPageGroup | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlPageGroup;
   ...
   */
  static cachedEmptyInst(): UiSdlPageGroup;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlPageGroup>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlPageGroup;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<UiSdlPageGroup | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<UiSdlPageGroup | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<UiSdlPageGroup | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<UiSdlPageGroup | null> | null>;
   ...
   */
  get(include?: string | null): UiSdlPageGroup | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): UiSdlPageGroup | null;
   ...
   */
  getMissing(spec: GetMissingSpec): UiSdlPageGroup;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): UiSdlPageGroup | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): UiSdlPageGroup;
   ...
   * @see #toString
   */
  static fromString(s: string | null): UiSdlPageGroup | null;
   ...
   */
  create(spec?: UpsertSpec | null): UiSdlPageGroup | null;
   ...
   */
  static createBatch(objs: C3.Array<UiSdlPageGroup | null> | null, spec?: UpsertSpec | null): ObjList<UiSdlPageGroup | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<UiSdlPageGroup | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<UiSdlPageGroup | null> | null;
   ...
   */
  update(srcObj?: UiSdlPageGroup | null, spec?: UpsertSpec | null): UiSdlPageGroup | null;
   ...
   */
  upsert(srcObj?: UiSdlPageGroup | null, spec?: UpsertSpec | null): UiSdlPageGroup | null;
   ...
   */
  merge(spec?: MergeSpec | null): UiSdlPageGroup | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): UiSdlPageGroup | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): UiSdlPageGroup | null;
   ...
   */
  static updateBatch(objs: C3.Array<UiSdlPageGroup | null> | null, srcObjs?: C3.Array<UiSdlPageGroup | null>, spec?: UpsertSpec | null): ObjList<UiSdlPageGroup | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<UiSdlPageGroup | null>>, spec?: UpsertSpec | null): ObjList<UiSdlPageGroup | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<UiSdlPageGroup | null> | null, srcObjs?: C3.Array<UiSdlPageGroup | null>, spec?: UpsertSpec | null): ObjList<UiSdlPageGroup | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<UiSdlPageGroup | null>>, spec?: UpsertSpec | null): ObjList<UiSdlPageGroup | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<UiSdlPageGroup | null> | null, spec?: TouchSpec | null): ObjList<UiSdlPageGroup | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<UiSdlPageGroup | null> | null, spec?: MergeSpec | null): ObjList<UiSdlPageGroup | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<UiSdlPageGroup | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<UiSdlPageGroup | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<UiSdlPageGroup | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<UiSdlPageGroup | null> | null;
   ...
   */
  static mergeAll(mergeObj: UiSdlPageGroup | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: UiSdlPageGroup | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<UiSdlPageGroup | null> | null, spec?: UpsertSpec | null): ObjList<UiSdlPageGroup | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<UiSdlPageGroup | null> | null, spec?: UpsertSpec | null): ObjList<UiSdlPageGroup | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<UiSdlPageGroup | null> | null): ObjList<UiSdlPageGroup | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<UiSdlPageGroup | null> | null): ObjList<UiSdlPageGroup | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<UiSdlPageGroup | null> | null): ObjList<UiSdlPageGroup | null>;
   ...
   */
  static afterCreate(objs: C3.Array<UiSdlPageGroup | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<UiSdlPageGroup | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<UiSdlPageGroup | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<UiSdlPageGroup | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<UiSdlPageGroup | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): UiSdlPageGroup | null;
   ...
   */
  withoutIdentity(): UiSdlPageGroup | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<UiSdlPageGroup | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: UiSdlPageGroup | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<UiSdlPageGroup | null> | null, callback?: λFunction<UiSdlPageGroup | null, UiSdlPageGroup | null> | null): ObjList<UiSdlPageGroup | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<UiSdlPageGroup | null> | null, callback?: λFunction<UiSdlPageGroup | null, UiSdlPageGroup | null> | null): C3.Array<ObjError | null>;
