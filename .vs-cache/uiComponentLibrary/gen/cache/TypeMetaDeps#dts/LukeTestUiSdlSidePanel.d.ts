// TypeScript definitions for the C3 type LukeTestUiSdlSidePanel

/**
 * Representation of the {@link UiSdlSidePanel} component for testing purposes.
 *
 * @remarks this represents a value passed to a method that expects an instance of LukeTestUiSdlSidePanel
 */
declare interface ILukeTestUiSdlSidePanel {
 ...
 */
declare class LukeTestUiSdlSidePanel extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): LukeTestUiSdlSidePanel | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): LukeTestUiSdlSidePanel | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): LukeTestUiSdlSidePanel | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): LukeTestUiSdlSidePanel | null;
   ...
   */
  replaceType(old: Type, new_: Type): LukeTestUiSdlSidePanel;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): LukeTestUiSdlSidePanel;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): LukeTestUiSdlSidePanel;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<LukeTestUiSdlSidePanel | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<LukeTestUiSdlSidePanel | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): LukeTestUiSdlSidePanel;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): LukeTestUiSdlSidePanel;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): LukeTestUiSdlSidePanel;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): LukeTestUiSdlSidePanel;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): LukeTestUiSdlSidePanel;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): LukeTestUiSdlSidePanel;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): LukeTestUiSdlSidePanel;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): LukeTestUiSdlSidePanel;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): LukeTestUiSdlSidePanel;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): LukeTestUiSdlSidePanel;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): LukeTestUiSdlSidePanel;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): LukeTestUiSdlSidePanel;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): LukeTestUiSdlSidePanel;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): LukeTestUiSdlSidePanel;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): LukeTestUiSdlSidePanel;
   ...
   * @see #unsetField
   */
  defaultField(field: string): LukeTestUiSdlSidePanel;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): LukeTestUiSdlSidePanel;
   ...
   * @see #removeField
   */
  unsetField(field: string): LukeTestUiSdlSidePanel;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): LukeTestUiSdlSidePanel;
   ...
   * @see #unsetField
   */
  removeField(field: string): LukeTestUiSdlSidePanel;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): LukeTestUiSdlSidePanel;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): LukeTestUiSdlSidePanel;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): LukeTestUiSdlSidePanel;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): LukeTestUiSdlSidePanel;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): LukeTestUiSdlSidePanel;

  mergeJson(json: any | null): LukeTestUiSdlSidePanel;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): LukeTestUiSdlSidePanel;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): LukeTestUiSdlSidePanel;
   ...
   */
  singletonArray(): C3.Array<LukeTestUiSdlSidePanel | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<LukeTestUiSdlSidePanel | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<LukeTestUiSdlSidePanel | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<LukeTestUiSdlSidePanel | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<LukeTestUiSdlSidePanel | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, LukeTestUiSdlSidePanel | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, LukeTestUiSdlSidePanel | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<LukeTestUiSdlSidePanel | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<LukeTestUiSdlSidePanel | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): LukeTestUiSdlSidePanel;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): LukeTestUiSdlSidePanel;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): LukeTestUiSdlSidePanel;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): LukeTestUiSdlSidePanel;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): LukeTestUiSdlSidePanel;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): LukeTestUiSdlSidePanel;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): LukeTestUiSdlSidePanel;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): LukeTestUiSdlSidePanel;
   ...
   */
  static cachedEmptyInst(): LukeTestUiSdlSidePanel;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<LukeTestUiSdlSidePanel>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): LukeTestUiSdlSidePanel;
