// TypeScript definitions for the C3 type UiSdlGraphTest

/**
 * {@link InMemoryGraph} type to assist in testing `UiSdlGraphData#uiGraphDataFetch`.
 *
 * @remarks this represents a value passed to a method that expects an instance of UiSdlGraphTest
 */
declare interface IUiSdlGraphTest {

  /**
   * All vertices in this graph
   */
  m_vertices?: C3.Array<UiSdlGraphTestVertex | null> | Array<IUiSdlGraphTestVertex | null>;

  /**
   * All edges in this graph
   */
  m_edges?: C3.Array<UiSdlGraphTestEdge | null> | Array<IUiSdlGraphTestEdge | null>;

  /**
   * Set of all vertices that are not traversable
   * E.g Graph is : A - B - C, and if B is not traversable then A and C are disconnected
   */
  m_nonTraversableVertices?: C3.Array<UiSdlGraphTestVertex | null> | Array<IUiSdlGraphTestVertex | null>;
 ...
 */
declare class UiSdlGraphTest extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlGraphTest | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlGraphTest | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlGraphTest | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlGraphTest | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlGraphTest;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlGraphTest;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlGraphTest;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlGraphTest | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlGraphTest | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlGraphTest;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlGraphTest;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlGraphTest;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlGraphTest;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlGraphTest;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlGraphTest;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlGraphTest;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlGraphTest;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlGraphTest;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlGraphTest;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlGraphTest;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlGraphTest;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlGraphTest;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlGraphTest;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlGraphTest;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlGraphTest;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlGraphTest;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlGraphTest;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlGraphTest;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlGraphTest;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlGraphTest;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlGraphTest;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlGraphTest;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlGraphTest;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlGraphTest;

  mergeJson(json: any | null): UiSdlGraphTest;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlGraphTest;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlGraphTest;
   ...
   */
  singletonArray(): C3.Array<UiSdlGraphTest | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlGraphTest | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlGraphTest | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlGraphTest | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlGraphTest | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlGraphTest | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlGraphTest | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlGraphTest | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlGraphTest | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlGraphTest;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlGraphTest;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlGraphTest;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlGraphTest;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlGraphTest;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlGraphTest;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlGraphTest;
   ...
   */
  static cachedEmptyInst(): UiSdlGraphTest;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlGraphTest>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlGraphTest;
   ...
   */
  vertices(filter?: string | null, bindings?: ObjMapp | null): C3.Array<UiSdlGraphTestVertex | null>;
   ...
   */
  containsVertex(vertex: UiSdlGraphTestVertex): boolean;
   ...
   */
  edges(filter?: string | null, bindings?: ObjMapp | null): C3.Array<UiSdlGraphTestEdge | null>;
   ...
   */
  containsEdge(edge: UiSdlGraphTestEdge): boolean;
   ...
   */
  connectedVertices(vertex?: UiSdlGraphTestVertex | null, depth?: number | null): C3.Array<UiSdlGraphTestVertex | null>;
   ...
   */
  connectedEdges(vertex?: UiSdlGraphTestVertex | null): C3.Array<UiSdlGraphTestEdge | null>;
   ...
   */
  connectedPaths(fromVertex?: UiSdlGraphTestVertex | null, toVertex?: UiSdlGraphTestVertex | null, noOfPaths?: number | null, allowCycles?: boolean, maxDepth?: number | null): C3.Array<C3.Array<UiSdlGraphTestVertex | null>>;

  /**
   * @return List of all the connected sub-graphs
   */
  allSubGraphs(): C3.Array<Graph<UiSdlGraphTestVertex | null, UiSdlGraphTestEdge | null> | null>;
   ...
   */
  connectedSubGraph(vertex?: UiSdlGraphTestVertex | null): Graph<UiSdlGraphTestVertex | null, UiSdlGraphTestEdge | null> | null;
   ...
   * @return The sub-graph connected with the given vertex
   */
  filteredSubGraph(vertex?: UiSdlGraphTestVertex | null, vertexFilter?: string | null, edgeFilter?: string | null, bindings?: ObjMapp | null, doCache?: boolean): Graph<UiSdlGraphTestVertex | null, UiSdlGraphTestEdge | null> | null;
   ...
   * @return The sub-graph connected with the given vertex
   */
  filteredDirectedSubGraph(vertex: UiSdlGraphTestVertex, spec: TraverseGraphSpec): Graph<UiSdlGraphTestVertex | null, UiSdlGraphTestEdge | null>;
   ...
   */
  collectCounts(vertex: UiSdlGraphTestVertex, countsSpec?: CollectCountsSpec | null): C3.Map<string | null, number | null>;
   ...
   * @see #collectCounts
   */
  collectCountsBatch(vertices?: C3.Array<UiSdlGraphTestVertex | null>, countsSpec?: CollectCountsSpec | null): C3.Array<C3.Map<string | null, number | null>>;
   ...
   */
  pathToSinkNodes(vertex: UiSdlGraphTestVertex, allowCycles?: boolean): C3.Array<C3.Array<UiSdlGraphTestVertex | null>>;
   ...
   */
  static makeGraph(vertices?: C3.Array<UiSdlGraphTestVertex | null>, edges?: C3.Array<UiSdlGraphTestEdge | null>, nonTraversableVertices?: C3.Array<UiSdlGraphTestVertex | null>, doCache?: boolean): Graph<UiSdlGraphTestVertex | null, UiSdlGraphTestEdge | null> | null;
   ...
   *              the cached graph (on the root action context) for any further computation on the graph
   */
  static loadGraph(batchSize?: number | null, threads?: number | null, vertexSpec?: GraphDataSpec | null, edgeSpec?: GraphDataSpec | null, doCache?: boolean): Graph<UiSdlGraphTestVertex | null, UiSdlGraphTestEdge | null> | null;
   ...
   */
  addVertices(vertices: Stream<UiSdlGraphTestVertex | null>): Graph<UiSdlGraphTestVertex | null, UiSdlGraphTestEdge | null>;
   ...
   * @return pointer to the graph object
   */
  addEdges(edges: Stream<UiSdlGraphTestEdge | null>): Graph<UiSdlGraphTestVertex | null, UiSdlGraphTestEdge | null>;
   ...
   */
  static saveGraph(spec: LoadGraphSpec): Graph<UiSdlGraphTestVertex | null, UiSdlGraphTestEdge | null>;
   ...
   */
  static generateRandomGraph(vertexCount?: number | null, edgeCount?: number | null, vertexInclude?: string | null, edgeInclude?: string | null, doCache?: boolean): Graph<UiSdlGraphTestVertex | null, UiSdlGraphTestEdge | null> | null;

  /**
   * topological sort the graph (only works for directed graph)
   * @return the id of vertex in topological sequence
   */
  topologicalSort(): C3.Array<UiSdlGraphTestVertex | null>;
