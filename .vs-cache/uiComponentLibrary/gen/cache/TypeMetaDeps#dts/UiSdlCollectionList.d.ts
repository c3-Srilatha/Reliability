// TypeScript definitions for the C3 type UiSdlCollectionList

/**
 * A UI component type that displays data in a collection list.
 *
 * @remarks this represents a value passed to a method that expects an instance of UiSdlCollectionList
 */
declare interface IUiSdlCollectionList {
 ...
 */
declare class UiSdlCollectionList extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlCollectionList | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlCollectionList | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlCollectionList | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlCollectionList | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlCollectionList;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlCollectionList;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlCollectionList;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlCollectionList | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlCollectionList | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlCollectionList;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlCollectionList;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlCollectionList;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlCollectionList;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlCollectionList;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlCollectionList;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlCollectionList;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlCollectionList;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlCollectionList;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlCollectionList;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlCollectionList;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlCollectionList;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlCollectionList;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlCollectionList;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlCollectionList;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlCollectionList;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlCollectionList;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlCollectionList;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlCollectionList;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlCollectionList;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlCollectionList;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlCollectionList;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlCollectionList;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlCollectionList;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlCollectionList;

  mergeJson(json: any | null): UiSdlCollectionList;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlCollectionList;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlCollectionList;
   ...
   */
  singletonArray(): C3.Array<UiSdlCollectionList | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlCollectionList | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlCollectionList | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlCollectionList | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlCollectionList | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlCollectionList | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlCollectionList | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlCollectionList | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlCollectionList | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlCollectionList;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlCollectionList;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlCollectionList;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlCollectionList;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlCollectionList;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlCollectionList;
   ...
   * @see #fromString
   */
  static make(s: string | null): UiSdlCollectionList | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlCollectionList;
   ...
   */
  static cachedEmptyInst(): UiSdlCollectionList;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlCollectionList>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlCollectionList;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<UiSdlCollectionList | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<UiSdlCollectionList | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<UiSdlCollectionList | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<UiSdlCollectionList | null> | null>;
   ...
   */
  dependencies(): MetadataDeps<UiSdlCollectionList | null>;

  save(subPath?: string | null, contentType?: string | null): UiSdlCollectionList;
  ...
  update(srcObj?: UiSdlCollectionList | null, spec?: UpsertSpec | null): UiSdlCollectionList | null;

  upsert(srcObj?: UiSdlCollectionList | null, spec?: UpsertSpec | null): UiSdlCollectionList | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): UiSdlCollectionList | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string | null, failIfMissing?: boolean): UiSdlCollectionList | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: UiSdlCollectionList, state: UiSdlReduxState): UiSdlCollectionList | null;
