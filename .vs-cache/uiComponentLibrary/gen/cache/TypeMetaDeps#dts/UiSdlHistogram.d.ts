// TypeScript definitions for the C3 type UiSdlHistogram

/**
 * A UI component type that displays data in a histogram.
 *
 * @remarks this represents a value passed to a method that expects an instance of UiSdlHistogram
 */
declare interface IUiSdlHistogram {
 ...
 */
declare class UiSdlHistogram extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlHistogram | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlHistogram | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlHistogram | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlHistogram | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlHistogram;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlHistogram;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlHistogram;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlHistogram | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlHistogram | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlHistogram;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlHistogram;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlHistogram;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlHistogram;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlHistogram;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlHistogram;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlHistogram;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlHistogram;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlHistogram;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlHistogram;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlHistogram;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlHistogram;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlHistogram;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlHistogram;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlHistogram;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlHistogram;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlHistogram;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlHistogram;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlHistogram;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlHistogram;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlHistogram;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlHistogram;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlHistogram;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlHistogram;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlHistogram;

  mergeJson(json: any | null): UiSdlHistogram;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlHistogram;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlHistogram;
   ...
   */
  singletonArray(): C3.Array<UiSdlHistogram | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlHistogram | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlHistogram | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlHistogram | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlHistogram | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlHistogram | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlHistogram | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlHistogram | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlHistogram | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlHistogram;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlHistogram;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlHistogram;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlHistogram;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlHistogram;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlHistogram;
   ...
   * @see #fromString
   */
  static make(s: string | null): UiSdlHistogram | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlHistogram;
   ...
   */
  static cachedEmptyInst(): UiSdlHistogram;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlHistogram>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlHistogram;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<UiSdlHistogram | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<UiSdlHistogram | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<UiSdlHistogram | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<UiSdlHistogram | null> | null>;
   ...
   */
  dependencies(): MetadataDeps<UiSdlHistogram | null>;

  save(subPath?: string | null, contentType?: string | null): UiSdlHistogram;
  ...
  update(srcObj?: UiSdlHistogram | null, spec?: UpsertSpec | null): UiSdlHistogram | null;

  upsert(srcObj?: UiSdlHistogram | null, spec?: UpsertSpec | null): UiSdlHistogram | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): UiSdlHistogram | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string | null, failIfMissing?: boolean): UiSdlHistogram | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: UiSdlHistogram, state: UiSdlReduxState): UiSdlHistogram | null;
