// TypeScript definitions for the C3 type UiSdlDiagramViewerAddOnGroupBaseDataSpec
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of UiSdlDiagramViewerAddOnGroupBaseDataSpec
 */
declare interface IUiSdlDiagramViewerAddOnGroupBaseDataSpec {
 ...
 */
declare class UiSdlDiagramViewerAddOnGroupBaseDataSpec extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlDiagramViewerAddOnGroupBaseDataSpec | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlDiagramViewerAddOnGroupBaseDataSpec | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlDiagramViewerAddOnGroupBaseDataSpec | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlDiagramViewerAddOnGroupBaseDataSpec | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlDiagramViewerAddOnGroupBaseDataSpec;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlDiagramViewerAddOnGroupBaseDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlDiagramViewerAddOnGroupBaseDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlDiagramViewerAddOnGroupBaseDataSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlDiagramViewerAddOnGroupBaseDataSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlDiagramViewerAddOnGroupBaseDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlDiagramViewerAddOnGroupBaseDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlDiagramViewerAddOnGroupBaseDataSpec;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlDiagramViewerAddOnGroupBaseDataSpec;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlDiagramViewerAddOnGroupBaseDataSpec;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlDiagramViewerAddOnGroupBaseDataSpec;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlDiagramViewerAddOnGroupBaseDataSpec;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlDiagramViewerAddOnGroupBaseDataSpec;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlDiagramViewerAddOnGroupBaseDataSpec;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlDiagramViewerAddOnGroupBaseDataSpec;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlDiagramViewerAddOnGroupBaseDataSpec;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlDiagramViewerAddOnGroupBaseDataSpec;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlDiagramViewerAddOnGroupBaseDataSpec;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlDiagramViewerAddOnGroupBaseDataSpec;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlDiagramViewerAddOnGroupBaseDataSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlDiagramViewerAddOnGroupBaseDataSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlDiagramViewerAddOnGroupBaseDataSpec;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlDiagramViewerAddOnGroupBaseDataSpec;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlDiagramViewerAddOnGroupBaseDataSpec;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlDiagramViewerAddOnGroupBaseDataSpec;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlDiagramViewerAddOnGroupBaseDataSpec;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlDiagramViewerAddOnGroupBaseDataSpec;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlDiagramViewerAddOnGroupBaseDataSpec;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlDiagramViewerAddOnGroupBaseDataSpec;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlDiagramViewerAddOnGroupBaseDataSpec;

  mergeJson(json: any | null): UiSdlDiagramViewerAddOnGroupBaseDataSpec;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlDiagramViewerAddOnGroupBaseDataSpec;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlDiagramViewerAddOnGroupBaseDataSpec;
   ...
   */
  singletonArray(): C3.Array<UiSdlDiagramViewerAddOnGroupBaseDataSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlDiagramViewerAddOnGroupBaseDataSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlDiagramViewerAddOnGroupBaseDataSpec | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlDiagramViewerAddOnGroupBaseDataSpec | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlDiagramViewerAddOnGroupBaseDataSpec | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlDiagramViewerAddOnGroupBaseDataSpec | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlDiagramViewerAddOnGroupBaseDataSpec | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlDiagramViewerAddOnGroupBaseDataSpec | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlDiagramViewerAddOnGroupBaseDataSpec | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlDiagramViewerAddOnGroupBaseDataSpec;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlDiagramViewerAddOnGroupBaseDataSpec;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlDiagramViewerAddOnGroupBaseDataSpec;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlDiagramViewerAddOnGroupBaseDataSpec;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlDiagramViewerAddOnGroupBaseDataSpec;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlDiagramViewerAddOnGroupBaseDataSpec;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlDiagramViewerAddOnGroupBaseDataSpec;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): UiSdlDiagramViewerAddOnGroupBaseDataSpec;
   ...
   */
  static cachedEmptyInst(): UiSdlDiagramViewerAddOnGroupBaseDataSpec;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlDiagramViewerAddOnGroupBaseDataSpec>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlDiagramViewerAddOnGroupBaseDataSpec;
   ...
   */
  static getDataTypeName(dataSpec?: UiSdlDiagramViewerAddOnGroupBaseDataSpec | null): string | null;
