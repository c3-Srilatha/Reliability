// TypeScript definitions for the C3 type UiSdlDataGridExportWarningModal
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of UiSdlDataGridExportWarningModal
 */
declare interface IUiSdlDataGridExportWarningModal {
 ...
 */
declare class UiSdlDataGridExportWarningModal extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlDataGridExportWarningModal | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlDataGridExportWarningModal | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlDataGridExportWarningModal | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlDataGridExportWarningModal | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlDataGridExportWarningModal;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlDataGridExportWarningModal;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlDataGridExportWarningModal;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlDataGridExportWarningModal | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlDataGridExportWarningModal | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlDataGridExportWarningModal;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlDataGridExportWarningModal;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlDataGridExportWarningModal;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlDataGridExportWarningModal;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlDataGridExportWarningModal;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlDataGridExportWarningModal;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlDataGridExportWarningModal;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlDataGridExportWarningModal;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlDataGridExportWarningModal;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlDataGridExportWarningModal;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlDataGridExportWarningModal;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlDataGridExportWarningModal;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlDataGridExportWarningModal;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlDataGridExportWarningModal;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlDataGridExportWarningModal;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlDataGridExportWarningModal;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlDataGridExportWarningModal;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlDataGridExportWarningModal;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlDataGridExportWarningModal;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlDataGridExportWarningModal;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlDataGridExportWarningModal;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlDataGridExportWarningModal;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlDataGridExportWarningModal;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlDataGridExportWarningModal;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlDataGridExportWarningModal;

  mergeJson(json: any | null): UiSdlDataGridExportWarningModal;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlDataGridExportWarningModal;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlDataGridExportWarningModal;
   ...
   */
  singletonArray(): C3.Array<UiSdlDataGridExportWarningModal | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlDataGridExportWarningModal | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlDataGridExportWarningModal | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlDataGridExportWarningModal | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlDataGridExportWarningModal | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlDataGridExportWarningModal | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlDataGridExportWarningModal | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlDataGridExportWarningModal | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlDataGridExportWarningModal | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlDataGridExportWarningModal;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlDataGridExportWarningModal;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlDataGridExportWarningModal;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlDataGridExportWarningModal;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlDataGridExportWarningModal;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlDataGridExportWarningModal;
   ...
   * @see #fromString
   */
  static make(s: string | null): UiSdlDataGridExportWarningModal | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlDataGridExportWarningModal;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): UiSdlDataGridExportWarningModal;
   ...
   */
  static cachedEmptyInst(): UiSdlDataGridExportWarningModal;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlDataGridExportWarningModal>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlDataGridExportWarningModal;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<UiSdlDataGridExportWarningModal | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<UiSdlDataGridExportWarningModal | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<UiSdlDataGridExportWarningModal | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<UiSdlDataGridExportWarningModal | null> | null>;
   ...
   */
  dependencies(): MetadataDeps<UiSdlDataGridExportWarningModal | null>;

  save(subPath?: string | null, contentType?: string | null): UiSdlDataGridExportWarningModal;
  ...
  update(srcObj?: UiSdlDataGridExportWarningModal | null, spec?: UpsertSpec | null): UiSdlDataGridExportWarningModal | null;

  upsert(srcObj?: UiSdlDataGridExportWarningModal | null, spec?: UpsertSpec | null): UiSdlDataGridExportWarningModal | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): UiSdlDataGridExportWarningModal | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string | null, failIfMissing?: boolean): UiSdlDataGridExportWarningModal | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: UiSdlDataGridExportWarningModal, state: UiSdlReduxState): UiSdlDataGridExportWarningModal | null;
