// TypeScript definitions for the C3 type UiSdlFilterPanelInternalDataSpec

/**
 * The internal data specification for {@link UiSdlFilterPanel}.
 *
 * @remarks this represents a value passed to a method that expects an instance of UiSdlFilterPanelInternalDataSpec
 */
declare interface IUiSdlFilterPanelInternalDataSpec {
 ...
 */
declare class UiSdlFilterPanelInternalDataSpec extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlFilterPanelInternalDataSpec | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlFilterPanelInternalDataSpec | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlFilterPanelInternalDataSpec | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlFilterPanelInternalDataSpec | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlFilterPanelInternalDataSpec;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlFilterPanelInternalDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlFilterPanelInternalDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlFilterPanelInternalDataSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlFilterPanelInternalDataSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlFilterPanelInternalDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlFilterPanelInternalDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlFilterPanelInternalDataSpec;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlFilterPanelInternalDataSpec;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlFilterPanelInternalDataSpec;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlFilterPanelInternalDataSpec;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlFilterPanelInternalDataSpec;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlFilterPanelInternalDataSpec;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlFilterPanelInternalDataSpec;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlFilterPanelInternalDataSpec;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlFilterPanelInternalDataSpec;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlFilterPanelInternalDataSpec;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlFilterPanelInternalDataSpec;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlFilterPanelInternalDataSpec;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlFilterPanelInternalDataSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlFilterPanelInternalDataSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlFilterPanelInternalDataSpec;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlFilterPanelInternalDataSpec;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlFilterPanelInternalDataSpec;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlFilterPanelInternalDataSpec;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlFilterPanelInternalDataSpec;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlFilterPanelInternalDataSpec;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlFilterPanelInternalDataSpec;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlFilterPanelInternalDataSpec;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlFilterPanelInternalDataSpec;

  mergeJson(json: any | null): UiSdlFilterPanelInternalDataSpec;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlFilterPanelInternalDataSpec;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlFilterPanelInternalDataSpec;
   ...
   */
  singletonArray(): C3.Array<UiSdlFilterPanelInternalDataSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlFilterPanelInternalDataSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlFilterPanelInternalDataSpec | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlFilterPanelInternalDataSpec | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlFilterPanelInternalDataSpec | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlFilterPanelInternalDataSpec | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlFilterPanelInternalDataSpec | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlFilterPanelInternalDataSpec | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlFilterPanelInternalDataSpec | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlFilterPanelInternalDataSpec;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlFilterPanelInternalDataSpec;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlFilterPanelInternalDataSpec;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlFilterPanelInternalDataSpec;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlFilterPanelInternalDataSpec;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlFilterPanelInternalDataSpec;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlFilterPanelInternalDataSpec;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): UiSdlFilterPanelInternalDataSpec;
   ...
   */
  static cachedEmptyInst(): UiSdlFilterPanelInternalDataSpec;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlFilterPanelInternalDataSpec>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlFilterPanelInternalDataSpec;
   ...
   */
  static getDataTypeName(dataSpec?: UiSdlFilterPanelInternalDataSpec | null): string | null;
