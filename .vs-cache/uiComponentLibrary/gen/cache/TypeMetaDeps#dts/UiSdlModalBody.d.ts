// TypeScript definitions for the C3 type UiSdlModalBody

/**
 * Base type for {@link UiSdlModal} and {@link UiSdlMultiStepModalStep}.
 *
 * @remarks this represents a value passed to a method that expects an instance of UiSdlModalBody
 */
declare interface IUiSdlModalBody {
 ...
 */
declare class UiSdlModalBody extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlModalBody | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlModalBody | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlModalBody | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlModalBody | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlModalBody;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlModalBody;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlModalBody;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlModalBody | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlModalBody | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlModalBody;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlModalBody;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlModalBody;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlModalBody;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlModalBody;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlModalBody;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlModalBody;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlModalBody;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlModalBody;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlModalBody;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlModalBody;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlModalBody;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlModalBody;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlModalBody;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlModalBody;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlModalBody;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlModalBody;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlModalBody;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlModalBody;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlModalBody;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlModalBody;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlModalBody;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlModalBody;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlModalBody;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlModalBody;

  mergeJson(json: any | null): UiSdlModalBody;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlModalBody;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlModalBody;
   ...
   */
  singletonArray(): C3.Array<UiSdlModalBody | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlModalBody | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlModalBody | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlModalBody | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlModalBody | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlModalBody | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlModalBody | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlModalBody | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlModalBody | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlModalBody;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlModalBody;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlModalBody;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlModalBody;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlModalBody;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlModalBody;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlModalBody;
   ...
   */
  static cachedEmptyInst(): UiSdlModalBody;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlModalBody>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlModalBody;
