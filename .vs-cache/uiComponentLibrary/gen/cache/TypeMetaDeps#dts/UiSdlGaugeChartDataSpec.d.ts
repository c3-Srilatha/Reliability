// TypeScript definitions for the C3 type UiSdlGaugeChartDataSpec

/**
 * The specification of data retrieval for instances of the {@link UiSdlGaugeChart} component type.
 *
 * @remarks this represents a value passed to a method that expects an instance of UiSdlGaugeChartDataSpec
 */
declare interface IUiSdlGaugeChartDataSpec {
   ...
   */
  valueField?: IUiSdlGaugeChartValueFieldDataSpecSetting | null;
}
 ...
 */
declare class UiSdlGaugeChartDataSpec extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlGaugeChartDataSpec | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlGaugeChartDataSpec | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlGaugeChartDataSpec | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlGaugeChartDataSpec | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlGaugeChartDataSpec;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlGaugeChartDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlGaugeChartDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlGaugeChartDataSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlGaugeChartDataSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlGaugeChartDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlGaugeChartDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlGaugeChartDataSpec;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlGaugeChartDataSpec;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlGaugeChartDataSpec;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlGaugeChartDataSpec;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlGaugeChartDataSpec;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlGaugeChartDataSpec;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlGaugeChartDataSpec;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlGaugeChartDataSpec;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlGaugeChartDataSpec;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlGaugeChartDataSpec;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlGaugeChartDataSpec;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlGaugeChartDataSpec;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlGaugeChartDataSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlGaugeChartDataSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlGaugeChartDataSpec;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlGaugeChartDataSpec;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlGaugeChartDataSpec;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlGaugeChartDataSpec;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlGaugeChartDataSpec;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlGaugeChartDataSpec;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlGaugeChartDataSpec;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlGaugeChartDataSpec;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlGaugeChartDataSpec;

  mergeJson(json: any | null): UiSdlGaugeChartDataSpec;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlGaugeChartDataSpec;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlGaugeChartDataSpec;
   ...
   */
  singletonArray(): C3.Array<UiSdlGaugeChartDataSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlGaugeChartDataSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlGaugeChartDataSpec | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlGaugeChartDataSpec | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlGaugeChartDataSpec | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlGaugeChartDataSpec | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlGaugeChartDataSpec | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlGaugeChartDataSpec | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlGaugeChartDataSpec | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlGaugeChartDataSpec;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlGaugeChartDataSpec;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlGaugeChartDataSpec;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlGaugeChartDataSpec;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlGaugeChartDataSpec;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlGaugeChartDataSpec;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlGaugeChartDataSpec;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): UiSdlGaugeChartDataSpec;
   ...
   */
  static cachedEmptyInst(): UiSdlGaugeChartDataSpec;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlGaugeChartDataSpec>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlGaugeChartDataSpec;
   ...
   */
  static getDataTypeName(dataSpec?: UiSdlGaugeChartDataSpec | null): string | null;
