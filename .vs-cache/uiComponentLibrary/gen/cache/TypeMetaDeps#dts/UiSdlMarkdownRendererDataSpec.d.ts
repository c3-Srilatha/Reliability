// TypeScript definitions for the C3 type UiSdlMarkdownRendererDataSpec

/**
 * A UI component type that represents a markdown renderer data spec.
 *
 * @remarks this represents a value passed to a method that expects an instance of UiSdlMarkdownRendererDataSpec
 */
declare interface IUiSdlMarkdownRendererDataSpec {
 ...
 */
declare class UiSdlMarkdownRendererDataSpec extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlMarkdownRendererDataSpec | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlMarkdownRendererDataSpec | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlMarkdownRendererDataSpec | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlMarkdownRendererDataSpec | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlMarkdownRendererDataSpec;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlMarkdownRendererDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlMarkdownRendererDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlMarkdownRendererDataSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlMarkdownRendererDataSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlMarkdownRendererDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlMarkdownRendererDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlMarkdownRendererDataSpec;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlMarkdownRendererDataSpec;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlMarkdownRendererDataSpec;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlMarkdownRendererDataSpec;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlMarkdownRendererDataSpec;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlMarkdownRendererDataSpec;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlMarkdownRendererDataSpec;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlMarkdownRendererDataSpec;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlMarkdownRendererDataSpec;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlMarkdownRendererDataSpec;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlMarkdownRendererDataSpec;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlMarkdownRendererDataSpec;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlMarkdownRendererDataSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlMarkdownRendererDataSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlMarkdownRendererDataSpec;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlMarkdownRendererDataSpec;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlMarkdownRendererDataSpec;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlMarkdownRendererDataSpec;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlMarkdownRendererDataSpec;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlMarkdownRendererDataSpec;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlMarkdownRendererDataSpec;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlMarkdownRendererDataSpec;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlMarkdownRendererDataSpec;

  mergeJson(json: any | null): UiSdlMarkdownRendererDataSpec;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlMarkdownRendererDataSpec;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlMarkdownRendererDataSpec;
   ...
   */
  singletonArray(): C3.Array<UiSdlMarkdownRendererDataSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlMarkdownRendererDataSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlMarkdownRendererDataSpec | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlMarkdownRendererDataSpec | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlMarkdownRendererDataSpec | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlMarkdownRendererDataSpec | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlMarkdownRendererDataSpec | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlMarkdownRendererDataSpec | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlMarkdownRendererDataSpec | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlMarkdownRendererDataSpec;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlMarkdownRendererDataSpec;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlMarkdownRendererDataSpec;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlMarkdownRendererDataSpec;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlMarkdownRendererDataSpec;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlMarkdownRendererDataSpec;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlMarkdownRendererDataSpec;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): UiSdlMarkdownRendererDataSpec;
   ...
   */
  static cachedEmptyInst(): UiSdlMarkdownRendererDataSpec;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlMarkdownRendererDataSpec>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlMarkdownRendererDataSpec;
   ...
   */
  static getDataTypeName(dataSpec?: UiSdlMarkdownRendererDataSpec | null): string | null;
