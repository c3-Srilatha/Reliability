// TypeScript definitions for the C3 type UiSdlBreadcrumbsDataSpec

/**
 * The specification of data retrieval for instances of the {@link UiSdlBreadcrumbs} component type.
 *
 * @remarks this represents a value passed to a method that expects an instance of UiSdlBreadcrumbsDataSpec
 */
declare interface IUiSdlBreadcrumbsDataSpec {
   ...
   */
  breadcrumbsDataMapping?: C3.Map<string | null, UiSdlBreadcrumbsDataSource | null> | {[key: string | null]: IUiSdlBreadcrumbsDataSource | null};
}
 ...
 */
declare class UiSdlBreadcrumbsDataSpec extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlBreadcrumbsDataSpec | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlBreadcrumbsDataSpec | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlBreadcrumbsDataSpec | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlBreadcrumbsDataSpec | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlBreadcrumbsDataSpec;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlBreadcrumbsDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlBreadcrumbsDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlBreadcrumbsDataSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlBreadcrumbsDataSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlBreadcrumbsDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlBreadcrumbsDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlBreadcrumbsDataSpec;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlBreadcrumbsDataSpec;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlBreadcrumbsDataSpec;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlBreadcrumbsDataSpec;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlBreadcrumbsDataSpec;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlBreadcrumbsDataSpec;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlBreadcrumbsDataSpec;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlBreadcrumbsDataSpec;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlBreadcrumbsDataSpec;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlBreadcrumbsDataSpec;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlBreadcrumbsDataSpec;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlBreadcrumbsDataSpec;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlBreadcrumbsDataSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlBreadcrumbsDataSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlBreadcrumbsDataSpec;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlBreadcrumbsDataSpec;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlBreadcrumbsDataSpec;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlBreadcrumbsDataSpec;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlBreadcrumbsDataSpec;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlBreadcrumbsDataSpec;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlBreadcrumbsDataSpec;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlBreadcrumbsDataSpec;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlBreadcrumbsDataSpec;

  mergeJson(json: any | null): UiSdlBreadcrumbsDataSpec;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlBreadcrumbsDataSpec;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlBreadcrumbsDataSpec;
   ...
   */
  singletonArray(): C3.Array<UiSdlBreadcrumbsDataSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlBreadcrumbsDataSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlBreadcrumbsDataSpec | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlBreadcrumbsDataSpec | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlBreadcrumbsDataSpec | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlBreadcrumbsDataSpec | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlBreadcrumbsDataSpec | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlBreadcrumbsDataSpec | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlBreadcrumbsDataSpec | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlBreadcrumbsDataSpec;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlBreadcrumbsDataSpec;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlBreadcrumbsDataSpec;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlBreadcrumbsDataSpec;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlBreadcrumbsDataSpec;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlBreadcrumbsDataSpec;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlBreadcrumbsDataSpec;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): UiSdlBreadcrumbsDataSpec;
   ...
   */
  static cachedEmptyInst(): UiSdlBreadcrumbsDataSpec;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlBreadcrumbsDataSpec>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlBreadcrumbsDataSpec;
   ...
   */
  static getDataTypeName(dataSpec?: UiSdlBreadcrumbsDataSpec | null): string | null;
