// TypeScript definitions for the C3 type UiSdlModalBase

/**
 * Base type for {@link UiSdlModal} and {@link UiSdlMultiStepModal}.
 *
 * @remarks this represents a value passed to a method that expects an instance of UiSdlModalBase
 */
declare interface IUiSdlModalBase {
 ...
 */
declare class UiSdlModalBase extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlModalBase | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlModalBase | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlModalBase | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlModalBase | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlModalBase;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlModalBase;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlModalBase;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlModalBase | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlModalBase | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlModalBase;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlModalBase;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlModalBase;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlModalBase;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlModalBase;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlModalBase;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlModalBase;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlModalBase;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlModalBase;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlModalBase;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlModalBase;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlModalBase;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlModalBase;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlModalBase;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlModalBase;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlModalBase;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlModalBase;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlModalBase;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlModalBase;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlModalBase;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlModalBase;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlModalBase;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlModalBase;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlModalBase;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlModalBase;

  mergeJson(json: any | null): UiSdlModalBase;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlModalBase;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlModalBase;
   ...
   */
  singletonArray(): C3.Array<UiSdlModalBase | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlModalBase | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlModalBase | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlModalBase | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlModalBase | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlModalBase | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlModalBase | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlModalBase | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlModalBase | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlModalBase;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlModalBase;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlModalBase;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlModalBase;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlModalBase;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlModalBase;
   ...
   * @see #fromString
   */
  static make(s: string | null): UiSdlModalBase | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlModalBase;
   ...
   */
  static cachedEmptyInst(): UiSdlModalBase;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlModalBase>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlModalBase;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<UiSdlModalBase | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<UiSdlModalBase | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<UiSdlModalBase | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<UiSdlModalBase | null> | null>;
   ...
   */
  dependencies(): MetadataDeps<UiSdlModalBase | null>;

  save(subPath?: string | null, contentType?: string | null): UiSdlModalBase;
  ...
  update(srcObj?: UiSdlModalBase | null, spec?: UpsertSpec | null): UiSdlModalBase | null;

  upsert(srcObj?: UiSdlModalBase | null, spec?: UpsertSpec | null): UiSdlModalBase | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): UiSdlModalBase | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string | null, failIfMissing?: boolean): UiSdlModalBase | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: UiSdlModalBase, state: UiSdlReduxState): UiSdlModalBase | null;
