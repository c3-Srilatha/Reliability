// TypeScript definitions for the C3 type UiSdlTimeseriesLineBarChartEventSeriesDataSpec
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of UiSdlTimeseriesLineBarChartEventSeriesDataSpec
 */
declare interface IUiSdlTimeseriesLineBarChartEventSeriesDataSpec {
   ...
   */
  timestamp: IUiSdlFieldBasedDataSpecSetting;
   ...
   *     }
   */
  yValue?: IUiSdlTimeseriesLineBarChartEventRelativePosition | null | IDimension | null | null;
   ...
   */
  tooltipAdditionalFields?: C3.Array<UiSdlTimeseriesLineBarChartTooltipAdditionalFieldDataSpecSetting | null> | Array<IUiSdlTimeseriesLineBarChartTooltipAdditionalFieldDataSpecSetting | null>;
 ...
 */
declare class UiSdlTimeseriesLineBarChartEventSeriesDataSpec extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlTimeseriesLineBarChartEventSeriesDataSpec | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlTimeseriesLineBarChartEventSeriesDataSpec | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlTimeseriesLineBarChartEventSeriesDataSpec | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlTimeseriesLineBarChartEventSeriesDataSpec | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlTimeseriesLineBarChartEventSeriesDataSpec;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlTimeseriesLineBarChartEventSeriesDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlTimeseriesLineBarChartEventSeriesDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlTimeseriesLineBarChartEventSeriesDataSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlTimeseriesLineBarChartEventSeriesDataSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlTimeseriesLineBarChartEventSeriesDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlTimeseriesLineBarChartEventSeriesDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlTimeseriesLineBarChartEventSeriesDataSpec;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlTimeseriesLineBarChartEventSeriesDataSpec;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlTimeseriesLineBarChartEventSeriesDataSpec;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlTimeseriesLineBarChartEventSeriesDataSpec;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlTimeseriesLineBarChartEventSeriesDataSpec;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlTimeseriesLineBarChartEventSeriesDataSpec;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlTimeseriesLineBarChartEventSeriesDataSpec;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlTimeseriesLineBarChartEventSeriesDataSpec;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlTimeseriesLineBarChartEventSeriesDataSpec;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlTimeseriesLineBarChartEventSeriesDataSpec;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlTimeseriesLineBarChartEventSeriesDataSpec;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlTimeseriesLineBarChartEventSeriesDataSpec;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlTimeseriesLineBarChartEventSeriesDataSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlTimeseriesLineBarChartEventSeriesDataSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlTimeseriesLineBarChartEventSeriesDataSpec;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlTimeseriesLineBarChartEventSeriesDataSpec;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlTimeseriesLineBarChartEventSeriesDataSpec;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlTimeseriesLineBarChartEventSeriesDataSpec;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlTimeseriesLineBarChartEventSeriesDataSpec;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlTimeseriesLineBarChartEventSeriesDataSpec;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlTimeseriesLineBarChartEventSeriesDataSpec;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlTimeseriesLineBarChartEventSeriesDataSpec;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlTimeseriesLineBarChartEventSeriesDataSpec;

  mergeJson(json: any | null): UiSdlTimeseriesLineBarChartEventSeriesDataSpec;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlTimeseriesLineBarChartEventSeriesDataSpec;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlTimeseriesLineBarChartEventSeriesDataSpec;
   ...
   */
  singletonArray(): C3.Array<UiSdlTimeseriesLineBarChartEventSeriesDataSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlTimeseriesLineBarChartEventSeriesDataSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlTimeseriesLineBarChartEventSeriesDataSpec | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlTimeseriesLineBarChartEventSeriesDataSpec | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlTimeseriesLineBarChartEventSeriesDataSpec | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlTimeseriesLineBarChartEventSeriesDataSpec | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlTimeseriesLineBarChartEventSeriesDataSpec | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlTimeseriesLineBarChartEventSeriesDataSpec | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlTimeseriesLineBarChartEventSeriesDataSpec | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlTimeseriesLineBarChartEventSeriesDataSpec;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlTimeseriesLineBarChartEventSeriesDataSpec;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlTimeseriesLineBarChartEventSeriesDataSpec;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlTimeseriesLineBarChartEventSeriesDataSpec;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlTimeseriesLineBarChartEventSeriesDataSpec;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlTimeseriesLineBarChartEventSeriesDataSpec;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlTimeseriesLineBarChartEventSeriesDataSpec;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): UiSdlTimeseriesLineBarChartEventSeriesDataSpec;
   ...
   */
  static cachedEmptyInst(): UiSdlTimeseriesLineBarChartEventSeriesDataSpec;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlTimeseriesLineBarChartEventSeriesDataSpec>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlTimeseriesLineBarChartEventSeriesDataSpec;
   ...
   */
  static getDataTypeName(dataSpec?: UiSdlTimeseriesLineBarChartEventSeriesDataSpec | null): string | null;
