// TypeScript definitions for the C3 type UiSdlCardListDataSpec

/**
 * The specification of data retrieval for instances of the {@link UiSdlCardList} component type.
 *
 * @remarks this represents a value passed to a method that expects an instance of UiSdlCardListDataSpec
 */
declare interface IUiSdlCardListDataSpec {
   ...
   */
  link?: IUiSdlCardListLinkFieldSetting | null;

  /**
   * Spec for how to configure the header field of a card.
   */
  header?: IUiSdlFieldBasedDataDynamicValueSpecSetting | null;

  /**
   * Spec for how to configure the subheader field of a card.
   */
  subHeader?: IUiSdlFieldBasedDataDynamicValueSpecSetting | null;

  /**
   * Spec for how to configure the numerical indicator field of a card.
   */
  numericalIndicator?: IUiSdlCardListNumericalIndicatorFieldSetting | null;

  /**
   * Spec for how to configure the content body field of a card.
   */
  contentBodyText?: IUiSdlCardListContentBodyTextFieldSetting | null;

  /**
   * Spec for how to configure the footer field of a card.
   */
  footerText?: IUiSdlFieldBasedDataDynamicValueSpecSetting | null;
   ...
   */
  filterSpec?: IFetchFilterSpec | null;

  /**
   * Array of spec to be used as a universal sorting bucket.
   */
  sortFields?: C3.Array<UiSdlCardListSortFieldDataSpecSetting | null> | Array<IUiSdlCardListSortFieldDataSpecSetting | null>;
}
 ...
 */
declare class UiSdlCardListDataSpec extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlCardListDataSpec | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlCardListDataSpec | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlCardListDataSpec | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlCardListDataSpec | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlCardListDataSpec;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlCardListDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlCardListDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlCardListDataSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlCardListDataSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlCardListDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlCardListDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlCardListDataSpec;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlCardListDataSpec;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlCardListDataSpec;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlCardListDataSpec;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlCardListDataSpec;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlCardListDataSpec;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlCardListDataSpec;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlCardListDataSpec;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlCardListDataSpec;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlCardListDataSpec;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlCardListDataSpec;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlCardListDataSpec;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlCardListDataSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlCardListDataSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlCardListDataSpec;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlCardListDataSpec;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlCardListDataSpec;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlCardListDataSpec;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlCardListDataSpec;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlCardListDataSpec;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlCardListDataSpec;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlCardListDataSpec;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlCardListDataSpec;

  mergeJson(json: any | null): UiSdlCardListDataSpec;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlCardListDataSpec;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlCardListDataSpec;
   ...
   */
  singletonArray(): C3.Array<UiSdlCardListDataSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlCardListDataSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlCardListDataSpec | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlCardListDataSpec | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlCardListDataSpec | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlCardListDataSpec | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlCardListDataSpec | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlCardListDataSpec | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlCardListDataSpec | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlCardListDataSpec;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlCardListDataSpec;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlCardListDataSpec;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlCardListDataSpec;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlCardListDataSpec;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlCardListDataSpec;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlCardListDataSpec;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): UiSdlCardListDataSpec;
   ...
   */
  static cachedEmptyInst(): UiSdlCardListDataSpec;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlCardListDataSpec>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlCardListDataSpec;
   ...
   */
  static getDataTypeName(dataSpec?: UiSdlCardListDataSpec | null): string | null;
