// TypeScript definitions for the C3 type UiSdlTimeseriesLineBarChartEvalDataSpec

/**
 * The specification of data retrieval for instances of the {@link UiSdlTimeseriesLineBarChart} component type.
 *
 * @remarks this represents a value passed to a method that expects an instance of UiSdlTimeseriesLineBarChartEvalDataSpec
 */
declare interface IUiSdlTimeseriesLineBarChartEvalDataSpec {
   ...
   */
  yAxisFields?: C3.Array<UiSdlTimeseriesLineBarChartEvalYAxisDataSpecSetting | null> | Array<IUiSdlTimeseriesLineBarChartEvalYAxisDataSpecSetting | null>;
}
 ...
 */
declare class UiSdlTimeseriesLineBarChartEvalDataSpec extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlTimeseriesLineBarChartEvalDataSpec | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlTimeseriesLineBarChartEvalDataSpec | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlTimeseriesLineBarChartEvalDataSpec | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlTimeseriesLineBarChartEvalDataSpec | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlTimeseriesLineBarChartEvalDataSpec;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlTimeseriesLineBarChartEvalDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlTimeseriesLineBarChartEvalDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlTimeseriesLineBarChartEvalDataSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlTimeseriesLineBarChartEvalDataSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlTimeseriesLineBarChartEvalDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlTimeseriesLineBarChartEvalDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlTimeseriesLineBarChartEvalDataSpec;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlTimeseriesLineBarChartEvalDataSpec;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlTimeseriesLineBarChartEvalDataSpec;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlTimeseriesLineBarChartEvalDataSpec;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlTimeseriesLineBarChartEvalDataSpec;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlTimeseriesLineBarChartEvalDataSpec;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlTimeseriesLineBarChartEvalDataSpec;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlTimeseriesLineBarChartEvalDataSpec;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlTimeseriesLineBarChartEvalDataSpec;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlTimeseriesLineBarChartEvalDataSpec;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlTimeseriesLineBarChartEvalDataSpec;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlTimeseriesLineBarChartEvalDataSpec;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlTimeseriesLineBarChartEvalDataSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlTimeseriesLineBarChartEvalDataSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlTimeseriesLineBarChartEvalDataSpec;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlTimeseriesLineBarChartEvalDataSpec;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlTimeseriesLineBarChartEvalDataSpec;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlTimeseriesLineBarChartEvalDataSpec;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlTimeseriesLineBarChartEvalDataSpec;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlTimeseriesLineBarChartEvalDataSpec;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlTimeseriesLineBarChartEvalDataSpec;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlTimeseriesLineBarChartEvalDataSpec;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlTimeseriesLineBarChartEvalDataSpec;

  mergeJson(json: any | null): UiSdlTimeseriesLineBarChartEvalDataSpec;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlTimeseriesLineBarChartEvalDataSpec;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlTimeseriesLineBarChartEvalDataSpec;
   ...
   */
  singletonArray(): C3.Array<UiSdlTimeseriesLineBarChartEvalDataSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlTimeseriesLineBarChartEvalDataSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlTimeseriesLineBarChartEvalDataSpec | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlTimeseriesLineBarChartEvalDataSpec | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlTimeseriesLineBarChartEvalDataSpec | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlTimeseriesLineBarChartEvalDataSpec | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlTimeseriesLineBarChartEvalDataSpec | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlTimeseriesLineBarChartEvalDataSpec | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlTimeseriesLineBarChartEvalDataSpec | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlTimeseriesLineBarChartEvalDataSpec;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlTimeseriesLineBarChartEvalDataSpec;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlTimeseriesLineBarChartEvalDataSpec;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlTimeseriesLineBarChartEvalDataSpec;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlTimeseriesLineBarChartEvalDataSpec;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlTimeseriesLineBarChartEvalDataSpec;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlTimeseriesLineBarChartEvalDataSpec;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): UiSdlTimeseriesLineBarChartEvalDataSpec;
   ...
   */
  static cachedEmptyInst(): UiSdlTimeseriesLineBarChartEvalDataSpec;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlTimeseriesLineBarChartEvalDataSpec>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlTimeseriesLineBarChartEvalDataSpec;
   ...
   */
  static getDataTypeName(dataSpec?: UiSdlTimeseriesLineBarChartEvalDataSpec | null): string | null;
