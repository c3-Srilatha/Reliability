// TypeScript definitions for the C3 type UiSdlParallelCoordinatesAxesDataSpec

/**
 * The specification of axes retrieval for instances of the {@link UiSdlParallelCoordinatesChart} component type.
 *
 * @remarks this represents a value passed to a method that expects an instance of UiSdlParallelCoordinatesAxesDataSpec
 */
declare interface IUiSdlParallelCoordinatesAxesDataSpec {
 ...
 */
declare class UiSdlParallelCoordinatesAxesDataSpec extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlParallelCoordinatesAxesDataSpec | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlParallelCoordinatesAxesDataSpec | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlParallelCoordinatesAxesDataSpec | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlParallelCoordinatesAxesDataSpec | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlParallelCoordinatesAxesDataSpec;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlParallelCoordinatesAxesDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlParallelCoordinatesAxesDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlParallelCoordinatesAxesDataSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlParallelCoordinatesAxesDataSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlParallelCoordinatesAxesDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlParallelCoordinatesAxesDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlParallelCoordinatesAxesDataSpec;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlParallelCoordinatesAxesDataSpec;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlParallelCoordinatesAxesDataSpec;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlParallelCoordinatesAxesDataSpec;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlParallelCoordinatesAxesDataSpec;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlParallelCoordinatesAxesDataSpec;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlParallelCoordinatesAxesDataSpec;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlParallelCoordinatesAxesDataSpec;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlParallelCoordinatesAxesDataSpec;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlParallelCoordinatesAxesDataSpec;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlParallelCoordinatesAxesDataSpec;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlParallelCoordinatesAxesDataSpec;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlParallelCoordinatesAxesDataSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlParallelCoordinatesAxesDataSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlParallelCoordinatesAxesDataSpec;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlParallelCoordinatesAxesDataSpec;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlParallelCoordinatesAxesDataSpec;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlParallelCoordinatesAxesDataSpec;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlParallelCoordinatesAxesDataSpec;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlParallelCoordinatesAxesDataSpec;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlParallelCoordinatesAxesDataSpec;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlParallelCoordinatesAxesDataSpec;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlParallelCoordinatesAxesDataSpec;

  mergeJson(json: any | null): UiSdlParallelCoordinatesAxesDataSpec;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlParallelCoordinatesAxesDataSpec;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlParallelCoordinatesAxesDataSpec;
   ...
   */
  singletonArray(): C3.Array<UiSdlParallelCoordinatesAxesDataSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlParallelCoordinatesAxesDataSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlParallelCoordinatesAxesDataSpec | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlParallelCoordinatesAxesDataSpec | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlParallelCoordinatesAxesDataSpec | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlParallelCoordinatesAxesDataSpec | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlParallelCoordinatesAxesDataSpec | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlParallelCoordinatesAxesDataSpec | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlParallelCoordinatesAxesDataSpec | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlParallelCoordinatesAxesDataSpec;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlParallelCoordinatesAxesDataSpec;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlParallelCoordinatesAxesDataSpec;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlParallelCoordinatesAxesDataSpec;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlParallelCoordinatesAxesDataSpec;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlParallelCoordinatesAxesDataSpec;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlParallelCoordinatesAxesDataSpec;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): UiSdlParallelCoordinatesAxesDataSpec;
   ...
   */
  static cachedEmptyInst(): UiSdlParallelCoordinatesAxesDataSpec;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlParallelCoordinatesAxesDataSpec>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlParallelCoordinatesAxesDataSpec;
   ...
   */
  static getDataTypeName(dataSpec?: UiSdlParallelCoordinatesAxesDataSpec | null): string | null;
