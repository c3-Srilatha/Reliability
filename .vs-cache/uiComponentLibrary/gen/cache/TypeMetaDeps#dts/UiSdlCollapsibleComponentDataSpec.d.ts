// TypeScript definitions for the C3 type UiSdlCollapsibleComponentDataSpec

/**
 * A UI component data spec for the header of a collapsible component.
 *
 * @remarks this represents a value passed to a method that expects an instance of UiSdlCollapsibleComponentDataSpec
 */
declare interface IUiSdlCollapsibleComponentDataSpec {
   ...
   */
  title?: IUiSdlFieldBasedDataSpecSetting | null;

  /**
   * Spec describing where to get the subtitle from.
   */
  subtitle?: IUiSdlFieldBasedDataSpecSetting | null;

  /**
   * Spec describing the secondaryTitle.
   */
  secondaryTitle?: IUiSdlFieldBasedDataSpecSetting | null;

  /**
   * Whether the secondaryTitle is rendered as text or a button.
   */
  secondaryTitleType?: string | null;
}
 ...
 */
declare class UiSdlCollapsibleComponentDataSpec extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlCollapsibleComponentDataSpec | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlCollapsibleComponentDataSpec | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlCollapsibleComponentDataSpec | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlCollapsibleComponentDataSpec | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlCollapsibleComponentDataSpec;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlCollapsibleComponentDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlCollapsibleComponentDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlCollapsibleComponentDataSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlCollapsibleComponentDataSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlCollapsibleComponentDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlCollapsibleComponentDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlCollapsibleComponentDataSpec;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlCollapsibleComponentDataSpec;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlCollapsibleComponentDataSpec;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlCollapsibleComponentDataSpec;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlCollapsibleComponentDataSpec;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlCollapsibleComponentDataSpec;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlCollapsibleComponentDataSpec;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlCollapsibleComponentDataSpec;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlCollapsibleComponentDataSpec;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlCollapsibleComponentDataSpec;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlCollapsibleComponentDataSpec;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlCollapsibleComponentDataSpec;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlCollapsibleComponentDataSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlCollapsibleComponentDataSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlCollapsibleComponentDataSpec;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlCollapsibleComponentDataSpec;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlCollapsibleComponentDataSpec;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlCollapsibleComponentDataSpec;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlCollapsibleComponentDataSpec;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlCollapsibleComponentDataSpec;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlCollapsibleComponentDataSpec;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlCollapsibleComponentDataSpec;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlCollapsibleComponentDataSpec;

  mergeJson(json: any | null): UiSdlCollapsibleComponentDataSpec;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlCollapsibleComponentDataSpec;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlCollapsibleComponentDataSpec;
   ...
   */
  singletonArray(): C3.Array<UiSdlCollapsibleComponentDataSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlCollapsibleComponentDataSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlCollapsibleComponentDataSpec | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlCollapsibleComponentDataSpec | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlCollapsibleComponentDataSpec | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlCollapsibleComponentDataSpec | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlCollapsibleComponentDataSpec | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlCollapsibleComponentDataSpec | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlCollapsibleComponentDataSpec | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlCollapsibleComponentDataSpec;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlCollapsibleComponentDataSpec;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlCollapsibleComponentDataSpec;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlCollapsibleComponentDataSpec;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlCollapsibleComponentDataSpec;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlCollapsibleComponentDataSpec;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlCollapsibleComponentDataSpec;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): UiSdlCollapsibleComponentDataSpec;
   ...
   */
  static cachedEmptyInst(): UiSdlCollapsibleComponentDataSpec;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlCollapsibleComponentDataSpec>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlCollapsibleComponentDataSpec;
   ...
   */
  static getDataTypeName(dataSpec?: UiSdlCollapsibleComponentDataSpec | null): string | null;
