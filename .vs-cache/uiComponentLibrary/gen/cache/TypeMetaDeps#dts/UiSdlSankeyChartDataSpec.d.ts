// TypeScript definitions for the C3 type UiSdlSankeyChartDataSpec
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of UiSdlSankeyChartDataSpec
 */
declare interface IUiSdlSankeyChartDataSpec {
   ...
   */
  nodeDataSpec?: IUiSdlSankeyChartNodeDataSpec | null;

  /**
   * The data spec of edges in the Sankey chart
   */
  edgeDataSpec?: IUiSdlSankeyChartEdgeDataSpec | null;
}
 ...
 */
declare class UiSdlSankeyChartDataSpec extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlSankeyChartDataSpec | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlSankeyChartDataSpec | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlSankeyChartDataSpec | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlSankeyChartDataSpec | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlSankeyChartDataSpec;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlSankeyChartDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlSankeyChartDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlSankeyChartDataSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlSankeyChartDataSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlSankeyChartDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlSankeyChartDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlSankeyChartDataSpec;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlSankeyChartDataSpec;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlSankeyChartDataSpec;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlSankeyChartDataSpec;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlSankeyChartDataSpec;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlSankeyChartDataSpec;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlSankeyChartDataSpec;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlSankeyChartDataSpec;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlSankeyChartDataSpec;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlSankeyChartDataSpec;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlSankeyChartDataSpec;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlSankeyChartDataSpec;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlSankeyChartDataSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlSankeyChartDataSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlSankeyChartDataSpec;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlSankeyChartDataSpec;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlSankeyChartDataSpec;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlSankeyChartDataSpec;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlSankeyChartDataSpec;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlSankeyChartDataSpec;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlSankeyChartDataSpec;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlSankeyChartDataSpec;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlSankeyChartDataSpec;

  mergeJson(json: any | null): UiSdlSankeyChartDataSpec;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlSankeyChartDataSpec;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlSankeyChartDataSpec;
   ...
   */
  singletonArray(): C3.Array<UiSdlSankeyChartDataSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlSankeyChartDataSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlSankeyChartDataSpec | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlSankeyChartDataSpec | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlSankeyChartDataSpec | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlSankeyChartDataSpec | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlSankeyChartDataSpec | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlSankeyChartDataSpec | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlSankeyChartDataSpec | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlSankeyChartDataSpec;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlSankeyChartDataSpec;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlSankeyChartDataSpec;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlSankeyChartDataSpec;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlSankeyChartDataSpec;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlSankeyChartDataSpec;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlSankeyChartDataSpec;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): UiSdlSankeyChartDataSpec;
   ...
   */
  static cachedEmptyInst(): UiSdlSankeyChartDataSpec;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlSankeyChartDataSpec>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlSankeyChartDataSpec;
   ...
   */
  static getDataTypeName(dataSpec?: UiSdlSankeyChartDataSpec | null): string | null;
