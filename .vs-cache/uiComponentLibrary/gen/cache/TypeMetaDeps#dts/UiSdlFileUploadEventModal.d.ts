// TypeScript definitions for the C3 type UiSdlFileUploadEventModal

/**
 * A UI component type that represents a file uploader event.
 *
 * @remarks this represents a value passed to a method that expects an instance of UiSdlFileUploadEventModal
 */
declare interface IUiSdlFileUploadEventModal {
 ...
 */
declare class UiSdlFileUploadEventModal extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlFileUploadEventModal | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlFileUploadEventModal | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlFileUploadEventModal | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlFileUploadEventModal | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlFileUploadEventModal;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlFileUploadEventModal;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlFileUploadEventModal;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlFileUploadEventModal | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlFileUploadEventModal | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlFileUploadEventModal;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlFileUploadEventModal;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlFileUploadEventModal;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlFileUploadEventModal;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlFileUploadEventModal;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlFileUploadEventModal;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlFileUploadEventModal;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlFileUploadEventModal;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlFileUploadEventModal;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlFileUploadEventModal;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlFileUploadEventModal;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlFileUploadEventModal;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlFileUploadEventModal;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlFileUploadEventModal;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlFileUploadEventModal;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlFileUploadEventModal;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlFileUploadEventModal;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlFileUploadEventModal;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlFileUploadEventModal;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlFileUploadEventModal;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlFileUploadEventModal;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlFileUploadEventModal;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlFileUploadEventModal;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlFileUploadEventModal;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlFileUploadEventModal;

  mergeJson(json: any | null): UiSdlFileUploadEventModal;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlFileUploadEventModal;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlFileUploadEventModal;
   ...
   */
  singletonArray(): C3.Array<UiSdlFileUploadEventModal | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlFileUploadEventModal | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlFileUploadEventModal | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlFileUploadEventModal | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlFileUploadEventModal | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlFileUploadEventModal | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlFileUploadEventModal | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlFileUploadEventModal | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlFileUploadEventModal | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlFileUploadEventModal;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlFileUploadEventModal;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlFileUploadEventModal;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlFileUploadEventModal;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlFileUploadEventModal;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlFileUploadEventModal;
   ...
   * @see #fromString
   */
  static make(s: string | null): UiSdlFileUploadEventModal | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlFileUploadEventModal;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): UiSdlFileUploadEventModal;
   ...
   */
  static cachedEmptyInst(): UiSdlFileUploadEventModal;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlFileUploadEventModal>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlFileUploadEventModal;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<UiSdlFileUploadEventModal | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<UiSdlFileUploadEventModal | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<UiSdlFileUploadEventModal | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<UiSdlFileUploadEventModal | null> | null>;
   ...
   */
  dependencies(): MetadataDeps<UiSdlFileUploadEventModal | null>;

  save(subPath?: string | null, contentType?: string | null): UiSdlFileUploadEventModal;
  ...
  update(srcObj?: UiSdlFileUploadEventModal | null, spec?: UpsertSpec | null): UiSdlFileUploadEventModal | null;

  upsert(srcObj?: UiSdlFileUploadEventModal | null, spec?: UpsertSpec | null): UiSdlFileUploadEventModal | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): UiSdlFileUploadEventModal | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string | null, failIfMissing?: boolean): UiSdlFileUploadEventModal | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: UiSdlFileUploadEventModal, state: UiSdlReduxState): UiSdlFileUploadEventModal | null;
