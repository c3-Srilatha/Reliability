// TypeScript definitions for the C3 type UiSdlCollapsibleNavigationDataSpec

/**
 * The specification of data retrieval for instances of the {@link UiSdlCollapsibleNavigation} component type.
 *
 * @remarks this represents a value passed to a method that expects an instance of UiSdlCollapsibleNavigationDataSpec
 */
declare interface IUiSdlCollapsibleNavigationDataSpec {
   ...
   */
  navigationItems?: C3.Array<UiSdlCollapsibleNavigationItem | null> | Array<IUiSdlCollapsibleNavigationItem | null>;
 ...
 */
declare class UiSdlCollapsibleNavigationDataSpec extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlCollapsibleNavigationDataSpec | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlCollapsibleNavigationDataSpec | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlCollapsibleNavigationDataSpec | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlCollapsibleNavigationDataSpec | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlCollapsibleNavigationDataSpec;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlCollapsibleNavigationDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlCollapsibleNavigationDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlCollapsibleNavigationDataSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlCollapsibleNavigationDataSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlCollapsibleNavigationDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlCollapsibleNavigationDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlCollapsibleNavigationDataSpec;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlCollapsibleNavigationDataSpec;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlCollapsibleNavigationDataSpec;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlCollapsibleNavigationDataSpec;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlCollapsibleNavigationDataSpec;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlCollapsibleNavigationDataSpec;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlCollapsibleNavigationDataSpec;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlCollapsibleNavigationDataSpec;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlCollapsibleNavigationDataSpec;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlCollapsibleNavigationDataSpec;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlCollapsibleNavigationDataSpec;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlCollapsibleNavigationDataSpec;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlCollapsibleNavigationDataSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlCollapsibleNavigationDataSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlCollapsibleNavigationDataSpec;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlCollapsibleNavigationDataSpec;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlCollapsibleNavigationDataSpec;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlCollapsibleNavigationDataSpec;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlCollapsibleNavigationDataSpec;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlCollapsibleNavigationDataSpec;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlCollapsibleNavigationDataSpec;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlCollapsibleNavigationDataSpec;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlCollapsibleNavigationDataSpec;

  mergeJson(json: any | null): UiSdlCollapsibleNavigationDataSpec;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlCollapsibleNavigationDataSpec;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlCollapsibleNavigationDataSpec;
   ...
   */
  singletonArray(): C3.Array<UiSdlCollapsibleNavigationDataSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlCollapsibleNavigationDataSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlCollapsibleNavigationDataSpec | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlCollapsibleNavigationDataSpec | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlCollapsibleNavigationDataSpec | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlCollapsibleNavigationDataSpec | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlCollapsibleNavigationDataSpec | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlCollapsibleNavigationDataSpec | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlCollapsibleNavigationDataSpec | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlCollapsibleNavigationDataSpec;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlCollapsibleNavigationDataSpec;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlCollapsibleNavigationDataSpec;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlCollapsibleNavigationDataSpec;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlCollapsibleNavigationDataSpec;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlCollapsibleNavigationDataSpec;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlCollapsibleNavigationDataSpec;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): UiSdlCollapsibleNavigationDataSpec;
   ...
   */
  static cachedEmptyInst(): UiSdlCollapsibleNavigationDataSpec;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlCollapsibleNavigationDataSpec>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlCollapsibleNavigationDataSpec;
   ...
   */
  static getDataTypeName(dataSpec?: UiSdlCollapsibleNavigationDataSpec | null): string | null;
