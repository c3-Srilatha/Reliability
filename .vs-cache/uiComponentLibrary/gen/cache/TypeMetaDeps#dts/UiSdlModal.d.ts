// TypeScript definitions for the C3 type UiSdlModal

/**
 * A UI component type that represents a modal.
 *
 * @remarks this represents a value passed to a method that expects an instance of UiSdlModal
 */
declare interface IUiSdlModal {
 ...
 */
declare class UiSdlModal extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlModal | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlModal | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlModal | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlModal | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlModal;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlModal;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlModal;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlModal | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlModal | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlModal;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlModal;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlModal;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlModal;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlModal;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlModal;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlModal;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlModal;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlModal;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlModal;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlModal;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlModal;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlModal;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlModal;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlModal;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlModal;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlModal;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlModal;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlModal;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlModal;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlModal;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlModal;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlModal;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlModal;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlModal;

  mergeJson(json: any | null): UiSdlModal;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlModal;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlModal;
   ...
   */
  singletonArray(): C3.Array<UiSdlModal | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlModal | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlModal | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlModal | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlModal | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlModal | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlModal | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlModal | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlModal | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlModal;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlModal;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlModal;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlModal;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlModal;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlModal;
   ...
   * @see #fromString
   */
  static make(s: string | null): UiSdlModal | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlModal;
   ...
   */
  static cachedEmptyInst(): UiSdlModal;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlModal>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlModal;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<UiSdlModal | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<UiSdlModal | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<UiSdlModal | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<UiSdlModal | null> | null>;
   ...
   */
  dependencies(): MetadataDeps<UiSdlModal | null>;

  save(subPath?: string | null, contentType?: string | null): UiSdlModal;
  ...
  update(srcObj?: UiSdlModal | null, spec?: UpsertSpec | null): UiSdlModal | null;

  upsert(srcObj?: UiSdlModal | null, spec?: UpsertSpec | null): UiSdlModal | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): UiSdlModal | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string | null, failIfMissing?: boolean): UiSdlModal | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: UiSdlModal, state: UiSdlReduxState): UiSdlModal | null;
