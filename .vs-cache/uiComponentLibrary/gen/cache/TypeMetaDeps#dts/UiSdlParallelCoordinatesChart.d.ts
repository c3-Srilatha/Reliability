// TypeScript definitions for the C3 type UiSdlParallelCoordinatesChart
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of UiSdlParallelCoordinatesChart
 */
declare interface IUiSdlParallelCoordinatesChart {
 ...
 */
declare class UiSdlParallelCoordinatesChart extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlParallelCoordinatesChart | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlParallelCoordinatesChart | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlParallelCoordinatesChart | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlParallelCoordinatesChart | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlParallelCoordinatesChart;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlParallelCoordinatesChart;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlParallelCoordinatesChart;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlParallelCoordinatesChart | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlParallelCoordinatesChart | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlParallelCoordinatesChart;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlParallelCoordinatesChart;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlParallelCoordinatesChart;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlParallelCoordinatesChart;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlParallelCoordinatesChart;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlParallelCoordinatesChart;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlParallelCoordinatesChart;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlParallelCoordinatesChart;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlParallelCoordinatesChart;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlParallelCoordinatesChart;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlParallelCoordinatesChart;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlParallelCoordinatesChart;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlParallelCoordinatesChart;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlParallelCoordinatesChart;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlParallelCoordinatesChart;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlParallelCoordinatesChart;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlParallelCoordinatesChart;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlParallelCoordinatesChart;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlParallelCoordinatesChart;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlParallelCoordinatesChart;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlParallelCoordinatesChart;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlParallelCoordinatesChart;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlParallelCoordinatesChart;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlParallelCoordinatesChart;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlParallelCoordinatesChart;

  mergeJson(json: any | null): UiSdlParallelCoordinatesChart;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlParallelCoordinatesChart;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlParallelCoordinatesChart;
   ...
   */
  singletonArray(): C3.Array<UiSdlParallelCoordinatesChart | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlParallelCoordinatesChart | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlParallelCoordinatesChart | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlParallelCoordinatesChart | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlParallelCoordinatesChart | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlParallelCoordinatesChart | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlParallelCoordinatesChart | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlParallelCoordinatesChart | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlParallelCoordinatesChart | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlParallelCoordinatesChart;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlParallelCoordinatesChart;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlParallelCoordinatesChart;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlParallelCoordinatesChart;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlParallelCoordinatesChart;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlParallelCoordinatesChart;
   ...
   * @see #fromString
   */
  static make(s: string | null): UiSdlParallelCoordinatesChart | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlParallelCoordinatesChart;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): UiSdlParallelCoordinatesChart;
   ...
   */
  static cachedEmptyInst(): UiSdlParallelCoordinatesChart;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlParallelCoordinatesChart>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlParallelCoordinatesChart;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<UiSdlParallelCoordinatesChart | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<UiSdlParallelCoordinatesChart | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<UiSdlParallelCoordinatesChart | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<UiSdlParallelCoordinatesChart | null> | null>;
   ...
   */
  dependencies(): MetadataDeps<UiSdlParallelCoordinatesChart | null>;

  save(subPath?: string | null, contentType?: string | null): UiSdlParallelCoordinatesChart;
  ...
  update(srcObj?: UiSdlParallelCoordinatesChart | null, spec?: UpsertSpec | null): UiSdlParallelCoordinatesChart | null;

  upsert(srcObj?: UiSdlParallelCoordinatesChart | null, spec?: UpsertSpec | null): UiSdlParallelCoordinatesChart | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): UiSdlParallelCoordinatesChart | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string | null, failIfMissing?: boolean): UiSdlParallelCoordinatesChart | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: UiSdlParallelCoordinatesChart, state: UiSdlReduxState): UiSdlParallelCoordinatesChart | null;
