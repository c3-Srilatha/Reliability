// TypeScript definitions for the C3 type UiSdlMetricTileEvalDataSpecKPITrendComparisonSetting

/**
 * Spec describing how to calculate KPI trend comparison result of a {@link UiSdlMetricTile}, using Feature.
 *
 * @remarks this represents a value passed to a method that expects an instance of UiSdlMetricTileEvalDataSpecKPITrendComparisonSetting
 */
declare interface IUiSdlMetricTileEvalDataSpecKPITrendComparisonSetting {
 ...
 */
declare class UiSdlMetricTileEvalDataSpecKPITrendComparisonSetting extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlMetricTileEvalDataSpecKPITrendComparisonSetting | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlMetricTileEvalDataSpecKPITrendComparisonSetting | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlMetricTileEvalDataSpecKPITrendComparisonSetting | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlMetricTileEvalDataSpecKPITrendComparisonSetting | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlMetricTileEvalDataSpecKPITrendComparisonSetting;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlMetricTileEvalDataSpecKPITrendComparisonSetting;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlMetricTileEvalDataSpecKPITrendComparisonSetting;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlMetricTileEvalDataSpecKPITrendComparisonSetting | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlMetricTileEvalDataSpecKPITrendComparisonSetting | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlMetricTileEvalDataSpecKPITrendComparisonSetting;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlMetricTileEvalDataSpecKPITrendComparisonSetting;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlMetricTileEvalDataSpecKPITrendComparisonSetting;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlMetricTileEvalDataSpecKPITrendComparisonSetting;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlMetricTileEvalDataSpecKPITrendComparisonSetting;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlMetricTileEvalDataSpecKPITrendComparisonSetting;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlMetricTileEvalDataSpecKPITrendComparisonSetting;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlMetricTileEvalDataSpecKPITrendComparisonSetting;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlMetricTileEvalDataSpecKPITrendComparisonSetting;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlMetricTileEvalDataSpecKPITrendComparisonSetting;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlMetricTileEvalDataSpecKPITrendComparisonSetting;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlMetricTileEvalDataSpecKPITrendComparisonSetting;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlMetricTileEvalDataSpecKPITrendComparisonSetting;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlMetricTileEvalDataSpecKPITrendComparisonSetting;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlMetricTileEvalDataSpecKPITrendComparisonSetting;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlMetricTileEvalDataSpecKPITrendComparisonSetting;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlMetricTileEvalDataSpecKPITrendComparisonSetting;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlMetricTileEvalDataSpecKPITrendComparisonSetting;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlMetricTileEvalDataSpecKPITrendComparisonSetting;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlMetricTileEvalDataSpecKPITrendComparisonSetting;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlMetricTileEvalDataSpecKPITrendComparisonSetting;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlMetricTileEvalDataSpecKPITrendComparisonSetting;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlMetricTileEvalDataSpecKPITrendComparisonSetting;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlMetricTileEvalDataSpecKPITrendComparisonSetting;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlMetricTileEvalDataSpecKPITrendComparisonSetting;

  mergeJson(json: any | null): UiSdlMetricTileEvalDataSpecKPITrendComparisonSetting;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlMetricTileEvalDataSpecKPITrendComparisonSetting;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlMetricTileEvalDataSpecKPITrendComparisonSetting;
   ...
   */
  singletonArray(): C3.Array<UiSdlMetricTileEvalDataSpecKPITrendComparisonSetting | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlMetricTileEvalDataSpecKPITrendComparisonSetting | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlMetricTileEvalDataSpecKPITrendComparisonSetting | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlMetricTileEvalDataSpecKPITrendComparisonSetting | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlMetricTileEvalDataSpecKPITrendComparisonSetting | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlMetricTileEvalDataSpecKPITrendComparisonSetting | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlMetricTileEvalDataSpecKPITrendComparisonSetting | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlMetricTileEvalDataSpecKPITrendComparisonSetting | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlMetricTileEvalDataSpecKPITrendComparisonSetting | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlMetricTileEvalDataSpecKPITrendComparisonSetting;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlMetricTileEvalDataSpecKPITrendComparisonSetting;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlMetricTileEvalDataSpecKPITrendComparisonSetting;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlMetricTileEvalDataSpecKPITrendComparisonSetting;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlMetricTileEvalDataSpecKPITrendComparisonSetting;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlMetricTileEvalDataSpecKPITrendComparisonSetting;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlMetricTileEvalDataSpecKPITrendComparisonSetting;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): UiSdlMetricTileEvalDataSpecKPITrendComparisonSetting;
   ...
   */
  static cachedEmptyInst(): UiSdlMetricTileEvalDataSpecKPITrendComparisonSetting;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlMetricTileEvalDataSpecKPITrendComparisonSetting>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlMetricTileEvalDataSpecKPITrendComparisonSetting;
   ...
   */
  static getDataTypeName(dataSpec?: UiSdlMetricTileEvalDataSpecKPITrendComparisonSetting | null): string | null;
