// TypeScript definitions for the C3 type UiSdlCategoricalLineBarChartDataSpec

/**
 * Type to represent the data spec for a {@link UiSdlCategoricalLineBarChart}.
 *
 * @remarks this represents a value passed to a method that expects an instance of UiSdlCategoricalLineBarChartDataSpec
 */
declare interface IUiSdlCategoricalLineBarChartDataSpec {
   ...
   */
  orderString?: IUiSdlCategoricalLineBarChartDataSpecOrderSetting | null;
   ...
   */
  xAxisField?: IUiSdlCategoricalLineBarChartXAxisDataSpecSetting | null;

  /**
   * The yAxis fields for the categorical chart.
   */
  yAxisFields?: C3.Array<UiSdlCategoricalLineBarChartYAxisDataSpecSetting | null> | Array<IUiSdlCategoricalLineBarChartYAxisDataSpecSetting | null>;

  /**
   * This field is set to true if ordering needs to be done on aggregation of multiple fields on the Y axis.
   */
  orderOnAggregateYAxisFields?: boolean;
 ...
 */
declare class UiSdlCategoricalLineBarChartDataSpec extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlCategoricalLineBarChartDataSpec | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlCategoricalLineBarChartDataSpec | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlCategoricalLineBarChartDataSpec | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlCategoricalLineBarChartDataSpec | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlCategoricalLineBarChartDataSpec;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlCategoricalLineBarChartDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlCategoricalLineBarChartDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlCategoricalLineBarChartDataSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlCategoricalLineBarChartDataSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlCategoricalLineBarChartDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlCategoricalLineBarChartDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlCategoricalLineBarChartDataSpec;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlCategoricalLineBarChartDataSpec;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlCategoricalLineBarChartDataSpec;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlCategoricalLineBarChartDataSpec;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlCategoricalLineBarChartDataSpec;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlCategoricalLineBarChartDataSpec;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlCategoricalLineBarChartDataSpec;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlCategoricalLineBarChartDataSpec;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlCategoricalLineBarChartDataSpec;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlCategoricalLineBarChartDataSpec;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlCategoricalLineBarChartDataSpec;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlCategoricalLineBarChartDataSpec;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlCategoricalLineBarChartDataSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlCategoricalLineBarChartDataSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlCategoricalLineBarChartDataSpec;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlCategoricalLineBarChartDataSpec;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlCategoricalLineBarChartDataSpec;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlCategoricalLineBarChartDataSpec;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlCategoricalLineBarChartDataSpec;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlCategoricalLineBarChartDataSpec;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlCategoricalLineBarChartDataSpec;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlCategoricalLineBarChartDataSpec;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlCategoricalLineBarChartDataSpec;

  mergeJson(json: any | null): UiSdlCategoricalLineBarChartDataSpec;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlCategoricalLineBarChartDataSpec;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlCategoricalLineBarChartDataSpec;
   ...
   */
  singletonArray(): C3.Array<UiSdlCategoricalLineBarChartDataSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlCategoricalLineBarChartDataSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlCategoricalLineBarChartDataSpec | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlCategoricalLineBarChartDataSpec | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlCategoricalLineBarChartDataSpec | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlCategoricalLineBarChartDataSpec | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlCategoricalLineBarChartDataSpec | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlCategoricalLineBarChartDataSpec | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlCategoricalLineBarChartDataSpec | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlCategoricalLineBarChartDataSpec;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlCategoricalLineBarChartDataSpec;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlCategoricalLineBarChartDataSpec;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlCategoricalLineBarChartDataSpec;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlCategoricalLineBarChartDataSpec;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlCategoricalLineBarChartDataSpec;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlCategoricalLineBarChartDataSpec;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): UiSdlCategoricalLineBarChartDataSpec;
   ...
   */
  static cachedEmptyInst(): UiSdlCategoricalLineBarChartDataSpec;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlCategoricalLineBarChartDataSpec>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlCategoricalLineBarChartDataSpec;
   ...
   */
  static getDataTypeName(dataSpec?: UiSdlCategoricalLineBarChartDataSpec | null): string | null;
   ...
   */
  buildGroupString(): string | null;

  /**
   * Helper function to build projection string.
   */
  buildProjectionString(): string | null;

  /**
   * Helper function to build order string.
   */
  buildOrderString(): string | null;
}
