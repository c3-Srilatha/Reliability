// TypeScript definitions for the C3 type UiSdlDiagramViewerAddOnTextGroupDataSpec
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of UiSdlDiagramViewerAddOnTextGroupDataSpec
 */
declare interface IUiSdlDiagramViewerAddOnTextGroupDataSpec {
 ...
 */
declare class UiSdlDiagramViewerAddOnTextGroupDataSpec extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlDiagramViewerAddOnTextGroupDataSpec | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlDiagramViewerAddOnTextGroupDataSpec | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlDiagramViewerAddOnTextGroupDataSpec | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlDiagramViewerAddOnTextGroupDataSpec | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlDiagramViewerAddOnTextGroupDataSpec;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlDiagramViewerAddOnTextGroupDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlDiagramViewerAddOnTextGroupDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlDiagramViewerAddOnTextGroupDataSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlDiagramViewerAddOnTextGroupDataSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlDiagramViewerAddOnTextGroupDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlDiagramViewerAddOnTextGroupDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlDiagramViewerAddOnTextGroupDataSpec;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlDiagramViewerAddOnTextGroupDataSpec;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlDiagramViewerAddOnTextGroupDataSpec;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlDiagramViewerAddOnTextGroupDataSpec;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlDiagramViewerAddOnTextGroupDataSpec;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlDiagramViewerAddOnTextGroupDataSpec;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlDiagramViewerAddOnTextGroupDataSpec;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlDiagramViewerAddOnTextGroupDataSpec;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlDiagramViewerAddOnTextGroupDataSpec;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlDiagramViewerAddOnTextGroupDataSpec;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlDiagramViewerAddOnTextGroupDataSpec;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlDiagramViewerAddOnTextGroupDataSpec;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlDiagramViewerAddOnTextGroupDataSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlDiagramViewerAddOnTextGroupDataSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlDiagramViewerAddOnTextGroupDataSpec;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlDiagramViewerAddOnTextGroupDataSpec;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlDiagramViewerAddOnTextGroupDataSpec;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlDiagramViewerAddOnTextGroupDataSpec;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlDiagramViewerAddOnTextGroupDataSpec;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlDiagramViewerAddOnTextGroupDataSpec;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlDiagramViewerAddOnTextGroupDataSpec;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlDiagramViewerAddOnTextGroupDataSpec;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlDiagramViewerAddOnTextGroupDataSpec;

  mergeJson(json: any | null): UiSdlDiagramViewerAddOnTextGroupDataSpec;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlDiagramViewerAddOnTextGroupDataSpec;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlDiagramViewerAddOnTextGroupDataSpec;
   ...
   */
  singletonArray(): C3.Array<UiSdlDiagramViewerAddOnTextGroupDataSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlDiagramViewerAddOnTextGroupDataSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlDiagramViewerAddOnTextGroupDataSpec | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlDiagramViewerAddOnTextGroupDataSpec | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlDiagramViewerAddOnTextGroupDataSpec | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlDiagramViewerAddOnTextGroupDataSpec | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlDiagramViewerAddOnTextGroupDataSpec | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlDiagramViewerAddOnTextGroupDataSpec | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlDiagramViewerAddOnTextGroupDataSpec | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlDiagramViewerAddOnTextGroupDataSpec;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlDiagramViewerAddOnTextGroupDataSpec;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlDiagramViewerAddOnTextGroupDataSpec;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlDiagramViewerAddOnTextGroupDataSpec;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlDiagramViewerAddOnTextGroupDataSpec;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlDiagramViewerAddOnTextGroupDataSpec;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlDiagramViewerAddOnTextGroupDataSpec;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): UiSdlDiagramViewerAddOnTextGroupDataSpec;
   ...
   */
  static cachedEmptyInst(): UiSdlDiagramViewerAddOnTextGroupDataSpec;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlDiagramViewerAddOnTextGroupDataSpec>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlDiagramViewerAddOnTextGroupDataSpec;
   ...
   */
  static getDataTypeName(dataSpec?: UiSdlDiagramViewerAddOnTextGroupDataSpec | null): string | null;
