// TypeScript definitions for the C3 type LukeTestUiSdlFormBase
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of LukeTestUiSdlFormBase
 */
declare interface ILukeTestUiSdlFormBase {
 ...
 */
declare class LukeTestUiSdlFormBase extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): LukeTestUiSdlFormBase | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): LukeTestUiSdlFormBase | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): LukeTestUiSdlFormBase | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): LukeTestUiSdlFormBase | null;
   ...
   */
  replaceType(old: Type, new_: Type): LukeTestUiSdlFormBase;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): LukeTestUiSdlFormBase;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): LukeTestUiSdlFormBase;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<LukeTestUiSdlFormBase | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<LukeTestUiSdlFormBase | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): LukeTestUiSdlFormBase;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): LukeTestUiSdlFormBase;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): LukeTestUiSdlFormBase;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): LukeTestUiSdlFormBase;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): LukeTestUiSdlFormBase;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): LukeTestUiSdlFormBase;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): LukeTestUiSdlFormBase;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): LukeTestUiSdlFormBase;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): LukeTestUiSdlFormBase;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): LukeTestUiSdlFormBase;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): LukeTestUiSdlFormBase;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): LukeTestUiSdlFormBase;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): LukeTestUiSdlFormBase;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): LukeTestUiSdlFormBase;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): LukeTestUiSdlFormBase;
   ...
   * @see #unsetField
   */
  defaultField(field: string): LukeTestUiSdlFormBase;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): LukeTestUiSdlFormBase;
   ...
   * @see #removeField
   */
  unsetField(field: string): LukeTestUiSdlFormBase;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): LukeTestUiSdlFormBase;
   ...
   * @see #unsetField
   */
  removeField(field: string): LukeTestUiSdlFormBase;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): LukeTestUiSdlFormBase;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): LukeTestUiSdlFormBase;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): LukeTestUiSdlFormBase;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): LukeTestUiSdlFormBase;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): LukeTestUiSdlFormBase;

  mergeJson(json: any | null): LukeTestUiSdlFormBase;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): LukeTestUiSdlFormBase;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): LukeTestUiSdlFormBase;
   ...
   */
  singletonArray(): C3.Array<LukeTestUiSdlFormBase | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<LukeTestUiSdlFormBase | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<LukeTestUiSdlFormBase | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<LukeTestUiSdlFormBase | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<LukeTestUiSdlFormBase | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, LukeTestUiSdlFormBase | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, LukeTestUiSdlFormBase | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<LukeTestUiSdlFormBase | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<LukeTestUiSdlFormBase | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): LukeTestUiSdlFormBase;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): LukeTestUiSdlFormBase;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): LukeTestUiSdlFormBase;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): LukeTestUiSdlFormBase;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): LukeTestUiSdlFormBase;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): LukeTestUiSdlFormBase;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): LukeTestUiSdlFormBase;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): LukeTestUiSdlFormBase;
   ...
   */
  static cachedEmptyInst(): LukeTestUiSdlFormBase;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<LukeTestUiSdlFormBase>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): LukeTestUiSdlFormBase;
