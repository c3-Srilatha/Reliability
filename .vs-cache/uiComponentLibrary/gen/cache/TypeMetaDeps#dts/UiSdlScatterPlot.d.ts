// TypeScript definitions for the C3 type UiSdlScatterPlot

/**
 * A UI component type that displays data in a scatter plot.
 *
 * @remarks this represents a value passed to a method that expects an instance of UiSdlScatterPlot
 */
declare interface IUiSdlScatterPlot {
 ...
 */
declare class UiSdlScatterPlot extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlScatterPlot | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlScatterPlot | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlScatterPlot | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlScatterPlot | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlScatterPlot;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlScatterPlot;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlScatterPlot;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlScatterPlot | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlScatterPlot | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlScatterPlot;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlScatterPlot;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlScatterPlot;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlScatterPlot;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlScatterPlot;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlScatterPlot;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlScatterPlot;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlScatterPlot;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlScatterPlot;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlScatterPlot;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlScatterPlot;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlScatterPlot;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlScatterPlot;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlScatterPlot;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlScatterPlot;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlScatterPlot;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlScatterPlot;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlScatterPlot;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlScatterPlot;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlScatterPlot;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlScatterPlot;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlScatterPlot;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlScatterPlot;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlScatterPlot;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlScatterPlot;

  mergeJson(json: any | null): UiSdlScatterPlot;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlScatterPlot;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlScatterPlot;
   ...
   */
  singletonArray(): C3.Array<UiSdlScatterPlot | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlScatterPlot | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlScatterPlot | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlScatterPlot | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlScatterPlot | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlScatterPlot | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlScatterPlot | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlScatterPlot | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlScatterPlot | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlScatterPlot;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlScatterPlot;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlScatterPlot;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlScatterPlot;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlScatterPlot;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlScatterPlot;
   ...
   * @see #fromString
   */
  static make(s: string | null): UiSdlScatterPlot | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlScatterPlot;
   ...
   */
  static cachedEmptyInst(): UiSdlScatterPlot;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlScatterPlot>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlScatterPlot;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<UiSdlScatterPlot | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<UiSdlScatterPlot | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<UiSdlScatterPlot | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<UiSdlScatterPlot | null> | null>;
   ...
   */
  dependencies(): MetadataDeps<UiSdlScatterPlot | null>;

  save(subPath?: string | null, contentType?: string | null): UiSdlScatterPlot;
  ...
  update(srcObj?: UiSdlScatterPlot | null, spec?: UpsertSpec | null): UiSdlScatterPlot | null;

  upsert(srcObj?: UiSdlScatterPlot | null, spec?: UpsertSpec | null): UiSdlScatterPlot | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): UiSdlScatterPlot | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string | null, failIfMissing?: boolean): UiSdlScatterPlot | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: UiSdlScatterPlot, state: UiSdlReduxState): UiSdlScatterPlot | null;
