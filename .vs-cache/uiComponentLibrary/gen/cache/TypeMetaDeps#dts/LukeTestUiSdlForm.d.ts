// TypeScript definitions for the C3 type LukeTestUiSdlForm

/**
 * Representation of the {@link UiSdlForm} component for testing purposes.
 *
 * @remarks this represents a value passed to a method that expects an instance of LukeTestUiSdlForm
 */
declare interface ILukeTestUiSdlForm {
 ...
 */
declare class LukeTestUiSdlForm extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): LukeTestUiSdlForm | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): LukeTestUiSdlForm | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): LukeTestUiSdlForm | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): LukeTestUiSdlForm | null;
   ...
   */
  replaceType(old: Type, new_: Type): LukeTestUiSdlForm;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): LukeTestUiSdlForm;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): LukeTestUiSdlForm;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<LukeTestUiSdlForm | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<LukeTestUiSdlForm | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): LukeTestUiSdlForm;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): LukeTestUiSdlForm;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): LukeTestUiSdlForm;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): LukeTestUiSdlForm;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): LukeTestUiSdlForm;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): LukeTestUiSdlForm;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): LukeTestUiSdlForm;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): LukeTestUiSdlForm;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): LukeTestUiSdlForm;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): LukeTestUiSdlForm;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): LukeTestUiSdlForm;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): LukeTestUiSdlForm;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): LukeTestUiSdlForm;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): LukeTestUiSdlForm;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): LukeTestUiSdlForm;
   ...
   * @see #unsetField
   */
  defaultField(field: string): LukeTestUiSdlForm;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): LukeTestUiSdlForm;
   ...
   * @see #removeField
   */
  unsetField(field: string): LukeTestUiSdlForm;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): LukeTestUiSdlForm;
   ...
   * @see #unsetField
   */
  removeField(field: string): LukeTestUiSdlForm;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): LukeTestUiSdlForm;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): LukeTestUiSdlForm;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): LukeTestUiSdlForm;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): LukeTestUiSdlForm;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): LukeTestUiSdlForm;

  mergeJson(json: any | null): LukeTestUiSdlForm;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): LukeTestUiSdlForm;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): LukeTestUiSdlForm;
   ...
   */
  singletonArray(): C3.Array<LukeTestUiSdlForm | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<LukeTestUiSdlForm | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<LukeTestUiSdlForm | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<LukeTestUiSdlForm | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<LukeTestUiSdlForm | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, LukeTestUiSdlForm | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, LukeTestUiSdlForm | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<LukeTestUiSdlForm | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<LukeTestUiSdlForm | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): LukeTestUiSdlForm;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): LukeTestUiSdlForm;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): LukeTestUiSdlForm;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): LukeTestUiSdlForm;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): LukeTestUiSdlForm;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): LukeTestUiSdlForm;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): LukeTestUiSdlForm;
   ...
   */
  static cachedEmptyInst(): LukeTestUiSdlForm;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<LukeTestUiSdlForm>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): LukeTestUiSdlForm;
