// TypeScript definitions for the C3 type UiSdlMultiStepModalStep

/**
 * Used inside {@link UiSdlMultiStepModal}.
 *
 * @remarks this represents a value passed to a method that expects an instance of UiSdlMultiStepModalStep
 */
declare interface IUiSdlMultiStepModalStep {
 ...
 */
declare class UiSdlMultiStepModalStep extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlMultiStepModalStep | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlMultiStepModalStep | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlMultiStepModalStep | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlMultiStepModalStep | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlMultiStepModalStep;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlMultiStepModalStep;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlMultiStepModalStep;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlMultiStepModalStep | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlMultiStepModalStep | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlMultiStepModalStep;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlMultiStepModalStep;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlMultiStepModalStep;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlMultiStepModalStep;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlMultiStepModalStep;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlMultiStepModalStep;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlMultiStepModalStep;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlMultiStepModalStep;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlMultiStepModalStep;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlMultiStepModalStep;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlMultiStepModalStep;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlMultiStepModalStep;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlMultiStepModalStep;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlMultiStepModalStep;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlMultiStepModalStep;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlMultiStepModalStep;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlMultiStepModalStep;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlMultiStepModalStep;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlMultiStepModalStep;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlMultiStepModalStep;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlMultiStepModalStep;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlMultiStepModalStep;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlMultiStepModalStep;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlMultiStepModalStep;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlMultiStepModalStep;

  mergeJson(json: any | null): UiSdlMultiStepModalStep;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlMultiStepModalStep;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlMultiStepModalStep;
   ...
   */
  singletonArray(): C3.Array<UiSdlMultiStepModalStep | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlMultiStepModalStep | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlMultiStepModalStep | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlMultiStepModalStep | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlMultiStepModalStep | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlMultiStepModalStep | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlMultiStepModalStep | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlMultiStepModalStep | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlMultiStepModalStep | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlMultiStepModalStep;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlMultiStepModalStep;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlMultiStepModalStep;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlMultiStepModalStep;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlMultiStepModalStep;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlMultiStepModalStep;
   ...
   * @see #fromString
   */
  static make(s: string | null): UiSdlMultiStepModalStep | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlMultiStepModalStep;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): UiSdlMultiStepModalStep;
   ...
   */
  static cachedEmptyInst(): UiSdlMultiStepModalStep;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlMultiStepModalStep>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlMultiStepModalStep;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<UiSdlMultiStepModalStep | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<UiSdlMultiStepModalStep | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<UiSdlMultiStepModalStep | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<UiSdlMultiStepModalStep | null> | null>;
   ...
   */
  dependencies(): MetadataDeps<UiSdlMultiStepModalStep | null>;

  save(subPath?: string | null, contentType?: string | null): UiSdlMultiStepModalStep;
  ...
  update(srcObj?: UiSdlMultiStepModalStep | null, spec?: UpsertSpec | null): UiSdlMultiStepModalStep | null;

  upsert(srcObj?: UiSdlMultiStepModalStep | null, spec?: UpsertSpec | null): UiSdlMultiStepModalStep | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): UiSdlMultiStepModalStep | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string | null, failIfMissing?: boolean): UiSdlMultiStepModalStep | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: UiSdlMultiStepModalStep, state: UiSdlReduxState): UiSdlMultiStepModalStep | null;
