// TypeScript definitions for the C3 type UiSdlPieChart

/**
 * The UI component type that displays data in pie chart
 *
 * @remarks this represents a value passed to a method that expects an instance of UiSdlPieChart
 */
declare interface IUiSdlPieChart {
 ...
 */
declare class UiSdlPieChart extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlPieChart | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlPieChart | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlPieChart | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlPieChart | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlPieChart;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlPieChart;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlPieChart;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlPieChart | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlPieChart | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlPieChart;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlPieChart;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlPieChart;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlPieChart;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlPieChart;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlPieChart;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlPieChart;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlPieChart;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlPieChart;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlPieChart;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlPieChart;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlPieChart;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlPieChart;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlPieChart;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlPieChart;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlPieChart;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlPieChart;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlPieChart;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlPieChart;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlPieChart;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlPieChart;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlPieChart;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlPieChart;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlPieChart;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlPieChart;

  mergeJson(json: any | null): UiSdlPieChart;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlPieChart;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlPieChart;
   ...
   */
  singletonArray(): C3.Array<UiSdlPieChart | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlPieChart | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlPieChart | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlPieChart | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlPieChart | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlPieChart | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlPieChart | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlPieChart | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlPieChart | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlPieChart;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlPieChart;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlPieChart;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlPieChart;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlPieChart;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlPieChart;
   ...
   * @see #fromString
   */
  static make(s: string | null): UiSdlPieChart | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlPieChart;
   ...
   */
  static cachedEmptyInst(): UiSdlPieChart;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlPieChart>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlPieChart;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<UiSdlPieChart | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<UiSdlPieChart | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<UiSdlPieChart | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<UiSdlPieChart | null> | null>;
   ...
   */
  dependencies(): MetadataDeps<UiSdlPieChart | null>;

  save(subPath?: string | null, contentType?: string | null): UiSdlPieChart;
  ...
  update(srcObj?: UiSdlPieChart | null, spec?: UpsertSpec | null): UiSdlPieChart | null;

  upsert(srcObj?: UiSdlPieChart | null, spec?: UpsertSpec | null): UiSdlPieChart | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): UiSdlPieChart | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string | null, failIfMissing?: boolean): UiSdlPieChart | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: UiSdlPieChart, state: UiSdlReduxState): UiSdlPieChart | null;
