// TypeScript definitions for the C3 type UiSdlWaterfallChart

/**
 * Waterfall Chart Component
 *
 * @remarks this represents a value passed to a method that expects an instance of UiSdlWaterfallChart
 */
declare interface IUiSdlWaterfallChart {
 ...
 */
declare class UiSdlWaterfallChart extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlWaterfallChart | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlWaterfallChart | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlWaterfallChart | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlWaterfallChart | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlWaterfallChart;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlWaterfallChart;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlWaterfallChart;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlWaterfallChart | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlWaterfallChart | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlWaterfallChart;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlWaterfallChart;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlWaterfallChart;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlWaterfallChart;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlWaterfallChart;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlWaterfallChart;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlWaterfallChart;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlWaterfallChart;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlWaterfallChart;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlWaterfallChart;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlWaterfallChart;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlWaterfallChart;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlWaterfallChart;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlWaterfallChart;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlWaterfallChart;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlWaterfallChart;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlWaterfallChart;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlWaterfallChart;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlWaterfallChart;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlWaterfallChart;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlWaterfallChart;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlWaterfallChart;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlWaterfallChart;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlWaterfallChart;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlWaterfallChart;

  mergeJson(json: any | null): UiSdlWaterfallChart;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlWaterfallChart;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlWaterfallChart;
   ...
   */
  singletonArray(): C3.Array<UiSdlWaterfallChart | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlWaterfallChart | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlWaterfallChart | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlWaterfallChart | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlWaterfallChart | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlWaterfallChart | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlWaterfallChart | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlWaterfallChart | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlWaterfallChart | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlWaterfallChart;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlWaterfallChart;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlWaterfallChart;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlWaterfallChart;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlWaterfallChart;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlWaterfallChart;
   ...
   * @see #fromString
   */
  static make(s: string | null): UiSdlWaterfallChart | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlWaterfallChart;
   ...
   */
  static cachedEmptyInst(): UiSdlWaterfallChart;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlWaterfallChart>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlWaterfallChart;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<UiSdlWaterfallChart | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<UiSdlWaterfallChart | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<UiSdlWaterfallChart | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<UiSdlWaterfallChart | null> | null>;
   ...
   */
  dependencies(): MetadataDeps<UiSdlWaterfallChart | null>;

  save(subPath?: string | null, contentType?: string | null): UiSdlWaterfallChart;
  ...
  update(srcObj?: UiSdlWaterfallChart | null, spec?: UpsertSpec | null): UiSdlWaterfallChart | null;

  upsert(srcObj?: UiSdlWaterfallChart | null, spec?: UpsertSpec | null): UiSdlWaterfallChart | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): UiSdlWaterfallChart | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string | null, failIfMissing?: boolean): UiSdlWaterfallChart | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: UiSdlWaterfallChart, state: UiSdlReduxState): UiSdlWaterfallChart | null;
