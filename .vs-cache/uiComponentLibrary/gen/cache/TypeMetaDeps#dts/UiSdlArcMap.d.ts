// TypeScript definitions for the C3 type UiSdlArcMap
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of UiSdlArcMap
 */
declare interface IUiSdlArcMap {
 ...
 */
declare class UiSdlArcMap extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlArcMap | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlArcMap | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlArcMap | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlArcMap | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlArcMap;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlArcMap;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlArcMap;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlArcMap | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlArcMap | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlArcMap;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlArcMap;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlArcMap;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlArcMap;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlArcMap;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlArcMap;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlArcMap;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlArcMap;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlArcMap;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlArcMap;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlArcMap;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlArcMap;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlArcMap;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlArcMap;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlArcMap;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlArcMap;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlArcMap;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlArcMap;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlArcMap;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlArcMap;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlArcMap;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlArcMap;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlArcMap;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlArcMap;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlArcMap;

  mergeJson(json: any | null): UiSdlArcMap;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlArcMap;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlArcMap;
   ...
   */
  singletonArray(): C3.Array<UiSdlArcMap | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlArcMap | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlArcMap | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlArcMap | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlArcMap | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlArcMap | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlArcMap | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlArcMap | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlArcMap | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlArcMap;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlArcMap;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlArcMap;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlArcMap;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlArcMap;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlArcMap;
   ...
   * @see #fromString
   */
  static make(s: string | null): UiSdlArcMap | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlArcMap;
   ...
   */
  static cachedEmptyInst(): UiSdlArcMap;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlArcMap>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlArcMap;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<UiSdlArcMap | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<UiSdlArcMap | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<UiSdlArcMap | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<UiSdlArcMap | null> | null>;
   ...
   */
  dependencies(): MetadataDeps<UiSdlArcMap | null>;

  save(subPath?: string | null, contentType?: string | null): UiSdlArcMap;
  ...
  update(srcObj?: UiSdlArcMap | null, spec?: UpsertSpec | null): UiSdlArcMap | null;

  upsert(srcObj?: UiSdlArcMap | null, spec?: UpsertSpec | null): UiSdlArcMap | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): UiSdlArcMap | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string | null, failIfMissing?: boolean): UiSdlArcMap | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: UiSdlArcMap, state: UiSdlReduxState): UiSdlArcMap | null;
