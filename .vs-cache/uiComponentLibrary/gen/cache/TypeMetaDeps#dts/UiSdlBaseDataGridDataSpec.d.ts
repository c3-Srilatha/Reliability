// TypeScript definitions for the C3 type UiSdlBaseDataGridDataSpec

/**
 * Base dataspec type for {@link UiSdlDataGridDataSpec} and {@link UiSdlFormDataGridDataSpec}.
 *
 * @remarks this represents a value passed to a method that expects an instance of UiSdlBaseDataGridDataSpec
 */
declare interface IUiSdlBaseDataGridDataSpec {
 ...
 */
declare class UiSdlBaseDataGridDataSpec extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlBaseDataGridDataSpec | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlBaseDataGridDataSpec | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlBaseDataGridDataSpec | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlBaseDataGridDataSpec | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlBaseDataGridDataSpec;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlBaseDataGridDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlBaseDataGridDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlBaseDataGridDataSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlBaseDataGridDataSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlBaseDataGridDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlBaseDataGridDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlBaseDataGridDataSpec;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlBaseDataGridDataSpec;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlBaseDataGridDataSpec;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlBaseDataGridDataSpec;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlBaseDataGridDataSpec;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlBaseDataGridDataSpec;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlBaseDataGridDataSpec;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlBaseDataGridDataSpec;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlBaseDataGridDataSpec;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlBaseDataGridDataSpec;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlBaseDataGridDataSpec;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlBaseDataGridDataSpec;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlBaseDataGridDataSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlBaseDataGridDataSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlBaseDataGridDataSpec;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlBaseDataGridDataSpec;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlBaseDataGridDataSpec;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlBaseDataGridDataSpec;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlBaseDataGridDataSpec;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlBaseDataGridDataSpec;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlBaseDataGridDataSpec;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlBaseDataGridDataSpec;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlBaseDataGridDataSpec;

  mergeJson(json: any | null): UiSdlBaseDataGridDataSpec;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlBaseDataGridDataSpec;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlBaseDataGridDataSpec;
   ...
   */
  singletonArray(): C3.Array<UiSdlBaseDataGridDataSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlBaseDataGridDataSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlBaseDataGridDataSpec | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlBaseDataGridDataSpec | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlBaseDataGridDataSpec | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlBaseDataGridDataSpec | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlBaseDataGridDataSpec | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlBaseDataGridDataSpec | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlBaseDataGridDataSpec | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlBaseDataGridDataSpec;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlBaseDataGridDataSpec;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlBaseDataGridDataSpec;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlBaseDataGridDataSpec;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlBaseDataGridDataSpec;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlBaseDataGridDataSpec;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlBaseDataGridDataSpec;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): UiSdlBaseDataGridDataSpec;
   ...
   */
  static cachedEmptyInst(): UiSdlBaseDataGridDataSpec;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlBaseDataGridDataSpec>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlBaseDataGridDataSpec;
   ...
   */
  static getDataTypeName(dataSpec?: UiSdlBaseDataGridDataSpec | null): string | null;
