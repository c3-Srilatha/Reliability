// TypeScript definitions for the C3 type UiSdlParallelCoordinatesChartDataSpec

/**
 * The specification of data retrieval for instances of the {@link UiSdlParallelCoordinatesChart} component type.
 *
 * @remarks this represents a value passed to a method that expects an instance of UiSdlParallelCoordinatesChartDataSpec
 */
declare interface IUiSdlParallelCoordinatesChartDataSpec {
 ...
 */
declare class UiSdlParallelCoordinatesChartDataSpec extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlParallelCoordinatesChartDataSpec | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlParallelCoordinatesChartDataSpec | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlParallelCoordinatesChartDataSpec | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlParallelCoordinatesChartDataSpec | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlParallelCoordinatesChartDataSpec;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlParallelCoordinatesChartDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlParallelCoordinatesChartDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlParallelCoordinatesChartDataSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlParallelCoordinatesChartDataSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlParallelCoordinatesChartDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlParallelCoordinatesChartDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlParallelCoordinatesChartDataSpec;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlParallelCoordinatesChartDataSpec;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlParallelCoordinatesChartDataSpec;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlParallelCoordinatesChartDataSpec;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlParallelCoordinatesChartDataSpec;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlParallelCoordinatesChartDataSpec;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlParallelCoordinatesChartDataSpec;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlParallelCoordinatesChartDataSpec;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlParallelCoordinatesChartDataSpec;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlParallelCoordinatesChartDataSpec;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlParallelCoordinatesChartDataSpec;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlParallelCoordinatesChartDataSpec;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlParallelCoordinatesChartDataSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlParallelCoordinatesChartDataSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlParallelCoordinatesChartDataSpec;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlParallelCoordinatesChartDataSpec;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlParallelCoordinatesChartDataSpec;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlParallelCoordinatesChartDataSpec;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlParallelCoordinatesChartDataSpec;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlParallelCoordinatesChartDataSpec;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlParallelCoordinatesChartDataSpec;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlParallelCoordinatesChartDataSpec;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlParallelCoordinatesChartDataSpec;

  mergeJson(json: any | null): UiSdlParallelCoordinatesChartDataSpec;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlParallelCoordinatesChartDataSpec;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlParallelCoordinatesChartDataSpec;
   ...
   */
  singletonArray(): C3.Array<UiSdlParallelCoordinatesChartDataSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlParallelCoordinatesChartDataSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlParallelCoordinatesChartDataSpec | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlParallelCoordinatesChartDataSpec | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlParallelCoordinatesChartDataSpec | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlParallelCoordinatesChartDataSpec | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlParallelCoordinatesChartDataSpec | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlParallelCoordinatesChartDataSpec | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlParallelCoordinatesChartDataSpec | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlParallelCoordinatesChartDataSpec;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlParallelCoordinatesChartDataSpec;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlParallelCoordinatesChartDataSpec;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlParallelCoordinatesChartDataSpec;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlParallelCoordinatesChartDataSpec;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlParallelCoordinatesChartDataSpec;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlParallelCoordinatesChartDataSpec;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): UiSdlParallelCoordinatesChartDataSpec;
   ...
   */
  static cachedEmptyInst(): UiSdlParallelCoordinatesChartDataSpec;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlParallelCoordinatesChartDataSpec>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlParallelCoordinatesChartDataSpec;
   ...
   */
  static getDataTypeName(dataSpec?: UiSdlParallelCoordinatesChartDataSpec | null): string | null;
