// TypeScript definitions for the C3 type UiSdlWaterfallChartDataSpec

/**
 * Config Waterfall chart
 *
 * @remarks this represents a value passed to a method that expects an instance of UiSdlWaterfallChartDataSpec
 */
declare interface IUiSdlWaterfallChartDataSpec {
   ...
   */
  groupByField?: IUiSdlFieldBasedDataSpecSetting | null;

  /**
   * Fields to be used as evaluation metrics.
   */
  xAxisFields?: C3.Array<UiSdlWaterfallChartDataField | null> | Array<IUiSdlWaterfallChartDataField | null>;
}
 ...
 */
declare class UiSdlWaterfallChartDataSpec extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlWaterfallChartDataSpec | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlWaterfallChartDataSpec | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlWaterfallChartDataSpec | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlWaterfallChartDataSpec | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlWaterfallChartDataSpec;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlWaterfallChartDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlWaterfallChartDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlWaterfallChartDataSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlWaterfallChartDataSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlWaterfallChartDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlWaterfallChartDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlWaterfallChartDataSpec;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlWaterfallChartDataSpec;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlWaterfallChartDataSpec;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlWaterfallChartDataSpec;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlWaterfallChartDataSpec;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlWaterfallChartDataSpec;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlWaterfallChartDataSpec;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlWaterfallChartDataSpec;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlWaterfallChartDataSpec;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlWaterfallChartDataSpec;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlWaterfallChartDataSpec;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlWaterfallChartDataSpec;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlWaterfallChartDataSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlWaterfallChartDataSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlWaterfallChartDataSpec;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlWaterfallChartDataSpec;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlWaterfallChartDataSpec;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlWaterfallChartDataSpec;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlWaterfallChartDataSpec;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlWaterfallChartDataSpec;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlWaterfallChartDataSpec;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlWaterfallChartDataSpec;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlWaterfallChartDataSpec;

  mergeJson(json: any | null): UiSdlWaterfallChartDataSpec;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlWaterfallChartDataSpec;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlWaterfallChartDataSpec;
   ...
   */
  singletonArray(): C3.Array<UiSdlWaterfallChartDataSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlWaterfallChartDataSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlWaterfallChartDataSpec | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlWaterfallChartDataSpec | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlWaterfallChartDataSpec | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlWaterfallChartDataSpec | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlWaterfallChartDataSpec | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlWaterfallChartDataSpec | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlWaterfallChartDataSpec | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlWaterfallChartDataSpec;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlWaterfallChartDataSpec;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlWaterfallChartDataSpec;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlWaterfallChartDataSpec;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlWaterfallChartDataSpec;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlWaterfallChartDataSpec;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlWaterfallChartDataSpec;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): UiSdlWaterfallChartDataSpec;
   ...
   */
  static cachedEmptyInst(): UiSdlWaterfallChartDataSpec;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlWaterfallChartDataSpec>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlWaterfallChartDataSpec;
   ...
   */
  static getDataTypeName(dataSpec?: UiSdlWaterfallChartDataSpec | null): string | null;
