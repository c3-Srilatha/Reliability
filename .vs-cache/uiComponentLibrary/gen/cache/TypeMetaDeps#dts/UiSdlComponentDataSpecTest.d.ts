// TypeScript definitions for the C3 type UiSdlComponentDataSpecTest

/**
 * Test data spec to test {@link UiSdlComponent} functionality.
 *
 * @remarks this represents a value passed to a method that expects an instance of UiSdlComponentDataSpecTest
 */
declare interface IUiSdlComponentDataSpecTest {
   ...
   */
  fieldWithDefaultValue?: C3.Array<string | null> | Array<string | null>;
}
 ...
 */
declare class UiSdlComponentDataSpecTest extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlComponentDataSpecTest | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlComponentDataSpecTest | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlComponentDataSpecTest | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlComponentDataSpecTest | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlComponentDataSpecTest;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlComponentDataSpecTest;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlComponentDataSpecTest;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlComponentDataSpecTest | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlComponentDataSpecTest | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlComponentDataSpecTest;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlComponentDataSpecTest;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlComponentDataSpecTest;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlComponentDataSpecTest;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlComponentDataSpecTest;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlComponentDataSpecTest;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlComponentDataSpecTest;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlComponentDataSpecTest;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlComponentDataSpecTest;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlComponentDataSpecTest;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlComponentDataSpecTest;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlComponentDataSpecTest;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlComponentDataSpecTest;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlComponentDataSpecTest;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlComponentDataSpecTest;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlComponentDataSpecTest;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlComponentDataSpecTest;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlComponentDataSpecTest;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlComponentDataSpecTest;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlComponentDataSpecTest;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlComponentDataSpecTest;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlComponentDataSpecTest;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlComponentDataSpecTest;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlComponentDataSpecTest;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlComponentDataSpecTest;

  mergeJson(json: any | null): UiSdlComponentDataSpecTest;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlComponentDataSpecTest;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlComponentDataSpecTest;
   ...
   */
  singletonArray(): C3.Array<UiSdlComponentDataSpecTest | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlComponentDataSpecTest | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlComponentDataSpecTest | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlComponentDataSpecTest | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlComponentDataSpecTest | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlComponentDataSpecTest | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlComponentDataSpecTest | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlComponentDataSpecTest | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlComponentDataSpecTest | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlComponentDataSpecTest;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlComponentDataSpecTest;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlComponentDataSpecTest;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlComponentDataSpecTest;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlComponentDataSpecTest;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlComponentDataSpecTest;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlComponentDataSpecTest;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): UiSdlComponentDataSpecTest;
   ...
   */
  static cachedEmptyInst(): UiSdlComponentDataSpecTest;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlComponentDataSpecTest>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlComponentDataSpecTest;
   ...
   */
  static getDataTypeName(dataSpec?: UiSdlComponentDataSpecTest | null): string | null;
