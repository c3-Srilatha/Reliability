// TypeScript definitions for the C3 type UiSdlCategoricalLineBarChartMarkLineDataSpec

/**
 * @remarks this represents a value passed to a method that expects an instance of UiSdlCategoricalLineBarChartMarkLineDataSpec
 */
declare interface IUiSdlCategoricalLineBarChartMarkLineDataSpec {
   ...
   */
  markLinesConfig: C3.Array<UiSdlLineBarChartMarkLinesConfig | null> | Array<IUiSdlLineBarChartMarkLinesConfig | null>;
}

/**
 * @remarks this represents a made instance of UiSdlCategoricalLineBarChartMarkLineDataSpec
 */
declare class UiSdlCategoricalLineBarChartMarkLineDataSpec extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlCategoricalLineBarChartMarkLineDataSpec | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlCategoricalLineBarChartMarkLineDataSpec | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlCategoricalLineBarChartMarkLineDataSpec | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlCategoricalLineBarChartMarkLineDataSpec | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlCategoricalLineBarChartMarkLineDataSpec;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlCategoricalLineBarChartMarkLineDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlCategoricalLineBarChartMarkLineDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlCategoricalLineBarChartMarkLineDataSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlCategoricalLineBarChartMarkLineDataSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlCategoricalLineBarChartMarkLineDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlCategoricalLineBarChartMarkLineDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlCategoricalLineBarChartMarkLineDataSpec;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlCategoricalLineBarChartMarkLineDataSpec;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlCategoricalLineBarChartMarkLineDataSpec;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlCategoricalLineBarChartMarkLineDataSpec;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlCategoricalLineBarChartMarkLineDataSpec;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlCategoricalLineBarChartMarkLineDataSpec;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlCategoricalLineBarChartMarkLineDataSpec;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlCategoricalLineBarChartMarkLineDataSpec;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlCategoricalLineBarChartMarkLineDataSpec;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlCategoricalLineBarChartMarkLineDataSpec;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlCategoricalLineBarChartMarkLineDataSpec;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlCategoricalLineBarChartMarkLineDataSpec;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlCategoricalLineBarChartMarkLineDataSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlCategoricalLineBarChartMarkLineDataSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlCategoricalLineBarChartMarkLineDataSpec;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlCategoricalLineBarChartMarkLineDataSpec;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlCategoricalLineBarChartMarkLineDataSpec;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlCategoricalLineBarChartMarkLineDataSpec;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlCategoricalLineBarChartMarkLineDataSpec;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlCategoricalLineBarChartMarkLineDataSpec;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlCategoricalLineBarChartMarkLineDataSpec;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlCategoricalLineBarChartMarkLineDataSpec;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlCategoricalLineBarChartMarkLineDataSpec;

  mergeJson(json: any | null): UiSdlCategoricalLineBarChartMarkLineDataSpec;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlCategoricalLineBarChartMarkLineDataSpec;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlCategoricalLineBarChartMarkLineDataSpec;
   ...
   */
  singletonArray(): C3.Array<UiSdlCategoricalLineBarChartMarkLineDataSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlCategoricalLineBarChartMarkLineDataSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlCategoricalLineBarChartMarkLineDataSpec | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlCategoricalLineBarChartMarkLineDataSpec | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlCategoricalLineBarChartMarkLineDataSpec | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlCategoricalLineBarChartMarkLineDataSpec | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlCategoricalLineBarChartMarkLineDataSpec | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlCategoricalLineBarChartMarkLineDataSpec | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlCategoricalLineBarChartMarkLineDataSpec | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlCategoricalLineBarChartMarkLineDataSpec;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlCategoricalLineBarChartMarkLineDataSpec;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlCategoricalLineBarChartMarkLineDataSpec;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlCategoricalLineBarChartMarkLineDataSpec;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlCategoricalLineBarChartMarkLineDataSpec;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlCategoricalLineBarChartMarkLineDataSpec;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlCategoricalLineBarChartMarkLineDataSpec;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): UiSdlCategoricalLineBarChartMarkLineDataSpec;
   ...
   */
  static cachedEmptyInst(): UiSdlCategoricalLineBarChartMarkLineDataSpec;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlCategoricalLineBarChartMarkLineDataSpec>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlCategoricalLineBarChartMarkLineDataSpec;
   ...
   */
  static getDataTypeName(dataSpec?: UiSdlCategoricalLineBarChartMarkLineDataSpec | null): string | null;
