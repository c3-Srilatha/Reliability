// TypeScript definitions for the C3 type UiSdlMap
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of UiSdlMap
 */
declare interface IUiSdlMap {
   ...
   */
  dataSpec?: IUiSdlMapDataSpec | null;
   ...
   */
  markerData?: IFetchResult<Obj | null> | null;
   ...
   */
  layers?: C3.Array<UiSdlMapLayer | null> | Array<IUiSdlMapLayer | null>;
   ...
   */
  defaultMarkerShape?: string | null;
   ...
   */
  zoom?: IUiSdlMapAutoZoom | null | IUiSdlMapFixedZoom | null | null;
 ...
 */
declare class UiSdlMap extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlMap | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlMap | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlMap | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlMap | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlMap;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlMap;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlMap;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlMap | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlMap | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlMap;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlMap;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlMap;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlMap;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlMap;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlMap;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlMap;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlMap;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlMap;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlMap;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlMap;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlMap;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlMap;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlMap;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlMap;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlMap;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlMap;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlMap;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlMap;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlMap;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlMap;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlMap;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlMap;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlMap;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlMap;

  mergeJson(json: any | null): UiSdlMap;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlMap;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlMap;
   ...
   */
  singletonArray(): C3.Array<UiSdlMap | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlMap | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlMap | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlMap | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlMap | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlMap | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlMap | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlMap | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlMap | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlMap;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlMap;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlMap;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlMap;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlMap;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlMap;
   ...
   * @see #fromString
   */
  static make(s: string | null): UiSdlMap | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlMap;
   ...
   */
  static cachedEmptyInst(): UiSdlMap;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlMap>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlMap;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<UiSdlMap | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<UiSdlMap | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<UiSdlMap | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<UiSdlMap | null> | null>;
   ...
   */
  dependencies(): MetadataDeps<UiSdlMap | null>;

  save(subPath?: string | null, contentType?: string | null): UiSdlMap;
  ...
  update(srcObj?: UiSdlMap | null, spec?: UpsertSpec | null): UiSdlMap | null;

  upsert(srcObj?: UiSdlMap | null, spec?: UpsertSpec | null): UiSdlMap | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): UiSdlMap | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string | null, failIfMissing?: boolean): UiSdlMap | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: UiSdlMap, state: UiSdlReduxState): UiSdlMap | null;
