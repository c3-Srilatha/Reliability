// TypeScript definitions for the C3 type UiSdlHistogramDataSpec

/**
 * Type to represent the data spec for a {@link UiSdlHistogram}.
 *
 * @remarks this represents a value passed to a method that expects an instance of UiSdlHistogramDataSpec
 */
declare interface IUiSdlHistogramDataSpec {
   ...
   */
  yAxisFields?: C3.Array<UiSdlHistogramYAxisDataSpecSetting | null> | Array<IUiSdlHistogramYAxisDataSpecSetting | null>;
}
 ...
 */
declare class UiSdlHistogramDataSpec extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlHistogramDataSpec | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlHistogramDataSpec | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlHistogramDataSpec | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlHistogramDataSpec | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlHistogramDataSpec;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlHistogramDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlHistogramDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlHistogramDataSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlHistogramDataSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlHistogramDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlHistogramDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlHistogramDataSpec;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlHistogramDataSpec;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlHistogramDataSpec;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlHistogramDataSpec;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlHistogramDataSpec;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlHistogramDataSpec;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlHistogramDataSpec;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlHistogramDataSpec;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlHistogramDataSpec;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlHistogramDataSpec;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlHistogramDataSpec;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlHistogramDataSpec;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlHistogramDataSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlHistogramDataSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlHistogramDataSpec;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlHistogramDataSpec;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlHistogramDataSpec;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlHistogramDataSpec;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlHistogramDataSpec;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlHistogramDataSpec;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlHistogramDataSpec;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlHistogramDataSpec;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlHistogramDataSpec;

  mergeJson(json: any | null): UiSdlHistogramDataSpec;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlHistogramDataSpec;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlHistogramDataSpec;
   ...
   */
  singletonArray(): C3.Array<UiSdlHistogramDataSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlHistogramDataSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlHistogramDataSpec | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlHistogramDataSpec | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlHistogramDataSpec | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlHistogramDataSpec | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlHistogramDataSpec | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlHistogramDataSpec | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlHistogramDataSpec | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlHistogramDataSpec;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlHistogramDataSpec;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlHistogramDataSpec;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlHistogramDataSpec;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlHistogramDataSpec;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlHistogramDataSpec;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlHistogramDataSpec;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): UiSdlHistogramDataSpec;
   ...
   */
  static cachedEmptyInst(): UiSdlHistogramDataSpec;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlHistogramDataSpec>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlHistogramDataSpec;
   ...
   */
  static getDataTypeName(dataSpec?: UiSdlHistogramDataSpec | null): string | null;
   ...
   */
  buildProjectionString(dataSpec?: any | null): string | null;
   ...
   */
  static buildFilterString(dataSpec?: UiSdlHistogramDataSpec | null, additionalFilter?: string | null): string | null;
}
