// TypeScript definitions for the C3 type UiSdlMetricTile

/**
 * A UI component type that displays metric information and/or sparkline plot in a tile along with a header.
 *
 * @remarks this represents a value passed to a method that expects an instance of UiSdlMetricTile
 */
declare interface IUiSdlMetricTile {
 ...
 */
declare class UiSdlMetricTile extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlMetricTile | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlMetricTile | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlMetricTile | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlMetricTile | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlMetricTile;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlMetricTile;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlMetricTile;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlMetricTile | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlMetricTile | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlMetricTile;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlMetricTile;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlMetricTile;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlMetricTile;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlMetricTile;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlMetricTile;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlMetricTile;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlMetricTile;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlMetricTile;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlMetricTile;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlMetricTile;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlMetricTile;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlMetricTile;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlMetricTile;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlMetricTile;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlMetricTile;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlMetricTile;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlMetricTile;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlMetricTile;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlMetricTile;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlMetricTile;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlMetricTile;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlMetricTile;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlMetricTile;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlMetricTile;

  mergeJson(json: any | null): UiSdlMetricTile;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlMetricTile;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlMetricTile;
   ...
   */
  singletonArray(): C3.Array<UiSdlMetricTile | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlMetricTile | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlMetricTile | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlMetricTile | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlMetricTile | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlMetricTile | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlMetricTile | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlMetricTile | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlMetricTile | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlMetricTile;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlMetricTile;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlMetricTile;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlMetricTile;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlMetricTile;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlMetricTile;
   ...
   * @see #fromString
   */
  static make(s: string | null): UiSdlMetricTile | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlMetricTile;
   ...
   */
  static cachedEmptyInst(): UiSdlMetricTile;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlMetricTile>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlMetricTile;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<UiSdlMetricTile | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<UiSdlMetricTile | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<UiSdlMetricTile | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<UiSdlMetricTile | null> | null>;
   ...
   */
  dependencies(): MetadataDeps<UiSdlMetricTile | null>;

  save(subPath?: string | null, contentType?: string | null): UiSdlMetricTile;
  ...
  update(srcObj?: UiSdlMetricTile | null, spec?: UpsertSpec | null): UiSdlMetricTile | null;

  upsert(srcObj?: UiSdlMetricTile | null, spec?: UpsertSpec | null): UiSdlMetricTile | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): UiSdlMetricTile | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string | null, failIfMissing?: boolean): UiSdlMetricTile | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: UiSdlMetricTile, state: UiSdlReduxState): UiSdlMetricTile | null;
