// TypeScript definitions for the C3 type UiSdlTreeListSearchDataSpec

/**
 * Data spec for providing auto-completed search suggestions for {@link UiSdlTreeList}.
 *
 * @remarks this represents a value passed to a method that expects an instance of UiSdlTreeListSearchDataSpec
 */
declare interface IUiSdlTreeListSearchDataSpec {
 ...
 */
declare class UiSdlTreeListSearchDataSpec extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlTreeListSearchDataSpec | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlTreeListSearchDataSpec | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlTreeListSearchDataSpec | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlTreeListSearchDataSpec | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlTreeListSearchDataSpec;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlTreeListSearchDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlTreeListSearchDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlTreeListSearchDataSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlTreeListSearchDataSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlTreeListSearchDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlTreeListSearchDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlTreeListSearchDataSpec;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlTreeListSearchDataSpec;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlTreeListSearchDataSpec;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlTreeListSearchDataSpec;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlTreeListSearchDataSpec;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlTreeListSearchDataSpec;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlTreeListSearchDataSpec;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlTreeListSearchDataSpec;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlTreeListSearchDataSpec;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlTreeListSearchDataSpec;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlTreeListSearchDataSpec;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlTreeListSearchDataSpec;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlTreeListSearchDataSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlTreeListSearchDataSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlTreeListSearchDataSpec;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlTreeListSearchDataSpec;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlTreeListSearchDataSpec;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlTreeListSearchDataSpec;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlTreeListSearchDataSpec;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlTreeListSearchDataSpec;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlTreeListSearchDataSpec;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlTreeListSearchDataSpec;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlTreeListSearchDataSpec;

  mergeJson(json: any | null): UiSdlTreeListSearchDataSpec;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlTreeListSearchDataSpec;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlTreeListSearchDataSpec;
   ...
   */
  singletonArray(): C3.Array<UiSdlTreeListSearchDataSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlTreeListSearchDataSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlTreeListSearchDataSpec | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlTreeListSearchDataSpec | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlTreeListSearchDataSpec | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlTreeListSearchDataSpec | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlTreeListSearchDataSpec | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlTreeListSearchDataSpec | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlTreeListSearchDataSpec | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlTreeListSearchDataSpec;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlTreeListSearchDataSpec;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlTreeListSearchDataSpec;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlTreeListSearchDataSpec;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlTreeListSearchDataSpec;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlTreeListSearchDataSpec;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlTreeListSearchDataSpec;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): UiSdlTreeListSearchDataSpec;
   ...
   */
  static cachedEmptyInst(): UiSdlTreeListSearchDataSpec;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlTreeListSearchDataSpec>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlTreeListSearchDataSpec;
   ...
   */
  static getDataTypeName(dataSpec?: UiSdlTreeListSearchDataSpec | null): string | null;
