// TypeScript definitions for the C3 type UiSdlMetricTileEvalDataSpec

/**
 * The specification of data retrieval for instances of the {@link UiSdlTimeseriesLineBarChart} component type.
 *
 * @remarks this represents a value passed to a method that expects an instance of UiSdlMetricTileEvalDataSpec
 */
declare interface IUiSdlMetricTileEvalDataSpec {
   ...
   */
  mainValue?: IUiSdlMetricTileEvalDataSpecMainValueSetting | null;

  /**
   * Spec describing how to evaluate the KPI trend comparison section of the {@link UiSdlMetricTile}
   */
  kpiTrendComparison?: IUiSdlMetricTileEvalDataSpecKPITrendComparisonSetting | null;

  /**
   * Spec describing how to evaluate the historic sparkline plot for the {@link UiSdlMetricTile}.
   */
  historicSparkline?: IUiSdlMetricTileEvalDataSpecHistoricalSparklineSetting | null;

  /**
   * Spec describing how to evaluate the forecast sparkline plot for the {@link UiSdlMetricTile}.
   */
  forecastSparkline?: IUiSdlMetricTileEvalDataSpecForecastSparklineSetting | null;

  /**
   * Spec describing how to evaluate the plan sparkline plot for the {@link UiSdlMetricTile}.
   */
  planSparkline?: IUiSdlMetricTileEvalDataSpecPlanSparklineSetting | null;
}
 ...
 */
declare class UiSdlMetricTileEvalDataSpec extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlMetricTileEvalDataSpec | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlMetricTileEvalDataSpec | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlMetricTileEvalDataSpec | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlMetricTileEvalDataSpec | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlMetricTileEvalDataSpec;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlMetricTileEvalDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlMetricTileEvalDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlMetricTileEvalDataSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlMetricTileEvalDataSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlMetricTileEvalDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlMetricTileEvalDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlMetricTileEvalDataSpec;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlMetricTileEvalDataSpec;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlMetricTileEvalDataSpec;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlMetricTileEvalDataSpec;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlMetricTileEvalDataSpec;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlMetricTileEvalDataSpec;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlMetricTileEvalDataSpec;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlMetricTileEvalDataSpec;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlMetricTileEvalDataSpec;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlMetricTileEvalDataSpec;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlMetricTileEvalDataSpec;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlMetricTileEvalDataSpec;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlMetricTileEvalDataSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlMetricTileEvalDataSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlMetricTileEvalDataSpec;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlMetricTileEvalDataSpec;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlMetricTileEvalDataSpec;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlMetricTileEvalDataSpec;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlMetricTileEvalDataSpec;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlMetricTileEvalDataSpec;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlMetricTileEvalDataSpec;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlMetricTileEvalDataSpec;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlMetricTileEvalDataSpec;

  mergeJson(json: any | null): UiSdlMetricTileEvalDataSpec;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlMetricTileEvalDataSpec;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlMetricTileEvalDataSpec;
   ...
   */
  singletonArray(): C3.Array<UiSdlMetricTileEvalDataSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlMetricTileEvalDataSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlMetricTileEvalDataSpec | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlMetricTileEvalDataSpec | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlMetricTileEvalDataSpec | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlMetricTileEvalDataSpec | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlMetricTileEvalDataSpec | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlMetricTileEvalDataSpec | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlMetricTileEvalDataSpec | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlMetricTileEvalDataSpec;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlMetricTileEvalDataSpec;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlMetricTileEvalDataSpec;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlMetricTileEvalDataSpec;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlMetricTileEvalDataSpec;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlMetricTileEvalDataSpec;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlMetricTileEvalDataSpec;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): UiSdlMetricTileEvalDataSpec;
   ...
   */
  static cachedEmptyInst(): UiSdlMetricTileEvalDataSpec;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlMetricTileEvalDataSpec>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlMetricTileEvalDataSpec;
   ...
   */
  static getDataTypeName(dataSpec?: UiSdlMetricTileEvalDataSpec | null): string | null;
