// TypeScript definitions for the C3 type UiSdlBaseDataGrid

/**
 * Base type for {@link UiSdlDataGrid} and {@link UiSdlFormDataGrid}.  Contains common logic to be shared across the two grid types.
 *
 * @remarks this represents a value passed to a method that expects an instance of UiSdlBaseDataGrid
 */
declare interface IUiSdlBaseDataGrid<DataType> {
 ...
 */
declare class UiSdlBaseDataGrid<DataType> extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlBaseDataGrid<DataType> | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlBaseDataGrid<DataType> | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlBaseDataGrid<DataType> | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlBaseDataGrid<DataType> | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlBaseDataGrid<DataType>;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlBaseDataGrid<DataType>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlBaseDataGrid<DataType>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlBaseDataGrid<DataType> | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlBaseDataGrid<DataType> | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlBaseDataGrid<DataType>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlBaseDataGrid<DataType>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlBaseDataGrid<DataType>;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlBaseDataGrid<DataType>;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlBaseDataGrid<DataType>;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlBaseDataGrid<DataType>;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlBaseDataGrid<DataType>;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlBaseDataGrid<DataType>;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlBaseDataGrid<DataType>;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlBaseDataGrid<DataType>;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlBaseDataGrid<DataType>;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlBaseDataGrid<DataType>;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlBaseDataGrid<DataType>;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlBaseDataGrid<DataType>;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlBaseDataGrid<DataType>;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlBaseDataGrid<DataType>;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlBaseDataGrid<DataType>;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlBaseDataGrid<DataType>;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlBaseDataGrid<DataType>;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlBaseDataGrid<DataType>;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlBaseDataGrid<DataType>;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlBaseDataGrid<DataType>;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlBaseDataGrid<DataType>;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlBaseDataGrid<DataType>;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlBaseDataGrid<DataType>;

  mergeJson(json: any | null): UiSdlBaseDataGrid<DataType>;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlBaseDataGrid<DataType>;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlBaseDataGrid<DataType>;
   ...
   */
  singletonArray(): C3.Array<UiSdlBaseDataGrid<DataType> | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlBaseDataGrid<DataType> | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlBaseDataGrid<DataType> | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlBaseDataGrid<DataType> | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlBaseDataGrid<DataType> | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlBaseDataGrid<DataType> | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlBaseDataGrid<DataType> | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlBaseDataGrid<DataType> | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlBaseDataGrid<DataType> | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlBaseDataGrid<DataType>;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlBaseDataGrid<DataType>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlBaseDataGrid<DataType>;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlBaseDataGrid<DataType>;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlBaseDataGrid<DataType>;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlBaseDataGrid<DataType>;
   ...
   * @see #fromString
   */
  static make(s: string | null): UiSdlBaseDataGrid<DataType> | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlBaseDataGrid<DataType>;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): UiSdlBaseDataGrid<DataType>;
   ...
   */
  static cachedEmptyInst(): UiSdlBaseDataGrid<DataType>;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlBaseDataGrid<DataType>>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlBaseDataGrid<DataType>;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<UiSdlBaseDataGrid<DataType> | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<UiSdlBaseDataGrid<DataType> | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<UiSdlBaseDataGrid<DataType> | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<UiSdlBaseDataGrid<DataType> | null> | null>;
   ...
   */
  dependencies(): MetadataDeps<UiSdlBaseDataGrid<DataType> | null>;

  save(subPath?: string | null, contentType?: string | null): UiSdlBaseDataGrid<DataType>;
  ...
  update(srcObj?: UiSdlBaseDataGrid<DataType> | null, spec?: UpsertSpec | null): UiSdlBaseDataGrid<DataType> | null;

  upsert(srcObj?: UiSdlBaseDataGrid<DataType> | null, spec?: UpsertSpec | null): UiSdlBaseDataGrid<DataType> | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): UiSdlBaseDataGrid<DataType> | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string | null, failIfMissing?: boolean): UiSdlBaseDataGrid<DataType> | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: UiSdlBaseDataGrid<DataType>, state: UiSdlReduxState): UiSdlBaseDataGrid<DataType> | null;
