...
# Python definitions for the C3 type UiSdlTimeseriesLineBarChart


class UiSdlTimeseriesLineBarChart(UiSdlLineBarChart[UiSdlTimeseriesLineBarChartDataSpec], UiSdlTimeZoneLabel):
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[UiSdlTimeseriesLineBarChart]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[UiSdlTimeseriesLineBarChart]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[UiSdlTimeseriesLineBarChart]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[UiSdlTimeseriesLineBarChart]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> UiSdlTimeseriesLineBarChart:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> UiSdlTimeseriesLineBarChart:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> UiSdlTimeseriesLineBarChart:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[UiSdlTimeseriesLineBarChart]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[UiSdlTimeseriesLineBarChart]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> UiSdlTimeseriesLineBarChart:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> UiSdlTimeseriesLineBarChart:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> UiSdlTimeseriesLineBarChart:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> UiSdlTimeseriesLineBarChart:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> UiSdlTimeseriesLineBarChart:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> UiSdlTimeseriesLineBarChart:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> UiSdlTimeseriesLineBarChart:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> UiSdlTimeseriesLineBarChart:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> UiSdlTimeseriesLineBarChart:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> UiSdlTimeseriesLineBarChart:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> UiSdlTimeseriesLineBarChart:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> UiSdlTimeseriesLineBarChart:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> UiSdlTimeseriesLineBarChart:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> UiSdlTimeseriesLineBarChart:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> UiSdlTimeseriesLineBarChart:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> UiSdlTimeseriesLineBarChart:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> UiSdlTimeseriesLineBarChart:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> UiSdlTimeseriesLineBarChart:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> UiSdlTimeseriesLineBarChart:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> UiSdlTimeseriesLineBarChart:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> UiSdlTimeseriesLineBarChart:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> UiSdlTimeseriesLineBarChart:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> UiSdlTimeseriesLineBarChart:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> UiSdlTimeseriesLineBarChart:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> UiSdlTimeseriesLineBarChart:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> UiSdlTimeseriesLineBarChart:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> UiSdlTimeseriesLineBarChart:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> UiSdlTimeseriesLineBarChart:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[UiSdlTimeseriesLineBarChart]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[UiSdlTimeseriesLineBarChart]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[UiSdlTimeseriesLineBarChart]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[UiSdlTimeseriesLineBarChart]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[UiSdlTimeseriesLineBarChart]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, UiSdlTimeseriesLineBarChart]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, UiSdlTimeseriesLineBarChart]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[UiSdlTimeseriesLineBarChart]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[UiSdlTimeseriesLineBarChart]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> UiSdlTimeseriesLineBarChart:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> UiSdlTimeseriesLineBarChart:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> UiSdlTimeseriesLineBarChart:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> UiSdlTimeseriesLineBarChart:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> UiSdlTimeseriesLineBarChart:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> UiSdlTimeseriesLineBarChart:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[UiSdlTimeseriesLineBarChart]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> UiSdlTimeseriesLineBarChart:
    """
    ...
    """
        ...
    def afterMake(self) -> UiSdlTimeseriesLineBarChart:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> UiSdlTimeseriesLineBarChart:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[UiSdlTimeseriesLineBarChart]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> UiSdlTimeseriesLineBarChart:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, spec: FetchSpec=None) -> FetchResult[UiSdlTimeseriesLineBarChart]:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, filter: Filter) -> FetchResult[UiSdlTimeseriesLineBarChart]:
    """
    ...
    """
        ...
    @classmethod
    def fetchObjStream(cls, spec: FetchStreamSpec=None) -> Union[Stream[UiSdlTimeseriesLineBarChart]]:
    """
    Fetches multiple obj instances based on a specification.  Only objs that the caller is authorized to fetch will be
    returned.
    ...
    """
        ...
    @classmethod
    def fetchMultiLocale(cls, spec: MultiLocaleFetchSpec=None) -> Union[Map[str, FetchResult[UiSdlTimeseriesLineBarChart]]]:
    """
    ...
    """
        ...
    def dependencies(self) -> MetadataDeps[UiSdlTimeseriesLineBarChart]:
    """
    Retrieves dependencies to types or other metadata elements for the given instance of metadata.
    """
        ...
    def save(self, subPath: str=None, contentType: str=None) -> UiSdlTimeseriesLineBarChart:
        ...
    ...
    def removeAll(cls, removeFilter: str=None) -> int:
        ...
    def update(self, srcObj: UiSdlTimeseriesLineBarChart=None, spec: UpsertSpec=None) -> Union[UiSdlTimeseriesLineBarChart]:
        ...
    def upsert(self, srcObj: UiSdlTimeseriesLineBarChart=None, spec: UpsertSpec=None) -> Union[UiSdlTimeseriesLineBarChart]:
        ...
    @classmethod
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[UiSdlTimeseriesLineBarChart]:
    """
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[UiSdlTimeseriesLineBarChart]:
    """
    ...
    def jsonify(cls, value: Any=None) -> Union[str]:
        ...
    @classmethod
    def doDataMerge(cls, componentId: str, dataSpecFieldName: str, dataDestinationFieldName: str, props: UiSdlTimeseriesLineBarChart, state: UiSdlReduxState) -> Union[UiSdlTimeseriesLineBarChart]:
    """
