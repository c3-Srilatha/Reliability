...
# Python definitions for the C3 type UiSdlTreeListIconColor


class UiSdlTreeListIconColor():
    """
    ...
    Mauve.
    """
    def __init__(self, LILAC: Optional[str]=None, OLIVE: Optional[str]=None, CARBON: Optional[str]=None, TEAL: Optional[str]=None, MAGENTA: Optional[str]=None, MAUVE: Optional[str]=None) -> None: ...
