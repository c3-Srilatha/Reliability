...
# Python definitions for the C3 type UiSdlMessageBannerAnimation


class UiSdlMessageBannerAnimation():
    """
    ...
    FROM_LEFT_SIDE: Optional[str]=None
    """
    ...
    """
    def __init__(self, FROM_LEFT_SIDE: Optional[str]=None, FROM_TOP: Optional[str]=None) -> None: ...
