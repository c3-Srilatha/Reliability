...
from c3.reconstructionToolkit.Reconstruction.ConcatenationPipe import Reconstruction.ConcatenationPipe
...
# Python definitions for the C3 type Reconstruction.ConcatenationPipe

DX = TypeVar('DX')

class ConcatenationPipe(Generic[DX], MlTemplate.AtomicPipe[DX, void, Data]):
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[Reconstruction.ConcatenationPipe[DX]]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[Reconstruction.ConcatenationPipe[DX]]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[Reconstruction.ConcatenationPipe[DX]]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[Reconstruction.ConcatenationPipe[DX]]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> Reconstruction.ConcatenationPipe[DX]:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> Reconstruction.ConcatenationPipe[DX]:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> Reconstruction.ConcatenationPipe[DX]:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[Reconstruction.ConcatenationPipe[DX]]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[Reconstruction.ConcatenationPipe[DX]]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> Reconstruction.ConcatenationPipe[DX]:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> Reconstruction.ConcatenationPipe[DX]:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> Reconstruction.ConcatenationPipe[DX]:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> Reconstruction.ConcatenationPipe[DX]:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> Reconstruction.ConcatenationPipe[DX]:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> Reconstruction.ConcatenationPipe[DX]:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> Reconstruction.ConcatenationPipe[DX]:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> Reconstruction.ConcatenationPipe[DX]:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> Reconstruction.ConcatenationPipe[DX]:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> Reconstruction.ConcatenationPipe[DX]:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> Reconstruction.ConcatenationPipe[DX]:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> Reconstruction.ConcatenationPipe[DX]:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> Reconstruction.ConcatenationPipe[DX]:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> Reconstruction.ConcatenationPipe[DX]:
    """
    @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> Reconstruction.ConcatenationPipe[DX]:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> Reconstruction.ConcatenationPipe[DX]:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> Reconstruction.ConcatenationPipe[DX]:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> Reconstruction.ConcatenationPipe[DX]:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> Reconstruction.ConcatenationPipe[DX]:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> Reconstruction.ConcatenationPipe[DX]:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> Reconstruction.ConcatenationPipe[DX]:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> Reconstruction.ConcatenationPipe[DX]:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> Reconstruction.ConcatenationPipe[DX]:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> Reconstruction.ConcatenationPipe[DX]:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> Reconstruction.ConcatenationPipe[DX]:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> Reconstruction.ConcatenationPipe[DX]:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> Reconstruction.ConcatenationPipe[DX]:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> Reconstruction.ConcatenationPipe[DX]:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[Reconstruction.ConcatenationPipe[DX]]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[Reconstruction.ConcatenationPipe[DX]]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[Reconstruction.ConcatenationPipe[DX]]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[Reconstruction.ConcatenationPipe[DX]]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[Reconstruction.ConcatenationPipe[DX]]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, Reconstruction.ConcatenationPipe[DX]]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, Reconstruction.ConcatenationPipe[DX]]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[Reconstruction.ConcatenationPipe[DX]]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[Reconstruction.ConcatenationPipe[DX]]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> Reconstruction.ConcatenationPipe[DX]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> Reconstruction.ConcatenationPipe[DX]:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> Reconstruction.ConcatenationPipe[DX]:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> Reconstruction.ConcatenationPipe[DX]:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> Reconstruction.ConcatenationPipe[DX]:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> Reconstruction.ConcatenationPipe[DX]:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[Reconstruction.ConcatenationPipe[DX]]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> Reconstruction.ConcatenationPipe[DX]:
    """
    ...
    """
        ...
    def afterMake(self) -> Reconstruction.ConcatenationPipe[DX]:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> Reconstruction.ConcatenationPipe[DX]:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[Reconstruction.ConcatenationPipe[DX]]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> Reconstruction.ConcatenationPipe[DX]:
    """
    ...
    """
        ...
    def remakeTemplate(self) -> Reconstruction.ConcatenationPipe[DX]:
    """
    ...
    """
        ...
    def withoutIdentity(self) -> Reconstruction.ConcatenationPipe[DX]:
    """
    ...
    """
        ...
    def trainSync(self, x: DX, y: =None, spec: MlOperationSpec=None) -> Reconstruction.ConcatenationPipe[DX]:
    """
    ...
    """
        ...
    @classmethod
    def allCached(cls) -> Union[Stream[Reconstruction.ConcatenationPipe[DX]]]:
    """
    @return stream of all available Cached instances.
    """
        ...
    @classmethod
    def find(cls, filter: str=None) -> Union[Stream[Reconstruction.ConcatenationPipe[DX]]]:
    """
    ...
    """
        ...
    @classmethod
    def findBy(cls, field: str, value: Any) -> Union[Stream[Reconstruction.ConcatenationPipe[DX]]]:
    """
    @return existing instances of this type that satisfy filter from data cache. Will call `produceAll`
            if cache is empty or if Ann.cache.all is true & data has not previously been fetched.
            Otherwise no population will be performed.
    """
        ...
    def getCached(self) -> Union[Reconstruction.ConcatenationPipe[DX]]:
    """
    @return cached instance.
    """
        ...
    @classmethod
    def forCacheKey(cls, key: str) -> Union[Reconstruction.ConcatenationPipe[DX]]:
    """
    ...
    """
        ...
    @classmethod
    def produce(cls, key: str) -> Union[Reconstruction.ConcatenationPipe[DX]]:
    """
    Should produce an entry for the cache key. This method should not be called directly.
    """
        ...
    @classmethod
    def produceAll(cls) -> Union[Map[str, Reconstruction.ConcatenationPipe[DX]]]:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, spec: FetchSpec=None) -> FetchResult[Reconstruction.ConcatenationPipe[DX]]:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, filter: Filter) -> FetchResult[Reconstruction.ConcatenationPipe[DX]]:
    """
    ...
    """
        ...
    @classmethod
    def fetchObjStream(cls, spec: FetchStreamSpec=None) -> Union[Stream[Reconstruction.ConcatenationPipe[DX]]]:
    """
    Fetches multiple obj instances based on a specification.  Only objs that the caller is authorized to fetch will be
    returned.
    ...
    """
        ...
    @classmethod
    def fetchMultiLocale(cls, spec: MultiLocaleFetchSpec=None) -> Union[Map[str, FetchResult[Reconstruction.ConcatenationPipe[DX]]]]:
    """
    ...
    """
        ...
    def get(self, include: str=None) -> Union[Reconstruction.ConcatenationPipe[DX]]:
    """
    ...
    """
        ...
    def getSpecific(self, include: str=None) -> Union[Reconstruction.ConcatenationPipe[DX]]:
    """
    ...
    """
        ...
    def getMissing(self, spec: GetMissingSpec) -> Reconstruction.ConcatenationPipe[DX]:
    """
    ...
    """
        ...
    def getDirect(self, include: str=None) -> Union[Reconstruction.ConcatenationPipe[DX]]:
    """
    ...
    """
        ...
    def applyReverseEdit(self, versionEdit: VersionEdit) -> Reconstruction.ConcatenationPipe[DX]:
    """
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[Reconstruction.ConcatenationPipe[DX]]:
    """
    ...
    """
        ...
    def create(self, spec: UpsertSpec=None) -> Union[Reconstruction.ConcatenationPipe[DX]]:
    """
    ...
    """
        ...
    @classmethod
    def createBatch(cls, objs: Array[Reconstruction.ConcatenationPipe[DX]], spec: UpsertSpec=None) -> Union[ObjList[Reconstruction.ConcatenationPipe[DX]]]:
    """
    ...
    """
        ...
    @classmethod
    def createBatchObjStream(cls, objs: Stream[Reconstruction.ConcatenationPipe[DX]], spec: CreateBatchObjStreamSpec=None) -> Union[ObjList[Reconstruction.ConcatenationPipe[DX]]]:
    """
    Creates multiple instances of a C3 type. If the operation fails and {@link UpsertSpec#dontThrowOnBatchError} is not
    specified (the default), then a C3BatchException will be thrown.  Otherwise {@link errors will be reported in the
    returned {@link ObjList}.  This will fail if any of the instances already exist.
    ...
    """
        ...
    def update(self, srcObj: Reconstruction.ConcatenationPipe[DX]=None, spec: UpsertSpec=None) -> Union[Reconstruction.ConcatenationPipe[DX]]:
    """
    ...
    """
        ...
    def upsert(self, srcObj: Reconstruction.ConcatenationPipe[DX]=None, spec: UpsertSpec=None) -> Union[Reconstruction.ConcatenationPipe[DX]]:
    """
    ...
    """
        ...
    @overload
    def merge(self, spec: MergeSpec=None) -> Union[Reconstruction.ConcatenationPipe[DX]]:
    """
    ...
    """
        ...
    @overload
    def merge(self, mergeInclude: str, spec: MergeSpec=None) -> Union[Reconstruction.ConcatenationPipe[DX]]:
    """
    ...
    """
        ...
    def touch(self, spec: TouchSpec=None) -> Union[Reconstruction.ConcatenationPipe[DX]]:
    """
    ...
    """
        ...
    @classmethod
    def updateBatch(cls, objs: Array[Reconstruction.ConcatenationPipe[DX]], srcObjs: Array[Reconstruction.ConcatenationPipe[DX]]=None, spec: UpsertSpec=None) -> Union[ObjList[Reconstruction.ConcatenationPipe[DX]]]:
    """
    ...
    """
        ...
    @classmethod
    def updateObjs(cls, objs: Callable[[], Union[Array[Reconstruction.ConcatenationPipe[DX]]]], spec: UpsertSpec=None) -> Union[ObjList[Reconstruction.ConcatenationPipe[DX]]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertBatch(cls, objs: Array[Reconstruction.ConcatenationPipe[DX]], srcObjs: Array[Reconstruction.ConcatenationPipe[DX]]=None, spec: UpsertSpec=None) -> Union[ObjList[Reconstruction.ConcatenationPipe[DX]]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertObjs(cls, objs: Callable[[], Union[Array[Reconstruction.ConcatenationPipe[DX]]]], spec: UpsertSpec=None) -> Union[ObjList[Reconstruction.ConcatenationPipe[DX]]]:
    """
    Creates instances of a C3 type if they don't already exist and updates them if they do exist. If the operation
    ...
    """
        ...
    @classmethod
    def touchBatch(cls, objs: Array[Reconstruction.ConcatenationPipe[DX]], spec: TouchSpec=None) -> Union[ObjList[Reconstruction.ConcatenationPipe[DX]]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[Reconstruction.ConcatenationPipe[DX]], spec: MergeSpec=None) -> Union[ObjList[Reconstruction.ConcatenationPipe[DX]]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[Reconstruction.ConcatenationPipe[DX]], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[Reconstruction.ConcatenationPipe[DX]]]:
    """
    Merges multiple instances of a C3 type or creates them if they don't exist. If the operation fails and {@link
    UpsertSpec#dontThrowOnBatchError} is not specified (the default), then a C3BatchException will be thrown.
    Otherwise errors will be reported in the returned {@link ObjList}.  The merge operation is described in the {@link
    ...
    """
        ...
    @classmethod
    def mergeObjs(cls, objs: Callable[[], Union[Array[Reconstruction.ConcatenationPipe[DX]]]], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[Reconstruction.ConcatenationPipe[DX]]]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: Reconstruction.ConcatenationPipe[DX], spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: Reconstruction.ConcatenationPipe[DX], mergeInclude: str, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def removeBatch(cls, objs: Array[Reconstruction.ConcatenationPipe[DX]], spec: UpsertSpec=None) -> Union[ObjList[Reconstruction.ConcatenationPipe[DX]]]:
    """
    ...
    """
        ...
    @classmethod
    def replace(cls, objs: Array[Reconstruction.ConcatenationPipe[DX]], spec: UpsertSpec=None) -> Union[ObjList[Reconstruction.ConcatenationPipe[DX]]]:
    """
    ...
    """
        ...
    def unremove(self) -> Union[Reconstruction.ConcatenationPipe[DX]]:
    """
    ...
    """
        ...
    @classmethod
    def beforeCreate(cls, objs: Array[Reconstruction.ConcatenationPipe[DX]]) -> ObjList[Reconstruction.ConcatenationPipe[DX]]:
    """
    ...
    """
        ...
    @classmethod
    def beforeUpdate(cls, objs: Array[Reconstruction.ConcatenationPipe[DX]]) -> ObjList[Reconstruction.ConcatenationPipe[DX]]:
    """
    ...
    """
        ...
    @classmethod
    def beforeRemove(cls, objs: Array[Reconstruction.ConcatenationPipe[DX]]) -> ObjList[Reconstruction.ConcatenationPipe[DX]]:
    """
    ...
    """
        ...
    @classmethod
    def afterCreate(cls, objs: Array[Reconstruction.ConcatenationPipe[DX]]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterUpdate(cls, objs: Array[Reconstruction.ConcatenationPipe[DX]]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterRemove(cls, objs: Array[Reconstruction.ConcatenationPipe[DX]]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def startImportData(cls, spec: StartImportDataSpec=None) -> PushStream[Reconstruction.ConcatenationPipe[DX]]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    @classmethod
    def startImportDataWithStats(cls, spec: StartImportDataSpec=None) -> PushStreamWithStats[Reconstruction.ConcatenationPipe[DX]]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[Reconstruction.ConcatenationPipe[DX]]:
    """
    ...
    """
        ...
    @classmethod
    def typeOfBatch(cls, objs: Array[Reconstruction.ConcatenationPipe[DX]]) -> Union[Array[EntityType]]:
    """
    ...
    """
        ...
    @classmethod
    def dbEcho(cls, template: Reconstruction.ConcatenationPipe[DX]=None, count: int=None, sendBack: bool=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def callbackLogic(cls, objs: Array[Reconstruction.ConcatenationPipe[DX]], callback: Callable[[Union[Reconstruction.ConcatenationPipe[DX]]], Union[Reconstruction.ConcatenationPipe[DX]]]=None) -> ObjList[Reconstruction.ConcatenationPipe[DX]]:
    """
    ...
    """
        ...
    @classmethod
    def afterCallbackLogic(cls, objs: Array[Reconstruction.ConcatenationPipe[DX]], callback: Callable[[Union[Reconstruction.ConcatenationPipe[DX]]], Union[Reconstruction.ConcatenationPipe[DX]]]=None) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    def publish(self, subPath: str=None, contentType: str=None) -> Reconstruction.ConcatenationPipe[DX]:
    """
    ...
    """
        ...
    @classmethod
    def removeSeedDataBatch(cls, objs: Array[SeedData]=None, spec: UpsertSpec=None) -> Union[ObjList[Reconstruction.ConcatenationPipe[DX]]]:
    """
    ...
    """
        ...
    def createSeedData(self, spec: UpsertSpec=None) -> Union[Reconstruction.ConcatenationPipe[DX]]:
    """
    ...
    """
        ...
    @classmethod
    def createSeedDataBatch(cls, objs: Array[SeedData]=None, spec: UpsertSpec=None) -> Union[ObjList[Reconstruction.ConcatenationPipe[DX]]]:
    """
    ...
    """
        ...
    def updateSeedData(self, srcObj: SeedData=None, spec: UpsertSpec=None) -> Union[Reconstruction.ConcatenationPipe[DX]]:
    """
    ...
    """
        ...
    @classmethod
    def updateSeedDataBatch(cls, objs: Array[SeedData]=None, srcObjs: Array[SeedData]=None, spec: UpsertSpec=None) -> Union[ObjList[Reconstruction.ConcatenationPipe[DX]]]:
    """
    ...
    """
        ...
    def clearUserUpdates(self, spec: MergeSpec=None) -> Union[Reconstruction.ConcatenationPipe[DX]]:
    """
    ...
    """
        ...
    @classmethod
    def clearUserUpdatesBatch(cls, objs: Array[SeedData]=None, spec: MergeSpec=None) -> Union[ObjList[Reconstruction.ConcatenationPipe[DX]]]:
    """
    ...
    """
        ...
    def dependencies(self) -> Union[SeedDataDeps[Reconstruction.ConcatenationPipe[DX]]]:
        ...
    ...
    """
        ...
    @classmethod
    def convert(cls, model: Any, spec: MlConvertSpec=None) -> Reconstruction.ConcatenationPipe[DX]:
    """
    ...
    """
        ...
    def freeze(self) -> Reconstruction.ConcatenationPipe[DX]:
    """
    Freezes an {@link MlPipe}
    @return modified copy of this {@link MlPipe} that cannot be trained
    """
        ...
    def unfreeze(self) -> Reconstruction.ConcatenationPipe[DX]:
    """
    ...
    """
        ...
    def byReference(self) -> Reconstruction.ConcatenationPipe[DX]:
    """
    ...
    """
        ...
    def updateModelFiles(self, modelFiles: Map[str, Url], spec: MlOperationSpec=None) -> Reconstruction.ConcatenationPipe[DX]:
    """
    ...
    """
        ...
    def afterTrain(self, doTrainOutputs: Any, spec: MlOperationSpec=None) -> Reconstruction.ConcatenationPipe[DX]:
    """
    ...
    """
        ...
    def withNewSpec(self, spec: MlConvertSpec=None) -> Reconstruction.ConcatenationPipe[DX]:
    """
    ...
    """
        ...
    def afterConvert(self, model: Any, spec: MlConvertSpec=None) -> Reconstruction.ConcatenationPipe[DX]:
    """
    ...
    """
        ...
    def withHyperparamSpaces(self, paramSpaces: Map[str, Hp.ParamSpace]) -> Reconstruction.ConcatenationPipe[DX]:
    """
