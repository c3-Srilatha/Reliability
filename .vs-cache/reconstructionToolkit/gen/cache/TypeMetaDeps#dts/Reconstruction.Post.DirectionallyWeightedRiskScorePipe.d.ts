// TypeScript definitions for the C3 type Reconstruction.Post.DirectionallyWeightedRiskScorePipe
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of Reconstruction.Post.DirectionallyWeightedRiskScorePipe
 */
declare namespace Reconstruction.Post {
  export interface IDirectionallyWeightedRiskScorePipe {
    ...
    /**
     * The name of the column in the {@link Data} output. Default is "riskScore"
     */
 ...
 * residuals, and a weight for all negative residuals.
 *
 * @remarks this represents a made instance of Reconstruction.Post.DirectionallyWeightedRiskScorePipe
 */
declare namespace Reconstruction.Post {
  export class DirectionallyWeightedRiskScorePipe extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): Reconstruction.Post.DirectionallyWeightedRiskScorePipe;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Reconstruction.Post.DirectionallyWeightedRiskScorePipe;

    /**
     * Name of this pipe.
     */
    readonly name?: string;
    withName(name: string | null): Reconstruction.Post.DirectionallyWeightedRiskScorePipe;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Reconstruction.Post.DirectionallyWeightedRiskScorePipe;
    ...
    withVersion(version: number | null): Reconstruction.Post.DirectionallyWeightedRiskScorePipe;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Reconstruction.Post.DirectionallyWeightedRiskScorePipe;
    ...
    withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): Reconstruction.Post.DirectionallyWeightedRiskScorePipe;
    ...
    withHidden(hidden: boolean): Reconstruction.Post.DirectionallyWeightedRiskScorePipe;
    ...
    withUserOwned(userOwned: boolean): Reconstruction.Post.DirectionallyWeightedRiskScorePipe;
    ...
    withTypeIdent(typeIdent: string | null): Reconstruction.Post.DirectionallyWeightedRiskScorePipe;

    /**
     * If true, then the pipe shall not be retrained
     */
    readonly frozen?: boolean;
    withFrozen(frozen: boolean): Reconstruction.Post.DirectionallyWeightedRiskScorePipe;

    /**
     * True if training has succeeded and false otherwise.
     */
    readonly trained?: boolean;
    withTrained(trained: boolean): Reconstruction.Post.DirectionallyWeightedRiskScorePipe;

    /**
     * Errors from training.
     */
    readonly trainingErrors?: string;
    withTrainingErrors(trainingErrors: string | null): Reconstruction.Post.DirectionallyWeightedRiskScorePipe;

    /**
     * If true, the underlying model only accepts flattened input.
     */
    readonly flattenInput?: boolean;
    withFlattenInput(flattenInput: boolean): Reconstruction.Post.DirectionallyWeightedRiskScorePipe;

    /**
     * The hyperparameters overridden of a native model or pipe.
     */
    readonly hyperparamOverrides?: Map_Type<string, any>;
    withHyperparamOverrides(hyperparamOverrides: Map_Type<string, any> | {[key: string]: any} | null): Reconstruction.Post.DirectionallyWeightedRiskScorePipe;
    ...
    withHyperparamSearchSpace(hyperparamSearchSpace: IHp.SearchSpace | null): Reconstruction.Post.DirectionallyWeightedRiskScorePipe;
    ...
    withHpoSpec(hpoSpec: IHpo.Spec | null): Reconstruction.Post.DirectionallyWeightedRiskScorePipe;

    /**
     * {@link Hpo.Experiment} stores the result of hyperparameter optimization to find the best model/pipeline.
     */
    readonly hpoExperiment?: Hpo.Experiment;
    withHpoExperiment(hpoExperiment: IHpo.Experiment | null): Reconstruction.Post.DirectionallyWeightedRiskScorePipe;

    /**
     * Reference to the experiment that produced this {@link MlPipe}. For example, this could be a {@link Hpo.ExperimentBase}.
     */
    readonly experiment?: any;
    withExperiment(experiment: any | null): Reconstruction.Post.DirectionallyWeightedRiskScorePipe;
    ...
    withModelFiles(modelFiles: Map_Type<string, Url> | {[key: string]: IUrl} | null): Reconstruction.Post.DirectionallyWeightedRiskScorePipe;
    ...
    withCustomModelCode(customModelCode: Map_Type<string, any> | {[key: string]: any} | null): Reconstruction.Post.DirectionallyWeightedRiskScorePipe;

    /**
     * Name for the function on the native model to call to do {@link MlProcessable#process}.
     */
    readonly processFunc?: string;
    withProcessFunc(processFunc: string | null): Reconstruction.Post.DirectionallyWeightedRiskScorePipe;
    ...
    withUnderlyingPipe(underlyingPipe: IMlAtomicPipe<any, any, any> | null): Reconstruction.Post.DirectionallyWeightedRiskScorePipe;

    /**
     * The name of the column in the {@link Data} output. Default is "riskScore"
     */
    readonly riskScoreColumnName?: string;
    withRiskScoreColumnName(riskScoreColumnName: string | null): Reconstruction.Post.DirectionallyWeightedRiskScorePipe;
    ...
    withDirectionalWeights(directionalWeights: Map_Type<string, Pair<number, number>> | {[key: string]: IPair<number, number>} | null): Reconstruction.Post.DirectionallyWeightedRiskScorePipe;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Reconstruction.Post.DirectionallyWeightedRiskScorePipe | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Reconstruction.Post.DirectionallyWeightedRiskScorePipe | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Reconstruction.Post.DirectionallyWeightedRiskScorePipe | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Reconstruction.Post.DirectionallyWeightedRiskScorePipe | null;
     ...
     */
    replaceType(old: Type, new_: Type): Reconstruction.Post.DirectionallyWeightedRiskScorePipe;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Reconstruction.Post.DirectionallyWeightedRiskScorePipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Reconstruction.Post.DirectionallyWeightedRiskScorePipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Reconstruction.Post.DirectionallyWeightedRiskScorePipe>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Reconstruction.Post.DirectionallyWeightedRiskScorePipe>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Reconstruction.Post.DirectionallyWeightedRiskScorePipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Reconstruction.Post.DirectionallyWeightedRiskScorePipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Reconstruction.Post.DirectionallyWeightedRiskScorePipe;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Reconstruction.Post.DirectionallyWeightedRiskScorePipe;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Reconstruction.Post.DirectionallyWeightedRiskScorePipe;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Reconstruction.Post.DirectionallyWeightedRiskScorePipe;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Reconstruction.Post.DirectionallyWeightedRiskScorePipe;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Reconstruction.Post.DirectionallyWeightedRiskScorePipe;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Reconstruction.Post.DirectionallyWeightedRiskScorePipe;
     ...
     * @see #removeField
     */
    withoutField(field: string): Reconstruction.Post.DirectionallyWeightedRiskScorePipe;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Reconstruction.Post.DirectionallyWeightedRiskScorePipe;
     ...
     */
    withoutFields(fields: Array_Type<string>): Reconstruction.Post.DirectionallyWeightedRiskScorePipe;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Reconstruction.Post.DirectionallyWeightedRiskScorePipe;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Reconstruction.Post.DirectionallyWeightedRiskScorePipe;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Reconstruction.Post.DirectionallyWeightedRiskScorePipe;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Reconstruction.Post.DirectionallyWeightedRiskScorePipe;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Reconstruction.Post.DirectionallyWeightedRiskScorePipe;
     ...
     * @see #removeField
     */
    unsetField(field: string): Reconstruction.Post.DirectionallyWeightedRiskScorePipe;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Reconstruction.Post.DirectionallyWeightedRiskScorePipe;
     ...
     * @see #unsetField
     */
    removeField(field: string): Reconstruction.Post.DirectionallyWeightedRiskScorePipe;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Reconstruction.Post.DirectionallyWeightedRiskScorePipe;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Reconstruction.Post.DirectionallyWeightedRiskScorePipe;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Reconstruction.Post.DirectionallyWeightedRiskScorePipe;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Reconstruction.Post.DirectionallyWeightedRiskScorePipe;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Reconstruction.Post.DirectionallyWeightedRiskScorePipe;

    mergeJson(json: any): Reconstruction.Post.DirectionallyWeightedRiskScorePipe;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Reconstruction.Post.DirectionallyWeightedRiskScorePipe;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Reconstruction.Post.DirectionallyWeightedRiskScorePipe;
     ...
     */
    singletonArray(): Array_Type<Reconstruction.Post.DirectionallyWeightedRiskScorePipe>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Reconstruction.Post.DirectionallyWeightedRiskScorePipe> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Reconstruction.Post.DirectionallyWeightedRiskScorePipe> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Reconstruction.Post.DirectionallyWeightedRiskScorePipe>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Reconstruction.Post.DirectionallyWeightedRiskScorePipe> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Reconstruction.Post.DirectionallyWeightedRiskScorePipe> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Reconstruction.Post.DirectionallyWeightedRiskScorePipe> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Reconstruction.Post.DirectionallyWeightedRiskScorePipe>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Reconstruction.Post.DirectionallyWeightedRiskScorePipe>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Reconstruction.Post.DirectionallyWeightedRiskScorePipe;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Reconstruction.Post.DirectionallyWeightedRiskScorePipe;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Reconstruction.Post.DirectionallyWeightedRiskScorePipe;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Reconstruction.Post.DirectionallyWeightedRiskScorePipe;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Reconstruction.Post.DirectionallyWeightedRiskScorePipe;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Reconstruction.Post.DirectionallyWeightedRiskScorePipe;
     ...
     * @see #fromString
     */
    static make(s: string): Reconstruction.Post.DirectionallyWeightedRiskScorePipe | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Reconstruction.Post.DirectionallyWeightedRiskScorePipe;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Reconstruction.Post.DirectionallyWeightedRiskScorePipe;
     ...
     */
    static cachedEmptyInst(): Reconstruction.Post.DirectionallyWeightedRiskScorePipe;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Reconstruction.Post.DirectionallyWeightedRiskScorePipe> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Reconstruction.Post.DirectionallyWeightedRiskScorePipe;
    ...
    /**
     * This method constructs a new {@link MlPipeline} that appends this risk score pipe to any {@link MlPipe} that has
     * `residuals` as an output. The returned pipeline will have a new output `riskScore`. See
     ...
     *
     * # To connect the risk score pipe to the `residuals` output of the autoencoder, simply invoke `succeed` on the risk
     * # score pipe.
     * pipeline = risk_score_pipe.succeed(autoencoder)
     * ```
     */
     ...
     */
    remakeTemplate(): Reconstruction.Post.DirectionallyWeightedRiskScorePipe;
     ...
     */
    withoutIdentity(): Reconstruction.Post.DirectionallyWeightedRiskScorePipe;
     ...
     */
    trainSync(x: , y?: , spec?: MlOperationSpec): Reconstruction.Post.DirectionallyWeightedRiskScorePipe;
     ...
     */
    static allCached(): Stream<Reconstruction.Post.DirectionallyWeightedRiskScorePipe> | null;
     ...
     */
    static find(filter?: string): Stream<Reconstruction.Post.DirectionallyWeightedRiskScorePipe> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<Reconstruction.Post.DirectionallyWeightedRiskScorePipe> | null;

    /**
     * @return cached instance.
     */
    getCached(): Reconstruction.Post.DirectionallyWeightedRiskScorePipe | null;

    /**
     * @return cached instance by the key.
     */
    static forCacheKey(key: string): Reconstruction.Post.DirectionallyWeightedRiskScorePipe | null;
     ...
     */
    static produce(key: string): Reconstruction.Post.DirectionallyWeightedRiskScorePipe | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, Reconstruction.Post.DirectionallyWeightedRiskScorePipe> | null;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Reconstruction.Post.DirectionallyWeightedRiskScorePipe>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Reconstruction.Post.DirectionallyWeightedRiskScorePipe>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Reconstruction.Post.DirectionallyWeightedRiskScorePipe> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Reconstruction.Post.DirectionallyWeightedRiskScorePipe>> | null;
     ...
     */
    get(include?: string): Reconstruction.Post.DirectionallyWeightedRiskScorePipe | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Reconstruction.Post.DirectionallyWeightedRiskScorePipe | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Reconstruction.Post.DirectionallyWeightedRiskScorePipe;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Reconstruction.Post.DirectionallyWeightedRiskScorePipe | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Reconstruction.Post.DirectionallyWeightedRiskScorePipe;
     ...
     * @see #toString
     */
    static fromString(s: string): Reconstruction.Post.DirectionallyWeightedRiskScorePipe | null;
     ...
     */
    create(spec?: UpsertSpec): Reconstruction.Post.DirectionallyWeightedRiskScorePipe | null;
     ...
     */
    static createBatch(objs: Array_Type<Reconstruction.Post.DirectionallyWeightedRiskScorePipe>, spec?: UpsertSpec): ObjList<Reconstruction.Post.DirectionallyWeightedRiskScorePipe> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Reconstruction.Post.DirectionallyWeightedRiskScorePipe>, spec?: CreateBatchObjStreamSpec): ObjList<Reconstruction.Post.DirectionallyWeightedRiskScorePipe> | null;
     ...
     */
    update(srcObj?: Reconstruction.Post.DirectionallyWeightedRiskScorePipe, spec?: UpsertSpec): Reconstruction.Post.DirectionallyWeightedRiskScorePipe | null;
     ...
     */
    upsert(srcObj?: Reconstruction.Post.DirectionallyWeightedRiskScorePipe, spec?: UpsertSpec): Reconstruction.Post.DirectionallyWeightedRiskScorePipe | null;
     ...
     */
    merge(spec?: MergeSpec): Reconstruction.Post.DirectionallyWeightedRiskScorePipe | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Reconstruction.Post.DirectionallyWeightedRiskScorePipe | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Reconstruction.Post.DirectionallyWeightedRiskScorePipe | null;
     ...
     */
    static updateBatch(objs: Array_Type<Reconstruction.Post.DirectionallyWeightedRiskScorePipe>, srcObjs?: Array_Type<Reconstruction.Post.DirectionallyWeightedRiskScorePipe>, spec?: UpsertSpec): ObjList<Reconstruction.Post.DirectionallyWeightedRiskScorePipe> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Reconstruction.Post.DirectionallyWeightedRiskScorePipe> | null>, spec?: UpsertSpec): ObjList<Reconstruction.Post.DirectionallyWeightedRiskScorePipe> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Reconstruction.Post.DirectionallyWeightedRiskScorePipe>, srcObjs?: Array_Type<Reconstruction.Post.DirectionallyWeightedRiskScorePipe>, spec?: UpsertSpec): ObjList<Reconstruction.Post.DirectionallyWeightedRiskScorePipe> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Reconstruction.Post.DirectionallyWeightedRiskScorePipe> | null>, spec?: UpsertSpec): ObjList<Reconstruction.Post.DirectionallyWeightedRiskScorePipe> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Reconstruction.Post.DirectionallyWeightedRiskScorePipe>, spec?: TouchSpec): ObjList<Reconstruction.Post.DirectionallyWeightedRiskScorePipe> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Reconstruction.Post.DirectionallyWeightedRiskScorePipe>, spec?: MergeSpec): ObjList<Reconstruction.Post.DirectionallyWeightedRiskScorePipe> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Reconstruction.Post.DirectionallyWeightedRiskScorePipe>, mergeInclude: string, spec?: MergeSpec): ObjList<Reconstruction.Post.DirectionallyWeightedRiskScorePipe> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Reconstruction.Post.DirectionallyWeightedRiskScorePipe> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Reconstruction.Post.DirectionallyWeightedRiskScorePipe> | null;
     ...
     */
    static mergeAll(mergeObj: Reconstruction.Post.DirectionallyWeightedRiskScorePipe, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Reconstruction.Post.DirectionallyWeightedRiskScorePipe, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Reconstruction.Post.DirectionallyWeightedRiskScorePipe>, spec?: UpsertSpec): ObjList<Reconstruction.Post.DirectionallyWeightedRiskScorePipe> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Reconstruction.Post.DirectionallyWeightedRiskScorePipe>, spec?: UpsertSpec): ObjList<Reconstruction.Post.DirectionallyWeightedRiskScorePipe> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Reconstruction.Post.DirectionallyWeightedRiskScorePipe | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Reconstruction.Post.DirectionallyWeightedRiskScorePipe>): ObjList<Reconstruction.Post.DirectionallyWeightedRiskScorePipe>;
     ...
     */
    static beforeUpdate(objs: Array_Type<Reconstruction.Post.DirectionallyWeightedRiskScorePipe>): ObjList<Reconstruction.Post.DirectionallyWeightedRiskScorePipe>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Reconstruction.Post.DirectionallyWeightedRiskScorePipe>): ObjList<Reconstruction.Post.DirectionallyWeightedRiskScorePipe>;
     ...
     */
    static afterCreate(objs: Array_Type<Reconstruction.Post.DirectionallyWeightedRiskScorePipe>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Reconstruction.Post.DirectionallyWeightedRiskScorePipe>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Reconstruction.Post.DirectionallyWeightedRiskScorePipe>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Reconstruction.Post.DirectionallyWeightedRiskScorePipe>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Reconstruction.Post.DirectionallyWeightedRiskScorePipe>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Reconstruction.Post.DirectionallyWeightedRiskScorePipe | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Reconstruction.Post.DirectionallyWeightedRiskScorePipe>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Reconstruction.Post.DirectionallyWeightedRiskScorePipe, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Reconstruction.Post.DirectionallyWeightedRiskScorePipe>, callback?: λFunction<Reconstruction.Post.DirectionallyWeightedRiskScorePipe | null, Reconstruction.Post.DirectionallyWeightedRiskScorePipe | null>): ObjList<Reconstruction.Post.DirectionallyWeightedRiskScorePipe>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Reconstruction.Post.DirectionallyWeightedRiskScorePipe>, callback?: λFunction<Reconstruction.Post.DirectionallyWeightedRiskScorePipe | null, Reconstruction.Post.DirectionallyWeightedRiskScorePipe | null>): Array_Type<ObjError> | null;
     ...
     */
    publish(subPath?: string, contentType?: string): Reconstruction.Post.DirectionallyWeightedRiskScorePipe;
     ...
     */
    static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<Reconstruction.Post.DirectionallyWeightedRiskScorePipe> | null;
     ...
     */
    createSeedData(spec?: UpsertSpec): Reconstruction.Post.DirectionallyWeightedRiskScorePipe | null;
     ...
     */
    static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<Reconstruction.Post.DirectionallyWeightedRiskScorePipe> | null;
     ...
     */
    updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): Reconstruction.Post.DirectionallyWeightedRiskScorePipe | null;
     ...
     */
    static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<Reconstruction.Post.DirectionallyWeightedRiskScorePipe> | null;
     ...
     * @return updated obj instance, same as {@link Persistable#update} return value.
     */
    clearUserUpdates(spec?: MergeSpec): Reconstruction.Post.DirectionallyWeightedRiskScorePipe | null;
     ...
     *         {@link Persistable#updateBatch}.
     */
    static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<Reconstruction.Post.DirectionallyWeightedRiskScorePipe> | null;
    ...
    dependencies(): SeedDataDeps<Reconstruction.Post.DirectionallyWeightedRiskScorePipe> | null;
     ...
     */
    static convert(model: any, spec?: MlConvertSpec): Reconstruction.Post.DirectionallyWeightedRiskScorePipe;

    /**
     * Freezes an {@link MlPipe}
     * @return modified copy of this {@link MlPipe} that cannot be trained
     */
    freeze(): Reconstruction.Post.DirectionallyWeightedRiskScorePipe;

    /**
     * Unfreezes an {@link MlPipe}
     * @return modified copy of this {@link MlPipe} that can be trained
     */
    unfreeze(): Reconstruction.Post.DirectionallyWeightedRiskScorePipe;
     ...
     * be returned as-is.
     */
    byReference(): Reconstruction.Post.DirectionallyWeightedRiskScorePipe;
     ...
     */
    updateModelFiles(modelFiles: Map_Type<string, Url>, spec?: MlOperationSpec): Reconstruction.Post.DirectionallyWeightedRiskScorePipe;
     ...
     */
    afterTrain(doTrainOutputs: any, spec?: MlOperationSpec): Reconstruction.Post.DirectionallyWeightedRiskScorePipe;
     ...
     */
    withNewSpec(spec?: MlConvertSpec): Reconstruction.Post.DirectionallyWeightedRiskScorePipe;
     ...
     */
    afterConvert(model: any, spec?: MlConvertSpec): Reconstruction.Post.DirectionallyWeightedRiskScorePipe;
     ...
     */
    withHyperparamSpaces(paramSpaces: Map_Type<string, Hp.ParamSpace>): Reconstruction.Post.DirectionallyWeightedRiskScorePipe;
