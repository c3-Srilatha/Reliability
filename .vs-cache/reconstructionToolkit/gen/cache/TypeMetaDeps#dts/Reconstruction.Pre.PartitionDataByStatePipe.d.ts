// TypeScript definitions for the C3 type Reconstruction.Pre.PartitionDataByStatePipe
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of Reconstruction.Pre.PartitionDataByStatePipe
 */
declare namespace Reconstruction.Pre {
  export interface IPartitionDataByStatePipe<DO> {
     ...
     */
    stateToValues?: Map_Type<string, Array_Type<any>> | {[key: string]: Array_Type<any> | Array<any>};
     ...
     */
    stateToFeatures?: Map_Type<string, Array_Type<string>> | {[key: string]: Array_Type<string> | Array<string>};
 ...
 */
declare namespace Reconstruction.Pre {
  export class PartitionDataByStatePipe<DO> extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): Reconstruction.Pre.PartitionDataByStatePipe;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Reconstruction.Pre.PartitionDataByStatePipe;

    /**
     * Name of this pipe.
     */
    readonly name?: string;
    withName(name: string | null): Reconstruction.Pre.PartitionDataByStatePipe;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Reconstruction.Pre.PartitionDataByStatePipe;
    ...
    withVersion(version: number | null): Reconstruction.Pre.PartitionDataByStatePipe;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Reconstruction.Pre.PartitionDataByStatePipe;
    ...
    withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): Reconstruction.Pre.PartitionDataByStatePipe;
    ...
    withHidden(hidden: boolean): Reconstruction.Pre.PartitionDataByStatePipe;
    ...
    withUserOwned(userOwned: boolean): Reconstruction.Pre.PartitionDataByStatePipe;
    ...
    withTypeIdent(typeIdent: string | null): Reconstruction.Pre.PartitionDataByStatePipe;

    /**
     * If true, then the pipe shall not be retrained
     */
    readonly frozen?: boolean;
    withFrozen(frozen: boolean): Reconstruction.Pre.PartitionDataByStatePipe;

    /**
     * True if training has succeeded and false otherwise.
     */
    readonly trained?: boolean;
    withTrained(trained: boolean): Reconstruction.Pre.PartitionDataByStatePipe;

    /**
     * Errors from training.
     */
    readonly trainingErrors?: string;
    withTrainingErrors(trainingErrors: string | null): Reconstruction.Pre.PartitionDataByStatePipe;

    /**
     * If true, the underlying model only accepts flattened input.
     */
    readonly flattenInput?: boolean;
    withFlattenInput(flattenInput: boolean): Reconstruction.Pre.PartitionDataByStatePipe;

    /**
     * The hyperparameters overridden of a native model or pipe.
     */
    readonly hyperparamOverrides?: Map_Type<string, any>;
    withHyperparamOverrides(hyperparamOverrides: Map_Type<string, any> | {[key: string]: any} | null): Reconstruction.Pre.PartitionDataByStatePipe;
    ...
    withHyperparamSearchSpace(hyperparamSearchSpace: IHp.SearchSpace | null): Reconstruction.Pre.PartitionDataByStatePipe;
    ...
    withHpoSpec(hpoSpec: IHpo.Spec | null): Reconstruction.Pre.PartitionDataByStatePipe;

    /**
     * {@link Hpo.Experiment} stores the result of hyperparameter optimization to find the best model/pipeline.
     */
    readonly hpoExperiment?: Hpo.Experiment;
    withHpoExperiment(hpoExperiment: IHpo.Experiment | null): Reconstruction.Pre.PartitionDataByStatePipe;

    /**
     * Reference to the experiment that produced this {@link MlPipe}. For example, this could be a {@link Hpo.ExperimentBase}.
     */
    readonly experiment?: any;
    withExperiment(experiment: any | null): Reconstruction.Pre.PartitionDataByStatePipe;
    ...
    withModelFiles(modelFiles: Map_Type<string, Url> | {[key: string]: IUrl} | null): Reconstruction.Pre.PartitionDataByStatePipe;
    ...
    withCustomModelCode(customModelCode: Map_Type<string, any> | {[key: string]: any} | null): Reconstruction.Pre.PartitionDataByStatePipe;

    /**
     * Name for the function on the native model to call to do {@link MlProcessable#process}.
     */
    readonly processFunc?: string;
    withProcessFunc(processFunc: string | null): Reconstruction.Pre.PartitionDataByStatePipe;
    ...
    withUnderlyingPipe(underlyingPipe: IMlAtomicPipe<any, any, any> | null): Reconstruction.Pre.PartitionDataByStatePipe;

    /**
     * The name of the states to partition data by.
     */
    readonly states: Array_Type<string>;
    withStates(states: Array_Type<string> | Array<string>): Reconstruction.Pre.PartitionDataByStatePipe;

    /**
     * The mapping for the names of the states to the value(s) of the states in the input `state`. One state can map to one or multiple values.
     */
    readonly stateToValues?: Map_Type<string, Array_Type<any>>;
    withStateToValues(stateToValues: Map_Type<string, Array_Type<any>> | {[key: string]: Array_Type<any> | Array<any>} | null): Reconstruction.Pre.PartitionDataByStatePipe;

    /**
     * The mapping of the state to the features that will be retained for that state after partitioning. If empty for a particular state, then all features will be retained.
     */
    readonly stateToFeatures?: Map_Type<string, Array_Type<string>>;
    withStateToFeatures(stateToFeatures: Map_Type<string, Array_Type<string>> | {[key: string]: Array_Type<string> | Array<string>} | null): Reconstruction.Pre.PartitionDataByStatePipe;
    ...
    withEmptyDataSubjectIndicator(emptyDataSubjectIndicator: string | null): Reconstruction.Pre.PartitionDataByStatePipe;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Reconstruction.Pre.PartitionDataByStatePipe<DO> | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Reconstruction.Pre.PartitionDataByStatePipe<DO> | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Reconstruction.Pre.PartitionDataByStatePipe<DO> | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Reconstruction.Pre.PartitionDataByStatePipe<DO> | null;
     ...
     */
    replaceType(old: Type, new_: Type): Reconstruction.Pre.PartitionDataByStatePipe<DO>;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Reconstruction.Pre.PartitionDataByStatePipe<DO>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Reconstruction.Pre.PartitionDataByStatePipe<DO>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Reconstruction.Pre.PartitionDataByStatePipe<DO>>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Reconstruction.Pre.PartitionDataByStatePipe<DO>>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Reconstruction.Pre.PartitionDataByStatePipe<DO>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Reconstruction.Pre.PartitionDataByStatePipe<DO>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Reconstruction.Pre.PartitionDataByStatePipe<DO>;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Reconstruction.Pre.PartitionDataByStatePipe<DO>;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Reconstruction.Pre.PartitionDataByStatePipe<DO>;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Reconstruction.Pre.PartitionDataByStatePipe<DO>;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Reconstruction.Pre.PartitionDataByStatePipe<DO>;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Reconstruction.Pre.PartitionDataByStatePipe<DO>;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Reconstruction.Pre.PartitionDataByStatePipe<DO>;
     ...
     * @see #removeField
     */
    withoutField(field: string): Reconstruction.Pre.PartitionDataByStatePipe<DO>;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Reconstruction.Pre.PartitionDataByStatePipe<DO>;
     ...
     */
    withoutFields(fields: Array_Type<string>): Reconstruction.Pre.PartitionDataByStatePipe<DO>;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Reconstruction.Pre.PartitionDataByStatePipe<DO>;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Reconstruction.Pre.PartitionDataByStatePipe<DO>;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Reconstruction.Pre.PartitionDataByStatePipe<DO>;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Reconstruction.Pre.PartitionDataByStatePipe<DO>;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Reconstruction.Pre.PartitionDataByStatePipe<DO>;
     ...
     * @see #removeField
     */
    unsetField(field: string): Reconstruction.Pre.PartitionDataByStatePipe<DO>;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Reconstruction.Pre.PartitionDataByStatePipe<DO>;
     ...
     * @see #unsetField
     */
    removeField(field: string): Reconstruction.Pre.PartitionDataByStatePipe<DO>;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Reconstruction.Pre.PartitionDataByStatePipe<DO>;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Reconstruction.Pre.PartitionDataByStatePipe<DO>;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Reconstruction.Pre.PartitionDataByStatePipe<DO>;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Reconstruction.Pre.PartitionDataByStatePipe<DO>;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Reconstruction.Pre.PartitionDataByStatePipe<DO>;

    mergeJson(json: any): Reconstruction.Pre.PartitionDataByStatePipe<DO>;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Reconstruction.Pre.PartitionDataByStatePipe<DO>;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Reconstruction.Pre.PartitionDataByStatePipe<DO>;
     ...
     */
    singletonArray(): Array_Type<Reconstruction.Pre.PartitionDataByStatePipe<DO>>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Reconstruction.Pre.PartitionDataByStatePipe<DO>> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Reconstruction.Pre.PartitionDataByStatePipe<DO>> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Reconstruction.Pre.PartitionDataByStatePipe<DO>>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Reconstruction.Pre.PartitionDataByStatePipe<DO>> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Reconstruction.Pre.PartitionDataByStatePipe<DO>> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Reconstruction.Pre.PartitionDataByStatePipe<DO>> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Reconstruction.Pre.PartitionDataByStatePipe<DO>>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Reconstruction.Pre.PartitionDataByStatePipe<DO>>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Reconstruction.Pre.PartitionDataByStatePipe<DO>;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Reconstruction.Pre.PartitionDataByStatePipe<DO>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Reconstruction.Pre.PartitionDataByStatePipe<DO>;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Reconstruction.Pre.PartitionDataByStatePipe<DO>;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Reconstruction.Pre.PartitionDataByStatePipe<DO>;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Reconstruction.Pre.PartitionDataByStatePipe<DO>;
     ...
     * @see #fromString
     */
    static make(s: string): Reconstruction.Pre.PartitionDataByStatePipe<DO> | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Reconstruction.Pre.PartitionDataByStatePipe<DO>;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Reconstruction.Pre.PartitionDataByStatePipe<DO>;
     ...
     */
    static cachedEmptyInst(): Reconstruction.Pre.PartitionDataByStatePipe<DO>;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Reconstruction.Pre.PartitionDataByStatePipe<DO>> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Reconstruction.Pre.PartitionDataByStatePipe<DO>;
     ...
     * ```
     */
    precede(pipe: MlPipe<any, any, any, any, any> | Map_Type<string, MlPipe<any, any, any, any, any>>, kwargs?: Map_Type<string, any>): MlPipeline<any, any, any, any, any>;
     ...
     */
    static connect(pre: MlPipeline<any, any, any, any, any>, center: MlPipe<any, any, any, any, any>, trainingMap: Map_Type<string, string>, processMap?: Map_Type<string, string>, kwargs?: Map_Type<string, any>): MlPipeline<any, any, any, any, any>;
     ...
     */
    static validate(pipe: MlPipe<any, any, any, any, any>, inputKeys: Array_Type<string>): void;
     ...
     */
    remakeTemplate(): Reconstruction.Pre.PartitionDataByStatePipe<DO>;
     ...
     */
    withoutIdentity(): Reconstruction.Pre.PartitionDataByStatePipe<DO>;
     ...
     */
    trainSync(x: , y?: , spec?: MlOperationSpec): Reconstruction.Pre.PartitionDataByStatePipe<DO>;
     ...
     */
    static allCached(): Stream<Reconstruction.Pre.PartitionDataByStatePipe<DO>> | null;
     ...
     */
    static find(filter?: string): Stream<Reconstruction.Pre.PartitionDataByStatePipe<DO>> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<Reconstruction.Pre.PartitionDataByStatePipe<DO>> | null;

    /**
     * @return cached instance.
     */
    getCached(): Reconstruction.Pre.PartitionDataByStatePipe<DO> | null;

    /**
     * @return cached instance by the key.
     */
    static forCacheKey(key: string): Reconstruction.Pre.PartitionDataByStatePipe<DO> | null;
     ...
     */
    static produce(key: string): Reconstruction.Pre.PartitionDataByStatePipe<DO> | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, Reconstruction.Pre.PartitionDataByStatePipe<DO>> | null;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Reconstruction.Pre.PartitionDataByStatePipe<DO>>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Reconstruction.Pre.PartitionDataByStatePipe<DO>>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Reconstruction.Pre.PartitionDataByStatePipe<DO>> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Reconstruction.Pre.PartitionDataByStatePipe<DO>>> | null;
     ...
     */
    get(include?: string): Reconstruction.Pre.PartitionDataByStatePipe<DO> | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Reconstruction.Pre.PartitionDataByStatePipe<DO> | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Reconstruction.Pre.PartitionDataByStatePipe<DO>;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Reconstruction.Pre.PartitionDataByStatePipe<DO> | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Reconstruction.Pre.PartitionDataByStatePipe<DO>;
     ...
     * @see #toString
     */
    static fromString(s: string): Reconstruction.Pre.PartitionDataByStatePipe<DO> | null;
     ...
     */
    create(spec?: UpsertSpec): Reconstruction.Pre.PartitionDataByStatePipe<DO> | null;
     ...
     */
    static createBatch(objs: Array_Type<Reconstruction.Pre.PartitionDataByStatePipe<DO>>, spec?: UpsertSpec): ObjList<Reconstruction.Pre.PartitionDataByStatePipe<DO>> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Reconstruction.Pre.PartitionDataByStatePipe<DO>>, spec?: CreateBatchObjStreamSpec): ObjList<Reconstruction.Pre.PartitionDataByStatePipe<DO>> | null;
     ...
     */
    update(srcObj?: Reconstruction.Pre.PartitionDataByStatePipe<DO>, spec?: UpsertSpec): Reconstruction.Pre.PartitionDataByStatePipe<DO> | null;
     ...
     */
    upsert(srcObj?: Reconstruction.Pre.PartitionDataByStatePipe<DO>, spec?: UpsertSpec): Reconstruction.Pre.PartitionDataByStatePipe<DO> | null;
     ...
     */
    merge(spec?: MergeSpec): Reconstruction.Pre.PartitionDataByStatePipe<DO> | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Reconstruction.Pre.PartitionDataByStatePipe<DO> | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Reconstruction.Pre.PartitionDataByStatePipe<DO> | null;
     ...
     */
    static updateBatch(objs: Array_Type<Reconstruction.Pre.PartitionDataByStatePipe<DO>>, srcObjs?: Array_Type<Reconstruction.Pre.PartitionDataByStatePipe<DO>>, spec?: UpsertSpec): ObjList<Reconstruction.Pre.PartitionDataByStatePipe<DO>> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Reconstruction.Pre.PartitionDataByStatePipe<DO>> | null>, spec?: UpsertSpec): ObjList<Reconstruction.Pre.PartitionDataByStatePipe<DO>> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Reconstruction.Pre.PartitionDataByStatePipe<DO>>, srcObjs?: Array_Type<Reconstruction.Pre.PartitionDataByStatePipe<DO>>, spec?: UpsertSpec): ObjList<Reconstruction.Pre.PartitionDataByStatePipe<DO>> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Reconstruction.Pre.PartitionDataByStatePipe<DO>> | null>, spec?: UpsertSpec): ObjList<Reconstruction.Pre.PartitionDataByStatePipe<DO>> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Reconstruction.Pre.PartitionDataByStatePipe<DO>>, spec?: TouchSpec): ObjList<Reconstruction.Pre.PartitionDataByStatePipe<DO>> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Reconstruction.Pre.PartitionDataByStatePipe<DO>>, spec?: MergeSpec): ObjList<Reconstruction.Pre.PartitionDataByStatePipe<DO>> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Reconstruction.Pre.PartitionDataByStatePipe<DO>>, mergeInclude: string, spec?: MergeSpec): ObjList<Reconstruction.Pre.PartitionDataByStatePipe<DO>> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Reconstruction.Pre.PartitionDataByStatePipe<DO>> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Reconstruction.Pre.PartitionDataByStatePipe<DO>> | null;
     ...
     */
    static mergeAll(mergeObj: Reconstruction.Pre.PartitionDataByStatePipe<DO>, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Reconstruction.Pre.PartitionDataByStatePipe<DO>, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Reconstruction.Pre.PartitionDataByStatePipe<DO>>, spec?: UpsertSpec): ObjList<Reconstruction.Pre.PartitionDataByStatePipe<DO>> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Reconstruction.Pre.PartitionDataByStatePipe<DO>>, spec?: UpsertSpec): ObjList<Reconstruction.Pre.PartitionDataByStatePipe<DO>> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Reconstruction.Pre.PartitionDataByStatePipe<DO> | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Reconstruction.Pre.PartitionDataByStatePipe<DO>>): ObjList<Reconstruction.Pre.PartitionDataByStatePipe<DO>>;
     ...
     */
    static beforeUpdate(objs: Array_Type<Reconstruction.Pre.PartitionDataByStatePipe<DO>>): ObjList<Reconstruction.Pre.PartitionDataByStatePipe<DO>>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Reconstruction.Pre.PartitionDataByStatePipe<DO>>): ObjList<Reconstruction.Pre.PartitionDataByStatePipe<DO>>;
     ...
     */
    static afterCreate(objs: Array_Type<Reconstruction.Pre.PartitionDataByStatePipe<DO>>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Reconstruction.Pre.PartitionDataByStatePipe<DO>>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Reconstruction.Pre.PartitionDataByStatePipe<DO>>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Reconstruction.Pre.PartitionDataByStatePipe<DO>>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Reconstruction.Pre.PartitionDataByStatePipe<DO>>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Reconstruction.Pre.PartitionDataByStatePipe<DO> | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Reconstruction.Pre.PartitionDataByStatePipe<DO>>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Reconstruction.Pre.PartitionDataByStatePipe<DO>, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Reconstruction.Pre.PartitionDataByStatePipe<DO>>, callback?: λFunction<Reconstruction.Pre.PartitionDataByStatePipe<DO> | null, Reconstruction.Pre.PartitionDataByStatePipe<DO> | null>): ObjList<Reconstruction.Pre.PartitionDataByStatePipe<DO>>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Reconstruction.Pre.PartitionDataByStatePipe<DO>>, callback?: λFunction<Reconstruction.Pre.PartitionDataByStatePipe<DO> | null, Reconstruction.Pre.PartitionDataByStatePipe<DO> | null>): Array_Type<ObjError> | null;
     ...
     */
    publish(subPath?: string, contentType?: string): Reconstruction.Pre.PartitionDataByStatePipe<DO>;
     ...
     */
    static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<Reconstruction.Pre.PartitionDataByStatePipe<DO>> | null;
     ...
     */
    createSeedData(spec?: UpsertSpec): Reconstruction.Pre.PartitionDataByStatePipe<DO> | null;
     ...
     */
    static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<Reconstruction.Pre.PartitionDataByStatePipe<DO>> | null;
     ...
     */
    updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): Reconstruction.Pre.PartitionDataByStatePipe<DO> | null;
     ...
     */
    static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<Reconstruction.Pre.PartitionDataByStatePipe<DO>> | null;
     ...
     * @return updated obj instance, same as {@link Persistable#update} return value.
     */
    clearUserUpdates(spec?: MergeSpec): Reconstruction.Pre.PartitionDataByStatePipe<DO> | null;
     ...
     *         {@link Persistable#updateBatch}.
     */
    static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<Reconstruction.Pre.PartitionDataByStatePipe<DO>> | null;
    ...
    dependencies(): SeedDataDeps<Reconstruction.Pre.PartitionDataByStatePipe<DO>> | null;
     ...
     */
    static convert(model: any, spec?: MlConvertSpec): Reconstruction.Pre.PartitionDataByStatePipe<DO>;

    /**
     * Freezes an {@link MlPipe}
     * @return modified copy of this {@link MlPipe} that cannot be trained
     */
    freeze(): Reconstruction.Pre.PartitionDataByStatePipe<DO>;

    /**
     * Unfreezes an {@link MlPipe}
     * @return modified copy of this {@link MlPipe} that can be trained
     */
    unfreeze(): Reconstruction.Pre.PartitionDataByStatePipe<DO>;
     ...
     * be returned as-is.
     */
    byReference(): Reconstruction.Pre.PartitionDataByStatePipe<DO>;
     ...
     */
    updateModelFiles(modelFiles: Map_Type<string, Url>, spec?: MlOperationSpec): Reconstruction.Pre.PartitionDataByStatePipe<DO>;
     ...
     */
    afterTrain(doTrainOutputs: any, spec?: MlOperationSpec): Reconstruction.Pre.PartitionDataByStatePipe<DO>;
     ...
     */
    withNewSpec(spec?: MlConvertSpec): Reconstruction.Pre.PartitionDataByStatePipe<DO>;
     ...
     */
    afterConvert(model: any, spec?: MlConvertSpec): Reconstruction.Pre.PartitionDataByStatePipe<DO>;
     ...
     */
    withHyperparamSpaces(paramSpaces: Map_Type<string, Hp.ParamSpace>): Reconstruction.Pre.PartitionDataByStatePipe<DO>;
