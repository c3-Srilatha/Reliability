// TypeScript definitions for the C3 type Reconstruction.TargetExtractionPipe

/**
 * This type represents a process-only {@link MlPipe} that extracts a target column and feature columns from an input
 * {@link Data}.
 *
 * @remarks this represents a value passed to a method that expects an instance of Reconstruction.TargetExtractionPipe
 */
declare namespace Reconstruction {
  export interface ITargetExtractionPipe {
    ...
    /**
     * The target column to extract
     */
    target: string;

    /**
     * The features to extract. If empty, this pipe will assume all other columns but the {@link #target} are features
     */
 ...
 * {@link Data}.
 *
 * @remarks this represents a made instance of Reconstruction.TargetExtractionPipe
 */
declare namespace Reconstruction {
  export class TargetExtractionPipe extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): Reconstruction.TargetExtractionPipe;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Reconstruction.TargetExtractionPipe;

    /**
     * Name of this pipe.
     */
    readonly name?: string;
    withName(name: string | null): Reconstruction.TargetExtractionPipe;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Reconstruction.TargetExtractionPipe;
    ...
    withVersion(version: number | null): Reconstruction.TargetExtractionPipe;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Reconstruction.TargetExtractionPipe;
    ...
    withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): Reconstruction.TargetExtractionPipe;
    ...
    withHidden(hidden: boolean): Reconstruction.TargetExtractionPipe;
    ...
    withUserOwned(userOwned: boolean): Reconstruction.TargetExtractionPipe;
    ...
    withTypeIdent(typeIdent: string | null): Reconstruction.TargetExtractionPipe;

    /**
     * If true, then the pipe shall not be retrained
     */
    readonly frozen?: boolean;
    withFrozen(frozen: boolean): Reconstruction.TargetExtractionPipe;

    /**
     * True if training has succeeded and false otherwise.
     */
    readonly trained?: boolean;
    withTrained(trained: boolean): Reconstruction.TargetExtractionPipe;

    /**
     * Errors from training.
     */
    readonly trainingErrors?: string;
    withTrainingErrors(trainingErrors: string | null): Reconstruction.TargetExtractionPipe;

    /**
     * If true, the underlying model only accepts flattened input.
     */
    readonly flattenInput?: boolean;
    withFlattenInput(flattenInput: boolean): Reconstruction.TargetExtractionPipe;

    /**
     * The hyperparameters overridden of a native model or pipe.
     */
    readonly hyperparamOverrides?: Map_Type<string, any>;
    withHyperparamOverrides(hyperparamOverrides: Map_Type<string, any> | {[key: string]: any} | null): Reconstruction.TargetExtractionPipe;
    ...
    withHyperparamSearchSpace(hyperparamSearchSpace: IHp.SearchSpace | null): Reconstruction.TargetExtractionPipe;
    ...
    withHpoSpec(hpoSpec: IHpo.Spec | null): Reconstruction.TargetExtractionPipe;

    /**
     * {@link Hpo.Experiment} stores the result of hyperparameter optimization to find the best model/pipeline.
     */
    readonly hpoExperiment?: Hpo.Experiment;
    withHpoExperiment(hpoExperiment: IHpo.Experiment | null): Reconstruction.TargetExtractionPipe;

    /**
     * Reference to the experiment that produced this {@link MlPipe}. For example, this could be a {@link Hpo.ExperimentBase}.
     */
    readonly experiment?: any;
    withExperiment(experiment: any | null): Reconstruction.TargetExtractionPipe;
    ...
    withModelFiles(modelFiles: Map_Type<string, Url> | {[key: string]: IUrl} | null): Reconstruction.TargetExtractionPipe;
    ...
    withCustomModelCode(customModelCode: Map_Type<string, any> | {[key: string]: any} | null): Reconstruction.TargetExtractionPipe;

    /**
     * Name for the function on the native model to call to do {@link MlProcessable#process}.
     */
    readonly processFunc?: string;
    withProcessFunc(processFunc: string | null): Reconstruction.TargetExtractionPipe;

    /**
     * The target column to extract
     */
    readonly target: string;
    withTarget(target: string): Reconstruction.TargetExtractionPipe;

    /**
     * The features to extract. If empty, this pipe will assume all other columns but the {@link #target} are features
     */
    readonly features?: Array_Type<string>;
    withFeatures(features: Array_Type<string> | Array<string> | null): Reconstruction.TargetExtractionPipe;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Reconstruction.TargetExtractionPipe | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Reconstruction.TargetExtractionPipe | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Reconstruction.TargetExtractionPipe | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Reconstruction.TargetExtractionPipe | null;
     ...
     */
    replaceType(old: Type, new_: Type): Reconstruction.TargetExtractionPipe;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Reconstruction.TargetExtractionPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Reconstruction.TargetExtractionPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Reconstruction.TargetExtractionPipe>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Reconstruction.TargetExtractionPipe>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Reconstruction.TargetExtractionPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Reconstruction.TargetExtractionPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Reconstruction.TargetExtractionPipe;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Reconstruction.TargetExtractionPipe;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Reconstruction.TargetExtractionPipe;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Reconstruction.TargetExtractionPipe;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Reconstruction.TargetExtractionPipe;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Reconstruction.TargetExtractionPipe;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Reconstruction.TargetExtractionPipe;
     ...
     * @see #removeField
     */
    withoutField(field: string): Reconstruction.TargetExtractionPipe;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Reconstruction.TargetExtractionPipe;
     ...
     */
    withoutFields(fields: Array_Type<string>): Reconstruction.TargetExtractionPipe;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Reconstruction.TargetExtractionPipe;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Reconstruction.TargetExtractionPipe;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Reconstruction.TargetExtractionPipe;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Reconstruction.TargetExtractionPipe;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Reconstruction.TargetExtractionPipe;
     ...
     * @see #removeField
     */
    unsetField(field: string): Reconstruction.TargetExtractionPipe;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Reconstruction.TargetExtractionPipe;
     ...
     * @see #unsetField
     */
    removeField(field: string): Reconstruction.TargetExtractionPipe;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Reconstruction.TargetExtractionPipe;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Reconstruction.TargetExtractionPipe;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Reconstruction.TargetExtractionPipe;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Reconstruction.TargetExtractionPipe;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Reconstruction.TargetExtractionPipe;

    mergeJson(json: any): Reconstruction.TargetExtractionPipe;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Reconstruction.TargetExtractionPipe;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Reconstruction.TargetExtractionPipe;
     ...
     */
    singletonArray(): Array_Type<Reconstruction.TargetExtractionPipe>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Reconstruction.TargetExtractionPipe> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Reconstruction.TargetExtractionPipe> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Reconstruction.TargetExtractionPipe>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Reconstruction.TargetExtractionPipe> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Reconstruction.TargetExtractionPipe> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Reconstruction.TargetExtractionPipe> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Reconstruction.TargetExtractionPipe>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Reconstruction.TargetExtractionPipe>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Reconstruction.TargetExtractionPipe;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Reconstruction.TargetExtractionPipe;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Reconstruction.TargetExtractionPipe;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Reconstruction.TargetExtractionPipe;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Reconstruction.TargetExtractionPipe;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Reconstruction.TargetExtractionPipe;
     ...
     * @see #fromString
     */
    static make(s: string): Reconstruction.TargetExtractionPipe | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Reconstruction.TargetExtractionPipe;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Reconstruction.TargetExtractionPipe;
     ...
     */
    static cachedEmptyInst(): Reconstruction.TargetExtractionPipe;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Reconstruction.TargetExtractionPipe> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Reconstruction.TargetExtractionPipe;
     ...
     */
    withoutIdentity(): Reconstruction.TargetExtractionPipe;
     ...
     */
    trainSync(x: Data, y?: , spec?: MlOperationSpec): Reconstruction.TargetExtractionPipe;
     ...
     */
    static allCached(): Stream<Reconstruction.TargetExtractionPipe> | null;
     ...
     */
    static find(filter?: string): Stream<Reconstruction.TargetExtractionPipe> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<Reconstruction.TargetExtractionPipe> | null;

    /**
     * @return cached instance.
     */
    getCached(): Reconstruction.TargetExtractionPipe | null;

    /**
     * @return cached instance by the key.
     */
    static forCacheKey(key: string): Reconstruction.TargetExtractionPipe | null;
     ...
     */
    static produce(key: string): Reconstruction.TargetExtractionPipe | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, Reconstruction.TargetExtractionPipe> | null;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Reconstruction.TargetExtractionPipe>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Reconstruction.TargetExtractionPipe>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Reconstruction.TargetExtractionPipe> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Reconstruction.TargetExtractionPipe>> | null;
     ...
     */
    get(include?: string): Reconstruction.TargetExtractionPipe | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Reconstruction.TargetExtractionPipe | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Reconstruction.TargetExtractionPipe;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Reconstruction.TargetExtractionPipe | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Reconstruction.TargetExtractionPipe;
     ...
     * @see #toString
     */
    static fromString(s: string): Reconstruction.TargetExtractionPipe | null;
     ...
     */
    create(spec?: UpsertSpec): Reconstruction.TargetExtractionPipe | null;
     ...
     */
    static createBatch(objs: Array_Type<Reconstruction.TargetExtractionPipe>, spec?: UpsertSpec): ObjList<Reconstruction.TargetExtractionPipe> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Reconstruction.TargetExtractionPipe>, spec?: CreateBatchObjStreamSpec): ObjList<Reconstruction.TargetExtractionPipe> | null;
     ...
     */
    update(srcObj?: Reconstruction.TargetExtractionPipe, spec?: UpsertSpec): Reconstruction.TargetExtractionPipe | null;
     ...
     */
    upsert(srcObj?: Reconstruction.TargetExtractionPipe, spec?: UpsertSpec): Reconstruction.TargetExtractionPipe | null;
     ...
     */
    merge(spec?: MergeSpec): Reconstruction.TargetExtractionPipe | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Reconstruction.TargetExtractionPipe | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Reconstruction.TargetExtractionPipe | null;
     ...
     */
    static updateBatch(objs: Array_Type<Reconstruction.TargetExtractionPipe>, srcObjs?: Array_Type<Reconstruction.TargetExtractionPipe>, spec?: UpsertSpec): ObjList<Reconstruction.TargetExtractionPipe> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Reconstruction.TargetExtractionPipe> | null>, spec?: UpsertSpec): ObjList<Reconstruction.TargetExtractionPipe> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Reconstruction.TargetExtractionPipe>, srcObjs?: Array_Type<Reconstruction.TargetExtractionPipe>, spec?: UpsertSpec): ObjList<Reconstruction.TargetExtractionPipe> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Reconstruction.TargetExtractionPipe> | null>, spec?: UpsertSpec): ObjList<Reconstruction.TargetExtractionPipe> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Reconstruction.TargetExtractionPipe>, spec?: TouchSpec): ObjList<Reconstruction.TargetExtractionPipe> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Reconstruction.TargetExtractionPipe>, spec?: MergeSpec): ObjList<Reconstruction.TargetExtractionPipe> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Reconstruction.TargetExtractionPipe>, mergeInclude: string, spec?: MergeSpec): ObjList<Reconstruction.TargetExtractionPipe> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Reconstruction.TargetExtractionPipe> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Reconstruction.TargetExtractionPipe> | null;
     ...
     */
    static mergeAll(mergeObj: Reconstruction.TargetExtractionPipe, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Reconstruction.TargetExtractionPipe, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Reconstruction.TargetExtractionPipe>, spec?: UpsertSpec): ObjList<Reconstruction.TargetExtractionPipe> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Reconstruction.TargetExtractionPipe>, spec?: UpsertSpec): ObjList<Reconstruction.TargetExtractionPipe> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Reconstruction.TargetExtractionPipe | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Reconstruction.TargetExtractionPipe>): ObjList<Reconstruction.TargetExtractionPipe>;
     ...
     */
    static beforeUpdate(objs: Array_Type<Reconstruction.TargetExtractionPipe>): ObjList<Reconstruction.TargetExtractionPipe>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Reconstruction.TargetExtractionPipe>): ObjList<Reconstruction.TargetExtractionPipe>;
     ...
     */
    static afterCreate(objs: Array_Type<Reconstruction.TargetExtractionPipe>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Reconstruction.TargetExtractionPipe>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Reconstruction.TargetExtractionPipe>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Reconstruction.TargetExtractionPipe>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Reconstruction.TargetExtractionPipe>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Reconstruction.TargetExtractionPipe | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Reconstruction.TargetExtractionPipe>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Reconstruction.TargetExtractionPipe, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Reconstruction.TargetExtractionPipe>, callback?: λFunction<Reconstruction.TargetExtractionPipe | null, Reconstruction.TargetExtractionPipe | null>): ObjList<Reconstruction.TargetExtractionPipe>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Reconstruction.TargetExtractionPipe>, callback?: λFunction<Reconstruction.TargetExtractionPipe | null, Reconstruction.TargetExtractionPipe | null>): Array_Type<ObjError> | null;
     ...
     */
    publish(subPath?: string, contentType?: string): Reconstruction.TargetExtractionPipe;
     ...
     */
    static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<Reconstruction.TargetExtractionPipe> | null;
     ...
     */
    createSeedData(spec?: UpsertSpec): Reconstruction.TargetExtractionPipe | null;
     ...
     */
    static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<Reconstruction.TargetExtractionPipe> | null;
     ...
     */
    updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): Reconstruction.TargetExtractionPipe | null;
     ...
     */
    static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<Reconstruction.TargetExtractionPipe> | null;
     ...
     * @return updated obj instance, same as {@link Persistable#update} return value.
     */
    clearUserUpdates(spec?: MergeSpec): Reconstruction.TargetExtractionPipe | null;
     ...
     *         {@link Persistable#updateBatch}.
     */
    static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<Reconstruction.TargetExtractionPipe> | null;
    ...
    dependencies(): SeedDataDeps<Reconstruction.TargetExtractionPipe> | null;
     ...
     * be returned as-is.
     */
    byReference(): Reconstruction.TargetExtractionPipe;
     ...
     */
    updateModelFiles(modelFiles: Map_Type<string, Url>, spec?: MlOperationSpec): Reconstruction.TargetExtractionPipe;
     ...
     */
    afterTrain(doTrainOutputs: any, spec?: MlOperationSpec): Reconstruction.TargetExtractionPipe;
     ...
     */
    withNewSpec(spec?: MlConvertSpec): Reconstruction.TargetExtractionPipe;
     ...
     */
    afterConvert(model: any, spec?: MlConvertSpec): Reconstruction.TargetExtractionPipe;
     ...
     */
    withHyperparamSpaces(paramSpaces: Map_Type<string, Hp.ParamSpace>): Reconstruction.TargetExtractionPipe;
