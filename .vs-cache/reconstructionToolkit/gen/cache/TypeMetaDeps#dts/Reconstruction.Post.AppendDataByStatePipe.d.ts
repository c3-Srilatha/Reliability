// TypeScript definitions for the C3 type Reconstruction.Post.AppendDataByStatePipe

/**
 * This type represents a process-only {@link MlPipe} that appends (row-wise) data across different states.
 *
 * @remarks this represents a value passed to a method that expects an instance of Reconstruction.Post.AppendDataByStatePipe
 */
declare namespace Reconstruction.Post {
  export interface IAppendDataByStatePipe<DX, DO> {
     ...
     */
    states: Array_Type<string> | Array<string>;
     ...
     */
    emptyDataSubjectIndicator?: string;
  }
}
 ...
 * This type represents a process-only {@link MlPipe} that appends (row-wise) data across different states.
 *
 * @remarks this represents a made instance of Reconstruction.Post.AppendDataByStatePipe
 */
declare namespace Reconstruction.Post {
  export class AppendDataByStatePipe<DX, DO> extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): Reconstruction.Post.AppendDataByStatePipe;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Reconstruction.Post.AppendDataByStatePipe;

    /**
     * Name of this pipe.
     */
    readonly name?: string;
    withName(name: string | null): Reconstruction.Post.AppendDataByStatePipe;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Reconstruction.Post.AppendDataByStatePipe;
    ...
    withVersion(version: number | null): Reconstruction.Post.AppendDataByStatePipe;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Reconstruction.Post.AppendDataByStatePipe;
    ...
    withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): Reconstruction.Post.AppendDataByStatePipe;
    ...
    withHidden(hidden: boolean): Reconstruction.Post.AppendDataByStatePipe;
    ...
    withUserOwned(userOwned: boolean): Reconstruction.Post.AppendDataByStatePipe;
    ...
    withTypeIdent(typeIdent: string | null): Reconstruction.Post.AppendDataByStatePipe;

    /**
     * If true, then the pipe shall not be retrained
     */
    readonly frozen?: boolean;
    withFrozen(frozen: boolean): Reconstruction.Post.AppendDataByStatePipe;

    /**
     * True if training has succeeded and false otherwise.
     */
    readonly trained?: boolean;
    withTrained(trained: boolean): Reconstruction.Post.AppendDataByStatePipe;

    /**
     * Errors from training.
     */
    readonly trainingErrors?: string;
    withTrainingErrors(trainingErrors: string | null): Reconstruction.Post.AppendDataByStatePipe;

    /**
     * If true, the underlying model only accepts flattened input.
     */
    readonly flattenInput?: boolean;
    withFlattenInput(flattenInput: boolean): Reconstruction.Post.AppendDataByStatePipe;

    /**
     * The hyperparameters overridden of a native model or pipe.
     */
    readonly hyperparamOverrides?: Map_Type<string, any>;
    withHyperparamOverrides(hyperparamOverrides: Map_Type<string, any> | {[key: string]: any} | null): Reconstruction.Post.AppendDataByStatePipe;
    ...
    withHyperparamSearchSpace(hyperparamSearchSpace: IHp.SearchSpace | null): Reconstruction.Post.AppendDataByStatePipe;
    ...
    withHpoSpec(hpoSpec: IHpo.Spec | null): Reconstruction.Post.AppendDataByStatePipe;

    /**
     * {@link Hpo.Experiment} stores the result of hyperparameter optimization to find the best model/pipeline.
     */
    readonly hpoExperiment?: Hpo.Experiment;
    withHpoExperiment(hpoExperiment: IHpo.Experiment | null): Reconstruction.Post.AppendDataByStatePipe;

    /**
     * Reference to the experiment that produced this {@link MlPipe}. For example, this could be a {@link Hpo.ExperimentBase}.
     */
    readonly experiment?: any;
    withExperiment(experiment: any | null): Reconstruction.Post.AppendDataByStatePipe;
    ...
    withModelFiles(modelFiles: Map_Type<string, Url> | {[key: string]: IUrl} | null): Reconstruction.Post.AppendDataByStatePipe;
    ...
    withCustomModelCode(customModelCode: Map_Type<string, any> | {[key: string]: any} | null): Reconstruction.Post.AppendDataByStatePipe;

    /**
     * Name for the function on the native model to call to do {@link MlProcessable#process}.
     */
    readonly processFunc?: string;
    withProcessFunc(processFunc: string | null): Reconstruction.Post.AppendDataByStatePipe;
    ...
    withUnderlyingPipe(underlyingPipe: IMlAtomicPipe<any, any, any> | null): Reconstruction.Post.AppendDataByStatePipe;

    /**
     * The names of the different states that need to be appended. These will determine the names of the input {@link Data}.
     */
    readonly states: Array_Type<string>;
    withStates(states: Array_Type<string> | Array<string>): Reconstruction.Post.AppendDataByStatePipe;
     ...
     * and the rows will be dropped when appending data across states. The default value is 'null'.
     */
    readonly emptyDataSubjectIndicator?: string;
    withEmptyDataSubjectIndicator(emptyDataSubjectIndicator: string | null): Reconstruction.Post.AppendDataByStatePipe;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Reconstruction.Post.AppendDataByStatePipe<DX, DO> | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Reconstruction.Post.AppendDataByStatePipe<DX, DO> | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Reconstruction.Post.AppendDataByStatePipe<DX, DO> | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Reconstruction.Post.AppendDataByStatePipe<DX, DO> | null;
     ...
     */
    replaceType(old: Type, new_: Type): Reconstruction.Post.AppendDataByStatePipe<DX, DO>;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Reconstruction.Post.AppendDataByStatePipe<DX, DO>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Reconstruction.Post.AppendDataByStatePipe<DX, DO>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Reconstruction.Post.AppendDataByStatePipe<DX, DO>>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Reconstruction.Post.AppendDataByStatePipe<DX, DO>>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Reconstruction.Post.AppendDataByStatePipe<DX, DO>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Reconstruction.Post.AppendDataByStatePipe<DX, DO>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Reconstruction.Post.AppendDataByStatePipe<DX, DO>;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Reconstruction.Post.AppendDataByStatePipe<DX, DO>;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Reconstruction.Post.AppendDataByStatePipe<DX, DO>;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Reconstruction.Post.AppendDataByStatePipe<DX, DO>;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Reconstruction.Post.AppendDataByStatePipe<DX, DO>;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Reconstruction.Post.AppendDataByStatePipe<DX, DO>;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Reconstruction.Post.AppendDataByStatePipe<DX, DO>;
     ...
     * @see #removeField
     */
    withoutField(field: string): Reconstruction.Post.AppendDataByStatePipe<DX, DO>;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Reconstruction.Post.AppendDataByStatePipe<DX, DO>;
     ...
     */
    withoutFields(fields: Array_Type<string>): Reconstruction.Post.AppendDataByStatePipe<DX, DO>;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Reconstruction.Post.AppendDataByStatePipe<DX, DO>;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Reconstruction.Post.AppendDataByStatePipe<DX, DO>;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Reconstruction.Post.AppendDataByStatePipe<DX, DO>;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Reconstruction.Post.AppendDataByStatePipe<DX, DO>;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Reconstruction.Post.AppendDataByStatePipe<DX, DO>;
     ...
     * @see #removeField
     */
    unsetField(field: string): Reconstruction.Post.AppendDataByStatePipe<DX, DO>;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Reconstruction.Post.AppendDataByStatePipe<DX, DO>;
     ...
     * @see #unsetField
     */
    removeField(field: string): Reconstruction.Post.AppendDataByStatePipe<DX, DO>;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Reconstruction.Post.AppendDataByStatePipe<DX, DO>;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Reconstruction.Post.AppendDataByStatePipe<DX, DO>;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Reconstruction.Post.AppendDataByStatePipe<DX, DO>;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Reconstruction.Post.AppendDataByStatePipe<DX, DO>;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Reconstruction.Post.AppendDataByStatePipe<DX, DO>;

    mergeJson(json: any): Reconstruction.Post.AppendDataByStatePipe<DX, DO>;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Reconstruction.Post.AppendDataByStatePipe<DX, DO>;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Reconstruction.Post.AppendDataByStatePipe<DX, DO>;
     ...
     */
    singletonArray(): Array_Type<Reconstruction.Post.AppendDataByStatePipe<DX, DO>>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Reconstruction.Post.AppendDataByStatePipe<DX, DO>> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Reconstruction.Post.AppendDataByStatePipe<DX, DO>> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Reconstruction.Post.AppendDataByStatePipe<DX, DO>>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Reconstruction.Post.AppendDataByStatePipe<DX, DO>> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Reconstruction.Post.AppendDataByStatePipe<DX, DO>> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Reconstruction.Post.AppendDataByStatePipe<DX, DO>> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Reconstruction.Post.AppendDataByStatePipe<DX, DO>>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Reconstruction.Post.AppendDataByStatePipe<DX, DO>>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Reconstruction.Post.AppendDataByStatePipe<DX, DO>;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Reconstruction.Post.AppendDataByStatePipe<DX, DO>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Reconstruction.Post.AppendDataByStatePipe<DX, DO>;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Reconstruction.Post.AppendDataByStatePipe<DX, DO>;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Reconstruction.Post.AppendDataByStatePipe<DX, DO>;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Reconstruction.Post.AppendDataByStatePipe<DX, DO>;
     ...
     * @see #fromString
     */
    static make(s: string): Reconstruction.Post.AppendDataByStatePipe<DX, DO> | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Reconstruction.Post.AppendDataByStatePipe<DX, DO>;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Reconstruction.Post.AppendDataByStatePipe<DX, DO>;
     ...
     */
    static cachedEmptyInst(): Reconstruction.Post.AppendDataByStatePipe<DX, DO>;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Reconstruction.Post.AppendDataByStatePipe<DX, DO>> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Reconstruction.Post.AppendDataByStatePipe<DX, DO>;
     ...
     */
    static generateCenterPipeline(center: MlPipe<any, any, any, any, any>, useVar?: boolean): MlPipeline<any, any, any, any, any>;
     ...
     */
    static mergePipelines(first: MlPipeline<any, any, any, any, any>, second: MlPipe<any, any, any, any, any>, outputToInput: Map_Type<string, string>, keepFirstOutputs?: boolean): MlPipeline<any, any, any, any, any>;
     ...
     */
    static makePipeline(first: MlPipeline<any, any, any, any, any>, second: MlPipeline<any, any, any, any, any>, newVertices: Array_Type<MlPipeline.Vertex>, newEdges: Array_Type<FlowGraph.Edge<MlPipeline.Vertex>>): MlPipeline<any, any, any, any, any>;
     ...
     * ```
     */
    succeed(pipe: MlPipe<any, any, any, any, any> | Map_Type<string, MlPipe<any, any, any, any, any>>, kwargs?: Map_Type<string, any>): MlPipeline<any, any, any, any, any>;
     ...
     */
    static connect(center: MlPipe<any, any, any, any, any>, post: MlPipeline<any, any, any, any, any>, inputMap: Map_Type<string, string>, kwargs?: Map_Type<string, any>): MlPipeline<any, any, any, any, any>;
     ...
     */
    static validate(pipe: MlPipe<any, any, any, any, any>, outputKeys: Array_Type<string>): void;
     ...
     */
    remakeTemplate(): Reconstruction.Post.AppendDataByStatePipe<DX, DO>;
     ...
     */
    withoutIdentity(): Reconstruction.Post.AppendDataByStatePipe<DX, DO>;
     ...
     */
    trainSync(x: DX, y?: , spec?: MlOperationSpec): Reconstruction.Post.AppendDataByStatePipe<DX, DO>;
     ...
     */
    static allCached(): Stream<Reconstruction.Post.AppendDataByStatePipe<DX, DO>> | null;
     ...
     */
    static find(filter?: string): Stream<Reconstruction.Post.AppendDataByStatePipe<DX, DO>> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<Reconstruction.Post.AppendDataByStatePipe<DX, DO>> | null;

    /**
     * @return cached instance.
     */
    getCached(): Reconstruction.Post.AppendDataByStatePipe<DX, DO> | null;

    /**
     * @return cached instance by the key.
     */
    static forCacheKey(key: string): Reconstruction.Post.AppendDataByStatePipe<DX, DO> | null;
     ...
     */
    static produce(key: string): Reconstruction.Post.AppendDataByStatePipe<DX, DO> | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, Reconstruction.Post.AppendDataByStatePipe<DX, DO>> | null;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Reconstruction.Post.AppendDataByStatePipe<DX, DO>>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Reconstruction.Post.AppendDataByStatePipe<DX, DO>>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Reconstruction.Post.AppendDataByStatePipe<DX, DO>> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Reconstruction.Post.AppendDataByStatePipe<DX, DO>>> | null;
     ...
     */
    get(include?: string): Reconstruction.Post.AppendDataByStatePipe<DX, DO> | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Reconstruction.Post.AppendDataByStatePipe<DX, DO> | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Reconstruction.Post.AppendDataByStatePipe<DX, DO>;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Reconstruction.Post.AppendDataByStatePipe<DX, DO> | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Reconstruction.Post.AppendDataByStatePipe<DX, DO>;
     ...
     * @see #toString
     */
    static fromString(s: string): Reconstruction.Post.AppendDataByStatePipe<DX, DO> | null;
     ...
     */
    create(spec?: UpsertSpec): Reconstruction.Post.AppendDataByStatePipe<DX, DO> | null;
     ...
     */
    static createBatch(objs: Array_Type<Reconstruction.Post.AppendDataByStatePipe<DX, DO>>, spec?: UpsertSpec): ObjList<Reconstruction.Post.AppendDataByStatePipe<DX, DO>> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Reconstruction.Post.AppendDataByStatePipe<DX, DO>>, spec?: CreateBatchObjStreamSpec): ObjList<Reconstruction.Post.AppendDataByStatePipe<DX, DO>> | null;
     ...
     */
    update(srcObj?: Reconstruction.Post.AppendDataByStatePipe<DX, DO>, spec?: UpsertSpec): Reconstruction.Post.AppendDataByStatePipe<DX, DO> | null;
     ...
     */
    upsert(srcObj?: Reconstruction.Post.AppendDataByStatePipe<DX, DO>, spec?: UpsertSpec): Reconstruction.Post.AppendDataByStatePipe<DX, DO> | null;
     ...
     */
    merge(spec?: MergeSpec): Reconstruction.Post.AppendDataByStatePipe<DX, DO> | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Reconstruction.Post.AppendDataByStatePipe<DX, DO> | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Reconstruction.Post.AppendDataByStatePipe<DX, DO> | null;
     ...
     */
    static updateBatch(objs: Array_Type<Reconstruction.Post.AppendDataByStatePipe<DX, DO>>, srcObjs?: Array_Type<Reconstruction.Post.AppendDataByStatePipe<DX, DO>>, spec?: UpsertSpec): ObjList<Reconstruction.Post.AppendDataByStatePipe<DX, DO>> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Reconstruction.Post.AppendDataByStatePipe<DX, DO>> | null>, spec?: UpsertSpec): ObjList<Reconstruction.Post.AppendDataByStatePipe<DX, DO>> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Reconstruction.Post.AppendDataByStatePipe<DX, DO>>, srcObjs?: Array_Type<Reconstruction.Post.AppendDataByStatePipe<DX, DO>>, spec?: UpsertSpec): ObjList<Reconstruction.Post.AppendDataByStatePipe<DX, DO>> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Reconstruction.Post.AppendDataByStatePipe<DX, DO>> | null>, spec?: UpsertSpec): ObjList<Reconstruction.Post.AppendDataByStatePipe<DX, DO>> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Reconstruction.Post.AppendDataByStatePipe<DX, DO>>, spec?: TouchSpec): ObjList<Reconstruction.Post.AppendDataByStatePipe<DX, DO>> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Reconstruction.Post.AppendDataByStatePipe<DX, DO>>, spec?: MergeSpec): ObjList<Reconstruction.Post.AppendDataByStatePipe<DX, DO>> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Reconstruction.Post.AppendDataByStatePipe<DX, DO>>, mergeInclude: string, spec?: MergeSpec): ObjList<Reconstruction.Post.AppendDataByStatePipe<DX, DO>> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Reconstruction.Post.AppendDataByStatePipe<DX, DO>> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Reconstruction.Post.AppendDataByStatePipe<DX, DO>> | null;
     ...
     */
    static mergeAll(mergeObj: Reconstruction.Post.AppendDataByStatePipe<DX, DO>, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Reconstruction.Post.AppendDataByStatePipe<DX, DO>, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Reconstruction.Post.AppendDataByStatePipe<DX, DO>>, spec?: UpsertSpec): ObjList<Reconstruction.Post.AppendDataByStatePipe<DX, DO>> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Reconstruction.Post.AppendDataByStatePipe<DX, DO>>, spec?: UpsertSpec): ObjList<Reconstruction.Post.AppendDataByStatePipe<DX, DO>> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Reconstruction.Post.AppendDataByStatePipe<DX, DO> | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Reconstruction.Post.AppendDataByStatePipe<DX, DO>>): ObjList<Reconstruction.Post.AppendDataByStatePipe<DX, DO>>;
     ...
     */
    static beforeUpdate(objs: Array_Type<Reconstruction.Post.AppendDataByStatePipe<DX, DO>>): ObjList<Reconstruction.Post.AppendDataByStatePipe<DX, DO>>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Reconstruction.Post.AppendDataByStatePipe<DX, DO>>): ObjList<Reconstruction.Post.AppendDataByStatePipe<DX, DO>>;
     ...
     */
    static afterCreate(objs: Array_Type<Reconstruction.Post.AppendDataByStatePipe<DX, DO>>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Reconstruction.Post.AppendDataByStatePipe<DX, DO>>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Reconstruction.Post.AppendDataByStatePipe<DX, DO>>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Reconstruction.Post.AppendDataByStatePipe<DX, DO>>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Reconstruction.Post.AppendDataByStatePipe<DX, DO>>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Reconstruction.Post.AppendDataByStatePipe<DX, DO> | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Reconstruction.Post.AppendDataByStatePipe<DX, DO>>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Reconstruction.Post.AppendDataByStatePipe<DX, DO>, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Reconstruction.Post.AppendDataByStatePipe<DX, DO>>, callback?: λFunction<Reconstruction.Post.AppendDataByStatePipe<DX, DO> | null, Reconstruction.Post.AppendDataByStatePipe<DX, DO> | null>): ObjList<Reconstruction.Post.AppendDataByStatePipe<DX, DO>>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Reconstruction.Post.AppendDataByStatePipe<DX, DO>>, callback?: λFunction<Reconstruction.Post.AppendDataByStatePipe<DX, DO> | null, Reconstruction.Post.AppendDataByStatePipe<DX, DO> | null>): Array_Type<ObjError> | null;
     ...
     */
    publish(subPath?: string, contentType?: string): Reconstruction.Post.AppendDataByStatePipe<DX, DO>;
     ...
     */
    static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<Reconstruction.Post.AppendDataByStatePipe<DX, DO>> | null;
     ...
     */
    createSeedData(spec?: UpsertSpec): Reconstruction.Post.AppendDataByStatePipe<DX, DO> | null;
     ...
     */
    static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<Reconstruction.Post.AppendDataByStatePipe<DX, DO>> | null;
     ...
     */
    updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): Reconstruction.Post.AppendDataByStatePipe<DX, DO> | null;
     ...
     */
    static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<Reconstruction.Post.AppendDataByStatePipe<DX, DO>> | null;
     ...
     * @return updated obj instance, same as {@link Persistable#update} return value.
     */
    clearUserUpdates(spec?: MergeSpec): Reconstruction.Post.AppendDataByStatePipe<DX, DO> | null;
     ...
     *         {@link Persistable#updateBatch}.
     */
    static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<Reconstruction.Post.AppendDataByStatePipe<DX, DO>> | null;
    ...
    dependencies(): SeedDataDeps<Reconstruction.Post.AppendDataByStatePipe<DX, DO>> | null;
     ...
     */
    static convert(model: any, spec?: MlConvertSpec): Reconstruction.Post.AppendDataByStatePipe<DX, DO>;

    /**
     * Freezes an {@link MlPipe}
     * @return modified copy of this {@link MlPipe} that cannot be trained
     */
    freeze(): Reconstruction.Post.AppendDataByStatePipe<DX, DO>;

    /**
     * Unfreezes an {@link MlPipe}
     * @return modified copy of this {@link MlPipe} that can be trained
     */
    unfreeze(): Reconstruction.Post.AppendDataByStatePipe<DX, DO>;
     ...
     * be returned as-is.
     */
    byReference(): Reconstruction.Post.AppendDataByStatePipe<DX, DO>;
     ...
     */
    updateModelFiles(modelFiles: Map_Type<string, Url>, spec?: MlOperationSpec): Reconstruction.Post.AppendDataByStatePipe<DX, DO>;
     ...
     */
    afterTrain(doTrainOutputs: any, spec?: MlOperationSpec): Reconstruction.Post.AppendDataByStatePipe<DX, DO>;
     ...
     */
    convertPipeInputsToNative(x: DX, y?: , spec?: MlOperationSpec): any;
     ...
     */
    withNewSpec(spec?: MlConvertSpec): Reconstruction.Post.AppendDataByStatePipe<DX, DO>;
     ...
     */
    afterConvert(model: any, spec?: MlConvertSpec): Reconstruction.Post.AppendDataByStatePipe<DX, DO>;
     ...
     */
    withHyperparamSpaces(paramSpaces: Map_Type<string, Hp.ParamSpace>): Reconstruction.Post.AppendDataByStatePipe<DX, DO>;
