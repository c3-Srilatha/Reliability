// TypeScript definitions for the C3 type Reconstruction.Algorithm.VirtualSensingPipeline
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of Reconstruction.Algorithm.VirtualSensingPipeline
 */
declare namespace Reconstruction.Algorithm {
  export interface IVirtualSensingPipeline<DS, DO, DI> {

    /**
     * A lookback duration for the current reconstruction algorithm that helps determine the time interval in which data
     * should be fetched.
     */
     ...
     */
    targets: Array_Type<string> | Array<string>;
     ...
     */
    targetToFeatures?: Map_Type<string, Array_Type<string>> | {[key: string]: Array_Type<string> | Array<string>};
     ...
     */
    regressor?: IMlPipe<any, any, any, any, any>;
     ...
     */
    targetToRegressor?: Map_Type<string, MlPipe<any, any, any, any, any>> | {[key: string]: IMlPipe<any, any, any, any, any>};
     ...
     */
    scoringMetric?: IMlScoringMetric<any, any, any>;
    ...
    targetToScoringMetric?: Map_Type<string, MlScoringMetric<any, any, any>> | {[key: string]: IMlScoringMetric<any, any, any>};
     ...
     */
    targetToInterpreter?: Map_Type<string, MlInterpreter<any, any>> | {[key: string]: IMlInterpreter<any, any>};
  }
}
 ...
 * return a {@link Data} of the `targets` by setting {@link #includeTarget}.
 *
 * @remarks this represents a made instance of Reconstruction.Algorithm.VirtualSensingPipeline
 */
declare namespace Reconstruction.Algorithm {
  export class VirtualSensingPipeline<DS, DO, DI> extends Obj  {
    ...
    withLookbackDuration(lookbackDuration: IDuration | null): Reconstruction.Algorithm.VirtualSensingPipeline;

    /**
     * An optional suffix that is added to the column names of the reconstruction {@link Data}.
     */
    readonly reconstructionSuffix?: string;
    withReconstructionSuffix(reconstructionSuffix: string | null): Reconstruction.Algorithm.VirtualSensingPipeline;

    /**
     * An optional suffix that is added to the column names of the residual {@link Data}.
     */
    readonly residualSuffix?: string;
    withResidualSuffix(residualSuffix: string | null): Reconstruction.Algorithm.VirtualSensingPipeline;

    /**
     * List of all vertices in this graph.
     */
    readonly vertices?: Array_Type<MlPipeline.Vertex>;
    withVertices(vertices: Array_Type<MlPipeline.Vertex> | Array<IMlPipeline.Vertex> | null): Reconstruction.Algorithm.VirtualSensingPipeline;

    /**
     * List of all edges in this graph.
     */
    readonly edges?: Array_Type<FlowGraph.Edge<MlPipeline.Vertex>>;
    withEdges(edges: Array_Type<FlowGraph.Edge<MlPipeline.Vertex>> | Array<IFlowGraph.Edge<MlPipeline.Vertex>> | null): Reconstruction.Algorithm.VirtualSensingPipeline;
    ...
    withVertexConnections(vertexConnections: Map_Type<string, Map_Type<string, any>> | {[key: string]: Map_Type<string, any> | {[key: string]: any}} | null): Reconstruction.Algorithm.VirtualSensingPipeline;
     ...
     */
    readonly id: string;
    withId(id: string): Reconstruction.Algorithm.VirtualSensingPipeline;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Reconstruction.Algorithm.VirtualSensingPipeline;

    /**
     * Name of this pipe.
     */
    readonly name?: string;
    withName(name: string | null): Reconstruction.Algorithm.VirtualSensingPipeline;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Reconstruction.Algorithm.VirtualSensingPipeline;
    ...
    withVersion(version: number | null): Reconstruction.Algorithm.VirtualSensingPipeline;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Reconstruction.Algorithm.VirtualSensingPipeline;
    ...
    withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): Reconstruction.Algorithm.VirtualSensingPipeline;
    ...
    withHidden(hidden: boolean): Reconstruction.Algorithm.VirtualSensingPipeline;
    ...
    withUserOwned(userOwned: boolean): Reconstruction.Algorithm.VirtualSensingPipeline;
    ...
    withTypeIdent(typeIdent: string | null): Reconstruction.Algorithm.VirtualSensingPipeline;

    /**
     * If true, then the pipe shall not be retrained
     */
    readonly frozen?: boolean;
    withFrozen(frozen: boolean): Reconstruction.Algorithm.VirtualSensingPipeline;

    /**
     * True if training has succeeded and false otherwise.
     */
    readonly trained?: boolean;
    withTrained(trained: boolean): Reconstruction.Algorithm.VirtualSensingPipeline;

    /**
     * Errors from training.
     */
    readonly trainingErrors?: string;
    withTrainingErrors(trainingErrors: string | null): Reconstruction.Algorithm.VirtualSensingPipeline;

    /**
     * If true, the underlying model only accepts flattened input.
     */
    readonly flattenInput?: boolean;
    withFlattenInput(flattenInput: boolean): Reconstruction.Algorithm.VirtualSensingPipeline;

    /**
     * The hyperparameters overridden of a native model or pipe.
     */
    readonly hyperparamOverrides?: Map_Type<string, any>;
    withHyperparamOverrides(hyperparamOverrides: Map_Type<string, any> | {[key: string]: any} | null): Reconstruction.Algorithm.VirtualSensingPipeline;
    ...
    withHyperparamSearchSpace(hyperparamSearchSpace: IHp.SearchSpace | null): Reconstruction.Algorithm.VirtualSensingPipeline;
    ...
    withHpoSpec(hpoSpec: IHpo.Spec | null): Reconstruction.Algorithm.VirtualSensingPipeline;

    /**
     * {@link Hpo.Experiment} stores the result of hyperparameter optimization to find the best model/pipeline.
     */
    readonly hpoExperiment?: Hpo.Experiment;
    withHpoExperiment(hpoExperiment: IHpo.Experiment | null): Reconstruction.Algorithm.VirtualSensingPipeline;

    /**
     * Reference to the experiment that produced this {@link MlPipe}. For example, this could be a {@link Hpo.ExperimentBase}.
     */
    readonly experiment?: any;
    withExperiment(experiment: any | null): Reconstruction.Algorithm.VirtualSensingPipeline;

    /**
     * Names of the {@link #score} outputs for this machine learning pipeline.
     */
    readonly scoreNames?: Set_Type<string>;
    withScoreNames(scoreNames: Set_Type<string> | Array<string> | null): Reconstruction.Algorithm.VirtualSensingPipeline;
    ...
    withTrainRun(trainRun: IWorkflowExecutorRun | null): Reconstruction.Algorithm.VirtualSensingPipeline;
    ...
    withTrainStatus(trainStatus: IWorkflow.Status | null): Reconstruction.Algorithm.VirtualSensingPipeline;
    ...
    withDoNotAutoUpsert(doNotAutoUpsert: boolean): Reconstruction.Algorithm.VirtualSensingPipeline;

    /**
     * A list of all target names in the `features` {@link Data} to build an estimator for. This must be specified
     * even if all features will have estimators.
     */
    readonly targets: Array_Type<string>;
    withTargets(targets: Array_Type<string> | Array<string>): Reconstruction.Algorithm.VirtualSensingPipeline;
     ...
     * use. If a particular target name is not included in this map, all other features will be used.
     */
    readonly targetToFeatures?: Map_Type<string, Array_Type<string>>;
    withTargetToFeatures(targetToFeatures: Map_Type<string, Array_Type<string>> | {[key: string]: Array_Type<string> | Array<string>} | null): Reconstruction.Algorithm.VirtualSensingPipeline;

    /**
     * If set, include the {@link targets} as an output of this pipeline.
     */
    readonly includeTarget?: boolean;
    withIncludeTarget(includeTarget: boolean): Reconstruction.Algorithm.VirtualSensingPipeline;

    /**
     * If {@link #includeTarget} is set, this suffix will be added to each target column.
     */
    readonly targetSuffix?: string;
    withTargetSuffix(targetSuffix: string | null): Reconstruction.Algorithm.VirtualSensingPipeline;
     ...
     * At least this field or {@link #targetToRegressor} must be populated.
     */
    readonly regressor?: MlPipe<any, any, any, any, any>;
    withRegressor(regressor: IMlPipe<any, any, any, any, any> | null): Reconstruction.Algorithm.VirtualSensingPipeline;
     ...
     * should contain an entry for each target.
     */
    readonly targetToRegressor?: Map_Type<string, MlPipe<any, any, any, any, any>>;
    withTargetToRegressor(targetToRegressor: Map_Type<string, MlPipe<any, any, any, any, any>> | {[key: string]: IMlPipe<any, any, any, any, any>} | null): Reconstruction.Algorithm.VirtualSensingPipeline;
     ...
     * At least this field or {@link #targetToScoringMetric} must be populated to perform HPO on this pipeline.
     */
    readonly scoringMetric?: MlScoringMetric<any, any, any>;
    withScoringMetric(scoringMetric: IMlScoringMetric<any, any, any> | null): Reconstruction.Algorithm.VirtualSensingPipeline;
     ...
     * aggregation will take place.
     */
    readonly scoreAggregation?: string;
    withScoreAggregation(scoreAggregation: string | null): Reconstruction.Algorithm.VirtualSensingPipeline;

    readonly targetToScoringMetric?: Map_Type<string, MlScoringMetric<any, any, any>>;
    withTargetToScoringMetric(targetToScoringMetric: Map_Type<string, MlScoringMetric<any, any, any>> | {[key: string]: IMlScoringMetric<any, any, any>} | null): Reconstruction.Algorithm.VirtualSensingPipeline;

    readonly interpreter?: MlInterpreter<any, any>;
    withInterpreter(interpreter: IMlInterpreter<any, any> | null): Reconstruction.Algorithm.VirtualSensingPipeline;

    /**
     * A map of target name to the interpreter that will interpret the target's {@link #regressor}. If both
     * {@link #interpreter} and this field are populated, this map will act as an override.
     */
    readonly targetToInterpreter?: Map_Type<string, MlInterpreter<any, any>>;
    withTargetToInterpreter(targetToInterpreter: Map_Type<string, MlInterpreter<any, any>> | {[key: string]: IMlInterpreter<any, any>} | null): Reconstruction.Algorithm.VirtualSensingPipeline;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI> | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI> | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI> | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI> | null;
     ...
     */
    replaceType(old: Type, new_: Type): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>;
     ...
     * @see #removeField
     */
    withoutField(field: string): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>;
     ...
     */
    withoutFields(fields: Array_Type<string>): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>;
     ...
     * @see #removeField
     */
    unsetField(field: string): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>;
     ...
     * @see #unsetField
     */
    removeField(field: string): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>;

    mergeJson(json: any): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>;
     ...
     */
    singletonArray(): Array_Type<Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>;
     ...
     * @see #fromString
     */
    static make(s: string): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI> | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>;
     ...
     */
    static cachedEmptyInst(): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>;
     ...
     */
    remakeTemplate(): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>;
     ...
     */
    precomputeVertexConnections(): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>;
     ...
     */
    mapVertices(mapper: λFunction<MlPipeline.Vertex | null, T | null>): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>;
     ...
     */
    topologicalSort(reverse?: boolean): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>;
     ...
     */
    ancestorGraph(sink: FlowGraph.Vertex): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>;
     ...
     */
    replaceVertex(oldVertex: FlowGraph.Vertex, newVertex: FlowGraph.Vertex, doNotMerge?: boolean, removeDisconnectedEdges?: boolean): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>;
     ...
     */
    replaceVertices(oldVertices: Array_Type<FlowGraph.Vertex>, newVertex: FlowGraph.Vertex, spec?: FlowGraphReplaceSpec): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>;
     ...
     * @return
     */
    replaceVertices(oldVertices: Array_Type<FlowGraph.Vertex>, newVertices: Array_Type<FlowGraph.Vertex>, newEdges?: Array_Type<FlowGraph.Edge<FlowGraph.Vertex>>, spec?: FlowGraphReplaceSpec): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>;
     ...
     * connected.
     */
    removeVertex(toRemove: FlowGraph.Vertex): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>;

    removeVertex(idToRemove: string): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>;
     ...
     */
    removeVertices(toRemove?: Array_Type<FlowGraph.Vertex>): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>;
     ...
     */
    mergeWith(other: Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>;
     ...
     */
    trainSync(x: , y?: , spec?: MlOperationSpec): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>;
     ...
     */
    static allCached(): Stream<Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>> | null;
     ...
     */
    static find(filter?: string): Stream<Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>> | null;

    /**
     * @return cached instance.
     */
    getCached(): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI> | null;

    /**
     * @return cached instance by the key.
     */
    static forCacheKey(key: string): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI> | null;
     ...
     */
    static produce(key: string): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI> | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>> | null;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>>> | null;
     ...
     */
    get(include?: string): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI> | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI> | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI> | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>;
     ...
     * @see #toString
     */
    static fromString(s: string): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI> | null;
     ...
     */
    create(spec?: UpsertSpec): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI> | null;
     ...
     */
    static createBatch(objs: Array_Type<Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>>, spec?: UpsertSpec): ObjList<Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>>, spec?: CreateBatchObjStreamSpec): ObjList<Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>> | null;
     ...
     */
    update(srcObj?: Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>, spec?: UpsertSpec): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI> | null;
     ...
     */
    upsert(srcObj?: Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>, spec?: UpsertSpec): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI> | null;
     ...
     */
    merge(spec?: MergeSpec): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI> | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI> | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI> | null;
     ...
     */
    static updateBatch(objs: Array_Type<Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>>, srcObjs?: Array_Type<Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>>, spec?: UpsertSpec): ObjList<Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>> | null>, spec?: UpsertSpec): ObjList<Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>>, srcObjs?: Array_Type<Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>>, spec?: UpsertSpec): ObjList<Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>> | null>, spec?: UpsertSpec): ObjList<Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>>, spec?: TouchSpec): ObjList<Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>>, spec?: MergeSpec): ObjList<Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>>, mergeInclude: string, spec?: MergeSpec): ObjList<Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>> | null;
     ...
     */
    static mergeAll(mergeObj: Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>>, spec?: UpsertSpec): ObjList<Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>>, spec?: UpsertSpec): ObjList<Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI> | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>>): ObjList<Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>>;
     ...
     */
    static beforeUpdate(objs: Array_Type<Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>>): ObjList<Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>>): ObjList<Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>>;
     ...
     */
    static afterCreate(objs: Array_Type<Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI> | null;
     ...
     */
    withoutIdentity(): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI> | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>>, callback?: λFunction<Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI> | null, Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI> | null>): ObjList<Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>>, callback?: λFunction<Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI> | null, Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI> | null>): Array_Type<ObjError> | null;
     ...
     */
    publish(subPath?: string, contentType?: string): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>;
     ...
     */
    static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>> | null;
     ...
     */
    createSeedData(spec?: UpsertSpec): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI> | null;
     ...
     */
    static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>> | null;
     ...
     */
    updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI> | null;
     ...
     */
    static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>> | null;
     ...
     * @return updated obj instance, same as {@link Persistable#update} return value.
     */
    clearUserUpdates(spec?: MergeSpec): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI> | null;
     ...
     *         {@link Persistable#updateBatch}.
     */
    static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>> | null;
    ...
    dependencies(): SeedDataDeps<Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>> | null;
     ...
     */
    static convert(model: any, spec?: MlConvertSpec): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>;

    /**
     * Freezes an {@link MlPipe}
     * @return modified copy of this {@link MlPipe} that cannot be trained
     */
    freeze(): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>;
     ...
     */
    freeze(paths?: Array_Type<string>): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>;

    /**
     * Unfreezes an {@link MlPipe}
     * @return modified copy of this {@link MlPipe} that can be trained
     */
    unfreeze(): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>;
     ...
     */
    unfreeze(paths?: Array_Type<string>): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>;
     ...
     * be returned as-is.
     */
    byReference(): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>;
     ...
     */
    train_verify(x?: , y?: , spec?: MlOperationSpec): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>;
     ...
     */
    withHyperparamSpaces(paramSpaces: Map_Type<string, Map_Type<string, Hp.ParamSpace>>): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>;
     ...
     */
    replacePipe(pipePath: string, newPipe: MlPipe<any, any, any, any, any>): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>;
     ...
     */
    replaceInterpreter(interpreterPath: string, newInterpreter: MlInterpreter<any, any>): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>;
     ...
     */
    flatten(): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>;
     ...
     */
    static fromV7Json(pipeline: string, runtimeRequirements: Array_Type<string>): Reconstruction.Algorithm.VirtualSensingPipeline<DS, DO, DI>;
