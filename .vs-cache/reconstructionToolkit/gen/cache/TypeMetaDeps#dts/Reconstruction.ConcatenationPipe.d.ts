// TypeScript definitions for the C3 type Reconstruction.ConcatenationPipe

/**
 * This type represents a process-only {@link MlPipe} that concatenates a map of {@link Data} column-wise. The inputs
 * should all have the same number of rows and the same indices.
 *
 * @remarks this represents a value passed to a method that expects an instance of Reconstruction.ConcatenationPipe
 */
declare namespace Reconstruction {
  export interface IConcatenationPipe<DX> {
    ...
    /**
     * The expected keys of the input {@link Map<String, Data>}
     */
 ...
 * should all have the same number of rows and the same indices.
 *
 * @remarks this represents a made instance of Reconstruction.ConcatenationPipe
 */
declare namespace Reconstruction {
  export class ConcatenationPipe<DX> extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): Reconstruction.ConcatenationPipe;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Reconstruction.ConcatenationPipe;

    /**
     * Name of this pipe.
     */
    readonly name?: string;
    withName(name: string | null): Reconstruction.ConcatenationPipe;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Reconstruction.ConcatenationPipe;
    ...
    withVersion(version: number | null): Reconstruction.ConcatenationPipe;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Reconstruction.ConcatenationPipe;
    ...
    withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): Reconstruction.ConcatenationPipe;
    ...
    withHidden(hidden: boolean): Reconstruction.ConcatenationPipe;
    ...
    withUserOwned(userOwned: boolean): Reconstruction.ConcatenationPipe;
    ...
    withTypeIdent(typeIdent: string | null): Reconstruction.ConcatenationPipe;

    /**
     * If true, then the pipe shall not be retrained
     */
    readonly frozen?: boolean;
    withFrozen(frozen: boolean): Reconstruction.ConcatenationPipe;

    /**
     * True if training has succeeded and false otherwise.
     */
    readonly trained?: boolean;
    withTrained(trained: boolean): Reconstruction.ConcatenationPipe;

    /**
     * Errors from training.
     */
    readonly trainingErrors?: string;
    withTrainingErrors(trainingErrors: string | null): Reconstruction.ConcatenationPipe;

    /**
     * If true, the underlying model only accepts flattened input.
     */
    readonly flattenInput?: boolean;
    withFlattenInput(flattenInput: boolean): Reconstruction.ConcatenationPipe;

    /**
     * The hyperparameters overridden of a native model or pipe.
     */
    readonly hyperparamOverrides?: Map_Type<string, any>;
    withHyperparamOverrides(hyperparamOverrides: Map_Type<string, any> | {[key: string]: any} | null): Reconstruction.ConcatenationPipe;
    ...
    withHyperparamSearchSpace(hyperparamSearchSpace: IHp.SearchSpace | null): Reconstruction.ConcatenationPipe;
    ...
    withHpoSpec(hpoSpec: IHpo.Spec | null): Reconstruction.ConcatenationPipe;

    /**
     * {@link Hpo.Experiment} stores the result of hyperparameter optimization to find the best model/pipeline.
     */
    readonly hpoExperiment?: Hpo.Experiment;
    withHpoExperiment(hpoExperiment: IHpo.Experiment | null): Reconstruction.ConcatenationPipe;

    /**
     * Reference to the experiment that produced this {@link MlPipe}. For example, this could be a {@link Hpo.ExperimentBase}.
     */
    readonly experiment?: any;
    withExperiment(experiment: any | null): Reconstruction.ConcatenationPipe;
    ...
    withModelFiles(modelFiles: Map_Type<string, Url> | {[key: string]: IUrl} | null): Reconstruction.ConcatenationPipe;
    ...
    withCustomModelCode(customModelCode: Map_Type<string, any> | {[key: string]: any} | null): Reconstruction.ConcatenationPipe;

    /**
     * Name for the function on the native model to call to do {@link MlProcessable#process}.
     */
    readonly processFunc?: string;
    withProcessFunc(processFunc: string | null): Reconstruction.ConcatenationPipe;
    ...
    withUnderlyingPipe(underlyingPipe: IMlAtomicPipe<any, any, any> | null): Reconstruction.ConcatenationPipe;

    /**
     * The expected keys of the input {@link Map<String, Data>}
     */
    readonly inputNames: Array_Type<string>;
    withInputNames(inputNames: Array_Type<string> | Array<string>): Reconstruction.ConcatenationPipe;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Reconstruction.ConcatenationPipe<DX> | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Reconstruction.ConcatenationPipe<DX> | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Reconstruction.ConcatenationPipe<DX> | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Reconstruction.ConcatenationPipe<DX> | null;
     ...
     */
    replaceType(old: Type, new_: Type): Reconstruction.ConcatenationPipe<DX>;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Reconstruction.ConcatenationPipe<DX>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Reconstruction.ConcatenationPipe<DX>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Reconstruction.ConcatenationPipe<DX>>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Reconstruction.ConcatenationPipe<DX>>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Reconstruction.ConcatenationPipe<DX>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Reconstruction.ConcatenationPipe<DX>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Reconstruction.ConcatenationPipe<DX>;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Reconstruction.ConcatenationPipe<DX>;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Reconstruction.ConcatenationPipe<DX>;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Reconstruction.ConcatenationPipe<DX>;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Reconstruction.ConcatenationPipe<DX>;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Reconstruction.ConcatenationPipe<DX>;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Reconstruction.ConcatenationPipe<DX>;
     ...
     * @see #removeField
     */
    withoutField(field: string): Reconstruction.ConcatenationPipe<DX>;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Reconstruction.ConcatenationPipe<DX>;
     ...
     */
    withoutFields(fields: Array_Type<string>): Reconstruction.ConcatenationPipe<DX>;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Reconstruction.ConcatenationPipe<DX>;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Reconstruction.ConcatenationPipe<DX>;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Reconstruction.ConcatenationPipe<DX>;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Reconstruction.ConcatenationPipe<DX>;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Reconstruction.ConcatenationPipe<DX>;
     ...
     * @see #removeField
     */
    unsetField(field: string): Reconstruction.ConcatenationPipe<DX>;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Reconstruction.ConcatenationPipe<DX>;
     ...
     * @see #unsetField
     */
    removeField(field: string): Reconstruction.ConcatenationPipe<DX>;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Reconstruction.ConcatenationPipe<DX>;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Reconstruction.ConcatenationPipe<DX>;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Reconstruction.ConcatenationPipe<DX>;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Reconstruction.ConcatenationPipe<DX>;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Reconstruction.ConcatenationPipe<DX>;

    mergeJson(json: any): Reconstruction.ConcatenationPipe<DX>;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Reconstruction.ConcatenationPipe<DX>;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Reconstruction.ConcatenationPipe<DX>;
     ...
     */
    singletonArray(): Array_Type<Reconstruction.ConcatenationPipe<DX>>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Reconstruction.ConcatenationPipe<DX>> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Reconstruction.ConcatenationPipe<DX>> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Reconstruction.ConcatenationPipe<DX>>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Reconstruction.ConcatenationPipe<DX>> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Reconstruction.ConcatenationPipe<DX>> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Reconstruction.ConcatenationPipe<DX>> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Reconstruction.ConcatenationPipe<DX>>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Reconstruction.ConcatenationPipe<DX>>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Reconstruction.ConcatenationPipe<DX>;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Reconstruction.ConcatenationPipe<DX>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Reconstruction.ConcatenationPipe<DX>;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Reconstruction.ConcatenationPipe<DX>;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Reconstruction.ConcatenationPipe<DX>;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Reconstruction.ConcatenationPipe<DX>;
     ...
     * @see #fromString
     */
    static make(s: string): Reconstruction.ConcatenationPipe<DX> | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Reconstruction.ConcatenationPipe<DX>;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Reconstruction.ConcatenationPipe<DX>;
     ...
     */
    static cachedEmptyInst(): Reconstruction.ConcatenationPipe<DX>;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Reconstruction.ConcatenationPipe<DX>> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Reconstruction.ConcatenationPipe<DX>;
     ...
     */
    remakeTemplate(): Reconstruction.ConcatenationPipe<DX>;
     ...
     */
    withoutIdentity(): Reconstruction.ConcatenationPipe<DX>;
     ...
     */
    trainSync(x: DX, y?: , spec?: MlOperationSpec): Reconstruction.ConcatenationPipe<DX>;
     ...
     */
    static allCached(): Stream<Reconstruction.ConcatenationPipe<DX>> | null;
     ...
     */
    static find(filter?: string): Stream<Reconstruction.ConcatenationPipe<DX>> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<Reconstruction.ConcatenationPipe<DX>> | null;

    /**
     * @return cached instance.
     */
    getCached(): Reconstruction.ConcatenationPipe<DX> | null;

    /**
     * @return cached instance by the key.
     */
    static forCacheKey(key: string): Reconstruction.ConcatenationPipe<DX> | null;
     ...
     */
    static produce(key: string): Reconstruction.ConcatenationPipe<DX> | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, Reconstruction.ConcatenationPipe<DX>> | null;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Reconstruction.ConcatenationPipe<DX>>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Reconstruction.ConcatenationPipe<DX>>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Reconstruction.ConcatenationPipe<DX>> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Reconstruction.ConcatenationPipe<DX>>> | null;
     ...
     */
    get(include?: string): Reconstruction.ConcatenationPipe<DX> | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Reconstruction.ConcatenationPipe<DX> | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Reconstruction.ConcatenationPipe<DX>;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Reconstruction.ConcatenationPipe<DX> | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Reconstruction.ConcatenationPipe<DX>;
     ...
     * @see #toString
     */
    static fromString(s: string): Reconstruction.ConcatenationPipe<DX> | null;
     ...
     */
    create(spec?: UpsertSpec): Reconstruction.ConcatenationPipe<DX> | null;
     ...
     */
    static createBatch(objs: Array_Type<Reconstruction.ConcatenationPipe<DX>>, spec?: UpsertSpec): ObjList<Reconstruction.ConcatenationPipe<DX>> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Reconstruction.ConcatenationPipe<DX>>, spec?: CreateBatchObjStreamSpec): ObjList<Reconstruction.ConcatenationPipe<DX>> | null;
     ...
     */
    update(srcObj?: Reconstruction.ConcatenationPipe<DX>, spec?: UpsertSpec): Reconstruction.ConcatenationPipe<DX> | null;
     ...
     */
    upsert(srcObj?: Reconstruction.ConcatenationPipe<DX>, spec?: UpsertSpec): Reconstruction.ConcatenationPipe<DX> | null;
     ...
     */
    merge(spec?: MergeSpec): Reconstruction.ConcatenationPipe<DX> | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Reconstruction.ConcatenationPipe<DX> | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Reconstruction.ConcatenationPipe<DX> | null;
     ...
     */
    static updateBatch(objs: Array_Type<Reconstruction.ConcatenationPipe<DX>>, srcObjs?: Array_Type<Reconstruction.ConcatenationPipe<DX>>, spec?: UpsertSpec): ObjList<Reconstruction.ConcatenationPipe<DX>> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Reconstruction.ConcatenationPipe<DX>> | null>, spec?: UpsertSpec): ObjList<Reconstruction.ConcatenationPipe<DX>> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Reconstruction.ConcatenationPipe<DX>>, srcObjs?: Array_Type<Reconstruction.ConcatenationPipe<DX>>, spec?: UpsertSpec): ObjList<Reconstruction.ConcatenationPipe<DX>> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Reconstruction.ConcatenationPipe<DX>> | null>, spec?: UpsertSpec): ObjList<Reconstruction.ConcatenationPipe<DX>> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Reconstruction.ConcatenationPipe<DX>>, spec?: TouchSpec): ObjList<Reconstruction.ConcatenationPipe<DX>> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Reconstruction.ConcatenationPipe<DX>>, spec?: MergeSpec): ObjList<Reconstruction.ConcatenationPipe<DX>> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Reconstruction.ConcatenationPipe<DX>>, mergeInclude: string, spec?: MergeSpec): ObjList<Reconstruction.ConcatenationPipe<DX>> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Reconstruction.ConcatenationPipe<DX>> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Reconstruction.ConcatenationPipe<DX>> | null;
     ...
     */
    static mergeAll(mergeObj: Reconstruction.ConcatenationPipe<DX>, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Reconstruction.ConcatenationPipe<DX>, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Reconstruction.ConcatenationPipe<DX>>, spec?: UpsertSpec): ObjList<Reconstruction.ConcatenationPipe<DX>> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Reconstruction.ConcatenationPipe<DX>>, spec?: UpsertSpec): ObjList<Reconstruction.ConcatenationPipe<DX>> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Reconstruction.ConcatenationPipe<DX> | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Reconstruction.ConcatenationPipe<DX>>): ObjList<Reconstruction.ConcatenationPipe<DX>>;
     ...
     */
    static beforeUpdate(objs: Array_Type<Reconstruction.ConcatenationPipe<DX>>): ObjList<Reconstruction.ConcatenationPipe<DX>>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Reconstruction.ConcatenationPipe<DX>>): ObjList<Reconstruction.ConcatenationPipe<DX>>;
     ...
     */
    static afterCreate(objs: Array_Type<Reconstruction.ConcatenationPipe<DX>>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Reconstruction.ConcatenationPipe<DX>>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Reconstruction.ConcatenationPipe<DX>>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Reconstruction.ConcatenationPipe<DX>>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Reconstruction.ConcatenationPipe<DX>>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Reconstruction.ConcatenationPipe<DX> | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Reconstruction.ConcatenationPipe<DX>>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Reconstruction.ConcatenationPipe<DX>, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Reconstruction.ConcatenationPipe<DX>>, callback?: λFunction<Reconstruction.ConcatenationPipe<DX> | null, Reconstruction.ConcatenationPipe<DX> | null>): ObjList<Reconstruction.ConcatenationPipe<DX>>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Reconstruction.ConcatenationPipe<DX>>, callback?: λFunction<Reconstruction.ConcatenationPipe<DX> | null, Reconstruction.ConcatenationPipe<DX> | null>): Array_Type<ObjError> | null;
     ...
     */
    publish(subPath?: string, contentType?: string): Reconstruction.ConcatenationPipe<DX>;
     ...
     */
    static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<Reconstruction.ConcatenationPipe<DX>> | null;
     ...
     */
    createSeedData(spec?: UpsertSpec): Reconstruction.ConcatenationPipe<DX> | null;
     ...
     */
    static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<Reconstruction.ConcatenationPipe<DX>> | null;
     ...
     */
    updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): Reconstruction.ConcatenationPipe<DX> | null;
     ...
     */
    static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<Reconstruction.ConcatenationPipe<DX>> | null;
     ...
     * @return updated obj instance, same as {@link Persistable#update} return value.
     */
    clearUserUpdates(spec?: MergeSpec): Reconstruction.ConcatenationPipe<DX> | null;
     ...
     *         {@link Persistable#updateBatch}.
     */
    static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<Reconstruction.ConcatenationPipe<DX>> | null;
    ...
    dependencies(): SeedDataDeps<Reconstruction.ConcatenationPipe<DX>> | null;
     ...
     * be returned as-is.
     */
    byReference(): Reconstruction.ConcatenationPipe<DX>;
     ...
     */
    updateModelFiles(modelFiles: Map_Type<string, Url>, spec?: MlOperationSpec): Reconstruction.ConcatenationPipe<DX>;
     ...
     */
    afterTrain(doTrainOutputs: any, spec?: MlOperationSpec): Reconstruction.ConcatenationPipe<DX>;
     ...
     */
    withNewSpec(spec?: MlConvertSpec): Reconstruction.ConcatenationPipe<DX>;
     ...
     */
    afterConvert(model: any, spec?: MlConvertSpec): Reconstruction.ConcatenationPipe<DX>;
     ...
     */
    withHyperparamSpaces(paramSpaces: Map_Type<string, Hp.ParamSpace>): Reconstruction.ConcatenationPipe<DX>;
