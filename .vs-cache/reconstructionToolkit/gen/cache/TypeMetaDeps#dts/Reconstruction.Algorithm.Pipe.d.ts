// TypeScript definitions for the C3 type Reconstruction.Algorithm.Pipe

/**
 * This Type represents all reconstruction algorithms in the form of an {@link MlTemplate.AtomicPipe}. This base Type
 * restricts all reconstruction atomic pipes to accept a single features `Data` as input, and should return at least
 * `reconstructions` and `residuals`. This Type is intended to be extended by developers of concrete reconstruction
 * atomic pipes.
 *
 * @remarks this represents a value passed to a method that expects an instance of Reconstruction.Algorithm.Pipe
 */
declare namespace Reconstruction.Algorithm {
  export interface IPipe<DO> {
 ...
 * atomic pipes.
 *
 * @remarks this represents a made instance of Reconstruction.Algorithm.Pipe
 */
declare namespace Reconstruction.Algorithm {
  export class Pipe<DO> extends Obj  {

    /**
     * An optional suffix that is added to the column names of the reconstruction {@link Data}.
     */
    readonly reconstructionSuffix?: string;
    withReconstructionSuffix(reconstructionSuffix: string | null): Reconstruction.Algorithm.Pipe;

    /**
     * An optional suffix that is added to the column names of the residual {@link Data}.
     */
    readonly residualSuffix?: string;
    withResidualSuffix(residualSuffix: string | null): Reconstruction.Algorithm.Pipe;
     ...
     */
    readonly id: string;
    withId(id: string): Reconstruction.Algorithm.Pipe;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Reconstruction.Algorithm.Pipe;

    /**
     * Name of this pipe.
     */
    readonly name?: string;
    withName(name: string | null): Reconstruction.Algorithm.Pipe;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Reconstruction.Algorithm.Pipe;
    ...
    withVersion(version: number | null): Reconstruction.Algorithm.Pipe;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Reconstruction.Algorithm.Pipe;
    ...
    withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): Reconstruction.Algorithm.Pipe;
    ...
    withHidden(hidden: boolean): Reconstruction.Algorithm.Pipe;
    ...
    withUserOwned(userOwned: boolean): Reconstruction.Algorithm.Pipe;
    ...
    withTypeIdent(typeIdent: string | null): Reconstruction.Algorithm.Pipe;

    /**
     * If true, then the pipe shall not be retrained
     */
    readonly frozen?: boolean;
    withFrozen(frozen: boolean): Reconstruction.Algorithm.Pipe;

    /**
     * True if training has succeeded and false otherwise.
     */
    readonly trained?: boolean;
    withTrained(trained: boolean): Reconstruction.Algorithm.Pipe;

    /**
     * Errors from training.
     */
    readonly trainingErrors?: string;
    withTrainingErrors(trainingErrors: string | null): Reconstruction.Algorithm.Pipe;

    /**
     * If true, the underlying model only accepts flattened input.
     */
    readonly flattenInput?: boolean;
    withFlattenInput(flattenInput: boolean): Reconstruction.Algorithm.Pipe;

    /**
     * The hyperparameters overridden of a native model or pipe.
     */
    readonly hyperparamOverrides?: Map_Type<string, any>;
    withHyperparamOverrides(hyperparamOverrides: Map_Type<string, any> | {[key: string]: any} | null): Reconstruction.Algorithm.Pipe;
    ...
    withHyperparamSearchSpace(hyperparamSearchSpace: IHp.SearchSpace | null): Reconstruction.Algorithm.Pipe;
    ...
    withHpoSpec(hpoSpec: IHpo.Spec | null): Reconstruction.Algorithm.Pipe;

    /**
     * {@link Hpo.Experiment} stores the result of hyperparameter optimization to find the best model/pipeline.
     */
    readonly hpoExperiment?: Hpo.Experiment;
    withHpoExperiment(hpoExperiment: IHpo.Experiment | null): Reconstruction.Algorithm.Pipe;

    /**
     * Reference to the experiment that produced this {@link MlPipe}. For example, this could be a {@link Hpo.ExperimentBase}.
     */
    readonly experiment?: any;
    withExperiment(experiment: any | null): Reconstruction.Algorithm.Pipe;
    ...
    withModelFiles(modelFiles: Map_Type<string, Url> | {[key: string]: IUrl} | null): Reconstruction.Algorithm.Pipe;
    ...
    withCustomModelCode(customModelCode: Map_Type<string, any> | {[key: string]: any} | null): Reconstruction.Algorithm.Pipe;

    /**
     * Name for the function on the native model to call to do {@link MlProcessable#process}.
     */
    readonly processFunc?: string;
    withProcessFunc(processFunc: string | null): Reconstruction.Algorithm.Pipe;
    ...
    withUnderlyingPipe(underlyingPipe: IMlAtomicPipe<any, any, any> | null): Reconstruction.Algorithm.Pipe;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Reconstruction.Algorithm.Pipe<DO> | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Reconstruction.Algorithm.Pipe<DO> | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Reconstruction.Algorithm.Pipe<DO> | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Reconstruction.Algorithm.Pipe<DO> | null;
     ...
     */
    replaceType(old: Type, new_: Type): Reconstruction.Algorithm.Pipe<DO>;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Reconstruction.Algorithm.Pipe<DO>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Reconstruction.Algorithm.Pipe<DO>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Reconstruction.Algorithm.Pipe<DO>>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Reconstruction.Algorithm.Pipe<DO>>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Reconstruction.Algorithm.Pipe<DO>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Reconstruction.Algorithm.Pipe<DO>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Reconstruction.Algorithm.Pipe<DO>;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Reconstruction.Algorithm.Pipe<DO>;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Reconstruction.Algorithm.Pipe<DO>;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Reconstruction.Algorithm.Pipe<DO>;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Reconstruction.Algorithm.Pipe<DO>;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Reconstruction.Algorithm.Pipe<DO>;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Reconstruction.Algorithm.Pipe<DO>;
     ...
     * @see #removeField
     */
    withoutField(field: string): Reconstruction.Algorithm.Pipe<DO>;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Reconstruction.Algorithm.Pipe<DO>;
     ...
     */
    withoutFields(fields: Array_Type<string>): Reconstruction.Algorithm.Pipe<DO>;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Reconstruction.Algorithm.Pipe<DO>;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Reconstruction.Algorithm.Pipe<DO>;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Reconstruction.Algorithm.Pipe<DO>;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Reconstruction.Algorithm.Pipe<DO>;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Reconstruction.Algorithm.Pipe<DO>;
     ...
     * @see #removeField
     */
    unsetField(field: string): Reconstruction.Algorithm.Pipe<DO>;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Reconstruction.Algorithm.Pipe<DO>;
     ...
     * @see #unsetField
     */
    removeField(field: string): Reconstruction.Algorithm.Pipe<DO>;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Reconstruction.Algorithm.Pipe<DO>;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Reconstruction.Algorithm.Pipe<DO>;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Reconstruction.Algorithm.Pipe<DO>;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Reconstruction.Algorithm.Pipe<DO>;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Reconstruction.Algorithm.Pipe<DO>;

    mergeJson(json: any): Reconstruction.Algorithm.Pipe<DO>;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Reconstruction.Algorithm.Pipe<DO>;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Reconstruction.Algorithm.Pipe<DO>;
     ...
     */
    singletonArray(): Array_Type<Reconstruction.Algorithm.Pipe<DO>>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Reconstruction.Algorithm.Pipe<DO>> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Reconstruction.Algorithm.Pipe<DO>> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Reconstruction.Algorithm.Pipe<DO>>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Reconstruction.Algorithm.Pipe<DO>> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Reconstruction.Algorithm.Pipe<DO>> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Reconstruction.Algorithm.Pipe<DO>> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Reconstruction.Algorithm.Pipe<DO>>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Reconstruction.Algorithm.Pipe<DO>>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Reconstruction.Algorithm.Pipe<DO>;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Reconstruction.Algorithm.Pipe<DO>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Reconstruction.Algorithm.Pipe<DO>;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Reconstruction.Algorithm.Pipe<DO>;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Reconstruction.Algorithm.Pipe<DO>;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Reconstruction.Algorithm.Pipe<DO>;
     ...
     * @see #fromString
     */
    static make(s: string): Reconstruction.Algorithm.Pipe<DO> | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Reconstruction.Algorithm.Pipe<DO>;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Reconstruction.Algorithm.Pipe<DO>;
     ...
     */
    static cachedEmptyInst(): Reconstruction.Algorithm.Pipe<DO>;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Reconstruction.Algorithm.Pipe<DO>> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Reconstruction.Algorithm.Pipe<DO>;
     ...
     */
    remakeTemplate(): Reconstruction.Algorithm.Pipe<DO>;
     ...
     */
    withoutIdentity(): Reconstruction.Algorithm.Pipe<DO>;
     ...
     */
    trainSync(x: , y?: , spec?: MlOperationSpec): Reconstruction.Algorithm.Pipe<DO>;
     ...
     */
    static allCached(): Stream<Reconstruction.Algorithm.Pipe<DO>> | null;
     ...
     */
    static find(filter?: string): Stream<Reconstruction.Algorithm.Pipe<DO>> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<Reconstruction.Algorithm.Pipe<DO>> | null;

    /**
     * @return cached instance.
     */
    getCached(): Reconstruction.Algorithm.Pipe<DO> | null;

    /**
     * @return cached instance by the key.
     */
    static forCacheKey(key: string): Reconstruction.Algorithm.Pipe<DO> | null;
     ...
     */
    static produce(key: string): Reconstruction.Algorithm.Pipe<DO> | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, Reconstruction.Algorithm.Pipe<DO>> | null;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Reconstruction.Algorithm.Pipe<DO>>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Reconstruction.Algorithm.Pipe<DO>>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Reconstruction.Algorithm.Pipe<DO>> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Reconstruction.Algorithm.Pipe<DO>>> | null;
     ...
     */
    get(include?: string): Reconstruction.Algorithm.Pipe<DO> | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Reconstruction.Algorithm.Pipe<DO> | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Reconstruction.Algorithm.Pipe<DO>;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Reconstruction.Algorithm.Pipe<DO> | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Reconstruction.Algorithm.Pipe<DO>;
     ...
     * @see #toString
     */
    static fromString(s: string): Reconstruction.Algorithm.Pipe<DO> | null;
     ...
     */
    create(spec?: UpsertSpec): Reconstruction.Algorithm.Pipe<DO> | null;
     ...
     */
    static createBatch(objs: Array_Type<Reconstruction.Algorithm.Pipe<DO>>, spec?: UpsertSpec): ObjList<Reconstruction.Algorithm.Pipe<DO>> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Reconstruction.Algorithm.Pipe<DO>>, spec?: CreateBatchObjStreamSpec): ObjList<Reconstruction.Algorithm.Pipe<DO>> | null;
     ...
     */
    update(srcObj?: Reconstruction.Algorithm.Pipe<DO>, spec?: UpsertSpec): Reconstruction.Algorithm.Pipe<DO> | null;
     ...
     */
    upsert(srcObj?: Reconstruction.Algorithm.Pipe<DO>, spec?: UpsertSpec): Reconstruction.Algorithm.Pipe<DO> | null;
     ...
     */
    merge(spec?: MergeSpec): Reconstruction.Algorithm.Pipe<DO> | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Reconstruction.Algorithm.Pipe<DO> | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Reconstruction.Algorithm.Pipe<DO> | null;
     ...
     */
    static updateBatch(objs: Array_Type<Reconstruction.Algorithm.Pipe<DO>>, srcObjs?: Array_Type<Reconstruction.Algorithm.Pipe<DO>>, spec?: UpsertSpec): ObjList<Reconstruction.Algorithm.Pipe<DO>> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Reconstruction.Algorithm.Pipe<DO>> | null>, spec?: UpsertSpec): ObjList<Reconstruction.Algorithm.Pipe<DO>> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Reconstruction.Algorithm.Pipe<DO>>, srcObjs?: Array_Type<Reconstruction.Algorithm.Pipe<DO>>, spec?: UpsertSpec): ObjList<Reconstruction.Algorithm.Pipe<DO>> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Reconstruction.Algorithm.Pipe<DO>> | null>, spec?: UpsertSpec): ObjList<Reconstruction.Algorithm.Pipe<DO>> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Reconstruction.Algorithm.Pipe<DO>>, spec?: TouchSpec): ObjList<Reconstruction.Algorithm.Pipe<DO>> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Reconstruction.Algorithm.Pipe<DO>>, spec?: MergeSpec): ObjList<Reconstruction.Algorithm.Pipe<DO>> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Reconstruction.Algorithm.Pipe<DO>>, mergeInclude: string, spec?: MergeSpec): ObjList<Reconstruction.Algorithm.Pipe<DO>> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Reconstruction.Algorithm.Pipe<DO>> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Reconstruction.Algorithm.Pipe<DO>> | null;
     ...
     */
    static mergeAll(mergeObj: Reconstruction.Algorithm.Pipe<DO>, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Reconstruction.Algorithm.Pipe<DO>, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Reconstruction.Algorithm.Pipe<DO>>, spec?: UpsertSpec): ObjList<Reconstruction.Algorithm.Pipe<DO>> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Reconstruction.Algorithm.Pipe<DO>>, spec?: UpsertSpec): ObjList<Reconstruction.Algorithm.Pipe<DO>> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Reconstruction.Algorithm.Pipe<DO> | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Reconstruction.Algorithm.Pipe<DO>>): ObjList<Reconstruction.Algorithm.Pipe<DO>>;
     ...
     */
    static beforeUpdate(objs: Array_Type<Reconstruction.Algorithm.Pipe<DO>>): ObjList<Reconstruction.Algorithm.Pipe<DO>>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Reconstruction.Algorithm.Pipe<DO>>): ObjList<Reconstruction.Algorithm.Pipe<DO>>;
     ...
     */
    static afterCreate(objs: Array_Type<Reconstruction.Algorithm.Pipe<DO>>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Reconstruction.Algorithm.Pipe<DO>>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Reconstruction.Algorithm.Pipe<DO>>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Reconstruction.Algorithm.Pipe<DO>>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Reconstruction.Algorithm.Pipe<DO>>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Reconstruction.Algorithm.Pipe<DO> | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Reconstruction.Algorithm.Pipe<DO>>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Reconstruction.Algorithm.Pipe<DO>, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Reconstruction.Algorithm.Pipe<DO>>, callback?: λFunction<Reconstruction.Algorithm.Pipe<DO> | null, Reconstruction.Algorithm.Pipe<DO> | null>): ObjList<Reconstruction.Algorithm.Pipe<DO>>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Reconstruction.Algorithm.Pipe<DO>>, callback?: λFunction<Reconstruction.Algorithm.Pipe<DO> | null, Reconstruction.Algorithm.Pipe<DO> | null>): Array_Type<ObjError> | null;
     ...
     */
    publish(subPath?: string, contentType?: string): Reconstruction.Algorithm.Pipe<DO>;
     ...
     */
    static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<Reconstruction.Algorithm.Pipe<DO>> | null;
     ...
     */
    createSeedData(spec?: UpsertSpec): Reconstruction.Algorithm.Pipe<DO> | null;
     ...
     */
    static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<Reconstruction.Algorithm.Pipe<DO>> | null;
     ...
     */
    updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): Reconstruction.Algorithm.Pipe<DO> | null;
     ...
     */
    static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<Reconstruction.Algorithm.Pipe<DO>> | null;
     ...
     * @return updated obj instance, same as {@link Persistable#update} return value.
     */
    clearUserUpdates(spec?: MergeSpec): Reconstruction.Algorithm.Pipe<DO> | null;
     ...
     *         {@link Persistable#updateBatch}.
     */
    static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<Reconstruction.Algorithm.Pipe<DO>> | null;
    ...
    dependencies(): SeedDataDeps<Reconstruction.Algorithm.Pipe<DO>> | null;
     ...
     * be returned as-is.
     */
    byReference(): Reconstruction.Algorithm.Pipe<DO>;
     ...
     */
    updateModelFiles(modelFiles: Map_Type<string, Url>, spec?: MlOperationSpec): Reconstruction.Algorithm.Pipe<DO>;
     ...
     */
    afterTrain(doTrainOutputs: any, spec?: MlOperationSpec): Reconstruction.Algorithm.Pipe<DO>;
     ...
     */
    withNewSpec(spec?: MlConvertSpec): Reconstruction.Algorithm.Pipe<DO>;
     ...
     */
    afterConvert(model: any, spec?: MlConvertSpec): Reconstruction.Algorithm.Pipe<DO>;
     ...
     */
    withHyperparamSpaces(paramSpaces: Map_Type<string, Hp.ParamSpace>): Reconstruction.Algorithm.Pipe<DO>;
