// TypeScript definitions for the C3 type Reconstruction.Post.RiskScorePipe

/**
 * This Type represents all pipes that compute a risk score based on a reconstruction model's output. All risk score
 * computation pipes should extend from this Type and output a single `Data` containing the risk scores.
 *
 * DEVELOPER NOTE: Developers may override {@link #succeed} to customize how a risk score pipe is appended to a central
 * pipe.
 *
 * @remarks this represents a value passed to a method that expects an instance of Reconstruction.Post.RiskScorePipe
 */
declare namespace Reconstruction.Post {
  export interface IRiskScorePipe<DX> {
 ...
 * pipe.
 *
 * @remarks this represents a made instance of Reconstruction.Post.RiskScorePipe
 */
declare namespace Reconstruction.Post {
  export class RiskScorePipe<DX> extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): Reconstruction.Post.RiskScorePipe;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Reconstruction.Post.RiskScorePipe;

    /**
     * Name of this pipe.
     */
    readonly name?: string;
    withName(name: string | null): Reconstruction.Post.RiskScorePipe;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Reconstruction.Post.RiskScorePipe;
    ...
    withVersion(version: number | null): Reconstruction.Post.RiskScorePipe;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Reconstruction.Post.RiskScorePipe;
    ...
    withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): Reconstruction.Post.RiskScorePipe;
    ...
    withHidden(hidden: boolean): Reconstruction.Post.RiskScorePipe;
    ...
    withUserOwned(userOwned: boolean): Reconstruction.Post.RiskScorePipe;
    ...
    withTypeIdent(typeIdent: string | null): Reconstruction.Post.RiskScorePipe;

    /**
     * If true, then the pipe shall not be retrained
     */
    readonly frozen?: boolean;
    withFrozen(frozen: boolean): Reconstruction.Post.RiskScorePipe;

    /**
     * True if training has succeeded and false otherwise.
     */
    readonly trained?: boolean;
    withTrained(trained: boolean): Reconstruction.Post.RiskScorePipe;

    /**
     * Errors from training.
     */
    readonly trainingErrors?: string;
    withTrainingErrors(trainingErrors: string | null): Reconstruction.Post.RiskScorePipe;

    /**
     * If true, the underlying model only accepts flattened input.
     */
    readonly flattenInput?: boolean;
    withFlattenInput(flattenInput: boolean): Reconstruction.Post.RiskScorePipe;

    /**
     * The hyperparameters overridden of a native model or pipe.
     */
    readonly hyperparamOverrides?: Map_Type<string, any>;
    withHyperparamOverrides(hyperparamOverrides: Map_Type<string, any> | {[key: string]: any} | null): Reconstruction.Post.RiskScorePipe;
    ...
    withHyperparamSearchSpace(hyperparamSearchSpace: IHp.SearchSpace | null): Reconstruction.Post.RiskScorePipe;
    ...
    withHpoSpec(hpoSpec: IHpo.Spec | null): Reconstruction.Post.RiskScorePipe;

    /**
     * {@link Hpo.Experiment} stores the result of hyperparameter optimization to find the best model/pipeline.
     */
    readonly hpoExperiment?: Hpo.Experiment;
    withHpoExperiment(hpoExperiment: IHpo.Experiment | null): Reconstruction.Post.RiskScorePipe;

    /**
     * Reference to the experiment that produced this {@link MlPipe}. For example, this could be a {@link Hpo.ExperimentBase}.
     */
    readonly experiment?: any;
    withExperiment(experiment: any | null): Reconstruction.Post.RiskScorePipe;
    ...
    withModelFiles(modelFiles: Map_Type<string, Url> | {[key: string]: IUrl} | null): Reconstruction.Post.RiskScorePipe;
    ...
    withCustomModelCode(customModelCode: Map_Type<string, any> | {[key: string]: any} | null): Reconstruction.Post.RiskScorePipe;

    /**
     * Name for the function on the native model to call to do {@link MlProcessable#process}.
     */
    readonly processFunc?: string;
    withProcessFunc(processFunc: string | null): Reconstruction.Post.RiskScorePipe;
    ...
    withUnderlyingPipe(underlyingPipe: IMlAtomicPipe<any, any, any> | null): Reconstruction.Post.RiskScorePipe;

    /**
     * The name of the column in the {@link Data} output. Default is "riskScore"
     */
    readonly riskScoreColumnName?: string;
    withRiskScoreColumnName(riskScoreColumnName: string | null): Reconstruction.Post.RiskScorePipe;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Reconstruction.Post.RiskScorePipe<DX> | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Reconstruction.Post.RiskScorePipe<DX> | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Reconstruction.Post.RiskScorePipe<DX> | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Reconstruction.Post.RiskScorePipe<DX> | null;
     ...
     */
    replaceType(old: Type, new_: Type): Reconstruction.Post.RiskScorePipe<DX>;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Reconstruction.Post.RiskScorePipe<DX>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Reconstruction.Post.RiskScorePipe<DX>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Reconstruction.Post.RiskScorePipe<DX>>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Reconstruction.Post.RiskScorePipe<DX>>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Reconstruction.Post.RiskScorePipe<DX>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Reconstruction.Post.RiskScorePipe<DX>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Reconstruction.Post.RiskScorePipe<DX>;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Reconstruction.Post.RiskScorePipe<DX>;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Reconstruction.Post.RiskScorePipe<DX>;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Reconstruction.Post.RiskScorePipe<DX>;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Reconstruction.Post.RiskScorePipe<DX>;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Reconstruction.Post.RiskScorePipe<DX>;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Reconstruction.Post.RiskScorePipe<DX>;
     ...
     * @see #removeField
     */
    withoutField(field: string): Reconstruction.Post.RiskScorePipe<DX>;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Reconstruction.Post.RiskScorePipe<DX>;
     ...
     */
    withoutFields(fields: Array_Type<string>): Reconstruction.Post.RiskScorePipe<DX>;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Reconstruction.Post.RiskScorePipe<DX>;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Reconstruction.Post.RiskScorePipe<DX>;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Reconstruction.Post.RiskScorePipe<DX>;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Reconstruction.Post.RiskScorePipe<DX>;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Reconstruction.Post.RiskScorePipe<DX>;
     ...
     * @see #removeField
     */
    unsetField(field: string): Reconstruction.Post.RiskScorePipe<DX>;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Reconstruction.Post.RiskScorePipe<DX>;
     ...
     * @see #unsetField
     */
    removeField(field: string): Reconstruction.Post.RiskScorePipe<DX>;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Reconstruction.Post.RiskScorePipe<DX>;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Reconstruction.Post.RiskScorePipe<DX>;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Reconstruction.Post.RiskScorePipe<DX>;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Reconstruction.Post.RiskScorePipe<DX>;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Reconstruction.Post.RiskScorePipe<DX>;

    mergeJson(json: any): Reconstruction.Post.RiskScorePipe<DX>;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Reconstruction.Post.RiskScorePipe<DX>;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Reconstruction.Post.RiskScorePipe<DX>;
     ...
     */
    singletonArray(): Array_Type<Reconstruction.Post.RiskScorePipe<DX>>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Reconstruction.Post.RiskScorePipe<DX>> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Reconstruction.Post.RiskScorePipe<DX>> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Reconstruction.Post.RiskScorePipe<DX>>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Reconstruction.Post.RiskScorePipe<DX>> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Reconstruction.Post.RiskScorePipe<DX>> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Reconstruction.Post.RiskScorePipe<DX>> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Reconstruction.Post.RiskScorePipe<DX>>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Reconstruction.Post.RiskScorePipe<DX>>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Reconstruction.Post.RiskScorePipe<DX>;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Reconstruction.Post.RiskScorePipe<DX>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Reconstruction.Post.RiskScorePipe<DX>;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Reconstruction.Post.RiskScorePipe<DX>;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Reconstruction.Post.RiskScorePipe<DX>;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Reconstruction.Post.RiskScorePipe<DX>;
     ...
     * @see #fromString
     */
    static make(s: string): Reconstruction.Post.RiskScorePipe<DX> | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Reconstruction.Post.RiskScorePipe<DX>;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Reconstruction.Post.RiskScorePipe<DX>;
     ...
     */
    static cachedEmptyInst(): Reconstruction.Post.RiskScorePipe<DX>;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Reconstruction.Post.RiskScorePipe<DX>> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Reconstruction.Post.RiskScorePipe<DX>;
     ...
     */
    remakeTemplate(): Reconstruction.Post.RiskScorePipe<DX>;
     ...
     */
    withoutIdentity(): Reconstruction.Post.RiskScorePipe<DX>;
     ...
     */
    trainSync(x: DX, y?: , spec?: MlOperationSpec): Reconstruction.Post.RiskScorePipe<DX>;
     ...
     *           the operation run object to query status and to get the final result.
     */
    process(x: DX, spec?: MlOperationSpec): MlOperationRun<> | null;
     ...
     */
    processSync(x: DX, spec?: MlOperationSpec):  | null;
     ...
     */
    static allCached(): Stream<Reconstruction.Post.RiskScorePipe<DX>> | null;
     ...
     */
    static find(filter?: string): Stream<Reconstruction.Post.RiskScorePipe<DX>> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<Reconstruction.Post.RiskScorePipe<DX>> | null;

    /**
     * @return cached instance.
     */
    getCached(): Reconstruction.Post.RiskScorePipe<DX> | null;

    /**
     * @return cached instance by the key.
     */
    static forCacheKey(key: string): Reconstruction.Post.RiskScorePipe<DX> | null;
     ...
     */
    static produce(key: string): Reconstruction.Post.RiskScorePipe<DX> | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, Reconstruction.Post.RiskScorePipe<DX>> | null;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Reconstruction.Post.RiskScorePipe<DX>>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Reconstruction.Post.RiskScorePipe<DX>>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Reconstruction.Post.RiskScorePipe<DX>> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Reconstruction.Post.RiskScorePipe<DX>>> | null;
     ...
     */
    get(include?: string): Reconstruction.Post.RiskScorePipe<DX> | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Reconstruction.Post.RiskScorePipe<DX> | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Reconstruction.Post.RiskScorePipe<DX>;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Reconstruction.Post.RiskScorePipe<DX> | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Reconstruction.Post.RiskScorePipe<DX>;
     ...
     * @see #toString
     */
    static fromString(s: string): Reconstruction.Post.RiskScorePipe<DX> | null;
     ...
     */
    create(spec?: UpsertSpec): Reconstruction.Post.RiskScorePipe<DX> | null;
     ...
     */
    static createBatch(objs: Array_Type<Reconstruction.Post.RiskScorePipe<DX>>, spec?: UpsertSpec): ObjList<Reconstruction.Post.RiskScorePipe<DX>> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Reconstruction.Post.RiskScorePipe<DX>>, spec?: CreateBatchObjStreamSpec): ObjList<Reconstruction.Post.RiskScorePipe<DX>> | null;
     ...
     */
    update(srcObj?: Reconstruction.Post.RiskScorePipe<DX>, spec?: UpsertSpec): Reconstruction.Post.RiskScorePipe<DX> | null;
     ...
     */
    upsert(srcObj?: Reconstruction.Post.RiskScorePipe<DX>, spec?: UpsertSpec): Reconstruction.Post.RiskScorePipe<DX> | null;
     ...
     */
    merge(spec?: MergeSpec): Reconstruction.Post.RiskScorePipe<DX> | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Reconstruction.Post.RiskScorePipe<DX> | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Reconstruction.Post.RiskScorePipe<DX> | null;
     ...
     */
    static updateBatch(objs: Array_Type<Reconstruction.Post.RiskScorePipe<DX>>, srcObjs?: Array_Type<Reconstruction.Post.RiskScorePipe<DX>>, spec?: UpsertSpec): ObjList<Reconstruction.Post.RiskScorePipe<DX>> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Reconstruction.Post.RiskScorePipe<DX>> | null>, spec?: UpsertSpec): ObjList<Reconstruction.Post.RiskScorePipe<DX>> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Reconstruction.Post.RiskScorePipe<DX>>, srcObjs?: Array_Type<Reconstruction.Post.RiskScorePipe<DX>>, spec?: UpsertSpec): ObjList<Reconstruction.Post.RiskScorePipe<DX>> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Reconstruction.Post.RiskScorePipe<DX>> | null>, spec?: UpsertSpec): ObjList<Reconstruction.Post.RiskScorePipe<DX>> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Reconstruction.Post.RiskScorePipe<DX>>, spec?: TouchSpec): ObjList<Reconstruction.Post.RiskScorePipe<DX>> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Reconstruction.Post.RiskScorePipe<DX>>, spec?: MergeSpec): ObjList<Reconstruction.Post.RiskScorePipe<DX>> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Reconstruction.Post.RiskScorePipe<DX>>, mergeInclude: string, spec?: MergeSpec): ObjList<Reconstruction.Post.RiskScorePipe<DX>> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Reconstruction.Post.RiskScorePipe<DX>> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Reconstruction.Post.RiskScorePipe<DX>> | null;
     ...
     */
    static mergeAll(mergeObj: Reconstruction.Post.RiskScorePipe<DX>, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Reconstruction.Post.RiskScorePipe<DX>, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Reconstruction.Post.RiskScorePipe<DX>>, spec?: UpsertSpec): ObjList<Reconstruction.Post.RiskScorePipe<DX>> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Reconstruction.Post.RiskScorePipe<DX>>, spec?: UpsertSpec): ObjList<Reconstruction.Post.RiskScorePipe<DX>> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Reconstruction.Post.RiskScorePipe<DX> | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Reconstruction.Post.RiskScorePipe<DX>>): ObjList<Reconstruction.Post.RiskScorePipe<DX>>;
     ...
     */
    static beforeUpdate(objs: Array_Type<Reconstruction.Post.RiskScorePipe<DX>>): ObjList<Reconstruction.Post.RiskScorePipe<DX>>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Reconstruction.Post.RiskScorePipe<DX>>): ObjList<Reconstruction.Post.RiskScorePipe<DX>>;
     ...
     */
    static afterCreate(objs: Array_Type<Reconstruction.Post.RiskScorePipe<DX>>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Reconstruction.Post.RiskScorePipe<DX>>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Reconstruction.Post.RiskScorePipe<DX>>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Reconstruction.Post.RiskScorePipe<DX>>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Reconstruction.Post.RiskScorePipe<DX>>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Reconstruction.Post.RiskScorePipe<DX> | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Reconstruction.Post.RiskScorePipe<DX>>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Reconstruction.Post.RiskScorePipe<DX>, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Reconstruction.Post.RiskScorePipe<DX>>, callback?: λFunction<Reconstruction.Post.RiskScorePipe<DX> | null, Reconstruction.Post.RiskScorePipe<DX> | null>): ObjList<Reconstruction.Post.RiskScorePipe<DX>>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Reconstruction.Post.RiskScorePipe<DX>>, callback?: λFunction<Reconstruction.Post.RiskScorePipe<DX> | null, Reconstruction.Post.RiskScorePipe<DX> | null>): Array_Type<ObjError> | null;
     ...
     */
    publish(subPath?: string, contentType?: string): Reconstruction.Post.RiskScorePipe<DX>;
     ...
     */
    static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<Reconstruction.Post.RiskScorePipe<DX>> | null;
     ...
     */
    createSeedData(spec?: UpsertSpec): Reconstruction.Post.RiskScorePipe<DX> | null;
     ...
     */
    static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<Reconstruction.Post.RiskScorePipe<DX>> | null;
     ...
     */
    updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): Reconstruction.Post.RiskScorePipe<DX> | null;
     ...
     */
    static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<Reconstruction.Post.RiskScorePipe<DX>> | null;
     ...
     * @return updated obj instance, same as {@link Persistable#update} return value.
     */
    clearUserUpdates(spec?: MergeSpec): Reconstruction.Post.RiskScorePipe<DX> | null;
     ...
     *         {@link Persistable#updateBatch}.
     */
    static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<Reconstruction.Post.RiskScorePipe<DX>> | null;
    ...
    dependencies(): SeedDataDeps<Reconstruction.Post.RiskScorePipe<DX>> | null;
     ...
     * be returned as-is.
     */
    byReference(): Reconstruction.Post.RiskScorePipe<DX>;
     ...
     */
    updateModelFiles(modelFiles: Map_Type<string, Url>, spec?: MlOperationSpec): Reconstruction.Post.RiskScorePipe<DX>;
     ...
     */
    afterTrain(doTrainOutputs: any, spec?: MlOperationSpec): Reconstruction.Post.RiskScorePipe<DX>;
     ...
     */
    withNewSpec(spec?: MlConvertSpec): Reconstruction.Post.RiskScorePipe<DX>;
     ...
     */
    afterConvert(model: any, spec?: MlConvertSpec): Reconstruction.Post.RiskScorePipe<DX>;
     ...
     */
    withHyperparamSpaces(paramSpaces: Map_Type<string, Hp.ParamSpace>): Reconstruction.Post.RiskScorePipe<DX>;
