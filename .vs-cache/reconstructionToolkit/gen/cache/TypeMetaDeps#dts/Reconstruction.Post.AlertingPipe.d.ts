// TypeScript definitions for the C3 type Reconstruction.Post.AlertingPipe

/**
 * This Type represents all alerting pipe that determine whether or not to raise an "alert" based on certain inputs. All
 * alerting pipes should extend from this Type and output a single `Data` containing the alerts.
 *
 * DEVELOPER NOTE: Developers may override {@link #succeed} to customize how an alerting pipe is appended to a central
 * pipe.
 *
 * @remarks this represents a value passed to a method that expects an instance of Reconstruction.Post.AlertingPipe
 */
declare namespace Reconstruction.Post {
  export interface IAlertingPipe<DX> {
 ...
 * pipe.
 *
 * @remarks this represents a made instance of Reconstruction.Post.AlertingPipe
 */
declare namespace Reconstruction.Post {
  export class AlertingPipe<DX> extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): Reconstruction.Post.AlertingPipe;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Reconstruction.Post.AlertingPipe;

    /**
     * Name of this pipe.
     */
    readonly name?: string;
    withName(name: string | null): Reconstruction.Post.AlertingPipe;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Reconstruction.Post.AlertingPipe;
    ...
    withVersion(version: number | null): Reconstruction.Post.AlertingPipe;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Reconstruction.Post.AlertingPipe;
    ...
    withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): Reconstruction.Post.AlertingPipe;
    ...
    withHidden(hidden: boolean): Reconstruction.Post.AlertingPipe;
    ...
    withUserOwned(userOwned: boolean): Reconstruction.Post.AlertingPipe;
    ...
    withTypeIdent(typeIdent: string | null): Reconstruction.Post.AlertingPipe;

    /**
     * If true, then the pipe shall not be retrained
     */
    readonly frozen?: boolean;
    withFrozen(frozen: boolean): Reconstruction.Post.AlertingPipe;

    /**
     * True if training has succeeded and false otherwise.
     */
    readonly trained?: boolean;
    withTrained(trained: boolean): Reconstruction.Post.AlertingPipe;

    /**
     * Errors from training.
     */
    readonly trainingErrors?: string;
    withTrainingErrors(trainingErrors: string | null): Reconstruction.Post.AlertingPipe;

    /**
     * If true, the underlying model only accepts flattened input.
     */
    readonly flattenInput?: boolean;
    withFlattenInput(flattenInput: boolean): Reconstruction.Post.AlertingPipe;

    /**
     * The hyperparameters overridden of a native model or pipe.
     */
    readonly hyperparamOverrides?: Map_Type<string, any>;
    withHyperparamOverrides(hyperparamOverrides: Map_Type<string, any> | {[key: string]: any} | null): Reconstruction.Post.AlertingPipe;
    ...
    withHyperparamSearchSpace(hyperparamSearchSpace: IHp.SearchSpace | null): Reconstruction.Post.AlertingPipe;
    ...
    withHpoSpec(hpoSpec: IHpo.Spec | null): Reconstruction.Post.AlertingPipe;

    /**
     * {@link Hpo.Experiment} stores the result of hyperparameter optimization to find the best model/pipeline.
     */
    readonly hpoExperiment?: Hpo.Experiment;
    withHpoExperiment(hpoExperiment: IHpo.Experiment | null): Reconstruction.Post.AlertingPipe;

    /**
     * Reference to the experiment that produced this {@link MlPipe}. For example, this could be a {@link Hpo.ExperimentBase}.
     */
    readonly experiment?: any;
    withExperiment(experiment: any | null): Reconstruction.Post.AlertingPipe;
    ...
    withModelFiles(modelFiles: Map_Type<string, Url> | {[key: string]: IUrl} | null): Reconstruction.Post.AlertingPipe;
    ...
    withCustomModelCode(customModelCode: Map_Type<string, any> | {[key: string]: any} | null): Reconstruction.Post.AlertingPipe;

    /**
     * Name for the function on the native model to call to do {@link MlProcessable#process}.
     */
    readonly processFunc?: string;
    withProcessFunc(processFunc: string | null): Reconstruction.Post.AlertingPipe;
    ...
    withUnderlyingPipe(underlyingPipe: IMlAtomicPipe<any, any, any> | null): Reconstruction.Post.AlertingPipe;

    /**
     * The name of the column in the {@link Data} output. Default is "alert"
     */
    readonly alertColumnName?: string;
    withAlertColumnName(alertColumnName: string | null): Reconstruction.Post.AlertingPipe;
    ...
    withLookbackDuration(lookbackDuration: IDuration | null): Reconstruction.Post.AlertingPipe;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Reconstruction.Post.AlertingPipe<DX> | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Reconstruction.Post.AlertingPipe<DX> | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Reconstruction.Post.AlertingPipe<DX> | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Reconstruction.Post.AlertingPipe<DX> | null;
     ...
     */
    replaceType(old: Type, new_: Type): Reconstruction.Post.AlertingPipe<DX>;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Reconstruction.Post.AlertingPipe<DX>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Reconstruction.Post.AlertingPipe<DX>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Reconstruction.Post.AlertingPipe<DX>>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Reconstruction.Post.AlertingPipe<DX>>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Reconstruction.Post.AlertingPipe<DX>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Reconstruction.Post.AlertingPipe<DX>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Reconstruction.Post.AlertingPipe<DX>;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Reconstruction.Post.AlertingPipe<DX>;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Reconstruction.Post.AlertingPipe<DX>;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Reconstruction.Post.AlertingPipe<DX>;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Reconstruction.Post.AlertingPipe<DX>;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Reconstruction.Post.AlertingPipe<DX>;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Reconstruction.Post.AlertingPipe<DX>;
     ...
     * @see #removeField
     */
    withoutField(field: string): Reconstruction.Post.AlertingPipe<DX>;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Reconstruction.Post.AlertingPipe<DX>;
     ...
     */
    withoutFields(fields: Array_Type<string>): Reconstruction.Post.AlertingPipe<DX>;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Reconstruction.Post.AlertingPipe<DX>;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Reconstruction.Post.AlertingPipe<DX>;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Reconstruction.Post.AlertingPipe<DX>;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Reconstruction.Post.AlertingPipe<DX>;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Reconstruction.Post.AlertingPipe<DX>;
     ...
     * @see #removeField
     */
    unsetField(field: string): Reconstruction.Post.AlertingPipe<DX>;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Reconstruction.Post.AlertingPipe<DX>;
     ...
     * @see #unsetField
     */
    removeField(field: string): Reconstruction.Post.AlertingPipe<DX>;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Reconstruction.Post.AlertingPipe<DX>;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Reconstruction.Post.AlertingPipe<DX>;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Reconstruction.Post.AlertingPipe<DX>;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Reconstruction.Post.AlertingPipe<DX>;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Reconstruction.Post.AlertingPipe<DX>;

    mergeJson(json: any): Reconstruction.Post.AlertingPipe<DX>;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Reconstruction.Post.AlertingPipe<DX>;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Reconstruction.Post.AlertingPipe<DX>;
     ...
     */
    singletonArray(): Array_Type<Reconstruction.Post.AlertingPipe<DX>>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Reconstruction.Post.AlertingPipe<DX>> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Reconstruction.Post.AlertingPipe<DX>> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Reconstruction.Post.AlertingPipe<DX>>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Reconstruction.Post.AlertingPipe<DX>> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Reconstruction.Post.AlertingPipe<DX>> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Reconstruction.Post.AlertingPipe<DX>> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Reconstruction.Post.AlertingPipe<DX>>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Reconstruction.Post.AlertingPipe<DX>>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Reconstruction.Post.AlertingPipe<DX>;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Reconstruction.Post.AlertingPipe<DX>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Reconstruction.Post.AlertingPipe<DX>;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Reconstruction.Post.AlertingPipe<DX>;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Reconstruction.Post.AlertingPipe<DX>;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Reconstruction.Post.AlertingPipe<DX>;
     ...
     * @see #fromString
     */
    static make(s: string): Reconstruction.Post.AlertingPipe<DX> | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Reconstruction.Post.AlertingPipe<DX>;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Reconstruction.Post.AlertingPipe<DX>;
     ...
     */
    static cachedEmptyInst(): Reconstruction.Post.AlertingPipe<DX>;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Reconstruction.Post.AlertingPipe<DX>> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Reconstruction.Post.AlertingPipe<DX>;
     ...
     */
    remakeTemplate(): Reconstruction.Post.AlertingPipe<DX>;
     ...
     */
    withoutIdentity(): Reconstruction.Post.AlertingPipe<DX>;
     ...
     */
    trainSync(x: DX, y?: , spec?: MlOperationSpec): Reconstruction.Post.AlertingPipe<DX>;
     ...
     */
    static allCached(): Stream<Reconstruction.Post.AlertingPipe<DX>> | null;
     ...
     */
    static find(filter?: string): Stream<Reconstruction.Post.AlertingPipe<DX>> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<Reconstruction.Post.AlertingPipe<DX>> | null;

    /**
     * @return cached instance.
     */
    getCached(): Reconstruction.Post.AlertingPipe<DX> | null;

    /**
     * @return cached instance by the key.
     */
    static forCacheKey(key: string): Reconstruction.Post.AlertingPipe<DX> | null;
     ...
     */
    static produce(key: string): Reconstruction.Post.AlertingPipe<DX> | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, Reconstruction.Post.AlertingPipe<DX>> | null;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Reconstruction.Post.AlertingPipe<DX>>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Reconstruction.Post.AlertingPipe<DX>>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Reconstruction.Post.AlertingPipe<DX>> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Reconstruction.Post.AlertingPipe<DX>>> | null;
     ...
     */
    get(include?: string): Reconstruction.Post.AlertingPipe<DX> | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Reconstruction.Post.AlertingPipe<DX> | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Reconstruction.Post.AlertingPipe<DX>;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Reconstruction.Post.AlertingPipe<DX> | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Reconstruction.Post.AlertingPipe<DX>;
     ...
     * @see #toString
     */
    static fromString(s: string): Reconstruction.Post.AlertingPipe<DX> | null;
     ...
     */
    create(spec?: UpsertSpec): Reconstruction.Post.AlertingPipe<DX> | null;
     ...
     */
    static createBatch(objs: Array_Type<Reconstruction.Post.AlertingPipe<DX>>, spec?: UpsertSpec): ObjList<Reconstruction.Post.AlertingPipe<DX>> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Reconstruction.Post.AlertingPipe<DX>>, spec?: CreateBatchObjStreamSpec): ObjList<Reconstruction.Post.AlertingPipe<DX>> | null;
     ...
     */
    update(srcObj?: Reconstruction.Post.AlertingPipe<DX>, spec?: UpsertSpec): Reconstruction.Post.AlertingPipe<DX> | null;
     ...
     */
    upsert(srcObj?: Reconstruction.Post.AlertingPipe<DX>, spec?: UpsertSpec): Reconstruction.Post.AlertingPipe<DX> | null;
     ...
     */
    merge(spec?: MergeSpec): Reconstruction.Post.AlertingPipe<DX> | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Reconstruction.Post.AlertingPipe<DX> | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Reconstruction.Post.AlertingPipe<DX> | null;
     ...
     */
    static updateBatch(objs: Array_Type<Reconstruction.Post.AlertingPipe<DX>>, srcObjs?: Array_Type<Reconstruction.Post.AlertingPipe<DX>>, spec?: UpsertSpec): ObjList<Reconstruction.Post.AlertingPipe<DX>> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Reconstruction.Post.AlertingPipe<DX>> | null>, spec?: UpsertSpec): ObjList<Reconstruction.Post.AlertingPipe<DX>> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Reconstruction.Post.AlertingPipe<DX>>, srcObjs?: Array_Type<Reconstruction.Post.AlertingPipe<DX>>, spec?: UpsertSpec): ObjList<Reconstruction.Post.AlertingPipe<DX>> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Reconstruction.Post.AlertingPipe<DX>> | null>, spec?: UpsertSpec): ObjList<Reconstruction.Post.AlertingPipe<DX>> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Reconstruction.Post.AlertingPipe<DX>>, spec?: TouchSpec): ObjList<Reconstruction.Post.AlertingPipe<DX>> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Reconstruction.Post.AlertingPipe<DX>>, spec?: MergeSpec): ObjList<Reconstruction.Post.AlertingPipe<DX>> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Reconstruction.Post.AlertingPipe<DX>>, mergeInclude: string, spec?: MergeSpec): ObjList<Reconstruction.Post.AlertingPipe<DX>> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Reconstruction.Post.AlertingPipe<DX>> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Reconstruction.Post.AlertingPipe<DX>> | null;
     ...
     */
    static mergeAll(mergeObj: Reconstruction.Post.AlertingPipe<DX>, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Reconstruction.Post.AlertingPipe<DX>, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Reconstruction.Post.AlertingPipe<DX>>, spec?: UpsertSpec): ObjList<Reconstruction.Post.AlertingPipe<DX>> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Reconstruction.Post.AlertingPipe<DX>>, spec?: UpsertSpec): ObjList<Reconstruction.Post.AlertingPipe<DX>> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Reconstruction.Post.AlertingPipe<DX> | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Reconstruction.Post.AlertingPipe<DX>>): ObjList<Reconstruction.Post.AlertingPipe<DX>>;
     ...
     */
    static beforeUpdate(objs: Array_Type<Reconstruction.Post.AlertingPipe<DX>>): ObjList<Reconstruction.Post.AlertingPipe<DX>>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Reconstruction.Post.AlertingPipe<DX>>): ObjList<Reconstruction.Post.AlertingPipe<DX>>;
     ...
     */
    static afterCreate(objs: Array_Type<Reconstruction.Post.AlertingPipe<DX>>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Reconstruction.Post.AlertingPipe<DX>>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Reconstruction.Post.AlertingPipe<DX>>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Reconstruction.Post.AlertingPipe<DX>>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Reconstruction.Post.AlertingPipe<DX>>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Reconstruction.Post.AlertingPipe<DX> | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Reconstruction.Post.AlertingPipe<DX>>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Reconstruction.Post.AlertingPipe<DX>, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Reconstruction.Post.AlertingPipe<DX>>, callback?: λFunction<Reconstruction.Post.AlertingPipe<DX> | null, Reconstruction.Post.AlertingPipe<DX> | null>): ObjList<Reconstruction.Post.AlertingPipe<DX>>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Reconstruction.Post.AlertingPipe<DX>>, callback?: λFunction<Reconstruction.Post.AlertingPipe<DX> | null, Reconstruction.Post.AlertingPipe<DX> | null>): Array_Type<ObjError> | null;
     ...
     */
    publish(subPath?: string, contentType?: string): Reconstruction.Post.AlertingPipe<DX>;
     ...
     */
    static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<Reconstruction.Post.AlertingPipe<DX>> | null;
     ...
     */
    createSeedData(spec?: UpsertSpec): Reconstruction.Post.AlertingPipe<DX> | null;
     ...
     */
    static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<Reconstruction.Post.AlertingPipe<DX>> | null;
     ...
     */
    updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): Reconstruction.Post.AlertingPipe<DX> | null;
     ...
     */
    static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<Reconstruction.Post.AlertingPipe<DX>> | null;
     ...
     * @return updated obj instance, same as {@link Persistable#update} return value.
     */
    clearUserUpdates(spec?: MergeSpec): Reconstruction.Post.AlertingPipe<DX> | null;
     ...
     *         {@link Persistable#updateBatch}.
     */
    static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<Reconstruction.Post.AlertingPipe<DX>> | null;
    ...
    dependencies(): SeedDataDeps<Reconstruction.Post.AlertingPipe<DX>> | null;
     ...
     * be returned as-is.
     */
    byReference(): Reconstruction.Post.AlertingPipe<DX>;
     ...
     */
    updateModelFiles(modelFiles: Map_Type<string, Url>, spec?: MlOperationSpec): Reconstruction.Post.AlertingPipe<DX>;
     ...
     */
    afterTrain(doTrainOutputs: any, spec?: MlOperationSpec): Reconstruction.Post.AlertingPipe<DX>;
     ...
     */
    withNewSpec(spec?: MlConvertSpec): Reconstruction.Post.AlertingPipe<DX>;
     ...
     */
    afterConvert(model: any, spec?: MlConvertSpec): Reconstruction.Post.AlertingPipe<DX>;
     ...
     */
    withHyperparamSpaces(paramSpaces: Map_Type<string, Hp.ParamSpace>): Reconstruction.Post.AlertingPipe<DX>;
