// TypeScript definitions for the C3 type Reconstruction.Algorithm.TransformerAutoencoderPipe

/**
 * This type represents an {@link MlPipe} template for a Pytorch-based Transformer Autoencoder, based on the paper
 * "TranAD: Deep Transformer Networks for Anomaly Detection in Multivariate Time Series Data" by Tuli et al. This pipe
 * will build and train a transformer-based autoencoder on 2D timeseries data based on the user-specified
 * hyperparameters. In particular, the size of this model solely depends on the number of input features
 * {@link #numFeatures} The outputs will be the reconstructed input and the residual between the reconstruction and the
 * original input.
 *
 * @remarks this represents a value passed to a method that expects an instance of Reconstruction.Algorithm.TransformerAutoencoderPipe
 */
declare namespace Reconstruction.Algorithm {
  export interface ITransformerAutoencoderPipe {
 ...
 * original input.
 *
 * @remarks this represents a made instance of Reconstruction.Algorithm.TransformerAutoencoderPipe
 */
declare namespace Reconstruction.Algorithm {
  export class TransformerAutoencoderPipe extends Obj  {
    ...
    withLookbackDuration(lookbackDuration: IDuration | null): Reconstruction.Algorithm.TransformerAutoencoderPipe;

    /**
     * An optional suffix that is added to the column names of the reconstruction {@link Data}.
     */
    readonly reconstructionSuffix?: string;
    withReconstructionSuffix(reconstructionSuffix: string | null): Reconstruction.Algorithm.TransformerAutoencoderPipe;

    /**
     * An optional suffix that is added to the column names of the residual {@link Data}.
     */
    readonly residualSuffix?: string;
    withResidualSuffix(residualSuffix: string | null): Reconstruction.Algorithm.TransformerAutoencoderPipe;
     ...
     */
    readonly id: string;
    withId(id: string): Reconstruction.Algorithm.TransformerAutoencoderPipe;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Reconstruction.Algorithm.TransformerAutoencoderPipe;

    /**
     * Name of this pipe.
     */
    readonly name?: string;
    withName(name: string | null): Reconstruction.Algorithm.TransformerAutoencoderPipe;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Reconstruction.Algorithm.TransformerAutoencoderPipe;
    ...
    withVersion(version: number | null): Reconstruction.Algorithm.TransformerAutoencoderPipe;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Reconstruction.Algorithm.TransformerAutoencoderPipe;
    ...
    withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): Reconstruction.Algorithm.TransformerAutoencoderPipe;
    ...
    withHidden(hidden: boolean): Reconstruction.Algorithm.TransformerAutoencoderPipe;
    ...
    withUserOwned(userOwned: boolean): Reconstruction.Algorithm.TransformerAutoencoderPipe;
    ...
    withTypeIdent(typeIdent: string | null): Reconstruction.Algorithm.TransformerAutoencoderPipe;

    /**
     * If true, then the pipe shall not be retrained
     */
    readonly frozen?: boolean;
    withFrozen(frozen: boolean): Reconstruction.Algorithm.TransformerAutoencoderPipe;

    /**
     * True if training has succeeded and false otherwise.
     */
    readonly trained?: boolean;
    withTrained(trained: boolean): Reconstruction.Algorithm.TransformerAutoencoderPipe;

    /**
     * Errors from training.
     */
    readonly trainingErrors?: string;
    withTrainingErrors(trainingErrors: string | null): Reconstruction.Algorithm.TransformerAutoencoderPipe;

    /**
     * If true, the underlying model only accepts flattened input.
     */
    readonly flattenInput?: boolean;
    withFlattenInput(flattenInput: boolean): Reconstruction.Algorithm.TransformerAutoencoderPipe;

    /**
     * The hyperparameters overridden of a native model or pipe.
     */
    readonly hyperparamOverrides?: Map_Type<string, any>;
    withHyperparamOverrides(hyperparamOverrides: Map_Type<string, any> | {[key: string]: any} | null): Reconstruction.Algorithm.TransformerAutoencoderPipe;
    ...
    withHyperparamSearchSpace(hyperparamSearchSpace: IHp.SearchSpace | null): Reconstruction.Algorithm.TransformerAutoencoderPipe;
    ...
    withHpoSpec(hpoSpec: IHpo.Spec | null): Reconstruction.Algorithm.TransformerAutoencoderPipe;

    /**
     * {@link Hpo.Experiment} stores the result of hyperparameter optimization to find the best model/pipeline.
     */
    readonly hpoExperiment?: Hpo.Experiment;
    withHpoExperiment(hpoExperiment: IHpo.Experiment | null): Reconstruction.Algorithm.TransformerAutoencoderPipe;

    /**
     * Reference to the experiment that produced this {@link MlPipe}. For example, this could be a {@link Hpo.ExperimentBase}.
     */
    readonly experiment?: any;
    withExperiment(experiment: any | null): Reconstruction.Algorithm.TransformerAutoencoderPipe;
    ...
    withModelFiles(modelFiles: Map_Type<string, Url> | {[key: string]: IUrl} | null): Reconstruction.Algorithm.TransformerAutoencoderPipe;
    ...
    withCustomModelCode(customModelCode: Map_Type<string, any> | {[key: string]: any} | null): Reconstruction.Algorithm.TransformerAutoencoderPipe;

    /**
     * Name for the function on the native model to call to do {@link MlProcessable#process}.
     */
    readonly processFunc?: string;
    withProcessFunc(processFunc: string | null): Reconstruction.Algorithm.TransformerAutoencoderPipe;
    ...
    withUnderlyingPipe(underlyingPipe: IMlAtomicPipe<any, any, any> | null): Reconstruction.Algorithm.TransformerAutoencoderPipe;

    /**
     * Training epochs
     */
    readonly epochs: number;
    withEpochs(epochs: number): Reconstruction.Algorithm.TransformerAutoencoderPipe;

    /**
     * Training batch size
     */
    readonly batchSize: number;
    withBatchSize(batchSize: number): Reconstruction.Algorithm.TransformerAutoencoderPipe;

    /**
     * Number of features
     */
    readonly numFeatures: number;
    withNumFeatures(numFeatures: number): Reconstruction.Algorithm.TransformerAutoencoderPipe;

    /**
     * Random seed used during model training. Use the same number for reproducible training results.
     */
    readonly randomSeed?: number;
    withRandomSeed(randomSeed: number | null): Reconstruction.Algorithm.TransformerAutoencoderPipe;
    ...
    withLearningRateOverride(learningRateOverride: number | null): Reconstruction.Algorithm.TransformerAutoencoderPipe;
    ...
    withWindowSize(windowSize: number): Reconstruction.Algorithm.TransformerAutoencoderPipe;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Reconstruction.Algorithm.TransformerAutoencoderPipe | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Reconstruction.Algorithm.TransformerAutoencoderPipe | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Reconstruction.Algorithm.TransformerAutoencoderPipe | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Reconstruction.Algorithm.TransformerAutoencoderPipe | null;
     ...
     */
    replaceType(old: Type, new_: Type): Reconstruction.Algorithm.TransformerAutoencoderPipe;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Reconstruction.Algorithm.TransformerAutoencoderPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Reconstruction.Algorithm.TransformerAutoencoderPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Reconstruction.Algorithm.TransformerAutoencoderPipe>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Reconstruction.Algorithm.TransformerAutoencoderPipe>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Reconstruction.Algorithm.TransformerAutoencoderPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Reconstruction.Algorithm.TransformerAutoencoderPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Reconstruction.Algorithm.TransformerAutoencoderPipe;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Reconstruction.Algorithm.TransformerAutoencoderPipe;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Reconstruction.Algorithm.TransformerAutoencoderPipe;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Reconstruction.Algorithm.TransformerAutoencoderPipe;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Reconstruction.Algorithm.TransformerAutoencoderPipe;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Reconstruction.Algorithm.TransformerAutoencoderPipe;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Reconstruction.Algorithm.TransformerAutoencoderPipe;
     ...
     * @see #removeField
     */
    withoutField(field: string): Reconstruction.Algorithm.TransformerAutoencoderPipe;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Reconstruction.Algorithm.TransformerAutoencoderPipe;
     ...
     */
    withoutFields(fields: Array_Type<string>): Reconstruction.Algorithm.TransformerAutoencoderPipe;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Reconstruction.Algorithm.TransformerAutoencoderPipe;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Reconstruction.Algorithm.TransformerAutoencoderPipe;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Reconstruction.Algorithm.TransformerAutoencoderPipe;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Reconstruction.Algorithm.TransformerAutoencoderPipe;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Reconstruction.Algorithm.TransformerAutoencoderPipe;
     ...
     * @see #removeField
     */
    unsetField(field: string): Reconstruction.Algorithm.TransformerAutoencoderPipe;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Reconstruction.Algorithm.TransformerAutoencoderPipe;
     ...
     * @see #unsetField
     */
    removeField(field: string): Reconstruction.Algorithm.TransformerAutoencoderPipe;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Reconstruction.Algorithm.TransformerAutoencoderPipe;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Reconstruction.Algorithm.TransformerAutoencoderPipe;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Reconstruction.Algorithm.TransformerAutoencoderPipe;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Reconstruction.Algorithm.TransformerAutoencoderPipe;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Reconstruction.Algorithm.TransformerAutoencoderPipe;

    mergeJson(json: any): Reconstruction.Algorithm.TransformerAutoencoderPipe;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Reconstruction.Algorithm.TransformerAutoencoderPipe;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Reconstruction.Algorithm.TransformerAutoencoderPipe;
     ...
     */
    singletonArray(): Array_Type<Reconstruction.Algorithm.TransformerAutoencoderPipe>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Reconstruction.Algorithm.TransformerAutoencoderPipe> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Reconstruction.Algorithm.TransformerAutoencoderPipe> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Reconstruction.Algorithm.TransformerAutoencoderPipe>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Reconstruction.Algorithm.TransformerAutoencoderPipe> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Reconstruction.Algorithm.TransformerAutoencoderPipe> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Reconstruction.Algorithm.TransformerAutoencoderPipe> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Reconstruction.Algorithm.TransformerAutoencoderPipe>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Reconstruction.Algorithm.TransformerAutoencoderPipe>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Reconstruction.Algorithm.TransformerAutoencoderPipe;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Reconstruction.Algorithm.TransformerAutoencoderPipe;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Reconstruction.Algorithm.TransformerAutoencoderPipe;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Reconstruction.Algorithm.TransformerAutoencoderPipe;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Reconstruction.Algorithm.TransformerAutoencoderPipe;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Reconstruction.Algorithm.TransformerAutoencoderPipe;
     ...
     * @see #fromString
     */
    static make(s: string): Reconstruction.Algorithm.TransformerAutoencoderPipe | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Reconstruction.Algorithm.TransformerAutoencoderPipe;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Reconstruction.Algorithm.TransformerAutoencoderPipe;
     ...
     */
    static cachedEmptyInst(): Reconstruction.Algorithm.TransformerAutoencoderPipe;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Reconstruction.Algorithm.TransformerAutoencoderPipe> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Reconstruction.Algorithm.TransformerAutoencoderPipe;
     ...
     */
    remakeTemplate(): Reconstruction.Algorithm.TransformerAutoencoderPipe;
     ...
     */
    withoutIdentity(): Reconstruction.Algorithm.TransformerAutoencoderPipe;
     ...
     */
    trainSync(x: , y?: , spec?: MlOperationSpec): Reconstruction.Algorithm.TransformerAutoencoderPipe;
     ...
     */
    static allCached(): Stream<Reconstruction.Algorithm.TransformerAutoencoderPipe> | null;
     ...
     */
    static find(filter?: string): Stream<Reconstruction.Algorithm.TransformerAutoencoderPipe> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<Reconstruction.Algorithm.TransformerAutoencoderPipe> | null;

    /**
     * @return cached instance.
     */
    getCached(): Reconstruction.Algorithm.TransformerAutoencoderPipe | null;

    /**
     * @return cached instance by the key.
     */
    static forCacheKey(key: string): Reconstruction.Algorithm.TransformerAutoencoderPipe | null;
     ...
     */
    static produce(key: string): Reconstruction.Algorithm.TransformerAutoencoderPipe | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, Reconstruction.Algorithm.TransformerAutoencoderPipe> | null;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Reconstruction.Algorithm.TransformerAutoencoderPipe>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Reconstruction.Algorithm.TransformerAutoencoderPipe>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Reconstruction.Algorithm.TransformerAutoencoderPipe> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Reconstruction.Algorithm.TransformerAutoencoderPipe>> | null;
     ...
     */
    get(include?: string): Reconstruction.Algorithm.TransformerAutoencoderPipe | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Reconstruction.Algorithm.TransformerAutoencoderPipe | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Reconstruction.Algorithm.TransformerAutoencoderPipe;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Reconstruction.Algorithm.TransformerAutoencoderPipe | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Reconstruction.Algorithm.TransformerAutoencoderPipe;
     ...
     * @see #toString
     */
    static fromString(s: string): Reconstruction.Algorithm.TransformerAutoencoderPipe | null;
     ...
     */
    create(spec?: UpsertSpec): Reconstruction.Algorithm.TransformerAutoencoderPipe | null;
     ...
     */
    static createBatch(objs: Array_Type<Reconstruction.Algorithm.TransformerAutoencoderPipe>, spec?: UpsertSpec): ObjList<Reconstruction.Algorithm.TransformerAutoencoderPipe> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Reconstruction.Algorithm.TransformerAutoencoderPipe>, spec?: CreateBatchObjStreamSpec): ObjList<Reconstruction.Algorithm.TransformerAutoencoderPipe> | null;
     ...
     */
    update(srcObj?: Reconstruction.Algorithm.TransformerAutoencoderPipe, spec?: UpsertSpec): Reconstruction.Algorithm.TransformerAutoencoderPipe | null;
     ...
     */
    upsert(srcObj?: Reconstruction.Algorithm.TransformerAutoencoderPipe, spec?: UpsertSpec): Reconstruction.Algorithm.TransformerAutoencoderPipe | null;
     ...
     */
    merge(spec?: MergeSpec): Reconstruction.Algorithm.TransformerAutoencoderPipe | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Reconstruction.Algorithm.TransformerAutoencoderPipe | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Reconstruction.Algorithm.TransformerAutoencoderPipe | null;
     ...
     */
    static updateBatch(objs: Array_Type<Reconstruction.Algorithm.TransformerAutoencoderPipe>, srcObjs?: Array_Type<Reconstruction.Algorithm.TransformerAutoencoderPipe>, spec?: UpsertSpec): ObjList<Reconstruction.Algorithm.TransformerAutoencoderPipe> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Reconstruction.Algorithm.TransformerAutoencoderPipe> | null>, spec?: UpsertSpec): ObjList<Reconstruction.Algorithm.TransformerAutoencoderPipe> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Reconstruction.Algorithm.TransformerAutoencoderPipe>, srcObjs?: Array_Type<Reconstruction.Algorithm.TransformerAutoencoderPipe>, spec?: UpsertSpec): ObjList<Reconstruction.Algorithm.TransformerAutoencoderPipe> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Reconstruction.Algorithm.TransformerAutoencoderPipe> | null>, spec?: UpsertSpec): ObjList<Reconstruction.Algorithm.TransformerAutoencoderPipe> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Reconstruction.Algorithm.TransformerAutoencoderPipe>, spec?: TouchSpec): ObjList<Reconstruction.Algorithm.TransformerAutoencoderPipe> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Reconstruction.Algorithm.TransformerAutoencoderPipe>, spec?: MergeSpec): ObjList<Reconstruction.Algorithm.TransformerAutoencoderPipe> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Reconstruction.Algorithm.TransformerAutoencoderPipe>, mergeInclude: string, spec?: MergeSpec): ObjList<Reconstruction.Algorithm.TransformerAutoencoderPipe> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Reconstruction.Algorithm.TransformerAutoencoderPipe> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Reconstruction.Algorithm.TransformerAutoencoderPipe> | null;
     ...
     */
    static mergeAll(mergeObj: Reconstruction.Algorithm.TransformerAutoencoderPipe, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Reconstruction.Algorithm.TransformerAutoencoderPipe, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Reconstruction.Algorithm.TransformerAutoencoderPipe>, spec?: UpsertSpec): ObjList<Reconstruction.Algorithm.TransformerAutoencoderPipe> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Reconstruction.Algorithm.TransformerAutoencoderPipe>, spec?: UpsertSpec): ObjList<Reconstruction.Algorithm.TransformerAutoencoderPipe> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Reconstruction.Algorithm.TransformerAutoencoderPipe | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Reconstruction.Algorithm.TransformerAutoencoderPipe>): ObjList<Reconstruction.Algorithm.TransformerAutoencoderPipe>;
     ...
     */
    static beforeUpdate(objs: Array_Type<Reconstruction.Algorithm.TransformerAutoencoderPipe>): ObjList<Reconstruction.Algorithm.TransformerAutoencoderPipe>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Reconstruction.Algorithm.TransformerAutoencoderPipe>): ObjList<Reconstruction.Algorithm.TransformerAutoencoderPipe>;
     ...
     */
    static afterCreate(objs: Array_Type<Reconstruction.Algorithm.TransformerAutoencoderPipe>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Reconstruction.Algorithm.TransformerAutoencoderPipe>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Reconstruction.Algorithm.TransformerAutoencoderPipe>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Reconstruction.Algorithm.TransformerAutoencoderPipe>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Reconstruction.Algorithm.TransformerAutoencoderPipe>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Reconstruction.Algorithm.TransformerAutoencoderPipe | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Reconstruction.Algorithm.TransformerAutoencoderPipe>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Reconstruction.Algorithm.TransformerAutoencoderPipe, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Reconstruction.Algorithm.TransformerAutoencoderPipe>, callback?: λFunction<Reconstruction.Algorithm.TransformerAutoencoderPipe | null, Reconstruction.Algorithm.TransformerAutoencoderPipe | null>): ObjList<Reconstruction.Algorithm.TransformerAutoencoderPipe>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Reconstruction.Algorithm.TransformerAutoencoderPipe>, callback?: λFunction<Reconstruction.Algorithm.TransformerAutoencoderPipe | null, Reconstruction.Algorithm.TransformerAutoencoderPipe | null>): Array_Type<ObjError> | null;
     ...
     */
    publish(subPath?: string, contentType?: string): Reconstruction.Algorithm.TransformerAutoencoderPipe;
     ...
     */
    static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<Reconstruction.Algorithm.TransformerAutoencoderPipe> | null;
     ...
     */
    createSeedData(spec?: UpsertSpec): Reconstruction.Algorithm.TransformerAutoencoderPipe | null;
     ...
     */
    static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<Reconstruction.Algorithm.TransformerAutoencoderPipe> | null;
     ...
     */
    updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): Reconstruction.Algorithm.TransformerAutoencoderPipe | null;
     ...
     */
    static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<Reconstruction.Algorithm.TransformerAutoencoderPipe> | null;
     ...
     * @return updated obj instance, same as {@link Persistable#update} return value.
     */
    clearUserUpdates(spec?: MergeSpec): Reconstruction.Algorithm.TransformerAutoencoderPipe | null;
     ...
     *         {@link Persistable#updateBatch}.
     */
    static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<Reconstruction.Algorithm.TransformerAutoencoderPipe> | null;
    ...
    dependencies(): SeedDataDeps<Reconstruction.Algorithm.TransformerAutoencoderPipe> | null;
     ...
     */
    static convert(model: any, spec?: MlConvertSpec): Reconstruction.Algorithm.TransformerAutoencoderPipe;

    /**
     * Freezes an {@link MlPipe}
     * @return modified copy of this {@link MlPipe} that cannot be trained
     */
    freeze(): Reconstruction.Algorithm.TransformerAutoencoderPipe;

    /**
     * Unfreezes an {@link MlPipe}
     * @return modified copy of this {@link MlPipe} that can be trained
     */
    unfreeze(): Reconstruction.Algorithm.TransformerAutoencoderPipe;
     ...
     * be returned as-is.
     */
    byReference(): Reconstruction.Algorithm.TransformerAutoencoderPipe;
     ...
     */
    updateModelFiles(modelFiles: Map_Type<string, Url>, spec?: MlOperationSpec): Reconstruction.Algorithm.TransformerAutoencoderPipe;
     ...
     */
    afterTrain(doTrainOutputs: any, spec?: MlOperationSpec): Reconstruction.Algorithm.TransformerAutoencoderPipe;
     ...
     */
    withNewSpec(spec?: MlConvertSpec): Reconstruction.Algorithm.TransformerAutoencoderPipe;
     ...
     */
    afterConvert(model: any, spec?: MlConvertSpec): Reconstruction.Algorithm.TransformerAutoencoderPipe;
     ...
     */
    withHyperparamSpaces(paramSpaces: Map_Type<string, Hp.ParamSpace>): Reconstruction.Algorithm.TransformerAutoencoderPipe;
