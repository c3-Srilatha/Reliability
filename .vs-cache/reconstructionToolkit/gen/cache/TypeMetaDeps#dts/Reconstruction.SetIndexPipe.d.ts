// TypeScript definitions for the C3 type Reconstruction.SetIndexPipe

/**
 * This type represents a process-only pipe that sets the {@link Feature.TIMESTAMP} and {@link Feature.SUBJECT}
 * columns of the input {@link Data} as indices.
 *
 * @remarks this represents a value passed to a method that expects an instance of Reconstruction.SetIndexPipe
 */
 ...
 * columns of the input {@link Data} as indices.
 *
 * @remarks this represents a made instance of Reconstruction.SetIndexPipe
 */
declare namespace Reconstruction {
  export class SetIndexPipe extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): Reconstruction.SetIndexPipe;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Reconstruction.SetIndexPipe;

    /**
     * Name of this pipe.
     */
    readonly name?: string;
    withName(name: string | null): Reconstruction.SetIndexPipe;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Reconstruction.SetIndexPipe;
    ...
    withVersion(version: number | null): Reconstruction.SetIndexPipe;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Reconstruction.SetIndexPipe;
    ...
    withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): Reconstruction.SetIndexPipe;
    ...
    withHidden(hidden: boolean): Reconstruction.SetIndexPipe;
    ...
    withUserOwned(userOwned: boolean): Reconstruction.SetIndexPipe;
    ...
    withTypeIdent(typeIdent: string | null): Reconstruction.SetIndexPipe;

    /**
     * If true, then the pipe shall not be retrained
     */
    readonly frozen?: boolean;
    withFrozen(frozen: boolean): Reconstruction.SetIndexPipe;

    /**
     * True if training has succeeded and false otherwise.
     */
    readonly trained?: boolean;
    withTrained(trained: boolean): Reconstruction.SetIndexPipe;

    /**
     * Errors from training.
     */
    readonly trainingErrors?: string;
    withTrainingErrors(trainingErrors: string | null): Reconstruction.SetIndexPipe;

    /**
     * If true, the underlying model only accepts flattened input.
     */
    readonly flattenInput?: boolean;
    withFlattenInput(flattenInput: boolean): Reconstruction.SetIndexPipe;

    /**
     * The hyperparameters overridden of a native model or pipe.
     */
    readonly hyperparamOverrides?: Map_Type<string, any>;
    withHyperparamOverrides(hyperparamOverrides: Map_Type<string, any> | {[key: string]: any} | null): Reconstruction.SetIndexPipe;
    ...
    withHyperparamSearchSpace(hyperparamSearchSpace: IHp.SearchSpace | null): Reconstruction.SetIndexPipe;
    ...
    withHpoSpec(hpoSpec: IHpo.Spec | null): Reconstruction.SetIndexPipe;

    /**
     * {@link Hpo.Experiment} stores the result of hyperparameter optimization to find the best model/pipeline.
     */
    readonly hpoExperiment?: Hpo.Experiment;
    withHpoExperiment(hpoExperiment: IHpo.Experiment | null): Reconstruction.SetIndexPipe;

    /**
     * Reference to the experiment that produced this {@link MlPipe}. For example, this could be a {@link Hpo.ExperimentBase}.
     */
    readonly experiment?: any;
    withExperiment(experiment: any | null): Reconstruction.SetIndexPipe;
    ...
    withModelFiles(modelFiles: Map_Type<string, Url> | {[key: string]: IUrl} | null): Reconstruction.SetIndexPipe;
    ...
    withCustomModelCode(customModelCode: Map_Type<string, any> | {[key: string]: any} | null): Reconstruction.SetIndexPipe;

    /**
     * Name for the function on the native model to call to do {@link MlProcessable#process}.
     */
    readonly processFunc?: string;
    withProcessFunc(processFunc: string | null): Reconstruction.SetIndexPipe;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Reconstruction.SetIndexPipe | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Reconstruction.SetIndexPipe | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Reconstruction.SetIndexPipe | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Reconstruction.SetIndexPipe | null;
     ...
     */
    replaceType(old: Type, new_: Type): Reconstruction.SetIndexPipe;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Reconstruction.SetIndexPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Reconstruction.SetIndexPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Reconstruction.SetIndexPipe>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Reconstruction.SetIndexPipe>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Reconstruction.SetIndexPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Reconstruction.SetIndexPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Reconstruction.SetIndexPipe;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Reconstruction.SetIndexPipe;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Reconstruction.SetIndexPipe;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Reconstruction.SetIndexPipe;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Reconstruction.SetIndexPipe;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Reconstruction.SetIndexPipe;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Reconstruction.SetIndexPipe;
     ...
     * @see #removeField
     */
    withoutField(field: string): Reconstruction.SetIndexPipe;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Reconstruction.SetIndexPipe;
     ...
     */
    withoutFields(fields: Array_Type<string>): Reconstruction.SetIndexPipe;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Reconstruction.SetIndexPipe;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Reconstruction.SetIndexPipe;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Reconstruction.SetIndexPipe;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Reconstruction.SetIndexPipe;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Reconstruction.SetIndexPipe;
     ...
     * @see #removeField
     */
    unsetField(field: string): Reconstruction.SetIndexPipe;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Reconstruction.SetIndexPipe;
     ...
     * @see #unsetField
     */
    removeField(field: string): Reconstruction.SetIndexPipe;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Reconstruction.SetIndexPipe;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Reconstruction.SetIndexPipe;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Reconstruction.SetIndexPipe;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Reconstruction.SetIndexPipe;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Reconstruction.SetIndexPipe;

    mergeJson(json: any): Reconstruction.SetIndexPipe;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Reconstruction.SetIndexPipe;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Reconstruction.SetIndexPipe;
     ...
     */
    singletonArray(): Array_Type<Reconstruction.SetIndexPipe>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Reconstruction.SetIndexPipe> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Reconstruction.SetIndexPipe> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Reconstruction.SetIndexPipe>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Reconstruction.SetIndexPipe> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Reconstruction.SetIndexPipe> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Reconstruction.SetIndexPipe> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Reconstruction.SetIndexPipe>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Reconstruction.SetIndexPipe>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Reconstruction.SetIndexPipe;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Reconstruction.SetIndexPipe;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Reconstruction.SetIndexPipe;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Reconstruction.SetIndexPipe;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Reconstruction.SetIndexPipe;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Reconstruction.SetIndexPipe;
     ...
     * @see #fromString
     */
    static make(s: string): Reconstruction.SetIndexPipe | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Reconstruction.SetIndexPipe;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Reconstruction.SetIndexPipe;
     ...
     */
    static cachedEmptyInst(): Reconstruction.SetIndexPipe;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Reconstruction.SetIndexPipe> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Reconstruction.SetIndexPipe;
     ...
     */
    withoutIdentity(): Reconstruction.SetIndexPipe;
     ...
     */
    trainSync(x: Data, y?: , spec?: MlOperationSpec): Reconstruction.SetIndexPipe;
     ...
     */
    static allCached(): Stream<Reconstruction.SetIndexPipe> | null;
     ...
     */
    static find(filter?: string): Stream<Reconstruction.SetIndexPipe> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<Reconstruction.SetIndexPipe> | null;

    /**
     * @return cached instance.
     */
    getCached(): Reconstruction.SetIndexPipe | null;

    /**
     * @return cached instance by the key.
     */
    static forCacheKey(key: string): Reconstruction.SetIndexPipe | null;
     ...
     */
    static produce(key: string): Reconstruction.SetIndexPipe | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, Reconstruction.SetIndexPipe> | null;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Reconstruction.SetIndexPipe>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Reconstruction.SetIndexPipe>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Reconstruction.SetIndexPipe> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Reconstruction.SetIndexPipe>> | null;
     ...
     */
    get(include?: string): Reconstruction.SetIndexPipe | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Reconstruction.SetIndexPipe | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Reconstruction.SetIndexPipe;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Reconstruction.SetIndexPipe | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Reconstruction.SetIndexPipe;
     ...
     * @see #toString
     */
    static fromString(s: string): Reconstruction.SetIndexPipe | null;
     ...
     */
    create(spec?: UpsertSpec): Reconstruction.SetIndexPipe | null;
     ...
     */
    static createBatch(objs: Array_Type<Reconstruction.SetIndexPipe>, spec?: UpsertSpec): ObjList<Reconstruction.SetIndexPipe> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Reconstruction.SetIndexPipe>, spec?: CreateBatchObjStreamSpec): ObjList<Reconstruction.SetIndexPipe> | null;
     ...
     */
    update(srcObj?: Reconstruction.SetIndexPipe, spec?: UpsertSpec): Reconstruction.SetIndexPipe | null;
     ...
     */
    upsert(srcObj?: Reconstruction.SetIndexPipe, spec?: UpsertSpec): Reconstruction.SetIndexPipe | null;
     ...
     */
    merge(spec?: MergeSpec): Reconstruction.SetIndexPipe | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Reconstruction.SetIndexPipe | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Reconstruction.SetIndexPipe | null;
     ...
     */
    static updateBatch(objs: Array_Type<Reconstruction.SetIndexPipe>, srcObjs?: Array_Type<Reconstruction.SetIndexPipe>, spec?: UpsertSpec): ObjList<Reconstruction.SetIndexPipe> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Reconstruction.SetIndexPipe> | null>, spec?: UpsertSpec): ObjList<Reconstruction.SetIndexPipe> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Reconstruction.SetIndexPipe>, srcObjs?: Array_Type<Reconstruction.SetIndexPipe>, spec?: UpsertSpec): ObjList<Reconstruction.SetIndexPipe> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Reconstruction.SetIndexPipe> | null>, spec?: UpsertSpec): ObjList<Reconstruction.SetIndexPipe> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Reconstruction.SetIndexPipe>, spec?: TouchSpec): ObjList<Reconstruction.SetIndexPipe> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Reconstruction.SetIndexPipe>, spec?: MergeSpec): ObjList<Reconstruction.SetIndexPipe> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Reconstruction.SetIndexPipe>, mergeInclude: string, spec?: MergeSpec): ObjList<Reconstruction.SetIndexPipe> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Reconstruction.SetIndexPipe> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Reconstruction.SetIndexPipe> | null;
     ...
     */
    static mergeAll(mergeObj: Reconstruction.SetIndexPipe, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Reconstruction.SetIndexPipe, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Reconstruction.SetIndexPipe>, spec?: UpsertSpec): ObjList<Reconstruction.SetIndexPipe> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Reconstruction.SetIndexPipe>, spec?: UpsertSpec): ObjList<Reconstruction.SetIndexPipe> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Reconstruction.SetIndexPipe | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Reconstruction.SetIndexPipe>): ObjList<Reconstruction.SetIndexPipe>;
     ...
     */
    static beforeUpdate(objs: Array_Type<Reconstruction.SetIndexPipe>): ObjList<Reconstruction.SetIndexPipe>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Reconstruction.SetIndexPipe>): ObjList<Reconstruction.SetIndexPipe>;
     ...
     */
    static afterCreate(objs: Array_Type<Reconstruction.SetIndexPipe>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Reconstruction.SetIndexPipe>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Reconstruction.SetIndexPipe>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Reconstruction.SetIndexPipe>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Reconstruction.SetIndexPipe>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Reconstruction.SetIndexPipe | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Reconstruction.SetIndexPipe>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Reconstruction.SetIndexPipe, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Reconstruction.SetIndexPipe>, callback?: λFunction<Reconstruction.SetIndexPipe | null, Reconstruction.SetIndexPipe | null>): ObjList<Reconstruction.SetIndexPipe>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Reconstruction.SetIndexPipe>, callback?: λFunction<Reconstruction.SetIndexPipe | null, Reconstruction.SetIndexPipe | null>): Array_Type<ObjError> | null;
     ...
     */
    publish(subPath?: string, contentType?: string): Reconstruction.SetIndexPipe;
     ...
     */
    static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<Reconstruction.SetIndexPipe> | null;
     ...
     */
    createSeedData(spec?: UpsertSpec): Reconstruction.SetIndexPipe | null;
     ...
     */
    static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<Reconstruction.SetIndexPipe> | null;
     ...
     */
    updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): Reconstruction.SetIndexPipe | null;
     ...
     */
    static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<Reconstruction.SetIndexPipe> | null;
     ...
     * @return updated obj instance, same as {@link Persistable#update} return value.
     */
    clearUserUpdates(spec?: MergeSpec): Reconstruction.SetIndexPipe | null;
     ...
     *         {@link Persistable#updateBatch}.
     */
    static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<Reconstruction.SetIndexPipe> | null;
    ...
    dependencies(): SeedDataDeps<Reconstruction.SetIndexPipe> | null;
     ...
     * be returned as-is.
     */
    byReference(): Reconstruction.SetIndexPipe;
     ...
     */
    updateModelFiles(modelFiles: Map_Type<string, Url>, spec?: MlOperationSpec): Reconstruction.SetIndexPipe;
     ...
     */
    afterTrain(doTrainOutputs: any, spec?: MlOperationSpec): Reconstruction.SetIndexPipe;
     ...
     */
    withNewSpec(spec?: MlConvertSpec): Reconstruction.SetIndexPipe;
     ...
     */
    afterConvert(model: any, spec?: MlConvertSpec): Reconstruction.SetIndexPipe;
     ...
     */
    withHyperparamSpaces(paramSpaces: Map_Type<string, Hp.ParamSpace>): Reconstruction.SetIndexPipe;
