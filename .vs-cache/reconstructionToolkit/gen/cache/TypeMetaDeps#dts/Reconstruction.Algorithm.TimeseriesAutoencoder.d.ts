// TypeScript definitions for the C3 type Reconstruction.Algorithm.TimeseriesAutoencoder

/**
 * This Type represents all autoencoders that model solely time-series data.
 *
 * @remarks this represents a value passed to a method that expects an instance of Reconstruction.Algorithm.TimeseriesAutoencoder
 */
declare namespace Reconstruction.Algorithm {
  export interface ITimeseriesAutoencoder<DO> {
 ...
 * This Type represents all autoencoders that model solely time-series data.
 *
 * @remarks this represents a made instance of Reconstruction.Algorithm.TimeseriesAutoencoder
 */
declare namespace Reconstruction.Algorithm {
  export class TimeseriesAutoencoder<DO> extends Obj  {
    ...
    withLookbackDuration(lookbackDuration: IDuration | null): Reconstruction.Algorithm.TimeseriesAutoencoder;

    /**
     * An optional suffix that is added to the column names of the reconstruction {@link Data}.
     */
    readonly reconstructionSuffix?: string;
    withReconstructionSuffix(reconstructionSuffix: string | null): Reconstruction.Algorithm.TimeseriesAutoencoder;

    /**
     * An optional suffix that is added to the column names of the residual {@link Data}.
     */
    readonly residualSuffix?: string;
    withResidualSuffix(residualSuffix: string | null): Reconstruction.Algorithm.TimeseriesAutoencoder;
     ...
     */
    readonly id: string;
    withId(id: string): Reconstruction.Algorithm.TimeseriesAutoencoder;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Reconstruction.Algorithm.TimeseriesAutoencoder;

    /**
     * Name of this pipe.
     */
    readonly name?: string;
    withName(name: string | null): Reconstruction.Algorithm.TimeseriesAutoencoder;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Reconstruction.Algorithm.TimeseriesAutoencoder;
    ...
    withVersion(version: number | null): Reconstruction.Algorithm.TimeseriesAutoencoder;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Reconstruction.Algorithm.TimeseriesAutoencoder;
    ...
    withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): Reconstruction.Algorithm.TimeseriesAutoencoder;
    ...
    withHidden(hidden: boolean): Reconstruction.Algorithm.TimeseriesAutoencoder;
    ...
    withUserOwned(userOwned: boolean): Reconstruction.Algorithm.TimeseriesAutoencoder;
    ...
    withTypeIdent(typeIdent: string | null): Reconstruction.Algorithm.TimeseriesAutoencoder;

    /**
     * If true, then the pipe shall not be retrained
     */
    readonly frozen?: boolean;
    withFrozen(frozen: boolean): Reconstruction.Algorithm.TimeseriesAutoencoder;

    /**
     * True if training has succeeded and false otherwise.
     */
    readonly trained?: boolean;
    withTrained(trained: boolean): Reconstruction.Algorithm.TimeseriesAutoencoder;

    /**
     * Errors from training.
     */
    readonly trainingErrors?: string;
    withTrainingErrors(trainingErrors: string | null): Reconstruction.Algorithm.TimeseriesAutoencoder;

    /**
     * If true, the underlying model only accepts flattened input.
     */
    readonly flattenInput?: boolean;
    withFlattenInput(flattenInput: boolean): Reconstruction.Algorithm.TimeseriesAutoencoder;

    /**
     * The hyperparameters overridden of a native model or pipe.
     */
    readonly hyperparamOverrides?: Map_Type<string, any>;
    withHyperparamOverrides(hyperparamOverrides: Map_Type<string, any> | {[key: string]: any} | null): Reconstruction.Algorithm.TimeseriesAutoencoder;
    ...
    withHyperparamSearchSpace(hyperparamSearchSpace: IHp.SearchSpace | null): Reconstruction.Algorithm.TimeseriesAutoencoder;
    ...
    withHpoSpec(hpoSpec: IHpo.Spec | null): Reconstruction.Algorithm.TimeseriesAutoencoder;

    /**
     * {@link Hpo.Experiment} stores the result of hyperparameter optimization to find the best model/pipeline.
     */
    readonly hpoExperiment?: Hpo.Experiment;
    withHpoExperiment(hpoExperiment: IHpo.Experiment | null): Reconstruction.Algorithm.TimeseriesAutoencoder;

    /**
     * Reference to the experiment that produced this {@link MlPipe}. For example, this could be a {@link Hpo.ExperimentBase}.
     */
    readonly experiment?: any;
    withExperiment(experiment: any | null): Reconstruction.Algorithm.TimeseriesAutoencoder;
    ...
    withModelFiles(modelFiles: Map_Type<string, Url> | {[key: string]: IUrl} | null): Reconstruction.Algorithm.TimeseriesAutoencoder;
    ...
    withCustomModelCode(customModelCode: Map_Type<string, any> | {[key: string]: any} | null): Reconstruction.Algorithm.TimeseriesAutoencoder;

    /**
     * Name for the function on the native model to call to do {@link MlProcessable#process}.
     */
    readonly processFunc?: string;
    withProcessFunc(processFunc: string | null): Reconstruction.Algorithm.TimeseriesAutoencoder;
    ...
    withUnderlyingPipe(underlyingPipe: IMlAtomicPipe<any, any, any> | null): Reconstruction.Algorithm.TimeseriesAutoencoder;

    /**
     * Training epochs
     */
    readonly epochs: number;
    withEpochs(epochs: number): Reconstruction.Algorithm.TimeseriesAutoencoder;

    /**
     * Training batch size
     */
    readonly batchSize: number;
    withBatchSize(batchSize: number): Reconstruction.Algorithm.TimeseriesAutoencoder;

    /**
     * Number of features
     */
    readonly numFeatures: number;
    withNumFeatures(numFeatures: number): Reconstruction.Algorithm.TimeseriesAutoencoder;

    /**
     * Random seed used during model training. Use the same number for reproducible training results.
     */
    readonly randomSeed?: number;
    withRandomSeed(randomSeed: number | null): Reconstruction.Algorithm.TimeseriesAutoencoder;
    ...
    withLearningRateOverride(learningRateOverride: number | null): Reconstruction.Algorithm.TimeseriesAutoencoder;
    ...
    withWindowSize(windowSize: number): Reconstruction.Algorithm.TimeseriesAutoencoder;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Reconstruction.Algorithm.TimeseriesAutoencoder<DO> | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Reconstruction.Algorithm.TimeseriesAutoencoder<DO> | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Reconstruction.Algorithm.TimeseriesAutoencoder<DO> | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Reconstruction.Algorithm.TimeseriesAutoencoder<DO> | null;
     ...
     */
    replaceType(old: Type, new_: Type): Reconstruction.Algorithm.TimeseriesAutoencoder<DO>;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Reconstruction.Algorithm.TimeseriesAutoencoder<DO>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Reconstruction.Algorithm.TimeseriesAutoencoder<DO>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Reconstruction.Algorithm.TimeseriesAutoencoder<DO>>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Reconstruction.Algorithm.TimeseriesAutoencoder<DO>>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Reconstruction.Algorithm.TimeseriesAutoencoder<DO>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Reconstruction.Algorithm.TimeseriesAutoencoder<DO>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Reconstruction.Algorithm.TimeseriesAutoencoder<DO>;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Reconstruction.Algorithm.TimeseriesAutoencoder<DO>;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Reconstruction.Algorithm.TimeseriesAutoencoder<DO>;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Reconstruction.Algorithm.TimeseriesAutoencoder<DO>;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Reconstruction.Algorithm.TimeseriesAutoencoder<DO>;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Reconstruction.Algorithm.TimeseriesAutoencoder<DO>;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Reconstruction.Algorithm.TimeseriesAutoencoder<DO>;
     ...
     * @see #removeField
     */
    withoutField(field: string): Reconstruction.Algorithm.TimeseriesAutoencoder<DO>;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Reconstruction.Algorithm.TimeseriesAutoencoder<DO>;
     ...
     */
    withoutFields(fields: Array_Type<string>): Reconstruction.Algorithm.TimeseriesAutoencoder<DO>;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Reconstruction.Algorithm.TimeseriesAutoencoder<DO>;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Reconstruction.Algorithm.TimeseriesAutoencoder<DO>;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Reconstruction.Algorithm.TimeseriesAutoencoder<DO>;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Reconstruction.Algorithm.TimeseriesAutoencoder<DO>;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Reconstruction.Algorithm.TimeseriesAutoencoder<DO>;
     ...
     * @see #removeField
     */
    unsetField(field: string): Reconstruction.Algorithm.TimeseriesAutoencoder<DO>;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Reconstruction.Algorithm.TimeseriesAutoencoder<DO>;
     ...
     * @see #unsetField
     */
    removeField(field: string): Reconstruction.Algorithm.TimeseriesAutoencoder<DO>;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Reconstruction.Algorithm.TimeseriesAutoencoder<DO>;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Reconstruction.Algorithm.TimeseriesAutoencoder<DO>;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Reconstruction.Algorithm.TimeseriesAutoencoder<DO>;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Reconstruction.Algorithm.TimeseriesAutoencoder<DO>;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Reconstruction.Algorithm.TimeseriesAutoencoder<DO>;

    mergeJson(json: any): Reconstruction.Algorithm.TimeseriesAutoencoder<DO>;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Reconstruction.Algorithm.TimeseriesAutoencoder<DO>;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Reconstruction.Algorithm.TimeseriesAutoencoder<DO>;
     ...
     */
    singletonArray(): Array_Type<Reconstruction.Algorithm.TimeseriesAutoencoder<DO>>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Reconstruction.Algorithm.TimeseriesAutoencoder<DO>> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Reconstruction.Algorithm.TimeseriesAutoencoder<DO>> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Reconstruction.Algorithm.TimeseriesAutoencoder<DO>>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Reconstruction.Algorithm.TimeseriesAutoencoder<DO>> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Reconstruction.Algorithm.TimeseriesAutoencoder<DO>> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Reconstruction.Algorithm.TimeseriesAutoencoder<DO>> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Reconstruction.Algorithm.TimeseriesAutoencoder<DO>>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Reconstruction.Algorithm.TimeseriesAutoencoder<DO>>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Reconstruction.Algorithm.TimeseriesAutoencoder<DO>;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Reconstruction.Algorithm.TimeseriesAutoencoder<DO>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Reconstruction.Algorithm.TimeseriesAutoencoder<DO>;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Reconstruction.Algorithm.TimeseriesAutoencoder<DO>;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Reconstruction.Algorithm.TimeseriesAutoencoder<DO>;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Reconstruction.Algorithm.TimeseriesAutoencoder<DO>;
     ...
     * @see #fromString
     */
    static make(s: string): Reconstruction.Algorithm.TimeseriesAutoencoder<DO> | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Reconstruction.Algorithm.TimeseriesAutoencoder<DO>;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Reconstruction.Algorithm.TimeseriesAutoencoder<DO>;
     ...
     */
    static cachedEmptyInst(): Reconstruction.Algorithm.TimeseriesAutoencoder<DO>;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Reconstruction.Algorithm.TimeseriesAutoencoder<DO>> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Reconstruction.Algorithm.TimeseriesAutoencoder<DO>;
     ...
     */
    remakeTemplate(): Reconstruction.Algorithm.TimeseriesAutoencoder<DO>;
     ...
     */
    withoutIdentity(): Reconstruction.Algorithm.TimeseriesAutoencoder<DO>;
     ...
     */
    trainSync(x: , y?: , spec?: MlOperationSpec): Reconstruction.Algorithm.TimeseriesAutoencoder<DO>;
     ...
     */
    static allCached(): Stream<Reconstruction.Algorithm.TimeseriesAutoencoder<DO>> | null;
     ...
     */
    static find(filter?: string): Stream<Reconstruction.Algorithm.TimeseriesAutoencoder<DO>> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<Reconstruction.Algorithm.TimeseriesAutoencoder<DO>> | null;

    /**
     * @return cached instance.
     */
    getCached(): Reconstruction.Algorithm.TimeseriesAutoencoder<DO> | null;

    /**
     * @return cached instance by the key.
     */
    static forCacheKey(key: string): Reconstruction.Algorithm.TimeseriesAutoencoder<DO> | null;
     ...
     */
    static produce(key: string): Reconstruction.Algorithm.TimeseriesAutoencoder<DO> | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, Reconstruction.Algorithm.TimeseriesAutoencoder<DO>> | null;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Reconstruction.Algorithm.TimeseriesAutoencoder<DO>>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Reconstruction.Algorithm.TimeseriesAutoencoder<DO>>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Reconstruction.Algorithm.TimeseriesAutoencoder<DO>> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Reconstruction.Algorithm.TimeseriesAutoencoder<DO>>> | null;
     ...
     */
    get(include?: string): Reconstruction.Algorithm.TimeseriesAutoencoder<DO> | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Reconstruction.Algorithm.TimeseriesAutoencoder<DO> | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Reconstruction.Algorithm.TimeseriesAutoencoder<DO>;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Reconstruction.Algorithm.TimeseriesAutoencoder<DO> | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Reconstruction.Algorithm.TimeseriesAutoencoder<DO>;
     ...
     * @see #toString
     */
    static fromString(s: string): Reconstruction.Algorithm.TimeseriesAutoencoder<DO> | null;
     ...
     */
    create(spec?: UpsertSpec): Reconstruction.Algorithm.TimeseriesAutoencoder<DO> | null;
     ...
     */
    static createBatch(objs: Array_Type<Reconstruction.Algorithm.TimeseriesAutoencoder<DO>>, spec?: UpsertSpec): ObjList<Reconstruction.Algorithm.TimeseriesAutoencoder<DO>> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Reconstruction.Algorithm.TimeseriesAutoencoder<DO>>, spec?: CreateBatchObjStreamSpec): ObjList<Reconstruction.Algorithm.TimeseriesAutoencoder<DO>> | null;
     ...
     */
    update(srcObj?: Reconstruction.Algorithm.TimeseriesAutoencoder<DO>, spec?: UpsertSpec): Reconstruction.Algorithm.TimeseriesAutoencoder<DO> | null;
     ...
     */
    upsert(srcObj?: Reconstruction.Algorithm.TimeseriesAutoencoder<DO>, spec?: UpsertSpec): Reconstruction.Algorithm.TimeseriesAutoencoder<DO> | null;
     ...
     */
    merge(spec?: MergeSpec): Reconstruction.Algorithm.TimeseriesAutoencoder<DO> | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Reconstruction.Algorithm.TimeseriesAutoencoder<DO> | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Reconstruction.Algorithm.TimeseriesAutoencoder<DO> | null;
     ...
     */
    static updateBatch(objs: Array_Type<Reconstruction.Algorithm.TimeseriesAutoencoder<DO>>, srcObjs?: Array_Type<Reconstruction.Algorithm.TimeseriesAutoencoder<DO>>, spec?: UpsertSpec): ObjList<Reconstruction.Algorithm.TimeseriesAutoencoder<DO>> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Reconstruction.Algorithm.TimeseriesAutoencoder<DO>> | null>, spec?: UpsertSpec): ObjList<Reconstruction.Algorithm.TimeseriesAutoencoder<DO>> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Reconstruction.Algorithm.TimeseriesAutoencoder<DO>>, srcObjs?: Array_Type<Reconstruction.Algorithm.TimeseriesAutoencoder<DO>>, spec?: UpsertSpec): ObjList<Reconstruction.Algorithm.TimeseriesAutoencoder<DO>> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Reconstruction.Algorithm.TimeseriesAutoencoder<DO>> | null>, spec?: UpsertSpec): ObjList<Reconstruction.Algorithm.TimeseriesAutoencoder<DO>> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Reconstruction.Algorithm.TimeseriesAutoencoder<DO>>, spec?: TouchSpec): ObjList<Reconstruction.Algorithm.TimeseriesAutoencoder<DO>> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Reconstruction.Algorithm.TimeseriesAutoencoder<DO>>, spec?: MergeSpec): ObjList<Reconstruction.Algorithm.TimeseriesAutoencoder<DO>> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Reconstruction.Algorithm.TimeseriesAutoencoder<DO>>, mergeInclude: string, spec?: MergeSpec): ObjList<Reconstruction.Algorithm.TimeseriesAutoencoder<DO>> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Reconstruction.Algorithm.TimeseriesAutoencoder<DO>> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Reconstruction.Algorithm.TimeseriesAutoencoder<DO>> | null;
     ...
     */
    static mergeAll(mergeObj: Reconstruction.Algorithm.TimeseriesAutoencoder<DO>, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Reconstruction.Algorithm.TimeseriesAutoencoder<DO>, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Reconstruction.Algorithm.TimeseriesAutoencoder<DO>>, spec?: UpsertSpec): ObjList<Reconstruction.Algorithm.TimeseriesAutoencoder<DO>> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Reconstruction.Algorithm.TimeseriesAutoencoder<DO>>, spec?: UpsertSpec): ObjList<Reconstruction.Algorithm.TimeseriesAutoencoder<DO>> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Reconstruction.Algorithm.TimeseriesAutoencoder<DO> | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Reconstruction.Algorithm.TimeseriesAutoencoder<DO>>): ObjList<Reconstruction.Algorithm.TimeseriesAutoencoder<DO>>;
     ...
     */
    static beforeUpdate(objs: Array_Type<Reconstruction.Algorithm.TimeseriesAutoencoder<DO>>): ObjList<Reconstruction.Algorithm.TimeseriesAutoencoder<DO>>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Reconstruction.Algorithm.TimeseriesAutoencoder<DO>>): ObjList<Reconstruction.Algorithm.TimeseriesAutoencoder<DO>>;
     ...
     */
    static afterCreate(objs: Array_Type<Reconstruction.Algorithm.TimeseriesAutoencoder<DO>>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Reconstruction.Algorithm.TimeseriesAutoencoder<DO>>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Reconstruction.Algorithm.TimeseriesAutoencoder<DO>>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Reconstruction.Algorithm.TimeseriesAutoencoder<DO>>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Reconstruction.Algorithm.TimeseriesAutoencoder<DO>>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Reconstruction.Algorithm.TimeseriesAutoencoder<DO> | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Reconstruction.Algorithm.TimeseriesAutoencoder<DO>>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Reconstruction.Algorithm.TimeseriesAutoencoder<DO>, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Reconstruction.Algorithm.TimeseriesAutoencoder<DO>>, callback?: λFunction<Reconstruction.Algorithm.TimeseriesAutoencoder<DO> | null, Reconstruction.Algorithm.TimeseriesAutoencoder<DO> | null>): ObjList<Reconstruction.Algorithm.TimeseriesAutoencoder<DO>>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Reconstruction.Algorithm.TimeseriesAutoencoder<DO>>, callback?: λFunction<Reconstruction.Algorithm.TimeseriesAutoencoder<DO> | null, Reconstruction.Algorithm.TimeseriesAutoencoder<DO> | null>): Array_Type<ObjError> | null;
     ...
     */
    publish(subPath?: string, contentType?: string): Reconstruction.Algorithm.TimeseriesAutoencoder<DO>;
     ...
     */
    static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<Reconstruction.Algorithm.TimeseriesAutoencoder<DO>> | null;
     ...
     */
    createSeedData(spec?: UpsertSpec): Reconstruction.Algorithm.TimeseriesAutoencoder<DO> | null;
     ...
     */
    static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<Reconstruction.Algorithm.TimeseriesAutoencoder<DO>> | null;
     ...
     */
    updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): Reconstruction.Algorithm.TimeseriesAutoencoder<DO> | null;
     ...
     */
    static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<Reconstruction.Algorithm.TimeseriesAutoencoder<DO>> | null;
     ...
     * @return updated obj instance, same as {@link Persistable#update} return value.
     */
    clearUserUpdates(spec?: MergeSpec): Reconstruction.Algorithm.TimeseriesAutoencoder<DO> | null;
     ...
     *         {@link Persistable#updateBatch}.
     */
    static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<Reconstruction.Algorithm.TimeseriesAutoencoder<DO>> | null;
    ...
    dependencies(): SeedDataDeps<Reconstruction.Algorithm.TimeseriesAutoencoder<DO>> | null;
     ...
     */
    static convert(model: any, spec?: MlConvertSpec): Reconstruction.Algorithm.TimeseriesAutoencoder<DO>;

    /**
     * Freezes an {@link MlPipe}
     * @return modified copy of this {@link MlPipe} that cannot be trained
     */
    freeze(): Reconstruction.Algorithm.TimeseriesAutoencoder<DO>;

    /**
     * Unfreezes an {@link MlPipe}
     * @return modified copy of this {@link MlPipe} that can be trained
     */
    unfreeze(): Reconstruction.Algorithm.TimeseriesAutoencoder<DO>;
     ...
     * be returned as-is.
     */
    byReference(): Reconstruction.Algorithm.TimeseriesAutoencoder<DO>;
     ...
     */
    updateModelFiles(modelFiles: Map_Type<string, Url>, spec?: MlOperationSpec): Reconstruction.Algorithm.TimeseriesAutoencoder<DO>;
     ...
     */
    afterTrain(doTrainOutputs: any, spec?: MlOperationSpec): Reconstruction.Algorithm.TimeseriesAutoencoder<DO>;
     ...
     */
    withNewSpec(spec?: MlConvertSpec): Reconstruction.Algorithm.TimeseriesAutoencoder<DO>;
     ...
     */
    afterConvert(model: any, spec?: MlConvertSpec): Reconstruction.Algorithm.TimeseriesAutoencoder<DO>;
     ...
     */
    withHyperparamSpaces(paramSpaces: Map_Type<string, Hp.ParamSpace>): Reconstruction.Algorithm.TimeseriesAutoencoder<DO>;
