// TypeScript definitions for the C3 type Reconstruction.Pre.NonzeroMaskingPipe
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of Reconstruction.Pre.NonzeroMaskingPipe
 */
declare namespace Reconstruction.Pre {
  export interface INonzeroMaskingPipe {
 ...
 */
declare namespace Reconstruction.Pre {
  export class NonzeroMaskingPipe extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): Reconstruction.Pre.NonzeroMaskingPipe;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Reconstruction.Pre.NonzeroMaskingPipe;

    /**
     * Name of this pipe.
     */
    readonly name?: string;
    withName(name: string | null): Reconstruction.Pre.NonzeroMaskingPipe;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Reconstruction.Pre.NonzeroMaskingPipe;
    ...
    withVersion(version: number | null): Reconstruction.Pre.NonzeroMaskingPipe;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Reconstruction.Pre.NonzeroMaskingPipe;
    ...
    withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): Reconstruction.Pre.NonzeroMaskingPipe;
    ...
    withHidden(hidden: boolean): Reconstruction.Pre.NonzeroMaskingPipe;
    ...
    withUserOwned(userOwned: boolean): Reconstruction.Pre.NonzeroMaskingPipe;
    ...
    withTypeIdent(typeIdent: string | null): Reconstruction.Pre.NonzeroMaskingPipe;

    /**
     * If true, then the pipe shall not be retrained
     */
    readonly frozen?: boolean;
    withFrozen(frozen: boolean): Reconstruction.Pre.NonzeroMaskingPipe;

    /**
     * True if training has succeeded and false otherwise.
     */
    readonly trained?: boolean;
    withTrained(trained: boolean): Reconstruction.Pre.NonzeroMaskingPipe;

    /**
     * Errors from training.
     */
    readonly trainingErrors?: string;
    withTrainingErrors(trainingErrors: string | null): Reconstruction.Pre.NonzeroMaskingPipe;

    /**
     * If true, the underlying model only accepts flattened input.
     */
    readonly flattenInput?: boolean;
    withFlattenInput(flattenInput: boolean): Reconstruction.Pre.NonzeroMaskingPipe;

    /**
     * The hyperparameters overridden of a native model or pipe.
     */
    readonly hyperparamOverrides?: Map_Type<string, any>;
    withHyperparamOverrides(hyperparamOverrides: Map_Type<string, any> | {[key: string]: any} | null): Reconstruction.Pre.NonzeroMaskingPipe;
    ...
    withHyperparamSearchSpace(hyperparamSearchSpace: IHp.SearchSpace | null): Reconstruction.Pre.NonzeroMaskingPipe;
    ...
    withHpoSpec(hpoSpec: IHpo.Spec | null): Reconstruction.Pre.NonzeroMaskingPipe;

    /**
     * {@link Hpo.Experiment} stores the result of hyperparameter optimization to find the best model/pipeline.
     */
    readonly hpoExperiment?: Hpo.Experiment;
    withHpoExperiment(hpoExperiment: IHpo.Experiment | null): Reconstruction.Pre.NonzeroMaskingPipe;

    /**
     * Reference to the experiment that produced this {@link MlPipe}. For example, this could be a {@link Hpo.ExperimentBase}.
     */
    readonly experiment?: any;
    withExperiment(experiment: any | null): Reconstruction.Pre.NonzeroMaskingPipe;
    ...
    withModelFiles(modelFiles: Map_Type<string, Url> | {[key: string]: IUrl} | null): Reconstruction.Pre.NonzeroMaskingPipe;
    ...
    withCustomModelCode(customModelCode: Map_Type<string, any> | {[key: string]: any} | null): Reconstruction.Pre.NonzeroMaskingPipe;

    /**
     * Name for the function on the native model to call to do {@link MlProcessable#process}.
     */
    readonly processFunc?: string;
    withProcessFunc(processFunc: string | null): Reconstruction.Pre.NonzeroMaskingPipe;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Reconstruction.Pre.NonzeroMaskingPipe | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Reconstruction.Pre.NonzeroMaskingPipe | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Reconstruction.Pre.NonzeroMaskingPipe | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Reconstruction.Pre.NonzeroMaskingPipe | null;
     ...
     */
    replaceType(old: Type, new_: Type): Reconstruction.Pre.NonzeroMaskingPipe;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Reconstruction.Pre.NonzeroMaskingPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Reconstruction.Pre.NonzeroMaskingPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Reconstruction.Pre.NonzeroMaskingPipe>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Reconstruction.Pre.NonzeroMaskingPipe>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Reconstruction.Pre.NonzeroMaskingPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Reconstruction.Pre.NonzeroMaskingPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Reconstruction.Pre.NonzeroMaskingPipe;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Reconstruction.Pre.NonzeroMaskingPipe;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Reconstruction.Pre.NonzeroMaskingPipe;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Reconstruction.Pre.NonzeroMaskingPipe;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Reconstruction.Pre.NonzeroMaskingPipe;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Reconstruction.Pre.NonzeroMaskingPipe;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Reconstruction.Pre.NonzeroMaskingPipe;
     ...
     * @see #removeField
     */
    withoutField(field: string): Reconstruction.Pre.NonzeroMaskingPipe;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Reconstruction.Pre.NonzeroMaskingPipe;
     ...
     */
    withoutFields(fields: Array_Type<string>): Reconstruction.Pre.NonzeroMaskingPipe;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Reconstruction.Pre.NonzeroMaskingPipe;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Reconstruction.Pre.NonzeroMaskingPipe;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Reconstruction.Pre.NonzeroMaskingPipe;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Reconstruction.Pre.NonzeroMaskingPipe;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Reconstruction.Pre.NonzeroMaskingPipe;
     ...
     * @see #removeField
     */
    unsetField(field: string): Reconstruction.Pre.NonzeroMaskingPipe;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Reconstruction.Pre.NonzeroMaskingPipe;
     ...
     * @see #unsetField
     */
    removeField(field: string): Reconstruction.Pre.NonzeroMaskingPipe;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Reconstruction.Pre.NonzeroMaskingPipe;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Reconstruction.Pre.NonzeroMaskingPipe;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Reconstruction.Pre.NonzeroMaskingPipe;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Reconstruction.Pre.NonzeroMaskingPipe;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Reconstruction.Pre.NonzeroMaskingPipe;

    mergeJson(json: any): Reconstruction.Pre.NonzeroMaskingPipe;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Reconstruction.Pre.NonzeroMaskingPipe;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Reconstruction.Pre.NonzeroMaskingPipe;
     ...
     */
    singletonArray(): Array_Type<Reconstruction.Pre.NonzeroMaskingPipe>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Reconstruction.Pre.NonzeroMaskingPipe> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Reconstruction.Pre.NonzeroMaskingPipe> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Reconstruction.Pre.NonzeroMaskingPipe>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Reconstruction.Pre.NonzeroMaskingPipe> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Reconstruction.Pre.NonzeroMaskingPipe> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Reconstruction.Pre.NonzeroMaskingPipe> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Reconstruction.Pre.NonzeroMaskingPipe>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Reconstruction.Pre.NonzeroMaskingPipe>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Reconstruction.Pre.NonzeroMaskingPipe;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Reconstruction.Pre.NonzeroMaskingPipe;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Reconstruction.Pre.NonzeroMaskingPipe;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Reconstruction.Pre.NonzeroMaskingPipe;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Reconstruction.Pre.NonzeroMaskingPipe;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Reconstruction.Pre.NonzeroMaskingPipe;
     ...
     * @see #fromString
     */
    static make(s: string): Reconstruction.Pre.NonzeroMaskingPipe | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Reconstruction.Pre.NonzeroMaskingPipe;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Reconstruction.Pre.NonzeroMaskingPipe;
     ...
     */
    static cachedEmptyInst(): Reconstruction.Pre.NonzeroMaskingPipe;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Reconstruction.Pre.NonzeroMaskingPipe> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Reconstruction.Pre.NonzeroMaskingPipe;
     ...
     */
    withoutIdentity(): Reconstruction.Pre.NonzeroMaskingPipe;
     ...
     */
    trainSync(x: , y?: , spec?: MlOperationSpec): Reconstruction.Pre.NonzeroMaskingPipe;
     ...
     */
    static allCached(): Stream<Reconstruction.Pre.NonzeroMaskingPipe> | null;
     ...
     */
    static find(filter?: string): Stream<Reconstruction.Pre.NonzeroMaskingPipe> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<Reconstruction.Pre.NonzeroMaskingPipe> | null;

    /**
     * @return cached instance.
     */
    getCached(): Reconstruction.Pre.NonzeroMaskingPipe | null;

    /**
     * @return cached instance by the key.
     */
    static forCacheKey(key: string): Reconstruction.Pre.NonzeroMaskingPipe | null;
     ...
     */
    static produce(key: string): Reconstruction.Pre.NonzeroMaskingPipe | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, Reconstruction.Pre.NonzeroMaskingPipe> | null;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Reconstruction.Pre.NonzeroMaskingPipe>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Reconstruction.Pre.NonzeroMaskingPipe>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Reconstruction.Pre.NonzeroMaskingPipe> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Reconstruction.Pre.NonzeroMaskingPipe>> | null;
     ...
     */
    get(include?: string): Reconstruction.Pre.NonzeroMaskingPipe | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Reconstruction.Pre.NonzeroMaskingPipe | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Reconstruction.Pre.NonzeroMaskingPipe;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Reconstruction.Pre.NonzeroMaskingPipe | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Reconstruction.Pre.NonzeroMaskingPipe;
     ...
     * @see #toString
     */
    static fromString(s: string): Reconstruction.Pre.NonzeroMaskingPipe | null;
     ...
     */
    create(spec?: UpsertSpec): Reconstruction.Pre.NonzeroMaskingPipe | null;
     ...
     */
    static createBatch(objs: Array_Type<Reconstruction.Pre.NonzeroMaskingPipe>, spec?: UpsertSpec): ObjList<Reconstruction.Pre.NonzeroMaskingPipe> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Reconstruction.Pre.NonzeroMaskingPipe>, spec?: CreateBatchObjStreamSpec): ObjList<Reconstruction.Pre.NonzeroMaskingPipe> | null;
     ...
     */
    update(srcObj?: Reconstruction.Pre.NonzeroMaskingPipe, spec?: UpsertSpec): Reconstruction.Pre.NonzeroMaskingPipe | null;
     ...
     */
    upsert(srcObj?: Reconstruction.Pre.NonzeroMaskingPipe, spec?: UpsertSpec): Reconstruction.Pre.NonzeroMaskingPipe | null;
     ...
     */
    merge(spec?: MergeSpec): Reconstruction.Pre.NonzeroMaskingPipe | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Reconstruction.Pre.NonzeroMaskingPipe | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Reconstruction.Pre.NonzeroMaskingPipe | null;
     ...
     */
    static updateBatch(objs: Array_Type<Reconstruction.Pre.NonzeroMaskingPipe>, srcObjs?: Array_Type<Reconstruction.Pre.NonzeroMaskingPipe>, spec?: UpsertSpec): ObjList<Reconstruction.Pre.NonzeroMaskingPipe> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Reconstruction.Pre.NonzeroMaskingPipe> | null>, spec?: UpsertSpec): ObjList<Reconstruction.Pre.NonzeroMaskingPipe> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Reconstruction.Pre.NonzeroMaskingPipe>, srcObjs?: Array_Type<Reconstruction.Pre.NonzeroMaskingPipe>, spec?: UpsertSpec): ObjList<Reconstruction.Pre.NonzeroMaskingPipe> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Reconstruction.Pre.NonzeroMaskingPipe> | null>, spec?: UpsertSpec): ObjList<Reconstruction.Pre.NonzeroMaskingPipe> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Reconstruction.Pre.NonzeroMaskingPipe>, spec?: TouchSpec): ObjList<Reconstruction.Pre.NonzeroMaskingPipe> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Reconstruction.Pre.NonzeroMaskingPipe>, spec?: MergeSpec): ObjList<Reconstruction.Pre.NonzeroMaskingPipe> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Reconstruction.Pre.NonzeroMaskingPipe>, mergeInclude: string, spec?: MergeSpec): ObjList<Reconstruction.Pre.NonzeroMaskingPipe> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Reconstruction.Pre.NonzeroMaskingPipe> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Reconstruction.Pre.NonzeroMaskingPipe> | null;
     ...
     */
    static mergeAll(mergeObj: Reconstruction.Pre.NonzeroMaskingPipe, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Reconstruction.Pre.NonzeroMaskingPipe, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Reconstruction.Pre.NonzeroMaskingPipe>, spec?: UpsertSpec): ObjList<Reconstruction.Pre.NonzeroMaskingPipe> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Reconstruction.Pre.NonzeroMaskingPipe>, spec?: UpsertSpec): ObjList<Reconstruction.Pre.NonzeroMaskingPipe> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Reconstruction.Pre.NonzeroMaskingPipe | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Reconstruction.Pre.NonzeroMaskingPipe>): ObjList<Reconstruction.Pre.NonzeroMaskingPipe>;
     ...
     */
    static beforeUpdate(objs: Array_Type<Reconstruction.Pre.NonzeroMaskingPipe>): ObjList<Reconstruction.Pre.NonzeroMaskingPipe>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Reconstruction.Pre.NonzeroMaskingPipe>): ObjList<Reconstruction.Pre.NonzeroMaskingPipe>;
     ...
     */
    static afterCreate(objs: Array_Type<Reconstruction.Pre.NonzeroMaskingPipe>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Reconstruction.Pre.NonzeroMaskingPipe>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Reconstruction.Pre.NonzeroMaskingPipe>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Reconstruction.Pre.NonzeroMaskingPipe>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Reconstruction.Pre.NonzeroMaskingPipe>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Reconstruction.Pre.NonzeroMaskingPipe | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Reconstruction.Pre.NonzeroMaskingPipe>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Reconstruction.Pre.NonzeroMaskingPipe, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Reconstruction.Pre.NonzeroMaskingPipe>, callback?: λFunction<Reconstruction.Pre.NonzeroMaskingPipe | null, Reconstruction.Pre.NonzeroMaskingPipe | null>): ObjList<Reconstruction.Pre.NonzeroMaskingPipe>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Reconstruction.Pre.NonzeroMaskingPipe>, callback?: λFunction<Reconstruction.Pre.NonzeroMaskingPipe | null, Reconstruction.Pre.NonzeroMaskingPipe | null>): Array_Type<ObjError> | null;
     ...
     */
    publish(subPath?: string, contentType?: string): Reconstruction.Pre.NonzeroMaskingPipe;
     ...
     */
    static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<Reconstruction.Pre.NonzeroMaskingPipe> | null;
     ...
     */
    createSeedData(spec?: UpsertSpec): Reconstruction.Pre.NonzeroMaskingPipe | null;
     ...
     */
    static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<Reconstruction.Pre.NonzeroMaskingPipe> | null;
     ...
     */
    updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): Reconstruction.Pre.NonzeroMaskingPipe | null;
     ...
     */
    static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<Reconstruction.Pre.NonzeroMaskingPipe> | null;
     ...
     * @return updated obj instance, same as {@link Persistable#update} return value.
     */
    clearUserUpdates(spec?: MergeSpec): Reconstruction.Pre.NonzeroMaskingPipe | null;
     ...
     *         {@link Persistable#updateBatch}.
     */
    static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<Reconstruction.Pre.NonzeroMaskingPipe> | null;
    ...
    dependencies(): SeedDataDeps<Reconstruction.Pre.NonzeroMaskingPipe> | null;
     ...
     */
    static convert(model: any, spec?: MlConvertSpec): Reconstruction.Pre.NonzeroMaskingPipe;

    /**
     * Freezes an {@link MlPipe}
     * @return modified copy of this {@link MlPipe} that cannot be trained
     */
    freeze(): Reconstruction.Pre.NonzeroMaskingPipe;

    /**
     * Unfreezes an {@link MlPipe}
     * @return modified copy of this {@link MlPipe} that can be trained
     */
    unfreeze(): Reconstruction.Pre.NonzeroMaskingPipe;
     ...
     * be returned as-is.
     */
    byReference(): Reconstruction.Pre.NonzeroMaskingPipe;
     ...
     */
    updateModelFiles(modelFiles: Map_Type<string, Url>, spec?: MlOperationSpec): Reconstruction.Pre.NonzeroMaskingPipe;
     ...
     */
    afterTrain(doTrainOutputs: any, spec?: MlOperationSpec): Reconstruction.Pre.NonzeroMaskingPipe;
     ...
     */
    withNewSpec(spec?: MlConvertSpec): Reconstruction.Pre.NonzeroMaskingPipe;
     ...
     */
    afterConvert(model: any, spec?: MlConvertSpec): Reconstruction.Pre.NonzeroMaskingPipe;
     ...
     */
    withHyperparamSpaces(paramSpaces: Map_Type<string, Hp.ParamSpace>): Reconstruction.Pre.NonzeroMaskingPipe;
