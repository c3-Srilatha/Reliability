// TypeScript definitions for the C3 type Reconstruction.Algorithm.Conv1dAutoencoderPipe
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of Reconstruction.Algorithm.Conv1dAutoencoderPipe
 */
declare namespace Reconstruction.Algorithm {
  export interface IConv1dAutoencoderPipe {
    ...
    /**
     * A window length specifying how many time stamps to reconstruct at a time. The {@link Data} input will be batched
     * into consecutive, single-stride windows of size {@link #windowSize}, and the number of windows to be fed into the
     * model at a time is defined by {@link #batchSize}.
     */
    windowSize: number;
 ...
 * projection of the original input in the autoencoder latent space.
 *
 * @remarks this represents a made instance of Reconstruction.Algorithm.Conv1dAutoencoderPipe
 */
declare namespace Reconstruction.Algorithm {
  export class Conv1dAutoencoderPipe extends Obj  {
    ...
    withLookbackDuration(lookbackDuration: IDuration | null): Reconstruction.Algorithm.Conv1dAutoencoderPipe;

    /**
     * An optional suffix that is added to the column names of the reconstruction {@link Data}.
     */
    readonly reconstructionSuffix?: string;
    withReconstructionSuffix(reconstructionSuffix: string | null): Reconstruction.Algorithm.Conv1dAutoencoderPipe;

    /**
     * An optional suffix that is added to the column names of the residual {@link Data}.
     */
    readonly residualSuffix?: string;
    withResidualSuffix(residualSuffix: string | null): Reconstruction.Algorithm.Conv1dAutoencoderPipe;
     ...
     */
    readonly id: string;
    withId(id: string): Reconstruction.Algorithm.Conv1dAutoencoderPipe;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Reconstruction.Algorithm.Conv1dAutoencoderPipe;

    /**
     * Name of this pipe.
     */
    readonly name?: string;
    withName(name: string | null): Reconstruction.Algorithm.Conv1dAutoencoderPipe;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Reconstruction.Algorithm.Conv1dAutoencoderPipe;
    ...
    withVersion(version: number | null): Reconstruction.Algorithm.Conv1dAutoencoderPipe;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Reconstruction.Algorithm.Conv1dAutoencoderPipe;
    ...
    withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): Reconstruction.Algorithm.Conv1dAutoencoderPipe;
    ...
    withHidden(hidden: boolean): Reconstruction.Algorithm.Conv1dAutoencoderPipe;
    ...
    withUserOwned(userOwned: boolean): Reconstruction.Algorithm.Conv1dAutoencoderPipe;
    ...
    withTypeIdent(typeIdent: string | null): Reconstruction.Algorithm.Conv1dAutoencoderPipe;

    /**
     * If true, then the pipe shall not be retrained
     */
    readonly frozen?: boolean;
    withFrozen(frozen: boolean): Reconstruction.Algorithm.Conv1dAutoencoderPipe;

    /**
     * True if training has succeeded and false otherwise.
     */
    readonly trained?: boolean;
    withTrained(trained: boolean): Reconstruction.Algorithm.Conv1dAutoencoderPipe;

    /**
     * Errors from training.
     */
    readonly trainingErrors?: string;
    withTrainingErrors(trainingErrors: string | null): Reconstruction.Algorithm.Conv1dAutoencoderPipe;

    /**
     * If true, the underlying model only accepts flattened input.
     */
    readonly flattenInput?: boolean;
    withFlattenInput(flattenInput: boolean): Reconstruction.Algorithm.Conv1dAutoencoderPipe;

    /**
     * The hyperparameters overridden of a native model or pipe.
     */
    readonly hyperparamOverrides?: Map_Type<string, any>;
    withHyperparamOverrides(hyperparamOverrides: Map_Type<string, any> | {[key: string]: any} | null): Reconstruction.Algorithm.Conv1dAutoencoderPipe;
    ...
    withHyperparamSearchSpace(hyperparamSearchSpace: IHp.SearchSpace | null): Reconstruction.Algorithm.Conv1dAutoencoderPipe;
    ...
    withHpoSpec(hpoSpec: IHpo.Spec | null): Reconstruction.Algorithm.Conv1dAutoencoderPipe;

    /**
     * {@link Hpo.Experiment} stores the result of hyperparameter optimization to find the best model/pipeline.
     */
    readonly hpoExperiment?: Hpo.Experiment;
    withHpoExperiment(hpoExperiment: IHpo.Experiment | null): Reconstruction.Algorithm.Conv1dAutoencoderPipe;

    /**
     * Reference to the experiment that produced this {@link MlPipe}. For example, this could be a {@link Hpo.ExperimentBase}.
     */
    readonly experiment?: any;
    withExperiment(experiment: any | null): Reconstruction.Algorithm.Conv1dAutoencoderPipe;
    ...
    withModelFiles(modelFiles: Map_Type<string, Url> | {[key: string]: IUrl} | null): Reconstruction.Algorithm.Conv1dAutoencoderPipe;
    ...
    withCustomModelCode(customModelCode: Map_Type<string, any> | {[key: string]: any} | null): Reconstruction.Algorithm.Conv1dAutoencoderPipe;

    /**
     * Name for the function on the native model to call to do {@link MlProcessable#process}.
     */
    readonly processFunc?: string;
    withProcessFunc(processFunc: string | null): Reconstruction.Algorithm.Conv1dAutoencoderPipe;
    ...
    withUnderlyingPipe(underlyingPipe: IMlAtomicPipe<any, any, any> | null): Reconstruction.Algorithm.Conv1dAutoencoderPipe;

    /**
     * Training epochs
     */
    readonly epochs: number;
    withEpochs(epochs: number): Reconstruction.Algorithm.Conv1dAutoencoderPipe;

    /**
     * Training batch size
     */
    readonly batchSize: number;
    withBatchSize(batchSize: number): Reconstruction.Algorithm.Conv1dAutoencoderPipe;

    /**
     * Number of features
     */
    readonly numFeatures: number;
    withNumFeatures(numFeatures: number): Reconstruction.Algorithm.Conv1dAutoencoderPipe;

    /**
     * Random seed used during model training. Use the same number for reproducible training results.
     */
    readonly randomSeed?: number;
    withRandomSeed(randomSeed: number | null): Reconstruction.Algorithm.Conv1dAutoencoderPipe;
    ...
    withLearningRateOverride(learningRateOverride: number | null): Reconstruction.Algorithm.Conv1dAutoencoderPipe;
    ...
    withWindowSize(windowSize: number): Reconstruction.Algorithm.Conv1dAutoencoderPipe;
    ...
    withDirectionalWeights(directionalWeights: Map_Type<string, Pair<number, number>> | {[key: string]: IPair<number, number>} | null): Reconstruction.Algorithm.Conv1dAutoencoderPipe;

    /**
     * Number of Conv layers in the encoder. Will also be used for number of Conv layers in the decoder.
     */
    readonly numEncoderConvolutionalLayers: number;
    withNumEncoderConvolutionalLayers(numEncoderConvolutionalLayers: number): Reconstruction.Algorithm.Conv1dAutoencoderPipe;

    /**
     * Dimension of the vector in the middle of the encoder, the output of "bottleneck" Dense layer
     */
    readonly latentDimension: number;
    withLatentDimension(latentDimension: number): Reconstruction.Algorithm.Conv1dAutoencoderPipe;
    ...
    withFilterScaleFactor(filterScaleFactor: number | null): Reconstruction.Algorithm.Conv1dAutoencoderPipe;

    /**
     * Size of the 1D convolution kernel sizes along the time axis.
     */
    readonly kernelSize: number;
    withKernelSize(kernelSize: number): Reconstruction.Algorithm.Conv1dAutoencoderPipe;

    /**
     * Number of Dense layers in the encoder. Will also be used for number of Conv layers in the decoder.
     */
    readonly numEncoderDenseLayers: number;
    withNumEncoderDenseLayers(numEncoderDenseLayers: number): Reconstruction.Algorithm.Conv1dAutoencoderPipe;

    /**
     * Activation function to use on all convolutional layers. (Middle Dense layers are both linear activation).
     */
    readonly activation?: string;
    withActivation(activation: string | null): Reconstruction.Algorithm.Conv1dAutoencoderPipe;

    /**
     * Whether and where to use a dropout layer. Ignored if unspecified.
     */
    readonly useDropout?: string;
    withUseDropout(useDropout: string | null): Reconstruction.Algorithm.Conv1dAutoencoderPipe;

    /**
     * Dropout layer's drop probability that must be between `0` and `1`, exclusive.
     */
    readonly dropoutProbability?: number;
    withDropoutProbability(dropoutProbability: number | null): Reconstruction.Algorithm.Conv1dAutoencoderPipe;

    /**
     * Whether and where to use a batch normalization layer. Ignored if unspecified.
     */
    readonly useBatchNormalization?: string;
    withUseBatchNormalization(useBatchNormalization: string | null): Reconstruction.Algorithm.Conv1dAutoencoderPipe;

    /**
     * Whether and where to use a kernel regularizer. Does not use if `null`.
     */
    readonly useKernelRegularizers?: string;
    withUseKernelRegularizers(useKernelRegularizers: string | null): Reconstruction.Algorithm.Conv1dAutoencoderPipe;

    /**
     * Kernel regularizer type as specified in `tensorflow.keras.regularizers`. Ignored if {@link #useKernelRegularizers} is unspecified.
     */
    readonly kernelRegularizationType?: string;
    withKernelRegularizationType(kernelRegularizationType: string | null): Reconstruction.Algorithm.Conv1dAutoencoderPipe;

    /**
     * Kernel regularization constant to use. Ignored if {@link #useKernelRegularizers} is unspecified.
     */
    readonly kernelRegularizationConstant?: number;
    withKernelRegularizationConstant(kernelRegularizationConstant: number | null): Reconstruction.Algorithm.Conv1dAutoencoderPipe;

    /**
     * Reconstruction loss to be used by the autoencoder.
     */
    readonly reconstructionLoss: string;
    withReconstructionLoss(reconstructionLoss: string): Reconstruction.Algorithm.Conv1dAutoencoderPipe;

    /**
     * Specifies the keras library optimizer.
     */
    readonly optimizerClassName?: string;
    withOptimizerClassName(optimizerClassName: string | null): Reconstruction.Algorithm.Conv1dAutoencoderPipe;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Reconstruction.Algorithm.Conv1dAutoencoderPipe | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Reconstruction.Algorithm.Conv1dAutoencoderPipe | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Reconstruction.Algorithm.Conv1dAutoencoderPipe | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Reconstruction.Algorithm.Conv1dAutoencoderPipe | null;
     ...
     */
    replaceType(old: Type, new_: Type): Reconstruction.Algorithm.Conv1dAutoencoderPipe;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Reconstruction.Algorithm.Conv1dAutoencoderPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Reconstruction.Algorithm.Conv1dAutoencoderPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Reconstruction.Algorithm.Conv1dAutoencoderPipe>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Reconstruction.Algorithm.Conv1dAutoencoderPipe>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Reconstruction.Algorithm.Conv1dAutoencoderPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Reconstruction.Algorithm.Conv1dAutoencoderPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Reconstruction.Algorithm.Conv1dAutoencoderPipe;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Reconstruction.Algorithm.Conv1dAutoencoderPipe;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Reconstruction.Algorithm.Conv1dAutoencoderPipe;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Reconstruction.Algorithm.Conv1dAutoencoderPipe;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Reconstruction.Algorithm.Conv1dAutoencoderPipe;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Reconstruction.Algorithm.Conv1dAutoencoderPipe;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Reconstruction.Algorithm.Conv1dAutoencoderPipe;
     ...
     * @see #removeField
     */
    withoutField(field: string): Reconstruction.Algorithm.Conv1dAutoencoderPipe;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Reconstruction.Algorithm.Conv1dAutoencoderPipe;
     ...
     */
    withoutFields(fields: Array_Type<string>): Reconstruction.Algorithm.Conv1dAutoencoderPipe;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Reconstruction.Algorithm.Conv1dAutoencoderPipe;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Reconstruction.Algorithm.Conv1dAutoencoderPipe;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Reconstruction.Algorithm.Conv1dAutoencoderPipe;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Reconstruction.Algorithm.Conv1dAutoencoderPipe;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Reconstruction.Algorithm.Conv1dAutoencoderPipe;
     ...
     * @see #removeField
     */
    unsetField(field: string): Reconstruction.Algorithm.Conv1dAutoencoderPipe;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Reconstruction.Algorithm.Conv1dAutoencoderPipe;
     ...
     * @see #unsetField
     */
    removeField(field: string): Reconstruction.Algorithm.Conv1dAutoencoderPipe;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Reconstruction.Algorithm.Conv1dAutoencoderPipe;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Reconstruction.Algorithm.Conv1dAutoencoderPipe;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Reconstruction.Algorithm.Conv1dAutoencoderPipe;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Reconstruction.Algorithm.Conv1dAutoencoderPipe;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Reconstruction.Algorithm.Conv1dAutoencoderPipe;

    mergeJson(json: any): Reconstruction.Algorithm.Conv1dAutoencoderPipe;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Reconstruction.Algorithm.Conv1dAutoencoderPipe;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Reconstruction.Algorithm.Conv1dAutoencoderPipe;
     ...
     */
    singletonArray(): Array_Type<Reconstruction.Algorithm.Conv1dAutoencoderPipe>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Reconstruction.Algorithm.Conv1dAutoencoderPipe> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Reconstruction.Algorithm.Conv1dAutoencoderPipe> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Reconstruction.Algorithm.Conv1dAutoencoderPipe>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Reconstruction.Algorithm.Conv1dAutoencoderPipe> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Reconstruction.Algorithm.Conv1dAutoencoderPipe> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Reconstruction.Algorithm.Conv1dAutoencoderPipe> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Reconstruction.Algorithm.Conv1dAutoencoderPipe>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Reconstruction.Algorithm.Conv1dAutoencoderPipe>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Reconstruction.Algorithm.Conv1dAutoencoderPipe;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Reconstruction.Algorithm.Conv1dAutoencoderPipe;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Reconstruction.Algorithm.Conv1dAutoencoderPipe;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Reconstruction.Algorithm.Conv1dAutoencoderPipe;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Reconstruction.Algorithm.Conv1dAutoencoderPipe;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Reconstruction.Algorithm.Conv1dAutoencoderPipe;
     ...
     * @see #fromString
     */
    static make(s: string): Reconstruction.Algorithm.Conv1dAutoencoderPipe | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Reconstruction.Algorithm.Conv1dAutoencoderPipe;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Reconstruction.Algorithm.Conv1dAutoencoderPipe;
     ...
     */
    static cachedEmptyInst(): Reconstruction.Algorithm.Conv1dAutoencoderPipe;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Reconstruction.Algorithm.Conv1dAutoencoderPipe> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Reconstruction.Algorithm.Conv1dAutoencoderPipe;
     ...
     */
    remakeTemplate(): Reconstruction.Algorithm.Conv1dAutoencoderPipe;
     ...
     */
    withoutIdentity(): Reconstruction.Algorithm.Conv1dAutoencoderPipe;
     ...
     */
    trainSync(x: , y?: , spec?: MlOperationSpec): Reconstruction.Algorithm.Conv1dAutoencoderPipe;
     ...
     */
    static allCached(): Stream<Reconstruction.Algorithm.Conv1dAutoencoderPipe> | null;
     ...
     */
    static find(filter?: string): Stream<Reconstruction.Algorithm.Conv1dAutoencoderPipe> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<Reconstruction.Algorithm.Conv1dAutoencoderPipe> | null;

    /**
     * @return cached instance.
     */
    getCached(): Reconstruction.Algorithm.Conv1dAutoencoderPipe | null;

    /**
     * @return cached instance by the key.
     */
    static forCacheKey(key: string): Reconstruction.Algorithm.Conv1dAutoencoderPipe | null;
     ...
     */
    static produce(key: string): Reconstruction.Algorithm.Conv1dAutoencoderPipe | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, Reconstruction.Algorithm.Conv1dAutoencoderPipe> | null;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Reconstruction.Algorithm.Conv1dAutoencoderPipe>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Reconstruction.Algorithm.Conv1dAutoencoderPipe>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Reconstruction.Algorithm.Conv1dAutoencoderPipe> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Reconstruction.Algorithm.Conv1dAutoencoderPipe>> | null;
     ...
     */
    get(include?: string): Reconstruction.Algorithm.Conv1dAutoencoderPipe | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Reconstruction.Algorithm.Conv1dAutoencoderPipe | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Reconstruction.Algorithm.Conv1dAutoencoderPipe;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Reconstruction.Algorithm.Conv1dAutoencoderPipe | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Reconstruction.Algorithm.Conv1dAutoencoderPipe;
     ...
     * @see #toString
     */
    static fromString(s: string): Reconstruction.Algorithm.Conv1dAutoencoderPipe | null;
     ...
     */
    create(spec?: UpsertSpec): Reconstruction.Algorithm.Conv1dAutoencoderPipe | null;
     ...
     */
    static createBatch(objs: Array_Type<Reconstruction.Algorithm.Conv1dAutoencoderPipe>, spec?: UpsertSpec): ObjList<Reconstruction.Algorithm.Conv1dAutoencoderPipe> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Reconstruction.Algorithm.Conv1dAutoencoderPipe>, spec?: CreateBatchObjStreamSpec): ObjList<Reconstruction.Algorithm.Conv1dAutoencoderPipe> | null;
     ...
     */
    update(srcObj?: Reconstruction.Algorithm.Conv1dAutoencoderPipe, spec?: UpsertSpec): Reconstruction.Algorithm.Conv1dAutoencoderPipe | null;
     ...
     */
    upsert(srcObj?: Reconstruction.Algorithm.Conv1dAutoencoderPipe, spec?: UpsertSpec): Reconstruction.Algorithm.Conv1dAutoencoderPipe | null;
     ...
     */
    merge(spec?: MergeSpec): Reconstruction.Algorithm.Conv1dAutoencoderPipe | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Reconstruction.Algorithm.Conv1dAutoencoderPipe | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Reconstruction.Algorithm.Conv1dAutoencoderPipe | null;
     ...
     */
    static updateBatch(objs: Array_Type<Reconstruction.Algorithm.Conv1dAutoencoderPipe>, srcObjs?: Array_Type<Reconstruction.Algorithm.Conv1dAutoencoderPipe>, spec?: UpsertSpec): ObjList<Reconstruction.Algorithm.Conv1dAutoencoderPipe> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Reconstruction.Algorithm.Conv1dAutoencoderPipe> | null>, spec?: UpsertSpec): ObjList<Reconstruction.Algorithm.Conv1dAutoencoderPipe> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Reconstruction.Algorithm.Conv1dAutoencoderPipe>, srcObjs?: Array_Type<Reconstruction.Algorithm.Conv1dAutoencoderPipe>, spec?: UpsertSpec): ObjList<Reconstruction.Algorithm.Conv1dAutoencoderPipe> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Reconstruction.Algorithm.Conv1dAutoencoderPipe> | null>, spec?: UpsertSpec): ObjList<Reconstruction.Algorithm.Conv1dAutoencoderPipe> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Reconstruction.Algorithm.Conv1dAutoencoderPipe>, spec?: TouchSpec): ObjList<Reconstruction.Algorithm.Conv1dAutoencoderPipe> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Reconstruction.Algorithm.Conv1dAutoencoderPipe>, spec?: MergeSpec): ObjList<Reconstruction.Algorithm.Conv1dAutoencoderPipe> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Reconstruction.Algorithm.Conv1dAutoencoderPipe>, mergeInclude: string, spec?: MergeSpec): ObjList<Reconstruction.Algorithm.Conv1dAutoencoderPipe> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Reconstruction.Algorithm.Conv1dAutoencoderPipe> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Reconstruction.Algorithm.Conv1dAutoencoderPipe> | null;
     ...
     */
    static mergeAll(mergeObj: Reconstruction.Algorithm.Conv1dAutoencoderPipe, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Reconstruction.Algorithm.Conv1dAutoencoderPipe, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Reconstruction.Algorithm.Conv1dAutoencoderPipe>, spec?: UpsertSpec): ObjList<Reconstruction.Algorithm.Conv1dAutoencoderPipe> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Reconstruction.Algorithm.Conv1dAutoencoderPipe>, spec?: UpsertSpec): ObjList<Reconstruction.Algorithm.Conv1dAutoencoderPipe> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Reconstruction.Algorithm.Conv1dAutoencoderPipe | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Reconstruction.Algorithm.Conv1dAutoencoderPipe>): ObjList<Reconstruction.Algorithm.Conv1dAutoencoderPipe>;
     ...
     */
    static beforeUpdate(objs: Array_Type<Reconstruction.Algorithm.Conv1dAutoencoderPipe>): ObjList<Reconstruction.Algorithm.Conv1dAutoencoderPipe>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Reconstruction.Algorithm.Conv1dAutoencoderPipe>): ObjList<Reconstruction.Algorithm.Conv1dAutoencoderPipe>;
     ...
     */
    static afterCreate(objs: Array_Type<Reconstruction.Algorithm.Conv1dAutoencoderPipe>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Reconstruction.Algorithm.Conv1dAutoencoderPipe>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Reconstruction.Algorithm.Conv1dAutoencoderPipe>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Reconstruction.Algorithm.Conv1dAutoencoderPipe>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Reconstruction.Algorithm.Conv1dAutoencoderPipe>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Reconstruction.Algorithm.Conv1dAutoencoderPipe | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Reconstruction.Algorithm.Conv1dAutoencoderPipe>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Reconstruction.Algorithm.Conv1dAutoencoderPipe, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Reconstruction.Algorithm.Conv1dAutoencoderPipe>, callback?: λFunction<Reconstruction.Algorithm.Conv1dAutoencoderPipe | null, Reconstruction.Algorithm.Conv1dAutoencoderPipe | null>): ObjList<Reconstruction.Algorithm.Conv1dAutoencoderPipe>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Reconstruction.Algorithm.Conv1dAutoencoderPipe>, callback?: λFunction<Reconstruction.Algorithm.Conv1dAutoencoderPipe | null, Reconstruction.Algorithm.Conv1dAutoencoderPipe | null>): Array_Type<ObjError> | null;
     ...
     */
    publish(subPath?: string, contentType?: string): Reconstruction.Algorithm.Conv1dAutoencoderPipe;
     ...
     */
    static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<Reconstruction.Algorithm.Conv1dAutoencoderPipe> | null;
     ...
     */
    createSeedData(spec?: UpsertSpec): Reconstruction.Algorithm.Conv1dAutoencoderPipe | null;
     ...
     */
    static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<Reconstruction.Algorithm.Conv1dAutoencoderPipe> | null;
     ...
     */
    updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): Reconstruction.Algorithm.Conv1dAutoencoderPipe | null;
     ...
     */
    static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<Reconstruction.Algorithm.Conv1dAutoencoderPipe> | null;
     ...
     * @return updated obj instance, same as {@link Persistable#update} return value.
     */
    clearUserUpdates(spec?: MergeSpec): Reconstruction.Algorithm.Conv1dAutoencoderPipe | null;
     ...
     *         {@link Persistable#updateBatch}.
     */
    static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<Reconstruction.Algorithm.Conv1dAutoencoderPipe> | null;
    ...
    dependencies(): SeedDataDeps<Reconstruction.Algorithm.Conv1dAutoencoderPipe> | null;
     ...
     */
    static convert(model: any, spec?: MlConvertSpec): Reconstruction.Algorithm.Conv1dAutoencoderPipe;

    /**
     * Freezes an {@link MlPipe}
     * @return modified copy of this {@link MlPipe} that cannot be trained
     */
    freeze(): Reconstruction.Algorithm.Conv1dAutoencoderPipe;

    /**
     * Unfreezes an {@link MlPipe}
     * @return modified copy of this {@link MlPipe} that can be trained
     */
    unfreeze(): Reconstruction.Algorithm.Conv1dAutoencoderPipe;
     ...
     * be returned as-is.
     */
    byReference(): Reconstruction.Algorithm.Conv1dAutoencoderPipe;
     ...
     */
    updateModelFiles(modelFiles: Map_Type<string, Url>, spec?: MlOperationSpec): Reconstruction.Algorithm.Conv1dAutoencoderPipe;
     ...
     */
    afterTrain(doTrainOutputs: any, spec?: MlOperationSpec): Reconstruction.Algorithm.Conv1dAutoencoderPipe;
     ...
     */
    withNewSpec(spec?: MlConvertSpec): Reconstruction.Algorithm.Conv1dAutoencoderPipe;
     ...
     */
    afterConvert(model: any, spec?: MlConvertSpec): Reconstruction.Algorithm.Conv1dAutoencoderPipe;
     ...
     */
    withHyperparamSpaces(paramSpaces: Map_Type<string, Hp.ParamSpace>): Reconstruction.Algorithm.Conv1dAutoencoderPipe;
     ...
     */
    generateAndAbsorbPipe(force?: boolean): MlTemplate.AtomicPipe<any, any, any>;
