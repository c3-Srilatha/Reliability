// TypeScript definitions for the C3 type Reconstruction.ScoreAggregationPipe

/**
 * This type represents a process-only pipe that aggregates scores from an {@link MlScoringMetric} based on the
 * specified aggregation function.
 *
 * @remarks this represents a value passed to a method that expects an instance of Reconstruction.ScoreAggregationPipe
 */
declare namespace Reconstruction {
  export interface IScoreAggregationPipe<DX> {
    ...
    /**
     * The list of input score names. This is required in order to properly build an {@link MlPipeline} using this
     * pipe.
     */
    scoreNames: Array_Type<string> | Array<string>;

    /**
     * The aggregation function to use to aggregate the scores.
     */
    aggFunc?: string;
  }
}
 ...
 * specified aggregation function.
 *
 * @remarks this represents a made instance of Reconstruction.ScoreAggregationPipe
 */
declare namespace Reconstruction {
  export class ScoreAggregationPipe<DX> extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): Reconstruction.ScoreAggregationPipe;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Reconstruction.ScoreAggregationPipe;

    /**
     * Name of this pipe.
     */
    readonly name?: string;
    withName(name: string | null): Reconstruction.ScoreAggregationPipe;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Reconstruction.ScoreAggregationPipe;
    ...
    withVersion(version: number | null): Reconstruction.ScoreAggregationPipe;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Reconstruction.ScoreAggregationPipe;
    ...
    withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): Reconstruction.ScoreAggregationPipe;
    ...
    withHidden(hidden: boolean): Reconstruction.ScoreAggregationPipe;
    ...
    withUserOwned(userOwned: boolean): Reconstruction.ScoreAggregationPipe;
    ...
    withTypeIdent(typeIdent: string | null): Reconstruction.ScoreAggregationPipe;

    /**
     * If true, then the pipe shall not be retrained
     */
    readonly frozen?: boolean;
    withFrozen(frozen: boolean): Reconstruction.ScoreAggregationPipe;

    /**
     * True if training has succeeded and false otherwise.
     */
    readonly trained?: boolean;
    withTrained(trained: boolean): Reconstruction.ScoreAggregationPipe;

    /**
     * Errors from training.
     */
    readonly trainingErrors?: string;
    withTrainingErrors(trainingErrors: string | null): Reconstruction.ScoreAggregationPipe;

    /**
     * If true, the underlying model only accepts flattened input.
     */
    readonly flattenInput?: boolean;
    withFlattenInput(flattenInput: boolean): Reconstruction.ScoreAggregationPipe;

    /**
     * The hyperparameters overridden of a native model or pipe.
     */
    readonly hyperparamOverrides?: Map_Type<string, any>;
    withHyperparamOverrides(hyperparamOverrides: Map_Type<string, any> | {[key: string]: any} | null): Reconstruction.ScoreAggregationPipe;
    ...
    withHyperparamSearchSpace(hyperparamSearchSpace: IHp.SearchSpace | null): Reconstruction.ScoreAggregationPipe;
    ...
    withHpoSpec(hpoSpec: IHpo.Spec | null): Reconstruction.ScoreAggregationPipe;

    /**
     * {@link Hpo.Experiment} stores the result of hyperparameter optimization to find the best model/pipeline.
     */
    readonly hpoExperiment?: Hpo.Experiment;
    withHpoExperiment(hpoExperiment: IHpo.Experiment | null): Reconstruction.ScoreAggregationPipe;

    /**
     * Reference to the experiment that produced this {@link MlPipe}. For example, this could be a {@link Hpo.ExperimentBase}.
     */
    readonly experiment?: any;
    withExperiment(experiment: any | null): Reconstruction.ScoreAggregationPipe;
    ...
    withModelFiles(modelFiles: Map_Type<string, Url> | {[key: string]: IUrl} | null): Reconstruction.ScoreAggregationPipe;
    ...
    withCustomModelCode(customModelCode: Map_Type<string, any> | {[key: string]: any} | null): Reconstruction.ScoreAggregationPipe;

    /**
     * Name for the function on the native model to call to do {@link MlProcessable#process}.
     */
    readonly processFunc?: string;
    withProcessFunc(processFunc: string | null): Reconstruction.ScoreAggregationPipe;
    ...
    withUnderlyingPipe(underlyingPipe: IMlAtomicPipe<any, any, any> | null): Reconstruction.ScoreAggregationPipe;

    /**
     * The list of input score names. This is required in order to properly build an {@link MlPipeline} using this
     * pipe.
     */
    readonly scoreNames: Array_Type<string>;
    withScoreNames(scoreNames: Array_Type<string> | Array<string>): Reconstruction.ScoreAggregationPipe;

    /**
     * The aggregation function to use to aggregate the scores.
     */
    readonly aggFunc?: string;
    withAggFunc(aggFunc: string | null): Reconstruction.ScoreAggregationPipe;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Reconstruction.ScoreAggregationPipe<DX> | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Reconstruction.ScoreAggregationPipe<DX> | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Reconstruction.ScoreAggregationPipe<DX> | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Reconstruction.ScoreAggregationPipe<DX> | null;
     ...
     */
    replaceType(old: Type, new_: Type): Reconstruction.ScoreAggregationPipe<DX>;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Reconstruction.ScoreAggregationPipe<DX>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Reconstruction.ScoreAggregationPipe<DX>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Reconstruction.ScoreAggregationPipe<DX>>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Reconstruction.ScoreAggregationPipe<DX>>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Reconstruction.ScoreAggregationPipe<DX>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Reconstruction.ScoreAggregationPipe<DX>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Reconstruction.ScoreAggregationPipe<DX>;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Reconstruction.ScoreAggregationPipe<DX>;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Reconstruction.ScoreAggregationPipe<DX>;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Reconstruction.ScoreAggregationPipe<DX>;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Reconstruction.ScoreAggregationPipe<DX>;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Reconstruction.ScoreAggregationPipe<DX>;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Reconstruction.ScoreAggregationPipe<DX>;
     ...
     * @see #removeField
     */
    withoutField(field: string): Reconstruction.ScoreAggregationPipe<DX>;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Reconstruction.ScoreAggregationPipe<DX>;
     ...
     */
    withoutFields(fields: Array_Type<string>): Reconstruction.ScoreAggregationPipe<DX>;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Reconstruction.ScoreAggregationPipe<DX>;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Reconstruction.ScoreAggregationPipe<DX>;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Reconstruction.ScoreAggregationPipe<DX>;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Reconstruction.ScoreAggregationPipe<DX>;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Reconstruction.ScoreAggregationPipe<DX>;
     ...
     * @see #removeField
     */
    unsetField(field: string): Reconstruction.ScoreAggregationPipe<DX>;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Reconstruction.ScoreAggregationPipe<DX>;
     ...
     * @see #unsetField
     */
    removeField(field: string): Reconstruction.ScoreAggregationPipe<DX>;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Reconstruction.ScoreAggregationPipe<DX>;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Reconstruction.ScoreAggregationPipe<DX>;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Reconstruction.ScoreAggregationPipe<DX>;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Reconstruction.ScoreAggregationPipe<DX>;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Reconstruction.ScoreAggregationPipe<DX>;

    mergeJson(json: any): Reconstruction.ScoreAggregationPipe<DX>;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Reconstruction.ScoreAggregationPipe<DX>;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Reconstruction.ScoreAggregationPipe<DX>;
     ...
     */
    singletonArray(): Array_Type<Reconstruction.ScoreAggregationPipe<DX>>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Reconstruction.ScoreAggregationPipe<DX>> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Reconstruction.ScoreAggregationPipe<DX>> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Reconstruction.ScoreAggregationPipe<DX>>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Reconstruction.ScoreAggregationPipe<DX>> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Reconstruction.ScoreAggregationPipe<DX>> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Reconstruction.ScoreAggregationPipe<DX>> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Reconstruction.ScoreAggregationPipe<DX>>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Reconstruction.ScoreAggregationPipe<DX>>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Reconstruction.ScoreAggregationPipe<DX>;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Reconstruction.ScoreAggregationPipe<DX>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Reconstruction.ScoreAggregationPipe<DX>;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Reconstruction.ScoreAggregationPipe<DX>;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Reconstruction.ScoreAggregationPipe<DX>;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Reconstruction.ScoreAggregationPipe<DX>;
     ...
     * @see #fromString
     */
    static make(s: string): Reconstruction.ScoreAggregationPipe<DX> | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Reconstruction.ScoreAggregationPipe<DX>;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Reconstruction.ScoreAggregationPipe<DX>;
     ...
     */
    static cachedEmptyInst(): Reconstruction.ScoreAggregationPipe<DX>;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Reconstruction.ScoreAggregationPipe<DX>> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Reconstruction.ScoreAggregationPipe<DX>;
     ...
     */
    remakeTemplate(): Reconstruction.ScoreAggregationPipe<DX>;
     ...
     */
    withoutIdentity(): Reconstruction.ScoreAggregationPipe<DX>;
     ...
     */
    trainSync(x: DX, y?: , spec?: MlOperationSpec): Reconstruction.ScoreAggregationPipe<DX>;
     ...
     *           the operation run object to query status and to get the final result.
     */
    process(x: DX, spec?: MlOperationSpec): MlOperationRun<number> | null;
     ...
     */
    processSync(x: DX, spec?: MlOperationSpec): number | null;
     ...
     */
    static allCached(): Stream<Reconstruction.ScoreAggregationPipe<DX>> | null;
     ...
     */
    static find(filter?: string): Stream<Reconstruction.ScoreAggregationPipe<DX>> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<Reconstruction.ScoreAggregationPipe<DX>> | null;

    /**
     * @return cached instance.
     */
    getCached(): Reconstruction.ScoreAggregationPipe<DX> | null;

    /**
     * @return cached instance by the key.
     */
    static forCacheKey(key: string): Reconstruction.ScoreAggregationPipe<DX> | null;
     ...
     */
    static produce(key: string): Reconstruction.ScoreAggregationPipe<DX> | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, Reconstruction.ScoreAggregationPipe<DX>> | null;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Reconstruction.ScoreAggregationPipe<DX>>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Reconstruction.ScoreAggregationPipe<DX>>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Reconstruction.ScoreAggregationPipe<DX>> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Reconstruction.ScoreAggregationPipe<DX>>> | null;
     ...
     */
    get(include?: string): Reconstruction.ScoreAggregationPipe<DX> | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Reconstruction.ScoreAggregationPipe<DX> | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Reconstruction.ScoreAggregationPipe<DX>;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Reconstruction.ScoreAggregationPipe<DX> | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Reconstruction.ScoreAggregationPipe<DX>;
     ...
     * @see #toString
     */
    static fromString(s: string): Reconstruction.ScoreAggregationPipe<DX> | null;
     ...
     */
    create(spec?: UpsertSpec): Reconstruction.ScoreAggregationPipe<DX> | null;
     ...
     */
    static createBatch(objs: Array_Type<Reconstruction.ScoreAggregationPipe<DX>>, spec?: UpsertSpec): ObjList<Reconstruction.ScoreAggregationPipe<DX>> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Reconstruction.ScoreAggregationPipe<DX>>, spec?: CreateBatchObjStreamSpec): ObjList<Reconstruction.ScoreAggregationPipe<DX>> | null;
     ...
     */
    update(srcObj?: Reconstruction.ScoreAggregationPipe<DX>, spec?: UpsertSpec): Reconstruction.ScoreAggregationPipe<DX> | null;
     ...
     */
    upsert(srcObj?: Reconstruction.ScoreAggregationPipe<DX>, spec?: UpsertSpec): Reconstruction.ScoreAggregationPipe<DX> | null;
     ...
     */
    merge(spec?: MergeSpec): Reconstruction.ScoreAggregationPipe<DX> | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Reconstruction.ScoreAggregationPipe<DX> | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Reconstruction.ScoreAggregationPipe<DX> | null;
     ...
     */
    static updateBatch(objs: Array_Type<Reconstruction.ScoreAggregationPipe<DX>>, srcObjs?: Array_Type<Reconstruction.ScoreAggregationPipe<DX>>, spec?: UpsertSpec): ObjList<Reconstruction.ScoreAggregationPipe<DX>> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Reconstruction.ScoreAggregationPipe<DX>> | null>, spec?: UpsertSpec): ObjList<Reconstruction.ScoreAggregationPipe<DX>> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Reconstruction.ScoreAggregationPipe<DX>>, srcObjs?: Array_Type<Reconstruction.ScoreAggregationPipe<DX>>, spec?: UpsertSpec): ObjList<Reconstruction.ScoreAggregationPipe<DX>> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Reconstruction.ScoreAggregationPipe<DX>> | null>, spec?: UpsertSpec): ObjList<Reconstruction.ScoreAggregationPipe<DX>> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Reconstruction.ScoreAggregationPipe<DX>>, spec?: TouchSpec): ObjList<Reconstruction.ScoreAggregationPipe<DX>> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Reconstruction.ScoreAggregationPipe<DX>>, spec?: MergeSpec): ObjList<Reconstruction.ScoreAggregationPipe<DX>> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Reconstruction.ScoreAggregationPipe<DX>>, mergeInclude: string, spec?: MergeSpec): ObjList<Reconstruction.ScoreAggregationPipe<DX>> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Reconstruction.ScoreAggregationPipe<DX>> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Reconstruction.ScoreAggregationPipe<DX>> | null;
     ...
     */
    static mergeAll(mergeObj: Reconstruction.ScoreAggregationPipe<DX>, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Reconstruction.ScoreAggregationPipe<DX>, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Reconstruction.ScoreAggregationPipe<DX>>, spec?: UpsertSpec): ObjList<Reconstruction.ScoreAggregationPipe<DX>> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Reconstruction.ScoreAggregationPipe<DX>>, spec?: UpsertSpec): ObjList<Reconstruction.ScoreAggregationPipe<DX>> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Reconstruction.ScoreAggregationPipe<DX> | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Reconstruction.ScoreAggregationPipe<DX>>): ObjList<Reconstruction.ScoreAggregationPipe<DX>>;
     ...
     */
    static beforeUpdate(objs: Array_Type<Reconstruction.ScoreAggregationPipe<DX>>): ObjList<Reconstruction.ScoreAggregationPipe<DX>>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Reconstruction.ScoreAggregationPipe<DX>>): ObjList<Reconstruction.ScoreAggregationPipe<DX>>;
     ...
     */
    static afterCreate(objs: Array_Type<Reconstruction.ScoreAggregationPipe<DX>>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Reconstruction.ScoreAggregationPipe<DX>>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Reconstruction.ScoreAggregationPipe<DX>>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Reconstruction.ScoreAggregationPipe<DX>>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Reconstruction.ScoreAggregationPipe<DX>>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Reconstruction.ScoreAggregationPipe<DX> | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Reconstruction.ScoreAggregationPipe<DX>>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Reconstruction.ScoreAggregationPipe<DX>, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Reconstruction.ScoreAggregationPipe<DX>>, callback?: λFunction<Reconstruction.ScoreAggregationPipe<DX> | null, Reconstruction.ScoreAggregationPipe<DX> | null>): ObjList<Reconstruction.ScoreAggregationPipe<DX>>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Reconstruction.ScoreAggregationPipe<DX>>, callback?: λFunction<Reconstruction.ScoreAggregationPipe<DX> | null, Reconstruction.ScoreAggregationPipe<DX> | null>): Array_Type<ObjError> | null;
     ...
     */
    publish(subPath?: string, contentType?: string): Reconstruction.ScoreAggregationPipe<DX>;
     ...
     */
    static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<Reconstruction.ScoreAggregationPipe<DX>> | null;
     ...
     */
    createSeedData(spec?: UpsertSpec): Reconstruction.ScoreAggregationPipe<DX> | null;
     ...
     */
    static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<Reconstruction.ScoreAggregationPipe<DX>> | null;
     ...
     */
    updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): Reconstruction.ScoreAggregationPipe<DX> | null;
     ...
     */
    static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<Reconstruction.ScoreAggregationPipe<DX>> | null;
     ...
     * @return updated obj instance, same as {@link Persistable#update} return value.
     */
    clearUserUpdates(spec?: MergeSpec): Reconstruction.ScoreAggregationPipe<DX> | null;
     ...
     *         {@link Persistable#updateBatch}.
     */
    static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<Reconstruction.ScoreAggregationPipe<DX>> | null;
    ...
    dependencies(): SeedDataDeps<Reconstruction.ScoreAggregationPipe<DX>> | null;
     ...
     */
    static convert(model: any, spec?: MlConvertSpec): Reconstruction.ScoreAggregationPipe<DX>;

    /**
     * Freezes an {@link MlPipe}
     * @return modified copy of this {@link MlPipe} that cannot be trained
     */
    freeze(): Reconstruction.ScoreAggregationPipe<DX>;

    /**
     * Unfreezes an {@link MlPipe}
     * @return modified copy of this {@link MlPipe} that can be trained
     */
    unfreeze(): Reconstruction.ScoreAggregationPipe<DX>;
     ...
     * be returned as-is.
     */
    byReference(): Reconstruction.ScoreAggregationPipe<DX>;
     ...
     */
    updateModelFiles(modelFiles: Map_Type<string, Url>, spec?: MlOperationSpec): Reconstruction.ScoreAggregationPipe<DX>;
     ...
     */
    afterTrain(doTrainOutputs: any, spec?: MlOperationSpec): Reconstruction.ScoreAggregationPipe<DX>;
     ...
     */
    convertNativeToPipeOutputs(output: any, datasetId?: string): number;
     ...
     */
    withNewSpec(spec?: MlConvertSpec): Reconstruction.ScoreAggregationPipe<DX>;
     ...
     */
    afterConvert(model: any, spec?: MlConvertSpec): Reconstruction.ScoreAggregationPipe<DX>;
     ...
     */
    withHyperparamSpaces(paramSpaces: Map_Type<string, Hp.ParamSpace>): Reconstruction.ScoreAggregationPipe<DX>;
