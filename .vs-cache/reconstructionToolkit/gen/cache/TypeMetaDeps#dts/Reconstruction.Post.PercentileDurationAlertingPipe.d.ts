// TypeScript definitions for the C3 type Reconstruction.Post.PercentileDurationAlertingPipe

/**
 * This type represents an {@link MlPipe} template which outputs an `alert` based on a dataset riskScores as input.
 *
 * @remarks this represents a value passed to a method that expects an instance of Reconstruction.Post.PercentileDurationAlertingPipe
 */
declare namespace Reconstruction.Post {
  export interface IPercentileDurationAlertingPipe {
 ...
 */
declare namespace Reconstruction.Post {
  export class PercentileDurationAlertingPipe extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): Reconstruction.Post.PercentileDurationAlertingPipe;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Reconstruction.Post.PercentileDurationAlertingPipe;

    /**
     * Name of this pipe.
     */
    readonly name?: string;
    withName(name: string | null): Reconstruction.Post.PercentileDurationAlertingPipe;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Reconstruction.Post.PercentileDurationAlertingPipe;
    ...
    withVersion(version: number | null): Reconstruction.Post.PercentileDurationAlertingPipe;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Reconstruction.Post.PercentileDurationAlertingPipe;
    ...
    withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): Reconstruction.Post.PercentileDurationAlertingPipe;
    ...
    withHidden(hidden: boolean): Reconstruction.Post.PercentileDurationAlertingPipe;
    ...
    withUserOwned(userOwned: boolean): Reconstruction.Post.PercentileDurationAlertingPipe;
    ...
    withTypeIdent(typeIdent: string | null): Reconstruction.Post.PercentileDurationAlertingPipe;

    /**
     * If true, then the pipe shall not be retrained
     */
    readonly frozen?: boolean;
    withFrozen(frozen: boolean): Reconstruction.Post.PercentileDurationAlertingPipe;

    /**
     * True if training has succeeded and false otherwise.
     */
    readonly trained?: boolean;
    withTrained(trained: boolean): Reconstruction.Post.PercentileDurationAlertingPipe;

    /**
     * Errors from training.
     */
    readonly trainingErrors?: string;
    withTrainingErrors(trainingErrors: string | null): Reconstruction.Post.PercentileDurationAlertingPipe;

    /**
     * If true, the underlying model only accepts flattened input.
     */
    readonly flattenInput?: boolean;
    withFlattenInput(flattenInput: boolean): Reconstruction.Post.PercentileDurationAlertingPipe;

    /**
     * The hyperparameters overridden of a native model or pipe.
     */
    readonly hyperparamOverrides?: Map_Type<string, any>;
    withHyperparamOverrides(hyperparamOverrides: Map_Type<string, any> | {[key: string]: any} | null): Reconstruction.Post.PercentileDurationAlertingPipe;
    ...
    withHyperparamSearchSpace(hyperparamSearchSpace: IHp.SearchSpace | null): Reconstruction.Post.PercentileDurationAlertingPipe;
    ...
    withHpoSpec(hpoSpec: IHpo.Spec | null): Reconstruction.Post.PercentileDurationAlertingPipe;

    /**
     * {@link Hpo.Experiment} stores the result of hyperparameter optimization to find the best model/pipeline.
     */
    readonly hpoExperiment?: Hpo.Experiment;
    withHpoExperiment(hpoExperiment: IHpo.Experiment | null): Reconstruction.Post.PercentileDurationAlertingPipe;

    /**
     * Reference to the experiment that produced this {@link MlPipe}. For example, this could be a {@link Hpo.ExperimentBase}.
     */
    readonly experiment?: any;
    withExperiment(experiment: any | null): Reconstruction.Post.PercentileDurationAlertingPipe;
    ...
    withModelFiles(modelFiles: Map_Type<string, Url> | {[key: string]: IUrl} | null): Reconstruction.Post.PercentileDurationAlertingPipe;
    ...
    withCustomModelCode(customModelCode: Map_Type<string, any> | {[key: string]: any} | null): Reconstruction.Post.PercentileDurationAlertingPipe;

    /**
     * Name for the function on the native model to call to do {@link MlProcessable#process}.
     */
    readonly processFunc?: string;
    withProcessFunc(processFunc: string | null): Reconstruction.Post.PercentileDurationAlertingPipe;
    ...
    withUnderlyingPipe(underlyingPipe: IMlAtomicPipe<any, any, any> | null): Reconstruction.Post.PercentileDurationAlertingPipe;

    /**
     * The name of the column in the {@link Data} output. Default is "alert"
     */
    readonly alertColumnName?: string;
    withAlertColumnName(alertColumnName: string | null): Reconstruction.Post.PercentileDurationAlertingPipe;
    ...
    withLookbackDuration(lookbackDuration: IDuration | null): Reconstruction.Post.PercentileDurationAlertingPipe;
    ...
    withRiskScoreColumnName(riskScoreColumnName: string | null): Reconstruction.Post.PercentileDurationAlertingPipe;
    ...
    withAlertPercentile(alertPercentile: number | null): Reconstruction.Post.PercentileDurationAlertingPipe;
    ...
    withAlertThreshold(alertThreshold: number | null): Reconstruction.Post.PercentileDurationAlertingPipe;
    ...
    withIgnoreSpan(ignoreSpan: number | null): Reconstruction.Post.PercentileDurationAlertingPipe;
    ...
    withMergeSpan(mergeSpan: number | null): Reconstruction.Post.PercentileDurationAlertingPipe;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Reconstruction.Post.PercentileDurationAlertingPipe | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Reconstruction.Post.PercentileDurationAlertingPipe | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Reconstruction.Post.PercentileDurationAlertingPipe | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Reconstruction.Post.PercentileDurationAlertingPipe | null;
     ...
     */
    replaceType(old: Type, new_: Type): Reconstruction.Post.PercentileDurationAlertingPipe;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Reconstruction.Post.PercentileDurationAlertingPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Reconstruction.Post.PercentileDurationAlertingPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Reconstruction.Post.PercentileDurationAlertingPipe>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Reconstruction.Post.PercentileDurationAlertingPipe>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Reconstruction.Post.PercentileDurationAlertingPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Reconstruction.Post.PercentileDurationAlertingPipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Reconstruction.Post.PercentileDurationAlertingPipe;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Reconstruction.Post.PercentileDurationAlertingPipe;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Reconstruction.Post.PercentileDurationAlertingPipe;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Reconstruction.Post.PercentileDurationAlertingPipe;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Reconstruction.Post.PercentileDurationAlertingPipe;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Reconstruction.Post.PercentileDurationAlertingPipe;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Reconstruction.Post.PercentileDurationAlertingPipe;
     ...
     * @see #removeField
     */
    withoutField(field: string): Reconstruction.Post.PercentileDurationAlertingPipe;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Reconstruction.Post.PercentileDurationAlertingPipe;
     ...
     */
    withoutFields(fields: Array_Type<string>): Reconstruction.Post.PercentileDurationAlertingPipe;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Reconstruction.Post.PercentileDurationAlertingPipe;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Reconstruction.Post.PercentileDurationAlertingPipe;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Reconstruction.Post.PercentileDurationAlertingPipe;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Reconstruction.Post.PercentileDurationAlertingPipe;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Reconstruction.Post.PercentileDurationAlertingPipe;
     ...
     * @see #removeField
     */
    unsetField(field: string): Reconstruction.Post.PercentileDurationAlertingPipe;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Reconstruction.Post.PercentileDurationAlertingPipe;
     ...
     * @see #unsetField
     */
    removeField(field: string): Reconstruction.Post.PercentileDurationAlertingPipe;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Reconstruction.Post.PercentileDurationAlertingPipe;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Reconstruction.Post.PercentileDurationAlertingPipe;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Reconstruction.Post.PercentileDurationAlertingPipe;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Reconstruction.Post.PercentileDurationAlertingPipe;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Reconstruction.Post.PercentileDurationAlertingPipe;

    mergeJson(json: any): Reconstruction.Post.PercentileDurationAlertingPipe;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Reconstruction.Post.PercentileDurationAlertingPipe;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Reconstruction.Post.PercentileDurationAlertingPipe;
     ...
     */
    singletonArray(): Array_Type<Reconstruction.Post.PercentileDurationAlertingPipe>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Reconstruction.Post.PercentileDurationAlertingPipe> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Reconstruction.Post.PercentileDurationAlertingPipe> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Reconstruction.Post.PercentileDurationAlertingPipe>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Reconstruction.Post.PercentileDurationAlertingPipe> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Reconstruction.Post.PercentileDurationAlertingPipe> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Reconstruction.Post.PercentileDurationAlertingPipe> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Reconstruction.Post.PercentileDurationAlertingPipe>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Reconstruction.Post.PercentileDurationAlertingPipe>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Reconstruction.Post.PercentileDurationAlertingPipe;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Reconstruction.Post.PercentileDurationAlertingPipe;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Reconstruction.Post.PercentileDurationAlertingPipe;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Reconstruction.Post.PercentileDurationAlertingPipe;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Reconstruction.Post.PercentileDurationAlertingPipe;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Reconstruction.Post.PercentileDurationAlertingPipe;
     ...
     * @see #fromString
     */
    static make(s: string): Reconstruction.Post.PercentileDurationAlertingPipe | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Reconstruction.Post.PercentileDurationAlertingPipe;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Reconstruction.Post.PercentileDurationAlertingPipe;
     ...
     */
    static cachedEmptyInst(): Reconstruction.Post.PercentileDurationAlertingPipe;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Reconstruction.Post.PercentileDurationAlertingPipe> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Reconstruction.Post.PercentileDurationAlertingPipe;
     ...
     */
    remakeTemplate(): Reconstruction.Post.PercentileDurationAlertingPipe;
     ...
     */
    withoutIdentity(): Reconstruction.Post.PercentileDurationAlertingPipe;
     ...
     */
    trainSync(x: , y?: , spec?: MlOperationSpec): Reconstruction.Post.PercentileDurationAlertingPipe;
     ...
     */
    static allCached(): Stream<Reconstruction.Post.PercentileDurationAlertingPipe> | null;
     ...
     */
    static find(filter?: string): Stream<Reconstruction.Post.PercentileDurationAlertingPipe> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<Reconstruction.Post.PercentileDurationAlertingPipe> | null;

    /**
     * @return cached instance.
     */
    getCached(): Reconstruction.Post.PercentileDurationAlertingPipe | null;

    /**
     * @return cached instance by the key.
     */
    static forCacheKey(key: string): Reconstruction.Post.PercentileDurationAlertingPipe | null;
     ...
     */
    static produce(key: string): Reconstruction.Post.PercentileDurationAlertingPipe | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, Reconstruction.Post.PercentileDurationAlertingPipe> | null;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Reconstruction.Post.PercentileDurationAlertingPipe>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Reconstruction.Post.PercentileDurationAlertingPipe>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Reconstruction.Post.PercentileDurationAlertingPipe> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Reconstruction.Post.PercentileDurationAlertingPipe>> | null;
     ...
     */
    get(include?: string): Reconstruction.Post.PercentileDurationAlertingPipe | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Reconstruction.Post.PercentileDurationAlertingPipe | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Reconstruction.Post.PercentileDurationAlertingPipe;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Reconstruction.Post.PercentileDurationAlertingPipe | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Reconstruction.Post.PercentileDurationAlertingPipe;
     ...
     * @see #toString
     */
    static fromString(s: string): Reconstruction.Post.PercentileDurationAlertingPipe | null;
     ...
     */
    create(spec?: UpsertSpec): Reconstruction.Post.PercentileDurationAlertingPipe | null;
     ...
     */
    static createBatch(objs: Array_Type<Reconstruction.Post.PercentileDurationAlertingPipe>, spec?: UpsertSpec): ObjList<Reconstruction.Post.PercentileDurationAlertingPipe> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Reconstruction.Post.PercentileDurationAlertingPipe>, spec?: CreateBatchObjStreamSpec): ObjList<Reconstruction.Post.PercentileDurationAlertingPipe> | null;
     ...
     */
    update(srcObj?: Reconstruction.Post.PercentileDurationAlertingPipe, spec?: UpsertSpec): Reconstruction.Post.PercentileDurationAlertingPipe | null;
     ...
     */
    upsert(srcObj?: Reconstruction.Post.PercentileDurationAlertingPipe, spec?: UpsertSpec): Reconstruction.Post.PercentileDurationAlertingPipe | null;
     ...
     */
    merge(spec?: MergeSpec): Reconstruction.Post.PercentileDurationAlertingPipe | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Reconstruction.Post.PercentileDurationAlertingPipe | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Reconstruction.Post.PercentileDurationAlertingPipe | null;
     ...
     */
    static updateBatch(objs: Array_Type<Reconstruction.Post.PercentileDurationAlertingPipe>, srcObjs?: Array_Type<Reconstruction.Post.PercentileDurationAlertingPipe>, spec?: UpsertSpec): ObjList<Reconstruction.Post.PercentileDurationAlertingPipe> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Reconstruction.Post.PercentileDurationAlertingPipe> | null>, spec?: UpsertSpec): ObjList<Reconstruction.Post.PercentileDurationAlertingPipe> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Reconstruction.Post.PercentileDurationAlertingPipe>, srcObjs?: Array_Type<Reconstruction.Post.PercentileDurationAlertingPipe>, spec?: UpsertSpec): ObjList<Reconstruction.Post.PercentileDurationAlertingPipe> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Reconstruction.Post.PercentileDurationAlertingPipe> | null>, spec?: UpsertSpec): ObjList<Reconstruction.Post.PercentileDurationAlertingPipe> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Reconstruction.Post.PercentileDurationAlertingPipe>, spec?: TouchSpec): ObjList<Reconstruction.Post.PercentileDurationAlertingPipe> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Reconstruction.Post.PercentileDurationAlertingPipe>, spec?: MergeSpec): ObjList<Reconstruction.Post.PercentileDurationAlertingPipe> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Reconstruction.Post.PercentileDurationAlertingPipe>, mergeInclude: string, spec?: MergeSpec): ObjList<Reconstruction.Post.PercentileDurationAlertingPipe> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Reconstruction.Post.PercentileDurationAlertingPipe> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Reconstruction.Post.PercentileDurationAlertingPipe> | null;
     ...
     */
    static mergeAll(mergeObj: Reconstruction.Post.PercentileDurationAlertingPipe, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Reconstruction.Post.PercentileDurationAlertingPipe, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Reconstruction.Post.PercentileDurationAlertingPipe>, spec?: UpsertSpec): ObjList<Reconstruction.Post.PercentileDurationAlertingPipe> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Reconstruction.Post.PercentileDurationAlertingPipe>, spec?: UpsertSpec): ObjList<Reconstruction.Post.PercentileDurationAlertingPipe> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Reconstruction.Post.PercentileDurationAlertingPipe | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Reconstruction.Post.PercentileDurationAlertingPipe>): ObjList<Reconstruction.Post.PercentileDurationAlertingPipe>;
     ...
     */
    static beforeUpdate(objs: Array_Type<Reconstruction.Post.PercentileDurationAlertingPipe>): ObjList<Reconstruction.Post.PercentileDurationAlertingPipe>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Reconstruction.Post.PercentileDurationAlertingPipe>): ObjList<Reconstruction.Post.PercentileDurationAlertingPipe>;
     ...
     */
    static afterCreate(objs: Array_Type<Reconstruction.Post.PercentileDurationAlertingPipe>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Reconstruction.Post.PercentileDurationAlertingPipe>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Reconstruction.Post.PercentileDurationAlertingPipe>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Reconstruction.Post.PercentileDurationAlertingPipe>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Reconstruction.Post.PercentileDurationAlertingPipe>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Reconstruction.Post.PercentileDurationAlertingPipe | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Reconstruction.Post.PercentileDurationAlertingPipe>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Reconstruction.Post.PercentileDurationAlertingPipe, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Reconstruction.Post.PercentileDurationAlertingPipe>, callback?: λFunction<Reconstruction.Post.PercentileDurationAlertingPipe | null, Reconstruction.Post.PercentileDurationAlertingPipe | null>): ObjList<Reconstruction.Post.PercentileDurationAlertingPipe>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Reconstruction.Post.PercentileDurationAlertingPipe>, callback?: λFunction<Reconstruction.Post.PercentileDurationAlertingPipe | null, Reconstruction.Post.PercentileDurationAlertingPipe | null>): Array_Type<ObjError> | null;
     ...
     */
    publish(subPath?: string, contentType?: string): Reconstruction.Post.PercentileDurationAlertingPipe;
     ...
     */
    static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<Reconstruction.Post.PercentileDurationAlertingPipe> | null;
     ...
     */
    createSeedData(spec?: UpsertSpec): Reconstruction.Post.PercentileDurationAlertingPipe | null;
     ...
     */
    static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<Reconstruction.Post.PercentileDurationAlertingPipe> | null;
     ...
     */
    updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): Reconstruction.Post.PercentileDurationAlertingPipe | null;
     ...
     */
    static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<Reconstruction.Post.PercentileDurationAlertingPipe> | null;
     ...
     * @return updated obj instance, same as {@link Persistable#update} return value.
     */
    clearUserUpdates(spec?: MergeSpec): Reconstruction.Post.PercentileDurationAlertingPipe | null;
     ...
     *         {@link Persistable#updateBatch}.
     */
    static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<Reconstruction.Post.PercentileDurationAlertingPipe> | null;
    ...
    dependencies(): SeedDataDeps<Reconstruction.Post.PercentileDurationAlertingPipe> | null;
     ...
     */
    static convert(model: any, spec?: MlConvertSpec): Reconstruction.Post.PercentileDurationAlertingPipe;

    /**
     * Freezes an {@link MlPipe}
     * @return modified copy of this {@link MlPipe} that cannot be trained
     */
    freeze(): Reconstruction.Post.PercentileDurationAlertingPipe;

    /**
     * Unfreezes an {@link MlPipe}
     * @return modified copy of this {@link MlPipe} that can be trained
     */
    unfreeze(): Reconstruction.Post.PercentileDurationAlertingPipe;
     ...
     * be returned as-is.
     */
    byReference(): Reconstruction.Post.PercentileDurationAlertingPipe;
     ...
     */
    updateModelFiles(modelFiles: Map_Type<string, Url>, spec?: MlOperationSpec): Reconstruction.Post.PercentileDurationAlertingPipe;
     ...
     */
    afterTrain(doTrainOutputs: any, spec?: MlOperationSpec): Reconstruction.Post.PercentileDurationAlertingPipe;
     ...
     */
    withNewSpec(spec?: MlConvertSpec): Reconstruction.Post.PercentileDurationAlertingPipe;
     ...
     */
    afterConvert(model: any, spec?: MlConvertSpec): Reconstruction.Post.PercentileDurationAlertingPipe;
     ...
     */
    withHyperparamSpaces(paramSpaces: Map_Type<string, Hp.ParamSpace>): Reconstruction.Post.PercentileDurationAlertingPipe;
