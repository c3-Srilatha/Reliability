// TypeScript definitions for the C3 type Reconstruction.Post.WeightedRiskScorePipe

/**
 * This type represents an {@link MlPipe} template that outputs a `riskScore` that is a weighted average of the
 * input residuals.
 *
 * @remarks this represents a value passed to a method that expects an instance of Reconstruction.Post.WeightedRiskScorePipe
 */
declare namespace Reconstruction.Post {
  export interface IWeightedRiskScorePipe {
 ...
 * input residuals.
 *
 * @remarks this represents a made instance of Reconstruction.Post.WeightedRiskScorePipe
 */
declare namespace Reconstruction.Post {
  export class WeightedRiskScorePipe extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): Reconstruction.Post.WeightedRiskScorePipe;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Reconstruction.Post.WeightedRiskScorePipe;

    /**
     * Name of this pipe.
     */
    readonly name?: string;
    withName(name: string | null): Reconstruction.Post.WeightedRiskScorePipe;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Reconstruction.Post.WeightedRiskScorePipe;
    ...
    withVersion(version: number | null): Reconstruction.Post.WeightedRiskScorePipe;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Reconstruction.Post.WeightedRiskScorePipe;
    ...
    withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): Reconstruction.Post.WeightedRiskScorePipe;
    ...
    withHidden(hidden: boolean): Reconstruction.Post.WeightedRiskScorePipe;
    ...
    withUserOwned(userOwned: boolean): Reconstruction.Post.WeightedRiskScorePipe;
    ...
    withTypeIdent(typeIdent: string | null): Reconstruction.Post.WeightedRiskScorePipe;

    /**
     * If true, then the pipe shall not be retrained
     */
    readonly frozen?: boolean;
    withFrozen(frozen: boolean): Reconstruction.Post.WeightedRiskScorePipe;

    /**
     * True if training has succeeded and false otherwise.
     */
    readonly trained?: boolean;
    withTrained(trained: boolean): Reconstruction.Post.WeightedRiskScorePipe;

    /**
     * Errors from training.
     */
    readonly trainingErrors?: string;
    withTrainingErrors(trainingErrors: string | null): Reconstruction.Post.WeightedRiskScorePipe;

    /**
     * If true, the underlying model only accepts flattened input.
     */
    readonly flattenInput?: boolean;
    withFlattenInput(flattenInput: boolean): Reconstruction.Post.WeightedRiskScorePipe;

    /**
     * The hyperparameters overridden of a native model or pipe.
     */
    readonly hyperparamOverrides?: Map_Type<string, any>;
    withHyperparamOverrides(hyperparamOverrides: Map_Type<string, any> | {[key: string]: any} | null): Reconstruction.Post.WeightedRiskScorePipe;
    ...
    withHyperparamSearchSpace(hyperparamSearchSpace: IHp.SearchSpace | null): Reconstruction.Post.WeightedRiskScorePipe;
    ...
    withHpoSpec(hpoSpec: IHpo.Spec | null): Reconstruction.Post.WeightedRiskScorePipe;

    /**
     * {@link Hpo.Experiment} stores the result of hyperparameter optimization to find the best model/pipeline.
     */
    readonly hpoExperiment?: Hpo.Experiment;
    withHpoExperiment(hpoExperiment: IHpo.Experiment | null): Reconstruction.Post.WeightedRiskScorePipe;

    /**
     * Reference to the experiment that produced this {@link MlPipe}. For example, this could be a {@link Hpo.ExperimentBase}.
     */
    readonly experiment?: any;
    withExperiment(experiment: any | null): Reconstruction.Post.WeightedRiskScorePipe;
    ...
    withModelFiles(modelFiles: Map_Type<string, Url> | {[key: string]: IUrl} | null): Reconstruction.Post.WeightedRiskScorePipe;
    ...
    withCustomModelCode(customModelCode: Map_Type<string, any> | {[key: string]: any} | null): Reconstruction.Post.WeightedRiskScorePipe;

    /**
     * Name for the function on the native model to call to do {@link MlProcessable#process}.
     */
    readonly processFunc?: string;
    withProcessFunc(processFunc: string | null): Reconstruction.Post.WeightedRiskScorePipe;
    ...
    withUnderlyingPipe(underlyingPipe: IMlAtomicPipe<any, any, any> | null): Reconstruction.Post.WeightedRiskScorePipe;

    /**
     * The name of the column in the {@link Data} output. Default is "riskScore"
     */
    readonly riskScoreColumnName?: string;
    withRiskScoreColumnName(riskScoreColumnName: string | null): Reconstruction.Post.WeightedRiskScorePipe;
    ...
    withWeights(weights: Map_Type<string, number> | {[key: string]: number} | null): Reconstruction.Post.WeightedRiskScorePipe;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Reconstruction.Post.WeightedRiskScorePipe | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Reconstruction.Post.WeightedRiskScorePipe | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Reconstruction.Post.WeightedRiskScorePipe | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Reconstruction.Post.WeightedRiskScorePipe | null;
     ...
     */
    replaceType(old: Type, new_: Type): Reconstruction.Post.WeightedRiskScorePipe;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Reconstruction.Post.WeightedRiskScorePipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Reconstruction.Post.WeightedRiskScorePipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Reconstruction.Post.WeightedRiskScorePipe>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Reconstruction.Post.WeightedRiskScorePipe>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Reconstruction.Post.WeightedRiskScorePipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Reconstruction.Post.WeightedRiskScorePipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Reconstruction.Post.WeightedRiskScorePipe;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Reconstruction.Post.WeightedRiskScorePipe;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Reconstruction.Post.WeightedRiskScorePipe;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Reconstruction.Post.WeightedRiskScorePipe;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Reconstruction.Post.WeightedRiskScorePipe;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Reconstruction.Post.WeightedRiskScorePipe;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Reconstruction.Post.WeightedRiskScorePipe;
     ...
     * @see #removeField
     */
    withoutField(field: string): Reconstruction.Post.WeightedRiskScorePipe;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Reconstruction.Post.WeightedRiskScorePipe;
     ...
     */
    withoutFields(fields: Array_Type<string>): Reconstruction.Post.WeightedRiskScorePipe;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Reconstruction.Post.WeightedRiskScorePipe;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Reconstruction.Post.WeightedRiskScorePipe;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Reconstruction.Post.WeightedRiskScorePipe;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Reconstruction.Post.WeightedRiskScorePipe;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Reconstruction.Post.WeightedRiskScorePipe;
     ...
     * @see #removeField
     */
    unsetField(field: string): Reconstruction.Post.WeightedRiskScorePipe;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Reconstruction.Post.WeightedRiskScorePipe;
     ...
     * @see #unsetField
     */
    removeField(field: string): Reconstruction.Post.WeightedRiskScorePipe;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Reconstruction.Post.WeightedRiskScorePipe;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Reconstruction.Post.WeightedRiskScorePipe;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Reconstruction.Post.WeightedRiskScorePipe;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Reconstruction.Post.WeightedRiskScorePipe;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Reconstruction.Post.WeightedRiskScorePipe;

    mergeJson(json: any): Reconstruction.Post.WeightedRiskScorePipe;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Reconstruction.Post.WeightedRiskScorePipe;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Reconstruction.Post.WeightedRiskScorePipe;
     ...
     */
    singletonArray(): Array_Type<Reconstruction.Post.WeightedRiskScorePipe>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Reconstruction.Post.WeightedRiskScorePipe> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Reconstruction.Post.WeightedRiskScorePipe> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Reconstruction.Post.WeightedRiskScorePipe>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Reconstruction.Post.WeightedRiskScorePipe> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Reconstruction.Post.WeightedRiskScorePipe> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Reconstruction.Post.WeightedRiskScorePipe> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Reconstruction.Post.WeightedRiskScorePipe>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Reconstruction.Post.WeightedRiskScorePipe>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Reconstruction.Post.WeightedRiskScorePipe;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Reconstruction.Post.WeightedRiskScorePipe;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Reconstruction.Post.WeightedRiskScorePipe;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Reconstruction.Post.WeightedRiskScorePipe;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Reconstruction.Post.WeightedRiskScorePipe;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Reconstruction.Post.WeightedRiskScorePipe;
     ...
     * @see #fromString
     */
    static make(s: string): Reconstruction.Post.WeightedRiskScorePipe | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Reconstruction.Post.WeightedRiskScorePipe;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Reconstruction.Post.WeightedRiskScorePipe;
     ...
     */
    static cachedEmptyInst(): Reconstruction.Post.WeightedRiskScorePipe;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Reconstruction.Post.WeightedRiskScorePipe> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Reconstruction.Post.WeightedRiskScorePipe;
     ...
     */
    remakeTemplate(): Reconstruction.Post.WeightedRiskScorePipe;
     ...
     */
    withoutIdentity(): Reconstruction.Post.WeightedRiskScorePipe;
     ...
     */
    trainSync(x: , y?: , spec?: MlOperationSpec): Reconstruction.Post.WeightedRiskScorePipe;
     ...
     */
    static allCached(): Stream<Reconstruction.Post.WeightedRiskScorePipe> | null;
     ...
     */
    static find(filter?: string): Stream<Reconstruction.Post.WeightedRiskScorePipe> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<Reconstruction.Post.WeightedRiskScorePipe> | null;

    /**
     * @return cached instance.
     */
    getCached(): Reconstruction.Post.WeightedRiskScorePipe | null;

    /**
     * @return cached instance by the key.
     */
    static forCacheKey(key: string): Reconstruction.Post.WeightedRiskScorePipe | null;
     ...
     */
    static produce(key: string): Reconstruction.Post.WeightedRiskScorePipe | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, Reconstruction.Post.WeightedRiskScorePipe> | null;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Reconstruction.Post.WeightedRiskScorePipe>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Reconstruction.Post.WeightedRiskScorePipe>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Reconstruction.Post.WeightedRiskScorePipe> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Reconstruction.Post.WeightedRiskScorePipe>> | null;
     ...
     */
    get(include?: string): Reconstruction.Post.WeightedRiskScorePipe | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Reconstruction.Post.WeightedRiskScorePipe | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Reconstruction.Post.WeightedRiskScorePipe;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Reconstruction.Post.WeightedRiskScorePipe | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Reconstruction.Post.WeightedRiskScorePipe;
     ...
     * @see #toString
     */
    static fromString(s: string): Reconstruction.Post.WeightedRiskScorePipe | null;
     ...
     */
    create(spec?: UpsertSpec): Reconstruction.Post.WeightedRiskScorePipe | null;
     ...
     */
    static createBatch(objs: Array_Type<Reconstruction.Post.WeightedRiskScorePipe>, spec?: UpsertSpec): ObjList<Reconstruction.Post.WeightedRiskScorePipe> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Reconstruction.Post.WeightedRiskScorePipe>, spec?: CreateBatchObjStreamSpec): ObjList<Reconstruction.Post.WeightedRiskScorePipe> | null;
     ...
     */
    update(srcObj?: Reconstruction.Post.WeightedRiskScorePipe, spec?: UpsertSpec): Reconstruction.Post.WeightedRiskScorePipe | null;
     ...
     */
    upsert(srcObj?: Reconstruction.Post.WeightedRiskScorePipe, spec?: UpsertSpec): Reconstruction.Post.WeightedRiskScorePipe | null;
     ...
     */
    merge(spec?: MergeSpec): Reconstruction.Post.WeightedRiskScorePipe | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Reconstruction.Post.WeightedRiskScorePipe | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Reconstruction.Post.WeightedRiskScorePipe | null;
     ...
     */
    static updateBatch(objs: Array_Type<Reconstruction.Post.WeightedRiskScorePipe>, srcObjs?: Array_Type<Reconstruction.Post.WeightedRiskScorePipe>, spec?: UpsertSpec): ObjList<Reconstruction.Post.WeightedRiskScorePipe> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Reconstruction.Post.WeightedRiskScorePipe> | null>, spec?: UpsertSpec): ObjList<Reconstruction.Post.WeightedRiskScorePipe> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Reconstruction.Post.WeightedRiskScorePipe>, srcObjs?: Array_Type<Reconstruction.Post.WeightedRiskScorePipe>, spec?: UpsertSpec): ObjList<Reconstruction.Post.WeightedRiskScorePipe> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Reconstruction.Post.WeightedRiskScorePipe> | null>, spec?: UpsertSpec): ObjList<Reconstruction.Post.WeightedRiskScorePipe> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Reconstruction.Post.WeightedRiskScorePipe>, spec?: TouchSpec): ObjList<Reconstruction.Post.WeightedRiskScorePipe> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Reconstruction.Post.WeightedRiskScorePipe>, spec?: MergeSpec): ObjList<Reconstruction.Post.WeightedRiskScorePipe> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Reconstruction.Post.WeightedRiskScorePipe>, mergeInclude: string, spec?: MergeSpec): ObjList<Reconstruction.Post.WeightedRiskScorePipe> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Reconstruction.Post.WeightedRiskScorePipe> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Reconstruction.Post.WeightedRiskScorePipe> | null;
     ...
     */
    static mergeAll(mergeObj: Reconstruction.Post.WeightedRiskScorePipe, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Reconstruction.Post.WeightedRiskScorePipe, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Reconstruction.Post.WeightedRiskScorePipe>, spec?: UpsertSpec): ObjList<Reconstruction.Post.WeightedRiskScorePipe> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Reconstruction.Post.WeightedRiskScorePipe>, spec?: UpsertSpec): ObjList<Reconstruction.Post.WeightedRiskScorePipe> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Reconstruction.Post.WeightedRiskScorePipe | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Reconstruction.Post.WeightedRiskScorePipe>): ObjList<Reconstruction.Post.WeightedRiskScorePipe>;
     ...
     */
    static beforeUpdate(objs: Array_Type<Reconstruction.Post.WeightedRiskScorePipe>): ObjList<Reconstruction.Post.WeightedRiskScorePipe>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Reconstruction.Post.WeightedRiskScorePipe>): ObjList<Reconstruction.Post.WeightedRiskScorePipe>;
     ...
     */
    static afterCreate(objs: Array_Type<Reconstruction.Post.WeightedRiskScorePipe>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Reconstruction.Post.WeightedRiskScorePipe>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Reconstruction.Post.WeightedRiskScorePipe>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Reconstruction.Post.WeightedRiskScorePipe>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Reconstruction.Post.WeightedRiskScorePipe>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Reconstruction.Post.WeightedRiskScorePipe | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Reconstruction.Post.WeightedRiskScorePipe>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Reconstruction.Post.WeightedRiskScorePipe, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Reconstruction.Post.WeightedRiskScorePipe>, callback?: λFunction<Reconstruction.Post.WeightedRiskScorePipe | null, Reconstruction.Post.WeightedRiskScorePipe | null>): ObjList<Reconstruction.Post.WeightedRiskScorePipe>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Reconstruction.Post.WeightedRiskScorePipe>, callback?: λFunction<Reconstruction.Post.WeightedRiskScorePipe | null, Reconstruction.Post.WeightedRiskScorePipe | null>): Array_Type<ObjError> | null;
     ...
     */
    publish(subPath?: string, contentType?: string): Reconstruction.Post.WeightedRiskScorePipe;
     ...
     */
    static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<Reconstruction.Post.WeightedRiskScorePipe> | null;
     ...
     */
    createSeedData(spec?: UpsertSpec): Reconstruction.Post.WeightedRiskScorePipe | null;
     ...
     */
    static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<Reconstruction.Post.WeightedRiskScorePipe> | null;
     ...
     */
    updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): Reconstruction.Post.WeightedRiskScorePipe | null;
     ...
     */
    static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<Reconstruction.Post.WeightedRiskScorePipe> | null;
     ...
     * @return updated obj instance, same as {@link Persistable#update} return value.
     */
    clearUserUpdates(spec?: MergeSpec): Reconstruction.Post.WeightedRiskScorePipe | null;
     ...
     *         {@link Persistable#updateBatch}.
     */
    static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<Reconstruction.Post.WeightedRiskScorePipe> | null;
    ...
    dependencies(): SeedDataDeps<Reconstruction.Post.WeightedRiskScorePipe> | null;
     ...
     */
    static convert(model: any, spec?: MlConvertSpec): Reconstruction.Post.WeightedRiskScorePipe;

    /**
     * Freezes an {@link MlPipe}
     * @return modified copy of this {@link MlPipe} that cannot be trained
     */
    freeze(): Reconstruction.Post.WeightedRiskScorePipe;

    /**
     * Unfreezes an {@link MlPipe}
     * @return modified copy of this {@link MlPipe} that can be trained
     */
    unfreeze(): Reconstruction.Post.WeightedRiskScorePipe;
     ...
     * be returned as-is.
     */
    byReference(): Reconstruction.Post.WeightedRiskScorePipe;
     ...
     */
    updateModelFiles(modelFiles: Map_Type<string, Url>, spec?: MlOperationSpec): Reconstruction.Post.WeightedRiskScorePipe;
     ...
     */
    afterTrain(doTrainOutputs: any, spec?: MlOperationSpec): Reconstruction.Post.WeightedRiskScorePipe;
     ...
     */
    withNewSpec(spec?: MlConvertSpec): Reconstruction.Post.WeightedRiskScorePipe;
     ...
     */
    afterConvert(model: any, spec?: MlConvertSpec): Reconstruction.Post.WeightedRiskScorePipe;
     ...
     */
    withHyperparamSpaces(paramSpaces: Map_Type<string, Hp.ParamSpace>): Reconstruction.Post.WeightedRiskScorePipe;
