// TypeScript definitions for the C3 type Reconstruction.Post.SimpleRiskScorePipe

/**
 * This type represents an {@link MlPipe} template which outputs a `riskScore` based on a dataset of residuals as input.
 *
 * @remarks this represents a value passed to a method that expects an instance of Reconstruction.Post.SimpleRiskScorePipe
 */
declare namespace Reconstruction.Post {
  export interface ISimpleRiskScorePipe {
 ...
 * This type represents an {@link MlPipe} template which outputs a `riskScore` based on a dataset of residuals as input.
 *
 * @remarks this represents a made instance of Reconstruction.Post.SimpleRiskScorePipe
 */
declare namespace Reconstruction.Post {
  export class SimpleRiskScorePipe extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): Reconstruction.Post.SimpleRiskScorePipe;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Reconstruction.Post.SimpleRiskScorePipe;

    /**
     * Name of this pipe.
     */
    readonly name?: string;
    withName(name: string | null): Reconstruction.Post.SimpleRiskScorePipe;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Reconstruction.Post.SimpleRiskScorePipe;
    ...
    withVersion(version: number | null): Reconstruction.Post.SimpleRiskScorePipe;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Reconstruction.Post.SimpleRiskScorePipe;
    ...
    withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): Reconstruction.Post.SimpleRiskScorePipe;
    ...
    withHidden(hidden: boolean): Reconstruction.Post.SimpleRiskScorePipe;
    ...
    withUserOwned(userOwned: boolean): Reconstruction.Post.SimpleRiskScorePipe;
    ...
    withTypeIdent(typeIdent: string | null): Reconstruction.Post.SimpleRiskScorePipe;

    /**
     * If true, then the pipe shall not be retrained
     */
    readonly frozen?: boolean;
    withFrozen(frozen: boolean): Reconstruction.Post.SimpleRiskScorePipe;

    /**
     * True if training has succeeded and false otherwise.
     */
    readonly trained?: boolean;
    withTrained(trained: boolean): Reconstruction.Post.SimpleRiskScorePipe;

    /**
     * Errors from training.
     */
    readonly trainingErrors?: string;
    withTrainingErrors(trainingErrors: string | null): Reconstruction.Post.SimpleRiskScorePipe;

    /**
     * If true, the underlying model only accepts flattened input.
     */
    readonly flattenInput?: boolean;
    withFlattenInput(flattenInput: boolean): Reconstruction.Post.SimpleRiskScorePipe;

    /**
     * The hyperparameters overridden of a native model or pipe.
     */
    readonly hyperparamOverrides?: Map_Type<string, any>;
    withHyperparamOverrides(hyperparamOverrides: Map_Type<string, any> | {[key: string]: any} | null): Reconstruction.Post.SimpleRiskScorePipe;
    ...
    withHyperparamSearchSpace(hyperparamSearchSpace: IHp.SearchSpace | null): Reconstruction.Post.SimpleRiskScorePipe;
    ...
    withHpoSpec(hpoSpec: IHpo.Spec | null): Reconstruction.Post.SimpleRiskScorePipe;

    /**
     * {@link Hpo.Experiment} stores the result of hyperparameter optimization to find the best model/pipeline.
     */
    readonly hpoExperiment?: Hpo.Experiment;
    withHpoExperiment(hpoExperiment: IHpo.Experiment | null): Reconstruction.Post.SimpleRiskScorePipe;

    /**
     * Reference to the experiment that produced this {@link MlPipe}. For example, this could be a {@link Hpo.ExperimentBase}.
     */
    readonly experiment?: any;
    withExperiment(experiment: any | null): Reconstruction.Post.SimpleRiskScorePipe;
    ...
    withModelFiles(modelFiles: Map_Type<string, Url> | {[key: string]: IUrl} | null): Reconstruction.Post.SimpleRiskScorePipe;
    ...
    withCustomModelCode(customModelCode: Map_Type<string, any> | {[key: string]: any} | null): Reconstruction.Post.SimpleRiskScorePipe;

    /**
     * Name for the function on the native model to call to do {@link MlProcessable#process}.
     */
    readonly processFunc?: string;
    withProcessFunc(processFunc: string | null): Reconstruction.Post.SimpleRiskScorePipe;
    ...
    withUnderlyingPipe(underlyingPipe: IMlAtomicPipe<any, any, any> | null): Reconstruction.Post.SimpleRiskScorePipe;

    /**
     * The name of the column in the {@link Data} output. Default is "riskScore"
     */
    readonly riskScoreColumnName?: string;
    withRiskScoreColumnName(riskScoreColumnName: string | null): Reconstruction.Post.SimpleRiskScorePipe;

    /**
     * `numpy` function to aggregate residual inputs.
     */
    readonly aggFunc: string;
    withAggFunc(aggFunc: string): Reconstruction.Post.SimpleRiskScorePipe;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Reconstruction.Post.SimpleRiskScorePipe | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Reconstruction.Post.SimpleRiskScorePipe | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Reconstruction.Post.SimpleRiskScorePipe | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Reconstruction.Post.SimpleRiskScorePipe | null;
     ...
     */
    replaceType(old: Type, new_: Type): Reconstruction.Post.SimpleRiskScorePipe;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Reconstruction.Post.SimpleRiskScorePipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Reconstruction.Post.SimpleRiskScorePipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Reconstruction.Post.SimpleRiskScorePipe>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Reconstruction.Post.SimpleRiskScorePipe>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Reconstruction.Post.SimpleRiskScorePipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Reconstruction.Post.SimpleRiskScorePipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Reconstruction.Post.SimpleRiskScorePipe;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Reconstruction.Post.SimpleRiskScorePipe;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Reconstruction.Post.SimpleRiskScorePipe;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Reconstruction.Post.SimpleRiskScorePipe;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Reconstruction.Post.SimpleRiskScorePipe;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Reconstruction.Post.SimpleRiskScorePipe;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Reconstruction.Post.SimpleRiskScorePipe;
     ...
     * @see #removeField
     */
    withoutField(field: string): Reconstruction.Post.SimpleRiskScorePipe;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Reconstruction.Post.SimpleRiskScorePipe;
     ...
     */
    withoutFields(fields: Array_Type<string>): Reconstruction.Post.SimpleRiskScorePipe;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Reconstruction.Post.SimpleRiskScorePipe;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Reconstruction.Post.SimpleRiskScorePipe;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Reconstruction.Post.SimpleRiskScorePipe;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Reconstruction.Post.SimpleRiskScorePipe;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Reconstruction.Post.SimpleRiskScorePipe;
     ...
     * @see #removeField
     */
    unsetField(field: string): Reconstruction.Post.SimpleRiskScorePipe;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Reconstruction.Post.SimpleRiskScorePipe;
     ...
     * @see #unsetField
     */
    removeField(field: string): Reconstruction.Post.SimpleRiskScorePipe;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Reconstruction.Post.SimpleRiskScorePipe;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Reconstruction.Post.SimpleRiskScorePipe;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Reconstruction.Post.SimpleRiskScorePipe;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Reconstruction.Post.SimpleRiskScorePipe;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Reconstruction.Post.SimpleRiskScorePipe;

    mergeJson(json: any): Reconstruction.Post.SimpleRiskScorePipe;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Reconstruction.Post.SimpleRiskScorePipe;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Reconstruction.Post.SimpleRiskScorePipe;
     ...
     */
    singletonArray(): Array_Type<Reconstruction.Post.SimpleRiskScorePipe>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Reconstruction.Post.SimpleRiskScorePipe> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Reconstruction.Post.SimpleRiskScorePipe> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Reconstruction.Post.SimpleRiskScorePipe>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Reconstruction.Post.SimpleRiskScorePipe> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Reconstruction.Post.SimpleRiskScorePipe> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Reconstruction.Post.SimpleRiskScorePipe> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Reconstruction.Post.SimpleRiskScorePipe>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Reconstruction.Post.SimpleRiskScorePipe>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Reconstruction.Post.SimpleRiskScorePipe;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Reconstruction.Post.SimpleRiskScorePipe;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Reconstruction.Post.SimpleRiskScorePipe;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Reconstruction.Post.SimpleRiskScorePipe;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Reconstruction.Post.SimpleRiskScorePipe;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Reconstruction.Post.SimpleRiskScorePipe;
     ...
     * @see #fromString
     */
    static make(s: string): Reconstruction.Post.SimpleRiskScorePipe | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Reconstruction.Post.SimpleRiskScorePipe;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Reconstruction.Post.SimpleRiskScorePipe;
     ...
     */
    static cachedEmptyInst(): Reconstruction.Post.SimpleRiskScorePipe;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Reconstruction.Post.SimpleRiskScorePipe> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Reconstruction.Post.SimpleRiskScorePipe;
     ...
     */
    remakeTemplate(): Reconstruction.Post.SimpleRiskScorePipe;
     ...
     */
    withoutIdentity(): Reconstruction.Post.SimpleRiskScorePipe;
     ...
     */
    trainSync(x: , y?: , spec?: MlOperationSpec): Reconstruction.Post.SimpleRiskScorePipe;
     ...
     */
    static allCached(): Stream<Reconstruction.Post.SimpleRiskScorePipe> | null;
     ...
     */
    static find(filter?: string): Stream<Reconstruction.Post.SimpleRiskScorePipe> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<Reconstruction.Post.SimpleRiskScorePipe> | null;

    /**
     * @return cached instance.
     */
    getCached(): Reconstruction.Post.SimpleRiskScorePipe | null;

    /**
     * @return cached instance by the key.
     */
    static forCacheKey(key: string): Reconstruction.Post.SimpleRiskScorePipe | null;
     ...
     */
    static produce(key: string): Reconstruction.Post.SimpleRiskScorePipe | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, Reconstruction.Post.SimpleRiskScorePipe> | null;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Reconstruction.Post.SimpleRiskScorePipe>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Reconstruction.Post.SimpleRiskScorePipe>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Reconstruction.Post.SimpleRiskScorePipe> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Reconstruction.Post.SimpleRiskScorePipe>> | null;
     ...
     */
    get(include?: string): Reconstruction.Post.SimpleRiskScorePipe | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Reconstruction.Post.SimpleRiskScorePipe | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Reconstruction.Post.SimpleRiskScorePipe;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Reconstruction.Post.SimpleRiskScorePipe | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Reconstruction.Post.SimpleRiskScorePipe;
     ...
     * @see #toString
     */
    static fromString(s: string): Reconstruction.Post.SimpleRiskScorePipe | null;
     ...
     */
    create(spec?: UpsertSpec): Reconstruction.Post.SimpleRiskScorePipe | null;
     ...
     */
    static createBatch(objs: Array_Type<Reconstruction.Post.SimpleRiskScorePipe>, spec?: UpsertSpec): ObjList<Reconstruction.Post.SimpleRiskScorePipe> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Reconstruction.Post.SimpleRiskScorePipe>, spec?: CreateBatchObjStreamSpec): ObjList<Reconstruction.Post.SimpleRiskScorePipe> | null;
     ...
     */
    update(srcObj?: Reconstruction.Post.SimpleRiskScorePipe, spec?: UpsertSpec): Reconstruction.Post.SimpleRiskScorePipe | null;
     ...
     */
    upsert(srcObj?: Reconstruction.Post.SimpleRiskScorePipe, spec?: UpsertSpec): Reconstruction.Post.SimpleRiskScorePipe | null;
     ...
     */
    merge(spec?: MergeSpec): Reconstruction.Post.SimpleRiskScorePipe | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Reconstruction.Post.SimpleRiskScorePipe | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Reconstruction.Post.SimpleRiskScorePipe | null;
     ...
     */
    static updateBatch(objs: Array_Type<Reconstruction.Post.SimpleRiskScorePipe>, srcObjs?: Array_Type<Reconstruction.Post.SimpleRiskScorePipe>, spec?: UpsertSpec): ObjList<Reconstruction.Post.SimpleRiskScorePipe> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Reconstruction.Post.SimpleRiskScorePipe> | null>, spec?: UpsertSpec): ObjList<Reconstruction.Post.SimpleRiskScorePipe> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Reconstruction.Post.SimpleRiskScorePipe>, srcObjs?: Array_Type<Reconstruction.Post.SimpleRiskScorePipe>, spec?: UpsertSpec): ObjList<Reconstruction.Post.SimpleRiskScorePipe> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Reconstruction.Post.SimpleRiskScorePipe> | null>, spec?: UpsertSpec): ObjList<Reconstruction.Post.SimpleRiskScorePipe> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Reconstruction.Post.SimpleRiskScorePipe>, spec?: TouchSpec): ObjList<Reconstruction.Post.SimpleRiskScorePipe> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Reconstruction.Post.SimpleRiskScorePipe>, spec?: MergeSpec): ObjList<Reconstruction.Post.SimpleRiskScorePipe> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Reconstruction.Post.SimpleRiskScorePipe>, mergeInclude: string, spec?: MergeSpec): ObjList<Reconstruction.Post.SimpleRiskScorePipe> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Reconstruction.Post.SimpleRiskScorePipe> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Reconstruction.Post.SimpleRiskScorePipe> | null;
     ...
     */
    static mergeAll(mergeObj: Reconstruction.Post.SimpleRiskScorePipe, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Reconstruction.Post.SimpleRiskScorePipe, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Reconstruction.Post.SimpleRiskScorePipe>, spec?: UpsertSpec): ObjList<Reconstruction.Post.SimpleRiskScorePipe> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Reconstruction.Post.SimpleRiskScorePipe>, spec?: UpsertSpec): ObjList<Reconstruction.Post.SimpleRiskScorePipe> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Reconstruction.Post.SimpleRiskScorePipe | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Reconstruction.Post.SimpleRiskScorePipe>): ObjList<Reconstruction.Post.SimpleRiskScorePipe>;
     ...
     */
    static beforeUpdate(objs: Array_Type<Reconstruction.Post.SimpleRiskScorePipe>): ObjList<Reconstruction.Post.SimpleRiskScorePipe>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Reconstruction.Post.SimpleRiskScorePipe>): ObjList<Reconstruction.Post.SimpleRiskScorePipe>;
     ...
     */
    static afterCreate(objs: Array_Type<Reconstruction.Post.SimpleRiskScorePipe>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Reconstruction.Post.SimpleRiskScorePipe>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Reconstruction.Post.SimpleRiskScorePipe>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Reconstruction.Post.SimpleRiskScorePipe>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Reconstruction.Post.SimpleRiskScorePipe>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Reconstruction.Post.SimpleRiskScorePipe | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Reconstruction.Post.SimpleRiskScorePipe>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Reconstruction.Post.SimpleRiskScorePipe, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Reconstruction.Post.SimpleRiskScorePipe>, callback?: λFunction<Reconstruction.Post.SimpleRiskScorePipe | null, Reconstruction.Post.SimpleRiskScorePipe | null>): ObjList<Reconstruction.Post.SimpleRiskScorePipe>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Reconstruction.Post.SimpleRiskScorePipe>, callback?: λFunction<Reconstruction.Post.SimpleRiskScorePipe | null, Reconstruction.Post.SimpleRiskScorePipe | null>): Array_Type<ObjError> | null;
     ...
     */
    publish(subPath?: string, contentType?: string): Reconstruction.Post.SimpleRiskScorePipe;
     ...
     */
    static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<Reconstruction.Post.SimpleRiskScorePipe> | null;
     ...
     */
    createSeedData(spec?: UpsertSpec): Reconstruction.Post.SimpleRiskScorePipe | null;
     ...
     */
    static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<Reconstruction.Post.SimpleRiskScorePipe> | null;
     ...
     */
    updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): Reconstruction.Post.SimpleRiskScorePipe | null;
     ...
     */
    static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<Reconstruction.Post.SimpleRiskScorePipe> | null;
     ...
     * @return updated obj instance, same as {@link Persistable#update} return value.
     */
    clearUserUpdates(spec?: MergeSpec): Reconstruction.Post.SimpleRiskScorePipe | null;
     ...
     *         {@link Persistable#updateBatch}.
     */
    static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<Reconstruction.Post.SimpleRiskScorePipe> | null;
    ...
    dependencies(): SeedDataDeps<Reconstruction.Post.SimpleRiskScorePipe> | null;
     ...
     */
    static convert(model: any, spec?: MlConvertSpec): Reconstruction.Post.SimpleRiskScorePipe;

    /**
     * Freezes an {@link MlPipe}
     * @return modified copy of this {@link MlPipe} that cannot be trained
     */
    freeze(): Reconstruction.Post.SimpleRiskScorePipe;

    /**
     * Unfreezes an {@link MlPipe}
     * @return modified copy of this {@link MlPipe} that can be trained
     */
    unfreeze(): Reconstruction.Post.SimpleRiskScorePipe;
     ...
     * be returned as-is.
     */
    byReference(): Reconstruction.Post.SimpleRiskScorePipe;
     ...
     */
    updateModelFiles(modelFiles: Map_Type<string, Url>, spec?: MlOperationSpec): Reconstruction.Post.SimpleRiskScorePipe;
     ...
     */
    afterTrain(doTrainOutputs: any, spec?: MlOperationSpec): Reconstruction.Post.SimpleRiskScorePipe;
     ...
     */
    withNewSpec(spec?: MlConvertSpec): Reconstruction.Post.SimpleRiskScorePipe;
     ...
     */
    afterConvert(model: any, spec?: MlConvertSpec): Reconstruction.Post.SimpleRiskScorePipe;
     ...
     */
    withHyperparamSpaces(paramSpaces: Map_Type<string, Hp.ParamSpace>): Reconstruction.Post.SimpleRiskScorePipe;
