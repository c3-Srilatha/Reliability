// TypeScript definitions for the C3 type ReliabilityDynamicAgentConfig

/**
 * Represents the default agent config which the user will use in the side panel within the application.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityDynamicAgentConfig
 */
declare interface IReliabilityDynamicAgentConfig {
  ...
  /**
   * The ID of the agent prompt used in the dynamic agent.
   */
  agentPromptId?: string;

  /**
   *  A map from a targetPageName of a route in the application to a context string which will be passed to the agent prompt when the user uses the side panel from that page.
   *  The context string will be passed to agent prompt and will be set in the 'UI_CONTEXT' parameter of the prompt.
   *  Example: {
   * "AlertDetailConditionalRender": "User is on the alert detail page viewing content for the alert with id"
   * }
   *  Make sure to use the 'pageParamName' in the context string so that it can be replaced with the actual values stored in the page params in the application state by regex matching.
   *  In the example above, the 'id' is the page param name for the alert detail page route. These names can be inferred from the route csv file.
   */
  uiContextMap?: Map_Type<string, string> | {[key: string]: string};

  /**
   * The name of the agent that the user can interact with on the side panel within the application.
   */
 ...
 * Represents the default agent config which the user will use in the side panel within the application.
 *
 * @remarks this represents a made instance of ReliabilityDynamicAgentConfig
 */
declare class ReliabilityDynamicAgentConfig extends Obj  {

  readonly configOverride?: string;
  withConfigOverride(configOverride: string | null): ReliabilityDynamicAgentConfig;

  static readonly configOverride?: string;

  readonly secretOverride?: string;
  withSecretOverride(secretOverride: string | null): ReliabilityDynamicAgentConfig;
  ...
  withIssues(issues: Array_Type<string> | Array<string> | null): ReliabilityDynamicAgentConfig;
   ...
   * The ID of the agent prompt used in the dynamic agent.
   */
  readonly agentPromptId?: string;
  withAgentPromptId(agentPromptId: string | null): ReliabilityDynamicAgentConfig;

  /**
   * The ID of the agent prompt used in the dynamic agent.
   */
  static readonly agentPromptId?: string;
   ...
   *  In the example above, the 'id' is the page param name for the alert detail page route. These names can be inferred from the route csv file.
   */
  readonly uiContextMap?: Map_Type<string, string>;
  withUiContextMap(uiContextMap: Map_Type<string, string> | {[key: string]: string} | null): ReliabilityDynamicAgentConfig;
   ...
   *  In the example above, the 'id' is the page param name for the alert detail page route. These names can be inferred from the route csv file.
   */
  static readonly uiContextMap?: Map_Type<string, string>;

  /**
   * The name of the agent that the user can interact with on the side panel within the application.
   */
  readonly agentConfigName?: string;
  withAgentConfigName(agentConfigName: string | null): ReliabilityDynamicAgentConfig;

  /**
   * The name of the agent that the user can interact with on the side panel within the application.
   */
  static readonly agentConfigName?: string;

  /**
   * @return the one and only instance to be used when member functions are called on this type.
   */
  static inst(): ReliabilityDynamicAgentConfig;

  /**
   * @return the cached instance if already cached, null otherwise. Does not instantiate if missing.
   */
  static cachedInst(): ReliabilityDynamicAgentConfig | null;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ReliabilityDynamicAgentConfig | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ReliabilityDynamicAgentConfig | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ReliabilityDynamicAgentConfig | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ReliabilityDynamicAgentConfig | null;
   ...
   */
  replaceType(old: Type, new_: Type): ReliabilityDynamicAgentConfig;
   ...
   * This method is used during live metadata update
   */
  static replaceType(old: Type, new_: Type): ReliabilityDynamicAgentConfig;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityDynamicAgentConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityDynamicAgentConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityDynamicAgentConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilityDynamicAgentConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityDynamicAgentConfig>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityDynamicAgentConfig>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityDynamicAgentConfig>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilityDynamicAgentConfig>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityDynamicAgentConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilityDynamicAgentConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityDynamicAgentConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityDynamicAgentConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityDynamicAgentConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityDynamicAgentConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ReliabilityDynamicAgentConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  static validateObj(): ReliabilityDynamicAgentConfig;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ReliabilityDynamicAgentConfig;
   ...
   * @see #defaultField
   */
  static withField(field: string, value: any, doNotConvert?: boolean): ReliabilityDynamicAgentConfig;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityDynamicAgentConfig;
   ...
   * @see #defaultField
   */
  static withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityDynamicAgentConfig;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityDynamicAgentConfig;
   ...
   * @return new Obj
   */
  static withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilityDynamicAgentConfig;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityDynamicAgentConfig;
   ...
   * @return new Obj
   */
  static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityDynamicAgentConfig;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ReliabilityDynamicAgentConfig;
   ...
   * @see #withoutField
   */
  static withoutFieldAtPath(path: string): ReliabilityDynamicAgentConfig;
   ...
   * @see #removeField
   */
  withoutField(field: string): ReliabilityDynamicAgentConfig;
   ...
   * @see #removeField
   */
  static withoutField(field: string): ReliabilityDynamicAgentConfig;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ReliabilityDynamicAgentConfig;
   ...
   * @see #removeField
   */
  static withoutField(field: FieldType): ReliabilityDynamicAgentConfig;
   ...
   */
  withoutFields(fields: Array_Type<string>): ReliabilityDynamicAgentConfig;
   ...
   * @return new Obj with removed fields
   */
  static withoutFields(fields: Array_Type<string>): ReliabilityDynamicAgentConfig;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityDynamicAgentConfig;
   ...
   * @return new Obj with removed fields
   */
  static withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilityDynamicAgentConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ReliabilityDynamicAgentConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  static withoutSecretFields(): ReliabilityDynamicAgentConfig;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityDynamicAgentConfig;
   ...
   * @see FieldType#defaultValue
   */
  static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilityDynamicAgentConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ReliabilityDynamicAgentConfig;
   ...
   * @see #unsetField
   */
  static defaultField(field: string): ReliabilityDynamicAgentConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ReliabilityDynamicAgentConfig;
   ...
   * @see #unsetField
   */
  static defaultField(field: FieldType): ReliabilityDynamicAgentConfig;
   ...
   * @see #removeField
   */
  unsetField(field: string): ReliabilityDynamicAgentConfig;
   ...
   * @see #removeField
   */
  static unsetField(field: string): ReliabilityDynamicAgentConfig;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ReliabilityDynamicAgentConfig;
   ...
   * @see #removeField
   */
  static unsetField(field: FieldType): ReliabilityDynamicAgentConfig;
   ...
   * @see #unsetField
   */
  removeField(field: string): ReliabilityDynamicAgentConfig;
   ...
   * @see #unsetField
   */
  static removeField(field: string): ReliabilityDynamicAgentConfig;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ReliabilityDynamicAgentConfig;
   ...
   * @see #unsetField
   */
  static removeField(field: FieldType): ReliabilityDynamicAgentConfig;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityDynamicAgentConfig;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilityDynamicAgentConfig;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityDynamicAgentConfig;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilityDynamicAgentConfig;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityDynamicAgentConfig;
   ...
   *        the same key or index.
   */
  static mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilityDynamicAgentConfig;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityDynamicAgentConfig;
   ...
   * traverse child reference and collection fields.
   */
  static mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilityDynamicAgentConfig;

  mergeJson(json: any): ReliabilityDynamicAgentConfig;

  static mergeJson(json: any): ReliabilityDynamicAgentConfig;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityDynamicAgentConfig;
   ...
   * @return Obj with child references merged
   */
  static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilityDynamicAgentConfig;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ReliabilityDynamicAgentConfig;
   ...
   * references with same name and collection elements at same index or key.
   */
  static sumObj(other: Obj, deep?: boolean): ReliabilityDynamicAgentConfig;
   ...
   */
  singletonArray(): Array_Type<ReliabilityDynamicAgentConfig>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonArray(): Array_Type<ReliabilityDynamicAgentConfig>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ReliabilityDynamicAgentConfig> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ReliabilityDynamicAgentConfig> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ReliabilityDynamicAgentConfig>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonSet(): Set_Type<ReliabilityDynamicAgentConfig>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ReliabilityDynamicAgentConfig> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ReliabilityDynamicAgentConfig> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityDynamicAgentConfig> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ReliabilityDynamicAgentConfig>;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  static toBuilder(): ObjBuilder<ReliabilityDynamicAgentConfig>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ReliabilityDynamicAgentConfig>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilityDynamicAgentConfig;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilityDynamicAgentConfig;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilityDynamicAgentConfig;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ReliabilityDynamicAgentConfig;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilityDynamicAgentConfig;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ReliabilityDynamicAgentConfig;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilityDynamicAgentConfig;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ReliabilityDynamicAgentConfig;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  static afterMake(): ReliabilityDynamicAgentConfig;
   ...
   */
  static cachedEmptyInst(): ReliabilityDynamicAgentConfig;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilityDynamicAgentConfig> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ReliabilityDynamicAgentConfig;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<ReliabilityDynamicAgentConfig> | null;
   ...
   */
  static find(filter?: string, doNotProduceAll?: boolean): Stream<ReliabilityDynamicAgentConfig> | null;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<ReliabilityDynamicAgentConfig> | null;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): ReliabilityDynamicAgentConfig | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string): ReliabilityDynamicAgentConfig | null;
   ...
   * @see findByCacheKey
   */
  getCached(): ReliabilityDynamicAgentConfig | null;
   ...
   * @see findByCacheKey
   */
  static getCached(): ReliabilityDynamicAgentConfig | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): ReliabilityDynamicAgentConfig | null;

  /**
   * @return newly produced cached instance.
   */
  static refreshCache(): ReliabilityDynamicAgentConfig | null;
   ...
   */
  static produce(key: string): ReliabilityDynamicAgentConfig | null;
   ...
   */
  static produceAll(): Map_Type<string, ReliabilityDynamicAgentConfig> | null;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): Map_Type<string, ReliabilityDynamicAgentConfig> | null;
   ...
   */
  getConfig(): ReliabilityDynamicAgentConfig;
   ...
   * Note that typical pattern is to use Configurable#config instead of this method.
   */
  static getConfig(): ReliabilityDynamicAgentConfig;
   ...
   */
  getSecret(): ReliabilityDynamicAgentConfig;
   ...
   * Note that typical pattern is to use Configurable#configWithSecrets instead of this method.
   */
  static getSecret(): ReliabilityDynamicAgentConfig;
   ...
   */
  withConfigKey(configKey: string): ReliabilityDynamicAgentConfig;
   ...
   *     config.configKey() => "folder1/abc"
   */
  static withConfigKey(configKey: string): ReliabilityDynamicAgentConfig;

  /**
   * @return copy without config key.
   */
  withoutConfigKey(): ReliabilityDynamicAgentConfig;

  /**
   * @return copy without config key.
   */
  static withoutConfigKey(): ReliabilityDynamicAgentConfig;

  /**
   * @return return cached config instance for provided config key.
   */
  static forConfigKey(configKey: string): ReliabilityDynamicAgentConfig | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string>): Stream<ReliabilityDynamicAgentConfig> | null;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: ReliabilityDynamicAgentConfig, override?: string): void;

  /**
   * Sets multiple field values to be the same as the passed instance.
   * @see setConfigValue
   */
  static setConfigValues(from: ReliabilityDynamicAgentConfig, override?: string): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: ReliabilityDynamicAgentConfig, override?: string): void;

  /**
   * Sets multiple secret field values to be the same as the passed instance.
   * @see setSecretValue
   */
  static setSecretValues(from: ReliabilityDynamicAgentConfig, override?: string): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): ReliabilityDynamicAgentConfig | null;
   ...
   */
  removeSecrets(): ReliabilityDynamicAgentConfig | null;

  /**
   * @return this config without any secret values.
   */
  static removeSecrets(): ReliabilityDynamicAgentConfig | null;

  /**
   * @return this config with only secret values.
   */
  removeNonSecrets(): ReliabilityDynamicAgentConfig | null;

  /**
   * @return this config with only secret values.
   */
  static removeNonSecrets(): ReliabilityDynamicAgentConfig | null;

  /**
   * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
   * validation and setup.
   */
  validate(): ReliabilityDynamicAgentConfig;

  /**
   * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
   * validation and setup.
   */
  static validate(): ReliabilityDynamicAgentConfig;
