// TypeScript definitions for the C3 type TargetExampleMultiLayer3

/**
 * This is an example Canonical used for testing BaseCanonicalTester package.
 *
 * @remarks this represents a value passed to a method that expects an instance of TargetExampleMultiLayer3
 */
declare interface ITargetExampleMultiLayer3 {
   ...
   */
  referenceType?: ICanonicalExample;
 ...
 */
declare class TargetExampleMultiLayer3 extends Obj  {
   ...
   */
  readonly id: string;
  withId(id: string): TargetExampleMultiLayer3;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): TargetExampleMultiLayer3;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): TargetExampleMultiLayer3;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): TargetExampleMultiLayer3;
  ...
  withVersion(version: number | null): TargetExampleMultiLayer3;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): TargetExampleMultiLayer3;

  /**
   * The name of the example.
   */
  readonly referenceType?: CanonicalExample;
  withReferenceType(referenceType: ICanonicalExample | null): TargetExampleMultiLayer3;

  /**
   * The unique identifier of the example.
   */
  readonly uniqueId?: string;
  withUniqueId(uniqueId: string | null): TargetExampleMultiLayer3;
   ...
   * @see #toJson
   */
  static fromJson(json: any): TargetExampleMultiLayer3 | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): TargetExampleMultiLayer3 | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): TargetExampleMultiLayer3 | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): TargetExampleMultiLayer3 | null;
   ...
   */
  replaceType(old: Type, new_: Type): TargetExampleMultiLayer3;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): TargetExampleMultiLayer3;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): TargetExampleMultiLayer3;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<TargetExampleMultiLayer3>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<TargetExampleMultiLayer3>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): TargetExampleMultiLayer3;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TargetExampleMultiLayer3;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TargetExampleMultiLayer3;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): TargetExampleMultiLayer3;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): TargetExampleMultiLayer3;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): TargetExampleMultiLayer3;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): TargetExampleMultiLayer3;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): TargetExampleMultiLayer3;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): TargetExampleMultiLayer3;
   ...
   * @see #removeField
   */
  withoutField(field: string): TargetExampleMultiLayer3;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): TargetExampleMultiLayer3;
   ...
   */
  withoutFields(fields: Array_Type<string>): TargetExampleMultiLayer3;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): TargetExampleMultiLayer3;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): TargetExampleMultiLayer3;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): TargetExampleMultiLayer3;
   ...
   * @see #unsetField
   */
  defaultField(field: string): TargetExampleMultiLayer3;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): TargetExampleMultiLayer3;
   ...
   * @see #removeField
   */
  unsetField(field: string): TargetExampleMultiLayer3;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): TargetExampleMultiLayer3;
   ...
   * @see #unsetField
   */
  removeField(field: string): TargetExampleMultiLayer3;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): TargetExampleMultiLayer3;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): TargetExampleMultiLayer3;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): TargetExampleMultiLayer3;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): TargetExampleMultiLayer3;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): TargetExampleMultiLayer3;

  mergeJson(json: any): TargetExampleMultiLayer3;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): TargetExampleMultiLayer3;
   ...
   */
  sumObj(other: Obj, deep?: boolean): TargetExampleMultiLayer3;
   ...
   */
  singletonArray(): Array_Type<TargetExampleMultiLayer3>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<TargetExampleMultiLayer3> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<TargetExampleMultiLayer3> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<TargetExampleMultiLayer3>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<TargetExampleMultiLayer3> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, TargetExampleMultiLayer3> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, TargetExampleMultiLayer3> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<TargetExampleMultiLayer3>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<TargetExampleMultiLayer3>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): TargetExampleMultiLayer3;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): TargetExampleMultiLayer3;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): TargetExampleMultiLayer3;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): TargetExampleMultiLayer3;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): TargetExampleMultiLayer3;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): TargetExampleMultiLayer3;
   ...
   * @see #fromString
   */
  static make(s: string): TargetExampleMultiLayer3 | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): TargetExampleMultiLayer3;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): TargetExampleMultiLayer3;
   ...
   */
  static cachedEmptyInst(): TargetExampleMultiLayer3;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<TargetExampleMultiLayer3> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): TargetExampleMultiLayer3;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<TargetExampleMultiLayer3>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<TargetExampleMultiLayer3>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<TargetExampleMultiLayer3> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<TargetExampleMultiLayer3>> | null;
   ...
   */
  get(include?: string): TargetExampleMultiLayer3 | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): TargetExampleMultiLayer3 | null;
   ...
   */
  getMissing(spec: GetMissingSpec): TargetExampleMultiLayer3;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): TargetExampleMultiLayer3 | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): TargetExampleMultiLayer3;
   ...
   * @see #toString
   */
  static fromString(s: string): TargetExampleMultiLayer3 | null;
   ...
   */
  create(spec?: UpsertSpec): TargetExampleMultiLayer3 | null;
   ...
   */
  static createBatch(objs: Array_Type<TargetExampleMultiLayer3>, spec?: UpsertSpec): ObjList<TargetExampleMultiLayer3> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<TargetExampleMultiLayer3>, spec?: CreateBatchObjStreamSpec): ObjList<TargetExampleMultiLayer3> | null;
   ...
   */
  update(srcObj?: TargetExampleMultiLayer3, spec?: UpsertSpec): TargetExampleMultiLayer3 | null;
   ...
   */
  upsert(srcObj?: TargetExampleMultiLayer3, spec?: UpsertSpec): TargetExampleMultiLayer3 | null;
   ...
   */
  merge(spec?: MergeSpec): TargetExampleMultiLayer3 | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): TargetExampleMultiLayer3 | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): TargetExampleMultiLayer3 | null;
   ...
   */
  static updateBatch(objs: Array_Type<TargetExampleMultiLayer3>, srcObjs?: Array_Type<TargetExampleMultiLayer3>, spec?: UpsertSpec): ObjList<TargetExampleMultiLayer3> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<TargetExampleMultiLayer3> | null>, spec?: UpsertSpec): ObjList<TargetExampleMultiLayer3> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<TargetExampleMultiLayer3>, srcObjs?: Array_Type<TargetExampleMultiLayer3>, spec?: UpsertSpec): ObjList<TargetExampleMultiLayer3> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<TargetExampleMultiLayer3> | null>, spec?: UpsertSpec): ObjList<TargetExampleMultiLayer3> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<TargetExampleMultiLayer3>, spec?: TouchSpec): ObjList<TargetExampleMultiLayer3> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<TargetExampleMultiLayer3>, spec?: MergeSpec): ObjList<TargetExampleMultiLayer3> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<TargetExampleMultiLayer3>, mergeInclude: string, spec?: MergeSpec): ObjList<TargetExampleMultiLayer3> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<TargetExampleMultiLayer3> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<TargetExampleMultiLayer3> | null;
   ...
   */
  static mergeAll(mergeObj: TargetExampleMultiLayer3, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: TargetExampleMultiLayer3, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<TargetExampleMultiLayer3>, spec?: UpsertSpec): ObjList<TargetExampleMultiLayer3> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<TargetExampleMultiLayer3>, spec?: UpsertSpec): ObjList<TargetExampleMultiLayer3> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): TargetExampleMultiLayer3 | null;
   ...
   */
  static beforeCreate(objs: Array_Type<TargetExampleMultiLayer3>): ObjList<TargetExampleMultiLayer3>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<TargetExampleMultiLayer3>): ObjList<TargetExampleMultiLayer3>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<TargetExampleMultiLayer3>): ObjList<TargetExampleMultiLayer3>;
   ...
   */
  static afterCreate(objs: Array_Type<TargetExampleMultiLayer3>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<TargetExampleMultiLayer3>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<TargetExampleMultiLayer3>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<TargetExampleMultiLayer3>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<TargetExampleMultiLayer3>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): TargetExampleMultiLayer3 | null;
   ...
   */
  withoutIdentity(): TargetExampleMultiLayer3 | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<TargetExampleMultiLayer3>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: TargetExampleMultiLayer3, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<TargetExampleMultiLayer3>, callback?: λFunction<TargetExampleMultiLayer3 | null, TargetExampleMultiLayer3 | null>): ObjList<TargetExampleMultiLayer3>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<TargetExampleMultiLayer3>, callback?: λFunction<TargetExampleMultiLayer3 | null, TargetExampleMultiLayer3 | null>): Array_Type<ObjError> | null;
