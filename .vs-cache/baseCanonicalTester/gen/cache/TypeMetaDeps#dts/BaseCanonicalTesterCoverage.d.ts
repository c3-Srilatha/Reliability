// TypeScript definitions for the C3 type BaseCanonicalTesterCoverage
 ...
 * the transform.
 *
 * @remarks this represents a value passed to a method that expects an instance of BaseCanonicalTesterCoverage
 */
declare interface IBaseCanonicalTesterCoverage {
 ...
 */
declare class BaseCanonicalTesterCoverage extends Obj  {
   ...
   */
  readonly id: string;
  withId(id: string): BaseCanonicalTesterCoverage;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): BaseCanonicalTesterCoverage;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): BaseCanonicalTesterCoverage;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): BaseCanonicalTesterCoverage;
  ...
  withVersion(version: number | null): BaseCanonicalTesterCoverage;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): BaseCanonicalTesterCoverage;

  /**
   * The source type that we are validating coverage against.
   */
  readonly sourceType: string;
  withSourceType(sourceType: string): BaseCanonicalTesterCoverage;

  /**
   * The target type that we are validating coverage against.
   */
  readonly targetType: string;
  withTargetType(targetType: string): BaseCanonicalTesterCoverage;

  /**
   * If test coverage is complete for the {@link transformName}.
   */
  readonly testCoverageComplete: boolean;
  withTestCoverageComplete(testCoverageComplete: boolean): BaseCanonicalTesterCoverage;

  /**
   * If test coverage is complete for the {@link transformName}.
   */
  readonly status?: string;
  withStatus(status: string | null): BaseCanonicalTesterCoverage;

  /**
   * The fields that are missing from the test coverage.
   */
  readonly transformName: string;
  withTransformName(transformName: string): BaseCanonicalTesterCoverage;
   ...
   * @see #toJson
   */
  static fromJson(json: any): BaseCanonicalTesterCoverage | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): BaseCanonicalTesterCoverage | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): BaseCanonicalTesterCoverage | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): BaseCanonicalTesterCoverage | null;
   ...
   */
  replaceType(old: Type, new_: Type): BaseCanonicalTesterCoverage;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): BaseCanonicalTesterCoverage;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): BaseCanonicalTesterCoverage;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<BaseCanonicalTesterCoverage>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<BaseCanonicalTesterCoverage>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): BaseCanonicalTesterCoverage;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): BaseCanonicalTesterCoverage;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): BaseCanonicalTesterCoverage;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): BaseCanonicalTesterCoverage;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): BaseCanonicalTesterCoverage;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): BaseCanonicalTesterCoverage;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): BaseCanonicalTesterCoverage;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): BaseCanonicalTesterCoverage;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): BaseCanonicalTesterCoverage;
   ...
   * @see #removeField
   */
  withoutField(field: string): BaseCanonicalTesterCoverage;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): BaseCanonicalTesterCoverage;
   ...
   */
  withoutFields(fields: Array_Type<string>): BaseCanonicalTesterCoverage;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): BaseCanonicalTesterCoverage;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): BaseCanonicalTesterCoverage;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): BaseCanonicalTesterCoverage;
   ...
   * @see #unsetField
   */
  defaultField(field: string): BaseCanonicalTesterCoverage;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): BaseCanonicalTesterCoverage;
   ...
   * @see #removeField
   */
  unsetField(field: string): BaseCanonicalTesterCoverage;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): BaseCanonicalTesterCoverage;
   ...
   * @see #unsetField
   */
  removeField(field: string): BaseCanonicalTesterCoverage;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): BaseCanonicalTesterCoverage;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): BaseCanonicalTesterCoverage;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): BaseCanonicalTesterCoverage;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): BaseCanonicalTesterCoverage;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): BaseCanonicalTesterCoverage;

  mergeJson(json: any): BaseCanonicalTesterCoverage;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): BaseCanonicalTesterCoverage;
   ...
   */
  sumObj(other: Obj, deep?: boolean): BaseCanonicalTesterCoverage;
   ...
   */
  singletonArray(): Array_Type<BaseCanonicalTesterCoverage>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<BaseCanonicalTesterCoverage> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<BaseCanonicalTesterCoverage> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<BaseCanonicalTesterCoverage>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<BaseCanonicalTesterCoverage> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, BaseCanonicalTesterCoverage> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, BaseCanonicalTesterCoverage> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<BaseCanonicalTesterCoverage>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<BaseCanonicalTesterCoverage>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): BaseCanonicalTesterCoverage;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): BaseCanonicalTesterCoverage;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): BaseCanonicalTesterCoverage;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): BaseCanonicalTesterCoverage;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): BaseCanonicalTesterCoverage;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): BaseCanonicalTesterCoverage;
   ...
   * @see #fromString
   */
  static make(s: string): BaseCanonicalTesterCoverage | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): BaseCanonicalTesterCoverage;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): BaseCanonicalTesterCoverage;
   ...
   */
  static cachedEmptyInst(): BaseCanonicalTesterCoverage;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<BaseCanonicalTesterCoverage> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): BaseCanonicalTesterCoverage;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<BaseCanonicalTesterCoverage>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<BaseCanonicalTesterCoverage>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<BaseCanonicalTesterCoverage> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<BaseCanonicalTesterCoverage>> | null;
   ...
   */
  get(include?: string): BaseCanonicalTesterCoverage | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): BaseCanonicalTesterCoverage | null;
   ...
   */
  getMissing(spec: GetMissingSpec): BaseCanonicalTesterCoverage;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): BaseCanonicalTesterCoverage | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): BaseCanonicalTesterCoverage;
   ...
   * @see #toString
   */
  static fromString(s: string): BaseCanonicalTesterCoverage | null;
   ...
   */
  create(spec?: UpsertSpec): BaseCanonicalTesterCoverage | null;
   ...
   */
  static createBatch(objs: Array_Type<BaseCanonicalTesterCoverage>, spec?: UpsertSpec): ObjList<BaseCanonicalTesterCoverage> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<BaseCanonicalTesterCoverage>, spec?: CreateBatchObjStreamSpec): ObjList<BaseCanonicalTesterCoverage> | null;
   ...
   */
  update(srcObj?: BaseCanonicalTesterCoverage, spec?: UpsertSpec): BaseCanonicalTesterCoverage | null;
   ...
   */
  upsert(srcObj?: BaseCanonicalTesterCoverage, spec?: UpsertSpec): BaseCanonicalTesterCoverage | null;
   ...
   */
  merge(spec?: MergeSpec): BaseCanonicalTesterCoverage | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): BaseCanonicalTesterCoverage | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): BaseCanonicalTesterCoverage | null;
   ...
   */
  static updateBatch(objs: Array_Type<BaseCanonicalTesterCoverage>, srcObjs?: Array_Type<BaseCanonicalTesterCoverage>, spec?: UpsertSpec): ObjList<BaseCanonicalTesterCoverage> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<BaseCanonicalTesterCoverage> | null>, spec?: UpsertSpec): ObjList<BaseCanonicalTesterCoverage> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<BaseCanonicalTesterCoverage>, srcObjs?: Array_Type<BaseCanonicalTesterCoverage>, spec?: UpsertSpec): ObjList<BaseCanonicalTesterCoverage> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<BaseCanonicalTesterCoverage> | null>, spec?: UpsertSpec): ObjList<BaseCanonicalTesterCoverage> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<BaseCanonicalTesterCoverage>, spec?: TouchSpec): ObjList<BaseCanonicalTesterCoverage> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<BaseCanonicalTesterCoverage>, spec?: MergeSpec): ObjList<BaseCanonicalTesterCoverage> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<BaseCanonicalTesterCoverage>, mergeInclude: string, spec?: MergeSpec): ObjList<BaseCanonicalTesterCoverage> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<BaseCanonicalTesterCoverage> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<BaseCanonicalTesterCoverage> | null;
   ...
   */
  static mergeAll(mergeObj: BaseCanonicalTesterCoverage, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: BaseCanonicalTesterCoverage, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<BaseCanonicalTesterCoverage>, spec?: UpsertSpec): ObjList<BaseCanonicalTesterCoverage> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<BaseCanonicalTesterCoverage>, spec?: UpsertSpec): ObjList<BaseCanonicalTesterCoverage> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): BaseCanonicalTesterCoverage | null;
   ...
   */
  static beforeCreate(objs: Array_Type<BaseCanonicalTesterCoverage>): ObjList<BaseCanonicalTesterCoverage>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<BaseCanonicalTesterCoverage>): ObjList<BaseCanonicalTesterCoverage>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<BaseCanonicalTesterCoverage>): ObjList<BaseCanonicalTesterCoverage>;
   ...
   */
  static afterCreate(objs: Array_Type<BaseCanonicalTesterCoverage>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<BaseCanonicalTesterCoverage>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<BaseCanonicalTesterCoverage>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<BaseCanonicalTesterCoverage>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<BaseCanonicalTesterCoverage>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): BaseCanonicalTesterCoverage | null;
   ...
   */
  withoutIdentity(): BaseCanonicalTesterCoverage | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<BaseCanonicalTesterCoverage>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: BaseCanonicalTesterCoverage, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<BaseCanonicalTesterCoverage>, callback?: λFunction<BaseCanonicalTesterCoverage | null, BaseCanonicalTesterCoverage | null>): ObjList<BaseCanonicalTesterCoverage>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<BaseCanonicalTesterCoverage>, callback?: λFunction<BaseCanonicalTesterCoverage | null, BaseCanonicalTesterCoverage | null>): Array_Type<ObjError> | null;
   ...
   */
  static persistTestCoverage(results?: Array_Type<BaseCanonicalTesterResults>): Array_Type<BaseCanonicalTesterCoverage> | null;
}
