// TypeScript definitions for the C3 type TargetExampleMultiLayer1

/**
 * This is an example Canonical used for testing BaseCanonicalTester package.
 *
 * @remarks this represents a value passed to a method that expects an instance of TargetExampleMultiLayer1
 */
declare interface ITargetExampleMultiLayer1 {
 ...
 */
declare class TargetExampleMultiLayer1 extends Obj  {
   ...
   */
  readonly id: string;
  withId(id: string): TargetExampleMultiLayer1;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): TargetExampleMultiLayer1;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): TargetExampleMultiLayer1;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): TargetExampleMultiLayer1;
  ...
  withVersion(version: number | null): TargetExampleMultiLayer1;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): TargetExampleMultiLayer1;

  /**
   * The value.
   */
  readonly value?: number;
  withValue(value: number | null): TargetExampleMultiLayer1;
   ...
   * @see #toJson
   */
  static fromJson(json: any): TargetExampleMultiLayer1 | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): TargetExampleMultiLayer1 | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): TargetExampleMultiLayer1 | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): TargetExampleMultiLayer1 | null;
   ...
   */
  replaceType(old: Type, new_: Type): TargetExampleMultiLayer1;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): TargetExampleMultiLayer1;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): TargetExampleMultiLayer1;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<TargetExampleMultiLayer1>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<TargetExampleMultiLayer1>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): TargetExampleMultiLayer1;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TargetExampleMultiLayer1;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TargetExampleMultiLayer1;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): TargetExampleMultiLayer1;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): TargetExampleMultiLayer1;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): TargetExampleMultiLayer1;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): TargetExampleMultiLayer1;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): TargetExampleMultiLayer1;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): TargetExampleMultiLayer1;
   ...
   * @see #removeField
   */
  withoutField(field: string): TargetExampleMultiLayer1;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): TargetExampleMultiLayer1;
   ...
   */
  withoutFields(fields: Array_Type<string>): TargetExampleMultiLayer1;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): TargetExampleMultiLayer1;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): TargetExampleMultiLayer1;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): TargetExampleMultiLayer1;
   ...
   * @see #unsetField
   */
  defaultField(field: string): TargetExampleMultiLayer1;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): TargetExampleMultiLayer1;
   ...
   * @see #removeField
   */
  unsetField(field: string): TargetExampleMultiLayer1;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): TargetExampleMultiLayer1;
   ...
   * @see #unsetField
   */
  removeField(field: string): TargetExampleMultiLayer1;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): TargetExampleMultiLayer1;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): TargetExampleMultiLayer1;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): TargetExampleMultiLayer1;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): TargetExampleMultiLayer1;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): TargetExampleMultiLayer1;

  mergeJson(json: any): TargetExampleMultiLayer1;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): TargetExampleMultiLayer1;
   ...
   */
  sumObj(other: Obj, deep?: boolean): TargetExampleMultiLayer1;
   ...
   */
  singletonArray(): Array_Type<TargetExampleMultiLayer1>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<TargetExampleMultiLayer1> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<TargetExampleMultiLayer1> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<TargetExampleMultiLayer1>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<TargetExampleMultiLayer1> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, TargetExampleMultiLayer1> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, TargetExampleMultiLayer1> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<TargetExampleMultiLayer1>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<TargetExampleMultiLayer1>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): TargetExampleMultiLayer1;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): TargetExampleMultiLayer1;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): TargetExampleMultiLayer1;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): TargetExampleMultiLayer1;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): TargetExampleMultiLayer1;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): TargetExampleMultiLayer1;
   ...
   * @see #fromString
   */
  static make(s: string): TargetExampleMultiLayer1 | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): TargetExampleMultiLayer1;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): TargetExampleMultiLayer1;
   ...
   */
  static cachedEmptyInst(): TargetExampleMultiLayer1;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<TargetExampleMultiLayer1> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): TargetExampleMultiLayer1;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<TargetExampleMultiLayer1>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<TargetExampleMultiLayer1>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<TargetExampleMultiLayer1> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<TargetExampleMultiLayer1>> | null;
   ...
   */
  get(include?: string): TargetExampleMultiLayer1 | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): TargetExampleMultiLayer1 | null;
   ...
   */
  getMissing(spec: GetMissingSpec): TargetExampleMultiLayer1;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): TargetExampleMultiLayer1 | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): TargetExampleMultiLayer1;
   ...
   * @see #toString
   */
  static fromString(s: string): TargetExampleMultiLayer1 | null;
   ...
   */
  create(spec?: UpsertSpec): TargetExampleMultiLayer1 | null;
   ...
   */
  static createBatch(objs: Array_Type<TargetExampleMultiLayer1>, spec?: UpsertSpec): ObjList<TargetExampleMultiLayer1> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<TargetExampleMultiLayer1>, spec?: CreateBatchObjStreamSpec): ObjList<TargetExampleMultiLayer1> | null;
   ...
   */
  update(srcObj?: TargetExampleMultiLayer1, spec?: UpsertSpec): TargetExampleMultiLayer1 | null;
   ...
   */
  upsert(srcObj?: TargetExampleMultiLayer1, spec?: UpsertSpec): TargetExampleMultiLayer1 | null;
   ...
   */
  merge(spec?: MergeSpec): TargetExampleMultiLayer1 | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): TargetExampleMultiLayer1 | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): TargetExampleMultiLayer1 | null;
   ...
   */
  static updateBatch(objs: Array_Type<TargetExampleMultiLayer1>, srcObjs?: Array_Type<TargetExampleMultiLayer1>, spec?: UpsertSpec): ObjList<TargetExampleMultiLayer1> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<TargetExampleMultiLayer1> | null>, spec?: UpsertSpec): ObjList<TargetExampleMultiLayer1> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<TargetExampleMultiLayer1>, srcObjs?: Array_Type<TargetExampleMultiLayer1>, spec?: UpsertSpec): ObjList<TargetExampleMultiLayer1> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<TargetExampleMultiLayer1> | null>, spec?: UpsertSpec): ObjList<TargetExampleMultiLayer1> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<TargetExampleMultiLayer1>, spec?: TouchSpec): ObjList<TargetExampleMultiLayer1> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<TargetExampleMultiLayer1>, spec?: MergeSpec): ObjList<TargetExampleMultiLayer1> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<TargetExampleMultiLayer1>, mergeInclude: string, spec?: MergeSpec): ObjList<TargetExampleMultiLayer1> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<TargetExampleMultiLayer1> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<TargetExampleMultiLayer1> | null;
   ...
   */
  static mergeAll(mergeObj: TargetExampleMultiLayer1, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: TargetExampleMultiLayer1, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<TargetExampleMultiLayer1>, spec?: UpsertSpec): ObjList<TargetExampleMultiLayer1> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<TargetExampleMultiLayer1>, spec?: UpsertSpec): ObjList<TargetExampleMultiLayer1> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): TargetExampleMultiLayer1 | null;
   ...
   */
  static beforeCreate(objs: Array_Type<TargetExampleMultiLayer1>): ObjList<TargetExampleMultiLayer1>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<TargetExampleMultiLayer1>): ObjList<TargetExampleMultiLayer1>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<TargetExampleMultiLayer1>): ObjList<TargetExampleMultiLayer1>;
   ...
   */
  static afterCreate(objs: Array_Type<TargetExampleMultiLayer1>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<TargetExampleMultiLayer1>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<TargetExampleMultiLayer1>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<TargetExampleMultiLayer1>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<TargetExampleMultiLayer1>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): TargetExampleMultiLayer1 | null;
   ...
   */
  withoutIdentity(): TargetExampleMultiLayer1 | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<TargetExampleMultiLayer1>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: TargetExampleMultiLayer1, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<TargetExampleMultiLayer1>, callback?: λFunction<TargetExampleMultiLayer1 | null, TargetExampleMultiLayer1 | null>): ObjList<TargetExampleMultiLayer1>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<TargetExampleMultiLayer1>, callback?: λFunction<TargetExampleMultiLayer1 | null, TargetExampleMultiLayer1 | null>): Array_Type<ObjError> | null;
