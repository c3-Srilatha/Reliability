// TypeScript definitions for the C3 type BaseCanonicalTester.Config

/**
 * Folder path configurations for BaseCanonicalTester.
 *
 * @remarks this represents a value passed to a method that expects an instance of BaseCanonicalTester.Config
 */
declare namespace BaseCanonicalTester {
...
declare namespace BaseCanonicalTester {
  export class Config extends Obj  {
    ...
    withConfigOverride(configOverride: string | null): BaseCanonicalTester.Config;

    static readonly configOverride?: string;

    readonly secretOverride?: string;
    withSecretOverride(secretOverride: string | null): BaseCanonicalTester.Config;
    ...
    withIssues(issues: Array_Type<string> | Array<string> | null): BaseCanonicalTester.Config;
     ...
     * Relative path to the canonical test directory within the package.
     */
    readonly pathToCanonicalDir?: string;
    withPathToCanonicalDir(pathToCanonicalDir: string | null): BaseCanonicalTester.Config;

    /**
     * Relative path to the canonical test directory within the package.
     */
    static readonly pathToCanonicalDir?: string;

    /**
     * The input sub-folder name for the test canonical source files.
     */
    readonly inputDirName?: string;
    withInputDirName(inputDirName: string | null): BaseCanonicalTester.Config;

    /**
     * The input sub-folder name for the test canonical source files.
     */
    static readonly inputDirName?: string;

    /**
     * The expected sub-folder for the test canonical target files.
     */
    readonly expectedDirName?: string;
    withExpectedDirName(expectedDirName: string | null): BaseCanonicalTester.Config;

    /**
     * The expected sub-folder for the test canonical target files.
     */
    static readonly expectedDirName?: string;
     ...
     * @see #toJson
     */
    static fromJson(json: any): BaseCanonicalTester.Config | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): BaseCanonicalTester.Config | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): BaseCanonicalTester.Config | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): BaseCanonicalTester.Config | null;
     ...
     */
    replaceType(old: Type, new_: Type): BaseCanonicalTester.Config;
     ...
     * This method is used during live metadata update
     */
    static replaceType(old: Type, new_: Type): BaseCanonicalTester.Config;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): BaseCanonicalTester.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): BaseCanonicalTester.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): BaseCanonicalTester.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): BaseCanonicalTester.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<BaseCanonicalTester.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<BaseCanonicalTester.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<BaseCanonicalTester.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<BaseCanonicalTester.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): BaseCanonicalTester.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): BaseCanonicalTester.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): BaseCanonicalTester.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): BaseCanonicalTester.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): BaseCanonicalTester.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): BaseCanonicalTester.Config;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): BaseCanonicalTester.Config;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    static validateObj(): BaseCanonicalTester.Config;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): BaseCanonicalTester.Config;
     ...
     * @see #defaultField
     */
    static withField(field: string, value: any, doNotConvert?: boolean): BaseCanonicalTester.Config;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): BaseCanonicalTester.Config;
     ...
     * @see #defaultField
     */
    static withField(field: FieldType, value: any, doNotConvert?: boolean): BaseCanonicalTester.Config;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): BaseCanonicalTester.Config;
     ...
     * @return new Obj
     */
    static withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): BaseCanonicalTester.Config;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): BaseCanonicalTester.Config;
     ...
     * @return new Obj
     */
    static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): BaseCanonicalTester.Config;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): BaseCanonicalTester.Config;
     ...
     * @see #withoutField
     */
    static withoutFieldAtPath(path: string): BaseCanonicalTester.Config;
     ...
     * @see #removeField
     */
    withoutField(field: string): BaseCanonicalTester.Config;
     ...
     * @see #removeField
     */
    static withoutField(field: string): BaseCanonicalTester.Config;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): BaseCanonicalTester.Config;
     ...
     * @see #removeField
     */
    static withoutField(field: FieldType): BaseCanonicalTester.Config;
     ...
     */
    withoutFields(fields: Array_Type<string>): BaseCanonicalTester.Config;
     ...
     * @return new Obj with removed fields
     */
    static withoutFields(fields: Array_Type<string>): BaseCanonicalTester.Config;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): BaseCanonicalTester.Config;
     ...
     * @return new Obj with removed fields
     */
    static withoutFieldsByType(fields: Array_Type<FieldType>): BaseCanonicalTester.Config;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): BaseCanonicalTester.Config;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    static withoutSecretFields(): BaseCanonicalTester.Config;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): BaseCanonicalTester.Config;
     ...
     * @see FieldType#defaultValue
     */
    static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): BaseCanonicalTester.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: string): BaseCanonicalTester.Config;
     ...
     * @see #unsetField
     */
    static defaultField(field: string): BaseCanonicalTester.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): BaseCanonicalTester.Config;
     ...
     * @see #unsetField
     */
    static defaultField(field: FieldType): BaseCanonicalTester.Config;
     ...
     * @see #removeField
     */
    unsetField(field: string): BaseCanonicalTester.Config;
     ...
     * @see #removeField
     */
    static unsetField(field: string): BaseCanonicalTester.Config;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): BaseCanonicalTester.Config;
     ...
     * @see #removeField
     */
    static unsetField(field: FieldType): BaseCanonicalTester.Config;
     ...
     * @see #unsetField
     */
    removeField(field: string): BaseCanonicalTester.Config;
     ...
     * @see #unsetField
     */
    static removeField(field: string): BaseCanonicalTester.Config;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): BaseCanonicalTester.Config;
     ...
     * @see #unsetField
     */
    static removeField(field: FieldType): BaseCanonicalTester.Config;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): BaseCanonicalTester.Config;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): BaseCanonicalTester.Config;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): BaseCanonicalTester.Config;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj, otherFieldsFilter: Type): BaseCanonicalTester.Config;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): BaseCanonicalTester.Config;
     ...
     *        the same key or index.
     */
    static mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): BaseCanonicalTester.Config;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): BaseCanonicalTester.Config;
     ...
     * traverse child reference and collection fields.
     */
    static mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): BaseCanonicalTester.Config;

    mergeJson(json: any): BaseCanonicalTester.Config;

    static mergeJson(json: any): BaseCanonicalTester.Config;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): BaseCanonicalTester.Config;
     ...
     * @return Obj with child references merged
     */
    static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): BaseCanonicalTester.Config;
     ...
     */
    sumObj(other: Obj, deep?: boolean): BaseCanonicalTester.Config;
     ...
     * references with same name and collection elements at same index or key.
     */
    static sumObj(other: Obj, deep?: boolean): BaseCanonicalTester.Config;
     ...
     */
    singletonArray(): Array_Type<BaseCanonicalTester.Config>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonArray(): Array_Type<BaseCanonicalTester.Config>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<BaseCanonicalTester.Config> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<BaseCanonicalTester.Config> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<BaseCanonicalTester.Config>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonSet(): Set_Type<BaseCanonicalTester.Config>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<BaseCanonicalTester.Config> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, BaseCanonicalTester.Config> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, BaseCanonicalTester.Config> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<BaseCanonicalTester.Config>;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    static toBuilder(): ObjBuilder<BaseCanonicalTester.Config>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<BaseCanonicalTester.Config>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): BaseCanonicalTester.Config;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): BaseCanonicalTester.Config;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): BaseCanonicalTester.Config;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): BaseCanonicalTester.Config;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): BaseCanonicalTester.Config;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): BaseCanonicalTester.Config;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): BaseCanonicalTester.Config;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): BaseCanonicalTester.Config;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    static afterMake(): BaseCanonicalTester.Config;
     ...
     */
    static cachedEmptyInst(): BaseCanonicalTester.Config;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<BaseCanonicalTester.Config> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): BaseCanonicalTester.Config;
     ...
     */
    static allCached(): Stream<BaseCanonicalTester.Config> | null;
     ...
     */
    static find(filter?: string): Stream<BaseCanonicalTester.Config> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<BaseCanonicalTester.Config> | null;

    /**
     * @return cached instance.
     */
    getCached(): BaseCanonicalTester.Config | null;

    /**
     * @return cached instance.
     */
    static getCached(): BaseCanonicalTester.Config | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string): BaseCanonicalTester.Config | null;
     ...
     */
    static produce(key: string): BaseCanonicalTester.Config | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, BaseCanonicalTester.Config> | null;
     ...
     */
    getConfig(): BaseCanonicalTester.Config;
     ...
     * Note that typical pattern is to use Configurable#config instead of this method.
     */
    static getConfig(): BaseCanonicalTester.Config;
     ...
     */
    getSecret(): BaseCanonicalTester.Config;
     ...
     * Note that typical pattern is to use Configurable#configWithSecrets instead of this method.
     */
    static getSecret(): BaseCanonicalTester.Config;
     ...
     */
    withConfigKey(configKey: string): BaseCanonicalTester.Config;
     ...
     *     config.configKey() => "folder1/abc"
     */
    static withConfigKey(configKey: string): BaseCanonicalTester.Config;

    /**
     * @return copy without config key.
     */
    withoutConfigKey(): BaseCanonicalTester.Config;

    /**
     * @return copy without config key.
     */
    static withoutConfigKey(): BaseCanonicalTester.Config;

    /**
     * @return return cached config instance for provided config key.
     */
    static forConfigKey(configKey: string): BaseCanonicalTester.Config | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string>): Stream<BaseCanonicalTester.Config> | null;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: BaseCanonicalTester.Config, override?: string): void;
     ...
     * @see setConfigValue
     */
    static setConfigValues(from: BaseCanonicalTester.Config, override?: string): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): BaseCanonicalTester.Config | null;
     ...
     */
    removeSecrets(): BaseCanonicalTester.Config | null;

    /**
     * @return this config without any secret values.
     */
    static removeSecrets(): BaseCanonicalTester.Config | null;

    /**
     * @return this config with only secret values.
     */
    removeNonSecrets(): BaseCanonicalTester.Config | null;

    /**
     * @return this config with only secret values.
     */
    static removeNonSecrets(): BaseCanonicalTester.Config | null;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    validate(): BaseCanonicalTester.Config;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    static validate(): BaseCanonicalTester.Config;
     ...
     */
    static inst(): BaseCanonicalTester.Config;
  }
}
