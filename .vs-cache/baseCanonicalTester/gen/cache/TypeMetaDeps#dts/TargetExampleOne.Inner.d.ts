// TypeScript definitions for the C3 type TargetExampleOne.Inner

/**
 * This is an example Canonical used for testing BaseCanonicalTester package.
 *
 * @remarks this represents a value passed to a method that expects an instance of TargetExampleOne.Inner
 */
declare namespace TargetExampleOne {
 ...
 */
declare namespace TargetExampleOne {
  export class Inner extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): TargetExampleOne.Inner;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): TargetExampleOne.Inner;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): TargetExampleOne.Inner;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): TargetExampleOne.Inner;
    ...
    withVersion(version: number | null): TargetExampleOne.Inner;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): TargetExampleOne.Inner;

    /**
     * The value.
     */
    readonly value?: number;
    withValue(value: number | null): TargetExampleOne.Inner;

    /**
     * The name of the parent.
     */
    readonly parent?: string;
    withParent(parent: string | null): TargetExampleOne.Inner;
     ...
     * @see #toJson
     */
    static fromJson(json: any): TargetExampleOne.Inner | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): TargetExampleOne.Inner | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): TargetExampleOne.Inner | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): TargetExampleOne.Inner | null;
     ...
     */
    replaceType(old: Type, new_: Type): TargetExampleOne.Inner;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): TargetExampleOne.Inner;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): TargetExampleOne.Inner;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<TargetExampleOne.Inner>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<TargetExampleOne.Inner>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): TargetExampleOne.Inner;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TargetExampleOne.Inner;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TargetExampleOne.Inner;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): TargetExampleOne.Inner;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): TargetExampleOne.Inner;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): TargetExampleOne.Inner;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): TargetExampleOne.Inner;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): TargetExampleOne.Inner;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): TargetExampleOne.Inner;
     ...
     * @see #removeField
     */
    withoutField(field: string): TargetExampleOne.Inner;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): TargetExampleOne.Inner;
     ...
     */
    withoutFields(fields: Array_Type<string>): TargetExampleOne.Inner;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): TargetExampleOne.Inner;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): TargetExampleOne.Inner;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): TargetExampleOne.Inner;
     ...
     * @see #unsetField
     */
    defaultField(field: string): TargetExampleOne.Inner;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): TargetExampleOne.Inner;
     ...
     * @see #removeField
     */
    unsetField(field: string): TargetExampleOne.Inner;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): TargetExampleOne.Inner;
     ...
     * @see #unsetField
     */
    removeField(field: string): TargetExampleOne.Inner;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): TargetExampleOne.Inner;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): TargetExampleOne.Inner;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): TargetExampleOne.Inner;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): TargetExampleOne.Inner;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): TargetExampleOne.Inner;

    mergeJson(json: any): TargetExampleOne.Inner;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): TargetExampleOne.Inner;
     ...
     */
    sumObj(other: Obj, deep?: boolean): TargetExampleOne.Inner;
     ...
     */
    singletonArray(): Array_Type<TargetExampleOne.Inner>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<TargetExampleOne.Inner> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<TargetExampleOne.Inner> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<TargetExampleOne.Inner>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<TargetExampleOne.Inner> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, TargetExampleOne.Inner> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, TargetExampleOne.Inner> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<TargetExampleOne.Inner>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<TargetExampleOne.Inner>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): TargetExampleOne.Inner;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): TargetExampleOne.Inner;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): TargetExampleOne.Inner;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): TargetExampleOne.Inner;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): TargetExampleOne.Inner;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): TargetExampleOne.Inner;
     ...
     * @see #fromString
     */
    static make(s: string): TargetExampleOne.Inner | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): TargetExampleOne.Inner;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): TargetExampleOne.Inner;
     ...
     */
    static cachedEmptyInst(): TargetExampleOne.Inner;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<TargetExampleOne.Inner> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): TargetExampleOne.Inner;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<TargetExampleOne.Inner>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<TargetExampleOne.Inner>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<TargetExampleOne.Inner> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<TargetExampleOne.Inner>> | null;
     ...
     */
    get(include?: string): TargetExampleOne.Inner | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): TargetExampleOne.Inner | null;
     ...
     */
    getMissing(spec: GetMissingSpec): TargetExampleOne.Inner;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): TargetExampleOne.Inner | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): TargetExampleOne.Inner;
     ...
     * @see #toString
     */
    static fromString(s: string): TargetExampleOne.Inner | null;
     ...
     */
    create(spec?: UpsertSpec): TargetExampleOne.Inner | null;
     ...
     */
    static createBatch(objs: Array_Type<TargetExampleOne.Inner>, spec?: UpsertSpec): ObjList<TargetExampleOne.Inner> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<TargetExampleOne.Inner>, spec?: CreateBatchObjStreamSpec): ObjList<TargetExampleOne.Inner> | null;
     ...
     */
    update(srcObj?: TargetExampleOne.Inner, spec?: UpsertSpec): TargetExampleOne.Inner | null;
     ...
     */
    upsert(srcObj?: TargetExampleOne.Inner, spec?: UpsertSpec): TargetExampleOne.Inner | null;
     ...
     */
    merge(spec?: MergeSpec): TargetExampleOne.Inner | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): TargetExampleOne.Inner | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): TargetExampleOne.Inner | null;
     ...
     */
    static updateBatch(objs: Array_Type<TargetExampleOne.Inner>, srcObjs?: Array_Type<TargetExampleOne.Inner>, spec?: UpsertSpec): ObjList<TargetExampleOne.Inner> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<TargetExampleOne.Inner> | null>, spec?: UpsertSpec): ObjList<TargetExampleOne.Inner> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<TargetExampleOne.Inner>, srcObjs?: Array_Type<TargetExampleOne.Inner>, spec?: UpsertSpec): ObjList<TargetExampleOne.Inner> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<TargetExampleOne.Inner> | null>, spec?: UpsertSpec): ObjList<TargetExampleOne.Inner> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<TargetExampleOne.Inner>, spec?: TouchSpec): ObjList<TargetExampleOne.Inner> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<TargetExampleOne.Inner>, spec?: MergeSpec): ObjList<TargetExampleOne.Inner> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<TargetExampleOne.Inner>, mergeInclude: string, spec?: MergeSpec): ObjList<TargetExampleOne.Inner> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<TargetExampleOne.Inner> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<TargetExampleOne.Inner> | null;
     ...
     */
    static mergeAll(mergeObj: TargetExampleOne.Inner, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: TargetExampleOne.Inner, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<TargetExampleOne.Inner>, spec?: UpsertSpec): ObjList<TargetExampleOne.Inner> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<TargetExampleOne.Inner>, spec?: UpsertSpec): ObjList<TargetExampleOne.Inner> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): TargetExampleOne.Inner | null;
     ...
     */
    static beforeCreate(objs: Array_Type<TargetExampleOne.Inner>): ObjList<TargetExampleOne.Inner>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<TargetExampleOne.Inner>): ObjList<TargetExampleOne.Inner>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<TargetExampleOne.Inner>): ObjList<TargetExampleOne.Inner>;
     ...
     */
    static afterCreate(objs: Array_Type<TargetExampleOne.Inner>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<TargetExampleOne.Inner>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<TargetExampleOne.Inner>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<TargetExampleOne.Inner>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<TargetExampleOne.Inner>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): TargetExampleOne.Inner | null;
     ...
     */
    withoutIdentity(): TargetExampleOne.Inner | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<TargetExampleOne.Inner>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: TargetExampleOne.Inner, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<TargetExampleOne.Inner>, callback?: λFunction<TargetExampleOne.Inner | null, TargetExampleOne.Inner | null>): ObjList<TargetExampleOne.Inner>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<TargetExampleOne.Inner>, callback?: λFunction<TargetExampleOne.Inner | null, TargetExampleOne.Inner | null>): Array_Type<ObjError> | null;
