// TypeScript definitions for the C3 type TargetExampleMultiLayer2

/**
 * This is an example Canonical used for testing BaseCanonicalTester package.
 *
 * @remarks this represents a value passed to a method that expects an instance of TargetExampleMultiLayer2
 */
declare interface ITargetExampleMultiLayer2 {
 ...
 */
declare class TargetExampleMultiLayer2 extends Obj  {
   ...
   */
  readonly id: string;
  withId(id: string): TargetExampleMultiLayer2;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): TargetExampleMultiLayer2;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): TargetExampleMultiLayer2;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): TargetExampleMultiLayer2;
  ...
  withVersion(version: number | null): TargetExampleMultiLayer2;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): TargetExampleMultiLayer2;

  /**
   * The value of the target.
   */
  readonly value?: number;
  withValue(value: number | null): TargetExampleMultiLayer2;

  /**
   * The primary key of the target.
   */
  readonly primaryKey?: string;
  withPrimaryKey(primaryKey: string | null): TargetExampleMultiLayer2;
   ...
   * @see #toJson
   */
  static fromJson(json: any): TargetExampleMultiLayer2 | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): TargetExampleMultiLayer2 | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): TargetExampleMultiLayer2 | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): TargetExampleMultiLayer2 | null;
   ...
   */
  replaceType(old: Type, new_: Type): TargetExampleMultiLayer2;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): TargetExampleMultiLayer2;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): TargetExampleMultiLayer2;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<TargetExampleMultiLayer2>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<TargetExampleMultiLayer2>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): TargetExampleMultiLayer2;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TargetExampleMultiLayer2;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TargetExampleMultiLayer2;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): TargetExampleMultiLayer2;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): TargetExampleMultiLayer2;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): TargetExampleMultiLayer2;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): TargetExampleMultiLayer2;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): TargetExampleMultiLayer2;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): TargetExampleMultiLayer2;
   ...
   * @see #removeField
   */
  withoutField(field: string): TargetExampleMultiLayer2;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): TargetExampleMultiLayer2;
   ...
   */
  withoutFields(fields: Array_Type<string>): TargetExampleMultiLayer2;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): TargetExampleMultiLayer2;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): TargetExampleMultiLayer2;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): TargetExampleMultiLayer2;
   ...
   * @see #unsetField
   */
  defaultField(field: string): TargetExampleMultiLayer2;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): TargetExampleMultiLayer2;
   ...
   * @see #removeField
   */
  unsetField(field: string): TargetExampleMultiLayer2;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): TargetExampleMultiLayer2;
   ...
   * @see #unsetField
   */
  removeField(field: string): TargetExampleMultiLayer2;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): TargetExampleMultiLayer2;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): TargetExampleMultiLayer2;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): TargetExampleMultiLayer2;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): TargetExampleMultiLayer2;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): TargetExampleMultiLayer2;

  mergeJson(json: any): TargetExampleMultiLayer2;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): TargetExampleMultiLayer2;
   ...
   */
  sumObj(other: Obj, deep?: boolean): TargetExampleMultiLayer2;
   ...
   */
  singletonArray(): Array_Type<TargetExampleMultiLayer2>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<TargetExampleMultiLayer2> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<TargetExampleMultiLayer2> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<TargetExampleMultiLayer2>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<TargetExampleMultiLayer2> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, TargetExampleMultiLayer2> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, TargetExampleMultiLayer2> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<TargetExampleMultiLayer2>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<TargetExampleMultiLayer2>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): TargetExampleMultiLayer2;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): TargetExampleMultiLayer2;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): TargetExampleMultiLayer2;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): TargetExampleMultiLayer2;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): TargetExampleMultiLayer2;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): TargetExampleMultiLayer2;
   ...
   * @see #fromString
   */
  static make(s: string): TargetExampleMultiLayer2 | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): TargetExampleMultiLayer2;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): TargetExampleMultiLayer2;
   ...
   */
  static cachedEmptyInst(): TargetExampleMultiLayer2;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<TargetExampleMultiLayer2> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): TargetExampleMultiLayer2;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<TargetExampleMultiLayer2>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<TargetExampleMultiLayer2>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<TargetExampleMultiLayer2> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<TargetExampleMultiLayer2>> | null;
   ...
   */
  get(include?: string): TargetExampleMultiLayer2 | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): TargetExampleMultiLayer2 | null;
   ...
   */
  getMissing(spec: GetMissingSpec): TargetExampleMultiLayer2;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): TargetExampleMultiLayer2 | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): TargetExampleMultiLayer2;
   ...
   * @see #toString
   */
  static fromString(s: string): TargetExampleMultiLayer2 | null;
   ...
   */
  create(spec?: UpsertSpec): TargetExampleMultiLayer2 | null;
   ...
   */
  static createBatch(objs: Array_Type<TargetExampleMultiLayer2>, spec?: UpsertSpec): ObjList<TargetExampleMultiLayer2> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<TargetExampleMultiLayer2>, spec?: CreateBatchObjStreamSpec): ObjList<TargetExampleMultiLayer2> | null;
   ...
   */
  update(srcObj?: TargetExampleMultiLayer2, spec?: UpsertSpec): TargetExampleMultiLayer2 | null;
   ...
   */
  upsert(srcObj?: TargetExampleMultiLayer2, spec?: UpsertSpec): TargetExampleMultiLayer2 | null;
   ...
   */
  merge(spec?: MergeSpec): TargetExampleMultiLayer2 | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): TargetExampleMultiLayer2 | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): TargetExampleMultiLayer2 | null;
   ...
   */
  static updateBatch(objs: Array_Type<TargetExampleMultiLayer2>, srcObjs?: Array_Type<TargetExampleMultiLayer2>, spec?: UpsertSpec): ObjList<TargetExampleMultiLayer2> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<TargetExampleMultiLayer2> | null>, spec?: UpsertSpec): ObjList<TargetExampleMultiLayer2> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<TargetExampleMultiLayer2>, srcObjs?: Array_Type<TargetExampleMultiLayer2>, spec?: UpsertSpec): ObjList<TargetExampleMultiLayer2> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<TargetExampleMultiLayer2> | null>, spec?: UpsertSpec): ObjList<TargetExampleMultiLayer2> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<TargetExampleMultiLayer2>, spec?: TouchSpec): ObjList<TargetExampleMultiLayer2> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<TargetExampleMultiLayer2>, spec?: MergeSpec): ObjList<TargetExampleMultiLayer2> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<TargetExampleMultiLayer2>, mergeInclude: string, spec?: MergeSpec): ObjList<TargetExampleMultiLayer2> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<TargetExampleMultiLayer2> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<TargetExampleMultiLayer2> | null;
   ...
   */
  static mergeAll(mergeObj: TargetExampleMultiLayer2, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: TargetExampleMultiLayer2, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<TargetExampleMultiLayer2>, spec?: UpsertSpec): ObjList<TargetExampleMultiLayer2> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<TargetExampleMultiLayer2>, spec?: UpsertSpec): ObjList<TargetExampleMultiLayer2> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): TargetExampleMultiLayer2 | null;
   ...
   */
  static beforeCreate(objs: Array_Type<TargetExampleMultiLayer2>): ObjList<TargetExampleMultiLayer2>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<TargetExampleMultiLayer2>): ObjList<TargetExampleMultiLayer2>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<TargetExampleMultiLayer2>): ObjList<TargetExampleMultiLayer2>;
   ...
   */
  static afterCreate(objs: Array_Type<TargetExampleMultiLayer2>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<TargetExampleMultiLayer2>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<TargetExampleMultiLayer2>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<TargetExampleMultiLayer2>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<TargetExampleMultiLayer2>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): TargetExampleMultiLayer2 | null;
   ...
   */
  withoutIdentity(): TargetExampleMultiLayer2 | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<TargetExampleMultiLayer2>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: TargetExampleMultiLayer2, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<TargetExampleMultiLayer2>, callback?: λFunction<TargetExampleMultiLayer2 | null, TargetExampleMultiLayer2 | null>): ObjList<TargetExampleMultiLayer2>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<TargetExampleMultiLayer2>, callback?: λFunction<TargetExampleMultiLayer2 | null, TargetExampleMultiLayer2 | null>): Array_Type<ObjError> | null;
