...
class ProtectionLoopAlert(FeatureEvaluatable):
    """
    ...
    {@link ProtectionLoop}
    """
    def __init__(self, id: Optional[str]=None, versionEdits: Optional[Array[VersionEdit]]=None, name: Optional[str]=None, meta: Optional[Meta]=None, version: Optional[int]=None, typeWithBindings: Optional[Type]=None, parent: Optional[ProtectionLoop]=None, timestamp: Optional[datetime]=None, risk: Optional[str]=None, unhealthySensors: Optional[Array[Sensor]]=None) -> None: ...
