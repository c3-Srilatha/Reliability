// TypeScript definitions for the C3 type SensorMeasurementBounds
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of SensorMeasurementBounds
 */
declare interface ISensorMeasurementBounds {
 ...
 */
declare class SensorMeasurementBounds extends Obj  {
  ...
  withTypeIdent(typeIdent: string | null): SensorMeasurementBounds;
   ...
   */
  readonly id: string;
  withId(id: string): SensorMeasurementBounds;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): SensorMeasurementBounds;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): SensorMeasurementBounds;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): SensorMeasurementBounds;
  ...
  withVersion(version: number | null): SensorMeasurementBounds;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): SensorMeasurementBounds;

  /**
   * The {@link Sensor} for which the bounds are being set.
   */
  readonly sensor: Sensor;
  withSensor(sensor: ISensor): SensorMeasurementBounds;
  ...
  withLowerBound(lowerBound: number | null): SensorMeasurementBounds;
  ...
  withUpperBound(upperBound: number | null): SensorMeasurementBounds;
   ...
   * @see #toJson
   */
  static fromJson(json: any): SensorMeasurementBounds | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): SensorMeasurementBounds | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): SensorMeasurementBounds | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): SensorMeasurementBounds | null;
   ...
   */
  replaceType(old: Type, new_: Type): SensorMeasurementBounds;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): SensorMeasurementBounds;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): SensorMeasurementBounds;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<SensorMeasurementBounds>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<SensorMeasurementBounds>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): SensorMeasurementBounds;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SensorMeasurementBounds;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SensorMeasurementBounds;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): SensorMeasurementBounds;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): SensorMeasurementBounds;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): SensorMeasurementBounds;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): SensorMeasurementBounds;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): SensorMeasurementBounds;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): SensorMeasurementBounds;
   ...
   * @see #removeField
   */
  withoutField(field: string): SensorMeasurementBounds;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): SensorMeasurementBounds;
   ...
   */
  withoutFields(fields: Array_Type<string>): SensorMeasurementBounds;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): SensorMeasurementBounds;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): SensorMeasurementBounds;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): SensorMeasurementBounds;
   ...
   * @see #unsetField
   */
  defaultField(field: string): SensorMeasurementBounds;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): SensorMeasurementBounds;
   ...
   * @see #removeField
   */
  unsetField(field: string): SensorMeasurementBounds;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): SensorMeasurementBounds;
   ...
   * @see #unsetField
   */
  removeField(field: string): SensorMeasurementBounds;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): SensorMeasurementBounds;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): SensorMeasurementBounds;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): SensorMeasurementBounds;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): SensorMeasurementBounds;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): SensorMeasurementBounds;

  mergeJson(json: any): SensorMeasurementBounds;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): SensorMeasurementBounds;
   ...
   */
  sumObj(other: Obj, deep?: boolean): SensorMeasurementBounds;
   ...
   */
  singletonArray(): Array_Type<SensorMeasurementBounds>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<SensorMeasurementBounds> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<SensorMeasurementBounds> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<SensorMeasurementBounds>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<SensorMeasurementBounds> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, SensorMeasurementBounds> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, SensorMeasurementBounds> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<SensorMeasurementBounds>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<SensorMeasurementBounds>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): SensorMeasurementBounds;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): SensorMeasurementBounds;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): SensorMeasurementBounds;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): SensorMeasurementBounds;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): SensorMeasurementBounds;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): SensorMeasurementBounds;
   ...
   * @see #fromString
   */
  static make(s: string): SensorMeasurementBounds | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): SensorMeasurementBounds;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): SensorMeasurementBounds;
   ...
   */
  static cachedEmptyInst(): SensorMeasurementBounds;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<SensorMeasurementBounds> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): SensorMeasurementBounds;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<SensorMeasurementBounds>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<SensorMeasurementBounds>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<SensorMeasurementBounds> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<SensorMeasurementBounds>> | null;
   ...
   */
  get(include?: string): SensorMeasurementBounds | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): SensorMeasurementBounds | null;
   ...
   */
  getMissing(spec: GetMissingSpec): SensorMeasurementBounds;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): SensorMeasurementBounds | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): SensorMeasurementBounds;
   ...
   * @see #toString
   */
  static fromString(s: string): SensorMeasurementBounds | null;
   ...
   */
  create(spec?: UpsertSpec): SensorMeasurementBounds | null;
   ...
   */
  static createBatch(objs: Array_Type<SensorMeasurementBounds>, spec?: UpsertSpec): ObjList<SensorMeasurementBounds> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<SensorMeasurementBounds>, spec?: CreateBatchObjStreamSpec): ObjList<SensorMeasurementBounds> | null;
   ...
   */
  update(srcObj?: SensorMeasurementBounds, spec?: UpsertSpec): SensorMeasurementBounds | null;
   ...
   */
  upsert(srcObj?: SensorMeasurementBounds, spec?: UpsertSpec): SensorMeasurementBounds | null;
   ...
   */
  merge(spec?: MergeSpec): SensorMeasurementBounds | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): SensorMeasurementBounds | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): SensorMeasurementBounds | null;
   ...
   */
  static updateBatch(objs: Array_Type<SensorMeasurementBounds>, srcObjs?: Array_Type<SensorMeasurementBounds>, spec?: UpsertSpec): ObjList<SensorMeasurementBounds> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<SensorMeasurementBounds> | null>, spec?: UpsertSpec): ObjList<SensorMeasurementBounds> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<SensorMeasurementBounds>, srcObjs?: Array_Type<SensorMeasurementBounds>, spec?: UpsertSpec): ObjList<SensorMeasurementBounds> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<SensorMeasurementBounds> | null>, spec?: UpsertSpec): ObjList<SensorMeasurementBounds> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<SensorMeasurementBounds>, spec?: TouchSpec): ObjList<SensorMeasurementBounds> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<SensorMeasurementBounds>, spec?: MergeSpec): ObjList<SensorMeasurementBounds> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<SensorMeasurementBounds>, mergeInclude: string, spec?: MergeSpec): ObjList<SensorMeasurementBounds> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<SensorMeasurementBounds> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<SensorMeasurementBounds> | null;
   ...
   */
  static mergeAll(mergeObj: SensorMeasurementBounds, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: SensorMeasurementBounds, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<SensorMeasurementBounds>, spec?: UpsertSpec): ObjList<SensorMeasurementBounds> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<SensorMeasurementBounds>, spec?: UpsertSpec): ObjList<SensorMeasurementBounds> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): SensorMeasurementBounds | null;
   ...
   */
  static beforeCreate(objs: Array_Type<SensorMeasurementBounds>): ObjList<SensorMeasurementBounds>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<SensorMeasurementBounds>): ObjList<SensorMeasurementBounds>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<SensorMeasurementBounds>): ObjList<SensorMeasurementBounds>;
   ...
   */
  static afterCreate(objs: Array_Type<SensorMeasurementBounds>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<SensorMeasurementBounds>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<SensorMeasurementBounds>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<SensorMeasurementBounds>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<SensorMeasurementBounds>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): SensorMeasurementBounds | null;
   ...
   */
  withoutIdentity(): SensorMeasurementBounds | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<SensorMeasurementBounds>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: SensorMeasurementBounds, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<SensorMeasurementBounds>, callback?: λFunction<SensorMeasurementBounds | null, SensorMeasurementBounds | null>): ObjList<SensorMeasurementBounds>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<SensorMeasurementBounds>, callback?: λFunction<SensorMeasurementBounds | null, SensorMeasurementBounds | null>): Array_Type<ObjError> | null;
