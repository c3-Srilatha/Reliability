...
from c3.platform.MapBuilder import MapBuilder
from c3.dataFusionBase.SampleTimedInterval import SampleTimedInterval
...
# Python definitions for the C3 type SampleTimedInterval

T = TypeVar('T')
F = TypeVar('F')

class SampleTimedInterval(Generic[T, F], TimedIntervalValue):
    """
    Ties a start and end timestamp to the relationship between 2 entities.
    
    @remarks this represents a made instance of SampleTimedInterval
    """
    ...
    """
    def __init__(self, start: Optional[datetime]=None, end: Optional[datetime]=None, id: Optional[str]=None, versionEdits: Optional[Array[VersionEdit]]=None, name: Optional[str]=None, meta: Optional[Meta]=None, version: Optional[int]=None, typeWithBindings: Optional[Type]=None, from: Optional[F]=None, to: Optional[T]=None) -> None: ...
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[SampleTimedInterval[F, T]]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[SampleTimedInterval[F, T]]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[SampleTimedInterval[F, T]]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[SampleTimedInterval[F, T]]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> SampleTimedInterval[F, T]:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> SampleTimedInterval[F, T]:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> SampleTimedInterval[F, T]:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[SampleTimedInterval[F, T]]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[SampleTimedInterval[F, T]]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> SampleTimedInterval[F, T]:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> SampleTimedInterval[F, T]:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> SampleTimedInterval[F, T]:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> SampleTimedInterval[F, T]:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> SampleTimedInterval[F, T]:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> SampleTimedInterval[F, T]:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> SampleTimedInterval[F, T]:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> SampleTimedInterval[F, T]:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> SampleTimedInterval[F, T]:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> SampleTimedInterval[F, T]:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> SampleTimedInterval[F, T]:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> SampleTimedInterval[F, T]:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> SampleTimedInterval[F, T]:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> SampleTimedInterval[F, T]:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> SampleTimedInterval[F, T]:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> SampleTimedInterval[F, T]:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> SampleTimedInterval[F, T]:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> SampleTimedInterval[F, T]:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> SampleTimedInterval[F, T]:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> SampleTimedInterval[F, T]:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> SampleTimedInterval[F, T]:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> SampleTimedInterval[F, T]:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> SampleTimedInterval[F, T]:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> SampleTimedInterval[F, T]:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> SampleTimedInterval[F, T]:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> SampleTimedInterval[F, T]:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> SampleTimedInterval[F, T]:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> SampleTimedInterval[F, T]:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[SampleTimedInterval[F, T]]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[SampleTimedInterval[F, T]]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[SampleTimedInterval[F, T]]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[SampleTimedInterval[F, T]]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[SampleTimedInterval[F, T]]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, SampleTimedInterval[F, T]]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, SampleTimedInterval[F, T]]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[SampleTimedInterval[F, T]]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[SampleTimedInterval[F, T]]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> SampleTimedInterval[F, T]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> SampleTimedInterval[F, T]:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> SampleTimedInterval[F, T]:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> SampleTimedInterval[F, T]:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> SampleTimedInterval[F, T]:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> SampleTimedInterval[F, T]:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[SampleTimedInterval[F, T]]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> SampleTimedInterval[F, T]:
    """
    ...
    """
        ...
    def afterMake(self) -> SampleTimedInterval[F, T]:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> SampleTimedInterval[F, T]:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[SampleTimedInterval[F, T]]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> SampleTimedInterval[F, T]:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, spec: FetchSpec=None) -> FetchResult[SampleTimedInterval[F, T]]:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, filter: Filter) -> FetchResult[SampleTimedInterval[F, T]]:
    """
    ...
    """
        ...
    @classmethod
    def fetchObjStream(cls, spec: FetchStreamSpec=None) -> Union[Stream[SampleTimedInterval[F, T]]]:
    """
    Fetches multiple obj instances based on a specification.  Only objs that the caller is authorized to fetch will be
    returned.
    ...
    """
        ...
    @classmethod
    def fetchMultiLocale(cls, spec: MultiLocaleFetchSpec=None) -> Union[Map[str, FetchResult[SampleTimedInterval[F, T]]]]:
    """
    ...
    """
        ...
    def get(self, include: str=None) -> Union[SampleTimedInterval[F, T]]:
    """
    ...
    """
        ...
    def getSpecific(self, include: str=None) -> Union[SampleTimedInterval[F, T]]:
    """
    ...
    """
        ...
    def getMissing(self, spec: GetMissingSpec) -> SampleTimedInterval[F, T]:
    """
    ...
    """
        ...
    def getDirect(self, include: str=None) -> Union[SampleTimedInterval[F, T]]:
    """
    ...
    """
        ...
    def applyReverseEdit(self, versionEdit: VersionEdit) -> SampleTimedInterval[F, T]:
    """
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[SampleTimedInterval[F, T]]:
    """
    ...
    """
        ...
    def create(self, spec: UpsertSpec=None) -> Union[SampleTimedInterval[F, T]]:
    """
    ...
    """
        ...
    @classmethod
    def createBatch(cls, objs: Array[SampleTimedInterval[F, T]], spec: UpsertSpec=None) -> Union[ObjList[SampleTimedInterval[F, T]]]:
    """
    ...
    """
        ...
    @classmethod
    def createBatchObjStream(cls, objs: Stream[SampleTimedInterval[F, T]], spec: CreateBatchObjStreamSpec=None) -> Union[ObjList[SampleTimedInterval[F, T]]]:
    """
    Creates multiple instances of a C3 type. If the operation fails and {@link UpsertSpec#dontThrowOnBatchError} is not
    specified (the default), then a C3BatchException will be thrown.  Otherwise {@link errors will be reported in the
    returned {@link ObjList}.  This will fail if any of the instances already exist.
    ...
    """
        ...
    def update(self, srcObj: SampleTimedInterval[F, T]=None, spec: UpsertSpec=None) -> Union[SampleTimedInterval[F, T]]:
    """
    ...
    """
        ...
    def upsert(self, srcObj: SampleTimedInterval[F, T]=None, spec: UpsertSpec=None) -> Union[SampleTimedInterval[F, T]]:
    """
    ...
    """
        ...
    @overload
    def merge(self, spec: MergeSpec=None) -> Union[SampleTimedInterval[F, T]]:
    """
    ...
    """
        ...
    @overload
    def merge(self, mergeInclude: str, spec: MergeSpec=None) -> Union[SampleTimedInterval[F, T]]:
    """
    ...
    """
        ...
    def touch(self, spec: TouchSpec=None) -> Union[SampleTimedInterval[F, T]]:
    """
    ...
    """
        ...
    @classmethod
    def updateBatch(cls, objs: Array[SampleTimedInterval[F, T]], srcObjs: Array[SampleTimedInterval[F, T]]=None, spec: UpsertSpec=None) -> Union[ObjList[SampleTimedInterval[F, T]]]:
    """
    ...
    """
        ...
    @classmethod
    def updateObjs(cls, objs: Callable[[], Union[Array[SampleTimedInterval[F, T]]]], spec: UpsertSpec=None) -> Union[ObjList[SampleTimedInterval[F, T]]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertBatch(cls, objs: Array[SampleTimedInterval[F, T]], srcObjs: Array[SampleTimedInterval[F, T]]=None, spec: UpsertSpec=None) -> Union[ObjList[SampleTimedInterval[F, T]]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertObjs(cls, objs: Callable[[], Union[Array[SampleTimedInterval[F, T]]]], spec: UpsertSpec=None) -> Union[ObjList[SampleTimedInterval[F, T]]]:
    """
    Creates instances of a C3 type if they don't already exist and updates them if they do exist. If the operation
    ...
    """
        ...
    @classmethod
    def touchBatch(cls, objs: Array[SampleTimedInterval[F, T]], spec: TouchSpec=None) -> Union[ObjList[SampleTimedInterval[F, T]]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[SampleTimedInterval[F, T]], spec: MergeSpec=None) -> Union[ObjList[SampleTimedInterval[F, T]]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[SampleTimedInterval[F, T]], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[SampleTimedInterval[F, T]]]:
    """
    Merges multiple instances of a C3 type or creates them if they don't exist. If the operation fails and {@link
    UpsertSpec#dontThrowOnBatchError} is not specified (the default), then a C3BatchException will be thrown.
    Otherwise errors will be reported in the returned {@link ObjList}.  The merge operation is described in the {@link
    ...
    """
        ...
    @classmethod
    def mergeObjs(cls, objs: Callable[[], Union[Array[SampleTimedInterval[F, T]]]], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[SampleTimedInterval[F, T]]]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: SampleTimedInterval[F, T], spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: SampleTimedInterval[F, T], mergeInclude: str, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def removeBatch(cls, objs: Array[SampleTimedInterval[F, T]], spec: UpsertSpec=None) -> Union[ObjList[SampleTimedInterval[F, T]]]:
    """
    ...
    """
        ...
    @classmethod
    def replace(cls, objs: Array[SampleTimedInterval[F, T]], spec: UpsertSpec=None) -> Union[ObjList[SampleTimedInterval[F, T]]]:
    """
    ...
    """
        ...
    def unremove(self) -> Union[SampleTimedInterval[F, T]]:
    """
    ...
    """
        ...
    @classmethod
    def beforeCreate(cls, objs: Array[SampleTimedInterval[F, T]]) -> ObjList[SampleTimedInterval[F, T]]:
    """
    ...
    """
        ...
    @classmethod
    def beforeUpdate(cls, objs: Array[SampleTimedInterval[F, T]]) -> ObjList[SampleTimedInterval[F, T]]:
    """
    ...
    """
        ...
    @classmethod
    def beforeRemove(cls, objs: Array[SampleTimedInterval[F, T]]) -> ObjList[SampleTimedInterval[F, T]]:
    """
    ...
    """
        ...
    @classmethod
    def afterCreate(cls, objs: Array[SampleTimedInterval[F, T]]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterUpdate(cls, objs: Array[SampleTimedInterval[F, T]]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterRemove(cls, objs: Array[SampleTimedInterval[F, T]]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def startImportData(cls, spec: StartImportDataSpec=None) -> PushStream[SampleTimedInterval[F, T]]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    @classmethod
    def startImportDataWithStats(cls, spec: StartImportDataSpec=None) -> PushStreamWithStats[SampleTimedInterval[F, T]]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[SampleTimedInterval[F, T]]:
    """
    ...
    """
        ...
    def withoutIdentity(self) -> Union[SampleTimedInterval[F, T]]:
    """
    ...
    """
        ...
    @classmethod
    def typeOfBatch(cls, objs: Array[SampleTimedInterval[F, T]]) -> Union[Array[EntityType]]:
    """
    ...
    """
        ...
    @classmethod
    def dbEcho(cls, template: SampleTimedInterval[F, T]=None, count: int=None, sendBack: bool=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def callbackLogic(cls, objs: Array[SampleTimedInterval[F, T]], callback: Callable[[Union[SampleTimedInterval[F, T]]], Union[SampleTimedInterval[F, T]]]=None) -> ObjList[SampleTimedInterval[F, T]]:
    """
    ...
    """
        ...
    @classmethod
    def afterCallbackLogic(cls, objs: Array[SampleTimedInterval[F, T]], callback: Callable[[Union[SampleTimedInterval[F, T]]], Union[SampleTimedInterval[F, T]]]=None) -> Union[Array[ObjError]]:
    """
