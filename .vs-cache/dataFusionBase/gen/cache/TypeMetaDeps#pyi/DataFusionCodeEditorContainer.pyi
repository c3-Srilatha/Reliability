...
# Python definitions for the C3 type DataFusionCodeEditorContainer


class DataFusionCodeEditorContainer(UiSdlComponent[UiSdlNoData]):
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[DataFusionCodeEditorContainer]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[DataFusionCodeEditorContainer]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[DataFusionCodeEditorContainer]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[DataFusionCodeEditorContainer]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> DataFusionCodeEditorContainer:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> DataFusionCodeEditorContainer:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> DataFusionCodeEditorContainer:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[DataFusionCodeEditorContainer]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[DataFusionCodeEditorContainer]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> DataFusionCodeEditorContainer:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> DataFusionCodeEditorContainer:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> DataFusionCodeEditorContainer:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> DataFusionCodeEditorContainer:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> DataFusionCodeEditorContainer:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> DataFusionCodeEditorContainer:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> DataFusionCodeEditorContainer:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> DataFusionCodeEditorContainer:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> DataFusionCodeEditorContainer:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> DataFusionCodeEditorContainer:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> DataFusionCodeEditorContainer:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> DataFusionCodeEditorContainer:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> DataFusionCodeEditorContainer:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> DataFusionCodeEditorContainer:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> DataFusionCodeEditorContainer:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> DataFusionCodeEditorContainer:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> DataFusionCodeEditorContainer:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> DataFusionCodeEditorContainer:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> DataFusionCodeEditorContainer:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> DataFusionCodeEditorContainer:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> DataFusionCodeEditorContainer:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> DataFusionCodeEditorContainer:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> DataFusionCodeEditorContainer:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> DataFusionCodeEditorContainer:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> DataFusionCodeEditorContainer:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> DataFusionCodeEditorContainer:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> DataFusionCodeEditorContainer:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> DataFusionCodeEditorContainer:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[DataFusionCodeEditorContainer]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[DataFusionCodeEditorContainer]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[DataFusionCodeEditorContainer]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[DataFusionCodeEditorContainer]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[DataFusionCodeEditorContainer]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, DataFusionCodeEditorContainer]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, DataFusionCodeEditorContainer]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[DataFusionCodeEditorContainer]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[DataFusionCodeEditorContainer]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> DataFusionCodeEditorContainer:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> DataFusionCodeEditorContainer:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> DataFusionCodeEditorContainer:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> DataFusionCodeEditorContainer:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> DataFusionCodeEditorContainer:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> DataFusionCodeEditorContainer:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[DataFusionCodeEditorContainer]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> DataFusionCodeEditorContainer:
    """
    ...
    """
        ...
    def afterMake(self) -> DataFusionCodeEditorContainer:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> DataFusionCodeEditorContainer:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[DataFusionCodeEditorContainer]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> DataFusionCodeEditorContainer:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, spec: FetchSpec=None) -> FetchResult[DataFusionCodeEditorContainer]:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, filter: Filter) -> FetchResult[DataFusionCodeEditorContainer]:
    """
    ...
    """
        ...
    @classmethod
    def fetchObjStream(cls, spec: FetchStreamSpec=None) -> Union[Stream[DataFusionCodeEditorContainer]]:
    """
    Fetches multiple obj instances based on a specification.  Only objs that the caller is authorized to fetch will be
    returned.
    ...
    """
        ...
    @classmethod
    def fetchMultiLocale(cls, spec: MultiLocaleFetchSpec=None) -> Union[Map[str, FetchResult[DataFusionCodeEditorContainer]]]:
    """
    ...
    """
        ...
    def dependencies(self) -> MetadataDeps[DataFusionCodeEditorContainer]:
    """
    Retrieves dependencies to types or other metadata elements for the given instance of metadata.
    """
        ...
    def save(self, subPath: str=None, contentType: str=None) -> DataFusionCodeEditorContainer:
        ...
    ...
    def removeAll(cls, removeFilter: str=None) -> int:
        ...
    def update(self, srcObj: DataFusionCodeEditorContainer=None, spec: UpsertSpec=None) -> Union[DataFusionCodeEditorContainer]:
        ...
    def upsert(self, srcObj: DataFusionCodeEditorContainer=None, spec: UpsertSpec=None) -> Union[DataFusionCodeEditorContainer]:
        ...
    @classmethod
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[DataFusionCodeEditorContainer]:
    """
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[DataFusionCodeEditorContainer]:
    """
    ...
    def jsonify(cls, value: Any=None) -> Union[str]:
        ...
    @classmethod
    def doDataMerge(cls, componentId: str, dataSpecFieldName: str, dataDestinationFieldName: str, props: DataFusionCodeEditorContainer, state: UiSdlReduxState) -> Union[DataFusionCodeEditorContainer]:
    """
