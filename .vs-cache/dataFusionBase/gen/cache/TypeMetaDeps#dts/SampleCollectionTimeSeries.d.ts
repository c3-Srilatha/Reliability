// TypeScript definitions for the C3 type SampleCollectionTimeSeries

/**
 * @remarks this represents a value passed to a method that expects an instance of SampleCollectionTimeSeries
 */
declare interface ISampleCollectionTimeSeries {
   ...
   */
  data?: C3.Array<SampleIntervalDataPoint | null> | Array<ISampleIntervalDataPoint | null>;
 ...
 */
declare class SampleCollectionTimeSeries extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): SampleCollectionTimeSeries | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): SampleCollectionTimeSeries | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): SampleCollectionTimeSeries | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): SampleCollectionTimeSeries | null;
   ...
   */
  replaceType(old: Type, new_: Type): SampleCollectionTimeSeries;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): SampleCollectionTimeSeries;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): SampleCollectionTimeSeries;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<SampleCollectionTimeSeries | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<SampleCollectionTimeSeries | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): SampleCollectionTimeSeries;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SampleCollectionTimeSeries;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SampleCollectionTimeSeries;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): SampleCollectionTimeSeries;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): SampleCollectionTimeSeries;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): SampleCollectionTimeSeries;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): SampleCollectionTimeSeries;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): SampleCollectionTimeSeries;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): SampleCollectionTimeSeries;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): SampleCollectionTimeSeries;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): SampleCollectionTimeSeries;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): SampleCollectionTimeSeries;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): SampleCollectionTimeSeries;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): SampleCollectionTimeSeries;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): SampleCollectionTimeSeries;
   ...
   * @see #unsetField
   */
  defaultField(field: string): SampleCollectionTimeSeries;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): SampleCollectionTimeSeries;
   ...
   * @see #removeField
   */
  unsetField(field: string): SampleCollectionTimeSeries;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): SampleCollectionTimeSeries;
   ...
   * @see #unsetField
   */
  removeField(field: string): SampleCollectionTimeSeries;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): SampleCollectionTimeSeries;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): SampleCollectionTimeSeries;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): SampleCollectionTimeSeries;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): SampleCollectionTimeSeries;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): SampleCollectionTimeSeries;

  mergeJson(json: any | null): SampleCollectionTimeSeries;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): SampleCollectionTimeSeries;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): SampleCollectionTimeSeries;
   ...
   */
  singletonArray(): C3.Array<SampleCollectionTimeSeries | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<SampleCollectionTimeSeries | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<SampleCollectionTimeSeries | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<SampleCollectionTimeSeries | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<SampleCollectionTimeSeries | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, SampleCollectionTimeSeries | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, SampleCollectionTimeSeries | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<SampleCollectionTimeSeries | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<SampleCollectionTimeSeries | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): SampleCollectionTimeSeries;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): SampleCollectionTimeSeries;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): SampleCollectionTimeSeries;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): SampleCollectionTimeSeries;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): SampleCollectionTimeSeries;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): SampleCollectionTimeSeries;
   ...
   * @see #fromString
   */
  static make(s: string | null): SampleCollectionTimeSeries | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): SampleCollectionTimeSeries;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): SampleCollectionTimeSeries;
   ...
   */
  static cachedEmptyInst(): SampleCollectionTimeSeries;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<SampleCollectionTimeSeries>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): SampleCollectionTimeSeries;
   ...
   */
  static normalizeTimeseries(timeseries?: TimedDataFields<SampleIntervalDataPoint | null> | null, start?: DateTime | null, end?: DateTime | null, overrideGrain?: string | null, forceGrainDetection?: boolean, force?: boolean): void;
   ...
   */
  static normalize(timeseries?: TimedDataFields<SampleIntervalDataPoint | null> | null, start?: DateTime | null, end?: DateTime | null, overrideGrain?: string | null, forceGrainDetection?: boolean): NormalizationResult | null;
   ...
   */
  static normalizationUnit(rawHeader: TimedDataFields<SampleIntervalDataPoint | null>, tsField: string): Unit | null;
   ...
   */
  static normalizationTreatment(rawHeader: TimedDataFields<SampleIntervalDataPoint | null>, tsField: string): string;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<SampleCollectionTimeSeries | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<SampleCollectionTimeSeries | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<SampleCollectionTimeSeries | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<SampleCollectionTimeSeries | null> | null>;
   ...
   */
  get(include?: string | null): SampleCollectionTimeSeries | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): SampleCollectionTimeSeries | null;
   ...
   */
  getMissing(spec: GetMissingSpec): SampleCollectionTimeSeries;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): SampleCollectionTimeSeries | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): SampleCollectionTimeSeries;
   ...
   * @see #toString
   */
  static fromString(s: string | null): SampleCollectionTimeSeries | null;
   ...
   */
  create(spec?: UpsertSpec | null): SampleCollectionTimeSeries | null;
   ...
   */
  static createBatch(objs: C3.Array<SampleCollectionTimeSeries | null> | null, spec?: UpsertSpec | null): ObjList<SampleCollectionTimeSeries | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<SampleCollectionTimeSeries | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<SampleCollectionTimeSeries | null> | null;
   ...
   */
  update(srcObj?: SampleCollectionTimeSeries | null, spec?: UpsertSpec | null): SampleCollectionTimeSeries | null;
   ...
   */
  upsert(srcObj?: SampleCollectionTimeSeries | null, spec?: UpsertSpec | null): SampleCollectionTimeSeries | null;
   ...
   */
  merge(spec?: MergeSpec | null): SampleCollectionTimeSeries | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): SampleCollectionTimeSeries | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): SampleCollectionTimeSeries | null;
   ...
   */
  static updateBatch(objs: C3.Array<SampleCollectionTimeSeries | null> | null, srcObjs?: C3.Array<SampleCollectionTimeSeries | null>, spec?: UpsertSpec | null): ObjList<SampleCollectionTimeSeries | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<SampleCollectionTimeSeries | null>>, spec?: UpsertSpec | null): ObjList<SampleCollectionTimeSeries | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<SampleCollectionTimeSeries | null> | null, srcObjs?: C3.Array<SampleCollectionTimeSeries | null>, spec?: UpsertSpec | null): ObjList<SampleCollectionTimeSeries | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<SampleCollectionTimeSeries | null>>, spec?: UpsertSpec | null): ObjList<SampleCollectionTimeSeries | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<SampleCollectionTimeSeries | null> | null, spec?: TouchSpec | null): ObjList<SampleCollectionTimeSeries | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<SampleCollectionTimeSeries | null> | null, spec?: MergeSpec | null): ObjList<SampleCollectionTimeSeries | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<SampleCollectionTimeSeries | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<SampleCollectionTimeSeries | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<SampleCollectionTimeSeries | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<SampleCollectionTimeSeries | null> | null;
   ...
   */
  static mergeAll(mergeObj: SampleCollectionTimeSeries | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: SampleCollectionTimeSeries | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<SampleCollectionTimeSeries | null> | null, spec?: UpsertSpec | null): ObjList<SampleCollectionTimeSeries | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<SampleCollectionTimeSeries | null> | null, spec?: UpsertSpec | null): ObjList<SampleCollectionTimeSeries | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): SampleCollectionTimeSeries | null;
   ...
   */
  static beforeCreate(objs: C3.Array<SampleCollectionTimeSeries | null> | null): ObjList<SampleCollectionTimeSeries | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<SampleCollectionTimeSeries | null> | null): ObjList<SampleCollectionTimeSeries | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<SampleCollectionTimeSeries | null> | null): ObjList<SampleCollectionTimeSeries | null>;
   ...
   */
  static afterCreate(objs: C3.Array<SampleCollectionTimeSeries | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<SampleCollectionTimeSeries | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<SampleCollectionTimeSeries | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<SampleCollectionTimeSeries | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<SampleCollectionTimeSeries | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): SampleCollectionTimeSeries | null;
   ...
   */
  withoutIdentity(): SampleCollectionTimeSeries | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<SampleCollectionTimeSeries | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: SampleCollectionTimeSeries | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<SampleCollectionTimeSeries | null> | null, callback?: λFunction<SampleCollectionTimeSeries | null, SampleCollectionTimeSeries | null> | null): ObjList<SampleCollectionTimeSeries | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<SampleCollectionTimeSeries | null> | null, callback?: λFunction<SampleCollectionTimeSeries | null, SampleCollectionTimeSeries | null> | null): C3.Array<ObjError | null>;
