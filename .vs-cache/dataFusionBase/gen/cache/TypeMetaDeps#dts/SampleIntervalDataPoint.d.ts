// TypeScript definitions for the C3 type SampleIntervalDataPoint

/**
 * @remarks this represents a value passed to a method that expects an instance of SampleIntervalDataPoint
 */
declare interface ISampleIntervalDataPoint {
  ...
  parent: ISampleCollectionTimeSeries;
 ...
 */
declare class SampleIntervalDataPoint extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): SampleIntervalDataPoint | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): SampleIntervalDataPoint | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): SampleIntervalDataPoint | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): SampleIntervalDataPoint | null;
   ...
   */
  replaceType(old: Type, new_: Type): SampleIntervalDataPoint;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): SampleIntervalDataPoint;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): SampleIntervalDataPoint;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<SampleIntervalDataPoint | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<SampleIntervalDataPoint | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): SampleIntervalDataPoint;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SampleIntervalDataPoint;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SampleIntervalDataPoint;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): SampleIntervalDataPoint;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): SampleIntervalDataPoint;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): SampleIntervalDataPoint;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): SampleIntervalDataPoint;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): SampleIntervalDataPoint;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): SampleIntervalDataPoint;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): SampleIntervalDataPoint;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): SampleIntervalDataPoint;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): SampleIntervalDataPoint;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): SampleIntervalDataPoint;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): SampleIntervalDataPoint;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): SampleIntervalDataPoint;
   ...
   * @see #unsetField
   */
  defaultField(field: string): SampleIntervalDataPoint;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): SampleIntervalDataPoint;
   ...
   * @see #removeField
   */
  unsetField(field: string): SampleIntervalDataPoint;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): SampleIntervalDataPoint;
   ...
   * @see #unsetField
   */
  removeField(field: string): SampleIntervalDataPoint;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): SampleIntervalDataPoint;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): SampleIntervalDataPoint;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): SampleIntervalDataPoint;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): SampleIntervalDataPoint;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): SampleIntervalDataPoint;

  mergeJson(json: any | null): SampleIntervalDataPoint;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): SampleIntervalDataPoint;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): SampleIntervalDataPoint;
   ...
   */
  singletonArray(): C3.Array<SampleIntervalDataPoint | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<SampleIntervalDataPoint | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<SampleIntervalDataPoint | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<SampleIntervalDataPoint | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<SampleIntervalDataPoint | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, SampleIntervalDataPoint | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, SampleIntervalDataPoint | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<SampleIntervalDataPoint | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<SampleIntervalDataPoint | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): SampleIntervalDataPoint;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): SampleIntervalDataPoint;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): SampleIntervalDataPoint;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): SampleIntervalDataPoint;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): SampleIntervalDataPoint;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): SampleIntervalDataPoint;
   ...
   * @see #fromString
   */
  static make(s: string | null): SampleIntervalDataPoint | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): SampleIntervalDataPoint;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): SampleIntervalDataPoint;
   ...
   */
  static cachedEmptyInst(): SampleIntervalDataPoint;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<SampleIntervalDataPoint>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): SampleIntervalDataPoint;

  /**
   * Extract the partition key from the given obj
   */
  partitionKey(failIfMissing?: boolean): SampleCollectionTimeSeries | null;
   ...
   */
  static partition(objs?: Stream<SampleIntervalDataPoint | null>, spec?: PartitionBucketStrategy | null): C3.Map<string | null, KvDataPartition | null>;
   ...
   */
  static fromPartitions(partitions?: Stream<KvDataPartition | null>): Stream<SampleIntervalDataPoint | null>;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<SampleIntervalDataPoint | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<SampleIntervalDataPoint | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<SampleIntervalDataPoint | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<SampleIntervalDataPoint | null> | null>;
   ...
   */
  get(include?: string | null): SampleIntervalDataPoint | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): SampleIntervalDataPoint | null;
   ...
   */
  getMissing(spec: GetMissingSpec): SampleIntervalDataPoint;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): SampleIntervalDataPoint | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): SampleIntervalDataPoint;
   ...
   * @see #toString
   */
  static fromString(s: string | null): SampleIntervalDataPoint | null;
   ...
   */
  create(spec?: UpsertSpec | null): SampleIntervalDataPoint | null;
   ...
   */
  static createBatch(objs: C3.Array<SampleIntervalDataPoint | null> | null, spec?: UpsertSpec | null): ObjList<SampleIntervalDataPoint | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<SampleIntervalDataPoint | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<SampleIntervalDataPoint | null> | null;
   ...
   */
  update(srcObj?: SampleIntervalDataPoint | null, spec?: UpsertSpec | null): SampleIntervalDataPoint | null;
   ...
   */
  upsert(srcObj?: SampleIntervalDataPoint | null, spec?: UpsertSpec | null): SampleIntervalDataPoint | null;
   ...
   */
  merge(spec?: MergeSpec | null): SampleIntervalDataPoint | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): SampleIntervalDataPoint | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): SampleIntervalDataPoint | null;
   ...
   */
  static updateBatch(objs: C3.Array<SampleIntervalDataPoint | null> | null, srcObjs?: C3.Array<SampleIntervalDataPoint | null>, spec?: UpsertSpec | null): ObjList<SampleIntervalDataPoint | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<SampleIntervalDataPoint | null>>, spec?: UpsertSpec | null): ObjList<SampleIntervalDataPoint | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<SampleIntervalDataPoint | null> | null, srcObjs?: C3.Array<SampleIntervalDataPoint | null>, spec?: UpsertSpec | null): ObjList<SampleIntervalDataPoint | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<SampleIntervalDataPoint | null>>, spec?: UpsertSpec | null): ObjList<SampleIntervalDataPoint | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<SampleIntervalDataPoint | null> | null, spec?: TouchSpec | null): ObjList<SampleIntervalDataPoint | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<SampleIntervalDataPoint | null> | null, spec?: MergeSpec | null): ObjList<SampleIntervalDataPoint | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<SampleIntervalDataPoint | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<SampleIntervalDataPoint | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<SampleIntervalDataPoint | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<SampleIntervalDataPoint | null> | null;
   ...
   */
  static mergeAll(mergeObj: SampleIntervalDataPoint | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: SampleIntervalDataPoint | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<SampleIntervalDataPoint | null> | null, spec?: UpsertSpec | null): ObjList<SampleIntervalDataPoint | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<SampleIntervalDataPoint | null> | null, spec?: UpsertSpec | null): ObjList<SampleIntervalDataPoint | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): SampleIntervalDataPoint | null;
   ...
   */
  static beforeCreate(objs: C3.Array<SampleIntervalDataPoint | null> | null): ObjList<SampleIntervalDataPoint | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<SampleIntervalDataPoint | null> | null): ObjList<SampleIntervalDataPoint | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<SampleIntervalDataPoint | null> | null): ObjList<SampleIntervalDataPoint | null>;
   ...
   */
  static afterCreate(objs: C3.Array<SampleIntervalDataPoint | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<SampleIntervalDataPoint | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<SampleIntervalDataPoint | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<SampleIntervalDataPoint | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<SampleIntervalDataPoint | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): SampleIntervalDataPoint | null;
   ...
   */
  withoutIdentity(): SampleIntervalDataPoint | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<SampleIntervalDataPoint | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: SampleIntervalDataPoint | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<SampleIntervalDataPoint | null> | null, callback?: λFunction<SampleIntervalDataPoint | null, SampleIntervalDataPoint | null> | null): ObjList<SampleIntervalDataPoint | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<SampleIntervalDataPoint | null> | null, callback?: λFunction<SampleIntervalDataPoint | null, SampleIntervalDataPoint | null> | null): C3.Array<ObjError | null>;
