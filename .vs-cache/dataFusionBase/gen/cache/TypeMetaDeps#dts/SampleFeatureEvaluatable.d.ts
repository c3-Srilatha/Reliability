// TypeScript definitions for the C3 type SampleFeatureEvaluatable

/**
 * A smart bulb entity that can be used to derive features for machine learning.
 *
 * @remarks this represents a value passed to a method that expects an instance of SampleFeatureEvaluatable
 */
declare interface ISampleFeatureEvaluatable {
 ...
 */
declare class SampleFeatureEvaluatable extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): SampleFeatureEvaluatable | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): SampleFeatureEvaluatable | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): SampleFeatureEvaluatable | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): SampleFeatureEvaluatable | null;
   ...
   */
  replaceType(old: Type, new_: Type): SampleFeatureEvaluatable;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): SampleFeatureEvaluatable;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): SampleFeatureEvaluatable;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<SampleFeatureEvaluatable | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<SampleFeatureEvaluatable | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): SampleFeatureEvaluatable;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SampleFeatureEvaluatable;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SampleFeatureEvaluatable;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): SampleFeatureEvaluatable;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): SampleFeatureEvaluatable;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): SampleFeatureEvaluatable;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): SampleFeatureEvaluatable;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): SampleFeatureEvaluatable;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): SampleFeatureEvaluatable;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): SampleFeatureEvaluatable;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): SampleFeatureEvaluatable;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): SampleFeatureEvaluatable;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): SampleFeatureEvaluatable;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): SampleFeatureEvaluatable;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): SampleFeatureEvaluatable;
   ...
   * @see #unsetField
   */
  defaultField(field: string): SampleFeatureEvaluatable;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): SampleFeatureEvaluatable;
   ...
   * @see #removeField
   */
  unsetField(field: string): SampleFeatureEvaluatable;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): SampleFeatureEvaluatable;
   ...
   * @see #unsetField
   */
  removeField(field: string): SampleFeatureEvaluatable;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): SampleFeatureEvaluatable;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): SampleFeatureEvaluatable;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): SampleFeatureEvaluatable;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): SampleFeatureEvaluatable;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): SampleFeatureEvaluatable;

  mergeJson(json: any | null): SampleFeatureEvaluatable;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): SampleFeatureEvaluatable;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): SampleFeatureEvaluatable;
   ...
   */
  singletonArray(): C3.Array<SampleFeatureEvaluatable | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<SampleFeatureEvaluatable | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<SampleFeatureEvaluatable | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<SampleFeatureEvaluatable | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<SampleFeatureEvaluatable | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, SampleFeatureEvaluatable | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, SampleFeatureEvaluatable | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<SampleFeatureEvaluatable | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<SampleFeatureEvaluatable | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): SampleFeatureEvaluatable;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): SampleFeatureEvaluatable;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): SampleFeatureEvaluatable;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): SampleFeatureEvaluatable;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): SampleFeatureEvaluatable;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): SampleFeatureEvaluatable;
   ...
   * @see #fromString
   */
  static make(s: string | null): SampleFeatureEvaluatable | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): SampleFeatureEvaluatable;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): SampleFeatureEvaluatable;
   ...
   */
  static cachedEmptyInst(): SampleFeatureEvaluatable;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<SampleFeatureEvaluatable>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): SampleFeatureEvaluatable;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<SampleFeatureEvaluatable | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<SampleFeatureEvaluatable | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<SampleFeatureEvaluatable | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<SampleFeatureEvaluatable | null> | null>;
   ...
   * @see Data
   */
  static evalFeatureSetBatch(batch: C3.Array<SampleFeatureEvaluatable | null>, featureSet: Feature.Set, spec?: EvalFeatureSpec | null): Data | null;
   ...
   * @see EvalFeaturesSpec
   */
  static evalFeaturesBatch(batch: C3.Array<SampleFeatureEvaluatable | null>, features: C3.Array<string | null>, spec?: EvalFeaturesSpec | null): Data | null;
   ...
   */
  get(include?: string | null): SampleFeatureEvaluatable | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): SampleFeatureEvaluatable | null;
   ...
   */
  getMissing(spec: GetMissingSpec): SampleFeatureEvaluatable;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): SampleFeatureEvaluatable | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): SampleFeatureEvaluatable;
   ...
   * @see #toString
   */
  static fromString(s: string | null): SampleFeatureEvaluatable | null;
   ...
   */
  create(spec?: UpsertSpec | null): SampleFeatureEvaluatable | null;
   ...
   */
  static createBatch(objs: C3.Array<SampleFeatureEvaluatable | null> | null, spec?: UpsertSpec | null): ObjList<SampleFeatureEvaluatable | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<SampleFeatureEvaluatable | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<SampleFeatureEvaluatable | null> | null;
   ...
   */
  update(srcObj?: SampleFeatureEvaluatable | null, spec?: UpsertSpec | null): SampleFeatureEvaluatable | null;
   ...
   */
  upsert(srcObj?: SampleFeatureEvaluatable | null, spec?: UpsertSpec | null): SampleFeatureEvaluatable | null;
   ...
   */
  merge(spec?: MergeSpec | null): SampleFeatureEvaluatable | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): SampleFeatureEvaluatable | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): SampleFeatureEvaluatable | null;
   ...
   */
  static updateBatch(objs: C3.Array<SampleFeatureEvaluatable | null> | null, srcObjs?: C3.Array<SampleFeatureEvaluatable | null>, spec?: UpsertSpec | null): ObjList<SampleFeatureEvaluatable | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<SampleFeatureEvaluatable | null>>, spec?: UpsertSpec | null): ObjList<SampleFeatureEvaluatable | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<SampleFeatureEvaluatable | null> | null, srcObjs?: C3.Array<SampleFeatureEvaluatable | null>, spec?: UpsertSpec | null): ObjList<SampleFeatureEvaluatable | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<SampleFeatureEvaluatable | null>>, spec?: UpsertSpec | null): ObjList<SampleFeatureEvaluatable | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<SampleFeatureEvaluatable | null> | null, spec?: TouchSpec | null): ObjList<SampleFeatureEvaluatable | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<SampleFeatureEvaluatable | null> | null, spec?: MergeSpec | null): ObjList<SampleFeatureEvaluatable | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<SampleFeatureEvaluatable | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<SampleFeatureEvaluatable | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<SampleFeatureEvaluatable | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<SampleFeatureEvaluatable | null> | null;
   ...
   */
  static mergeAll(mergeObj: SampleFeatureEvaluatable | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: SampleFeatureEvaluatable | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<SampleFeatureEvaluatable | null> | null, spec?: UpsertSpec | null): ObjList<SampleFeatureEvaluatable | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<SampleFeatureEvaluatable | null> | null, spec?: UpsertSpec | null): ObjList<SampleFeatureEvaluatable | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): SampleFeatureEvaluatable | null;
   ...
   */
  static beforeCreate(objs: C3.Array<SampleFeatureEvaluatable | null> | null): ObjList<SampleFeatureEvaluatable | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<SampleFeatureEvaluatable | null> | null): ObjList<SampleFeatureEvaluatable | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<SampleFeatureEvaluatable | null> | null): ObjList<SampleFeatureEvaluatable | null>;
   ...
   */
  static afterCreate(objs: C3.Array<SampleFeatureEvaluatable | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<SampleFeatureEvaluatable | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<SampleFeatureEvaluatable | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<SampleFeatureEvaluatable | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<SampleFeatureEvaluatable | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): SampleFeatureEvaluatable | null;
   ...
   */
  withoutIdentity(): SampleFeatureEvaluatable | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<SampleFeatureEvaluatable | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: SampleFeatureEvaluatable | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<SampleFeatureEvaluatable | null> | null, callback?: λFunction<SampleFeatureEvaluatable | null, SampleFeatureEvaluatable | null> | null): ObjList<SampleFeatureEvaluatable | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<SampleFeatureEvaluatable | null> | null, callback?: λFunction<SampleFeatureEvaluatable | null, SampleFeatureEvaluatable | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static getAverageTemperature(timestamp?: DateTime | null): number | null;
}
