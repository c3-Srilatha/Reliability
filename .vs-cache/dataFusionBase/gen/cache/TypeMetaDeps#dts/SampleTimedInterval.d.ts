// TypeScript definitions for the C3 type SampleTimedInterval

/**
 * Ties a start and end timestamp to the relationship between 2 entities.
 *
 * @remarks this represents a value passed to a method that expects an instance of SampleTimedInterval
 */
declare interface ISampleTimedInterval<F, T> {
 ...
 */
declare class SampleTimedInterval<F, T> extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): SampleTimedInterval<F, T> | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): SampleTimedInterval<F, T> | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): SampleTimedInterval<F, T> | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): SampleTimedInterval<F, T> | null;
   ...
   */
  replaceType(old: Type, new_: Type): SampleTimedInterval<F, T>;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): SampleTimedInterval<F, T>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): SampleTimedInterval<F, T>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<SampleTimedInterval<F, T> | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<SampleTimedInterval<F, T> | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): SampleTimedInterval<F, T>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SampleTimedInterval<F, T>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SampleTimedInterval<F, T>;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): SampleTimedInterval<F, T>;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): SampleTimedInterval<F, T>;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): SampleTimedInterval<F, T>;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): SampleTimedInterval<F, T>;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): SampleTimedInterval<F, T>;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): SampleTimedInterval<F, T>;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): SampleTimedInterval<F, T>;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): SampleTimedInterval<F, T>;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): SampleTimedInterval<F, T>;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): SampleTimedInterval<F, T>;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): SampleTimedInterval<F, T>;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): SampleTimedInterval<F, T>;
   ...
   * @see #unsetField
   */
  defaultField(field: string): SampleTimedInterval<F, T>;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): SampleTimedInterval<F, T>;
   ...
   * @see #removeField
   */
  unsetField(field: string): SampleTimedInterval<F, T>;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): SampleTimedInterval<F, T>;
   ...
   * @see #unsetField
   */
  removeField(field: string): SampleTimedInterval<F, T>;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): SampleTimedInterval<F, T>;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): SampleTimedInterval<F, T>;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): SampleTimedInterval<F, T>;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): SampleTimedInterval<F, T>;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): SampleTimedInterval<F, T>;

  mergeJson(json: any | null): SampleTimedInterval<F, T>;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): SampleTimedInterval<F, T>;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): SampleTimedInterval<F, T>;
   ...
   */
  singletonArray(): C3.Array<SampleTimedInterval<F, T> | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<SampleTimedInterval<F, T> | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<SampleTimedInterval<F, T> | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<SampleTimedInterval<F, T> | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<SampleTimedInterval<F, T> | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, SampleTimedInterval<F, T> | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, SampleTimedInterval<F, T> | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<SampleTimedInterval<F, T> | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<SampleTimedInterval<F, T> | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): SampleTimedInterval<F, T>;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): SampleTimedInterval<F, T>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): SampleTimedInterval<F, T>;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): SampleTimedInterval<F, T>;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): SampleTimedInterval<F, T>;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): SampleTimedInterval<F, T>;
   ...
   * @see #fromString
   */
  static make(s: string | null): SampleTimedInterval<F, T> | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): SampleTimedInterval<F, T>;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): SampleTimedInterval<F, T>;
   ...
   */
  static cachedEmptyInst(): SampleTimedInterval<F, T>;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<SampleTimedInterval<F, T>>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): SampleTimedInterval<F, T>;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<SampleTimedInterval<F, T> | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<SampleTimedInterval<F, T> | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<SampleTimedInterval<F, T> | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<SampleTimedInterval<F, T> | null> | null>;
   ...
   */
  get(include?: string | null): SampleTimedInterval<F, T> | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): SampleTimedInterval<F, T> | null;
   ...
   */
  getMissing(spec: GetMissingSpec): SampleTimedInterval<F, T>;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): SampleTimedInterval<F, T> | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): SampleTimedInterval<F, T>;
   ...
   * @see #toString
   */
  static fromString(s: string | null): SampleTimedInterval<F, T> | null;
   ...
   */
  create(spec?: UpsertSpec | null): SampleTimedInterval<F, T> | null;
   ...
   */
  static createBatch(objs: C3.Array<SampleTimedInterval<F, T> | null> | null, spec?: UpsertSpec | null): ObjList<SampleTimedInterval<F, T> | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<SampleTimedInterval<F, T> | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<SampleTimedInterval<F, T> | null> | null;
   ...
   */
  update(srcObj?: SampleTimedInterval<F, T> | null, spec?: UpsertSpec | null): SampleTimedInterval<F, T> | null;
   ...
   */
  upsert(srcObj?: SampleTimedInterval<F, T> | null, spec?: UpsertSpec | null): SampleTimedInterval<F, T> | null;
   ...
   */
  merge(spec?: MergeSpec | null): SampleTimedInterval<F, T> | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): SampleTimedInterval<F, T> | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): SampleTimedInterval<F, T> | null;
   ...
   */
  static updateBatch(objs: C3.Array<SampleTimedInterval<F, T> | null> | null, srcObjs?: C3.Array<SampleTimedInterval<F, T> | null>, spec?: UpsertSpec | null): ObjList<SampleTimedInterval<F, T> | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<SampleTimedInterval<F, T> | null>>, spec?: UpsertSpec | null): ObjList<SampleTimedInterval<F, T> | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<SampleTimedInterval<F, T> | null> | null, srcObjs?: C3.Array<SampleTimedInterval<F, T> | null>, spec?: UpsertSpec | null): ObjList<SampleTimedInterval<F, T> | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<SampleTimedInterval<F, T> | null>>, spec?: UpsertSpec | null): ObjList<SampleTimedInterval<F, T> | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<SampleTimedInterval<F, T> | null> | null, spec?: TouchSpec | null): ObjList<SampleTimedInterval<F, T> | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<SampleTimedInterval<F, T> | null> | null, spec?: MergeSpec | null): ObjList<SampleTimedInterval<F, T> | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<SampleTimedInterval<F, T> | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<SampleTimedInterval<F, T> | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<SampleTimedInterval<F, T> | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<SampleTimedInterval<F, T> | null> | null;
   ...
   */
  static mergeAll(mergeObj: SampleTimedInterval<F, T> | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: SampleTimedInterval<F, T> | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<SampleTimedInterval<F, T> | null> | null, spec?: UpsertSpec | null): ObjList<SampleTimedInterval<F, T> | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<SampleTimedInterval<F, T> | null> | null, spec?: UpsertSpec | null): ObjList<SampleTimedInterval<F, T> | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): SampleTimedInterval<F, T> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<SampleTimedInterval<F, T> | null> | null): ObjList<SampleTimedInterval<F, T> | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<SampleTimedInterval<F, T> | null> | null): ObjList<SampleTimedInterval<F, T> | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<SampleTimedInterval<F, T> | null> | null): ObjList<SampleTimedInterval<F, T> | null>;
   ...
   */
  static afterCreate(objs: C3.Array<SampleTimedInterval<F, T> | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<SampleTimedInterval<F, T> | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<SampleTimedInterval<F, T> | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<SampleTimedInterval<F, T> | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<SampleTimedInterval<F, T> | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): SampleTimedInterval<F, T> | null;
   ...
   */
  withoutIdentity(): SampleTimedInterval<F, T> | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<SampleTimedInterval<F, T> | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: SampleTimedInterval<F, T> | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<SampleTimedInterval<F, T> | null> | null, callback?: λFunction<SampleTimedInterval<F, T> | null, SampleTimedInterval<F, T> | null> | null): ObjList<SampleTimedInterval<F, T> | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<SampleTimedInterval<F, T> | null> | null, callback?: λFunction<SampleTimedInterval<F, T> | null, SampleTimedInterval<F, T> | null> | null): C3.Array<ObjError | null>;
