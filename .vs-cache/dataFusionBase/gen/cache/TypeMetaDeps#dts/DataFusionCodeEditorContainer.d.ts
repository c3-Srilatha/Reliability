// TypeScript definitions for the C3 type DataFusionCodeEditorContainer

/**
 * Type to represent the container of the code editor. Includes type/function list, problems console, header
 *
 * @remarks this represents a value passed to a method that expects an instance of DataFusionCodeEditorContainer
 */
declare interface IDataFusionCodeEditorContainer {
 ...
 * Type to represent the container of the code editor. Includes type/function list, problems console, header
 *
 * @remarks this represents a made instance of DataFusionCodeEditorContainer
 */
declare class DataFusionCodeEditorContainer extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): DataFusionCodeEditorContainer | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): DataFusionCodeEditorContainer | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): DataFusionCodeEditorContainer | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): DataFusionCodeEditorContainer | null;
   ...
   */
  replaceType(old: Type, new_: Type): DataFusionCodeEditorContainer;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DataFusionCodeEditorContainer;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DataFusionCodeEditorContainer;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DataFusionCodeEditorContainer | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DataFusionCodeEditorContainer | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): DataFusionCodeEditorContainer;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DataFusionCodeEditorContainer;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DataFusionCodeEditorContainer;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): DataFusionCodeEditorContainer;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): DataFusionCodeEditorContainer;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): DataFusionCodeEditorContainer;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): DataFusionCodeEditorContainer;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): DataFusionCodeEditorContainer;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): DataFusionCodeEditorContainer;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): DataFusionCodeEditorContainer;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): DataFusionCodeEditorContainer;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): DataFusionCodeEditorContainer;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): DataFusionCodeEditorContainer;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): DataFusionCodeEditorContainer;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): DataFusionCodeEditorContainer;
   ...
   * @see #unsetField
   */
  defaultField(field: string): DataFusionCodeEditorContainer;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): DataFusionCodeEditorContainer;
   ...
   * @see #removeField
   */
  unsetField(field: string): DataFusionCodeEditorContainer;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): DataFusionCodeEditorContainer;
   ...
   * @see #unsetField
   */
  removeField(field: string): DataFusionCodeEditorContainer;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): DataFusionCodeEditorContainer;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): DataFusionCodeEditorContainer;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): DataFusionCodeEditorContainer;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): DataFusionCodeEditorContainer;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): DataFusionCodeEditorContainer;

  mergeJson(json: any | null): DataFusionCodeEditorContainer;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): DataFusionCodeEditorContainer;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): DataFusionCodeEditorContainer;
   ...
   */
  singletonArray(): C3.Array<DataFusionCodeEditorContainer | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<DataFusionCodeEditorContainer | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<DataFusionCodeEditorContainer | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<DataFusionCodeEditorContainer | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<DataFusionCodeEditorContainer | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, DataFusionCodeEditorContainer | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, DataFusionCodeEditorContainer | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<DataFusionCodeEditorContainer | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<DataFusionCodeEditorContainer | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): DataFusionCodeEditorContainer;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): DataFusionCodeEditorContainer;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): DataFusionCodeEditorContainer;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): DataFusionCodeEditorContainer;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): DataFusionCodeEditorContainer;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): DataFusionCodeEditorContainer;
   ...
   * @see #fromString
   */
  static make(s: string | null): DataFusionCodeEditorContainer | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): DataFusionCodeEditorContainer;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): DataFusionCodeEditorContainer;
   ...
   */
  static cachedEmptyInst(): DataFusionCodeEditorContainer;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<DataFusionCodeEditorContainer>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): DataFusionCodeEditorContainer;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<DataFusionCodeEditorContainer | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<DataFusionCodeEditorContainer | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<DataFusionCodeEditorContainer | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<DataFusionCodeEditorContainer | null> | null>;
   ...
   */
  dependencies(): MetadataDeps<DataFusionCodeEditorContainer | null>;

  save(subPath?: string | null, contentType?: string | null): DataFusionCodeEditorContainer;
  ...
  update(srcObj?: DataFusionCodeEditorContainer | null, spec?: UpsertSpec | null): DataFusionCodeEditorContainer | null;

  upsert(srcObj?: DataFusionCodeEditorContainer | null, spec?: UpsertSpec | null): DataFusionCodeEditorContainer | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): DataFusionCodeEditorContainer | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string | null, failIfMissing?: boolean): DataFusionCodeEditorContainer | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: DataFusionCodeEditorContainer, state: UiSdlReduxState): DataFusionCodeEditorContainer | null;
