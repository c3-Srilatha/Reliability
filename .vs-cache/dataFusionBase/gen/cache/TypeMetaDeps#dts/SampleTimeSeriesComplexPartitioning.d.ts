// TypeScript definitions for the C3 type SampleTimeSeriesComplexPartitioning
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of SampleTimeSeriesComplexPartitioning
 */
declare interface ISampleTimeSeriesComplexPartitioning {
 ...
 */
declare class SampleTimeSeriesComplexPartitioning extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): SampleTimeSeriesComplexPartitioning | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): SampleTimeSeriesComplexPartitioning | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): SampleTimeSeriesComplexPartitioning | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): SampleTimeSeriesComplexPartitioning | null;
   ...
   */
  replaceType(old: Type, new_: Type): SampleTimeSeriesComplexPartitioning;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): SampleTimeSeriesComplexPartitioning;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): SampleTimeSeriesComplexPartitioning;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<SampleTimeSeriesComplexPartitioning | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<SampleTimeSeriesComplexPartitioning | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): SampleTimeSeriesComplexPartitioning;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SampleTimeSeriesComplexPartitioning;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SampleTimeSeriesComplexPartitioning;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): SampleTimeSeriesComplexPartitioning;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): SampleTimeSeriesComplexPartitioning;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): SampleTimeSeriesComplexPartitioning;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): SampleTimeSeriesComplexPartitioning;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): SampleTimeSeriesComplexPartitioning;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): SampleTimeSeriesComplexPartitioning;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): SampleTimeSeriesComplexPartitioning;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): SampleTimeSeriesComplexPartitioning;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): SampleTimeSeriesComplexPartitioning;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): SampleTimeSeriesComplexPartitioning;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): SampleTimeSeriesComplexPartitioning;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): SampleTimeSeriesComplexPartitioning;
   ...
   * @see #unsetField
   */
  defaultField(field: string): SampleTimeSeriesComplexPartitioning;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): SampleTimeSeriesComplexPartitioning;
   ...
   * @see #removeField
   */
  unsetField(field: string): SampleTimeSeriesComplexPartitioning;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): SampleTimeSeriesComplexPartitioning;
   ...
   * @see #unsetField
   */
  removeField(field: string): SampleTimeSeriesComplexPartitioning;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): SampleTimeSeriesComplexPartitioning;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): SampleTimeSeriesComplexPartitioning;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): SampleTimeSeriesComplexPartitioning;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): SampleTimeSeriesComplexPartitioning;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): SampleTimeSeriesComplexPartitioning;

  mergeJson(json: any | null): SampleTimeSeriesComplexPartitioning;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): SampleTimeSeriesComplexPartitioning;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): SampleTimeSeriesComplexPartitioning;
   ...
   */
  singletonArray(): C3.Array<SampleTimeSeriesComplexPartitioning | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<SampleTimeSeriesComplexPartitioning | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<SampleTimeSeriesComplexPartitioning | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<SampleTimeSeriesComplexPartitioning | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<SampleTimeSeriesComplexPartitioning | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, SampleTimeSeriesComplexPartitioning | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, SampleTimeSeriesComplexPartitioning | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<SampleTimeSeriesComplexPartitioning | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<SampleTimeSeriesComplexPartitioning | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): SampleTimeSeriesComplexPartitioning;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): SampleTimeSeriesComplexPartitioning;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): SampleTimeSeriesComplexPartitioning;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): SampleTimeSeriesComplexPartitioning;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): SampleTimeSeriesComplexPartitioning;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): SampleTimeSeriesComplexPartitioning;
   ...
   * @see #fromString
   */
  static make(s: string | null): SampleTimeSeriesComplexPartitioning | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): SampleTimeSeriesComplexPartitioning;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): SampleTimeSeriesComplexPartitioning;
   ...
   */
  static cachedEmptyInst(): SampleTimeSeriesComplexPartitioning;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<SampleTimeSeriesComplexPartitioning>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): SampleTimeSeriesComplexPartitioning;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<SampleTimeSeriesComplexPartitioning | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<SampleTimeSeriesComplexPartitioning | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<SampleTimeSeriesComplexPartitioning | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<SampleTimeSeriesComplexPartitioning | null> | null>;
   ...
   * @see Data
   */
  static evalFeatureSetBatch(batch: C3.Array<SampleTimeSeriesComplexPartitioning | null>, featureSet: Feature.Set, spec?: EvalFeatureSpec | null): Data | null;
   ...
   * @see EvalFeaturesSpec
   */
  static evalFeaturesBatch(batch: C3.Array<SampleTimeSeriesComplexPartitioning | null>, features: C3.Array<string | null>, spec?: EvalFeaturesSpec | null): Data | null;
   ...
   */
  get(include?: string | null): SampleTimeSeriesComplexPartitioning | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): SampleTimeSeriesComplexPartitioning | null;
   ...
   */
  getMissing(spec: GetMissingSpec): SampleTimeSeriesComplexPartitioning;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): SampleTimeSeriesComplexPartitioning | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): SampleTimeSeriesComplexPartitioning;
   ...
   * @see #toString
   */
  static fromString(s: string | null): SampleTimeSeriesComplexPartitioning | null;
   ...
   */
  create(spec?: UpsertSpec | null): SampleTimeSeriesComplexPartitioning | null;
   ...
   */
  static createBatch(objs: C3.Array<SampleTimeSeriesComplexPartitioning | null> | null, spec?: UpsertSpec | null): ObjList<SampleTimeSeriesComplexPartitioning | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<SampleTimeSeriesComplexPartitioning | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<SampleTimeSeriesComplexPartitioning | null> | null;
   ...
   */
  update(srcObj?: SampleTimeSeriesComplexPartitioning | null, spec?: UpsertSpec | null): SampleTimeSeriesComplexPartitioning | null;
   ...
   */
  upsert(srcObj?: SampleTimeSeriesComplexPartitioning | null, spec?: UpsertSpec | null): SampleTimeSeriesComplexPartitioning | null;
   ...
   */
  merge(spec?: MergeSpec | null): SampleTimeSeriesComplexPartitioning | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): SampleTimeSeriesComplexPartitioning | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): SampleTimeSeriesComplexPartitioning | null;
   ...
   */
  static updateBatch(objs: C3.Array<SampleTimeSeriesComplexPartitioning | null> | null, srcObjs?: C3.Array<SampleTimeSeriesComplexPartitioning | null>, spec?: UpsertSpec | null): ObjList<SampleTimeSeriesComplexPartitioning | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<SampleTimeSeriesComplexPartitioning | null>>, spec?: UpsertSpec | null): ObjList<SampleTimeSeriesComplexPartitioning | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<SampleTimeSeriesComplexPartitioning | null> | null, srcObjs?: C3.Array<SampleTimeSeriesComplexPartitioning | null>, spec?: UpsertSpec | null): ObjList<SampleTimeSeriesComplexPartitioning | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<SampleTimeSeriesComplexPartitioning | null>>, spec?: UpsertSpec | null): ObjList<SampleTimeSeriesComplexPartitioning | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<SampleTimeSeriesComplexPartitioning | null> | null, spec?: TouchSpec | null): ObjList<SampleTimeSeriesComplexPartitioning | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<SampleTimeSeriesComplexPartitioning | null> | null, spec?: MergeSpec | null): ObjList<SampleTimeSeriesComplexPartitioning | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<SampleTimeSeriesComplexPartitioning | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<SampleTimeSeriesComplexPartitioning | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<SampleTimeSeriesComplexPartitioning | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<SampleTimeSeriesComplexPartitioning | null> | null;
   ...
   */
  static mergeAll(mergeObj: SampleTimeSeriesComplexPartitioning | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: SampleTimeSeriesComplexPartitioning | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<SampleTimeSeriesComplexPartitioning | null> | null, spec?: UpsertSpec | null): ObjList<SampleTimeSeriesComplexPartitioning | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<SampleTimeSeriesComplexPartitioning | null> | null, spec?: UpsertSpec | null): ObjList<SampleTimeSeriesComplexPartitioning | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): SampleTimeSeriesComplexPartitioning | null;
   ...
   */
  static beforeCreate(objs: C3.Array<SampleTimeSeriesComplexPartitioning | null> | null): ObjList<SampleTimeSeriesComplexPartitioning | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<SampleTimeSeriesComplexPartitioning | null> | null): ObjList<SampleTimeSeriesComplexPartitioning | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<SampleTimeSeriesComplexPartitioning | null> | null): ObjList<SampleTimeSeriesComplexPartitioning | null>;
   ...
   */
  static afterCreate(objs: C3.Array<SampleTimeSeriesComplexPartitioning | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<SampleTimeSeriesComplexPartitioning | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<SampleTimeSeriesComplexPartitioning | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<SampleTimeSeriesComplexPartitioning | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<SampleTimeSeriesComplexPartitioning | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): SampleTimeSeriesComplexPartitioning | null;
   ...
   */
  withoutIdentity(): SampleTimeSeriesComplexPartitioning | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<SampleTimeSeriesComplexPartitioning | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: SampleTimeSeriesComplexPartitioning | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<SampleTimeSeriesComplexPartitioning | null> | null, callback?: λFunction<SampleTimeSeriesComplexPartitioning | null, SampleTimeSeriesComplexPartitioning | null> | null): ObjList<SampleTimeSeriesComplexPartitioning | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<SampleTimeSeriesComplexPartitioning | null> | null, callback?: λFunction<SampleTimeSeriesComplexPartitioning | null, SampleTimeSeriesComplexPartitioning | null> | null): C3.Array<ObjError | null>;
