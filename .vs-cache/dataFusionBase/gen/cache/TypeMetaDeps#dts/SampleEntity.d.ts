// TypeScript definitions for the C3 type SampleEntity

/**
 * A simple relational entity type.
 *
 * @remarks this represents a value passed to a method that expects an instance of SampleEntity
 */
declare interface ISampleEntity {
  ...
  /**
   * Numerical value associated with the entity.
   */
  value?: number | null;
}
 ...
 * A simple relational entity type.
 *
 * @remarks this represents a made instance of SampleEntity
 */
declare class SampleEntity extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): SampleEntity | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): SampleEntity | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): SampleEntity | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): SampleEntity | null;
   ...
   */
  replaceType(old: Type, new_: Type): SampleEntity;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): SampleEntity;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): SampleEntity;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<SampleEntity | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<SampleEntity | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): SampleEntity;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SampleEntity;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SampleEntity;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): SampleEntity;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): SampleEntity;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): SampleEntity;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): SampleEntity;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): SampleEntity;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): SampleEntity;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): SampleEntity;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): SampleEntity;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): SampleEntity;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): SampleEntity;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): SampleEntity;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): SampleEntity;
   ...
   * @see #unsetField
   */
  defaultField(field: string): SampleEntity;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): SampleEntity;
   ...
   * @see #removeField
   */
  unsetField(field: string): SampleEntity;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): SampleEntity;
   ...
   * @see #unsetField
   */
  removeField(field: string): SampleEntity;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): SampleEntity;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): SampleEntity;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): SampleEntity;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): SampleEntity;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): SampleEntity;

  mergeJson(json: any | null): SampleEntity;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): SampleEntity;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): SampleEntity;
   ...
   */
  singletonArray(): C3.Array<SampleEntity | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<SampleEntity | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<SampleEntity | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<SampleEntity | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<SampleEntity | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, SampleEntity | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, SampleEntity | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<SampleEntity | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<SampleEntity | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): SampleEntity;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): SampleEntity;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): SampleEntity;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): SampleEntity;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): SampleEntity;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): SampleEntity;
   ...
   * @see #fromString
   */
  static make(s: string | null): SampleEntity | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): SampleEntity;
   ...
   */
  static cachedEmptyInst(): SampleEntity;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<SampleEntity>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): SampleEntity;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<SampleEntity | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<SampleEntity | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<SampleEntity | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<SampleEntity | null> | null>;
   ...
   */
  get(include?: string | null): SampleEntity | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): SampleEntity | null;
   ...
   */
  getMissing(spec: GetMissingSpec): SampleEntity;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): SampleEntity | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): SampleEntity;
   ...
   * @see #toString
   */
  static fromString(s: string | null): SampleEntity | null;
   ...
   */
  create(spec?: UpsertSpec | null): SampleEntity | null;
   ...
   */
  static createBatch(objs: C3.Array<SampleEntity | null> | null, spec?: UpsertSpec | null): ObjList<SampleEntity | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<SampleEntity | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<SampleEntity | null> | null;
   ...
   */
  update(srcObj?: SampleEntity | null, spec?: UpsertSpec | null): SampleEntity | null;
   ...
   */
  upsert(srcObj?: SampleEntity | null, spec?: UpsertSpec | null): SampleEntity | null;
   ...
   */
  merge(spec?: MergeSpec | null): SampleEntity | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): SampleEntity | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): SampleEntity | null;
   ...
   */
  static updateBatch(objs: C3.Array<SampleEntity | null> | null, srcObjs?: C3.Array<SampleEntity | null>, spec?: UpsertSpec | null): ObjList<SampleEntity | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<SampleEntity | null>>, spec?: UpsertSpec | null): ObjList<SampleEntity | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<SampleEntity | null> | null, srcObjs?: C3.Array<SampleEntity | null>, spec?: UpsertSpec | null): ObjList<SampleEntity | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<SampleEntity | null>>, spec?: UpsertSpec | null): ObjList<SampleEntity | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<SampleEntity | null> | null, spec?: TouchSpec | null): ObjList<SampleEntity | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<SampleEntity | null> | null, spec?: MergeSpec | null): ObjList<SampleEntity | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<SampleEntity | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<SampleEntity | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<SampleEntity | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<SampleEntity | null> | null;
   ...
   */
  static mergeAll(mergeObj: SampleEntity | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: SampleEntity | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<SampleEntity | null> | null, spec?: UpsertSpec | null): ObjList<SampleEntity | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<SampleEntity | null> | null, spec?: UpsertSpec | null): ObjList<SampleEntity | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<SampleEntity | null> | null): ObjList<SampleEntity | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<SampleEntity | null> | null): ObjList<SampleEntity | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<SampleEntity | null> | null): ObjList<SampleEntity | null>;
   ...
   */
  static afterCreate(objs: C3.Array<SampleEntity | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<SampleEntity | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<SampleEntity | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<SampleEntity | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<SampleEntity | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): SampleEntity | null;
   ...
   */
  withoutIdentity(): SampleEntity | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<SampleEntity | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: SampleEntity | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<SampleEntity | null> | null, callback?: λFunction<SampleEntity | null, SampleEntity | null> | null): ObjList<SampleEntity | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<SampleEntity | null> | null, callback?: λFunction<SampleEntity | null, SampleEntity | null> | null): C3.Array<ObjError | null>;
