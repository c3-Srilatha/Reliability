// TypeScript definitions for the C3 type SampleCalc

/**
 * @remarks this represents a value passed to a method that expects an instance of SampleCalc
 */
declare interface ISampleCalc {
  ...
  arry?: C3.Array<number | null> | Array<number | null>;

  calcInt?: number | null;

  calcArry?: C3.Array<number | null> | Array<number | null>;

  calcInt2?: number | null;

  calcInt3?: number | null;

  calcIntNested?: number | null;
}

/**
 * @remarks this represents a made instance of SampleCalc
 */
declare class SampleCalc extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): SampleCalc | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): SampleCalc | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): SampleCalc | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): SampleCalc | null;
   ...
   */
  replaceType(old: Type, new_: Type): SampleCalc;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): SampleCalc;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): SampleCalc;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<SampleCalc | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<SampleCalc | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): SampleCalc;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SampleCalc;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SampleCalc;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): SampleCalc;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): SampleCalc;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): SampleCalc;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): SampleCalc;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): SampleCalc;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): SampleCalc;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): SampleCalc;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): SampleCalc;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): SampleCalc;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): SampleCalc;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): SampleCalc;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): SampleCalc;
   ...
   * @see #unsetField
   */
  defaultField(field: string): SampleCalc;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): SampleCalc;
   ...
   * @see #removeField
   */
  unsetField(field: string): SampleCalc;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): SampleCalc;
   ...
   * @see #unsetField
   */
  removeField(field: string): SampleCalc;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): SampleCalc;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): SampleCalc;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): SampleCalc;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): SampleCalc;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): SampleCalc;

  mergeJson(json: any | null): SampleCalc;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): SampleCalc;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): SampleCalc;
   ...
   */
  singletonArray(): C3.Array<SampleCalc | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<SampleCalc | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<SampleCalc | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<SampleCalc | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<SampleCalc | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, SampleCalc | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, SampleCalc | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<SampleCalc | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<SampleCalc | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): SampleCalc;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): SampleCalc;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): SampleCalc;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): SampleCalc;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): SampleCalc;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): SampleCalc;
   ...
   * @see #fromString
   */
  static make(s: string | null): SampleCalc | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): SampleCalc;
   ...
   */
  static cachedEmptyInst(): SampleCalc;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<SampleCalc>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): SampleCalc;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<SampleCalc | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<SampleCalc | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<SampleCalc | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<SampleCalc | null> | null>;
   ...
   */
  get(include?: string | null): SampleCalc | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): SampleCalc | null;
   ...
   */
  getMissing(spec: GetMissingSpec): SampleCalc;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): SampleCalc | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): SampleCalc;
   ...
   * @see #toString
   */
  static fromString(s: string | null): SampleCalc | null;
   ...
   */
  create(spec?: UpsertSpec | null): SampleCalc | null;
   ...
   */
  static createBatch(objs: C3.Array<SampleCalc | null> | null, spec?: UpsertSpec | null): ObjList<SampleCalc | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<SampleCalc | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<SampleCalc | null> | null;
   ...
   */
  update(srcObj?: SampleCalc | null, spec?: UpsertSpec | null): SampleCalc | null;
   ...
   */
  upsert(srcObj?: SampleCalc | null, spec?: UpsertSpec | null): SampleCalc | null;
   ...
   */
  merge(spec?: MergeSpec | null): SampleCalc | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): SampleCalc | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): SampleCalc | null;
   ...
   */
  static updateBatch(objs: C3.Array<SampleCalc | null> | null, srcObjs?: C3.Array<SampleCalc | null>, spec?: UpsertSpec | null): ObjList<SampleCalc | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<SampleCalc | null>>, spec?: UpsertSpec | null): ObjList<SampleCalc | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<SampleCalc | null> | null, srcObjs?: C3.Array<SampleCalc | null>, spec?: UpsertSpec | null): ObjList<SampleCalc | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<SampleCalc | null>>, spec?: UpsertSpec | null): ObjList<SampleCalc | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<SampleCalc | null> | null, spec?: TouchSpec | null): ObjList<SampleCalc | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<SampleCalc | null> | null, spec?: MergeSpec | null): ObjList<SampleCalc | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<SampleCalc | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<SampleCalc | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<SampleCalc | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<SampleCalc | null> | null;
   ...
   */
  static mergeAll(mergeObj: SampleCalc | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: SampleCalc | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<SampleCalc | null> | null, spec?: UpsertSpec | null): ObjList<SampleCalc | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<SampleCalc | null> | null, spec?: UpsertSpec | null): ObjList<SampleCalc | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<SampleCalc | null> | null): ObjList<SampleCalc | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<SampleCalc | null> | null): ObjList<SampleCalc | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<SampleCalc | null> | null): ObjList<SampleCalc | null>;
   ...
   */
  static afterCreate(objs: C3.Array<SampleCalc | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<SampleCalc | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<SampleCalc | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<SampleCalc | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<SampleCalc | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): SampleCalc | null;
   ...
   */
  withoutIdentity(): SampleCalc | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<SampleCalc | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: SampleCalc | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<SampleCalc | null> | null, callback?: λFunction<SampleCalc | null, SampleCalc | null> | null): ObjList<SampleCalc | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<SampleCalc | null> | null, callback?: λFunction<SampleCalc | null, SampleCalc | null> | null): C3.Array<ObjError | null>;
