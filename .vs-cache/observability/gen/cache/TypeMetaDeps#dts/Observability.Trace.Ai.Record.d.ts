// TypeScript definitions for the C3 type Observability.Trace.Ai.Record
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of Observability.Trace.Ai.Record
 */
declare namespace Observability.Trace.Ai {
...
declare namespace Observability.Trace.Ai {
  export class Record extends Obj  {
    ...
    withName(name: string | null): Observability.Trace.Ai.Record;
    ...
    withStartTime(startTime: DateTime | Date | string | null): Observability.Trace.Ai.Record;
    ...
    withEndTime(endTime: DateTime | Date | string | null): Observability.Trace.Ai.Record;
    ...
    withDurationInMillis(durationInMillis: number | null): Observability.Trace.Ai.Record;

    /**
     * Number of {@link Observability.Span}s in this {@link Observability.Trace}.
     */
    readonly spanCount?: number;
    withSpanCount(spanCount: number | null): Observability.Trace.Ai.Record;

    /**
     * Number of {@link Observability.Span}s in this {@link Observability.Trace} that have errors.
     */
    readonly errorCount?: number;
    withErrorCount(errorCount: number | null): Observability.Trace.Ai.Record;

    /**
     * The status code of this {@link Observability.Trace}.
     */
    readonly status?: string;
    withStatus(status: string | null): Observability.Trace.Ai.Record;

    /**
     * True if there were errors during aggregation
     */
    readonly hasAggregationErrors?: boolean;
    withHasAggregationErrors(hasAggregationErrors: boolean): Observability.Trace.Ai.Record;

    /**
     * Input for trace - uses "APPEND" aggregatioon
     */
    readonly prompt?: Array_Type<string>;
    withPrompt(prompt: Array_Type<string> | Array<string> | null): Observability.Trace.Ai.Record;

    /**
     * Output for trace - uses "APPEND" aggregation
     */
    readonly response?: Array_Type<string>;
    withResponse(response: Array_Type<string> | Array<string> | null): Observability.Trace.Ai.Record;

    /**
     * Number of total tokens, uses "SUM" aggregation
     */
    readonly tokenSum?: number;
    withTokenSum(tokenSum: number | null): Observability.Trace.Ai.Record;

    /**
     * Number of total tokens, uses "MAX" aggregation
     */
    readonly maxTokens?: number;
    withMaxTokens(maxTokens: number | null): Observability.Trace.Ai.Record;

    /**
     * Tracks best case latency, uses "MIN" aggregation
     */
    readonly minLatency?: number;
    withMinLatency(minLatency: number | null): Observability.Trace.Ai.Record;

    /**
     * True, if any of the span responses are toxic, uses "ANY" aggregation
     */
    readonly isToxic?: boolean;
    withIsToxic(isToxic: boolean): Observability.Trace.Ai.Record;

    /**
     * True, if all of the span responses are valid, uses "AND" aggregation
     */
    readonly isValid?: boolean;
    withIsValid(isValid: boolean): Observability.Trace.Ai.Record;

    /**
     * Counts the number of tool calls in trace, uses "COUNT" aggregation
     */
    readonly grandChildCount?: number;
    withGrandChildCount(grandChildCount: number | null): Observability.Trace.Ai.Record;

    /**
     * Minimum confidence score of plan step
     */
    readonly confidenceScore?: number;
    withConfidenceScore(confidenceScore: number | null): Observability.Trace.Ai.Record;

    /**
     * Maximum duration of plan step
     */
    readonly maxDuration?: number;
    withMaxDuration(maxDuration: number | null): Observability.Trace.Ai.Record;

    /**
     * Total tokens for prompt-response pair
     */
    readonly totalTokens?: number;
    withTotalTokens(totalTokens: number | null): Observability.Trace.Ai.Record;

    /**
     * Number of tool calls
     */
    readonly numTools?: number;
    withNumTools(numTools: number | null): Observability.Trace.Ai.Record;

    /**
     * Completion text of response
     */
    readonly completion?: Array_Type<string>;
    withCompletion(completion: Array_Type<string> | Array<string> | null): Observability.Trace.Ai.Record;

    /**
     * Prompt of response
     */
    readonly input?: Array_Type<string>;
    withInput(input: Array_Type<string> | Array<string> | null): Observability.Trace.Ai.Record;
     ...
     */
    readonly id: string;
    withId(id: string): Observability.Trace.Ai.Record;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Observability.Trace.Ai.Record;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Observability.Trace.Ai.Record;
    ...
    withVersion(version: number | null): Observability.Trace.Ai.Record;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Observability.Trace.Ai.Record;

    /**
     * {@link Observability.Span.Record}s in this {@link Observability.Trace.Ai.Record}
     */
    readonly spans?: Array_Type<Observability.Span.Record>;
    withSpans(spans: Array_Type<Observability.Span.Record> | Array<IObservability.Span.Record> | null): Observability.Trace.Ai.Record;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Observability.Trace.Ai.Record | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Observability.Trace.Ai.Record | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Observability.Trace.Ai.Record | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Observability.Trace.Ai.Record | null;
     ...
     */
    replaceType(old: Type, new_: Type): Observability.Trace.Ai.Record;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Observability.Trace.Ai.Record;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Observability.Trace.Ai.Record;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Observability.Trace.Ai.Record>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Observability.Trace.Ai.Record>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Observability.Trace.Ai.Record;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Observability.Trace.Ai.Record;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Observability.Trace.Ai.Record;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Observability.Trace.Ai.Record;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Observability.Trace.Ai.Record;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Observability.Trace.Ai.Record;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Observability.Trace.Ai.Record;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Observability.Trace.Ai.Record;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Observability.Trace.Ai.Record;
     ...
     * @see #removeField
     */
    withoutField(field: string): Observability.Trace.Ai.Record;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Observability.Trace.Ai.Record;
     ...
     */
    withoutFields(fields: Array_Type<string>): Observability.Trace.Ai.Record;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Observability.Trace.Ai.Record;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Observability.Trace.Ai.Record;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Observability.Trace.Ai.Record;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Observability.Trace.Ai.Record;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Observability.Trace.Ai.Record;
     ...
     * @see #removeField
     */
    unsetField(field: string): Observability.Trace.Ai.Record;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Observability.Trace.Ai.Record;
     ...
     * @see #unsetField
     */
    removeField(field: string): Observability.Trace.Ai.Record;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Observability.Trace.Ai.Record;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Observability.Trace.Ai.Record;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Observability.Trace.Ai.Record;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Observability.Trace.Ai.Record;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Observability.Trace.Ai.Record;

    mergeJson(json: any): Observability.Trace.Ai.Record;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Observability.Trace.Ai.Record;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Observability.Trace.Ai.Record;
     ...
     */
    singletonArray(): Array_Type<Observability.Trace.Ai.Record>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Observability.Trace.Ai.Record> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Observability.Trace.Ai.Record> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Observability.Trace.Ai.Record>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Observability.Trace.Ai.Record> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Observability.Trace.Ai.Record> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Observability.Trace.Ai.Record> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Observability.Trace.Ai.Record>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Observability.Trace.Ai.Record>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Observability.Trace.Ai.Record;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Observability.Trace.Ai.Record;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Observability.Trace.Ai.Record;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Observability.Trace.Ai.Record;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Observability.Trace.Ai.Record;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Observability.Trace.Ai.Record;
     ...
     * @see #fromString
     */
    static make(s: string): Observability.Trace.Ai.Record | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Observability.Trace.Ai.Record;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Observability.Trace.Ai.Record;
     ...
     */
    static cachedEmptyInst(): Observability.Trace.Ai.Record;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Observability.Trace.Ai.Record> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Observability.Trace.Ai.Record;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Observability.Trace.Ai.Record>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Observability.Trace.Ai.Record>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Observability.Trace.Ai.Record> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Observability.Trace.Ai.Record>> | null;
     ...
     */
    get(include?: string): Observability.Trace.Ai.Record | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Observability.Trace.Ai.Record | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Observability.Trace.Ai.Record;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Observability.Trace.Ai.Record | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Observability.Trace.Ai.Record;
     ...
     * @see #toString
     */
    static fromString(s: string): Observability.Trace.Ai.Record | null;
     ...
     */
    create(spec?: UpsertSpec): Observability.Trace.Ai.Record | null;
     ...
     */
    static createBatch(objs: Array_Type<Observability.Trace.Ai.Record>, spec?: UpsertSpec): ObjList<Observability.Trace.Ai.Record> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Observability.Trace.Ai.Record>, spec?: CreateBatchObjStreamSpec): ObjList<Observability.Trace.Ai.Record> | null;
     ...
     */
    update(srcObj?: Observability.Trace.Ai.Record, spec?: UpsertSpec): Observability.Trace.Ai.Record | null;
     ...
     */
    upsert(srcObj?: Observability.Trace.Ai.Record, spec?: UpsertSpec): Observability.Trace.Ai.Record | null;
     ...
     */
    merge(spec?: MergeSpec): Observability.Trace.Ai.Record | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Observability.Trace.Ai.Record | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Observability.Trace.Ai.Record | null;
     ...
     */
    static updateBatch(objs: Array_Type<Observability.Trace.Ai.Record>, srcObjs?: Array_Type<Observability.Trace.Ai.Record>, spec?: UpsertSpec): ObjList<Observability.Trace.Ai.Record> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Observability.Trace.Ai.Record> | null>, spec?: UpsertSpec): ObjList<Observability.Trace.Ai.Record> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Observability.Trace.Ai.Record>, srcObjs?: Array_Type<Observability.Trace.Ai.Record>, spec?: UpsertSpec): ObjList<Observability.Trace.Ai.Record> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Observability.Trace.Ai.Record> | null>, spec?: UpsertSpec): ObjList<Observability.Trace.Ai.Record> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Observability.Trace.Ai.Record>, spec?: TouchSpec): ObjList<Observability.Trace.Ai.Record> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Observability.Trace.Ai.Record>, spec?: MergeSpec): ObjList<Observability.Trace.Ai.Record> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Observability.Trace.Ai.Record>, mergeInclude: string, spec?: MergeSpec): ObjList<Observability.Trace.Ai.Record> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Observability.Trace.Ai.Record> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Observability.Trace.Ai.Record> | null;
     ...
     */
    static mergeAll(mergeObj: Observability.Trace.Ai.Record, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Observability.Trace.Ai.Record, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Observability.Trace.Ai.Record>, spec?: UpsertSpec): ObjList<Observability.Trace.Ai.Record> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Observability.Trace.Ai.Record>, spec?: UpsertSpec): ObjList<Observability.Trace.Ai.Record> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Observability.Trace.Ai.Record | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Observability.Trace.Ai.Record>): ObjList<Observability.Trace.Ai.Record>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<Observability.Trace.Ai.Record>): ObjList<Observability.Trace.Ai.Record>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Observability.Trace.Ai.Record>): ObjList<Observability.Trace.Ai.Record>;
     ...
     */
    static afterCreate(objs: Array_Type<Observability.Trace.Ai.Record>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Observability.Trace.Ai.Record>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Observability.Trace.Ai.Record>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Observability.Trace.Ai.Record>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Observability.Trace.Ai.Record>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Observability.Trace.Ai.Record | null;
     ...
     */
    withoutIdentity(): Observability.Trace.Ai.Record | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Observability.Trace.Ai.Record>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Observability.Trace.Ai.Record, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Observability.Trace.Ai.Record>, callback?: λFunction<Observability.Trace.Ai.Record | null, Observability.Trace.Ai.Record | null>): ObjList<Observability.Trace.Ai.Record>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Observability.Trace.Ai.Record>, callback?: λFunction<Observability.Trace.Ai.Record | null, Observability.Trace.Ai.Record | null>): Array_Type<ObjError> | null;
