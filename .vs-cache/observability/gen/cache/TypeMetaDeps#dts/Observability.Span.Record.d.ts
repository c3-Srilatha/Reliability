// TypeScript definitions for the C3 type Observability.Span.Record
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of Observability.Span.Record
 */
declare namespace Observability.Span {
  export interface IRecord {
     ...
     */
    attributes?: Map_Type<string, any | null> | {[key: string]: any | null};
     ...
     */
    trace?: IObservability.Trace.Record;
...
declare namespace Observability.Span {
  export class Record extends Obj  {
    ...
    withParentSpanId(parentSpanId: string | null): Observability.Span.Record;

    /**
     * Action context associated with this {@link Observability.Span}.
     */
    readonly actionContext?: string;
    withActionContext(actionContext: string | null): Observability.Span.Record;

    /**
     * The name of this {@link Observability.Span}.
     */
    readonly name: string;
    withName(name: string): Observability.Span.Record;

    /**
     * The kind of this {@link Observability.Span}.
     */
    readonly kind?: string;
    withKind(kind: string | null): Observability.Span.Record;

    /**
     * The start time of this {@link Observability.Span}.
     */
    readonly startTime: DateTime;
    withStartTime(startTime: DateTime | Date | string): Observability.Span.Record;

    /**
     * The end time of this {@link Observability.Span}.
     */
    readonly endTime: DateTime;
    withEndTime(endTime: DateTime | Date | string): Observability.Span.Record;

    /**
     * The action ID associated with this {@link Observability.Span}.
     */
    readonly actionId?: string;
    withActionId(actionId: string | null): Observability.Span.Record;

    /**
     * The parent action ID associated with this {@link Observability.Span}.
     */
    readonly parentActionId?: string;
    withParentActionId(parentActionId: string | null): Observability.Span.Record;

    /**
     * A map of attributes associated with this {@link Observability.Span}.
     */
    readonly attributes?: Map_Type<string, any | null>;
    withAttributes(attributes: Map_Type<string, any | null> | {[key: string]: any | null} | null): Observability.Span.Record;

    /**
     * The status code of this {@link Observability.Span}.
     */
    readonly status: string;
    withStatus(status: string): Observability.Span.Record;

    /**
     * The error stack trace for this {@link Observability.Span}.
     */
    readonly exceptionStack?: string;
    withExceptionStack(exceptionStack: string | null): Observability.Span.Record;

    /**
     * {@link Type} of trace that this span belongs to.
     */
    readonly traceType?: string;
    withTraceType(traceType: string | null): Observability.Span.Record;
     ...
     */
    readonly id: string;
    withId(id: string): Observability.Span.Record;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Observability.Span.Record;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Observability.Span.Record;
    ...
    withVersion(version: number | null): Observability.Span.Record;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Observability.Span.Record;

    /**
     * The {@link Observability.Trace.Record} to which this {@link Observability.Span.Record} belongs.
     */
    readonly trace?: Observability.Trace.Record;
    withTrace(trace: IObservability.Trace.Record | null): Observability.Span.Record;

    /**
     * `id` of trace record that this span belongs to.
     */
    readonly traceId?: string;
    withTraceId(traceId: string | null): Observability.Span.Record;

    /**
     * {@link Type} of trace record that this span belongs to.
     */
    readonly traceRecordType?: string;
    withTraceRecordType(traceRecordType: string | null): Observability.Span.Record;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Observability.Span.Record | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Observability.Span.Record | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Observability.Span.Record | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Observability.Span.Record | null;
     ...
     */
    replaceType(old: Type, new_: Type): Observability.Span.Record;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Observability.Span.Record;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Observability.Span.Record;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Observability.Span.Record>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Observability.Span.Record>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Observability.Span.Record;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Observability.Span.Record;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Observability.Span.Record;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Observability.Span.Record;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Observability.Span.Record;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Observability.Span.Record;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Observability.Span.Record;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Observability.Span.Record;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Observability.Span.Record;
     ...
     * @see #removeField
     */
    withoutField(field: string): Observability.Span.Record;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Observability.Span.Record;
     ...
     */
    withoutFields(fields: Array_Type<string>): Observability.Span.Record;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Observability.Span.Record;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Observability.Span.Record;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Observability.Span.Record;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Observability.Span.Record;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Observability.Span.Record;
     ...
     * @see #removeField
     */
    unsetField(field: string): Observability.Span.Record;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Observability.Span.Record;
     ...
     * @see #unsetField
     */
    removeField(field: string): Observability.Span.Record;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Observability.Span.Record;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Observability.Span.Record;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Observability.Span.Record;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Observability.Span.Record;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Observability.Span.Record;

    mergeJson(json: any): Observability.Span.Record;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Observability.Span.Record;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Observability.Span.Record;
     ...
     */
    singletonArray(): Array_Type<Observability.Span.Record>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Observability.Span.Record> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Observability.Span.Record> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Observability.Span.Record>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Observability.Span.Record> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Observability.Span.Record> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Observability.Span.Record> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Observability.Span.Record>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Observability.Span.Record>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Observability.Span.Record;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Observability.Span.Record;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Observability.Span.Record;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Observability.Span.Record;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Observability.Span.Record;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Observability.Span.Record;
     ...
     * @see #fromString
     */
    static make(s: string): Observability.Span.Record | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Observability.Span.Record;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Observability.Span.Record;
     ...
     */
    static cachedEmptyInst(): Observability.Span.Record;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Observability.Span.Record> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Observability.Span.Record;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Observability.Span.Record>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Observability.Span.Record>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Observability.Span.Record> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Observability.Span.Record>> | null;
     ...
     */
    get(include?: string): Observability.Span.Record | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Observability.Span.Record | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Observability.Span.Record;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Observability.Span.Record | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Observability.Span.Record;
     ...
     * @see #toString
     */
    static fromString(s: string): Observability.Span.Record | null;
     ...
     */
    create(spec?: UpsertSpec): Observability.Span.Record | null;
     ...
     */
    static createBatch(objs: Array_Type<Observability.Span.Record>, spec?: UpsertSpec): ObjList<Observability.Span.Record> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Observability.Span.Record>, spec?: CreateBatchObjStreamSpec): ObjList<Observability.Span.Record> | null;
     ...
     */
    update(srcObj?: Observability.Span.Record, spec?: UpsertSpec): Observability.Span.Record | null;
     ...
     */
    upsert(srcObj?: Observability.Span.Record, spec?: UpsertSpec): Observability.Span.Record | null;
     ...
     */
    merge(spec?: MergeSpec): Observability.Span.Record | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Observability.Span.Record | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Observability.Span.Record | null;
     ...
     */
    static updateBatch(objs: Array_Type<Observability.Span.Record>, srcObjs?: Array_Type<Observability.Span.Record>, spec?: UpsertSpec): ObjList<Observability.Span.Record> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Observability.Span.Record> | null>, spec?: UpsertSpec): ObjList<Observability.Span.Record> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Observability.Span.Record>, srcObjs?: Array_Type<Observability.Span.Record>, spec?: UpsertSpec): ObjList<Observability.Span.Record> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Observability.Span.Record> | null>, spec?: UpsertSpec): ObjList<Observability.Span.Record> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Observability.Span.Record>, spec?: TouchSpec): ObjList<Observability.Span.Record> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Observability.Span.Record>, spec?: MergeSpec): ObjList<Observability.Span.Record> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Observability.Span.Record>, mergeInclude: string, spec?: MergeSpec): ObjList<Observability.Span.Record> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Observability.Span.Record> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Observability.Span.Record> | null;
     ...
     */
    static mergeAll(mergeObj: Observability.Span.Record, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Observability.Span.Record, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Observability.Span.Record>, spec?: UpsertSpec): ObjList<Observability.Span.Record> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Observability.Span.Record>, spec?: UpsertSpec): ObjList<Observability.Span.Record> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Observability.Span.Record | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Observability.Span.Record>): ObjList<Observability.Span.Record>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<Observability.Span.Record>): ObjList<Observability.Span.Record>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Observability.Span.Record>): ObjList<Observability.Span.Record>;
     ...
     */
    static afterCreate(objs: Array_Type<Observability.Span.Record>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Observability.Span.Record>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Observability.Span.Record>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Observability.Span.Record>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Observability.Span.Record>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Observability.Span.Record | null;
     ...
     */
    withoutIdentity(): Observability.Span.Record | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Observability.Span.Record>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Observability.Span.Record, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Observability.Span.Record>, callback?: λFunction<Observability.Span.Record | null, Observability.Span.Record | null>): ObjList<Observability.Span.Record>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Observability.Span.Record>, callback?: λFunction<Observability.Span.Record | null, Observability.Span.Record | null>): Array_Type<ObjError> | null;
     ...
     */
    static aggregateSpans(spans: Array_Type<Observability.Span.Record>): void;
  }
}
