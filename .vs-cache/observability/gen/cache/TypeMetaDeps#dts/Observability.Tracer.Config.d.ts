// TypeScript definitions for the C3 type Observability.Tracer.Config

/**
 * Configuration options for {@link Observability.Tracer}
 *
 * @remarks this represents a value passed to a method that expects an instance of Observability.Tracer.Config
 */
declare namespace Observability.Tracer {
  export interface IConfig {
     ...
     */
    disableExceptionRecording?: boolean;
     ...
     */
    disableAggregationErrors?: boolean;
...
declare namespace Observability.Tracer {
  export class Config extends Obj  {
    ...
    withConfigOverride(configOverride: string | null): Observability.Tracer.Config;

    static readonly configOverride?: string;

    readonly secretOverride?: string;
    withSecretOverride(secretOverride: string | null): Observability.Tracer.Config;
    ...
    withIssues(issues: Array_Type<string> | Array<string> | null): Observability.Tracer.Config;
    ...
    withEnableTracing(enableTracing: boolean): Observability.Tracer.Config;

    /**
     * By default, all tracing is disabled.
     * If True, tracing is enabled
     */
    static readonly enableTracing?: boolean;

    /**
     * By default, spans record exceptions.
     * If True, spans will not record exceptions.
     */
    readonly disableExceptionRecording?: boolean;
    withDisableExceptionRecording(disableExceptionRecording: boolean): Observability.Tracer.Config;

    /**
     * By default, spans record exceptions.
     * If True, spans will not record exceptions.
     */
    static readonly disableExceptionRecording?: boolean;

    /**
     * By default, if there are any errors during aggregation of span attribute values to trace, the system will raise the error.
     * If True, aggregation errors are not raised.
     */
    readonly disableAggregationErrors?: boolean;
    withDisableAggregationErrors(disableAggregationErrors: boolean): Observability.Tracer.Config;

    /**
     * By default, if there are any errors during aggregation of span attribute values to trace, the system will raise the error.
     * If True, aggregation errors are not raised.
     */
    static readonly disableAggregationErrors?: boolean;
    ...
    withEnableBatching(enableBatching: boolean): Observability.Tracer.Config;
     ...
     * If True, spans are collected in an in-memory queue and upserted into {@link Observability.Span.Record}s periodically.
     */
    static readonly enableBatching?: boolean;
    ...
    withMaxQueueSize(maxQueueSize: number | null): Observability.Tracer.Config;

    /**
     * If {@link #enableBatching} is True, sets the maximum in-memory queue size for collecting spans.
     * The queue will be flushed before {@link #scheduleMillis} if the queue size exceeds maxQueueSize
     */
    static readonly maxQueueSize?: number;

    /**
     * If {@link #enableBatching} is True, sets the periodicity of batch upserts.
     * i.e If {@link #scheduleMillis} is 100, then every 100 ms the in-memory queue is drained.
     */
    readonly scheduleMillis?: number;
    withScheduleMillis(scheduleMillis: number | null): Observability.Tracer.Config;

    /**
     * If {@link #enableBatching} is True, sets the periodicity of batch upserts.
     * i.e If {@link #scheduleMillis} is 100, then every 100 ms the in-memory queue is drained.
     */
    static readonly scheduleMillis?: number;
    ...
    withMaxBatchSize(maxBatchSize: number | null): Observability.Tracer.Config;
     ...
     * i.e There will be 3 batch upserts for upserting 600 spans.
     */
    static readonly maxBatchSize?: number;
    ...
    withTimeoutMillis(timeoutMillis: number | null): Observability.Tracer.Config;

    /**
     * If {@link #enableBatching} is True, sets the timeout for each batch of in-memory span export to DB.
     * Each batch needs to be exported to DB within this timeout.
     */
    static readonly timeoutMillis?: number;

    /**
     * Time to live for the trace and its spans.
     * Traces and spans older than this duration are deleted from persisted store if {@link #enableCleanUp} is set to True.
     */
    readonly traceRecordTtl?: string;
    withTraceRecordTtl(traceRecordTtl: string | null): Observability.Tracer.Config;

    /**
     * Time to live for the trace and its spans.
     * Traces and spans older than this duration are deleted from persisted store if {@link #enableCleanUp} is set to True.
     */
    static readonly traceRecordTtl?: string;

    /**
     * Whether to enable cleaning of old traces.
     */
    readonly enableCleanUp?: boolean;
    withEnableCleanUp(enableCleanUp: boolean): Observability.Tracer.Config;

    /**
     * Whether to enable cleaning of old traces.
     */
    static readonly enableCleanUp?: boolean;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Observability.Tracer.Config | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Observability.Tracer.Config | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Observability.Tracer.Config | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Observability.Tracer.Config | null;
     ...
     */
    replaceType(old: Type, new_: Type): Observability.Tracer.Config;
     ...
     * This method is used during live metadata update
     */
    static replaceType(old: Type, new_: Type): Observability.Tracer.Config;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Observability.Tracer.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Observability.Tracer.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Observability.Tracer.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Observability.Tracer.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Observability.Tracer.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Observability.Tracer.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Observability.Tracer.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Observability.Tracer.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Observability.Tracer.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Observability.Tracer.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Observability.Tracer.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Observability.Tracer.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Observability.Tracer.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Observability.Tracer.Config;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Observability.Tracer.Config;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    static validateObj(): Observability.Tracer.Config;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Observability.Tracer.Config;
     ...
     * @see #defaultField
     */
    static withField(field: string, value: any, doNotConvert?: boolean): Observability.Tracer.Config;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Observability.Tracer.Config;
     ...
     * @see #defaultField
     */
    static withField(field: FieldType, value: any, doNotConvert?: boolean): Observability.Tracer.Config;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Observability.Tracer.Config;
     ...
     * @return new Obj
     */
    static withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Observability.Tracer.Config;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Observability.Tracer.Config;
     ...
     * @return new Obj
     */
    static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Observability.Tracer.Config;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Observability.Tracer.Config;
     ...
     * @see #withoutField
     */
    static withoutFieldAtPath(path: string): Observability.Tracer.Config;
     ...
     * @see #removeField
     */
    withoutField(field: string): Observability.Tracer.Config;
     ...
     * @see #removeField
     */
    static withoutField(field: string): Observability.Tracer.Config;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Observability.Tracer.Config;
     ...
     * @see #removeField
     */
    static withoutField(field: FieldType): Observability.Tracer.Config;
     ...
     */
    withoutFields(fields: Array_Type<string>): Observability.Tracer.Config;
     ...
     * @return new Obj with removed fields
     */
    static withoutFields(fields: Array_Type<string>): Observability.Tracer.Config;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Observability.Tracer.Config;
     ...
     * @return new Obj with removed fields
     */
    static withoutFieldsByType(fields: Array_Type<FieldType>): Observability.Tracer.Config;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Observability.Tracer.Config;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    static withoutSecretFields(): Observability.Tracer.Config;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Observability.Tracer.Config;
     ...
     * @see FieldType#defaultValue
     */
    static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Observability.Tracer.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Observability.Tracer.Config;
     ...
     * @see #unsetField
     */
    static defaultField(field: string): Observability.Tracer.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Observability.Tracer.Config;
     ...
     * @see #unsetField
     */
    static defaultField(field: FieldType): Observability.Tracer.Config;
     ...
     * @see #removeField
     */
    unsetField(field: string): Observability.Tracer.Config;
     ...
     * @see #removeField
     */
    static unsetField(field: string): Observability.Tracer.Config;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Observability.Tracer.Config;
     ...
     * @see #removeField
     */
    static unsetField(field: FieldType): Observability.Tracer.Config;
     ...
     * @see #unsetField
     */
    removeField(field: string): Observability.Tracer.Config;
     ...
     * @see #unsetField
     */
    static removeField(field: string): Observability.Tracer.Config;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Observability.Tracer.Config;
     ...
     * @see #unsetField
     */
    static removeField(field: FieldType): Observability.Tracer.Config;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Observability.Tracer.Config;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Observability.Tracer.Config;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Observability.Tracer.Config;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj, otherFieldsFilter: Type): Observability.Tracer.Config;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Observability.Tracer.Config;
     ...
     *        the same key or index.
     */
    static mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Observability.Tracer.Config;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Observability.Tracer.Config;
     ...
     * traverse child reference and collection fields.
     */
    static mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Observability.Tracer.Config;

    mergeJson(json: any): Observability.Tracer.Config;

    static mergeJson(json: any): Observability.Tracer.Config;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Observability.Tracer.Config;
     ...
     * @return Obj with child references merged
     */
    static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Observability.Tracer.Config;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Observability.Tracer.Config;
     ...
     * references with same name and collection elements at same index or key.
     */
    static sumObj(other: Obj, deep?: boolean): Observability.Tracer.Config;
     ...
     */
    singletonArray(): Array_Type<Observability.Tracer.Config>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonArray(): Array_Type<Observability.Tracer.Config>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Observability.Tracer.Config> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Observability.Tracer.Config> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Observability.Tracer.Config>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonSet(): Set_Type<Observability.Tracer.Config>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Observability.Tracer.Config> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Observability.Tracer.Config> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Observability.Tracer.Config> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Observability.Tracer.Config>;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    static toBuilder(): ObjBuilder<Observability.Tracer.Config>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Observability.Tracer.Config>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Observability.Tracer.Config;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Observability.Tracer.Config;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Observability.Tracer.Config;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Observability.Tracer.Config;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Observability.Tracer.Config;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Observability.Tracer.Config;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Observability.Tracer.Config;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Observability.Tracer.Config;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    static afterMake(): Observability.Tracer.Config;
     ...
     */
    static cachedEmptyInst(): Observability.Tracer.Config;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Observability.Tracer.Config> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Observability.Tracer.Config;
     ...
     */
    static allCached(): Stream<Observability.Tracer.Config> | null;
     ...
     */
    static find(filter?: string): Stream<Observability.Tracer.Config> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<Observability.Tracer.Config> | null;

    /**
     * @return cached instance.
     */
    getCached(): Observability.Tracer.Config | null;

    /**
     * @return cached instance.
     */
    static getCached(): Observability.Tracer.Config | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string): Observability.Tracer.Config | null;
     ...
     */
    static produce(key: string): Observability.Tracer.Config | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, Observability.Tracer.Config> | null;
     ...
     */
    getConfig(): Observability.Tracer.Config;
     ...
     * Note that typical pattern is to use Configurable#config instead of this method.
     */
    static getConfig(): Observability.Tracer.Config;
     ...
     */
    getSecret(): Observability.Tracer.Config;
     ...
     * Note that typical pattern is to use Configurable#configWithSecrets instead of this method.
     */
    static getSecret(): Observability.Tracer.Config;
     ...
     */
    withConfigKey(configKey: string): Observability.Tracer.Config;
     ...
     *     config.configKey() => "folder1/abc"
     */
    static withConfigKey(configKey: string): Observability.Tracer.Config;

    /**
     * @return copy without config key.
     */
    withoutConfigKey(): Observability.Tracer.Config;

    /**
     * @return copy without config key.
     */
    static withoutConfigKey(): Observability.Tracer.Config;

    /**
     * @return return cached config instance for provided config key.
     */
    static forConfigKey(configKey: string): Observability.Tracer.Config | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string>): Stream<Observability.Tracer.Config> | null;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: Observability.Tracer.Config, override?: string): void;
     ...
     * @see setConfigValue
     */
    static setConfigValues(from: Observability.Tracer.Config, override?: string): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): Observability.Tracer.Config | null;
     ...
     */
    removeSecrets(): Observability.Tracer.Config | null;

    /**
     * @return this config without any secret values.
     */
    static removeSecrets(): Observability.Tracer.Config | null;

    /**
     * @return this config with only secret values.
     */
    removeNonSecrets(): Observability.Tracer.Config | null;

    /**
     * @return this config with only secret values.
     */
    static removeNonSecrets(): Observability.Tracer.Config | null;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    validate(): Observability.Tracer.Config;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    static validate(): Observability.Tracer.Config;
     ...
     */
    static inst(): Observability.Tracer.Config;
  }
}
