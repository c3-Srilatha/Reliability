// TypeScript definitions for the C3 type UiSdlGraphVisualizationGraphWarningModalReact

/**
 * The react component type of {@link UiSdlGraphVisualizationGraphWarningModal}.
 *
 * @remarks this represents a value passed to a method that expects an instance of UiSdlGraphVisualizationGraphWarningModalReact
 */
declare interface IUiSdlGraphVisualizationGraphWarningModalReact {
   ...
   */
  uiSdlGraphVisualizationComponentId?: string | null;
}
 ...
 */
declare class UiSdlGraphVisualizationGraphWarningModalReact extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlGraphVisualizationGraphWarningModalReact | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlGraphVisualizationGraphWarningModalReact | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlGraphVisualizationGraphWarningModalReact | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlGraphVisualizationGraphWarningModalReact | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlGraphVisualizationGraphWarningModalReact;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlGraphVisualizationGraphWarningModalReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlGraphVisualizationGraphWarningModalReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlGraphVisualizationGraphWarningModalReact | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlGraphVisualizationGraphWarningModalReact | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlGraphVisualizationGraphWarningModalReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlGraphVisualizationGraphWarningModalReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlGraphVisualizationGraphWarningModalReact;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlGraphVisualizationGraphWarningModalReact;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlGraphVisualizationGraphWarningModalReact;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlGraphVisualizationGraphWarningModalReact;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlGraphVisualizationGraphWarningModalReact;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlGraphVisualizationGraphWarningModalReact;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlGraphVisualizationGraphWarningModalReact;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlGraphVisualizationGraphWarningModalReact;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlGraphVisualizationGraphWarningModalReact;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlGraphVisualizationGraphWarningModalReact;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlGraphVisualizationGraphWarningModalReact;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlGraphVisualizationGraphWarningModalReact;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlGraphVisualizationGraphWarningModalReact;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlGraphVisualizationGraphWarningModalReact;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlGraphVisualizationGraphWarningModalReact;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlGraphVisualizationGraphWarningModalReact;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlGraphVisualizationGraphWarningModalReact;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlGraphVisualizationGraphWarningModalReact;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlGraphVisualizationGraphWarningModalReact;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlGraphVisualizationGraphWarningModalReact;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlGraphVisualizationGraphWarningModalReact;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlGraphVisualizationGraphWarningModalReact;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlGraphVisualizationGraphWarningModalReact;

  mergeJson(json: any | null): UiSdlGraphVisualizationGraphWarningModalReact;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlGraphVisualizationGraphWarningModalReact;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlGraphVisualizationGraphWarningModalReact;
   ...
   */
  singletonArray(): C3.Array<UiSdlGraphVisualizationGraphWarningModalReact | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlGraphVisualizationGraphWarningModalReact | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlGraphVisualizationGraphWarningModalReact | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlGraphVisualizationGraphWarningModalReact | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlGraphVisualizationGraphWarningModalReact | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlGraphVisualizationGraphWarningModalReact | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlGraphVisualizationGraphWarningModalReact | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlGraphVisualizationGraphWarningModalReact | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlGraphVisualizationGraphWarningModalReact | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlGraphVisualizationGraphWarningModalReact;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlGraphVisualizationGraphWarningModalReact;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlGraphVisualizationGraphWarningModalReact;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlGraphVisualizationGraphWarningModalReact;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlGraphVisualizationGraphWarningModalReact;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlGraphVisualizationGraphWarningModalReact;
   ...
   * @see #fromString
   */
  static make(s: string | null): UiSdlGraphVisualizationGraphWarningModalReact | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlGraphVisualizationGraphWarningModalReact;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): UiSdlGraphVisualizationGraphWarningModalReact;
   ...
   */
  static cachedEmptyInst(): UiSdlGraphVisualizationGraphWarningModalReact;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlGraphVisualizationGraphWarningModalReact>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlGraphVisualizationGraphWarningModalReact;
   ...
   */
  static render(props?: UiSdlGraphVisualizationGraphWarningModalReact | null): void;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<UiSdlGraphVisualizationGraphWarningModalReact | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<UiSdlGraphVisualizationGraphWarningModalReact | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<UiSdlGraphVisualizationGraphWarningModalReact | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<UiSdlGraphVisualizationGraphWarningModalReact | null> | null>;
   ...
   */
  dependencies(): MetadataDeps<UiSdlGraphVisualizationGraphWarningModalReact | null>;

  save(subPath?: string | null, contentType?: string | null): UiSdlGraphVisualizationGraphWarningModalReact;
  ...
  update(srcObj?: UiSdlGraphVisualizationGraphWarningModalReact | null, spec?: UpsertSpec | null): UiSdlGraphVisualizationGraphWarningModalReact | null;

  upsert(srcObj?: UiSdlGraphVisualizationGraphWarningModalReact | null, spec?: UpsertSpec | null): UiSdlGraphVisualizationGraphWarningModalReact | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): UiSdlGraphVisualizationGraphWarningModalReact | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string | null, failIfMissing?: boolean): UiSdlGraphVisualizationGraphWarningModalReact | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: UiSdlGraphVisualizationGraphWarningModalReact, state: UiSdlReduxState): UiSdlGraphVisualizationGraphWarningModalReact | null;
   ...
   */
  static setUiSdlGraphVisualizationComponentIdAction(id?: string | null, uiSdlGraphVisualizationComponentId?: string | null): UiSdlGraphVisualizationComponentIdSetAction | null;
   ...
   */
  static uiSdlGraphVisualizationComponentIdSetReducer(state: UiSdlReduxState, action?: UiSdlGraphVisualizationComponentIdSetAction | null): UiSdlReduxState;
}
