...
class MasterSensor():
    ...
    """
    def __init__(self, id: Optional[str]=None, versionEdits: Optional[Array[VersionEdit]]=None, name: Optional[str]=None, meta: Optional[Meta]=None, version: Optional[int]=None, typeWithBindings: Optional[Type]=None, sensorId: Optional[str]=None, facility: Optional[Facility]=None, sensorDescription: Optional[str]=None, exampleValue: Optional[str]=None, unit: Optional[Unit]=None, convertedSensor: Optional[Sensor]=None, diagramParsedSensor: Optional[ParsedSensor]=None, relatedParsedSensors: Optional[Array[ParsedSensor]]=None, displayName: Optional[str]=None) -> None: ...
