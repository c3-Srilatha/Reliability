...
# Python definitions for the C3 type DiagramParsingExpressionEngineFunction


class DiagramParsingExpressionEngineFunction(ExpressionEngineFunction, MetricFunctionLibrary):
    """
    ...
    **Note on ML applications**
    ...
    """
        ...
    @classmethod
    def getMatchConfidenceLevel(cls, matchConfidenceScore: float=None) -> Union[str]:
    """
    ...
    """
        ...
    @classmethod
    def removePdfExtension(cls, sourceDiagram: str=None) -> Union[str]:
    """
