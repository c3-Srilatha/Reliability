...
# Python definitions for the C3 type DiagramParsingClassLabel


class DiagramParsingClassLabel():
    """
    ...
    is interested in.
    """
    def __init__(self, TAG: Optional[str]=None, LMI: Optional[str]=None, CPT: Optional[str]=None, PLC: Optional[str]=None, VSL: Optional[str]=None, INFO: Optional[str]=None, EQPINFO: Optional[str]=None, NEG: Optional[str]=None) -> None: ...
