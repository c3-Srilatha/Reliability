...
class ParsedSensor():
    ...
    """
    def __init__(self, id: Optional[str]=None, versionEdits: Optional[Array[VersionEdit]]=None, name: Optional[str]=None, meta: Optional[Meta]=None, version: Optional[int]=None, typeWithBindings: Optional[Type]=None, diagramExtract: Optional[ParsedDiagramExtract]=None, diagram: Optional[ParsableDiagram]=None, boundingBox: Optional[DiagramParsingBoundingBox]=None, parsedText: Optional[str]=None, actualSensor: Optional[MasterSensor]=None, originalMatchedActualSensor: Optional[MasterSensor]=None, isVerified: Optional[bool]=None, collidingSensors: Optional[Array[ParsedSensor]]=None, isDuplicate: Optional[bool]=None, matchConfidenceScore: Optional[float]=None, matchConfidenceLevel: Optional[str]=None) -> None: ...
