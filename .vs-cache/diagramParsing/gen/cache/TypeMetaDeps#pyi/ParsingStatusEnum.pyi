...
# Python definitions for the C3 type ParsingStatusEnum


class ParsingStatusEnum():
    """
    ...
    """
    def __init__(self, WAITING_IN_QUEUE: Optional[str]=None, EXTRACTING_SYMBOLS_AND_TEXT: Optional[str]=None, MATCH_PARSED_TEXT: Optional[str]=None, COMPLETED: Optional[str]=None, FAILED: Optional[str]=None) -> None: ...
