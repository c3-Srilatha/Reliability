...
# Python definitions for the C3 type CraftNetPipe


class CraftNetPipe(ImageToTextPipe):
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[CraftNetPipe]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[CraftNetPipe]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[CraftNetPipe]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[CraftNetPipe]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> CraftNetPipe:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> CraftNetPipe:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> CraftNetPipe:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[CraftNetPipe]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[CraftNetPipe]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> CraftNetPipe:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> CraftNetPipe:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> CraftNetPipe:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> CraftNetPipe:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> CraftNetPipe:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> CraftNetPipe:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> CraftNetPipe:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> CraftNetPipe:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> CraftNetPipe:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> CraftNetPipe:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> CraftNetPipe:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> CraftNetPipe:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> CraftNetPipe:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> CraftNetPipe:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> CraftNetPipe:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> CraftNetPipe:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> CraftNetPipe:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> CraftNetPipe:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> CraftNetPipe:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> CraftNetPipe:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> CraftNetPipe:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> CraftNetPipe:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> CraftNetPipe:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> CraftNetPipe:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> CraftNetPipe:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> CraftNetPipe:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> CraftNetPipe:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> CraftNetPipe:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[CraftNetPipe]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[CraftNetPipe]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[CraftNetPipe]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[CraftNetPipe]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[CraftNetPipe]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, CraftNetPipe]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, CraftNetPipe]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[CraftNetPipe]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[CraftNetPipe]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> CraftNetPipe:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> CraftNetPipe:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> CraftNetPipe:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> CraftNetPipe:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> CraftNetPipe:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> CraftNetPipe:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[CraftNetPipe]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> CraftNetPipe:
    """
    ...
    """
        ...
    def afterMake(self) -> CraftNetPipe:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> CraftNetPipe:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[CraftNetPipe]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> CraftNetPipe:
    """
    ...
    """
        ...
    def remakeTemplate(self) -> CraftNetPipe:
    """
    ...
    """
        ...
    def withoutIdentity(self) -> CraftNetPipe:
    """
    ...
    """
        ...
    def trainSync(self, x: Data, y: =None, spec: MlOperationSpec=None) -> CraftNetPipe:
    """
    ...
    """
        ...
    @classmethod
    def allCached(cls, doNotProduceAll: bool=None) -> Union[Stream[CraftNetPipe]]:
    """
    ...
    """
        ...
    @classmethod
    def find(cls, filter: str=None, doNotProduceAll: bool=None) -> Union[Stream[CraftNetPipe]]:
    """
    ...
    """
        ...
    @classmethod
    def findBy(cls, field: str, value: Any, doNotProduceAll: bool=None) -> Union[Stream[CraftNetPipe]]:
    """
    @param doNotProduceAll if true, will not populate cache and only return available cached instances. Will call
           `produceAll` if cache is empty or if Ann.cache.all is true & data has not previously been fetched.
    @return existing instances of this type that satisfy filter from data cache.
    """
        ...
    @classmethod
    def findByCacheKey(cls, key: str) -> Union[CraftNetPipe]:
    """
    ...
    """
        ...
    @classmethod
    def forCacheKey(cls, key: str) -> Union[CraftNetPipe]:
    """
    ...
    """
        ...
    def getCached(self) -> Union[CraftNetPipe]:
    """
    ...
    """
        ...
    def refreshCache(self) -> Union[CraftNetPipe]:
    """
    ...
    """
        ...
    @classmethod
    def produce(cls, key: str) -> Union[CraftNetPipe]:
    """
    Should produce an entry for the cache key. This method should not be called directly.
    """
        ...
    @classmethod
    def produceAll(cls) -> Union[Map[str, CraftNetPipe]]:
    """
    ...
    """
        ...
    @classmethod
    def doProduceAll(cls) -> Union[Map[str, CraftNetPipe]]:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, spec: FetchSpec=None) -> FetchResult[CraftNetPipe]:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, filter: Filter) -> FetchResult[CraftNetPipe]:
    """
    ...
    """
        ...
    @classmethod
    def fetchObjStream(cls, spec: FetchStreamSpec=None) -> Union[Stream[CraftNetPipe]]:
    """
    Fetches multiple obj instances based on a specification.  Only objs that the caller is authorized to fetch will be
    returned.
    ...
    """
        ...
    @classmethod
    def fetchMultiLocale(cls, spec: MultiLocaleFetchSpec=None) -> Union[Map[str, FetchResult[CraftNetPipe]]]:
    """
    ...
    """
        ...
    def get(self, include: str=None) -> Union[CraftNetPipe]:
    """
    ...
    """
        ...
    def getSpecific(self, include: str=None) -> Union[CraftNetPipe]:
    """
    ...
    """
        ...
    def getMissing(self, spec: GetMissingSpec) -> CraftNetPipe:
    """
    ...
    """
        ...
    def getDirect(self, include: str=None) -> Union[CraftNetPipe]:
    """
    ...
    """
        ...
    def applyReverseEdit(self, versionEdit: VersionEdit) -> CraftNetPipe:
    """
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[CraftNetPipe]:
    """
    ...
    """
        ...
    def create(self, spec: UpsertSpec=None) -> Union[CraftNetPipe]:
    """
    ...
    """
        ...
    @classmethod
    def createBatch(cls, objs: Array[CraftNetPipe], spec: UpsertSpec=None) -> Union[ObjList[CraftNetPipe]]:
    """
    ...
    """
        ...
    @classmethod
    def createBatchObjStream(cls, objs: Stream[CraftNetPipe], spec: CreateBatchObjStreamSpec=None) -> Union[ObjList[CraftNetPipe]]:
    """
    Creates multiple instances of a C3 type. If the operation fails and {@link UpsertSpec#dontThrowOnBatchError} is not
    specified (the default), then a C3BatchException will be thrown.  Otherwise {@link errors will be reported in the
    returned {@link ObjList}.  This will fail if any of the instances already exist.
    ...
    """
        ...
    def update(self, srcObj: CraftNetPipe=None, spec: UpsertSpec=None) -> Union[CraftNetPipe]:
    """
    ...
    """
        ...
    def upsert(self, srcObj: CraftNetPipe=None, spec: UpsertSpec=None) -> Union[CraftNetPipe]:
    """
    ...
    """
        ...
    @overload
    def merge(self, spec: MergeSpec=None) -> Union[CraftNetPipe]:
    """
    ...
    """
        ...
    @overload
    def merge(self, mergeInclude: str, spec: MergeSpec=None) -> Union[CraftNetPipe]:
    """
    ...
    """
        ...
    def touch(self, spec: TouchSpec=None) -> Union[CraftNetPipe]:
    """
    ...
    """
        ...
    @classmethod
    def updateBatch(cls, objs: Array[CraftNetPipe], srcObjs: Array[CraftNetPipe]=None, spec: UpsertSpec=None) -> Union[ObjList[CraftNetPipe]]:
    """
    ...
    """
        ...
    @classmethod
    def updateObjs(cls, objs: Callable[[], Union[Array[CraftNetPipe]]], spec: UpsertSpec=None) -> Union[ObjList[CraftNetPipe]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertBatch(cls, objs: Array[CraftNetPipe], srcObjs: Array[CraftNetPipe]=None, spec: UpsertSpec=None) -> Union[ObjList[CraftNetPipe]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertObjs(cls, objs: Callable[[], Union[Array[CraftNetPipe]]], spec: UpsertSpec=None) -> Union[ObjList[CraftNetPipe]]:
    """
    Creates instances of a C3 type if they don't already exist and updates them if they do exist. If the operation
    ...
    """
        ...
    @classmethod
    def touchBatch(cls, objs: Array[CraftNetPipe], spec: TouchSpec=None) -> Union[ObjList[CraftNetPipe]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[CraftNetPipe], spec: MergeSpec=None) -> Union[ObjList[CraftNetPipe]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[CraftNetPipe], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[CraftNetPipe]]:
    """
    Merges multiple instances of a C3 type or creates them if they don't exist. If the operation fails and {@link
    UpsertSpec#dontThrowOnBatchError} is not specified (the default), then a C3BatchException will be thrown.
    Otherwise errors will be reported in the returned {@link ObjList}.  The merge operation is described in the {@link
    ...
    """
        ...
    @classmethod
    def mergeObjs(cls, objs: Callable[[], Union[Array[CraftNetPipe]]], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[CraftNetPipe]]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: CraftNetPipe, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: CraftNetPipe, mergeInclude: str, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def removeBatch(cls, objs: Array[CraftNetPipe], spec: UpsertSpec=None) -> Union[ObjList[CraftNetPipe]]:
    """
    ...
    """
        ...
    @classmethod
    def replace(cls, objs: Array[CraftNetPipe], spec: UpsertSpec=None) -> Union[ObjList[CraftNetPipe]]:
    """
    ...
    """
        ...
    def unremove(self) -> Union[CraftNetPipe]:
    """
    ...
    """
        ...
    @classmethod
    def beforeCreate(cls, objs: Array[CraftNetPipe]) -> ObjList[CraftNetPipe]:
    """
    ...
    """
        ...
    @classmethod
    def beforeUpdate(cls, objs: Array[CraftNetPipe]) -> ObjList[CraftNetPipe]:
    """
    ...
    """
        ...
    @classmethod
    def beforeRemove(cls, objs: Array[CraftNetPipe]) -> ObjList[CraftNetPipe]:
    """
    ...
    """
        ...
    @classmethod
    def afterCreate(cls, objs: Array[CraftNetPipe]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterUpdate(cls, objs: Array[CraftNetPipe]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterRemove(cls, objs: Array[CraftNetPipe]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def startImportData(cls, spec: StartImportDataSpec=None) -> PushStream[CraftNetPipe]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    @classmethod
    def startImportDataWithStats(cls, spec: StartImportDataSpec=None) -> PushStreamWithStats[CraftNetPipe]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[CraftNetPipe]:
    """
    ...
    """
        ...
    @classmethod
    def typeOfBatch(cls, objs: Array[CraftNetPipe]) -> Union[Array[EntityType]]:
    """
    ...
    """
        ...
    @classmethod
    def dbEcho(cls, template: CraftNetPipe=None, count: int=None, sendBack: bool=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def callbackLogic(cls, objs: Array[CraftNetPipe], callback: Callable[[Union[CraftNetPipe]], Union[CraftNetPipe]]=None) -> ObjList[CraftNetPipe]:
    """
    ...
    """
        ...
    @classmethod
    def afterCallbackLogic(cls, objs: Array[CraftNetPipe], callback: Callable[[Union[CraftNetPipe]], Union[CraftNetPipe]]=None) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    def publish(self, subPath: str=None, contentType: str=None) -> CraftNetPipe:
    """
    ...
    """
        ...
    @classmethod
    def removeSeedDataBatch(cls, objs: Array[SeedData]=None, spec: UpsertSpec=None) -> Union[ObjList[CraftNetPipe]]:
    """
    ...
    """
        ...
    def createSeedData(self, spec: UpsertSpec=None) -> Union[CraftNetPipe]:
    """
    ...
    """
        ...
    @classmethod
    def createSeedDataBatch(cls, objs: Array[SeedData]=None, spec: UpsertSpec=None) -> Union[ObjList[CraftNetPipe]]:
    """
    ...
    """
        ...
    def updateSeedData(self, srcObj: SeedData=None, spec: UpsertSpec=None) -> Union[CraftNetPipe]:
    """
    ...
    """
        ...
    @classmethod
    def updateSeedDataBatch(cls, objs: Array[SeedData]=None, srcObjs: Array[SeedData]=None, spec: UpsertSpec=None) -> Union[ObjList[CraftNetPipe]]:
    """
    ...
    """
        ...
    def clearUserUpdates(self, spec: MergeSpec=None) -> Union[CraftNetPipe]:
    """
    ...
    """
        ...
    @classmethod
    def clearUserUpdatesBatch(cls, objs: Array[SeedData]=None, spec: MergeSpec=None) -> Union[ObjList[CraftNetPipe]]:
    """
    ...
    """
        ...
    def dependencies(self) -> Union[SeedDataDeps[CraftNetPipe]]:
        ...
    ...
    """
        ...
    @classmethod
    def convert(cls, model: Any, spec: MlConvertSpec=None) -> CraftNetPipe:
    """
    ...
    """
        ...
    def byReference(self) -> CraftNetPipe:
    """
    ...
    """
        ...
    def updateModelFiles(self, modelFiles: Map[str, Url], spec: MlOperationSpec=None) -> CraftNetPipe:
    """
    ...
    """
        ...
    def afterTrain(self, doTrainOutputs: Any, spec: MlOperationSpec=None) -> CraftNetPipe:
    """
    ...
    """
        ...
    def withNewSpec(self, spec: MlConvertSpec=None) -> CraftNetPipe:
    """
    ...
    """
        ...
    def afterConvert(self, model: Any, spec: MlConvertSpec=None) -> CraftNetPipe:
    """
    ...
    """
        ...
    def withHyperparamSpaces(self, paramSpaces: Map[str, Hp.ParamSpace]) -> CraftNetPipe:
    """
