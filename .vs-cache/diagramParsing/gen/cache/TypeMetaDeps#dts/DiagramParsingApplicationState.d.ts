// TypeScript definitions for the C3 type DiagramParsingApplicationState

/**
 * Application state for the Diagram Parsing Application.
 * All shared data sources become fields in this application state.
 *
 * @remarks this represents a value passed to a method that expects an instance of DiagramParsingApplicationState
 */
declare interface IDiagramParsingApplicationState {
  ...
  /**
   * Used to store {@link Sensor} objects, to be shown as options in sensor column's dropdown in verification grid.
   */
  options?: any;
   ...
   */
  sensorSearchOptions?: any;

  /**
   * Flag that helps to know if Master Sensor List is available
   */
  isMasterSensorsAvailable?: boolean;
}
 ...
 * All shared data sources become fields in this application state.
 *
 * @remarks this represents a made instance of DiagramParsingApplicationState
 */
declare class DiagramParsingApplicationState extends Obj  {

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): DiagramParsingApplicationState;

  /**
   * Unique identifier for the logical object that instance of this type represents.
   */
  readonly id?: string;
  withId(id: string | null): DiagramParsingApplicationState;

  /**
   * The name of the component. Optional field for informational purposes only.
   */
  readonly name?: string;
  withName(name: string | null): DiagramParsingApplicationState;
  ...
  withDataSpec(dataSpec: IUiSdlNoData | null): DiagramParsingApplicationState;

  /**
   * Disable if you want to avoid sending any and all requests for this component on first render.
   */
  readonly disableDataRequestOnFirstRender?: boolean;
  withDisableDataRequestOnFirstRender(disableDataRequestOnFirstRender: boolean): DiagramParsingApplicationState;

  /**
   * Whether the effect triggers and epics have been registered
   */
  readonly triggersRegistered?: boolean;
  withTriggersRegistered(triggersRegistered: boolean): DiagramParsingApplicationState;

  /**
   * Whether to wrap the component with a div which has a class name of its metdata id. Useful for targeting with css.
   */
  readonly wrapWithMetadataId?: boolean;
  withWrapWithMetadataId(wrapWithMetadataId: boolean): DiagramParsingApplicationState;

  /**
   * The Redux namespace for the application state to indicate where the application data is stored in the Redux state.
   */
  readonly REDUX_NAMESPACE?: string;
  withREDUX_NAMESPACE(REDUX_NAMESPACE: string | null): DiagramParsingApplicationState;

  /**
   * Collection of extra async {@link UiSdlEffectTrigger}.
   */
  readonly effectTriggers?: Array_Type<UiSdlEffectTrigger>;
  withEffectTriggers(effectTriggers: Array_Type<UiSdlEffectTrigger> | Array<IUiSdlEffectTrigger> | null): DiagramParsingApplicationState;

  /**
   * Used to store {@link Sensor} objects, to be shown as options in sensor column's dropdown in verification grid.
   */
  readonly options?: any;
  withOptions(options: any | null): DiagramParsingApplicationState;

  /**
   * Used to store {@link Sensor} objects, to be shown as options in sensor column's dropdown in verification grid
   * based on the user's search query
   */
  readonly sensorSearchOptions?: any;
  withSensorSearchOptions(sensorSearchOptions: any | null): DiagramParsingApplicationState;

  /**
   * Flag that helps to know if Master Sensor List is available
   */
  readonly isMasterSensorsAvailable?: boolean;
  withIsMasterSensorsAvailable(isMasterSensorsAvailable: boolean): DiagramParsingApplicationState;
   ...
   * @see #toJson
   */
  static fromJson(json: any): DiagramParsingApplicationState | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): DiagramParsingApplicationState | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): DiagramParsingApplicationState | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): DiagramParsingApplicationState | null;
   ...
   */
  replaceType(old: Type, new_: Type): DiagramParsingApplicationState;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): DiagramParsingApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): DiagramParsingApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<DiagramParsingApplicationState>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<DiagramParsingApplicationState>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): DiagramParsingApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DiagramParsingApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DiagramParsingApplicationState;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): DiagramParsingApplicationState;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): DiagramParsingApplicationState;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): DiagramParsingApplicationState;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): DiagramParsingApplicationState;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): DiagramParsingApplicationState;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): DiagramParsingApplicationState;
   ...
   * @see #removeField
   */
  withoutField(field: string): DiagramParsingApplicationState;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): DiagramParsingApplicationState;
   ...
   */
  withoutFields(fields: Array_Type<string>): DiagramParsingApplicationState;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): DiagramParsingApplicationState;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): DiagramParsingApplicationState;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): DiagramParsingApplicationState;
   ...
   * @see #unsetField
   */
  defaultField(field: string): DiagramParsingApplicationState;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): DiagramParsingApplicationState;
   ...
   * @see #removeField
   */
  unsetField(field: string): DiagramParsingApplicationState;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): DiagramParsingApplicationState;
   ...
   * @see #unsetField
   */
  removeField(field: string): DiagramParsingApplicationState;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): DiagramParsingApplicationState;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): DiagramParsingApplicationState;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): DiagramParsingApplicationState;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): DiagramParsingApplicationState;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): DiagramParsingApplicationState;

  mergeJson(json: any): DiagramParsingApplicationState;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): DiagramParsingApplicationState;
   ...
   */
  sumObj(other: Obj, deep?: boolean): DiagramParsingApplicationState;
   ...
   */
  singletonArray(): Array_Type<DiagramParsingApplicationState>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<DiagramParsingApplicationState> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<DiagramParsingApplicationState> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<DiagramParsingApplicationState>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<DiagramParsingApplicationState> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, DiagramParsingApplicationState> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, DiagramParsingApplicationState> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<DiagramParsingApplicationState>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<DiagramParsingApplicationState>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): DiagramParsingApplicationState;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): DiagramParsingApplicationState;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): DiagramParsingApplicationState;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): DiagramParsingApplicationState;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): DiagramParsingApplicationState;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): DiagramParsingApplicationState;
   ...
   * @see #fromString
   */
  static make(s: string): DiagramParsingApplicationState | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): DiagramParsingApplicationState;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): DiagramParsingApplicationState;
   ...
   */
  static cachedEmptyInst(): DiagramParsingApplicationState;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<DiagramParsingApplicationState> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): DiagramParsingApplicationState;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<DiagramParsingApplicationState>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<DiagramParsingApplicationState>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<DiagramParsingApplicationState> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<DiagramParsingApplicationState>> | null;
   ...
   */
  dependencies(): MetadataDeps<DiagramParsingApplicationState>;

  save(subPath?: string, contentType?: string): DiagramParsingApplicationState;
  ...
  update(srcObj?: DiagramParsingApplicationState, spec?: UpsertSpec): DiagramParsingApplicationState | null;

  upsert(srcObj?: DiagramParsingApplicationState, spec?: UpsertSpec): DiagramParsingApplicationState | null;
   ...
   * @see #toString
   */
  static fromString(s: string): DiagramParsingApplicationState | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string, failIfMissing?: boolean): DiagramParsingApplicationState | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: DiagramParsingApplicationState, state: UiSdlReduxState): DiagramParsingApplicationState | null;
   ...
   * @param value
   *            The value to update the state field with.
   * @returns a Redux action of type `SET_FIELD`.
   */
  static setFieldAction(field: string, value?: any): UiSdlReduxAction<any>;
