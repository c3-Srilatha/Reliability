// TypeScript definitions for the C3 type SymbolDetectionPipe

/**
 * This type represents an abstract {@link MlPipe} template for symbol detection in diagrams.
 *
 * @remarks this represents a value passed to a method that expects an instance of SymbolDetectionPipe
 */
declare interface ISymbolDetectionPipe {
 ...
 * This type represents an abstract {@link MlPipe} template for symbol detection in diagrams.
 *
 * @remarks this represents a made instance of SymbolDetectionPipe
 */
declare class SymbolDetectionPipe extends Obj  {
   ...
   */
  readonly id: string;
  withId(id: string): SymbolDetectionPipe;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): SymbolDetectionPipe;

  /**
   * Name of this pipe.
   */
  readonly name?: string;
  withName(name: string | null): SymbolDetectionPipe;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): SymbolDetectionPipe;
  ...
  withVersion(version: number | null): SymbolDetectionPipe;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): SymbolDetectionPipe;
  ...
  withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): SymbolDetectionPipe;
  ...
  withHidden(hidden: boolean): SymbolDetectionPipe;
  ...
  withUserOwned(userOwned: boolean): SymbolDetectionPipe;
  ...
  withTypeIdent(typeIdent: string | null): SymbolDetectionPipe;

  /**
   * If true, then the pipe shall not be retrained
   */
  readonly frozen?: boolean;
  withFrozen(frozen: boolean): SymbolDetectionPipe;

  /**
   * True if training has succeeded and false otherwise.
   */
  readonly trained?: boolean;
  withTrained(trained: boolean): SymbolDetectionPipe;

  /**
   * Errors from training.
   */
  readonly trainingErrors?: string;
  withTrainingErrors(trainingErrors: string | null): SymbolDetectionPipe;

  /**
   * If true, the underlying model only accepts flattened input.
   */
  readonly flattenInput?: boolean;
  withFlattenInput(flattenInput: boolean): SymbolDetectionPipe;

  /**
   * The hyperparameters overridden of a native model or pipe.
   */
  readonly hyperparamOverrides?: Map_Type<string, any>;
  withHyperparamOverrides(hyperparamOverrides: Map_Type<string, any> | {[key: string]: any} | null): SymbolDetectionPipe;
  ...
  withHyperparamSearchSpace(hyperparamSearchSpace: IHp.SearchSpace | null): SymbolDetectionPipe;
  ...
  withHpoSpec(hpoSpec: IHpo.Spec | null): SymbolDetectionPipe;

  /**
   * {@link Hpo.Experiment} stores the result of hyperparameter optimization to find the best model/pipeline.
   */
  readonly hpoExperiment?: Hpo.Experiment;
  withHpoExperiment(hpoExperiment: IHpo.Experiment | null): SymbolDetectionPipe;

  /**
   * Reference to the experiment that produced this {@link MlPipe}. For example, this could be a {@link Hpo.ExperimentBase}.
   */
  readonly experiment?: any;
  withExperiment(experiment: any | null): SymbolDetectionPipe;
  ...
  withModelFiles(modelFiles: Map_Type<string, Url> | {[key: string]: IUrl} | null): SymbolDetectionPipe;
  ...
  withCustomModelCode(customModelCode: Map_Type<string, any> | {[key: string]: any} | null): SymbolDetectionPipe;

  /**
   * Name for the function on the native model to call to do {@link MlProcessable#process}.
   */
  readonly processFunc?: string;
  withProcessFunc(processFunc: string | null): SymbolDetectionPipe;
  ...
  withUnderlyingPipe(underlyingPipe: IMlAtomicPipe<any, any, any> | null): SymbolDetectionPipe;

  /**
   * The name of the column containing the urls of the images to be processed.
   */
  readonly imageColumnName: string;
  withImageColumnName(imageColumnName: string): SymbolDetectionPipe;
  ...
  withAugmenters(augmenters: Array_Type<DiagramAugmenter> | Array<IDiagramAugmenter> | null): SymbolDetectionPipe;
   ...
   * @see #toJson
   */
  static fromJson(json: any): SymbolDetectionPipe | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): SymbolDetectionPipe | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): SymbolDetectionPipe | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): SymbolDetectionPipe | null;
   ...
   */
  replaceType(old: Type, new_: Type): SymbolDetectionPipe;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): SymbolDetectionPipe;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): SymbolDetectionPipe;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<SymbolDetectionPipe>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<SymbolDetectionPipe>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): SymbolDetectionPipe;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SymbolDetectionPipe;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SymbolDetectionPipe;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): SymbolDetectionPipe;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): SymbolDetectionPipe;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): SymbolDetectionPipe;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): SymbolDetectionPipe;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): SymbolDetectionPipe;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): SymbolDetectionPipe;
   ...
   * @see #removeField
   */
  withoutField(field: string): SymbolDetectionPipe;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): SymbolDetectionPipe;
   ...
   */
  withoutFields(fields: Array_Type<string>): SymbolDetectionPipe;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): SymbolDetectionPipe;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): SymbolDetectionPipe;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): SymbolDetectionPipe;
   ...
   * @see #unsetField
   */
  defaultField(field: string): SymbolDetectionPipe;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): SymbolDetectionPipe;
   ...
   * @see #removeField
   */
  unsetField(field: string): SymbolDetectionPipe;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): SymbolDetectionPipe;
   ...
   * @see #unsetField
   */
  removeField(field: string): SymbolDetectionPipe;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): SymbolDetectionPipe;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): SymbolDetectionPipe;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): SymbolDetectionPipe;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): SymbolDetectionPipe;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): SymbolDetectionPipe;

  mergeJson(json: any): SymbolDetectionPipe;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): SymbolDetectionPipe;
   ...
   */
  sumObj(other: Obj, deep?: boolean): SymbolDetectionPipe;
   ...
   */
  singletonArray(): Array_Type<SymbolDetectionPipe>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<SymbolDetectionPipe> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<SymbolDetectionPipe> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<SymbolDetectionPipe>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<SymbolDetectionPipe> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, SymbolDetectionPipe> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, SymbolDetectionPipe> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<SymbolDetectionPipe>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<SymbolDetectionPipe>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): SymbolDetectionPipe;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): SymbolDetectionPipe;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): SymbolDetectionPipe;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): SymbolDetectionPipe;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): SymbolDetectionPipe;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): SymbolDetectionPipe;
   ...
   * @see #fromString
   */
  static make(s: string): SymbolDetectionPipe | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): SymbolDetectionPipe;
   ...
   */
  static cachedEmptyInst(): SymbolDetectionPipe;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<SymbolDetectionPipe> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): SymbolDetectionPipe;
   ...
   */
  remakeTemplate(): SymbolDetectionPipe;
   ...
   */
  withoutIdentity(): SymbolDetectionPipe;
   ...
   */
  trainSync(x: Data, y?: , spec?: MlOperationSpec): SymbolDetectionPipe;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<SymbolDetectionPipe> | null;
   ...
   */
  static find(filter?: string, doNotProduceAll?: boolean): Stream<SymbolDetectionPipe> | null;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<SymbolDetectionPipe> | null;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): SymbolDetectionPipe | null;
   ...
   * @see findByCacheKey
   */
  static forCacheKey(key: string): SymbolDetectionPipe | null;
   ...
   * @see findByCacheKey
   */
  getCached(): SymbolDetectionPipe | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): SymbolDetectionPipe | null;
   ...
   */
  static produce(key: string): SymbolDetectionPipe | null;
   ...
   */
  static produceAll(): Map_Type<string, SymbolDetectionPipe> | null;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): Map_Type<string, SymbolDetectionPipe> | null;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<SymbolDetectionPipe>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<SymbolDetectionPipe>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<SymbolDetectionPipe> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<SymbolDetectionPipe>> | null;
   ...
   */
  get(include?: string): SymbolDetectionPipe | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): SymbolDetectionPipe | null;
   ...
   */
  getMissing(spec: GetMissingSpec): SymbolDetectionPipe;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): SymbolDetectionPipe | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): SymbolDetectionPipe;
   ...
   * @see #toString
   */
  static fromString(s: string): SymbolDetectionPipe | null;
   ...
   */
  create(spec?: UpsertSpec): SymbolDetectionPipe | null;
   ...
   */
  static createBatch(objs: Array_Type<SymbolDetectionPipe>, spec?: UpsertSpec): ObjList<SymbolDetectionPipe> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<SymbolDetectionPipe>, spec?: CreateBatchObjStreamSpec): ObjList<SymbolDetectionPipe> | null;
   ...
   */
  update(srcObj?: SymbolDetectionPipe, spec?: UpsertSpec): SymbolDetectionPipe | null;
   ...
   */
  upsert(srcObj?: SymbolDetectionPipe, spec?: UpsertSpec): SymbolDetectionPipe | null;
   ...
   */
  merge(spec?: MergeSpec): SymbolDetectionPipe | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): SymbolDetectionPipe | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): SymbolDetectionPipe | null;
   ...
   */
  static updateBatch(objs: Array_Type<SymbolDetectionPipe>, srcObjs?: Array_Type<SymbolDetectionPipe>, spec?: UpsertSpec): ObjList<SymbolDetectionPipe> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<SymbolDetectionPipe> | null>, spec?: UpsertSpec): ObjList<SymbolDetectionPipe> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<SymbolDetectionPipe>, srcObjs?: Array_Type<SymbolDetectionPipe>, spec?: UpsertSpec): ObjList<SymbolDetectionPipe> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<SymbolDetectionPipe> | null>, spec?: UpsertSpec): ObjList<SymbolDetectionPipe> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<SymbolDetectionPipe>, spec?: TouchSpec): ObjList<SymbolDetectionPipe> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<SymbolDetectionPipe>, spec?: MergeSpec): ObjList<SymbolDetectionPipe> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<SymbolDetectionPipe>, mergeInclude: string, spec?: MergeSpec): ObjList<SymbolDetectionPipe> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<SymbolDetectionPipe> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<SymbolDetectionPipe> | null;
   ...
   */
  static mergeAll(mergeObj: SymbolDetectionPipe, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: SymbolDetectionPipe, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<SymbolDetectionPipe>, spec?: UpsertSpec): ObjList<SymbolDetectionPipe> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<SymbolDetectionPipe>, spec?: UpsertSpec): ObjList<SymbolDetectionPipe> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): SymbolDetectionPipe | null;
   ...
   */
  static beforeCreate(objs: Array_Type<SymbolDetectionPipe>): ObjList<SymbolDetectionPipe>;
   ...
   */
  static beforeUpdate(objs: Array_Type<SymbolDetectionPipe>): ObjList<SymbolDetectionPipe>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<SymbolDetectionPipe>): ObjList<SymbolDetectionPipe>;
   ...
   */
  static afterCreate(objs: Array_Type<SymbolDetectionPipe>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<SymbolDetectionPipe>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<SymbolDetectionPipe>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<SymbolDetectionPipe>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<SymbolDetectionPipe>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): SymbolDetectionPipe | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<SymbolDetectionPipe>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: SymbolDetectionPipe, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<SymbolDetectionPipe>, callback?: λFunction<SymbolDetectionPipe | null, SymbolDetectionPipe | null>): ObjList<SymbolDetectionPipe>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<SymbolDetectionPipe>, callback?: λFunction<SymbolDetectionPipe | null, SymbolDetectionPipe | null>): Array_Type<ObjError> | null;
   ...
   */
  publish(subPath?: string, contentType?: string): SymbolDetectionPipe;
   ...
   */
  static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<SymbolDetectionPipe> | null;
   ...
   */
  createSeedData(spec?: UpsertSpec): SymbolDetectionPipe | null;
   ...
   */
  static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<SymbolDetectionPipe> | null;
   ...
   */
  updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): SymbolDetectionPipe | null;
   ...
   */
  static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<SymbolDetectionPipe> | null;
   ...
   * @return updated obj instance, same as {@link Persistable#update} return value.
   */
  clearUserUpdates(spec?: MergeSpec): SymbolDetectionPipe | null;
   ...
   *         {@link Persistable#updateBatch}.
   */
  static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<SymbolDetectionPipe> | null;
  ...
  dependencies(): SeedDataDeps<SymbolDetectionPipe> | null;
   ...
   * be returned as-is.
   */
  byReference(): SymbolDetectionPipe;
   ...
   */
  updateModelFiles(modelFiles: Map_Type<string, Url>, spec?: MlOperationSpec): SymbolDetectionPipe;
   ...
   */
  afterTrain(doTrainOutputs: any, spec?: MlOperationSpec): SymbolDetectionPipe;
   ...
   */
  withNewSpec(spec?: MlConvertSpec): SymbolDetectionPipe;
   ...
   */
  afterConvert(model: any, spec?: MlConvertSpec): SymbolDetectionPipe;
   ...
   */
  withHyperparamSpaces(paramSpaces: Map_Type<string, Hp.ParamSpace>): SymbolDetectionPipe;
