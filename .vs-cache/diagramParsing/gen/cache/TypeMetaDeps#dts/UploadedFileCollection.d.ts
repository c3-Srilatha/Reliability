// TypeScript definitions for the C3 type UploadedFileCollection
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of UploadedFileCollection
 */
declare interface IUploadedFileCollection {
   ...
   */
  sourceParsableDiagrams: Array_Type<SourceParsableDiagram> | Array<ISourceParsableDiagram>;
 ...
 * An entity of this type is created upon file upload and deleted once parsing has `COMPLETED` or `FAILED` for the respective files as indicated by `parsingStatus`.
 *
 * @remarks this represents a made instance of UploadedFileCollection
 */
declare class UploadedFileCollection extends Obj  {
   ...
   */
  readonly id: string;
  withId(id: string): UploadedFileCollection;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): UploadedFileCollection;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): UploadedFileCollection;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): UploadedFileCollection;
  ...
  withVersion(version: number | null): UploadedFileCollection;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): UploadedFileCollection;

  /**
   * The collection of {@link SourceParsableDiagram}s associated with this collection.
   */
  readonly sourceParsableDiagrams: Array_Type<SourceParsableDiagram>;
  withSourceParsableDiagrams(sourceParsableDiagrams: Array_Type<SourceParsableDiagram> | Array<ISourceParsableDiagram>): UploadedFileCollection;

  /**
   * The DS {@link Workflow.Run} triggered on the {@link #sourceParsableDiagrams} in this collection.
   */
  readonly workflowRun?: Workflow.Run;
  withWorkflowRun(workflowRun: IWorkflow.Run | null): UploadedFileCollection;
  ...
  withUserDismissed(userDismissed: boolean): UploadedFileCollection;

  /**
   * The number of {@link SourceParsableDiagram}s being tracked
   */
  readonly numFiles?: number;
  withNumFiles(numFiles: number | null): UploadedFileCollection;

  /**
   * The current status of the parsing job, populated by {@link #getParsingStatus}
   */
  readonly parsingStatus?: string;
  withParsingStatus(parsingStatus: string | null): UploadedFileCollection;
   ...
   * @see #toJson
   */
  static fromJson(json: any): UploadedFileCollection | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): UploadedFileCollection | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): UploadedFileCollection | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): UploadedFileCollection | null;
   ...
   */
  replaceType(old: Type, new_: Type): UploadedFileCollection;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): UploadedFileCollection;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): UploadedFileCollection;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<UploadedFileCollection>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<UploadedFileCollection>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): UploadedFileCollection;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UploadedFileCollection;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UploadedFileCollection;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UploadedFileCollection;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UploadedFileCollection;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UploadedFileCollection;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): UploadedFileCollection;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UploadedFileCollection;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UploadedFileCollection;
   ...
   * @see #removeField
   */
  withoutField(field: string): UploadedFileCollection;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): UploadedFileCollection;
   ...
   */
  withoutFields(fields: Array_Type<string>): UploadedFileCollection;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): UploadedFileCollection;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UploadedFileCollection;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): UploadedFileCollection;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UploadedFileCollection;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UploadedFileCollection;
   ...
   * @see #removeField
   */
  unsetField(field: string): UploadedFileCollection;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UploadedFileCollection;
   ...
   * @see #unsetField
   */
  removeField(field: string): UploadedFileCollection;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UploadedFileCollection;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): UploadedFileCollection;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): UploadedFileCollection;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): UploadedFileCollection;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): UploadedFileCollection;

  mergeJson(json: any): UploadedFileCollection;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): UploadedFileCollection;
   ...
   */
  sumObj(other: Obj, deep?: boolean): UploadedFileCollection;
   ...
   */
  singletonArray(): Array_Type<UploadedFileCollection>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<UploadedFileCollection> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UploadedFileCollection> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<UploadedFileCollection>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UploadedFileCollection> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, UploadedFileCollection> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UploadedFileCollection> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UploadedFileCollection>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UploadedFileCollection>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): UploadedFileCollection;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): UploadedFileCollection;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): UploadedFileCollection;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UploadedFileCollection;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): UploadedFileCollection;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UploadedFileCollection;
   ...
   * @see #fromString
   */
  static make(s: string): UploadedFileCollection | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): UploadedFileCollection;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): UploadedFileCollection;
   ...
   */
  static cachedEmptyInst(): UploadedFileCollection;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<UploadedFileCollection> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): UploadedFileCollection;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<UploadedFileCollection>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<UploadedFileCollection>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<UploadedFileCollection> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<UploadedFileCollection>> | null;
   ...
   */
  get(include?: string): UploadedFileCollection | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): UploadedFileCollection | null;
   ...
   */
  getMissing(spec: GetMissingSpec): UploadedFileCollection;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): UploadedFileCollection | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): UploadedFileCollection;
   ...
   * @see #toString
   */
  static fromString(s: string): UploadedFileCollection | null;
   ...
   */
  create(spec?: UpsertSpec): UploadedFileCollection | null;
   ...
   */
  static createBatch(objs: Array_Type<UploadedFileCollection>, spec?: UpsertSpec): ObjList<UploadedFileCollection> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<UploadedFileCollection>, spec?: CreateBatchObjStreamSpec): ObjList<UploadedFileCollection> | null;
   ...
   */
  update(srcObj?: UploadedFileCollection, spec?: UpsertSpec): UploadedFileCollection | null;
   ...
   */
  upsert(srcObj?: UploadedFileCollection, spec?: UpsertSpec): UploadedFileCollection | null;
   ...
   */
  merge(spec?: MergeSpec): UploadedFileCollection | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): UploadedFileCollection | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): UploadedFileCollection | null;
   ...
   */
  static updateBatch(objs: Array_Type<UploadedFileCollection>, srcObjs?: Array_Type<UploadedFileCollection>, spec?: UpsertSpec): ObjList<UploadedFileCollection> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<UploadedFileCollection> | null>, spec?: UpsertSpec): ObjList<UploadedFileCollection> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<UploadedFileCollection>, srcObjs?: Array_Type<UploadedFileCollection>, spec?: UpsertSpec): ObjList<UploadedFileCollection> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<UploadedFileCollection> | null>, spec?: UpsertSpec): ObjList<UploadedFileCollection> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<UploadedFileCollection>, spec?: TouchSpec): ObjList<UploadedFileCollection> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<UploadedFileCollection>, spec?: MergeSpec): ObjList<UploadedFileCollection> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<UploadedFileCollection>, mergeInclude: string, spec?: MergeSpec): ObjList<UploadedFileCollection> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<UploadedFileCollection> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<UploadedFileCollection> | null;
   ...
   */
  static mergeAll(mergeObj: UploadedFileCollection, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: UploadedFileCollection, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<UploadedFileCollection>, spec?: UpsertSpec): ObjList<UploadedFileCollection> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<UploadedFileCollection>, spec?: UpsertSpec): ObjList<UploadedFileCollection> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): UploadedFileCollection | null;
   ...
   */
  static beforeCreate(objs: Array_Type<UploadedFileCollection>): ObjList<UploadedFileCollection>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<UploadedFileCollection>): ObjList<UploadedFileCollection>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<UploadedFileCollection>): ObjList<UploadedFileCollection>;
   ...
   */
  static afterCreate(objs: Array_Type<UploadedFileCollection>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<UploadedFileCollection>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<UploadedFileCollection>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<UploadedFileCollection>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<UploadedFileCollection>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): UploadedFileCollection | null;
   ...
   */
  withoutIdentity(): UploadedFileCollection | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<UploadedFileCollection>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: UploadedFileCollection, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<UploadedFileCollection>, callback?: λFunction<UploadedFileCollection | null, UploadedFileCollection | null>): ObjList<UploadedFileCollection>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<UploadedFileCollection>, callback?: λFunction<UploadedFileCollection | null, UploadedFileCollection | null>): Array_Type<ObjError> | null;
   ...
   */
  getParsingStatus(returnInclude?: string): UploadedFileCollection | null;
   ...
   */
  static fetchWithLatestStatus(spec?: FetchSpec): FetchResult<UploadedFileCollection>;
}
