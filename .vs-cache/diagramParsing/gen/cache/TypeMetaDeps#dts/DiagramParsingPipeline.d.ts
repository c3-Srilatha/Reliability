// TypeScript definitions for the C3 type DiagramParsingPipeline

/**
 * Pipeline that takes a list of P&IDs in PDF format, detects the symbols (LMI, TAG, etc) on those digrams
 * and recognizes the texts on each symbol. The pipeline consists of three steps each implemented by
 * an {@link MlPipe}: {@link PdfToImagePipe}, {@link SymbolDetectionPipe}, and {@link ImageToTextPipe}.
 *
 * @remarks this represents a value passed to a method that expects an instance of DiagramParsingPipeline
 */
declare interface IDiagramParsingPipeline<DX, DO> {
  ...
  /**
   * First step of diagram parsing: {@link SymbolDetectionPipe}.
   * If the `symbolDetectionPipe` is not given during the object initialization,
   * the function `DiagramParsingPipeline#beforeCreate` will instantiate a pipe with
   * the function `DiagramParsingSetupUtils#createTwoStageSymbolDetectionPipeTemplate`
   */
  symbolDetectionPipe?: ISymbolDetectionPipe;

  /**
   * Second step of diagram parsing: {@link ImageToTextPipe}.
   * If the `imageToTextPipe` is not given during the object initialization,
   * the function `DiagramParsingPipeline#beforeCreate` will instantiate a pipe with
   * the function `DiagramParsingSetupUtils#createImageToTextPipeTemplate`
   */
  imageToTextPipe?: IImageToTextPipe;

  /**
   * Third step of diagram parsing: {@link ConnectionDetectionPipe}.
   * Detects connections between elements in the diagram, helping to identify relationships and interactions
   * between the symbols in the parsed diagram.
   */
  connectionDetectionPipe?: IMlPipe<any, any, any, any, any>;
}
 ...
 * an {@link MlPipe}: {@link PdfToImagePipe}, {@link SymbolDetectionPipe}, and {@link ImageToTextPipe}.
 *
 * @remarks this represents a made instance of DiagramParsingPipeline
 */
declare class DiagramParsingPipeline<DX, DO> extends Obj  {

  /**
   * List of all vertices in this graph.
   */
  readonly vertices?: Array_Type<MlPipeline.Vertex>;
  withVertices(vertices: Array_Type<MlPipeline.Vertex> | Array<IMlPipeline.Vertex> | null): DiagramParsingPipeline;

  /**
   * List of all edges in this graph.
   */
  readonly edges?: Array_Type<FlowGraph.Edge<MlPipeline.Vertex>>;
  withEdges(edges: Array_Type<FlowGraph.Edge<MlPipeline.Vertex>> | Array<IFlowGraph.Edge<MlPipeline.Vertex>> | null): DiagramParsingPipeline;
  ...
  withVertexConnections(vertexConnections: Map_Type<string, Map_Type<string, any>> | {[key: string]: Map_Type<string, any> | {[key: string]: any}} | null): DiagramParsingPipeline;
   ...
   */
  readonly id: string;
  withId(id: string): DiagramParsingPipeline;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): DiagramParsingPipeline;

  /**
   * Name of this pipe.
   */
  readonly name?: string;
  withName(name: string | null): DiagramParsingPipeline;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): DiagramParsingPipeline;
  ...
  withVersion(version: number | null): DiagramParsingPipeline;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): DiagramParsingPipeline;
  ...
  withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): DiagramParsingPipeline;
  ...
  withHidden(hidden: boolean): DiagramParsingPipeline;
  ...
  withUserOwned(userOwned: boolean): DiagramParsingPipeline;
  ...
  withTypeIdent(typeIdent: string | null): DiagramParsingPipeline;

  /**
   * If true, then the pipe shall not be retrained
   */
  readonly frozen?: boolean;
  withFrozen(frozen: boolean): DiagramParsingPipeline;

  /**
   * True if training has succeeded and false otherwise.
   */
  readonly trained?: boolean;
  withTrained(trained: boolean): DiagramParsingPipeline;

  /**
   * Errors from training.
   */
  readonly trainingErrors?: string;
  withTrainingErrors(trainingErrors: string | null): DiagramParsingPipeline;

  /**
   * If true, the underlying model only accepts flattened input.
   */
  readonly flattenInput?: boolean;
  withFlattenInput(flattenInput: boolean): DiagramParsingPipeline;

  /**
   * The hyperparameters overridden of a native model or pipe.
   */
  readonly hyperparamOverrides?: Map_Type<string, any>;
  withHyperparamOverrides(hyperparamOverrides: Map_Type<string, any> | {[key: string]: any} | null): DiagramParsingPipeline;
  ...
  withHyperparamSearchSpace(hyperparamSearchSpace: IHp.SearchSpace | null): DiagramParsingPipeline;
  ...
  withHpoSpec(hpoSpec: IHpo.Spec | null): DiagramParsingPipeline;

  /**
   * {@link Hpo.Experiment} stores the result of hyperparameter optimization to find the best model/pipeline.
   */
  readonly hpoExperiment?: Hpo.Experiment;
  withHpoExperiment(hpoExperiment: IHpo.Experiment | null): DiagramParsingPipeline;

  /**
   * Reference to the experiment that produced this {@link MlPipe}. For example, this could be a {@link Hpo.ExperimentBase}.
   */
  readonly experiment?: any;
  withExperiment(experiment: any | null): DiagramParsingPipeline;

  /**
   * Names of the {@link #score} outputs for this machine learning pipeline.
   */
  readonly scoreNames?: Set_Type<string>;
  withScoreNames(scoreNames: Set_Type<string> | Array<string> | null): DiagramParsingPipeline;
  ...
  withTrainRun(trainRun: IWorkflowExecutorRun | null): DiagramParsingPipeline;
  ...
  withTrainStatus(trainStatus: IWorkflow.Status | null): DiagramParsingPipeline;
  ...
  withDoNotAutoUpsert(doNotAutoUpsert: boolean): DiagramParsingPipeline;
   ...
   * the function `DiagramParsingSetupUtils#createTwoStageSymbolDetectionPipeTemplate`
   */
  readonly symbolDetectionPipe?: SymbolDetectionPipe;
  withSymbolDetectionPipe(symbolDetectionPipe: ISymbolDetectionPipe | null): DiagramParsingPipeline;
   ...
   * the function `DiagramParsingSetupUtils#createImageToTextPipeTemplate`
   */
  readonly imageToTextPipe?: ImageToTextPipe;
  withImageToTextPipe(imageToTextPipe: IImageToTextPipe | null): DiagramParsingPipeline;
   ...
   * between the symbols in the parsed diagram.
   */
  readonly connectionDetectionPipe?: MlPipe<any, any, any, any, any>;
  withConnectionDetectionPipe(connectionDetectionPipe: IMlPipe<any, any, any, any, any> | null): DiagramParsingPipeline;
   ...
   * @see #toJson
   */
  static fromJson(json: any): DiagramParsingPipeline<DX, DO> | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): DiagramParsingPipeline<DX, DO> | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): DiagramParsingPipeline<DX, DO> | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): DiagramParsingPipeline<DX, DO> | null;
   ...
   */
  replaceType(old: Type, new_: Type): DiagramParsingPipeline<DX, DO>;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): DiagramParsingPipeline<DX, DO>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): DiagramParsingPipeline<DX, DO>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<DiagramParsingPipeline<DX, DO>>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<DiagramParsingPipeline<DX, DO>>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): DiagramParsingPipeline<DX, DO>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DiagramParsingPipeline<DX, DO>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DiagramParsingPipeline<DX, DO>;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): DiagramParsingPipeline<DX, DO>;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): DiagramParsingPipeline<DX, DO>;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): DiagramParsingPipeline<DX, DO>;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): DiagramParsingPipeline<DX, DO>;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): DiagramParsingPipeline<DX, DO>;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): DiagramParsingPipeline<DX, DO>;
   ...
   * @see #removeField
   */
  withoutField(field: string): DiagramParsingPipeline<DX, DO>;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): DiagramParsingPipeline<DX, DO>;
   ...
   */
  withoutFields(fields: Array_Type<string>): DiagramParsingPipeline<DX, DO>;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): DiagramParsingPipeline<DX, DO>;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): DiagramParsingPipeline<DX, DO>;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): DiagramParsingPipeline<DX, DO>;
   ...
   * @see #unsetField
   */
  defaultField(field: string): DiagramParsingPipeline<DX, DO>;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): DiagramParsingPipeline<DX, DO>;
   ...
   * @see #removeField
   */
  unsetField(field: string): DiagramParsingPipeline<DX, DO>;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): DiagramParsingPipeline<DX, DO>;
   ...
   * @see #unsetField
   */
  removeField(field: string): DiagramParsingPipeline<DX, DO>;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): DiagramParsingPipeline<DX, DO>;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): DiagramParsingPipeline<DX, DO>;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): DiagramParsingPipeline<DX, DO>;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): DiagramParsingPipeline<DX, DO>;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): DiagramParsingPipeline<DX, DO>;

  mergeJson(json: any): DiagramParsingPipeline<DX, DO>;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): DiagramParsingPipeline<DX, DO>;
   ...
   */
  sumObj(other: Obj, deep?: boolean): DiagramParsingPipeline<DX, DO>;
   ...
   */
  singletonArray(): Array_Type<DiagramParsingPipeline<DX, DO>>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<DiagramParsingPipeline<DX, DO>> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<DiagramParsingPipeline<DX, DO>> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<DiagramParsingPipeline<DX, DO>>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<DiagramParsingPipeline<DX, DO>> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, DiagramParsingPipeline<DX, DO>> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, DiagramParsingPipeline<DX, DO>> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<DiagramParsingPipeline<DX, DO>>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<DiagramParsingPipeline<DX, DO>>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): DiagramParsingPipeline<DX, DO>;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): DiagramParsingPipeline<DX, DO>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): DiagramParsingPipeline<DX, DO>;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): DiagramParsingPipeline<DX, DO>;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): DiagramParsingPipeline<DX, DO>;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): DiagramParsingPipeline<DX, DO>;
   ...
   * @see #fromString
   */
  static make(s: string): DiagramParsingPipeline<DX, DO> | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): DiagramParsingPipeline<DX, DO>;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): DiagramParsingPipeline<DX, DO>;
   ...
   */
  static cachedEmptyInst(): DiagramParsingPipeline<DX, DO>;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<DiagramParsingPipeline<DX, DO>> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): DiagramParsingPipeline<DX, DO>;
   ...
   */
  remakeTemplate(): DiagramParsingPipeline<DX, DO>;
   ...
   */
  precomputeVertexConnections(): DiagramParsingPipeline<DX, DO>;
   ...
   */
  mapVertices(mapper: λFunction<MlPipeline.Vertex | null, T | null>): DiagramParsingPipeline<DX, DO>;
   ...
   */
  topologicalSort(reverse?: boolean): DiagramParsingPipeline<DX, DO>;
   ...
   */
  ancestorGraph(sink: FlowGraph.Vertex): DiagramParsingPipeline<DX, DO>;
   ...
   */
  replaceVertex(oldVertex: FlowGraph.Vertex, newVertex: FlowGraph.Vertex, doNotMerge?: boolean, removeDisconnectedEdges?: boolean): DiagramParsingPipeline<DX, DO>;
   ...
   */
  replaceVertices(oldVertices: Array_Type<FlowGraph.Vertex>, newVertex: FlowGraph.Vertex, spec?: FlowGraphReplaceSpec): DiagramParsingPipeline<DX, DO>;
   ...
   * @return
   */
  replaceVertices(oldVertices: Array_Type<FlowGraph.Vertex>, newVertices: Array_Type<FlowGraph.Vertex>, newEdges?: Array_Type<FlowGraph.Edge<FlowGraph.Vertex>>, spec?: FlowGraphReplaceSpec): DiagramParsingPipeline<DX, DO>;
   ...
   * connected.
   */
  removeVertex(toRemove: FlowGraph.Vertex): DiagramParsingPipeline<DX, DO>;

  removeVertex(idToRemove: string): DiagramParsingPipeline<DX, DO>;
   ...
   */
  removeVertices(toRemove?: Array_Type<FlowGraph.Vertex>): DiagramParsingPipeline<DX, DO>;
   ...
   */
  mergeWith(other: DiagramParsingPipeline<DX, DO>): DiagramParsingPipeline<DX, DO>;
   ...
   */
  trainSync(x: DX, y?: , spec?: MlOperationSpec): DiagramParsingPipeline<DX, DO>;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<DiagramParsingPipeline<DX, DO>> | null;
   ...
   */
  static find(filter?: string, doNotProduceAll?: boolean): Stream<DiagramParsingPipeline<DX, DO>> | null;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<DiagramParsingPipeline<DX, DO>> | null;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): DiagramParsingPipeline<DX, DO> | null;
   ...
   * @see findByCacheKey
   */
  static forCacheKey(key: string): DiagramParsingPipeline<DX, DO> | null;
   ...
   * @see findByCacheKey
   */
  getCached(): DiagramParsingPipeline<DX, DO> | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): DiagramParsingPipeline<DX, DO> | null;
   ...
   */
  static produce(key: string): DiagramParsingPipeline<DX, DO> | null;
   ...
   */
  static produceAll(): Map_Type<string, DiagramParsingPipeline<DX, DO>> | null;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): Map_Type<string, DiagramParsingPipeline<DX, DO>> | null;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<DiagramParsingPipeline<DX, DO>>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<DiagramParsingPipeline<DX, DO>>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<DiagramParsingPipeline<DX, DO>> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<DiagramParsingPipeline<DX, DO>>> | null;
   ...
   */
  get(include?: string): DiagramParsingPipeline<DX, DO> | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): DiagramParsingPipeline<DX, DO> | null;
   ...
   */
  getMissing(spec: GetMissingSpec): DiagramParsingPipeline<DX, DO>;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): DiagramParsingPipeline<DX, DO> | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): DiagramParsingPipeline<DX, DO>;
   ...
   * @see #toString
   */
  static fromString(s: string): DiagramParsingPipeline<DX, DO> | null;
   ...
   */
  create(spec?: UpsertSpec): DiagramParsingPipeline<DX, DO> | null;
   ...
   */
  static createBatch(objs: Array_Type<DiagramParsingPipeline<DX, DO>>, spec?: UpsertSpec): ObjList<DiagramParsingPipeline<DX, DO>> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<DiagramParsingPipeline<DX, DO>>, spec?: CreateBatchObjStreamSpec): ObjList<DiagramParsingPipeline<DX, DO>> | null;
   ...
   */
  update(srcObj?: DiagramParsingPipeline<DX, DO>, spec?: UpsertSpec): DiagramParsingPipeline<DX, DO> | null;
   ...
   */
  upsert(srcObj?: DiagramParsingPipeline<DX, DO>, spec?: UpsertSpec): DiagramParsingPipeline<DX, DO> | null;
   ...
   */
  merge(spec?: MergeSpec): DiagramParsingPipeline<DX, DO> | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): DiagramParsingPipeline<DX, DO> | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): DiagramParsingPipeline<DX, DO> | null;
   ...
   */
  static updateBatch(objs: Array_Type<DiagramParsingPipeline<DX, DO>>, srcObjs?: Array_Type<DiagramParsingPipeline<DX, DO>>, spec?: UpsertSpec): ObjList<DiagramParsingPipeline<DX, DO>> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<DiagramParsingPipeline<DX, DO>> | null>, spec?: UpsertSpec): ObjList<DiagramParsingPipeline<DX, DO>> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<DiagramParsingPipeline<DX, DO>>, srcObjs?: Array_Type<DiagramParsingPipeline<DX, DO>>, spec?: UpsertSpec): ObjList<DiagramParsingPipeline<DX, DO>> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<DiagramParsingPipeline<DX, DO>> | null>, spec?: UpsertSpec): ObjList<DiagramParsingPipeline<DX, DO>> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<DiagramParsingPipeline<DX, DO>>, spec?: TouchSpec): ObjList<DiagramParsingPipeline<DX, DO>> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<DiagramParsingPipeline<DX, DO>>, spec?: MergeSpec): ObjList<DiagramParsingPipeline<DX, DO>> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<DiagramParsingPipeline<DX, DO>>, mergeInclude: string, spec?: MergeSpec): ObjList<DiagramParsingPipeline<DX, DO>> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<DiagramParsingPipeline<DX, DO>> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<DiagramParsingPipeline<DX, DO>> | null;
   ...
   */
  static mergeAll(mergeObj: DiagramParsingPipeline<DX, DO>, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: DiagramParsingPipeline<DX, DO>, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<DiagramParsingPipeline<DX, DO>>, spec?: UpsertSpec): ObjList<DiagramParsingPipeline<DX, DO>> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<DiagramParsingPipeline<DX, DO>>, spec?: UpsertSpec): ObjList<DiagramParsingPipeline<DX, DO>> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): DiagramParsingPipeline<DX, DO> | null;
   ...
   */
  static beforeCreate(objs: Array_Type<DiagramParsingPipeline<DX, DO>>): ObjList<DiagramParsingPipeline<DX, DO>>;
   ...
   */
  static beforeUpdate(objs: Array_Type<DiagramParsingPipeline<DX, DO>>): ObjList<DiagramParsingPipeline<DX, DO>>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<DiagramParsingPipeline<DX, DO>>): ObjList<DiagramParsingPipeline<DX, DO>>;
   ...
   */
  static afterCreate(objs: Array_Type<DiagramParsingPipeline<DX, DO>>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<DiagramParsingPipeline<DX, DO>>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<DiagramParsingPipeline<DX, DO>>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<DiagramParsingPipeline<DX, DO>>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<DiagramParsingPipeline<DX, DO>>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): DiagramParsingPipeline<DX, DO> | null;
   ...
   */
  withoutIdentity(): DiagramParsingPipeline<DX, DO> | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<DiagramParsingPipeline<DX, DO>>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: DiagramParsingPipeline<DX, DO>, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<DiagramParsingPipeline<DX, DO>>, callback?: λFunction<DiagramParsingPipeline<DX, DO> | null, DiagramParsingPipeline<DX, DO> | null>): ObjList<DiagramParsingPipeline<DX, DO>>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<DiagramParsingPipeline<DX, DO>>, callback?: λFunction<DiagramParsingPipeline<DX, DO> | null, DiagramParsingPipeline<DX, DO> | null>): Array_Type<ObjError> | null;
   ...
   */
  publish(subPath?: string, contentType?: string): DiagramParsingPipeline<DX, DO>;
   ...
   */
  static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<DiagramParsingPipeline<DX, DO>> | null;
   ...
   */
  createSeedData(spec?: UpsertSpec): DiagramParsingPipeline<DX, DO> | null;
   ...
   */
  static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<DiagramParsingPipeline<DX, DO>> | null;
   ...
   */
  updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): DiagramParsingPipeline<DX, DO> | null;
   ...
   */
  static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<DiagramParsingPipeline<DX, DO>> | null;
   ...
   * @return updated obj instance, same as {@link Persistable#update} return value.
   */
  clearUserUpdates(spec?: MergeSpec): DiagramParsingPipeline<DX, DO> | null;
   ...
   *         {@link Persistable#updateBatch}.
   */
  static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<DiagramParsingPipeline<DX, DO>> | null;
  ...
  dependencies(): SeedDataDeps<DiagramParsingPipeline<DX, DO>> | null;
   ...
   */
  static convert(model: any, spec?: MlConvertSpec): DiagramParsingPipeline<DX, DO>;

  /**
   * Freezes an {@link MlPipe}
   * @return modified copy of this {@link MlPipe} that cannot be trained
   */
  freeze(): DiagramParsingPipeline<DX, DO>;
   ...
   */
  freeze(paths?: Array_Type<string>): DiagramParsingPipeline<DX, DO>;

  /**
   * Unfreezes an {@link MlPipe}
   * @return modified copy of this {@link MlPipe} that can be trained
   */
  unfreeze(): DiagramParsingPipeline<DX, DO>;
   ...
   */
  unfreeze(paths?: Array_Type<string>): DiagramParsingPipeline<DX, DO>;
   ...
   * be returned as-is.
   */
  byReference(): DiagramParsingPipeline<DX, DO>;
   ...
   */
  train_verify(x?: DX, y?: , spec?: MlOperationSpec): DiagramParsingPipeline<DX, DO>;
   ...
   */
  withHyperparamSpaces(paramSpaces: Map_Type<string, Map_Type<string, Hp.ParamSpace>>): DiagramParsingPipeline<DX, DO>;
   ...
   */
  replacePipe(pipePath: string, newPipe: MlPipe<any, any, any, any, any>): DiagramParsingPipeline<DX, DO>;
   ...
   */
  replaceInterpreter(interpreterPath: string, newInterpreter: MlInterpreter<any, any>): DiagramParsingPipeline<DX, DO>;
   ...
   */
  flatten(): DiagramParsingPipeline<DX, DO>;
   ...
   */
  static fromV7Json(pipeline: string, runtimeRequirements: Array_Type<string>): DiagramParsingPipeline<DX, DO>;
