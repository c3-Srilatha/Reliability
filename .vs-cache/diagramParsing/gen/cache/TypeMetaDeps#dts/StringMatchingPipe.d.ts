// TypeScript definitions for the C3 type StringMatchingPipe
 ...
 * ```
 *
 * @remarks this represents a value passed to a method that expects an instance of StringMatchingPipe
 */
declare interface IStringMatchingPipe {
 ...
 * ```
 *
 * @remarks this represents a made instance of StringMatchingPipe
 */
declare class StringMatchingPipe extends Obj  {
   ...
   */
  readonly id: string;
  withId(id: string): StringMatchingPipe;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): StringMatchingPipe;

  /**
   * Name of this pipe.
   */
  readonly name?: string;
  withName(name: string | null): StringMatchingPipe;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): StringMatchingPipe;
  ...
  withVersion(version: number | null): StringMatchingPipe;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): StringMatchingPipe;
  ...
  withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): StringMatchingPipe;
  ...
  withHidden(hidden: boolean): StringMatchingPipe;
  ...
  withUserOwned(userOwned: boolean): StringMatchingPipe;
  ...
  withTypeIdent(typeIdent: string | null): StringMatchingPipe;

  /**
   * If true, then the pipe shall not be retrained
   */
  readonly frozen?: boolean;
  withFrozen(frozen: boolean): StringMatchingPipe;

  /**
   * True if training has succeeded and false otherwise.
   */
  readonly trained?: boolean;
  withTrained(trained: boolean): StringMatchingPipe;

  /**
   * Errors from training.
   */
  readonly trainingErrors?: string;
  withTrainingErrors(trainingErrors: string | null): StringMatchingPipe;

  /**
   * If true, the underlying model only accepts flattened input.
   */
  readonly flattenInput?: boolean;
  withFlattenInput(flattenInput: boolean): StringMatchingPipe;

  /**
   * The hyperparameters overridden of a native model or pipe.
   */
  readonly hyperparamOverrides?: Map_Type<string, any>;
  withHyperparamOverrides(hyperparamOverrides: Map_Type<string, any> | {[key: string]: any} | null): StringMatchingPipe;
  ...
  withHyperparamSearchSpace(hyperparamSearchSpace: IHp.SearchSpace | null): StringMatchingPipe;
  ...
  withHpoSpec(hpoSpec: IHpo.Spec | null): StringMatchingPipe;

  /**
   * {@link Hpo.Experiment} stores the result of hyperparameter optimization to find the best model/pipeline.
   */
  readonly hpoExperiment?: Hpo.Experiment;
  withHpoExperiment(hpoExperiment: IHpo.Experiment | null): StringMatchingPipe;

  /**
   * Reference to the experiment that produced this {@link MlPipe}. For example, this could be a {@link Hpo.ExperimentBase}.
   */
  readonly experiment?: any;
  withExperiment(experiment: any | null): StringMatchingPipe;
  ...
  withModelFiles(modelFiles: Map_Type<string, Url> | {[key: string]: IUrl} | null): StringMatchingPipe;
  ...
  withCustomModelCode(customModelCode: Map_Type<string, any> | {[key: string]: any} | null): StringMatchingPipe;

  /**
   * Name for the function on the native model to call to do {@link MlProcessable#process}.
   */
  readonly processFunc?: string;
  withProcessFunc(processFunc: string | null): StringMatchingPipe;
  ...
  withUnderlyingPipe(underlyingPipe: IMlAtomicPipe<any, any, any> | null): StringMatchingPipe;

  /**
   * Name of the column that contains text for string matching in the input data.
   */
  readonly textColumnName: string;
  withTextColumnName(textColumnName: string): StringMatchingPipe;
  ...
  withMethod(method: string | null): StringMatchingPipe;

  /**
   * The type of similarity score to use
   */
  readonly similarity?: string;
  withSimilarity(similarity: string | null): StringMatchingPipe;

  /**
   * The minimum similarity score to consider a match
   */
  readonly minScore?: number;
  withMinScore(minScore: number | null): StringMatchingPipe;
   ...
   * @see #toJson
   */
  static fromJson(json: any): StringMatchingPipe | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): StringMatchingPipe | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): StringMatchingPipe | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): StringMatchingPipe | null;
   ...
   */
  replaceType(old: Type, new_: Type): StringMatchingPipe;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): StringMatchingPipe;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): StringMatchingPipe;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<StringMatchingPipe>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<StringMatchingPipe>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): StringMatchingPipe;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): StringMatchingPipe;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): StringMatchingPipe;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): StringMatchingPipe;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): StringMatchingPipe;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): StringMatchingPipe;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): StringMatchingPipe;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): StringMatchingPipe;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): StringMatchingPipe;
   ...
   * @see #removeField
   */
  withoutField(field: string): StringMatchingPipe;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): StringMatchingPipe;
   ...
   */
  withoutFields(fields: Array_Type<string>): StringMatchingPipe;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): StringMatchingPipe;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): StringMatchingPipe;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): StringMatchingPipe;
   ...
   * @see #unsetField
   */
  defaultField(field: string): StringMatchingPipe;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): StringMatchingPipe;
   ...
   * @see #removeField
   */
  unsetField(field: string): StringMatchingPipe;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): StringMatchingPipe;
   ...
   * @see #unsetField
   */
  removeField(field: string): StringMatchingPipe;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): StringMatchingPipe;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): StringMatchingPipe;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): StringMatchingPipe;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): StringMatchingPipe;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): StringMatchingPipe;

  mergeJson(json: any): StringMatchingPipe;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): StringMatchingPipe;
   ...
   */
  sumObj(other: Obj, deep?: boolean): StringMatchingPipe;
   ...
   */
  singletonArray(): Array_Type<StringMatchingPipe>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<StringMatchingPipe> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<StringMatchingPipe> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<StringMatchingPipe>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<StringMatchingPipe> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, StringMatchingPipe> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, StringMatchingPipe> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<StringMatchingPipe>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<StringMatchingPipe>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): StringMatchingPipe;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): StringMatchingPipe;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): StringMatchingPipe;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): StringMatchingPipe;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): StringMatchingPipe;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): StringMatchingPipe;
   ...
   * @see #fromString
   */
  static make(s: string): StringMatchingPipe | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): StringMatchingPipe;
   ...
   */
  static cachedEmptyInst(): StringMatchingPipe;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<StringMatchingPipe> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): StringMatchingPipe;
   ...
   */
  remakeTemplate(): StringMatchingPipe;
   ...
   */
  withoutIdentity(): StringMatchingPipe;
   ...
   */
  trainSync(x: , y?: , spec?: MlOperationSpec): StringMatchingPipe;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<StringMatchingPipe> | null;
   ...
   */
  static find(filter?: string, doNotProduceAll?: boolean): Stream<StringMatchingPipe> | null;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<StringMatchingPipe> | null;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): StringMatchingPipe | null;
   ...
   * @see findByCacheKey
   */
  static forCacheKey(key: string): StringMatchingPipe | null;
   ...
   * @see findByCacheKey
   */
  getCached(): StringMatchingPipe | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): StringMatchingPipe | null;
   ...
   */
  static produce(key: string): StringMatchingPipe | null;
   ...
   */
  static produceAll(): Map_Type<string, StringMatchingPipe> | null;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): Map_Type<string, StringMatchingPipe> | null;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<StringMatchingPipe>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<StringMatchingPipe>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<StringMatchingPipe> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<StringMatchingPipe>> | null;
   ...
   */
  get(include?: string): StringMatchingPipe | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): StringMatchingPipe | null;
   ...
   */
  getMissing(spec: GetMissingSpec): StringMatchingPipe;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): StringMatchingPipe | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): StringMatchingPipe;
   ...
   * @see #toString
   */
  static fromString(s: string): StringMatchingPipe | null;
   ...
   */
  create(spec?: UpsertSpec): StringMatchingPipe | null;
   ...
   */
  static createBatch(objs: Array_Type<StringMatchingPipe>, spec?: UpsertSpec): ObjList<StringMatchingPipe> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<StringMatchingPipe>, spec?: CreateBatchObjStreamSpec): ObjList<StringMatchingPipe> | null;
   ...
   */
  update(srcObj?: StringMatchingPipe, spec?: UpsertSpec): StringMatchingPipe | null;
   ...
   */
  upsert(srcObj?: StringMatchingPipe, spec?: UpsertSpec): StringMatchingPipe | null;
   ...
   */
  merge(spec?: MergeSpec): StringMatchingPipe | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): StringMatchingPipe | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): StringMatchingPipe | null;
   ...
   */
  static updateBatch(objs: Array_Type<StringMatchingPipe>, srcObjs?: Array_Type<StringMatchingPipe>, spec?: UpsertSpec): ObjList<StringMatchingPipe> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<StringMatchingPipe> | null>, spec?: UpsertSpec): ObjList<StringMatchingPipe> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<StringMatchingPipe>, srcObjs?: Array_Type<StringMatchingPipe>, spec?: UpsertSpec): ObjList<StringMatchingPipe> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<StringMatchingPipe> | null>, spec?: UpsertSpec): ObjList<StringMatchingPipe> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<StringMatchingPipe>, spec?: TouchSpec): ObjList<StringMatchingPipe> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<StringMatchingPipe>, spec?: MergeSpec): ObjList<StringMatchingPipe> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<StringMatchingPipe>, mergeInclude: string, spec?: MergeSpec): ObjList<StringMatchingPipe> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<StringMatchingPipe> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<StringMatchingPipe> | null;
   ...
   */
  static mergeAll(mergeObj: StringMatchingPipe, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: StringMatchingPipe, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<StringMatchingPipe>, spec?: UpsertSpec): ObjList<StringMatchingPipe> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<StringMatchingPipe>, spec?: UpsertSpec): ObjList<StringMatchingPipe> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): StringMatchingPipe | null;
   ...
   */
  static beforeCreate(objs: Array_Type<StringMatchingPipe>): ObjList<StringMatchingPipe>;
   ...
   */
  static beforeUpdate(objs: Array_Type<StringMatchingPipe>): ObjList<StringMatchingPipe>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<StringMatchingPipe>): ObjList<StringMatchingPipe>;
   ...
   */
  static afterCreate(objs: Array_Type<StringMatchingPipe>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<StringMatchingPipe>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<StringMatchingPipe>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<StringMatchingPipe>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<StringMatchingPipe>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): StringMatchingPipe | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<StringMatchingPipe>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: StringMatchingPipe, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<StringMatchingPipe>, callback?: λFunction<StringMatchingPipe | null, StringMatchingPipe | null>): ObjList<StringMatchingPipe>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<StringMatchingPipe>, callback?: λFunction<StringMatchingPipe | null, StringMatchingPipe | null>): Array_Type<ObjError> | null;
   ...
   */
  publish(subPath?: string, contentType?: string): StringMatchingPipe;
   ...
   */
  static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<StringMatchingPipe> | null;
   ...
   */
  createSeedData(spec?: UpsertSpec): StringMatchingPipe | null;
   ...
   */
  static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<StringMatchingPipe> | null;
   ...
   */
  updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): StringMatchingPipe | null;
   ...
   */
  static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<StringMatchingPipe> | null;
   ...
   * @return updated obj instance, same as {@link Persistable#update} return value.
   */
  clearUserUpdates(spec?: MergeSpec): StringMatchingPipe | null;
   ...
   *         {@link Persistable#updateBatch}.
   */
  static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<StringMatchingPipe> | null;
  ...
  dependencies(): SeedDataDeps<StringMatchingPipe> | null;
   ...
   * be returned as-is.
   */
  byReference(): StringMatchingPipe;
   ...
   */
  updateModelFiles(modelFiles: Map_Type<string, Url>, spec?: MlOperationSpec): StringMatchingPipe;
   ...
   */
  afterTrain(doTrainOutputs: any, spec?: MlOperationSpec): StringMatchingPipe;
   ...
   */
  withNewSpec(spec?: MlConvertSpec): StringMatchingPipe;
   ...
   */
  afterConvert(model: any, spec?: MlConvertSpec): StringMatchingPipe;
   ...
   */
  withHyperparamSpaces(paramSpaces: Map_Type<string, Hp.ParamSpace>): StringMatchingPipe;
   ...
   */
  processInWorkflow(x: Map_Type<string, Data>): Data.Persisted;
}
