// TypeScript definitions for the C3 type ImageToTextPipe

/**
 * Pipe that detects the text inside each asset (LMI, TAG, etc) of a diagram
 * and uses OCR to recognize the content of the detected texts.
 * By default, the pipe uses the EasyOCR technique: {@link https://github.com/JaidedAI/EasyOCR}.
 *
 * @remarks this represents a value passed to a method that expects an instance of ImageToTextPipe
 */
declare interface IImageToTextPipe {
  ...
  /**
   * Image zoom/magnification ratio
   */
  zoom?: number;
}
 ...
 * By default, the pipe uses the EasyOCR technique: {@link https://github.com/JaidedAI/EasyOCR}.
 *
 * @remarks this represents a made instance of ImageToTextPipe
 */
declare class ImageToTextPipe extends Obj  {
   ...
   */
  readonly id: string;
  withId(id: string): ImageToTextPipe;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ImageToTextPipe;

  /**
   * Name of this pipe.
   */
  readonly name?: string;
  withName(name: string | null): ImageToTextPipe;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): ImageToTextPipe;
  ...
  withVersion(version: number | null): ImageToTextPipe;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): ImageToTextPipe;
  ...
  withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): ImageToTextPipe;
  ...
  withHidden(hidden: boolean): ImageToTextPipe;
  ...
  withUserOwned(userOwned: boolean): ImageToTextPipe;
  ...
  withTypeIdent(typeIdent: string | null): ImageToTextPipe;

  /**
   * If true, then the pipe shall not be retrained
   */
  readonly frozen?: boolean;
  withFrozen(frozen: boolean): ImageToTextPipe;

  /**
   * True if training has succeeded and false otherwise.
   */
  readonly trained?: boolean;
  withTrained(trained: boolean): ImageToTextPipe;

  /**
   * Errors from training.
   */
  readonly trainingErrors?: string;
  withTrainingErrors(trainingErrors: string | null): ImageToTextPipe;

  /**
   * If true, the underlying model only accepts flattened input.
   */
  readonly flattenInput?: boolean;
  withFlattenInput(flattenInput: boolean): ImageToTextPipe;

  /**
   * The hyperparameters overridden of a native model or pipe.
   */
  readonly hyperparamOverrides?: Map_Type<string, any>;
  withHyperparamOverrides(hyperparamOverrides: Map_Type<string, any> | {[key: string]: any} | null): ImageToTextPipe;
  ...
  withHyperparamSearchSpace(hyperparamSearchSpace: IHp.SearchSpace | null): ImageToTextPipe;
  ...
  withHpoSpec(hpoSpec: IHpo.Spec | null): ImageToTextPipe;

  /**
   * {@link Hpo.Experiment} stores the result of hyperparameter optimization to find the best model/pipeline.
   */
  readonly hpoExperiment?: Hpo.Experiment;
  withHpoExperiment(hpoExperiment: IHpo.Experiment | null): ImageToTextPipe;

  /**
   * Reference to the experiment that produced this {@link MlPipe}. For example, this could be a {@link Hpo.ExperimentBase}.
   */
  readonly experiment?: any;
  withExperiment(experiment: any | null): ImageToTextPipe;
  ...
  withModelFiles(modelFiles: Map_Type<string, Url> | {[key: string]: IUrl} | null): ImageToTextPipe;
  ...
  withCustomModelCode(customModelCode: Map_Type<string, any> | {[key: string]: any} | null): ImageToTextPipe;

  /**
   * Name for the function on the native model to call to do {@link MlProcessable#process}.
   */
  readonly processFunc?: string;
  withProcessFunc(processFunc: string | null): ImageToTextPipe;
  ...
  withUnderlyingPipe(underlyingPipe: IMlAtomicPipe<any, any, any> | null): ImageToTextPipe;

  /**
   * The name of the column containing the urls of the images to be processed.
   */
  readonly imageColumnName: string;
  withImageColumnName(imageColumnName: string): ImageToTextPipe;

  /**
   * Image zoom/magnification ratio
   */
  readonly zoom?: number;
  withZoom(zoom: number | null): ImageToTextPipe;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ImageToTextPipe | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ImageToTextPipe | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ImageToTextPipe | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ImageToTextPipe | null;
   ...
   */
  replaceType(old: Type, new_: Type): ImageToTextPipe;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ImageToTextPipe;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ImageToTextPipe;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ImageToTextPipe>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ImageToTextPipe>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ImageToTextPipe;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ImageToTextPipe;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ImageToTextPipe;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ImageToTextPipe;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ImageToTextPipe;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ImageToTextPipe;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ImageToTextPipe;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ImageToTextPipe;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ImageToTextPipe;
   ...
   * @see #removeField
   */
  withoutField(field: string): ImageToTextPipe;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ImageToTextPipe;
   ...
   */
  withoutFields(fields: Array_Type<string>): ImageToTextPipe;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ImageToTextPipe;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ImageToTextPipe;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ImageToTextPipe;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ImageToTextPipe;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ImageToTextPipe;
   ...
   * @see #removeField
   */
  unsetField(field: string): ImageToTextPipe;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ImageToTextPipe;
   ...
   * @see #unsetField
   */
  removeField(field: string): ImageToTextPipe;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ImageToTextPipe;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ImageToTextPipe;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ImageToTextPipe;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ImageToTextPipe;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ImageToTextPipe;

  mergeJson(json: any): ImageToTextPipe;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ImageToTextPipe;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ImageToTextPipe;
   ...
   */
  singletonArray(): Array_Type<ImageToTextPipe>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ImageToTextPipe> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ImageToTextPipe> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ImageToTextPipe>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ImageToTextPipe> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ImageToTextPipe> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ImageToTextPipe> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ImageToTextPipe>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ImageToTextPipe>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ImageToTextPipe;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ImageToTextPipe;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ImageToTextPipe;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ImageToTextPipe;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ImageToTextPipe;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ImageToTextPipe;
   ...
   * @see #fromString
   */
  static make(s: string): ImageToTextPipe | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ImageToTextPipe;
   ...
   */
  static cachedEmptyInst(): ImageToTextPipe;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ImageToTextPipe> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ImageToTextPipe;
   ...
   */
  remakeTemplate(): ImageToTextPipe;
   ...
   */
  withoutIdentity(): ImageToTextPipe;
   ...
   */
  trainSync(x: Data, y?: , spec?: MlOperationSpec): ImageToTextPipe;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<ImageToTextPipe> | null;
   ...
   */
  static find(filter?: string, doNotProduceAll?: boolean): Stream<ImageToTextPipe> | null;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<ImageToTextPipe> | null;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): ImageToTextPipe | null;
   ...
   * @see findByCacheKey
   */
  static forCacheKey(key: string): ImageToTextPipe | null;
   ...
   * @see findByCacheKey
   */
  getCached(): ImageToTextPipe | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): ImageToTextPipe | null;
   ...
   */
  static produce(key: string): ImageToTextPipe | null;
   ...
   */
  static produceAll(): Map_Type<string, ImageToTextPipe> | null;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): Map_Type<string, ImageToTextPipe> | null;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<ImageToTextPipe>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ImageToTextPipe>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<ImageToTextPipe> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ImageToTextPipe>> | null;
   ...
   */
  get(include?: string): ImageToTextPipe | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): ImageToTextPipe | null;
   ...
   */
  getMissing(spec: GetMissingSpec): ImageToTextPipe;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): ImageToTextPipe | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): ImageToTextPipe;
   ...
   * @see #toString
   */
  static fromString(s: string): ImageToTextPipe | null;
   ...
   */
  create(spec?: UpsertSpec): ImageToTextPipe | null;
   ...
   */
  static createBatch(objs: Array_Type<ImageToTextPipe>, spec?: UpsertSpec): ObjList<ImageToTextPipe> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ImageToTextPipe>, spec?: CreateBatchObjStreamSpec): ObjList<ImageToTextPipe> | null;
   ...
   */
  update(srcObj?: ImageToTextPipe, spec?: UpsertSpec): ImageToTextPipe | null;
   ...
   */
  upsert(srcObj?: ImageToTextPipe, spec?: UpsertSpec): ImageToTextPipe | null;
   ...
   */
  merge(spec?: MergeSpec): ImageToTextPipe | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): ImageToTextPipe | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): ImageToTextPipe | null;
   ...
   */
  static updateBatch(objs: Array_Type<ImageToTextPipe>, srcObjs?: Array_Type<ImageToTextPipe>, spec?: UpsertSpec): ObjList<ImageToTextPipe> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<ImageToTextPipe> | null>, spec?: UpsertSpec): ObjList<ImageToTextPipe> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<ImageToTextPipe>, srcObjs?: Array_Type<ImageToTextPipe>, spec?: UpsertSpec): ObjList<ImageToTextPipe> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<ImageToTextPipe> | null>, spec?: UpsertSpec): ObjList<ImageToTextPipe> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<ImageToTextPipe>, spec?: TouchSpec): ObjList<ImageToTextPipe> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ImageToTextPipe>, spec?: MergeSpec): ObjList<ImageToTextPipe> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ImageToTextPipe>, mergeInclude: string, spec?: MergeSpec): ObjList<ImageToTextPipe> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<ImageToTextPipe> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ImageToTextPipe> | null;
   ...
   */
  static mergeAll(mergeObj: ImageToTextPipe, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ImageToTextPipe, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<ImageToTextPipe>, spec?: UpsertSpec): ObjList<ImageToTextPipe> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<ImageToTextPipe>, spec?: UpsertSpec): ObjList<ImageToTextPipe> | null;
   ...
   */
  static beforeCreate(objs: Array_Type<ImageToTextPipe>): ObjList<ImageToTextPipe>;
   ...
   */
  static beforeUpdate(objs: Array_Type<ImageToTextPipe>): ObjList<ImageToTextPipe>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<ImageToTextPipe>): ObjList<ImageToTextPipe>;
   ...
   */
  static afterCreate(objs: Array_Type<ImageToTextPipe>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<ImageToTextPipe>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<ImageToTextPipe>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<ImageToTextPipe>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ImageToTextPipe>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): ImageToTextPipe | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<ImageToTextPipe>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: ImageToTextPipe, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<ImageToTextPipe>, callback?: λFunction<ImageToTextPipe | null, ImageToTextPipe | null>): ObjList<ImageToTextPipe>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<ImageToTextPipe>, callback?: λFunction<ImageToTextPipe | null, ImageToTextPipe | null>): Array_Type<ObjError> | null;
   ...
   */
  publish(subPath?: string, contentType?: string): ImageToTextPipe;
   ...
   */
  static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ImageToTextPipe> | null;
   ...
   */
  createSeedData(spec?: UpsertSpec): ImageToTextPipe | null;
   ...
   */
  static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ImageToTextPipe> | null;
   ...
   */
  updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): ImageToTextPipe | null;
   ...
   */
  static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ImageToTextPipe> | null;
   ...
   * @return updated obj instance, same as {@link Persistable#update} return value.
   */
  clearUserUpdates(spec?: MergeSpec): ImageToTextPipe | null;
   ...
   *         {@link Persistable#updateBatch}.
   */
  static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<ImageToTextPipe> | null;
  ...
  dependencies(): SeedDataDeps<ImageToTextPipe> | null;
   ...
   */
  updateModelFiles(modelFiles: Map_Type<string, Url>, spec?: MlOperationSpec): ImageToTextPipe;
   ...
   */
  afterTrain(doTrainOutputs: any, spec?: MlOperationSpec): ImageToTextPipe;
   ...
   */
  withNewSpec(spec?: MlConvertSpec): ImageToTextPipe;
   ...
   */
  afterConvert(model: any, spec?: MlConvertSpec): ImageToTextPipe;
   ...
   */
  withHyperparamSpaces(paramSpaces: Map_Type<string, Hp.ParamSpace>): ImageToTextPipe;
