// TypeScript definitions for the C3 type PdfToImagePipe

/**
 * This type represents an abstract {@link MlPipe} template for converting pdfs to images.
 *
 * @remarks this represents a value passed to a method that expects an instance of PdfToImagePipe
 */
declare interface IPdfToImagePipe {
  ...
  /**
   * Format that extracted images should be saved in. The full list of supported formats can be
   * found [here](https://pillow.readthedocs.io/en/latest/handbook/image-file-formats.html).
   */
  format?: string;

  /**
   * The number of pixels per inch in the generated images. A higher value will increase the image resolution, but will
   * also increase the output image size. Normally, 300dpi is needed for a sharp image.
   */
  dpi?: number;

  /**
   * Whether to resize images to target dimensions.
   * If false (default), images keep their original dimensions from PDF rendering.
   */
  resizeImages?: boolean;

  /**
   * Target height to resize images to (when resizeImages=true).
   * Defaults to config value if not specified.
   */
  imageHeight?: number;

  /**
   * Target width to resize images to (when resizeImages=true).
   * Defaults to config value if not specified.
   */
  imageWidth?: number;

  /**
   * Whether to maintain aspect ratio when resizing (when resizeImages=true).
   * If false (default), images are stretched to exact dimensions.
   */
 ...
 * This type represents an abstract {@link MlPipe} template for converting pdfs to images.
 *
 * @remarks this represents a made instance of PdfToImagePipe
 */
declare class PdfToImagePipe extends Obj  {
   ...
   */
  readonly id: string;
  withId(id: string): PdfToImagePipe;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): PdfToImagePipe;

  /**
   * Name of this pipe.
   */
  readonly name?: string;
  withName(name: string | null): PdfToImagePipe;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): PdfToImagePipe;
  ...
  withVersion(version: number | null): PdfToImagePipe;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): PdfToImagePipe;
  ...
  withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): PdfToImagePipe;
  ...
  withHidden(hidden: boolean): PdfToImagePipe;
  ...
  withUserOwned(userOwned: boolean): PdfToImagePipe;
  ...
  withTypeIdent(typeIdent: string | null): PdfToImagePipe;

  /**
   * If true, then the pipe shall not be retrained
   */
  readonly frozen?: boolean;
  withFrozen(frozen: boolean): PdfToImagePipe;

  /**
   * True if training has succeeded and false otherwise.
   */
  readonly trained?: boolean;
  withTrained(trained: boolean): PdfToImagePipe;

  /**
   * Errors from training.
   */
  readonly trainingErrors?: string;
  withTrainingErrors(trainingErrors: string | null): PdfToImagePipe;

  /**
   * If true, the underlying model only accepts flattened input.
   */
  readonly flattenInput?: boolean;
  withFlattenInput(flattenInput: boolean): PdfToImagePipe;

  /**
   * The hyperparameters overridden of a native model or pipe.
   */
  readonly hyperparamOverrides?: Map_Type<string, any>;
  withHyperparamOverrides(hyperparamOverrides: Map_Type<string, any> | {[key: string]: any} | null): PdfToImagePipe;
  ...
  withHyperparamSearchSpace(hyperparamSearchSpace: IHp.SearchSpace | null): PdfToImagePipe;
  ...
  withHpoSpec(hpoSpec: IHpo.Spec | null): PdfToImagePipe;

  /**
   * {@link Hpo.Experiment} stores the result of hyperparameter optimization to find the best model/pipeline.
   */
  readonly hpoExperiment?: Hpo.Experiment;
  withHpoExperiment(hpoExperiment: IHpo.Experiment | null): PdfToImagePipe;

  /**
   * Reference to the experiment that produced this {@link MlPipe}. For example, this could be a {@link Hpo.ExperimentBase}.
   */
  readonly experiment?: any;
  withExperiment(experiment: any | null): PdfToImagePipe;
  ...
  withModelFiles(modelFiles: Map_Type<string, Url> | {[key: string]: IUrl} | null): PdfToImagePipe;
  ...
  withCustomModelCode(customModelCode: Map_Type<string, any> | {[key: string]: any} | null): PdfToImagePipe;

  /**
   * Name for the function on the native model to call to do {@link MlProcessable#process}.
   */
  readonly processFunc?: string;
  withProcessFunc(processFunc: string | null): PdfToImagePipe;
  ...
  withUnderlyingPipe(underlyingPipe: IMlAtomicPipe<any, any, any> | null): PdfToImagePipe;

  /**
   * The name of the column containing the urls of the files to convert.
   */
  readonly columnName: string;
  withColumnName(columnName: string): PdfToImagePipe;
  ...
  withFormat(format: string | null): PdfToImagePipe;
   ...
   */
  readonly dpi?: number;
  withDpi(dpi: number | null): PdfToImagePipe;
  ...
  withResizeImages(resizeImages: boolean): PdfToImagePipe;
  ...
  withImageHeight(imageHeight: number | null): PdfToImagePipe;
  ...
  withImageWidth(imageWidth: number | null): PdfToImagePipe;
  ...
  withMaintainAspectRatio(maintainAspectRatio: boolean): PdfToImagePipe;
   ...
   * @see #toJson
   */
  static fromJson(json: any): PdfToImagePipe | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): PdfToImagePipe | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): PdfToImagePipe | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): PdfToImagePipe | null;
   ...
   */
  replaceType(old: Type, new_: Type): PdfToImagePipe;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): PdfToImagePipe;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): PdfToImagePipe;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<PdfToImagePipe>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<PdfToImagePipe>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): PdfToImagePipe;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): PdfToImagePipe;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): PdfToImagePipe;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): PdfToImagePipe;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): PdfToImagePipe;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): PdfToImagePipe;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): PdfToImagePipe;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): PdfToImagePipe;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): PdfToImagePipe;
   ...
   * @see #removeField
   */
  withoutField(field: string): PdfToImagePipe;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): PdfToImagePipe;
   ...
   */
  withoutFields(fields: Array_Type<string>): PdfToImagePipe;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): PdfToImagePipe;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): PdfToImagePipe;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): PdfToImagePipe;
   ...
   * @see #unsetField
   */
  defaultField(field: string): PdfToImagePipe;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): PdfToImagePipe;
   ...
   * @see #removeField
   */
  unsetField(field: string): PdfToImagePipe;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): PdfToImagePipe;
   ...
   * @see #unsetField
   */
  removeField(field: string): PdfToImagePipe;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): PdfToImagePipe;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): PdfToImagePipe;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): PdfToImagePipe;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): PdfToImagePipe;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): PdfToImagePipe;

  mergeJson(json: any): PdfToImagePipe;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): PdfToImagePipe;
   ...
   */
  sumObj(other: Obj, deep?: boolean): PdfToImagePipe;
   ...
   */
  singletonArray(): Array_Type<PdfToImagePipe>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<PdfToImagePipe> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<PdfToImagePipe> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<PdfToImagePipe>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<PdfToImagePipe> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, PdfToImagePipe> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, PdfToImagePipe> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<PdfToImagePipe>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<PdfToImagePipe>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): PdfToImagePipe;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): PdfToImagePipe;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): PdfToImagePipe;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): PdfToImagePipe;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): PdfToImagePipe;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): PdfToImagePipe;
   ...
   * @see #fromString
   */
  static make(s: string): PdfToImagePipe | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): PdfToImagePipe;
   ...
   */
  static cachedEmptyInst(): PdfToImagePipe;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<PdfToImagePipe> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): PdfToImagePipe;
   ...
   */
  withoutIdentity(): PdfToImagePipe;
   ...
   */
  trainSync(x: Data, y?: , spec?: MlOperationSpec): PdfToImagePipe;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<PdfToImagePipe> | null;
   ...
   */
  static find(filter?: string, doNotProduceAll?: boolean): Stream<PdfToImagePipe> | null;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<PdfToImagePipe> | null;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): PdfToImagePipe | null;
   ...
   * @see findByCacheKey
   */
  static forCacheKey(key: string): PdfToImagePipe | null;
   ...
   * @see findByCacheKey
   */
  getCached(): PdfToImagePipe | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): PdfToImagePipe | null;
   ...
   */
  static produce(key: string): PdfToImagePipe | null;
   ...
   */
  static produceAll(): Map_Type<string, PdfToImagePipe> | null;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): Map_Type<string, PdfToImagePipe> | null;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<PdfToImagePipe>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<PdfToImagePipe>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<PdfToImagePipe> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<PdfToImagePipe>> | null;
   ...
   */
  get(include?: string): PdfToImagePipe | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): PdfToImagePipe | null;
   ...
   */
  getMissing(spec: GetMissingSpec): PdfToImagePipe;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): PdfToImagePipe | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): PdfToImagePipe;
   ...
   * @see #toString
   */
  static fromString(s: string): PdfToImagePipe | null;
   ...
   */
  create(spec?: UpsertSpec): PdfToImagePipe | null;
   ...
   */
  static createBatch(objs: Array_Type<PdfToImagePipe>, spec?: UpsertSpec): ObjList<PdfToImagePipe> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<PdfToImagePipe>, spec?: CreateBatchObjStreamSpec): ObjList<PdfToImagePipe> | null;
   ...
   */
  update(srcObj?: PdfToImagePipe, spec?: UpsertSpec): PdfToImagePipe | null;
   ...
   */
  upsert(srcObj?: PdfToImagePipe, spec?: UpsertSpec): PdfToImagePipe | null;
   ...
   */
  merge(spec?: MergeSpec): PdfToImagePipe | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): PdfToImagePipe | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): PdfToImagePipe | null;
   ...
   */
  static updateBatch(objs: Array_Type<PdfToImagePipe>, srcObjs?: Array_Type<PdfToImagePipe>, spec?: UpsertSpec): ObjList<PdfToImagePipe> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<PdfToImagePipe> | null>, spec?: UpsertSpec): ObjList<PdfToImagePipe> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<PdfToImagePipe>, srcObjs?: Array_Type<PdfToImagePipe>, spec?: UpsertSpec): ObjList<PdfToImagePipe> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<PdfToImagePipe> | null>, spec?: UpsertSpec): ObjList<PdfToImagePipe> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<PdfToImagePipe>, spec?: TouchSpec): ObjList<PdfToImagePipe> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<PdfToImagePipe>, spec?: MergeSpec): ObjList<PdfToImagePipe> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<PdfToImagePipe>, mergeInclude: string, spec?: MergeSpec): ObjList<PdfToImagePipe> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<PdfToImagePipe> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<PdfToImagePipe> | null;
   ...
   */
  static mergeAll(mergeObj: PdfToImagePipe, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: PdfToImagePipe, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<PdfToImagePipe>, spec?: UpsertSpec): ObjList<PdfToImagePipe> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<PdfToImagePipe>, spec?: UpsertSpec): ObjList<PdfToImagePipe> | null;
   ...
   */
  static beforeCreate(objs: Array_Type<PdfToImagePipe>): ObjList<PdfToImagePipe>;
   ...
   */
  static beforeUpdate(objs: Array_Type<PdfToImagePipe>): ObjList<PdfToImagePipe>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<PdfToImagePipe>): ObjList<PdfToImagePipe>;
   ...
   */
  static afterCreate(objs: Array_Type<PdfToImagePipe>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<PdfToImagePipe>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<PdfToImagePipe>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<PdfToImagePipe>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<PdfToImagePipe>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): PdfToImagePipe | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<PdfToImagePipe>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: PdfToImagePipe, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<PdfToImagePipe>, callback?: λFunction<PdfToImagePipe | null, PdfToImagePipe | null>): ObjList<PdfToImagePipe>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<PdfToImagePipe>, callback?: λFunction<PdfToImagePipe | null, PdfToImagePipe | null>): Array_Type<ObjError> | null;
   ...
   */
  publish(subPath?: string, contentType?: string): PdfToImagePipe;
   ...
   */
  static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<PdfToImagePipe> | null;
   ...
   */
  createSeedData(spec?: UpsertSpec): PdfToImagePipe | null;
   ...
   */
  static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<PdfToImagePipe> | null;
   ...
   */
  updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): PdfToImagePipe | null;
   ...
   */
  static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<PdfToImagePipe> | null;
   ...
   * @return updated obj instance, same as {@link Persistable#update} return value.
   */
  clearUserUpdates(spec?: MergeSpec): PdfToImagePipe | null;
   ...
   *         {@link Persistable#updateBatch}.
   */
  static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<PdfToImagePipe> | null;
  ...
  dependencies(): SeedDataDeps<PdfToImagePipe> | null;
   ...
   */
  updateModelFiles(modelFiles: Map_Type<string, Url>, spec?: MlOperationSpec): PdfToImagePipe;
   ...
   */
  afterTrain(doTrainOutputs: any, spec?: MlOperationSpec): PdfToImagePipe;
   ...
   */
  withNewSpec(spec?: MlConvertSpec): PdfToImagePipe;
   ...
   */
  afterConvert(model: any, spec?: MlConvertSpec): PdfToImagePipe;
   ...
   */
  withHyperparamSpaces(paramSpaces: Map_Type<string, Hp.ParamSpace>): PdfToImagePipe;
  ...
  /**
   * A version of {@link #doProcess} that takes a native input and returns a native output.
   * This is used to avoid creating {@link Data.Persisted}.
   */
  doProcessNative(input?: any): any | null;
}
