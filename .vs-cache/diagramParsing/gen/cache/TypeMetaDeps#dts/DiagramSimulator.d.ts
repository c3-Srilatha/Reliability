// TypeScript definitions for the C3 type DiagramSimulator

/**
 * Augmenter that can simulate a labeled image based on the original diagram.
 *
 * @remarks this represents a value passed to a method that expects an instance of DiagramSimulator
 */
declare interface IDiagramSimulator {
  ...
  /**
   * The target classes the augmenter will be using. If nothing is provided here,
   * all the available classes in a labeled diagram will be used.
   */
  targets?: Array_Type<string> | Array<string>;

  /**
   * Output shape of the augmented image
   */
  outputShape: Array_Type<number> | Array<number>;

  /**
   * Maximum number of elements appears on the simulated diagram image.
   */
  numElements: number;

  /**
   * Random scale range that each element is augmented by.
   * If not provided, use scale=1 by default.
   */
  scaleRange?: Array_Type<number> | Array<number>;

  /**
   * Whether to use white background when generating simualtion images.
   */
  useWhiteBackground?: boolean;

  /**
   * The corresponding frequency for each target when doing simulation.
   * If nothing is provided, use the existing frequency of symbols on the raw diagram.
   */
  frequency?: Map_Type<string, number> | {[key: string]: number};
}

/**
 * Augmenter that can simulate a labeled image based on the original diagram.
 *
 * @remarks this represents a made instance of DiagramSimulator
 */
declare class DiagramSimulator extends Obj  {
  ...
  withTypeIdent(typeIdent: string | null): DiagramSimulator;
   ...
   */
  readonly id: string;
  withId(id: string): DiagramSimulator;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): DiagramSimulator;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): DiagramSimulator;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): DiagramSimulator;
  ...
  withVersion(version: number | null): DiagramSimulator;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): DiagramSimulator;
  ...
  withTargets(targets: Array_Type<string> | Array<string> | null): DiagramSimulator;

  /**
   * Output shape of the augmented image
   */
  readonly outputShape: Array_Type<number>;
  withOutputShape(outputShape: Array_Type<number> | Array<number>): DiagramSimulator;

  /**
   * Maximum number of elements appears on the simulated diagram image.
   */
  readonly numElements: number;
  withNumElements(numElements: number): DiagramSimulator;

  /**
   * Random scale range that each element is augmented by.
   * If not provided, use scale=1 by default.
   */
  readonly scaleRange?: Array_Type<number>;
  withScaleRange(scaleRange: Array_Type<number> | Array<number> | null): DiagramSimulator;

  /**
   * Whether to use white background when generating simualtion images.
   */
  readonly useWhiteBackground?: boolean;
  withUseWhiteBackground(useWhiteBackground: boolean): DiagramSimulator;

  /**
   * The corresponding frequency for each target when doing simulation.
   * If nothing is provided, use the existing frequency of symbols on the raw diagram.
   */
  readonly frequency?: Map_Type<string, number>;
  withFrequency(frequency: Map_Type<string, number> | {[key: string]: number} | null): DiagramSimulator;
   ...
   * @see #toJson
   */
  static fromJson(json: any): DiagramSimulator | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): DiagramSimulator | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): DiagramSimulator | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): DiagramSimulator | null;
   ...
   */
  replaceType(old: Type, new_: Type): DiagramSimulator;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): DiagramSimulator;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): DiagramSimulator;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<DiagramSimulator>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<DiagramSimulator>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): DiagramSimulator;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DiagramSimulator;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DiagramSimulator;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): DiagramSimulator;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): DiagramSimulator;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): DiagramSimulator;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): DiagramSimulator;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): DiagramSimulator;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): DiagramSimulator;
   ...
   * @see #removeField
   */
  withoutField(field: string): DiagramSimulator;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): DiagramSimulator;
   ...
   */
  withoutFields(fields: Array_Type<string>): DiagramSimulator;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): DiagramSimulator;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): DiagramSimulator;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): DiagramSimulator;
   ...
   * @see #unsetField
   */
  defaultField(field: string): DiagramSimulator;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): DiagramSimulator;
   ...
   * @see #removeField
   */
  unsetField(field: string): DiagramSimulator;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): DiagramSimulator;
   ...
   * @see #unsetField
   */
  removeField(field: string): DiagramSimulator;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): DiagramSimulator;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): DiagramSimulator;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): DiagramSimulator;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): DiagramSimulator;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): DiagramSimulator;

  mergeJson(json: any): DiagramSimulator;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): DiagramSimulator;
   ...
   */
  sumObj(other: Obj, deep?: boolean): DiagramSimulator;
   ...
   */
  singletonArray(): Array_Type<DiagramSimulator>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<DiagramSimulator> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<DiagramSimulator> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<DiagramSimulator>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<DiagramSimulator> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, DiagramSimulator> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, DiagramSimulator> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<DiagramSimulator>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<DiagramSimulator>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): DiagramSimulator;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): DiagramSimulator;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): DiagramSimulator;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): DiagramSimulator;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): DiagramSimulator;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): DiagramSimulator;
   ...
   * @see #fromString
   */
  static make(s: string): DiagramSimulator | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): DiagramSimulator;
   ...
   */
  static cachedEmptyInst(): DiagramSimulator;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<DiagramSimulator> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): DiagramSimulator;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<DiagramSimulator>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<DiagramSimulator>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<DiagramSimulator> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<DiagramSimulator>> | null;
   ...
   */
  get(include?: string): DiagramSimulator | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): DiagramSimulator | null;
   ...
   */
  getMissing(spec: GetMissingSpec): DiagramSimulator;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): DiagramSimulator | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): DiagramSimulator;
   ...
   * @see #toString
   */
  static fromString(s: string): DiagramSimulator | null;
   ...
   */
  create(spec?: UpsertSpec): DiagramSimulator | null;
   ...
   */
  static createBatch(objs: Array_Type<DiagramSimulator>, spec?: UpsertSpec): ObjList<DiagramSimulator> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<DiagramSimulator>, spec?: CreateBatchObjStreamSpec): ObjList<DiagramSimulator> | null;
   ...
   */
  update(srcObj?: DiagramSimulator, spec?: UpsertSpec): DiagramSimulator | null;
   ...
   */
  upsert(srcObj?: DiagramSimulator, spec?: UpsertSpec): DiagramSimulator | null;
   ...
   */
  merge(spec?: MergeSpec): DiagramSimulator | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): DiagramSimulator | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): DiagramSimulator | null;
   ...
   */
  static updateBatch(objs: Array_Type<DiagramSimulator>, srcObjs?: Array_Type<DiagramSimulator>, spec?: UpsertSpec): ObjList<DiagramSimulator> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<DiagramSimulator> | null>, spec?: UpsertSpec): ObjList<DiagramSimulator> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<DiagramSimulator>, srcObjs?: Array_Type<DiagramSimulator>, spec?: UpsertSpec): ObjList<DiagramSimulator> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<DiagramSimulator> | null>, spec?: UpsertSpec): ObjList<DiagramSimulator> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<DiagramSimulator>, spec?: TouchSpec): ObjList<DiagramSimulator> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<DiagramSimulator>, spec?: MergeSpec): ObjList<DiagramSimulator> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<DiagramSimulator>, mergeInclude: string, spec?: MergeSpec): ObjList<DiagramSimulator> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<DiagramSimulator> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<DiagramSimulator> | null;
   ...
   */
  static mergeAll(mergeObj: DiagramSimulator, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: DiagramSimulator, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<DiagramSimulator>, spec?: UpsertSpec): ObjList<DiagramSimulator> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<DiagramSimulator>, spec?: UpsertSpec): ObjList<DiagramSimulator> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): DiagramSimulator | null;
   ...
   */
  static beforeCreate(objs: Array_Type<DiagramSimulator>): ObjList<DiagramSimulator>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<DiagramSimulator>): ObjList<DiagramSimulator>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<DiagramSimulator>): ObjList<DiagramSimulator>;
   ...
   */
  static afterCreate(objs: Array_Type<DiagramSimulator>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<DiagramSimulator>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<DiagramSimulator>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<DiagramSimulator>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<DiagramSimulator>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): DiagramSimulator | null;
   ...
   */
  withoutIdentity(): DiagramSimulator | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<DiagramSimulator>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: DiagramSimulator, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<DiagramSimulator>, callback?: λFunction<DiagramSimulator | null, DiagramSimulator | null>): ObjList<DiagramSimulator>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<DiagramSimulator>, callback?: λFunction<DiagramSimulator | null, DiagramSimulator | null>): Array_Type<ObjError> | null;
  ...
  /**
   * Generate a single labeled image using parameters that can be changed in
   * runtime instead of just construction time.
   */
  generate(diagram: LabeledDiagram): LabeledImage;
}
