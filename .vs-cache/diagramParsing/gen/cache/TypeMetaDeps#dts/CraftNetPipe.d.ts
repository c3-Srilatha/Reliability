// TypeScript definitions for the C3 type CraftNetPipe

/**
 * Pipe that detects texts using the CRAFT (Character-Region Awareness For Text detection) technique.
 * See {@link https://github.com/clovaai/CRAFT-pytorch} and {@link https://arxiv.org/pdf/1904.01941.pdf}
 * for more information on CRAFT.
 *
 * @remarks this represents a value passed to a method that expects an instance of CraftNetPipe
 */
declare interface ICraftNetPipe {
  ...
  /**
   * File for saving the pytorch pth file of the main text detection net.
   */
  mainNetPth: IFile;

  /**
   * File for saving the pytorch pth file of the text detection refining net.
   */
  refineNetPth: IFile;
}
 ...
 * for more information on CRAFT.
 *
 * @remarks this represents a made instance of CraftNetPipe
 */
declare class CraftNetPipe extends Obj  {
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): CraftNetPipe;

  /**
   * Name of this pipe.
   */
  readonly name?: string;
  withName(name: string | null): CraftNetPipe;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): CraftNetPipe;
  ...
  withVersion(version: number | null): CraftNetPipe;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): CraftNetPipe;
  ...
  withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): CraftNetPipe;
  ...
  withHidden(hidden: boolean): CraftNetPipe;
  ...
  withUserOwned(userOwned: boolean): CraftNetPipe;
  ...
  withTypeIdent(typeIdent: string | null): CraftNetPipe;

  /**
   * If true, then the pipe shall not be retrained
   */
  readonly frozen?: boolean;
  withFrozen(frozen: boolean): CraftNetPipe;

  /**
   * True if training has succeeded and false otherwise.
   */
  readonly trained?: boolean;
  withTrained(trained: boolean): CraftNetPipe;

  /**
   * Errors from training.
   */
  readonly trainingErrors?: string;
  withTrainingErrors(trainingErrors: string | null): CraftNetPipe;

  /**
   * If true, the underlying model only accepts flattened input.
   */
  readonly flattenInput?: boolean;
  withFlattenInput(flattenInput: boolean): CraftNetPipe;

  /**
   * The hyperparameters overridden of a native model or pipe.
   */
  readonly hyperparamOverrides?: Map_Type<string, any>;
  withHyperparamOverrides(hyperparamOverrides: Map_Type<string, any> | {[key: string]: any} | null): CraftNetPipe;
  ...
  withHyperparamSearchSpace(hyperparamSearchSpace: IHp.SearchSpace | null): CraftNetPipe;
  ...
  withHpoSpec(hpoSpec: IHpo.Spec | null): CraftNetPipe;

  /**
   * {@link Hpo.Experiment} stores the result of hyperparameter optimization to find the best model/pipeline.
   */
  readonly hpoExperiment?: Hpo.Experiment;
  withHpoExperiment(hpoExperiment: IHpo.Experiment | null): CraftNetPipe;

  /**
   * Reference to the experiment that produced this {@link MlPipe}. For example, this could be a {@link Hpo.ExperimentBase}.
   */
  readonly experiment?: any;
  withExperiment(experiment: any | null): CraftNetPipe;
  ...
  withModelFiles(modelFiles: Map_Type<string, Url> | {[key: string]: IUrl} | null): CraftNetPipe;
  ...
  withCustomModelCode(customModelCode: Map_Type<string, any> | {[key: string]: any} | null): CraftNetPipe;

  /**
   * Name for the function on the native model to call to do {@link MlProcessable#process}.
   */
  readonly processFunc?: string;
  withProcessFunc(processFunc: string | null): CraftNetPipe;
  ...
  withUnderlyingPipe(underlyingPipe: IMlAtomicPipe<any, any, any> | null): CraftNetPipe;

  /**
   * The name of the column containing the urls of the images to be processed.
   */
  readonly imageColumnName: string;
  withImageColumnName(imageColumnName: string): CraftNetPipe;

  /**
   * Image zoom/magnification ratio
   */
  readonly zoom?: number;
  withZoom(zoom: number | null): CraftNetPipe;

  /**
   * File for saving the pytorch pth file of the main text detection net.
   */
  readonly mainNetPth: File;
  withMainNetPth(mainNetPth: IFile): CraftNetPipe;

  /**
   * File for saving the pytorch pth file of the text detection refining net.
   */
  readonly refineNetPth: File;
  withRefineNetPth(refineNetPth: IFile): CraftNetPipe;
   ...
   * @see #toJson
   */
  static fromJson(json: any): CraftNetPipe | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): CraftNetPipe | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): CraftNetPipe | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): CraftNetPipe | null;
   ...
   */
  replaceType(old: Type, new_: Type): CraftNetPipe;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): CraftNetPipe;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): CraftNetPipe;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<CraftNetPipe>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<CraftNetPipe>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): CraftNetPipe;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): CraftNetPipe;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): CraftNetPipe;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): CraftNetPipe;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): CraftNetPipe;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): CraftNetPipe;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): CraftNetPipe;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): CraftNetPipe;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): CraftNetPipe;
   ...
   * @see #removeField
   */
  withoutField(field: string): CraftNetPipe;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): CraftNetPipe;
   ...
   */
  withoutFields(fields: Array_Type<string>): CraftNetPipe;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): CraftNetPipe;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): CraftNetPipe;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): CraftNetPipe;
   ...
   * @see #unsetField
   */
  defaultField(field: string): CraftNetPipe;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): CraftNetPipe;
   ...
   * @see #removeField
   */
  unsetField(field: string): CraftNetPipe;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): CraftNetPipe;
   ...
   * @see #unsetField
   */
  removeField(field: string): CraftNetPipe;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): CraftNetPipe;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): CraftNetPipe;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): CraftNetPipe;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): CraftNetPipe;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): CraftNetPipe;

  mergeJson(json: any): CraftNetPipe;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): CraftNetPipe;
   ...
   */
  sumObj(other: Obj, deep?: boolean): CraftNetPipe;
   ...
   */
  singletonArray(): Array_Type<CraftNetPipe>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<CraftNetPipe> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<CraftNetPipe> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<CraftNetPipe>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<CraftNetPipe> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, CraftNetPipe> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, CraftNetPipe> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<CraftNetPipe>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<CraftNetPipe>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): CraftNetPipe;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): CraftNetPipe;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): CraftNetPipe;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): CraftNetPipe;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): CraftNetPipe;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): CraftNetPipe;
   ...
   * @see #fromString
   */
  static make(s: string): CraftNetPipe | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): CraftNetPipe;
   ...
   */
  static cachedEmptyInst(): CraftNetPipe;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<CraftNetPipe> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): CraftNetPipe;
   ...
   */
  trainSync(x: Data, y?: , spec?: MlOperationSpec): CraftNetPipe;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<CraftNetPipe> | null;
   ...
   */
  static find(filter?: string, doNotProduceAll?: boolean): Stream<CraftNetPipe> | null;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<CraftNetPipe> | null;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): CraftNetPipe | null;
   ...
   * @see findByCacheKey
   */
  static forCacheKey(key: string): CraftNetPipe | null;
   ...
   * @see findByCacheKey
   */
  getCached(): CraftNetPipe | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): CraftNetPipe | null;
   ...
   */
  static produce(key: string): CraftNetPipe | null;
   ...
   */
  static produceAll(): Map_Type<string, CraftNetPipe> | null;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): Map_Type<string, CraftNetPipe> | null;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<CraftNetPipe>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<CraftNetPipe>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<CraftNetPipe> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<CraftNetPipe>> | null;
   ...
   */
  get(include?: string): CraftNetPipe | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): CraftNetPipe | null;
   ...
   */
  getMissing(spec: GetMissingSpec): CraftNetPipe;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): CraftNetPipe | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): CraftNetPipe;
   ...
   * @see #toString
   */
  static fromString(s: string): CraftNetPipe | null;
   ...
   */
  create(spec?: UpsertSpec): CraftNetPipe | null;
   ...
   */
  static createBatch(objs: Array_Type<CraftNetPipe>, spec?: UpsertSpec): ObjList<CraftNetPipe> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<CraftNetPipe>, spec?: CreateBatchObjStreamSpec): ObjList<CraftNetPipe> | null;
   ...
   */
  update(srcObj?: CraftNetPipe, spec?: UpsertSpec): CraftNetPipe | null;
   ...
   */
  upsert(srcObj?: CraftNetPipe, spec?: UpsertSpec): CraftNetPipe | null;
   ...
   */
  merge(spec?: MergeSpec): CraftNetPipe | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): CraftNetPipe | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): CraftNetPipe | null;
   ...
   */
  static updateBatch(objs: Array_Type<CraftNetPipe>, srcObjs?: Array_Type<CraftNetPipe>, spec?: UpsertSpec): ObjList<CraftNetPipe> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<CraftNetPipe> | null>, spec?: UpsertSpec): ObjList<CraftNetPipe> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<CraftNetPipe>, srcObjs?: Array_Type<CraftNetPipe>, spec?: UpsertSpec): ObjList<CraftNetPipe> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<CraftNetPipe> | null>, spec?: UpsertSpec): ObjList<CraftNetPipe> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<CraftNetPipe>, spec?: TouchSpec): ObjList<CraftNetPipe> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<CraftNetPipe>, spec?: MergeSpec): ObjList<CraftNetPipe> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<CraftNetPipe>, mergeInclude: string, spec?: MergeSpec): ObjList<CraftNetPipe> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<CraftNetPipe> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<CraftNetPipe> | null;
   ...
   */
  static mergeAll(mergeObj: CraftNetPipe, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: CraftNetPipe, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<CraftNetPipe>, spec?: UpsertSpec): ObjList<CraftNetPipe> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<CraftNetPipe>, spec?: UpsertSpec): ObjList<CraftNetPipe> | null;
   ...
   */
  static beforeCreate(objs: Array_Type<CraftNetPipe>): ObjList<CraftNetPipe>;
   ...
   */
  static beforeUpdate(objs: Array_Type<CraftNetPipe>): ObjList<CraftNetPipe>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<CraftNetPipe>): ObjList<CraftNetPipe>;
   ...
   */
  static afterCreate(objs: Array_Type<CraftNetPipe>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<CraftNetPipe>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<CraftNetPipe>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<CraftNetPipe>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<CraftNetPipe>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): CraftNetPipe | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<CraftNetPipe>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: CraftNetPipe, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<CraftNetPipe>, callback?: λFunction<CraftNetPipe | null, CraftNetPipe | null>): ObjList<CraftNetPipe>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<CraftNetPipe>, callback?: λFunction<CraftNetPipe | null, CraftNetPipe | null>): Array_Type<ObjError> | null;
   ...
   */
  publish(subPath?: string, contentType?: string): CraftNetPipe;
   ...
   */
  static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<CraftNetPipe> | null;
   ...
   */
  createSeedData(spec?: UpsertSpec): CraftNetPipe | null;
   ...
   */
  static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<CraftNetPipe> | null;
   ...
   */
  updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): CraftNetPipe | null;
   ...
   */
  static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<CraftNetPipe> | null;
   ...
   * @return updated obj instance, same as {@link Persistable#update} return value.
   */
  clearUserUpdates(spec?: MergeSpec): CraftNetPipe | null;
   ...
   *         {@link Persistable#updateBatch}.
   */
  static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<CraftNetPipe> | null;
  ...
  dependencies(): SeedDataDeps<CraftNetPipe> | null;
   ...
   */
  static convert(model: any, spec?: MlConvertSpec): CraftNetPipe;
   ...
   */
  updateModelFiles(modelFiles: Map_Type<string, Url>, spec?: MlOperationSpec): CraftNetPipe;
   ...
   */
  afterTrain(doTrainOutputs: any, spec?: MlOperationSpec): CraftNetPipe;
   ...
   */
  withNewSpec(spec?: MlConvertSpec): CraftNetPipe;
   ...
   */
  afterConvert(model: any, spec?: MlConvertSpec): CraftNetPipe;
   ...
   */
  withHyperparamSpaces(paramSpaces: Map_Type<string, Hp.ParamSpace>): CraftNetPipe;
