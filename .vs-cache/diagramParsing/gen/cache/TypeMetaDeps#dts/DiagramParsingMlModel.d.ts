// TypeScript definitions for the C3 type DiagramParsingMlModel

/**
 * Extends {@link MlModel} to create a specialized model for diagram parsing tasks.
 * This model is specifically designed to handle parsing of diagrams within the context of machine learning.
 *
 * @remarks this represents a value passed to a method that expects an instance of DiagramParsingMlModel
 */
declare interface IDiagramParsingMlModel {
 ...
 * This model is specifically designed to handle parsing of diagrams within the context of machine learning.
 *
 * @remarks this represents a made instance of DiagramParsingMlModel
 */
declare class DiagramParsingMlModel extends Obj  {

  /**
   * The project this object belongs to.
   */
  readonly project: MlProject;
  withProject(project: IMlProject): DiagramParsingMlModel;
   ...
   */
  readonly id: string;
  withId(id: string): DiagramParsingMlModel;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): DiagramParsingMlModel;

  /**
   * Name of this model.
   */
  readonly name?: string;
  withName(name: string | null): DiagramParsingMlModel;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): DiagramParsingMlModel;
  ...
  withVersion(version: number | null): DiagramParsingMlModel;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): DiagramParsingMlModel;
  ...
  withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): DiagramParsingMlModel;
  ...
  withHidden(hidden: boolean): DiagramParsingMlModel;
  ...
  withUserOwned(userOwned: boolean): DiagramParsingMlModel;
  ...
  withTypeIdent(typeIdent: string | null): DiagramParsingMlModel;
  ...
  withPipeline(pipeline: IMlPipeline<any, any, any, any, any>): DiagramParsingMlModel;
  ...
  withWorkflowOverrides(workflowOverrides: Map_Type<string, Workflow> | {[key: string]: IWorkflow} | null): DiagramParsingMlModel;
  ...
  withFeatures(features: Array_Type<Feature.Set> | Array<IFeature.Set> | null): DiagramParsingMlModel;
  ...
  withXFeatures(xFeatures: Map_Type<string, Feature.Set> | {[key: string]: IFeature.Set} | null): DiagramParsingMlModel;
  ...
  withYFeatures(yFeatures: Map_Type<string, Feature.Set> | {[key: string]: IFeature.Set} | null): DiagramParsingMlModel;
  ...
  withXProjections(xProjections: Map_Type<string, string> | {[key: string]: string} | null): DiagramParsingMlModel;
  ...
  withYProjections(yProjections: Map_Type<string, string> | {[key: string]: string} | null): DiagramParsingMlModel;
  ...
  withSnapshot(snapshot: IFeature.Set.Snapshot | null): DiagramParsingMlModel;
  ...
  withSnapshots(snapshots: Array_Type<Feature.Set.Snapshot> | Array<IFeature.Set.Snapshot> | null): DiagramParsingMlModel;
  ...
  withXSnapshots(xSnapshots: Map_Type<string, Feature.Set.Snapshot> | {[key: string]: IFeature.Set.Snapshot} | null): DiagramParsingMlModel;
  ...
  withYSnapshots(ySnapshots: Map_Type<string, Feature.Set.Snapshot> | {[key: string]: IFeature.Set.Snapshot} | null): DiagramParsingMlModel;

  /**
   * {@link MlModel.Input} that captures the inputs used for {@link MlModel#train}.
   */
  readonly trainInput?: MlModel.Input;
  withTrainInput(trainInput: IMlModel.Input | null): DiagramParsingMlModel;

  /**
   * Foreign key reference to a list of all {@link MlModel.Evaluation.Result} for this {@link MlModel}.
   */
  readonly evaluationResults?: Array_Type<MlModel.Evaluation.Result>;
  withEvaluationResults(evaluationResults: Array_Type<MlModel.Evaluation.Result> | Array<IMlModel.Evaluation.Result> | null): DiagramParsingMlModel;

  /**
   * Foreign key reference to a list of all {@link MlModel.Monitor.TimedResult} for this {@link MlModel}.
   */
  readonly monitorResults?: Array_Type<MlModel.Monitor.TimedResult>;
  withMonitorResults(monitorResults: Array_Type<MlModel.Monitor.TimedResult> | Array<IMlModel.Monitor.TimedResult> | null): DiagramParsingMlModel;

  /**
   * Foreign key reference to the health history of this {@link MlModel}.
   */
  readonly healthHistory?: Array_Type<MlModel.Health.History>;
  withHealthHistory(healthHistory: Array_Type<MlModel.Health.History> | Array<IMlModel.Health.History> | null): DiagramParsingMlModel;
  ...
  withTrainScores(trainScores: Map_Type<string, number> | {[key: string]: number} | null): DiagramParsingMlModel;
  ...
  withOperationSpec(operationSpec: Map_Type<string, MlOperationSpec> | {[key: string]: IMlOperationSpec} | null): DiagramParsingMlModel;
   ...
   * @see #toJson
   */
  static fromJson(json: any): DiagramParsingMlModel | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): DiagramParsingMlModel | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): DiagramParsingMlModel | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): DiagramParsingMlModel | null;
   ...
   */
  replaceType(old: Type, new_: Type): DiagramParsingMlModel;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): DiagramParsingMlModel;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): DiagramParsingMlModel;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<DiagramParsingMlModel>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<DiagramParsingMlModel>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): DiagramParsingMlModel;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DiagramParsingMlModel;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DiagramParsingMlModel;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): DiagramParsingMlModel;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): DiagramParsingMlModel;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): DiagramParsingMlModel;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): DiagramParsingMlModel;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): DiagramParsingMlModel;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): DiagramParsingMlModel;
   ...
   * @see #removeField
   */
  withoutField(field: string): DiagramParsingMlModel;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): DiagramParsingMlModel;
   ...
   */
  withoutFields(fields: Array_Type<string>): DiagramParsingMlModel;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): DiagramParsingMlModel;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): DiagramParsingMlModel;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): DiagramParsingMlModel;
   ...
   * @see #unsetField
   */
  defaultField(field: string): DiagramParsingMlModel;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): DiagramParsingMlModel;
   ...
   * @see #removeField
   */
  unsetField(field: string): DiagramParsingMlModel;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): DiagramParsingMlModel;
   ...
   * @see #unsetField
   */
  removeField(field: string): DiagramParsingMlModel;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): DiagramParsingMlModel;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): DiagramParsingMlModel;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): DiagramParsingMlModel;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): DiagramParsingMlModel;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): DiagramParsingMlModel;

  mergeJson(json: any): DiagramParsingMlModel;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): DiagramParsingMlModel;
   ...
   */
  sumObj(other: Obj, deep?: boolean): DiagramParsingMlModel;
   ...
   */
  singletonArray(): Array_Type<DiagramParsingMlModel>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<DiagramParsingMlModel> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<DiagramParsingMlModel> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<DiagramParsingMlModel>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<DiagramParsingMlModel> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, DiagramParsingMlModel> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, DiagramParsingMlModel> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<DiagramParsingMlModel>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<DiagramParsingMlModel>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): DiagramParsingMlModel;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): DiagramParsingMlModel;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): DiagramParsingMlModel;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): DiagramParsingMlModel;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): DiagramParsingMlModel;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): DiagramParsingMlModel;
   ...
   * @see #fromString
   */
  static make(s: string): DiagramParsingMlModel | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): DiagramParsingMlModel;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): DiagramParsingMlModel;
   ...
   */
  static cachedEmptyInst(): DiagramParsingMlModel;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<DiagramParsingMlModel> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): DiagramParsingMlModel;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<DiagramParsingMlModel> | null;
   ...
   */
  static find(filter?: string, doNotProduceAll?: boolean): Stream<DiagramParsingMlModel> | null;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<DiagramParsingMlModel> | null;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): DiagramParsingMlModel | null;
   ...
   * @see findByCacheKey
   */
  static forCacheKey(key: string): DiagramParsingMlModel | null;
   ...
   * @see findByCacheKey
   */
  getCached(): DiagramParsingMlModel | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): DiagramParsingMlModel | null;
   ...
   */
  static produce(key: string): DiagramParsingMlModel | null;
   ...
   */
  static produceAll(): Map_Type<string, DiagramParsingMlModel> | null;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): Map_Type<string, DiagramParsingMlModel> | null;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<DiagramParsingMlModel>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<DiagramParsingMlModel>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<DiagramParsingMlModel> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<DiagramParsingMlModel>> | null;
   ...
   */
  get(include?: string): DiagramParsingMlModel | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): DiagramParsingMlModel | null;
   ...
   */
  getMissing(spec: GetMissingSpec): DiagramParsingMlModel;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): DiagramParsingMlModel | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): DiagramParsingMlModel;
   ...
   * @see #toString
   */
  static fromString(s: string): DiagramParsingMlModel | null;
   ...
   */
  create(spec?: UpsertSpec): DiagramParsingMlModel | null;
   ...
   */
  static createBatch(objs: Array_Type<DiagramParsingMlModel>, spec?: UpsertSpec): ObjList<DiagramParsingMlModel> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<DiagramParsingMlModel>, spec?: CreateBatchObjStreamSpec): ObjList<DiagramParsingMlModel> | null;
   ...
   */
  update(srcObj?: DiagramParsingMlModel, spec?: UpsertSpec): DiagramParsingMlModel | null;
   ...
   */
  upsert(srcObj?: DiagramParsingMlModel, spec?: UpsertSpec): DiagramParsingMlModel | null;
   ...
   */
  merge(spec?: MergeSpec): DiagramParsingMlModel | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): DiagramParsingMlModel | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): DiagramParsingMlModel | null;
   ...
   */
  static updateBatch(objs: Array_Type<DiagramParsingMlModel>, srcObjs?: Array_Type<DiagramParsingMlModel>, spec?: UpsertSpec): ObjList<DiagramParsingMlModel> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<DiagramParsingMlModel> | null>, spec?: UpsertSpec): ObjList<DiagramParsingMlModel> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<DiagramParsingMlModel>, srcObjs?: Array_Type<DiagramParsingMlModel>, spec?: UpsertSpec): ObjList<DiagramParsingMlModel> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<DiagramParsingMlModel> | null>, spec?: UpsertSpec): ObjList<DiagramParsingMlModel> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<DiagramParsingMlModel>, spec?: TouchSpec): ObjList<DiagramParsingMlModel> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<DiagramParsingMlModel>, spec?: MergeSpec): ObjList<DiagramParsingMlModel> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<DiagramParsingMlModel>, mergeInclude: string, spec?: MergeSpec): ObjList<DiagramParsingMlModel> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<DiagramParsingMlModel> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<DiagramParsingMlModel> | null;
   ...
   */
  static mergeAll(mergeObj: DiagramParsingMlModel, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: DiagramParsingMlModel, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<DiagramParsingMlModel>, spec?: UpsertSpec): ObjList<DiagramParsingMlModel> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<DiagramParsingMlModel>, spec?: UpsertSpec): ObjList<DiagramParsingMlModel> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): DiagramParsingMlModel | null;
   ...
   */
  static beforeCreate(objs: Array_Type<DiagramParsingMlModel>): ObjList<DiagramParsingMlModel>;
   ...
   */
  static beforeUpdate(objs: Array_Type<DiagramParsingMlModel>): ObjList<DiagramParsingMlModel>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<DiagramParsingMlModel>): ObjList<DiagramParsingMlModel>;
   ...
   */
  static afterCreate(objs: Array_Type<DiagramParsingMlModel>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<DiagramParsingMlModel>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<DiagramParsingMlModel>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<DiagramParsingMlModel>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<DiagramParsingMlModel>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): DiagramParsingMlModel | null;
   ...
   */
  withoutIdentity(): DiagramParsingMlModel | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<DiagramParsingMlModel>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: DiagramParsingMlModel, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<DiagramParsingMlModel>, callback?: λFunction<DiagramParsingMlModel | null, DiagramParsingMlModel | null>): ObjList<DiagramParsingMlModel>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<DiagramParsingMlModel>, callback?: λFunction<DiagramParsingMlModel | null, DiagramParsingMlModel | null>): Array_Type<ObjError> | null;
   ...
   */
  publish(subPath?: string, contentType?: string): DiagramParsingMlModel;
   ...
   */
  static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<DiagramParsingMlModel> | null;
   ...
   */
  createSeedData(spec?: UpsertSpec): DiagramParsingMlModel | null;
   ...
   */
  static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<DiagramParsingMlModel> | null;
   ...
   */
  updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): DiagramParsingMlModel | null;
   ...
   */
  static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<DiagramParsingMlModel> | null;
   ...
   * @return updated obj instance, same as {@link Persistable#update} return value.
   */
  clearUserUpdates(spec?: MergeSpec): DiagramParsingMlModel | null;
   ...
   *         {@link Persistable#updateBatch}.
   */
  static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<DiagramParsingMlModel> | null;
  ...
  dependencies(): SeedDataDeps<DiagramParsingMlModel> | null;
   ...
   */
  static createModel(project: MlProject, pipeline: MlPipeline<any, any, any, any, any>, x?: Map_Type<string, Feature.Set> | Feature.Set, y?: Map_Type<string, Feature.Set> | Feature.Set, id?: string): DiagramParsingMlModel;
   ...
   */
  precompute(operation: string, spec?: MlOperationSpec): DiagramParsingMlModel;
