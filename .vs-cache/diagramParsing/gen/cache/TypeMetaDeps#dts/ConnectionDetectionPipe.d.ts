// TypeScript definitions for the C3 type ConnectionDetectionPipe

/**
 * ConnectionDetectionPipe: A pipeline component for detecting connections between symbols in diagrams.
 * It processes data to detect the connections and identifies symbols' bounding boxes and image URLs.
 * This is an abstract type that extends {@link MlTemplate.AtomicPipe}.
 *
 * @remarks this represents a value passed to a method that expects an instance of ConnectionDetectionPipe
 */
declare interface IConnectionDetectionPipe {
 ...
 * This is an abstract type that extends {@link MlTemplate.AtomicPipe}.
 *
 * @remarks this represents a made instance of ConnectionDetectionPipe
 */
declare class ConnectionDetectionPipe extends Obj  {
   ...
   */
  readonly id: string;
  withId(id: string): ConnectionDetectionPipe;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ConnectionDetectionPipe;

  /**
   * Name of this pipe.
   */
  readonly name?: string;
  withName(name: string | null): ConnectionDetectionPipe;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): ConnectionDetectionPipe;
  ...
  withVersion(version: number | null): ConnectionDetectionPipe;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): ConnectionDetectionPipe;
  ...
  withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): ConnectionDetectionPipe;
  ...
  withHidden(hidden: boolean): ConnectionDetectionPipe;
  ...
  withUserOwned(userOwned: boolean): ConnectionDetectionPipe;
  ...
  withTypeIdent(typeIdent: string | null): ConnectionDetectionPipe;

  /**
   * If true, then the pipe shall not be retrained
   */
  readonly frozen?: boolean;
  withFrozen(frozen: boolean): ConnectionDetectionPipe;

  /**
   * True if training has succeeded and false otherwise.
   */
  readonly trained?: boolean;
  withTrained(trained: boolean): ConnectionDetectionPipe;

  /**
   * Errors from training.
   */
  readonly trainingErrors?: string;
  withTrainingErrors(trainingErrors: string | null): ConnectionDetectionPipe;

  /**
   * If true, the underlying model only accepts flattened input.
   */
  readonly flattenInput?: boolean;
  withFlattenInput(flattenInput: boolean): ConnectionDetectionPipe;

  /**
   * The hyperparameters overridden of a native model or pipe.
   */
  readonly hyperparamOverrides?: Map_Type<string, any>;
  withHyperparamOverrides(hyperparamOverrides: Map_Type<string, any> | {[key: string]: any} | null): ConnectionDetectionPipe;
  ...
  withHyperparamSearchSpace(hyperparamSearchSpace: IHp.SearchSpace | null): ConnectionDetectionPipe;
  ...
  withHpoSpec(hpoSpec: IHpo.Spec | null): ConnectionDetectionPipe;

  /**
   * {@link Hpo.Experiment} stores the result of hyperparameter optimization to find the best model/pipeline.
   */
  readonly hpoExperiment?: Hpo.Experiment;
  withHpoExperiment(hpoExperiment: IHpo.Experiment | null): ConnectionDetectionPipe;

  /**
   * Reference to the experiment that produced this {@link MlPipe}. For example, this could be a {@link Hpo.ExperimentBase}.
   */
  readonly experiment?: any;
  withExperiment(experiment: any | null): ConnectionDetectionPipe;
  ...
  withModelFiles(modelFiles: Map_Type<string, Url> | {[key: string]: IUrl} | null): ConnectionDetectionPipe;
  ...
  withCustomModelCode(customModelCode: Map_Type<string, any> | {[key: string]: any} | null): ConnectionDetectionPipe;

  /**
   * Name for the function on the native model to call to do {@link MlProcessable#process}.
   */
  readonly processFunc?: string;
  withProcessFunc(processFunc: string | null): ConnectionDetectionPipe;
  ...
  withUnderlyingPipe(underlyingPipe: IMlAtomicPipe<any, any, any> | null): ConnectionDetectionPipe;

  /**
   * The name of the column containing {@link DiagramParsingBoundingBox}s for the detected symbols.
   */
  readonly boundingBoxColumnName: string;
  withBoundingBoxColumnName(boundingBoxColumnName: string): ConnectionDetectionPipe;

  /**
   * The name of the column containing the urls of the files to convert.
   */
  readonly imageColumnName: string;
  withImageColumnName(imageColumnName: string): ConnectionDetectionPipe;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ConnectionDetectionPipe | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ConnectionDetectionPipe | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ConnectionDetectionPipe | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ConnectionDetectionPipe | null;
   ...
   */
  replaceType(old: Type, new_: Type): ConnectionDetectionPipe;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ConnectionDetectionPipe;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ConnectionDetectionPipe;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ConnectionDetectionPipe>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ConnectionDetectionPipe>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ConnectionDetectionPipe;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ConnectionDetectionPipe;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ConnectionDetectionPipe;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ConnectionDetectionPipe;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ConnectionDetectionPipe;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ConnectionDetectionPipe;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ConnectionDetectionPipe;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ConnectionDetectionPipe;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ConnectionDetectionPipe;
   ...
   * @see #removeField
   */
  withoutField(field: string): ConnectionDetectionPipe;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ConnectionDetectionPipe;
   ...
   */
  withoutFields(fields: Array_Type<string>): ConnectionDetectionPipe;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ConnectionDetectionPipe;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ConnectionDetectionPipe;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ConnectionDetectionPipe;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ConnectionDetectionPipe;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ConnectionDetectionPipe;
   ...
   * @see #removeField
   */
  unsetField(field: string): ConnectionDetectionPipe;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ConnectionDetectionPipe;
   ...
   * @see #unsetField
   */
  removeField(field: string): ConnectionDetectionPipe;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ConnectionDetectionPipe;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ConnectionDetectionPipe;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ConnectionDetectionPipe;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ConnectionDetectionPipe;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ConnectionDetectionPipe;

  mergeJson(json: any): ConnectionDetectionPipe;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ConnectionDetectionPipe;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ConnectionDetectionPipe;
   ...
   */
  singletonArray(): Array_Type<ConnectionDetectionPipe>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ConnectionDetectionPipe> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ConnectionDetectionPipe> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ConnectionDetectionPipe>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ConnectionDetectionPipe> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ConnectionDetectionPipe> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ConnectionDetectionPipe> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ConnectionDetectionPipe>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ConnectionDetectionPipe>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ConnectionDetectionPipe;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ConnectionDetectionPipe;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ConnectionDetectionPipe;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ConnectionDetectionPipe;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ConnectionDetectionPipe;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ConnectionDetectionPipe;
   ...
   * @see #fromString
   */
  static make(s: string): ConnectionDetectionPipe | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ConnectionDetectionPipe;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ConnectionDetectionPipe;
   ...
   */
  static cachedEmptyInst(): ConnectionDetectionPipe;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ConnectionDetectionPipe> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ConnectionDetectionPipe;
   ...
   */
  remakeTemplate(): ConnectionDetectionPipe;
   ...
   */
  withoutIdentity(): ConnectionDetectionPipe;
   ...
   */
  trainSync(x: Data, y?: , spec?: MlOperationSpec): ConnectionDetectionPipe;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<ConnectionDetectionPipe> | null;
   ...
   */
  static find(filter?: string, doNotProduceAll?: boolean): Stream<ConnectionDetectionPipe> | null;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<ConnectionDetectionPipe> | null;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): ConnectionDetectionPipe | null;
   ...
   * @see findByCacheKey
   */
  static forCacheKey(key: string): ConnectionDetectionPipe | null;
   ...
   * @see findByCacheKey
   */
  getCached(): ConnectionDetectionPipe | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): ConnectionDetectionPipe | null;
   ...
   */
  static produce(key: string): ConnectionDetectionPipe | null;
   ...
   */
  static produceAll(): Map_Type<string, ConnectionDetectionPipe> | null;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): Map_Type<string, ConnectionDetectionPipe> | null;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<ConnectionDetectionPipe>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ConnectionDetectionPipe>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<ConnectionDetectionPipe> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ConnectionDetectionPipe>> | null;
   ...
   */
  get(include?: string): ConnectionDetectionPipe | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): ConnectionDetectionPipe | null;
   ...
   */
  getMissing(spec: GetMissingSpec): ConnectionDetectionPipe;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): ConnectionDetectionPipe | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): ConnectionDetectionPipe;
   ...
   * @see #toString
   */
  static fromString(s: string): ConnectionDetectionPipe | null;
   ...
   */
  create(spec?: UpsertSpec): ConnectionDetectionPipe | null;
   ...
   */
  static createBatch(objs: Array_Type<ConnectionDetectionPipe>, spec?: UpsertSpec): ObjList<ConnectionDetectionPipe> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ConnectionDetectionPipe>, spec?: CreateBatchObjStreamSpec): ObjList<ConnectionDetectionPipe> | null;
   ...
   */
  update(srcObj?: ConnectionDetectionPipe, spec?: UpsertSpec): ConnectionDetectionPipe | null;
   ...
   */
  upsert(srcObj?: ConnectionDetectionPipe, spec?: UpsertSpec): ConnectionDetectionPipe | null;
   ...
   */
  merge(spec?: MergeSpec): ConnectionDetectionPipe | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): ConnectionDetectionPipe | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): ConnectionDetectionPipe | null;
   ...
   */
  static updateBatch(objs: Array_Type<ConnectionDetectionPipe>, srcObjs?: Array_Type<ConnectionDetectionPipe>, spec?: UpsertSpec): ObjList<ConnectionDetectionPipe> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<ConnectionDetectionPipe> | null>, spec?: UpsertSpec): ObjList<ConnectionDetectionPipe> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<ConnectionDetectionPipe>, srcObjs?: Array_Type<ConnectionDetectionPipe>, spec?: UpsertSpec): ObjList<ConnectionDetectionPipe> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<ConnectionDetectionPipe> | null>, spec?: UpsertSpec): ObjList<ConnectionDetectionPipe> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<ConnectionDetectionPipe>, spec?: TouchSpec): ObjList<ConnectionDetectionPipe> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ConnectionDetectionPipe>, spec?: MergeSpec): ObjList<ConnectionDetectionPipe> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ConnectionDetectionPipe>, mergeInclude: string, spec?: MergeSpec): ObjList<ConnectionDetectionPipe> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<ConnectionDetectionPipe> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ConnectionDetectionPipe> | null;
   ...
   */
  static mergeAll(mergeObj: ConnectionDetectionPipe, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ConnectionDetectionPipe, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<ConnectionDetectionPipe>, spec?: UpsertSpec): ObjList<ConnectionDetectionPipe> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<ConnectionDetectionPipe>, spec?: UpsertSpec): ObjList<ConnectionDetectionPipe> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): ConnectionDetectionPipe | null;
   ...
   */
  static beforeCreate(objs: Array_Type<ConnectionDetectionPipe>): ObjList<ConnectionDetectionPipe>;
   ...
   */
  static beforeUpdate(objs: Array_Type<ConnectionDetectionPipe>): ObjList<ConnectionDetectionPipe>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<ConnectionDetectionPipe>): ObjList<ConnectionDetectionPipe>;
   ...
   */
  static afterCreate(objs: Array_Type<ConnectionDetectionPipe>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<ConnectionDetectionPipe>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<ConnectionDetectionPipe>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<ConnectionDetectionPipe>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ConnectionDetectionPipe>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): ConnectionDetectionPipe | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<ConnectionDetectionPipe>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: ConnectionDetectionPipe, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<ConnectionDetectionPipe>, callback?: λFunction<ConnectionDetectionPipe | null, ConnectionDetectionPipe | null>): ObjList<ConnectionDetectionPipe>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<ConnectionDetectionPipe>, callback?: λFunction<ConnectionDetectionPipe | null, ConnectionDetectionPipe | null>): Array_Type<ObjError> | null;
   ...
   */
  publish(subPath?: string, contentType?: string): ConnectionDetectionPipe;
   ...
   */
  static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ConnectionDetectionPipe> | null;
   ...
   */
  createSeedData(spec?: UpsertSpec): ConnectionDetectionPipe | null;
   ...
   */
  static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ConnectionDetectionPipe> | null;
   ...
   */
  updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): ConnectionDetectionPipe | null;
   ...
   */
  static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<ConnectionDetectionPipe> | null;
   ...
   * @return updated obj instance, same as {@link Persistable#update} return value.
   */
  clearUserUpdates(spec?: MergeSpec): ConnectionDetectionPipe | null;
   ...
   *         {@link Persistable#updateBatch}.
   */
  static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<ConnectionDetectionPipe> | null;
  ...
  dependencies(): SeedDataDeps<ConnectionDetectionPipe> | null;
   ...
   * be returned as-is.
   */
  byReference(): ConnectionDetectionPipe;
   ...
   */
  updateModelFiles(modelFiles: Map_Type<string, Url>, spec?: MlOperationSpec): ConnectionDetectionPipe;
   ...
   */
  afterTrain(doTrainOutputs: any, spec?: MlOperationSpec): ConnectionDetectionPipe;
   ...
   */
  withNewSpec(spec?: MlConvertSpec): ConnectionDetectionPipe;
   ...
   */
  afterConvert(model: any, spec?: MlConvertSpec): ConnectionDetectionPipe;
   ...
   */
  withHyperparamSpaces(paramSpaces: Map_Type<string, Hp.ParamSpace>): ConnectionDetectionPipe;
