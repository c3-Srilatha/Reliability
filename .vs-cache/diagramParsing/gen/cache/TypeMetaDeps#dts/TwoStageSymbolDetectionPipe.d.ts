// TypeScript definitions for the C3 type TwoStageSymbolDetectionPipe

/**
 * This type represents an {@link MlPipe} template for two-stage symbol detection in diagrams.
 *
 * @remarks this represents a value passed to a method that expects an instance of TwoStageSymbolDetectionPipe
 */
declare interface ITwoStageSymbolDetectionPipe {
  ...
  /**
   * Region proposer for the symbol detector. This field is required if the user wants to directly run {@link process}
   * without training the pipe first. For running {@link train}, this field is optional. If it is provided, the pipe
   * will further fine-tune the proposer on the input training data.
   */
  proposer?: IRegionProposer;

  /**
   * Classifier that predicts the class of each detected region. This field is required if the user wants to
   * directly run {@link process} without training the pipe first. For running {@link train}, this field is optional.
   * If it is provided, the pipe will further fine-tune the classifier on the input training data.
   */
  classifier?: IRegionClassifier;

  /**
   * Parameters to control the training process for the region proposer and classifier. This field is required
   * if the user wants to train the pipe using {@link train}.
   */
  trainingSpec?: ITwoStageSymbolDetectionTrainingSpec;

  /**
   * Probability thresholds for each symbol type. The parameter would be used for {@link RegionClassifier} during inference.
   */
  thresholds: Array_Type<number> | Array<number>;
}

/**
 * This type represents an {@link MlPipe} template for two-stage symbol detection in diagrams.
 *
 * @remarks this represents a made instance of TwoStageSymbolDetectionPipe
 */
declare class TwoStageSymbolDetectionPipe extends Obj  {
   ...
   */
  readonly id: string;
  withId(id: string): TwoStageSymbolDetectionPipe;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): TwoStageSymbolDetectionPipe;

  /**
   * Name of this pipe.
   */
  readonly name?: string;
  withName(name: string | null): TwoStageSymbolDetectionPipe;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): TwoStageSymbolDetectionPipe;
  ...
  withVersion(version: number | null): TwoStageSymbolDetectionPipe;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): TwoStageSymbolDetectionPipe;
  ...
  withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): TwoStageSymbolDetectionPipe;
  ...
  withHidden(hidden: boolean): TwoStageSymbolDetectionPipe;
  ...
  withUserOwned(userOwned: boolean): TwoStageSymbolDetectionPipe;
  ...
  withTypeIdent(typeIdent: string | null): TwoStageSymbolDetectionPipe;

  /**
   * If true, then the pipe shall not be retrained
   */
  readonly frozen?: boolean;
  withFrozen(frozen: boolean): TwoStageSymbolDetectionPipe;

  /**
   * True if training has succeeded and false otherwise.
   */
  readonly trained?: boolean;
  withTrained(trained: boolean): TwoStageSymbolDetectionPipe;

  /**
   * Errors from training.
   */
  readonly trainingErrors?: string;
  withTrainingErrors(trainingErrors: string | null): TwoStageSymbolDetectionPipe;

  /**
   * If true, the underlying model only accepts flattened input.
   */
  readonly flattenInput?: boolean;
  withFlattenInput(flattenInput: boolean): TwoStageSymbolDetectionPipe;

  /**
   * The hyperparameters overridden of a native model or pipe.
   */
  readonly hyperparamOverrides?: Map_Type<string, any>;
  withHyperparamOverrides(hyperparamOverrides: Map_Type<string, any> | {[key: string]: any} | null): TwoStageSymbolDetectionPipe;
  ...
  withHyperparamSearchSpace(hyperparamSearchSpace: IHp.SearchSpace | null): TwoStageSymbolDetectionPipe;
  ...
  withHpoSpec(hpoSpec: IHpo.Spec | null): TwoStageSymbolDetectionPipe;

  /**
   * {@link Hpo.Experiment} stores the result of hyperparameter optimization to find the best model/pipeline.
   */
  readonly hpoExperiment?: Hpo.Experiment;
  withHpoExperiment(hpoExperiment: IHpo.Experiment | null): TwoStageSymbolDetectionPipe;

  /**
   * Reference to the experiment that produced this {@link MlPipe}. For example, this could be a {@link Hpo.ExperimentBase}.
   */
  readonly experiment?: any;
  withExperiment(experiment: any | null): TwoStageSymbolDetectionPipe;
  ...
  withModelFiles(modelFiles: Map_Type<string, Url> | {[key: string]: IUrl} | null): TwoStageSymbolDetectionPipe;
  ...
  withCustomModelCode(customModelCode: Map_Type<string, any> | {[key: string]: any} | null): TwoStageSymbolDetectionPipe;

  /**
   * Name for the function on the native model to call to do {@link MlProcessable#process}.
   */
  readonly processFunc?: string;
  withProcessFunc(processFunc: string | null): TwoStageSymbolDetectionPipe;
  ...
  withUnderlyingPipe(underlyingPipe: IMlAtomicPipe<any, any, any> | null): TwoStageSymbolDetectionPipe;

  /**
   * The name of the column containing the urls of the images to be processed.
   */
  readonly imageColumnName: string;
  withImageColumnName(imageColumnName: string): TwoStageSymbolDetectionPipe;
  ...
  withAugmenters(augmenters: Array_Type<DiagramAugmenter> | Array<IDiagramAugmenter> | null): TwoStageSymbolDetectionPipe;
   ...
   * will further fine-tune the proposer on the input training data.
   */
  readonly proposer?: RegionProposer;
  withProposer(proposer: IRegionProposer | null): TwoStageSymbolDetectionPipe;
   ...
   * If it is provided, the pipe will further fine-tune the classifier on the input training data.
   */
  readonly classifier?: RegionClassifier;
  withClassifier(classifier: IRegionClassifier | null): TwoStageSymbolDetectionPipe;

  /**
   * Parameters to control the training process for the region proposer and classifier. This field is required
   * if the user wants to train the pipe using {@link train}.
   */
  readonly trainingSpec?: TwoStageSymbolDetectionTrainingSpec;
  withTrainingSpec(trainingSpec: ITwoStageSymbolDetectionTrainingSpec | null): TwoStageSymbolDetectionPipe;

  /**
   * Probability thresholds for each symbol type. The parameter would be used for {@link RegionClassifier} during inference.
   */
  readonly thresholds: Array_Type<number>;
  withThresholds(thresholds: Array_Type<number> | Array<number>): TwoStageSymbolDetectionPipe;
   ...
   * @see #toJson
   */
  static fromJson(json: any): TwoStageSymbolDetectionPipe | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): TwoStageSymbolDetectionPipe | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): TwoStageSymbolDetectionPipe | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): TwoStageSymbolDetectionPipe | null;
   ...
   */
  replaceType(old: Type, new_: Type): TwoStageSymbolDetectionPipe;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): TwoStageSymbolDetectionPipe;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): TwoStageSymbolDetectionPipe;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<TwoStageSymbolDetectionPipe>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<TwoStageSymbolDetectionPipe>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): TwoStageSymbolDetectionPipe;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TwoStageSymbolDetectionPipe;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TwoStageSymbolDetectionPipe;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): TwoStageSymbolDetectionPipe;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): TwoStageSymbolDetectionPipe;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): TwoStageSymbolDetectionPipe;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): TwoStageSymbolDetectionPipe;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): TwoStageSymbolDetectionPipe;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): TwoStageSymbolDetectionPipe;
   ...
   * @see #removeField
   */
  withoutField(field: string): TwoStageSymbolDetectionPipe;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): TwoStageSymbolDetectionPipe;
   ...
   */
  withoutFields(fields: Array_Type<string>): TwoStageSymbolDetectionPipe;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): TwoStageSymbolDetectionPipe;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): TwoStageSymbolDetectionPipe;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): TwoStageSymbolDetectionPipe;
   ...
   * @see #unsetField
   */
  defaultField(field: string): TwoStageSymbolDetectionPipe;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): TwoStageSymbolDetectionPipe;
   ...
   * @see #removeField
   */
  unsetField(field: string): TwoStageSymbolDetectionPipe;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): TwoStageSymbolDetectionPipe;
   ...
   * @see #unsetField
   */
  removeField(field: string): TwoStageSymbolDetectionPipe;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): TwoStageSymbolDetectionPipe;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): TwoStageSymbolDetectionPipe;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): TwoStageSymbolDetectionPipe;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): TwoStageSymbolDetectionPipe;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): TwoStageSymbolDetectionPipe;

  mergeJson(json: any): TwoStageSymbolDetectionPipe;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): TwoStageSymbolDetectionPipe;
   ...
   */
  sumObj(other: Obj, deep?: boolean): TwoStageSymbolDetectionPipe;
   ...
   */
  singletonArray(): Array_Type<TwoStageSymbolDetectionPipe>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<TwoStageSymbolDetectionPipe> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<TwoStageSymbolDetectionPipe> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<TwoStageSymbolDetectionPipe>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<TwoStageSymbolDetectionPipe> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, TwoStageSymbolDetectionPipe> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, TwoStageSymbolDetectionPipe> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<TwoStageSymbolDetectionPipe>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<TwoStageSymbolDetectionPipe>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): TwoStageSymbolDetectionPipe;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): TwoStageSymbolDetectionPipe;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): TwoStageSymbolDetectionPipe;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): TwoStageSymbolDetectionPipe;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): TwoStageSymbolDetectionPipe;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): TwoStageSymbolDetectionPipe;
   ...
   * @see #fromString
   */
  static make(s: string): TwoStageSymbolDetectionPipe | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): TwoStageSymbolDetectionPipe;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): TwoStageSymbolDetectionPipe;
   ...
   */
  static cachedEmptyInst(): TwoStageSymbolDetectionPipe;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<TwoStageSymbolDetectionPipe> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): TwoStageSymbolDetectionPipe;
   ...
   */
  remakeTemplate(): TwoStageSymbolDetectionPipe;
   ...
   */
  withoutIdentity(): TwoStageSymbolDetectionPipe;
   ...
   */
  trainSync(x: Data, y?: , spec?: MlOperationSpec): TwoStageSymbolDetectionPipe;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<TwoStageSymbolDetectionPipe> | null;
   ...
   */
  static find(filter?: string, doNotProduceAll?: boolean): Stream<TwoStageSymbolDetectionPipe> | null;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<TwoStageSymbolDetectionPipe> | null;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): TwoStageSymbolDetectionPipe | null;
   ...
   * @see findByCacheKey
   */
  static forCacheKey(key: string): TwoStageSymbolDetectionPipe | null;
   ...
   * @see findByCacheKey
   */
  getCached(): TwoStageSymbolDetectionPipe | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): TwoStageSymbolDetectionPipe | null;
   ...
   */
  static produce(key: string): TwoStageSymbolDetectionPipe | null;
   ...
   */
  static produceAll(): Map_Type<string, TwoStageSymbolDetectionPipe> | null;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): Map_Type<string, TwoStageSymbolDetectionPipe> | null;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<TwoStageSymbolDetectionPipe>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<TwoStageSymbolDetectionPipe>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<TwoStageSymbolDetectionPipe> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<TwoStageSymbolDetectionPipe>> | null;
   ...
   */
  get(include?: string): TwoStageSymbolDetectionPipe | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): TwoStageSymbolDetectionPipe | null;
   ...
   */
  getMissing(spec: GetMissingSpec): TwoStageSymbolDetectionPipe;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): TwoStageSymbolDetectionPipe | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): TwoStageSymbolDetectionPipe;
   ...
   * @see #toString
   */
  static fromString(s: string): TwoStageSymbolDetectionPipe | null;
   ...
   */
  create(spec?: UpsertSpec): TwoStageSymbolDetectionPipe | null;
   ...
   */
  static createBatch(objs: Array_Type<TwoStageSymbolDetectionPipe>, spec?: UpsertSpec): ObjList<TwoStageSymbolDetectionPipe> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<TwoStageSymbolDetectionPipe>, spec?: CreateBatchObjStreamSpec): ObjList<TwoStageSymbolDetectionPipe> | null;
   ...
   */
  update(srcObj?: TwoStageSymbolDetectionPipe, spec?: UpsertSpec): TwoStageSymbolDetectionPipe | null;
   ...
   */
  upsert(srcObj?: TwoStageSymbolDetectionPipe, spec?: UpsertSpec): TwoStageSymbolDetectionPipe | null;
   ...
   */
  merge(spec?: MergeSpec): TwoStageSymbolDetectionPipe | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): TwoStageSymbolDetectionPipe | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): TwoStageSymbolDetectionPipe | null;
   ...
   */
  static updateBatch(objs: Array_Type<TwoStageSymbolDetectionPipe>, srcObjs?: Array_Type<TwoStageSymbolDetectionPipe>, spec?: UpsertSpec): ObjList<TwoStageSymbolDetectionPipe> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<TwoStageSymbolDetectionPipe> | null>, spec?: UpsertSpec): ObjList<TwoStageSymbolDetectionPipe> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<TwoStageSymbolDetectionPipe>, srcObjs?: Array_Type<TwoStageSymbolDetectionPipe>, spec?: UpsertSpec): ObjList<TwoStageSymbolDetectionPipe> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<TwoStageSymbolDetectionPipe> | null>, spec?: UpsertSpec): ObjList<TwoStageSymbolDetectionPipe> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<TwoStageSymbolDetectionPipe>, spec?: TouchSpec): ObjList<TwoStageSymbolDetectionPipe> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<TwoStageSymbolDetectionPipe>, spec?: MergeSpec): ObjList<TwoStageSymbolDetectionPipe> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<TwoStageSymbolDetectionPipe>, mergeInclude: string, spec?: MergeSpec): ObjList<TwoStageSymbolDetectionPipe> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<TwoStageSymbolDetectionPipe> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<TwoStageSymbolDetectionPipe> | null;
   ...
   */
  static mergeAll(mergeObj: TwoStageSymbolDetectionPipe, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: TwoStageSymbolDetectionPipe, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<TwoStageSymbolDetectionPipe>, spec?: UpsertSpec): ObjList<TwoStageSymbolDetectionPipe> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<TwoStageSymbolDetectionPipe>, spec?: UpsertSpec): ObjList<TwoStageSymbolDetectionPipe> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): TwoStageSymbolDetectionPipe | null;
   ...
   */
  static beforeCreate(objs: Array_Type<TwoStageSymbolDetectionPipe>): ObjList<TwoStageSymbolDetectionPipe>;
   ...
   */
  static beforeUpdate(objs: Array_Type<TwoStageSymbolDetectionPipe>): ObjList<TwoStageSymbolDetectionPipe>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<TwoStageSymbolDetectionPipe>): ObjList<TwoStageSymbolDetectionPipe>;
   ...
   */
  static afterCreate(objs: Array_Type<TwoStageSymbolDetectionPipe>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<TwoStageSymbolDetectionPipe>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<TwoStageSymbolDetectionPipe>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<TwoStageSymbolDetectionPipe>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<TwoStageSymbolDetectionPipe>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): TwoStageSymbolDetectionPipe | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<TwoStageSymbolDetectionPipe>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: TwoStageSymbolDetectionPipe, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<TwoStageSymbolDetectionPipe>, callback?: λFunction<TwoStageSymbolDetectionPipe | null, TwoStageSymbolDetectionPipe | null>): ObjList<TwoStageSymbolDetectionPipe>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<TwoStageSymbolDetectionPipe>, callback?: λFunction<TwoStageSymbolDetectionPipe | null, TwoStageSymbolDetectionPipe | null>): Array_Type<ObjError> | null;
   ...
   */
  publish(subPath?: string, contentType?: string): TwoStageSymbolDetectionPipe;
   ...
   */
  static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<TwoStageSymbolDetectionPipe> | null;
   ...
   */
  createSeedData(spec?: UpsertSpec): TwoStageSymbolDetectionPipe | null;
   ...
   */
  static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<TwoStageSymbolDetectionPipe> | null;
   ...
   */
  updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): TwoStageSymbolDetectionPipe | null;
   ...
   */
  static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<TwoStageSymbolDetectionPipe> | null;
   ...
   * @return updated obj instance, same as {@link Persistable#update} return value.
   */
  clearUserUpdates(spec?: MergeSpec): TwoStageSymbolDetectionPipe | null;
   ...
   *         {@link Persistable#updateBatch}.
   */
  static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<TwoStageSymbolDetectionPipe> | null;
  ...
  dependencies(): SeedDataDeps<TwoStageSymbolDetectionPipe> | null;
   ...
   * be returned as-is.
   */
  byReference(): TwoStageSymbolDetectionPipe;
   ...
   */
  updateModelFiles(modelFiles: Map_Type<string, Url>, spec?: MlOperationSpec): TwoStageSymbolDetectionPipe;
   ...
   */
  afterTrain(doTrainOutputs: any, spec?: MlOperationSpec): TwoStageSymbolDetectionPipe;
   ...
   */
  withNewSpec(spec?: MlConvertSpec): TwoStageSymbolDetectionPipe;
   ...
   */
  afterConvert(model: any, spec?: MlConvertSpec): TwoStageSymbolDetectionPipe;
   ...
   */
  withHyperparamSpaces(paramSpaces: Map_Type<string, Hp.ParamSpace>): TwoStageSymbolDetectionPipe;
