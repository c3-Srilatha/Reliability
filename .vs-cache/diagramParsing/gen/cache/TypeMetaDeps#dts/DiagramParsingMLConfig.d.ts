// TypeScript definitions for the C3 type DiagramParsingMLConfig

/**
 * ML Configurations for Diagram Parsing application.
 *
 * @remarks this represents a value passed to a method that expects an instance of DiagramParsingMLConfig
 */
declare interface IDiagramParsingMLConfig {
  ...
  /**
   * Target height to resize all the images to
   */
  imageHeight?: number;

  /**
   * Target width to resize all the images to
   */
  imageWidth?: number;

  /**
   * Whether to resize images to target dimensions.
   * If true, images are resized using imageHeight/imageWidth and maintainAspectRatio settings.
   * If false (default), images keep their original dimensions from PDF rendering (based on DPI).
   * Set to false when you want to preserve original PDF dimensions without standardization.
   */
  resizeImages?: boolean;

  /**
   * Whether to maintain aspect ratio when resizing images.
   * If true, images are scaled to fit within target dimensions and padded with white.
   * If false (default), images are stretched to exact target dimensions.
   * Set to true when your project has PDFs with varying aspect ratios.
   */
  maintainAspectRatio?: boolean;

  /**
   * A list of symbol types to be detected
   */
  targets?: Array_Type<string> | Array<string>;

  /**
   * Probability thresholds for each symbol type
   */
  thresholds?: Array_Type<number> | Array<number>;

  /**
   * Relative path that contains the h5 model files for building {@link DiagramParsingPipeline#symbolDetectionPipe}.
   */
  modelFileRelativePath?: string;

  /**
   * The default name of the {@link Feature.Set} that will be used by {@link DiagramParsingMlModel}s.
   */
  featureSetName?: string;

  /**
   * The id for the model to be used for the parsing workflow.
   * If no or invalid Id is set, then a default {@link DiagramParsingMlModel} will be used.
   */
  modelId?: string;
}
 ...
 * ML Configurations for Diagram Parsing application.
 *
 * @remarks this represents a made instance of DiagramParsingMLConfig
 */
declare class DiagramParsingMLConfig extends Obj  {

  readonly configOverride?: string;
  withConfigOverride(configOverride: string | null): DiagramParsingMLConfig;

  static readonly configOverride?: string;

  readonly secretOverride?: string;
  withSecretOverride(secretOverride: string | null): DiagramParsingMLConfig;
  ...
  withIssues(issues: Array_Type<string> | Array<string> | null): DiagramParsingMLConfig;
  ...
  withFormat(format: string | null): DiagramParsingMLConfig;
   ...
   */
  readonly dpi?: number;
  withDpi(dpi: number | null): DiagramParsingMLConfig;
  ...
  withZoom(zoom: number | null): DiagramParsingMLConfig;
  ...
  withImageHeight(imageHeight: number | null): DiagramParsingMLConfig;

  /**
   * Target height to resize all the images to
   */
  static readonly imageHeight?: number;

  /**
   * Target width to resize all the images to
   */
  readonly imageWidth?: number;
  withImageWidth(imageWidth: number | null): DiagramParsingMLConfig;

  /**
   * Target width to resize all the images to
   */
  static readonly imageWidth?: number;
  ...
  withResizeImages(resizeImages: boolean): DiagramParsingMLConfig;
   ...
   * Set to false when you want to preserve original PDF dimensions without standardization.
   */
  static readonly resizeImages?: boolean;
  ...
  withMaintainAspectRatio(maintainAspectRatio: boolean): DiagramParsingMLConfig;
   ...
   * Set to true when your project has PDFs with varying aspect ratios.
   */
  static readonly maintainAspectRatio?: boolean;

  /**
   * A list of symbol types to be detected
   */
  readonly targets?: Array_Type<string>;
  withTargets(targets: Array_Type<string> | Array<string> | null): DiagramParsingMLConfig;

  /**
   * A list of symbol types to be detected
   */
  static readonly targets?: Array_Type<string>;

  /**
   * Probability thresholds for each symbol type
   */
  readonly thresholds?: Array_Type<number>;
  withThresholds(thresholds: Array_Type<number> | Array<number> | null): DiagramParsingMLConfig;

  /**
   * Probability thresholds for each symbol type
   */
  static readonly thresholds?: Array_Type<number>;

  /**
   * Relative path that contains the h5 model files for building {@link DiagramParsingPipeline#symbolDetectionPipe}.
   */
  readonly modelFileRelativePath?: string;
  withModelFileRelativePath(modelFileRelativePath: string | null): DiagramParsingMLConfig;

  /**
   * Relative path that contains the h5 model files for building {@link DiagramParsingPipeline#symbolDetectionPipe}.
   */
  static readonly modelFileRelativePath?: string;

  /**
   * The default name of the {@link Feature.Set} that will be used by {@link DiagramParsingMlModel}s.
   */
  readonly featureSetName?: string;
  withFeatureSetName(featureSetName: string | null): DiagramParsingMLConfig;

  /**
   * The default name of the {@link Feature.Set} that will be used by {@link DiagramParsingMlModel}s.
   */
  static readonly featureSetName?: string;
  ...
  withModelId(modelId: string | null): DiagramParsingMLConfig;
   ...
   * @see #toJson
   */
  static fromJson(json: any): DiagramParsingMLConfig | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): DiagramParsingMLConfig | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): DiagramParsingMLConfig | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): DiagramParsingMLConfig | null;
   ...
   */
  replaceType(old: Type, new_: Type): DiagramParsingMLConfig;
   ...
   * This method is used during live metadata update
   */
  static replaceType(old: Type, new_: Type): DiagramParsingMLConfig;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): DiagramParsingMLConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): DiagramParsingMLConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): DiagramParsingMLConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): DiagramParsingMLConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<DiagramParsingMLConfig>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<DiagramParsingMLConfig>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<DiagramParsingMLConfig>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<DiagramParsingMLConfig>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): DiagramParsingMLConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): DiagramParsingMLConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DiagramParsingMLConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DiagramParsingMLConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DiagramParsingMLConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DiagramParsingMLConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): DiagramParsingMLConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  static validateObj(): DiagramParsingMLConfig;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): DiagramParsingMLConfig;
   ...
   * @see #defaultField
   */
  static withField(field: string, value: any, doNotConvert?: boolean): DiagramParsingMLConfig;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): DiagramParsingMLConfig;
   ...
   * @see #defaultField
   */
  static withField(field: FieldType, value: any, doNotConvert?: boolean): DiagramParsingMLConfig;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): DiagramParsingMLConfig;
   ...
   * @return new Obj
   */
  static withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): DiagramParsingMLConfig;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): DiagramParsingMLConfig;
   ...
   * @return new Obj
   */
  static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): DiagramParsingMLConfig;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): DiagramParsingMLConfig;
   ...
   * @see #withoutField
   */
  static withoutFieldAtPath(path: string): DiagramParsingMLConfig;
   ...
   * @see #removeField
   */
  withoutField(field: string): DiagramParsingMLConfig;
   ...
   * @see #removeField
   */
  static withoutField(field: string): DiagramParsingMLConfig;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): DiagramParsingMLConfig;
   ...
   * @see #removeField
   */
  static withoutField(field: FieldType): DiagramParsingMLConfig;
   ...
   */
  withoutFields(fields: Array_Type<string>): DiagramParsingMLConfig;
   ...
   * @return new Obj with removed fields
   */
  static withoutFields(fields: Array_Type<string>): DiagramParsingMLConfig;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): DiagramParsingMLConfig;
   ...
   * @return new Obj with removed fields
   */
  static withoutFieldsByType(fields: Array_Type<FieldType>): DiagramParsingMLConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): DiagramParsingMLConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  static withoutSecretFields(): DiagramParsingMLConfig;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): DiagramParsingMLConfig;
   ...
   * @see FieldType#defaultValue
   */
  static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): DiagramParsingMLConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: string): DiagramParsingMLConfig;
   ...
   * @see #unsetField
   */
  static defaultField(field: string): DiagramParsingMLConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): DiagramParsingMLConfig;
   ...
   * @see #unsetField
   */
  static defaultField(field: FieldType): DiagramParsingMLConfig;
   ...
   * @see #removeField
   */
  unsetField(field: string): DiagramParsingMLConfig;
   ...
   * @see #removeField
   */
  static unsetField(field: string): DiagramParsingMLConfig;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): DiagramParsingMLConfig;
   ...
   * @see #removeField
   */
  static unsetField(field: FieldType): DiagramParsingMLConfig;
   ...
   * @see #unsetField
   */
  removeField(field: string): DiagramParsingMLConfig;
   ...
   * @see #unsetField
   */
  static removeField(field: string): DiagramParsingMLConfig;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): DiagramParsingMLConfig;
   ...
   * @see #unsetField
   */
  static removeField(field: FieldType): DiagramParsingMLConfig;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): DiagramParsingMLConfig;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): DiagramParsingMLConfig;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): DiagramParsingMLConfig;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj, otherFieldsFilter: Type): DiagramParsingMLConfig;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): DiagramParsingMLConfig;
   ...
   *        the same key or index.
   */
  static mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): DiagramParsingMLConfig;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): DiagramParsingMLConfig;
   ...
   * traverse child reference and collection fields.
   */
  static mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): DiagramParsingMLConfig;

  mergeJson(json: any): DiagramParsingMLConfig;

  static mergeJson(json: any): DiagramParsingMLConfig;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): DiagramParsingMLConfig;
   ...
   * @return Obj with child references merged
   */
  static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): DiagramParsingMLConfig;
   ...
   */
  sumObj(other: Obj, deep?: boolean): DiagramParsingMLConfig;
   ...
   * references with same name and collection elements at same index or key.
   */
  static sumObj(other: Obj, deep?: boolean): DiagramParsingMLConfig;
   ...
   */
  singletonArray(): Array_Type<DiagramParsingMLConfig>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonArray(): Array_Type<DiagramParsingMLConfig>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<DiagramParsingMLConfig> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<DiagramParsingMLConfig> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<DiagramParsingMLConfig>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonSet(): Set_Type<DiagramParsingMLConfig>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<DiagramParsingMLConfig> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, DiagramParsingMLConfig> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, DiagramParsingMLConfig> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<DiagramParsingMLConfig>;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  static toBuilder(): ObjBuilder<DiagramParsingMLConfig>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<DiagramParsingMLConfig>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): DiagramParsingMLConfig;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): DiagramParsingMLConfig;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): DiagramParsingMLConfig;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): DiagramParsingMLConfig;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): DiagramParsingMLConfig;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): DiagramParsingMLConfig;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): DiagramParsingMLConfig;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): DiagramParsingMLConfig;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  static afterMake(): DiagramParsingMLConfig;
   ...
   */
  static cachedEmptyInst(): DiagramParsingMLConfig;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<DiagramParsingMLConfig> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): DiagramParsingMLConfig;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<DiagramParsingMLConfig> | null;
   ...
   */
  static find(filter?: string, doNotProduceAll?: boolean): Stream<DiagramParsingMLConfig> | null;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<DiagramParsingMLConfig> | null;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): DiagramParsingMLConfig | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string): DiagramParsingMLConfig | null;
   ...
   * @see findByCacheKey
   */
  getCached(): DiagramParsingMLConfig | null;
   ...
   * @see findByCacheKey
   */
  static getCached(): DiagramParsingMLConfig | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): DiagramParsingMLConfig | null;

  /**
   * @return newly produced cached instance.
   */
  static refreshCache(): DiagramParsingMLConfig | null;
   ...
   */
  static produce(key: string): DiagramParsingMLConfig | null;
   ...
   */
  static produceAll(): Map_Type<string, DiagramParsingMLConfig> | null;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): Map_Type<string, DiagramParsingMLConfig> | null;
   ...
   */
  getConfig(): DiagramParsingMLConfig;
   ...
   * Note that typical pattern is to use Configurable#config instead of this method.
   */
  static getConfig(): DiagramParsingMLConfig;
   ...
   */
  getSecret(): DiagramParsingMLConfig;
   ...
   * Note that typical pattern is to use Configurable#configWithSecrets instead of this method.
   */
  static getSecret(): DiagramParsingMLConfig;
   ...
   */
  withConfigKey(configKey: string): DiagramParsingMLConfig;
   ...
   *     config.configKey() => "folder1/abc"
   */
  static withConfigKey(configKey: string): DiagramParsingMLConfig;

  /**
   * @return copy without config key.
   */
  withoutConfigKey(): DiagramParsingMLConfig;

  /**
   * @return copy without config key.
   */
  static withoutConfigKey(): DiagramParsingMLConfig;

  /**
   * @return return cached config instance for provided config key.
   */
  static forConfigKey(configKey: string): DiagramParsingMLConfig | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string>): Stream<DiagramParsingMLConfig> | null;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: DiagramParsingMLConfig, override?: string): void;

  /**
   * Sets multiple field values to be the same as the passed instance.
   * @see setConfigValue
   */
  static setConfigValues(from: DiagramParsingMLConfig, override?: string): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: DiagramParsingMLConfig, override?: string): void;

  /**
   * Sets multiple secret field values to be the same as the passed instance.
   * @see setSecretValue
   */
  static setSecretValues(from: DiagramParsingMLConfig, override?: string): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): DiagramParsingMLConfig | null;
   ...
   */
  removeSecrets(): DiagramParsingMLConfig | null;

  /**
   * @return this config without any secret values.
   */
  static removeSecrets(): DiagramParsingMLConfig | null;

  /**
   * @return this config with only secret values.
   */
  removeNonSecrets(): DiagramParsingMLConfig | null;

  /**
   * @return this config with only secret values.
   */
  static removeNonSecrets(): DiagramParsingMLConfig | null;

  /**
   * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
   * validation and setup.
   */
  validate(): DiagramParsingMLConfig;

  /**
   * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
   * validation and setup.
   */
  static validate(): DiagramParsingMLConfig;
