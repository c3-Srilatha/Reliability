...
declare class PhysicalAsset extends Obj  {
  ...
  withDiagramRelations(diagramRelations: Array_Type<ParsableDiagramToPhysicalAssetRelation> | Array<IParsableDiagramToPhysicalAssetRelation> | null): PhysicalAsset;

  /**
   * Count of {@link ParsableDiagram}s which have been linked to this asset.
   */
  readonly numDiagramRelations?: number;
  withNumDiagramRelations(numDiagramRelations: number | null): PhysicalAsset;
