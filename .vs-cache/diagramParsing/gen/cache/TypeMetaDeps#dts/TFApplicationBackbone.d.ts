// TypeScript definitions for the C3 type TFApplicationBackbone

/**
 * The Backbone of object detection
 *
 * @remarks this represents a value passed to a method that expects an instance of TFApplicationBackbone
 */
declare interface ITFApplicationBackbone {
  ...
  /**
   * The layers will be used to generate the output.
   * E.g, ['block4a_activation','top_conv']
   */
  layerNames: Array_Type<string> | Array<string>;

  /**
   * Whether the backbone layers are trainable. The length needs to be one or
   * match the number of layers in the model
   */
  trainable?: boolean;

  /**
   * Class of the backbone models, for example EfficientNet contains several
   * different size of models like B0, B1 ...
   */
  className: string;

  /**
   * Type of the model like EfficientNetB0, DenseNet121, etc ...
   */
  modelName: string;
  ...
  /**
   * Parameters used for backbone initialization in training. This will
   * default to {'include_top': True, 'weights': 'imagenet'} if not given
   */
  initParams?: Map_Type<string, any> | {[key: string]: any};
}

/**
 * The Backbone of object detection
 *
 * @remarks this represents a made instance of TFApplicationBackbone
 */
declare class TFApplicationBackbone extends Obj  {
  ...
  withTypeIdent(typeIdent: string | null): TFApplicationBackbone;
   ...
   */
  readonly id: string;
  withId(id: string): TFApplicationBackbone;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): TFApplicationBackbone;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): TFApplicationBackbone;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): TFApplicationBackbone;
  ...
  withVersion(version: number | null): TFApplicationBackbone;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): TFApplicationBackbone;

  /**
   * The layers will be used to generate the output.
   * E.g, ['block4a_activation','top_conv']
   */
  readonly layerNames: Array_Type<string>;
  withLayerNames(layerNames: Array_Type<string> | Array<string>): TFApplicationBackbone;
  ...
  withTrainable(trainable: boolean): TFApplicationBackbone;
  ...
  withClassName(className: string): TFApplicationBackbone;

  /**
   * Type of the model like EfficientNetB0, DenseNet121, etc ...
   */
  readonly modelName: string;
  withModelName(modelName: string): TFApplicationBackbone;

  /**
   * Trained tensorflow model file
   */
  readonly h5: File;
  withH5(h5: IFile): TFApplicationBackbone;

  /**
   * Parameters used for backbone initialization in training. This will
   * default to {'include_top': True, 'weights': 'imagenet'} if not given
   */
  readonly initParams?: Map_Type<string, any>;
  withInitParams(initParams: Map_Type<string, any> | {[key: string]: any} | null): TFApplicationBackbone;
   ...
   * @see #toJson
   */
  static fromJson(json: any): TFApplicationBackbone | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): TFApplicationBackbone | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): TFApplicationBackbone | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): TFApplicationBackbone | null;
   ...
   */
  replaceType(old: Type, new_: Type): TFApplicationBackbone;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): TFApplicationBackbone;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): TFApplicationBackbone;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<TFApplicationBackbone>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<TFApplicationBackbone>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): TFApplicationBackbone;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TFApplicationBackbone;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TFApplicationBackbone;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): TFApplicationBackbone;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): TFApplicationBackbone;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): TFApplicationBackbone;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): TFApplicationBackbone;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): TFApplicationBackbone;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): TFApplicationBackbone;
   ...
   * @see #removeField
   */
  withoutField(field: string): TFApplicationBackbone;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): TFApplicationBackbone;
   ...
   */
  withoutFields(fields: Array_Type<string>): TFApplicationBackbone;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): TFApplicationBackbone;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): TFApplicationBackbone;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): TFApplicationBackbone;
   ...
   * @see #unsetField
   */
  defaultField(field: string): TFApplicationBackbone;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): TFApplicationBackbone;
   ...
   * @see #removeField
   */
  unsetField(field: string): TFApplicationBackbone;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): TFApplicationBackbone;
   ...
   * @see #unsetField
   */
  removeField(field: string): TFApplicationBackbone;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): TFApplicationBackbone;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): TFApplicationBackbone;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): TFApplicationBackbone;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): TFApplicationBackbone;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): TFApplicationBackbone;

  mergeJson(json: any): TFApplicationBackbone;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): TFApplicationBackbone;
   ...
   */
  sumObj(other: Obj, deep?: boolean): TFApplicationBackbone;
   ...
   */
  singletonArray(): Array_Type<TFApplicationBackbone>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<TFApplicationBackbone> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<TFApplicationBackbone> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<TFApplicationBackbone>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<TFApplicationBackbone> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, TFApplicationBackbone> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, TFApplicationBackbone> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<TFApplicationBackbone>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<TFApplicationBackbone>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): TFApplicationBackbone;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): TFApplicationBackbone;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): TFApplicationBackbone;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): TFApplicationBackbone;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): TFApplicationBackbone;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): TFApplicationBackbone;
   ...
   * @see #fromString
   */
  static make(s: string): TFApplicationBackbone | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): TFApplicationBackbone;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): TFApplicationBackbone;
   ...
   */
  static cachedEmptyInst(): TFApplicationBackbone;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<TFApplicationBackbone> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): TFApplicationBackbone;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<TFApplicationBackbone>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<TFApplicationBackbone>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<TFApplicationBackbone> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<TFApplicationBackbone>> | null;
   ...
   */
  get(include?: string): TFApplicationBackbone | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): TFApplicationBackbone | null;
   ...
   */
  getMissing(spec: GetMissingSpec): TFApplicationBackbone;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): TFApplicationBackbone | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): TFApplicationBackbone;
   ...
   * @see #toString
   */
  static fromString(s: string): TFApplicationBackbone | null;
   ...
   */
  create(spec?: UpsertSpec): TFApplicationBackbone | null;
   ...
   */
  static createBatch(objs: Array_Type<TFApplicationBackbone>, spec?: UpsertSpec): ObjList<TFApplicationBackbone> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<TFApplicationBackbone>, spec?: CreateBatchObjStreamSpec): ObjList<TFApplicationBackbone> | null;
   ...
   */
  update(srcObj?: TFApplicationBackbone, spec?: UpsertSpec): TFApplicationBackbone | null;
   ...
   */
  upsert(srcObj?: TFApplicationBackbone, spec?: UpsertSpec): TFApplicationBackbone | null;
   ...
   */
  merge(spec?: MergeSpec): TFApplicationBackbone | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): TFApplicationBackbone | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): TFApplicationBackbone | null;
   ...
   */
  static updateBatch(objs: Array_Type<TFApplicationBackbone>, srcObjs?: Array_Type<TFApplicationBackbone>, spec?: UpsertSpec): ObjList<TFApplicationBackbone> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<TFApplicationBackbone> | null>, spec?: UpsertSpec): ObjList<TFApplicationBackbone> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<TFApplicationBackbone>, srcObjs?: Array_Type<TFApplicationBackbone>, spec?: UpsertSpec): ObjList<TFApplicationBackbone> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<TFApplicationBackbone> | null>, spec?: UpsertSpec): ObjList<TFApplicationBackbone> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<TFApplicationBackbone>, spec?: TouchSpec): ObjList<TFApplicationBackbone> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<TFApplicationBackbone>, spec?: MergeSpec): ObjList<TFApplicationBackbone> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<TFApplicationBackbone>, mergeInclude: string, spec?: MergeSpec): ObjList<TFApplicationBackbone> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<TFApplicationBackbone> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<TFApplicationBackbone> | null;
   ...
   */
  static mergeAll(mergeObj: TFApplicationBackbone, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: TFApplicationBackbone, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<TFApplicationBackbone>, spec?: UpsertSpec): ObjList<TFApplicationBackbone> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<TFApplicationBackbone>, spec?: UpsertSpec): ObjList<TFApplicationBackbone> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): TFApplicationBackbone | null;
   ...
   */
  static beforeCreate(objs: Array_Type<TFApplicationBackbone>): ObjList<TFApplicationBackbone>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<TFApplicationBackbone>): ObjList<TFApplicationBackbone>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<TFApplicationBackbone>): ObjList<TFApplicationBackbone>;
   ...
   */
  static afterCreate(objs: Array_Type<TFApplicationBackbone>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<TFApplicationBackbone>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<TFApplicationBackbone>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<TFApplicationBackbone>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<TFApplicationBackbone>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): TFApplicationBackbone | null;
   ...
   */
  withoutIdentity(): TFApplicationBackbone | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<TFApplicationBackbone>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: TFApplicationBackbone, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<TFApplicationBackbone>, callback?: λFunction<TFApplicationBackbone | null, TFApplicationBackbone | null>): ObjList<TFApplicationBackbone>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<TFApplicationBackbone>, callback?: λFunction<TFApplicationBackbone | null, TFApplicationBackbone | null>): Array_Type<ObjError> | null;
  ...
  /**
   * Convert backbone to native tensorflow, keras, pytorch, ... type object
   * so it can be used together with downstream models
   */
  toNative(): any;

  /**
   * Apply backbone and extract features from the inputs
   *
   * @param inputs images or other formats compatible with the backbone
   * @return feature tensors or features vectors for the inputs
   */
  extract(inputs: Array_Type<any>): Array_Type<any>;

  /**
   * Save a native tensorflow/keras model to a h5 file and create a new persisted
   * {@link TFApplicationBackbone} entity. The other fields, such as {@link modelName},
   * {@link layerNames}, and {@link trainable} will remain the same.
   */
  updateWithNative(model: any): TFApplicationBackbone;
}
