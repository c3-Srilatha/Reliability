// TypeScript definitions for the C3 type DiagramParsingConfig

/**
 * Configurations for the Diagram Parsing module.
 *
 * @remarks this represents a value passed to a method that expects an instance of DiagramParsingConfig
 */
declare interface IDiagramParsingConfig {
  ...
  /**
   * Specific type name for connected assets. Type referenced must be/extend {@link PhysicalAsset}.
   */
  assetTypeName?: string;

  /**
   * An ordered list used to determine inclusive upper bounds for match confidence scores for {DiagramParsingConfig#matchConfidenceLevels}.
   * For example, by default, a match confidence score of 0.6 implies Medium match confidence and that of 0.9 implies High match confidence.
   *
   * Note: *order matters* the match confidence score at index 0 corresponds to lowest possible score for match confidence.
   * [0.5, 0.75, 1]
   * ['Low', 'Medium', 'High']
   */
  matchConfidenceScoreUpperBounds?: Array_Type<number> | Array<number>;

  /**
   * An ordered list used to determine all strings match confidence can qualitatively be set to depending on {DiagramParsingConfig#matchConfidenceScoreUpperBounds}.
   * For example, the default Medium match confidence corresponds to a match confidence score less than or equal to 0.75 but greater than 0.5.
   *
   * **IMPORTANT: If you modify this list, you must also modify the match confidence column on DiagramDetailSensorMatchVerificationGrid to match.**
   *
   * Note: *order matters* the match confidence score at index 0 corresponds to lowest possible match confidence level.
   *
   * Note: *case sensitive*.
   */
  matchConfidenceLevels?: Array_Type<string> | Array<string>;

  /**
   * An ordered list used to map each match confidence level to a color on the UI.
   * See {DiagramParsingConfig#matchConfidenceLevels} for more information.
   *
   * Note: If an opaque color is provided, the alpha value will be set to 0.5 on the Diagram Viewer.
   *
   * Note: Currently will only affect the Diagram Viewer, and the Grid will have to be manually updated to match.
   */
  matchConfidenceLevelColors?: Array_Type<string> | Array<string>;
}

/**
 * Configurations for the Diagram Parsing module.
 *
 * @remarks this represents a made instance of DiagramParsingConfig
 */
declare class DiagramParsingConfig extends Obj  {

  readonly configOverride?: string;
  withConfigOverride(configOverride: string | null): DiagramParsingConfig;

  static readonly configOverride?: string;

  readonly secretOverride?: string;
  withSecretOverride(secretOverride: string | null): DiagramParsingConfig;
  ...
  withIssues(issues: Array_Type<string> | Array<string> | null): DiagramParsingConfig;
  ...
  withAssetTypeName(assetTypeName: string | null): DiagramParsingConfig;
   ...
   * ['Low', 'Medium', 'High']
   */
  readonly matchConfidenceScoreUpperBounds?: Array_Type<number>;
  withMatchConfidenceScoreUpperBounds(matchConfidenceScoreUpperBounds: Array_Type<number> | Array<number> | null): DiagramParsingConfig;
   ...
   * ['Low', 'Medium', 'High']
   */
  static readonly matchConfidenceScoreUpperBounds?: Array_Type<number>;
   ...
   * Note: *case sensitive*.
   */
  readonly matchConfidenceLevels?: Array_Type<string>;
  withMatchConfidenceLevels(matchConfidenceLevels: Array_Type<string> | Array<string> | null): DiagramParsingConfig;
   ...
   * Note: *case sensitive*.
   */
  static readonly matchConfidenceLevels?: Array_Type<string>;
   ...
   * Note: Currently will only affect the Diagram Viewer, and the Grid will have to be manually updated to match.
   */
  readonly matchConfidenceLevelColors?: Array_Type<string>;
  withMatchConfidenceLevelColors(matchConfidenceLevelColors: Array_Type<string> | Array<string> | null): DiagramParsingConfig;
   ...
   * @see #toJson
   */
  static fromJson(json: any): DiagramParsingConfig | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): DiagramParsingConfig | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): DiagramParsingConfig | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): DiagramParsingConfig | null;
   ...
   */
  replaceType(old: Type, new_: Type): DiagramParsingConfig;
   ...
   * This method is used during live metadata update
   */
  static replaceType(old: Type, new_: Type): DiagramParsingConfig;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): DiagramParsingConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): DiagramParsingConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): DiagramParsingConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): DiagramParsingConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<DiagramParsingConfig>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<DiagramParsingConfig>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<DiagramParsingConfig>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<DiagramParsingConfig>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): DiagramParsingConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): DiagramParsingConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DiagramParsingConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DiagramParsingConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DiagramParsingConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DiagramParsingConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): DiagramParsingConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  static validateObj(): DiagramParsingConfig;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): DiagramParsingConfig;
   ...
   * @see #defaultField
   */
  static withField(field: string, value: any, doNotConvert?: boolean): DiagramParsingConfig;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): DiagramParsingConfig;
   ...
   * @see #defaultField
   */
  static withField(field: FieldType, value: any, doNotConvert?: boolean): DiagramParsingConfig;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): DiagramParsingConfig;
   ...
   * @return new Obj
   */
  static withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): DiagramParsingConfig;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): DiagramParsingConfig;
   ...
   * @return new Obj
   */
  static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): DiagramParsingConfig;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): DiagramParsingConfig;
   ...
   * @see #withoutField
   */
  static withoutFieldAtPath(path: string): DiagramParsingConfig;
   ...
   * @see #removeField
   */
  withoutField(field: string): DiagramParsingConfig;
   ...
   * @see #removeField
   */
  static withoutField(field: string): DiagramParsingConfig;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): DiagramParsingConfig;
   ...
   * @see #removeField
   */
  static withoutField(field: FieldType): DiagramParsingConfig;
   ...
   */
  withoutFields(fields: Array_Type<string>): DiagramParsingConfig;
   ...
   * @return new Obj with removed fields
   */
  static withoutFields(fields: Array_Type<string>): DiagramParsingConfig;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): DiagramParsingConfig;
   ...
   * @return new Obj with removed fields
   */
  static withoutFieldsByType(fields: Array_Type<FieldType>): DiagramParsingConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): DiagramParsingConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  static withoutSecretFields(): DiagramParsingConfig;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): DiagramParsingConfig;
   ...
   * @see FieldType#defaultValue
   */
  static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): DiagramParsingConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: string): DiagramParsingConfig;
   ...
   * @see #unsetField
   */
  static defaultField(field: string): DiagramParsingConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): DiagramParsingConfig;
   ...
   * @see #unsetField
   */
  static defaultField(field: FieldType): DiagramParsingConfig;
   ...
   * @see #removeField
   */
  unsetField(field: string): DiagramParsingConfig;
   ...
   * @see #removeField
   */
  static unsetField(field: string): DiagramParsingConfig;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): DiagramParsingConfig;
   ...
   * @see #removeField
   */
  static unsetField(field: FieldType): DiagramParsingConfig;
   ...
   * @see #unsetField
   */
  removeField(field: string): DiagramParsingConfig;
   ...
   * @see #unsetField
   */
  static removeField(field: string): DiagramParsingConfig;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): DiagramParsingConfig;
   ...
   * @see #unsetField
   */
  static removeField(field: FieldType): DiagramParsingConfig;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): DiagramParsingConfig;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): DiagramParsingConfig;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): DiagramParsingConfig;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj, otherFieldsFilter: Type): DiagramParsingConfig;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): DiagramParsingConfig;
   ...
   *        the same key or index.
   */
  static mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): DiagramParsingConfig;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): DiagramParsingConfig;
   ...
   * traverse child reference and collection fields.
   */
  static mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): DiagramParsingConfig;

  mergeJson(json: any): DiagramParsingConfig;

  static mergeJson(json: any): DiagramParsingConfig;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): DiagramParsingConfig;
   ...
   * @return Obj with child references merged
   */
  static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): DiagramParsingConfig;
   ...
   */
  sumObj(other: Obj, deep?: boolean): DiagramParsingConfig;
   ...
   * references with same name and collection elements at same index or key.
   */
  static sumObj(other: Obj, deep?: boolean): DiagramParsingConfig;
   ...
   */
  singletonArray(): Array_Type<DiagramParsingConfig>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonArray(): Array_Type<DiagramParsingConfig>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<DiagramParsingConfig> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<DiagramParsingConfig> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<DiagramParsingConfig>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonSet(): Set_Type<DiagramParsingConfig>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<DiagramParsingConfig> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, DiagramParsingConfig> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, DiagramParsingConfig> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<DiagramParsingConfig>;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  static toBuilder(): ObjBuilder<DiagramParsingConfig>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<DiagramParsingConfig>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): DiagramParsingConfig;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): DiagramParsingConfig;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): DiagramParsingConfig;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): DiagramParsingConfig;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): DiagramParsingConfig;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): DiagramParsingConfig;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): DiagramParsingConfig;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): DiagramParsingConfig;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  static afterMake(): DiagramParsingConfig;
   ...
   */
  static cachedEmptyInst(): DiagramParsingConfig;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<DiagramParsingConfig> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): DiagramParsingConfig;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<DiagramParsingConfig> | null;
   ...
   */
  static find(filter?: string, doNotProduceAll?: boolean): Stream<DiagramParsingConfig> | null;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<DiagramParsingConfig> | null;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): DiagramParsingConfig | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string): DiagramParsingConfig | null;
   ...
   * @see findByCacheKey
   */
  getCached(): DiagramParsingConfig | null;
   ...
   * @see findByCacheKey
   */
  static getCached(): DiagramParsingConfig | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): DiagramParsingConfig | null;

  /**
   * @return newly produced cached instance.
   */
  static refreshCache(): DiagramParsingConfig | null;
   ...
   */
  static produce(key: string): DiagramParsingConfig | null;
   ...
   */
  static produceAll(): Map_Type<string, DiagramParsingConfig> | null;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): Map_Type<string, DiagramParsingConfig> | null;
   ...
   */
  getConfig(): DiagramParsingConfig;
   ...
   * Note that typical pattern is to use Configurable#config instead of this method.
   */
  static getConfig(): DiagramParsingConfig;
   ...
   */
  getSecret(): DiagramParsingConfig;
   ...
   * Note that typical pattern is to use Configurable#configWithSecrets instead of this method.
   */
  static getSecret(): DiagramParsingConfig;
   ...
   */
  withConfigKey(configKey: string): DiagramParsingConfig;
   ...
   *     config.configKey() => "folder1/abc"
   */
  static withConfigKey(configKey: string): DiagramParsingConfig;

  /**
   * @return copy without config key.
   */
  withoutConfigKey(): DiagramParsingConfig;

  /**
   * @return copy without config key.
   */
  static withoutConfigKey(): DiagramParsingConfig;

  /**
   * @return return cached config instance for provided config key.
   */
  static forConfigKey(configKey: string): DiagramParsingConfig | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string>): Stream<DiagramParsingConfig> | null;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: DiagramParsingConfig, override?: string): void;

  /**
   * Sets multiple field values to be the same as the passed instance.
   * @see setConfigValue
   */
  static setConfigValues(from: DiagramParsingConfig, override?: string): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: DiagramParsingConfig, override?: string): void;

  /**
   * Sets multiple secret field values to be the same as the passed instance.
   * @see setSecretValue
   */
  static setSecretValues(from: DiagramParsingConfig, override?: string): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): DiagramParsingConfig | null;
   ...
   */
  removeSecrets(): DiagramParsingConfig | null;

  /**
   * @return this config without any secret values.
   */
  static removeSecrets(): DiagramParsingConfig | null;

  /**
   * @return this config with only secret values.
   */
  removeNonSecrets(): DiagramParsingConfig | null;

  /**
   * @return this config with only secret values.
   */
  static removeNonSecrets(): DiagramParsingConfig | null;

  /**
   * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
   * validation and setup.
   */
  validate(): DiagramParsingConfig;

  /**
   * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
   * validation and setup.
   */
  static validate(): DiagramParsingConfig;
