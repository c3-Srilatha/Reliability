// TypeScript definitions for the C3 type LabeledDiagram

/**
 * Represents a {@link ParsableDiagram} with labeled bounding boxes.
 *
 * @remarks this represents a value passed to a method that expects an instance of LabeledDiagram
 */
declare interface ILabeledDiagram {
   ...
   */
  sourceDiagram?: ISourceParsableDiagram;
   ...
   */
  extracts?: Array_Type<ParsedDiagramExtract> | Array<IParsedDiagramExtract>;

  /**
   * Latest {@link ParsedDiagramExtract} created for this diagram.
   */
  latestExtract?: IParsedDiagramExtract;

  /**
   * Latest {@link ParsedDiagramExtract}'s sensor count created for this diagram.
   */
  latestExtractSensorCount?: number;

  /**
   * Collection of {@link ParsedAsset}s extracted by parsing the diagram.
   */
  assets?: Array_Type<ParsedAsset> | Array<IParsedAsset>;

  /**
   * Collection of {@link ParsedSensor}s associated with all the `extracts` of this diagram.
   */
  sensors?: Array_Type<ParsedSensor> | Array<IParsedSensor>;

  /**
   * {@link PhysicalAsset} relations associated with this diagram.
   */
  connectedAssetRelations?: Array_Type<ParsableDiagramToPhysicalAssetRelation> | Array<IParsableDiagramToPhysicalAssetRelation>;

  /**
   * The number of connected {@link PhysicalAsset}s.
   */
  numConnectedAssets?: number;
   ...
   */
  lastUpdate?: IParsableDiagramUpdateInfo;
  ...
  /**
   * Bounding boxes contains all the label information and the location information
   */
  boxes: Array_Type<DiagramParsingBoundingBox> | Array<IDiagramParsingBoundingBox>;

  /**
   * Bounding box contains all the label information and the location information
   */
  classToBoxes?: Map_Type<string, Array_Type<DiagramParsingBoundingBox>> | {[key: string]: Array_Type<DiagramParsingBoundingBox> | Array<IDiagramParsingBoundingBox>};
}

/**
 * Represents a {@link ParsableDiagram} with labeled bounding boxes.
 *
 * @remarks this represents a made instance of LabeledDiagram
 */
declare class LabeledDiagram extends Obj  {

  /**
   * The id of this instance.
   */
  readonly id: string;
  withId(id: string): LabeledDiagram;
  ...
  withTypeIdent(typeIdent: string | null): LabeledDiagram;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): LabeledDiagram;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): LabeledDiagram;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): LabeledDiagram;
  ...
  withVersion(version: number | null): LabeledDiagram;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): LabeledDiagram;
  ...
  withSource(source: IFile): LabeledDiagram;
  ...
  withImageFile(imageFile: IFile): LabeledDiagram;

  /**
   * The {@link SourceParsableDiagram} which has the original source of diagrams in either a pdf or an image.
   * Notice that multiple {@link ParsableDiagram} can reference to the same {@link SourceParsableDiagram}.
   */
  readonly sourceDiagram?: SourceParsableDiagram;
  withSourceDiagram(sourceDiagram: ISourceParsableDiagram | null): LabeledDiagram;

  /**
   * pid number, default to p&id file name, might be duplicate if p&id have multiple pages
   */
  readonly pidNumber?: string;
  withPidNumber(pidNumber: string | null): LabeledDiagram;
   ...
   * {@link ParsedDiagramExtract}s are accessbile from this field.
   */
  readonly extracts?: Array_Type<ParsedDiagramExtract>;
  withExtracts(extracts: Array_Type<ParsedDiagramExtract> | Array<IParsedDiagramExtract> | null): LabeledDiagram;

  /**
   * Latest {@link ParsedDiagramExtract} created for this diagram.
   */
  readonly latestExtract?: ParsedDiagramExtract;
  withLatestExtract(latestExtract: IParsedDiagramExtract | null): LabeledDiagram;

  /**
   * Latest {@link ParsedDiagramExtract}'s sensor count created for this diagram.
   */
  readonly latestExtractSensorCount?: number;
  withLatestExtractSensorCount(latestExtractSensorCount: number | null): LabeledDiagram;

  /**
   * Collection of {@link ParsedAsset}s extracted by parsing the diagram.
   */
  readonly assets?: Array_Type<ParsedAsset>;
  withAssets(assets: Array_Type<ParsedAsset> | Array<IParsedAsset> | null): LabeledDiagram;

  /**
   * Collection of {@link ParsedSensor}s associated with all the `extracts` of this diagram.
   */
  readonly sensors?: Array_Type<ParsedSensor>;
  withSensors(sensors: Array_Type<ParsedSensor> | Array<IParsedSensor> | null): LabeledDiagram;

  /**
   * {@link PhysicalAsset} relations associated with this diagram.
   */
  readonly connectedAssetRelations?: Array_Type<ParsableDiagramToPhysicalAssetRelation>;
  withConnectedAssetRelations(connectedAssetRelations: Array_Type<ParsableDiagramToPhysicalAssetRelation> | Array<IParsableDiagramToPhysicalAssetRelation> | null): LabeledDiagram;

  /**
   * The number of connected {@link PhysicalAsset}s.
   */
  readonly numConnectedAssets?: number;
  withNumConnectedAssets(numConnectedAssets: number | null): LabeledDiagram;
   ...
   *   connecting {@link PhysicalAsset}s
   */
  readonly lastUpdate?: ParsableDiagramUpdateInfo;
  withLastUpdate(lastUpdate: IParsableDiagramUpdateInfo | null): LabeledDiagram;
  ...
  withParsingStatus(parsingStatus: string | null): LabeledDiagram;

  /**
   * A translated representation of {@link ParsableDiagram#parsingStatus} to be used in the UI.
   */
  readonly displayStatus?: string;
  withDisplayStatus(displayStatus: string | null): LabeledDiagram;

  /**
   * Bounding boxes contains all the label information and the location information
   */
  readonly boxes: Array_Type<DiagramParsingBoundingBox>;
  withBoxes(boxes: Array_Type<DiagramParsingBoundingBox> | Array<IDiagramParsingBoundingBox>): LabeledDiagram;

  /**
   * Bounding box contains all the label information and the location information
   */
  readonly classToBoxes?: Map_Type<string, Array_Type<DiagramParsingBoundingBox>>;
  withClassToBoxes(classToBoxes: Map_Type<string, Array_Type<DiagramParsingBoundingBox>> | {[key: string]: Array_Type<DiagramParsingBoundingBox> | Array<IDiagramParsingBoundingBox>} | null): LabeledDiagram;
   ...
   * @see #toJson
   */
  static fromJson(json: any): LabeledDiagram | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): LabeledDiagram | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): LabeledDiagram | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): LabeledDiagram | null;
   ...
   */
  replaceType(old: Type, new_: Type): LabeledDiagram;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): LabeledDiagram;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): LabeledDiagram;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<LabeledDiagram>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<LabeledDiagram>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): LabeledDiagram;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): LabeledDiagram;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): LabeledDiagram;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): LabeledDiagram;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): LabeledDiagram;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): LabeledDiagram;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): LabeledDiagram;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): LabeledDiagram;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): LabeledDiagram;
   ...
   * @see #removeField
   */
  withoutField(field: string): LabeledDiagram;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): LabeledDiagram;
   ...
   */
  withoutFields(fields: Array_Type<string>): LabeledDiagram;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): LabeledDiagram;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): LabeledDiagram;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): LabeledDiagram;
   ...
   * @see #unsetField
   */
  defaultField(field: string): LabeledDiagram;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): LabeledDiagram;
   ...
   * @see #removeField
   */
  unsetField(field: string): LabeledDiagram;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): LabeledDiagram;
   ...
   * @see #unsetField
   */
  removeField(field: string): LabeledDiagram;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): LabeledDiagram;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): LabeledDiagram;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): LabeledDiagram;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): LabeledDiagram;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): LabeledDiagram;

  mergeJson(json: any): LabeledDiagram;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): LabeledDiagram;
   ...
   */
  sumObj(other: Obj, deep?: boolean): LabeledDiagram;
   ...
   */
  singletonArray(): Array_Type<LabeledDiagram>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<LabeledDiagram> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<LabeledDiagram> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<LabeledDiagram>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<LabeledDiagram> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, LabeledDiagram> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, LabeledDiagram> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<LabeledDiagram>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<LabeledDiagram>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): LabeledDiagram;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): LabeledDiagram;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): LabeledDiagram;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): LabeledDiagram;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): LabeledDiagram;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): LabeledDiagram;
   ...
   * @see #fromString
   */
  static make(s: string): LabeledDiagram | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): LabeledDiagram;
   ...
   */
  static cachedEmptyInst(): LabeledDiagram;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<LabeledDiagram> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): LabeledDiagram;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<LabeledDiagram>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<LabeledDiagram>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<LabeledDiagram> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<LabeledDiagram>> | null;
   ...
   */
  static evalFeatureSetBatch(batch: Array_Type<LabeledDiagram>, featureSet: Feature.Set, spec?: EvalFeatureSpec): Data | null;
   ...
   * ```
   */
  static evalFeaturesBatch(batch: Array_Type<LabeledDiagram>, features: Array_Type<string>, spec?: EvalFeaturesSpec): Data | null;
   ...
   * @see #toString
   */
  static fromString(s: string): LabeledDiagram | null;
   ...
   */
  get(include?: string): LabeledDiagram | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): LabeledDiagram | null;
   ...
   */
  getMissing(spec: GetMissingSpec): LabeledDiagram;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): LabeledDiagram | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): LabeledDiagram;
   ...
   */
  create(spec?: UpsertSpec): LabeledDiagram | null;
   ...
   */
  static createBatch(objs: Array_Type<LabeledDiagram>, spec?: UpsertSpec): ObjList<LabeledDiagram> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<LabeledDiagram>, spec?: CreateBatchObjStreamSpec): ObjList<LabeledDiagram> | null;
   ...
   */
  update(srcObj?: LabeledDiagram, spec?: UpsertSpec): LabeledDiagram | null;
   ...
   */
  upsert(srcObj?: LabeledDiagram, spec?: UpsertSpec): LabeledDiagram | null;
   ...
   */
  merge(spec?: MergeSpec): LabeledDiagram | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): LabeledDiagram | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): LabeledDiagram | null;
   ...
   */
  static updateBatch(objs: Array_Type<LabeledDiagram>, srcObjs?: Array_Type<LabeledDiagram>, spec?: UpsertSpec): ObjList<LabeledDiagram> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<LabeledDiagram> | null>, spec?: UpsertSpec): ObjList<LabeledDiagram> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<LabeledDiagram>, srcObjs?: Array_Type<LabeledDiagram>, spec?: UpsertSpec): ObjList<LabeledDiagram> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<LabeledDiagram> | null>, spec?: UpsertSpec): ObjList<LabeledDiagram> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<LabeledDiagram>, spec?: TouchSpec): ObjList<LabeledDiagram> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<LabeledDiagram>, spec?: MergeSpec): ObjList<LabeledDiagram> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<LabeledDiagram>, mergeInclude: string, spec?: MergeSpec): ObjList<LabeledDiagram> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<LabeledDiagram> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<LabeledDiagram> | null;
   ...
   */
  static mergeAll(mergeObj: LabeledDiagram, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: LabeledDiagram, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<LabeledDiagram>, spec?: UpsertSpec): ObjList<LabeledDiagram> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<LabeledDiagram>, spec?: UpsertSpec): ObjList<LabeledDiagram> | null;
   ...
   */
  static beforeCreate(objs: Array_Type<LabeledDiagram>): ObjList<LabeledDiagram>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<LabeledDiagram>): ObjList<LabeledDiagram>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<LabeledDiagram>): ObjList<LabeledDiagram>;
   ...
   */
  static afterCreate(objs: Array_Type<LabeledDiagram>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<LabeledDiagram>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<LabeledDiagram>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<LabeledDiagram>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<LabeledDiagram>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): LabeledDiagram | null;
   ...
   */
  withoutIdentity(): LabeledDiagram | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<LabeledDiagram>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: LabeledDiagram, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<LabeledDiagram>, callback?: λFunction<LabeledDiagram | null, LabeledDiagram | null>): ObjList<LabeledDiagram>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<LabeledDiagram>, callback?: λFunction<LabeledDiagram | null, LabeledDiagram | null>): Array_Type<ObjError> | null;
   ...
   */
  connectAssetToDiagram(asset?: PhysicalAsset): void;

  /**
   * Helper that takes in the formfields and passes only the {@link PhysicalAsset} to `connectAssetToDiagram`
   */
  submitConnectForm(formObject?: any): ParsableDiagram | null;
   ...
   */
  static updateDiagramAndImageNames(formObj?: any): ParsableDiagram | null;
   ...
   */
  static deleteBatch(diagrams: Array_Type<LabeledDiagram>): ObjList<LabeledDiagram> | null;
   ...
   */
  static unverifySensorsOnLatestExtract(diagramIds?: Array_Type<string>): void;

  /**
   * Check if a class label is present in the one of the bounding boxes
   */
  hasTarget(target: string): boolean;

  /**
   * Convert the diagram to a numpy array.
   *
   * @param zoom the zoom factor for scaling the image. The default value is 1.0.
   */
  toArray(zoom?: number = '1.0'): any;

  /**
   * Rescale the image and bounding boxes and create a new entity of LabeledDiagram.
   *
   * @param zoom the zoom factor for scaling the image.
   * @param destImageUrl the destination url to save the rescaled image.
   */
  rescale(zoom?: number, destImageUrl?: string): LabeledDiagram;

  /**
   * Constructor method that combines a {@link ParsableDiagram} and an XML from image annotation
   * tools to form a unified {@link LabeledDiagram} with {@link boxes}
   *
   * @param diagram an existing {@link ParsableDiagram}
   * @param xml the text read from a XML file. For example, you can use the python code below to read
   * an xml file into text:
   * ```py
   * with open("./dummy.xml") as f: xml = f.read()
   * ```
   */
  static fromXml(diagram: ParsableDiagram, xml: string): LabeledDiagram;

  /**
   * Visualize the labeled diagram with bounding boxes
   */
  show(targets?: Array_Type<string>): void;
}
