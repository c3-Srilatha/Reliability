// TypeScript definitions for the C3 type CannyEdgeDetectionPipe

/**
 * Pipe for detecting connections among entities typically found by detecting objects in an image.
 *
 * @remarks this represents a value passed to a method that expects an instance of CannyEdgeDetectionPipe
 */
declare interface ICannyEdgeDetectionPipe {
  ...
  /**
   * The name of the column containing {@link DiagramParsingBoundingBox}s for the detected symbols.
   */
  boundingBoxColumnName: string;

  /**
   * The name of the column containing the urls of the files to convert.
   */
  imageColumnName: string;

  /**
   * Threshold for consider as line
   */
  imageThresholdValue: number;

  /**
   * Minimum distance between dashed lines to be considered as connected
   */
  dashedLineDetectionMinLineLength: number;

  /**
   * Maximum distance between dashed lines to be considered as connected
   */
  dashedLineDetectionMaxLineGap: number;
}

/**
 * Pipe for detecting connections among entities typically found by detecting objects in an image.
 *
 * @remarks this represents a made instance of CannyEdgeDetectionPipe
 */
declare class CannyEdgeDetectionPipe extends Obj  {
   ...
   */
  readonly id: string;
  withId(id: string): CannyEdgeDetectionPipe;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): CannyEdgeDetectionPipe;

  /**
   * Name of this pipe.
   */
  readonly name?: string;
  withName(name: string | null): CannyEdgeDetectionPipe;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): CannyEdgeDetectionPipe;
  ...
  withVersion(version: number | null): CannyEdgeDetectionPipe;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): CannyEdgeDetectionPipe;
  ...
  withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): CannyEdgeDetectionPipe;
  ...
  withHidden(hidden: boolean): CannyEdgeDetectionPipe;
  ...
  withUserOwned(userOwned: boolean): CannyEdgeDetectionPipe;
  ...
  withTypeIdent(typeIdent: string | null): CannyEdgeDetectionPipe;

  /**
   * If true, then the pipe shall not be retrained
   */
  readonly frozen?: boolean;
  withFrozen(frozen: boolean): CannyEdgeDetectionPipe;

  /**
   * True if training has succeeded and false otherwise.
   */
  readonly trained?: boolean;
  withTrained(trained: boolean): CannyEdgeDetectionPipe;

  /**
   * Errors from training.
   */
  readonly trainingErrors?: string;
  withTrainingErrors(trainingErrors: string | null): CannyEdgeDetectionPipe;

  /**
   * If true, the underlying model only accepts flattened input.
   */
  readonly flattenInput?: boolean;
  withFlattenInput(flattenInput: boolean): CannyEdgeDetectionPipe;

  /**
   * The hyperparameters overridden of a native model or pipe.
   */
  readonly hyperparamOverrides?: Map_Type<string, any>;
  withHyperparamOverrides(hyperparamOverrides: Map_Type<string, any> | {[key: string]: any} | null): CannyEdgeDetectionPipe;
  ...
  withHyperparamSearchSpace(hyperparamSearchSpace: IHp.SearchSpace | null): CannyEdgeDetectionPipe;
  ...
  withHpoSpec(hpoSpec: IHpo.Spec | null): CannyEdgeDetectionPipe;

  /**
   * {@link Hpo.Experiment} stores the result of hyperparameter optimization to find the best model/pipeline.
   */
  readonly hpoExperiment?: Hpo.Experiment;
  withHpoExperiment(hpoExperiment: IHpo.Experiment | null): CannyEdgeDetectionPipe;

  /**
   * Reference to the experiment that produced this {@link MlPipe}. For example, this could be a {@link Hpo.ExperimentBase}.
   */
  readonly experiment?: any;
  withExperiment(experiment: any | null): CannyEdgeDetectionPipe;
  ...
  withModelFiles(modelFiles: Map_Type<string, Url> | {[key: string]: IUrl} | null): CannyEdgeDetectionPipe;
  ...
  withCustomModelCode(customModelCode: Map_Type<string, any> | {[key: string]: any} | null): CannyEdgeDetectionPipe;

  /**
   * Name for the function on the native model to call to do {@link MlProcessable#process}.
   */
  readonly processFunc?: string;
  withProcessFunc(processFunc: string | null): CannyEdgeDetectionPipe;
  ...
  withUnderlyingPipe(underlyingPipe: IMlAtomicPipe<any, any, any> | null): CannyEdgeDetectionPipe;

  /**
   * The name of the column containing {@link DiagramParsingBoundingBox}s for the detected symbols.
   */
  readonly boundingBoxColumnName: string;
  withBoundingBoxColumnName(boundingBoxColumnName: string): CannyEdgeDetectionPipe;

  /**
   * The name of the column containing the urls of the files to convert.
   */
  readonly imageColumnName: string;
  withImageColumnName(imageColumnName: string): CannyEdgeDetectionPipe;

  /**
   * Threshold for consider as line
   */
  readonly imageThresholdValue: number;
  withImageThresholdValue(imageThresholdValue: number): CannyEdgeDetectionPipe;

  /**
   * Minimum distance between dashed lines to be considered as connected
   */
  readonly dashedLineDetectionMinLineLength: number;
  withDashedLineDetectionMinLineLength(dashedLineDetectionMinLineLength: number): CannyEdgeDetectionPipe;

  /**
   * Maximum distance between dashed lines to be considered as connected
   */
  readonly dashedLineDetectionMaxLineGap: number;
  withDashedLineDetectionMaxLineGap(dashedLineDetectionMaxLineGap: number): CannyEdgeDetectionPipe;
   ...
   * @see #toJson
   */
  static fromJson(json: any): CannyEdgeDetectionPipe | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): CannyEdgeDetectionPipe | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): CannyEdgeDetectionPipe | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): CannyEdgeDetectionPipe | null;
   ...
   */
  replaceType(old: Type, new_: Type): CannyEdgeDetectionPipe;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): CannyEdgeDetectionPipe;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): CannyEdgeDetectionPipe;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<CannyEdgeDetectionPipe>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<CannyEdgeDetectionPipe>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): CannyEdgeDetectionPipe;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): CannyEdgeDetectionPipe;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): CannyEdgeDetectionPipe;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): CannyEdgeDetectionPipe;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): CannyEdgeDetectionPipe;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): CannyEdgeDetectionPipe;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): CannyEdgeDetectionPipe;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): CannyEdgeDetectionPipe;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): CannyEdgeDetectionPipe;
   ...
   * @see #removeField
   */
  withoutField(field: string): CannyEdgeDetectionPipe;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): CannyEdgeDetectionPipe;
   ...
   */
  withoutFields(fields: Array_Type<string>): CannyEdgeDetectionPipe;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): CannyEdgeDetectionPipe;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): CannyEdgeDetectionPipe;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): CannyEdgeDetectionPipe;
   ...
   * @see #unsetField
   */
  defaultField(field: string): CannyEdgeDetectionPipe;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): CannyEdgeDetectionPipe;
   ...
   * @see #removeField
   */
  unsetField(field: string): CannyEdgeDetectionPipe;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): CannyEdgeDetectionPipe;
   ...
   * @see #unsetField
   */
  removeField(field: string): CannyEdgeDetectionPipe;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): CannyEdgeDetectionPipe;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): CannyEdgeDetectionPipe;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): CannyEdgeDetectionPipe;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): CannyEdgeDetectionPipe;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): CannyEdgeDetectionPipe;

  mergeJson(json: any): CannyEdgeDetectionPipe;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): CannyEdgeDetectionPipe;
   ...
   */
  sumObj(other: Obj, deep?: boolean): CannyEdgeDetectionPipe;
   ...
   */
  singletonArray(): Array_Type<CannyEdgeDetectionPipe>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<CannyEdgeDetectionPipe> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<CannyEdgeDetectionPipe> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<CannyEdgeDetectionPipe>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<CannyEdgeDetectionPipe> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, CannyEdgeDetectionPipe> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, CannyEdgeDetectionPipe> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<CannyEdgeDetectionPipe>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<CannyEdgeDetectionPipe>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): CannyEdgeDetectionPipe;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): CannyEdgeDetectionPipe;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): CannyEdgeDetectionPipe;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): CannyEdgeDetectionPipe;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): CannyEdgeDetectionPipe;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): CannyEdgeDetectionPipe;
   ...
   * @see #fromString
   */
  static make(s: string): CannyEdgeDetectionPipe | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): CannyEdgeDetectionPipe;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): CannyEdgeDetectionPipe;
   ...
   */
  static cachedEmptyInst(): CannyEdgeDetectionPipe;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<CannyEdgeDetectionPipe> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): CannyEdgeDetectionPipe;
   ...
   */
  remakeTemplate(): CannyEdgeDetectionPipe;
   ...
   */
  withoutIdentity(): CannyEdgeDetectionPipe;
   ...
   */
  trainSync(x: Data, y?: , spec?: MlOperationSpec): CannyEdgeDetectionPipe;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<CannyEdgeDetectionPipe> | null;
   ...
   */
  static find(filter?: string, doNotProduceAll?: boolean): Stream<CannyEdgeDetectionPipe> | null;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<CannyEdgeDetectionPipe> | null;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): CannyEdgeDetectionPipe | null;
   ...
   * @see findByCacheKey
   */
  static forCacheKey(key: string): CannyEdgeDetectionPipe | null;
   ...
   * @see findByCacheKey
   */
  getCached(): CannyEdgeDetectionPipe | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): CannyEdgeDetectionPipe | null;
   ...
   */
  static produce(key: string): CannyEdgeDetectionPipe | null;
   ...
   */
  static produceAll(): Map_Type<string, CannyEdgeDetectionPipe> | null;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): Map_Type<string, CannyEdgeDetectionPipe> | null;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<CannyEdgeDetectionPipe>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<CannyEdgeDetectionPipe>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<CannyEdgeDetectionPipe> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<CannyEdgeDetectionPipe>> | null;
   ...
   */
  get(include?: string): CannyEdgeDetectionPipe | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): CannyEdgeDetectionPipe | null;
   ...
   */
  getMissing(spec: GetMissingSpec): CannyEdgeDetectionPipe;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): CannyEdgeDetectionPipe | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): CannyEdgeDetectionPipe;
   ...
   * @see #toString
   */
  static fromString(s: string): CannyEdgeDetectionPipe | null;
   ...
   */
  create(spec?: UpsertSpec): CannyEdgeDetectionPipe | null;
   ...
   */
  static createBatch(objs: Array_Type<CannyEdgeDetectionPipe>, spec?: UpsertSpec): ObjList<CannyEdgeDetectionPipe> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<CannyEdgeDetectionPipe>, spec?: CreateBatchObjStreamSpec): ObjList<CannyEdgeDetectionPipe> | null;
   ...
   */
  update(srcObj?: CannyEdgeDetectionPipe, spec?: UpsertSpec): CannyEdgeDetectionPipe | null;
   ...
   */
  upsert(srcObj?: CannyEdgeDetectionPipe, spec?: UpsertSpec): CannyEdgeDetectionPipe | null;
   ...
   */
  merge(spec?: MergeSpec): CannyEdgeDetectionPipe | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): CannyEdgeDetectionPipe | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): CannyEdgeDetectionPipe | null;
   ...
   */
  static updateBatch(objs: Array_Type<CannyEdgeDetectionPipe>, srcObjs?: Array_Type<CannyEdgeDetectionPipe>, spec?: UpsertSpec): ObjList<CannyEdgeDetectionPipe> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<CannyEdgeDetectionPipe> | null>, spec?: UpsertSpec): ObjList<CannyEdgeDetectionPipe> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<CannyEdgeDetectionPipe>, srcObjs?: Array_Type<CannyEdgeDetectionPipe>, spec?: UpsertSpec): ObjList<CannyEdgeDetectionPipe> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<CannyEdgeDetectionPipe> | null>, spec?: UpsertSpec): ObjList<CannyEdgeDetectionPipe> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<CannyEdgeDetectionPipe>, spec?: TouchSpec): ObjList<CannyEdgeDetectionPipe> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<CannyEdgeDetectionPipe>, spec?: MergeSpec): ObjList<CannyEdgeDetectionPipe> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<CannyEdgeDetectionPipe>, mergeInclude: string, spec?: MergeSpec): ObjList<CannyEdgeDetectionPipe> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<CannyEdgeDetectionPipe> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<CannyEdgeDetectionPipe> | null;
   ...
   */
  static mergeAll(mergeObj: CannyEdgeDetectionPipe, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: CannyEdgeDetectionPipe, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<CannyEdgeDetectionPipe>, spec?: UpsertSpec): ObjList<CannyEdgeDetectionPipe> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<CannyEdgeDetectionPipe>, spec?: UpsertSpec): ObjList<CannyEdgeDetectionPipe> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): CannyEdgeDetectionPipe | null;
   ...
   */
  static beforeCreate(objs: Array_Type<CannyEdgeDetectionPipe>): ObjList<CannyEdgeDetectionPipe>;
   ...
   */
  static beforeUpdate(objs: Array_Type<CannyEdgeDetectionPipe>): ObjList<CannyEdgeDetectionPipe>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<CannyEdgeDetectionPipe>): ObjList<CannyEdgeDetectionPipe>;
   ...
   */
  static afterCreate(objs: Array_Type<CannyEdgeDetectionPipe>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<CannyEdgeDetectionPipe>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<CannyEdgeDetectionPipe>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<CannyEdgeDetectionPipe>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<CannyEdgeDetectionPipe>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): CannyEdgeDetectionPipe | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<CannyEdgeDetectionPipe>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: CannyEdgeDetectionPipe, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<CannyEdgeDetectionPipe>, callback?: λFunction<CannyEdgeDetectionPipe | null, CannyEdgeDetectionPipe | null>): ObjList<CannyEdgeDetectionPipe>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<CannyEdgeDetectionPipe>, callback?: λFunction<CannyEdgeDetectionPipe | null, CannyEdgeDetectionPipe | null>): Array_Type<ObjError> | null;
   ...
   */
  publish(subPath?: string, contentType?: string): CannyEdgeDetectionPipe;
   ...
   */
  static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<CannyEdgeDetectionPipe> | null;
   ...
   */
  createSeedData(spec?: UpsertSpec): CannyEdgeDetectionPipe | null;
   ...
   */
  static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<CannyEdgeDetectionPipe> | null;
   ...
   */
  updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): CannyEdgeDetectionPipe | null;
   ...
   */
  static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<CannyEdgeDetectionPipe> | null;
   ...
   * @return updated obj instance, same as {@link Persistable#update} return value.
   */
  clearUserUpdates(spec?: MergeSpec): CannyEdgeDetectionPipe | null;
   ...
   *         {@link Persistable#updateBatch}.
   */
  static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<CannyEdgeDetectionPipe> | null;
  ...
  dependencies(): SeedDataDeps<CannyEdgeDetectionPipe> | null;
   ...
   * be returned as-is.
   */
  byReference(): CannyEdgeDetectionPipe;
   ...
   */
  updateModelFiles(modelFiles: Map_Type<string, Url>, spec?: MlOperationSpec): CannyEdgeDetectionPipe;
   ...
   */
  afterTrain(doTrainOutputs: any, spec?: MlOperationSpec): CannyEdgeDetectionPipe;
   ...
   */
  withNewSpec(spec?: MlConvertSpec): CannyEdgeDetectionPipe;
   ...
   */
  afterConvert(model: any, spec?: MlConvertSpec): CannyEdgeDetectionPipe;
   ...
   */
  withHyperparamSpaces(paramSpaces: Map_Type<string, Hp.ParamSpace>): CannyEdgeDetectionPipe;
  ...
  /**
   * Visualize the connections for symbols of specific local id
   * @param df - the dataframe containing image, asset_id and bounding_box
   * @param sourceSymbolId - the local id of the symbol to show connections for
   */
  visualizeConnections(df: Data, sourceSymbolId: string): void;
}
