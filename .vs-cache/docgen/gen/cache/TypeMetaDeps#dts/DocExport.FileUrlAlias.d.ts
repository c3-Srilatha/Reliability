// TypeScript definitions for the C3 type DocExport.FileUrlAlias

/**
 * Type to capture the map between a filename and it's url alias on the developer portal.
 *
 * @remarks this represents a value passed to a method that expects an instance of DocExport.FileUrlAlias
 */
declare namespace DocExport {
  export interface IFileUrlAlias {
 ...
 */
declare namespace DocExport {
  export class FileUrlAlias extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): DocExport.FileUrlAlias;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): DocExport.FileUrlAlias;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): DocExport.FileUrlAlias;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): DocExport.FileUrlAlias;
    ...
    withVersion(version: number | null): DocExport.FileUrlAlias;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): DocExport.FileUrlAlias;

    /**
     * The name of the file.
     */
    readonly fileName: string;
    withFileName(fileName: string): DocExport.FileUrlAlias;

    /**
     * The url alias of the file on the developer portal.
     */
    readonly urlAlias: string;
    withUrlAlias(urlAlias: string): DocExport.FileUrlAlias;
     ...
     * @see #toJson
     */
    static fromJson(json: any): DocExport.FileUrlAlias | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): DocExport.FileUrlAlias | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): DocExport.FileUrlAlias | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): DocExport.FileUrlAlias | null;
     ...
     */
    replaceType(old: Type, new_: Type): DocExport.FileUrlAlias;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): DocExport.FileUrlAlias;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): DocExport.FileUrlAlias;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<DocExport.FileUrlAlias>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<DocExport.FileUrlAlias>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): DocExport.FileUrlAlias;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DocExport.FileUrlAlias;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DocExport.FileUrlAlias;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): DocExport.FileUrlAlias;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): DocExport.FileUrlAlias;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): DocExport.FileUrlAlias;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): DocExport.FileUrlAlias;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): DocExport.FileUrlAlias;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): DocExport.FileUrlAlias;
     ...
     * @see #removeField
     */
    withoutField(field: string): DocExport.FileUrlAlias;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): DocExport.FileUrlAlias;
     ...
     */
    withoutFields(fields: Array_Type<string>): DocExport.FileUrlAlias;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): DocExport.FileUrlAlias;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): DocExport.FileUrlAlias;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): DocExport.FileUrlAlias;
     ...
     * @see #unsetField
     */
    defaultField(field: string): DocExport.FileUrlAlias;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): DocExport.FileUrlAlias;
     ...
     * @see #removeField
     */
    unsetField(field: string): DocExport.FileUrlAlias;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): DocExport.FileUrlAlias;
     ...
     * @see #unsetField
     */
    removeField(field: string): DocExport.FileUrlAlias;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): DocExport.FileUrlAlias;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): DocExport.FileUrlAlias;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): DocExport.FileUrlAlias;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): DocExport.FileUrlAlias;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): DocExport.FileUrlAlias;

    mergeJson(json: any): DocExport.FileUrlAlias;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): DocExport.FileUrlAlias;
     ...
     */
    sumObj(other: Obj, deep?: boolean): DocExport.FileUrlAlias;
     ...
     */
    singletonArray(): Array_Type<DocExport.FileUrlAlias>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<DocExport.FileUrlAlias> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<DocExport.FileUrlAlias> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<DocExport.FileUrlAlias>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<DocExport.FileUrlAlias> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, DocExport.FileUrlAlias> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, DocExport.FileUrlAlias> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<DocExport.FileUrlAlias>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<DocExport.FileUrlAlias>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): DocExport.FileUrlAlias;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): DocExport.FileUrlAlias;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): DocExport.FileUrlAlias;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): DocExport.FileUrlAlias;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): DocExport.FileUrlAlias;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): DocExport.FileUrlAlias;
     ...
     * @see #fromString
     */
    static make(s: string): DocExport.FileUrlAlias | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): DocExport.FileUrlAlias;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): DocExport.FileUrlAlias;
     ...
     */
    static cachedEmptyInst(): DocExport.FileUrlAlias;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<DocExport.FileUrlAlias> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): DocExport.FileUrlAlias;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<DocExport.FileUrlAlias>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<DocExport.FileUrlAlias>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<DocExport.FileUrlAlias> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<DocExport.FileUrlAlias>> | null;
     ...
     */
    get(include?: string): DocExport.FileUrlAlias | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): DocExport.FileUrlAlias | null;
     ...
     */
    getMissing(spec: GetMissingSpec): DocExport.FileUrlAlias;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): DocExport.FileUrlAlias | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): DocExport.FileUrlAlias;
     ...
     * @see #toString
     */
    static fromString(s: string): DocExport.FileUrlAlias | null;
     ...
     */
    create(spec?: UpsertSpec): DocExport.FileUrlAlias | null;
     ...
     */
    static createBatch(objs: Array_Type<DocExport.FileUrlAlias>, spec?: UpsertSpec): ObjList<DocExport.FileUrlAlias> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<DocExport.FileUrlAlias>, spec?: CreateBatchObjStreamSpec): ObjList<DocExport.FileUrlAlias> | null;
     ...
     */
    update(srcObj?: DocExport.FileUrlAlias, spec?: UpsertSpec): DocExport.FileUrlAlias | null;
     ...
     */
    upsert(srcObj?: DocExport.FileUrlAlias, spec?: UpsertSpec): DocExport.FileUrlAlias | null;
     ...
     */
    merge(spec?: MergeSpec): DocExport.FileUrlAlias | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): DocExport.FileUrlAlias | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): DocExport.FileUrlAlias | null;
     ...
     */
    static updateBatch(objs: Array_Type<DocExport.FileUrlAlias>, srcObjs?: Array_Type<DocExport.FileUrlAlias>, spec?: UpsertSpec): ObjList<DocExport.FileUrlAlias> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<DocExport.FileUrlAlias> | null>, spec?: UpsertSpec): ObjList<DocExport.FileUrlAlias> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<DocExport.FileUrlAlias>, srcObjs?: Array_Type<DocExport.FileUrlAlias>, spec?: UpsertSpec): ObjList<DocExport.FileUrlAlias> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<DocExport.FileUrlAlias> | null>, spec?: UpsertSpec): ObjList<DocExport.FileUrlAlias> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<DocExport.FileUrlAlias>, spec?: TouchSpec): ObjList<DocExport.FileUrlAlias> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<DocExport.FileUrlAlias>, spec?: MergeSpec): ObjList<DocExport.FileUrlAlias> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<DocExport.FileUrlAlias>, mergeInclude: string, spec?: MergeSpec): ObjList<DocExport.FileUrlAlias> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<DocExport.FileUrlAlias> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<DocExport.FileUrlAlias> | null;
     ...
     */
    static mergeAll(mergeObj: DocExport.FileUrlAlias, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: DocExport.FileUrlAlias, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<DocExport.FileUrlAlias>, spec?: UpsertSpec): ObjList<DocExport.FileUrlAlias> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<DocExport.FileUrlAlias>, spec?: UpsertSpec): ObjList<DocExport.FileUrlAlias> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): DocExport.FileUrlAlias | null;
     ...
     */
    static beforeCreate(objs: Array_Type<DocExport.FileUrlAlias>): ObjList<DocExport.FileUrlAlias>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<DocExport.FileUrlAlias>): ObjList<DocExport.FileUrlAlias>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<DocExport.FileUrlAlias>): ObjList<DocExport.FileUrlAlias>;
     ...
     */
    static afterCreate(objs: Array_Type<DocExport.FileUrlAlias>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<DocExport.FileUrlAlias>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<DocExport.FileUrlAlias>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<DocExport.FileUrlAlias>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<DocExport.FileUrlAlias>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): DocExport.FileUrlAlias | null;
     ...
     */
    withoutIdentity(): DocExport.FileUrlAlias | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<DocExport.FileUrlAlias>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: DocExport.FileUrlAlias, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<DocExport.FileUrlAlias>, callback?: λFunction<DocExport.FileUrlAlias | null, DocExport.FileUrlAlias | null>): ObjList<DocExport.FileUrlAlias>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<DocExport.FileUrlAlias>, callback?: λFunction<DocExport.FileUrlAlias | null, DocExport.FileUrlAlias | null>): Array_Type<ObjError> | null;
