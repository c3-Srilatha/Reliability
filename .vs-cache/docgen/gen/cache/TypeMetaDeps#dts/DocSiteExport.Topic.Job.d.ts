// TypeScript definitions for the C3 type DocSiteExport.Topic.Job

/**
 * Batch job to export documentation for topic files ([.c3doc.md](FileExt#DOC)).
 *
 * @remarks this represents a value passed to a method that expects an instance of DocSiteExport.Topic.Job
 */
declare namespace DocSiteExport.Topic {
...
declare namespace DocSiteExport.Topic {
  export class Job extends Obj  {
    ...
    withRun(run: IBatchJobRun | null): DocSiteExport.Topic.Job;

    /**
     * previous job executions for this instance
     */
    readonly runs?: Array_Type<BatchJobRun>;
    withRuns(runs: Array_Type<BatchJobRun> | Array<IBatchJobRun> | null): DocSiteExport.Topic.Job;

    /**
     * FOR INTERNAL USE ONLY - Specify options in call to {@link start}.
     */
    readonly options?: Obj;
    withOptions(options: IObj | null): DocSiteExport.Topic.Job;
    ...
    withOnCompleteCallback(onCompleteCallback: IJobBase.Callback | null): DocSiteExport.Topic.Job;
    ...
    withPriority(priority: number | null): DocSiteExport.Topic.Job;
    ...
    withDisabled(disabled: boolean): DocSiteExport.Topic.Job;
    ...
    withMaxConcurrency(maxConcurrency: number | null): DocSiteExport.Topic.Job;
    ...
    withMaxConcurrencyPerNode(maxConcurrencyPerNode: number | null): DocSiteExport.Topic.Job;
    ...
    withRunAsUser(runAsUser: boolean): DocSiteExport.Topic.Job;

    /**
     * Don't set this field in the BatchJob, set it in the BatchJobOptions when calling `start`
     */
    readonly nodePool?: string;
    withNodePool(nodePool: string | null): DocSiteExport.Topic.Job;
    ...
    withSkipIfRunning(skipIfRunning: boolean): DocSiteExport.Topic.Job;

    /**
     * Set to between 1 and 5 to enable auto recovery. See {@link invalidation-queues.c3doc Invalidation Queues} for detailed documentation.
     */
    readonly numAutoRecoveryAttempts?: number;
    withNumAutoRecoveryAttempts(numAutoRecoveryAttempts: number | null): DocSiteExport.Topic.Job;
    ...
    withTypeIdent(typeIdent: string | null): DocSiteExport.Topic.Job;
     ...
     */
    readonly id: string;
    withId(id: string): DocSiteExport.Topic.Job;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): DocSiteExport.Topic.Job;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): DocSiteExport.Topic.Job;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): DocSiteExport.Topic.Job;
    ...
    withVersion(version: number | null): DocSiteExport.Topic.Job;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): DocSiteExport.Topic.Job;
    ...
    withAbortOnError(abortOnError: boolean): DocSiteExport.Topic.Job;
     ...
     * @see #toJson
     */
    static fromJson(json: any): DocSiteExport.Topic.Job | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): DocSiteExport.Topic.Job | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): DocSiteExport.Topic.Job | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): DocSiteExport.Topic.Job | null;
     ...
     */
    replaceType(old: Type, new_: Type): DocSiteExport.Topic.Job;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): DocSiteExport.Topic.Job;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): DocSiteExport.Topic.Job;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<DocSiteExport.Topic.Job>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<DocSiteExport.Topic.Job>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): DocSiteExport.Topic.Job;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DocSiteExport.Topic.Job;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DocSiteExport.Topic.Job;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): DocSiteExport.Topic.Job;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): DocSiteExport.Topic.Job;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): DocSiteExport.Topic.Job;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): DocSiteExport.Topic.Job;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): DocSiteExport.Topic.Job;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): DocSiteExport.Topic.Job;
     ...
     * @see #removeField
     */
    withoutField(field: string): DocSiteExport.Topic.Job;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): DocSiteExport.Topic.Job;
     ...
     */
    withoutFields(fields: Array_Type<string>): DocSiteExport.Topic.Job;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): DocSiteExport.Topic.Job;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): DocSiteExport.Topic.Job;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): DocSiteExport.Topic.Job;
     ...
     * @see #unsetField
     */
    defaultField(field: string): DocSiteExport.Topic.Job;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): DocSiteExport.Topic.Job;
     ...
     * @see #removeField
     */
    unsetField(field: string): DocSiteExport.Topic.Job;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): DocSiteExport.Topic.Job;
     ...
     * @see #unsetField
     */
    removeField(field: string): DocSiteExport.Topic.Job;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): DocSiteExport.Topic.Job;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): DocSiteExport.Topic.Job;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): DocSiteExport.Topic.Job;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): DocSiteExport.Topic.Job;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): DocSiteExport.Topic.Job;

    mergeJson(json: any): DocSiteExport.Topic.Job;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): DocSiteExport.Topic.Job;
     ...
     */
    sumObj(other: Obj, deep?: boolean): DocSiteExport.Topic.Job;
     ...
     */
    singletonArray(): Array_Type<DocSiteExport.Topic.Job>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<DocSiteExport.Topic.Job> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<DocSiteExport.Topic.Job> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<DocSiteExport.Topic.Job>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<DocSiteExport.Topic.Job> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, DocSiteExport.Topic.Job> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, DocSiteExport.Topic.Job> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<DocSiteExport.Topic.Job>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<DocSiteExport.Topic.Job>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): DocSiteExport.Topic.Job;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): DocSiteExport.Topic.Job;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): DocSiteExport.Topic.Job;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): DocSiteExport.Topic.Job;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): DocSiteExport.Topic.Job;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): DocSiteExport.Topic.Job;
     ...
     * @see #fromString
     */
    static make(s: string): DocSiteExport.Topic.Job | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): DocSiteExport.Topic.Job;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): DocSiteExport.Topic.Job;
     ...
     */
    static cachedEmptyInst(): DocSiteExport.Topic.Job;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<DocSiteExport.Topic.Job> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): DocSiteExport.Topic.Job;
     ...
     */
    start(options?: DocSiteExport.Topic.Job.Options): BatchJobStatus | null;
     ...
     */
    cleanup(options?: DocSiteExport.Topic.Job.Options): void;
    ...
    cancelJob(removeResults?: boolean, force?: boolean): JobBase<BatchJobRun, BatchJobStatus, DocSiteExport.Topic.Job.Options> | null;

    failJob(run: JobRun<BatchJobStatusBase>): JobBase<BatchJobRun, BatchJobStatus, DocSiteExport.Topic.Job.Options> | null;
    ...
    validateStart(options?: DocSiteExport.Topic.Job.Options): void;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<DocSiteExport.Topic.Job>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<DocSiteExport.Topic.Job>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<DocSiteExport.Topic.Job> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<DocSiteExport.Topic.Job>> | null;
     ...
     */
    get(include?: string): DocSiteExport.Topic.Job | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): DocSiteExport.Topic.Job | null;
     ...
     */
    getMissing(spec: GetMissingSpec): DocSiteExport.Topic.Job;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): DocSiteExport.Topic.Job | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): DocSiteExport.Topic.Job;
     ...
     * @see #toString
     */
    static fromString(s: string): DocSiteExport.Topic.Job | null;
     ...
     */
    create(spec?: UpsertSpec): DocSiteExport.Topic.Job | null;
     ...
     */
    static createBatch(objs: Array_Type<DocSiteExport.Topic.Job>, spec?: UpsertSpec): ObjList<DocSiteExport.Topic.Job> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<DocSiteExport.Topic.Job>, spec?: CreateBatchObjStreamSpec): ObjList<DocSiteExport.Topic.Job> | null;
     ...
     */
    update(srcObj?: DocSiteExport.Topic.Job, spec?: UpsertSpec): DocSiteExport.Topic.Job | null;
     ...
     */
    upsert(srcObj?: DocSiteExport.Topic.Job, spec?: UpsertSpec): DocSiteExport.Topic.Job | null;
     ...
     */
    merge(spec?: MergeSpec): DocSiteExport.Topic.Job | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): DocSiteExport.Topic.Job | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): DocSiteExport.Topic.Job | null;
     ...
     */
    static updateBatch(objs: Array_Type<DocSiteExport.Topic.Job>, srcObjs?: Array_Type<DocSiteExport.Topic.Job>, spec?: UpsertSpec): ObjList<DocSiteExport.Topic.Job> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<DocSiteExport.Topic.Job> | null>, spec?: UpsertSpec): ObjList<DocSiteExport.Topic.Job> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<DocSiteExport.Topic.Job>, srcObjs?: Array_Type<DocSiteExport.Topic.Job>, spec?: UpsertSpec): ObjList<DocSiteExport.Topic.Job> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<DocSiteExport.Topic.Job> | null>, spec?: UpsertSpec): ObjList<DocSiteExport.Topic.Job> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<DocSiteExport.Topic.Job>, spec?: TouchSpec): ObjList<DocSiteExport.Topic.Job> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<DocSiteExport.Topic.Job>, spec?: MergeSpec): ObjList<DocSiteExport.Topic.Job> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<DocSiteExport.Topic.Job>, mergeInclude: string, spec?: MergeSpec): ObjList<DocSiteExport.Topic.Job> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<DocSiteExport.Topic.Job> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<DocSiteExport.Topic.Job> | null;
     ...
     */
    static mergeAll(mergeObj: DocSiteExport.Topic.Job, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: DocSiteExport.Topic.Job, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<DocSiteExport.Topic.Job>, spec?: UpsertSpec): ObjList<DocSiteExport.Topic.Job> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<DocSiteExport.Topic.Job>, spec?: UpsertSpec): ObjList<DocSiteExport.Topic.Job> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): DocSiteExport.Topic.Job | null;
     ...
     */
    static beforeCreate(objs: Array_Type<DocSiteExport.Topic.Job>): ObjList<DocSiteExport.Topic.Job>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<DocSiteExport.Topic.Job>): ObjList<DocSiteExport.Topic.Job>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<DocSiteExport.Topic.Job>): ObjList<DocSiteExport.Topic.Job>;
     ...
     */
    static afterCreate(objs: Array_Type<DocSiteExport.Topic.Job>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<DocSiteExport.Topic.Job>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<DocSiteExport.Topic.Job>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<DocSiteExport.Topic.Job>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<DocSiteExport.Topic.Job>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): DocSiteExport.Topic.Job | null;
     ...
     */
    withoutIdentity(): DocSiteExport.Topic.Job | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<DocSiteExport.Topic.Job>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: DocSiteExport.Topic.Job, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<DocSiteExport.Topic.Job>, callback?: λFunction<DocSiteExport.Topic.Job | null, DocSiteExport.Topic.Job | null>): ObjList<DocSiteExport.Topic.Job>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<DocSiteExport.Topic.Job>, callback?: λFunction<DocSiteExport.Topic.Job | null, DocSiteExport.Topic.Job | null>): Array_Type<ObjError> | null;
     ...
     */
    static doStart(job?: DocSiteExport.Topic.Job, options?: DocSiteExport.Topic.Job.Options): void;
     ...
     */
    static processBatch(batch?: DocSiteExport.Topic.Job.Batch, job?: DocSiteExport.Topic.Job, options?: DocSiteExport.Topic.Job.Options): void;
     ...
     */
    static allComplete(job: DocSiteExport.Topic.Job, options?: DocSiteExport.Topic.Job.Options): string | null;
     ...
     *           Options the job was run with.
     */
    static failed(job: DocSiteExport.Topic.Job, status: BatchJobStatus, options?: DocSiteExport.Topic.Job.Options): void;
     ...
     *        Batch to schedule.
     */
    scheduleBatch(batch?: DocSiteExport.Topic.Job.Batch): void;
     ...
     *        Batches to schedule.
     */
    scheduleBatches(batches?: Array_Type<DocSiteExport.Topic.Job.Batch>): void;
     ...
     */
    static scheduleObjBatch(job?: DocSiteExport.Topic.Job, objBatch?: ObjBatch, logPrefix?: string): number | null;
