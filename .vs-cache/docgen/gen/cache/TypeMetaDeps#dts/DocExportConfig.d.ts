// TypeScript definitions for the C3 type DocExportConfig

/**
 * Config Type to store documentation export variables.
 *
 * @remarks this represents a value passed to a method that expects an instance of DocExportConfig
 */
declare interface IDocExportConfig {
  ...
  /**
   * The versions of packages for which documentation artifacts are being generated.
   */
  packageVersions?: Map_Type<string, string> | {[key: string]: string};

  /**
   * The portal host link to use when construction documentation links.
   */
  portalHost?: string;
  ...
  /**
   * The configured server version on which documentation artifacts were generated.
   */
 ...
 * Config Type to store documentation export variables.
 *
 * @remarks this represents a made instance of DocExportConfig
 */
declare class DocExportConfig extends Obj  {

  readonly configOverride?: string;
  withConfigOverride(configOverride: string | null): DocExportConfig;

  static readonly configOverride?: string;

  readonly secretOverride?: string;
  withSecretOverride(secretOverride: string | null): DocExportConfig;
  ...
  withIssues(issues: Array_Type<string> | Array<string> | null): DocExportConfig;
   ...
   * The versions of packages for which documentation artifacts are being generated.
   */
  readonly packageVersions?: Map_Type<string, string>;
  withPackageVersions(packageVersions: Map_Type<string, string> | {[key: string]: string} | null): DocExportConfig;

  /**
   * The versions of packages for which documentation artifacts are being generated.
   */
  static readonly packageVersions?: Map_Type<string, string>;

  /**
   * The portal host link to use when construction documentation links.
   */
  readonly portalHost?: string;
  withPortalHost(portalHost: string | null): DocExportConfig;

  /**
   * The portal host link to use when construction documentation links.
   */
  static readonly portalHost?: string;

  /**
   * The temporary directory url created for holding the documentation artifacts.
   */
  readonly tmpDirectoryUrl?: string;
  withTmpDirectoryUrl(tmpDirectoryUrl: string | null): DocExportConfig;
  ...
  withConfiguredServerVersion(configuredServerVersion: string | null): DocExportConfig;
   ...
   * @see #toJson
   */
  static fromJson(json: any): DocExportConfig | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): DocExportConfig | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): DocExportConfig | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): DocExportConfig | null;
   ...
   */
  replaceType(old: Type, new_: Type): DocExportConfig;
   ...
   * This method is used during live metadata update
   */
  static replaceType(old: Type, new_: Type): DocExportConfig;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): DocExportConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): DocExportConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): DocExportConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): DocExportConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<DocExportConfig>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<DocExportConfig>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<DocExportConfig>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<DocExportConfig>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): DocExportConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): DocExportConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DocExportConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DocExportConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DocExportConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DocExportConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): DocExportConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  static validateObj(): DocExportConfig;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): DocExportConfig;
   ...
   * @see #defaultField
   */
  static withField(field: string, value: any, doNotConvert?: boolean): DocExportConfig;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): DocExportConfig;
   ...
   * @see #defaultField
   */
  static withField(field: FieldType, value: any, doNotConvert?: boolean): DocExportConfig;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): DocExportConfig;
   ...
   * @return new Obj
   */
  static withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): DocExportConfig;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): DocExportConfig;
   ...
   * @return new Obj
   */
  static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): DocExportConfig;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): DocExportConfig;
   ...
   * @see #withoutField
   */
  static withoutFieldAtPath(path: string): DocExportConfig;
   ...
   * @see #removeField
   */
  withoutField(field: string): DocExportConfig;
   ...
   * @see #removeField
   */
  static withoutField(field: string): DocExportConfig;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): DocExportConfig;
   ...
   * @see #removeField
   */
  static withoutField(field: FieldType): DocExportConfig;
   ...
   */
  withoutFields(fields: Array_Type<string>): DocExportConfig;
   ...
   * @return new Obj with removed fields
   */
  static withoutFields(fields: Array_Type<string>): DocExportConfig;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): DocExportConfig;
   ...
   * @return new Obj with removed fields
   */
  static withoutFieldsByType(fields: Array_Type<FieldType>): DocExportConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): DocExportConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  static withoutSecretFields(): DocExportConfig;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): DocExportConfig;
   ...
   * @see FieldType#defaultValue
   */
  static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): DocExportConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: string): DocExportConfig;
   ...
   * @see #unsetField
   */
  static defaultField(field: string): DocExportConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): DocExportConfig;
   ...
   * @see #unsetField
   */
  static defaultField(field: FieldType): DocExportConfig;
   ...
   * @see #removeField
   */
  unsetField(field: string): DocExportConfig;
   ...
   * @see #removeField
   */
  static unsetField(field: string): DocExportConfig;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): DocExportConfig;
   ...
   * @see #removeField
   */
  static unsetField(field: FieldType): DocExportConfig;
   ...
   * @see #unsetField
   */
  removeField(field: string): DocExportConfig;
   ...
   * @see #unsetField
   */
  static removeField(field: string): DocExportConfig;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): DocExportConfig;
   ...
   * @see #unsetField
   */
  static removeField(field: FieldType): DocExportConfig;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): DocExportConfig;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): DocExportConfig;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): DocExportConfig;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj, otherFieldsFilter: Type): DocExportConfig;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): DocExportConfig;
   ...
   *        the same key or index.
   */
  static mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): DocExportConfig;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): DocExportConfig;
   ...
   * traverse child reference and collection fields.
   */
  static mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): DocExportConfig;

  mergeJson(json: any): DocExportConfig;

  static mergeJson(json: any): DocExportConfig;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): DocExportConfig;
   ...
   * @return Obj with child references merged
   */
  static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): DocExportConfig;
   ...
   */
  sumObj(other: Obj, deep?: boolean): DocExportConfig;
   ...
   * references with same name and collection elements at same index or key.
   */
  static sumObj(other: Obj, deep?: boolean): DocExportConfig;
   ...
   */
  singletonArray(): Array_Type<DocExportConfig>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonArray(): Array_Type<DocExportConfig>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<DocExportConfig> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<DocExportConfig> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<DocExportConfig>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonSet(): Set_Type<DocExportConfig>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<DocExportConfig> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, DocExportConfig> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, DocExportConfig> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<DocExportConfig>;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  static toBuilder(): ObjBuilder<DocExportConfig>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<DocExportConfig>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): DocExportConfig;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): DocExportConfig;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): DocExportConfig;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): DocExportConfig;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): DocExportConfig;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): DocExportConfig;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): DocExportConfig;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  static afterMake(): DocExportConfig;
   ...
   */
  static cachedEmptyInst(): DocExportConfig;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<DocExportConfig> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): DocExportConfig;
   ...
   */
  static allCached(): Stream<DocExportConfig> | null;
   ...
   */
  static find(filter?: string): Stream<DocExportConfig> | null;
   ...
   *         Otherwise no population will be performed.
   */
  static findBy(field: string, value: any): Stream<DocExportConfig> | null;

  /**
   * @return cached instance.
   */
  getCached(): DocExportConfig | null;

  /**
   * @return cached instance.
   */
  static getCached(): DocExportConfig | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string): DocExportConfig | null;
   ...
   * Note that typical pattern is to use Configurable#config instead of this method.
   */
  static getConfig(): DocExportConfig;
   ...
   * Note that typical pattern is to use Configurable#configWithSecrets instead of this method.
   */
  static getSecret(): DocExportConfig;
   ...
   */
  withConfigKey(configKey: string): DocExportConfig;
   ...
   *     config.configKey() => "folder1/abc"
   */
  static withConfigKey(configKey: string): DocExportConfig;

  /**
   * @return copy without config key.
   */
  withoutConfigKey(): DocExportConfig;

  /**
   * @return copy without config key.
   */
  static withoutConfigKey(): DocExportConfig;

  /**
   * @return return cached config instance for provided config key.
   */
  static forConfigKey(configKey: string): DocExportConfig | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string>): Stream<DocExportConfig> | null;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: DocExportConfig, override?: string): void;
   ...
   * @see setConfigValue
   */
  static setConfigValues(from: DocExportConfig, override?: string): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): DocExportConfig | null;
   ...
   */
  removeSecrets(): DocExportConfig | null;

  /**
   * @return this config without any secret values.
   */
  static removeSecrets(): DocExportConfig | null;

  /**
   * @return this config with only secret values.
   */
  removeNonSecrets(): DocExportConfig | null;

  /**
   * @return this config with only secret values.
   */
  static removeNonSecrets(): DocExportConfig | null;

  /**
   * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
   * validation and setup.
   */
  validate(): DocExportConfig;

  /**
   * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
   * validation and setup.
   */
  static validate(): DocExportConfig;
