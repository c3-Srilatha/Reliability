// TypeScript definitions for the C3 type GuideDocExport

/**
 * Batch job to export documentation for C3 guides.
 *
 * @remarks this represents a value passed to a method that expects an instance of GuideDocExport
 */
declare interface IGuideDocExport {
 ...
 */
declare class GuideDocExport extends Obj  {

  /**
   * current or last job execution for this instance
   */
  readonly run?: BatchJobRun;
  withRun(run: IBatchJobRun | null): GuideDocExport;

  /**
   * previous job executions for this instance
   */
  readonly runs?: Array_Type<BatchJobRun>;
  withRuns(runs: Array_Type<BatchJobRun> | Array<IBatchJobRun> | null): GuideDocExport;

  /**
   * FOR INTERNAL USE ONLY - Specify options in call to {@link start}.
   */
  readonly options?: Obj;
  withOptions(options: IObj | null): GuideDocExport;
  ...
  withOnCompleteCallback(onCompleteCallback: IJobBase.Callback | null): GuideDocExport;
  ...
  withPriority(priority: number | null): GuideDocExport;
  ...
  withDisabled(disabled: boolean): GuideDocExport;
  ...
  withMaxConcurrency(maxConcurrency: number | null): GuideDocExport;
  ...
  withMaxConcurrencyPerNode(maxConcurrencyPerNode: number | null): GuideDocExport;
  ...
  withRunAsUser(runAsUser: boolean): GuideDocExport;

  /**
   * Don't set this field in the BatchJob, set it in the BatchJobOptions when calling `start`
   */
  readonly nodePool?: string;
  withNodePool(nodePool: string | null): GuideDocExport;
  ...
  withSkipIfRunning(skipIfRunning: boolean): GuideDocExport;

  /**
   * Set to between 1 and 5 to enable auto recovery. See {@link invalidation-queues.c3doc Invalidation Queues} for detailed documentation.
   */
  readonly numAutoRecoveryAttempts?: number;
  withNumAutoRecoveryAttempts(numAutoRecoveryAttempts: number | null): GuideDocExport;
  ...
  withTypeIdent(typeIdent: string | null): GuideDocExport;
   ...
   */
  readonly id: string;
  withId(id: string): GuideDocExport;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): GuideDocExport;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): GuideDocExport;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): GuideDocExport;
  ...
  withVersion(version: number | null): GuideDocExport;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): GuideDocExport;
  ...
  withAbortOnError(abortOnError: boolean): GuideDocExport;
   ...
   * @see #toJson
   */
  static fromJson(json: any): GuideDocExport | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): GuideDocExport | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): GuideDocExport | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): GuideDocExport | null;
   ...
   */
  replaceType(old: Type, new_: Type): GuideDocExport;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GuideDocExport;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GuideDocExport;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<GuideDocExport>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<GuideDocExport>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): GuideDocExport;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GuideDocExport;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GuideDocExport;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): GuideDocExport;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): GuideDocExport;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): GuideDocExport;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): GuideDocExport;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): GuideDocExport;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): GuideDocExport;
   ...
   * @see #removeField
   */
  withoutField(field: string): GuideDocExport;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): GuideDocExport;
   ...
   */
  withoutFields(fields: Array_Type<string>): GuideDocExport;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): GuideDocExport;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): GuideDocExport;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): GuideDocExport;
   ...
   * @see #unsetField
   */
  defaultField(field: string): GuideDocExport;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): GuideDocExport;
   ...
   * @see #removeField
   */
  unsetField(field: string): GuideDocExport;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): GuideDocExport;
   ...
   * @see #unsetField
   */
  removeField(field: string): GuideDocExport;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): GuideDocExport;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): GuideDocExport;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): GuideDocExport;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): GuideDocExport;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): GuideDocExport;

  mergeJson(json: any): GuideDocExport;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): GuideDocExport;
   ...
   */
  sumObj(other: Obj, deep?: boolean): GuideDocExport;
   ...
   */
  singletonArray(): Array_Type<GuideDocExport>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<GuideDocExport> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<GuideDocExport> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<GuideDocExport>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<GuideDocExport> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, GuideDocExport> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, GuideDocExport> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<GuideDocExport>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<GuideDocExport>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): GuideDocExport;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): GuideDocExport;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): GuideDocExport;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): GuideDocExport;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): GuideDocExport;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): GuideDocExport;
   ...
   * @see #fromString
   */
  static make(s: string): GuideDocExport | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): GuideDocExport;
   ...
   */
  static cachedEmptyInst(): GuideDocExport;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<GuideDocExport> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): GuideDocExport;
   ...
   */
  start(options?: GuideDocExportOptions): BatchJobStatus | null;
   ...
   */
  cleanup(options?: GuideDocExportOptions): void;
  ...
  cancelJob(removeResults?: boolean, force?: boolean): JobBase<BatchJobRun, BatchJobStatus, GuideDocExportOptions> | null;

  failJob(run: JobRun<BatchJobStatusBase>): JobBase<BatchJobRun, BatchJobStatus, GuideDocExportOptions> | null;
  ...
  validateStart(options?: GuideDocExportOptions): void;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<GuideDocExport>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<GuideDocExport>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<GuideDocExport> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<GuideDocExport>> | null;
   ...
   */
  get(include?: string): GuideDocExport | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): GuideDocExport | null;
   ...
   */
  getMissing(spec: GetMissingSpec): GuideDocExport;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): GuideDocExport | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): GuideDocExport;
   ...
   * @see #toString
   */
  static fromString(s: string): GuideDocExport | null;
   ...
   */
  create(spec?: UpsertSpec): GuideDocExport | null;
   ...
   */
  static createBatch(objs: Array_Type<GuideDocExport>, spec?: UpsertSpec): ObjList<GuideDocExport> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<GuideDocExport>, spec?: CreateBatchObjStreamSpec): ObjList<GuideDocExport> | null;
   ...
   */
  update(srcObj?: GuideDocExport, spec?: UpsertSpec): GuideDocExport | null;
   ...
   */
  upsert(srcObj?: GuideDocExport, spec?: UpsertSpec): GuideDocExport | null;
   ...
   */
  merge(spec?: MergeSpec): GuideDocExport | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): GuideDocExport | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): GuideDocExport | null;
   ...
   */
  static updateBatch(objs: Array_Type<GuideDocExport>, srcObjs?: Array_Type<GuideDocExport>, spec?: UpsertSpec): ObjList<GuideDocExport> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<GuideDocExport> | null>, spec?: UpsertSpec): ObjList<GuideDocExport> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<GuideDocExport>, srcObjs?: Array_Type<GuideDocExport>, spec?: UpsertSpec): ObjList<GuideDocExport> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<GuideDocExport> | null>, spec?: UpsertSpec): ObjList<GuideDocExport> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<GuideDocExport>, spec?: TouchSpec): ObjList<GuideDocExport> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<GuideDocExport>, spec?: MergeSpec): ObjList<GuideDocExport> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<GuideDocExport>, mergeInclude: string, spec?: MergeSpec): ObjList<GuideDocExport> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<GuideDocExport> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<GuideDocExport> | null;
   ...
   */
  static mergeAll(mergeObj: GuideDocExport, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: GuideDocExport, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<GuideDocExport>, spec?: UpsertSpec): ObjList<GuideDocExport> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<GuideDocExport>, spec?: UpsertSpec): ObjList<GuideDocExport> | null;
   ...
   */
  static beforeCreate(objs: Array_Type<GuideDocExport>): ObjList<GuideDocExport>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<GuideDocExport>): ObjList<GuideDocExport>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<GuideDocExport>): ObjList<GuideDocExport>;
   ...
   */
  static afterCreate(objs: Array_Type<GuideDocExport>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<GuideDocExport>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<GuideDocExport>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<GuideDocExport>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<GuideDocExport>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): GuideDocExport | null;
   ...
   */
  withoutIdentity(): GuideDocExport | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<GuideDocExport>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: GuideDocExport, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<GuideDocExport>, callback?: λFunction<GuideDocExport | null, GuideDocExport | null>): ObjList<GuideDocExport>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<GuideDocExport>, callback?: λFunction<GuideDocExport | null, GuideDocExport | null>): Array_Type<ObjError> | null;
   ...
   */
  static doStart(job?: GuideDocExport, options?: GuideDocExportOptions): void;
   ...
   */
  static processBatch(batch?: GuideDocExportBatch, job?: GuideDocExport, options?: GuideDocExportOptions): void;
   ...
   */
  static allComplete(job: GuideDocExport, options?: GuideDocExportOptions): string | null;
   ...
   *           Options the job was run with.
   */
  static failed(job: GuideDocExport, status: BatchJobStatus, options?: GuideDocExportOptions): void;
   ...
   *        Batch to schedule.
   */
  scheduleBatch(batch?: GuideDocExportBatch): void;
   ...
   *        Batches to schedule.
   */
  scheduleBatches(batches?: Array_Type<GuideDocExportBatch>): void;
   ...
   */
  static scheduleObjBatch(job?: GuideDocExport, objBatch?: ObjBatch, logPrefix?: string): number | null;
