// TypeScript definitions for the C3 type TypeDocExport

/**
 * Batch job to export documentation for C3 Types.
 *
 * @remarks this represents a value passed to a method that expects an instance of TypeDocExport
 */
declare interface ITypeDocExport {
 ...
 */
declare class TypeDocExport extends Obj  {

  /**
   * current or last job execution for this instance
   */
  readonly run?: BatchJobRun;
  withRun(run: IBatchJobRun | null): TypeDocExport;

  /**
   * previous job executions for this instance
   */
  readonly runs?: Array_Type<BatchJobRun>;
  withRuns(runs: Array_Type<BatchJobRun> | Array<IBatchJobRun> | null): TypeDocExport;

  /**
   * FOR INTERNAL USE ONLY - Specify options in call to {@link start}.
   */
  readonly options?: Obj;
  withOptions(options: IObj | null): TypeDocExport;
  ...
  withOnCompleteCallback(onCompleteCallback: IJobBase.Callback | null): TypeDocExport;
  ...
  withPriority(priority: number | null): TypeDocExport;
  ...
  withDisabled(disabled: boolean): TypeDocExport;
  ...
  withMaxConcurrency(maxConcurrency: number | null): TypeDocExport;
  ...
  withMaxConcurrencyPerNode(maxConcurrencyPerNode: number | null): TypeDocExport;
  ...
  withRunAsUser(runAsUser: boolean): TypeDocExport;

  /**
   * Don't set this field in the BatchJob, set it in the BatchJobOptions when calling `start`
   */
  readonly nodePool?: string;
  withNodePool(nodePool: string | null): TypeDocExport;
  ...
  withSkipIfRunning(skipIfRunning: boolean): TypeDocExport;

  /**
   * Set to between 1 and 5 to enable auto recovery. See {@link invalidation-queues.c3doc Invalidation Queues} for detailed documentation.
   */
  readonly numAutoRecoveryAttempts?: number;
  withNumAutoRecoveryAttempts(numAutoRecoveryAttempts: number | null): TypeDocExport;
  ...
  withTypeIdent(typeIdent: string | null): TypeDocExport;
   ...
   */
  readonly id: string;
  withId(id: string): TypeDocExport;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): TypeDocExport;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): TypeDocExport;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): TypeDocExport;
  ...
  withVersion(version: number | null): TypeDocExport;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): TypeDocExport;
  ...
  withAbortOnError(abortOnError: boolean): TypeDocExport;
   ...
   * @see #toJson
   */
  static fromJson(json: any): TypeDocExport | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): TypeDocExport | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): TypeDocExport | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): TypeDocExport | null;
   ...
   */
  replaceType(old: Type, new_: Type): TypeDocExport;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): TypeDocExport;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): TypeDocExport;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<TypeDocExport>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<TypeDocExport>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): TypeDocExport;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TypeDocExport;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TypeDocExport;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): TypeDocExport;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): TypeDocExport;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): TypeDocExport;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): TypeDocExport;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): TypeDocExport;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): TypeDocExport;
   ...
   * @see #removeField
   */
  withoutField(field: string): TypeDocExport;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): TypeDocExport;
   ...
   */
  withoutFields(fields: Array_Type<string>): TypeDocExport;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): TypeDocExport;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): TypeDocExport;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): TypeDocExport;
   ...
   * @see #unsetField
   */
  defaultField(field: string): TypeDocExport;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): TypeDocExport;
   ...
   * @see #removeField
   */
  unsetField(field: string): TypeDocExport;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): TypeDocExport;
   ...
   * @see #unsetField
   */
  removeField(field: string): TypeDocExport;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): TypeDocExport;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): TypeDocExport;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): TypeDocExport;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): TypeDocExport;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): TypeDocExport;

  mergeJson(json: any): TypeDocExport;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): TypeDocExport;
   ...
   */
  sumObj(other: Obj, deep?: boolean): TypeDocExport;
   ...
   */
  singletonArray(): Array_Type<TypeDocExport>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<TypeDocExport> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<TypeDocExport> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<TypeDocExport>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<TypeDocExport> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, TypeDocExport> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, TypeDocExport> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<TypeDocExport>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<TypeDocExport>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): TypeDocExport;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): TypeDocExport;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): TypeDocExport;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): TypeDocExport;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): TypeDocExport;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): TypeDocExport;
   ...
   * @see #fromString
   */
  static make(s: string): TypeDocExport | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): TypeDocExport;
   ...
   */
  static cachedEmptyInst(): TypeDocExport;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<TypeDocExport> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): TypeDocExport;
   ...
   */
  start(options?: TypeDocExportOptions): BatchJobStatus | null;
   ...
   */
  cleanup(options?: TypeDocExportOptions): void;
  ...
  cancelJob(removeResults?: boolean, force?: boolean): JobBase<BatchJobRun, BatchJobStatus, TypeDocExportOptions> | null;

  failJob(run: JobRun<BatchJobStatusBase>): JobBase<BatchJobRun, BatchJobStatus, TypeDocExportOptions> | null;
  ...
  validateStart(options?: TypeDocExportOptions): void;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<TypeDocExport>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<TypeDocExport>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<TypeDocExport> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<TypeDocExport>> | null;
   ...
   */
  get(include?: string): TypeDocExport | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): TypeDocExport | null;
   ...
   */
  getMissing(spec: GetMissingSpec): TypeDocExport;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): TypeDocExport | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): TypeDocExport;
   ...
   * @see #toString
   */
  static fromString(s: string): TypeDocExport | null;
   ...
   */
  create(spec?: UpsertSpec): TypeDocExport | null;
   ...
   */
  static createBatch(objs: Array_Type<TypeDocExport>, spec?: UpsertSpec): ObjList<TypeDocExport> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<TypeDocExport>, spec?: CreateBatchObjStreamSpec): ObjList<TypeDocExport> | null;
   ...
   */
  update(srcObj?: TypeDocExport, spec?: UpsertSpec): TypeDocExport | null;
   ...
   */
  upsert(srcObj?: TypeDocExport, spec?: UpsertSpec): TypeDocExport | null;
   ...
   */
  merge(spec?: MergeSpec): TypeDocExport | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): TypeDocExport | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): TypeDocExport | null;
   ...
   */
  static updateBatch(objs: Array_Type<TypeDocExport>, srcObjs?: Array_Type<TypeDocExport>, spec?: UpsertSpec): ObjList<TypeDocExport> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<TypeDocExport> | null>, spec?: UpsertSpec): ObjList<TypeDocExport> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<TypeDocExport>, srcObjs?: Array_Type<TypeDocExport>, spec?: UpsertSpec): ObjList<TypeDocExport> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<TypeDocExport> | null>, spec?: UpsertSpec): ObjList<TypeDocExport> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<TypeDocExport>, spec?: TouchSpec): ObjList<TypeDocExport> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<TypeDocExport>, spec?: MergeSpec): ObjList<TypeDocExport> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<TypeDocExport>, mergeInclude: string, spec?: MergeSpec): ObjList<TypeDocExport> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<TypeDocExport> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<TypeDocExport> | null;
   ...
   */
  static mergeAll(mergeObj: TypeDocExport, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: TypeDocExport, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<TypeDocExport>, spec?: UpsertSpec): ObjList<TypeDocExport> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<TypeDocExport>, spec?: UpsertSpec): ObjList<TypeDocExport> | null;
   ...
   */
  static beforeCreate(objs: Array_Type<TypeDocExport>): ObjList<TypeDocExport>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<TypeDocExport>): ObjList<TypeDocExport>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<TypeDocExport>): ObjList<TypeDocExport>;
   ...
   */
  static afterCreate(objs: Array_Type<TypeDocExport>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<TypeDocExport>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<TypeDocExport>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<TypeDocExport>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<TypeDocExport>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): TypeDocExport | null;
   ...
   */
  withoutIdentity(): TypeDocExport | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<TypeDocExport>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: TypeDocExport, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<TypeDocExport>, callback?: λFunction<TypeDocExport | null, TypeDocExport | null>): ObjList<TypeDocExport>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<TypeDocExport>, callback?: λFunction<TypeDocExport | null, TypeDocExport | null>): Array_Type<ObjError> | null;
   ...
   */
  static doStart(job?: TypeDocExport, options?: TypeDocExportOptions): void;
   ...
   */
  static processBatch(batch?: TypeDocExportBatch, job?: TypeDocExport, options?: TypeDocExportOptions): void;
   ...
   */
  static allComplete(job: TypeDocExport, options?: TypeDocExportOptions): string | null;
   ...
   *           Options the job was run with.
   */
  static failed(job: TypeDocExport, status: BatchJobStatus, options?: TypeDocExportOptions): void;
   ...
   *        Batch to schedule.
   */
  scheduleBatch(batch?: TypeDocExportBatch): void;
   ...
   *        Batches to schedule.
   */
  scheduleBatches(batches?: Array_Type<TypeDocExportBatch>): void;
   ...
   */
  static scheduleObjBatch(job?: TypeDocExport, objBatch?: ObjBatch, logPrefix?: string): number | null;
