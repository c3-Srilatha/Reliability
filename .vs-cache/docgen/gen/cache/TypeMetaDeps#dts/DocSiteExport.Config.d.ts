// TypeScript definitions for the C3 type DocSiteExport.Config

/**
 * Config Type to store documentation export variables.
 *
 * @remarks this represents a value passed to a method that expects an instance of DocSiteExport.Config
 */
declare namespace DocSiteExport {
  export interface IConfig {
    ...
    /**
     * The [temporary directory](TmpFileSystem#createTmpDirectory) URL created for holding
     * the documentation artifacts.
     */
    tmpDirectoryUrl?: string;

    /**
     * The {@link Pkg} documentation generation is being run for. This **won't** always
     * match {@link App#rootPkg}.
     */
    pkgName?: string;
  }
}
 ...
 * Config Type to store documentation export variables.
 *
 * @remarks this represents a made instance of DocSiteExport.Config
 */
declare namespace DocSiteExport {
  export class Config extends Obj  {

    readonly configOverride?: string;
    withConfigOverride(configOverride: string | null): DocSiteExport.Config;

    static readonly configOverride?: string;

    readonly secretOverride?: string;
    withSecretOverride(secretOverride: string | null): DocSiteExport.Config;
    ...
    withIssues(issues: Array_Type<string> | Array<string> | null): DocSiteExport.Config;
     ...
     * the documentation artifacts.
     */
    readonly tmpDirectoryUrl?: string;
    withTmpDirectoryUrl(tmpDirectoryUrl: string | null): DocSiteExport.Config;

    /**
     * The [temporary directory](TmpFileSystem#createTmpDirectory) URL created for holding
     * the documentation artifacts.
     */
    static readonly tmpDirectoryUrl?: string;
    ...
    withPkgName(pkgName: string | null): DocSiteExport.Config;

    /**
     * The {@link Pkg} documentation generation is being run for. This **won't** always
     * match {@link App#rootPkg}.
     */
    static readonly pkgName?: string;

    /**
     * @return the one and only instance to be used when member functions are called on this type.
     */
    static inst(): DocSiteExport.Config;
     ...
     * @see #toJson
     */
    static fromJson(json: any): DocSiteExport.Config | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): DocSiteExport.Config | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): DocSiteExport.Config | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): DocSiteExport.Config | null;
     ...
     */
    replaceType(old: Type, new_: Type): DocSiteExport.Config;
     ...
     * This method is used during live metadata update
     */
    static replaceType(old: Type, new_: Type): DocSiteExport.Config;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): DocSiteExport.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): DocSiteExport.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): DocSiteExport.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): DocSiteExport.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<DocSiteExport.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<DocSiteExport.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<DocSiteExport.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<DocSiteExport.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): DocSiteExport.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): DocSiteExport.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DocSiteExport.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DocSiteExport.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DocSiteExport.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DocSiteExport.Config;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): DocSiteExport.Config;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    static validateObj(): DocSiteExport.Config;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): DocSiteExport.Config;
     ...
     * @see #defaultField
     */
    static withField(field: string, value: any, doNotConvert?: boolean): DocSiteExport.Config;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): DocSiteExport.Config;
     ...
     * @see #defaultField
     */
    static withField(field: FieldType, value: any, doNotConvert?: boolean): DocSiteExport.Config;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): DocSiteExport.Config;
     ...
     * @return new Obj
     */
    static withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): DocSiteExport.Config;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): DocSiteExport.Config;
     ...
     * @return new Obj
     */
    static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): DocSiteExport.Config;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): DocSiteExport.Config;
     ...
     * @see #withoutField
     */
    static withoutFieldAtPath(path: string): DocSiteExport.Config;
     ...
     * @see #removeField
     */
    withoutField(field: string): DocSiteExport.Config;
     ...
     * @see #removeField
     */
    static withoutField(field: string): DocSiteExport.Config;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): DocSiteExport.Config;
     ...
     * @see #removeField
     */
    static withoutField(field: FieldType): DocSiteExport.Config;
     ...
     */
    withoutFields(fields: Array_Type<string>): DocSiteExport.Config;
     ...
     * @return new Obj with removed fields
     */
    static withoutFields(fields: Array_Type<string>): DocSiteExport.Config;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): DocSiteExport.Config;
     ...
     * @return new Obj with removed fields
     */
    static withoutFieldsByType(fields: Array_Type<FieldType>): DocSiteExport.Config;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): DocSiteExport.Config;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    static withoutSecretFields(): DocSiteExport.Config;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): DocSiteExport.Config;
     ...
     * @see FieldType#defaultValue
     */
    static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): DocSiteExport.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: string): DocSiteExport.Config;
     ...
     * @see #unsetField
     */
    static defaultField(field: string): DocSiteExport.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): DocSiteExport.Config;
     ...
     * @see #unsetField
     */
    static defaultField(field: FieldType): DocSiteExport.Config;
     ...
     * @see #removeField
     */
    unsetField(field: string): DocSiteExport.Config;
     ...
     * @see #removeField
     */
    static unsetField(field: string): DocSiteExport.Config;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): DocSiteExport.Config;
     ...
     * @see #removeField
     */
    static unsetField(field: FieldType): DocSiteExport.Config;
     ...
     * @see #unsetField
     */
    removeField(field: string): DocSiteExport.Config;
     ...
     * @see #unsetField
     */
    static removeField(field: string): DocSiteExport.Config;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): DocSiteExport.Config;
     ...
     * @see #unsetField
     */
    static removeField(field: FieldType): DocSiteExport.Config;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): DocSiteExport.Config;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): DocSiteExport.Config;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): DocSiteExport.Config;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj, otherFieldsFilter: Type): DocSiteExport.Config;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): DocSiteExport.Config;
     ...
     *        the same key or index.
     */
    static mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): DocSiteExport.Config;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): DocSiteExport.Config;
     ...
     * traverse child reference and collection fields.
     */
    static mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): DocSiteExport.Config;

    mergeJson(json: any): DocSiteExport.Config;

    static mergeJson(json: any): DocSiteExport.Config;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): DocSiteExport.Config;
     ...
     * @return Obj with child references merged
     */
    static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): DocSiteExport.Config;
     ...
     */
    sumObj(other: Obj, deep?: boolean): DocSiteExport.Config;
     ...
     * references with same name and collection elements at same index or key.
     */
    static sumObj(other: Obj, deep?: boolean): DocSiteExport.Config;
     ...
     */
    singletonArray(): Array_Type<DocSiteExport.Config>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonArray(): Array_Type<DocSiteExport.Config>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<DocSiteExport.Config> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<DocSiteExport.Config> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<DocSiteExport.Config>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonSet(): Set_Type<DocSiteExport.Config>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<DocSiteExport.Config> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, DocSiteExport.Config> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, DocSiteExport.Config> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<DocSiteExport.Config>;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    static toBuilder(): ObjBuilder<DocSiteExport.Config>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<DocSiteExport.Config>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): DocSiteExport.Config;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): DocSiteExport.Config;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): DocSiteExport.Config;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): DocSiteExport.Config;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): DocSiteExport.Config;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): DocSiteExport.Config;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): DocSiteExport.Config;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): DocSiteExport.Config;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    static afterMake(): DocSiteExport.Config;
     ...
     */
    static cachedEmptyInst(): DocSiteExport.Config;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<DocSiteExport.Config> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): DocSiteExport.Config;
     ...
     */
    static allCached(): Stream<DocSiteExport.Config> | null;
     ...
     */
    static find(filter?: string): Stream<DocSiteExport.Config> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<DocSiteExport.Config> | null;

    /**
     * @return cached instance.
     */
    getCached(): DocSiteExport.Config | null;

    /**
     * @return cached instance.
     */
    static getCached(): DocSiteExport.Config | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string): DocSiteExport.Config | null;
     ...
     */
    static produce(key: string): DocSiteExport.Config | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, DocSiteExport.Config> | null;
     ...
     */
    getConfig(): DocSiteExport.Config;
     ...
     * Note that typical pattern is to use Configurable#config instead of this method.
     */
    static getConfig(): DocSiteExport.Config;
     ...
     */
    getSecret(): DocSiteExport.Config;
     ...
     * Note that typical pattern is to use Configurable#configWithSecrets instead of this method.
     */
    static getSecret(): DocSiteExport.Config;
     ...
     */
    withConfigKey(configKey: string): DocSiteExport.Config;
     ...
     *     config.configKey() => "folder1/abc"
     */
    static withConfigKey(configKey: string): DocSiteExport.Config;

    /**
     * @return copy without config key.
     */
    withoutConfigKey(): DocSiteExport.Config;

    /**
     * @return copy without config key.
     */
    static withoutConfigKey(): DocSiteExport.Config;

    /**
     * @return return cached config instance for provided config key.
     */
    static forConfigKey(configKey: string): DocSiteExport.Config | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string>): Stream<DocSiteExport.Config> | null;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: DocSiteExport.Config, override?: string): void;
     ...
     * @see setConfigValue
     */
    static setConfigValues(from: DocSiteExport.Config, override?: string): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): DocSiteExport.Config | null;
     ...
     */
    removeSecrets(): DocSiteExport.Config | null;

    /**
     * @return this config without any secret values.
     */
    static removeSecrets(): DocSiteExport.Config | null;

    /**
     * @return this config with only secret values.
     */
    removeNonSecrets(): DocSiteExport.Config | null;

    /**
     * @return this config with only secret values.
     */
    static removeNonSecrets(): DocSiteExport.Config | null;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    validate(): DocSiteExport.Config;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    static validate(): DocSiteExport.Config;
