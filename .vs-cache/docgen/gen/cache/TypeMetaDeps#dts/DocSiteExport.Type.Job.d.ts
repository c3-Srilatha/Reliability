// TypeScript definitions for the C3 type DocSiteExport.Type.Job

/**
 * Batch job to export documentation for {@link Type} ([.c3typ](FileExt#TYPE)) files.
 *
 * @remarks this represents a value passed to a method that expects an instance of DocSiteExport.Type.Job
 */
declare namespace DocSiteExport.Type {
...
declare namespace DocSiteExport.Type {
  export class Job extends Obj  {
    ...
    withRun(run: IBatchJobRun | null): DocSiteExport.Type.Job;

    /**
     * previous job executions for this instance
     */
    readonly runs?: Array_Type<BatchJobRun>;
    withRuns(runs: Array_Type<BatchJobRun> | Array<IBatchJobRun> | null): DocSiteExport.Type.Job;

    /**
     * FOR INTERNAL USE ONLY - Specify options in call to {@link start}.
     */
    readonly options?: Obj;
    withOptions(options: IObj | null): DocSiteExport.Type.Job;
    ...
    withOnCompleteCallback(onCompleteCallback: IJobBase.Callback | null): DocSiteExport.Type.Job;
    ...
    withPriority(priority: number | null): DocSiteExport.Type.Job;
    ...
    withDisabled(disabled: boolean): DocSiteExport.Type.Job;
    ...
    withMaxConcurrency(maxConcurrency: number | null): DocSiteExport.Type.Job;
    ...
    withMaxConcurrencyPerNode(maxConcurrencyPerNode: number | null): DocSiteExport.Type.Job;
    ...
    withRunAsUser(runAsUser: boolean): DocSiteExport.Type.Job;

    /**
     * Don't set this field in the BatchJob, set it in the BatchJobOptions when calling `start`
     */
    readonly nodePool?: string;
    withNodePool(nodePool: string | null): DocSiteExport.Type.Job;
    ...
    withSkipIfRunning(skipIfRunning: boolean): DocSiteExport.Type.Job;

    /**
     * Set to between 1 and 5 to enable auto recovery. See {@link invalidation-queues.c3doc Invalidation Queues} for detailed documentation.
     */
    readonly numAutoRecoveryAttempts?: number;
    withNumAutoRecoveryAttempts(numAutoRecoveryAttempts: number | null): DocSiteExport.Type.Job;
    ...
    withTypeIdent(typeIdent: string | null): DocSiteExport.Type.Job;
     ...
     */
    readonly id: string;
    withId(id: string): DocSiteExport.Type.Job;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): DocSiteExport.Type.Job;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): DocSiteExport.Type.Job;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): DocSiteExport.Type.Job;
    ...
    withVersion(version: number | null): DocSiteExport.Type.Job;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): DocSiteExport.Type.Job;
    ...
    withAbortOnError(abortOnError: boolean): DocSiteExport.Type.Job;
     ...
     * @see #toJson
     */
    static fromJson(json: any): DocSiteExport.Type.Job | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): DocSiteExport.Type.Job | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): DocSiteExport.Type.Job | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): DocSiteExport.Type.Job | null;
     ...
     */
    replaceType(old: Type, new_: Type): DocSiteExport.Type.Job;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): DocSiteExport.Type.Job;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): DocSiteExport.Type.Job;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<DocSiteExport.Type.Job>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<DocSiteExport.Type.Job>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): DocSiteExport.Type.Job;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DocSiteExport.Type.Job;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DocSiteExport.Type.Job;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): DocSiteExport.Type.Job;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): DocSiteExport.Type.Job;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): DocSiteExport.Type.Job;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): DocSiteExport.Type.Job;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): DocSiteExport.Type.Job;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): DocSiteExport.Type.Job;
     ...
     * @see #removeField
     */
    withoutField(field: string): DocSiteExport.Type.Job;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): DocSiteExport.Type.Job;
     ...
     */
    withoutFields(fields: Array_Type<string>): DocSiteExport.Type.Job;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): DocSiteExport.Type.Job;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): DocSiteExport.Type.Job;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): DocSiteExport.Type.Job;
     ...
     * @see #unsetField
     */
    defaultField(field: string): DocSiteExport.Type.Job;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): DocSiteExport.Type.Job;
     ...
     * @see #removeField
     */
    unsetField(field: string): DocSiteExport.Type.Job;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): DocSiteExport.Type.Job;
     ...
     * @see #unsetField
     */
    removeField(field: string): DocSiteExport.Type.Job;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): DocSiteExport.Type.Job;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): DocSiteExport.Type.Job;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): DocSiteExport.Type.Job;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): DocSiteExport.Type.Job;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): DocSiteExport.Type.Job;

    mergeJson(json: any): DocSiteExport.Type.Job;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): DocSiteExport.Type.Job;
     ...
     */
    sumObj(other: Obj, deep?: boolean): DocSiteExport.Type.Job;
     ...
     */
    singletonArray(): Array_Type<DocSiteExport.Type.Job>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<DocSiteExport.Type.Job> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<DocSiteExport.Type.Job> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<DocSiteExport.Type.Job>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<DocSiteExport.Type.Job> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, DocSiteExport.Type.Job> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, DocSiteExport.Type.Job> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<DocSiteExport.Type.Job>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<DocSiteExport.Type.Job>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): DocSiteExport.Type.Job;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): DocSiteExport.Type.Job;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): DocSiteExport.Type.Job;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): DocSiteExport.Type.Job;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): DocSiteExport.Type.Job;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): DocSiteExport.Type.Job;
     ...
     * @see #fromString
     */
    static make(s: string): DocSiteExport.Type.Job | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): DocSiteExport.Type.Job;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): DocSiteExport.Type.Job;
     ...
     */
    static cachedEmptyInst(): DocSiteExport.Type.Job;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<DocSiteExport.Type.Job> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): DocSiteExport.Type.Job;
     ...
     */
    start(options?: DocSiteExport.Type.Job.Options): BatchJobStatus | null;
     ...
     */
    cleanup(options?: DocSiteExport.Type.Job.Options): void;
    ...
    cancelJob(removeResults?: boolean, force?: boolean): JobBase<BatchJobRun, BatchJobStatus, DocSiteExport.Type.Job.Options> | null;

    failJob(run: JobRun<BatchJobStatusBase>): JobBase<BatchJobRun, BatchJobStatus, DocSiteExport.Type.Job.Options> | null;
    ...
    validateStart(options?: DocSiteExport.Type.Job.Options): void;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<DocSiteExport.Type.Job>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<DocSiteExport.Type.Job>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<DocSiteExport.Type.Job> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<DocSiteExport.Type.Job>> | null;
     ...
     */
    get(include?: string): DocSiteExport.Type.Job | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): DocSiteExport.Type.Job | null;
     ...
     */
    getMissing(spec: GetMissingSpec): DocSiteExport.Type.Job;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): DocSiteExport.Type.Job | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): DocSiteExport.Type.Job;
     ...
     * @see #toString
     */
    static fromString(s: string): DocSiteExport.Type.Job | null;
     ...
     */
    create(spec?: UpsertSpec): DocSiteExport.Type.Job | null;
     ...
     */
    static createBatch(objs: Array_Type<DocSiteExport.Type.Job>, spec?: UpsertSpec): ObjList<DocSiteExport.Type.Job> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<DocSiteExport.Type.Job>, spec?: CreateBatchObjStreamSpec): ObjList<DocSiteExport.Type.Job> | null;
     ...
     */
    update(srcObj?: DocSiteExport.Type.Job, spec?: UpsertSpec): DocSiteExport.Type.Job | null;
     ...
     */
    upsert(srcObj?: DocSiteExport.Type.Job, spec?: UpsertSpec): DocSiteExport.Type.Job | null;
     ...
     */
    merge(spec?: MergeSpec): DocSiteExport.Type.Job | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): DocSiteExport.Type.Job | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): DocSiteExport.Type.Job | null;
     ...
     */
    static updateBatch(objs: Array_Type<DocSiteExport.Type.Job>, srcObjs?: Array_Type<DocSiteExport.Type.Job>, spec?: UpsertSpec): ObjList<DocSiteExport.Type.Job> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<DocSiteExport.Type.Job> | null>, spec?: UpsertSpec): ObjList<DocSiteExport.Type.Job> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<DocSiteExport.Type.Job>, srcObjs?: Array_Type<DocSiteExport.Type.Job>, spec?: UpsertSpec): ObjList<DocSiteExport.Type.Job> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<DocSiteExport.Type.Job> | null>, spec?: UpsertSpec): ObjList<DocSiteExport.Type.Job> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<DocSiteExport.Type.Job>, spec?: TouchSpec): ObjList<DocSiteExport.Type.Job> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<DocSiteExport.Type.Job>, spec?: MergeSpec): ObjList<DocSiteExport.Type.Job> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<DocSiteExport.Type.Job>, mergeInclude: string, spec?: MergeSpec): ObjList<DocSiteExport.Type.Job> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<DocSiteExport.Type.Job> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<DocSiteExport.Type.Job> | null;
     ...
     */
    static mergeAll(mergeObj: DocSiteExport.Type.Job, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: DocSiteExport.Type.Job, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<DocSiteExport.Type.Job>, spec?: UpsertSpec): ObjList<DocSiteExport.Type.Job> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<DocSiteExport.Type.Job>, spec?: UpsertSpec): ObjList<DocSiteExport.Type.Job> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): DocSiteExport.Type.Job | null;
     ...
     */
    static beforeCreate(objs: Array_Type<DocSiteExport.Type.Job>): ObjList<DocSiteExport.Type.Job>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<DocSiteExport.Type.Job>): ObjList<DocSiteExport.Type.Job>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<DocSiteExport.Type.Job>): ObjList<DocSiteExport.Type.Job>;
     ...
     */
    static afterCreate(objs: Array_Type<DocSiteExport.Type.Job>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<DocSiteExport.Type.Job>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<DocSiteExport.Type.Job>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<DocSiteExport.Type.Job>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<DocSiteExport.Type.Job>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): DocSiteExport.Type.Job | null;
     ...
     */
    withoutIdentity(): DocSiteExport.Type.Job | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<DocSiteExport.Type.Job>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: DocSiteExport.Type.Job, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<DocSiteExport.Type.Job>, callback?: λFunction<DocSiteExport.Type.Job | null, DocSiteExport.Type.Job | null>): ObjList<DocSiteExport.Type.Job>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<DocSiteExport.Type.Job>, callback?: λFunction<DocSiteExport.Type.Job | null, DocSiteExport.Type.Job | null>): Array_Type<ObjError> | null;
     ...
     */
    static doStart(job?: DocSiteExport.Type.Job, options?: DocSiteExport.Type.Job.Options): void;
     ...
     */
    static processBatch(batch?: DocSiteExport.Type.Job.Batch, job?: DocSiteExport.Type.Job, options?: DocSiteExport.Type.Job.Options): void;
     ...
     */
    static allComplete(job: DocSiteExport.Type.Job, options?: DocSiteExport.Type.Job.Options): string | null;
     ...
     *           Options the job was run with.
     */
    static failed(job: DocSiteExport.Type.Job, status: BatchJobStatus, options?: DocSiteExport.Type.Job.Options): void;
     ...
     *        Batch to schedule.
     */
    scheduleBatch(batch?: DocSiteExport.Type.Job.Batch): void;
     ...
     *        Batches to schedule.
     */
    scheduleBatches(batches?: Array_Type<DocSiteExport.Type.Job.Batch>): void;
     ...
     */
    static scheduleObjBatch(job?: DocSiteExport.Type.Job, objBatch?: ObjBatch, logPrefix?: string): number | null;
