// TypeScript definitions for the C3 type TopicDocExport

/**
 * Batch job to export documentation for C3 topics.
 *
 * @remarks this represents a value passed to a method that expects an instance of TopicDocExport
 */
declare interface ITopicDocExport {
 ...
 */
declare class TopicDocExport extends Obj  {

  /**
   * current or last job execution for this instance
   */
  readonly run?: BatchJobRun;
  withRun(run: IBatchJobRun | null): TopicDocExport;

  /**
   * previous job executions for this instance
   */
  readonly runs?: Array_Type<BatchJobRun>;
  withRuns(runs: Array_Type<BatchJobRun> | Array<IBatchJobRun> | null): TopicDocExport;

  /**
   * FOR INTERNAL USE ONLY - Specify options in call to {@link start}.
   */
  readonly options?: Obj;
  withOptions(options: IObj | null): TopicDocExport;
  ...
  withOnCompleteCallback(onCompleteCallback: IJobBase.Callback | null): TopicDocExport;
  ...
  withPriority(priority: number | null): TopicDocExport;
  ...
  withDisabled(disabled: boolean): TopicDocExport;
  ...
  withMaxConcurrency(maxConcurrency: number | null): TopicDocExport;
  ...
  withMaxConcurrencyPerNode(maxConcurrencyPerNode: number | null): TopicDocExport;
  ...
  withRunAsUser(runAsUser: boolean): TopicDocExport;

  /**
   * Don't set this field in the BatchJob, set it in the BatchJobOptions when calling `start`
   */
  readonly nodePool?: string;
  withNodePool(nodePool: string | null): TopicDocExport;
  ...
  withSkipIfRunning(skipIfRunning: boolean): TopicDocExport;

  /**
   * Set to between 1 and 5 to enable auto recovery. See {@link invalidation-queues.c3doc Invalidation Queues} for detailed documentation.
   */
  readonly numAutoRecoveryAttempts?: number;
  withNumAutoRecoveryAttempts(numAutoRecoveryAttempts: number | null): TopicDocExport;
  ...
  withTypeIdent(typeIdent: string | null): TopicDocExport;
   ...
   */
  readonly id: string;
  withId(id: string): TopicDocExport;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): TopicDocExport;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): TopicDocExport;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): TopicDocExport;
  ...
  withVersion(version: number | null): TopicDocExport;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): TopicDocExport;
  ...
  withAbortOnError(abortOnError: boolean): TopicDocExport;
   ...
   * @see #toJson
   */
  static fromJson(json: any): TopicDocExport | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): TopicDocExport | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): TopicDocExport | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): TopicDocExport | null;
   ...
   */
  replaceType(old: Type, new_: Type): TopicDocExport;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): TopicDocExport;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): TopicDocExport;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<TopicDocExport>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<TopicDocExport>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): TopicDocExport;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TopicDocExport;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TopicDocExport;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): TopicDocExport;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): TopicDocExport;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): TopicDocExport;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): TopicDocExport;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): TopicDocExport;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): TopicDocExport;
   ...
   * @see #removeField
   */
  withoutField(field: string): TopicDocExport;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): TopicDocExport;
   ...
   */
  withoutFields(fields: Array_Type<string>): TopicDocExport;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): TopicDocExport;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): TopicDocExport;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): TopicDocExport;
   ...
   * @see #unsetField
   */
  defaultField(field: string): TopicDocExport;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): TopicDocExport;
   ...
   * @see #removeField
   */
  unsetField(field: string): TopicDocExport;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): TopicDocExport;
   ...
   * @see #unsetField
   */
  removeField(field: string): TopicDocExport;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): TopicDocExport;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): TopicDocExport;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): TopicDocExport;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): TopicDocExport;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): TopicDocExport;

  mergeJson(json: any): TopicDocExport;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): TopicDocExport;
   ...
   */
  sumObj(other: Obj, deep?: boolean): TopicDocExport;
   ...
   */
  singletonArray(): Array_Type<TopicDocExport>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<TopicDocExport> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<TopicDocExport> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<TopicDocExport>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<TopicDocExport> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, TopicDocExport> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, TopicDocExport> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<TopicDocExport>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<TopicDocExport>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): TopicDocExport;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): TopicDocExport;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): TopicDocExport;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): TopicDocExport;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): TopicDocExport;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): TopicDocExport;
   ...
   * @see #fromString
   */
  static make(s: string): TopicDocExport | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): TopicDocExport;
   ...
   */
  static cachedEmptyInst(): TopicDocExport;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<TopicDocExport> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): TopicDocExport;
   ...
   */
  start(options?: TopicDocExportOptions): BatchJobStatus | null;
   ...
   */
  cleanup(options?: TopicDocExportOptions): void;
  ...
  cancelJob(removeResults?: boolean, force?: boolean): JobBase<BatchJobRun, BatchJobStatus, TopicDocExportOptions> | null;

  failJob(run: JobRun<BatchJobStatusBase>): JobBase<BatchJobRun, BatchJobStatus, TopicDocExportOptions> | null;
  ...
  validateStart(options?: TopicDocExportOptions): void;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<TopicDocExport>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<TopicDocExport>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<TopicDocExport> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<TopicDocExport>> | null;
   ...
   */
  get(include?: string): TopicDocExport | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): TopicDocExport | null;
   ...
   */
  getMissing(spec: GetMissingSpec): TopicDocExport;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): TopicDocExport | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): TopicDocExport;
   ...
   * @see #toString
   */
  static fromString(s: string): TopicDocExport | null;
   ...
   */
  create(spec?: UpsertSpec): TopicDocExport | null;
   ...
   */
  static createBatch(objs: Array_Type<TopicDocExport>, spec?: UpsertSpec): ObjList<TopicDocExport> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<TopicDocExport>, spec?: CreateBatchObjStreamSpec): ObjList<TopicDocExport> | null;
   ...
   */
  update(srcObj?: TopicDocExport, spec?: UpsertSpec): TopicDocExport | null;
   ...
   */
  upsert(srcObj?: TopicDocExport, spec?: UpsertSpec): TopicDocExport | null;
   ...
   */
  merge(spec?: MergeSpec): TopicDocExport | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): TopicDocExport | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): TopicDocExport | null;
   ...
   */
  static updateBatch(objs: Array_Type<TopicDocExport>, srcObjs?: Array_Type<TopicDocExport>, spec?: UpsertSpec): ObjList<TopicDocExport> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<TopicDocExport> | null>, spec?: UpsertSpec): ObjList<TopicDocExport> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<TopicDocExport>, srcObjs?: Array_Type<TopicDocExport>, spec?: UpsertSpec): ObjList<TopicDocExport> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<TopicDocExport> | null>, spec?: UpsertSpec): ObjList<TopicDocExport> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<TopicDocExport>, spec?: TouchSpec): ObjList<TopicDocExport> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<TopicDocExport>, spec?: MergeSpec): ObjList<TopicDocExport> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<TopicDocExport>, mergeInclude: string, spec?: MergeSpec): ObjList<TopicDocExport> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<TopicDocExport> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<TopicDocExport> | null;
   ...
   */
  static mergeAll(mergeObj: TopicDocExport, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: TopicDocExport, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<TopicDocExport>, spec?: UpsertSpec): ObjList<TopicDocExport> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<TopicDocExport>, spec?: UpsertSpec): ObjList<TopicDocExport> | null;
   ...
   */
  static beforeCreate(objs: Array_Type<TopicDocExport>): ObjList<TopicDocExport>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<TopicDocExport>): ObjList<TopicDocExport>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<TopicDocExport>): ObjList<TopicDocExport>;
   ...
   */
  static afterCreate(objs: Array_Type<TopicDocExport>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<TopicDocExport>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<TopicDocExport>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<TopicDocExport>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<TopicDocExport>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): TopicDocExport | null;
   ...
   */
  withoutIdentity(): TopicDocExport | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<TopicDocExport>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: TopicDocExport, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<TopicDocExport>, callback?: λFunction<TopicDocExport | null, TopicDocExport | null>): ObjList<TopicDocExport>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<TopicDocExport>, callback?: λFunction<TopicDocExport | null, TopicDocExport | null>): Array_Type<ObjError> | null;
   ...
   */
  static doStart(job?: TopicDocExport, options?: TopicDocExportOptions): void;
   ...
   */
  static processBatch(batch?: TopicDocExportBatch, job?: TopicDocExport, options?: TopicDocExportOptions): void;
   ...
   */
  static allComplete(job: TopicDocExport, options?: TopicDocExportOptions): string | null;
   ...
   *           Options the job was run with.
   */
  static failed(job: TopicDocExport, status: BatchJobStatus, options?: TopicDocExportOptions): void;
   ...
   *        Batch to schedule.
   */
  scheduleBatch(batch?: TopicDocExportBatch): void;
   ...
   *        Batches to schedule.
   */
  scheduleBatches(batches?: Array_Type<TopicDocExportBatch>): void;
   ...
   */
  static scheduleObjBatch(job?: TopicDocExport, objBatch?: ObjBatch, logPrefix?: string): number | null;
