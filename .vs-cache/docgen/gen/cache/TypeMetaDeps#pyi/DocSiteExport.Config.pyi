...
# Python definitions for the C3 type DocSiteExport.Config
...
class Config(Singleton, Config):
    ...
    tmpDirectoryUrl: Optional[str]=None
    """
    ...
    """
    def __init__(self, configOverride: Optional[str]=None, secretOverride: Optional[str]=None, issues: Optional[Array[str]]=None, tmpDirectoryUrl: Optional[str]=None, pkgName: Optional[str]=None) -> None: ...

    @classmethod
    def inst(cls) -> DocSiteExport.Config:
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[DocSiteExport.Config]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[DocSiteExport.Config]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[DocSiteExport.Config]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[DocSiteExport.Config]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> DocSiteExport.Config:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> DocSiteExport.Config:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> DocSiteExport.Config:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[DocSiteExport.Config]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[DocSiteExport.Config]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> DocSiteExport.Config:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> DocSiteExport.Config:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> DocSiteExport.Config:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> DocSiteExport.Config:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> DocSiteExport.Config:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> DocSiteExport.Config:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> DocSiteExport.Config:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> DocSiteExport.Config:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> DocSiteExport.Config:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> DocSiteExport.Config:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> DocSiteExport.Config:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> DocSiteExport.Config:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> DocSiteExport.Config:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> DocSiteExport.Config:
    """
    @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> DocSiteExport.Config:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> DocSiteExport.Config:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> DocSiteExport.Config:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> DocSiteExport.Config:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> DocSiteExport.Config:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> DocSiteExport.Config:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> DocSiteExport.Config:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> DocSiteExport.Config:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> DocSiteExport.Config:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> DocSiteExport.Config:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> DocSiteExport.Config:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> DocSiteExport.Config:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> DocSiteExport.Config:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> DocSiteExport.Config:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[DocSiteExport.Config]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[DocSiteExport.Config]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[DocSiteExport.Config]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[DocSiteExport.Config]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[DocSiteExport.Config]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, DocSiteExport.Config]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, DocSiteExport.Config]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[DocSiteExport.Config]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[DocSiteExport.Config]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> DocSiteExport.Config:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> DocSiteExport.Config:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> DocSiteExport.Config:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> DocSiteExport.Config:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> DocSiteExport.Config:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> DocSiteExport.Config:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> DocSiteExport.Config:
    """
    ...
    """
        ...
    def afterMake(self) -> DocSiteExport.Config:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> DocSiteExport.Config:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[DocSiteExport.Config]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> DocSiteExport.Config:
    """
    ...
    """
        ...
    @classmethod
    def allCached(cls) -> Union[Stream[DocSiteExport.Config]]:
    """
    @return stream of all available Cached instances.
    """
        ...
    @classmethod
    def find(cls, filter: str=None) -> Union[Stream[DocSiteExport.Config]]:
    """
    ...
    """
        ...
    @classmethod
    def findBy(cls, field: str, value: Any) -> Union[Stream[DocSiteExport.Config]]:
    """
    @return existing instances of this type that satisfy filter from data cache. Will call `produceAll`
            if cache is empty or if Ann.cache.all is true & data has not previously been fetched.
            Otherwise no population will be performed.
    """
        ...
    def getCached(self) -> Union[DocSiteExport.Config]:
    """
    @return cached instance.
    """
        ...
    @classmethod
    def forCacheKey(cls, key: str) -> Union[DocSiteExport.Config]:
    """
    ...
    """
        ...
    @classmethod
    def produce(cls, key: str) -> Union[DocSiteExport.Config]:
    """
    Should produce an entry for the cache key. This method should not be called directly.
    """
        ...
    @classmethod
    def produceAll(cls) -> Union[Map[str, DocSiteExport.Config]]:
    """
    ...
    """
        ...
    def getConfig(self) -> DocSiteExport.Config:
    """
    ...
    """
        ...
    def getSecret(self) -> DocSiteExport.Config:
    """
    ...
    """
        ...
    def withConfigKey(self, configKey: str) -> DocSiteExport.Config:
    """
    ...
    """
        ...
    def withoutConfigKey(self) -> DocSiteExport.Config:
    """
    @return copy without config key.
    """
        ...
    @classmethod
    def forConfigKey(cls, configKey: str) -> Union[DocSiteExport.Config]:
    """
    ...
    """
        ...
    @classmethod
    def listConfigs(cls, parallel: bool=None, filter: Callable[[str], bool]=None) -> Union[Stream[DocSiteExport.Config]]:
    """
    @param
    ...
    """
        ...
    @overload
    def setConfigValues(self, from_: DocSiteExport.Config, override: str=None) -> None:
    """
    ...
    """
        ...
    @classmethod
    def loadConfigAndSecret(cls, configKey: str) -> Union[DocSiteExport.Config]:
    """
    ...
    """
        ...
    def removeSecrets(self) -> Union[DocSiteExport.Config]:
    """
    @return this config without any secret values.
    """
        ...
    def removeNonSecrets(self) -> Union[DocSiteExport.Config]:
    """
    @return this config with only secret values.
    """
        ...
    def validate(self) -> DocSiteExport.Config:
    """
