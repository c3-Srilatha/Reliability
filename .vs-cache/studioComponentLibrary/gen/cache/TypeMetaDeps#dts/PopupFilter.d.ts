// TypeScript definitions for the C3 type PopupFilter

/**
 * A filter pills component where users add filters from a popup.
 *
 * @remarks this represents a value passed to a method that expects an instance of PopupFilter
 */
declare interface IPopupFilter {
 ...
 */
declare class PopupFilter extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): PopupFilter | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): PopupFilter | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): PopupFilter | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): PopupFilter | null;
   ...
   */
  replaceType(old: Type, new_: Type): PopupFilter;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): PopupFilter;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): PopupFilter;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<PopupFilter | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<PopupFilter | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): PopupFilter;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): PopupFilter;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): PopupFilter;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): PopupFilter;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): PopupFilter;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): PopupFilter;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): PopupFilter;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): PopupFilter;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): PopupFilter;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): PopupFilter;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): PopupFilter;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): PopupFilter;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): PopupFilter;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): PopupFilter;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): PopupFilter;
   ...
   * @see #unsetField
   */
  defaultField(field: string): PopupFilter;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): PopupFilter;
   ...
   * @see #removeField
   */
  unsetField(field: string): PopupFilter;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): PopupFilter;
   ...
   * @see #unsetField
   */
  removeField(field: string): PopupFilter;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): PopupFilter;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): PopupFilter;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): PopupFilter;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): PopupFilter;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): PopupFilter;

  mergeJson(json: any | null): PopupFilter;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): PopupFilter;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): PopupFilter;
   ...
   */
  singletonArray(): C3.Array<PopupFilter | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<PopupFilter | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<PopupFilter | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<PopupFilter | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<PopupFilter | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, PopupFilter | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, PopupFilter | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<PopupFilter | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<PopupFilter | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): PopupFilter;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): PopupFilter;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): PopupFilter;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): PopupFilter;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): PopupFilter;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): PopupFilter;
   ...
   * @see #fromString
   */
  static make(s: string | null): PopupFilter | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): PopupFilter;
   ...
   */
  static cachedEmptyInst(): PopupFilter;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<PopupFilter>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): PopupFilter;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<PopupFilter | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<PopupFilter | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<PopupFilter | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<PopupFilter | null> | null>;
   ...
   */
  dependencies(): MetadataDeps<PopupFilter | null>;

  save(subPath?: string | null, contentType?: string | null): PopupFilter;
  ...
  update(srcObj?: PopupFilter | null, spec?: UpsertSpec | null): PopupFilter | null;

  upsert(srcObj?: PopupFilter | null, spec?: UpsertSpec | null): PopupFilter | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): PopupFilter | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string | null, failIfMissing?: boolean): PopupFilter | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: PopupFilter, state: UiSdlReduxState): PopupFilter | null;
