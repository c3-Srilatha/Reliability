// TypeScript definitions for the C3 type CurrentAppInfoApplicationState
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of CurrentAppInfoApplicationState
 */
declare interface ICurrentAppInfoApplicationState {
   ...
   */
  currentAppInfo?: any | null;

  /**
   * Map of package dependencies for the current application
   */
  packageDependencies?: IC3.Map<string | null, Pkg | null> | null;
}
 ...
 */
declare class CurrentAppInfoApplicationState extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): CurrentAppInfoApplicationState | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): CurrentAppInfoApplicationState | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): CurrentAppInfoApplicationState | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): CurrentAppInfoApplicationState | null;
   ...
   */
  replaceType(old: Type, new_: Type): CurrentAppInfoApplicationState;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): CurrentAppInfoApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): CurrentAppInfoApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<CurrentAppInfoApplicationState | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<CurrentAppInfoApplicationState | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): CurrentAppInfoApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): CurrentAppInfoApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): CurrentAppInfoApplicationState;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): CurrentAppInfoApplicationState;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): CurrentAppInfoApplicationState;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): CurrentAppInfoApplicationState;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): CurrentAppInfoApplicationState;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): CurrentAppInfoApplicationState;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): CurrentAppInfoApplicationState;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): CurrentAppInfoApplicationState;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): CurrentAppInfoApplicationState;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): CurrentAppInfoApplicationState;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): CurrentAppInfoApplicationState;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): CurrentAppInfoApplicationState;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): CurrentAppInfoApplicationState;
   ...
   * @see #unsetField
   */
  defaultField(field: string): CurrentAppInfoApplicationState;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): CurrentAppInfoApplicationState;
   ...
   * @see #removeField
   */
  unsetField(field: string): CurrentAppInfoApplicationState;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): CurrentAppInfoApplicationState;
   ...
   * @see #unsetField
   */
  removeField(field: string): CurrentAppInfoApplicationState;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): CurrentAppInfoApplicationState;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): CurrentAppInfoApplicationState;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): CurrentAppInfoApplicationState;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): CurrentAppInfoApplicationState;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): CurrentAppInfoApplicationState;

  mergeJson(json: any | null): CurrentAppInfoApplicationState;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): CurrentAppInfoApplicationState;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): CurrentAppInfoApplicationState;
   ...
   */
  singletonArray(): C3.Array<CurrentAppInfoApplicationState | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<CurrentAppInfoApplicationState | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<CurrentAppInfoApplicationState | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<CurrentAppInfoApplicationState | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<CurrentAppInfoApplicationState | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, CurrentAppInfoApplicationState | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, CurrentAppInfoApplicationState | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<CurrentAppInfoApplicationState | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<CurrentAppInfoApplicationState | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): CurrentAppInfoApplicationState;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): CurrentAppInfoApplicationState;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): CurrentAppInfoApplicationState;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): CurrentAppInfoApplicationState;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): CurrentAppInfoApplicationState;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): CurrentAppInfoApplicationState;
   ...
   * @see #fromString
   */
  static make(s: string | null): CurrentAppInfoApplicationState | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): CurrentAppInfoApplicationState;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): CurrentAppInfoApplicationState;
   ...
   */
  static cachedEmptyInst(): CurrentAppInfoApplicationState;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<CurrentAppInfoApplicationState>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): CurrentAppInfoApplicationState;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<CurrentAppInfoApplicationState | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<CurrentAppInfoApplicationState | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<CurrentAppInfoApplicationState | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<CurrentAppInfoApplicationState | null> | null>;
   ...
   */
  dependencies(): MetadataDeps<CurrentAppInfoApplicationState | null>;

  save(subPath?: string | null, contentType?: string | null): CurrentAppInfoApplicationState;
  ...
  update(srcObj?: CurrentAppInfoApplicationState | null, spec?: UpsertSpec | null): CurrentAppInfoApplicationState | null;

  upsert(srcObj?: CurrentAppInfoApplicationState | null, spec?: UpsertSpec | null): CurrentAppInfoApplicationState | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): CurrentAppInfoApplicationState | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string | null, failIfMissing?: boolean): CurrentAppInfoApplicationState | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: CurrentAppInfoApplicationState, state: UiSdlReduxState): CurrentAppInfoApplicationState | null;
   ...
   */
  static setCurrentAppInfoAction(currentAppInfo?: any | null): UiSdlReduxAction<any>;

  /**
   * Listens for actions of type `SET_CURRENT_APP_INFO` and sets `currentAppInfo`
   */
  static setCurrentAppInfoReducer(state: UiSdlReduxState, action: UiSdlReduxAction<any>): UiSdlReduxState;

  /**
   * Retrieves the `currentAppInfo` from state
   */
  static getCurrentAppInfo(state: UiSdlReduxState): any | null;

  /**
   * Getter to determine if the current application is in production mode
   */
  static isAppInProdMode(state: UiSdlReduxState): boolean;
   ...
   */
  static getCurrentAppInfoAction(): UiSdlAction;

  /**
   * Epic to populate the `currentAppInfo` on application state initialize
   */
  static setCurrentAppInfoEpic(state: UiSdlReduxState, action: UiSdlReduxAction<any>): UiSdlReduxState;

  /**
   * An action to set `packageDependencies`
   */
  static setPackageDependenciesAction(packageDependencies?: C3.Map<string | null, Pkg | null> | null): UiSdlReduxAction<any>;

  /**
   * Listens for actions of type `SET_PACKAGE_DEPENDENCIES` and sets `packageDependencies`
   */
  static setPackageDependenciesReducer(state: UiSdlReduxState, action: UiSdlReduxAction<any>): UiSdlReduxState;

  /**
   * Retrieves the `packageDependencies` from state
   */
  static getPackageDependencies(state: UiSdlReduxState): C3.Map<string | null, Pkg | null> | null;
}
