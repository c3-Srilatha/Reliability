// TypeScript definitions for the C3 type StudioModalReact

/**
 * React renderer for {@link StudioModal}
 *
 * @remarks this represents a value passed to a method that expects an instance of StudioModalReact
 */
declare interface IStudioModalReact {
 ...
 */
declare class StudioModalReact extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): StudioModalReact | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): StudioModalReact | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): StudioModalReact | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): StudioModalReact | null;
   ...
   */
  replaceType(old: Type, new_: Type): StudioModalReact;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): StudioModalReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): StudioModalReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<StudioModalReact | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<StudioModalReact | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): StudioModalReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): StudioModalReact;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): StudioModalReact;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): StudioModalReact;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): StudioModalReact;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): StudioModalReact;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): StudioModalReact;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): StudioModalReact;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): StudioModalReact;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): StudioModalReact;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): StudioModalReact;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): StudioModalReact;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): StudioModalReact;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): StudioModalReact;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): StudioModalReact;
   ...
   * @see #unsetField
   */
  defaultField(field: string): StudioModalReact;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): StudioModalReact;
   ...
   * @see #removeField
   */
  unsetField(field: string): StudioModalReact;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): StudioModalReact;
   ...
   * @see #unsetField
   */
  removeField(field: string): StudioModalReact;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): StudioModalReact;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): StudioModalReact;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): StudioModalReact;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): StudioModalReact;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): StudioModalReact;

  mergeJson(json: any | null): StudioModalReact;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): StudioModalReact;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): StudioModalReact;
   ...
   */
  singletonArray(): C3.Array<StudioModalReact | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<StudioModalReact | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<StudioModalReact | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<StudioModalReact | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<StudioModalReact | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, StudioModalReact | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, StudioModalReact | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<StudioModalReact | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<StudioModalReact | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): StudioModalReact;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): StudioModalReact;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): StudioModalReact;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): StudioModalReact;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): StudioModalReact;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): StudioModalReact;
   ...
   * @see #fromString
   */
  static make(s: string | null): StudioModalReact | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): StudioModalReact;
   ...
   */
  static cachedEmptyInst(): StudioModalReact;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<StudioModalReact>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): StudioModalReact;
   ...
   */
  static render(props?: StudioModalReact | null): void;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<StudioModalReact | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<StudioModalReact | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<StudioModalReact | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<StudioModalReact | null> | null>;
   ...
   */
  dependencies(): MetadataDeps<StudioModalReact | null>;

  save(subPath?: string | null, contentType?: string | null): StudioModalReact;
  ...
  update(srcObj?: StudioModalReact | null, spec?: UpsertSpec | null): StudioModalReact | null;

  upsert(srcObj?: StudioModalReact | null, spec?: UpsertSpec | null): StudioModalReact | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): StudioModalReact | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string | null, failIfMissing?: boolean): StudioModalReact | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: StudioModalReact, state: UiSdlReduxState): StudioModalReact | null;
