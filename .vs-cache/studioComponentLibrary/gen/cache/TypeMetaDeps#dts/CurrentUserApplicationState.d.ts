// TypeScript definitions for the C3 type CurrentUserApplicationState
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of CurrentUserApplicationState
 */
declare interface ICurrentUserApplicationState {
 ...
 */
declare class CurrentUserApplicationState extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): CurrentUserApplicationState | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): CurrentUserApplicationState | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): CurrentUserApplicationState | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): CurrentUserApplicationState | null;
   ...
   */
  replaceType(old: Type, new_: Type): CurrentUserApplicationState;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): CurrentUserApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): CurrentUserApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<CurrentUserApplicationState | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<CurrentUserApplicationState | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): CurrentUserApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): CurrentUserApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): CurrentUserApplicationState;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): CurrentUserApplicationState;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): CurrentUserApplicationState;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): CurrentUserApplicationState;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): CurrentUserApplicationState;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): CurrentUserApplicationState;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): CurrentUserApplicationState;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): CurrentUserApplicationState;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): CurrentUserApplicationState;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): CurrentUserApplicationState;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): CurrentUserApplicationState;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): CurrentUserApplicationState;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): CurrentUserApplicationState;
   ...
   * @see #unsetField
   */
  defaultField(field: string): CurrentUserApplicationState;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): CurrentUserApplicationState;
   ...
   * @see #removeField
   */
  unsetField(field: string): CurrentUserApplicationState;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): CurrentUserApplicationState;
   ...
   * @see #unsetField
   */
  removeField(field: string): CurrentUserApplicationState;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): CurrentUserApplicationState;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): CurrentUserApplicationState;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): CurrentUserApplicationState;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): CurrentUserApplicationState;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): CurrentUserApplicationState;

  mergeJson(json: any | null): CurrentUserApplicationState;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): CurrentUserApplicationState;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): CurrentUserApplicationState;
   ...
   */
  singletonArray(): C3.Array<CurrentUserApplicationState | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<CurrentUserApplicationState | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<CurrentUserApplicationState | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<CurrentUserApplicationState | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<CurrentUserApplicationState | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, CurrentUserApplicationState | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, CurrentUserApplicationState | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<CurrentUserApplicationState | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<CurrentUserApplicationState | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): CurrentUserApplicationState;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): CurrentUserApplicationState;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): CurrentUserApplicationState;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): CurrentUserApplicationState;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): CurrentUserApplicationState;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): CurrentUserApplicationState;
   ...
   * @see #fromString
   */
  static make(s: string | null): CurrentUserApplicationState | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): CurrentUserApplicationState;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): CurrentUserApplicationState;
   ...
   */
  static cachedEmptyInst(): CurrentUserApplicationState;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<CurrentUserApplicationState>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): CurrentUserApplicationState;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<CurrentUserApplicationState | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<CurrentUserApplicationState | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<CurrentUserApplicationState | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<CurrentUserApplicationState | null> | null>;
   ...
   */
  dependencies(): MetadataDeps<CurrentUserApplicationState | null>;

  save(subPath?: string | null, contentType?: string | null): CurrentUserApplicationState;
  ...
  update(srcObj?: CurrentUserApplicationState | null, spec?: UpsertSpec | null): CurrentUserApplicationState | null;

  upsert(srcObj?: CurrentUserApplicationState | null, spec?: UpsertSpec | null): CurrentUserApplicationState | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): CurrentUserApplicationState | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string | null, failIfMissing?: boolean): CurrentUserApplicationState | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: CurrentUserApplicationState, state: UiSdlReduxState): CurrentUserApplicationState | null;
   ...
   */
  static setCurrentUserAction(currentUser?: User | null): UiSdlReduxAction<any>;

  /**
   * Listens for actions of type `SET_CURRENT_USER` and sets `currentUser`
   */
  static setCurrentUserReducer(state: UiSdlReduxState, action: UiSdlReduxAction<any>): UiSdlReduxState;

  /**
   * Retrieves the `currentUser` from state
   */
  static getCurrentUser(state: UiSdlReduxState): User | null;

  /**
   * Epic to populate the `currentUser` on application state initialize
   */
  static setCurrentUserEpic(state: UiSdlReduxState, action: UiSdlReduxAction<any>): UiSdlReduxState;
}
