// TypeScript definitions for the C3 type UiSdlEnhancedCardListDataSpec

/**
 * The specification of data retrieval for instances of the {@link UiSdlEnhancedCardList} component type.
 *
 * @remarks this represents a value passed to a method that expects an instance of UiSdlEnhancedCardListDataSpec
 */
declare interface IUiSdlEnhancedCardListDataSpec {
   ...
   */
  principalCardDataSpecSetting?: IUiSdlEnhancedPrincipalCardDataSpecSetting | null;

  /**
   * Data spec configuration for the sub UiSdlEnhancedCard.
   */
  subCardDataSpecSetting?: IUiSdlEnhancedSubCardDataSpecSetting | null;
 ...
 */
declare class UiSdlEnhancedCardListDataSpec extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlEnhancedCardListDataSpec | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlEnhancedCardListDataSpec | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlEnhancedCardListDataSpec | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlEnhancedCardListDataSpec | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlEnhancedCardListDataSpec;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlEnhancedCardListDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlEnhancedCardListDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlEnhancedCardListDataSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlEnhancedCardListDataSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlEnhancedCardListDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlEnhancedCardListDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlEnhancedCardListDataSpec;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlEnhancedCardListDataSpec;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlEnhancedCardListDataSpec;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlEnhancedCardListDataSpec;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlEnhancedCardListDataSpec;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlEnhancedCardListDataSpec;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlEnhancedCardListDataSpec;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlEnhancedCardListDataSpec;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlEnhancedCardListDataSpec;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlEnhancedCardListDataSpec;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlEnhancedCardListDataSpec;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlEnhancedCardListDataSpec;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlEnhancedCardListDataSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlEnhancedCardListDataSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlEnhancedCardListDataSpec;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlEnhancedCardListDataSpec;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlEnhancedCardListDataSpec;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlEnhancedCardListDataSpec;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlEnhancedCardListDataSpec;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlEnhancedCardListDataSpec;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlEnhancedCardListDataSpec;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlEnhancedCardListDataSpec;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlEnhancedCardListDataSpec;

  mergeJson(json: any | null): UiSdlEnhancedCardListDataSpec;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlEnhancedCardListDataSpec;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlEnhancedCardListDataSpec;
   ...
   */
  singletonArray(): C3.Array<UiSdlEnhancedCardListDataSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlEnhancedCardListDataSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlEnhancedCardListDataSpec | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlEnhancedCardListDataSpec | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlEnhancedCardListDataSpec | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlEnhancedCardListDataSpec | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlEnhancedCardListDataSpec | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlEnhancedCardListDataSpec | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlEnhancedCardListDataSpec | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlEnhancedCardListDataSpec;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlEnhancedCardListDataSpec;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlEnhancedCardListDataSpec;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlEnhancedCardListDataSpec;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlEnhancedCardListDataSpec;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlEnhancedCardListDataSpec;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlEnhancedCardListDataSpec;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): UiSdlEnhancedCardListDataSpec;
   ...
   */
  static cachedEmptyInst(): UiSdlEnhancedCardListDataSpec;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlEnhancedCardListDataSpec>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlEnhancedCardListDataSpec;
   ...
   */
  static getDataTypeName(dataSpec?: UiSdlEnhancedCardListDataSpec | null): string | null;
