// TypeScript definitions for the C3 type StudioFileExplorer
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of StudioFileExplorer
 */
declare interface IStudioFileExplorer {
 ...
 */
declare class StudioFileExplorer extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): StudioFileExplorer | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): StudioFileExplorer | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): StudioFileExplorer | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): StudioFileExplorer | null;
   ...
   */
  replaceType(old: Type, new_: Type): StudioFileExplorer;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): StudioFileExplorer;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): StudioFileExplorer;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<StudioFileExplorer | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<StudioFileExplorer | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): StudioFileExplorer;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): StudioFileExplorer;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): StudioFileExplorer;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): StudioFileExplorer;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): StudioFileExplorer;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): StudioFileExplorer;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): StudioFileExplorer;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): StudioFileExplorer;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): StudioFileExplorer;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): StudioFileExplorer;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): StudioFileExplorer;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): StudioFileExplorer;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): StudioFileExplorer;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): StudioFileExplorer;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): StudioFileExplorer;
   ...
   * @see #unsetField
   */
  defaultField(field: string): StudioFileExplorer;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): StudioFileExplorer;
   ...
   * @see #removeField
   */
  unsetField(field: string): StudioFileExplorer;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): StudioFileExplorer;
   ...
   * @see #unsetField
   */
  removeField(field: string): StudioFileExplorer;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): StudioFileExplorer;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): StudioFileExplorer;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): StudioFileExplorer;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): StudioFileExplorer;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): StudioFileExplorer;

  mergeJson(json: any | null): StudioFileExplorer;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): StudioFileExplorer;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): StudioFileExplorer;
   ...
   */
  singletonArray(): C3.Array<StudioFileExplorer | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<StudioFileExplorer | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<StudioFileExplorer | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<StudioFileExplorer | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<StudioFileExplorer | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, StudioFileExplorer | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, StudioFileExplorer | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<StudioFileExplorer | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<StudioFileExplorer | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): StudioFileExplorer;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): StudioFileExplorer;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): StudioFileExplorer;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): StudioFileExplorer;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): StudioFileExplorer;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): StudioFileExplorer;
   ...
   * @see #fromString
   */
  static make(s: string | null): StudioFileExplorer | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): StudioFileExplorer;
   ...
   */
  static cachedEmptyInst(): StudioFileExplorer;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<StudioFileExplorer>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): StudioFileExplorer;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<StudioFileExplorer | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<StudioFileExplorer | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<StudioFileExplorer | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<StudioFileExplorer | null> | null>;
   ...
   */
  dependencies(): MetadataDeps<StudioFileExplorer | null>;

  save(subPath?: string | null, contentType?: string | null): StudioFileExplorer;
  ...
  update(srcObj?: StudioFileExplorer | null, spec?: UpsertSpec | null): StudioFileExplorer | null;

  upsert(srcObj?: StudioFileExplorer | null, spec?: UpsertSpec | null): StudioFileExplorer | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): StudioFileExplorer | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string | null, failIfMissing?: boolean): StudioFileExplorer | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: StudioFileExplorer, state: UiSdlReduxState): StudioFileExplorer | null;
