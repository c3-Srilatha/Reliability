// TypeScript definitions for the C3 type DataMountApplicationState
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of DataMountApplicationState
 */
declare interface IDataMountApplicationState {
 ...
 */
declare class DataMountApplicationState extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): DataMountApplicationState | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): DataMountApplicationState | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): DataMountApplicationState | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): DataMountApplicationState | null;
   ...
   */
  replaceType(old: Type, new_: Type): DataMountApplicationState;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DataMountApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DataMountApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DataMountApplicationState | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DataMountApplicationState | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): DataMountApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DataMountApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DataMountApplicationState;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): DataMountApplicationState;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): DataMountApplicationState;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): DataMountApplicationState;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): DataMountApplicationState;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): DataMountApplicationState;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): DataMountApplicationState;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): DataMountApplicationState;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): DataMountApplicationState;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): DataMountApplicationState;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): DataMountApplicationState;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): DataMountApplicationState;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): DataMountApplicationState;
   ...
   * @see #unsetField
   */
  defaultField(field: string): DataMountApplicationState;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): DataMountApplicationState;
   ...
   * @see #removeField
   */
  unsetField(field: string): DataMountApplicationState;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): DataMountApplicationState;
   ...
   * @see #unsetField
   */
  removeField(field: string): DataMountApplicationState;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): DataMountApplicationState;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): DataMountApplicationState;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): DataMountApplicationState;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): DataMountApplicationState;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): DataMountApplicationState;

  mergeJson(json: any | null): DataMountApplicationState;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): DataMountApplicationState;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): DataMountApplicationState;
   ...
   */
  singletonArray(): C3.Array<DataMountApplicationState | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<DataMountApplicationState | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<DataMountApplicationState | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<DataMountApplicationState | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<DataMountApplicationState | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, DataMountApplicationState | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, DataMountApplicationState | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<DataMountApplicationState | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<DataMountApplicationState | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): DataMountApplicationState;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): DataMountApplicationState;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): DataMountApplicationState;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): DataMountApplicationState;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): DataMountApplicationState;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): DataMountApplicationState;
   ...
   * @see #fromString
   */
  static make(s: string | null): DataMountApplicationState | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): DataMountApplicationState;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): DataMountApplicationState;
   ...
   */
  static cachedEmptyInst(): DataMountApplicationState;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<DataMountApplicationState>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): DataMountApplicationState;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<DataMountApplicationState | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<DataMountApplicationState | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<DataMountApplicationState | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<DataMountApplicationState | null> | null>;
   ...
   */
  dependencies(): MetadataDeps<DataMountApplicationState | null>;

  save(subPath?: string | null, contentType?: string | null): DataMountApplicationState;
  ...
  update(srcObj?: DataMountApplicationState | null, spec?: UpsertSpec | null): DataMountApplicationState | null;

  upsert(srcObj?: DataMountApplicationState | null, spec?: UpsertSpec | null): DataMountApplicationState | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): DataMountApplicationState | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string | null, failIfMissing?: boolean): DataMountApplicationState | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: DataMountApplicationState, state: UiSdlReduxState): DataMountApplicationState | null;
   ...
   */
  static setDataLoadMountPathEpic(state: UiSdlReduxState, action: UiSdlReduxAction<any>): UiSdlReduxState;
}
