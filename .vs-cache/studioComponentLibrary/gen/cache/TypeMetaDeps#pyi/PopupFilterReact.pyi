...
from c3.studioComponentLibrary.PopupFilterOption import PopupFilterOption
...
from c3.studioComponentLibrary.PopupFilterDataItem import PopupFilterDataItem
from c3.platform.Promise import Promise
...
# Python definitions for the C3 type PopupFilterReact


class PopupFilterReact(ReactFunction, PopupFilter):
    """
    ...
    filterOptions: Optional[Array[PopupFilterOption]]=None
    """
    The options/fields to apply filters on
    """

    selectedFilterOption: Optional[PopupFilterOption]=None
    """
    The currently selected filter option/field
    """

    filterOptionPlaceholder: Optional[str]=None
    """
    The placeholder for the filter option dropdown
    """

    currentFilterData: Optional[Array[PopupFilterDataItem]]=None
    """
    The current filter data that is being modified in a {@link UiSdlFormDataGrid}
    """

    filtersData: Optional[Array[Array[PopupFilterDataItem]]]=None
    """
    Data for displaying the filter pills.
    """
    def __init__(self, meta: Optional[Meta]=None, id: Optional[str]=None, name: Optional[str]=None, dataSpec: Optional[Any]=None, disableDataRequestOnFirstRender: Optional[bool]=None, triggersRegistered: Optional[bool]=None, wrapWithMetadataId: Optional[bool]=None, open: Optional[bool]=None, invalid: Optional[bool]=None, filterOptions: Optional[Array[PopupFilterOption]]=None, selectedFilterOption: Optional[PopupFilterOption]=None, filterOptionPlaceholder: Optional[str]=None, currentFilterData: Optional[Array[PopupFilterDataItem]]=None, filtersData: Optional[Array[Array[PopupFilterDataItem]]]=None) -> None: ...
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[PopupFilterReact]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[PopupFilterReact]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[PopupFilterReact]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[PopupFilterReact]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> PopupFilterReact:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> PopupFilterReact:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> PopupFilterReact:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[PopupFilterReact]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[PopupFilterReact]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> PopupFilterReact:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> PopupFilterReact:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> PopupFilterReact:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> PopupFilterReact:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> PopupFilterReact:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> PopupFilterReact:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> PopupFilterReact:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> PopupFilterReact:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> PopupFilterReact:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> PopupFilterReact:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> PopupFilterReact:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> PopupFilterReact:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> PopupFilterReact:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> PopupFilterReact:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> PopupFilterReact:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> PopupFilterReact:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> PopupFilterReact:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> PopupFilterReact:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> PopupFilterReact:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> PopupFilterReact:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> PopupFilterReact:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> PopupFilterReact:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> PopupFilterReact:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> PopupFilterReact:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> PopupFilterReact:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> PopupFilterReact:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> PopupFilterReact:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> PopupFilterReact:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[PopupFilterReact]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[PopupFilterReact]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[PopupFilterReact]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[PopupFilterReact]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[PopupFilterReact]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, PopupFilterReact]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, PopupFilterReact]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[PopupFilterReact]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[PopupFilterReact]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> PopupFilterReact:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> PopupFilterReact:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> PopupFilterReact:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> PopupFilterReact:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> PopupFilterReact:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> PopupFilterReact:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[PopupFilterReact]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> PopupFilterReact:
    """
    ...
    """
        ...
    def afterMake(self) -> PopupFilterReact:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> PopupFilterReact:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[PopupFilterReact]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> PopupFilterReact:
    """
    ...
    """
        ...
    @classmethod
    def render(cls, props: PopupFilterReact=None) -> None:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, spec: FetchSpec=None) -> FetchResult[PopupFilterReact]:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, filter: Filter) -> FetchResult[PopupFilterReact]:
    """
    ...
    """
        ...
    @classmethod
    def fetchObjStream(cls, spec: FetchStreamSpec=None) -> Union[Stream[PopupFilterReact]]:
    """
    Fetches multiple obj instances based on a specification.  Only objs that the caller is authorized to fetch will be
    returned.
    ...
    """
        ...
    @classmethod
    def fetchMultiLocale(cls, spec: MultiLocaleFetchSpec=None) -> Union[Map[str, FetchResult[PopupFilterReact]]]:
    """
    ...
    """
        ...
    def dependencies(self) -> MetadataDeps[PopupFilterReact]:
    """
    Retrieves dependencies to types or other metadata elements for the given instance of metadata.
    """
        ...
    def save(self, subPath: str=None, contentType: str=None) -> PopupFilterReact:
        ...
    ...
    def removeAll(cls, removeFilter: str=None) -> int:
        ...
    def update(self, srcObj: PopupFilterReact=None, spec: UpsertSpec=None) -> Union[PopupFilterReact]:
        ...
    def upsert(self, srcObj: PopupFilterReact=None, spec: UpsertSpec=None) -> Union[PopupFilterReact]:
        ...
    @classmethod
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[PopupFilterReact]:
    """
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[PopupFilterReact]:
    """
    ...
    def jsonify(cls, value: Any=None) -> Union[str]:
        ...
    @classmethod
    def doDataMerge(cls, componentId: str, dataSpecFieldName: str, dataDestinationFieldName: str, props: PopupFilterReact, state: UiSdlReduxState) -> Union[PopupFilterReact]:
    """
    ...
    """
        ...
    @classmethod
    def setFilterInvalidAction(cls, id: str, invalid: bool=None) -> UiSdlReduxAction[Any]:
    """
    ...
    """
        ...
    @classmethod
    def setFilterInvalidReducer(cls, state: UiSdlReduxState, action: UiSdlReduxAction[Any]) -> UiSdlReduxState:
    """
    ...
    """
        ...
    @classmethod
    def resetFilterDataEpic(cls, state: UiSdlReduxState, action: UiSdlReduxAction[Any]) -> UiSdlReduxState:
    """
    ...
    """
        ...
    @classmethod
    def setSelectedFilterOptionAction(cls, id: str, filterOption: PopupFilterOption) -> UiSdlReduxAction[Any]:
    """
    ...
    """
        ...
    @classmethod
    def setSelectedFilterOptionReducer(cls, state: UiSdlReduxState, action: UiSdlReduxAction[Any]) -> UiSdlReduxState:
    """
    ...
    """
        ...
    @classmethod
    def updateCurrentFilterDataAction(cls, id: str, itemId: str=None, dataItem: PopupFilterDataItem=None) -> UiSdlReduxAction[Any]:
    """
    ...
    """
        ...
    @classmethod
    def updateCurrentFilterDataReducer(cls, state: UiSdlReduxState, action: UiSdlReduxAction[Any]) -> UiSdlReduxState:
    """
    ...
    """
        ...
    @classmethod
    def addCurrentFilterDataAction(cls, id: str) -> UiSdlReduxAction[Any]:
    """
    ...
    """
        ...
    @classmethod
    def addCurrentFilterDataReducer(cls, state: UiSdlReduxState, action: UiSdlReduxAction[Any]) -> UiSdlReduxState:
    """
    ...
    """
        ...
    @classmethod
    def removeCurrentFilterDataAction(cls, id: str, itemId: str=None) -> UiSdlReduxAction[Any]:
    """
    ...
    """
        ...
    @classmethod
    def removeCurrentFilterDataReducer(cls, state: UiSdlReduxState, action: UiSdlReduxAction[Any]) -> UiSdlReduxState:
    """
    ...
    """
        ...
    @classmethod
    def clearCurrentFilterDataAction(cls, id: str) -> UiSdlReduxAction[Any]:
    """
    ...
    """
        ...
    @classmethod
    def clearCurrentFilterDataReducer(cls, state: UiSdlReduxState, action: UiSdlReduxAction[Any]) -> UiSdlReduxState:
    """
    ...
    """
        ...
    @classmethod
    def addFilterAction(cls, id: str, filterItems: Array[PopupFilterDataItem]=None) -> UiSdlReduxAction[Any]:
    """
    ...
    """
        ...
    @classmethod
    def addFilterReducer(cls, state: UiSdlReduxState, action: UiSdlReduxAction[Any]) -> UiSdlReduxState:
    """
    ...
    """
        ...
    @classmethod
    def addFilterEpic(cls, state: UiSdlReduxState, action: UiSdlReduxAction[Any]) -> UiSdlReduxState:
    """
    Epic triggered when user applies a filter, which resets the popup filter and closes the popup.
    """
        ...
    @classmethod
    def clearAllFiltersAction(cls, id: str) -> UiSdlReduxAction[Any]:
    """
    ...
    """
        ...
    @classmethod
    def clearAllFiltersReducer(cls, state: UiSdlReduxState, action: UiSdlReduxAction[Any]) -> UiSdlReduxState:
    """
    ...
    """
        ...
    @classmethod
    def clearFilterAction(cls, id: str, filterIndex: int) -> UiSdlReduxAction[Any]:
    """
    ...
    """
        ...
    @classmethod
    def clearFilterReducer(cls, state: UiSdlReduxState, action: UiSdlReduxAction[Any]) -> UiSdlReduxState:
    """
    ...
    """
        ...
    @classmethod
    def openCloseFilterAction(cls, id: str, open: bool=None) -> UiSdlReduxAction[Any]:
    """
    ...
    """
        ...
    @classmethod
    def openFilterReducer(cls, state: UiSdlReduxState, action: UiSdlReduxAction[Any]) -> UiSdlReduxState:
    """
    ...
    """
        ...
    @classmethod
    def closeFilterReducer(cls, state: UiSdlReduxState, action: UiSdlReduxAction[Any]) -> UiSdlReduxState:
    """
    ...
    """
        ...
    @classmethod
    def closeFilterEpic(cls, state: UiSdlReduxState, action: UiSdlReduxAction[Any]) -> UiSdlReduxState:
    """
