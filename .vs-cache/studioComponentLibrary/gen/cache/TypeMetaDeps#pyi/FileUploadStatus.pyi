...
# Python definitions for the C3 type FileUploadStatus


class FileUploadStatus(UiSdlFileUploadFileStatus):
    """
    ...
    """
    def __init__(self, QUEUED: Optional[str]=None, UPLOADING: Optional[str]=None, SUCCESSFUL: Optional[str]=None, ERROR: Optional[str]=None, INVALID: Optional[str]=None, INVALID_SIZE: Optional[str]=None, CANCELLED: Optional[str]=None) -> None: ...
