...
# Python definitions for the C3 type ModelExperimentPreviewChart


class ModelExperimentPreviewChart(UiSdlTimeseriesLineBarChart):
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[ModelExperimentPreviewChart]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[ModelExperimentPreviewChart]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[ModelExperimentPreviewChart]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[ModelExperimentPreviewChart]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> ModelExperimentPreviewChart:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> ModelExperimentPreviewChart:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> ModelExperimentPreviewChart:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[ModelExperimentPreviewChart]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[ModelExperimentPreviewChart]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> ModelExperimentPreviewChart:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> ModelExperimentPreviewChart:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> ModelExperimentPreviewChart:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> ModelExperimentPreviewChart:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> ModelExperimentPreviewChart:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> ModelExperimentPreviewChart:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> ModelExperimentPreviewChart:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> ModelExperimentPreviewChart:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> ModelExperimentPreviewChart:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> ModelExperimentPreviewChart:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> ModelExperimentPreviewChart:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> ModelExperimentPreviewChart:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> ModelExperimentPreviewChart:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> ModelExperimentPreviewChart:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> ModelExperimentPreviewChart:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> ModelExperimentPreviewChart:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> ModelExperimentPreviewChart:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> ModelExperimentPreviewChart:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> ModelExperimentPreviewChart:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> ModelExperimentPreviewChart:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> ModelExperimentPreviewChart:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> ModelExperimentPreviewChart:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> ModelExperimentPreviewChart:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> ModelExperimentPreviewChart:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> ModelExperimentPreviewChart:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> ModelExperimentPreviewChart:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> ModelExperimentPreviewChart:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> ModelExperimentPreviewChart:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[ModelExperimentPreviewChart]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[ModelExperimentPreviewChart]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[ModelExperimentPreviewChart]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[ModelExperimentPreviewChart]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[ModelExperimentPreviewChart]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, ModelExperimentPreviewChart]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, ModelExperimentPreviewChart]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[ModelExperimentPreviewChart]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[ModelExperimentPreviewChart]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> ModelExperimentPreviewChart:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> ModelExperimentPreviewChart:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> ModelExperimentPreviewChart:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> ModelExperimentPreviewChart:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> ModelExperimentPreviewChart:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> ModelExperimentPreviewChart:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[ModelExperimentPreviewChart]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> ModelExperimentPreviewChart:
    """
    ...
    """
        ...
    def afterMake(self) -> ModelExperimentPreviewChart:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> ModelExperimentPreviewChart:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[ModelExperimentPreviewChart]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> ModelExperimentPreviewChart:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, spec: FetchSpec=None) -> FetchResult[ModelExperimentPreviewChart]:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, filter: Filter) -> FetchResult[ModelExperimentPreviewChart]:
    """
    ...
    """
        ...
    @classmethod
    def fetchObjStream(cls, spec: FetchStreamSpec=None) -> Union[Stream[ModelExperimentPreviewChart]]:
    """
    Fetches multiple obj instances based on a specification.  Only objs that the caller is authorized to fetch will be
    returned.
    ...
    """
        ...
    @classmethod
    def fetchMultiLocale(cls, spec: MultiLocaleFetchSpec=None) -> Union[Map[str, FetchResult[ModelExperimentPreviewChart]]]:
    """
    ...
    """
        ...
    def dependencies(self) -> MetadataDeps[ModelExperimentPreviewChart]:
    """
    Retrieves dependencies to types or other metadata elements for the given instance of metadata.
    """
        ...
    def save(self, subPath: str=None, contentType: str=None) -> ModelExperimentPreviewChart:
        ...
    ...
    def removeAll(cls, removeFilter: str=None) -> int:
        ...
    def update(self, srcObj: ModelExperimentPreviewChart=None, spec: UpsertSpec=None) -> Union[ModelExperimentPreviewChart]:
        ...
    def upsert(self, srcObj: ModelExperimentPreviewChart=None, spec: UpsertSpec=None) -> Union[ModelExperimentPreviewChart]:
        ...
    @classmethod
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[ModelExperimentPreviewChart]:
    """
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[ModelExperimentPreviewChart]:
    """
    ...
    def jsonify(cls, value: Any=None) -> Union[str]:
        ...
    @classmethod
    def doDataMerge(cls, componentId: str, dataSpecFieldName: str, dataDestinationFieldName: str, props: ModelExperimentPreviewChart, state: UiSdlReduxState) -> Union[ModelExperimentPreviewChart]:
    """
