// TypeScript definitions for the C3 type ModelScenarioApplicationState

/**
 * Application state that holds the model scenario information.
 *
 * @remarks this represents a value passed to a method that expects an instance of ModelScenarioApplicationState
 */
declare interface IModelScenarioApplicationState {
   ...
   */
  actionMap?: C3.Map<string | null, UiApDataStoreAction | null> | {[key: string | null]: IUiApDataStoreAction | null};
   ...
   */
  resolvedActionMap?: C3.Map<string | null, UiApDataStoreAction | null> | {[key: string | null]: IUiApDataStoreAction | null};

  /**
   * A map of data IDs to the data that has been fetched.
   */
  dataMap?: C3.Map<string | null, any> | {[key: string | null]: any};
   ...
   */
  resolvedContextVars?: C3.Map<string | null, any> | {[key: string | null]: any};

  /**
   * A map of data IDs to a boolean indicating if the data is currently being fetched.
   */
  isLoadingMap?: C3.Map<string | null, boolean> | {[key: string | null]: boolean};
   ...
   */
  selectedItems?: C3.Array<string | null> | Array<string | null>;
   ...
   */
  scenarioWindowAtCSVUpload?: C3.Array<DateTime | null> | Array<IDateTime | null>;
   ...
   */
  lastPlottedTimeRange?: ITimeRange | null;
   ...
   */
  overriddenFeatures?: C3.Map<string | null, ReliabilityMlModelScenario.ValueGenerator | null> | {[key: string | null]: IReliabilityMlModelScenario.ValueGenerator | null};
}
 ...
 */
declare class ModelScenarioApplicationState extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): ModelScenarioApplicationState | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): ModelScenarioApplicationState | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): ModelScenarioApplicationState | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): ModelScenarioApplicationState | null;
   ...
   */
  replaceType(old: Type, new_: Type): ModelScenarioApplicationState;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ModelScenarioApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ModelScenarioApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ModelScenarioApplicationState | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ModelScenarioApplicationState | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): ModelScenarioApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ModelScenarioApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ModelScenarioApplicationState;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ModelScenarioApplicationState;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ModelScenarioApplicationState;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ModelScenarioApplicationState;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): ModelScenarioApplicationState;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ModelScenarioApplicationState;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ModelScenarioApplicationState;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): ModelScenarioApplicationState;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): ModelScenarioApplicationState;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): ModelScenarioApplicationState;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): ModelScenarioApplicationState;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ModelScenarioApplicationState;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): ModelScenarioApplicationState;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ModelScenarioApplicationState;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ModelScenarioApplicationState;
   ...
   * @see #removeField
   */
  unsetField(field: string): ModelScenarioApplicationState;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ModelScenarioApplicationState;
   ...
   * @see #unsetField
   */
  removeField(field: string): ModelScenarioApplicationState;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ModelScenarioApplicationState;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): ModelScenarioApplicationState;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): ModelScenarioApplicationState;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): ModelScenarioApplicationState;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): ModelScenarioApplicationState;

  mergeJson(json: any | null): ModelScenarioApplicationState;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): ModelScenarioApplicationState;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): ModelScenarioApplicationState;
   ...
   */
  singletonArray(): C3.Array<ModelScenarioApplicationState | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<ModelScenarioApplicationState | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ModelScenarioApplicationState | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<ModelScenarioApplicationState | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ModelScenarioApplicationState | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, ModelScenarioApplicationState | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ModelScenarioApplicationState | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ModelScenarioApplicationState | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ModelScenarioApplicationState | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): ModelScenarioApplicationState;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): ModelScenarioApplicationState;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): ModelScenarioApplicationState;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ModelScenarioApplicationState;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): ModelScenarioApplicationState;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ModelScenarioApplicationState;
   ...
   * @see #fromString
   */
  static make(s: string | null): ModelScenarioApplicationState | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): ModelScenarioApplicationState;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ModelScenarioApplicationState;
   ...
   */
  static cachedEmptyInst(): ModelScenarioApplicationState;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<ModelScenarioApplicationState>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): ModelScenarioApplicationState;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<ModelScenarioApplicationState | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ModelScenarioApplicationState | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<ModelScenarioApplicationState | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<ModelScenarioApplicationState | null> | null>;
   ...
   */
  dependencies(): MetadataDeps<ModelScenarioApplicationState | null>;

  save(subPath?: string | null, contentType?: string | null): ModelScenarioApplicationState;
  ...
  update(srcObj?: ModelScenarioApplicationState | null, spec?: UpsertSpec | null): ModelScenarioApplicationState | null;

  upsert(srcObj?: ModelScenarioApplicationState | null, spec?: UpsertSpec | null): ModelScenarioApplicationState | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): ModelScenarioApplicationState | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string | null, failIfMissing?: boolean): ModelScenarioApplicationState | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: ModelScenarioApplicationState, state: UiSdlReduxState): ModelScenarioApplicationState | null;
   ...
   */
  static setResolvedActionMapAction(id?: string | null, dataId?: string | null, resolvedActionMap?: C3.Map<string | null, UiApDataStoreAction | null>): UiSdlReduxAction<any> | null;
   ...
   */
  static setResolvedActionMapReducer(state?: UiSdlReduxState | null, action?: UiSdlReduxAction<any> | null): UiSdlReduxState | null;
   ...
   */
  static setArgsAction(spec?: UiApDataStoreSetArgsSpec | null): UiSdlReduxAction<any> | null;
   ...
   * @return The new state of the application.
   */
  static setArgsReducer(state?: UiSdlReduxState | null, action?: UiSdlReduxAction<any> | null): UiSdlReduxState | null;
   ...
   */
  static dataRequestAction(spec?: UiApDataStoreDataRequestSpec | null): UiSdlReduxAction<any> | null;
   ...
   */
  static dataReceiveAction(spec?: UiApDataStoreDataReceiveSpec | null): UiSdlReduxAction<any> | null;
   ...
   * @return The new state of the application.
   */
  static dataReceiveReducer(state?: UiSdlReduxState | null, action?: UiSdlReduxAction<any> | null): UiSdlReduxState | null;
   ...
   */
  static dataRequestEpic(actionStream?: UiSdlActionsObservable | null, stateStream?: UiSdlStatesObservable | null): UiSdlActionsObservable | null;
   ...
   */
  static dataErrorAction(id?: string | null, dataId?: string | null, error?: any): UiSdlReduxAction<any> | null;
   ...
   */
  static setResolvedContextVarsAction(id?: string | null, resolvedContextVars?: C3.Map<string | null, any>): UiSdlReduxAction<any> | null;
   ...
   * @return The new state of the application.
   */
  static setResolvedContextVarsReducer(state?: UiSdlReduxState | null, action?: UiSdlReduxAction<any> | null): UiSdlReduxState | null;
   ...
   * @return A stream of actions.
   */
  static registerUpdateResolvedActionsEpic(actionStream?: UiSdlActionsObservable | null, stateStream?: UiSdlStatesObservable | null): UiSdlActionsObservable | null;
   ...
   */
  static clearPlotsAction(id: string, plotIds: C3.Array<string | null>, clearTsDataset?: boolean): UiSdlReduxAction<any>;
   ...
   */
  static clearPlotsReducer(state: UiSdlReduxState, action: UiSdlReduxAction<any>): UiSdlReduxState;
   ...
   */
  static clearDimensionsAction(id: string, dimensions: C3.Array<string | null>): UiSdlReduxAction<any>;
   ...
   */
  static clearDimensionsReducer(state: UiSdlReduxState, action: UiSdlReduxAction<any>): UiSdlReduxState;
   ...
   */
  static getModelAndDataTimeRange(state: UiSdlReduxState): any | null;
   ...
   */
  static buildScenarioSpec(state: UiSdlReduxState): ReliabilityOrchestrator.ModelScenarioProcess.Spec | null;
   ...
   */
  static blockAccessIfFeatureFlagDisabled(state: UiSdlReduxState): UiSdlActionsObservable | null;
}
