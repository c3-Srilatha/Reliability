...
declare class AnalysisRiskScoreChartHelper {
   ...
   */
  static getFeatureOptionsForAssets(spec?: FetchSpec | null, project?: ReliabilityMl.Project | null): FetchResult<any | null> | null;
   ...
   */
  static getSensorOptionsForAssetSensorRelations(spec?: FetchSpec | null): FetchResult<any | null> | null;
}
