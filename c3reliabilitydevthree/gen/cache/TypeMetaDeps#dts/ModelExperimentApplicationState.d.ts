// TypeScript definitions for the C3 type ModelExperimentApplicationState

/**
 * Application state for the Model Experiment workflow in Reliability.
 *
 * @remarks this represents a value passed to a method that expects an instance of ModelExperimentApplicationState
 */
declare interface IModelExperimentApplicationState {
   ...
   */
  experimentModelStatus?: string | null;
 ...
 */
declare class ModelExperimentApplicationState extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): ModelExperimentApplicationState | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): ModelExperimentApplicationState | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): ModelExperimentApplicationState | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): ModelExperimentApplicationState | null;
   ...
   */
  replaceType(old: Type, new_: Type): ModelExperimentApplicationState;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ModelExperimentApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ModelExperimentApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ModelExperimentApplicationState | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ModelExperimentApplicationState | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): ModelExperimentApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ModelExperimentApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ModelExperimentApplicationState;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ModelExperimentApplicationState;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ModelExperimentApplicationState;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ModelExperimentApplicationState;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): ModelExperimentApplicationState;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ModelExperimentApplicationState;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ModelExperimentApplicationState;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): ModelExperimentApplicationState;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): ModelExperimentApplicationState;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): ModelExperimentApplicationState;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): ModelExperimentApplicationState;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ModelExperimentApplicationState;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): ModelExperimentApplicationState;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ModelExperimentApplicationState;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ModelExperimentApplicationState;
   ...
   * @see #removeField
   */
  unsetField(field: string): ModelExperimentApplicationState;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ModelExperimentApplicationState;
   ...
   * @see #unsetField
   */
  removeField(field: string): ModelExperimentApplicationState;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ModelExperimentApplicationState;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): ModelExperimentApplicationState;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): ModelExperimentApplicationState;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): ModelExperimentApplicationState;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): ModelExperimentApplicationState;

  mergeJson(json: any | null): ModelExperimentApplicationState;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): ModelExperimentApplicationState;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): ModelExperimentApplicationState;
   ...
   */
  singletonArray(): C3.Array<ModelExperimentApplicationState | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<ModelExperimentApplicationState | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ModelExperimentApplicationState | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<ModelExperimentApplicationState | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ModelExperimentApplicationState | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, ModelExperimentApplicationState | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ModelExperimentApplicationState | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ModelExperimentApplicationState | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ModelExperimentApplicationState | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): ModelExperimentApplicationState;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): ModelExperimentApplicationState;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): ModelExperimentApplicationState;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ModelExperimentApplicationState;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): ModelExperimentApplicationState;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ModelExperimentApplicationState;
   ...
   * @see #fromString
   */
  static make(s: string | null): ModelExperimentApplicationState | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): ModelExperimentApplicationState;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ModelExperimentApplicationState;
   ...
   */
  static cachedEmptyInst(): ModelExperimentApplicationState;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<ModelExperimentApplicationState>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): ModelExperimentApplicationState;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<ModelExperimentApplicationState | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ModelExperimentApplicationState | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<ModelExperimentApplicationState | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<ModelExperimentApplicationState | null> | null>;
   ...
   */
  dependencies(): MetadataDeps<ModelExperimentApplicationState | null>;

  save(subPath?: string | null, contentType?: string | null): ModelExperimentApplicationState;
  ...
  update(srcObj?: ModelExperimentApplicationState | null, spec?: UpsertSpec | null): ModelExperimentApplicationState | null;

  upsert(srcObj?: ModelExperimentApplicationState | null, spec?: UpsertSpec | null): ModelExperimentApplicationState | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): ModelExperimentApplicationState | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string | null, failIfMissing?: boolean): ModelExperimentApplicationState | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: ModelExperimentApplicationState, state: UiSdlReduxState): ModelExperimentApplicationState | null;
   ...
   */
  static setModelExperimentStatusAction(stateId: string, field: string, value?: any, path?: string | null, sourceId?: string | null): UiSdlReduxAction<any>;
   ...
   * @returns a new Redux state
   */
  static setModelExperimentStatusReducer(state: UiSdlReduxState, action: UiSdlReduxAction<any>): UiSdlReduxState;
}
