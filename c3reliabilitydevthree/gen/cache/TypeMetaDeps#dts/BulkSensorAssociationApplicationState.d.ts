...
declare interface IBulkSensorAssociationApplicationState {
   ...
   */
  settings?: IBulkSensorAssociationUiSettings | null;
   ...
   */
  currentlyOpenSensorAssociationJob?: IReliabilityAssetSensorAssociationJob | null;
...
declare class BulkSensorAssociationApplicationState extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): BulkSensorAssociationApplicationState | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): BulkSensorAssociationApplicationState | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): BulkSensorAssociationApplicationState | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): BulkSensorAssociationApplicationState | null;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): BulkSensorAssociationApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): BulkSensorAssociationApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<BulkSensorAssociationApplicationState | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<BulkSensorAssociationApplicationState | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): BulkSensorAssociationApplicationState;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): BulkSensorAssociationApplicationState;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): BulkSensorAssociationApplicationState;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): BulkSensorAssociationApplicationState;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): BulkSensorAssociationApplicationState;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): BulkSensorAssociationApplicationState;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): BulkSensorAssociationApplicationState;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): BulkSensorAssociationApplicationState;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): BulkSensorAssociationApplicationState;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): BulkSensorAssociationApplicationState;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): BulkSensorAssociationApplicationState;

  mergeJson(json: any | null): BulkSensorAssociationApplicationState;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): BulkSensorAssociationApplicationState;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): BulkSensorAssociationApplicationState;
   ...
   */
  singletonArray(): C3.Array<BulkSensorAssociationApplicationState | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<BulkSensorAssociationApplicationState | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<BulkSensorAssociationApplicationState | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<BulkSensorAssociationApplicationState | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<BulkSensorAssociationApplicationState | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, BulkSensorAssociationApplicationState | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, BulkSensorAssociationApplicationState | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<BulkSensorAssociationApplicationState | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<BulkSensorAssociationApplicationState | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): BulkSensorAssociationApplicationState;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): BulkSensorAssociationApplicationState;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): BulkSensorAssociationApplicationState;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): BulkSensorAssociationApplicationState;
   ...
   * @see #fromString
   */
  static make(s: string | null): BulkSensorAssociationApplicationState | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): BulkSensorAssociationApplicationState;
   ...
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<BulkSensorAssociationApplicationState>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): BulkSensorAssociationApplicationState;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<BulkSensorAssociationApplicationState | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<BulkSensorAssociationApplicationState | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<BulkSensorAssociationApplicationState | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<BulkSensorAssociationApplicationState | null> | null>;
   ...
   */
  dependencies(): MetadataDeps<BulkSensorAssociationApplicationState | null>;

  save(subPath?: string | null, contentType?: string | null): BulkSensorAssociationApplicationState;
  ...
  update(srcObj?: BulkSensorAssociationApplicationState | null, spec?: UpsertSpec | null): BulkSensorAssociationApplicationState | null;

  upsert(srcObj?: BulkSensorAssociationApplicationState | null, spec?: UpsertSpec | null): BulkSensorAssociationApplicationState | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): BulkSensorAssociationApplicationState | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string | null, failIfMissing?: boolean): BulkSensorAssociationApplicationState | null;
