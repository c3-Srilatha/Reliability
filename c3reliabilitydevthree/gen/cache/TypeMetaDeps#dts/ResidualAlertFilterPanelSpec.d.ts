...
declare interface IResidualAlertFilterPanelSpec {
   ...
   */
  NON_OPERATIONAL_MASK_NAME?: string | null;
   ...
   */
  reliabilityMetricIds?: C3.Array<string | null> | Array<string | null>;
...
declare class ResidualAlertFilterPanelSpec extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): ResidualAlertFilterPanelSpec | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): ResidualAlertFilterPanelSpec | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): ResidualAlertFilterPanelSpec | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): ResidualAlertFilterPanelSpec | null;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ResidualAlertFilterPanelSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ResidualAlertFilterPanelSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ResidualAlertFilterPanelSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ResidualAlertFilterPanelSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): ResidualAlertFilterPanelSpec;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): ResidualAlertFilterPanelSpec;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): ResidualAlertFilterPanelSpec;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): ResidualAlertFilterPanelSpec;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): ResidualAlertFilterPanelSpec;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): ResidualAlertFilterPanelSpec;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): ResidualAlertFilterPanelSpec;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): ResidualAlertFilterPanelSpec;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): ResidualAlertFilterPanelSpec;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): ResidualAlertFilterPanelSpec;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): ResidualAlertFilterPanelSpec;

  mergeJson(json: any | null): ResidualAlertFilterPanelSpec;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): ResidualAlertFilterPanelSpec;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): ResidualAlertFilterPanelSpec;
   ...
   */
  singletonArray(): C3.Array<ResidualAlertFilterPanelSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<ResidualAlertFilterPanelSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ResidualAlertFilterPanelSpec | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<ResidualAlertFilterPanelSpec | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ResidualAlertFilterPanelSpec | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, ResidualAlertFilterPanelSpec | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ResidualAlertFilterPanelSpec | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ResidualAlertFilterPanelSpec | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ResidualAlertFilterPanelSpec | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): ResidualAlertFilterPanelSpec;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): ResidualAlertFilterPanelSpec;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): ResidualAlertFilterPanelSpec;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): ResidualAlertFilterPanelSpec;
   ...
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): ResidualAlertFilterPanelSpec;
   ...
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<ResidualAlertFilterPanelSpec>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): ResidualAlertFilterPanelSpec;
