...
declare class BulkSensorAssociationUiSettingsTransform extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): BulkSensorAssociationUiSettingsTransform | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): BulkSensorAssociationUiSettingsTransform | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): BulkSensorAssociationUiSettingsTransform | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): BulkSensorAssociationUiSettingsTransform | null;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): BulkSensorAssociationUiSettingsTransform;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): BulkSensorAssociationUiSettingsTransform;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<BulkSensorAssociationUiSettingsTransform | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<BulkSensorAssociationUiSettingsTransform | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): BulkSensorAssociationUiSettingsTransform;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): BulkSensorAssociationUiSettingsTransform;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): BulkSensorAssociationUiSettingsTransform;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): BulkSensorAssociationUiSettingsTransform;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): BulkSensorAssociationUiSettingsTransform;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): BulkSensorAssociationUiSettingsTransform;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): BulkSensorAssociationUiSettingsTransform;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): BulkSensorAssociationUiSettingsTransform;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): BulkSensorAssociationUiSettingsTransform;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): BulkSensorAssociationUiSettingsTransform;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): BulkSensorAssociationUiSettingsTransform;

  mergeJson(json: any | null): BulkSensorAssociationUiSettingsTransform;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): BulkSensorAssociationUiSettingsTransform;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): BulkSensorAssociationUiSettingsTransform;
   ...
   */
  singletonArray(): C3.Array<BulkSensorAssociationUiSettingsTransform | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<BulkSensorAssociationUiSettingsTransform | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<BulkSensorAssociationUiSettingsTransform | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<BulkSensorAssociationUiSettingsTransform | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<BulkSensorAssociationUiSettingsTransform | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, BulkSensorAssociationUiSettingsTransform | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, BulkSensorAssociationUiSettingsTransform | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<BulkSensorAssociationUiSettingsTransform | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<BulkSensorAssociationUiSettingsTransform | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): BulkSensorAssociationUiSettingsTransform;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): BulkSensorAssociationUiSettingsTransform;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): BulkSensorAssociationUiSettingsTransform;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): BulkSensorAssociationUiSettingsTransform;
   ...
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): BulkSensorAssociationUiSettingsTransform;
   ...
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<BulkSensorAssociationUiSettingsTransform>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): BulkSensorAssociationUiSettingsTransform;

  /**
   * Transforms data from an object such as evalMetricsResult, to UiSdlChartData type.
   */
  static transform(data: BulkSensorAssociationUiSettings, context?: UiSdlDataTransform.Context | null): any | null;
