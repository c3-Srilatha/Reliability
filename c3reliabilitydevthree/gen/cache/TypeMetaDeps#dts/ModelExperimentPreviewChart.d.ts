// TypeScript definitions for the C3 type ModelExperimentPreviewChart

/**
 * The UI component that handles showing model experiment preview data in a chart.
 *
 * @remarks this represents a value passed to a method that expects an instance of ModelExperimentPreviewChart
 */
declare interface IModelExperimentPreviewChart {
 ...
 * The UI component that handles showing model experiment preview data in a chart.
 *
 * @remarks this represents a made instance of ModelExperimentPreviewChart
 */
declare class ModelExperimentPreviewChart extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): ModelExperimentPreviewChart | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): ModelExperimentPreviewChart | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): ModelExperimentPreviewChart | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): ModelExperimentPreviewChart | null;
   ...
   */
  replaceType(old: Type, new_: Type): ModelExperimentPreviewChart;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ModelExperimentPreviewChart;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ModelExperimentPreviewChart;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ModelExperimentPreviewChart | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ModelExperimentPreviewChart | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): ModelExperimentPreviewChart;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ModelExperimentPreviewChart;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ModelExperimentPreviewChart;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ModelExperimentPreviewChart;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ModelExperimentPreviewChart;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ModelExperimentPreviewChart;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): ModelExperimentPreviewChart;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ModelExperimentPreviewChart;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ModelExperimentPreviewChart;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): ModelExperimentPreviewChart;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): ModelExperimentPreviewChart;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): ModelExperimentPreviewChart;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): ModelExperimentPreviewChart;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ModelExperimentPreviewChart;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): ModelExperimentPreviewChart;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ModelExperimentPreviewChart;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ModelExperimentPreviewChart;
   ...
   * @see #removeField
   */
  unsetField(field: string): ModelExperimentPreviewChart;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ModelExperimentPreviewChart;
   ...
   * @see #unsetField
   */
  removeField(field: string): ModelExperimentPreviewChart;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ModelExperimentPreviewChart;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): ModelExperimentPreviewChart;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): ModelExperimentPreviewChart;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): ModelExperimentPreviewChart;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): ModelExperimentPreviewChart;

  mergeJson(json: any | null): ModelExperimentPreviewChart;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): ModelExperimentPreviewChart;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): ModelExperimentPreviewChart;
   ...
   */
  singletonArray(): C3.Array<ModelExperimentPreviewChart | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<ModelExperimentPreviewChart | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ModelExperimentPreviewChart | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<ModelExperimentPreviewChart | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ModelExperimentPreviewChart | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, ModelExperimentPreviewChart | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ModelExperimentPreviewChart | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ModelExperimentPreviewChart | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ModelExperimentPreviewChart | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): ModelExperimentPreviewChart;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): ModelExperimentPreviewChart;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): ModelExperimentPreviewChart;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ModelExperimentPreviewChart;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): ModelExperimentPreviewChart;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ModelExperimentPreviewChart;
   ...
   * @see #fromString
   */
  static make(s: string | null): ModelExperimentPreviewChart | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): ModelExperimentPreviewChart;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ModelExperimentPreviewChart;
   ...
   */
  static cachedEmptyInst(): ModelExperimentPreviewChart;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<ModelExperimentPreviewChart>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): ModelExperimentPreviewChart;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<ModelExperimentPreviewChart | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ModelExperimentPreviewChart | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<ModelExperimentPreviewChart | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<ModelExperimentPreviewChart | null> | null>;
   ...
   */
  dependencies(): MetadataDeps<ModelExperimentPreviewChart | null>;

  save(subPath?: string | null, contentType?: string | null): ModelExperimentPreviewChart;
  ...
  update(srcObj?: ModelExperimentPreviewChart | null, spec?: UpsertSpec | null): ModelExperimentPreviewChart | null;

  upsert(srcObj?: ModelExperimentPreviewChart | null, spec?: UpsertSpec | null): ModelExperimentPreviewChart | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): ModelExperimentPreviewChart | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string | null, failIfMissing?: boolean): ModelExperimentPreviewChart | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: ModelExperimentPreviewChart, state: UiSdlReduxState): ModelExperimentPreviewChart | null;
