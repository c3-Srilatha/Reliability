// TypeScript definitions for the C3 type ReliabilityMapAssetRelation
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityMapAssetRelation
 */
declare interface IReliabilityMapAssetRelation {
   ...
   */
  points?: C3.Array<LatLong | null> | Array<ILatLong | null>;
   ...
   */
  facilities?: C3.Array<Facility | null> | Array<IFacility | null>;
}
 ...
 *           between `Asset 0` and `Asset 1` and it will be used to represent the connection in both directions.
 *
 * @remarks this represents a made instance of ReliabilityMapAssetRelation
 */
declare class ReliabilityMapAssetRelation extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): ReliabilityMapAssetRelation | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): ReliabilityMapAssetRelation | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): ReliabilityMapAssetRelation | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): ReliabilityMapAssetRelation | null;
   ...
   */
  replaceType(old: Type, new_: Type): ReliabilityMapAssetRelation;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ReliabilityMapAssetRelation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ReliabilityMapAssetRelation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ReliabilityMapAssetRelation | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ReliabilityMapAssetRelation | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): ReliabilityMapAssetRelation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityMapAssetRelation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityMapAssetRelation;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ReliabilityMapAssetRelation;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ReliabilityMapAssetRelation;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityMapAssetRelation;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): ReliabilityMapAssetRelation;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityMapAssetRelation;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ReliabilityMapAssetRelation;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): ReliabilityMapAssetRelation;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): ReliabilityMapAssetRelation;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): ReliabilityMapAssetRelation;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): ReliabilityMapAssetRelation;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ReliabilityMapAssetRelation;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): ReliabilityMapAssetRelation;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ReliabilityMapAssetRelation;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ReliabilityMapAssetRelation;
   ...
   * @see #removeField
   */
  unsetField(field: string): ReliabilityMapAssetRelation;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ReliabilityMapAssetRelation;
   ...
   * @see #unsetField
   */
  removeField(field: string): ReliabilityMapAssetRelation;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ReliabilityMapAssetRelation;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): ReliabilityMapAssetRelation;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): ReliabilityMapAssetRelation;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): ReliabilityMapAssetRelation;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): ReliabilityMapAssetRelation;

  mergeJson(json: any | null): ReliabilityMapAssetRelation;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): ReliabilityMapAssetRelation;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): ReliabilityMapAssetRelation;
   ...
   */
  singletonArray(): C3.Array<ReliabilityMapAssetRelation | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<ReliabilityMapAssetRelation | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ReliabilityMapAssetRelation | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<ReliabilityMapAssetRelation | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ReliabilityMapAssetRelation | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, ReliabilityMapAssetRelation | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityMapAssetRelation | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ReliabilityMapAssetRelation | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ReliabilityMapAssetRelation | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): ReliabilityMapAssetRelation;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): ReliabilityMapAssetRelation;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): ReliabilityMapAssetRelation;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ReliabilityMapAssetRelation;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): ReliabilityMapAssetRelation;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ReliabilityMapAssetRelation;
   ...
   * @see #fromString
   */
  static make(s: string | null): ReliabilityMapAssetRelation | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): ReliabilityMapAssetRelation;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ReliabilityMapAssetRelation;
   ...
   */
  static cachedEmptyInst(): ReliabilityMapAssetRelation;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<ReliabilityMapAssetRelation>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): ReliabilityMapAssetRelation;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<ReliabilityMapAssetRelation | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ReliabilityMapAssetRelation | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<ReliabilityMapAssetRelation | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<ReliabilityMapAssetRelation | null> | null>;
   ...
   */
  get(include?: string | null): ReliabilityMapAssetRelation | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): ReliabilityMapAssetRelation | null;
   ...
   */
  getMissing(spec: GetMissingSpec): ReliabilityMapAssetRelation;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): ReliabilityMapAssetRelation | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): ReliabilityMapAssetRelation;
   ...
   * @see #toString
   */
  static fromString(s: string | null): ReliabilityMapAssetRelation | null;
   ...
   */
  create(spec?: UpsertSpec | null): ReliabilityMapAssetRelation | null;
   ...
   */
  static createBatch(objs: C3.Array<ReliabilityMapAssetRelation | null> | null, spec?: UpsertSpec | null): ObjList<ReliabilityMapAssetRelation | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ReliabilityMapAssetRelation | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<ReliabilityMapAssetRelation | null> | null;
   ...
   */
  update(srcObj?: ReliabilityMapAssetRelation | null, spec?: UpsertSpec | null): ReliabilityMapAssetRelation | null;
   ...
   */
  upsert(srcObj?: ReliabilityMapAssetRelation | null, spec?: UpsertSpec | null): ReliabilityMapAssetRelation | null;
   ...
   */
  merge(spec?: MergeSpec | null): ReliabilityMapAssetRelation | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): ReliabilityMapAssetRelation | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): ReliabilityMapAssetRelation | null;
   ...
   */
  static updateBatch(objs: C3.Array<ReliabilityMapAssetRelation | null> | null, srcObjs?: C3.Array<ReliabilityMapAssetRelation | null>, spec?: UpsertSpec | null): ObjList<ReliabilityMapAssetRelation | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<ReliabilityMapAssetRelation | null>>, spec?: UpsertSpec | null): ObjList<ReliabilityMapAssetRelation | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<ReliabilityMapAssetRelation | null> | null, srcObjs?: C3.Array<ReliabilityMapAssetRelation | null>, spec?: UpsertSpec | null): ObjList<ReliabilityMapAssetRelation | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<ReliabilityMapAssetRelation | null>>, spec?: UpsertSpec | null): ObjList<ReliabilityMapAssetRelation | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<ReliabilityMapAssetRelation | null> | null, spec?: TouchSpec | null): ObjList<ReliabilityMapAssetRelation | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<ReliabilityMapAssetRelation | null> | null, spec?: MergeSpec | null): ObjList<ReliabilityMapAssetRelation | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<ReliabilityMapAssetRelation | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<ReliabilityMapAssetRelation | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<ReliabilityMapAssetRelation | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<ReliabilityMapAssetRelation | null> | null;
   ...
   */
  static mergeAll(mergeObj: ReliabilityMapAssetRelation | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ReliabilityMapAssetRelation | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<ReliabilityMapAssetRelation | null> | null, spec?: UpsertSpec | null): ObjList<ReliabilityMapAssetRelation | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<ReliabilityMapAssetRelation | null> | null, spec?: UpsertSpec | null): ObjList<ReliabilityMapAssetRelation | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): ReliabilityMapAssetRelation | null;
   ...
   */
  static beforeCreate(objs: C3.Array<ReliabilityMapAssetRelation | null> | null): ObjList<ReliabilityMapAssetRelation | null>;

  /**
   * Before updating the entity we should ensure its a valid relation.
   */
  static beforeUpdate(objs: C3.Array<ReliabilityMapAssetRelation | null> | null): ObjList<ReliabilityMapAssetRelation | null>;
   ...
   */
  static beforeRemove(objs: C3.Array<ReliabilityMapAssetRelation | null> | null): ObjList<ReliabilityMapAssetRelation | null>;
   ...
   */
  static afterCreate(objs: C3.Array<ReliabilityMapAssetRelation | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<ReliabilityMapAssetRelation | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<ReliabilityMapAssetRelation | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<ReliabilityMapAssetRelation | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<ReliabilityMapAssetRelation | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): ReliabilityMapAssetRelation | null;
   ...
   */
  withoutIdentity(): ReliabilityMapAssetRelation | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<ReliabilityMapAssetRelation | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: ReliabilityMapAssetRelation | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<ReliabilityMapAssetRelation | null> | null, callback?: λFunction<ReliabilityMapAssetRelation | null, ReliabilityMapAssetRelation | null> | null): ObjList<ReliabilityMapAssetRelation | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<ReliabilityMapAssetRelation | null> | null, callback?: λFunction<ReliabilityMapAssetRelation | null, ReliabilityMapAssetRelation | null> | null): C3.Array<ObjError | null>;
