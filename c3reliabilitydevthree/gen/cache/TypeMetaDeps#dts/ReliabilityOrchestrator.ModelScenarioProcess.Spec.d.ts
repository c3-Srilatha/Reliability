...
declare namespace ReliabilityOrchestrator.ModelScenarioProcess {
  export interface ISpec {
     ...
     */
    scenario?: IReliabilityMlModelScenario | null;
     ...
     */
    featureOutputData?: C3.Map<string | null, ReliabilityMlModelScenario.ValueGenerator | null> | {[key: string | null]: IReliabilityMlModelScenario.ValueGenerator | null} | null;
  }
}
...
declare namespace ReliabilityOrchestrator.ModelScenarioProcess {
  export class Spec extends Obj {
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): ReliabilityOrchestrator.ModelScenarioProcess.Spec | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): ReliabilityOrchestrator.ModelScenarioProcess.Spec | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): ReliabilityOrchestrator.ModelScenarioProcess.Spec | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): ReliabilityOrchestrator.ModelScenarioProcess.Spec | null;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ReliabilityOrchestrator.ModelScenarioProcess.Spec;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ReliabilityOrchestrator.ModelScenarioProcess.Spec;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ReliabilityOrchestrator.ModelScenarioProcess.Spec | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ReliabilityOrchestrator.ModelScenarioProcess.Spec | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): ReliabilityOrchestrator.ModelScenarioProcess.Spec;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): ReliabilityOrchestrator.ModelScenarioProcess.Spec;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): ReliabilityOrchestrator.ModelScenarioProcess.Spec;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): ReliabilityOrchestrator.ModelScenarioProcess.Spec;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): ReliabilityOrchestrator.ModelScenarioProcess.Spec;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): ReliabilityOrchestrator.ModelScenarioProcess.Spec;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): ReliabilityOrchestrator.ModelScenarioProcess.Spec;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): ReliabilityOrchestrator.ModelScenarioProcess.Spec;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): ReliabilityOrchestrator.ModelScenarioProcess.Spec;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): ReliabilityOrchestrator.ModelScenarioProcess.Spec;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): ReliabilityOrchestrator.ModelScenarioProcess.Spec;

    mergeJson(json: any | null): ReliabilityOrchestrator.ModelScenarioProcess.Spec;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): ReliabilityOrchestrator.ModelScenarioProcess.Spec;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): ReliabilityOrchestrator.ModelScenarioProcess.Spec;
     ...
     */
    singletonArray(): C3.Array<ReliabilityOrchestrator.ModelScenarioProcess.Spec | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<ReliabilityOrchestrator.ModelScenarioProcess.Spec | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<ReliabilityOrchestrator.ModelScenarioProcess.Spec | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<ReliabilityOrchestrator.ModelScenarioProcess.Spec | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<ReliabilityOrchestrator.ModelScenarioProcess.Spec | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, ReliabilityOrchestrator.ModelScenarioProcess.Spec | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityOrchestrator.ModelScenarioProcess.Spec | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<ReliabilityOrchestrator.ModelScenarioProcess.Spec | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<ReliabilityOrchestrator.ModelScenarioProcess.Spec | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): ReliabilityOrchestrator.ModelScenarioProcess.Spec;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): ReliabilityOrchestrator.ModelScenarioProcess.Spec;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): ReliabilityOrchestrator.ModelScenarioProcess.Spec;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): ReliabilityOrchestrator.ModelScenarioProcess.Spec;
     ...
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): ReliabilityOrchestrator.ModelScenarioProcess.Spec;
     ...
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<ReliabilityOrchestrator.ModelScenarioProcess.Spec>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): ReliabilityOrchestrator.ModelScenarioProcess.Spec;
     ...
     */
    preValidate(): C3.Map<string | null, C3.Array<string | null>>;
     ...
     */
    postValidate(workflow?: Workflow | null): C3.Map<string | null, C3.Array<string | null>>;
     ...
     */
    static saveScenarioFeatureData(scenario: ReliabilityMlModelScenario, pipelineFeatureData?: C3.Map<string | null, any>): ReliabilityMlModelScenario | null;
     ...
     *          {@link MlPipeline#process} and {@link MlPipeline#interpret} steps.
     */
    buildPipelineXFeaturesData(asset: ReliabilityAsset, scenarioFeatureData: Data, originalProcessedData?: any): C3.Map<string | null, Data | null>;
     ...
     */
    createAndStartWorkflowWithScenario(scenarioName?: string | null): ReliabilityMlModelScenario | null;
     ...
     */
    static buildAlertObjsFromScenario(project: ReliabilityMl.Project, alertData: any, algorithmData: any, featuresData: any): FetchResultWithTotalCount<any | null> | null;
     ...
     */
    static buildChartDataFromScenario(algorithmData: any, originalAlgorithmData: any, featuresData: any, alertData?: FetchResultWithTotalCount<any | null> | null): UiApTimeseriesChartDataConfig | null;
  }
}
