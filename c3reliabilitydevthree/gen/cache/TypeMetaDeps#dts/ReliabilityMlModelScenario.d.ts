...
declare interface IReliabilityMlModelScenario {
   ...
   */
  translatedStatusKey?: string | null;
   ...
   */
  scenarioPipelineData?: C3.Map<string | null, any> | {[key: string | null]: any};
   ...
   */
  alertData?: IData.Persisted | null;
   ...
   * ```
   */
  algorithmData?: IData.Persisted | null;
   ...
   */
  originalAlgorithmData?: IData.Persisted | null;
   ...
   *           not persisting the map correctly, so we can use `any` to store it as a `Boxed<json>` instead.
   */
  featureOutputData?: C3.Map<string | null, any> | {[key: string | null]: any};

  /**
   * The spec used to generate the scenario.
   */
  spec?: IReliabilityOrchestrator.ModelScenarioProcess.Spec | null;
   ...
   */
  workflowRun?: IWorkflow.Run | null;
}
...
declare class ReliabilityMlModelScenario extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): ReliabilityMlModelScenario | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): ReliabilityMlModelScenario | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): ReliabilityMlModelScenario | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): ReliabilityMlModelScenario | null;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ReliabilityMlModelScenario;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ReliabilityMlModelScenario;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ReliabilityMlModelScenario | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ReliabilityMlModelScenario | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): ReliabilityMlModelScenario;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): ReliabilityMlModelScenario;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): ReliabilityMlModelScenario;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): ReliabilityMlModelScenario;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): ReliabilityMlModelScenario;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): ReliabilityMlModelScenario;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): ReliabilityMlModelScenario;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): ReliabilityMlModelScenario;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): ReliabilityMlModelScenario;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): ReliabilityMlModelScenario;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): ReliabilityMlModelScenario;

  mergeJson(json: any | null): ReliabilityMlModelScenario;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): ReliabilityMlModelScenario;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): ReliabilityMlModelScenario;
   ...
   */
  singletonArray(): C3.Array<ReliabilityMlModelScenario | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<ReliabilityMlModelScenario | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ReliabilityMlModelScenario | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<ReliabilityMlModelScenario | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ReliabilityMlModelScenario | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, ReliabilityMlModelScenario | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityMlModelScenario | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ReliabilityMlModelScenario | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ReliabilityMlModelScenario | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): ReliabilityMlModelScenario;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): ReliabilityMlModelScenario;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): ReliabilityMlModelScenario;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): ReliabilityMlModelScenario;
   ...
   * @see #fromString
   */
  static make(s: string | null): ReliabilityMlModelScenario | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): ReliabilityMlModelScenario;
   ...
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<ReliabilityMlModelScenario>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): ReliabilityMlModelScenario;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<ReliabilityMlModelScenario | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ReliabilityMlModelScenario | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<ReliabilityMlModelScenario | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<ReliabilityMlModelScenario | null> | null>;
   ...
   */
  get(include?: string | null): ReliabilityMlModelScenario | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): ReliabilityMlModelScenario | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): ReliabilityMlModelScenario | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): ReliabilityMlModelScenario | null;
   ...
   */
  create(spec?: UpsertSpec | null): ReliabilityMlModelScenario | null;
   ...
   */
  static createBatch(objs: C3.Array<ReliabilityMlModelScenario | null> | null, spec?: UpsertSpec | null): ObjList<ReliabilityMlModelScenario | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ReliabilityMlModelScenario | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<ReliabilityMlModelScenario | null> | null;
   ...
   */
  update(srcObj?: ReliabilityMlModelScenario | null, spec?: UpsertSpec | null): ReliabilityMlModelScenario | null;
   ...
   */
  upsert(srcObj?: ReliabilityMlModelScenario | null, spec?: UpsertSpec | null): ReliabilityMlModelScenario | null;
   ...
   */
  merge(spec?: MergeSpec | null): ReliabilityMlModelScenario | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): ReliabilityMlModelScenario | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): ReliabilityMlModelScenario | null;
   ...
   */
  static updateBatch(objs: C3.Array<ReliabilityMlModelScenario | null> | null, srcObjs?: C3.Array<ReliabilityMlModelScenario | null>, spec?: UpsertSpec | null): ObjList<ReliabilityMlModelScenario | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<ReliabilityMlModelScenario | null>>, spec?: UpsertSpec | null): ObjList<ReliabilityMlModelScenario | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<ReliabilityMlModelScenario | null> | null, srcObjs?: C3.Array<ReliabilityMlModelScenario | null>, spec?: UpsertSpec | null): ObjList<ReliabilityMlModelScenario | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<ReliabilityMlModelScenario | null>>, spec?: UpsertSpec | null): ObjList<ReliabilityMlModelScenario | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<ReliabilityMlModelScenario | null> | null, spec?: TouchSpec | null): ObjList<ReliabilityMlModelScenario | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<ReliabilityMlModelScenario | null> | null, spec?: MergeSpec | null): ObjList<ReliabilityMlModelScenario | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<ReliabilityMlModelScenario | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<ReliabilityMlModelScenario | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<ReliabilityMlModelScenario | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<ReliabilityMlModelScenario | null> | null;
   ...
   */
  static mergeAll(mergeObj: ReliabilityMlModelScenario | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ReliabilityMlModelScenario | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<ReliabilityMlModelScenario | null> | null, spec?: UpsertSpec | null): ObjList<ReliabilityMlModelScenario | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<ReliabilityMlModelScenario | null> | null, spec?: UpsertSpec | null): ObjList<ReliabilityMlModelScenario | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<ReliabilityMlModelScenario | null> | null): ObjList<ReliabilityMlModelScenario | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<ReliabilityMlModelScenario | null> | null): ObjList<ReliabilityMlModelScenario | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<ReliabilityMlModelScenario | null> | null): ObjList<ReliabilityMlModelScenario | null>;
   ...
   */
  static afterCreate(objs: C3.Array<ReliabilityMlModelScenario | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<ReliabilityMlModelScenario | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<ReliabilityMlModelScenario | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<ReliabilityMlModelScenario | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<ReliabilityMlModelScenario | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): ReliabilityMlModelScenario | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<ReliabilityMlModelScenario | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: ReliabilityMlModelScenario | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<ReliabilityMlModelScenario | null> | null, callback?: λFunction<ReliabilityMlModelScenario | null, ReliabilityMlModelScenario | null> | null): ObjList<ReliabilityMlModelScenario | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<ReliabilityMlModelScenario | null> | null, callback?: λFunction<ReliabilityMlModelScenario | null, ReliabilityMlModelScenario | null> | null): C3.Array<ObjError | null>;
