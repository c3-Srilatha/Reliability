...
declare interface IReliabilityAsset {
   ...
   * this array.
   */
  dataValidationRuns?: C3.Array<DataValidationRun | null> | Array<IDataValidationRun | null>;

  /**
   * The latest {@link DataValidationRun}. Also, the first
   * element in the {@link dataValidationRuns} array.
   */
  latestDataValidationRun?: IDataValidationRun | null;
   ...
   * this array.
   */
  datasetPreparationRuns?: C3.Array<ReliabilityMlDatasetPreparationRun | null> | Array<IReliabilityMlDatasetPreparationRun | null>;

  /**
   * The latest {@link ReliabilityMlDatasetPreparationRun}. Also, the first
   * element in the {@link #datasetPreparationRuns} array.
   */
  latestDatasetPreparationRun?: IReliabilityMlDatasetPreparationRun | null;

  /**
   * The {@link #datasetPreparationRuns} that have status `COMPLETE`.
   */
  completeDatasetPreparationRuns?: C3.Array<ReliabilityMlDatasetPreparationRun | null> | Array<IReliabilityMlDatasetPreparationRun | null>;

  /**
   * The latest run in {@link #completeDatasetPreparationRuns}.
   */
  latestCompleteDatasetPreparationRun?: IReliabilityMlDatasetPreparationRun | null;

  /**
   * The {@link #datasetPreparationRuns} that have status `COMPLETE` project.id 'reliabilityRisk'.
   */
  completeRiskDatasetPreparationRuns?: C3.Array<ReliabilityMlDatasetPreparationRun | null> | Array<IReliabilityMlDatasetPreparationRun | null>;

  /**
   * The latest run in {@link #latestCompleteRiskDatasetPreparationRun}.
   */
  latestCompleteRiskDatasetPreparationRun?: IReliabilityMlDatasetPreparationRun | null;

  /**
   * The count of {@link #completeDatasetPreparationRuns}.
   */
  countOfCompleteDatasetPreparationRuns?: number | null;
   ...
   * this array.
   */
  sensorAssociationRuns?: C3.Array<ReliabilityAssetSensorAssociationRun | null> | Array<IReliabilityAssetSensorAssociationRun | null>;

  /**
   * The latest {@link ReliabilityAssetSensorAssociationRun}. Also, the first
   * element in the {@link sensorAssociationRuns} array.
   */
  latestSensorAssociationRun?: IReliabilityAssetSensorAssociationRun | null;

  /**
   * The {@link ReliabilityAssetSensorAssociationRun}s that have status `IN PROGRESS`.
   */
  inProgressSensorAssociationRuns?: C3.Array<ReliabilityAssetSensorAssociationRun | null> | Array<IReliabilityAssetSensorAssociationRun | null>;

  /**
   * The {@link ReliabilityAssetSensorAssociationRun}s that have status `COMPLETE`.
   */
  completeSensorAssociationRuns?: C3.Array<ReliabilityAssetSensorAssociationRun | null> | Array<IReliabilityAssetSensorAssociationRun | null>;

  /**
   * The latest run in {@link #completeSensorAssociationRuns}.
   */
  latestCompleteSensorAssociationRun?: IReliabilityAssetSensorAssociationRun | null;

  /**
   * Represents the current status of sensor association based on the {@link #sensorAssociationRuns}.
   * If there is a completed run, the status is COMPLETE. Otherwise, it is the status of the latest run.
   */
  sensorAssociationStatus?: string | null;
   ...
   */
  parentRelations?: C3.Array<ReliabilityAssetHierarchicalRelation | null> | Array<IReliabilityAssetHierarchicalRelation | null>;

  /**
   * All outgoing {@link ReliabilityAssetHierarchicalRelation}s.
   */
  childRelations?: C3.Array<ReliabilityAssetHierarchicalRelation | null> | Array<IReliabilityAssetHierarchicalRelation | null>;
   ...
   */
  events?: C3.Array<ReliabilityAssetEvent | null> | Array<IReliabilityAssetEvent | null>;
   ...
   */
  hierarchyTemplateAssetId?: string | null;

  /**
   * All ancestors in the hierarchy throughout history.
   */
  relDenormAncestors?: C3.Array<ReliabilityAssetHierarchyDenorm | null> | Array<IReliabilityAssetHierarchyDenorm | null>;

  /**
   * All current ancestors in the hierarchy, excluding {@link Sensor}s.
   */
  currentRelDenormAncestors?: C3.Array<ReliabilityAssetHierarchyDenorm | null> | Array<IReliabilityAssetHierarchyDenorm | null>;

  /**
   * All current ancestors in the hierarchy and this asset.
   */
  currentAncestorsAndSelf?: C3.Array<ReliabilityAsset | null> | Array<IReliabilityAsset | null>;

  /**
   * All descendants in the asset hierarchy throughout history.
   */
  relDenormDescendants?: C3.Array<ReliabilityAssetHierarchyDenorm | null> | Array<IReliabilityAssetHierarchyDenorm | null>;

  /**
   * Current descendants in the asset hierarchy, excluding {@link Sensor}s.
   */
  currentRelDenormDescendants?: C3.Array<ReliabilityAssetHierarchyDenorm | null> | Array<IReliabilityAssetHierarchyDenorm | null>;
   ...
   */
  currentChildrenAndSelf?: C3.Array<ReliabilityAsset | null> | Array<IReliabilityAsset | null>;

  /**
   * Number of current descendants in the asset hierarchy
   */
  numCurrentDescendants?: number | null;

  /**
   * The current direct children of this asset.
   */
  currentChildren?: C3.Array<ReliabilityAsset | null> | Array<IReliabilityAsset | null>;

  /**
   * Relations to {@link Sensor}s currently directly linked to this asset.
   */
  currentSensorHierarchicalRelations?: C3.Array<ReliabilityAssetSensorHierarchicalRelation | null> | Array<IReliabilityAssetSensorHierarchicalRelation | null>;

  /**
   * Relations to {@link Sensor}s directly linked to this asset.
   */
  sensorHierarchicalRelations?: C3.Array<ReliabilityAssetSensorHierarchicalRelation | null> | Array<IReliabilityAssetSensorHierarchicalRelation | null>;

  /**
   * Current descendants in the asset hierarchy that are {@link Sensor}s.
   */
  currentSensorDenormDescendants?: C3.Array<ReliabilityAssetSensorHierarchicalRelation | null> | Array<IReliabilityAssetSensorHierarchicalRelation | null>;

  /**
   * All {@link Sensor}s ever clustered to this {@link ReliabilityAsset}.
   */
  sensorRelations?: C3.Array<ReliabilityAssetSensorRelation | null> | Array<IReliabilityAssetSensorRelation | null>;

  /**
   * Current {@link Sensor}s clustered to this {@link ReliabilityAsset}.
   */
  currentSensorRelations?: C3.Array<ReliabilityAssetSensorRelation | null> | Array<IReliabilityAssetSensorRelation | null>;
   ...
   */
  hierarchyClassification?: string | null;
   ...
   */
  linked3DModel?: IReliabilityAsset3dmodel | null;

  /**
   * The 3D model linked to this asset, or the 3D model linked to the asset class if no 3D model is linked to this asset.
   */
  linked3DModelToDisplay?: IReliabilityAsset3dmodel | null;

  /**
   * Current incoming {@link ReliabilityAssetHierarchicalRelation}s.
   */
  currentParentRelations?: C3.Array<ReliabilityAssetHierarchicalRelation | null> | Array<IReliabilityAssetHierarchicalRelation | null>;

  /**
   * Count of outgoing {@link ReliabilityAssetHierarchicalRelation}s.
   */
  numChildRelations?: number | null;

  /**
   * Current outgoing {@link ReliabilityAssetHierarchicalRelation}s.
   */
  currentChildRelations?: C3.Array<ReliabilityAssetHierarchicalRelation | null> | Array<IReliabilityAssetHierarchicalRelation | null>;
   ...
   */
  facilityRelations?: C3.Array<FacilityReliabilityAssetHierarchicalRelation | null> | Array<IFacilityReliabilityAssetHierarchicalRelation | null>;
   ...
   */
  currentFacilityRelations?: C3.Array<FacilityReliabilityAssetHierarchicalRelation | null> | Array<IFacilityReliabilityAssetHierarchicalRelation | null>;

  /**
   * {@link WorkOrder}s belonging directly to this asset.
   */
  directWorkOrders?: C3.Array<WorkOrder | null> | Array<IWorkOrder | null>;
   ...
   */
  members?: C3.Array<Member | null> | Array<IMember | null>;

  /**
   * The capacity of the asset.
   */
  capacity?: IExactDimension | null;

  /**
   * All the {@link AssetDocument}s associated with this asset.
   */
  documents?: C3.Array<AssetDocument | null> | Array<IAssetDocument | null>;
   ...
   */
  rootAsset?: IReliabilityAsset | null;
   ...
   */
  characteristics?: C3.Array<ReliabilityAssetCharacteristicValue | null> | Array<IReliabilityAssetCharacteristicValue | null>;

  /**
   * The importance level of the asset, which is used to determine the asset's criticality.
   */
  assetImportanceLevel?: IReliabilityAssetImportance | null;

  /**
   * All current model relations for this asset.
   */
  currentModelRelations?: C3.Array<ReliabilityAssetToModelRelation | null> | Array<IReliabilityAssetToModelRelation | null>;

  /**
   * All model validation relations for reliabilityRisk models for this asset.
   */
  riskModelValidationRelations?: C3.Array<ReliabilityAssetToRiskModelValidationRelation | null> | Array<IReliabilityAssetToRiskModelValidationRelation | null>;

  /**
   * All current model relations for reliabilityRisk models for this asset.
   */
  currentReliabilityRiskModelRelations?: C3.Array<ReliabilityAssetToRiskModelRelation | null> | Array<IReliabilityAssetToRiskModelRelation | null>;

  /**
   * Alerts belonging to this asset and its descendant assets.
   */
  alerts?: C3.Array<ReliabilityAssetAlert | null> | Array<IReliabilityAssetAlert | null>;

  /**
   * Count of projects that the {@link ReliabilityAssetToModelRelation}s with status 'CHAMPION' belong to.
   */
  countOfLiveProjects?: number | null;

  /**
   * All model relations for reliabilityRisk models for this asset.
   */
  reliabilityRiskModelRelations?: C3.Array<ReliabilityAssetToRiskModelRelation | null> | Array<IReliabilityAssetToRiskModelRelation | null>;
   ...
   */
  modelRelations?: C3.Array<ReliabilityAssetToModelRelation | null> | Array<IReliabilityAssetToModelRelation | null>;

  /**
   * Most recent alert belonging directly to this asset
   */
  latestAlert?: IReliabilityAssetAlert | null;

  /**
   * Alerts belonging directly to this asset.
   */
  directAlerts?: C3.Array<ReliabilityAssetAlert | null> | Array<IReliabilityAssetAlert | null>;
   ...
   */
  caseRelations?: C3.Array<ReliabilityAssetCaseToAssetRelation | null> | Array<IReliabilityAssetCaseToAssetRelation | null>;

  /**
   * Alerts from the last 7 days.
   */
  recentAlerts?: C3.Array<ReliabilityAssetAlert | null> | Array<IReliabilityAssetAlert | null>;

  /**
   * Number of live models for this asset.
   */
  numLiveModels?: number | null;

  /**
   * The latest {@link ReliabilityAssetRegime}.
   */
  latestRegime?: IReliabilityAssetRegime | null;
   ...
   */
  reliabilityRiskLiveModel?: IReliabilityMlModel | null;

  /**
   * Date of last update to model setup.
   */
  lastModelSetupUpdateDate?: DateTime | Date | string | null;
   ...
   */
  modelConfigRunRelations?: C3.Array<ReliabilityAssetToModelConfigRunRelation | null> | Array<IReliabilityAssetToModelConfigRunRelation | null>;

  /**
   * Count of open {@link ReliabilityAssetAlert}'s on this asset and its descendents in the last 24 hours
   */
  numLatestOpenAlerts?: number | null;
   ...
   */
  directCases?: C3.Array<ReliabilityAssetCase | null> | Array<IReliabilityAssetCase | null>;
   ...
   */
  numChallengerModels?: number | null;

  /**
   * Number of days since the last updated model.
   */
  daysSinceLastUpdatedReliabilityRiskModels?: number | null;

  /**
   * Sensor alerts in the last 24 hours.
   */
  latestSensorAlerts?: C3.Array<SensorHealthAlert | null> | Array<ISensorHealthAlert | null>;
   ...
   */
  assignedProjects?: C3.Array<ReliabilityMl.Project | null> | Array<IReliabilityMl.Project | null>;
   ...
   */
  diagramConfigs?: C3.Array<ProcessDiagramConfig | null> | Array<IProcessDiagramConfig | null>;
}
...
declare class ReliabilityAsset extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): ReliabilityAsset | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): ReliabilityAsset | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): ReliabilityAsset | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): ReliabilityAsset | null;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ReliabilityAsset;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ReliabilityAsset;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ReliabilityAsset | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ReliabilityAsset | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): ReliabilityAsset;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): ReliabilityAsset;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): ReliabilityAsset;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): ReliabilityAsset;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): ReliabilityAsset;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): ReliabilityAsset;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): ReliabilityAsset;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): ReliabilityAsset;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): ReliabilityAsset;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): ReliabilityAsset;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): ReliabilityAsset;

  mergeJson(json: any | null): ReliabilityAsset;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): ReliabilityAsset;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): ReliabilityAsset;
   ...
   */
  singletonArray(): C3.Array<ReliabilityAsset | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<ReliabilityAsset | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ReliabilityAsset | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<ReliabilityAsset | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ReliabilityAsset | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, ReliabilityAsset | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityAsset | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ReliabilityAsset | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ReliabilityAsset | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): ReliabilityAsset;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): ReliabilityAsset;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): ReliabilityAsset;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): ReliabilityAsset;
   ...
   * @see #fromString
   */
  static make(s: string | null): ReliabilityAsset | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): ReliabilityAsset;
   ...
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<ReliabilityAsset>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): ReliabilityAsset;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<ReliabilityAsset | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ReliabilityAsset | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<ReliabilityAsset | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<ReliabilityAsset | null> | null>;
   ...
   */
  static evalFeatureSetBatch(batch: C3.Array<ReliabilityAsset | null>, featureSet: Feature.Set, spec?: EvalFeatureSpec | null): Data | null;
   ...
   * ```
   */
  static evalFeaturesBatch(batch: C3.Array<ReliabilityAsset | null>, features: C3.Array<string | null>, spec?: EvalFeaturesSpec | null): Data | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): ReliabilityAsset | null;
   ...
   */
  routes(project: MlProject, statusFilter?: string | null, skipValidation?: boolean): C3.Array<MlModel.Route | null>;
   ...
   */
  models(project: MlProject, statusFilter?: string | null): C3.Array<MlModel | null>;
   ...
   * @see #models
   */
  static modelsPerSubject(subjects: C3.Array<MlSubject | null>, project: MlProject, statusFilter?: string | null): C3.Map<string | null, C3.Array<MlModel | null>>;
   ...
   * @see #models
   */
  static modelsPerSubject(subjectFilter: string, project: MlProject, statusFilter?: string | null): C3.Map<string | null, C3.Array<MlModel | null>>;
   ...
   */
  static routesSubjectsPerModel(subjects: C3.Array<MlSubject | null>, spec: MlSubject.OperationSpec): C3.Map<string | null, C3.Map<string | null, C3.Array<MlSubject | null>>>;
   ...
   */
  static projects(): C3.Array<MlProject | null>;
   ...
   */
  static processBatch(subjects?: C3.Array<MlSubject>, spec: MlSubject.OperationSpec): MlSubject.ProcessResult;
   ...
   */
  static startProcessJob(spec: MlSubject.OperationJobSpec): MlOperationRun<MlSubject.OperationJob.Run | null>;
   ...
   */
  static interpretBatch(subjects?: C3.Array<MlSubject>, spec: MlSubject.OperationSpec): MlSubject.InterpretResult;
   ...
   * @return a handle to the asynchronous job execution.
   */
  static startInterpretJob(spec: MlSubject.OperationJobSpec): MlOperationRun<MlSubject.OperationJob.Run | null>;
   ...
   */
  get(include?: string | null): ReliabilityAsset | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): ReliabilityAsset | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): ReliabilityAsset | null;
   ...
   */
  create(spec?: UpsertSpec | null): ReliabilityAsset | null;
   ...
   */
  static createBatch(objs: C3.Array<ReliabilityAsset | null> | null, spec?: UpsertSpec | null): ObjList<ReliabilityAsset | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ReliabilityAsset | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<ReliabilityAsset | null> | null;
   ...
   */
  update(srcObj?: ReliabilityAsset | null, spec?: UpsertSpec | null): ReliabilityAsset | null;
   ...
   */
  upsert(srcObj?: ReliabilityAsset | null, spec?: UpsertSpec | null): ReliabilityAsset | null;
   ...
   */
  merge(spec?: MergeSpec | null): ReliabilityAsset | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): ReliabilityAsset | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): ReliabilityAsset | null;
   ...
   */
  static updateBatch(objs: C3.Array<ReliabilityAsset | null> | null, srcObjs?: C3.Array<ReliabilityAsset | null>, spec?: UpsertSpec | null): ObjList<ReliabilityAsset | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<ReliabilityAsset | null>>, spec?: UpsertSpec | null): ObjList<ReliabilityAsset | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<ReliabilityAsset | null> | null, srcObjs?: C3.Array<ReliabilityAsset | null>, spec?: UpsertSpec | null): ObjList<ReliabilityAsset | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<ReliabilityAsset | null>>, spec?: UpsertSpec | null): ObjList<ReliabilityAsset | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<ReliabilityAsset | null> | null, spec?: TouchSpec | null): ObjList<ReliabilityAsset | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<ReliabilityAsset | null> | null, spec?: MergeSpec | null): ObjList<ReliabilityAsset | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<ReliabilityAsset | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<ReliabilityAsset | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<ReliabilityAsset | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<ReliabilityAsset | null> | null;
   ...
   */
  static mergeAll(mergeObj: ReliabilityAsset | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ReliabilityAsset | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<ReliabilityAsset | null> | null, spec?: UpsertSpec | null): ObjList<ReliabilityAsset | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<ReliabilityAsset | null> | null, spec?: UpsertSpec | null): ObjList<ReliabilityAsset | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<ReliabilityAsset | null> | null): ObjList<ReliabilityAsset | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<ReliabilityAsset | null> | null): ObjList<ReliabilityAsset | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<ReliabilityAsset | null> | null): ObjList<ReliabilityAsset | null>;
   ...
   */
  static afterCreate(objs: C3.Array<ReliabilityAsset | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<ReliabilityAsset | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<ReliabilityAsset | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<ReliabilityAsset | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<ReliabilityAsset | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): ReliabilityAsset | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<ReliabilityAsset | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: ReliabilityAsset | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<ReliabilityAsset | null> | null, callback?: λFunction<ReliabilityAsset | null, ReliabilityAsset | null> | null): ObjList<ReliabilityAsset | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<ReliabilityAsset | null> | null, callback?: λFunction<ReliabilityAsset | null, ReliabilityAsset | null> | null): C3.Array<ObjError | null>;
   ...
   */
  fetchDataValidationRuns(spec?: FetchSpec | null): FetchResult<DataValidationRun | null> | null;
   ...
   */
  getLatestDataValidationRun(dataValidationRuleSet?: DataValidationRuleset | null): DataValidationRun | null;
   ...
   */
  executeRulesValidation(ruleQueue: C3.Array<DataValidationRule | null> | null, run: DataValidationRun, persistResults?: boolean): DataValidationRun;
   ...
   */
  fetchDataValidationRules(spec?: DataValidationResultSubjectSpec | null): C3.Map<string | null, C3.Array<DataValidationRule | null>> | C3.Array<DataValidationRule | null> | null;
   ...
   */
  fetchDataValidationResults(spec?: DataValidationResultSubjectSpec | null): C3.Map<string | null, C3.Array<DataValidationResult | null>> | C3.Array<DataValidationResult | null> | null;
   ...
   */
  runDataValidation(ruleset: DataValidationRuleset, args?: C3.Map<string | null, any>, spec?: DataValidationExecutionSpec | null): DataValidationRun | null | DataValidationBatchJob | null | DataValidationMapReduceJob | null | null;
   ...
   *    Flag to determine whether results should be persisted.
   */
  static runRule(run: DataValidationRun, rule?: DataValidationRule | null, args: C3.Map<string | null, any>, persistResults?: boolean): DataValidationResult | null;
   ...
   */
  assignToProject(project?: ReliabilityMl.Project | null): void;
   ...
   */
  getMlStartEnd(start?: DateTime | null, end?: DateTime | null): StrPair | null;
   ...
   */
  static getFlatliningPercentage(flatliningTimeSteps?: number | null, df?: any): any;
   ...
   */
  createSensorFeatures(excludeSensors?: C3.Array<string | null>, start?: DateTime | null, end?: DateTime | null, interval?: string | null, method?: string | null, additionalRasrs?: C3.Array<ReliabilityAssetSensorRelation | null>): C3.Array<Feature | null>;
   ...
   */
  static createTimeRangeMaskExpression(timeRanges?: C3.Array<TimeRange | null>): string | null;
   ...
   */
  prepareInitialFeatureSet(spec: ReliabilityMlFeaturePreparationSpec | null, start?: DateTime | null, end?: DateTime | null, interval?: string | null): Feature.Set | null;
   ...
   */
  prepareCleanedFeatureSet(featureSet: Feature.Set, spec: ReliabilityMlFeaturePreparationSpec | null, start?: DateTime | null, end?: DateTime | null, masks?: C3.Map<string | null, Feature.Set | null>, interval?: string | null, sensorAssociationJobId?: string | null): Feature.Set | null;
   ...
   */
  prepareFeatures(spec: ReliabilityMlFeaturePreparationSpec | null, start?: DateTime | null, end?: DateTime | null, masksBeforeCleaning?: C3.Array<string | null>, maskPreparationSpec: ReliabilityMlMaskPreparationSpec | null, interval?: string | null, sensorAssociationJobId?: string | null): C3.Map<string | null, Feature.Set | null>;
   ...
   */
  static prepareDefaultAssetEventsMask(start?: DateTime | null, end?: DateTime | null, interval?: string | null): Feature | null;
   ...
   */
  prepareAssetEventsMask(start?: DateTime | null, end?: DateTime | null, features: Feature.Set, masks?: C3.Map<string | null, Feature.Set | null>, interval?: string | null, overrideFeature?: Feature | null): Feature.Set | null;
   ...
   */
  preparePreAssetEventsMask(preAssetEventsWindow?: number | null, start?: DateTime | null, end?: DateTime | null, features: Feature.Set, masks?: C3.Map<string | null, Feature.Set | null>, interval?: string | null, overrideFeature?: Feature | null): Feature.Set | null;
   ...
   */
  preparePostAssetEventsMask(postAssetEventsWindow?: number | null, start?: DateTime | null, end?: DateTime | null, features: Feature.Set, masks?: C3.Map<string | null, Feature.Set | null>, interval?: string | null, overrideFeature?: Feature | null): Feature.Set | null;
   ...
   */
  prepareIsAssetNotOperationalMask(start?: DateTime | null, end?: DateTime | null, features: Feature.Set, masks?: C3.Map<string | null, Feature.Set | null>, interval?: string | null, overrideFeature?: Feature | null): Feature.Set | null;
   ...
   */
  prepareAlgorithmicallyComputedTrainingMask(start?: DateTime | null, end?: DateTime | null, generateAlgorithmicallyComputedTrainingMask?: boolean, algorithmicallyComputedTrainingMaskTechnique?: AlgorithmicallyComputedTrainingMaskTechnique | null, features: Feature.Set, masks?: C3.Map<string | null, Feature.Set | null>, interval?: string | null): Feature.Set | null;
   ...
   */
  prepareAdHocTrainingMask(start?: DateTime | null, end?: DateTime | null, features?: Feature.Set | null, masks?: C3.Map<string | null, Feature.Set | null>, interval?: string | null, timeRanges?: C3.Array<TimeRange | null>, preIsAssetNotOperationalFeatureOverride?: Feature | null, postIsAssetNotOperationalFeatureOverride?: Feature | null, overrideFeature?: Feature | null): Feature.Set | null;
   ...
   */
  prepareAdHocInferenceMask(start?: DateTime | null, end?: DateTime | null, features?: Feature.Set | null, masks?: C3.Map<string | null, Feature.Set | null>, interval?: string | null, postIsAssetNotOperationalFeatureOverride?: Feature | null, overrideFeature?: Feature | null, timeRanges?: C3.Array<TimeRange | null>): Feature.Set | null;
   ...
   */
  prepareMask(spec: ReliabilityMlMaskPreparationSpec | null, start?: DateTime | null, end?: DateTime | null, maskToApply?: string | null, features?: Feature.Set | null, masks?: C3.Map<string | null, Feature.Set | null>, interval?: string | null): Feature.Set | null;
   ...
   */
  prepareMasks(spec: ReliabilityMlMaskPreparationSpec | null, start?: DateTime | null, end?: DateTime | null, masksToApply?: C3.Array<string | null>, features?: Feature.Set | null, masksApplied?: C3.Map<string | null, Feature.Set | null>, interval?: string | null): C3.Map<string | null, Feature.Set | null>;
   ...
   */
  prepareTarget(spec: ReliabilityMlTargetPreparationSpec | null, start?: DateTime | null, end?: DateTime | null, interval?: string | null): C3.Map<string | null, Feature.Set | null>;
   ...
   */
  prepareAlertContext(project?: ReliabilityMl.Project | null, start?: DateTime | null, end?: DateTime | null, interval?: string | null, overrideFeatures?: C3.Array<Feature | null>): C3.Map<string | null, Feature.Set | null>;
   ...
   */
  trainValSplit(featureSet: Feature.Set, spec: ReliabilityMlTrainValSplitSpec | null, start: DateTime, end: DateTime): C3.Map<string | null, TimeRange | null>;
   ...
   */
  beforePrepareMlDatasets(spec: ReliabilityMlDatasetPreparationSpec, job?: ReliabilityMlDatasetPreparationJob | null): ReliabilityMlDatasetPreparationSpec;
   ...
   * @return a {@link ReliabilityMlDatasetPreparationRun} representing the completed preparation.
   */
  prepareMlDatasets(spec?: ReliabilityMlDatasetPreparationSpec | null, job?: ReliabilityMlDatasetPreparationJob | null): ReliabilityMlDatasetPreparationRun | null;
   ...
   */
  static prepareMlDatasetsBatch(spec?: ReliabilityMlDatasetPreparationSpec | null, options?: MapReduceOptions | null): ReliabilityMlDatasetPreparationJob | null;
   ...
   */
  static validateMaskExpression(assetId: string, expressions?: C3.Array<string | null>): boolean;
   ...
   */
  static parseMaskExpression(expression?: string | null): string | null;
   ...
   * @return a {@link ReliabilityMlDatasetPreparationRun} representing the completed preparation.
   */
  static prepareMlDatasetsAndSensorDataReports(assets: C3.Array<ReliabilityAsset | null>, spec: ReliabilityMlDatasetPreparationSpec): ReliabilityMlDatasetPreparationRun | null;
   ...
   */
  prepareSensorDataReports(spec: ReliabilityMlDatasetPreparationSpec, overrideTimeRange?: TimeRange | null): ReliabilityMlDatasetPreparationSpec;
   ...
   */
  fetchRelevantAssets(level?: number | null, isAbsolute?: boolean): FetchResult<ReliabilityAsset | null> | null;
   ...
   *     ```
   */
  static fetchSensorsForSelectedAssets(assets: C3.Array<string | null>, spec?: FetchSpec | null, sensorDataReportsFilter?: string | null): FetchResultWithTotalCount<any | null> | null;
   ...
   */
  removeCorrelatedFeatures(features: C3.Array<Sensor | null>): ObjList<ReliabilityAssetSensorRelation | null> | null;
   ...
   * @returns The list of updated {@link ReliabilityAssetSensorRelation relations}.
   */
  addCorrelatedFeatures(features: C3.Array<Sensor | null>): ObjList<ReliabilityAssetSensorRelation | null> | null;
   ...
   */
  static populateAcl(objs?: C3.Array<ReliabilityAsset | null>): number | null;
   ...
   * @return the obj with the new acl after merging the indicated entry.
   */
  mergeAclEntries(entries: C3.Array<AclEntry | null> | null): ReliabilityAsset;
   ...
   */
  static createData(assetId: string, numberOfSensors: number, assetName?: string | null, start?: DateTime | null, end?: DateTime | null, eventHourOffset?: number | null): void;
   ...
   */
  static createSensorAssociatonData(): C3.Map<string | null, any>;
   ...
   */
  getSensorsForExpectedSensors(expectedSensors?: C3.Array<ExpectedSensor | null>): C3.Map<string | null, Sensor | null>;
   ...
   */
  static createAsset(assetName: string, parent: ReliabilityAsset | null | Facility | null, waitForHierarchyCalcs?: boolean): ReliabilityAsset | null;
   ...
   */
  moveAsset(parent: ReliabilityAsset | null | Facility | null): void;
   ...
   */
  deleteAssetAndRemoveFromHierarchy(deleteDescendents?: boolean): void;
   ...
   */
  static processAssetHierarchyChangesSinceTimestamp(startTimestamp: DateTime, batchSize?: number | null): void;
   ...
   */
  static getIdsOfCurrentChildrenAndSelf(parentIds?: C3.Array<string | null>): C3.Array<string | null>;
   ...
   */
  generateSensorDataReport(spec: SensorReportSpec): C3.Array<SensorDataReport | null>;
   ...
   */
  fetchSensorRelationsWithExpectedSensorsMissingInAssetClassObjStream(assetClass: AssetClass, spec?: FetchSpec | null): Stream<ReliabilityAssetSensorRelation | null>;
   ...
   */
  fetchSensorRelationsWithExpectedSensorsMissingInAssetClass(assetClass: AssetClass, spec?: FetchSpec | null): FetchResultWithTotalCount<ReliabilityAssetSensorRelation | null> | null;
   ...
   */
  evalFeaturesWithinTimeHorizon(features: C3.Array<string | null>, spec: EvalFeaturesSpec): Data | null;
   ...
   */
  updateMutedPeriodDates(alertType: ReliabilityAlertType, start?: DateTime | null, end?: DateTime | null, duration?: number | null, timestamp?: DateTime | null): AlertMutedPeriod;
   ...
   */
  static fetchAssetLevels(maxDepthOverride?: number | null): any | null;
   ...
   */
  modifySensorMappings(spec?: ModifySensorMappingSpec | null): void;
   ...
   */
  getIncrementalInferencePeriod(timeRange: TimeRange, project: ReliabilityMl.Project, statusLabel?: string | null): TimeRange;
   ...
   */
  createMutedPeriod(alertType: ReliabilityAlertType, start?: DateTime | null, end?: DateTime | null, duration?: number | null): AlertMutedPeriod;
   ...
   */
  static generateMultiReportEntity(assets: C3.Array<ReliabilityAsset | null>, facility?: Facility | null, assetReportSpec: ReliabilityAssetReportSpec, waitForCompletion?: boolean): ReliabilityAssetReport | null | ReliabilityAssetReportJob | null | null;
   ...
   */
  getMutedPeriodForAlertType(alertType: ReliabilityAlertType, timestamp?: DateTime | null): AlertMutedPeriod | null;
   ...
   */
  static fetchCountProjectsNotAddedToAsset(assetId: string, spec?: FetchSpec | null): number;
   ...
   */
  static fetchAssetsForWorkOrder(caseId?: string | null): FetchResult<ReliabilityAsset | null> | null;
   ...
   */
  static fetchProjectsNotAddedToAsset(assetId: string, spec: FetchSpec): FetchResult<ReliabilityMl.Project | null>;
}
