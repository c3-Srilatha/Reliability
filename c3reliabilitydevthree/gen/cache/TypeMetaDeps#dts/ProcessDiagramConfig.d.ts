// TypeScript definitions for the C3 type ProcessDiagramConfig

/**
 * Configuration for one component in a {@link UiSdlProcessFlowDiagram}.
 *
 * @remarks this represents a value passed to a method that expects an instance of ProcessDiagramConfig
 */
declare interface IProcessDiagramConfig {
 ...
 */
declare class ProcessDiagramConfig extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): ProcessDiagramConfig | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): ProcessDiagramConfig | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): ProcessDiagramConfig | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): ProcessDiagramConfig | null;
   ...
   */
  replaceType(old: Type, new_: Type): ProcessDiagramConfig;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ProcessDiagramConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ProcessDiagramConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ProcessDiagramConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ProcessDiagramConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): ProcessDiagramConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ProcessDiagramConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ProcessDiagramConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ProcessDiagramConfig;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ProcessDiagramConfig;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ProcessDiagramConfig;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): ProcessDiagramConfig;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ProcessDiagramConfig;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ProcessDiagramConfig;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): ProcessDiagramConfig;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): ProcessDiagramConfig;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): ProcessDiagramConfig;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): ProcessDiagramConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ProcessDiagramConfig;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): ProcessDiagramConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ProcessDiagramConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ProcessDiagramConfig;
   ...
   * @see #removeField
   */
  unsetField(field: string): ProcessDiagramConfig;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ProcessDiagramConfig;
   ...
   * @see #unsetField
   */
  removeField(field: string): ProcessDiagramConfig;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ProcessDiagramConfig;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): ProcessDiagramConfig;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): ProcessDiagramConfig;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): ProcessDiagramConfig;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): ProcessDiagramConfig;

  mergeJson(json: any | null): ProcessDiagramConfig;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): ProcessDiagramConfig;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): ProcessDiagramConfig;
   ...
   */
  singletonArray(): C3.Array<ProcessDiagramConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<ProcessDiagramConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ProcessDiagramConfig | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<ProcessDiagramConfig | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ProcessDiagramConfig | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, ProcessDiagramConfig | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ProcessDiagramConfig | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ProcessDiagramConfig | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ProcessDiagramConfig | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): ProcessDiagramConfig;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): ProcessDiagramConfig;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): ProcessDiagramConfig;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ProcessDiagramConfig;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): ProcessDiagramConfig;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ProcessDiagramConfig;
   ...
   * @see #fromString
   */
  static make(s: string | null): ProcessDiagramConfig | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): ProcessDiagramConfig;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ProcessDiagramConfig;
   ...
   */
  static cachedEmptyInst(): ProcessDiagramConfig;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<ProcessDiagramConfig>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): ProcessDiagramConfig;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<ProcessDiagramConfig | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ProcessDiagramConfig | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<ProcessDiagramConfig | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<ProcessDiagramConfig | null> | null>;
   ...
   */
  get(include?: string | null): ProcessDiagramConfig | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): ProcessDiagramConfig | null;
   ...
   */
  getMissing(spec: GetMissingSpec): ProcessDiagramConfig;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): ProcessDiagramConfig | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): ProcessDiagramConfig;
   ...
   * @see #toString
   */
  static fromString(s: string | null): ProcessDiagramConfig | null;
   ...
   */
  create(spec?: UpsertSpec | null): ProcessDiagramConfig | null;
   ...
   */
  static createBatch(objs: C3.Array<ProcessDiagramConfig | null> | null, spec?: UpsertSpec | null): ObjList<ProcessDiagramConfig | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ProcessDiagramConfig | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<ProcessDiagramConfig | null> | null;
   ...
   */
  update(srcObj?: ProcessDiagramConfig | null, spec?: UpsertSpec | null): ProcessDiagramConfig | null;
   ...
   */
  upsert(srcObj?: ProcessDiagramConfig | null, spec?: UpsertSpec | null): ProcessDiagramConfig | null;
   ...
   */
  merge(spec?: MergeSpec | null): ProcessDiagramConfig | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): ProcessDiagramConfig | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): ProcessDiagramConfig | null;
   ...
   */
  static updateBatch(objs: C3.Array<ProcessDiagramConfig | null> | null, srcObjs?: C3.Array<ProcessDiagramConfig | null>, spec?: UpsertSpec | null): ObjList<ProcessDiagramConfig | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<ProcessDiagramConfig | null>>, spec?: UpsertSpec | null): ObjList<ProcessDiagramConfig | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<ProcessDiagramConfig | null> | null, srcObjs?: C3.Array<ProcessDiagramConfig | null>, spec?: UpsertSpec | null): ObjList<ProcessDiagramConfig | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<ProcessDiagramConfig | null>>, spec?: UpsertSpec | null): ObjList<ProcessDiagramConfig | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<ProcessDiagramConfig | null> | null, spec?: TouchSpec | null): ObjList<ProcessDiagramConfig | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<ProcessDiagramConfig | null> | null, spec?: MergeSpec | null): ObjList<ProcessDiagramConfig | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<ProcessDiagramConfig | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<ProcessDiagramConfig | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<ProcessDiagramConfig | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<ProcessDiagramConfig | null> | null;
   ...
   */
  static mergeAll(mergeObj: ProcessDiagramConfig | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ProcessDiagramConfig | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<ProcessDiagramConfig | null> | null, spec?: UpsertSpec | null): ObjList<ProcessDiagramConfig | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<ProcessDiagramConfig | null> | null, spec?: UpsertSpec | null): ObjList<ProcessDiagramConfig | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): ProcessDiagramConfig | null;
   ...
   */
  static beforeCreate(objs: C3.Array<ProcessDiagramConfig | null> | null): ObjList<ProcessDiagramConfig | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<ProcessDiagramConfig | null> | null): ObjList<ProcessDiagramConfig | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<ProcessDiagramConfig | null> | null): ObjList<ProcessDiagramConfig | null>;
   ...
   */
  static afterCreate(objs: C3.Array<ProcessDiagramConfig | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<ProcessDiagramConfig | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<ProcessDiagramConfig | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<ProcessDiagramConfig | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<ProcessDiagramConfig | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): ProcessDiagramConfig | null;
   ...
   */
  withoutIdentity(): ProcessDiagramConfig | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<ProcessDiagramConfig | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: ProcessDiagramConfig | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<ProcessDiagramConfig | null> | null, callback?: λFunction<ProcessDiagramConfig | null, ProcessDiagramConfig | null> | null): ObjList<ProcessDiagramConfig | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<ProcessDiagramConfig | null> | null, callback?: λFunction<ProcessDiagramConfig | null, ProcessDiagramConfig | null> | null): C3.Array<ObjError | null>;
