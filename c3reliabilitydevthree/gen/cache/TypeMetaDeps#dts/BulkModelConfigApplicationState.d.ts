...
declare interface IBulkModelConfigApplicationState {
   ...
   */
  settings?: IBulkModelConfigUiSettings | null;
   ...
   */
  selectedAssetIdsWithoutDataset?: C3.Array<ReliabilityAsset | null> | Array<IReliabilityAsset | null>;
   ...
   */
  selectedAssetIdsWithDataset?: C3.Array<ReliabilityAsset | null> | Array<IReliabilityAsset | null>;

  /**
   * The list of model templates that can be chosen.
   */
  templateData?: C3.Array<ModelTemplate | null> | Array<IModelTemplate | null>;
   ...
   */
  selectedModels?: C3.Array<string | null> | Array<string | null>;
   ...
   */
  selectedCVs?: C3.Array<string | null> | Array<string | null>;
   ...
   */
  sensorAssociationFlowTargetAssetIds?: C3.Array<string | null> | Array<string | null>;

  /**
   * When `isSensorAssociationFlow` is `true`, this field contains the ids of the assets that are not ready for
   * model configuration.
   */
  sensorAssociationFlowErrorAssets?: C3.Array<ReliabilityAsset | null> | Array<IReliabilityAsset | null>;
}
...
declare class BulkModelConfigApplicationState extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): BulkModelConfigApplicationState | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): BulkModelConfigApplicationState | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): BulkModelConfigApplicationState | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): BulkModelConfigApplicationState | null;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): BulkModelConfigApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): BulkModelConfigApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<BulkModelConfigApplicationState | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<BulkModelConfigApplicationState | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): BulkModelConfigApplicationState;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): BulkModelConfigApplicationState;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): BulkModelConfigApplicationState;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): BulkModelConfigApplicationState;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): BulkModelConfigApplicationState;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): BulkModelConfigApplicationState;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): BulkModelConfigApplicationState;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): BulkModelConfigApplicationState;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): BulkModelConfigApplicationState;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): BulkModelConfigApplicationState;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): BulkModelConfigApplicationState;

  mergeJson(json: any | null): BulkModelConfigApplicationState;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): BulkModelConfigApplicationState;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): BulkModelConfigApplicationState;
   ...
   */
  singletonArray(): C3.Array<BulkModelConfigApplicationState | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<BulkModelConfigApplicationState | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<BulkModelConfigApplicationState | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<BulkModelConfigApplicationState | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<BulkModelConfigApplicationState | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, BulkModelConfigApplicationState | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, BulkModelConfigApplicationState | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<BulkModelConfigApplicationState | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<BulkModelConfigApplicationState | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): BulkModelConfigApplicationState;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): BulkModelConfigApplicationState;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): BulkModelConfigApplicationState;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): BulkModelConfigApplicationState;
   ...
   * @see #fromString
   */
  static make(s: string | null): BulkModelConfigApplicationState | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): BulkModelConfigApplicationState;
   ...
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<BulkModelConfigApplicationState>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): BulkModelConfigApplicationState;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<BulkModelConfigApplicationState | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<BulkModelConfigApplicationState | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<BulkModelConfigApplicationState | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<BulkModelConfigApplicationState | null> | null>;
   ...
   */
  dependencies(): MetadataDeps<BulkModelConfigApplicationState | null>;

  save(subPath?: string | null, contentType?: string | null): BulkModelConfigApplicationState;
  ...
  update(srcObj?: BulkModelConfigApplicationState | null, spec?: UpsertSpec | null): BulkModelConfigApplicationState | null;

  upsert(srcObj?: BulkModelConfigApplicationState | null, spec?: UpsertSpec | null): BulkModelConfigApplicationState | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): BulkModelConfigApplicationState | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string | null, failIfMissing?: boolean): BulkModelConfigApplicationState | null;
   ...
   */
  static setTemplateDataAction(templateData?: C3.Array<ModelTemplate | null>): UiSdlReduxAction<any>;
   ...
   */
  static setHyperparamAction(field: string, value?: string | null): UiSdlReduxAction<any>;
   ...
   */
  static startUiWorkflowAction(usingBulkDataPrep?: boolean, usingBulkSensorAssociation?: boolean, isSensorAssociationFlow?: boolean, dataType?: string | null, dataItemIds?: C3.Array<string | null>): UiSdlReduxAction<any>;
