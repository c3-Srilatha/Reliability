// TypeScript definitions for the C3 type ReliabilityMetric

/**
 * This remix type is used to defined fields and functions used on the UI side for {@link ReliabilityMetric}.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilityMetric
 */
declare interface IReliabilityMetric {
   ...
   */
  dependencyMetrics?: C3.Array<ReliabilityMetricDependencies | null> | Array<IReliabilityMetricDependencies | null>;
   ...
   * Will be fetched from the {@link ReliabilityMetricDependencies} based on the `relationType`.
   */
  childMetrics?: C3.Array<ReliabilityMetricDependencies | null> | Array<IReliabilityMetricDependencies | null>;
   ...
   */
  allowedUser?: IUser | null;

  /**
   * A list of related assets that this metric is associated with.
   */
  assets?: C3.Array<ReliabilityAsset | null> | Array<IReliabilityAsset | null>;
   ...
   */
  assetsDisplayStrInSidePanel?: string | null;
}
 ...
 */
declare class ReliabilityMetric extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): ReliabilityMetric | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): ReliabilityMetric | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): ReliabilityMetric | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): ReliabilityMetric | null;
   ...
   */
  replaceType(old: Type, new_: Type): ReliabilityMetric;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ReliabilityMetric;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ReliabilityMetric;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ReliabilityMetric | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ReliabilityMetric | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): ReliabilityMetric;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityMetric;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilityMetric;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ReliabilityMetric;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ReliabilityMetric;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilityMetric;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): ReliabilityMetric;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilityMetric;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ReliabilityMetric;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): ReliabilityMetric;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): ReliabilityMetric;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): ReliabilityMetric;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): ReliabilityMetric;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ReliabilityMetric;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): ReliabilityMetric;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ReliabilityMetric;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ReliabilityMetric;
   ...
   * @see #removeField
   */
  unsetField(field: string): ReliabilityMetric;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ReliabilityMetric;
   ...
   * @see #unsetField
   */
  removeField(field: string): ReliabilityMetric;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ReliabilityMetric;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): ReliabilityMetric;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): ReliabilityMetric;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): ReliabilityMetric;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): ReliabilityMetric;

  mergeJson(json: any | null): ReliabilityMetric;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): ReliabilityMetric;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): ReliabilityMetric;
   ...
   */
  singletonArray(): C3.Array<ReliabilityMetric | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<ReliabilityMetric | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ReliabilityMetric | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<ReliabilityMetric | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ReliabilityMetric | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, ReliabilityMetric | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilityMetric | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ReliabilityMetric | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ReliabilityMetric | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): ReliabilityMetric;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): ReliabilityMetric;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): ReliabilityMetric;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ReliabilityMetric;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): ReliabilityMetric;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ReliabilityMetric;
   ...
   * @see #fromString
   */
  static make(s: string | null): ReliabilityMetric | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): ReliabilityMetric;
   ...
   */
  static cachedEmptyInst(): ReliabilityMetric;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<ReliabilityMetric>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): ReliabilityMetric;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<ReliabilityMetric | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ReliabilityMetric | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<ReliabilityMetric | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<ReliabilityMetric | null> | null>;
   ...
   */
  get(include?: string | null): ReliabilityMetric | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): ReliabilityMetric | null;
   ...
   */
  getMissing(spec: GetMissingSpec): ReliabilityMetric;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): ReliabilityMetric | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): ReliabilityMetric;
   ...
   * @see #toString
   */
  static fromString(s: string | null): ReliabilityMetric | null;
   ...
   */
  create(spec?: UpsertSpec | null): ReliabilityMetric | null;
   ...
   */
  static createBatch(objs: C3.Array<ReliabilityMetric | null> | null, spec?: UpsertSpec | null): ObjList<ReliabilityMetric | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ReliabilityMetric | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<ReliabilityMetric | null> | null;
   ...
   */
  update(srcObj?: ReliabilityMetric | null, spec?: UpsertSpec | null): ReliabilityMetric | null;
   ...
   */
  upsert(srcObj?: ReliabilityMetric | null, spec?: UpsertSpec | null): ReliabilityMetric | null;
   ...
   */
  merge(spec?: MergeSpec | null): ReliabilityMetric | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): ReliabilityMetric | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): ReliabilityMetric | null;
   ...
   */
  static updateBatch(objs: C3.Array<ReliabilityMetric | null> | null, srcObjs?: C3.Array<ReliabilityMetric | null>, spec?: UpsertSpec | null): ObjList<ReliabilityMetric | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<ReliabilityMetric | null>>, spec?: UpsertSpec | null): ObjList<ReliabilityMetric | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<ReliabilityMetric | null> | null, srcObjs?: C3.Array<ReliabilityMetric | null>, spec?: UpsertSpec | null): ObjList<ReliabilityMetric | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<ReliabilityMetric | null>>, spec?: UpsertSpec | null): ObjList<ReliabilityMetric | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<ReliabilityMetric | null> | null, spec?: TouchSpec | null): ObjList<ReliabilityMetric | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<ReliabilityMetric | null> | null, spec?: MergeSpec | null): ObjList<ReliabilityMetric | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<ReliabilityMetric | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<ReliabilityMetric | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<ReliabilityMetric | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<ReliabilityMetric | null> | null;
   ...
   */
  static mergeAll(mergeObj: ReliabilityMetric | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ReliabilityMetric | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<ReliabilityMetric | null> | null, spec?: UpsertSpec | null): ObjList<ReliabilityMetric | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<ReliabilityMetric | null> | null, spec?: UpsertSpec | null): ObjList<ReliabilityMetric | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): ReliabilityMetric | null;
   ...
   */
  static beforeCreate(objs: C3.Array<ReliabilityMetric | null> | null): ObjList<ReliabilityMetric | null>;
   ...
   */
  static beforeUpdate(objs: C3.Array<ReliabilityMetric | null> | null): ObjList<ReliabilityMetric | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<ReliabilityMetric | null> | null): ObjList<ReliabilityMetric | null>;
   ...
   */
  static afterCreate(objs: C3.Array<ReliabilityMetric | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static afterUpdate(objs: C3.Array<ReliabilityMetric | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<ReliabilityMetric | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<ReliabilityMetric | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<ReliabilityMetric | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): ReliabilityMetric | null;
   ...
   */
  withoutIdentity(): ReliabilityMetric | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<ReliabilityMetric | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: ReliabilityMetric | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<ReliabilityMetric | null> | null, callback?: λFunction<ReliabilityMetric | null, ReliabilityMetric | null> | null): ObjList<ReliabilityMetric | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<ReliabilityMetric | null> | null, callback?: λFunction<ReliabilityMetric | null, ReliabilityMetric | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static createMetric(formObject: ReliabilityMetricSpec, childMetrics?: C3.Array<ReliabilityMetric | null>): ReliabilityMetric | null;
   ...
   */
  static modifyMetric(formObject: ReliabilityMetricSpec, childMetrics?: C3.Array<ReliabilityMetric | null>): ReliabilityMetric | null;
   ...
   */
  static deleteMetric(metricId?: string | null): ReliabilityMetric | null;
   ...
   */
  static isNameDuplicated(name: string, id?: string | null): boolean;
   ...
   */
  static fetchMetricByCurrentUser(spec?: FetchSpec | null): FetchResult<ReliabilityMetric | null> | null;
   ...
   */
  static parseExpression(metricExpression: string): C3.Array<string | null>;
   ...
   */
  static clearDependencyMetrics(metricToDelete: ReliabilityMetric): void;
   ...
   */
  static replaceSensorTag(expression?: string | null): string | null;
   ...
   */
  static replaceMetricExpandedExpression(expression?: string | null, metrics?: C3.Array<ReliabilityMetric | null>): string | null;
   ...
   */
  static evalMetrics(metrics: C3.Array<ReliabilityMetric | null>, start: DateTime, end: DateTime, interval: string): C3.Map<string | null, Timeseries<any> | null>;
   ...
   */
  static fetchChildMetrics(expression: string, spec?: FetchSpec | null): FetchResultWithTotalCount<ReliabilityMetric | null> | null;
   ...
   */
  static validateSyntax(expression: string): string | null;
   ...
   */
  static fetchDependentMetrics(metricId: string, spec?: FetchSpec | null): FetchResultWithTotalCount<ReliabilityMetric | null> | null;
   ...
   */
  static getAssetsForMetrics(sensorObjs?: C3.Array<Sensor | null>, metricObjs?: C3.Array<ReliabilityMetric | null>): C3.Array<string | null>;
   ...
   */
  static validateMetricExpression(expression?: string | null): string | null;
   ...
   */
  static buildMetricPreviewSpec(expression: string): CreateMetricConfigurationPreviewChartHelperSpec | null;
   ...
   * @returns The translation key of the error message if the expression is invalid, else returns `null`.
   */
  static validateExpression(expressionIdentifiers?: C3.Array<string | null>): string | null;
}
