...
declare interface IModelScenarioDetailsApplicationState {
   ...
   */
  chartConfig?: IUiApTimeseriesChartConfig | null;
   ...
   * nested grid.
   */
  alertData?: C3.Map<string | null, FetchResult<any | null> | null> | {[key: string | null]: IFetchResult<any | null> | null};
   ...
   */
  featureData?: C3.Map<string | null, Timeseries<any> | null> | {[key: string | null]: ITimeseries<any> | null};

  /**
   * The time range of the scenario.
   */
  scenarioTimeRange?: ITimeRange | null;
...
declare class ModelScenarioDetailsApplicationState extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): ModelScenarioDetailsApplicationState | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): ModelScenarioDetailsApplicationState | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): ModelScenarioDetailsApplicationState | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): ModelScenarioDetailsApplicationState | null;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ModelScenarioDetailsApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ModelScenarioDetailsApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ModelScenarioDetailsApplicationState | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ModelScenarioDetailsApplicationState | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): ModelScenarioDetailsApplicationState;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): ModelScenarioDetailsApplicationState;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): ModelScenarioDetailsApplicationState;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): ModelScenarioDetailsApplicationState;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): ModelScenarioDetailsApplicationState;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): ModelScenarioDetailsApplicationState;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): ModelScenarioDetailsApplicationState;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): ModelScenarioDetailsApplicationState;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): ModelScenarioDetailsApplicationState;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): ModelScenarioDetailsApplicationState;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): ModelScenarioDetailsApplicationState;

  mergeJson(json: any | null): ModelScenarioDetailsApplicationState;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): ModelScenarioDetailsApplicationState;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): ModelScenarioDetailsApplicationState;
   ...
   */
  singletonArray(): C3.Array<ModelScenarioDetailsApplicationState | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<ModelScenarioDetailsApplicationState | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ModelScenarioDetailsApplicationState | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<ModelScenarioDetailsApplicationState | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ModelScenarioDetailsApplicationState | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, ModelScenarioDetailsApplicationState | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ModelScenarioDetailsApplicationState | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ModelScenarioDetailsApplicationState | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ModelScenarioDetailsApplicationState | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): ModelScenarioDetailsApplicationState;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): ModelScenarioDetailsApplicationState;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): ModelScenarioDetailsApplicationState;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): ModelScenarioDetailsApplicationState;
   ...
   * @see #fromString
   */
  static make(s: string | null): ModelScenarioDetailsApplicationState | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): ModelScenarioDetailsApplicationState;
   ...
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<ModelScenarioDetailsApplicationState>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): ModelScenarioDetailsApplicationState;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<ModelScenarioDetailsApplicationState | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ModelScenarioDetailsApplicationState | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<ModelScenarioDetailsApplicationState | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<ModelScenarioDetailsApplicationState | null> | null>;
   ...
   */
  dependencies(): MetadataDeps<ModelScenarioDetailsApplicationState | null>;

  save(subPath?: string | null, contentType?: string | null): ModelScenarioDetailsApplicationState;
  ...
  update(srcObj?: ModelScenarioDetailsApplicationState | null, spec?: UpsertSpec | null): ModelScenarioDetailsApplicationState | null;

  upsert(srcObj?: ModelScenarioDetailsApplicationState | null, spec?: UpsertSpec | null): ModelScenarioDetailsApplicationState | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): ModelScenarioDetailsApplicationState | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string | null, failIfMissing?: boolean): ModelScenarioDetailsApplicationState | null;
