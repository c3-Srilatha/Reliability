// TypeScript definitions for the C3 type AssetMapApplicationState

/**
 * Application state for the Asset Map page.
 *
 * @remarks this represents a value passed to a method that expects an instance of AssetMapApplicationState
 */
declare interface IAssetMapApplicationState {
   ...
   */
  submittedFilterSpec?: string | null;
}
 ...
 */
declare class AssetMapApplicationState extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): AssetMapApplicationState | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): AssetMapApplicationState | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): AssetMapApplicationState | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): AssetMapApplicationState | null;
   ...
   */
  replaceType(old: Type, new_: Type): AssetMapApplicationState;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): AssetMapApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): AssetMapApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<AssetMapApplicationState | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<AssetMapApplicationState | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): AssetMapApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): AssetMapApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): AssetMapApplicationState;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): AssetMapApplicationState;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): AssetMapApplicationState;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): AssetMapApplicationState;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): AssetMapApplicationState;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): AssetMapApplicationState;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): AssetMapApplicationState;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): AssetMapApplicationState;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): AssetMapApplicationState;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): AssetMapApplicationState;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): AssetMapApplicationState;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): AssetMapApplicationState;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): AssetMapApplicationState;
   ...
   * @see #unsetField
   */
  defaultField(field: string): AssetMapApplicationState;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): AssetMapApplicationState;
   ...
   * @see #removeField
   */
  unsetField(field: string): AssetMapApplicationState;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): AssetMapApplicationState;
   ...
   * @see #unsetField
   */
  removeField(field: string): AssetMapApplicationState;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): AssetMapApplicationState;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): AssetMapApplicationState;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): AssetMapApplicationState;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): AssetMapApplicationState;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): AssetMapApplicationState;

  mergeJson(json: any | null): AssetMapApplicationState;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): AssetMapApplicationState;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): AssetMapApplicationState;
   ...
   */
  singletonArray(): C3.Array<AssetMapApplicationState | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<AssetMapApplicationState | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<AssetMapApplicationState | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<AssetMapApplicationState | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<AssetMapApplicationState | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, AssetMapApplicationState | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, AssetMapApplicationState | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<AssetMapApplicationState | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<AssetMapApplicationState | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): AssetMapApplicationState;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): AssetMapApplicationState;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): AssetMapApplicationState;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): AssetMapApplicationState;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): AssetMapApplicationState;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): AssetMapApplicationState;
   ...
   * @see #fromString
   */
  static make(s: string | null): AssetMapApplicationState | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): AssetMapApplicationState;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): AssetMapApplicationState;
   ...
   */
  static cachedEmptyInst(): AssetMapApplicationState;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<AssetMapApplicationState>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): AssetMapApplicationState;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<AssetMapApplicationState | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<AssetMapApplicationState | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<AssetMapApplicationState | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<AssetMapApplicationState | null> | null>;
   ...
   */
  dependencies(): MetadataDeps<AssetMapApplicationState | null>;

  save(subPath?: string | null, contentType?: string | null): AssetMapApplicationState;
  ...
  update(srcObj?: AssetMapApplicationState | null, spec?: UpsertSpec | null): AssetMapApplicationState | null;

  upsert(srcObj?: AssetMapApplicationState | null, spec?: UpsertSpec | null): AssetMapApplicationState | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): AssetMapApplicationState | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string | null, failIfMissing?: boolean): AssetMapApplicationState | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: AssetMapApplicationState, state: UiSdlReduxState): AssetMapApplicationState | null;
