...
declare class MetricConfigApplicationState extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): MetricConfigApplicationState | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): MetricConfigApplicationState | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): MetricConfigApplicationState | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): MetricConfigApplicationState | null;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): MetricConfigApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): MetricConfigApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<MetricConfigApplicationState | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<MetricConfigApplicationState | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): MetricConfigApplicationState;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): MetricConfigApplicationState;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): MetricConfigApplicationState;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): MetricConfigApplicationState;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): MetricConfigApplicationState;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): MetricConfigApplicationState;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): MetricConfigApplicationState;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): MetricConfigApplicationState;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): MetricConfigApplicationState;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): MetricConfigApplicationState;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): MetricConfigApplicationState;

  mergeJson(json: any | null): MetricConfigApplicationState;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): MetricConfigApplicationState;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): MetricConfigApplicationState;
   ...
   */
  singletonArray(): C3.Array<MetricConfigApplicationState | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<MetricConfigApplicationState | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<MetricConfigApplicationState | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<MetricConfigApplicationState | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<MetricConfigApplicationState | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, MetricConfigApplicationState | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, MetricConfigApplicationState | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<MetricConfigApplicationState | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<MetricConfigApplicationState | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): MetricConfigApplicationState;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): MetricConfigApplicationState;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): MetricConfigApplicationState;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): MetricConfigApplicationState;
   ...
   * @see #fromString
   */
  static make(s: string | null): MetricConfigApplicationState | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): MetricConfigApplicationState;
   ...
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<MetricConfigApplicationState>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): MetricConfigApplicationState;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<MetricConfigApplicationState | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<MetricConfigApplicationState | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<MetricConfigApplicationState | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<MetricConfigApplicationState | null> | null>;
   ...
   */
  dependencies(): MetadataDeps<MetricConfigApplicationState | null>;

  save(subPath?: string | null, contentType?: string | null): MetricConfigApplicationState;
  ...
  update(srcObj?: MetricConfigApplicationState | null, spec?: UpsertSpec | null): MetricConfigApplicationState | null;

  upsert(srcObj?: MetricConfigApplicationState | null, spec?: UpsertSpec | null): MetricConfigApplicationState | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): MetricConfigApplicationState | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string | null, failIfMissing?: boolean): MetricConfigApplicationState | null;
